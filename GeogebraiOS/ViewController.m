...
- (void)viewDidLoad {
    ...
    //JavaIoFile* testFile = [[JavaIoFile alloc] initWithNSString:@"/Users/jacky/GSoC/GeogebraiOS/testFiles/Matrices.ggb"];
    ...
    OrgScilabForgeJlatexmathTeXFormula* formula = [[OrgScilabForgeJlatexmathTeXFormula alloc] initWithNSString:latex1];
    ...
    [g2 setColorWithOrgScilabForgeJlatexmathPlatformGraphicsColor:OrgScilabForgeJlatexmathColorUtil_GREEN_];
