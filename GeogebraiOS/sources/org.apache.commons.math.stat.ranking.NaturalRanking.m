...
- (IOSDoubleArray *)rankWithDoubleArray:(IOSDoubleArray *)data {
  IOSObjectArray *ranks = [IOSObjectArray arrayWithLength:((IOSDoubleArray *) nil_chk(data))->size_ type:OrgApacheCommonsMathStatRankingNaturalRanking_IntDoublePair_class_()];
  for (jint i = 0; i < data->size_; i++) {
    IOSObjectArray_SetAndConsume(ranks, i, new_OrgApacheCommonsMathStatRankingNaturalRanking_IntDoublePair_initWithDouble_withInt_(IOSDoubleArray_Get(data, i), i));
  }
  ...
  IOSDoubleArray *out = [IOSDoubleArray arrayWithLength:((IOSObjectArray *) nil_chk(ranks))->size_];
  jint pos = 1;
  *IOSDoubleArray_GetRef(out, [((OrgApacheCommonsMathStatRankingNaturalRanking_IntDoublePair *) nil_chk(IOSObjectArray_Get(ranks, 0))) getPosition]) = pos;
  id<JavaUtilList> tiesTrace = [new_JavaUtilArrayList_init() autorelease];
  ...
  for (jint i = 1; i < ranks->size_; i++) {
    if (JavaLangDouble_compareWithDouble_withDouble_([((OrgApacheCommonsMathStatRankingNaturalRanking_IntDoublePair *) nil_chk(IOSObjectArray_Get(ranks, i))) getValue], [((OrgApacheCommonsMathStatRankingNaturalRanking_IntDoublePair *) nil_chk(IOSObjectArray_Get(ranks, i - 1))) getValue]) > 0) {
      ...
      tiesTrace = [new_JavaUtilArrayList_init() autorelease];
...
- (void)dealloc {
  RELEASE_(nanStrategy_);
  RELEASE_(tiesStrategy_);
...
+ (void)initialize {
  if (self == [OrgApacheCommonsMathStatRankingNaturalRanking class]) {
    JreStrongAssign(&OrgApacheCommonsMathStatRankingNaturalRanking_DEFAULT_NAN_STRATEGY_, nil, OrgApacheCommonsMathStatRankingNaNStrategyEnum_get_MAXIMAL());
    JreStrongAssign(&OrgApacheCommonsMathStatRankingNaturalRanking_DEFAULT_TIES_STRATEGY_, nil, OrgApacheCommonsMathStatRankingTiesStrategyEnum_get_AVERAGE());
...
void OrgApacheCommonsMathStatRankingNaturalRanking_init(OrgApacheCommonsMathStatRankingNaturalRanking *self) {
  NSObject_init(self);
  OrgApacheCommonsMathStatRankingNaturalRanking_set_tiesStrategy_(self, OrgApacheCommonsMathStatRankingNaturalRanking_DEFAULT_TIES_STRATEGY_);
  OrgApacheCommonsMathStatRankingNaturalRanking_set_nanStrategy_(self, OrgApacheCommonsMathStatRankingNaturalRanking_DEFAULT_NAN_STRATEGY_);
  OrgApacheCommonsMathStatRankingNaturalRanking_set_randomData_(self, nil);
}
...
void OrgApacheCommonsMathStatRankingNaturalRanking_initWithOrgApacheCommonsMathStatRankingTiesStrategyEnum_(OrgApacheCommonsMathStatRankingNaturalRanking *self, OrgApacheCommonsMathStatRankingTiesStrategyEnum *tiesStrategy) {
  NSObject_init(self);
  OrgApacheCommonsMathStatRankingNaturalRanking_set_tiesStrategy_(self, tiesStrategy);
  OrgApacheCommonsMathStatRankingNaturalRanking_set_nanStrategy_(self, OrgApacheCommonsMathStatRankingNaturalRanking_DEFAULT_NAN_STRATEGY_);
  OrgApacheCommonsMathStatRankingNaturalRanking_setAndConsume_randomData_(self, new_OrgApacheCommonsMathRandomRandomDataImpl_init());
}
...
void OrgApacheCommonsMathStatRankingNaturalRanking_initWithOrgApacheCommonsMathStatRankingNaNStrategyEnum_(OrgApacheCommonsMathStatRankingNaturalRanking *self, OrgApacheCommonsMathStatRankingNaNStrategyEnum *nanStrategy) {
  NSObject_init(self);
  OrgApacheCommonsMathStatRankingNaturalRanking_set_nanStrategy_(self, nanStrategy);
  OrgApacheCommonsMathStatRankingNaturalRanking_set_tiesStrategy_(self, OrgApacheCommonsMathStatRankingNaturalRanking_DEFAULT_TIES_STRATEGY_);
  OrgApacheCommonsMathStatRankingNaturalRanking_set_randomData_(self, nil);
}
...
void OrgApacheCommonsMathStatRankingNaturalRanking_initWithOrgApacheCommonsMathRandomRandomGenerator_(OrgApacheCommonsMathStatRankingNaturalRanking *self, id<OrgApacheCommonsMathRandomRandomGenerator> randomGenerator) {
  NSObject_init(self);
  OrgApacheCommonsMathStatRankingNaturalRanking_set_tiesStrategy_(self, OrgApacheCommonsMathStatRankingTiesStrategyEnum_get_RANDOM());
  OrgApacheCommonsMathStatRankingNaturalRanking_set_nanStrategy_(self, OrgApacheCommonsMathStatRankingNaturalRanking_DEFAULT_NAN_STRATEGY_);
  OrgApacheCommonsMathStatRankingNaturalRanking_setAndConsume_randomData_(self, new_OrgApacheCommonsMathRandomRandomDataImpl_initWithOrgApacheCommonsMathRandomRandomGenerator_(randomGenerator));
}
...
IOSObjectArray *OrgApacheCommonsMathStatRankingNaturalRanking_removeNaNsWithOrgApacheCommonsMathStatRankingNaturalRanking_IntDoublePairArray_(OrgApacheCommonsMathStatRankingNaturalRanking *self, IOSObjectArray *ranks) {
  ...
  IOSObjectArray *outRanks = [IOSObjectArray arrayWithLength:((IOSObjectArray *) nil_chk(ranks))->size_ type:OrgApacheCommonsMathStatRankingNaturalRanking_IntDoublePair_class_()];
  jint j = 0;
...
void OrgApacheCommonsMathStatRankingNaturalRanking_recodeNaNsWithOrgApacheCommonsMathStatRankingNaturalRanking_IntDoublePairArray_withDouble_(OrgApacheCommonsMathStatRankingNaturalRanking *self, IOSObjectArray *ranks, jdouble value) {
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(ranks))->size_; i++) {
    if (JavaLangDouble_isNaNWithDouble_([((OrgApacheCommonsMathStatRankingNaturalRanking_IntDoublePair *) nil_chk(IOSObjectArray_Get(ranks, i))) getValue])) {
      IOSObjectArray_SetAndConsume(ranks, i, new_OrgApacheCommonsMathStatRankingNaturalRanking_IntDoublePair_initWithDouble_withInt_(value, [((OrgApacheCommonsMathStatRankingNaturalRanking_IntDoublePair *) nil_chk(IOSObjectArray_Get(ranks, i))) getPosition]));
    }
  }
}
...
id<JavaUtilList> OrgApacheCommonsMathStatRankingNaturalRanking_getNanPositionsWithOrgApacheCommonsMathStatRankingNaturalRanking_IntDoublePairArray_(OrgApacheCommonsMathStatRankingNaturalRanking *self, IOSObjectArray *ranks) {
  JavaUtilArrayList *out = [new_JavaUtilArrayList_init() autorelease];
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(ranks))->size_; i++) {
    if (JavaLangDouble_isNaNWithDouble_([((OrgApacheCommonsMathStatRankingNaturalRanking_IntDoublePair *) nil_chk(IOSObjectArray_Get(ranks, i))) getValue])) {
...
- (jint)compareToWithId:(OrgApacheCommonsMathStatRankingNaturalRanking_IntDoublePair *)other {
  check_class_cast(other, [OrgApacheCommonsMathStatRankingNaturalRanking_IntDoublePair class]);
