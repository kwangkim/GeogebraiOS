...
void OrgApacheCommonsCollections15KeyvalueMultiKey_initWithNSObjectArray_(OrgApacheCommonsCollections15KeyvalueMultiKey *self, IOSObjectArray *keys) {
  OrgApacheCommonsCollections15KeyvalueMultiKey_initWithNSObjectArray_withBoolean_(self, keys, YES);
}
...
void OrgApacheCommonsCollections15KeyvalueMultiKey_initWithNSObjectArray_withBoolean_(OrgApacheCommonsCollections15KeyvalueMultiKey *self, IOSObjectArray *keys, jboolean makeClone) {
  NSObject_init(self);
  if (keys == nil) {
    @throw [new_JavaLangIllegalArgumentException_initWithNSString_(@"The array of keys must not be null") autorelease];
  }
  if (makeClone) {
    OrgApacheCommonsCollections15KeyvalueMultiKey_set_keys_(self, [((IOSObjectArray *) nil_chk(keys)) clone]);
  }
  else {
    OrgApacheCommonsCollections15KeyvalueMultiKey_set_keys_(self, keys);
  }
  jint total = 0;
