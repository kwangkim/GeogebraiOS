...
- (jdouble)getNorm {
  return [self walkInColumnOrderWithOrgApacheCommonsMathLinearRealMatrixPreservingVisitor:[new_OrgApacheCommonsMathLinearAbstractRealMatrix_$1_init() autorelease]];
}

- (jdouble)getFrobeniusNorm {
  return [self walkInOptimizedOrderWithOrgApacheCommonsMathLinearRealMatrixPreservingVisitor:[new_OrgApacheCommonsMathLinearAbstractRealMatrix_$2_init() autorelease]];
}
...
- (id<OrgApacheCommonsMathLinearRealMatrix>)getSubMatrixWithIntArray:(IOSIntArray *)selectedRows
  ...
  [((id<OrgApacheCommonsMathLinearRealMatrix>) nil_chk(subMatrix)) walkInOptimizedOrderWithOrgApacheCommonsMathLinearRealMatrixChangingVisitor:[new_OrgApacheCommonsMathLinearAbstractRealMatrix_$3_initWithOrgApacheCommonsMathLinearAbstractRealMatrix_withIntArray_withIntArray_(self, selectedRows, selectedColumns) autorelease]];
  return subMatrix;
}
...
- (void)copySubMatrixWithInt:(jint)startRow
  ...
  [self walkInOptimizedOrderWithOrgApacheCommonsMathLinearRealMatrixPreservingVisitor:[new_OrgApacheCommonsMathLinearAbstractRealMatrix_$4_initWithDoubleArray2_(destination) autorelease] withInt:startRow withInt:endRow withInt:startColumn withInt:endColumn];
}
...
- (void)setSubMatrixWithDoubleArray2:(IOSObjectArray *)subMatrix
  ...
  OrgApacheCommonsMathLinearAbstractRealMatrix_set_lu_(self, nil);
}
...
- (id<OrgApacheCommonsMathLinearRealVector>)getRowVectorWithInt:(jint)row {
  return [new_OrgApacheCommonsMathLinearArrayRealVector_initWithDoubleArray_withBoolean_([self getRowWithInt:row], NO) autorelease];
}
...
- (id<OrgApacheCommonsMathLinearRealVector>)getColumnVectorWithInt:(jint)column {
  return [new_OrgApacheCommonsMathLinearArrayRealVector_initWithDoubleArray_withBoolean_([self getColumnWithInt:column], NO) autorelease];
}
...
- (id<OrgApacheCommonsMathLinearRealMatrix>)transpose {
  ...
  [self walkInOptimizedOrderWithOrgApacheCommonsMathLinearRealMatrixPreservingVisitor:[new_OrgApacheCommonsMathLinearAbstractRealMatrix_$5_initWithOrgApacheCommonsMathLinearRealMatrix_(out) autorelease]];
  return out;
}

- (id<OrgApacheCommonsMathLinearRealMatrix>)inverse {
  if (lu_ == nil) {
    OrgApacheCommonsMathLinearAbstractRealMatrix_set_lu_(self, [((OrgApacheCommonsMathLinearLUDecompositionImpl *) [new_OrgApacheCommonsMathLinearLUDecompositionImpl_initWithOrgApacheCommonsMathLinearRealMatrix_withDouble_(self, OrgApacheCommonsMathUtilMathUtils_SAFE_MIN) autorelease]) getSolver]);
  }
  return [((id<OrgApacheCommonsMathLinearDecompositionSolver>) nil_chk(lu_)) getInverse];
}

- (jdouble)getDeterminant {
  return [((OrgApacheCommonsMathLinearLUDecompositionImpl *) [new_OrgApacheCommonsMathLinearLUDecompositionImpl_initWithOrgApacheCommonsMathLinearRealMatrix_withDouble_(self, OrgApacheCommonsMathUtilMathUtils_SAFE_MIN) autorelease]) getDeterminant];
}
...
- (id<OrgApacheCommonsMathLinearRealVector>)operateWithOrgApacheCommonsMathLinearRealVector:(id<OrgApacheCommonsMathLinearRealVector>)v {
  @try {
    return [new_OrgApacheCommonsMathLinearArrayRealVector_initWithDoubleArray_withBoolean_([self operateWithDoubleArray:[((OrgApacheCommonsMathLinearArrayRealVector *) nil_chk(((OrgApacheCommonsMathLinearArrayRealVector *) check_class_cast(v, [OrgApacheCommonsMathLinearArrayRealVector class])))) getDataRef]], NO) autorelease];
  }
...
- (id<OrgApacheCommonsMathLinearRealVector>)preMultiplyWithOrgApacheCommonsMathLinearRealVector:(id<OrgApacheCommonsMathLinearRealVector>)v {
  @try {
    return [new_OrgApacheCommonsMathLinearArrayRealVector_initWithDoubleArray_withBoolean_([self preMultiplyWithDoubleArray:[((OrgApacheCommonsMathLinearArrayRealVector *) nil_chk(((OrgApacheCommonsMathLinearArrayRealVector *) check_class_cast(v, [OrgApacheCommonsMathLinearArrayRealVector class])))) getDataRef]], NO) autorelease];
  }
  @catch (JavaLangClassCastException *cce) {
    jint nRows = [self getRowDimension];
    jint nCols = [self getColumnDimension];
    ...
    return [new_OrgApacheCommonsMathLinearArrayRealVector_initWithDoubleArray_(out) autorelease];
  }
}
...
- (NSString *)description {
  ...
  for (jint i = 0; i < nRows; ++i) {
    ...
    for (jint j = 0; j < nCols; ++j) {
      ...
      [res appendWithDouble:[self getEntryWithInt:i withInt:j]];
    }
    [res appendWithNSString:@"}"];
  }
  [res appendWithNSString:@"}"];
...
void OrgApacheCommonsMathLinearAbstractRealMatrix_$3_initWithOrgApacheCommonsMathLinearAbstractRealMatrix_withIntArray_withIntArray_(OrgApacheCommonsMathLinearAbstractRealMatrix_$3 *self, OrgApacheCommonsMathLinearAbstractRealMatrix *outer$, IOSIntArray *capture$0, IOSIntArray *capture$1) {
  OrgApacheCommonsMathLinearAbstractRealMatrix_$3_set_this$0_(self, outer$);
  OrgApacheCommonsMathLinearAbstractRealMatrix_$3_set_val$selectedRows_(self, capture$0);
  OrgApacheCommonsMathLinearAbstractRealMatrix_$3_set_val$selectedColumns_(self, capture$1);
...
void OrgApacheCommonsMathLinearAbstractRealMatrix_$4_initWithDoubleArray2_(OrgApacheCommonsMathLinearAbstractRealMatrix_$4 *self, IOSObjectArray *capture$0) {
  OrgApacheCommonsMathLinearAbstractRealMatrix_$4_set_val$destination_(self, capture$0);
...
void OrgApacheCommonsMathLinearAbstractRealMatrix_$5_initWithOrgApacheCommonsMathLinearRealMatrix_(OrgApacheCommonsMathLinearAbstractRealMatrix_$5 *self, id<OrgApacheCommonsMathLinearRealMatrix> capture$0) {
  OrgApacheCommonsMathLinearAbstractRealMatrix_$5_set_val$out_(self, capture$0);
  OrgApacheCommonsMathLinearDefaultRealMatrixPreservingVisitor_init(self);
}
