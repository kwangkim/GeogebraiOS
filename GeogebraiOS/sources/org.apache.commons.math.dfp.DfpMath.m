...
//  source: /Users/jacky/GSoC/geogebra_iOS/geogebra/geogebra/common/src/org/apache/commons/math/dfp/DfpMath.java
//
...
IOSObjectArray *OrgApacheCommonsMathDfpDfpMath_splitWithOrgApacheCommonsMathDfpDfpField_withNSString_(OrgApacheCommonsMathDfpDfpField *field, NSString *a) {
  ...
  jint sp = 0;
  jint sig = 0;
  buf = [IOSCharArray arrayWithLength:((jint) [((NSString *) nil_chk(a)) length])];
  ...
  IOSObjectArray_Set(result, 0, [((OrgApacheCommonsMathDfpDfpField *) nil_chk(field)) newDfpWithNSString:[NSString stringWithCharacters:buf offset:0 length:sp]]);
  for (jint i = 0; i < buf->size_; i++) {
    *IOSCharArray_GetRef(buf, i) = [a charAtWithInt:i];
  ...
  IOSObjectArray_Set(result, 1, [field newDfpWithNSString:[NSString stringWithCharacters:buf]]);
  return result;
}
...
IOSObjectArray *OrgApacheCommonsMathDfpDfpMath_splitWithOrgApacheCommonsMathDfpDfp_(OrgApacheCommonsMathDfpDfp *a) {
  ...
  IOSObjectArray_Set(result, 0, [((OrgApacheCommonsMathDfpDfp *) nil_chk([a addWithId:shift])) subtractWithId:shift]);
  IOSObjectArray_Set(result, 1, [a subtractWithId:IOSObjectArray_Get(result, 0)]);
  return result;
}
...
IOSObjectArray *OrgApacheCommonsMathDfpDfpMath_splitMultWithOrgApacheCommonsMathDfpDfpArray_withOrgApacheCommonsMathDfpDfpArray_(IOSObjectArray *a, IOSObjectArray *b) {
  OrgApacheCommonsMathDfpDfpMath_initialize();
  IOSObjectArray *result = [IOSObjectArray arrayWithLength:2 type:OrgApacheCommonsMathDfpDfp_class_()];
  IOSObjectArray_Set(result, 1, [((OrgApacheCommonsMathDfpDfp *) nil_chk(IOSObjectArray_Get(nil_chk(a), 0))) getZero]);
  IOSObjectArray_Set(result, 0, [((OrgApacheCommonsMathDfpDfp *) nil_chk(IOSObjectArray_Get(a, 0))) multiplyWithId:IOSObjectArray_Get(nil_chk(b), 0)]);
...
IOSObjectArray *OrgApacheCommonsMathDfpDfpMath_splitDivWithOrgApacheCommonsMathDfpDfpArray_withOrgApacheCommonsMathDfpDfpArray_(IOSObjectArray *a, IOSObjectArray *b) {
  ...
  result = [IOSObjectArray arrayWithLength:2 type:OrgApacheCommonsMathDfpDfp_class_()];
  IOSObjectArray_Set(result, 0, [((OrgApacheCommonsMathDfpDfp *) nil_chk(IOSObjectArray_Get(nil_chk(a), 0))) divideWithId:IOSObjectArray_Get(nil_chk(b), 0)]);
  IOSObjectArray_Set(result, 1, [((OrgApacheCommonsMathDfpDfp *) nil_chk([((OrgApacheCommonsMathDfpDfp *) nil_chk(IOSObjectArray_Get(a, 1))) multiplyWithId:IOSObjectArray_Get(b, 0)])) subtractWithId:[((OrgApacheCommonsMathDfpDfp *) nil_chk(IOSObjectArray_Get(a, 0))) multiplyWithId:IOSObjectArray_Get(b, 1)]]);
...
OrgApacheCommonsMathDfpDfp *OrgApacheCommonsMathDfpDfpMath_splitPowWithOrgApacheCommonsMathDfpDfpArray_withInt_(IOSObjectArray *base, jint a) {
  OrgApacheCommonsMathDfpDfpMath_initialize();
  jboolean invert = NO;
  IOSObjectArray *r = [IOSObjectArray arrayWithLength:2 type:OrgApacheCommonsMathDfpDfp_class_()];
  IOSObjectArray *result = [IOSObjectArray arrayWithLength:2 type:OrgApacheCommonsMathDfpDfp_class_()];
  IOSObjectArray_Set(result, 0, [((OrgApacheCommonsMathDfpDfp *) nil_chk(IOSObjectArray_Get(nil_chk(base), 0))) getOne]);
  IOSObjectArray_Set(result, 1, [((OrgApacheCommonsMathDfpDfp *) nil_chk(IOSObjectArray_Get(base, 0))) getZero]);
  if (a == 0) {
  ...
  do {
    IOSObjectArray_SetAndConsume(r, 0, new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfp_(IOSObjectArray_Get(base, 0)));
    IOSObjectArray_SetAndConsume(r, 1, new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfp_(IOSObjectArray_Get(base, 1)));
    jint trial = 1;
    jint prevtrial;
    while (YES) {
      prevtrial = trial;
  ...
  while (a >= 1);
  IOSObjectArray_Set(nil_chk(result), 0, [((OrgApacheCommonsMathDfpDfp *) nil_chk(IOSObjectArray_Get(result, 0))) addWithId:IOSObjectArray_Get(result, 1)]);
  if (invert) {
    IOSObjectArray_Set(result, 0, [((OrgApacheCommonsMathDfpDfp *) nil_chk([((OrgApacheCommonsMathDfpDfp *) nil_chk(IOSObjectArray_Get(base, 0))) getOne])) divideWithId:IOSObjectArray_Get(result, 0)]);
  }
...
OrgApacheCommonsMathDfpDfp *OrgApacheCommonsMathDfpDfpMath_powWithOrgApacheCommonsMathDfpDfp_withInt_(OrgApacheCommonsMathDfpDfp *base, jint a) {
  ...
  do {
    OrgApacheCommonsMathDfpDfp *r = [new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfp_(base) autorelease];
    OrgApacheCommonsMathDfpDfp *prevr;
    jint trial = 1;
    jint prevtrial;
    do {
      prevr = [new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfp_(r) autorelease];
      prevtrial = trial;
...
OrgApacheCommonsMathDfpDfp *OrgApacheCommonsMathDfpDfpMath_logWithOrgApacheCommonsMathDfpDfp_(OrgApacheCommonsMathDfpDfp *a) {
  ...
  x = [new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfp_(a) autorelease];
  lr = [x log10K];
  ...
  IOSObjectArray *spy = [IOSObjectArray arrayWithLength:2 type:OrgApacheCommonsMathDfpDfp_class_()];
  IOSObjectArray_Set(spy, 0, OrgApacheCommonsMathDfpDfpMath_powWithOrgApacheCommonsMathDfpDfp_withInt_([a getTwo], p2));
  IOSObjectArray_Set(nil_chk(spx), 0, [((OrgApacheCommonsMathDfpDfp *) nil_chk(IOSObjectArray_Get(spx, 0))) divideWithId:IOSObjectArray_Get(spy, 0)]);
  IOSObjectArray_Set(spx, 1, [((OrgApacheCommonsMathDfpDfp *) nil_chk(IOSObjectArray_Get(spx, 1))) divideWithId:IOSObjectArray_Get(spy, 0)]);
  IOSObjectArray_Set(spy, 0, [a newInstanceWithNSString:@"1.33333"]);
  while ([((OrgApacheCommonsMathDfpDfp *) nil_chk([((OrgApacheCommonsMathDfpDfp *) nil_chk(IOSObjectArray_Get(spx, 0))) addWithId:IOSObjectArray_Get(spx, 1)])) greaterThanWithOrgApacheCommonsMathDfpDfp:IOSObjectArray_Get(spy, 0)]) {
    IOSObjectArray_Set(spx, 0, [((OrgApacheCommonsMathDfpDfp *) nil_chk(IOSObjectArray_Get(spx, 0))) divideWithInt:2]);
    IOSObjectArray_Set(spx, 1, [((OrgApacheCommonsMathDfpDfp *) nil_chk(IOSObjectArray_Get(spx, 1))) divideWithInt:2]);
    p2++;
  }
  IOSObjectArray *spz = OrgApacheCommonsMathDfpDfpMath_logInternalWithOrgApacheCommonsMathDfpDfpArray_(spx);
  IOSObjectArray_Set(spx, 0, [a newInstanceWithNSString:[((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) [new_JavaLangStringBuilder_init() autorelease]) appendWithInt:p2 + 4 * lr])) description]]);
  IOSObjectArray_Set(spx, 1, [a getZero]);
  ...
  IOSObjectArray_Set(nil_chk(spz), 0, [((OrgApacheCommonsMathDfpDfp *) nil_chk(IOSObjectArray_Get(spz, 0))) addWithId:IOSObjectArray_Get(nil_chk(spy), 0)]);
  IOSObjectArray_Set(spz, 1, [((OrgApacheCommonsMathDfpDfp *) nil_chk(IOSObjectArray_Get(spz, 1))) addWithId:IOSObjectArray_Get(spy, 1)]);
  IOSObjectArray_Set(spx, 0, [a newInstanceWithNSString:[((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) [new_JavaLangStringBuilder_init() autorelease]) appendWithInt:4 * lr])) description]]);
  IOSObjectArray_Set(spx, 1, [a getZero]);
  ...
  IOSObjectArray_Set(spz, 0, [((OrgApacheCommonsMathDfpDfp *) nil_chk(IOSObjectArray_Get(spz, 0))) addWithId:IOSObjectArray_Get(nil_chk(spy), 0)]);
  IOSObjectArray_Set(spz, 1, [((OrgApacheCommonsMathDfpDfp *) nil_chk(IOSObjectArray_Get(spz, 1))) addWithId:IOSObjectArray_Get(spy, 1)]);
...
OrgApacheCommonsMathDfpDfp *OrgApacheCommonsMathDfpDfpMath_sinWithOrgApacheCommonsMathDfpDfp_(OrgApacheCommonsMathDfpDfp *a) {
  ...
  if ([((OrgApacheCommonsMathDfpDfp *) nil_chk(x)) lessThanWithOrgApacheCommonsMathDfpDfp:[pi divideWithInt:4]]) {
    IOSObjectArray *c = [IOSObjectArray arrayWithLength:2 type:OrgApacheCommonsMathDfpDfp_class_()];
    IOSObjectArray_Set(c, 0, x);
    IOSObjectArray_Set(c, 1, zero);
    ...
    IOSObjectArray_Set(c, 0, [((OrgApacheCommonsMathDfpDfp *) nil_chk([((OrgApacheCommonsMathDfpDfp *) nil_chk(IOSObjectArray_Get(nil_chk(piSplit), 0))) divideWithInt:2])) subtractWithId:x]);
    IOSObjectArray_Set(c, 1, [((OrgApacheCommonsMathDfpDfp *) nil_chk(IOSObjectArray_Get(piSplit, 1))) divideWithInt:2]);
...
OrgApacheCommonsMathDfpDfp *OrgApacheCommonsMathDfpDfpMath_atanInternalWithOrgApacheCommonsMathDfpDfp_(OrgApacheCommonsMathDfpDfp *a) {
  OrgApacheCommonsMathDfpDfpMath_initialize();
  OrgApacheCommonsMathDfpDfp *y = [new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfp_(a) autorelease];
  OrgApacheCommonsMathDfpDfp *x = [new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfp_(y) autorelease];
  OrgApacheCommonsMathDfpDfp *py = [new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfp_(y) autorelease];
  for (jint i = 3; i < 90; i += 2) {
...
OrgApacheCommonsMathDfpDfp *OrgApacheCommonsMathDfpDfpMath_atanWithOrgApacheCommonsMathDfpDfp_(OrgApacheCommonsMathDfpDfp *a) {
  ...
  OrgApacheCommonsMathDfpDfp *x = [new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfp_(a) autorelease];
  if ([x lessThanWithOrgApacheCommonsMathDfpDfp:zero]) {
    neg = YES;
    x = [x negate];
  }
  ...
  if ([((OrgApacheCommonsMathDfpDfp *) nil_chk(x)) greaterThanWithOrgApacheCommonsMathDfpDfp:ty]) {
    IOSObjectArray *sty = [IOSObjectArray arrayWithLength:2 type:OrgApacheCommonsMathDfpDfp_class_()];
    sub = YES;
    IOSObjectArray_Set(sty, 0, [((OrgApacheCommonsMathDfpDfp *) nil_chk(IOSObjectArray_Get(sqr2Split, 0))) subtractWithId:one]);
    IOSObjectArray_Set(sty, 1, IOSObjectArray_Get(sqr2Split, 1));
    ...
    IOSObjectArray_Set(nil_chk(ds), 0, [((OrgApacheCommonsMathDfpDfp *) nil_chk(IOSObjectArray_Get(ds, 0))) addWithId:one]);
    IOSObjectArray_Set(nil_chk(xs), 0, [((OrgApacheCommonsMathDfpDfp *) nil_chk(IOSObjectArray_Get(xs, 0))) subtractWithId:IOSObjectArray_Get(sty, 0)]);
    IOSObjectArray_Set(xs, 1, [((OrgApacheCommonsMathDfpDfp *) nil_chk(IOSObjectArray_Get(xs, 1))) subtractWithId:IOSObjectArray_Get(sty, 1)]);
