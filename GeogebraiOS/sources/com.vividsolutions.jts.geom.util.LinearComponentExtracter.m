...
//  source: /Users/jacky/GSoC/geogebra_iOS/geogebra/geogebra/common/src/com/vividsolutions/jts/geom/util/LinearComponentExtracter.java
//
...
id<JavaUtilList> ComVividsolutionsJtsGeomUtilLinearComponentExtracter_getLinesWithComVividsolutionsJtsGeomGeometry_(ComVividsolutionsJtsGeomGeometry *geom) {
  ...
  [((ComVividsolutionsJtsGeomGeometry *) nil_chk(geom)) applyWithComVividsolutionsJtsGeomGeometryComponentFilter:[new_ComVividsolutionsJtsGeomUtilLinearComponentExtracter_initWithJavaUtilList_(lines) autorelease]];
  return lines;
}
...
void ComVividsolutionsJtsGeomUtilLinearComponentExtracter_initWithJavaUtilList_(ComVividsolutionsJtsGeomUtilLinearComponentExtracter *self, id<JavaUtilList> lines) {
  NSObject_init(self);
  ComVividsolutionsJtsGeomUtilLinearComponentExtracter_set_lines_(self, lines);
}
