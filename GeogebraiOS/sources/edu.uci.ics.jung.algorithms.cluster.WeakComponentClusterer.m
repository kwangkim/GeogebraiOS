...
- (id<JavaUtilSet>)transformWithId:(id<EduUciIcsJungGraphGraph>)graph {
  id<JavaUtilSet> clusterSet = [new_JavaUtilHashSet_init() autorelease];
  JavaUtilHashSet *unvisitedVertices = [new_JavaUtilHashSet_initWithJavaUtilCollection_([((id<EduUciIcsJungGraphGraph>) nil_chk(graph)) getVertices]) autorelease];
  while (![unvisitedVertices isEmpty]) {
    id<JavaUtilSet> cluster = [new_JavaUtilHashSet_init() autorelease];
