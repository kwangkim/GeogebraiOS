...
- (id<JavaUtilSortedSet>)subSetWithId:(id)fromElement
  ...
  @synchronized(lock_) {
    ...
    return [new_OrgApacheCommonsCollections15SetSynchronizedSortedSet_initWithJavaUtilSortedSet_withId_(set, lock_) autorelease];
  }
}
...
id<JavaUtilSortedSet> OrgApacheCommonsCollections15SetSynchronizedSortedSet_decorateWithJavaUtilSortedSet_(id<JavaUtilSortedSet> set) {
  ...
  return [new_OrgApacheCommonsCollections15SetSynchronizedSortedSet_initWithJavaUtilSortedSet_(set) autorelease];
}
