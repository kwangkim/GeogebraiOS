...
- (IOSObjectArray *)simplifyWithDouble:(jdouble)distanceTol {
  ...
  ComVividsolutionsJtsOperationBufferBufferInputLineSimplifier_setAndConsume_isDeleted_(self, [IOSBooleanArray newArrayWithLength:((IOSObjectArray *) nil_chk(inputLine_))->size_]);
...
IOSObjectArray *ComVividsolutionsJtsOperationBufferBufferInputLineSimplifier_simplifyWithComVividsolutionsJtsGeomCoordinateArray_withDouble_(IOSObjectArray *inputLine, jdouble distanceTol) {
  ...
  ComVividsolutionsJtsOperationBufferBufferInputLineSimplifier *simp = [new_ComVividsolutionsJtsOperationBufferBufferInputLineSimplifier_initWithComVividsolutionsJtsGeomCoordinateArray_(inputLine) autorelease];
...
void ComVividsolutionsJtsOperationBufferBufferInputLineSimplifier_initWithComVividsolutionsJtsGeomCoordinateArray_(ComVividsolutionsJtsOperationBufferBufferInputLineSimplifier *self, IOSObjectArray *inputLine) {
  ...
  ComVividsolutionsJtsOperationBufferBufferInputLineSimplifier_set_inputLine_(self, inputLine);
}
