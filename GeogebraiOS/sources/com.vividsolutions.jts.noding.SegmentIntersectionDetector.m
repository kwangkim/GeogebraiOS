...
//  source: /Users/jacky/GSoC/geogebra_iOS/geogebra/geogebra/common/src/com/vividsolutions/jts/noding/SegmentIntersectionDetector.java
//
...
- (void)processIntersectionsWithComVividsolutionsJtsNodingSegmentString:(id<ComVividsolutionsJtsNodingSegmentString>)e0
  ...
  if ([li_ hasIntersection]) {
    ...
    if (intPt_ == nil || saveLocation) {
      ComVividsolutionsJtsNodingSegmentIntersectionDetector_set_intPt_(self, [li_ getIntersectionWithInt:0]);
      ComVividsolutionsJtsNodingSegmentIntersectionDetector_setAndConsume_intSegments_(self, [IOSObjectArray newArrayWithLength:4 type:ComVividsolutionsJtsGeomCoordinate_class_()]);
...
void ComVividsolutionsJtsNodingSegmentIntersectionDetector_initWithComVividsolutionsJtsAlgorithmLineIntersector_(ComVividsolutionsJtsNodingSegmentIntersectionDetector *self, ComVividsolutionsJtsAlgorithmLineIntersector *li) {
  ...
  ComVividsolutionsJtsNodingSegmentIntersectionDetector_set_intPt_(self, nil);
  ComVividsolutionsJtsNodingSegmentIntersectionDetector_set_intSegments_(self, nil);
  ComVividsolutionsJtsNodingSegmentIntersectionDetector_set_li_(self, li);
}
