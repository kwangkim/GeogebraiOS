...
- (id<OrgApacheCommonsMathGeneticsPopulation>)nextGeneration {
  OrgApacheCommonsMathGeneticsElitisticListPopulation *nextGeneration = [new_OrgApacheCommonsMathGeneticsElitisticListPopulation_initWithInt_withDouble_([self getPopulationLimit], [self getElitismRate]) autorelease];
...
- (void)setElitismRateWithDouble:(jdouble)elitismRate {
  if (elitismRate < 0 || elitismRate > 1) @throw [new_JavaLangIllegalArgumentException_initWithNSString_(@"Elitism rate has to be in [0,1]") autorelease];
