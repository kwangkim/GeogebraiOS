...
@interface GeogebraCommonKernelProverAlgoAreParallel () {
 @public
...
J2OBJC_FIELD_SETTER(GeogebraCommonKernelProverAlgoAreParallel, inputLine1_, GeogebraCommonKernelGeosGeoLine *)
J2OBJC_FIELD_SETTER(GeogebraCommonKernelProverAlgoAreParallel, inputLine2_, GeogebraCommonKernelGeosGeoLine *)
J2OBJC_FIELD_SETTER(GeogebraCommonKernelProverAlgoAreParallel, outputBoolean_, GeogebraCommonKernelGeosGeoBoolean *)
J2OBJC_FIELD_SETTER(GeogebraCommonKernelProverAlgoAreParallel, polynomials_, IOSObjectArray *)
J2OBJC_FIELD_SETTER(GeogebraCommonKernelProverAlgoAreParallel, botanaPolynomials_, IOSObjectArray *)

__attribute__((unused)) static void GeogebraCommonKernelProverAlgoAreParallel_compute(GeogebraCommonKernelProverAlgoAreParallel *self);

@implementation GeogebraCommonKernelProverAlgoAreParallel
...
- (instancetype)initWithGeogebraCommonKernelConstruction:(GeogebraCommonKernelConstruction *)cons
  ...
  GeogebraCommonKernelProverAlgoAreParallel_initWithGeogebraCommonKernelConstruction_withNSString_withGeogebraCommonKernelGeosGeoElement_withGeogebraCommonKernelGeosGeoElement_(self, cons, label, inputLine1, inputLine2);
  return self;
}

- (GeogebraCommonKernelCommandsCommandsEnum *)getClassName {
  return GeogebraCommonKernelCommandsCommandsEnum_get_AreParallel();
}
...
- (void)compute {
  GeogebraCommonKernelProverAlgoAreParallel_compute(self);
}
...
- (IOSObjectArray *)getPolynomials {
  ...
  if (inputLine1_ != nil && inputLine2_ != nil) {
    ...
    GeogebraCommonKernelProverAlgoAreParallel_setAndConsume_polynomials_(self, [IOSObjectArray newArrayWithLength:1 type:GeogebraCommonKernelProverPolynomialPolynomial_class_()]);
    IOSObjectArray_Set(polynomials_, 0, [((GeogebraCommonKernelProverPolynomialPolynomial *) nil_chk([((GeogebraCommonKernelProverPolynomialPolynomial *) nil_chk(IOSObjectArray_Get(nil_chk(coords1), 0))) multiplyWithGeogebraCommonKernelProverPolynomialPolynomial:IOSObjectArray_Get(nil_chk(coords2), 1)])) subtractWithGeogebraCommonKernelProverPolynomialPolynomial:[((GeogebraCommonKernelProverPolynomialPolynomial *) nil_chk(IOSObjectArray_Get(coords1, 1))) multiplyWithGeogebraCommonKernelProverPolynomialPolynomial:IOSObjectArray_Get(coords2, 0)]]);
    return polynomials_;
  }
  @throw [new_GeogebraCommonKernelProverNoSymbolicParametersException_init() autorelease];
}
...
- (IOSObjectArray *)getBotanaPolynomials {
  ...
  if (inputLine1_ != nil && inputLine2_ != nil) {
    ...
    GeogebraCommonKernelProverAlgoAreParallel_setAndConsume_botanaPolynomials_(self, [IOSObjectArray newArrayWithDimensions:2 lengths:(jint[]){ 1, 1 } type:GeogebraCommonKernelProverPolynomialPolynomial_class_()]);
    IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(botanaPolynomials_, 0)), 0, GeogebraCommonKernelProverPolynomialPolynomial_parallelWithGeogebraCommonKernelProverPolynomialVariable_withGeogebraCommonKernelProverPolynomialVariable_withGeogebraCommonKernelProverPolynomialVariable_withGeogebraCommonKernelProverPolynomialVariable_withGeogebraCommonKernelProverPolynomialVariable_withGeogebraCommonKernelProverPolynomialVariable_withGeogebraCommonKernelProverPolynomialVariable_withGeogebraCommonKernelProverPolynomialVariable_(IOSObjectArray_Get(nil_chk(v1), 0), IOSObjectArray_Get(v1, 1), IOSObjectArray_Get(v1, 2), IOSObjectArray_Get(v1, 3), IOSObjectArray_Get(nil_chk(v2), 0), IOSObjectArray_Get(v2, 1), IOSObjectArray_Get(v2, 2), IOSObjectArray_Get(v2, 3)));
    return botanaPolynomials_;
  }
  return nil;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithGeogebraCommonKernelConstruction:withNSString:withGeogebraCommonKernelGeosGeoElement:withGeogebraCommonKernelGeosGeoElement:", "AlgoAreParallel", NULL, 0x1, NULL, NULL },
  ...
  static const J2ObjcClassInfo _GeogebraCommonKernelProverAlgoAreParallel = { 2, "AlgoAreParallel", "geogebra.common.kernel.prover", NULL, 0x1, 11, methods, 5, fields, 0, NULL, 0, NULL, NULL, NULL };
  return &_GeogebraCommonKernelProverAlgoAreParallel;
}
...
void GeogebraCommonKernelProverAlgoAreParallel_initWithGeogebraCommonKernelConstruction_withNSString_withGeogebraCommonKernelGeosGeoElement_withGeogebraCommonKernelGeosGeoElement_(GeogebraCommonKernelProverAlgoAreParallel *self, GeogebraCommonKernelConstruction *cons, NSString *label, GeogebraCommonKernelGeosGeoElement *inputLine1, GeogebraCommonKernelGeosGeoElement *inputLine2) {
  ...
  GeogebraCommonKernelProverAlgoAreParallel_set_inputLine1_(self, (GeogebraCommonKernelGeosGeoLine *) check_class_cast(inputLine1, [GeogebraCommonKernelGeosGeoLine class]));
  GeogebraCommonKernelProverAlgoAreParallel_set_inputLine2_(self, (GeogebraCommonKernelGeosGeoLine *) check_class_cast(inputLine2, [GeogebraCommonKernelGeosGeoLine class]));
  GeogebraCommonKernelProverAlgoAreParallel_setAndConsume_outputBoolean_(self, new_GeogebraCommonKernelGeosGeoBoolean_initWithGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  GeogebraCommonKernelProverAlgoAreParallel_compute(self);
}
...
GeogebraCommonKernelProverAlgoAreParallel *new_GeogebraCommonKernelProverAlgoAreParallel_initWithGeogebraCommonKernelConstruction_withNSString_withGeogebraCommonKernelGeosGeoElement_withGeogebraCommonKernelGeosGeoElement_(GeogebraCommonKernelConstruction *cons, NSString *label, GeogebraCommonKernelGeosGeoElement *inputLine1, GeogebraCommonKernelGeosGeoElement *inputLine2) {
  GeogebraCommonKernelProverAlgoAreParallel *self = [GeogebraCommonKernelProverAlgoAreParallel alloc];
  GeogebraCommonKernelProverAlgoAreParallel_initWithGeogebraCommonKernelConstruction_withNSString_withGeogebraCommonKernelGeosGeoElement_withGeogebraCommonKernelGeosGeoElement_(self, cons, label, inputLine1, inputLine2);
  return self;
}

void GeogebraCommonKernelProverAlgoAreParallel_compute(GeogebraCommonKernelProverAlgoAreParallel *self) {
  [((GeogebraCommonKernelGeosGeoBoolean *) nil_chk(self->outputBoolean_)) setValueWithBoolean:[((GeogebraCommonKernelGeosGeoLine *) nil_chk(self->inputLine1_)) isParallelWithGeogebraCommonKernelGeosGeoLine:self->inputLine2_]];
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(GeogebraCommonKernelProverAlgoAreParallel)
