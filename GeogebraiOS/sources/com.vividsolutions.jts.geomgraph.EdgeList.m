...
- (void)addWithComVividsolutionsJtsGeomgraphEdge:(ComVividsolutionsJtsGeomgraphEdge *)e {
  ...
  ComVividsolutionsJtsNodingOrientedCoordinateArray *oca = [new_ComVividsolutionsJtsNodingOrientedCoordinateArray_initWithComVividsolutionsJtsGeomCoordinateArray_([((ComVividsolutionsJtsGeomgraphEdge *) nil_chk(e)) getCoordinates]) autorelease];
  [((id<JavaUtilMap>) nil_chk(ocaMap_)) putWithId:oca withId:e];
}
...
void ComVividsolutionsJtsGeomgraphEdgeList_init(ComVividsolutionsJtsGeomgraphEdgeList *self) {
  NSObject_init(self);
  ComVividsolutionsJtsGeomgraphEdgeList_setAndConsume_edges_(self, new_JavaUtilArrayList_init());
  ComVividsolutionsJtsGeomgraphEdgeList_setAndConsume_ocaMap_(self, new_JavaUtilTreeMap_init());
}
