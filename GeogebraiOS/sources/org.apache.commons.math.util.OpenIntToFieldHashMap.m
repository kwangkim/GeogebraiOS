...
- (OrgApacheCommonsMathUtilOpenIntToFieldHashMap_Iterator *)iterator {
  return [new_OrgApacheCommonsMathUtilOpenIntToFieldHashMap_Iterator_initWithOrgApacheCommonsMathUtilOpenIntToFieldHashMap_(self) autorelease];
}
...
void OrgApacheCommonsMathUtilOpenIntToFieldHashMap_initWithOrgApacheCommonsMathField_(OrgApacheCommonsMathUtilOpenIntToFieldHashMap *self, id<OrgApacheCommonsMathField> field) {
  OrgApacheCommonsMathUtilOpenIntToFieldHashMap_initWithOrgApacheCommonsMathField_withInt_withOrgApacheCommonsMathFieldElement_(self, field, OrgApacheCommonsMathUtilOpenIntToFieldHashMap_DEFAULT_EXPECTED_SIZE, [((id<OrgApacheCommonsMathField>) nil_chk(field)) getZero]);
}
...
void OrgApacheCommonsMathUtilOpenIntToFieldHashMap_initWithOrgApacheCommonsMathField_withOrgApacheCommonsMathFieldElement_(OrgApacheCommonsMathUtilOpenIntToFieldHashMap *self, id<OrgApacheCommonsMathField> field, id<OrgApacheCommonsMathFieldElement> missingEntries) {
  OrgApacheCommonsMathUtilOpenIntToFieldHashMap_initWithOrgApacheCommonsMathField_withInt_withOrgApacheCommonsMathFieldElement_(self, field, OrgApacheCommonsMathUtilOpenIntToFieldHashMap_DEFAULT_EXPECTED_SIZE, missingEntries);
}
...
void OrgApacheCommonsMathUtilOpenIntToFieldHashMap_initWithOrgApacheCommonsMathField_withInt_(OrgApacheCommonsMathUtilOpenIntToFieldHashMap *self, id<OrgApacheCommonsMathField> field, jint expectedSize) {
  OrgApacheCommonsMathUtilOpenIntToFieldHashMap_initWithOrgApacheCommonsMathField_withInt_withOrgApacheCommonsMathFieldElement_(self, field, expectedSize, [((id<OrgApacheCommonsMathField>) nil_chk(field)) getZero]);
}
...
void OrgApacheCommonsMathUtilOpenIntToFieldHashMap_initWithOrgApacheCommonsMathField_withInt_withOrgApacheCommonsMathFieldElement_(OrgApacheCommonsMathUtilOpenIntToFieldHashMap *self, id<OrgApacheCommonsMathField> field, jint expectedSize, id<OrgApacheCommonsMathFieldElement> missingEntries) {
  NSObject_init(self);
  OrgApacheCommonsMathUtilOpenIntToFieldHashMap_set_field_(self, field);
  jint capacity = OrgApacheCommonsMathUtilOpenIntToFieldHashMap_computeCapacityWithInt_(expectedSize);
  OrgApacheCommonsMathUtilOpenIntToFieldHashMap_setAndConsume_keys_(self, [IOSIntArray newArrayWithLength:capacity]);
  OrgApacheCommonsMathUtilOpenIntToFieldHashMap_set_values_(self, OrgApacheCommonsMathUtilOpenIntToFieldHashMap_buildArrayWithInt_(self, capacity));
  OrgApacheCommonsMathUtilOpenIntToFieldHashMap_setAndConsume_states_(self, [IOSByteArray newArrayWithLength:capacity]);
  OrgApacheCommonsMathUtilOpenIntToFieldHashMap_set_missingEntries_(self, missingEntries);
...
void OrgApacheCommonsMathUtilOpenIntToFieldHashMap_initWithOrgApacheCommonsMathUtilOpenIntToFieldHashMap_(OrgApacheCommonsMathUtilOpenIntToFieldHashMap *self, OrgApacheCommonsMathUtilOpenIntToFieldHashMap *source) {
  NSObject_init(self);
  OrgApacheCommonsMathUtilOpenIntToFieldHashMap_set_field_(self, ((OrgApacheCommonsMathUtilOpenIntToFieldHashMap *) nil_chk(source))->field_);
  jint length = ((IOSIntArray *) nil_chk(source->keys_))->size_;
  OrgApacheCommonsMathUtilOpenIntToFieldHashMap_setAndConsume_keys_(self, [IOSIntArray newArrayWithLength:length]);
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(source->keys_, 0, self->keys_, 0, length);
  OrgApacheCommonsMathUtilOpenIntToFieldHashMap_set_values_(self, OrgApacheCommonsMathUtilOpenIntToFieldHashMap_buildArrayWithInt_(self, length));
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(source->values_, 0, self->values_, 0, length);
  OrgApacheCommonsMathUtilOpenIntToFieldHashMap_setAndConsume_states_(self, [IOSByteArray newArrayWithLength:length]);
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(source->states_, 0, self->states_, 0, length);
  OrgApacheCommonsMathUtilOpenIntToFieldHashMap_set_missingEntries_(self, source->missingEntries_);
...
id OrgApacheCommonsMathUtilOpenIntToFieldHashMap_doRemoveWithInt_(OrgApacheCommonsMathUtilOpenIntToFieldHashMap *self, jint index) {
  ...
  *IOSByteArray_GetRef(nil_chk(self->states_), index) = OrgApacheCommonsMathUtilOpenIntToFieldHashMap_REMOVED;
  ...
  IOSObjectArray_Set(self->values_, index, self->missingEntries_);
  --self->size__;
  ++self->count_;
  return previous;
}
  ...
  for (jint i = 0; i < oldLength; ++i) {
    if (IOSByteArray_Get(oldStates, i) == OrgApacheCommonsMathUtilOpenIntToFieldHashMap_FULL) {
      ...
      *IOSIntArray_GetRef(newKeys, index) = key;
      IOSObjectArray_Set(nil_chk(newValues), index, IOSObjectArray_Get(nil_chk(oldValues), i));
      *IOSByteArray_GetRef(newStates, index) = OrgApacheCommonsMathUtilOpenIntToFieldHashMap_FULL;
    }
  }
  self->mask_ = newMask;
  OrgApacheCommonsMathUtilOpenIntToFieldHashMap_set_keys_(self, newKeys);
  OrgApacheCommonsMathUtilOpenIntToFieldHashMap_set_values_(self, newValues);
  OrgApacheCommonsMathUtilOpenIntToFieldHashMap_set_states_(self, newStates);
}
...
void OrgApacheCommonsMathUtilOpenIntToFieldHashMap_Iterator_initWithOrgApacheCommonsMathUtilOpenIntToFieldHashMap_(OrgApacheCommonsMathUtilOpenIntToFieldHashMap_Iterator *self, OrgApacheCommonsMathUtilOpenIntToFieldHashMap *outer$) {
  OrgApacheCommonsMathUtilOpenIntToFieldHashMap_Iterator_set_this$0_(self, outer$);
  NSObject_init(self);
