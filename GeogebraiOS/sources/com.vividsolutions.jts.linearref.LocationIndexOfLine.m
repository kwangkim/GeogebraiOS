...
- (IOSObjectArray *)indicesOfWithComVividsolutionsJtsGeomGeometry:(ComVividsolutionsJtsGeomGeometry *)subLine {
  ...
  ComVividsolutionsJtsLinearrefLocationIndexOfPoint *locPt = [new_ComVividsolutionsJtsLinearrefLocationIndexOfPoint_initWithComVividsolutionsJtsGeomGeometry_(linearGeom_) autorelease];
  IOSObjectArray *subLineLoc = [IOSObjectArray arrayWithLength:2 type:ComVividsolutionsJtsLinearrefLinearLocation_class_()];
  IOSObjectArray_Set(subLineLoc, 0, [locPt indexOfWithComVividsolutionsJtsGeomCoordinate:startPt]);
  if ([subLine getLength] == 0.0) {
    IOSObjectArray_Set(subLineLoc, 1, (ComVividsolutionsJtsLinearrefLinearLocation *) check_class_cast([((ComVividsolutionsJtsLinearrefLinearLocation *) nil_chk(IOSObjectArray_Get(subLineLoc, 0))) clone], [ComVividsolutionsJtsLinearrefLinearLocation class]));
  }
  else {
    IOSObjectArray_Set(subLineLoc, 1, [locPt indexOfAfterWithComVividsolutionsJtsGeomCoordinate:endPt withComVividsolutionsJtsLinearrefLinearLocation:IOSObjectArray_Get(subLineLoc, 0)]);
  }
  return subLineLoc;
}
...
IOSObjectArray *ComVividsolutionsJtsLinearrefLocationIndexOfLine_indicesOfWithComVividsolutionsJtsGeomGeometry_withComVividsolutionsJtsGeomGeometry_(ComVividsolutionsJtsGeomGeometry *linearGeom, ComVividsolutionsJtsGeomGeometry *subLine) {
  ...
  ComVividsolutionsJtsLinearrefLocationIndexOfLine *locater = [new_ComVividsolutionsJtsLinearrefLocationIndexOfLine_initWithComVividsolutionsJtsGeomGeometry_(linearGeom) autorelease];
...
void ComVividsolutionsJtsLinearrefLocationIndexOfLine_initWithComVividsolutionsJtsGeomGeometry_(ComVividsolutionsJtsLinearrefLocationIndexOfLine *self, ComVividsolutionsJtsGeomGeometry *linearGeom) {
  NSObject_init(self);
  ComVividsolutionsJtsLinearrefLocationIndexOfLine_set_linearGeom_(self, linearGeom);
}
