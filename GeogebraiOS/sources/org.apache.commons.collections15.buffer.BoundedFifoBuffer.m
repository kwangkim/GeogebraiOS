...
//  source: /Users/jacky/GSoC/geogebra_iOS/geogebra/geogebra/common/src/org/apache/commons/collections15/buffer/BoundedFifoBuffer.java
//
...
- (void)readObjectWithJavaIoObjectInputStream:(JavaIoObjectInputStream *)inArg {
  ...
  OrgApacheCommonsCollections15BufferBoundedFifoBuffer_set_elements_(self, (IOSObjectArray *) check_class_cast([IOSObjectArray arrayWithLength:maxElements_ type:NSObject_class_()], [IOSObjectArray class]));
  jint size = [inArg readInt];
  for (jint i = 0; i < size; i++) {
    IOSObjectArray_Set(elements_, i, (id) [inArg readObject]);
  }
  start_ = 0;
...
- (jboolean)addWithId:(id)element {
  ...
  if (full_) {
    @throw [new_OrgApacheCommonsCollections15BufferOverflowException_initWithNSString_(JreStrcat("$I$", @"The buffer cannot hold more than ", maxElements_, @" objects.")) autorelease];
  }
  IOSObjectArray_Set(nil_chk(elements_), end_++, element);
...
- (id)remove {
  ...
  if (nil != element) {
    IOSObjectArray_Set(elements_, start_++, nil);
...
- (id<JavaUtilIterator>)iterator {
  return [new_OrgApacheCommonsCollections15BufferBoundedFifoBuffer_$1_initWithOrgApacheCommonsCollections15BufferBoundedFifoBuffer_(self) autorelease];
}
...
void OrgApacheCommonsCollections15BufferBoundedFifoBuffer_initWithInt_(OrgApacheCommonsCollections15BufferBoundedFifoBuffer *self, jint size) {
  ...
  OrgApacheCommonsCollections15BufferBoundedFifoBuffer_set_elements_(self, (IOSObjectArray *) check_class_cast([IOSObjectArray arrayWithLength:size type:NSObject_class_()], [IOSObjectArray class]));
...
void OrgApacheCommonsCollections15BufferBoundedFifoBuffer_initWithJavaUtilCollection_(OrgApacheCommonsCollections15BufferBoundedFifoBuffer *self, id<JavaUtilCollection> coll) {
  OrgApacheCommonsCollections15BufferBoundedFifoBuffer_initWithInt_(self, [((id<JavaUtilCollection>) nil_chk(coll)) size]);
...
- (void)remove {
  ...
  while (i != this$0_->end_) {
    if (i >= this$0_->maxElements_) {
      IOSObjectArray_Set(nil_chk(this$0_->elements_), i - 1, IOSObjectArray_Get(this$0_->elements_, 0));
      i = 0;
    }
    else {
      IOSObjectArray_Set(nil_chk(this$0_->elements_), i - 1, IOSObjectArray_Get(this$0_->elements_, i));
      i++;
    }
  }
  lastReturnedIndex_ = -1;
  this$0_->end_ = OrgApacheCommonsCollections15BufferBoundedFifoBuffer_decrementWithInt_(this$0_, this$0_->end_);
  IOSObjectArray_Set(nil_chk(this$0_->elements_), this$0_->end_, nil);
  this$0_->full_ = NO;
...
void OrgApacheCommonsCollections15BufferBoundedFifoBuffer_$1_initWithOrgApacheCommonsCollections15BufferBoundedFifoBuffer_(OrgApacheCommonsCollections15BufferBoundedFifoBuffer_$1 *self, OrgApacheCommonsCollections15BufferBoundedFifoBuffer *outer$) {
  OrgApacheCommonsCollections15BufferBoundedFifoBuffer_$1_set_this$0_(self, outer$);
  NSObject_init(self);
