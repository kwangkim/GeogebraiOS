...
- (IOSIntArray *)sampleWithInt:(jint)sampleSize {
  ...
  IOSIntArray *out = [IOSIntArray arrayWithLength:sampleSize];
...
void OrgApacheCommonsMathDistributionAbstractIntegerDistribution_init(OrgApacheCommonsMathDistributionAbstractIntegerDistribution *self) {
  ...
  OrgApacheCommonsMathDistributionAbstractIntegerDistribution_setAndConsume_randomData_(self, new_OrgApacheCommonsMathRandomRandomDataImpl_init());
}
