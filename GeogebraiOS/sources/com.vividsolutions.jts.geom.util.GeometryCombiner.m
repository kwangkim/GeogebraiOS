...
//  source: /Users/jacky/GSoC/geogebra_iOS/geogebra/geogebra/common/src/com/vividsolutions/jts/geom/util/GeometryCombiner.java
//
...
- (ComVividsolutionsJtsGeomGeometry *)combine {
  id<JavaUtilList> elems = [new_JavaUtilArrayList_init() autorelease];
...
ComVividsolutionsJtsGeomGeometry *ComVividsolutionsJtsGeomUtilGeometryCombiner_combineWithJavaUtilCollection_(id<JavaUtilCollection> geoms) {
  ...
  ComVividsolutionsJtsGeomUtilGeometryCombiner *combiner = [new_ComVividsolutionsJtsGeomUtilGeometryCombiner_initWithJavaUtilCollection_(geoms) autorelease];
...
ComVividsolutionsJtsGeomGeometry *ComVividsolutionsJtsGeomUtilGeometryCombiner_combineWithComVividsolutionsJtsGeomGeometry_withComVividsolutionsJtsGeomGeometry_(ComVividsolutionsJtsGeomGeometry *g0, ComVividsolutionsJtsGeomGeometry *g1) {
  ComVividsolutionsJtsGeomUtilGeometryCombiner_initialize();
  ComVividsolutionsJtsGeomUtilGeometryCombiner *combiner = [new_ComVividsolutionsJtsGeomUtilGeometryCombiner_initWithJavaUtilCollection_(ComVividsolutionsJtsGeomUtilGeometryCombiner_createListWithId_withId_(g0, g1)) autorelease];
  return [combiner combine];
}
...
ComVividsolutionsJtsGeomGeometry *ComVividsolutionsJtsGeomUtilGeometryCombiner_combineWithComVividsolutionsJtsGeomGeometry_withComVividsolutionsJtsGeomGeometry_withComVividsolutionsJtsGeomGeometry_(ComVividsolutionsJtsGeomGeometry *g0, ComVividsolutionsJtsGeomGeometry *g1, ComVividsolutionsJtsGeomGeometry *g2) {
  ComVividsolutionsJtsGeomUtilGeometryCombiner_initialize();
  ComVividsolutionsJtsGeomUtilGeometryCombiner *combiner = [new_ComVividsolutionsJtsGeomUtilGeometryCombiner_initWithJavaUtilCollection_(ComVividsolutionsJtsGeomUtilGeometryCombiner_createListWithId_withId_withId_(g0, g1, g2)) autorelease];
  return [combiner combine];
}
...
void ComVividsolutionsJtsGeomUtilGeometryCombiner_initWithJavaUtilCollection_(ComVividsolutionsJtsGeomUtilGeometryCombiner *self, id<JavaUtilCollection> geoms) {
  NSObject_init(self);
  self->skipEmpty_ = NO;
  ComVividsolutionsJtsGeomUtilGeometryCombiner_set_geomFactory_(self, ComVividsolutionsJtsGeomUtilGeometryCombiner_extractFactoryWithJavaUtilCollection_(geoms));
  ComVividsolutionsJtsGeomUtilGeometryCombiner_set_inputGeoms_(self, geoms);
}
