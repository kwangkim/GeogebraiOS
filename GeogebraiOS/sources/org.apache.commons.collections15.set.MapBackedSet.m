...
- (jboolean)addWithId:(id)obj {
  ...
  [map_ putWithId:obj withId:dummyValue_];
...
id<JavaUtilSet> OrgApacheCommonsCollections15SetMapBackedSet_decorateWithJavaUtilMap_withId_(id<JavaUtilMap> map, id dummyValue) {
  OrgApacheCommonsCollections15SetMapBackedSet_initialize();
  if (map == nil) {
    @throw [new_JavaLangIllegalArgumentException_initWithNSString_(@"The map must not be null") autorelease];
  }
  return [new_OrgApacheCommonsCollections15SetMapBackedSet_initWithJavaUtilMap_withId_(map, dummyValue) autorelease];
}
...
void OrgApacheCommonsCollections15SetMapBackedSet_initWithJavaUtilMap_withId_(OrgApacheCommonsCollections15SetMapBackedSet *self, id<JavaUtilMap> map, id dummyValue) {
  NSObject_init(self);
  OrgApacheCommonsCollections15SetMapBackedSet_set_map_(self, map);
  OrgApacheCommonsCollections15SetMapBackedSet_set_dummyValue_(self, dummyValue);
}
