...
@implementation GeogebraCommonKernelBarycentricCmdCubic

- (instancetype)initWithGeogebraCommonKernelKernel:(GeogebraCommonKernelKernel *)kernel {
  GeogebraCommonKernelBarycentricCmdCubic_initWithGeogebraCommonKernelKernel_(self, kernel);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithGeogebraCommonKernelKernel:", "CmdCubic", NULL, 0x1, NULL, NULL },
  ...
  static const J2ObjcClassInfo _GeogebraCommonKernelBarycentricCmdCubic = { 2, "CmdCubic", "geogebra.common.kernel.barycentric", NULL, 0x1, 2, methods, 0, NULL, 0, NULL, 0, NULL, NULL, NULL };
  return &_GeogebraCommonKernelBarycentricCmdCubic;
}

@end

void GeogebraCommonKernelBarycentricCmdCubic_initWithGeogebraCommonKernelKernel_(GeogebraCommonKernelBarycentricCmdCubic *self, GeogebraCommonKernelKernel *kernel) {
  GeogebraCommonKernelCommandsCommandProcessor_initWithGeogebraCommonKernelKernel_(self, kernel);
}

GeogebraCommonKernelBarycentricCmdCubic *new_GeogebraCommonKernelBarycentricCmdCubic_initWithGeogebraCommonKernelKernel_(GeogebraCommonKernelKernel *kernel) {
  GeogebraCommonKernelBarycentricCmdCubic *self = [GeogebraCommonKernelBarycentricCmdCubic alloc];
  GeogebraCommonKernelBarycentricCmdCubic_initWithGeogebraCommonKernelKernel_(self, kernel);
  return self;
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(GeogebraCommonKernelBarycentricCmdCubic)
