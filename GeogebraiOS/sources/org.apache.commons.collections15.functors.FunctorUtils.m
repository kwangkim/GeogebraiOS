...
void OrgApacheCommonsCollections15FunctorsFunctorUtils_validateWithOrgApacheCommonsCollections15PredicateArray_(IOSObjectArray *predicates) {
  OrgApacheCommonsCollections15FunctorsFunctorUtils_initialize();
  if (predicates == nil) {
    @throw [new_JavaLangIllegalArgumentException_initWithNSString_(@"The predicate array must not be null") autorelease];
  }
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(predicates))->size_; i++) {
    if (IOSObjectArray_Get(predicates, i) == nil) {
      @throw [new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$I$", @"The predicate array must not contain a null predicate, index ", i, @" was null")) autorelease];
    }
  }
}
...
void OrgApacheCommonsCollections15FunctorsFunctorUtils_validateMin2WithOrgApacheCommonsCollections15PredicateArray_(IOSObjectArray *predicates) {
  ...
  if (((IOSObjectArray *) nil_chk(predicates))->size_ < 2) {
    @throw [new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$I", @"At least 2 predicates must be specified in the predicate array, size was ", predicates->size_)) autorelease];
  }
...
IOSObjectArray *OrgApacheCommonsCollections15FunctorsFunctorUtils_validateWithJavaUtilCollection_(id<JavaUtilCollection> predicates) {
  OrgApacheCommonsCollections15FunctorsFunctorUtils_initialize();
  if (predicates == nil) {
    @throw [new_JavaLangIllegalArgumentException_initWithNSString_(@"The predicate collection must not be null") autorelease];
  }
  if ([((id<JavaUtilCollection>) nil_chk(predicates)) size] < 2) {
    @throw [new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$I", @"At least 2 predicates must be specified in the predicate collection, size was ", [predicates size])) autorelease];
  }
  IOSObjectArray *preds = [IOSObjectArray arrayWithLength:[predicates size] type:OrgApacheCommonsCollections15Predicate_class_()];
  jint i = 0;
  for (id<JavaUtilIterator> it = [predicates iterator]; [((id<JavaUtilIterator>) nil_chk(it)) hasNext]; ) {
    IOSObjectArray_Set(preds, i, [it next]);
    if (IOSObjectArray_Get(preds, i) == nil) {
      @throw [new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$I$", @"The predicate collection must not contain a null predicate, index ", i, @" was null")) autorelease];
    }
    i++;
  }
  return preds;
...
void OrgApacheCommonsCollections15FunctorsFunctorUtils_validateWithOrgApacheCommonsCollections15ClosureArray_(IOSObjectArray *closures) {
  OrgApacheCommonsCollections15FunctorsFunctorUtils_initialize();
  if (closures == nil) {
    @throw [new_JavaLangIllegalArgumentException_initWithNSString_(@"The closure array must not be null") autorelease];
  }
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(closures))->size_; i++) {
    if (IOSObjectArray_Get(closures, i) == nil) {
      @throw [new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$I$", @"The closure array must not contain a null closure, index ", i, @" was null")) autorelease];
    }
  }
}
...
void OrgApacheCommonsCollections15FunctorsFunctorUtils_validateWithOrgApacheCommonsCollections15TransformerArray_(IOSObjectArray *transformers) {
  OrgApacheCommonsCollections15FunctorsFunctorUtils_initialize();
  if (transformers == nil) {
    @throw [new_JavaLangIllegalArgumentException_initWithNSString_(@"The transformer array must not be null") autorelease];
  }
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(transformers))->size_; i++) {
    if (IOSObjectArray_Get(transformers, i) == nil) {
      @throw [new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$I$", @"The transformer array must not contain a null transformer, index ", i, @" was null")) autorelease];
    }
  }
}
