...
- (OrgApacheCommonsMathStatDescriptiveSynchronizedDescriptiveStatistics *)copy__ {
  @synchronized(self) {
    OrgApacheCommonsMathStatDescriptiveSynchronizedDescriptiveStatistics *result = [new_OrgApacheCommonsMathStatDescriptiveSynchronizedDescriptiveStatistics_init() autorelease];
...
void OrgApacheCommonsMathStatDescriptiveSynchronizedDescriptiveStatistics_init(OrgApacheCommonsMathStatDescriptiveSynchronizedDescriptiveStatistics *self) {
  OrgApacheCommonsMathStatDescriptiveSynchronizedDescriptiveStatistics_initWithInt_(self, OrgApacheCommonsMathStatDescriptiveDescriptiveStatistics_INFINITE_WINDOW);
}
