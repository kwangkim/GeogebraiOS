...
//  source: /Users/jacky/GSoC/geogebra_iOS/geogebra/geogebra/common/src/org/apache/commons/math/ode/nonstiff/AdamsMoultonIntegrator.java
//
...
- (jdouble)integrateWithOrgApacheCommonsMathOdeFirstOrderDifferentialEquations:(id<OrgApacheCommonsMathOdeFirstOrderDifferentialEquations>)equations
  ...
  IOSDoubleArray *yDot = [IOSDoubleArray arrayWithLength:y0->size_];
  IOSDoubleArray *yTmp = [IOSDoubleArray arrayWithLength:y0->size_];
  IOSDoubleArray *predictedScaled = [IOSDoubleArray arrayWithLength:y0->size_];
  OrgApacheCommonsMathLinearArray2DRowRealMatrix *nordsieckTmp = nil;
  OrgApacheCommonsMathOdeSamplingNordsieckStepInterpolator *interpolator = [new_OrgApacheCommonsMathOdeSamplingNordsieckStepInterpolator_init() autorelease];
  ...
  do {
    ...
    jdouble stepEnd = stepStart_ + stepSize_;
    [self computeDerivativesWithDouble:stepEnd withDoubleArray:yTmp withDoubleArray:yDot];
    IOSDoubleArray *correctedScaled = [IOSDoubleArray arrayWithLength:y0->size_];
    for (jint j = 0; j < y0->size_; ++j) {
    ...
    OrgApacheCommonsMathOdeMultistepIntegrator_set_scaled_(self, correctedScaled);
    OrgApacheCommonsMathOdeMultistepIntegrator_set_nordsieck_(self, nordsieckTmp);
    if (!isLastStep_) {
      [interpolator storeTimeWithDouble:stepStart_];
      if (resetOccurred_) {
...
void OrgApacheCommonsMathOdeNonstiffAdamsMoultonIntegrator_initWithInt_withDouble_withDouble_withDouble_withDouble_(OrgApacheCommonsMathOdeNonstiffAdamsMoultonIntegrator *self, jint nSteps, jdouble minStep, jdouble maxStep, jdouble scalAbsoluteTolerance, jdouble scalRelativeTolerance) {
  OrgApacheCommonsMathOdeNonstiffAdamsIntegrator_initWithNSString_withInt_withInt_withDouble_withDouble_withDouble_withDouble_(self, OrgApacheCommonsMathOdeNonstiffAdamsMoultonIntegrator_METHOD_NAME_, nSteps, nSteps + 1, minStep, maxStep, scalAbsoluteTolerance, scalRelativeTolerance);
}
...
void OrgApacheCommonsMathOdeNonstiffAdamsMoultonIntegrator_initWithInt_withDouble_withDouble_withDoubleArray_withDoubleArray_(OrgApacheCommonsMathOdeNonstiffAdamsMoultonIntegrator *self, jint nSteps, jdouble minStep, jdouble maxStep, IOSDoubleArray *vecAbsoluteTolerance, IOSDoubleArray *vecRelativeTolerance) {
  OrgApacheCommonsMathOdeNonstiffAdamsIntegrator_initWithNSString_withInt_withInt_withDouble_withDouble_withDoubleArray_withDoubleArray_(self, OrgApacheCommonsMathOdeNonstiffAdamsMoultonIntegrator_METHOD_NAME_, nSteps, nSteps + 1, minStep, maxStep, vecAbsoluteTolerance, vecRelativeTolerance);
}
...
void OrgApacheCommonsMathOdeNonstiffAdamsMoultonIntegrator_Corrector_initWithOrgApacheCommonsMathOdeNonstiffAdamsMoultonIntegrator_withDoubleArray_withDoubleArray_withDoubleArray_(OrgApacheCommonsMathOdeNonstiffAdamsMoultonIntegrator_Corrector *self, OrgApacheCommonsMathOdeNonstiffAdamsMoultonIntegrator *outer$, IOSDoubleArray *previous, IOSDoubleArray *scaled, IOSDoubleArray *state) {
  OrgApacheCommonsMathOdeNonstiffAdamsMoultonIntegrator_Corrector_set_this$0_(self, outer$);
  NSObject_init(self);
  OrgApacheCommonsMathOdeNonstiffAdamsMoultonIntegrator_Corrector_set_previous_(self, previous);
  OrgApacheCommonsMathOdeNonstiffAdamsMoultonIntegrator_Corrector_set_scaled1_(self, scaled);
  OrgApacheCommonsMathOdeNonstiffAdamsMoultonIntegrator_Corrector_set_after_(self, state);
  OrgApacheCommonsMathOdeNonstiffAdamsMoultonIntegrator_Corrector_set_before_(self, [((IOSDoubleArray *) nil_chk(state)) clone]);
}
