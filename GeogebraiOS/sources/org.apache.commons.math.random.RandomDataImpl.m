...
//  source: /Users/jacky/GSoC/geogebra_iOS/geogebra/geogebra/common/src/org/apache/commons/math/random/RandomDataImpl.java
//
...
- (NSString *)nextHexStringWithInt:(jint)len {
  if (len <= 0) {
    @throw [new_OrgApacheCommonsMathExceptionNotStrictlyPositiveException_initWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSNumber_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_LENGTH(), JavaLangInteger_valueOfWithInt_(len)) autorelease];
  }
  ...
  IOSByteArray *randomBytes = [IOSByteArray arrayWithLength:(len / 2) + 1];
  ...
  for (jint i = 0; i < randomBytes->size_; i++) {
    ...
    [outBuffer appendWithNSString:hex];
  }
...
- (jlong)nextLongWithLong:(jlong)lower
  ...
  if (lower >= upper) {
    @throw [new_OrgApacheCommonsMathExceptionNumberIsTooLargeException_initWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSNumber_withNSNumber_withBoolean_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_LOWER_BOUND_NOT_BELOW_UPPER_BOUND(), JavaLangLong_valueOfWithLong_(lower), JavaLangLong_valueOfWithLong_(upper), NO) autorelease];
  }
  jdouble r = [((id<OrgApacheCommonsMathRandomRandomGenerator>) nil_chk(OrgApacheCommonsMathRandomRandomDataImpl_getRan(self))) nextDouble];
...
- (NSString *)nextSecureHexStringWithInt:(jint)len {
  ...
  @catch (JavaSecurityNoSuchAlgorithmException *ex) {
    @throw [new_OrgApacheCommonsMathExceptionMathInternalError_initWithJavaLangThrowable_(ex) autorelease];
  }
  [((JavaSecurityMessageDigest *) nil_chk(alg)) reset];
  jint numIter = (len / 40) + 1;
  JavaLangStringBuilder *outBuffer = [new_JavaLangStringBuilder_init() autorelease];
  for (jint iter = 1; iter < numIter + 1; iter++) {
    IOSByteArray *randomBytes = [IOSByteArray arrayWithLength:40];
...
- (jlong)nextPoissonWithDouble:(jdouble)mean {
  if (mean <= 0) {
    @throw [new_OrgApacheCommonsMathExceptionNotStrictlyPositiveException_initWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSNumber_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_MEAN(), JavaLangDouble_valueOfWithDouble_(mean)) autorelease];
  }
...
- (jdouble)nextGaussianWithDouble:(jdouble)mu
  ...
  if (sigma <= 0) {
    @throw [new_OrgApacheCommonsMathExceptionNotStrictlyPositiveException_initWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSNumber_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_STANDARD_DEVIATION(), JavaLangDouble_valueOfWithDouble_(sigma)) autorelease];
  }
...
- (jdouble)nextUniformWithDouble:(jdouble)lower
  ...
  if (lower >= upper) {
    @throw [new_OrgApacheCommonsMathExceptionNumberIsTooLargeException_initWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSNumber_withNSNumber_withBoolean_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_LOWER_BOUND_NOT_BELOW_UPPER_BOUND(), JavaLangDouble_valueOfWithDouble_(lower), JavaLangDouble_valueOfWithDouble_(upper), NO) autorelease];
  }
  id<OrgApacheCommonsMathRandomRandomGenerator> generator = OrgApacheCommonsMathRandomRandomDataImpl_getRan(self);
...
- (jdouble)nextBetaWithDouble:(jdouble)alpha
  ...
  return [self nextInversionDeviateWithOrgApacheCommonsMathDistributionContinuousDistribution:[new_OrgApacheCommonsMathDistributionBetaDistributionImpl_initWithDouble_withDouble_(alpha, beta) autorelease]];
}

- (jint)nextBinomialWithInt:(jint)numberOfTrials
                 withDouble:(jdouble)probabilityOfSuccess {
  return [self nextInversionDeviateWithOrgApacheCommonsMathDistributionIntegerDistribution:[new_OrgApacheCommonsMathDistributionBinomialDistributionImpl_initWithInt_withDouble_(numberOfTrials, probabilityOfSuccess) autorelease]];
}

- (jdouble)nextCauchyWithDouble:(jdouble)median
                     withDouble:(jdouble)scale_ {
  return [self nextInversionDeviateWithOrgApacheCommonsMathDistributionContinuousDistribution:[new_OrgApacheCommonsMathDistributionCauchyDistributionImpl_initWithDouble_withDouble_(median, scale_) autorelease]];
}

- (jdouble)nextChiSquareWithDouble:(jdouble)df {
  return [self nextInversionDeviateWithOrgApacheCommonsMathDistributionContinuousDistribution:[new_OrgApacheCommonsMathDistributionChiSquaredDistributionImpl_initWithDouble_(df) autorelease]];
}

- (jdouble)nextFWithDouble:(jdouble)numeratorDf
                withDouble:(jdouble)denominatorDf {
  return [self nextInversionDeviateWithOrgApacheCommonsMathDistributionContinuousDistribution:[new_OrgApacheCommonsMathDistributionFDistributionImpl_initWithDouble_withDouble_(numeratorDf, denominatorDf) autorelease]];
}

- (jdouble)nextGammaWithDouble:(jdouble)shape
                    withDouble:(jdouble)scale_ {
  return [self nextInversionDeviateWithOrgApacheCommonsMathDistributionContinuousDistribution:[new_OrgApacheCommonsMathDistributionGammaDistributionImpl_initWithDouble_withDouble_(shape, scale_) autorelease]];
}

- (jint)nextHypergeometricWithInt:(jint)populationSize
                          withInt:(jint)numberOfSuccesses
                          withInt:(jint)sampleSize {
  return [self nextInversionDeviateWithOrgApacheCommonsMathDistributionIntegerDistribution:[new_OrgApacheCommonsMathDistributionHypergeometricDistributionImpl_initWithInt_withInt_withInt_(populationSize, numberOfSuccesses, sampleSize) autorelease]];
}

- (jint)nextPascalWithInt:(jint)r
               withDouble:(jdouble)p {
  return [self nextInversionDeviateWithOrgApacheCommonsMathDistributionIntegerDistribution:[new_OrgApacheCommonsMathDistributionPascalDistributionImpl_initWithInt_withDouble_(r, p) autorelease]];
}

- (jdouble)nextTWithDouble:(jdouble)df {
  return [self nextInversionDeviateWithOrgApacheCommonsMathDistributionContinuousDistribution:[new_OrgApacheCommonsMathDistributionTDistributionImpl_initWithDouble_(df) autorelease]];
}

- (jdouble)nextWeibullWithDouble:(jdouble)shape
                      withDouble:(jdouble)scale_ {
  return [self nextInversionDeviateWithOrgApacheCommonsMathDistributionContinuousDistribution:[new_OrgApacheCommonsMathDistributionWeibullDistributionImpl_initWithDouble_withDouble_(shape, scale_) autorelease]];
}

- (jint)nextZipfWithInt:(jint)numberOfElements
             withDouble:(jdouble)exponent {
  return [self nextInversionDeviateWithOrgApacheCommonsMathDistributionIntegerDistribution:[new_OrgApacheCommonsMathDistributionZipfDistributionImpl_initWithInt_withDouble_(numberOfElements, exponent) autorelease]];
}
...
- (void)reSeedWithLong:(jlong)seed {
  if (rand_ == nil) {
    OrgApacheCommonsMathRandomRandomDataImpl_setAndConsume_rand_(self, new_OrgApacheCommonsMathRandomJDKRandomGenerator_init());
  }
...
- (void)reSeedSecure {
  if (secRand_ == nil) {
    OrgApacheCommonsMathRandomRandomDataImpl_setAndConsume_secRand_(self, new_JavaSecuritySecureRandom_init());
  }
...
- (void)setSecureAlgorithmWithNSString:(NSString *)algorithm
  ...
  OrgApacheCommonsMathRandomRandomDataImpl_set_secRand_(self, JavaSecuritySecureRandom_getInstanceWithNSString_withNSString_(algorithm, provider));
}

- (IOSIntArray *)nextPermutationWithInt:(jint)n
                                withInt:(jint)k {
  if (k > n) {
    @throw [new_OrgApacheCommonsMathExceptionNumberIsTooLargeException_initWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSNumber_withNSNumber_withBoolean_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_PERMUTATION_EXCEEDS_N(), JavaLangInteger_valueOfWithInt_(k), JavaLangInteger_valueOfWithInt_(n), YES) autorelease];
  }
  if (k == 0) {
    @throw [new_OrgApacheCommonsMathExceptionNotStrictlyPositiveException_initWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSNumber_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_PERMUTATION_SIZE(), JavaLangInteger_valueOfWithInt_(k)) autorelease];
  }
  ...
  IOSIntArray *result = [IOSIntArray arrayWithLength:k];
  for (jint i = 0; i < k; i++) {
...
- (IOSObjectArray *)nextSampleWithJavaUtilCollection:(id<JavaUtilCollection>)c
  ...
  if (k > len) {
    @throw [new_OrgApacheCommonsMathExceptionNumberIsTooLargeException_initWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSNumber_withNSNumber_withBoolean_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_SAMPLE_SIZE_EXCEEDS_COLLECTION_SIZE(), JavaLangInteger_valueOfWithInt_(k), JavaLangInteger_valueOfWithInt_(len), YES) autorelease];
  }
  if (k <= 0) {
    @throw [new_OrgApacheCommonsMathExceptionNotStrictlyPositiveException_initWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSNumber_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_NUMBER_OF_SAMPLES(), JavaLangInteger_valueOfWithInt_(k)) autorelease];
  }
  IOSObjectArray *objects = [c toArray];
  IOSIntArray *index = [self nextPermutationWithInt:len withInt:k];
  IOSObjectArray *result = [IOSObjectArray arrayWithLength:k type:NSObject_class_()];
  for (jint i = 0; i < k; i++) {
    IOSObjectArray_Set(result, i, IOSObjectArray_Get(nil_chk(objects), IOSIntArray_Get(nil_chk(index), i)));
  }
  return result;
}
...
void OrgApacheCommonsMathRandomRandomDataImpl_init(OrgApacheCommonsMathRandomRandomDataImpl *self) {
  NSObject_init(self);
  OrgApacheCommonsMathRandomRandomDataImpl_set_rand_(self, nil);
  OrgApacheCommonsMathRandomRandomDataImpl_set_secRand_(self, nil);
}
...
void OrgApacheCommonsMathRandomRandomDataImpl_initWithOrgApacheCommonsMathRandomRandomGenerator_(OrgApacheCommonsMathRandomRandomDataImpl *self, id<OrgApacheCommonsMathRandomRandomGenerator> rand) {
  ...
  OrgApacheCommonsMathRandomRandomDataImpl_set_rand_(self, nil);
  OrgApacheCommonsMathRandomRandomDataImpl_set_secRand_(self, nil);
  OrgApacheCommonsMathRandomRandomDataImpl_set_rand_(self, rand);
}
...
IOSIntArray *OrgApacheCommonsMathRandomRandomDataImpl_getNaturalWithInt_(OrgApacheCommonsMathRandomRandomDataImpl *self, jint n) {
  IOSIntArray *natural = [IOSIntArray arrayWithLength:n];
  for (jint i = 0; i < n; i++) {
