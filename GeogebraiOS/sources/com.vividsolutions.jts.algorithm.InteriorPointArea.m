...
- (void)addPolygonWithComVividsolutionsJtsGeomGeometry:(ComVividsolutionsJtsGeomGeometry *)geometry {
  ...
  if (interiorPoint_ == nil || width > maxWidth_) {
    ComVividsolutionsJtsAlgorithmInteriorPointArea_set_interiorPoint_(self, [self centreWithComVividsolutionsJtsGeomEnvelope:[widestIntersection getEnvelopeInternal]]);
    maxWidth_ = width;
  }
}
...
void ComVividsolutionsJtsAlgorithmInteriorPointArea_initWithComVividsolutionsJtsGeomGeometry_(ComVividsolutionsJtsAlgorithmInteriorPointArea *self, ComVividsolutionsJtsGeomGeometry *g) {
  NSObject_init(self);
  ComVividsolutionsJtsAlgorithmInteriorPointArea_set_interiorPoint_(self, nil);
  self->maxWidth_ = 0.0;
  ComVividsolutionsJtsAlgorithmInteriorPointArea_set_factory_(self, [((ComVividsolutionsJtsGeomGeometry *) nil_chk(g)) getFactory]);
