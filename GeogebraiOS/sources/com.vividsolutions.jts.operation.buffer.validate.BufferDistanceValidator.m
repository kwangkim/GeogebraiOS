...
//  source: /Users/jacky/GSoC/geogebra_iOS/geogebra/geogebra/common/src/com/vividsolutions/jts/operation/buffer/validate/BufferDistanceValidator.java
//
...
void ComVividsolutionsJtsOperationBufferValidateBufferDistanceValidator_initWithComVividsolutionsJtsGeomGeometry_withDouble_withComVividsolutionsJtsGeomGeometry_(ComVividsolutionsJtsOperationBufferValidateBufferDistanceValidator *self, ComVividsolutionsJtsGeomGeometry *input, jdouble bufDistance, ComVividsolutionsJtsGeomGeometry *result) {
  NSObject_init(self);
  self->isValid__ = YES;
  ComVividsolutionsJtsOperationBufferValidateBufferDistanceValidator_set_errMsg_(self, nil);
  ComVividsolutionsJtsOperationBufferValidateBufferDistanceValidator_set_errorLocation_(self, nil);
  ComVividsolutionsJtsOperationBufferValidateBufferDistanceValidator_set_input_(self, input);
  self->bufDistance_ = bufDistance;
  ComVividsolutionsJtsOperationBufferValidateBufferDistanceValidator_set_result_(self, result);
}
...
ComVividsolutionsJtsGeomGeometry *ComVividsolutionsJtsOperationBufferValidateBufferDistanceValidator_getPolygonLinesWithComVividsolutionsJtsGeomGeometry_(ComVividsolutionsJtsOperationBufferValidateBufferDistanceValidator *self, ComVividsolutionsJtsGeomGeometry *g) {
  ...
  ComVividsolutionsJtsGeomUtilLinearComponentExtracter *lineExtracter = [new_ComVividsolutionsJtsGeomUtilLinearComponentExtracter_initWithJavaUtilList_(lines) autorelease];
...
void ComVividsolutionsJtsOperationBufferValidateBufferDistanceValidator_checkMinimumDistanceWithComVividsolutionsJtsGeomGeometry_withComVividsolutionsJtsGeomGeometry_withDouble_(ComVividsolutionsJtsOperationBufferValidateBufferDistanceValidator *self, ComVividsolutionsJtsGeomGeometry *g1, ComVividsolutionsJtsGeomGeometry *g2, jdouble minDist) {
  ComVividsolutionsJtsOperationDistanceDistanceOp *distOp = [new_ComVividsolutionsJtsOperationDistanceDistanceOp_initWithComVividsolutionsJtsGeomGeometry_withComVividsolutionsJtsGeomGeometry_withDouble_(g1, g2, minDist) autorelease];
  self->minDistanceFound_ = [distOp distance];
  if (self->minDistanceFound_ < minDist) {
    self->isValid__ = NO;
    IOSObjectArray *pts = [distOp nearestPoints];
    ComVividsolutionsJtsOperationBufferValidateBufferDistanceValidator_set_errorLocation_(self, IOSObjectArray_Get(nil_chk([distOp nearestPoints]), 1));
    ComVividsolutionsJtsOperationBufferValidateBufferDistanceValidator_set_errMsg_(self, JreStrcat("$D$$$", @"Distance between buffer curve and input is too small (", self->minDistanceFound_, @" at ", ComVividsolutionsJtsIoWKTWriter_toLineStringWithComVividsolutionsJtsGeomCoordinate_withComVividsolutionsJtsGeomCoordinate_(IOSObjectArray_Get(nil_chk(pts), 0), IOSObjectArray_Get(pts, 1)), @" )"));
  }
}

void ComVividsolutionsJtsOperationBufferValidateBufferDistanceValidator_checkMaximumDistanceWithComVividsolutionsJtsGeomGeometry_withComVividsolutionsJtsGeomGeometry_withDouble_(ComVividsolutionsJtsOperationBufferValidateBufferDistanceValidator *self, ComVividsolutionsJtsGeomGeometry *input, ComVividsolutionsJtsGeomGeometry *bufCurve, jdouble maxDist) {
  ComVividsolutionsJtsAlgorithmDistanceDiscreteHausdorffDistance *haus = [new_ComVividsolutionsJtsAlgorithmDistanceDiscreteHausdorffDistance_initWithComVividsolutionsJtsGeomGeometry_withComVividsolutionsJtsGeomGeometry_(bufCurve, input) autorelease];
  ...
  if (self->maxDistanceFound_ > maxDist) {
    ...
    ComVividsolutionsJtsOperationBufferValidateBufferDistanceValidator_set_errorLocation_(self, IOSObjectArray_Get(nil_chk(pts), 1));
    ComVividsolutionsJtsOperationBufferValidateBufferDistanceValidator_set_errMsg_(self, JreStrcat("$D$$C", @"Distance between buffer curve and input is too large (", self->maxDistanceFound_, @" at ", ComVividsolutionsJtsIoWKTWriter_toLineStringWithComVividsolutionsJtsGeomCoordinate_withComVividsolutionsJtsGeomCoordinate_(IOSObjectArray_Get(pts, 0), IOSObjectArray_Get(pts, 1)), ')'));
  }
}
