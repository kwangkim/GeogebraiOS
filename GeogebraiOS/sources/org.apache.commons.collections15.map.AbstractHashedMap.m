...
- (void)reuseEntryWithOrgApacheCommonsCollections15MapAbstractHashedMap_HashEntry:(OrgApacheCommonsCollections15MapAbstractHashedMap_HashEntry *)entry_
                                                                          ...
                                                                          withInt:(jint)hashCode
                                                                           withId:(id)key
                                                                           withId:(id)value {
  OrgApacheCommonsCollections15MapAbstractHashedMap_HashEntry_set_next_(nil_chk(entry_), IOSObjectArray_Get(nil_chk(data_), hashIndex));
  entry_->hashCode__ = hashCode;
  OrgApacheCommonsCollections15MapAbstractHashedMap_HashEntry_set_key_(entry_, key);
  OrgApacheCommonsCollections15MapAbstractHashedMap_HashEntry_set_value_(entry_, value);
}
...
- (OrgApacheCommonsCollections15MapAbstractHashedMap_HashEntry *)createEntryWithOrgApacheCommonsCollections15MapAbstractHashedMap_HashEntry:(OrgApacheCommonsCollections15MapAbstractHashedMap_HashEntry *)next
                                                                                                                                    withInt:(jint)hashCode
                                                                                                                                     withId:(id)key
                                                                                                                                     withId:(id)value {
  return [new_OrgApacheCommonsCollections15MapAbstractHashedMap_HashEntry_initWithOrgApacheCommonsCollections15MapAbstractHashedMap_HashEntry_withInt_withId_withId_(next, hashCode, key, value) autorelease];
}
...
- (void)removeEntryWithOrgApacheCommonsCollections15MapAbstractHashedMap_HashEntry:(OrgApacheCommonsCollections15MapAbstractHashedMap_HashEntry *)entry_
                   ...
                   withOrgApacheCommonsCollections15MapAbstractHashedMap_HashEntry:(OrgApacheCommonsCollections15MapAbstractHashedMap_HashEntry *)previous {
  if (previous == nil) {
    IOSObjectArray_Set(nil_chk(data_), hashIndex, ((OrgApacheCommonsCollections15MapAbstractHashedMap_HashEntry *) nil_chk(entry_))->next_);
  }
  else {
...
- (void)destroyEntryWithOrgApacheCommonsCollections15MapAbstractHashedMap_HashEntry:(OrgApacheCommonsCollections15MapAbstractHashedMap_HashEntry *)entry_ {
  OrgApacheCommonsCollections15MapAbstractHashedMap_HashEntry_set_next_(nil_chk(entry_), nil);
  OrgApacheCommonsCollections15MapAbstractHashedMap_HashEntry_set_key_(entry_, nil);
  OrgApacheCommonsCollections15MapAbstractHashedMap_HashEntry_set_value_(entry_, nil);
}
...
- (void)ensureCapacityWithInt:(jint)newCapacity {
  ...
  if (size__ == 0) {
    ...
    OrgApacheCommonsCollections15MapAbstractHashedMap_setAndConsume_data_(self, [IOSObjectArray newArrayWithLength:newCapacity type:OrgApacheCommonsCollections15MapAbstractHashedMap_HashEntry_class_()]);
  }
  else {
    IOSObjectArray *oldEntries = data_;
    IOSObjectArray *newEntries = [IOSObjectArray arrayWithLength:newCapacity type:OrgApacheCommonsCollections15MapAbstractHashedMap_HashEntry_class_()];
    modCount_++;
    for (jint i = oldCapacity - 1; i >= 0; i--) {
      ...
      if (entry_ != nil) {
        IOSObjectArray_Set(oldEntries, i, nil);
        do {
          ...
          OrgApacheCommonsCollections15MapAbstractHashedMap_HashEntry_set_next_(entry_, IOSObjectArray_Get(newEntries, index));
          IOSObjectArray_Set(newEntries, index, entry_);
          entry_ = next;
        }
        while (entry_ != nil);
      }
    ...
    threshold_ = [self calculateThresholdWithInt:newCapacity withFloat:loadFactor_];
    OrgApacheCommonsCollections15MapAbstractHashedMap_set_data_(self, newEntries);
  }
}
...
- (id<OrgApacheCommonsCollections15MapIterator>)mapIterator {
  ...
  return [new_OrgApacheCommonsCollections15MapAbstractHashedMap_HashMapIterator_initWithOrgApacheCommonsCollections15MapAbstractHashedMap_(self) autorelease];
}

- (id<JavaUtilSet>)entrySet {
  if (entrySet__ == nil) {
    OrgApacheCommonsCollections15MapAbstractHashedMap_setAndConsume_entrySet__(self, new_OrgApacheCommonsCollections15MapAbstractHashedMap_EntrySet_initWithOrgApacheCommonsCollections15MapAbstractHashedMap_(self));
  }
  return entrySet__;
}
...
- (id<JavaUtilIterator>)createEntrySetIterator {
  ...
  return [new_OrgApacheCommonsCollections15MapAbstractHashedMap_EntrySetIterator_initWithOrgApacheCommonsCollections15MapAbstractHashedMap_(self) autorelease];
}

- (id<JavaUtilSet>)keySet {
  if (keySet_AbstractHashedMap_ == nil) {
    OrgApacheCommonsCollections15MapAbstractHashedMap_setAndConsume_keySet_AbstractHashedMap_(self, new_OrgApacheCommonsCollections15MapAbstractHashedMap_KeySet_initWithOrgApacheCommonsCollections15MapAbstractHashedMap_(self));
  }
...
- (id<JavaUtilIterator>)createKeySetIterator {
  ...
  return [new_OrgApacheCommonsCollections15MapAbstractHashedMap_KeySetIterator_initWithOrgApacheCommonsCollections15MapAbstractHashedMap_(self) autorelease];
}

- (id<JavaUtilCollection>)values {
  if (values__ == nil) {
    OrgApacheCommonsCollections15MapAbstractHashedMap_setAndConsume_values__(self, new_OrgApacheCommonsCollections15MapAbstractHashedMap_Values_initWithOrgApacheCommonsCollections15MapAbstractHashedMap_(self));
  }
  return values__;
}
...
- (id<JavaUtilIterator>)createValuesIterator {
  ...
  return [new_OrgApacheCommonsCollections15MapAbstractHashedMap_ValuesIterator_initWithOrgApacheCommonsCollections15MapAbstractHashedMap_(self) autorelease];
}
...
- (id)clone {
  @try {
    ...
    OrgApacheCommonsCollections15MapAbstractHashedMap_setAndConsume_data_(nil_chk(cloned), [IOSObjectArray newArrayWithLength:((IOSObjectArray *) nil_chk(data_))->size_ type:OrgApacheCommonsCollections15MapAbstractHashedMap_HashEntry_class_()]);
    OrgApacheCommonsCollections15MapAbstractHashedMap_set_entrySet__(cloned, nil);
    OrgApacheCommonsCollections15MapAbstractHashedMap_set_keySet_AbstractHashedMap_(cloned, nil);
    OrgApacheCommonsCollections15MapAbstractHashedMap_set_values__(cloned, nil);
    cloned->modCount_ = 0;
    cloned->size__ = 0;
    [cloned init__];
...
- (NSString *)description {
  ...
  JavaLangStringBuffer *buf = [new_JavaLangStringBuffer_initWithInt_(32 * [self size]) autorelease];
  [buf appendWithChar:'{'];
  id<OrgApacheCommonsCollections15MapIterator> it = [self mapIterator];
  ...
  while (hasNext) {
    ...
    hasNext = [it hasNext];
    if (hasNext) {
      [((JavaLangStringBuffer *) nil_chk([buf appendWithChar:','])) appendWithChar:' '];
    }
  }
  [buf appendWithChar:'}'];
...
- (void)dealloc {
  RELEASE_(data_);
  RELEASE_(entrySet__);
  RELEASE_(keySet_AbstractHashedMap_);
  RELEASE_(values__);
  [super dealloc];
}
...
+ (void)initialize {
  if (self == [OrgApacheCommonsCollections15MapAbstractHashedMap class]) {
    JreStrongAssignAndConsume(&OrgApacheCommonsCollections15MapAbstractHashedMap_NULL__, nil, new_NSObject_init());
...
void OrgApacheCommonsCollections15MapAbstractHashedMap_initWithInt_withFloat_withInt_(OrgApacheCommonsCollections15MapAbstractHashedMap *self, jint initialCapacity, jfloat loadFactor, jint threshold) {
  ...
  OrgApacheCommonsCollections15MapAbstractHashedMap_setAndConsume_data_(self, [IOSObjectArray newArrayWithLength:initialCapacity type:OrgApacheCommonsCollections15MapAbstractHashedMap_HashEntry_class_()]);
...
void OrgApacheCommonsCollections15MapAbstractHashedMap_initWithInt_(OrgApacheCommonsCollections15MapAbstractHashedMap *self, jint initialCapacity) {
  OrgApacheCommonsCollections15MapAbstractHashedMap_initWithInt_withFloat_(self, initialCapacity, OrgApacheCommonsCollections15MapAbstractHashedMap_DEFAULT_LOAD_FACTOR);
}
...
void OrgApacheCommonsCollections15MapAbstractHashedMap_initWithInt_withFloat_(OrgApacheCommonsCollections15MapAbstractHashedMap *self, jint initialCapacity, jfloat loadFactor) {
  ...
  if (initialCapacity < 1) {
    @throw [new_JavaLangIllegalArgumentException_initWithNSString_(@"Initial capacity must be greater than 0") autorelease];
  }
  if (loadFactor <= 0.0f || JavaLangFloat_isNaNWithFloat_(loadFactor)) {
    @throw [new_JavaLangIllegalArgumentException_initWithNSString_(@"Load factor must be greater than 0") autorelease];
  }
  self->loadFactor_ = loadFactor;
...
void OrgApacheCommonsCollections15MapAbstractHashedMap_initWithJavaUtilMap_(OrgApacheCommonsCollections15MapAbstractHashedMap *self, id<JavaUtilMap> map) {
  OrgApacheCommonsCollections15MapAbstractHashedMap_initWithInt_withFloat_(self, JavaLangMath_maxWithInt_withInt_(2 * [((id<JavaUtilMap>) nil_chk(map)) size], OrgApacheCommonsCollections15MapAbstractHashedMap_DEFAULT_CAPACITY), OrgApacheCommonsCollections15MapAbstractHashedMap_DEFAULT_LOAD_FACTOR);
...
- (OrgApacheCommonsCollections15MapAbstractHashedMap_HashEntry *)nextEntry {
  ...
  OrgApacheCommonsCollections15MapAbstractHashedMap_HashIterator_set_next_(self, n);
  hashIndex_ = i;
  OrgApacheCommonsCollections15MapAbstractHashedMap_HashIterator_set_last_(self, newCurrent);
  return newCurrent;
}
...
- (void)remove {
  ...
  [parent_ removeWithId:[((OrgApacheCommonsCollections15MapAbstractHashedMap_HashEntry *) nil_chk(last_)) getKey]];
  OrgApacheCommonsCollections15MapAbstractHashedMap_HashIterator_set_last_(self, nil);
...
void OrgApacheCommonsCollections15MapAbstractHashedMap_HashIterator_initWithOrgApacheCommonsCollections15MapAbstractHashedMap_(OrgApacheCommonsCollections15MapAbstractHashedMap_HashIterator *self, OrgApacheCommonsCollections15MapAbstractHashedMap *parent) {
  NSObject_init(self);
  OrgApacheCommonsCollections15MapAbstractHashedMap_HashIterator_set_parent_(self, parent);
  ...
  OrgApacheCommonsCollections15MapAbstractHashedMap_HashIterator_set_next_(self, next);
  self->hashIndex_ = i;
...
- (jboolean)removeWithId:(id)obj {
  ...
  [((OrgApacheCommonsCollections15MapAbstractHashedMap *) nil_chk(parent_)) removeWithId:key];
  return YES;
}
...
void OrgApacheCommonsCollections15MapAbstractHashedMap_EntrySet_initWithOrgApacheCommonsCollections15MapAbstractHashedMap_(OrgApacheCommonsCollections15MapAbstractHashedMap_EntrySet *self, OrgApacheCommonsCollections15MapAbstractHashedMap *parent) {
  ...
  OrgApacheCommonsCollections15MapAbstractHashedMap_EntrySet_set_parent_(self, parent);
}
...
void OrgApacheCommonsCollections15MapAbstractHashedMap_KeySet_initWithOrgApacheCommonsCollections15MapAbstractHashedMap_(OrgApacheCommonsCollections15MapAbstractHashedMap_KeySet *self, OrgApacheCommonsCollections15MapAbstractHashedMap *parent) {
  JavaUtilAbstractSet_init(self);
  OrgApacheCommonsCollections15MapAbstractHashedMap_KeySet_set_parent_(self, parent);
}
...
void OrgApacheCommonsCollections15MapAbstractHashedMap_Values_initWithOrgApacheCommonsCollections15MapAbstractHashedMap_(OrgApacheCommonsCollections15MapAbstractHashedMap_Values *self, OrgApacheCommonsCollections15MapAbstractHashedMap *parent) {
  ...
  OrgApacheCommonsCollections15MapAbstractHashedMap_Values_set_parent_(self, parent);
}
...
- (void)setKeyWithId:(id)key {
  OrgApacheCommonsCollections15MapAbstractHashedMap_HashEntry_set_key_(self, key);
}
...
- (id)setValueWithId:(id)value {
  id old = self->value_;
  OrgApacheCommonsCollections15MapAbstractHashedMap_HashEntry_set_value_(self, value);
  return old;
}
...
void OrgApacheCommonsCollections15MapAbstractHashedMap_HashEntry_initWithOrgApacheCommonsCollections15MapAbstractHashedMap_HashEntry_withInt_withId_withId_(OrgApacheCommonsCollections15MapAbstractHashedMap_HashEntry *self, OrgApacheCommonsCollections15MapAbstractHashedMap_HashEntry *next, jint hashCode, id key, id value) {
  NSObject_init(self);
  OrgApacheCommonsCollections15MapAbstractHashedMap_HashEntry_set_next_(self, next);
