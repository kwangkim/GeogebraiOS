...
//  source: /Users/jacky/GSoC/geogebra_iOS/geogebra/geogebra/common/src/org/apache/commons/math/util/FastMath.java
//
...
+ (void)initialize {
  if (self == [OrgApacheCommonsMathUtilFastMath class]) {
    JreStrongAssignAndConsume(&OrgApacheCommonsMathUtilFastMath_EXP_INT_TABLE_A_, nil, [IOSDoubleArray newArrayWithLength:1500]);
    JreStrongAssignAndConsume(&OrgApacheCommonsMathUtilFastMath_EXP_INT_TABLE_B_, nil, [IOSDoubleArray newArrayWithLength:1500]);
    JreStrongAssignAndConsume(&OrgApacheCommonsMathUtilFastMath_EXP_FRAC_TABLE_A_, nil, [IOSDoubleArray newArrayWithLength:1025]);
    JreStrongAssignAndConsume(&OrgApacheCommonsMathUtilFastMath_EXP_FRAC_TABLE_B_, nil, [IOSDoubleArray newArrayWithLength:1025]);
    JreStrongAssignAndConsume(&OrgApacheCommonsMathUtilFastMath_FACT_, nil, [IOSDoubleArray newArrayWithLength:20]);
    JreStrongAssignAndConsume(&OrgApacheCommonsMathUtilFastMath_LN_MANT_, nil, [IOSObjectArray newArrayWithLength:1024 type:IOSClass_doubleArray(1)]);
    JreStrongAssignAndConsume(&OrgApacheCommonsMathUtilFastMath_LN_SPLIT_COEF_, nil, [IOSObjectArray newArrayWithObjects:(id[]){ [IOSDoubleArray arrayWithDoubles:(jdouble[]){ 2.0, 0.0 } count:2], [IOSDoubleArray arrayWithDoubles:(jdouble[]){ 0.6666666269302368, 3.9736429850260626E-8 } count:2], [IOSDoubleArray arrayWithDoubles:(jdouble[]){ 0.3999999761581421, 2.3841857910019882E-8 } count:2], [IOSDoubleArray arrayWithDoubles:(jdouble[]){ 0.2857142686843872, 1.7029898543501842E-8 } count:2], [IOSDoubleArray arrayWithDoubles:(jdouble[]){ 0.2222222089767456, 1.3245471311735498E-8 } count:2], [IOSDoubleArray arrayWithDoubles:(jdouble[]){ 0.1818181574344635, 2.4384203044354907E-8 } count:2], [IOSDoubleArray arrayWithDoubles:(jdouble[]){ 0.1538461446762085, 9.140260083262505E-9 } count:2], [IOSDoubleArray arrayWithDoubles:(jdouble[]){ 0.13333332538604736, 9.220590270857665E-9 } count:2], [IOSDoubleArray arrayWithDoubles:(jdouble[]){ 0.11764700710773468, 1.2393345855018391E-8 } count:2], [IOSDoubleArray arrayWithDoubles:(jdouble[]){ 0.10526403784751892, 8.251545029714408E-9 } count:2], [IOSDoubleArray arrayWithDoubles:(jdouble[]){ 0.0952233225107193, 1.2675934823758863E-8 } count:2], [IOSDoubleArray arrayWithDoubles:(jdouble[]){ 0.08713622391223907, 1.1430250008909141E-8 } count:2], [IOSDoubleArray arrayWithDoubles:(jdouble[]){ 0.07842259109020233, 2.404307984052299E-9 } count:2], [IOSDoubleArray arrayWithDoubles:(jdouble[]){ 0.08371849358081818, 1.176342548272881E-8 } count:2], [IOSDoubleArray arrayWithDoubles:(jdouble[]){ 0.030589580535888672, 1.2958646899018938E-9 } count:2], [IOSDoubleArray arrayWithDoubles:(jdouble[]){ 0.14982303977012634, 1.225743062930824E-8 } count:2] } count:16 type:IOSClass_doubleArray(1)]);
    JreStrongAssignAndConsume(&OrgApacheCommonsMathUtilFastMath_LN_QUICK_COEF_, nil, [IOSObjectArray newArrayWithObjects:(id[]){ [IOSDoubleArray arrayWithDoubles:(jdouble[]){ 1.0, 5.669184079525E-24 } count:2], [IOSDoubleArray arrayWithDoubles:(jdouble[]){ -0.25, -0.25 } count:2], [IOSDoubleArray arrayWithDoubles:(jdouble[]){ 0.3333333134651184, 1.986821492305628E-8 } count:2], [IOSDoubleArray arrayWithDoubles:(jdouble[]){ -0.25, -6.663542893624021E-14 } count:2], [IOSDoubleArray arrayWithDoubles:(jdouble[]){ 0.19999998807907104, 1.1921056801463227E-8 } count:2], [IOSDoubleArray arrayWithDoubles:(jdouble[]){ -0.1666666567325592, -7.800414592973399E-9 } count:2], [IOSDoubleArray arrayWithDoubles:(jdouble[]){ 0.1428571343421936, 5.650007086920087E-9 } count:2], [IOSDoubleArray arrayWithDoubles:(jdouble[]){ -0.12502530217170715, -7.44321345601866E-11 } count:2], [IOSDoubleArray arrayWithDoubles:(jdouble[]){ 0.11113807559013367, 9.219544613762692E-9 } count:2] } count:9 type:IOSClass_doubleArray(1)]);
    JreStrongAssignAndConsume(&OrgApacheCommonsMathUtilFastMath_LN_HI_PREC_COEF_, nil, [IOSObjectArray newArrayWithObjects:(id[]){ [IOSDoubleArray arrayWithDoubles:(jdouble[]){ 1.0, -6.032174644509064E-23 } count:2], [IOSDoubleArray arrayWithDoubles:(jdouble[]){ -0.25, -0.25 } count:2], [IOSDoubleArray arrayWithDoubles:(jdouble[]){ 0.3333333134651184, 1.9868161777724352E-8 } count:2], [IOSDoubleArray arrayWithDoubles:(jdouble[]){ -0.2499999701976776, -2.957007209750105E-8 } count:2], [IOSDoubleArray arrayWithDoubles:(jdouble[]){ 0.19999954104423523, 1.5830993332061267E-10 } count:2], [IOSDoubleArray arrayWithDoubles:(jdouble[]){ -0.16624879837036133, -2.6033824355191673E-8 } count:2] } count:6 type:IOSClass_doubleArray(1)]);
    JreStrongAssignAndConsume(&OrgApacheCommonsMathUtilFastMath_SINE_TABLE_A_, nil, [IOSDoubleArray newArrayWithLength:14]);
    JreStrongAssignAndConsume(&OrgApacheCommonsMathUtilFastMath_SINE_TABLE_B_, nil, [IOSDoubleArray newArrayWithLength:14]);
    JreStrongAssignAndConsume(&OrgApacheCommonsMathUtilFastMath_COSINE_TABLE_A_, nil, [IOSDoubleArray newArrayWithLength:14]);
    JreStrongAssignAndConsume(&OrgApacheCommonsMathUtilFastMath_COSINE_TABLE_B_, nil, [IOSDoubleArray newArrayWithLength:14]);
    JreStrongAssignAndConsume(&OrgApacheCommonsMathUtilFastMath_TANGENT_TABLE_A_, nil, [IOSDoubleArray newArrayWithLength:14]);
    JreStrongAssignAndConsume(&OrgApacheCommonsMathUtilFastMath_TANGENT_TABLE_B_, nil, [IOSDoubleArray newArrayWithLength:14]);
    JreStrongAssignAndConsume(&OrgApacheCommonsMathUtilFastMath_RECIP_2PI_, nil, [IOSLongArray newArrayWithLongs:(jlong[]){ (LShift64((jlong) 0x28be60dbLL, 32)) | (jlong) 0x9391054aLL, (LShift64((jlong) 0x7f09d5f4LL, 32)) | (jlong) 0x7d4d3770LL, (LShift64((jlong) 0x36d8a566LL, 32)) | (jlong) 0x4f10e410LL, (LShift64((jlong) 0x7f9458eaLL, 32)) | (jlong) 0xf7aef158LL, (LShift64((jlong) 0x6dc91b8eLL, 32)) | (jlong) 0x909374b8LL, (LShift64((jlong) 0x01924bbaLL, 32)) | (jlong) 0x82746487LL, (LShift64((jlong) 0x3f877ac7LL, 32)) | (jlong) 0x2c4a69cfLL, (LShift64((jlong) 0xba208d7dLL, 32)) | (jlong) 0x4baed121LL, (LShift64((jlong) 0x3a671c09LL, 32)) | (jlong) 0xad17df90LL, (LShift64((jlong) 0x4e64758eLL, 32)) | (jlong) 0x60d4ce7dLL, (LShift64((jlong) 0x272117e2LL, 32)) | (jlong) 0xef7e4a0eLL, (LShift64((jlong) 0xc7fe25ffLL, 32)) | (jlong) 0xf7816603LL, (LShift64((jlong) 0xfbcbc462LL, 32)) | (jlong) 0xd6829b47LL, (LShift64((jlong) 0xdb4d9fb3LL, 32)) | (jlong) 0xc9f2c26dLL, (LShift64((jlong) 0xd3d18fd9LL, 32)) | (jlong) 0xa797fa8bLL, (LShift64((jlong) 0x5d49eeb1LL, 32)) | (jlong) 0xfaf97c5eLL, (LShift64((jlong) 0xcf41ce7dLL, 32)) | (jlong) 0xe294a4baLL, LShift64((jlong) 0x9afed7ecLL, 32) } count:18]);
    JreStrongAssignAndConsume(&OrgApacheCommonsMathUtilFastMath_PI_O_4_BITS_, nil, [IOSLongArray newArrayWithLongs:(jlong[]){ (LShift64((jlong) 0xc90fdaa2LL, 32)) | (jlong) 0x2168c234LL, (LShift64((jlong) 0xc4c6628bLL, 32)) | (jlong) 0x80dc1cd1LL } count:2]);
    JreStrongAssignAndConsume(&OrgApacheCommonsMathUtilFastMath_EIGHTHS_, nil, [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 0, 0.125, 0.25, 0.375, 0.5, 0.625, 0.75, 0.875, 1.0, 1.125, 1.25, 1.375, 1.5, 1.625 } count:14]);
    JreStrongAssignAndConsume(&OrgApacheCommonsMathUtilFastMath_CBRTTWO_, nil, [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 0.6299605249474366, 0.7937005259840998, 1.0, 1.2599210498948732, 1.5874010519681994 } count:5]);
    {
      jint i;
      *IOSDoubleArray_GetRef(OrgApacheCommonsMathUtilFastMath_FACT_, 0) = 1.0;
      ...
      IOSDoubleArray *recip = [IOSDoubleArray arrayWithLength:2];
      for (i = 0; i < 750; i++) {
      ...
      for (i = 0; i < OrgApacheCommonsMathUtilFastMath_LN_MANT_->size_; i++) {
        ...
        IOSObjectArray_Set(OrgApacheCommonsMathUtilFastMath_LN_MANT_, i, OrgApacheCommonsMathUtilFastMath_slowLogWithDouble_(d));
      }
      OrgApacheCommonsMathUtilFastMath_buildSinCosTables();
    }
...
jdouble OrgApacheCommonsMathUtilFastMath_coshWithDouble_(jdouble x) {
  ...
  IOSDoubleArray *hiPrec = [IOSDoubleArray arrayWithLength:2];
  if (x < 0.0) {
    x = -x;
  }
...
jdouble OrgApacheCommonsMathUtilFastMath_slowexpWithDouble_withDoubleArray_(jdouble x, IOSDoubleArray *result) {
  OrgApacheCommonsMathUtilFastMath_initialize();
  IOSDoubleArray *xs = [IOSDoubleArray arrayWithLength:2];
  IOSDoubleArray *ys = [IOSDoubleArray arrayWithLength:2];
  IOSDoubleArray *facts = [IOSDoubleArray arrayWithLength:2];
  IOSDoubleArray *as = [IOSDoubleArray arrayWithLength:2];
...
void OrgApacheCommonsMathUtilFastMath_quadMultWithDoubleArray_withDoubleArray_withDoubleArray_(IOSDoubleArray *a, IOSDoubleArray *b, IOSDoubleArray *result) {
  ...
  IOSDoubleArray *xs = [IOSDoubleArray arrayWithLength:2];
  IOSDoubleArray *ys = [IOSDoubleArray arrayWithLength:2];
  IOSDoubleArray *zs = [IOSDoubleArray arrayWithLength:2];
...
jdouble OrgApacheCommonsMathUtilFastMath_powWithDouble_withDouble_(jdouble x, jdouble y) {
  OrgApacheCommonsMathUtilFastMath_initialize();
  IOSDoubleArray *lns = [IOSDoubleArray arrayWithLength:2];
  if (y == 0.0) {
    return 1.0;
  }
  if (x != x) {
...
IOSDoubleArray *OrgApacheCommonsMathUtilFastMath_slowLogWithDouble_(jdouble xi) {
  OrgApacheCommonsMathUtilFastMath_initialize();
  IOSDoubleArray *x = [IOSDoubleArray arrayWithLength:2];
  IOSDoubleArray *x2 = [IOSDoubleArray arrayWithLength:2];
  IOSDoubleArray *y = [IOSDoubleArray arrayWithLength:2];
...
void OrgApacheCommonsMathUtilFastMath_buildSinCosTables() {
  ...
  for (jint i = 7; i < 14; i++) {
    ...
    IOSDoubleArray *ys = [IOSDoubleArray arrayWithLength:2];
    IOSDoubleArray *as = [IOSDoubleArray arrayWithLength:2];
    IOSDoubleArray *bs = [IOSDoubleArray arrayWithLength:2];
    IOSDoubleArray *temps = [IOSDoubleArray arrayWithLength:2];
    if ((i & 1) == 0) {
...
jdouble OrgApacheCommonsMathUtilFastMath_sinWithDouble_(jdouble x) {
  ...
  if (xa > 3294198.0) {
    IOSDoubleArray *reduceResults = [IOSDoubleArray arrayWithLength:3];
