...
//  source: /Users/jacky/GSoC/geogebra_iOS/geogebra/geogebra/common/src/edu/uci/ics/jung/graph/UndirectedSparseGraph.java
//
...
withEduUciIcsJungGraphUtilEdgeTypeEnum:(EduUciIcsJungGraphUtilEdgeTypeEnum *)edgeType {
  ...
  [((id<JavaUtilMap>) nil_chk([vertices_ getWithId:v1])) putWithId:v2 withId:edge];
  [((id<JavaUtilMap>) nil_chk([vertices_ getWithId:v2])) putWithId:v1 withId:edge];
  return YES;
}
...
- (jboolean)addVertexWithId:(id)vertex {
  ...
  if (![self containsVertexWithId:vertex]) {
    [((id<JavaUtilMap>) nil_chk(vertices_)) putWithId:vertex withId:[new_JavaUtilHashMap_init() autorelease]];
    return YES;
  }
  else {
    return NO;
...
- (jboolean)removeVertexWithId:(id)vertex {
  ...
  for (id __strong edge in [new_JavaUtilArrayList_initWithJavaUtilCollection_([((id<JavaUtilMap>) nil_chk([((id<JavaUtilMap>) nil_chk(vertices_)) getWithId:vertex])) values]) autorelease]) [self removeEdgeWithId:edge];
  [vertices_ removeWithId:vertex];
  return YES;
}
...
- (jboolean)removeEdgeWithId:(id)edge {
  ...
  [((id<JavaUtilMap>) nil_chk([((id<JavaUtilMap>) nil_chk(vertices_)) getWithId:v1])) removeWithId:v2];
  [((id<JavaUtilMap>) nil_chk([vertices_ getWithId:v2])) removeWithId:v1];
  [((id<JavaUtilMap>) nil_chk(edges_)) removeWithId:edge];
  return YES;
}

- (EduUciIcsJungGraphUndirectedSparseGraph *)newInstance {
  return [new_EduUciIcsJungGraphUndirectedSparseGraph_init() autorelease];
}
...
id<OrgApacheCommonsCollections15Factory> EduUciIcsJungGraphUndirectedSparseGraph_getFactory() {
  ...
  return [new_EduUciIcsJungGraphUndirectedSparseGraph_$1_init() autorelease];
}

void EduUciIcsJungGraphUndirectedSparseGraph_init(EduUciIcsJungGraphUndirectedSparseGraph *self) {
  EduUciIcsJungGraphAbstractTypedGraph_initWithEduUciIcsJungGraphUtilEdgeTypeEnum_(self, EduUciIcsJungGraphUtilEdgeTypeEnum_get_UNDIRECTED());
  EduUciIcsJungGraphUndirectedSparseGraph_setAndConsume_vertices_(self, new_JavaUtilHashMap_init());
  EduUciIcsJungGraphUndirectedSparseGraph_setAndConsume_edges_(self, new_JavaUtilHashMap_init());
}
