...
- (jint)compareToWithId:(OrgApacheCommonsMathFractionFraction *)object {
  check_class_cast(object, [OrgApacheCommonsMathFractionFraction class]);
...
- (OrgApacheCommonsMathFractionFraction *)negate {
  if (numerator_ == JavaLangInteger_MIN_VALUE) {
    @throw OrgApacheCommonsMathMathRuntimeException_createArithmeticExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_OVERFLOW_IN_FRACTION(), [IOSObjectArray arrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(numerator_), JavaLangInteger_valueOfWithInt_(denominator_) } count:2 type:NSObject_class_()]);
  }
  return [new_OrgApacheCommonsMathFractionFraction_initWithInt_withInt_(-numerator_, denominator_) autorelease];
}

- (OrgApacheCommonsMathFractionFraction *)reciprocal {
  return [new_OrgApacheCommonsMathFractionFraction_initWithInt_withInt_(denominator_, numerator_) autorelease];
}
...
- (OrgApacheCommonsMathFractionFraction *)addWithInt:(jint)i {
  return [new_OrgApacheCommonsMathFractionFraction_initWithInt_withInt_(numerator_ + i * denominator_, denominator_) autorelease];
}
...
- (OrgApacheCommonsMathFractionFraction *)multiplyWithId:(OrgApacheCommonsMathFractionFraction *)fraction {
  if (fraction == nil) {
    @throw [new_OrgApacheCommonsMathExceptionNullArgumentException_initWithOrgApacheCommonsMathExceptionUtilLocalizable_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_FRACTION()) autorelease];
  }
...
- (OrgApacheCommonsMathFractionFraction *)multiplyWithInt:(jint)i {
  return [new_OrgApacheCommonsMathFractionFraction_initWithInt_withInt_(numerator_ * i, denominator_) autorelease];
}
...
- (OrgApacheCommonsMathFractionFraction *)divideWithInt:(jint)i {
  return [new_OrgApacheCommonsMathFractionFraction_initWithInt_withInt_(numerator_, denominator_ * i) autorelease];
}
...
+ (void)initialize {
  if (self == [OrgApacheCommonsMathFractionFraction class]) {
    JreStrongAssignAndConsume(&OrgApacheCommonsMathFractionFraction_TWO_, nil, new_OrgApacheCommonsMathFractionFraction_initWithInt_withInt_(2, 1));
    JreStrongAssignAndConsume(&OrgApacheCommonsMathFractionFraction_ONE_, nil, new_OrgApacheCommonsMathFractionFraction_initWithInt_withInt_(1, 1));
    JreStrongAssignAndConsume(&OrgApacheCommonsMathFractionFraction_ZERO_, nil, new_OrgApacheCommonsMathFractionFraction_initWithInt_withInt_(0, 1));
    JreStrongAssignAndConsume(&OrgApacheCommonsMathFractionFraction_FOUR_FIFTHS_, nil, new_OrgApacheCommonsMathFractionFraction_initWithInt_withInt_(4, 5));
    JreStrongAssignAndConsume(&OrgApacheCommonsMathFractionFraction_ONE_FIFTH_, nil, new_OrgApacheCommonsMathFractionFraction_initWithInt_withInt_(1, 5));
    JreStrongAssignAndConsume(&OrgApacheCommonsMathFractionFraction_ONE_HALF_, nil, new_OrgApacheCommonsMathFractionFraction_initWithInt_withInt_(1, 2));
    JreStrongAssignAndConsume(&OrgApacheCommonsMathFractionFraction_ONE_QUARTER_, nil, new_OrgApacheCommonsMathFractionFraction_initWithInt_withInt_(1, 4));
    JreStrongAssignAndConsume(&OrgApacheCommonsMathFractionFraction_ONE_THIRD_, nil, new_OrgApacheCommonsMathFractionFraction_initWithInt_withInt_(1, 3));
    JreStrongAssignAndConsume(&OrgApacheCommonsMathFractionFraction_THREE_FIFTHS_, nil, new_OrgApacheCommonsMathFractionFraction_initWithInt_withInt_(3, 5));
    JreStrongAssignAndConsume(&OrgApacheCommonsMathFractionFraction_THREE_QUARTERS_, nil, new_OrgApacheCommonsMathFractionFraction_initWithInt_withInt_(3, 4));
    JreStrongAssignAndConsume(&OrgApacheCommonsMathFractionFraction_TWO_FIFTHS_, nil, new_OrgApacheCommonsMathFractionFraction_initWithInt_withInt_(2, 5));
    JreStrongAssignAndConsume(&OrgApacheCommonsMathFractionFraction_TWO_QUARTERS_, nil, new_OrgApacheCommonsMathFractionFraction_initWithInt_withInt_(2, 4));
    JreStrongAssignAndConsume(&OrgApacheCommonsMathFractionFraction_TWO_THIRDS_, nil, new_OrgApacheCommonsMathFractionFraction_initWithInt_withInt_(2, 3));
    JreStrongAssignAndConsume(&OrgApacheCommonsMathFractionFraction_MINUS_ONE_, nil, new_OrgApacheCommonsMathFractionFraction_initWithInt_withInt_(-1, 1));
...
void OrgApacheCommonsMathFractionFraction_initWithDouble_(OrgApacheCommonsMathFractionFraction *self, jdouble value) {
  OrgApacheCommonsMathFractionFraction_initWithDouble_withDouble_withInt_(self, value, 1.0e-5, 100);
}
...
void OrgApacheCommonsMathFractionFraction_initWithDouble_withDouble_withInt_(OrgApacheCommonsMathFractionFraction *self, jdouble value, jdouble epsilon, jint maxIterations) {
  OrgApacheCommonsMathFractionFraction_initWithDouble_withDouble_withInt_withInt_(self, value, epsilon, JavaLangInteger_MAX_VALUE, maxIterations);
}
...
void OrgApacheCommonsMathFractionFraction_initWithDouble_withInt_(OrgApacheCommonsMathFractionFraction *self, jdouble value, jint maxDenominator) {
  OrgApacheCommonsMathFractionFraction_initWithDouble_withDouble_withInt_withInt_(self, value, 0, maxDenominator, 100);
}
...
void OrgApacheCommonsMathFractionFraction_initWithInt_(OrgApacheCommonsMathFractionFraction *self, jint num) {
  OrgApacheCommonsMathFractionFraction_initWithInt_withInt_(self, num, 1);
}
...
OrgApacheCommonsMathFractionFraction *OrgApacheCommonsMathFractionFraction_addSubWithOrgApacheCommonsMathFractionFraction_withBoolean_(OrgApacheCommonsMathFractionFraction *self, OrgApacheCommonsMathFractionFraction *fraction, jboolean isAdd) {
  ...
  if ([((JavaMathBigInteger *) nil_chk(w)) bitLength] > 31) {
    @throw OrgApacheCommonsMathMathRuntimeException_createArithmeticExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_NUMERATOR_OVERFLOW_AFTER_MULTIPLY(), [IOSObjectArray arrayWithObjects:(id[]){ w } count:1 type:NSObject_class_()]);
  }
  return [new_OrgApacheCommonsMathFractionFraction_initWithInt_withInt_([w intValue], OrgApacheCommonsMathUtilMathUtils_mulAndCheckWithInt_withInt_(self->denominator_ / d1, fraction->denominator_ / d2)) autorelease];
}
...
OrgApacheCommonsMathFractionFraction *OrgApacheCommonsMathFractionFraction_getReducedFractionWithInt_withInt_(jint numerator, jint denominator) {
  ...
  numerator /= gcd;
  denominator /= gcd;
  return [new_OrgApacheCommonsMathFractionFraction_initWithInt_withInt_(numerator, denominator) autorelease];
}
