...
//  source: /Users/jacky/GSoC/geogebra_iOS/geogebra/geogebra/common/src/org/apache/commons/math/stat/correlation/Covariance.java
//
...
- (id<OrgApacheCommonsMathLinearRealMatrix>)computeCovarianceMatrixWithOrgApacheCommonsMathLinearRealMatrix:(id<OrgApacheCommonsMathLinearRealMatrix>)matrix
  ...
  OrgApacheCommonsMathStatDescriptiveMomentVariance *variance = [new_OrgApacheCommonsMathStatDescriptiveMomentVariance_initWithBoolean_(biasCorrected) autorelease];
  id<OrgApacheCommonsMathLinearRealMatrix> outMatrix = [new_OrgApacheCommonsMathLinearBlockRealMatrix_initWithInt_withInt_(dimension, dimension) autorelease];
...
- (id<OrgApacheCommonsMathLinearRealMatrix>)computeCovarianceMatrixWithDoubleArray2:(IOSObjectArray *)data
                                                                        withBoolean:(jboolean)biasCorrected {
  return [self computeCovarianceMatrixWithOrgApacheCommonsMathLinearRealMatrix:[new_OrgApacheCommonsMathLinearBlockRealMatrix_initWithDoubleArray2_(data) autorelease] withBoolean:biasCorrected];
}
...
void OrgApacheCommonsMathStatCorrelationCovariance_init(OrgApacheCommonsMathStatCorrelationCovariance *self) {
  NSObject_init(self);
  OrgApacheCommonsMathStatCorrelationCovariance_set_covarianceMatrix_(self, nil);
  self->n_ = 0;
}
...
void OrgApacheCommonsMathStatCorrelationCovariance_initWithDoubleArray2_withBoolean_(OrgApacheCommonsMathStatCorrelationCovariance *self, IOSObjectArray *data, jboolean biasCorrected) {
  OrgApacheCommonsMathStatCorrelationCovariance_initWithOrgApacheCommonsMathLinearRealMatrix_withBoolean_(self, [new_OrgApacheCommonsMathLinearBlockRealMatrix_initWithDoubleArray2_(data) autorelease], biasCorrected);
}
...
void OrgApacheCommonsMathStatCorrelationCovariance_initWithDoubleArray2_(OrgApacheCommonsMathStatCorrelationCovariance *self, IOSObjectArray *data) {
  OrgApacheCommonsMathStatCorrelationCovariance_initWithDoubleArray2_withBoolean_(self, data, YES);
}
...
void OrgApacheCommonsMathStatCorrelationCovariance_initWithOrgApacheCommonsMathLinearRealMatrix_withBoolean_(OrgApacheCommonsMathStatCorrelationCovariance *self, id<OrgApacheCommonsMathLinearRealMatrix> matrix, jboolean biasCorrected) {
  ...
  OrgApacheCommonsMathStatCorrelationCovariance_set_covarianceMatrix_(self, [self computeCovarianceMatrixWithOrgApacheCommonsMathLinearRealMatrix:matrix withBoolean:biasCorrected]);
}
...
void OrgApacheCommonsMathStatCorrelationCovariance_initWithOrgApacheCommonsMathLinearRealMatrix_(OrgApacheCommonsMathStatCorrelationCovariance *self, id<OrgApacheCommonsMathLinearRealMatrix> matrix) {
  OrgApacheCommonsMathStatCorrelationCovariance_initWithOrgApacheCommonsMathLinearRealMatrix_withBoolean_(self, matrix, YES);
}
