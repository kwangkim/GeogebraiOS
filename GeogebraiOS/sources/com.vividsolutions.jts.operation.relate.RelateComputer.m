...
- (ComVividsolutionsJtsGeomIntersectionMatrix *)computeIM {
  ComVividsolutionsJtsGeomIntersectionMatrix *im = [new_ComVividsolutionsJtsGeomIntersectionMatrix_init() autorelease];
  ...
  [((ComVividsolutionsJtsGeomgraphGeometryGraph *) nil_chk(IOSObjectArray_Get(arg_, 0))) computeSelfNodesWithComVividsolutionsJtsAlgorithmLineIntersector:li_ withBoolean:NO];
  [((ComVividsolutionsJtsGeomgraphGeometryGraph *) nil_chk(IOSObjectArray_Get(arg_, 1))) computeSelfNodesWithComVividsolutionsJtsAlgorithmLineIntersector:li_ withBoolean:NO];
...
void ComVividsolutionsJtsOperationRelateRelateComputer_initWithComVividsolutionsJtsGeomgraphGeometryGraphArray_(ComVividsolutionsJtsOperationRelateRelateComputer *self, IOSObjectArray *arg) {
  NSObject_init(self);
  ComVividsolutionsJtsOperationRelateRelateComputer_setAndConsume_li_(self, new_ComVividsolutionsJtsAlgorithmRobustLineIntersector_init());
  ComVividsolutionsJtsOperationRelateRelateComputer_setAndConsume_ptLocator_(self, new_ComVividsolutionsJtsAlgorithmPointLocator_init());
  ComVividsolutionsJtsOperationRelateRelateComputer_setAndConsume_nodes_(self, new_ComVividsolutionsJtsGeomgraphNodeMap_initWithComVividsolutionsJtsGeomgraphNodeFactory_([new_ComVividsolutionsJtsOperationRelateRelateNodeFactory_init() autorelease]));
  ComVividsolutionsJtsOperationRelateRelateComputer_set_im_(self, nil);
  ComVividsolutionsJtsOperationRelateRelateComputer_setAndConsume_isolatedEdges_(self, new_JavaUtilArrayList_init());
  ComVividsolutionsJtsOperationRelateRelateComputer_set_arg_(self, arg);
}
