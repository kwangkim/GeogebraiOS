...
- (id<JavaUtilSortedSet>)subSetWithId:(id)fromElement
  ...
  return [new_OrgApacheCommonsCollections15SetTransformedSortedSet_initWithJavaUtilSortedSet_withOrgApacheCommonsCollections15Transformer_(set, transformer_) autorelease];
}
...
id<JavaUtilSortedSet> OrgApacheCommonsCollections15SetTransformedSortedSet_decorateWithJavaUtilSortedSet_withOrgApacheCommonsCollections15Transformer_(id<JavaUtilSortedSet> set, id<OrgApacheCommonsCollections15Transformer> transformer) {
  ...
  return [new_OrgApacheCommonsCollections15SetTransformedSortedSet_initWithJavaUtilSortedSet_withOrgApacheCommonsCollections15Transformer_(set, transformer) autorelease];
}
