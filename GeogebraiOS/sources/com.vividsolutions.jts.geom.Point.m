...
- (IOSObjectArray *)getCoordinates {
  return [self isEmpty] ? [IOSObjectArray arrayWithObjects:(id[]){  } count:0 type:ComVividsolutionsJtsGeomCoordinate_class_()] : [IOSObjectArray arrayWithObjects:(id[]){ [self getCoordinate] } count:1 type:ComVividsolutionsJtsGeomCoordinate_class_()];
}
...
- (jdouble)getX {
  if ([self getCoordinate] == nil) {
    @throw [new_JavaLangIllegalStateException_initWithNSString_(@"getX called on empty Point") autorelease];
  }
...
- (jdouble)getY {
  if ([self getCoordinate] == nil) {
    @throw [new_JavaLangIllegalStateException_initWithNSString_(@"getY called on empty Point") autorelease];
  }
...
- (ComVividsolutionsJtsGeomEnvelope *)computeEnvelopeInternal {
  ...
  ComVividsolutionsJtsGeomEnvelope *env = [new_ComVividsolutionsJtsGeomEnvelope_init() autorelease];
...
- (id)clone {
  ...
  ComVividsolutionsJtsGeomPoint_set_coordinates_(nil_chk(p), (id<ComVividsolutionsJtsGeomCoordinateSequence>) check_protocol_cast([((id<ComVividsolutionsJtsGeomCoordinateSequence>) nil_chk(coordinates_)) clone], @protocol(ComVividsolutionsJtsGeomCoordinateSequence)));
  return p;
}
...
void ComVividsolutionsJtsGeomPoint_initWithComVividsolutionsJtsGeomCoordinate_withComVividsolutionsJtsGeomPrecisionModel_withInt_(ComVividsolutionsJtsGeomPoint *self, ComVividsolutionsJtsGeomCoordinate *coordinate, ComVividsolutionsJtsGeomPrecisionModel *precisionModel, jint SRID) {
  ...
  ComVividsolutionsJtsGeomPoint_init__WithComVividsolutionsJtsGeomCoordinateSequence_(self, [((id<ComVividsolutionsJtsGeomCoordinateSequenceFactory>) nil_chk([((ComVividsolutionsJtsGeomGeometryFactory *) nil_chk([self getFactory])) getCoordinateSequenceFactory])) createWithComVividsolutionsJtsGeomCoordinateArray:coordinate != nil ? [IOSObjectArray arrayWithObjects:(id[]){ coordinate } count:1 type:ComVividsolutionsJtsGeomCoordinate_class_()] : [IOSObjectArray arrayWithObjects:(id[]){  } count:0 type:ComVividsolutionsJtsGeomCoordinate_class_()]]);
}
...
void ComVividsolutionsJtsGeomPoint_init__WithComVividsolutionsJtsGeomCoordinateSequence_(ComVividsolutionsJtsGeomPoint *self, id<ComVividsolutionsJtsGeomCoordinateSequence> coordinates) {
  if (coordinates == nil) {
    coordinates = [((id<ComVividsolutionsJtsGeomCoordinateSequenceFactory>) nil_chk([((ComVividsolutionsJtsGeomGeometryFactory *) nil_chk([self getFactory])) getCoordinateSequenceFactory])) createWithComVividsolutionsJtsGeomCoordinateArray:[IOSObjectArray arrayWithObjects:(id[]){  } count:0 type:ComVividsolutionsJtsGeomCoordinate_class_()]];
  }
  ...
  ComVividsolutionsJtsGeomPoint_set_coordinates_(self, coordinates);
}
