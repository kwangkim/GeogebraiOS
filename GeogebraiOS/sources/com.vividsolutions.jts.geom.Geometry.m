...
//  source: /Users/jacky/GSoC/geogebra_iOS/geogebra/geogebra/common/src/com/vividsolutions/jts/geom/Geometry.java
//
...
- (void)setUserDataWithId:(id)userData {
  ComVividsolutionsJtsGeomGeometry_set_userData_(self, userData);
}
...
- (jboolean)isSimple {
  ...
  ComVividsolutionsJtsOperationIsSimpleOp *op = [new_ComVividsolutionsJtsOperationIsSimpleOp_initWithComVividsolutionsJtsGeomGeometry_(self) autorelease];
  return [op isSimple];
}

- (jboolean)isValid {
  ComVividsolutionsJtsOperationValidIsValidOp *isValidOp = [new_ComVividsolutionsJtsOperationValidIsValidOp_initWithComVividsolutionsJtsGeomGeometry_(self) autorelease];
...
- (ComVividsolutionsJtsGeomPoint *)getCentroid {
  ...
  if (dim == 0) {
    ComVividsolutionsJtsAlgorithmCentroidPoint *cent = [new_ComVividsolutionsJtsAlgorithmCentroidPoint_init() autorelease];
    [cent addWithComVividsolutionsJtsGeomGeometry:self];
    centPt = [cent getCentroid];
  }
  else if (dim == 1) {
    ComVividsolutionsJtsAlgorithmCentroidLine *cent = [new_ComVividsolutionsJtsAlgorithmCentroidLine_init() autorelease];
    [cent addWithComVividsolutionsJtsGeomGeometry:self];
    centPt = [cent getCentroid];
  }
  else {
    ComVividsolutionsJtsAlgorithmCentroidArea *cent = [new_ComVividsolutionsJtsAlgorithmCentroidArea_init() autorelease];
    [cent addWithComVividsolutionsJtsGeomGeometry:self];
    centPt = [cent getCentroid];
  }
...
- (ComVividsolutionsJtsGeomPoint *)getInteriorPoint {
  ...
  jint dim = [self getDimension];
  if (dim == 0) {
    ComVividsolutionsJtsAlgorithmInteriorPointPoint *intPt = [new_ComVividsolutionsJtsAlgorithmInteriorPointPoint_initWithComVividsolutionsJtsGeomGeometry_(self) autorelease];
    interiorPt = [intPt getInteriorPoint];
  }
  else if (dim == 1) {
    ComVividsolutionsJtsAlgorithmInteriorPointLine *intPt = [new_ComVividsolutionsJtsAlgorithmInteriorPointLine_initWithComVividsolutionsJtsGeomGeometry_(self) autorelease];
    interiorPt = [intPt getInteriorPoint];
  }
  else {
    ComVividsolutionsJtsAlgorithmInteriorPointArea *intPt = [new_ComVividsolutionsJtsAlgorithmInteriorPointArea_initWithComVividsolutionsJtsGeomGeometry_(self) autorelease];
    interiorPt = [intPt getInteriorPoint];
  }
...
- (ComVividsolutionsJtsGeomEnvelope *)getEnvelopeInternal {
  if (envelope_ == nil) {
    ComVividsolutionsJtsGeomGeometry_set_envelope_(self, [self computeEnvelopeInternal]);
  }
  return envelope_;
}
...
- (void)geometryChangedAction {
  ComVividsolutionsJtsGeomGeometry_set_envelope_(self, nil);
}
...
- (ComVividsolutionsJtsGeomGeometry *)convexHull {
  return [([new_ComVividsolutionsJtsAlgorithmConvexHull_initWithComVividsolutionsJtsGeomGeometry_(self) autorelease]) getConvexHull];
}
...
- (void)checkNotGeometryCollectionWithComVividsolutionsJtsGeomGeometry:(ComVividsolutionsJtsGeomGeometry *)g {
  if ([((NSString *) nil_chk([[((ComVividsolutionsJtsGeomGeometry *) nil_chk(g)) getClass] getName])) isEqual:@"com.vividsolutions.jts.geom.GeometryCollection"]) {
    @throw [new_JavaLangIllegalArgumentException_initWithNSString_(@"This method does not support GeometryCollection arguments") autorelease];
  }
}
...
+ (void)initialize {
  if (self == [ComVividsolutionsJtsGeomGeometry class]) {
    JreStrongAssignAndConsume(&ComVividsolutionsJtsGeomGeometry_geometryChangedFilter_, nil, new_ComVividsolutionsJtsGeomGeometry_$1_init());
...
void ComVividsolutionsJtsGeomGeometry_initWithComVividsolutionsJtsGeomGeometryFactory_(ComVividsolutionsJtsGeomGeometry *self, ComVividsolutionsJtsGeomGeometryFactory *factory) {
  NSObject_init(self);
  ComVividsolutionsJtsGeomGeometry_set_userData_(self, nil);
  ComVividsolutionsJtsGeomGeometry_set_factory_(self, factory);
