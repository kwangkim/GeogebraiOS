...
#ifndef _GeogebraCommonKernelAdvancedAlgoAffineRatio_H_
#define _GeogebraCommonKernelAdvancedAlgoAffineRatio_H_
...
@interface GeogebraCommonKernelAdvancedAlgoAffineRatio : GeogebraCommonKernelAlgosAlgoElement
...
J2OBJC_EMPTY_STATIC_INIT(GeogebraCommonKernelAdvancedAlgoAffineRatio)
...
FOUNDATION_EXPORT GeogebraCommonKernelAdvancedAlgoAffineRatio *new_GeogebraCommonKernelAdvancedAlgoAffineRatio_initWithGeogebraCommonKernelConstruction_withNSString_withGeogebraCommonKernelGeosGeoPoint_withGeogebraCommonKernelGeosGeoPoint_withGeogebraCommonKernelGeosGeoPoint_(GeogebraCommonKernelConstruction *cons, NSString *label, GeogebraCommonKernelGeosGeoPoint *A, GeogebraCommonKernelGeosGeoPoint *B, GeogebraCommonKernelGeosGeoPoint *C) NS_RETURNS_RETAINED;

J2OBJC_TYPE_LITERAL_HEADER(GeogebraCommonKernelAdvancedAlgoAffineRatio)

#endif // _GeogebraCommonKernelAdvancedAlgoAffineRatio_H_
