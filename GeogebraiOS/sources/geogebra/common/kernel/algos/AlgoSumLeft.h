...
#ifndef _GeogebraCommonKernelAlgosAlgoSumLeft_H_
#define _GeogebraCommonKernelAlgosAlgoSumLeft_H_
...
@interface GeogebraCommonKernelAlgosAlgoSumLeft : GeogebraCommonKernelAlgosAlgoFunctionAreaSums
...
- (GeogebraCommonKernelAlgosAlgoSumLeft *)copy__ OBJC_METHOD_FAMILY_NONE;

- (GeogebraCommonKernelCommandsCommandsEnum *)getClassName;

@end

J2OBJC_EMPTY_STATIC_INIT(GeogebraCommonKernelAlgosAlgoSumLeft)
...
FOUNDATION_EXPORT GeogebraCommonKernelAlgosAlgoSumLeft *new_GeogebraCommonKernelAlgosAlgoSumLeft_initWithGeogebraCommonKernelConstruction_withNSString_withGeogebraCommonKernelGeosGeoFunction_withGeogebraCommonKernelArithmeticNumberValue_withGeogebraCommonKernelArithmeticNumberValue_withGeogebraCommonKernelArithmeticNumberValue_(GeogebraCommonKernelConstruction *cons, NSString *label, GeogebraCommonKernelGeosGeoFunction *f, id<GeogebraCommonKernelArithmeticNumberValue> a, id<GeogebraCommonKernelArithmeticNumberValue> b, id<GeogebraCommonKernelArithmeticNumberValue> n) NS_RETURNS_RETAINED;

J2OBJC_TYPE_LITERAL_HEADER(GeogebraCommonKernelAlgosAlgoSumLeft)

#endif // _GeogebraCommonKernelAlgosAlgoSumLeft_H_
