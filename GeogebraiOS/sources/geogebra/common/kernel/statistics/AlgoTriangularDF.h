...
#ifndef _GeogebraCommonKernelStatisticsAlgoTriangularDF_H_
#define _GeogebraCommonKernelStatisticsAlgoTriangularDF_H_
...
@interface GeogebraCommonKernelStatisticsAlgoTriangularDF : GeogebraCommonKernelAlgosAlgoElement
...
J2OBJC_EMPTY_STATIC_INIT(GeogebraCommonKernelStatisticsAlgoTriangularDF)
...
FOUNDATION_EXPORT GeogebraCommonKernelStatisticsAlgoTriangularDF *new_GeogebraCommonKernelStatisticsAlgoTriangularDF_initWithGeogebraCommonKernelConstruction_withNSString_withGeogebraCommonKernelArithmeticNumberValue_withGeogebraCommonKernelArithmeticNumberValue_withGeogebraCommonKernelArithmeticNumberValue_withGeogebraCommonKernelArithmeticBooleanValue_(GeogebraCommonKernelConstruction *cons, NSString *label, id<GeogebraCommonKernelArithmeticNumberValue> a, id<GeogebraCommonKernelArithmeticNumberValue> b, id<GeogebraCommonKernelArithmeticNumberValue> mode, id<GeogebraCommonKernelArithmeticBooleanValue> cumulative) NS_RETURNS_RETAINED;
...
FOUNDATION_EXPORT GeogebraCommonKernelStatisticsAlgoTriangularDF *new_GeogebraCommonKernelStatisticsAlgoTriangularDF_initWithGeogebraCommonKernelConstruction_withGeogebraCommonKernelArithmeticNumberValue_withGeogebraCommonKernelArithmeticNumberValue_withGeogebraCommonKernelArithmeticNumberValue_withGeogebraCommonKernelArithmeticBooleanValue_(GeogebraCommonKernelConstruction *cons, id<GeogebraCommonKernelArithmeticNumberValue> a, id<GeogebraCommonKernelArithmeticNumberValue> b, id<GeogebraCommonKernelArithmeticNumberValue> mode, id<GeogebraCommonKernelArithmeticBooleanValue> cumulative) NS_RETURNS_RETAINED;

J2OBJC_TYPE_LITERAL_HEADER(GeogebraCommonKernelStatisticsAlgoTriangularDF)

#endif // _GeogebraCommonKernelStatisticsAlgoTriangularDF_H_
