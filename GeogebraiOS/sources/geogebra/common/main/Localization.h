...
#ifndef _GeogebraCommonMainLocalization_H_
#define _GeogebraCommonMainLocalization_H_
...
@interface GeogebraCommonMainLocalization : NSObject {
 @public
...
J2OBJC_EMPTY_STATIC_INIT(GeogebraCommonMainLocalization)

J2OBJC_FIELD_SETTER(GeogebraCommonMainLocalization, sbPlain_, JavaLangStringBuilder *)

FOUNDATION_EXPORT NSString *GeogebraCommonMainLocalization_syntaxCAS_;
J2OBJC_STATIC_FIELD_GETTER(GeogebraCommonMainLocalization, syntaxCAS_, NSString *)

FOUNDATION_EXPORT NSString *GeogebraCommonMainLocalization_syntax3D_;
J2OBJC_STATIC_FIELD_GETTER(GeogebraCommonMainLocalization, syntax3D_, NSString *)

FOUNDATION_EXPORT NSString *GeogebraCommonMainLocalization_syntaxStr_;
J2OBJC_STATIC_FIELD_GETTER(GeogebraCommonMainLocalization, syntaxStr_, NSString *)

FOUNDATION_EXPORT void GeogebraCommonMainLocalization_initWithInt_withInt_(GeogebraCommonMainLocalization *self, jint dimension, jint maxFigures);

FOUNDATION_EXPORT jboolean GeogebraCommonMainLocalization_rightToLeftReadingOrderWithNSString_(NSString *language);

J2OBJC_TYPE_LITERAL_HEADER(GeogebraCommonMainLocalization)

#endif // _GeogebraCommonMainLocalization_H_
