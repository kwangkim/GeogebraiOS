...
#ifndef _GeogebraCommonGeogebra3DKernel3DCommandsCmdMidpoint3D_H_
#define _GeogebraCommonGeogebra3DKernel3DCommandsCmdMidpoint3D_H_
...
@interface GeogebraCommonGeogebra3DKernel3DCommandsCmdMidpoint3D : GeogebraCommonKernelCommandsCmdMidpoint
...
J2OBJC_EMPTY_STATIC_INIT(GeogebraCommonGeogebra3DKernel3DCommandsCmdMidpoint3D)

FOUNDATION_EXPORT void GeogebraCommonGeogebra3DKernel3DCommandsCmdMidpoint3D_initWithGeogebraCommonKernelKernel_(GeogebraCommonGeogebra3DKernel3DCommandsCmdMidpoint3D *self, GeogebraCommonKernelKernel *kernel);

FOUNDATION_EXPORT GeogebraCommonGeogebra3DKernel3DCommandsCmdMidpoint3D *new_GeogebraCommonGeogebra3DKernel3DCommandsCmdMidpoint3D_initWithGeogebraCommonKernelKernel_(GeogebraCommonKernelKernel *kernel) NS_RETURNS_RETAINED;

J2OBJC_TYPE_LITERAL_HEADER(GeogebraCommonGeogebra3DKernel3DCommandsCmdMidpoint3D)

#endif // _GeogebraCommonGeogebra3DKernel3DCommandsCmdMidpoint3D_H_
