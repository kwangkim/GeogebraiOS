...
#ifndef _GeogebraCommonGeogebra3DKernel3DAlgosAlgoArchimedeanSolid_H_
#define _GeogebraCommonGeogebra3DKernel3DAlgosAlgoArchimedeanSolid_H_
...
@interface GeogebraCommonGeogebra3DKernel3DAlgosAlgoArchimedeanSolid : GeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedron {
 @public
...
J2OBJC_EMPTY_STATIC_INIT(GeogebraCommonGeogebra3DKernel3DAlgosAlgoArchimedeanSolid)

J2OBJC_FIELD_SETTER(GeogebraCommonGeogebra3DKernel3DAlgosAlgoArchimedeanSolid, outputPolygons_, GeogebraCommonKernelAlgosAlgoElement_OutputHandler *)
J2OBJC_FIELD_SETTER(GeogebraCommonGeogebra3DKernel3DAlgosAlgoArchimedeanSolid, outputSegments_, GeogebraCommonKernelAlgosAlgoElement_OutputHandler *)
J2OBJC_FIELD_SETTER(GeogebraCommonGeogebra3DKernel3DAlgosAlgoArchimedeanSolid, matrix_, GeogebraCommonKernelMatrixCoordMatrix4x4 *)
...
FOUNDATION_EXPORT GeogebraCommonGeogebra3DKernel3DAlgosAlgoArchimedeanSolid *new_GeogebraCommonGeogebra3DKernel3DAlgosAlgoArchimedeanSolid_initWithGeogebraCommonKernelConstruction_withNSStringArray_withGeogebraCommonKernelKernelNDGeoPointND_withGeogebraCommonKernelKernelNDGeoPointND_withGeogebraCommonKernelKernelNDGeoDirectionND_withGeogebraCommonKernelCommandsCommandsEnum_(GeogebraCommonKernelConstruction *c, IOSObjectArray *labels, id<GeogebraCommonKernelKernelNDGeoPointND> A, id<GeogebraCommonKernelKernelNDGeoPointND> B, id<GeogebraCommonKernelKernelNDGeoDirectionND> v, GeogebraCommonKernelCommandsCommandsEnum *name) NS_RETURNS_RETAINED;

J2OBJC_TYPE_LITERAL_HEADER(GeogebraCommonGeogebra3DKernel3DAlgosAlgoArchimedeanSolid)

#endif // _GeogebraCommonGeogebra3DKernel3DAlgosAlgoArchimedeanSolid_H_
