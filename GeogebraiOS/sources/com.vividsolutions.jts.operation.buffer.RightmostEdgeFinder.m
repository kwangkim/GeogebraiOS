...
//  source: /Users/jacky/GSoC/geogebra_iOS/geogebra/geogebra/common/src/com/vividsolutions/jts/operation/buffer/RightmostEdgeFinder.java
//
...
- (void)findEdgeWithJavaUtilList:(id<JavaUtilList>)dirEdgeList {
  ...
  ComVividsolutionsJtsOperationBufferRightmostEdgeFinder_set_orientedDe_(self, minDe_);
  ...
  if (rightmostSide == ComVividsolutionsJtsGeomgraphPosition_LEFT) {
    ComVividsolutionsJtsOperationBufferRightmostEdgeFinder_set_orientedDe_(self, [((ComVividsolutionsJtsGeomgraphDirectedEdge *) nil_chk(minDe_)) getSym]);
  }
}
...
void ComVividsolutionsJtsOperationBufferRightmostEdgeFinder_init(ComVividsolutionsJtsOperationBufferRightmostEdgeFinder *self) {
  NSObject_init(self);
  self->minIndex_ = -1;
  ComVividsolutionsJtsOperationBufferRightmostEdgeFinder_set_minCoord_(self, nil);
  ComVividsolutionsJtsOperationBufferRightmostEdgeFinder_set_minDe_(self, nil);
  ComVividsolutionsJtsOperationBufferRightmostEdgeFinder_set_orientedDe_(self, nil);
}
...
void ComVividsolutionsJtsOperationBufferRightmostEdgeFinder_findRightmostEdgeAtNode(ComVividsolutionsJtsOperationBufferRightmostEdgeFinder *self) {
  ...
  ComVividsolutionsJtsOperationBufferRightmostEdgeFinder_set_minDe_(self, [((ComVividsolutionsJtsGeomgraphDirectedEdgeStar *) nil_chk(star)) getRightmostEdge]);
  if (![((ComVividsolutionsJtsGeomgraphDirectedEdge *) nil_chk(self->minDe_)) isForward]) {
    ComVividsolutionsJtsOperationBufferRightmostEdgeFinder_set_minDe_(self, [self->minDe_ getSym]);
...
void ComVividsolutionsJtsOperationBufferRightmostEdgeFinder_checkForRightmostCoordinateWithComVividsolutionsJtsGeomgraphDirectedEdge_(ComVividsolutionsJtsOperationBufferRightmostEdgeFinder *self, ComVividsolutionsJtsGeomgraphDirectedEdge *de) {
  ...
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(coord))->size_ - 1; i++) {
    if (self->minCoord_ == nil || ((ComVividsolutionsJtsGeomCoordinate *) nil_chk(IOSObjectArray_Get(coord, i)))->x_ > self->minCoord_->x_) {
      ComVividsolutionsJtsOperationBufferRightmostEdgeFinder_set_minDe_(self, de);
      self->minIndex_ = i;
      ComVividsolutionsJtsOperationBufferRightmostEdgeFinder_set_minCoord_(self, IOSObjectArray_Get(coord, i));
    }
  }
}
