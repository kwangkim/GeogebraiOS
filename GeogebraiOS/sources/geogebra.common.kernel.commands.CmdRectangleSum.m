...
@implementation GeogebraCommonKernelCommandsCmdRectangleSum

- (instancetype)initWithGeogebraCommonKernelKernel:(GeogebraCommonKernelKernel *)kernel {
  GeogebraCommonKernelCommandsCmdRectangleSum_initWithGeogebraCommonKernelKernel_(self, kernel);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithGeogebraCommonKernelKernel:", "CmdRectangleSum", NULL, 0x1, NULL, NULL },
  ...
  static const J2ObjcClassInfo _GeogebraCommonKernelCommandsCmdRectangleSum = { 2, "CmdRectangleSum", "geogebra.common.kernel.commands", NULL, 0x1, 2, methods, 0, NULL, 0, NULL, 0, NULL, NULL, NULL };
  return &_GeogebraCommonKernelCommandsCmdRectangleSum;
}

@end

void GeogebraCommonKernelCommandsCmdRectangleSum_initWithGeogebraCommonKernelKernel_(GeogebraCommonKernelCommandsCmdRectangleSum *self, GeogebraCommonKernelKernel *kernel) {
  GeogebraCommonKernelCommandsCommandProcessor_initWithGeogebraCommonKernelKernel_(self, kernel);
}

GeogebraCommonKernelCommandsCmdRectangleSum *new_GeogebraCommonKernelCommandsCmdRectangleSum_initWithGeogebraCommonKernelKernel_(GeogebraCommonKernelKernel *kernel) {
  GeogebraCommonKernelCommandsCmdRectangleSum *self = [GeogebraCommonKernelCommandsCmdRectangleSum alloc];
  GeogebraCommonKernelCommandsCmdRectangleSum_initWithGeogebraCommonKernelKernel_(self, kernel);
  return self;
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(GeogebraCommonKernelCommandsCmdRectangleSum)
