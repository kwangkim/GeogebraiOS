...
- (void)setComparatorWithInt:(jint)index
      withJavaUtilComparator:(id<JavaUtilComparator>)comparator
                 withBoolean:(jboolean)reverse {
  OrgApacheCommonsCollections15ComparatorsComparatorChain_checkLocked(self);
  [((id<JavaUtilList>) nil_chk(comparatorChain_)) setWithInt:index withId:comparator];
  if (reverse == YES) {
...
- (void)dealloc {
  RELEASE_(comparatorChain_);
  RELEASE_(orderingBits_);
  [super dealloc];
}
...
void OrgApacheCommonsCollections15ComparatorsComparatorChain_init(OrgApacheCommonsCollections15ComparatorsComparatorChain *self) {
  OrgApacheCommonsCollections15ComparatorsComparatorChain_initWithJavaUtilList_withJavaUtilBitSet_(self, [new_JavaUtilArrayList_init() autorelease], [new_JavaUtilBitSet_init() autorelease]);
}
...
void OrgApacheCommonsCollections15ComparatorsComparatorChain_initWithJavaUtilComparator_(OrgApacheCommonsCollections15ComparatorsComparatorChain *self, id<JavaUtilComparator> comparator) {
  OrgApacheCommonsCollections15ComparatorsComparatorChain_initWithJavaUtilComparator_withBoolean_(self, comparator, NO);
}
...
void OrgApacheCommonsCollections15ComparatorsComparatorChain_initWithJavaUtilComparator_withBoolean_(OrgApacheCommonsCollections15ComparatorsComparatorChain *self, id<JavaUtilComparator> comparator, jboolean reverse) {
  NSObject_init(self);
  OrgApacheCommonsCollections15ComparatorsComparatorChain_set_comparatorChain_(self, nil);
  OrgApacheCommonsCollections15ComparatorsComparatorChain_set_orderingBits_(self, nil);
  self->isLocked__ = NO;
  OrgApacheCommonsCollections15ComparatorsComparatorChain_setAndConsume_comparatorChain_(self, new_JavaUtilArrayList_init());
  [self->comparatorChain_ addWithId:comparator];
  OrgApacheCommonsCollections15ComparatorsComparatorChain_setAndConsume_orderingBits_(self, new_JavaUtilBitSet_initWithInt_(1));
  if (reverse == YES) {
...
void OrgApacheCommonsCollections15ComparatorsComparatorChain_initWithJavaUtilList_(OrgApacheCommonsCollections15ComparatorsComparatorChain *self, id<JavaUtilList> list) {
  OrgApacheCommonsCollections15ComparatorsComparatorChain_initWithJavaUtilList_withJavaUtilBitSet_(self, list, [new_JavaUtilBitSet_initWithInt_([((id<JavaUtilList>) nil_chk(list)) size]) autorelease]);
}
...
void OrgApacheCommonsCollections15ComparatorsComparatorChain_initWithJavaUtilList_withJavaUtilBitSet_(OrgApacheCommonsCollections15ComparatorsComparatorChain *self, id<JavaUtilList> list, JavaUtilBitSet *bits) {
  ...
  OrgApacheCommonsCollections15ComparatorsComparatorChain_set_orderingBits_(self, nil);
  self->isLocked__ = NO;
  OrgApacheCommonsCollections15ComparatorsComparatorChain_set_comparatorChain_(self, list);
  OrgApacheCommonsCollections15ComparatorsComparatorChain_set_orderingBits_(self, bits);
}
...
void OrgApacheCommonsCollections15ComparatorsComparatorChain_checkLocked(OrgApacheCommonsCollections15ComparatorsComparatorChain *self) {
  if (self->isLocked__ == YES) {
    @throw [new_JavaLangUnsupportedOperationException_initWithNSString_(@"Comparator ordering cannot be changed after the first comparison is performed") autorelease];
  }
}
...
void OrgApacheCommonsCollections15ComparatorsComparatorChain_checkChainIntegrity(OrgApacheCommonsCollections15ComparatorsComparatorChain *self) {
  if ([((id<JavaUtilList>) nil_chk(self->comparatorChain_)) size] == 0) {
    @throw [new_JavaLangUnsupportedOperationException_initWithNSString_(@"ComparatorChains must contain at least one Comparator") autorelease];
  }
}
