...
void ComVividsolutionsJtsAlgorithmPointLocator_init(ComVividsolutionsJtsAlgorithmPointLocator *self) {
  NSObject_init(self);
  ComVividsolutionsJtsAlgorithmPointLocator_set_boundaryRule_(self, ComVividsolutionsJtsAlgorithmBoundaryNodeRule_get_OGC_SFS_BOUNDARY_RULE_());
}
...
void ComVividsolutionsJtsAlgorithmPointLocator_initWithComVividsolutionsJtsAlgorithmBoundaryNodeRule_(ComVividsolutionsJtsAlgorithmPointLocator *self, id<ComVividsolutionsJtsAlgorithmBoundaryNodeRule> boundaryRule) {
  NSObject_init(self);
  ComVividsolutionsJtsAlgorithmPointLocator_set_boundaryRule_(self, ComVividsolutionsJtsAlgorithmBoundaryNodeRule_get_OGC_SFS_BOUNDARY_RULE_());
  if (boundaryRule == nil) @throw [new_JavaLangIllegalArgumentException_initWithNSString_(@"Rule must be non-null") autorelease];
  ComVividsolutionsJtsAlgorithmPointLocator_set_boundaryRule_(self, boundaryRule);
}
