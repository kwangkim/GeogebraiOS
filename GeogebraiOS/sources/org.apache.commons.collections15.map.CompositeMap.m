...
- (void)setMutatorWithOrgApacheCommonsCollections15MapCompositeMap_MapMutator:(id<OrgApacheCommonsCollections15MapCompositeMap_MapMutator>)mutator {
  OrgApacheCommonsCollections15MapCompositeMap_set_mutator_(self, mutator);
}
...
- (void)addCompositedWithJavaUtilMap:(id<JavaUtilMap>)map {
  @synchronized(self) {
    for (jint i = ((IOSObjectArray *) nil_chk(composite_))->size_ - 1; i >= 0; --i) {
      ...
      if ([((id<JavaUtilCollection>) nil_chk(intersect)) size] != 0) {
        if (self->mutator_ == nil) {
          @throw [new_JavaLangIllegalArgumentException_initWithNSString_(@"Key collision adding Map to CompositeMap") autorelease];
        }
        else {
    ...
    IOSObjectArray *temp = [IOSObjectArray arrayWithLength:self->composite_->size_ + 1 type:JavaUtilMap_class_()];
    JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(self->composite_, 0, temp, 0, self->composite_->size_);
    IOSObjectArray_Set(temp, temp->size_ - 1, map);
    OrgApacheCommonsCollections15MapCompositeMap_set_composite_(self, temp);
  }
}
  ...
  @synchronized(self) {
    ...
    for (jint i = 0; i < size; ++i) {
      if ([((id<JavaUtilMap>) nil_chk(IOSObjectArray_Get(self->composite_, i))) isEqual:map]) {
        IOSObjectArray *temp = [IOSObjectArray arrayWithLength:size - 1 type:JavaUtilMap_class_()];
...
- (id<JavaUtilSet>)entrySet {
  OrgApacheCommonsCollections15SetCompositeSet *entries = [new_OrgApacheCommonsCollections15SetCompositeSet_init() autorelease];
  for (jint i = ((IOSObjectArray *) nil_chk(self->composite_))->size_ - 1; i >= 0; --i) {
...
- (id<JavaUtilSet>)keySet {
  OrgApacheCommonsCollections15SetCompositeSet *keys = [new_OrgApacheCommonsCollections15SetCompositeSet_init() autorelease];
  for (jint i = ((IOSObjectArray *) nil_chk(self->composite_))->size_ - 1; i >= 0; --i) {
...
- (id)putWithId:(id)key
         withId:(id)value {
  if (self->mutator_ == nil) {
    @throw [new_JavaLangUnsupportedOperationException_initWithNSString_(@"No mutator specified") autorelease];
  }
...
- (id<JavaUtilCollection>)values {
  OrgApacheCommonsCollections15CollectionCompositeCollection *keys = [new_OrgApacheCommonsCollections15CollectionCompositeCollection_init() autorelease];
  for (jint i = ((IOSObjectArray *) nil_chk(self->composite_))->size_ - 1; i >= 0; --i) {
...
void OrgApacheCommonsCollections15MapCompositeMap_init(OrgApacheCommonsCollections15MapCompositeMap *self) {
  OrgApacheCommonsCollections15MapCompositeMap_initWithJavaUtilMapArray_withOrgApacheCommonsCollections15MapCompositeMap_MapMutator_(self, [IOSObjectArray arrayWithObjects:(id[]){  } count:0 type:JavaUtilMap_class_()], nil);
}
...
void OrgApacheCommonsCollections15MapCompositeMap_initWithJavaUtilMap_withJavaUtilMap_(OrgApacheCommonsCollections15MapCompositeMap *self, id<JavaUtilMap> one, id<JavaUtilMap> two) {
  OrgApacheCommonsCollections15MapCompositeMap_initWithJavaUtilMapArray_withOrgApacheCommonsCollections15MapCompositeMap_MapMutator_(self, [IOSObjectArray arrayWithObjects:(id[]){ one, two } count:2 type:JavaUtilMap_class_()], nil);
}
...
void OrgApacheCommonsCollections15MapCompositeMap_initWithJavaUtilMap_withJavaUtilMap_withOrgApacheCommonsCollections15MapCompositeMap_MapMutator_(OrgApacheCommonsCollections15MapCompositeMap *self, id<JavaUtilMap> one, id<JavaUtilMap> two, id<OrgApacheCommonsCollections15MapCompositeMap_MapMutator> mutator) {
  OrgApacheCommonsCollections15MapCompositeMap_initWithJavaUtilMapArray_withOrgApacheCommonsCollections15MapCompositeMap_MapMutator_(self, [IOSObjectArray arrayWithObjects:(id[]){ one, two } count:2 type:JavaUtilMap_class_()], mutator);
}
...
void OrgApacheCommonsCollections15MapCompositeMap_initWithJavaUtilMapArray_(OrgApacheCommonsCollections15MapCompositeMap *self, IOSObjectArray *composite) {
  OrgApacheCommonsCollections15MapCompositeMap_initWithJavaUtilMapArray_withOrgApacheCommonsCollections15MapCompositeMap_MapMutator_(self, composite, nil);
}
...
void OrgApacheCommonsCollections15MapCompositeMap_initWithJavaUtilMapArray_withOrgApacheCommonsCollections15MapCompositeMap_MapMutator_(OrgApacheCommonsCollections15MapCompositeMap *self, IOSObjectArray *composite, id<OrgApacheCommonsCollections15MapCompositeMap_MapMutator> mutator) {
  NSObject_init(self);
  OrgApacheCommonsCollections15MapCompositeMap_set_mutator_(self, mutator);
  OrgApacheCommonsCollections15MapCompositeMap_setAndConsume_composite_(self, [IOSObjectArray newArrayWithLength:0 type:JavaUtilMap_class_()]);
