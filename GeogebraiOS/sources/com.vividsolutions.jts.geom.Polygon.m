...
//  source: /Users/jacky/GSoC/geogebra_iOS/geogebra/geogebra/common/src/com/vividsolutions/jts/geom/Polygon.java
//
...
- (IOSObjectArray *)getCoordinates {
  if ([self isEmpty]) {
    return [IOSObjectArray arrayWithObjects:(id[]){  } count:0 type:ComVividsolutionsJtsGeomCoordinate_class_()];
  }
  ...
  for (jint x = 0; x < ((IOSObjectArray *) nil_chk(shellCoordinates))->size_; x++) {
    k++;
    IOSObjectArray_Set(coordinates, k, IOSObjectArray_Get(shellCoordinates, x));
  }
...
- (ComVividsolutionsJtsGeomGeometry *)getBoundary {
  ...
  IOSObjectArray *rings = [IOSObjectArray arrayWithLength:((IOSObjectArray *) nil_chk(holes_))->size_ + 1 type:ComVividsolutionsJtsGeomLinearRing_class_()];
  IOSObjectArray_Set(rings, 0, shell_);
  for (jint i = 0; i < holes_->size_; i++) {
    IOSObjectArray_Set(rings, i + 1, IOSObjectArray_Get(holes_, i));
  }
...
- (id)clone {
  ...
  ComVividsolutionsJtsGeomPolygon_set_shell_(nil_chk(poly), (ComVividsolutionsJtsGeomLinearRing *) check_class_cast([((ComVividsolutionsJtsGeomLinearRing *) nil_chk(shell_)) clone], [ComVividsolutionsJtsGeomLinearRing class]));
  ComVividsolutionsJtsGeomPolygon_setAndConsume_holes_(poly, [IOSObjectArray newArrayWithLength:((IOSObjectArray *) nil_chk(holes_))->size_ type:ComVividsolutionsJtsGeomLinearRing_class_()]);
  for (jint i = 0; i < holes_->size_; i++) {
    IOSObjectArray_Set(poly->holes_, i, (ComVividsolutionsJtsGeomLinearRing *) check_class_cast([((ComVividsolutionsJtsGeomLinearRing *) nil_chk(IOSObjectArray_Get(holes_, i))) clone], [ComVividsolutionsJtsGeomLinearRing class]));
  }
  return poly;
}
...
void ComVividsolutionsJtsGeomPolygon_initWithComVividsolutionsJtsGeomLinearRing_withComVividsolutionsJtsGeomPrecisionModel_withInt_(ComVividsolutionsJtsGeomPolygon *self, ComVividsolutionsJtsGeomLinearRing *shell, ComVividsolutionsJtsGeomPrecisionModel *precisionModel, jint SRID) {
  ComVividsolutionsJtsGeomPolygon_initWithComVividsolutionsJtsGeomLinearRing_withComVividsolutionsJtsGeomLinearRingArray_withComVividsolutionsJtsGeomGeometryFactory_(self, shell, [IOSObjectArray arrayWithObjects:(id[]){  } count:0 type:ComVividsolutionsJtsGeomLinearRing_class_()], [new_ComVividsolutionsJtsGeomGeometryFactory_initWithComVividsolutionsJtsGeomPrecisionModel_withInt_(precisionModel, SRID) autorelease]);
}
...
void ComVividsolutionsJtsGeomPolygon_initWithComVividsolutionsJtsGeomLinearRing_withComVividsolutionsJtsGeomLinearRingArray_withComVividsolutionsJtsGeomGeometryFactory_(ComVividsolutionsJtsGeomPolygon *self, ComVividsolutionsJtsGeomLinearRing *shell, IOSObjectArray *holes, ComVividsolutionsJtsGeomGeometryFactory *factory) {
  ...
  ComVividsolutionsJtsGeomPolygon_set_shell_(self, nil);
  if (shell == nil) {
  ...
  if (holes == nil) {
    holes = [IOSObjectArray arrayWithObjects:(id[]){  } count:0 type:ComVividsolutionsJtsGeomLinearRing_class_()];
  }
  if (ComVividsolutionsJtsGeomGeometry_hasNullElementsWithNSObjectArray_(holes)) {
    @throw [new_JavaLangIllegalArgumentException_initWithNSString_(@"holes must not contain null elements") autorelease];
  }
  if ([((ComVividsolutionsJtsGeomLinearRing *) nil_chk(shell)) isEmpty] && ComVividsolutionsJtsGeomGeometry_hasNonEmptyElementsWithComVividsolutionsJtsGeomGeometryArray_(holes)) {
    @throw [new_JavaLangIllegalArgumentException_initWithNSString_(@"shell is empty but holes are not") autorelease];
  }
  ComVividsolutionsJtsGeomPolygon_set_shell_(self, shell);
  ComVividsolutionsJtsGeomPolygon_set_holes_(self, holes);
}
...
void ComVividsolutionsJtsGeomPolygon_normalizeWithComVividsolutionsJtsGeomLinearRing_withBoolean_(ComVividsolutionsJtsGeomPolygon *self, ComVividsolutionsJtsGeomLinearRing *ring, jboolean clockwise) {
  ...
  IOSObjectArray *uniqueCoordinates = [IOSObjectArray arrayWithLength:((IOSObjectArray *) nil_chk([ring getCoordinates]))->size_ - 1 type:ComVividsolutionsJtsGeomCoordinate_class_()];
  ...
  IOSObjectArray_Set(nil_chk([ring getCoordinates]), uniqueCoordinates->size_, IOSObjectArray_Get(uniqueCoordinates, 0));
