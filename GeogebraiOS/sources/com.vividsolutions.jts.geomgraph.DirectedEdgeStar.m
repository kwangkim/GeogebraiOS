...
- (void)computeLabellingWithComVividsolutionsJtsGeomgraphGeometryGraphArray:(IOSObjectArray *)geom {
  ...
  ComVividsolutionsJtsGeomgraphDirectedEdgeStar_setAndConsume_label_(self, new_ComVividsolutionsJtsGeomgraphLabel_initWithInt_(ComVividsolutionsJtsGeomLocation_NONE));
  for (id<JavaUtilIterator> it = [self iterator]; [((id<JavaUtilIterator>) nil_chk(it)) hasNext]; ) {
...
- (void)linkResultDirectedEdges {
  ComVividsolutionsJtsGeomgraphDirectedEdgeStar_getResultAreaEdges(self);
  ...
  if (state == LINKING_TO_OUTGOING_) {
    if (firstOut == nil) @throw [new_ComVividsolutionsJtsGeomTopologyException_initWithNSString_withComVividsolutionsJtsGeomCoordinate_(@"no outgoing dirEdge found", [self getCoordinate]) autorelease];
...
- (void)computeDepthsWithComVividsolutionsJtsGeomgraphDirectedEdge:(ComVividsolutionsJtsGeomgraphDirectedEdge *)de {
  ...
  if (lastDepth != targetLastDepth) @throw [new_ComVividsolutionsJtsGeomTopologyException_initWithNSString_(JreStrcat("$@", @"depth mismatch at ", [de getCoordinate])) autorelease];
}
...
id<JavaUtilList> ComVividsolutionsJtsGeomgraphDirectedEdgeStar_getResultAreaEdges(ComVividsolutionsJtsGeomgraphDirectedEdgeStar *self) {
  ...
  ComVividsolutionsJtsGeomgraphDirectedEdgeStar_setAndConsume_resultAreaEdgeList_(self, new_JavaUtilArrayList_init());
  for (id<JavaUtilIterator> it = [self iterator]; [((id<JavaUtilIterator>) nil_chk(it)) hasNext]; ) {
    ComVividsolutionsJtsGeomgraphDirectedEdge *de = (ComVividsolutionsJtsGeomgraphDirectedEdge *) check_class_cast([it next], [ComVividsolutionsJtsGeomgraphDirectedEdge class]);
