...
//  source: /Users/jacky/GSoC/geogebra_iOS/geogebra/geogebra/common/src/org/apache/commons/math/genetics/TournamentSelection.java
//
...
OrgApacheCommonsMathGeneticsChromosome *OrgApacheCommonsMathGeneticsTournamentSelection_tournamentWithOrgApacheCommonsMathGeneticsListPopulation_(OrgApacheCommonsMathGeneticsTournamentSelection *self, OrgApacheCommonsMathGeneticsListPopulation *population) {
  if ([((OrgApacheCommonsMathGeneticsListPopulation *) nil_chk(population)) getPopulationSize] < self->arity_) @throw [new_JavaLangIllegalArgumentException_initWithNSString_(@"Tournament arity cannot be bigger than population size.") autorelease];
  OrgApacheCommonsMathGeneticsListPopulation *tournamentPopulation = [new_OrgApacheCommonsMathGeneticsTournamentSelection_$1_initWithInt_(self->arity_) autorelease];
  id<JavaUtilList> chromosomes = [new_JavaUtilArrayList_initWithJavaUtilCollection_([population getChromosomes]) autorelease];
  for (jint i = 0; i < self->arity_; i++) {
    ...
    [chromosomes removeWithInt:rind];
  }
...
void OrgApacheCommonsMathGeneticsTournamentSelection_$1_initWithInt_(OrgApacheCommonsMathGeneticsTournamentSelection_$1 *self, jint arg$0) {
  OrgApacheCommonsMathGeneticsListPopulation_initWithInt_(self, arg$0);
}
