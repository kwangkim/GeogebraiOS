...
id<OrgApacheCommonsCollections15Factory> OrgApacheCommonsCollections15FunctorsPrototypeFactory_getInstanceWithId_(id prototype) {
  ...
  @try {
    JavaLangReflectMethod *method = [[nil_chk(prototype) getClass] getMethod:@"clone" parameterTypes:nil];
...
- (id)create {
  ...
  @try {
    return (id) [((JavaLangReflectMethod *) nil_chk(iCloneMethod_)) invokeWithId:iPrototype_ withNSObjectArray:nil];
  }
...
void OrgApacheCommonsCollections15FunctorsPrototypeFactory_PrototypeCloneFactory_findCloneMethod(OrgApacheCommonsCollections15FunctorsPrototypeFactory_PrototypeCloneFactory *self) {
  @try {
    OrgApacheCommonsCollections15FunctorsPrototypeFactory_PrototypeCloneFactory_set_iCloneMethod_(self, [[nil_chk(self->iPrototype_) getClass] getMethod:@"clone" parameterTypes:nil]);
  }
  @catch (JavaLangNoSuchMethodException *ex) {
