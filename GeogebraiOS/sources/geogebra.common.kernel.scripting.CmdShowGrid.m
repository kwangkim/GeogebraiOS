...
@implementation GeogebraCommonKernelScriptingCmdShowGrid

- (instancetype)initWithGeogebraCommonKernelKernel:(GeogebraCommonKernelKernel *)kernel {
  GeogebraCommonKernelScriptingCmdShowGrid_initWithGeogebraCommonKernelKernel_(self, kernel);
  return self;
}
...
- (void)performWithGeogebraCommonKernelArithmeticCommand:(GeogebraCommonKernelArithmeticCommand *)c {
  ...
  GeogebraCommonKernelCommandsCmdScripting_set_arg_(self, [self resArgsWithGeogebraCommonKernelArithmeticCommand:c]);
  {
    ...
    switch (n) {
      ...
      [((id<GeogebraCommonEuclidianEuclidianViewInterfaceCommon>) nil_chk(ev)) showGridWithBoolean:YES];
      [ev repaintView];
      break;
      case 1:
      ...
      ev = [((GeogebraCommonMainApp *) nil_chk(app_)) getActiveEuclidianView];
      [((id<GeogebraCommonEuclidianEuclidianViewInterfaceCommon>) nil_chk(ev)) showGridWithBoolean:show];
      [ev repaintView];
      break;
      case 2:
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithGeogebraCommonKernelKernel:", "CmdShowGrid", NULL, 0x1, NULL, NULL },
    { "performWithGeogebraCommonKernelArithmeticCommand:", "perform", "V", 0x14, "Lgeogebra.common.main.MyError;", NULL },
  };
  static const J2ObjcClassInfo _GeogebraCommonKernelScriptingCmdShowGrid = { 2, "CmdShowGrid", "geogebra.common.kernel.scripting", NULL, 0x1, 2, methods, 0, NULL, 0, NULL, 0, NULL, NULL, NULL };
  return &_GeogebraCommonKernelScriptingCmdShowGrid;
}

@end

void GeogebraCommonKernelScriptingCmdShowGrid_initWithGeogebraCommonKernelKernel_(GeogebraCommonKernelScriptingCmdShowGrid *self, GeogebraCommonKernelKernel *kernel) {
  GeogebraCommonKernelCommandsCmdScripting_initWithGeogebraCommonKernelKernel_(self, kernel);
}

GeogebraCommonKernelScriptingCmdShowGrid *new_GeogebraCommonKernelScriptingCmdShowGrid_initWithGeogebraCommonKernelKernel_(GeogebraCommonKernelKernel *kernel) {
  GeogebraCommonKernelScriptingCmdShowGrid *self = [GeogebraCommonKernelScriptingCmdShowGrid alloc];
  GeogebraCommonKernelScriptingCmdShowGrid_initWithGeogebraCommonKernelKernel_(self, kernel);
  return self;
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(GeogebraCommonKernelScriptingCmdShowGrid)
