...
//  source: /Users/jacky/GSoC/geogebra_iOS/geogebra/geogebra/common/src/com/vividsolutions/jts/geomgraph/Label.java
//
...
- (void)mergeWithComVividsolutionsJtsGeomgraphLabel:(ComVividsolutionsJtsGeomgraphLabel *)lbl {
  for (jint i = 0; i < 2; i++) {
    if (IOSObjectArray_Get(nil_chk(elt_), i) == nil && IOSObjectArray_Get(((ComVividsolutionsJtsGeomgraphLabel *) nil_chk(lbl))->elt_, i) != nil) {
      IOSObjectArray_SetAndConsume(elt_, i, new_ComVividsolutionsJtsGeomgraphTopologyLocation_initWithComVividsolutionsJtsGeomgraphTopologyLocation_(IOSObjectArray_Get(lbl->elt_, i)));
    }
    else {
...
- (void)toLineWithInt:(jint)geomIndex {
  if ([((ComVividsolutionsJtsGeomgraphTopologyLocation *) nil_chk(IOSObjectArray_Get(nil_chk(elt_), geomIndex))) isArea]) IOSObjectArray_SetAndConsume(elt_, geomIndex, new_ComVividsolutionsJtsGeomgraphTopologyLocation_initWithInt_(IOSIntArray_Get(nil_chk(((ComVividsolutionsJtsGeomgraphTopologyLocation *) nil_chk(IOSObjectArray_Get(elt_, geomIndex)))->location_), 0)));
}

- (NSString *)description {
  JavaLangStringBuffer *buf = [new_JavaLangStringBuffer_init() autorelease];
  if (IOSObjectArray_Get(nil_chk(elt_), 0) != nil) {
    [buf appendWithNSString:@"A:"];
    [buf appendWithNSString:[((ComVividsolutionsJtsGeomgraphTopologyLocation *) nil_chk(IOSObjectArray_Get(elt_, 0))) description]];
  }
  if (IOSObjectArray_Get(elt_, 1) != nil) {
    [buf appendWithNSString:@" B:"];
    [buf appendWithNSString:[((ComVividsolutionsJtsGeomgraphTopologyLocation *) nil_chk(IOSObjectArray_Get(elt_, 1))) description]];
  }
...
ComVividsolutionsJtsGeomgraphLabel *ComVividsolutionsJtsGeomgraphLabel_toLineLabelWithComVividsolutionsJtsGeomgraphLabel_(ComVividsolutionsJtsGeomgraphLabel *label) {
  ...
  ComVividsolutionsJtsGeomgraphLabel *lineLabel = [new_ComVividsolutionsJtsGeomgraphLabel_initWithInt_(ComVividsolutionsJtsGeomLocation_NONE) autorelease];
  for (jint i = 0; i < 2; i++) {
...
void ComVividsolutionsJtsGeomgraphLabel_initWithInt_(ComVividsolutionsJtsGeomgraphLabel *self, jint onLoc) {
  NSObject_init(self);
  ComVividsolutionsJtsGeomgraphLabel_setAndConsume_elt_(self, [IOSObjectArray newArrayWithLength:2 type:ComVividsolutionsJtsGeomgraphTopologyLocation_class_()]);
  IOSObjectArray_SetAndConsume(self->elt_, 0, new_ComVividsolutionsJtsGeomgraphTopologyLocation_initWithInt_(onLoc));
  IOSObjectArray_SetAndConsume(self->elt_, 1, new_ComVividsolutionsJtsGeomgraphTopologyLocation_initWithInt_(onLoc));
}
...
void ComVividsolutionsJtsGeomgraphLabel_initWithInt_withInt_(ComVividsolutionsJtsGeomgraphLabel *self, jint geomIndex, jint onLoc) {
  NSObject_init(self);
  ComVividsolutionsJtsGeomgraphLabel_setAndConsume_elt_(self, [IOSObjectArray newArrayWithLength:2 type:ComVividsolutionsJtsGeomgraphTopologyLocation_class_()]);
  IOSObjectArray_SetAndConsume(self->elt_, 0, new_ComVividsolutionsJtsGeomgraphTopologyLocation_initWithInt_(ComVividsolutionsJtsGeomLocation_NONE));
  IOSObjectArray_SetAndConsume(self->elt_, 1, new_ComVividsolutionsJtsGeomgraphTopologyLocation_initWithInt_(ComVividsolutionsJtsGeomLocation_NONE));
...
void ComVividsolutionsJtsGeomgraphLabel_initWithInt_withInt_withInt_(ComVividsolutionsJtsGeomgraphLabel *self, jint onLoc, jint leftLoc, jint rightLoc) {
  NSObject_init(self);
  ComVividsolutionsJtsGeomgraphLabel_setAndConsume_elt_(self, [IOSObjectArray newArrayWithLength:2 type:ComVividsolutionsJtsGeomgraphTopologyLocation_class_()]);
  IOSObjectArray_SetAndConsume(self->elt_, 0, new_ComVividsolutionsJtsGeomgraphTopologyLocation_initWithInt_withInt_withInt_(onLoc, leftLoc, rightLoc));
  IOSObjectArray_SetAndConsume(self->elt_, 1, new_ComVividsolutionsJtsGeomgraphTopologyLocation_initWithInt_withInt_withInt_(onLoc, leftLoc, rightLoc));
}
...
void ComVividsolutionsJtsGeomgraphLabel_initWithInt_withInt_withInt_withInt_(ComVividsolutionsJtsGeomgraphLabel *self, jint geomIndex, jint onLoc, jint leftLoc, jint rightLoc) {
  NSObject_init(self);
  ComVividsolutionsJtsGeomgraphLabel_setAndConsume_elt_(self, [IOSObjectArray newArrayWithLength:2 type:ComVividsolutionsJtsGeomgraphTopologyLocation_class_()]);
  IOSObjectArray_SetAndConsume(self->elt_, 0, new_ComVividsolutionsJtsGeomgraphTopologyLocation_initWithInt_withInt_withInt_(ComVividsolutionsJtsGeomLocation_NONE, ComVividsolutionsJtsGeomLocation_NONE, ComVividsolutionsJtsGeomLocation_NONE));
  IOSObjectArray_SetAndConsume(self->elt_, 1, new_ComVividsolutionsJtsGeomgraphTopologyLocation_initWithInt_withInt_withInt_(ComVividsolutionsJtsGeomLocation_NONE, ComVividsolutionsJtsGeomLocation_NONE, ComVividsolutionsJtsGeomLocation_NONE));
...
void ComVividsolutionsJtsGeomgraphLabel_initWithComVividsolutionsJtsGeomgraphLabel_(ComVividsolutionsJtsGeomgraphLabel *self, ComVividsolutionsJtsGeomgraphLabel *lbl) {
  NSObject_init(self);
  ComVividsolutionsJtsGeomgraphLabel_setAndConsume_elt_(self, [IOSObjectArray newArrayWithLength:2 type:ComVividsolutionsJtsGeomgraphTopologyLocation_class_()]);
  IOSObjectArray_SetAndConsume(self->elt_, 0, new_ComVividsolutionsJtsGeomgraphTopologyLocation_initWithComVividsolutionsJtsGeomgraphTopologyLocation_(IOSObjectArray_Get(((ComVividsolutionsJtsGeomgraphLabel *) nil_chk(lbl))->elt_, 0)));
  IOSObjectArray_SetAndConsume(self->elt_, 1, new_ComVividsolutionsJtsGeomgraphTopologyLocation_initWithComVividsolutionsJtsGeomgraphTopologyLocation_(IOSObjectArray_Get(lbl->elt_, 1)));
}
