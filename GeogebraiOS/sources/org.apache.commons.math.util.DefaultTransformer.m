...
- (jdouble)transformWithId:(id)o {
  if (o == nil) {
    @throw [new_OrgApacheCommonsMathMathException_initWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_OBJECT_TRANSFORMATION(), [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]) autorelease];
  }
