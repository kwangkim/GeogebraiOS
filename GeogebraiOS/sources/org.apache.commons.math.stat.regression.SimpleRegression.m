...
//  source: /Users/jacky/GSoC/geogebra_iOS/geogebra/geogebra/common/src/org/apache/commons/math/stat/regression/SimpleRegression.java
//
...
- (jdouble)getSlopeConfidenceIntervalWithDouble:(jdouble)alpha {
  if (alpha >= 1 || alpha <= 0) {
    @throw OrgApacheCommonsMathMathRuntimeException_createIllegalArgumentExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_OUT_OF_BOUND_SIGNIFICANCE_LEVEL(), [IOSObjectArray arrayWithObjects:(id[]){ JavaLangDouble_valueOfWithDouble_(alpha), JavaLangDouble_valueOfWithDouble_(0.0), JavaLangDouble_valueOfWithDouble_(1.0) } count:3 type:NSObject_class_()]);
  }
...
- (void)setDistributionWithOrgApacheCommonsMathDistributionTDistribution:(id<OrgApacheCommonsMathDistributionTDistribution>)value {
  OrgApacheCommonsMathStatRegressionSimpleRegression_set_distribution_(self, value);
  if (n_ > 2) {
    [((id<OrgApacheCommonsMathDistributionTDistribution>) nil_chk(distribution_)) setDegreesOfFreedomWithDouble:n_ - 2];
  }
}
...
void OrgApacheCommonsMathStatRegressionSimpleRegression_init(OrgApacheCommonsMathStatRegressionSimpleRegression *self) {
  OrgApacheCommonsMathStatRegressionSimpleRegression_initWithOrgApacheCommonsMathDistributionTDistribution_(self, [new_OrgApacheCommonsMathDistributionTDistributionImpl_initWithDouble_(1.0) autorelease]);
}
...
void OrgApacheCommonsMathStatRegressionSimpleRegression_initWithInt_(OrgApacheCommonsMathStatRegressionSimpleRegression *self, jint degrees) {
  ...
  self->xbar_ = 0;
  self->ybar_ = 0;
  [self setDistributionWithOrgApacheCommonsMathDistributionTDistribution:[new_OrgApacheCommonsMathDistributionTDistributionImpl_initWithDouble_(degrees) autorelease]];
}
