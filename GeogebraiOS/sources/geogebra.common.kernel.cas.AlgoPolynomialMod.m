...
@interface GeogebraCommonKernelCasAlgoPolynomialMod () {
 @public
...
J2OBJC_FIELD_SETTER(GeogebraCommonKernelCasAlgoPolynomialMod, f1_, GeogebraCommonKernelGeosGeoFunction *)
J2OBJC_FIELD_SETTER(GeogebraCommonKernelCasAlgoPolynomialMod, f2_, GeogebraCommonKernelGeosGeoFunction *)
J2OBJC_FIELD_SETTER(GeogebraCommonKernelCasAlgoPolynomialMod, g_, GeogebraCommonKernelGeosGeoFunction *)
J2OBJC_FIELD_SETTER(GeogebraCommonKernelCasAlgoPolynomialMod, sb_, JavaLangStringBuilder *)
J2OBJC_FIELD_SETTER(GeogebraCommonKernelCasAlgoPolynomialMod, arbconst_, GeogebraCommonKernelArithmeticMyArbitraryConstant *)

__attribute__((unused)) static void GeogebraCommonKernelCasAlgoPolynomialMod_compute(GeogebraCommonKernelCasAlgoPolynomialMod *self);

@implementation GeogebraCommonKernelCasAlgoPolynomialMod
...
- (instancetype)initWithGeogebraCommonKernelConstruction:(GeogebraCommonKernelConstruction *)cons
  ...
  GeogebraCommonKernelCasAlgoPolynomialMod_initWithGeogebraCommonKernelConstruction_withNSString_withGeogebraCommonKernelGeosGeoFunction_withGeogebraCommonKernelGeosGeoFunction_(self, cons, label, f1, f2);
  return self;
}
...
- (void)compute {
  GeogebraCommonKernelCasAlgoPolynomialMod_compute(self);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithGeogebraCommonKernelConstruction:withNSString:withGeogebraCommonKernelGeosGeoFunction:withGeogebraCommonKernelGeosGeoFunction:", "AlgoPolynomialMod", NULL, 0x1, NULL, NULL },
  ...
  static const J2ObjcClassInfo _GeogebraCommonKernelCasAlgoPolynomialMod = { 2, "AlgoPolynomialMod", "geogebra.common.kernel.cas", NULL, 0x1, 5, methods, 5, fields, 0, NULL, 0, NULL, NULL, NULL };
  return &_GeogebraCommonKernelCasAlgoPolynomialMod;
}
...
void GeogebraCommonKernelCasAlgoPolynomialMod_initWithGeogebraCommonKernelConstruction_withNSString_withGeogebraCommonKernelGeosGeoFunction_withGeogebraCommonKernelGeosGeoFunction_(GeogebraCommonKernelCasAlgoPolynomialMod *self, GeogebraCommonKernelConstruction *cons, NSString *label, GeogebraCommonKernelGeosGeoFunction *f1, GeogebraCommonKernelGeosGeoFunction *f2) {
  ...
  GeogebraCommonKernelCasAlgoPolynomialMod_setAndConsume_sb_(self, new_JavaLangStringBuilder_init());
  GeogebraCommonKernelCasAlgoPolynomialMod_setAndConsume_arbconst_(self, new_GeogebraCommonKernelArithmeticMyArbitraryConstant_initWithGeogebraCommonKernelAlgosConstructionElement_(self));
  GeogebraCommonKernelCasAlgoPolynomialMod_set_f1_(self, f1);
  GeogebraCommonKernelCasAlgoPolynomialMod_set_f2_(self, f2);
  GeogebraCommonKernelCasAlgoPolynomialMod_setAndConsume_g_(self, new_GeogebraCommonKernelGeosGeoFunction_initWithGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  GeogebraCommonKernelCasAlgoPolynomialMod_compute(self);
...
GeogebraCommonKernelCasAlgoPolynomialMod *new_GeogebraCommonKernelCasAlgoPolynomialMod_initWithGeogebraCommonKernelConstruction_withNSString_withGeogebraCommonKernelGeosGeoFunction_withGeogebraCommonKernelGeosGeoFunction_(GeogebraCommonKernelConstruction *cons, NSString *label, GeogebraCommonKernelGeosGeoFunction *f1, GeogebraCommonKernelGeosGeoFunction *f2) {
  GeogebraCommonKernelCasAlgoPolynomialMod *self = [GeogebraCommonKernelCasAlgoPolynomialMod alloc];
  GeogebraCommonKernelCasAlgoPolynomialMod_initWithGeogebraCommonKernelConstruction_withNSString_withGeogebraCommonKernelGeosGeoFunction_withGeogebraCommonKernelGeosGeoFunction_(self, cons, label, f1, f2);
  return self;
}

void GeogebraCommonKernelCasAlgoPolynomialMod_compute(GeogebraCommonKernelCasAlgoPolynomialMod *self) {
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(GeogebraCommonKernelCasAlgoPolynomialMod)
