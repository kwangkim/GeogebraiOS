...
@implementation GeogebraCommonKernelStatisticsCmdFillRow

- (instancetype)initWithGeogebraCommonKernelKernel:(GeogebraCommonKernelKernel *)kernel {
  GeogebraCommonKernelStatisticsCmdFillRow_initWithGeogebraCommonKernelKernel_(self, kernel);
  return self;
}
...
- (IOSObjectArray *)processWithGeogebraCommonKernelArithmeticCommand:(GeogebraCommonKernelArithmeticCommand *)c {
  ...
  switch (n) {
    ...
    if ((*IOSBooleanArray_GetRef(ok, 0) = ([((GeogebraCommonKernelGeosGeoElement *) nil_chk(IOSObjectArray_Get(nil_chk(arg), 0))) isGeoNumeric])) && (*IOSBooleanArray_GetRef(ok, 1) = ([((GeogebraCommonKernelGeosGeoElement *) nil_chk(IOSObjectArray_Get(arg, 1))) isGeoList]))) {
      jint row = -1 + J2ObjCFpToInt([((GeogebraCommonKernelGeosGeoNumeric *) nil_chk(((GeogebraCommonKernelGeosGeoNumeric *) check_class_cast(IOSObjectArray_Get(arg, 0), [GeogebraCommonKernelGeosGeoNumeric class])))) getDouble]);
      if (row < 0 || row > GeogebraCommonKernelKernel_get_MAX_SPREADSHEET_ROWS_DESKTOP_()) @throw [self argErrWithGeogebraCommonMainApp:app_ withNSString:[c getName] withGeogebraCommonKernelArithmeticExpressionValue:IOSObjectArray_Get(arg, 0)];
      ...
      for (jint col = 0; col < [list size]; col++) {
        GeogebraCommonKernelGeosGeoElement *cellGeo = [((GeogebraCommonKernelGeosGeoElement *) nil_chk([list getWithInt:col])) copy__];
        @try {
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithGeogebraCommonKernelKernel:", "CmdFillRow", NULL, 0x1, NULL, NULL },
  ...
  static const J2ObjcClassInfo _GeogebraCommonKernelStatisticsCmdFillRow = { 2, "CmdFillRow", "geogebra.common.kernel.statistics", NULL, 0x1, 2, methods, 0, NULL, 0, NULL, 0, NULL, NULL, NULL };
  return &_GeogebraCommonKernelStatisticsCmdFillRow;
}

@end

void GeogebraCommonKernelStatisticsCmdFillRow_initWithGeogebraCommonKernelKernel_(GeogebraCommonKernelStatisticsCmdFillRow *self, GeogebraCommonKernelKernel *kernel) {
  GeogebraCommonKernelCommandsCommandProcessor_initWithGeogebraCommonKernelKernel_(self, kernel);
}

GeogebraCommonKernelStatisticsCmdFillRow *new_GeogebraCommonKernelStatisticsCmdFillRow_initWithGeogebraCommonKernelKernel_(GeogebraCommonKernelKernel *kernel) {
  GeogebraCommonKernelStatisticsCmdFillRow *self = [GeogebraCommonKernelStatisticsCmdFillRow alloc];
  GeogebraCommonKernelStatisticsCmdFillRow_initWithGeogebraCommonKernelKernel_(self, kernel);
  return self;
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(GeogebraCommonKernelStatisticsCmdFillRow)
