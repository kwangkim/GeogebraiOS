...
- (void)dealloc {
  RELEASE_(mGraph_);
  RELEASE_(mRandom_);
  RELEASE_(vertex_index_);
  RELEASE_(index_vertex_);
...
void EduUciIcsJungAlgorithmsGeneratorsRandomBarabasiAlbertGenerator_initWithOrgApacheCommonsCollections15Factory_withOrgApacheCommonsCollections15Factory_withOrgApacheCommonsCollections15Factory_withInt_withInt_withInt_withJavaUtilSet_(EduUciIcsJungAlgorithmsGeneratorsRandomBarabasiAlbertGenerator *self, id<OrgApacheCommonsCollections15Factory> graphFactory, id<OrgApacheCommonsCollections15Factory> vertexFactory, id<OrgApacheCommonsCollections15Factory> edgeFactory, jint init_vertices, jint numEdgesToAttach, jint seed, id<JavaUtilSet> seedVertices) {
  NSObject_init(self);
  EduUciIcsJungAlgorithmsGeneratorsRandomBarabasiAlbertGenerator_set_mGraph_(self, nil);
  ...
  EduUciIcsJungAlgorithmsGeneratorsRandomBarabasiAlbertGenerator_setAndConsume_mRandom_(self, new_JavaUtilRandom_initWithLong_(seed));
  EduUciIcsJungAlgorithmsGeneratorsRandomBarabasiAlbertGenerator_set_graphFactory_(self, graphFactory);
  EduUciIcsJungAlgorithmsGeneratorsRandomBarabasiAlbertGenerator_set_vertexFactory_(self, vertexFactory);
  EduUciIcsJungAlgorithmsGeneratorsRandomBarabasiAlbertGenerator_set_edgeFactory_(self, edgeFactory);
...
void EduUciIcsJungAlgorithmsGeneratorsRandomBarabasiAlbertGenerator_initialize__WithJavaUtilSet_(EduUciIcsJungAlgorithmsGeneratorsRandomBarabasiAlbertGenerator *self, id<JavaUtilSet> seedVertices) {
  EduUciIcsJungAlgorithmsGeneratorsRandomBarabasiAlbertGenerator_set_mGraph_(self, [((id<OrgApacheCommonsCollections15Factory>) nil_chk(self->graphFactory_)) create]);
  EduUciIcsJungAlgorithmsGeneratorsRandomBarabasiAlbertGenerator_setAndConsume_vertex_index_(self, new_JavaUtilArrayList_initWithInt_(2 * self->init_vertices_));
  EduUciIcsJungAlgorithmsGeneratorsRandomBarabasiAlbertGenerator_setAndConsume_index_vertex_(self, new_JavaUtilHashMap_initWithInt_(2 * self->init_vertices_));
  for (jint i = 0; i < self->init_vertices_; i++) {
    ...
    [self->index_vertex_ putWithId:v withId:JavaLangInteger_valueOfWithInt_(i)];
...
void EduUciIcsJungAlgorithmsGeneratorsRandomBarabasiAlbertGenerator_createRandomEdgeWithJavaUtilCollection_withId_withJavaUtilSet_(EduUciIcsJungAlgorithmsGeneratorsRandomBarabasiAlbertGenerator *self, id<JavaUtilCollection> preexistingNodes, id newVertex, id<JavaUtilSet> added_pairs) {
  ...
  do {
    ...
    endpoints = [new_EduUciIcsJungGraphUtilPair_initWithId_withId_(newVertex, attach_point) autorelease];
    if (!([EduUciIcsJungGraphMultiGraph_class_() isInstance:self->mGraph_])) {
      ...
      if ([((id<EduUciIcsJungGraphGraph>) nil_chk(self->mGraph_)) getDefaultEdgeType] == EduUciIcsJungGraphUtilEdgeTypeEnum_get_UNDIRECTED() && [added_pairs containsWithId:[new_EduUciIcsJungGraphUtilPair_initWithId_withId_(attach_point, newVertex) autorelease]]) continue;
    }
  ...
  if ([((id<EduUciIcsJungGraphGraph>) nil_chk(self->mGraph_)) getDefaultEdgeType] == EduUciIcsJungGraphUtilEdgeTypeEnum_get_UNDIRECTED()) {
    [added_pairs addWithId:[new_EduUciIcsJungGraphUtilPair_initWithId_withId_(attach_point, newVertex) autorelease]];
  }
}
...
void EduUciIcsJungAlgorithmsGeneratorsRandomBarabasiAlbertGenerator_evolveGraph(EduUciIcsJungAlgorithmsGeneratorsRandomBarabasiAlbertGenerator *self) {
  ...
  id<JavaUtilSet> added_pairs = [new_JavaUtilHashSet_initWithInt_(self->mNumEdgesToAttachPerStep_ * 3) autorelease];
  ...
  [((id<JavaUtilMap>) nil_chk(self->index_vertex_)) putWithId:newVertex withId:[new_JavaLangInteger_initWithInt_([self->vertex_index_ size] - 1) autorelease]];
}
