...
jboolean ComVividsolutionsJtsOperationBufferValidateBufferResultValidator_isValidWithComVividsolutionsJtsGeomGeometry_withDouble_withComVividsolutionsJtsGeomGeometry_(ComVividsolutionsJtsGeomGeometry *g, jdouble distance, ComVividsolutionsJtsGeomGeometry *result) {
  ...
  ComVividsolutionsJtsOperationBufferValidateBufferResultValidator *validator = [new_ComVividsolutionsJtsOperationBufferValidateBufferResultValidator_initWithComVividsolutionsJtsGeomGeometry_withDouble_withComVividsolutionsJtsGeomGeometry_(g, distance, result) autorelease];
...
void ComVividsolutionsJtsOperationBufferValidateBufferResultValidator_initWithComVividsolutionsJtsGeomGeometry_withDouble_withComVividsolutionsJtsGeomGeometry_(ComVividsolutionsJtsOperationBufferValidateBufferResultValidator *self, ComVividsolutionsJtsGeomGeometry *input, jdouble distance, ComVividsolutionsJtsGeomGeometry *result) {
  NSObject_init(self);
  self->isValid__ = YES;
  ComVividsolutionsJtsOperationBufferValidateBufferResultValidator_set_errorMsg_(self, nil);
  ComVividsolutionsJtsOperationBufferValidateBufferResultValidator_set_errorLocation_(self, nil);
  ComVividsolutionsJtsOperationBufferValidateBufferResultValidator_set_input_(self, input);
  self->distance_ = distance;
  ComVividsolutionsJtsOperationBufferValidateBufferResultValidator_set_result_(self, result);
}
...
void ComVividsolutionsJtsOperationBufferValidateBufferResultValidator_checkPolygonal(ComVividsolutionsJtsOperationBufferValidateBufferResultValidator *self) {
  ...
  ComVividsolutionsJtsOperationBufferValidateBufferResultValidator_set_errorMsg_(self, @"Result is not polygonal");
...
void ComVividsolutionsJtsOperationBufferValidateBufferResultValidator_checkExpectedEmpty(ComVividsolutionsJtsOperationBufferValidateBufferResultValidator *self) {
  ...
  if (![((ComVividsolutionsJtsGeomGeometry *) nil_chk(self->result_)) isEmpty]) {
    self->isValid__ = NO;
    ComVividsolutionsJtsOperationBufferValidateBufferResultValidator_set_errorMsg_(self, @"Result is non-empty");
  }
...
void ComVividsolutionsJtsOperationBufferValidateBufferResultValidator_checkEnvelope(ComVividsolutionsJtsOperationBufferValidateBufferResultValidator *self) {
  ...
  ComVividsolutionsJtsGeomEnvelope *expectedEnv = [new_ComVividsolutionsJtsGeomEnvelope_initWithComVividsolutionsJtsGeomEnvelope_([((ComVividsolutionsJtsGeomGeometry *) nil_chk(self->input_)) getEnvelopeInternal]) autorelease];
  [expectedEnv expandByWithDouble:self->distance_];
  ComVividsolutionsJtsGeomEnvelope *bufEnv = [new_ComVividsolutionsJtsGeomEnvelope_initWithComVividsolutionsJtsGeomEnvelope_([((ComVividsolutionsJtsGeomGeometry *) nil_chk(self->result_)) getEnvelopeInternal]) autorelease];
  [bufEnv expandByWithDouble:padding];
  if (![bufEnv containsWithComVividsolutionsJtsGeomEnvelope:expectedEnv]) {
    self->isValid__ = NO;
    ComVividsolutionsJtsOperationBufferValidateBufferResultValidator_set_errorMsg_(self, @"Buffer envelope is incorrect");
  }
...
void ComVividsolutionsJtsOperationBufferValidateBufferResultValidator_checkArea(ComVividsolutionsJtsOperationBufferValidateBufferResultValidator *self) {
  ...
  if (self->distance_ > 0.0 && inputArea > resultArea) {
    self->isValid__ = NO;
    ComVividsolutionsJtsOperationBufferValidateBufferResultValidator_set_errorMsg_(self, @"Area of positive buffer is smaller than input");
  }
  if (self->distance_ < 0.0 && inputArea < resultArea) {
    self->isValid__ = NO;
    ComVividsolutionsJtsOperationBufferValidateBufferResultValidator_set_errorMsg_(self, @"Area of negative buffer is larger than input");
  }
...
void ComVividsolutionsJtsOperationBufferValidateBufferResultValidator_checkDistance(ComVividsolutionsJtsOperationBufferValidateBufferResultValidator *self) {
  ComVividsolutionsJtsOperationBufferValidateBufferDistanceValidator *distValid = [new_ComVividsolutionsJtsOperationBufferValidateBufferDistanceValidator_initWithComVividsolutionsJtsGeomGeometry_withDouble_withComVividsolutionsJtsGeomGeometry_(self->input_, self->distance_, self->result_) autorelease];
  if (![distValid isValid]) {
    self->isValid__ = NO;
    ComVividsolutionsJtsOperationBufferValidateBufferResultValidator_set_errorMsg_(self, [distValid getErrorMessage]);
    ComVividsolutionsJtsOperationBufferValidateBufferResultValidator_set_errorLocation_(self, [distValid getErrorLocation]);
  }
