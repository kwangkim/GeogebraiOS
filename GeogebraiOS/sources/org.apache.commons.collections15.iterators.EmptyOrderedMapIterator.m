...
+ (void)initialize {
  if (self == [OrgApacheCommonsCollections15IteratorsEmptyOrderedMapIterator class]) {
    JreStrongAssignAndConsume(&OrgApacheCommonsCollections15IteratorsEmptyOrderedMapIterator_INSTANCE_, nil, new_OrgApacheCommonsCollections15IteratorsEmptyOrderedMapIterator_init());
