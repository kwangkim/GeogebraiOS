...
- (void)addWithComVividsolutionsJtsGeomGeometry:(ComVividsolutionsJtsGeomGeometry *)geometry {
  [((ComVividsolutionsJtsGeomGeometry *) nil_chk(geometry)) applyWithComVividsolutionsJtsGeomGeometryComponentFilter:[new_ComVividsolutionsJtsOperationLinemergeLineSequencer_$1_initWithComVividsolutionsJtsOperationLinemergeLineSequencer_(self) autorelease]];
}
...
jboolean ComVividsolutionsJtsOperationLinemergeLineSequencer_isSequencedWithComVividsolutionsJtsGeomGeometry_(ComVividsolutionsJtsGeomGeometry *geom) {
  ...
  id<JavaUtilSet> prevSubgraphNodes = [new_JavaUtilTreeSet_init() autorelease];
  ComVividsolutionsJtsGeomCoordinate *lastNode = nil;
  id<JavaUtilList> currNodes = [new_JavaUtilArrayList_init() autorelease];
...
void ComVividsolutionsJtsOperationLinemergeLineSequencer_addLineWithComVividsolutionsJtsGeomLineString_(ComVividsolutionsJtsOperationLinemergeLineSequencer *self, ComVividsolutionsJtsGeomLineString *lineString) {
  if (self->factory_ == nil) {
    ComVividsolutionsJtsOperationLinemergeLineSequencer_set_factory_(self, [((ComVividsolutionsJtsGeomLineString *) nil_chk(lineString)) getFactory]);
  }
...
void ComVividsolutionsJtsOperationLinemergeLineSequencer_computeSequence(ComVividsolutionsJtsOperationLinemergeLineSequencer *self) {
  ...
  ComVividsolutionsJtsOperationLinemergeLineSequencer_set_sequencedGeometry_(self, ComVividsolutionsJtsOperationLinemergeLineSequencer_buildSequencedGeometryWithJavaUtilList_(self, sequences));
...
id<JavaUtilList> ComVividsolutionsJtsOperationLinemergeLineSequencer_findSequences(ComVividsolutionsJtsOperationLinemergeLineSequencer *self) {
  id<JavaUtilList> sequences = [new_JavaUtilArrayList_init() autorelease];
  ComVividsolutionsJtsPlanargraphAlgorithmConnectedSubgraphFinder *csFinder = [new_ComVividsolutionsJtsPlanargraphAlgorithmConnectedSubgraphFinder_initWithComVividsolutionsJtsPlanargraphPlanarGraph_(self->graph_) autorelease];
...
id<JavaUtilList> ComVividsolutionsJtsOperationLinemergeLineSequencer_findSequenceWithComVividsolutionsJtsPlanargraphSubgraph_(ComVividsolutionsJtsOperationLinemergeLineSequencer *self, ComVividsolutionsJtsPlanargraphSubgraph *graph) {
  ...
  id<JavaUtilList> seq = [new_JavaUtilLinkedList_init() autorelease];
...
id<JavaUtilList> ComVividsolutionsJtsOperationLinemergeLineSequencer_reverseWithJavaUtilList_(ComVividsolutionsJtsOperationLinemergeLineSequencer *self, id<JavaUtilList> seq) {
  JavaUtilLinkedList *newSeq = [new_JavaUtilLinkedList_init() autorelease];
...
ComVividsolutionsJtsGeomGeometry *ComVividsolutionsJtsOperationLinemergeLineSequencer_buildSequencedGeometryWithJavaUtilList_(ComVividsolutionsJtsOperationLinemergeLineSequencer *self, id<JavaUtilList> sequences) {
  ...
  if ([lines size] == 0) return [((ComVividsolutionsJtsGeomGeometryFactory *) nil_chk(self->factory_)) createMultiLineStringWithComVividsolutionsJtsGeomLineStringArray:[IOSObjectArray arrayWithLength:0 type:ComVividsolutionsJtsGeomLineString_class_()]];
...
ComVividsolutionsJtsGeomLineString *ComVividsolutionsJtsOperationLinemergeLineSequencer_reverseWithComVividsolutionsJtsGeomLineString_(ComVividsolutionsJtsGeomLineString *line) {
  ...
  IOSObjectArray *revPts = [IOSObjectArray arrayWithLength:((IOSObjectArray *) nil_chk(pts))->size_ type:ComVividsolutionsJtsGeomCoordinate_class_()];
  jint len = pts->size_;
  for (jint i = 0; i < len; i++) {
    IOSObjectArray_SetAndConsume(revPts, len - 1 - i, new_ComVividsolutionsJtsGeomCoordinate_initWithComVividsolutionsJtsGeomCoordinate_(IOSObjectArray_Get(pts, i)));
  }
...
void ComVividsolutionsJtsOperationLinemergeLineSequencer_init(ComVividsolutionsJtsOperationLinemergeLineSequencer *self) {
  NSObject_init(self);
  ComVividsolutionsJtsOperationLinemergeLineSequencer_setAndConsume_graph_(self, new_ComVividsolutionsJtsOperationLinemergeLineMergeGraph_init());
  ComVividsolutionsJtsOperationLinemergeLineSequencer_setAndConsume_factory_(self, new_ComVividsolutionsJtsGeomGeometryFactory_init());
  self->lineCount_ = 0;
  self->isRun_ = NO;
  ComVividsolutionsJtsOperationLinemergeLineSequencer_set_sequencedGeometry_(self, nil);
...
void ComVividsolutionsJtsOperationLinemergeLineSequencer_$1_initWithComVividsolutionsJtsOperationLinemergeLineSequencer_(ComVividsolutionsJtsOperationLinemergeLineSequencer_$1 *self, ComVividsolutionsJtsOperationLinemergeLineSequencer *outer$) {
  ComVividsolutionsJtsOperationLinemergeLineSequencer_$1_set_this$0_(self, outer$);
  NSObject_init(self);
}
