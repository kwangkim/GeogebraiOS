...
@interface GeogebraCommonEuclidianDrawDrawIntegral () {
 @public
...
J2OBJC_FIELD_SETTER(GeogebraCommonEuclidianDrawDrawIntegral, n_, GeogebraCommonKernelGeosGeoNumeric *)
J2OBJC_FIELD_SETTER(GeogebraCommonEuclidianDrawDrawIntegral, f_, GeogebraCommonKernelGeosGeoFunction *)
J2OBJC_FIELD_SETTER(GeogebraCommonEuclidianDrawDrawIntegral, a_, id<GeogebraCommonKernelArithmeticNumberValue>)
J2OBJC_FIELD_SETTER(GeogebraCommonEuclidianDrawDrawIntegral, b_, id<GeogebraCommonKernelArithmeticNumberValue>)
J2OBJC_FIELD_SETTER(GeogebraCommonEuclidianDrawDrawIntegral, gp_, GeogebraCommonEuclidianPlotGeneralPathClippedForCurvePlotter *)

__attribute__((unused)) static void GeogebraCommonEuclidianDrawDrawIntegral_init__(GeogebraCommonEuclidianDrawDrawIntegral *self);

__attribute__((unused)) static void GeogebraCommonEuclidianDrawDrawIntegral_initFromCasObject(GeogebraCommonEuclidianDrawDrawIntegral *self);

__attribute__((unused)) static void GeogebraCommonEuclidianDrawDrawIntegral_update(GeogebraCommonEuclidianDrawDrawIntegral *self);

@implementation GeogebraCommonEuclidianDrawDrawIntegral
...
- (instancetype)initWithGeogebraCommonEuclidianEuclidianView:(GeogebraCommonEuclidianEuclidianView *)view
  ...
  GeogebraCommonEuclidianDrawDrawIntegral_initWithGeogebraCommonEuclidianEuclidianView_withGeogebraCommonKernelGeosGeoNumeric_withBoolean_(self, view, n, casObject);
  return self;
}

- (void)init__ {
  GeogebraCommonEuclidianDrawDrawIntegral_init__(self);
}

- (void)initFromCasObject {
  GeogebraCommonEuclidianDrawDrawIntegral_initFromCasObject(self);
}

- (void)update {
  GeogebraCommonEuclidianDrawDrawIntegral_update(self);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithGeogebraCommonEuclidianEuclidianView:withGeogebraCommonKernelGeosGeoNumeric:withBoolean:", "DrawIntegral", NULL, 0x1, NULL, NULL },
  ...
  static const J2ObjcClassInfo _GeogebraCommonEuclidianDrawDrawIntegral = { 2, "DrawIntegral", "geogebra.common.euclidian.draw", NULL, 0x1, 11, methods, 8, fields, 0, NULL, 0, NULL, NULL, NULL };
  return &_GeogebraCommonEuclidianDrawDrawIntegral;
}

@end

void GeogebraCommonEuclidianDrawDrawIntegral_initWithGeogebraCommonEuclidianEuclidianView_withGeogebraCommonKernelGeosGeoNumeric_withBoolean_(GeogebraCommonEuclidianDrawDrawIntegral *self, GeogebraCommonEuclidianEuclidianView *view, GeogebraCommonKernelGeosGeoNumeric *n, jboolean casObject) {
  GeogebraCommonEuclidianDrawable_init(self);
  GeogebraCommonEuclidianDrawable_set_view_(self, view);
  GeogebraCommonEuclidianDrawDrawIntegral_set_n_(self, n);
...
GeogebraCommonEuclidianDrawDrawIntegral *new_GeogebraCommonEuclidianDrawDrawIntegral_initWithGeogebraCommonEuclidianEuclidianView_withGeogebraCommonKernelGeosGeoNumeric_withBoolean_(GeogebraCommonEuclidianEuclidianView *view, GeogebraCommonKernelGeosGeoNumeric *n, jboolean casObject) {
  GeogebraCommonEuclidianDrawDrawIntegral *self = [GeogebraCommonEuclidianDrawDrawIntegral alloc];
  GeogebraCommonEuclidianDrawDrawIntegral_initWithGeogebraCommonEuclidianEuclidianView_withGeogebraCommonKernelGeosGeoNumeric_withBoolean_(self, view, n, casObject);
  return self;
}

void GeogebraCommonEuclidianDrawDrawIntegral_init__(GeogebraCommonEuclidianDrawDrawIntegral *self) {
  if (self->isCasObject_) {
    GeogebraCommonEuclidianDrawDrawIntegral_initFromCasObject(self);
    return;
  }
  GeogebraCommonKernelCasAlgoIntegralDefinite *algo = (GeogebraCommonKernelCasAlgoIntegralDefinite *) check_class_cast([((GeogebraCommonKernelGeosGeoNumeric *) nil_chk(self->n_)) getDrawAlgorithm], [GeogebraCommonKernelCasAlgoIntegralDefinite class]);
  GeogebraCommonEuclidianDrawDrawIntegral_set_f_(self, [((GeogebraCommonKernelCasAlgoIntegralDefinite *) nil_chk(algo)) getFunction]);
  GeogebraCommonEuclidianDrawDrawIntegral_set_a_(self, [algo getA]);
  GeogebraCommonEuclidianDrawDrawIntegral_set_b_(self, [algo getB]);
}

void GeogebraCommonEuclidianDrawDrawIntegral_initFromCasObject(GeogebraCommonEuclidianDrawDrawIntegral *self) {
  ...
  GeogebraCommonEuclidianDrawDrawIntegral_setAndConsume_f_(self, new_GeogebraCommonKernelGeosGeoFunction_initWithGeogebraCommonKernelConstruction_withGeogebraCommonKernelArithmeticFunction_([((GeogebraCommonKernelKernel *) nil_chk(kernel)) getConstruction], [new_GeogebraCommonKernelArithmeticFunction_initWithGeogebraCommonKernelArithmeticExpressionNode_([((GeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((GeogebraCommonKernelArithmeticExpressionNode *) nil_chk([cmd getArgumentWithInt:0])) wrap])) replaceCasCommands]) autorelease]));
  GeogebraCommonEuclidianDrawDrawIntegral_setAndConsume_a_(self, new_GeogebraCommonKernelArithmeticMyDouble_initWithGeogebraCommonKernelKernel_withDouble_([cmd getKernel], [((GeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((GeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((GeogebraCommonKernelArithmeticExpressionNode *) nil_chk([cmd getArgumentWithInt:1])) wrap])) replaceCasCommands])) evaluateDouble]));
  GeogebraCommonEuclidianDrawDrawIntegral_setAndConsume_b_(self, new_GeogebraCommonKernelArithmeticMyDouble_initWithGeogebraCommonKernelKernel_withDouble_([cmd getKernel], [((GeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((GeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((GeogebraCommonKernelArithmeticExpressionNode *) nil_chk([cmd getArgumentWithInt:2])) wrap])) replaceCasCommands])) evaluateDouble]));
}

void GeogebraCommonEuclidianDrawDrawIntegral_update(GeogebraCommonEuclidianDrawDrawIntegral *self) {
  ...
  if (![((GeogebraCommonKernelAlgosAlgoElement *) nil_chk([self->geo_ getDrawAlgorithm])) isEqual:[self->geo_ getParentAlgorithm]] || self->isCasObject_) GeogebraCommonEuclidianDrawDrawIntegral_init__(self);
  if (self->gp_ == nil) GeogebraCommonEuclidianDrawDrawIntegral_setAndConsume_gp_(self, new_GeogebraCommonEuclidianPlotGeneralPathClippedForCurvePlotter_initWithGeogebraCommonEuclidianEuclidianViewInterfaceSlim_(self->view_));
  else [self->gp_ reset];
  ...
  if (GeogebraCommonKernelKernel_isEqualWithDouble_withDouble_(aRW, bRW)) {
    [((GeogebraCommonEuclidianPlotGeneralPathClippedForCurvePlotter *) nil_chk(self->gp_)) moveToWithDouble:ax withDouble:y0];
    [self->gp_ lineToWithDouble:ax withDouble:[self->view_ toScreenCoordYdWithDouble:[((GeogebraCommonKernelGeosGeoFunction *) nil_chk(self->f_)) evaluateWithDouble:aRW]]];
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(GeogebraCommonEuclidianDrawDrawIntegral)
