...
+ (void)initialize {
  if (self == [OrgApacheCommonsMathAnalysisPolynomialsPolynomialsUtils class]) {
    {
      JreStrongAssignAndConsume(&OrgApacheCommonsMathAnalysisPolynomialsPolynomialsUtils_CHEBYSHEV_COEFFICIENTS_, nil, new_JavaUtilArrayList_init());
      ...
      [OrgApacheCommonsMathAnalysisPolynomialsPolynomialsUtils_CHEBYSHEV_COEFFICIENTS_ addWithId:OrgApacheCommonsMathFractionBigFraction_get_ONE_()];
      JreStrongAssignAndConsume(&OrgApacheCommonsMathAnalysisPolynomialsPolynomialsUtils_HERMITE_COEFFICIENTS_, nil, new_JavaUtilArrayList_init());
      ...
      JreStrongAssignAndConsume(&OrgApacheCommonsMathAnalysisPolynomialsPolynomialsUtils_LAGUERRE_COEFFICIENTS_, nil, new_JavaUtilArrayList_init());
      ...
      JreStrongAssignAndConsume(&OrgApacheCommonsMathAnalysisPolynomialsPolynomialsUtils_LEGENDRE_COEFFICIENTS_, nil, new_JavaUtilArrayList_init());
...
OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction *OrgApacheCommonsMathAnalysisPolynomialsPolynomialsUtils_createHermitePolynomialWithInt_(jint degree) {
  OrgApacheCommonsMathAnalysisPolynomialsPolynomialsUtils_initialize();
  return OrgApacheCommonsMathAnalysisPolynomialsPolynomialsUtils_buildPolynomialWithInt_withJavaUtilArrayList_withOrgApacheCommonsMathAnalysisPolynomialsPolynomialsUtils_RecurrenceCoefficientsGenerator_(degree, OrgApacheCommonsMathAnalysisPolynomialsPolynomialsUtils_HERMITE_COEFFICIENTS_, [new_OrgApacheCommonsMathAnalysisPolynomialsPolynomialsUtils_$2_init() autorelease]);
}
...
OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction *OrgApacheCommonsMathAnalysisPolynomialsPolynomialsUtils_createLaguerrePolynomialWithInt_(jint degree) {
  OrgApacheCommonsMathAnalysisPolynomialsPolynomialsUtils_initialize();
  return OrgApacheCommonsMathAnalysisPolynomialsPolynomialsUtils_buildPolynomialWithInt_withJavaUtilArrayList_withOrgApacheCommonsMathAnalysisPolynomialsPolynomialsUtils_RecurrenceCoefficientsGenerator_(degree, OrgApacheCommonsMathAnalysisPolynomialsPolynomialsUtils_LAGUERRE_COEFFICIENTS_, [new_OrgApacheCommonsMathAnalysisPolynomialsPolynomialsUtils_$3_init() autorelease]);
}
...
OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction *OrgApacheCommonsMathAnalysisPolynomialsPolynomialsUtils_buildPolynomialWithInt_withJavaUtilArrayList_withOrgApacheCommonsMathAnalysisPolynomialsPolynomialsUtils_RecurrenceCoefficientsGenerator_(jint degree, JavaUtilArrayList *coefficients, id<OrgApacheCommonsMathAnalysisPolynomialsPolynomialsUtils_RecurrenceCoefficientsGenerator> generator) {
  ...
  IOSDoubleArray *a = [IOSDoubleArray arrayWithLength:degree + 1];
  ...
  return [new_OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction_initWithDoubleArray_(a) autorelease];
}
...
void OrgApacheCommonsMathAnalysisPolynomialsPolynomialsUtils_$1_init(OrgApacheCommonsMathAnalysisPolynomialsPolynomialsUtils_$1 *self) {
  NSObject_init(self);
  OrgApacheCommonsMathAnalysisPolynomialsPolynomialsUtils_$1_setAndConsume_coeffs_(self, [IOSObjectArray newArrayWithObjects:(id[]){ OrgApacheCommonsMathFractionBigFraction_get_ZERO_(), OrgApacheCommonsMathFractionBigFraction_get_TWO_(), OrgApacheCommonsMathFractionBigFraction_get_ONE_() } count:3 type:OrgApacheCommonsMathFractionBigFraction_class_()]);
}
...
- (IOSObjectArray *)generateWithInt:(jint)k {
  return [IOSObjectArray arrayWithObjects:(id[]){ OrgApacheCommonsMathFractionBigFraction_get_ZERO_(), OrgApacheCommonsMathFractionBigFraction_get_TWO_(), [new_OrgApacheCommonsMathFractionBigFraction_initWithInt_(2 * k) autorelease] } count:3 type:OrgApacheCommonsMathFractionBigFraction_class_()];
}
...
- (IOSObjectArray *)generateWithInt:(jint)k {
  jint kP1 = k + 1;
  return [IOSObjectArray arrayWithObjects:(id[]){ [new_OrgApacheCommonsMathFractionBigFraction_initWithInt_withInt_(2 * k + 1, kP1) autorelease], [new_OrgApacheCommonsMathFractionBigFraction_initWithInt_withInt_(-1, kP1) autorelease], [new_OrgApacheCommonsMathFractionBigFraction_initWithInt_withInt_(k, kP1) autorelease] } count:3 type:OrgApacheCommonsMathFractionBigFraction_class_()];
}
...
- (IOSObjectArray *)generateWithInt:(jint)k {
  jint kP1 = k + 1;
  return [IOSObjectArray arrayWithObjects:(id[]){ OrgApacheCommonsMathFractionBigFraction_get_ZERO_(), [new_OrgApacheCommonsMathFractionBigFraction_initWithInt_withInt_(k + kP1, kP1) autorelease], [new_OrgApacheCommonsMathFractionBigFraction_initWithInt_withInt_(k, kP1) autorelease] } count:3 type:OrgApacheCommonsMathFractionBigFraction_class_()];
}
