...
//  source: /Users/jacky/GSoC/geogebra_iOS/geogebra/geogebra/common/src/org/apache/commons/math/stat/regression/AbstractMultipleLinearRegression.java
//
...
- (void)newSampleDataWithDoubleArray:(IOSDoubleArray *)data
                             ...
                             withInt:(jint)nvars {
  if (data == nil) {
    @throw OrgApacheCommonsMathMathRuntimeException_createIllegalArgumentExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_NULL_NOT_ALLOWED(), [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
  }
  ...
  if (nobs <= nvars) {
    @throw OrgApacheCommonsMathMathRuntimeException_createIllegalArgumentExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_NOT_ENOUGH_DATA_FOR_NUMBER_OF_PREDICTORS(), [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
  }
  IOSDoubleArray *y = [IOSDoubleArray arrayWithLength:nobs];
  jint cols = noIntercept_ ? nvars : nvars + 1;
  IOSObjectArray *x = [IOSDoubleArray arrayWithDimensions:2 lengths:(jint[]){ nobs, cols }];
  jint pointer = 0;
  ...
  OrgApacheCommonsMathStatRegressionAbstractMultipleLinearRegression_setAndConsume_X_(self, new_OrgApacheCommonsMathLinearArray2DRowRealMatrix_initWithDoubleArray2_(x));
  OrgApacheCommonsMathStatRegressionAbstractMultipleLinearRegression_setAndConsume_Y_(self, new_OrgApacheCommonsMathLinearArrayRealVector_initWithDoubleArray_(y));
}
...
- (void)newXSampleDataWithDoubleArray2:(IOSObjectArray *)x {
  ...
  if (noIntercept_) {
    OrgApacheCommonsMathStatRegressionAbstractMultipleLinearRegression_setAndConsume_X_(self, new_OrgApacheCommonsMathLinearArray2DRowRealMatrix_initWithDoubleArray2_withBoolean_(x, YES));
  }
  else {
    jint nVars = ((IOSDoubleArray *) nil_chk(IOSObjectArray_Get(x, 0)))->size_;
    IOSObjectArray *xAug = [IOSDoubleArray arrayWithDimensions:2 lengths:(jint[]){ x->size_, nVars + 1 }];
    ...
    OrgApacheCommonsMathStatRegressionAbstractMultipleLinearRegression_setAndConsume_X_(self, new_OrgApacheCommonsMathLinearArray2DRowRealMatrix_initWithDoubleArray2_withBoolean_(xAug, NO));
  }
}
...
- (void)validateSampleDataWithDoubleArray2:(IOSObjectArray *)x
  ...
  if (((IOSDoubleArray *) nil_chk(IOSObjectArray_Get(x, 0)))->size_ + 1 > x->size_) {
    @throw OrgApacheCommonsMathMathRuntimeException_createIllegalArgumentExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_NOT_ENOUGH_DATA_FOR_NUMBER_OF_PREDICTORS(), [IOSObjectArray arrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(x->size_), JavaLangInteger_valueOfWithInt_(((IOSDoubleArray *) nil_chk(IOSObjectArray_Get(x, 0)))->size_) } count:2 type:NSObject_class_()]);
  }
}
...
- (jdouble)calculateYVariance {
  return [((OrgApacheCommonsMathStatDescriptiveMomentVariance *) [new_OrgApacheCommonsMathStatDescriptiveMomentVariance_init() autorelease]) evaluateWithDoubleArray:[((id<OrgApacheCommonsMathLinearRealVector>) nil_chk(Y_)) getData]];
}
