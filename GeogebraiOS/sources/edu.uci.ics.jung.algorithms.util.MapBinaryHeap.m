...
- (id)element {
  id top = [self peek];
  if (top == nil) @throw [new_JavaUtilNoSuchElementException_init() autorelease];
  return top;
}
...
- (id)poll {
  ...
  if (top != nil) {
    ...
    [((id<JavaUtilMap>) nil_chk(object_indices_)) putWithId:bottom_elt withId:[new_JavaLangInteger_initWithInt_(EduUciIcsJungAlgorithmsUtilMapBinaryHeap_TOP) autorelease]];
    ...
    [object_indices_ removeWithId:top];
  }
  return top;
}
...
void EduUciIcsJungAlgorithmsUtilMapBinaryHeap_initWithJavaUtilComparator_(EduUciIcsJungAlgorithmsUtilMapBinaryHeap *self, id<JavaUtilComparator> comp) {
  ...
  EduUciIcsJungAlgorithmsUtilMapBinaryHeap_setAndConsume_heap_(self, new_JavaUtilVector_init());
  EduUciIcsJungAlgorithmsUtilMapBinaryHeap_setAndConsume_object_indices_(self, new_JavaUtilHashMap_init());
  EduUciIcsJungAlgorithmsUtilMapBinaryHeap_initialize__WithJavaUtilComparator_(self, comp);
}
...
void EduUciIcsJungAlgorithmsUtilMapBinaryHeap_init(EduUciIcsJungAlgorithmsUtilMapBinaryHeap *self) {
  ...
  EduUciIcsJungAlgorithmsUtilMapBinaryHeap_setAndConsume_heap_(self, new_JavaUtilVector_init());
  EduUciIcsJungAlgorithmsUtilMapBinaryHeap_setAndConsume_object_indices_(self, new_JavaUtilHashMap_init());
  EduUciIcsJungAlgorithmsUtilMapBinaryHeap_initialize__WithJavaUtilComparator_(self, [new_EduUciIcsJungAlgorithmsUtilMapBinaryHeap_ComparableComparator_initWithEduUciIcsJungAlgorithmsUtilMapBinaryHeap_(self) autorelease]);
}
...
void EduUciIcsJungAlgorithmsUtilMapBinaryHeap_initialize__WithJavaUtilComparator_(EduUciIcsJungAlgorithmsUtilMapBinaryHeap *self, id<JavaUtilComparator> comp) {
  EduUciIcsJungAlgorithmsUtilMapBinaryHeap_set_comp_(self, comp);
  [self clear];
}
...
jint EduUciIcsJungAlgorithmsUtilMapBinaryHeap_percolateUpWithInt_withId_(EduUciIcsJungAlgorithmsUtilMapBinaryHeap *self, jint cur, id o) {
  ...
  while ((i > EduUciIcsJungAlgorithmsUtilMapBinaryHeap_TOP) && ([((id<JavaUtilComparator>) nil_chk(self->comp_)) compareWithId:[((JavaUtilVector *) nil_chk(self->heap_)) elementAtWithInt:EduUciIcsJungAlgorithmsUtilMapBinaryHeap_parentWithInt_(self, i)] withId:o] > 0)) {
    ...
    [((id<JavaUtilMap>) nil_chk(self->object_indices_)) putWithId:parentElt withId:[new_JavaLangInteger_initWithInt_(i) autorelease]];
    i = EduUciIcsJungAlgorithmsUtilMapBinaryHeap_parentWithInt_(self, i);
  }
  [((id<JavaUtilMap>) nil_chk(self->object_indices_)) putWithId:o withId:[new_JavaLangInteger_initWithInt_(i) autorelease]];
...
void EduUciIcsJungAlgorithmsUtilMapBinaryHeap_swapWithInt_withInt_(EduUciIcsJungAlgorithmsUtilMapBinaryHeap *self, jint i, jint j) {
  ...
  [((id<JavaUtilMap>) nil_chk(self->object_indices_)) putWithId:jElt withId:[new_JavaLangInteger_initWithInt_(i) autorelease]];
  [self->heap_ setElementAtWithId:iElt withInt:j];
  [self->object_indices_ putWithId:iElt withId:[new_JavaLangInteger_initWithInt_(j) autorelease]];
}
...
- (jint)compareWithId:(id)arg0
               withId:(id)arg1 {
  if (!([JavaLangComparable_class_() isInstance:arg0]) || !([JavaLangComparable_class_() isInstance:arg1])) @throw [new_JavaLangIllegalArgumentException_initWithNSString_(@"Arguments must be Comparable") autorelease];
