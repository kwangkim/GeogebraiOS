...
//  source: /Users/jacky/GSoC/geogebra_iOS/geogebra/geogebra/common/src/org/apache/commons/math/optimization/fitting/ParametricGaussianFunction.java
//
...
- (IOSDoubleArray *)gradientWithDouble:(jdouble)x
  ...
  return [IOSDoubleArray arrayWithDoubles:(jdouble[]){ 1.0, exp, f, f * xMc / d } count:4];
}
