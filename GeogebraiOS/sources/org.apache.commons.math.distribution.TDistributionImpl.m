...
void OrgApacheCommonsMathDistributionTDistributionImpl_initWithDouble_(OrgApacheCommonsMathDistributionTDistributionImpl *self, jdouble degreesOfFreedom) {
  OrgApacheCommonsMathDistributionTDistributionImpl_initWithDouble_withDouble_(self, degreesOfFreedom, OrgApacheCommonsMathDistributionTDistributionImpl_DEFAULT_INVERSE_ABSOLUTE_ACCURACY);
}
