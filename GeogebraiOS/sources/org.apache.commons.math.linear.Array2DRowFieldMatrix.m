...
- (id<OrgApacheCommonsMathLinearFieldMatrix>)createMatrixWithInt:(jint)rowDimension
                                                         withInt:(jint)columnDimension {
  return [new_OrgApacheCommonsMathLinearArray2DRowFieldMatrix_initWithOrgApacheCommonsMathField_withInt_withInt_([self getField], rowDimension, columnDimension) autorelease];
}

- (id<OrgApacheCommonsMathLinearFieldMatrix>)copy__ {
  return [new_OrgApacheCommonsMathLinearArray2DRowFieldMatrix_initWithOrgApacheCommonsMathFieldElementArray2_withBoolean_(OrgApacheCommonsMathLinearArray2DRowFieldMatrix_copyOut(self), NO) autorelease];
}
...
- (OrgApacheCommonsMathLinearArray2DRowFieldMatrix *)addWithOrgApacheCommonsMathLinearArray2DRowFieldMatrix:(OrgApacheCommonsMathLinearArray2DRowFieldMatrix *)m {
  ...
  for (jint row = 0; row < rowCount; row++) {
    ...
    for (jint col = 0; col < columnCount; col++) {
      IOSObjectArray_Set(nil_chk(outDataRow), col, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(nil_chk(dataRow), col))) addWithId:IOSObjectArray_Get(nil_chk(mRow), col)]);
    }
  }
  return [new_OrgApacheCommonsMathLinearArray2DRowFieldMatrix_initWithOrgApacheCommonsMathFieldElementArray2_withBoolean_(outData, NO) autorelease];
}
...
- (OrgApacheCommonsMathLinearArray2DRowFieldMatrix *)subtractWithOrgApacheCommonsMathLinearArray2DRowFieldMatrix:(OrgApacheCommonsMathLinearArray2DRowFieldMatrix *)m {
  ...
  for (jint row = 0; row < rowCount; row++) {
    ...
    IOSObjectArray *outDataRow = IOSObjectArray_Get(nil_chk(outData), row);
    for (jint col = 0; col < columnCount; col++) {
      IOSObjectArray_Set(nil_chk(outDataRow), col, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(nil_chk(dataRow), col))) subtractWithId:IOSObjectArray_Get(nil_chk(mRow), col)]);
    }
  }
  return [new_OrgApacheCommonsMathLinearArray2DRowFieldMatrix_initWithOrgApacheCommonsMathFieldElementArray2_withBoolean_(outData, NO) autorelease];
}
...
- (void)setSubMatrixWithOrgApacheCommonsMathFieldElementArray2:(IOSObjectArray *)subMatrix
  ...
  if (data_ == nil) {
    ...
    OrgApacheCommonsMathLinearArray2DRowFieldMatrix_set_data_(self, OrgApacheCommonsMathLinearAbstractFieldMatrix_buildArrayWithOrgApacheCommonsMathField_withInt_withInt_([self getField], subMatrix->size_, nCols));
...
withOrgApacheCommonsMathFieldElement:(id<OrgApacheCommonsMathFieldElement>)value {
  @try {
    IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(nil_chk(data_), row)), column, value);
  }
  @catch (JavaLangArrayIndexOutOfBoundsException *e) {
    @throw [new_OrgApacheCommonsMathLinearMatrixIndexException_initWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_NO_SUCH_MATRIX_ENTRY(), [IOSObjectArray arrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(row), JavaLangInteger_valueOfWithInt_(column), JavaLangInteger_valueOfWithInt_([self getRowDimension]), JavaLangInteger_valueOfWithInt_([self getColumnDimension]) } count:4 type:NSObject_class_()]) autorelease];
  }
...
withOrgApacheCommonsMathFieldElement:(id<OrgApacheCommonsMathFieldElement>)increment {
  @try {
    IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(nil_chk(data_), row)), column, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(data_, row)), column))) addWithId:increment]);
  }
  @catch (JavaLangArrayIndexOutOfBoundsException *e) {
    @throw [new_OrgApacheCommonsMathLinearMatrixIndexException_initWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_NO_SUCH_MATRIX_ENTRY(), [IOSObjectArray arrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(row), JavaLangInteger_valueOfWithInt_(column), JavaLangInteger_valueOfWithInt_([self getRowDimension]), JavaLangInteger_valueOfWithInt_([self getColumnDimension]) } count:4 type:NSObject_class_()]) autorelease];
  }
...
withOrgApacheCommonsMathFieldElement:(id<OrgApacheCommonsMathFieldElement>)factor {
  @try {
    IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(nil_chk(data_), row)), column, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(data_, row)), column))) multiplyWithId:factor]);
  }
  @catch (JavaLangArrayIndexOutOfBoundsException *e) {
    @throw [new_OrgApacheCommonsMathLinearMatrixIndexException_initWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_NO_SUCH_MATRIX_ENTRY(), [IOSObjectArray arrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(row), JavaLangInteger_valueOfWithInt_(column), JavaLangInteger_valueOfWithInt_([self getRowDimension]), JavaLangInteger_valueOfWithInt_([self getColumnDimension]) } count:4 type:NSObject_class_()]) autorelease];
  }
...
- (id)walkInRowOrderWithOrgApacheCommonsMathLinearFieldMatrixChangingVisitor:(id<OrgApacheCommonsMathLinearFieldMatrixChangingVisitor>)visitor {
  ...
  for (jint i = 0; i < rows; ++i) {
    ...
    for (jint j = 0; j < columns; ++j) {
      IOSObjectArray_Set(nil_chk(rowI), j, [visitor visitWithInt:i withInt:j withOrgApacheCommonsMathFieldElement:IOSObjectArray_Get(rowI, j)]);
    }
  }
  return [visitor end];
}
...
void OrgApacheCommonsMathLinearArray2DRowFieldMatrix_initWithOrgApacheCommonsMathField_withInt_withInt_(OrgApacheCommonsMathLinearArray2DRowFieldMatrix *self, id<OrgApacheCommonsMathField> field, jint rowDimension, jint columnDimension) {
  ...
  OrgApacheCommonsMathLinearArray2DRowFieldMatrix_set_data_(self, OrgApacheCommonsMathLinearAbstractFieldMatrix_buildArrayWithOrgApacheCommonsMathField_withInt_withInt_(field, rowDimension, columnDimension));
}
...
void OrgApacheCommonsMathLinearArray2DRowFieldMatrix_initWithOrgApacheCommonsMathFieldElementArray2_(OrgApacheCommonsMathLinearArray2DRowFieldMatrix *self, IOSObjectArray *d) {
  OrgApacheCommonsMathLinearAbstractFieldMatrix_initWithOrgApacheCommonsMathField_(self, OrgApacheCommonsMathLinearAbstractFieldMatrix_extractFieldWithOrgApacheCommonsMathFieldElementArray2_(d));
...
void OrgApacheCommonsMathLinearArray2DRowFieldMatrix_initWithOrgApacheCommonsMathFieldElementArray2_withBoolean_(OrgApacheCommonsMathLinearArray2DRowFieldMatrix *self, IOSObjectArray *d, jboolean copyArray) {
  ...
  if (copyArray) {
    ...
    OrgApacheCommonsMathLinearArray2DRowFieldMatrix_set_data_(self, d);
  }
}
...
void OrgApacheCommonsMathLinearArray2DRowFieldMatrix_initWithOrgApacheCommonsMathFieldElementArray_(OrgApacheCommonsMathLinearArray2DRowFieldMatrix *self, IOSObjectArray *v) {
  OrgApacheCommonsMathLinearAbstractFieldMatrix_initWithOrgApacheCommonsMathField_(self, OrgApacheCommonsMathLinearAbstractFieldMatrix_extractFieldWithOrgApacheCommonsMathFieldElementArray_(v));
  jint nRows = ((IOSObjectArray *) nil_chk(v))->size_;
  OrgApacheCommonsMathLinearArray2DRowFieldMatrix_set_data_(self, OrgApacheCommonsMathLinearAbstractFieldMatrix_buildArrayWithOrgApacheCommonsMathField_withInt_withInt_([self getField], nRows, 1));
  for (jint row = 0; row < nRows; row++) {
    IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(nil_chk(self->data_), row)), 0, IOSObjectArray_Get(v, row));
  }
}
