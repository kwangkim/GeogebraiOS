...
- (IOSObjectArray *)getAllParameters {
  return [parameters_ toArrayWithNSObjectArray:[IOSObjectArray arrayWithLength:[((id<JavaUtilList>) nil_chk(parameters_)) size] type:OrgApacheCommonsMathEstimationEstimatedParameter_class_()]];
}

- (IOSObjectArray *)getUnboundParameters {
  id<JavaUtilList> unbound = [new_JavaUtilArrayList_initWithInt_([((id<JavaUtilList>) nil_chk(parameters_)) size]) autorelease];
  ...
  return [unbound toArrayWithNSObjectArray:[IOSObjectArray arrayWithLength:[unbound size] type:OrgApacheCommonsMathEstimationEstimatedParameter_class_()]];
}

- (IOSObjectArray *)getMeasurements {
  return [measurements_ toArrayWithNSObjectArray:[IOSObjectArray arrayWithLength:[((id<JavaUtilList>) nil_chk(measurements_)) size] type:OrgApacheCommonsMathEstimationWeightedMeasurement_class_()]];
}
...
void OrgApacheCommonsMathEstimationSimpleEstimationProblem_init(OrgApacheCommonsMathEstimationSimpleEstimationProblem *self) {
  NSObject_init(self);
  OrgApacheCommonsMathEstimationSimpleEstimationProblem_setAndConsume_parameters_(self, new_JavaUtilArrayList_init());
  OrgApacheCommonsMathEstimationSimpleEstimationProblem_setAndConsume_measurements_(self, new_JavaUtilArrayList_init());
}
