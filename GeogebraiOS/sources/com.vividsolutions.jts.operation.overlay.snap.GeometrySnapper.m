...
- (ComVividsolutionsJtsGeomGeometry *)snapToWithComVividsolutionsJtsGeomGeometry:(ComVividsolutionsJtsGeomGeometry *)snapGeom
  ...
  ComVividsolutionsJtsOperationOverlaySnapSnapTransformer *snapTrans = [new_ComVividsolutionsJtsOperationOverlaySnapSnapTransformer_initWithDouble_withComVividsolutionsJtsGeomCoordinateArray_(snapTolerance, snapPts) autorelease];
...
- (IOSObjectArray *)extractTargetCoordinatesWithComVividsolutionsJtsGeomGeometry:(ComVividsolutionsJtsGeomGeometry *)g {
  id<JavaUtilSet> ptSet = [new_JavaUtilTreeSet_init() autorelease];
  ...
  return (IOSObjectArray *) check_class_cast([ptSet toArrayWithNSObjectArray:[IOSObjectArray arrayWithLength:0 type:ComVividsolutionsJtsGeomCoordinate_class_()]], [IOSObjectArray class]);
}
...
IOSObjectArray *ComVividsolutionsJtsOperationOverlaySnapGeometrySnapper_snapWithComVividsolutionsJtsGeomGeometry_withComVividsolutionsJtsGeomGeometry_withDouble_(ComVividsolutionsJtsGeomGeometry *g0, ComVividsolutionsJtsGeomGeometry *g1, jdouble snapTolerance) {
  ComVividsolutionsJtsOperationOverlaySnapGeometrySnapper_initialize();
  IOSObjectArray *snapGeom = [IOSObjectArray arrayWithLength:2 type:ComVividsolutionsJtsGeomGeometry_class_()];
  ComVividsolutionsJtsOperationOverlaySnapGeometrySnapper *snapper0 = [new_ComVividsolutionsJtsOperationOverlaySnapGeometrySnapper_initWithComVividsolutionsJtsGeomGeometry_(g0) autorelease];
  IOSObjectArray_Set(snapGeom, 0, [snapper0 snapToWithComVividsolutionsJtsGeomGeometry:g1 withDouble:snapTolerance]);
  ComVividsolutionsJtsOperationOverlaySnapGeometrySnapper *snapper1 = [new_ComVividsolutionsJtsOperationOverlaySnapGeometrySnapper_initWithComVividsolutionsJtsGeomGeometry_(g1) autorelease];
  IOSObjectArray_Set(snapGeom, 1, [snapper1 snapToWithComVividsolutionsJtsGeomGeometry:IOSObjectArray_Get(snapGeom, 0) withDouble:snapTolerance]);
  return snapGeom;
}
...
void ComVividsolutionsJtsOperationOverlaySnapGeometrySnapper_initWithComVividsolutionsJtsGeomGeometry_(ComVividsolutionsJtsOperationOverlaySnapGeometrySnapper *self, ComVividsolutionsJtsGeomGeometry *srcGeom) {
  NSObject_init(self);
  ComVividsolutionsJtsOperationOverlaySnapGeometrySnapper_set_srcGeom_(self, srcGeom);
}
...
void ComVividsolutionsJtsOperationOverlaySnapSnapTransformer_initWithDouble_withComVividsolutionsJtsGeomCoordinateArray_(ComVividsolutionsJtsOperationOverlaySnapSnapTransformer *self, jdouble snapTolerance, IOSObjectArray *snapPts) {
  ...
  ComVividsolutionsJtsOperationOverlaySnapSnapTransformer_set_snapPts_(self, snapPts);
}
...
IOSObjectArray *ComVividsolutionsJtsOperationOverlaySnapSnapTransformer_snapLineWithComVividsolutionsJtsGeomCoordinateArray_withComVividsolutionsJtsGeomCoordinateArray_(ComVividsolutionsJtsOperationOverlaySnapSnapTransformer *self, IOSObjectArray *srcPts, IOSObjectArray *snapPts) {
  ComVividsolutionsJtsOperationOverlaySnapLineStringSnapper *snapper = [new_ComVividsolutionsJtsOperationOverlaySnapLineStringSnapper_initWithComVividsolutionsJtsGeomCoordinateArray_withDouble_(srcPts, self->snapTolerance_) autorelease];
