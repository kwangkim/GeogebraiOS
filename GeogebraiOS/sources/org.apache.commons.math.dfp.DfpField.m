...
- (void)setRoundingModeWithOrgApacheCommonsMathDfpDfpField_RoundingModeEnum:(OrgApacheCommonsMathDfpDfpField_RoundingModeEnum *)mode {
  OrgApacheCommonsMathDfpDfpField_set_rMode_(self, mode);
}
...
- (OrgApacheCommonsMathDfpDfp *)newDfp {
  return [new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_(self) autorelease];
}

- (OrgApacheCommonsMathDfpDfp *)newDfpWithByte:(jbyte)x {
  return [new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withByte_(self, x) autorelease];
}

- (OrgApacheCommonsMathDfpDfp *)newDfpWithInt:(jint)x {
  return [new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withInt_(self, x) autorelease];
}

- (OrgApacheCommonsMathDfpDfp *)newDfpWithLong:(jlong)x {
  return [new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withLong_(self, x) autorelease];
}

- (OrgApacheCommonsMathDfpDfp *)newDfpWithDouble:(jdouble)x {
  return [new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withDouble_(self, x) autorelease];
}
...
- (OrgApacheCommonsMathDfpDfp *)newDfpWithNSString:(NSString *)s {
  return [new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withNSString_(self, s) autorelease];
}

- (OrgApacheCommonsMathDfpDfp *)newDfpWithByte:(jbyte)sign
                                      withByte:(jbyte)nans {
  return [new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withByte_withByte_(self, sign, nans) autorelease];
}
...
- (void)dealloc {
  ...
  RELEASE_(sqr2_);
  RELEASE_(sqr2Split_);
  RELEASE_(sqr2Reciprocal_);
  RELEASE_(sqr3_);
  RELEASE_(sqr3Reciprocal_);
  RELEASE_(pi_);
  RELEASE_(piSplit_);
  RELEASE_(e_);
  RELEASE_(eSplit_);
...
void OrgApacheCommonsMathDfpDfpField_initWithInt_(OrgApacheCommonsMathDfpDfpField *self, jint decimalDigits) {
  OrgApacheCommonsMathDfpDfpField_initWithInt_withBoolean_(self, decimalDigits, YES);
}
...
void OrgApacheCommonsMathDfpDfpField_initWithInt_withBoolean_(OrgApacheCommonsMathDfpDfpField *self, jint decimalDigits, jboolean computeConstants) {
  ...
  OrgApacheCommonsMathDfpDfpField_set_rMode_(self, OrgApacheCommonsMathDfpDfpField_RoundingModeEnum_get_ROUND_HALF_EVEN());
  self->ieeeFlags_ = 0;
  OrgApacheCommonsMathDfpDfpField_setAndConsume_zero_(self, new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withInt_(self, 0));
  OrgApacheCommonsMathDfpDfpField_setAndConsume_one_(self, new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withInt_(self, 1));
  OrgApacheCommonsMathDfpDfpField_setAndConsume_two_(self, new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withInt_(self, 2));
  if (computeConstants) {
    @synchronized(OrgApacheCommonsMathDfpDfpField_class_()) {
      ...
      OrgApacheCommonsMathDfpDfpField_setAndConsume_sqr2_(self, new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withNSString_(self, OrgApacheCommonsMathDfpDfpField_sqr2String_));
      OrgApacheCommonsMathDfpDfpField_set_sqr2Split_(self, OrgApacheCommonsMathDfpDfpField_splitWithNSString_(self, OrgApacheCommonsMathDfpDfpField_sqr2String_));
      OrgApacheCommonsMathDfpDfpField_setAndConsume_sqr2Reciprocal_(self, new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withNSString_(self, OrgApacheCommonsMathDfpDfpField_sqr2ReciprocalString_));
      OrgApacheCommonsMathDfpDfpField_setAndConsume_sqr3_(self, new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withNSString_(self, OrgApacheCommonsMathDfpDfpField_sqr3String_));
      OrgApacheCommonsMathDfpDfpField_setAndConsume_sqr3Reciprocal_(self, new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withNSString_(self, OrgApacheCommonsMathDfpDfpField_sqr3ReciprocalString_));
      OrgApacheCommonsMathDfpDfpField_setAndConsume_pi_(self, new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withNSString_(self, OrgApacheCommonsMathDfpDfpField_piString_));
      OrgApacheCommonsMathDfpDfpField_set_piSplit_(self, OrgApacheCommonsMathDfpDfpField_splitWithNSString_(self, OrgApacheCommonsMathDfpDfpField_piString_));
      OrgApacheCommonsMathDfpDfpField_setAndConsume_e_(self, new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withNSString_(self, OrgApacheCommonsMathDfpDfpField_eString_));
      OrgApacheCommonsMathDfpDfpField_set_eSplit_(self, OrgApacheCommonsMathDfpDfpField_splitWithNSString_(self, OrgApacheCommonsMathDfpDfpField_eString_));
      OrgApacheCommonsMathDfpDfpField_setAndConsume_ln2_(self, new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withNSString_(self, OrgApacheCommonsMathDfpDfpField_ln2String_));
      OrgApacheCommonsMathDfpDfpField_set_ln2Split_(self, OrgApacheCommonsMathDfpDfpField_splitWithNSString_(self, OrgApacheCommonsMathDfpDfpField_ln2String_));
      OrgApacheCommonsMathDfpDfpField_setAndConsume_ln5_(self, new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withNSString_(self, OrgApacheCommonsMathDfpDfpField_ln5String_));
      OrgApacheCommonsMathDfpDfpField_set_ln5Split_(self, OrgApacheCommonsMathDfpDfpField_splitWithNSString_(self, OrgApacheCommonsMathDfpDfpField_ln5String_));
      OrgApacheCommonsMathDfpDfpField_setAndConsume_ln10_(self, new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withNSString_(self, OrgApacheCommonsMathDfpDfpField_ln10String_));
    }
  }
  else {
    OrgApacheCommonsMathDfpDfpField_set_sqr2_(self, nil);
    OrgApacheCommonsMathDfpDfpField_set_sqr2Split_(self, nil);
    OrgApacheCommonsMathDfpDfpField_set_sqr2Reciprocal_(self, nil);
    OrgApacheCommonsMathDfpDfpField_set_sqr3_(self, nil);
    OrgApacheCommonsMathDfpDfpField_set_sqr3Reciprocal_(self, nil);
    OrgApacheCommonsMathDfpDfpField_set_pi_(self, nil);
    OrgApacheCommonsMathDfpDfpField_set_piSplit_(self, nil);
    OrgApacheCommonsMathDfpDfpField_set_e_(self, nil);
    OrgApacheCommonsMathDfpDfpField_set_eSplit_(self, nil);
    OrgApacheCommonsMathDfpDfpField_set_ln2_(self, nil);
    OrgApacheCommonsMathDfpDfpField_set_ln2Split_(self, nil);
    OrgApacheCommonsMathDfpDfpField_set_ln5_(self, nil);
    OrgApacheCommonsMathDfpDfpField_set_ln5Split_(self, nil);
    OrgApacheCommonsMathDfpDfpField_set_ln10_(self, nil);
  }
}
...
IOSObjectArray *OrgApacheCommonsMathDfpDfpField_splitWithNSString_(OrgApacheCommonsMathDfpDfpField *self, NSString *a) {
  IOSObjectArray *result = [IOSObjectArray arrayWithLength:2 type:OrgApacheCommonsMathDfpDfp_class_()];
  jboolean leading = YES;
  jint sp = 0;
  jint sig = 0;
  IOSCharArray *buf = [IOSCharArray arrayWithLength:((jint) [((NSString *) nil_chk(a)) length])];
  ...
  IOSObjectArray_SetAndConsume(result, 0, new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withNSString_(self, [NSString stringWithCharacters:buf offset:0 length:sp]));
  for (jint i = 0; i < buf->size_; i++) {
    *IOSCharArray_GetRef(buf, i) = [a charAtWithInt:i];
  ...
  IOSObjectArray_SetAndConsume(result, 1, new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withNSString_(self, [NSString stringWithCharacters:buf]));
  return result;
}
...
void OrgApacheCommonsMathDfpDfpField_computeStringConstantsWithInt_(jint highPrecisionDecimalDigits) {
  ...
  if (OrgApacheCommonsMathDfpDfpField_sqr2String_ == nil || ((jint) [OrgApacheCommonsMathDfpDfpField_sqr2String_ length]) < highPrecisionDecimalDigits - 3) {
    OrgApacheCommonsMathDfpDfpField *highPrecisionField = [new_OrgApacheCommonsMathDfpDfpField_initWithInt_withBoolean_(highPrecisionDecimalDigits, NO) autorelease];
    OrgApacheCommonsMathDfpDfp *highPrecisionOne = [new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withInt_(highPrecisionField, 1) autorelease];
    OrgApacheCommonsMathDfpDfp *highPrecisionTwo = [new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withInt_(highPrecisionField, 2) autorelease];
    OrgApacheCommonsMathDfpDfp *highPrecisionThree = [new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withInt_(highPrecisionField, 3) autorelease];
    OrgApacheCommonsMathDfpDfp *highPrecisionSqr2 = [highPrecisionTwo sqrt];
    JreStrongAssign(&OrgApacheCommonsMathDfpDfpField_sqr2String_, nil, [((OrgApacheCommonsMathDfpDfp *) nil_chk(highPrecisionSqr2)) description]);
    JreStrongAssign(&OrgApacheCommonsMathDfpDfpField_sqr2ReciprocalString_, nil, [((OrgApacheCommonsMathDfpDfp *) nil_chk([highPrecisionOne divideWithId:highPrecisionSqr2])) description]);
    OrgApacheCommonsMathDfpDfp *highPrecisionSqr3 = [highPrecisionThree sqrt];
    JreStrongAssign(&OrgApacheCommonsMathDfpDfpField_sqr3String_, nil, [((OrgApacheCommonsMathDfpDfp *) nil_chk(highPrecisionSqr3)) description]);
    JreStrongAssign(&OrgApacheCommonsMathDfpDfpField_sqr3ReciprocalString_, nil, [((OrgApacheCommonsMathDfpDfp *) nil_chk([highPrecisionOne divideWithId:highPrecisionSqr3])) description]);
    JreStrongAssign(&OrgApacheCommonsMathDfpDfpField_piString_, nil, [((OrgApacheCommonsMathDfpDfp *) nil_chk(OrgApacheCommonsMathDfpDfpField_computePiWithOrgApacheCommonsMathDfpDfp_withOrgApacheCommonsMathDfpDfp_withOrgApacheCommonsMathDfpDfp_(highPrecisionOne, highPrecisionTwo, highPrecisionThree))) description]);
    JreStrongAssign(&OrgApacheCommonsMathDfpDfpField_eString_, nil, [((OrgApacheCommonsMathDfpDfp *) nil_chk(OrgApacheCommonsMathDfpDfpField_computeExpWithOrgApacheCommonsMathDfpDfp_withOrgApacheCommonsMathDfpDfp_(highPrecisionOne, highPrecisionOne))) description]);
    JreStrongAssign(&OrgApacheCommonsMathDfpDfpField_ln2String_, nil, [((OrgApacheCommonsMathDfpDfp *) nil_chk(OrgApacheCommonsMathDfpDfpField_computeLnWithOrgApacheCommonsMathDfpDfp_withOrgApacheCommonsMathDfpDfp_withOrgApacheCommonsMathDfpDfp_(highPrecisionTwo, highPrecisionOne, highPrecisionTwo))) description]);
    JreStrongAssign(&OrgApacheCommonsMathDfpDfpField_ln5String_, nil, [((OrgApacheCommonsMathDfpDfp *) nil_chk(OrgApacheCommonsMathDfpDfpField_computeLnWithOrgApacheCommonsMathDfpDfp_withOrgApacheCommonsMathDfpDfp_withOrgApacheCommonsMathDfpDfp_([new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withInt_(highPrecisionField, 5) autorelease], highPrecisionOne, highPrecisionTwo))) description]);
    JreStrongAssign(&OrgApacheCommonsMathDfpDfpField_ln10String_, nil, [((OrgApacheCommonsMathDfpDfp *) nil_chk(OrgApacheCommonsMathDfpDfpField_computeLnWithOrgApacheCommonsMathDfpDfp_withOrgApacheCommonsMathDfpDfp_withOrgApacheCommonsMathDfpDfp_([new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withInt_(highPrecisionField, 10) autorelease], highPrecisionOne, highPrecisionTwo))) description]);
  }
}
...
OrgApacheCommonsMathDfpDfp *OrgApacheCommonsMathDfpDfpField_computeExpWithOrgApacheCommonsMathDfpDfp_withOrgApacheCommonsMathDfpDfp_(OrgApacheCommonsMathDfpDfp *a, OrgApacheCommonsMathDfpDfp *one) {
  OrgApacheCommonsMathDfpDfpField_initialize();
  OrgApacheCommonsMathDfpDfp *y = [new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfp_(one) autorelease];
  OrgApacheCommonsMathDfpDfp *py = [new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfp_(one) autorelease];
  OrgApacheCommonsMathDfpDfp *f = [new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfp_(one) autorelease];
  OrgApacheCommonsMathDfpDfp *fi = [new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfp_(one) autorelease];
  OrgApacheCommonsMathDfpDfp *x = [new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfp_(one) autorelease];
  for (jint i = 0; i < 10000; i++) {
    ...
    py = [new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfp_(y) autorelease];
  }
  return y;
}
...
OrgApacheCommonsMathDfpDfp *OrgApacheCommonsMathDfpDfpField_computeLnWithOrgApacheCommonsMathDfpDfp_withOrgApacheCommonsMathDfpDfp_withOrgApacheCommonsMathDfpDfp_(OrgApacheCommonsMathDfpDfp *a, OrgApacheCommonsMathDfpDfp *one, OrgApacheCommonsMathDfpDfp *two) {
  OrgApacheCommonsMathDfpDfpField_initialize();
  jint den = 1;
  OrgApacheCommonsMathDfpDfp *x = [((OrgApacheCommonsMathDfpDfp *) nil_chk([a addWithId:[new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withInt_([((OrgApacheCommonsMathDfpDfp *) nil_chk(a)) getField], -1) autorelease]])) divideWithId:[a addWithId:one]];
  OrgApacheCommonsMathDfpDfp *y = [new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfp_(x) autorelease];
  OrgApacheCommonsMathDfpDfp *num = [new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfp_(x) autorelease];
  OrgApacheCommonsMathDfpDfp *py = [new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfp_(y) autorelease];
  for (jint i = 0; i < 10000; i++) {
