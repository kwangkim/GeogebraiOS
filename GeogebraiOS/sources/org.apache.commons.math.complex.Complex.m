...
//  source: /Users/jacky/GSoC/geogebra_iOS/geogebra/geogebra/common/src/org/apache/commons/math/complex/Complex.java
//
...
- (OrgApacheCommonsMathComplexComplex *)createComplexWithDouble:(jdouble)realPart
  ...
  return [new_OrgApacheCommonsMathComplexComplex_initWithDouble_withDouble_(realPart, imaginaryPart) autorelease];
}
...
+ (void)initialize {
  if (self == [OrgApacheCommonsMathComplexComplex class]) {
    JreStrongAssignAndConsume(&OrgApacheCommonsMathComplexComplex_I_, nil, new_OrgApacheCommonsMathComplexComplex_initWithDouble_withDouble_(0.0, 1.0));
    JreStrongAssignAndConsume(&OrgApacheCommonsMathComplexComplex_NaN_, nil, new_OrgApacheCommonsMathComplexComplex_initWithDouble_withDouble_(JavaLangDouble_NaN, JavaLangDouble_NaN));
    JreStrongAssignAndConsume(&OrgApacheCommonsMathComplexComplex_INF_, nil, new_OrgApacheCommonsMathComplexComplex_initWithDouble_withDouble_(JavaLangDouble_POSITIVE_INFINITY, JavaLangDouble_POSITIVE_INFINITY));
    JreStrongAssignAndConsume(&OrgApacheCommonsMathComplexComplex_ONE_, nil, new_OrgApacheCommonsMathComplexComplex_initWithDouble_withDouble_(1.0, 0.0));
    JreStrongAssignAndConsume(&OrgApacheCommonsMathComplexComplex_ZERO_, nil, new_OrgApacheCommonsMathComplexComplex_initWithDouble_withDouble_(0.0, 0.0));
