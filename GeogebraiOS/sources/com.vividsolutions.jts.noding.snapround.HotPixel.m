...
//  source: /Users/jacky/GSoC/geogebra_iOS/geogebra/geogebra/common/src/com/vividsolutions/jts/noding/snapround/HotPixel.java
//
...
- (ComVividsolutionsJtsGeomEnvelope *)getSafeEnvelope {
  if (safeEnv_ == nil) {
    ...
    ComVividsolutionsJtsNodingSnaproundHotPixel_setAndConsume_safeEnv_(self, new_ComVividsolutionsJtsGeomEnvelope_initWithDouble_withDouble_withDouble_withDouble_(((ComVividsolutionsJtsGeomCoordinate *) nil_chk(originalPt_))->x_ - safeTolerance, originalPt_->x_ + safeTolerance, originalPt_->y_ - safeTolerance, originalPt_->y_ + safeTolerance));
  }
  return safeEnv_;
}
...
void ComVividsolutionsJtsNodingSnaproundHotPixel_initWithComVividsolutionsJtsGeomCoordinate_withDouble_withComVividsolutionsJtsAlgorithmLineIntersector_(ComVividsolutionsJtsNodingSnaproundHotPixel *self, ComVividsolutionsJtsGeomCoordinate *pt, jdouble scaleFactor, ComVividsolutionsJtsAlgorithmLineIntersector *li) {
  NSObject_init(self);
  ComVividsolutionsJtsNodingSnaproundHotPixel_setAndConsume_corner_(self, [IOSObjectArray newArrayWithLength:4 type:ComVividsolutionsJtsGeomCoordinate_class_()]);
  ComVividsolutionsJtsNodingSnaproundHotPixel_set_safeEnv_(self, nil);
  ComVividsolutionsJtsNodingSnaproundHotPixel_set_originalPt_(self, pt);
  ComVividsolutionsJtsNodingSnaproundHotPixel_set_pt_(self, pt);
  self->scaleFactor_ = scaleFactor;
  ComVividsolutionsJtsNodingSnaproundHotPixel_set_li_(self, li);
  if (scaleFactor != 1.0) {
    ComVividsolutionsJtsNodingSnaproundHotPixel_setAndConsume_pt_(self, new_ComVividsolutionsJtsGeomCoordinate_initWithDouble_withDouble_(ComVividsolutionsJtsNodingSnaproundHotPixel_scale__WithDouble_(self, ((ComVividsolutionsJtsGeomCoordinate *) nil_chk(pt))->x_), ComVividsolutionsJtsNodingSnaproundHotPixel_scale__WithDouble_(self, pt->y_)));
    ComVividsolutionsJtsNodingSnaproundHotPixel_setAndConsume_p0Scaled_(self, new_ComVividsolutionsJtsGeomCoordinate_init());
    ComVividsolutionsJtsNodingSnaproundHotPixel_setAndConsume_p1Scaled_(self, new_ComVividsolutionsJtsGeomCoordinate_init());
  }
...
void ComVividsolutionsJtsNodingSnaproundHotPixel_initCornersWithComVividsolutionsJtsGeomCoordinate_(ComVividsolutionsJtsNodingSnaproundHotPixel *self, ComVividsolutionsJtsGeomCoordinate *pt) {
  ...
  IOSObjectArray_SetAndConsume(nil_chk(self->corner_), 0, new_ComVividsolutionsJtsGeomCoordinate_initWithDouble_withDouble_(self->maxx_, self->maxy_));
  IOSObjectArray_SetAndConsume(self->corner_, 1, new_ComVividsolutionsJtsGeomCoordinate_initWithDouble_withDouble_(self->minx_, self->maxy_));
  IOSObjectArray_SetAndConsume(self->corner_, 2, new_ComVividsolutionsJtsGeomCoordinate_initWithDouble_withDouble_(self->minx_, self->miny_));
  IOSObjectArray_SetAndConsume(self->corner_, 3, new_ComVividsolutionsJtsGeomCoordinate_initWithDouble_withDouble_(self->maxx_, self->miny_));
}
