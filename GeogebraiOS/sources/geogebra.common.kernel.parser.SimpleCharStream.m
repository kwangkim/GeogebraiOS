...
@implementation GeogebraCommonKernelParserSimpleCharStream
...
- (void)ExpandBuffWithBoolean:(jboolean)wrapAround {
  ...
  @try {
    if (wrapAround) {
      ...
      GeogebraCommonKernelParserSimpleCharStream_set_buffer_(self, newbuffer);
      ...
      GeogebraCommonKernelParserSimpleCharStream_set_bufline_(self, newbufline);
      ...
      GeogebraCommonKernelParserSimpleCharStream_set_bufcolumn_(self, newbufcolumn);
...
- (instancetype)initWithJavaIoReader:(JavaIoReader *)dstream
  ...
  GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoReader_withInt_withInt_withInt_(self, dstream, startline, startcolumn, buffersize);
  return self;
}
...
- (instancetype)initWithJavaIoReader:(JavaIoReader *)dstream
                             withInt:(jint)startline
                             withInt:(jint)startcolumn {
  GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoReader_withInt_withInt_(self, dstream, startline, startcolumn);
  return self;
}

- (instancetype)initWithJavaIoReader:(JavaIoReader *)dstream {
  GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoReader_(self, dstream);
  return self;
}
...
- (void)ReInitWithJavaIoReader:(JavaIoReader *)dstream
                       ...
                       withInt:(jint)startcolumn
                       withInt:(jint)buffersize {
  GeogebraCommonKernelParserSimpleCharStream_set_inputStream_(self, dstream);
  line_ = startline;
  column_ = startcolumn - 1;
  if (buffer_ == nil || buffersize != buffer_->size_) {
    available_ = bufsize_ = buffersize;
    GeogebraCommonKernelParserSimpleCharStream_setAndConsume_buffer_(self, [IOSCharArray newArrayWithLength:buffersize]);
    GeogebraCommonKernelParserSimpleCharStream_setAndConsume_bufline_(self, [IOSIntArray newArrayWithLength:buffersize]);
    GeogebraCommonKernelParserSimpleCharStream_setAndConsume_bufcolumn_(self, [IOSIntArray newArrayWithLength:buffersize]);
  }
...
- (instancetype)initWithJavaIoInputStream:(JavaIoInputStream *)dstream
                             withNSString:(NSString *)encoding
                                  ...
                                  withInt:(jint)startcolumn
                                  withInt:(jint)buffersize {
  GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoInputStream_withNSString_withInt_withInt_withInt_(self, dstream, encoding, startline, startcolumn, buffersize);
  return self;
}
...
- (instancetype)initWithJavaIoInputStream:(JavaIoInputStream *)dstream
                                  ...
                                  withInt:(jint)startcolumn
                                  withInt:(jint)buffersize {
  GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoInputStream_withInt_withInt_withInt_(self, dstream, startline, startcolumn, buffersize);
  return self;
}
...
- (instancetype)initWithJavaIoInputStream:(JavaIoInputStream *)dstream
                             withNSString:(NSString *)encoding
                                  withInt:(jint)startline
                                  withInt:(jint)startcolumn {
  GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoInputStream_withNSString_withInt_withInt_(self, dstream, encoding, startline, startcolumn);
  return self;
}
...
- (instancetype)initWithJavaIoInputStream:(JavaIoInputStream *)dstream
                                  withInt:(jint)startline
                                  withInt:(jint)startcolumn {
  GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoInputStream_withInt_withInt_(self, dstream, startline, startcolumn);
  return self;
}

- (instancetype)initWithJavaIoInputStream:(JavaIoInputStream *)dstream
                             withNSString:(NSString *)encoding {
  GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoInputStream_withNSString_(self, dstream, encoding);
  return self;
}

- (instancetype)initWithJavaIoInputStream:(JavaIoInputStream *)dstream {
  GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoInputStream_(self, dstream);
  return self;
}
...
- (void)Done {
  GeogebraCommonKernelParserSimpleCharStream_set_buffer_(self, nil);
  GeogebraCommonKernelParserSimpleCharStream_set_bufline_(self, nil);
  GeogebraCommonKernelParserSimpleCharStream_set_bufcolumn_(self, nil);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "staticFlag_", NULL, 0x19, "Z", NULL, NULL, .constantValue.asBOOL = GeogebraCommonKernelParserSimpleCharStream_staticFlag },
  ...
  static const J2ObjcClassInfo _GeogebraCommonKernelParserSimpleCharStream = { 2, "SimpleCharStream", "geogebra.common.kernel.parser", NULL, 0x1, 36, methods, 16, fields, 0, NULL, 0, NULL, NULL, NULL };
  return &_GeogebraCommonKernelParserSimpleCharStream;
}

@end

void GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoReader_withInt_withInt_withInt_(GeogebraCommonKernelParserSimpleCharStream *self, JavaIoReader *dstream, jint startline, jint startcolumn, jint buffersize) {
  NSObject_init(self);
  self->bufpos_ = -1;
  self->column_ = 0;
  self->line_ = 1;
...
GeogebraCommonKernelParserSimpleCharStream *new_GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoReader_withInt_withInt_withInt_(JavaIoReader *dstream, jint startline, jint startcolumn, jint buffersize) {
  GeogebraCommonKernelParserSimpleCharStream *self = [GeogebraCommonKernelParserSimpleCharStream alloc];
  GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoReader_withInt_withInt_withInt_(self, dstream, startline, startcolumn, buffersize);
  return self;
}

void GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoReader_withInt_withInt_(GeogebraCommonKernelParserSimpleCharStream *self, JavaIoReader *dstream, jint startline, jint startcolumn) {
  GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoReader_withInt_withInt_withInt_(self, dstream, startline, startcolumn, 4096);
}

GeogebraCommonKernelParserSimpleCharStream *new_GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoReader_withInt_withInt_(JavaIoReader *dstream, jint startline, jint startcolumn) {
  GeogebraCommonKernelParserSimpleCharStream *self = [GeogebraCommonKernelParserSimpleCharStream alloc];
  GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoReader_withInt_withInt_(self, dstream, startline, startcolumn);
  return self;
}

void GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoReader_(GeogebraCommonKernelParserSimpleCharStream *self, JavaIoReader *dstream) {
  GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoReader_withInt_withInt_withInt_(self, dstream, 1, 1, 4096);
}

GeogebraCommonKernelParserSimpleCharStream *new_GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoReader_(JavaIoReader *dstream) {
  GeogebraCommonKernelParserSimpleCharStream *self = [GeogebraCommonKernelParserSimpleCharStream alloc];
  GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoReader_(self, dstream);
  return self;
}

void GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoInputStream_withNSString_withInt_withInt_withInt_(GeogebraCommonKernelParserSimpleCharStream *self, JavaIoInputStream *dstream, NSString *encoding, jint startline, jint startcolumn, jint buffersize) {
  GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoReader_withInt_withInt_withInt_(self, encoding == nil ? [new_JavaIoInputStreamReader_initWithJavaIoInputStream_(dstream) autorelease] : [new_JavaIoInputStreamReader_initWithJavaIoInputStream_withNSString_(dstream, encoding) autorelease], startline, startcolumn, buffersize);
}

GeogebraCommonKernelParserSimpleCharStream *new_GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoInputStream_withNSString_withInt_withInt_withInt_(JavaIoInputStream *dstream, NSString *encoding, jint startline, jint startcolumn, jint buffersize) {
  GeogebraCommonKernelParserSimpleCharStream *self = [GeogebraCommonKernelParserSimpleCharStream alloc];
  GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoInputStream_withNSString_withInt_withInt_withInt_(self, dstream, encoding, startline, startcolumn, buffersize);
  return self;
}

void GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoInputStream_withInt_withInt_withInt_(GeogebraCommonKernelParserSimpleCharStream *self, JavaIoInputStream *dstream, jint startline, jint startcolumn, jint buffersize) {
  GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoReader_withInt_withInt_withInt_(self, [new_JavaIoInputStreamReader_initWithJavaIoInputStream_(dstream) autorelease], startline, startcolumn, buffersize);
}

GeogebraCommonKernelParserSimpleCharStream *new_GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoInputStream_withInt_withInt_withInt_(JavaIoInputStream *dstream, jint startline, jint startcolumn, jint buffersize) {
  GeogebraCommonKernelParserSimpleCharStream *self = [GeogebraCommonKernelParserSimpleCharStream alloc];
  GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoInputStream_withInt_withInt_withInt_(self, dstream, startline, startcolumn, buffersize);
  return self;
}

void GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoInputStream_withNSString_withInt_withInt_(GeogebraCommonKernelParserSimpleCharStream *self, JavaIoInputStream *dstream, NSString *encoding, jint startline, jint startcolumn) {
  GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoInputStream_withNSString_withInt_withInt_withInt_(self, dstream, encoding, startline, startcolumn, 4096);
}

GeogebraCommonKernelParserSimpleCharStream *new_GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoInputStream_withNSString_withInt_withInt_(JavaIoInputStream *dstream, NSString *encoding, jint startline, jint startcolumn) {
  GeogebraCommonKernelParserSimpleCharStream *self = [GeogebraCommonKernelParserSimpleCharStream alloc];
  GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoInputStream_withNSString_withInt_withInt_(self, dstream, encoding, startline, startcolumn);
  return self;
}

void GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoInputStream_withInt_withInt_(GeogebraCommonKernelParserSimpleCharStream *self, JavaIoInputStream *dstream, jint startline, jint startcolumn) {
  GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoInputStream_withInt_withInt_withInt_(self, dstream, startline, startcolumn, 4096);
}

GeogebraCommonKernelParserSimpleCharStream *new_GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoInputStream_withInt_withInt_(JavaIoInputStream *dstream, jint startline, jint startcolumn) {
  GeogebraCommonKernelParserSimpleCharStream *self = [GeogebraCommonKernelParserSimpleCharStream alloc];
  GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoInputStream_withInt_withInt_(self, dstream, startline, startcolumn);
  return self;
}

void GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoInputStream_withNSString_(GeogebraCommonKernelParserSimpleCharStream *self, JavaIoInputStream *dstream, NSString *encoding) {
  GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoInputStream_withNSString_withInt_withInt_withInt_(self, dstream, encoding, 1, 1, 4096);
}

GeogebraCommonKernelParserSimpleCharStream *new_GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoInputStream_withNSString_(JavaIoInputStream *dstream, NSString *encoding) {
  GeogebraCommonKernelParserSimpleCharStream *self = [GeogebraCommonKernelParserSimpleCharStream alloc];
  GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoInputStream_withNSString_(self, dstream, encoding);
  return self;
}

void GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoInputStream_(GeogebraCommonKernelParserSimpleCharStream *self, JavaIoInputStream *dstream) {
  GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoInputStream_withInt_withInt_withInt_(self, dstream, 1, 1, 4096);
}

GeogebraCommonKernelParserSimpleCharStream *new_GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoInputStream_(JavaIoInputStream *dstream) {
  GeogebraCommonKernelParserSimpleCharStream *self = [GeogebraCommonKernelParserSimpleCharStream alloc];
  GeogebraCommonKernelParserSimpleCharStream_initWithJavaIoInputStream_(self, dstream);
  return self;
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(GeogebraCommonKernelParserSimpleCharStream)
