...
- (void)setWithId:(id)obj {
  @throw [new_JavaLangUnsupportedOperationException_initWithNSString_(@"set() is not supported") autorelease];
}

- (void)addWithId:(id)obj {
  @throw [new_JavaLangUnsupportedOperationException_initWithNSString_(@"add() is not supported") autorelease];
}
...
id<JavaUtilListIterator> OrgApacheCommonsCollections15IteratorsUnmodifiableListIterator_decorateWithJavaUtilListIterator_(id<JavaUtilListIterator> iterator) {
  ...
  return [new_OrgApacheCommonsCollections15IteratorsUnmodifiableListIterator_initWithJavaUtilListIterator_(iterator) autorelease];
}
...
void OrgApacheCommonsCollections15IteratorsUnmodifiableListIterator_initWithJavaUtilListIterator_(OrgApacheCommonsCollections15IteratorsUnmodifiableListIterator *self, id<JavaUtilListIterator> iterator) {
  NSObject_init(self);
  OrgApacheCommonsCollections15IteratorsUnmodifiableListIterator_set_iterator_(self, iterator);
}
