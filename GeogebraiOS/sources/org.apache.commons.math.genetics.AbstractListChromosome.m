...
- (NSString *)description {
  return NSString_formatWithNSString_withNSObjectArray_(@"(f=%s %s)", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangDouble_valueOfWithDouble_([self getFitness]), [self getRepresentation] } count:2 type:NSObject_class_()]);
}
...
void OrgApacheCommonsMathGeneticsAbstractListChromosome_initWithJavaUtilList_(OrgApacheCommonsMathGeneticsAbstractListChromosome *self, id<JavaUtilList> representation) {
  ...
  @catch (OrgApacheCommonsMathGeneticsInvalidRepresentationException *e) {
    @throw [new_JavaLangIllegalArgumentException_initWithNSString_withJavaLangThrowable_(NSString_formatWithNSString_withNSObjectArray_(@"Invalid representation for %s", [IOSObjectArray arrayWithObjects:(id[]){ [[self getClass] getSimpleName] } count:1 type:NSObject_class_()]), e) autorelease];
  }
  OrgApacheCommonsMathGeneticsAbstractListChromosome_set_representation_(self, JavaUtilCollections_unmodifiableListWithJavaUtilList_([new_JavaUtilArrayList_initWithJavaUtilCollection_(representation) autorelease]));
}
...
void OrgApacheCommonsMathGeneticsAbstractListChromosome_initWithNSObjectArray_(OrgApacheCommonsMathGeneticsAbstractListChromosome *self, IOSObjectArray *representation) {
  OrgApacheCommonsMathGeneticsAbstractListChromosome_initWithJavaUtilList_(self, JavaUtilArrays_asListWithNSObjectArray_(representation));
}
