...
//  source: /Users/jacky/GSoC/geogebra_iOS/geogebra/geogebra/common/src/org/apache/commons/math/linear/ArrayFieldVector.java
//
...
- (id<OrgApacheCommonsMathLinearFieldVector>)copy__ {
  return [new_OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathLinearArrayFieldVector_withBoolean_(self, YES) autorelease];
}
...
- (id<OrgApacheCommonsMathLinearFieldVector>)addWithOrgApacheCommonsMathLinearFieldVector:(id<OrgApacheCommonsMathLinearFieldVector>)v {
  ...
  @catch (JavaLangClassCastException *cce) {
    ...
    for (jint i = 0; i < data_->size_; i++) {
      IOSObjectArray_Set(nil_chk(out), i, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(data_, i))) addWithId:[((id<OrgApacheCommonsMathLinearFieldVector>) nil_chk(v)) getEntryWithInt:i]]);
    }
...
- (id<OrgApacheCommonsMathLinearFieldVector>)addWithOrgApacheCommonsMathFieldElementArray:(IOSObjectArray *)v {
  ...
  IOSObjectArray *out = OrgApacheCommonsMathLinearArrayFieldVector_buildArrayWithInt_(self, ((IOSObjectArray *) nil_chk(data_))->size_);
  for (jint i = 0; i < data_->size_; i++) {
    IOSObjectArray_Set(nil_chk(out), i, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(data_, i))) addWithId:IOSObjectArray_Get(v, i)]);
  }
  return [new_OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathFieldElementArray_(out) autorelease];
}
...
- (id<OrgApacheCommonsMathLinearFieldVector>)subtractWithOrgApacheCommonsMathLinearFieldVector:(id<OrgApacheCommonsMathLinearFieldVector>)v {
  ...
  @catch (JavaLangClassCastException *cce) {
    ...
    IOSObjectArray *out = OrgApacheCommonsMathLinearArrayFieldVector_buildArrayWithInt_(self, ((IOSObjectArray *) nil_chk(data_))->size_);
    for (jint i = 0; i < data_->size_; i++) {
      IOSObjectArray_Set(nil_chk(out), i, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(data_, i))) subtractWithId:[((id<OrgApacheCommonsMathLinearFieldVector>) nil_chk(v)) getEntryWithInt:i]]);
    }
    return [new_OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathFieldElementArray_(out) autorelease];
  }
}
...
- (id<OrgApacheCommonsMathLinearFieldVector>)subtractWithOrgApacheCommonsMathFieldElementArray:(IOSObjectArray *)v {
  ...
  IOSObjectArray *out = OrgApacheCommonsMathLinearArrayFieldVector_buildArrayWithInt_(self, ((IOSObjectArray *) nil_chk(data_))->size_);
  for (jint i = 0; i < data_->size_; i++) {
    IOSObjectArray_Set(nil_chk(out), i, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(data_, i))) subtractWithId:IOSObjectArray_Get(v, i)]);
  }
  return [new_OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathFieldElementArray_(out) autorelease];
}
...
- (id<OrgApacheCommonsMathLinearFieldVector>)mapAddWithOrgApacheCommonsMathFieldElement:(id<OrgApacheCommonsMathFieldElement>)d {
  IOSObjectArray *out = OrgApacheCommonsMathLinearArrayFieldVector_buildArrayWithInt_(self, ((IOSObjectArray *) nil_chk(data_))->size_);
  for (jint i = 0; i < data_->size_; i++) {
    IOSObjectArray_Set(nil_chk(out), i, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(data_, i))) addWithId:d]);
  }
  return [new_OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathFieldElementArray_(out) autorelease];
}
...
- (id<OrgApacheCommonsMathLinearFieldVector>)mapAddToSelfWithOrgApacheCommonsMathFieldElement:(id<OrgApacheCommonsMathFieldElement>)d {
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(data_))->size_; i++) {
    IOSObjectArray_Set(data_, i, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(data_, i))) addWithId:d]);
  }
  return self;
}
...
- (id<OrgApacheCommonsMathLinearFieldVector>)mapSubtractWithOrgApacheCommonsMathFieldElement:(id<OrgApacheCommonsMathFieldElement>)d {
  IOSObjectArray *out = OrgApacheCommonsMathLinearArrayFieldVector_buildArrayWithInt_(self, ((IOSObjectArray *) nil_chk(data_))->size_);
  for (jint i = 0; i < data_->size_; i++) {
    IOSObjectArray_Set(nil_chk(out), i, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(data_, i))) subtractWithId:d]);
  }
  return [new_OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathFieldElementArray_(out) autorelease];
}
...
- (id<OrgApacheCommonsMathLinearFieldVector>)mapSubtractToSelfWithOrgApacheCommonsMathFieldElement:(id<OrgApacheCommonsMathFieldElement>)d {
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(data_))->size_; i++) {
    IOSObjectArray_Set(data_, i, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(data_, i))) subtractWithId:d]);
  }
  return self;
}
...
- (id<OrgApacheCommonsMathLinearFieldVector>)mapMultiplyWithOrgApacheCommonsMathFieldElement:(id<OrgApacheCommonsMathFieldElement>)d {
  IOSObjectArray *out = OrgApacheCommonsMathLinearArrayFieldVector_buildArrayWithInt_(self, ((IOSObjectArray *) nil_chk(data_))->size_);
  for (jint i = 0; i < data_->size_; i++) {
    IOSObjectArray_Set(nil_chk(out), i, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(data_, i))) multiplyWithId:d]);
  }
  return [new_OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathFieldElementArray_(out) autorelease];
}
...
- (id<OrgApacheCommonsMathLinearFieldVector>)mapMultiplyToSelfWithOrgApacheCommonsMathFieldElement:(id<OrgApacheCommonsMathFieldElement>)d {
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(data_))->size_; i++) {
    IOSObjectArray_Set(data_, i, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(data_, i))) multiplyWithId:d]);
  }
  return self;
}
...
- (id<OrgApacheCommonsMathLinearFieldVector>)mapDivideWithOrgApacheCommonsMathFieldElement:(id<OrgApacheCommonsMathFieldElement>)d {
  IOSObjectArray *out = OrgApacheCommonsMathLinearArrayFieldVector_buildArrayWithInt_(self, ((IOSObjectArray *) nil_chk(data_))->size_);
  for (jint i = 0; i < data_->size_; i++) {
    IOSObjectArray_Set(nil_chk(out), i, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(data_, i))) divideWithId:d]);
  }
  return [new_OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathFieldElementArray_(out) autorelease];
}
...
- (id<OrgApacheCommonsMathLinearFieldVector>)mapDivideToSelfWithOrgApacheCommonsMathFieldElement:(id<OrgApacheCommonsMathFieldElement>)d {
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(data_))->size_; i++) {
    IOSObjectArray_Set(data_, i, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(data_, i))) divideWithId:d]);
  }
  return self;
}
...
- (id<OrgApacheCommonsMathLinearFieldVector>)mapInv {
  ...
  for (jint i = 0; i < data_->size_; i++) {
    IOSObjectArray_Set(nil_chk(out), i, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(one)) divideWithId:IOSObjectArray_Get(data_, i)]);
  }
  return [new_OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathFieldElementArray_(out) autorelease];
}
...
- (id<OrgApacheCommonsMathLinearFieldVector>)mapInvToSelf {
  id<OrgApacheCommonsMathFieldElement> one = [((id<OrgApacheCommonsMathField>) nil_chk(field_)) getOne];
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(data_))->size_; i++) {
    IOSObjectArray_Set(data_, i, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(one)) divideWithId:IOSObjectArray_Get(data_, i)]);
  }
  return self;
}
...
- (id<OrgApacheCommonsMathLinearFieldVector>)ebeMultiplyWithOrgApacheCommonsMathLinearFieldVector:(id<OrgApacheCommonsMathLinearFieldVector>)v {
  ...
  @catch (JavaLangClassCastException *cce) {
    ...
    IOSObjectArray *out = OrgApacheCommonsMathLinearArrayFieldVector_buildArrayWithInt_(self, ((IOSObjectArray *) nil_chk(data_))->size_);
    for (jint i = 0; i < data_->size_; i++) {
      IOSObjectArray_Set(nil_chk(out), i, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(data_, i))) multiplyWithId:[((id<OrgApacheCommonsMathLinearFieldVector>) nil_chk(v)) getEntryWithInt:i]]);
    }
    return [new_OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathFieldElementArray_(out) autorelease];
  }
}
...
- (id<OrgApacheCommonsMathLinearFieldVector>)ebeMultiplyWithOrgApacheCommonsMathFieldElementArray:(IOSObjectArray *)v {
  ...
  IOSObjectArray *out = OrgApacheCommonsMathLinearArrayFieldVector_buildArrayWithInt_(self, ((IOSObjectArray *) nil_chk(data_))->size_);
  for (jint i = 0; i < data_->size_; i++) {
    IOSObjectArray_Set(nil_chk(out), i, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(data_, i))) multiplyWithId:IOSObjectArray_Get(v, i)]);
  }
  return [new_OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathFieldElementArray_(out) autorelease];
}
...
- (id<OrgApacheCommonsMathLinearFieldVector>)ebeDivideWithOrgApacheCommonsMathLinearFieldVector:(id<OrgApacheCommonsMathLinearFieldVector>)v {
  ...
  @catch (JavaLangClassCastException *cce) {
    ...
    IOSObjectArray *out = OrgApacheCommonsMathLinearArrayFieldVector_buildArrayWithInt_(self, ((IOSObjectArray *) nil_chk(data_))->size_);
    for (jint i = 0; i < data_->size_; i++) {
      IOSObjectArray_Set(nil_chk(out), i, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(data_, i))) divideWithId:[((id<OrgApacheCommonsMathLinearFieldVector>) nil_chk(v)) getEntryWithInt:i]]);
    }
    return [new_OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathFieldElementArray_(out) autorelease];
  }
}
...
- (id<OrgApacheCommonsMathLinearFieldVector>)ebeDivideWithOrgApacheCommonsMathFieldElementArray:(IOSObjectArray *)v {
  ...
  IOSObjectArray *out = OrgApacheCommonsMathLinearArrayFieldVector_buildArrayWithInt_(self, ((IOSObjectArray *) nil_chk(data_))->size_);
  for (jint i = 0; i < data_->size_; i++) {
    IOSObjectArray_Set(nil_chk(out), i, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(data_, i))) divideWithId:IOSObjectArray_Get(v, i)]);
  }
  return [new_OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathFieldElementArray_(out) autorelease];
}
...
- (id<OrgApacheCommonsMathLinearFieldVector>)projectionWithOrgApacheCommonsMathFieldElementArray:(IOSObjectArray *)v {
  return [self projectionWithOrgApacheCommonsMathLinearArrayFieldVector:[new_OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathFieldElementArray_withBoolean_(v, NO) autorelease]];
}
...
- (id<OrgApacheCommonsMathLinearFieldMatrix>)outerProductWithOrgApacheCommonsMathLinearFieldVector:(id<OrgApacheCommonsMathLinearFieldVector>)v {
  ...
  @catch (JavaLangClassCastException *cce) {
    ...
    id<OrgApacheCommonsMathLinearFieldMatrix> out = [new_OrgApacheCommonsMathLinearArray2DRowFieldMatrix_initWithOrgApacheCommonsMathField_withInt_withInt_(field_, m, m) autorelease];
    for (jint i = 0; i < data_->size_; i++) {
...
- (id<OrgApacheCommonsMathLinearFieldVector>)appendWithOrgApacheCommonsMathLinearFieldVector:(id<OrgApacheCommonsMathLinearFieldVector>)v {
  ...
  @catch (JavaLangClassCastException *cce) {
    return [new_OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathLinearArrayFieldVector_withOrgApacheCommonsMathLinearArrayFieldVector_(self, [new_OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathLinearFieldVector_(v) autorelease]) autorelease];
  }
}
...
- (OrgApacheCommonsMathLinearArrayFieldVector *)appendWithOrgApacheCommonsMathLinearArrayFieldVector:(OrgApacheCommonsMathLinearArrayFieldVector *)v {
  return [new_OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathLinearArrayFieldVector_withOrgApacheCommonsMathLinearArrayFieldVector_(self, v) autorelease];
}
...
- (id<OrgApacheCommonsMathLinearFieldVector>)appendWithOrgApacheCommonsMathFieldElement:(id<OrgApacheCommonsMathFieldElement>)inArg {
  ...
  IOSObjectArray_Set(nil_chk(out), data_->size_, inArg);
  return [new_OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathFieldElementArray_(out) autorelease];
}

- (id<OrgApacheCommonsMathLinearFieldVector>)appendWithOrgApacheCommonsMathFieldElementArray:(IOSObjectArray *)inArg {
  return [new_OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathLinearArrayFieldVector_withOrgApacheCommonsMathFieldElementArray_(self, inArg) autorelease];
}

- (id<OrgApacheCommonsMathLinearFieldVector>)getSubVectorWithInt:(jint)index
                                                         withInt:(jint)n {
  OrgApacheCommonsMathLinearArrayFieldVector *out = [new_OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathField_withInt_(field_, n) autorelease];
  @try {
...
withOrgApacheCommonsMathFieldElement:(id<OrgApacheCommonsMathFieldElement>)value {
  @try {
    IOSObjectArray_Set(nil_chk(data_), index, value);
  }
  @catch (JavaLangIndexOutOfBoundsException *e) {
    OrgApacheCommonsMathLinearArrayFieldVector_checkIndexWithInt_(self, index);
  }
  ...
  @try {
    ...
    @catch (JavaLangClassCastException *cce) {
      for (jint i = index; i < index + [((id<OrgApacheCommonsMathLinearFieldVector>) nil_chk(v)) getDimension]; ++i) {
        IOSObjectArray_Set(nil_chk(data_), i, [v getEntryWithInt:i - index]);
      }
    }
  }
  @catch (JavaLangIndexOutOfBoundsException *e) {
...
void OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathField_(OrgApacheCommonsMathLinearArrayFieldVector *self, id<OrgApacheCommonsMathField> field) {
  OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathField_withInt_(self, field, 0);
}
...
void OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathField_withInt_(OrgApacheCommonsMathLinearArrayFieldVector *self, id<OrgApacheCommonsMathField> field, jint size) {
  NSObject_init(self);
  OrgApacheCommonsMathLinearArrayFieldVector_set_field_(self, field);
  OrgApacheCommonsMathLinearArrayFieldVector_set_data_(self, OrgApacheCommonsMathLinearArrayFieldVector_buildArrayWithInt_(self, size));
...
void OrgApacheCommonsMathLinearArrayFieldVector_initWithInt_withOrgApacheCommonsMathFieldElement_(OrgApacheCommonsMathLinearArrayFieldVector *self, jint size, id<OrgApacheCommonsMathFieldElement> preset) {
  OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathField_withInt_(self, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(preset)) getField], size);
...
void OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathFieldElementArray_(OrgApacheCommonsMathLinearArrayFieldVector *self, IOSObjectArray *d) {
  NSObject_init(self);
  @try {
    OrgApacheCommonsMathLinearArrayFieldVector_set_field_(self, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(nil_chk(d), 0))) getField]);
    OrgApacheCommonsMathLinearArrayFieldVector_set_data_(self, [d clone]);
  }
  @catch (JavaLangArrayIndexOutOfBoundsException *e) {
    @throw OrgApacheCommonsMathMathRuntimeException_createIllegalArgumentExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_VECTOR_MUST_HAVE_AT_LEAST_ONE_ELEMENT(), [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
  }
}
...
void OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathField_withOrgApacheCommonsMathFieldElementArray_(OrgApacheCommonsMathLinearArrayFieldVector *self, id<OrgApacheCommonsMathField> field, IOSObjectArray *d) {
  NSObject_init(self);
  OrgApacheCommonsMathLinearArrayFieldVector_set_field_(self, field);
  OrgApacheCommonsMathLinearArrayFieldVector_set_data_(self, [((IOSObjectArray *) nil_chk(d)) clone]);
}
...
void OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathFieldElementArray_withBoolean_(OrgApacheCommonsMathLinearArrayFieldVector *self, IOSObjectArray *d, jboolean copyArray) {
  ...
  OrgApacheCommonsMathLinearArrayFieldVector_set_field_(self, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(d, 0))) getField]);
  OrgApacheCommonsMathLinearArrayFieldVector_set_data_(self, copyArray ? [d clone] : d);
}
...
void OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathField_withOrgApacheCommonsMathFieldElementArray_withBoolean_(OrgApacheCommonsMathLinearArrayFieldVector *self, id<OrgApacheCommonsMathField> field, IOSObjectArray *d, jboolean copyArray) {
  NSObject_init(self);
  OrgApacheCommonsMathLinearArrayFieldVector_set_field_(self, field);
  OrgApacheCommonsMathLinearArrayFieldVector_set_data_(self, copyArray ? [((IOSObjectArray *) nil_chk(d)) clone] : d);
}
...
void OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathLinearFieldVector_(OrgApacheCommonsMathLinearArrayFieldVector *self, id<OrgApacheCommonsMathLinearFieldVector> v) {
  NSObject_init(self);
  OrgApacheCommonsMathLinearArrayFieldVector_set_field_(self, [((id<OrgApacheCommonsMathLinearFieldVector>) nil_chk(v)) getField]);
  OrgApacheCommonsMathLinearArrayFieldVector_set_data_(self, OrgApacheCommonsMathLinearArrayFieldVector_buildArrayWithInt_(self, [v getDimension]));
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(self->data_))->size_; ++i) {
    IOSObjectArray_Set(self->data_, i, [v getEntryWithInt:i]);
  }
}
...
void OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathLinearArrayFieldVector_(OrgApacheCommonsMathLinearArrayFieldVector *self, OrgApacheCommonsMathLinearArrayFieldVector *v) {
  NSObject_init(self);
  OrgApacheCommonsMathLinearArrayFieldVector_set_field_(self, [((OrgApacheCommonsMathLinearArrayFieldVector *) nil_chk(v)) getField]);
  OrgApacheCommonsMathLinearArrayFieldVector_set_data_(self, [((IOSObjectArray *) nil_chk(v->data_)) clone]);
}
...
void OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathLinearArrayFieldVector_withBoolean_(OrgApacheCommonsMathLinearArrayFieldVector *self, OrgApacheCommonsMathLinearArrayFieldVector *v, jboolean deep) {
  NSObject_init(self);
  OrgApacheCommonsMathLinearArrayFieldVector_set_field_(self, [((OrgApacheCommonsMathLinearArrayFieldVector *) nil_chk(v)) getField]);
  OrgApacheCommonsMathLinearArrayFieldVector_set_data_(self, deep ? [((IOSObjectArray *) nil_chk(v->data_)) clone] : v->data_);
}
...
void OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathLinearArrayFieldVector_withOrgApacheCommonsMathLinearArrayFieldVector_(OrgApacheCommonsMathLinearArrayFieldVector *self, OrgApacheCommonsMathLinearArrayFieldVector *v1, OrgApacheCommonsMathLinearArrayFieldVector *v2) {
  NSObject_init(self);
  OrgApacheCommonsMathLinearArrayFieldVector_set_field_(self, [((OrgApacheCommonsMathLinearArrayFieldVector *) nil_chk(v1)) getField]);
  OrgApacheCommonsMathLinearArrayFieldVector_set_data_(self, OrgApacheCommonsMathLinearArrayFieldVector_buildArrayWithInt_(self, ((IOSObjectArray *) nil_chk(v1->data_))->size_ + ((OrgApacheCommonsMathLinearArrayFieldVector *) nil_chk(v2))->data_->size_));
...
void OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathLinearArrayFieldVector_withOrgApacheCommonsMathFieldElementArray_(OrgApacheCommonsMathLinearArrayFieldVector *self, OrgApacheCommonsMathLinearArrayFieldVector *v1, IOSObjectArray *v2) {
  NSObject_init(self);
  OrgApacheCommonsMathLinearArrayFieldVector_set_field_(self, [((OrgApacheCommonsMathLinearArrayFieldVector *) nil_chk(v1)) getField]);
  OrgApacheCommonsMathLinearArrayFieldVector_set_data_(self, OrgApacheCommonsMathLinearArrayFieldVector_buildArrayWithInt_(self, ((IOSObjectArray *) nil_chk(v1->data_))->size_ + ((IOSObjectArray *) nil_chk(v2))->size_));
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(v1->data_, 0, self->data_, 0, ((IOSObjectArray *) nil_chk(v1->data_))->size_);
...
void OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathFieldElementArray_withOrgApacheCommonsMathLinearArrayFieldVector_(OrgApacheCommonsMathLinearArrayFieldVector *self, IOSObjectArray *v1, OrgApacheCommonsMathLinearArrayFieldVector *v2) {
  NSObject_init(self);
  OrgApacheCommonsMathLinearArrayFieldVector_set_field_(self, [((OrgApacheCommonsMathLinearArrayFieldVector *) nil_chk(v2)) getField]);
  OrgApacheCommonsMathLinearArrayFieldVector_set_data_(self, OrgApacheCommonsMathLinearArrayFieldVector_buildArrayWithInt_(self, ((IOSObjectArray *) nil_chk(v1))->size_ + ((IOSObjectArray *) nil_chk(v2->data_))->size_));
...
void OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathFieldElementArray_withOrgApacheCommonsMathFieldElementArray_(OrgApacheCommonsMathLinearArrayFieldVector *self, IOSObjectArray *v1, IOSObjectArray *v2) {
  NSObject_init(self);
  @try {
    OrgApacheCommonsMathLinearArrayFieldVector_set_data_(self, OrgApacheCommonsMathLinearArrayFieldVector_buildArrayWithInt_(self, ((IOSObjectArray *) nil_chk(v1))->size_ + ((IOSObjectArray *) nil_chk(v2))->size_));
    JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(v1, 0, self->data_, 0, v1->size_);
    JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(v2, 0, self->data_, v1->size_, v2->size_);
    OrgApacheCommonsMathLinearArrayFieldVector_set_field_(self, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(nil_chk(self->data_), 0))) getField]);
  }
  @catch (JavaLangArrayIndexOutOfBoundsException *e) {
    @throw OrgApacheCommonsMathMathRuntimeException_createIllegalArgumentExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_VECTOR_MUST_HAVE_AT_LEAST_ONE_ELEMENT(), [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
  }
...
void OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathField_withOrgApacheCommonsMathFieldElementArray_withOrgApacheCommonsMathFieldElementArray_(OrgApacheCommonsMathLinearArrayFieldVector *self, id<OrgApacheCommonsMathField> field, IOSObjectArray *v1, IOSObjectArray *v2) {
  ...
  OrgApacheCommonsMathLinearArrayFieldVector_set_data_(self, OrgApacheCommonsMathLinearArrayFieldVector_buildArrayWithInt_(self, v1->size_ + v2->size_));
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(v1, 0, self->data_, 0, v1->size_);
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(v2, 0, self->data_, v1->size_, v2->size_);
  OrgApacheCommonsMathLinearArrayFieldVector_set_field_(self, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(nil_chk(self->data_), 0))) getField]);
}
