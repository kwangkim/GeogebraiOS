...
@implementation GeogebraCommonKernelScriptingCmdShowLayer

- (instancetype)initWithGeogebraCommonKernelKernel:(GeogebraCommonKernelKernel *)kernel {
  GeogebraCommonKernelScriptingCmdShowLayer_initWithGeogebraCommonKernelKernel_(self, kernel);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithGeogebraCommonKernelKernel:", "CmdShowLayer", NULL, 0x1, NULL, NULL },
    { "performWithGeogebraCommonKernelArithmeticCommand:", "perform", "V", 0x14, "Lgeogebra.common.main.MyError;", NULL },
  };
  static const J2ObjcClassInfo _GeogebraCommonKernelScriptingCmdShowLayer = { 2, "CmdShowLayer", "geogebra.common.kernel.scripting", NULL, 0x1, 2, methods, 0, NULL, 0, NULL, 0, NULL, NULL, NULL };
  return &_GeogebraCommonKernelScriptingCmdShowLayer;
}

@end

void GeogebraCommonKernelScriptingCmdShowLayer_initWithGeogebraCommonKernelKernel_(GeogebraCommonKernelScriptingCmdShowLayer *self, GeogebraCommonKernelKernel *kernel) {
  GeogebraCommonKernelCommandsCmdScripting_initWithGeogebraCommonKernelKernel_(self, kernel);
}

GeogebraCommonKernelScriptingCmdShowLayer *new_GeogebraCommonKernelScriptingCmdShowLayer_initWithGeogebraCommonKernelKernel_(GeogebraCommonKernelKernel *kernel) {
  GeogebraCommonKernelScriptingCmdShowLayer *self = [GeogebraCommonKernelScriptingCmdShowLayer alloc];
  GeogebraCommonKernelScriptingCmdShowLayer_initWithGeogebraCommonKernelKernel_(self, kernel);
  return self;
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(GeogebraCommonKernelScriptingCmdShowLayer)
