...
//  source: /Users/jacky/GSoC/geogebra_iOS/geogebra/geogebra/common/src/org/apache/commons/collections15/ExtendedProperties.java
//
...
- (NSString *)interpolateHelperWithNSString:(NSString *)base
  ...
  if (priorVariables == nil) {
    priorVariables = [new_JavaUtilArrayList_init() autorelease];
  ...
  JavaLangStringBuffer *result = [new_JavaLangStringBuffer_init() autorelease];
  while (((begin = [((NSString *) nil_chk(base)) indexOfString:OrgApacheCommonsCollections15ExtendedProperties_START_TOKEN_ fromIndex:prec + ((jint) [OrgApacheCommonsCollections15ExtendedProperties_END_TOKEN_ length])]) > -1) && ((end = [base indexOfString:OrgApacheCommonsCollections15ExtendedProperties_END_TOKEN_ fromIndex:begin]) > -1)) {
    [result appendWithNSString:[base substring:prec + ((jint) [OrgApacheCommonsCollections15ExtendedProperties_END_TOKEN_ length]) endIndex:begin]];
    ...
    if ([((id<JavaUtilList>) nil_chk(priorVariables)) containsWithId:variable]) {
      ...
      JavaLangStringBuffer *priorVariableSb = [new_JavaLangStringBuffer_init() autorelease];
      for (id<JavaUtilIterator> it = [priorVariables iterator]; [((id<JavaUtilIterator>) nil_chk(it)) hasNext]; ) {
        [priorVariableSb appendWithId:[it next]];
        if ([it hasNext]) {
          [priorVariableSb appendWithNSString:@"->"];
        }
      }
      @throw [new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$$$$", @"infinite loop in property interpolation of ", initialBase, @": ", [priorVariableSb description])) autorelease];
    }
    else {
      [priorVariables addWithId:variable];
    }
    ...
    if (value != nil) {
      [result appendWithNSString:[self interpolateHelperWithNSString:[value description] withJavaUtilList:priorVariables]];
      ...
      [result appendWithNSString:[defaults_ getStringWithNSString:variable]];
    }
    else {
      [((JavaLangStringBuffer *) nil_chk([((JavaLangStringBuffer *) nil_chk([result appendWithNSString:OrgApacheCommonsCollections15ExtendedProperties_START_TOKEN_])) appendWithNSString:variable])) appendWithNSString:OrgApacheCommonsCollections15ExtendedProperties_END_TOKEN_];
    }
    prec = end;
  }
  [result appendWithNSString:[base substring:prec + ((jint) [OrgApacheCommonsCollections15ExtendedProperties_END_TOKEN_ length]) endIndex:((jint) [base length])]];
...
- (void)setIncludeWithNSString:(NSString *)inc {
  JreStrongAssign(&OrgApacheCommonsCollections15ExtendedProperties_include_, nil, inc);
}
...
- (void)load__WithJavaIoInputStream:(JavaIoInputStream *)input
  ...
  @synchronized(self) {
    ...
    if (enc != nil) {
      @try {
        reader = [new_OrgApacheCommonsCollections15ExtendedProperties_PropertiesReader_initWithJavaIoReader_([new_JavaIoInputStreamReader_initWithJavaIoInputStream_withNSString_(input, enc) autorelease]) autorelease];
      }
    ...
    if (reader == nil) {
      @try {
        reader = [new_OrgApacheCommonsCollections15ExtendedProperties_PropertiesReader_initWithJavaIoReader_([new_JavaIoInputStreamReader_initWithJavaIoInputStream_withNSString_(input, @"8859_1") autorelease]) autorelease];
      }
      @catch (JavaIoUnsupportedEncodingException *ex) {
        reader = [new_OrgApacheCommonsCollections15ExtendedProperties_PropertiesReader_initWithJavaIoReader_([new_JavaIoInputStreamReader_initWithJavaIoInputStream_(input) autorelease]) autorelease];
      }
    }
    @try {
      while (YES) {
        ...
        if (equalSign > 0) {
          ...
          if ([self getInclude] != nil && [((NSString *) nil_chk(key)) equalsIgnoreCase:[self getInclude]]) {
            ...
            if ([((NSString *) nil_chk(value)) hasPrefix:fileSeparator_]) {
              file = [new_JavaIoFile_initWithNSString_(value) autorelease];
            }
            else {
              if ([value hasPrefix:JreStrcat("C$", '.', fileSeparator_)]) {
                value = [value substring:2];
              }
              file = [new_JavaIoFile_initWithNSString_(JreStrcat("$$", basePath_, value)) autorelease];
            }
            if ([((JavaIoFile *) nil_chk(file)) exists] && [file canRead]) {
              [self load__WithJavaIoInputStream:[new_JavaIoFileInputStream_initWithJavaIoFile_(file) autorelease]];
            }
          }
          else {
...
- (void)addPropertyWithNSString:(NSString *)key
  ...
  if ([value isKindOfClass:[NSString class]]) {
    ...
    if ([((NSString *) nil_chk(str)) indexOfString:OrgApacheCommonsCollections15ExtendedProperties_PropertiesTokenizer_get_DELIMITER_()] > 0) {
      OrgApacheCommonsCollections15ExtendedProperties_PropertiesTokenizer *tokenizer = [new_OrgApacheCommonsCollections15ExtendedProperties_PropertiesTokenizer_initWithNSString_(str) autorelease];
...
- (void)saveWithJavaIoOutputStream:(JavaIoOutputStream *)output
  ...
  @synchronized(self) {
    ...
    JavaIoPrintWriter *theWrtr = [new_JavaIoPrintWriter_initWithJavaIoOutputStream_(output) autorelease];
    if (header != nil) {
    ...
    while ([((id<JavaUtilEnumeration>) nil_chk(theKeys)) hasMoreElements]) {
      ...
      if (value != nil) {
        if ([value isKindOfClass:[NSString class]]) {
          JavaLangStringBuffer *currentOutput = [new_JavaLangStringBuffer_init() autorelease];
          [currentOutput appendWithNSString:key];
          [currentOutput appendWithNSString:@"="];
          [currentOutput appendWithNSString:OrgApacheCommonsCollections15ExtendedProperties_escapeWithNSString_((NSString *) check_class_cast(value, [NSString class]))];
          ...
          while ([((id<JavaUtilEnumeration>) nil_chk(valuesEnum)) hasMoreElements]) {
            ...
            [currentOutput appendWithNSString:key];
            [currentOutput appendWithNSString:@"="];
            [currentOutput appendWithNSString:OrgApacheCommonsCollections15ExtendedProperties_escapeWithNSString_(currentElement)];
            [theWrtr printlnWithNSString:[currentOutput description]];
          }
        }
      }
...
- (id<JavaUtilIterator>)getKeysWithNSString:(NSString *)prefix {
  ...
  JavaUtilArrayList *matchingKeys = [new_JavaUtilArrayList_init() autorelease];
...
- (OrgApacheCommonsCollections15ExtendedProperties *)subsetWithNSString:(NSString *)prefix {
  OrgApacheCommonsCollections15ExtendedProperties *c = [new_OrgApacheCommonsCollections15ExtendedProperties_init() autorelease];
  id<JavaUtilIterator> keys = [self getKeys];
...
- (NSString *)getStringWithNSString:(NSString *)key
  ...
  if ([value isKindOfClass:[NSString class]]) {
    ...
    @throw [new_JavaLangClassCastException_initWithNSString_(JreStrcat("C$$", '\'', key, @"' doesn't map to a String object")) autorelease];
  }
}

- (JavaUtilProperties *)getPropertiesWithNSString:(NSString *)key {
  return [self getPropertiesWithNSString:key withJavaUtilProperties:[new_JavaUtilProperties_init() autorelease]];
}

- (JavaUtilProperties *)getPropertiesWithNSString:(NSString *)key
                           withJavaUtilProperties:(JavaUtilProperties *)defaults {
  IOSObjectArray *tokens = [self getStringArrayWithNSString:key];
  JavaUtilProperties *props = [new_JavaUtilProperties_initWithJavaUtilProperties_(defaults) autorelease];
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(tokens))->size_; i++) {
    ...
    if (equalSign > 0) {
      ...
      [props putWithId:pkey withId:pvalue];
    }
    else {
      @throw [new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("C$$", '\'', token, @"' does not contain an equals sign")) autorelease];
    }
  }
  return props;
}
...
- (IOSObjectArray *)getStringArrayWithNSString:(NSString *)key {
  ...
  if ([value isKindOfClass:[NSString class]]) {
    vector = [new_JavaUtilVector_initWithInt_(1) autorelease];
    ...
    @throw [new_JavaLangClassCastException_initWithNSString_(JreStrcat("C$$", '\'', key, @"' doesn't map to a String/Vector object")) autorelease];
  }
  IOSObjectArray *tokens = [IOSObjectArray arrayWithLength:[((JavaUtilVector *) nil_chk(vector)) size] type:NSString_class_()];
  for (jint i = 0; i < tokens->size_; i++) {
    IOSObjectArray_Set(tokens, i, (NSString *) check_class_cast([vector elementAtWithInt:i], [NSString class]));
  }
  return tokens;
}
...
- (JavaUtilVector *)getVectorWithNSString:(NSString *)key
  ...
  if ([value isKindOfClass:[JavaUtilVector class]]) {
    ...
    JavaUtilVector *v = [new_JavaUtilVector_initWithInt_(1) autorelease];
    ...
    if (defaults_ != nil) {
      ...
      return ((defaultValue == nil) ? [new_JavaUtilVector_init() autorelease] : defaultValue);
    }
  }
  else {
    @throw [new_JavaLangClassCastException_initWithNSString_(JreStrcat("C$$", '\'', key, @"' doesn't map to a Vector object")) autorelease];
  }
}
...
- (jboolean)getBooleanWithNSString:(NSString *)key {
  ...
  if (b != nil) {
    ...
    @throw [new_JavaUtilNoSuchElementException_initWithNSString_(JreStrcat("C$$", '\'', key, @"' doesn't map to an existing object")) autorelease];
  }
}

- (jboolean)getBooleanWithNSString:(NSString *)key
                       withBoolean:(jboolean)defaultValue {
  return [((JavaLangBoolean *) nil_chk([self getBooleanWithNSString:key withJavaLangBoolean:[new_JavaLangBoolean_initWithBoolean_(defaultValue) autorelease]])) booleanValue];
}
...
- (JavaLangBoolean *)getBooleanWithNSString:(NSString *)key
  ...
  if ([value isKindOfClass:[JavaLangBoolean class]]) {
    ...
    JavaLangBoolean *b = [new_JavaLangBoolean_initWithNSString_(s) autorelease];
    [self putWithId:key withId:b];
    return b;
  }
  else if (value == nil) {
    if (defaults_ != nil) {
    ...
    @throw [new_JavaLangClassCastException_initWithNSString_(JreStrcat("C$$", '\'', key, @"' doesn't map to a Boolean object")) autorelease];
  }
}
...
- (jbyte)getByteWithNSString:(NSString *)key
  ...
  return [((JavaLangByte *) nil_chk([self getByteWithNSString:key withJavaLangByte:[new_JavaLangByte_initWithByte_(defaultValue) autorelease]])) charValue];
}
...
- (JavaLangByte *)getByteWithNSString:(NSString *)key
  ...
  if ([value isKindOfClass:[JavaLangByte class]]) {
    ...
    JavaLangByte *b = [new_JavaLangByte_initWithNSString_((NSString *) check_class_cast(value, [NSString class])) autorelease];
    [self putWithId:key withId:b];
    return b;
  }
  else if (value == nil) {
    ...
    @throw [new_JavaLangClassCastException_initWithNSString_(JreStrcat("C$$", '\'', key, @"' doesn't map to a Byte object")) autorelease];
  }
}
...
- (jshort)getShortWithNSString:(NSString *)key
  ...
  return [((JavaLangShort *) nil_chk([self getShortWithNSString:key withJavaLangShort:[new_JavaLangShort_initWithShort_(defaultValue) autorelease]])) shortValue];
}
...
- (JavaLangShort *)getShortWithNSString:(NSString *)key
  ...
  if ([value isKindOfClass:[JavaLangShort class]]) {
    ...
    JavaLangShort *s = [new_JavaLangShort_initWithNSString_((NSString *) check_class_cast(value, [NSString class])) autorelease];
    [self putWithId:key withId:s];
    return s;
  }
  else if (value == nil) {
    if (defaults_ != nil) {
    ...
    @throw [new_JavaLangClassCastException_initWithNSString_(JreStrcat("C$$", '\'', key, @"' doesn't map to a Short object")) autorelease];
  }
}
...
- (JavaLangInteger *)getIntegerWithNSString:(NSString *)key
  ...
  if ([value isKindOfClass:[JavaLangInteger class]]) {
    ...
    JavaLangInteger *i = [new_JavaLangInteger_initWithNSString_((NSString *) check_class_cast(value, [NSString class])) autorelease];
    [self putWithId:key withId:i];
    return i;
  }
  else if (value == nil) {
    if (defaults_ != nil) {
    ...
    @throw [new_JavaLangClassCastException_initWithNSString_(JreStrcat("C$$", '\'', key, @"' doesn't map to a Integer object")) autorelease];
  }
}
...
- (jlong)getLongWithNSString:(NSString *)key
  ...
  return [((JavaLangLong *) nil_chk([self getLongWithNSString:key withJavaLangLong:[new_JavaLangLong_initWithLong_(defaultValue) autorelease]])) longLongValue];
}
...
- (JavaLangLong *)getLongWithNSString:(NSString *)key
  ...
  if ([value isKindOfClass:[JavaLangLong class]]) {
    ...
    JavaLangLong *l = [new_JavaLangLong_initWithNSString_((NSString *) check_class_cast(value, [NSString class])) autorelease];
    [self putWithId:key withId:l];
    return l;
  }
  else if (value == nil) {
    if (defaults_ != nil) {
    ...
    @throw [new_JavaLangClassCastException_initWithNSString_(JreStrcat("C$$", '\'', key, @"' doesn't map to a Long object")) autorelease];
  }
}
...
- (jfloat)getFloatWithNSString:(NSString *)key
  ...
  return [((JavaLangFloat *) nil_chk([self getFloatWithNSString:key withJavaLangFloat:[new_JavaLangFloat_initWithFloat_(defaultValue) autorelease]])) floatValue];
}
...
- (JavaLangFloat *)getFloatWithNSString:(NSString *)key
  ...
  if ([value isKindOfClass:[JavaLangFloat class]]) {
    ...
    JavaLangFloat *f = [new_JavaLangFloat_initWithNSString_((NSString *) check_class_cast(value, [NSString class])) autorelease];
    [self putWithId:key withId:f];
    return f;
  }
  else if (value == nil) {
    if (defaults_ != nil) {
    ...
    @throw [new_JavaLangClassCastException_initWithNSString_(JreStrcat("C$$", '\'', key, @"' doesn't map to a Float object")) autorelease];
  }
}
...
- (jdouble)getDoubleWithNSString:(NSString *)key
  ...
  return [((JavaLangDouble *) nil_chk([self getDoubleWithNSString:key withJavaLangDouble:[new_JavaLangDouble_initWithDouble_(defaultValue) autorelease]])) doubleValue];
}
...
- (JavaLangDouble *)getDoubleWithNSString:(NSString *)key
  ...
  if ([value isKindOfClass:[JavaLangDouble class]]) {
    ...
    JavaLangDouble *d = [new_JavaLangDouble_initWithNSString_((NSString *) check_class_cast(value, [NSString class])) autorelease];
    [self putWithId:key withId:d];
    return d;
  }
  else if (value == nil) {
    if (defaults_ != nil) {
    ...
    @throw [new_JavaLangClassCastException_initWithNSString_(JreStrcat("C$$", '\'', key, @"' doesn't map to a Double object")) autorelease];
  }
}
...
- (void)dealloc {
  ...
  RELEASE_(file_);
  RELEASE_(basePath_);
  RELEASE_(fileSeparator_);
  RELEASE_(keysAsListed_);
  [super dealloc];
}
...
NSString *OrgApacheCommonsCollections15ExtendedProperties_escapeWithNSString_(NSString *s) {
  ...
  JavaLangStringBuffer *buf = [new_JavaLangStringBuffer_initWithNSString_(s) autorelease];
  for (jint i = 0; i < [buf length]; i++) {
    jchar c = [buf charAtWithInt:i];
    if (c == ',' || c == '\\') {
      [buf insertWithInt:i withChar:'\\'];
      i++;
    }
  }
...
void OrgApacheCommonsCollections15ExtendedProperties_init(OrgApacheCommonsCollections15ExtendedProperties *self) {
  ...
  OrgApacheCommonsCollections15ExtendedProperties_set_fileSeparator_(self, JavaLangSystem_getPropertyWithNSString_(@"file.separator"));
  self->isInitialized__ = NO;
  OrgApacheCommonsCollections15ExtendedProperties_setAndConsume_keysAsListed_(self, new_JavaUtilArrayList_init());
}
...
void OrgApacheCommonsCollections15ExtendedProperties_initWithNSString_(OrgApacheCommonsCollections15ExtendedProperties *self, NSString *file) {
  OrgApacheCommonsCollections15ExtendedProperties_initWithNSString_withNSString_(self, file, nil);
}
...
void OrgApacheCommonsCollections15ExtendedProperties_initWithNSString_withNSString_(OrgApacheCommonsCollections15ExtendedProperties *self, NSString *file, NSString *defaultFile) {
  ...
  self->isInitialized__ = NO;
  OrgApacheCommonsCollections15ExtendedProperties_setAndConsume_keysAsListed_(self, new_JavaUtilArrayList_init());
  OrgApacheCommonsCollections15ExtendedProperties_set_file_(self, file);
  OrgApacheCommonsCollections15ExtendedProperties_set_basePath_(self, [((JavaIoFile *) [new_JavaIoFile_initWithNSString_(file) autorelease]) getAbsolutePath]);
  OrgApacheCommonsCollections15ExtendedProperties_set_basePath_(self, [self->basePath_ substring:0 endIndex:[((NSString *) nil_chk(self->basePath_)) lastIndexOfString:self->fileSeparator_] + 1]);
  JavaIoFileInputStream *in = nil;
  @try {
    in = [new_JavaIoFileInputStream_initWithNSString_(file) autorelease];
  ...
  if (defaultFile != nil) {
    OrgApacheCommonsCollections15ExtendedProperties_setAndConsume_defaults_(self, new_OrgApacheCommonsCollections15ExtendedProperties_initWithNSString_(defaultFile));
  }
}
...
void OrgApacheCommonsCollections15ExtendedProperties_addPropertyInternalWithNSString_withId_(OrgApacheCommonsCollections15ExtendedProperties *self, NSString *key, id value) {
  ...
  if ([current isKindOfClass:[NSString class]]) {
    JavaUtilVector *v = [new_JavaUtilVector_initWithInt_(2) autorelease];
    ...
    while (YES) {
      ...
      if ((((jint) [((NSString *) nil_chk(line)) length]) != 0) && ([line charAtWithInt:0] != '#')) {
        if (OrgApacheCommonsCollections15ExtendedProperties_endsWithSlashWithNSString_(line)) {
          ...
          [buffer appendWithNSString:line];
        }
        else {
          [buffer appendWithNSString:line];
          break;
...
void OrgApacheCommonsCollections15ExtendedProperties_PropertiesReader_initWithJavaIoReader_(OrgApacheCommonsCollections15ExtendedProperties_PropertiesReader *self, JavaIoReader *reader) {
  JavaIoLineNumberReader_initWithJavaIoReader_(self, reader);
}
...
- (NSString *)nextToken {
  ...
  while ([self hasMoreTokens]) {
    ...
    if (OrgApacheCommonsCollections15ExtendedProperties_endsWithSlashWithNSString_(token)) {
      [buffer appendWithNSString:[token substring:0 endIndex:((jint) [((NSString *) nil_chk(token)) length]) - 1]];
      [buffer appendWithNSString:OrgApacheCommonsCollections15ExtendedProperties_PropertiesTokenizer_DELIMITER_];
    }
    else {
      [buffer appendWithNSString:token];
      break;
    }
  }
...
void OrgApacheCommonsCollections15ExtendedProperties_PropertiesTokenizer_initWithNSString_(OrgApacheCommonsCollections15ExtendedProperties_PropertiesTokenizer *self, NSString *string) {
  JavaUtilStringTokenizer_initWithNSString_withNSString_(self, string, OrgApacheCommonsCollections15ExtendedProperties_PropertiesTokenizer_DELIMITER_);
}
