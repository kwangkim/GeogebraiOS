...
- (IOSDoubleArray *)getMatrixEntries {
  return [IOSDoubleArray arrayWithDoubles:(jdouble[]){ m00_, m01_, m02_, m10_, m11_, m12_ } count:6];
}
...
- (ComVividsolutionsJtsGeomUtilAffineTransformation *)getInverse {
  ...
  if (det == 0) @throw [new_ComVividsolutionsJtsGeomUtilNoninvertibleTransformationException_initWithNSString_(@"Transformation is non-invertible") autorelease];
  ...
  return [new_ComVividsolutionsJtsGeomUtilAffineTransformation_initWithDouble_withDouble_withDouble_withDouble_withDouble_withDouble_(im00, im01, im02, im10, im11, im12) autorelease];
}
...
- (ComVividsolutionsJtsGeomUtilAffineTransformation *)setToReflectionBasicWithDouble:(jdouble)x0
                                                                          ...
                                                                          withDouble:(jdouble)y1 {
  if (x0 == x1 && y0 == y1) {
    @throw [new_JavaLangIllegalArgumentException_initWithNSString_(@"Reflection line points must be distinct") autorelease];
  }
  jdouble dx = x1 - x0;
  jdouble dy = y1 - y0;
...
- (ComVividsolutionsJtsGeomUtilAffineTransformation *)setToReflectionWithDouble:(jdouble)x0
  ...
  [self setToTranslationWithDouble:-x0 withDouble:-y0];
  jdouble dx = x1 - x0;
  jdouble dy = y1 - y0;
  jdouble d = JavaLangMath_sqrtWithDouble_(dx * dx + dy * dy);
  jdouble sin = dy / d;
  jdouble cos = dx / d;
  [self rotateWithDouble:-sin withDouble:cos];
  [self scale__WithDouble:1 withDouble:-1];
  [self rotateWithDouble:sin withDouble:cos];
  [self translateWithDouble:x0 withDouble:y0];
  return self;
}
...
- (ComVividsolutionsJtsGeomUtilAffineTransformation *)setToReflectionWithDouble:(jdouble)x
                                                                     withDouble:(jdouble)y {
  if (x == 0.0 && y == 0.0) {
    @throw [new_JavaLangIllegalArgumentException_initWithNSString_(@"Reflection vector must be non-zero") autorelease];
  }
...
- (ComVividsolutionsJtsGeomUtilAffineTransformation *)setToRotationWithDouble:(jdouble)theta {
  [self setToRotationWithDouble:JavaLangMath_sinWithDouble_(theta) withDouble:JavaLangMath_cosWithDouble_(theta)];
  return self;
}
...
- (ComVividsolutionsJtsGeomUtilAffineTransformation *)setToRotationWithDouble:(jdouble)theta
                                                                   withDouble:(jdouble)x
                                                                   withDouble:(jdouble)y {
  [self setToRotationWithDouble:JavaLangMath_sinWithDouble_(theta) withDouble:JavaLangMath_cosWithDouble_(theta) withDouble:x withDouble:y];
  return self;
}
...
- (ComVividsolutionsJtsGeomUtilAffineTransformation *)reflectWithDouble:(jdouble)x0
                                                             ...
                                                             withDouble:(jdouble)x1
                                                             withDouble:(jdouble)y1 {
  [self composeWithComVividsolutionsJtsGeomUtilAffineTransformation:ComVividsolutionsJtsGeomUtilAffineTransformation_reflectionInstanceWithDouble_withDouble_withDouble_withDouble_(x0, y0, x1, y1)];
  return self;
}

- (ComVividsolutionsJtsGeomUtilAffineTransformation *)reflectWithDouble:(jdouble)x
                                                             withDouble:(jdouble)y {
  [self composeWithComVividsolutionsJtsGeomUtilAffineTransformation:ComVividsolutionsJtsGeomUtilAffineTransformation_reflectionInstanceWithDouble_withDouble_(x, y)];
  return self;
}

- (ComVividsolutionsJtsGeomUtilAffineTransformation *)rotateWithDouble:(jdouble)theta {
  [self composeWithComVividsolutionsJtsGeomUtilAffineTransformation:ComVividsolutionsJtsGeomUtilAffineTransformation_rotationInstanceWithDouble_(theta)];
  return self;
}

- (ComVividsolutionsJtsGeomUtilAffineTransformation *)rotateWithDouble:(jdouble)sinTheta
                                                            withDouble:(jdouble)cosTheta {
  [self composeWithComVividsolutionsJtsGeomUtilAffineTransformation:ComVividsolutionsJtsGeomUtilAffineTransformation_rotationInstanceWithDouble_withDouble_(sinTheta, cosTheta)];
  return self;
}
...
- (ComVividsolutionsJtsGeomUtilAffineTransformation *)rotateWithDouble:(jdouble)theta
                                                            withDouble:(jdouble)x
                                                            withDouble:(jdouble)y {
  [self composeWithComVividsolutionsJtsGeomUtilAffineTransformation:ComVividsolutionsJtsGeomUtilAffineTransformation_rotationInstanceWithDouble_withDouble_withDouble_(theta, x, y)];
  return self;
}
...
- (ComVividsolutionsJtsGeomUtilAffineTransformation *)scale__WithDouble:(jdouble)xScale
                                                             withDouble:(jdouble)yScale {
  [self composeWithComVividsolutionsJtsGeomUtilAffineTransformation:ComVividsolutionsJtsGeomUtilAffineTransformation_scaleInstanceWithDouble_withDouble_(xScale, yScale)];
  return self;
}

- (ComVividsolutionsJtsGeomUtilAffineTransformation *)shearWithDouble:(jdouble)xShear
                                                           withDouble:(jdouble)yShear {
  [self composeWithComVividsolutionsJtsGeomUtilAffineTransformation:ComVividsolutionsJtsGeomUtilAffineTransformation_shearInstanceWithDouble_withDouble_(xShear, yShear)];
  return self;
}

- (ComVividsolutionsJtsGeomUtilAffineTransformation *)translateWithDouble:(jdouble)x
                                                               withDouble:(jdouble)y {
  [self composeWithComVividsolutionsJtsGeomUtilAffineTransformation:ComVividsolutionsJtsGeomUtilAffineTransformation_translationInstanceWithDouble_withDouble_(x, y)];
  return self;
}
...
ComVividsolutionsJtsGeomUtilAffineTransformation *ComVividsolutionsJtsGeomUtilAffineTransformation_reflectionInstanceWithDouble_withDouble_withDouble_withDouble_(jdouble x0, jdouble y0, jdouble x1, jdouble y1) {
  ...
  ComVividsolutionsJtsGeomUtilAffineTransformation *trans = [new_ComVividsolutionsJtsGeomUtilAffineTransformation_init() autorelease];
  [trans setToReflectionWithDouble:x0 withDouble:y0 withDouble:x1 withDouble:y1];
  return trans;
}
...
ComVividsolutionsJtsGeomUtilAffineTransformation *ComVividsolutionsJtsGeomUtilAffineTransformation_reflectionInstanceWithDouble_withDouble_(jdouble x, jdouble y) {
  ComVividsolutionsJtsGeomUtilAffineTransformation_initialize();
  ComVividsolutionsJtsGeomUtilAffineTransformation *trans = [new_ComVividsolutionsJtsGeomUtilAffineTransformation_init() autorelease];
  [trans setToReflectionWithDouble:x withDouble:y];
  return trans;
}
...
ComVividsolutionsJtsGeomUtilAffineTransformation *ComVividsolutionsJtsGeomUtilAffineTransformation_rotationInstanceWithDouble_withDouble_(jdouble sinTheta, jdouble cosTheta) {
  ComVividsolutionsJtsGeomUtilAffineTransformation_initialize();
  ComVividsolutionsJtsGeomUtilAffineTransformation *trans = [new_ComVividsolutionsJtsGeomUtilAffineTransformation_init() autorelease];
  [trans setToRotationWithDouble:sinTheta withDouble:cosTheta];
  return trans;
}
...
ComVividsolutionsJtsGeomUtilAffineTransformation *ComVividsolutionsJtsGeomUtilAffineTransformation_rotationInstanceWithDouble_withDouble_withDouble_withDouble_(jdouble sinTheta, jdouble cosTheta, jdouble x, jdouble y) {
  ComVividsolutionsJtsGeomUtilAffineTransformation_initialize();
  ComVividsolutionsJtsGeomUtilAffineTransformation *trans = [new_ComVividsolutionsJtsGeomUtilAffineTransformation_init() autorelease];
  [trans setToRotationWithDouble:sinTheta withDouble:cosTheta withDouble:x withDouble:y];
  return trans;
}
...
ComVividsolutionsJtsGeomUtilAffineTransformation *ComVividsolutionsJtsGeomUtilAffineTransformation_scaleInstanceWithDouble_withDouble_(jdouble xScale, jdouble yScale) {
  ComVividsolutionsJtsGeomUtilAffineTransformation_initialize();
  ComVividsolutionsJtsGeomUtilAffineTransformation *trans = [new_ComVividsolutionsJtsGeomUtilAffineTransformation_init() autorelease];
  [trans setToScaleWithDouble:xScale withDouble:yScale];
  return trans;
}
...
ComVividsolutionsJtsGeomUtilAffineTransformation *ComVividsolutionsJtsGeomUtilAffineTransformation_shearInstanceWithDouble_withDouble_(jdouble xShear, jdouble yShear) {
  ComVividsolutionsJtsGeomUtilAffineTransformation_initialize();
  ComVividsolutionsJtsGeomUtilAffineTransformation *trans = [new_ComVividsolutionsJtsGeomUtilAffineTransformation_init() autorelease];
  [trans setToShearWithDouble:xShear withDouble:yShear];
  return trans;
}
...
ComVividsolutionsJtsGeomUtilAffineTransformation *ComVividsolutionsJtsGeomUtilAffineTransformation_translationInstanceWithDouble_withDouble_(jdouble x, jdouble y) {
  ComVividsolutionsJtsGeomUtilAffineTransformation_initialize();
  ComVividsolutionsJtsGeomUtilAffineTransformation *trans = [new_ComVividsolutionsJtsGeomUtilAffineTransformation_init() autorelease];
  [trans setToTranslationWithDouble:x withDouble:y];
  return trans;
}
...
void ComVividsolutionsJtsGeomUtilAffineTransformation_initWithDouble_withDouble_withDouble_withDouble_withDouble_withDouble_(ComVividsolutionsJtsGeomUtilAffineTransformation *self, jdouble m00, jdouble m01, jdouble m02, jdouble m10, jdouble m11, jdouble m12) {
  NSObject_init(self);
  [self setTransformationWithDouble:m00 withDouble:m01 withDouble:m02 withDouble:m10 withDouble:m11 withDouble:m12];
}
...
void ComVividsolutionsJtsGeomUtilAffineTransformation_initWithComVividsolutionsJtsGeomUtilAffineTransformation_(ComVividsolutionsJtsGeomUtilAffineTransformation *self, ComVividsolutionsJtsGeomUtilAffineTransformation *trans) {
  NSObject_init(self);
  [self setTransformationWithComVividsolutionsJtsGeomUtilAffineTransformation:trans];
}
