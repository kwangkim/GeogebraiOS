...
@implementation GeogebraCommonKernelAdvancedCmdAreParallel

- (instancetype)initWithGeogebraCommonKernelKernel:(GeogebraCommonKernelKernel *)kernel {
  GeogebraCommonKernelAdvancedCmdAreParallel_initWithGeogebraCommonKernelKernel_(self, kernel);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithGeogebraCommonKernelKernel:", "CmdAreParallel", NULL, 0x1, NULL, NULL },
  ...
  static const J2ObjcClassInfo _GeogebraCommonKernelAdvancedCmdAreParallel = { 2, "CmdAreParallel", "geogebra.common.kernel.advanced", NULL, 0x1, 2, methods, 0, NULL, 0, NULL, 0, NULL, NULL, NULL };
  return &_GeogebraCommonKernelAdvancedCmdAreParallel;
}

@end

void GeogebraCommonKernelAdvancedCmdAreParallel_initWithGeogebraCommonKernelKernel_(GeogebraCommonKernelAdvancedCmdAreParallel *self, GeogebraCommonKernelKernel *kernel) {
  GeogebraCommonKernelCommandsCommandProcessor_initWithGeogebraCommonKernelKernel_(self, kernel);
}

GeogebraCommonKernelAdvancedCmdAreParallel *new_GeogebraCommonKernelAdvancedCmdAreParallel_initWithGeogebraCommonKernelKernel_(GeogebraCommonKernelKernel *kernel) {
  GeogebraCommonKernelAdvancedCmdAreParallel *self = [GeogebraCommonKernelAdvancedCmdAreParallel alloc];
  GeogebraCommonKernelAdvancedCmdAreParallel_initWithGeogebraCommonKernelKernel_(self, kernel);
  return self;
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(GeogebraCommonKernelAdvancedCmdAreParallel)
