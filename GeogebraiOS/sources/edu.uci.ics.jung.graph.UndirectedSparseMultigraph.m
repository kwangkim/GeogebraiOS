...
- (jboolean)removeVertexWithId:(id)vertex {
  ...
  for (id __strong edge in [new_JavaUtilArrayList_initWithJavaUtilCollection_([self getIncident_internalWithId:vertex]) autorelease]) [self removeEdgeWithId:edge];
...
withEduUciIcsJungGraphUtilEdgeTypeEnum:(EduUciIcsJungGraphUtilEdgeTypeEnum *)edgeType {
  return [self addEdgeWithId:edge withEduUciIcsJungGraphUtilPair:[new_EduUciIcsJungGraphUtilPair_initWithId_withId_(v1, v2) autorelease] withEduUciIcsJungGraphUtilEdgeTypeEnum:edgeType];
}
...
- (EduUciIcsJungGraphUndirectedSparseMultigraph *)newInstance {
  return [new_EduUciIcsJungGraphUndirectedSparseMultigraph_init() autorelease];
}
...
id<OrgApacheCommonsCollections15Factory> EduUciIcsJungGraphUndirectedSparseMultigraph_getFactory() {
  ...
  return [new_EduUciIcsJungGraphUndirectedSparseMultigraph_$1_init() autorelease];
}
...
void EduUciIcsJungGraphUndirectedSparseMultigraph_init(EduUciIcsJungGraphUndirectedSparseMultigraph *self) {
  ...
  EduUciIcsJungGraphUndirectedSparseMultigraph_setAndConsume_vertices_(self, new_JavaUtilHashMap_init());
  EduUciIcsJungGraphUndirectedSparseMultigraph_setAndConsume_edges_(self, new_JavaUtilHashMap_init());
}
