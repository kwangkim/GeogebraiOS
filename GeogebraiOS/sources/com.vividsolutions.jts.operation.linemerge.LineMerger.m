...
- (void)addWithComVividsolutionsJtsGeomGeometry:(ComVividsolutionsJtsGeomGeometry *)geometry {
  [((ComVividsolutionsJtsGeomGeometry *) nil_chk(geometry)) applyWithComVividsolutionsJtsGeomGeometryComponentFilter:[new_ComVividsolutionsJtsOperationLinemergeLineMerger_$1_initWithComVividsolutionsJtsOperationLinemergeLineMerger_(self) autorelease]];
}

- (void)addWithJavaUtilCollection:(id<JavaUtilCollection>)geometries {
  ComVividsolutionsJtsOperationLinemergeLineMerger_set_mergedLineStrings_(self, nil);
...
- (void)dealloc {
  RELEASE_(graph_);
  RELEASE_(mergedLineStrings_);
  RELEASE_(factory_);
  RELEASE_(edgeStrings_);
  [super dealloc];
}
...
void ComVividsolutionsJtsOperationLinemergeLineMerger_addWithComVividsolutionsJtsGeomLineString_(ComVividsolutionsJtsOperationLinemergeLineMerger *self, ComVividsolutionsJtsGeomLineString *lineString) {
  if (self->factory_ == nil) {
    ComVividsolutionsJtsOperationLinemergeLineMerger_set_factory_(self, [((ComVividsolutionsJtsGeomLineString *) nil_chk(lineString)) getFactory]);
  }
...
void ComVividsolutionsJtsOperationLinemergeLineMerger_merge(ComVividsolutionsJtsOperationLinemergeLineMerger *self) {
  ...
  ComVividsolutionsJtsOperationLinemergeLineMerger_setAndConsume_edgeStrings_(self, new_JavaUtilArrayList_init());
  ComVividsolutionsJtsOperationLinemergeLineMerger_buildEdgeStringsForObviousStartNodes(self);
  ComVividsolutionsJtsOperationLinemergeLineMerger_buildEdgeStringsForIsolatedLoops(self);
  ComVividsolutionsJtsOperationLinemergeLineMerger_setAndConsume_mergedLineStrings_(self, new_JavaUtilArrayList_init());
...
ComVividsolutionsJtsOperationLinemergeEdgeString *ComVividsolutionsJtsOperationLinemergeLineMerger_buildEdgeStringStartingWithWithComVividsolutionsJtsOperationLinemergeLineMergeDirectedEdge_(ComVividsolutionsJtsOperationLinemergeLineMerger *self, ComVividsolutionsJtsOperationLinemergeLineMergeDirectedEdge *start) {
  ComVividsolutionsJtsOperationLinemergeEdgeString *edgeString = [new_ComVividsolutionsJtsOperationLinemergeEdgeString_initWithComVividsolutionsJtsGeomGeometryFactory_(self->factory_) autorelease];
...
void ComVividsolutionsJtsOperationLinemergeLineMerger_init(ComVividsolutionsJtsOperationLinemergeLineMerger *self) {
  NSObject_init(self);
  ComVividsolutionsJtsOperationLinemergeLineMerger_setAndConsume_graph_(self, new_ComVividsolutionsJtsOperationLinemergeLineMergeGraph_init());
  ComVividsolutionsJtsOperationLinemergeLineMerger_set_mergedLineStrings_(self, nil);
  ComVividsolutionsJtsOperationLinemergeLineMerger_set_factory_(self, nil);
  ComVividsolutionsJtsOperationLinemergeLineMerger_set_edgeStrings_(self, nil);
}
...
void ComVividsolutionsJtsOperationLinemergeLineMerger_$1_initWithComVividsolutionsJtsOperationLinemergeLineMerger_(ComVividsolutionsJtsOperationLinemergeLineMerger_$1 *self, ComVividsolutionsJtsOperationLinemergeLineMerger *outer$) {
  ComVividsolutionsJtsOperationLinemergeLineMerger_$1_set_this$0_(self, outer$);
  NSObject_init(self);
}
