...
//  source: /Users/jacky/GSoC/geogebra_iOS/geogebra/geogebra/common/src/edu/uci/ics/jung/algorithms/metrics/StructuralHoles.java
//
...
void EduUciIcsJungAlgorithmsMetricsStructuralHoles_initWithEduUciIcsJungGraphGraph_withOrgApacheCommonsCollections15Transformer_(EduUciIcsJungAlgorithmsMetricsStructuralHoles *self, id<EduUciIcsJungGraphGraph> graph, id<OrgApacheCommonsCollections15Transformer> nev) {
  NSObject_init(self);
  EduUciIcsJungAlgorithmsMetricsStructuralHoles_set_g_(self, graph);
  EduUciIcsJungAlgorithmsMetricsStructuralHoles_set_edge_weight_(self, nev);
}
