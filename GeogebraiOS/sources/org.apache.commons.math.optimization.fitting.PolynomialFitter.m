...
//  source: /Users/jacky/GSoC/geogebra_iOS/geogebra/geogebra/common/src/org/apache/commons/math/optimization/fitting/PolynomialFitter.java
//
...
void OrgApacheCommonsMathOptimizationFittingPolynomialFitter_initWithInt_withOrgApacheCommonsMathOptimizationDifferentiableMultivariateVectorialOptimizer_(OrgApacheCommonsMathOptimizationFittingPolynomialFitter *self, jint degree, id<OrgApacheCommonsMathOptimizationDifferentiableMultivariateVectorialOptimizer> optimizer) {
  NSObject_init(self);
  OrgApacheCommonsMathOptimizationFittingPolynomialFitter_setAndConsume_fitter_(self, new_OrgApacheCommonsMathOptimizationFittingCurveFitter_initWithOrgApacheCommonsMathOptimizationDifferentiableMultivariateVectorialOptimizer_(optimizer));
  self->degree_ = degree;
}
...
- (IOSDoubleArray *)gradientWithDouble:(jdouble)x
                       withDoubleArray:(IOSDoubleArray *)parameters {
  IOSDoubleArray *gradient = [IOSDoubleArray arrayWithLength:((IOSDoubleArray *) nil_chk(parameters))->size_];
  jdouble xn = 1.0;
