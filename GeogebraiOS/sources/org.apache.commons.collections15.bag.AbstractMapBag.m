...
//  source: /Users/jacky/GSoC/geogebra_iOS/geogebra/geogebra/common/src/org/apache/commons/collections15/bag/AbstractMapBag.java
//
...
- (jboolean)containsAllWithJavaUtilCollection:(id<JavaUtilCollection>)coll {
  ...
  return [self containsAllWithOrgApacheCommonsCollections15Bag:[new_OrgApacheCommonsCollections15BagHashBag_initWithJavaUtilCollection_(coll) autorelease]];
}
...
- (id<JavaUtilIterator>)iterator {
  return [new_OrgApacheCommonsCollections15BagAbstractMapBag_BagIterator_initWithOrgApacheCommonsCollections15BagAbstractMapBag_(self) autorelease];
}
...
- (jboolean)addWithId:(id)object
  ...
  if (nCopies > 0) {
    ...
    size__ += nCopies;
    if (mut == nil) {
      [map_ putWithId:object withId:[new_OrgApacheCommonsCollections15BagAbstractMapBag_MutableInteger_initWithInt_(nCopies) autorelease]];
      return YES;
    }
    else {
      mut->value_ += nCopies;
...
- (jboolean)removeWithId:(id)object
  ...
  if (nCopies < ((OrgApacheCommonsCollections15BagAbstractMapBag_MutableInteger *) nil_chk(mut))->value_) {
    mut->value_ -= nCopies;
    [map_ putWithId:object withId:mut];
    size__ -= nCopies;
  }
  else {
    [map_ removeWithId:object];
...
- (jboolean)retainAllWithJavaUtilCollection:(id<JavaUtilCollection>)coll {
  ...
  return [self retainAllWithOrgApacheCommonsCollections15Bag:[new_OrgApacheCommonsCollections15BagHashBag_initWithJavaUtilCollection_(coll) autorelease]];
}

- (jboolean)retainAllWithOrgApacheCommonsCollections15Bag:(id<OrgApacheCommonsCollections15Bag>)other {
  jboolean result = NO;
  id<OrgApacheCommonsCollections15Bag> excess = [new_OrgApacheCommonsCollections15BagHashBag_init() autorelease];
...
- (IOSObjectArray *)toArray {
  ...
  while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
    ...
    for (jint index = [self getCountWithId:current]; index > 0; index--) {
      IOSObjectArray_Set(result, i++, current);
    }
  }
  return result;
}
...
- (IOSObjectArray *)toArrayWithNSObjectArray:(IOSObjectArray *)array {
  ...
  while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
    id current = [it next];
    for (jint index = [self getCountWithId:current]; index > 0; index--) {
      IOSObjectArray_Set(nil_chk(array), i++, current);
    }
  }
  if (((IOSObjectArray *) nil_chk(array))->size_ > size) {
...
- (id<JavaUtilSet>)uniqueSet {
  if (uniqueSet__ == nil) {
    OrgApacheCommonsCollections15BagAbstractMapBag_set_uniqueSet__(self, OrgApacheCommonsCollections15SetUnmodifiableSet_decorateWithJavaUtilSet_([((id<JavaUtilMap>) nil_chk(map_)) keySet]));
  }
  return uniqueSet__;
}
...
- (void)doReadObjectWithJavaUtilMap:(id<JavaUtilMap>)map
  ...
  OrgApacheCommonsCollections15BagAbstractMapBag_set_map_(self, map);
  ...
  for (jint i = 0; i < entrySize; i++) {
    ...
    [((id<JavaUtilMap>) nil_chk(map)) putWithId:obj withId:[new_OrgApacheCommonsCollections15BagAbstractMapBag_MutableInteger_initWithInt_(count) autorelease]];
    size__ += count;
  }
}
...
- (NSString *)description {
  ...
  while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
    ...
    [buf appendWithInt:count];
    [buf appendWithChar:':'];
    [buf appendWithId:current];
    if ([it hasNext]) {
      [buf appendWithChar:','];
    }
  }
...
- (id)next {
  ...
  if (itemCount_ == 0) {
    OrgApacheCommonsCollections15BagAbstractMapBag_BagIterator_set_current_(self, [((id<JavaUtilIterator>) nil_chk(entryIterator_)) next]);
...
void OrgApacheCommonsCollections15BagAbstractMapBag_BagIterator_initWithOrgApacheCommonsCollections15BagAbstractMapBag_(OrgApacheCommonsCollections15BagAbstractMapBag_BagIterator *self, OrgApacheCommonsCollections15BagAbstractMapBag *parent) {
  NSObject_init(self);
  OrgApacheCommonsCollections15BagAbstractMapBag_BagIterator_set_parent_(self, parent);
  OrgApacheCommonsCollections15BagAbstractMapBag_BagIterator_set_entryIterator_(self, [((id<JavaUtilSet>) nil_chk([((id<JavaUtilMap>) nil_chk(((OrgApacheCommonsCollections15BagAbstractMapBag *) nil_chk(parent))->map_)) entrySet])) iterator]);
  OrgApacheCommonsCollections15BagAbstractMapBag_BagIterator_set_current_(self, nil);
