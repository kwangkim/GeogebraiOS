...
- (OrgApacheCommonsMathStatDescriptiveMomentSkewness *)copy__ {
  OrgApacheCommonsMathStatDescriptiveMomentSkewness *result = [new_OrgApacheCommonsMathStatDescriptiveMomentSkewness_init() autorelease];
...
void OrgApacheCommonsMathStatDescriptiveMomentSkewness_init(OrgApacheCommonsMathStatDescriptiveMomentSkewness *self) {
  ...
  OrgApacheCommonsMathStatDescriptiveMomentSkewness_set_moment_(self, nil);
  self->incMoment_ = YES;
  OrgApacheCommonsMathStatDescriptiveMomentSkewness_setAndConsume_moment_(self, new_OrgApacheCommonsMathStatDescriptiveMomentThirdMoment_init());
}
...
void OrgApacheCommonsMathStatDescriptiveMomentSkewness_initWithOrgApacheCommonsMathStatDescriptiveMomentThirdMoment_(OrgApacheCommonsMathStatDescriptiveMomentSkewness *self, OrgApacheCommonsMathStatDescriptiveMomentThirdMoment *m3) {
  ...
  OrgApacheCommonsMathStatDescriptiveMomentSkewness_set_moment_(self, nil);
  self->incMoment_ = NO;
  OrgApacheCommonsMathStatDescriptiveMomentSkewness_set_moment_(self, m3);
}
...
void OrgApacheCommonsMathStatDescriptiveMomentSkewness_copy__WithOrgApacheCommonsMathStatDescriptiveMomentSkewness_withOrgApacheCommonsMathStatDescriptiveMomentSkewness_(OrgApacheCommonsMathStatDescriptiveMomentSkewness *source, OrgApacheCommonsMathStatDescriptiveMomentSkewness *dest) {
  ...
  OrgApacheCommonsMathStatDescriptiveMomentSkewness_setAndConsume_moment_(dest, new_OrgApacheCommonsMathStatDescriptiveMomentThirdMoment_initWithOrgApacheCommonsMathStatDescriptiveMomentThirdMoment_([((OrgApacheCommonsMathStatDescriptiveMomentThirdMoment *) nil_chk(source->moment_)) copy__]));
