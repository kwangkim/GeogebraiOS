...
//  source: /Users/jacky/GSoC/geogebra_iOS/geogebra/geogebra/common/src/com/vividsolutions/jts/planargraph/DirectedEdgeStar.java
//
...
void ComVividsolutionsJtsPlanargraphDirectedEdgeStar_init(ComVividsolutionsJtsPlanargraphDirectedEdgeStar *self) {
  NSObject_init(self);
  ComVividsolutionsJtsPlanargraphDirectedEdgeStar_setAndConsume_outEdges_(self, new_JavaUtilArrayList_init());
  self->sorted_ = NO;
}
