...
jboolean ComVividsolutionsJtsAlgorithmNonRobustCGAlgorithms_isCCWWithComVividsolutionsJtsGeomCoordinateArray_(IOSObjectArray *ring) {
  ...
  if ([((ComVividsolutionsJtsGeomCoordinate *) nil_chk(prev)) isEqual:hip] || [((ComVividsolutionsJtsGeomCoordinate *) nil_chk(next)) isEqual:hip] || [prev isEqual:next]) @throw [new_JavaLangIllegalArgumentException_initWithNSString_(@"degenerate ring (does not contain 3 different points)") autorelease];
