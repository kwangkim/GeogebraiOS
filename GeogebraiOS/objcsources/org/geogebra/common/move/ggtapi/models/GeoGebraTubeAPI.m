...
- (jboolean)checkAvailableWithOrgGeogebraCommonMoveGgtapiOperationsLogInOperation:(OrgGeogebraCommonMoveGgtapiOperationsLogInOperation *)op {
  if (self->availabilityCheckDone_ && op != nil) {
    [op onEventWithOrgGeogebraCommonMoveEventsBaseEvent:new_OrgGeogebraCommonMoveGgtapiTubeAvailabilityCheckEvent_initWithBoolean_(self->available_)];
  }
...
- (void)setUserLanguageWithNSString:(NSString *)lang
  ...
  OrgGeogebraCommonMoveGgtapiModelsGeoGebraTubeAPI_performRequestWithNSString_withBoolean_withOrgGeogebraCommonMoveGgtapiModelsAjaxCallback_(self, JreStrcat("$$$$$", @"{\"request\": {\"api\":\"1.0.0\",\"login\": {\"token\":\"", token, @"\", \"getuserinfo\":\"false\"},\"task\": {\"type\":\"setuserlang\", \"lang\":\"", lang, @"\"}}}"), YES, new_OrgGeogebraCommonMoveGgtapiModelsGeoGebraTubeAPI_$3_init());
}

- (void)logoutWithNSString:(NSString *)token {
  OrgGeogebraCommonMoveGgtapiModelsGeoGebraTubeAPI_performRequestWithNSString_withBoolean_withOrgGeogebraCommonMoveGgtapiModelsAjaxCallback_(self, JreStrcat("$$$", @"{\"request\": {\"api\":\"1.0.0\",\"logout\": {\"token\":\"", token, @"\", \"getuserinfo\":\"false\"}}}"), YES, new_OrgGeogebraCommonMoveGgtapiModelsGeoGebraTubeAPI_$4_init());
}
...
jboolean OrgGeogebraCommonMoveGgtapiModelsGeoGebraTubeAPI_checkIfAvailableWithOrgGeogebraCommonMoveGgtapiOperationsLogInOperation_withNSString_(OrgGeogebraCommonMoveGgtapiModelsGeoGebraTubeAPI *self, OrgGeogebraCommonMoveGgtapiOperationsLogInOperation *op, NSString *clientInfo) {
  ...
  @try {
    OrgGeogebraCommonMoveGgtapiModelsGeoGebraTubeAPI_performRequestWithNSString_withBoolean_withOrgGeogebraCommonMoveGgtapiModelsAjaxCallback_(self, JreStrcat("$$$", @"{\"request\": {\"-api\": \"1.0.0\",", clientInfo, @"\"task\": {\"-type\": \"info\"}}}"), NO, new_OrgGeogebraCommonMoveGgtapiModelsGeoGebraTubeAPI_$2_initWithOrgGeogebraCommonMoveGgtapiModelsGeoGebraTubeAPI_withOrgGeogebraCommonMoveGgtapiOperationsLogInOperation_(self, op));
  }
...
- (void)onSuccessWithNSString:(NSString *)responseStr {
  @try {
    ...
    if (![this$0_ parseUserDataFromResponseWithOrgGeogebraCommonMoveGgtapiModelsGeoGebraTubeUser:val$user_ withNSString:responseStr]) {
      [((OrgGeogebraCommonMoveGgtapiOperationsLogInOperation *) nil_chk(val$op_)) onEventWithOrgGeogebraCommonMoveEventsBaseEvent:new_OrgGeogebraCommonMoveGgtapiEventsLoginEvent_initWithOrgGeogebraCommonMoveGgtapiModelsGeoGebraTubeUser_withBoolean_withBoolean_withNSString_(val$user_, NO, val$automatic_, responseStr)];
      return;
    }
    [((OrgGeogebraCommonMoveGgtapiOperationsLogInOperation *) nil_chk(val$op_)) onEventWithOrgGeogebraCommonMoveEventsBaseEvent:new_OrgGeogebraCommonMoveGgtapiEventsLoginEvent_initWithOrgGeogebraCommonMoveGgtapiModelsGeoGebraTubeUser_withBoolean_withBoolean_withNSString_(val$user_, YES, val$automatic_, responseStr)];
  }
  @catch (JavaLangException *e) {
    [((JavaLangException *) nil_chk(e)) printStackTrace];
  }
...
- (void)onErrorWithNSString:(NSString *)error {
  ...
  [((OrgGeogebraCommonMoveGgtapiOperationsLogInOperation *) nil_chk(val$op_)) onEventWithOrgGeogebraCommonMoveEventsBaseEvent:new_OrgGeogebraCommonMoveGgtapiEventsLoginEvent_initWithOrgGeogebraCommonMoveGgtapiModelsGeoGebraTubeUser_withBoolean_withBoolean_withNSString_(val$user_, NO, val$automatic_, nil)];
}
...
- (void)onSuccessWithNSString:(NSString *)response {
  ...
  this$0_->available_ = YES;
  if (val$op_ != nil) {
    [val$op_ onEventWithOrgGeogebraCommonMoveEventsBaseEvent:new_OrgGeogebraCommonMoveGgtapiTubeAvailabilityCheckEvent_initWithBoolean_(YES)];
  }
}
