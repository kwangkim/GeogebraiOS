...
- (void)performTokenLoginWithNSString:(NSString *)token
  ...
  [self doPerformTokenLoginWithOrgGeogebraCommonMoveGgtapiModelsGeoGebraTubeUser:new_OrgGeogebraCommonMoveGgtapiModelsGeoGebraTubeUser_initWithNSString_(token) withBoolean:automatic];
}

- (void)stayLoggedOut {
  [((OrgGeogebraCommonMoveGgtapiModelsAuthenticationModel *) nil_chk([self getModel])) stayLoggedOut];
  [self onEventWithOrgGeogebraCommonMoveEventsBaseEvent:new_OrgGeogebraCommonMoveEventsStayLoggedOutEvent_initWithNSString_(nil)];
}

- (void)performCookieLoginWithNSString:(NSString *)cookie {
  [self doPerformTokenLoginWithOrgGeogebraCommonMoveGgtapiModelsGeoGebraTubeUser:new_OrgGeogebraCommonMoveGgtapiModelsGeoGebraTubeUser_initWithNSString_withNSString_(nil, cookie) withBoolean:YES];
}
...
- (void)doPerformTokenLoginWithOrgGeogebraCommonMoveGgtapiModelsGeoGebraTubeUser:(OrgGeogebraCommonMoveGgtapiModelsGeoGebraTubeUser *)user
  ...
  [self onEventWithOrgGeogebraCommonMoveEventsBaseEvent:new_OrgGeogebraCommonMoveGgtapiEventsLoginAttemptEvent_initWithOrgGeogebraCommonMoveGgtapiModelsGeoGebraTubeUser_(user)];
...
- (void)performLogOut {
  [self onEventWithOrgGeogebraCommonMoveEventsBaseEvent:new_OrgGeogebraCommonMoveGgtapiEventsLogOutEvent_init()];
}
