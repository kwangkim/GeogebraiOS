...
- (void)dispatchEventWithOrgGeogebraCommonPluginEventTypeEnum:(OrgGeogebraCommonPluginEventTypeEnum *)evtType
  ...
  [self dispatchEventWithOrgGeogebraCommonPluginEvent:new_OrgGeogebraCommonPluginEvent_initWithOrgGeogebraCommonPluginEventTypeEnum_withOrgGeogebraCommonKernelGeosGeoElement_withNSString_(evtType, geo, arg)];
}
...
- (void)dispatchEventWithOrgGeogebraCommonPluginEventTypeEnum:(OrgGeogebraCommonPluginEventTypeEnum *)evtType
  ...
  [self dispatchEventWithOrgGeogebraCommonPluginEvent:new_OrgGeogebraCommonPluginEvent_initWithOrgGeogebraCommonPluginEventTypeEnum_withOrgGeogebraCommonKernelGeosGeoElement_(evtType, geo)];
}
...
- (void)dispatchBulkEventWithOrgGeogebraCommonPluginEventTypeEnum:(OrgGeogebraCommonPluginEventTypeEnum *)evtType
  ...
  [self dispatchEventWithOrgGeogebraCommonPluginEvent:new_OrgGeogebraCommonPluginEvent_initWithOrgGeogebraCommonPluginEventTypeEnum_withOrgGeogebraCommonKernelGeosGeoElement_withNSString_withJavaUtilArrayList_(evtType, nil, nil, geos)];
}
