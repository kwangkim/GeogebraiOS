...
withOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  ...
  if (type != nil) {
    if (type == OrgGeogebraCommonPluginSensorLogger_TypesEnum_get_PORT()) {
      ...
      OrgGeogebraCommonPluginSensorLogger_appID_ = [((OrgGeogebraCommonKernelGeosGeoText *) nil_chk(((OrgGeogebraCommonKernelGeosGeoText *) check_class_cast(geo, [OrgGeogebraCommonKernelGeosGeoText class])))) getTextString];
    }
    else {
      ...
      (void) [((JavaUtilHashMap *) nil_chk(listeners_)) putWithId:type withId:(OrgGeogebraCommonKernelGeosGeoNumeric *) check_class_cast(geo, [OrgGeogebraCommonKernelGeosGeoNumeric class])];
    }
  }
}
...
- (void)removeRegisteredGeoWithOrgGeogebraCommonPluginSensorLogger_TypesEnum:(OrgGeogebraCommonPluginSensorLogger_TypesEnum *)sensor {
  (void) [((JavaUtilHashMap *) nil_chk(listeners_)) removeWithId:sensor];
  (void) [((JavaUtilHashMap *) nil_chk(listenersL_)) removeWithId:sensor];
  (void) [((JavaUtilHashMap *) nil_chk(listenersF_)) removeWithId:sensor];
  (void) [((JavaUtilHashMap *) nil_chk(listenersAges_)) removeWithId:sensor];
  (void) [((JavaUtilHashMap *) nil_chk(listLimits_)) removeWithId:sensor];
}
...
withOrgGeogebraCommonKernelGeosGeoFunction:(OrgGeogebraCommonKernelGeosGeoFunction *)function
  ...
  if (type != nil) {
    ...
    (void) [((JavaUtilHashMap *) nil_chk(listenersF_)) putWithId:type withId:function];
  }
}
...
withOrgGeogebraCommonKernelGeosGeoList:(OrgGeogebraCommonKernelGeosGeoList *)list
  ...
  if (type != nil) {
    ...
    (void) [((JavaUtilHashMap *) nil_chk(listenersL_)) putWithId:type withId:list];
  }
}
...
- (void)logWithOrgGeogebraCommonPluginSensorLogger_TypesEnum:(OrgGeogebraCommonPluginSensorLogger_TypesEnum *)type
  ...
  if (geo != nil) {
    ...
    if (list != nil) {
      geo = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_([list getConstruction], val);
...
void OrgGeogebraCommonPluginSensorLogger_prepareRegisterWithOrgGeogebraCommonPluginSensorLogger_TypesEnum_withOrgGeogebraCommonKernelGeosGeoElement_withDouble_(OrgGeogebraCommonPluginSensorLogger *self, OrgGeogebraCommonPluginSensorLogger_TypesEnum *type, OrgGeogebraCommonKernelGeosGeoElement *geo, jdouble limit) {
  ...
  (void) [((JavaUtilHashMap *) nil_chk(self->listenersL_)) removeWithId:type];
  (void) [((JavaUtilHashMap *) nil_chk(self->listeners_)) removeWithId:type];
  (void) [((JavaUtilHashMap *) nil_chk(self->listenersF_)) removeWithId:type];
  jint lim = (jint) JavaLangMath_roundWithDouble_(limit);
  if (lim < 0) {
    lim = 0;
  }
  (void) [((JavaUtilHashMap *) nil_chk(self->listLimits_)) putWithId:type withId:JavaLangInteger_valueOfWithInt_(lim)];
  (void) [((JavaUtilHashMap *) nil_chk(self->listenersAges_)) putWithId:type withId:JavaLangInteger_valueOfWithInt_(0)];
}
...
void OrgGeogebraCommonPluginSensorLogger_registerLogWithOrgGeogebraCommonPluginSensorLogger_TypesEnum_(OrgGeogebraCommonPluginSensorLogger *self, OrgGeogebraCommonPluginSensorLogger_TypesEnum *type) {
  ...
  (void) [self->listenersAges_ putWithId:type withId:JavaLangInteger_valueOfWithInt_(referenceAge + 1)];
  ...
  while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
    ...
    if (referenceAge > [age intValue] + 1) {
      (void) [self->listenersAges_ putWithId:thistype withId:JavaLangInteger_valueOfWithInt_([age intValue] + 1)];
  ...
  if (numOld == numAll) {
    ...
    while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
      thistype = (OrgGeogebraCommonPluginSensorLogger_TypesEnum *) check_class_cast([it next], [OrgGeogebraCommonPluginSensorLogger_TypesEnum class]);
      JavaLangInteger *age = [self->listenersAges_ getWithId:thistype];
      (void) [self->listenersAges_ putWithId:thistype withId:JavaLangInteger_valueOfWithInt_([((JavaLangInteger *) nil_chk(age)) intValue] - 100)];
    }
  }
}
...
void OrgGeogebraCommonPluginSensorLogger_init(OrgGeogebraCommonPluginSensorLogger *self) {
  ...
  self->listenersL_ = new_JavaUtilHashMap_init();
  self->listenersF_ = new_JavaUtilHashMap_init();
  self->listLimits_ = new_JavaUtilHashMap_init();
  self->listenersAges_ = new_JavaUtilHashMap_init();
