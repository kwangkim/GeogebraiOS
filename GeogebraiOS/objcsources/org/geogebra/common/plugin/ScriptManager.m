...
- (void)reset {
  if (updateListenerMap_ != nil) {
    OrgGeogebraCommonPluginScriptManager_set_updateListenerMap_(self, nil);
  }
  if (clickListenerMap_ != nil) {
    OrgGeogebraCommonPluginScriptManager_set_clickListenerMap_(self, nil);
  }
...
- (void)registerObjectUpdateListenerWithNSString:(NSString *)objName
  ...
  OrgGeogebraCommonPluginScriptManager_set_updateListenerMap_(self, OrgGeogebraCommonPluginScriptManager_registerObjectListenerWithJavaUtilHashMap_withNSString_withNSString_(self, updateListenerMap_, objName, fName));
}
...
- (void)registerObjectClickListenerWithNSString:(NSString *)objName
                                   withNSString:(NSString *)fName {
  OrgGeogebraCommonPluginScriptManager_set_clickListenerMap_(self, OrgGeogebraCommonPluginScriptManager_registerObjectListenerWithJavaUtilHashMap_withNSString_withNSString_(self, clickListenerMap_, objName, fName));
}
...
- (JavaUtilArrayList *)getAddListeners {
  if (addListeners_ == nil) {
    OrgGeogebraCommonPluginScriptManager_setAndConsume_addListeners_(self, new_JavaUtilArrayList_init());
  }
...
- (JavaUtilArrayList *)getStoreUndoListeners {
  if (storeUndoListeners_ == nil) {
    OrgGeogebraCommonPluginScriptManager_setAndConsume_storeUndoListeners_(self, new_JavaUtilArrayList_init());
  }
...
- (JavaUtilArrayList *)getRemoveListeners {
  if (removeListeners_ == nil) {
    OrgGeogebraCommonPluginScriptManager_setAndConsume_removeListeners_(self, new_JavaUtilArrayList_init());
  }
...
- (JavaUtilArrayList *)getRenameListeners {
  if (renameListeners_ == nil) {
    OrgGeogebraCommonPluginScriptManager_setAndConsume_renameListeners_(self, new_JavaUtilArrayList_init());
  }
...
- (JavaUtilArrayList *)getupdateListeners {
  if (updateListeners_ == nil) {
    OrgGeogebraCommonPluginScriptManager_setAndConsume_updateListeners_(self, new_JavaUtilArrayList_init());
  }
...
- (JavaUtilArrayList *)getClearListeners {
  if (clearListeners_ == nil) {
    OrgGeogebraCommonPluginScriptManager_setAndConsume_clearListeners_(self, new_JavaUtilArrayList_init());
  }
...
- (JavaUtilHashMap *)getUpdateListenerMap {
  if (updateListenerMap_ == nil) {
    OrgGeogebraCommonPluginScriptManager_setAndConsume_updateListenerMap_(self, new_JavaUtilHashMap_init());
  }
...
- (JavaUtilHashMap *)getClickListenerMap {
  if (clickListenerMap_ == nil) {
    OrgGeogebraCommonPluginScriptManager_setAndConsume_clickListenerMap_(self, new_JavaUtilHashMap_init());
  }
...
void OrgGeogebraCommonPluginScriptManager_initWithOrgGeogebraCommonMainApp_(OrgGeogebraCommonPluginScriptManager *self, OrgGeogebraCommonMainApp *app) {
  ...
  OrgGeogebraCommonPluginScriptManager_setAndConsume_renameListeners_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonPluginScriptManager_setAndConsume_updateListeners_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonPluginScriptManager_setAndConsume_clickListeners_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonPluginScriptManager_setAndConsume_clearListeners_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonPluginScriptManager_setAndConsume_clientListeners_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonPluginScriptManager_set_app_(self, app);
