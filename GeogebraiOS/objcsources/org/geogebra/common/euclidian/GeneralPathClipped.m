...
- (void)addPointWithInt:(jint)pos
             ...
             withDouble:(jdouble)y {
  OrgGeogebraCommonKernelMyPoint *p = [new_OrgGeogebraCommonKernelMyPoint_initWithDouble_withDouble_withBoolean_(x, y, YES) autorelease];
...
- (void)transformWithOrgGeogebraCommonAwtGAffineTransform:(id<OrgGeogebraCommonAwtGAffineTransform>)af {
  ...
  for (jint i = 0; i < size; i++) {
    ...
    [((id<OrgGeogebraCommonAwtGAffineTransform>) nil_chk(af)) transformWithOrgGeogebraCommonAwtGPoint2D:p withOrgGeogebraCommonAwtGPoint2D:p];
  }
}
...
void OrgGeogebraCommonEuclidianGeneralPathClipped_initWithOrgGeogebraCommonEuclidianEuclidianViewInterfaceSlim_(OrgGeogebraCommonEuclidianGeneralPathClipped *self, id<OrgGeogebraCommonEuclidianEuclidianViewInterfaceSlim> view) {
  NSObject_init(self);
  OrgGeogebraCommonEuclidianGeneralPathClipped_set_view_(self, view);
  OrgGeogebraCommonEuclidianGeneralPathClipped_setAndConsume_pathPoints_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonEuclidianGeneralPathClipped_set_gp_(self, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newGeneralPath]);
  OrgGeogebraCommonEuclidianGeneralPathClipped_reset(self);
}
...
void OrgGeogebraCommonEuclidianGeneralPathClipped_reset(OrgGeogebraCommonEuclidianGeneralPathClipped *self) {
  ...
  OrgGeogebraCommonEuclidianGeneralPathClipped_set_bounds_(self, nil);
...
void OrgGeogebraCommonEuclidianGeneralPathClipped_addPointWithDouble_withDouble_withBoolean_(OrgGeogebraCommonEuclidianGeneralPathClipped *self, jdouble x, jdouble y, jboolean lineTo) {
  OrgGeogebraCommonKernelMyPoint *p = [new_OrgGeogebraCommonKernelMyPoint_initWithDouble_withDouble_withBoolean_(x, y, lineTo) autorelease];
  OrgGeogebraCommonEuclidianGeneralPathClipped_updateBoundsWithOrgGeogebraCommonKernelMyPoint_(self, p);
...
void OrgGeogebraCommonEuclidianGeneralPathClipped_updateBoundsWithOrgGeogebraCommonKernelMyPoint_(OrgGeogebraCommonEuclidianGeneralPathClipped *self, OrgGeogebraCommonKernelMyPoint *p) {
  if (self->bounds_ == nil) {
    OrgGeogebraCommonEuclidianGeneralPathClipped_set_bounds_(self, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newRectangle]);
