...
- (OrgGeogebraCommonEuclidianModesModeDelete *)getDeleteMode {
  if (deleteMode_ == nil && view_ != nil) {
    OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_deleteMode_(self, new_OrgGeogebraCommonEuclidianModesModeDelete_initWithOrgGeogebraCommonEuclidianEuclidianView_(view_));
  }
  return deleteMode_;
}
...
- (void)createCompanions {
  OrgGeogebraCommonEuclidianEuclidianController_set_companion_(self, [self newCompanion]);
}
...
- (OrgGeogebraCommonEuclidianEuclidianControllerCompanion *)newCompanion {
  return [new_OrgGeogebraCommonEuclidianEuclidianControllerCompanion_initWithOrgGeogebraCommonEuclidianEuclidianController_(self) autorelease];
}
...
- (void)updatePastePreviewPosition {
  if (translationVec_ == nil) {
    OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_translationVec_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(2));
  }
...
- (void)setPastePreviewSelected {
  if (pastePreviewSelected_ != nil) {
    ...
    OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_pastePreviewSelected_(self, new_JavaUtilArrayList_init());
  }
  OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_pastePreviewSelectedAndDependent_(self, new_JavaUtilArrayList_init());
  ...
  if ((pastePreviewSelected_ != nil) && ![pastePreviewSelected_ isEmpty]) {
    ...
    OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_persistentStickyPointList_(self, new_JavaUtilArrayList_init());
...
- (void)deletePastePreviewSelected {
  if (pastePreviewSelected_ != nil) {
    ...
    OrgGeogebraCommonEuclidianEuclidianController_set_pastePreviewSelected_(self, nil);
  }
  if (pastePreviewSelectedAndDependent_ != nil) {
    OrgGeogebraCommonEuclidianEuclidianController_set_pastePreviewSelectedAndDependent_(self, nil);
  }
}
...
- (IOSObjectArray *)getSelectedNumberValues {
  IOSObjectArray *ret = [IOSObjectArray arrayWithLength:[((JavaUtilArrayList *) nil_chk(selectedNumberValues_)) size] type:OrgGeogebraCommonKernelArithmeticNumberValue_class_()];
...
- (IOSObjectArray *)getSelectedSegments {
  IOSObjectArray *segments = [IOSObjectArray arrayWithLength:[((JavaUtilArrayList *) nil_chk(selectedSegments_)) size] type:OrgGeogebraCommonKernelGeosGeoSegment_class_()];
  OrgGeogebraCommonEuclidianEuclidianController_getSelectedSegmentsNDWithOrgGeogebraCommonKernelKernelNDGeoSegmentNDArray_(self, segments);
  return segments;
}
...
- (IOSObjectArray *)getSelectedVectors {
  IOSObjectArray *vectors = [IOSObjectArray arrayWithLength:[((JavaUtilArrayList *) nil_chk(selectedVectors_)) size] type:OrgGeogebraCommonKernelGeosGeoVector_class_()];
  OrgGeogebraCommonEuclidianEuclidianController_getSelectedVectorsNDWithOrgGeogebraCommonKernelKernelNDGeoVectorNDArray_(self, vectors);
  return vectors;
}
...
- (IOSObjectArray *)getSelectedCirclesND {
  IOSObjectArray *circles = [IOSObjectArray arrayWithLength:[((JavaUtilArrayList *) nil_chk(selectedConicsND_)) size] type:OrgGeogebraCommonKernelKernelNDGeoConicND_class_()];
  jint i = 0;
...
- (IOSObjectArray *)getSelectedDirections {
  IOSObjectArray *directions = [IOSObjectArray arrayWithLength:[((JavaUtilArrayList *) nil_chk(selectedDirections_)) size] type:OrgGeogebraCommonKernelKernelNDGeoDirectionND_class_()];
  jint i = 0;
...
- (id<OrgGeogebraCommonKernelKernelNDGeoPointND>)createNewPointWithNSString:(NSString *)label
  ...
  if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk([((id<OrgGeogebraCommonKernelRegion>) nil_chk(region)) toGeoElement])) isGeoElement3D]) {
    [self checkZoomingWithBoolean:forPreviewable];
    if (tmpCoordsL4_ == nil) {
      OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_tmpCoordsL4_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4));
    }
...
- (void)setKernelWithOrgGeogebraCommonKernelKernel:(OrgGeogebraCommonKernelKernel *)kernel {
  OrgGeogebraCommonEuclidianEuclidianController_set_kernel_(self, kernel);
}
...
- (IOSObjectArray *)intersectWithOrgGeogebraCommonEuclidianHits:(OrgGeogebraCommonEuclidianHits *)intersectHits {
  ...
  if (!selectionPreview_ && ([hits size] > (2 - OrgGeogebraCommonEuclidianEuclidianController_selGeos(self)))) {
    OrgGeogebraCommonEuclidianHits *goodHits = [new_OrgGeogebraCommonEuclidianHits_init() autorelease];
    [hits getHitsWithOrgGeogebraCommonKernelGeosTestEnum:OrgGeogebraCommonKernelGeosTestEnum_get_GEOLINEND() withOrgGeogebraCommonEuclidianHits:tempArrayList_];
    [goodHits addAllWithJavaUtilCollection:tempArrayList_];
    if ([goodHits size] < 2) {
      [hits getHitsWithOrgGeogebraCommonKernelGeosTestEnum:OrgGeogebraCommonKernelGeosTestEnum_get_GEOCONICND() withOrgGeogebraCommonEuclidianHits:tempArrayList_];
      [goodHits addAllWithJavaUtilCollection:tempArrayList_];
    }
    if ([goodHits size] < 2) {
      [hits getHitsWithOrgGeogebraCommonKernelGeosTestEnum:OrgGeogebraCommonKernelGeosTestEnum_get_GEOFUNCTION() withOrgGeogebraCommonEuclidianHits:tempArrayList_];
      [goodHits addAllWithJavaUtilCollection:tempArrayList_];
    }
    if ([goodHits size] < 2) {
      [hits getHitsWithOrgGeogebraCommonKernelGeosTestEnum:OrgGeogebraCommonKernelGeosTestEnum_get_GEOPOLYGON() withOrgGeogebraCommonEuclidianHits:tempArrayList_];
      [goodHits addAllWithJavaUtilCollection:tempArrayList_];
    }
    if ([goodHits size] < 2) {
      [hits getHitsWithOrgGeogebraCommonKernelGeosTestEnum:OrgGeogebraCommonKernelGeosTestEnum_get_GEOPOLYLINE() withOrgGeogebraCommonEuclidianHits:tempArrayList_];
      [goodHits addAllWithJavaUtilCollection:tempArrayList_];
    }
    hits = goodHits;
  }
  ...
  if (OrgGeogebraCommonEuclidianEuclidianController_selLines(self) >= 2) {
    ...
    if (!polynomials) {
      OrgGeogebraCommonKernelGeosGeoPoint *initPoint = [new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) getConstruction]) autorelease];
    ...
    IOSObjectArray *ret = [IOSObjectArray arrayWithObjects:(id[]){ nil } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    [self checkZooming];
    ret = [((OrgGeogebraCommonKernelAlgosAlgoDispatcher *) nil_chk([self getAlgoDispatcher])) IntersectLinePolyLineWithNSStringArray:[IOSObjectArray arrayWithObjects:(id[]){ nil } count:1 type:NSString_class_()] withOrgGeogebraCommonKernelGeosGeoLine:line withOrgGeogebraCommonKernelGeosGeoPolyLine:polyLine];
    return ret;
  }
    ...
    IOSObjectArray *ret = [IOSObjectArray arrayWithObjects:(id[]){ nil } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    [self checkZooming];
    ret = [((OrgGeogebraCommonKernelAlgosAlgoDispatcher *) nil_chk([self getAlgoDispatcher])) IntersectLineCurveWithNSStringArray:[IOSObjectArray arrayWithObjects:(id[]){ nil } count:1 type:NSString_class_()] withOrgGeogebraCommonKernelGeosGeoLine:line withOrgGeogebraCommonKernelGeosGeoCurveCartesian:curve];
    return ret;
  }
    ...
    IOSObjectArray *ret = [IOSObjectArray arrayWithObjects:(id[]){ nil } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    [self checkZooming];
    ret = [((OrgGeogebraCommonKernelAlgosAlgoDispatcher *) nil_chk([self getAlgoDispatcher])) IntersectLinePolygonWithNSStringArray:[IOSObjectArray arrayWithObjects:(id[]){ nil } count:1 type:NSString_class_()] withOrgGeogebraCommonKernelGeosGeoLine:line withOrgGeogebraCommonKernelGeosGeoPolygon:polygon];
    return ret;
  }
...
- (IOSObjectArray *)switchModeForThreePointsWithInt:(jint)threePointsMode {
  ...
  switch (threePointsMode) {
    ...
    [self checkZooming];
    IOSObjectArray_Set(ret, 0, [((OrgGeogebraCommonEuclidianEuclidianControllerCompanion *) nil_chk(companion_)) ellipseHyperbolaWithOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(nil_chk(points), 0) withOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(points, 1) withOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(points, 2) withInt:OrgGeogebraCommonKernelKernelNDGeoConicNDConstants_CONIC_ELLIPSE]);
    break;
    case OrgGeogebraCommonEuclidianEuclidianConstants_MODE_HYPERBOLA_THREE_POINTS:
    [self checkZooming];
    IOSObjectArray_Set(ret, 0, [((OrgGeogebraCommonEuclidianEuclidianControllerCompanion *) nil_chk(companion_)) ellipseHyperbolaWithOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(nil_chk(points), 0) withOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(points, 1) withOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(points, 2) withInt:OrgGeogebraCommonKernelKernelNDGeoConicNDConstants_CONIC_HYPERBOLA]);
    break;
    case OrgGeogebraCommonEuclidianEuclidianConstants_MODE_CIRCUMCIRCLE_ARC_THREE_POINTS:
    [self checkZooming];
    IOSObjectArray_Set(ret, 0, [((OrgGeogebraCommonEuclidianEuclidianControllerCompanion *) nil_chk(companion_)) circumcircleArcWithOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(nil_chk(points), 0) withOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(points, 1) withOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(points, 2)]);
    break;
    case OrgGeogebraCommonEuclidianEuclidianConstants_MODE_CIRCUMCIRCLE_SECTOR_THREE_POINTS:
    [self checkZooming];
    IOSObjectArray_Set(ret, 0, [((OrgGeogebraCommonEuclidianEuclidianControllerCompanion *) nil_chk(companion_)) circumcircleSectorWithOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(nil_chk(points), 0) withOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(points, 1) withOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(points, 2)]);
    break;
    case OrgGeogebraCommonEuclidianEuclidianConstants_MODE_CIRCLE_ARC_THREE_POINTS:
    [self checkZooming];
    IOSObjectArray_Set(ret, 0, [((OrgGeogebraCommonEuclidianEuclidianControllerCompanion *) nil_chk(companion_)) circleArcSectorWithOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(nil_chk(points), 0) withOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(points, 1) withOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(points, 2) withInt:OrgGeogebraCommonKernelKernelNDGeoConicNDConstants_CONIC_PART_ARC]);
    break;
    case OrgGeogebraCommonEuclidianEuclidianConstants_MODE_CIRCLE_SECTOR_THREE_POINTS:
    [self checkZooming];
    IOSObjectArray_Set(ret, 0, [((OrgGeogebraCommonEuclidianEuclidianControllerCompanion *) nil_chk(companion_)) circleArcSectorWithOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(nil_chk(points), 0) withOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(points, 1) withOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(points, 2) withInt:OrgGeogebraCommonKernelKernelNDGeoConicNDConstants_CONIC_PART_SECTOR]);
    break;
    default:
    return nil;
  }
...
- (OrgGeogebraCommonKernelMatrixCoords *)getMouseLocRW {
  if (mouseLocRW_ == nil) {
    OrgGeogebraCommonEuclidianEuclidianController_set_mouseLocRW_(self, OrgGeogebraCommonKernelMatrixCoords_createInhomCoorsInD3());
  }
  if (mouseLoc_ == nil) {
...
- (void)setMouseLocationWithBoolean:(jboolean)alt
                            withInt:(jint)x
                            withInt:(jint)y {
  OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_mouseLoc_(self, new_OrgGeogebraCommonAwtGPoint_initWithInt_withInt_(x, y));
...
- (OrgGeogebraCommonEuclidianTextDispatcher *)getTextDispatcher {
  if (textDispatcher_ == nil) {
    OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_textDispatcher_(self, new_OrgGeogebraCommonEuclidianTextDispatcher_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonEuclidianEuclidianView_(kernel_, view_));
  }
...
- (jboolean)createNewPointWithOrgGeogebraCommonEuclidianHits:(OrgGeogebraCommonEuclidianHits *)hits
  ...
  if (point != nil) {
    OrgGeogebraCommonEuclidianEuclidianController_set_pointCreated_(self, point);
...
- (void)macroProcessWithOrgGeogebraCommonUtilAsyncOperation:(OrgGeogebraCommonUtilAsyncOperation *)callback2 {
  if (OrgGeogebraCommonEuclidianEuclidianController_selGeos(self) == ((IOSObjectArray *) nil_chk(macroInput_))->size_) {
    [self checkZooming];
    [((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) useMacroWithNSStringArray:nil withOrgGeogebraCommonKernelMacro:macro__ withOrgGeogebraCommonKernelGeosGeoElementArray:OrgGeogebraCommonEuclidianEuclidianController_getSelectedGeos(self)];
  ...
  IOSObjectArray *ret = nil;
  {
    ...
    switch (mode_) {
      ...
      if (selectionPreview_) {
        ...
        IOSObjectArray *ret0 = [IOSObjectArray arrayWithObjects:(id[]){ nil } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
        IOSObjectArray_Set(ret0, 0, [((OrgGeogebraCommonEuclidianHits *) nil_chk(hits)) getFirstHitWithOrgGeogebraCommonKernelGeosTestEnum:OrgGeogebraCommonKernelGeosTestEnum_get_GEOPOINTND()]);
        ret = ret0;
      ...
      callback2 = [new_OrgGeogebraCommonEuclidianEuclidianController_$2_initWithOrgGeogebraCommonEuclidianEuclidianController_withOrgGeogebraCommonUtilAsyncOperation_(self, callback) autorelease];
      OrgGeogebraCommonEuclidianEuclidianController_macroWithOrgGeogebraCommonEuclidianHits_withOrgGeogebraCommonUtilAsyncOperation_(self, hits, callback2);
      return NO;
...
- (jboolean)processModeWithOrgGeogebraCommonEuclidianHits:(OrgGeogebraCommonEuclidianHits *)processHits
  ...
  OrgGeogebraCommonUtilAsyncOperation *callback = [new_OrgGeogebraCommonEuclidianEuclidianController_$3_initWithOrgGeogebraCommonEuclidianEuclidianController_withOrgGeogebraCommonEuclidianHits_(self, hits2) autorelease];
...
- (void)setMovedGeoPointWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  ...
  if ((algo != nil) && ([OrgGeogebraCommonKernelAlgosAlgoDynamicCoordinatesInterface_class_() isInstance:algo])) {
    OrgGeogebraCommonEuclidianEuclidianController_set_movedGeoPoint_(self, [((id<OrgGeogebraCommonKernelAlgosAlgoDynamicCoordinatesInterface>) check_protocol_cast(algo, @protocol(OrgGeogebraCommonKernelAlgosAlgoDynamicCoordinatesInterface))) getParentPoint]);
  }
...
- (OrgGeogebraCommonEuclidianHits *)addPointCreatedForMouseReleasedWithOrgGeogebraCommonEuclidianHits:(OrgGeogebraCommonEuclidianHits *)releasedHits {
  ...
  if ([((OrgGeogebraCommonEuclidianHits *) nil_chk(hits)) isEmpty]) {
    hits = [new_OrgGeogebraCommonEuclidianHits_init() autorelease];
...
- (void)wrapMouseExitedWithOrgGeogebraCommonEuclidianEventAbstractEvent:(OrgGeogebraCommonEuclidianEventAbstractEvent *)event {
  ...
  OrgGeogebraCommonEuclidianEuclidianController_set_mouseLoc_(self, nil);
  [((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) notifyRepaint];
  [self stopCollectingMinorRepaints];
  [view_ mouseExited];
}
...
- (void)resetMovedGeoPoint {
  OrgGeogebraCommonEuclidianEuclidianController_set_movedGeoPoint_(self, nil);
}
...
- (void)handleMovedElementWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo
  ...
  OrgGeogebraCommonEuclidianEuclidianController_set_movedGeoElement_(self, geo);
  moveMode__ = OrgGeogebraCommonEuclidianEuclidianController_MOVE_NONE;
...
- (jboolean)handleMovedElementDependentWithChangeableCoordParentNumbers {
  if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(movedGeoElement_)) hasChangeableCoordParentNumbers]) {
    ...
    OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_translateableGeos_(self, new_JavaUtilArrayList_init());
...
- (void)handleMovedElementDependent {
    ...
    if ([[movedGeoElement_ getParentAlgorithm] isKindOfClass:[OrgGeogebraCommonKernelAlgosAlgoVector class]]) {
      ...
      if ([((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(start)) isIndependent] && ![((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(end)) isIndependent]) {
        ...
        *IOSDoubleArray_GetRef(transformCoordsOffset_, 1) = yRW_ - [coords getY];
        ...
        OrgGeogebraCommonEuclidianEuclidianController_set_movedGeoPoint_(self, start);
        return;
      }
    }
    else {
  ...
  if (vec != nil) {
    if ([[vec getParentAlgorithm] isKindOfClass:[OrgGeogebraCommonKernelAlgosAlgoVectorPoint class]]) {
      ...
      *IOSDoubleArray_GetRef(transformCoordsOffset_, 1) = yRW_ - vec->y_;
      OrgGeogebraCommonEuclidianEuclidianController_set_movedGeoPoint_(self, [((OrgGeogebraCommonKernelAlgosAlgoVectorPoint *) nil_chk(algo)) getP]);
      return;
    }
    if (sameVector && (([vec getLabelSimple] == nil) || [vec isIndependent])) {
      *IOSDoubleArray_GetRef(nil_chk(transformCoordsOffset_), 0) = xRW_ - vec->x_;
      *IOSDoubleArray_GetRef(transformCoordsOffset_, 1) = yRW_ - vec->y_;
      OrgGeogebraCommonEuclidianEuclidianController_set_movedGeoVector_(self, vec);
  ...
  if (![self handleMovedElementDependentWithChangeableCoordParentNumbers] && [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(movedGeoElement_)) hasMoveableInputPointsWithOrgGeogebraCommonEuclidianEuclidianViewInterfaceSlim:view_]) {
    if ([movedGeoElement_ isGeoLine] || [movedGeoElement_ isGeoPolygon] || ([movedGeoElement_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoPolyLine class]]) || [movedGeoElement_ isGeoConic] || [movedGeoElement_ isGeoImage] || [movedGeoElement_ isGeoList] || [movedGeoElement_ isGeoVector]) {
      if (translateableGeos_ == nil) OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_translateableGeos_(self, new_JavaUtilArrayList_init());
...
- (void)handleMovedElementFreeWithOrgGeogebraCommonEuclidianEventPointerEventTypeEnum:(OrgGeogebraCommonEuclidianEventPointerEventTypeEnum *)type {
  if (OrgGeogebraCommonEuclidianEuclidianController_handleMovedElementFreePoint(self)) {
    ...
    OrgGeogebraCommonEuclidianEuclidianController_set_movedGeoLine_(self, (id<OrgGeogebraCommonKernelKernelNDGeoLineND>) check_protocol_cast(movedGeoElement_, @protocol(OrgGeogebraCommonKernelKernelNDGeoLineND)));
    ...
    OrgGeogebraCommonEuclidianEuclidianController_set_movedGeoVector_(self, (id<OrgGeogebraCommonKernelKernelNDGeoVectorND>) check_protocol_cast(movedGeoElement_, @protocol(OrgGeogebraCommonKernelKernelNDGeoVectorND)));
    if ([movedGeoVector_ hasAbsoluteLocation]) {
      ...
      if ((2.0 * OrgGeogebraCommonUtilMyMath_lengthWithDouble_withDouble_(xRW_ - sx, yRW_ - sy)) < OrgGeogebraCommonUtilMyMath_lengthWithDouble_withDouble_([((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(vCoords)) getX], [vCoords getY])) {
        ...
        if (sP == nil) {
          sP = [new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) getConstruction]) autorelease];
    ...
    OrgGeogebraCommonEuclidianEuclidianController_set_movedGeoConic_(self, (OrgGeogebraCommonKernelGeosGeoConic *) check_class_cast(movedGeoElement_, [OrgGeogebraCommonKernelGeosGeoConic class]));
    ...
    [self setStartPointLocation];
    if (tempConic_ == nil) {
      OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_tempConic_(self, new_OrgGeogebraCommonKernelGeosGeoConic_initWithOrgGeogebraCommonKernelConstruction_([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) getConstruction]));
    }
    ...
    OrgGeogebraCommonEuclidianEuclidianController_set_movedGeoImplicitPoly_(self, (OrgGeogebraCommonKernelImplicitGeoImplicitPoly *) check_class_cast(movedGeoElement_, [OrgGeogebraCommonKernelImplicitGeoImplicitPoly class]));
    [((OrgGeogebraCommonEuclidianEuclidianView *) nil_chk(view_)) setShowMouseCoordsWithBoolean:NO];
    [view_ setDragCursor];
    [self setStartPointLocation];
    if (tempImplicitPoly_ == nil) {
      OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_tempImplicitPoly_(self, new_OrgGeogebraCommonKernelImplicitGeoImplicitPoly_initWithOrgGeogebraCommonKernelImplicitGeoImplicitPoly_(movedGeoImplicitPoly_));
    }
    else {
      [tempImplicitPoly_ setWithOrgGeogebraCommonKernelGeosGeoElement:movedGeoImplicitPoly_];
    }
    if (tempDependentPointX_ == nil) {
      OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_tempDependentPointX_(self, new_JavaUtilArrayList_init());
    }
    else {
      [tempDependentPointX_ clear];
    }
    if (tempDependentPointY_ == nil) {
      OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_tempDependentPointY_(self, new_JavaUtilArrayList_init());
    }
    else {
      [tempDependentPointY_ clear];
    }
    if (moveDependentPoints_ == nil) {
      OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_moveDependentPoints_(self, new_JavaUtilArrayList_init());
    }
    else {
  ...
  if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(movedGeoElement_)) isGeoFunction]) {
    if ([[movedGeoElement_ getParentAlgorithm] isKindOfClass:[OrgGeogebraCommonKernelAlgosAlgoFunctionFreehand class]]) {
      ...
      if (![((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(IOSObjectArray_Get(nil_chk([algo getInput]), 0))) isLabelSet] && [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(input)) getParentAlgorithm] == nil) {
        ...
        OrgGeogebraCommonEuclidianEuclidianController_set_movedGeoFunction_(self, (OrgGeogebraCommonKernelGeosGeoFunction *) check_class_cast(movedGeoElement_, [OrgGeogebraCommonKernelGeosGeoFunction class]));
      }
    }
    ...
    if (tempFunction_ == nil) {
      OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_tempFunction_(self, new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) getConstruction]));
    }
    ...
    OrgGeogebraCommonEuclidianEuclidianController_set_movedGeoNumeric_(self, (OrgGeogebraCommonKernelGeosGeoNumeric *) check_class_cast(movedGeoElement_, [OrgGeogebraCommonKernelGeosGeoNumeric class]));
    ...
    OrgGeogebraCommonEuclidianEuclidianController_set_movedGeoBoolean_(self, (OrgGeogebraCommonKernelGeosGeoBoolean *) check_class_cast(movedGeoElement_, [OrgGeogebraCommonKernelGeosGeoBoolean class]));
    ...
    *IOSDoubleArray_GetRef(transformCoordsOffset_, 1) = [view_ toRealWorldCoordYWithDouble:oldLoc_->y_ + 5] - yRW_;
    ...
    if ((![((OrgGeogebraCommonMainApp *) nil_chk(app_)) isApplet] || temporaryMode_) && (textFieldSelected || buttonSelected || (moveSelected && [app_ isRightClickEnabled]))) {
      OrgGeogebraCommonEuclidianEuclidianController_set_movedGeoButton_(self, (id<OrgGeogebraCommonKernelGeosFurniture>) check_protocol_cast(movedGeoElement_, @protocol(OrgGeogebraCommonKernelGeosFurniture)));
    ...
    OrgGeogebraCommonEuclidianEuclidianController_set_movedGeoImage_(self, (OrgGeogebraCommonKernelGeosGeoImage *) check_class_cast(movedGeoElement_, [OrgGeogebraCommonKernelGeosGeoImage class]));
    [((OrgGeogebraCommonEuclidianEuclidianView *) nil_chk(view_)) setShowMouseCoordsWithBoolean:NO];
    [view_ setDragCursor];
    if ([movedGeoImage_ isAbsoluteScreenLocActive]) {
      ...
      *IOSDoubleArray_GetRef(transformCoordsOffset_, 1) = [view_ toRealWorldCoordYWithDouble:oldLoc_->y_] - yRW_;
      ...
      [self setStartPointLocation];
      OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_oldImage_(self, new_OrgGeogebraCommonKernelGeosGeoImage_initWithOrgGeogebraCommonKernelGeosGeoImage_(movedGeoImage_));
...
- (void)wrapMouseDraggedWithOrgGeogebraCommonEuclidianEventAbstractEvent:(OrgGeogebraCommonEuclidianEventAbstractEvent *)event
  ...
  OrgGeogebraCommonEuclidianEuclidianController_set_lastMouseLoc_(self, mouseLoc_);
  [self setMouseLocationWithOrgGeogebraCommonEuclidianEventAbstractEvent:event];
  [self transformCoords];
...
- (void)handleMousePressedForRotateModeWithOrgGeogebraCommonEuclidianEventPointerEventTypeEnum:(OrgGeogebraCommonEuclidianEventPointerEventTypeEnum *)type {
  ...
  if (rotationCenter_ == nil) {
    ...
    if (![hits isEmpty] && [hits containsWithId:rotationCenter_]) {
      ...
      OrgGeogebraCommonEuclidianEuclidianController_set_rotationCenter_(self, nil);
      moveMode__ = OrgGeogebraCommonEuclidianEuclidianController_MOVE_NONE;
      return;
    }
    ...
    OrgGeogebraCommonEuclidianEuclidianController_set_rotGeoElement_(self, geo);
    if (geo != nil) {
...
- (void)wrapMousePressedWithOrgGeogebraCommonEuclidianEventAbstractEvent:(OrgGeogebraCommonEuclidianEventAbstractEvent *)event {
  ...
  OrgGeogebraCommonEuclidianEuclidianController_set_pressedButton_(self, [((OrgGeogebraCommonEuclidianEuclidianView *) nil_chk(view_)) getHitButtonWithOrgGeogebraCommonAwtGPoint:mouseLoc_ withOrgGeogebraCommonEuclidianEventPointerEventTypeEnum:[event getType]]);
  if (pressedButton_ != nil) {
...
- (void)processSelectionRectangleWithBoolean:(jboolean)alt
  ...
  switch (mode_) {
    ...
    if ((hits != nil) && ([hits size] > 0) && alt && [app_ isUsingFullGui] && [app_ getGuiManager] != nil && [app_ showAlgebraInput]) {
      ...
      for (jint i = 0; i < [hits size]; i++) {
        [sb appendWithNSString:[((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk([hits getWithInt:i])) getLabelWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]];
        if (i < ([hits size] - 1)) {
          [sb appendWithNSString:@", "];
        }
      }
...
- (void)wrapMouseReleasedWithOrgGeogebraCommonEuclidianEventAbstractEvent:(OrgGeogebraCommonEuclidianEventAbstractEvent *)event {
  ...
  OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_lastMouseUpLoc_(self, new_OrgGeogebraCommonAwtGPoint_initWithInt_withInt_(x, y));
  ...
  if (pressedButton_ != nil) {
    ...
    OrgGeogebraCommonEuclidianEuclidianController_set_pressedButton_(self, nil);
  }
  ...
  *IOSDoubleArray_GetRef(transformCoordsOffset_, 1) = 0;
  ...
  if (draggingOccured_) {
    ...
    OrgGeogebraCommonEuclidianEuclidianController_set_movedGeoElement_(self, nil);
    OrgGeogebraCommonEuclidianEuclidianController_set_rotGeoElement_(self, nil);
    if (!temporaryMode_) {
  ...
  if (temporaryMode_) {
    ...
    OrgGeogebraCommonUtilAsyncOperation *callback = [new_OrgGeogebraCommonEuclidianEuclidianController_$5_initWithOrgGeogebraCommonEuclidianEuclidianController_withOrgGeogebraCommonEuclidianHits_withOrgGeogebraCommonEuclidianEventAbstractEvent_(self, hits2, event) autorelease];
...
- (void)setLineEndPointWithOrgGeogebraCommonAwtGPoint2D:(OrgGeogebraCommonAwtGPoint2D *)p {
  if (p == nil) OrgGeogebraCommonEuclidianEuclidianController_set_lineEndPoint_(self, nil);
  else OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_lineEndPoint_(self, new_OrgGeogebraCommonAwtGPoint2D_Double_initWithDouble_withDouble_([p getX], [p getY]));
...
- (void)setLineEndPointWithOrgGeogebraCommonAwtGPoint2D_Double:(OrgGeogebraCommonAwtGPoint2D_Double *)point {
  OrgGeogebraCommonEuclidianEuclidianController_set_lineEndPoint_(self, point);
  useLineEndPoint_ = YES;
}
...
- (id<OrgGeogebraCommonEuclidianPreviewable>)switchPreviewableForInitNewModeWithInt:(jint)mode1 {
  id<OrgGeogebraCommonEuclidianPreviewable> previewDrawable = nil;
  {
    ...
    switch (mode1) {
      ...
      break;
      case OrgGeogebraCommonEuclidianEuclidianConstants_MODE_COMPASSES:
      previewDrawable = [new_OrgGeogebraCommonEuclidianDrawDrawConic_initWithOrgGeogebraCommonEuclidianEuclidianView_withInt_withJavaUtilArrayList_withJavaUtilArrayList_withJavaUtilArrayList_(view_, mode1, selectedPoints_, selectedSegments_, selectedConicsND_) autorelease];
      break;
      case OrgGeogebraCommonEuclidianEuclidianConstants_MODE_SEMICIRCLE:
      case OrgGeogebraCommonEuclidianEuclidianConstants_MODE_CIRCLE_ARC_THREE_POINTS:
      case OrgGeogebraCommonEuclidianEuclidianConstants_MODE_CIRCUMCIRCLE_ARC_THREE_POINTS:
      case OrgGeogebraCommonEuclidianEuclidianConstants_MODE_CIRCLE_SECTOR_THREE_POINTS:
      case OrgGeogebraCommonEuclidianEuclidianConstants_MODE_CIRCUMCIRCLE_SECTOR_THREE_POINTS:
      previewDrawable = [new_OrgGeogebraCommonEuclidianDrawDrawConicPart_initWithOrgGeogebraCommonEuclidianEuclidianView_withInt_withJavaUtilArrayList_(view_, mode1, selectedPoints_) autorelease];
      break;
      case OrgGeogebraCommonEuclidianEuclidianConstants_MODE_TRANSLATE_BY_VECTOR:
      useLineEndPoint_ = NO;
      previewDrawable = [((OrgGeogebraCommonEuclidianEuclidianView *) nil_chk(view_)) createPreviewVectorWithJavaUtilArrayList:selectedPoints_];
      ...
      if (mode1 >= OrgGeogebraCommonEuclidianEuclidianConstants_MACRO_MODE_ID_OFFSET) {
        ...
        OrgGeogebraCommonEuclidianEuclidianController_set_macro__(self, [((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) getMacroWithInt:macroID]);
        OrgGeogebraCommonEuclidianEuclidianController_set_macroInput_(self, [((OrgGeogebraCommonKernelMacro *) nil_chk(macro__)) getInputTypes]);
...
- (void)setDefaultEventTypeWithOrgGeogebraCommonEuclidianEventPointerEventTypeEnum:(OrgGeogebraCommonEuclidianEventPointerEventTypeEnum *)pointerEventType {
  OrgGeogebraCommonEuclidianEuclidianController_set_defaultEventType_(self, pointerEventType);
}
...
void OrgGeogebraCommonEuclidianEuclidianController_initWithOrgGeogebraCommonMainApp_(OrgGeogebraCommonEuclidianEuclidianController *self, OrgGeogebraCommonMainApp *app) {
  ...
  OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_tempArrayList_(self, new_OrgGeogebraCommonEuclidianHits_init());
  OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_tempArrayList2_(self, new_OrgGeogebraCommonEuclidianHits_init());
  OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_tempArrayList3_(self, new_OrgGeogebraCommonEuclidianHits_init());
  OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_selectedPoints_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_selectedNumbers_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_selectedNumberValues_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_selectedLines_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_selectedDirections_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_selectedSegments_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_selectedRegions_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_selectedPaths_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_selectedConicsND_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_selectedImplicitpoly_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_selectedFunctions_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_selectedCurves_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_selectedVectors_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_selectedPolygons_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_selectedPolyLines_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_selectedGeos_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_selectedLists_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_highlightedGeos_(self, new_OrgGeogebraCommonEuclidianHits_init());
  OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_justCreatedGeos_(self, new_JavaUtilArrayList_init());
  ...
  OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_transformCoordsOffset_(self, [IOSDoubleArray newArrayWithLength:2]);
  self->allowSelectionRectangleForTranslateByVector_ = YES;
  OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_persistentStickyPointList_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_oldLoc_(self, new_OrgGeogebraCommonAwtGPoint_init());
  OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_startPoint_(self, new_OrgGeogebraCommonAwtGPoint2D_Double_init());
  OrgGeogebraCommonEuclidianEuclidianController_set_lineEndPoint_(self, nil);
  OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_selectionStartPoint_(self, new_OrgGeogebraCommonAwtGPoint_init());
  self->mouseIsOverLabel__ = NO;
  self->collectingRepaints_ = 0;
  self->collectedRepaints_ = NO;
  self->animationButtonPressed_ = NO;
  OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_handleAddSelectedArrayList_(self, new_OrgGeogebraCommonEuclidianHits_init());
  ...
  OrgGeogebraCommonEuclidianEuclidianController_set_defaultEventType_(self, OrgGeogebraCommonEuclidianEventPointerEventTypeEnum_get_MOUSE());
  self->needsAttach_ = NO;
  OrgGeogebraCommonEuclidianEuclidianController_set_app_(self, app);
  OrgGeogebraCommonEuclidianEuclidianController_set_selection_(self, [((OrgGeogebraCommonMainApp *) nil_chk(app)) getSelectionManager]);
  OrgGeogebraCommonEuclidianEuclidianController_set_l10n_(self, [app getLocalization]);
...
IOSObjectArray *OrgGeogebraCommonEuclidianEuclidianController_getSelectedGeos(OrgGeogebraCommonEuclidianEuclidianController *self) {
  IOSObjectArray *ret = [IOSObjectArray arrayWithLength:[((JavaUtilArrayList *) nil_chk(self->selectedGeos_)) size] type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
  jint i = 0;
...
IOSObjectArray *OrgGeogebraCommonEuclidianEuclidianController_getSelectedPointsND(OrgGeogebraCommonEuclidianEuclidianController *self) {
  IOSObjectArray *ret = [IOSObjectArray arrayWithLength:[((JavaUtilArrayList *) nil_chk(self->selectedPoints_)) size] type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()];
...
IOSObjectArray *OrgGeogebraCommonEuclidianEuclidianController_getSelectedPoints(OrgGeogebraCommonEuclidianEuclidianController *self) {
  IOSObjectArray *ret = [IOSObjectArray arrayWithLength:[((JavaUtilArrayList *) nil_chk(self->selectedPoints_)) size] type:OrgGeogebraCommonKernelGeosGeoPoint_class_()];
  OrgGeogebraCommonEuclidianEuclidianController_getSelectedPointsNDWithOrgGeogebraCommonKernelKernelNDGeoPointNDArray_(self, ret);
  return ret;
}
...
IOSObjectArray *OrgGeogebraCommonEuclidianEuclidianController_getSelectedNumbers(OrgGeogebraCommonEuclidianEuclidianController *self) {
  IOSObjectArray *ret = [IOSObjectArray arrayWithLength:[((JavaUtilArrayList *) nil_chk(self->selectedNumbers_)) size] type:OrgGeogebraCommonKernelGeosGeoNumeric_class_()];
...
IOSObjectArray *OrgGeogebraCommonEuclidianEuclidianController_getSelectedLists(OrgGeogebraCommonEuclidianEuclidianController *self) {
  IOSObjectArray *ret = [IOSObjectArray arrayWithLength:[((JavaUtilArrayList *) nil_chk(self->selectedLists_)) size] type:OrgGeogebraCommonKernelGeosGeoList_class_()];
...
IOSObjectArray *OrgGeogebraCommonEuclidianEuclidianController_getSelectedPolygons(OrgGeogebraCommonEuclidianEuclidianController *self) {
  IOSObjectArray *ret = [IOSObjectArray arrayWithLength:[((JavaUtilArrayList *) nil_chk(self->selectedPolygons_)) size] type:OrgGeogebraCommonKernelGeosGeoPolygon_class_()];
...
IOSObjectArray *OrgGeogebraCommonEuclidianEuclidianController_getSelectedPolyLines(OrgGeogebraCommonEuclidianEuclidianController *self) {
  IOSObjectArray *ret = [IOSObjectArray arrayWithLength:[((JavaUtilArrayList *) nil_chk(self->selectedPolyLines_)) size] type:OrgGeogebraCommonKernelGeosGeoPolyLine_class_()];
...
IOSObjectArray *OrgGeogebraCommonEuclidianEuclidianController_getSelectedLinesND(OrgGeogebraCommonEuclidianEuclidianController *self) {
  IOSObjectArray *lines = [IOSObjectArray arrayWithLength:[((JavaUtilArrayList *) nil_chk(self->selectedLines_)) size] type:OrgGeogebraCommonKernelKernelNDGeoLineND_class_()];
  OrgGeogebraCommonEuclidianEuclidianController_getSelectedLinesNDWithOrgGeogebraCommonKernelKernelNDGeoLineNDArray_(self, lines);
  return lines;
}
...
IOSObjectArray *OrgGeogebraCommonEuclidianEuclidianController_getSelectedLines(OrgGeogebraCommonEuclidianEuclidianController *self) {
  IOSObjectArray *lines = [IOSObjectArray arrayWithLength:[((JavaUtilArrayList *) nil_chk(self->selectedLines_)) size] type:OrgGeogebraCommonKernelGeosGeoLine_class_()];
  OrgGeogebraCommonEuclidianEuclidianController_getSelectedLinesNDWithOrgGeogebraCommonKernelKernelNDGeoLineNDArray_(self, lines);
  return lines;
}
...
IOSObjectArray *OrgGeogebraCommonEuclidianEuclidianController_getSelectedSegmentsND(OrgGeogebraCommonEuclidianEuclidianController *self) {
  IOSObjectArray *segments = [IOSObjectArray arrayWithLength:[((JavaUtilArrayList *) nil_chk(self->selectedSegments_)) size] type:OrgGeogebraCommonKernelKernelNDGeoSegmentND_class_()];
  OrgGeogebraCommonEuclidianEuclidianController_getSelectedSegmentsNDWithOrgGeogebraCommonKernelKernelNDGeoSegmentNDArray_(self, segments);
  return segments;
}
...
IOSObjectArray *OrgGeogebraCommonEuclidianEuclidianController_getSelectedVectorsND(OrgGeogebraCommonEuclidianEuclidianController *self) {
  IOSObjectArray *vectors = [IOSObjectArray arrayWithLength:[((JavaUtilArrayList *) nil_chk(self->selectedVectors_)) size] type:OrgGeogebraCommonKernelKernelNDGeoVectorND_class_()];
  OrgGeogebraCommonEuclidianEuclidianController_getSelectedVectorsNDWithOrgGeogebraCommonKernelKernelNDGeoVectorNDArray_(self, vectors);
  return vectors;
}
...
IOSObjectArray *OrgGeogebraCommonEuclidianEuclidianController_getSelectedConics(OrgGeogebraCommonEuclidianEuclidianController *self) {
  IOSObjectArray *conics = [IOSObjectArray arrayWithLength:[((JavaUtilArrayList *) nil_chk(self->selectedConicsND_)) size] type:OrgGeogebraCommonKernelGeosGeoConic_class_()];
  jint i = 0;
  id<JavaUtilIterator> it = [self->selectedConicsND_ iterator];
  while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
    IOSObjectArray_Set(conics, i, (OrgGeogebraCommonKernelGeosGeoConic *) check_class_cast([it next], [OrgGeogebraCommonKernelGeosGeoConic class]));
    i++;
  }
...
IOSObjectArray *OrgGeogebraCommonEuclidianEuclidianController_getSelectedCircles(OrgGeogebraCommonEuclidianEuclidianController *self) {
  IOSObjectArray *circles = [IOSObjectArray arrayWithLength:[((JavaUtilArrayList *) nil_chk(self->selectedConicsND_)) size] type:OrgGeogebraCommonKernelGeosGeoConic_class_()];
  jint i = 0;
  id<JavaUtilIterator> it = [self->selectedConicsND_ iterator];
  while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
    OrgGeogebraCommonKernelKernelNDGeoConicND *c = [it next];
    if ([((OrgGeogebraCommonKernelKernelNDGeoConicND *) nil_chk(c)) isCircle]) {
      IOSObjectArray_Set(circles, i, (OrgGeogebraCommonKernelGeosGeoConic *) check_class_cast(c, [OrgGeogebraCommonKernelGeosGeoConic class]));
      i++;
    }
  }
  OrgGeogebraCommonEuclidianEuclidianController_clearSelectionWithJavaUtilArrayList_(self, self->selectedConicsND_);
...
IOSObjectArray *OrgGeogebraCommonEuclidianEuclidianController_getSelectedConicsND(OrgGeogebraCommonEuclidianEuclidianController *self) {
  IOSObjectArray *conics = [IOSObjectArray arrayWithLength:[((JavaUtilArrayList *) nil_chk(self->selectedConicsND_)) size] type:OrgGeogebraCommonKernelKernelNDGeoConicND_class_()];
  jint i = 0;
  id<JavaUtilIterator> it = [self->selectedConicsND_ iterator];
  while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
...
IOSObjectArray *OrgGeogebraCommonEuclidianEuclidianController_getSelectedRegions(OrgGeogebraCommonEuclidianEuclidianController *self) {
  IOSObjectArray *regions = [IOSObjectArray arrayWithLength:[((JavaUtilArrayList *) nil_chk(self->selectedRegions_)) size] type:OrgGeogebraCommonKernelRegion_class_()];
  jint i = 0;
...
IOSObjectArray *OrgGeogebraCommonEuclidianEuclidianController_getSelectedPaths(OrgGeogebraCommonEuclidianEuclidianController *self) {
  IOSObjectArray *paths = [IOSObjectArray arrayWithLength:[((JavaUtilArrayList *) nil_chk(self->selectedPaths_)) size] type:OrgGeogebraCommonKernelPath_class_()];
  jint i = 0;
...
IOSObjectArray *OrgGeogebraCommonEuclidianEuclidianController_getSelectedImplicitpoly(OrgGeogebraCommonEuclidianEuclidianController *self) {
  IOSObjectArray *implicitPoly = [IOSObjectArray arrayWithLength:[((JavaUtilArrayList *) nil_chk(self->selectedImplicitpoly_)) size] type:OrgGeogebraCommonKernelImplicitGeoImplicitPoly_class_()];
  jint i = 0;
...
IOSObjectArray *OrgGeogebraCommonEuclidianEuclidianController_getSelectedFunctions(OrgGeogebraCommonEuclidianEuclidianController *self) {
  IOSObjectArray *functions = [IOSObjectArray arrayWithLength:[((JavaUtilArrayList *) nil_chk(self->selectedFunctions_)) size] type:OrgGeogebraCommonKernelGeosGeoFunction_class_()];
  jint i = 0;
...
IOSObjectArray *OrgGeogebraCommonEuclidianEuclidianController_getSelectedCurves(OrgGeogebraCommonEuclidianEuclidianController *self) {
  IOSObjectArray *curves = [IOSObjectArray arrayWithLength:[((JavaUtilArrayList *) nil_chk(self->selectedCurves_)) size] type:OrgGeogebraCommonKernelGeosGeoCurveCartesian_class_()];
  jint i = 0;
...
IOSObjectArray *OrgGeogebraCommonEuclidianEuclidianController_vectorWithOrgGeogebraCommonEuclidianHits_(OrgGeogebraCommonEuclidianEuclidianController *self, OrgGeogebraCommonEuclidianHits *hits) {
  ...
  if (OrgGeogebraCommonEuclidianEuclidianController_selPoints(self) == 2) {
    IOSObjectArray *points = OrgGeogebraCommonEuclidianEuclidianController_getSelectedPointsND(self);
    return [IOSObjectArray arrayWithObjects:(id[]){ [self vectorWithOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(nil_chk(points), 0) withOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(points, 1)] } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
  }
  return nil;
}
  ...
  if (self->polygonMode_ == OrgGeogebraCommonEuclidianEuclidianController_POLYGON_VECTOR) {
    ...
    if (OrgGeogebraCommonEuclidianEuclidianController_selPolygons(self) == 1) {
      ...
      for (jint i = 0; i < points->size_; i++) {
        IOSObjectArray_Set(pointsCopy, i, [((OrgGeogebraCommonKernelGeosGeoPoint *) nil_chk(IOSObjectArray_Get(points, i))) copy__]);
...
IOSObjectArray *OrgGeogebraCommonEuclidianEuclidianController_parabolaWithOrgGeogebraCommonEuclidianHits_(OrgGeogebraCommonEuclidianEuclidianController *self, OrgGeogebraCommonEuclidianHits *hits) {
  ...
  if (OrgGeogebraCommonEuclidianEuclidianController_selPoints(self) == 1) {
    if (OrgGeogebraCommonEuclidianEuclidianController_selLines(self) == 1) {
      ...
      IOSObjectArray *ret = [IOSObjectArray arrayWithObjects:(id[]){ nil } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
      [self checkZooming];
      IOSObjectArray_Set(ret, 0, [((OrgGeogebraCommonEuclidianEuclidianControllerCompanion *) nil_chk(self->companion_)) parabolaWithOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(nil_chk(points), 0) withOrgGeogebraCommonKernelKernelNDGeoLineND:IOSObjectArray_Get(nil_chk(lines), 0)]);
      return ret;
    }
  }
  return nil;
...
IOSObjectArray *OrgGeogebraCommonEuclidianEuclidianController_midpointWithOrgGeogebraCommonEuclidianHits_(OrgGeogebraCommonEuclidianEuclidianController *self, OrgGeogebraCommonEuclidianHits *hits) {
  ...
  if (OrgGeogebraCommonEuclidianEuclidianController_selPoints(self) == 2) {
    IOSObjectArray *points = OrgGeogebraCommonEuclidianEuclidianController_getSelectedPointsND(self);
    [self checkZooming];
    IOSObjectArray_Set(ret, 0, [((OrgGeogebraCommonEuclidianEuclidianControllerCompanion *) nil_chk(self->companion_)) midpointWithOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(nil_chk(points), 0) withOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(points, 1)]);
    ...
    [self checkZooming];
    IOSObjectArray_Set(ret, 0, [((OrgGeogebraCommonEuclidianEuclidianControllerCompanion *) nil_chk(self->companion_)) midpointWithOrgGeogebraCommonKernelKernelNDGeoSegmentND:IOSObjectArray_Get(nil_chk(segments), 0)]);
    return ret;
  }
  else if (OrgGeogebraCommonEuclidianEuclidianController_selConics(self) == 1) {
    IOSObjectArray *conics = OrgGeogebraCommonEuclidianEuclidianController_getSelectedConicsND(self);
    [self checkZooming];
    IOSObjectArray_Set(ret, 0, [((OrgGeogebraCommonEuclidianEuclidianControllerCompanion *) nil_chk(self->companion_)) midpointWithOrgGeogebraCommonKernelKernelNDGeoConicND:IOSObjectArray_Get(nil_chk(conics), 0)]);
    return ret;
  }
  return nil;
}
...
IOSObjectArray *OrgGeogebraCommonEuclidianEuclidianController_lineBisectorWithOrgGeogebraCommonEuclidianHits_(OrgGeogebraCommonEuclidianEuclidianController *self, OrgGeogebraCommonEuclidianHits *hits) {
  ...
  if (OrgGeogebraCommonEuclidianEuclidianController_selPoints(self) == 2) {
    IOSObjectArray *points = OrgGeogebraCommonEuclidianEuclidianController_getSelectedPointsND(self);
    [self checkZooming];
    [((OrgGeogebraCommonEuclidianEuclidianControllerCompanion *) nil_chk(self->companion_)) lineBisectorWithOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(nil_chk(points), 0) withOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(points, 1)];
    return ret;
  }
  else if (OrgGeogebraCommonEuclidianEuclidianController_selSegments(self) == 1) {
    IOSObjectArray *segments = OrgGeogebraCommonEuclidianEuclidianController_getSelectedSegmentsND(self);
    [self checkZooming];
    [((OrgGeogebraCommonEuclidianEuclidianControllerCompanion *) nil_chk(self->companion_)) lineBisectorWithOrgGeogebraCommonKernelKernelNDGeoSegmentND:IOSObjectArray_Get(nil_chk(segments), 0)];
    return ret;
  }
  return nil;
}
...
IOSObjectArray *OrgGeogebraCommonEuclidianEuclidianController_locusWithOrgGeogebraCommonEuclidianHits_(OrgGeogebraCommonEuclidianEuclidianController *self, OrgGeogebraCommonEuclidianHits *hits) {
  ...
  if (OrgGeogebraCommonEuclidianEuclidianController_selPoints(self) == 2) {
    ...
    IOSObjectArray *ret = [IOSObjectArray arrayWithObjects:(id[]){ locus } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    return ret;
  }
  return nil;
}
...
IOSObjectArray *OrgGeogebraCommonEuclidianEuclidianController_conic5WithOrgGeogebraCommonEuclidianHits_(OrgGeogebraCommonEuclidianEuclidianController *self, OrgGeogebraCommonEuclidianHits *hits) {
  ...
  if (OrgGeogebraCommonEuclidianEuclidianController_selPoints(self) == 5) {
    ...
    IOSObjectArray *ret = [IOSObjectArray arrayWithObjects:(id[]){ nil } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    [self checkZooming];
    IOSObjectArray_Set(ret, 0, [((OrgGeogebraCommonEuclidianEuclidianControllerCompanion *) nil_chk(self->companion_)) conic5WithOrgGeogebraCommonKernelKernelNDGeoPointNDArray:points]);
    return ret;
  }
  return nil;
}
...
IOSObjectArray *OrgGeogebraCommonEuclidianEuclidianController_tangentsWithOrgGeogebraCommonEuclidianHits_(OrgGeogebraCommonEuclidianEuclidianController *self, OrgGeogebraCommonEuclidianHits *hits) {
  ...
  if (OrgGeogebraCommonEuclidianEuclidianController_selConics(self) == 1) {
    ...
    if (OrgGeogebraCommonEuclidianEuclidianController_selPoints(self) == 1) {
      ...
      IOSObjectArray *ret = [IOSObjectArray arrayWithObjects:(id[]){ nil } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
      [self checkZooming];
      IOSObjectArray_Set(ret, 0, [((OrgGeogebraCommonKernelAlgosAlgoDispatcher *) nil_chk([self getAlgoDispatcher])) TangentWithNSString:nil withOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(nil_chk(points), 0) withOrgGeogebraCommonKernelGeosGeoFunction:IOSObjectArray_Get(nil_chk(functions), 0)]);
      return ret;
    }
  }
    ...
    if (OrgGeogebraCommonEuclidianEuclidianController_selPoints(self) == 1) {
      ...
      IOSObjectArray *ret = [IOSObjectArray arrayWithObjects:(id[]){ nil } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
      [self checkZooming];
      IOSObjectArray_Set(ret, 0, [((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) TangentWithNSString:nil withOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(nil_chk(points), 0) withOrgGeogebraCommonKernelGeosGeoCurveCartesian:IOSObjectArray_Get(nil_chk(curves), 0)]);
      return ret;
    }
  }
  else if (OrgGeogebraCommonEuclidianEuclidianController_selImplicitpoly(self) == 1) {
...
IOSObjectArray *OrgGeogebraCommonEuclidianEuclidianController_polarLineWithOrgGeogebraCommonEuclidianHits_(OrgGeogebraCommonEuclidianEuclidianController *self, OrgGeogebraCommonEuclidianHits *hits) {
  ...
  if (OrgGeogebraCommonEuclidianEuclidianController_selConics(self) == 1) {
    ...
    if (OrgGeogebraCommonEuclidianEuclidianController_selPoints(self) == 1) {
      ...
      IOSObjectArray *points = OrgGeogebraCommonEuclidianEuclidianController_getSelectedPointsND(self);
      [self checkZooming];
      IOSObjectArray_Set(ret, 0, [((OrgGeogebraCommonEuclidianEuclidianControllerCompanion *) nil_chk(self->companion_)) polarLineWithOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(nil_chk(points), 0) withOrgGeogebraCommonKernelKernelNDGeoConicND:IOSObjectArray_Get(nil_chk(conics), 0)]);
      return ret;
    }
    else if (OrgGeogebraCommonEuclidianEuclidianController_selLines(self) == 1) {
      IOSObjectArray *conics = OrgGeogebraCommonEuclidianEuclidianController_getSelectedConicsND(self);
      IOSObjectArray *lines = OrgGeogebraCommonEuclidianEuclidianController_getSelectedLinesND(self);
      [self checkZooming];
      IOSObjectArray_Set(ret, 0, [((OrgGeogebraCommonEuclidianEuclidianControllerCompanion *) nil_chk(self->companion_)) diameterLineWithOrgGeogebraCommonKernelKernelNDGeoLineND:IOSObjectArray_Get(nil_chk(lines), 0) withOrgGeogebraCommonKernelKernelNDGeoConicND:IOSObjectArray_Get(nil_chk(conics), 0)]);
      return ret;
    }
      ...
      [self checkZooming];
      IOSObjectArray_Set(ret, 0, [((OrgGeogebraCommonEuclidianEuclidianControllerCompanion *) nil_chk(self->companion_)) diameterLineWithOrgGeogebraCommonKernelKernelNDGeoVectorND:IOSObjectArray_Get(nil_chk(vecs), 0) withOrgGeogebraCommonKernelKernelNDGeoConicND:IOSObjectArray_Get(nil_chk(conics), 0)]);
      return ret;
    }
  }
  return nil;
...
jboolean OrgGeogebraCommonEuclidianEuclidianController_copyVisualStyleWithOrgGeogebraCommonEuclidianHits_(OrgGeogebraCommonEuclidianEuclidianController *self, OrgGeogebraCommonEuclidianHits *hits) {
  ...
  if ([((OrgGeogebraCommonMainApp *) nil_chk(self->app_)) getGeoForCopyStyle] == nil) {
    ...
    OrgGeogebraCommonEuclidianHits *oldhits = [new_OrgGeogebraCommonEuclidianHits_init() autorelease];
...
jboolean OrgGeogebraCommonEuclidianEuclidianController_textWithOrgGeogebraCommonEuclidianHits_(OrgGeogebraCommonEuclidianEuclidianController *self, OrgGeogebraCommonEuclidianHits *hits) {
  ...
  if ([((OrgGeogebraCommonEuclidianHits *) nil_chk(hits)) isEmpty]) {
    ...
    [self checkZooming];
    loc = [new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_([((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) getConstruction]) autorelease];
...
jboolean OrgGeogebraCommonEuclidianEuclidianController_attachDetachWithOrgGeogebraCommonEuclidianHits_(OrgGeogebraCommonEuclidianEuclidianController *self, OrgGeogebraCommonEuclidianHits *hits) {
  if (self->detachFrom_ != nil || self->needsAttach_) {
    ...
    if ([hits containsGeoPoint] && [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(((OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(self->movedGeoPoint_, [OrgGeogebraCommonKernelGeosGeoElement class])))) hasChildren]) {
      ...
      if (self->movedGeoPoint_ != nil && self->detachFrom_ != nil && ![hits containsWithId:self->detachFrom_]) {
        ...
        OrgGeogebraCommonEuclidianEuclidianController_set_movedGeoPoint_(self, (id<OrgGeogebraCommonKernelKernelNDGeoPointND>) check_protocol_cast([((OrgGeogebraCommonKernelConstruction *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) getConstruction])) geoTableVarLookupWithNSString:name], @protocol(OrgGeogebraCommonKernelKernelNDGeoPointND)));
      }
    ...
    self->needsAttach_ = NO;
    OrgGeogebraCommonEuclidianEuclidianController_set_detachFrom_(self, nil);
    if (OrgGeogebraCommonEuclidianEuclidianController_selGeos(self) > 0) {
      [self clearSelections];
    }
    return YES;
  ...
  if ([((JavaUtilArrayList *) nil_chk(self->selectedPoints_)) size] == 1) {
    ...
    if ([((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(p)) isPointOnPath] || [p isPointInRegion]) {
      OrgGeogebraCommonEuclidianEuclidianController_getSelectedPointsND(self);
      OrgGeogebraCommonEuclidianEuclidianController_getSelectedRegions(self);
      OrgGeogebraCommonEuclidianEuclidianController_getSelectedPaths(self);
      [self checkZooming];
...
IOSObjectArray *OrgGeogebraCommonEuclidianEuclidianController_fitLineWithOrgGeogebraCommonEuclidianHits_(OrgGeogebraCommonEuclidianEuclidianController *self, OrgGeogebraCommonEuclidianHits *hits) {
  ...
  if (OrgGeogebraCommonEuclidianEuclidianController_selLists(self) > 0) {
    ...
    if (list != nil) {
      IOSObjectArray_Set(ret, 0, OrgGeogebraCommonEuclidianEuclidianController_FitLineYWithNSString_withOrgGeogebraCommonKernelGeosGeoList_(self, nil, list));
      return ret;
    }
  }
  else {
...
OrgGeogebraCommonKernelGeosGeoLine *OrgGeogebraCommonEuclidianEuclidianController_FitLineYWithNSString_withOrgGeogebraCommonKernelGeosGeoList_(OrgGeogebraCommonEuclidianEuclidianController *self, NSString *label, OrgGeogebraCommonKernelGeosGeoList *list) {
  OrgGeogebraCommonKernelStatisticsAlgoFitLineY *algo = [new_OrgGeogebraCommonKernelStatisticsAlgoFitLineY_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoList_([((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) getConstruction], label, list) autorelease];
...
IOSObjectArray *OrgGeogebraCommonEuclidianEuclidianController_angleWithOrgGeogebraCommonEuclidianHits_(OrgGeogebraCommonEuclidianEuclidianController *self, OrgGeogebraCommonEuclidianHits *hits) {
  ...
  if (angle != nil) {
    IOSObjectArray *ret = [IOSObjectArray arrayWithObjects:(id[]){ angle } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    return ret;
  }
  else if (angles != nil) {
    return angles;
...
IOSObjectArray *OrgGeogebraCommonEuclidianEuclidianController_distanceWithOrgGeogebraCommonEuclidianHits_(OrgGeogebraCommonEuclidianEuclidianController *self, OrgGeogebraCommonEuclidianHits *hits) {
  ...
  if (OrgGeogebraCommonEuclidianEuclidianController_selPoints(self) == 2) {
    ...
    [self checkZooming];
    IOSObjectArray *ret = [IOSObjectArray arrayWithObjects:(id[]){ nil } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    IOSObjectArray_Set(ret, 0, [((OrgGeogebraCommonEuclidianTextDispatcher *) nil_chk([self getTextDispatcher])) createDistanceTextWithOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(nil_chk(points), 0) withOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(points, 1)]);
    return ret;
  }
    ...
    IOSObjectArray *lines = OrgGeogebraCommonEuclidianEuclidianController_getSelectedLinesND(self);
    IOSObjectArray *ret = [IOSObjectArray arrayWithObjects:(id[]){ nil } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    IOSObjectArray_Set(ret, 0, [((OrgGeogebraCommonEuclidianTextDispatcher *) nil_chk([self getTextDispatcher])) createDistanceTextWithOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(nil_chk(points), 0) withOrgGeogebraCommonKernelKernelNDGeoLineND:IOSObjectArray_Get(nil_chk(lines), 0)]);
    [self clearSelections];
    return ret;
  }
  else if (OrgGeogebraCommonEuclidianEuclidianController_selSegments(self) == 1) {
    ...
    IOSObjectArray *ret = [IOSObjectArray arrayWithObjects:(id[]){ seg } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    return ret;
  }
  else if (OrgGeogebraCommonEuclidianEuclidianController_selLines(self) == 2) {
    IOSObjectArray *lines = OrgGeogebraCommonEuclidianEuclidianController_getSelectedLinesND(self);
    IOSObjectArray *ret = [IOSObjectArray arrayWithObjects:(id[]){ nil } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    [self checkZooming];
    IOSObjectArray_Set(ret, 0, [((OrgGeogebraCommonKernelAlgosAlgoDispatcher *) nil_chk([self getAlgoDispatcher])) DistanceWithNSString:nil withOrgGeogebraCommonKernelKernelNDGeoLineND:IOSObjectArray_Get(nil_chk(lines), 0) withOrgGeogebraCommonKernelKernelNDGeoLineND:IOSObjectArray_Get(lines, 1)]);
    return ret;
  }
  else if (OrgGeogebraCommonEuclidianEuclidianController_selConics(self) == 1) {
    OrgGeogebraCommonKernelKernelNDGeoConicND *conic = IOSObjectArray_Get(nil_chk(OrgGeogebraCommonEuclidianEuclidianController_getSelectedConicsND(self)), 0);
...
IOSObjectArray *OrgGeogebraCommonEuclidianEuclidianController_compassesWithOrgGeogebraCommonEuclidianHits_(OrgGeogebraCommonEuclidianEuclidianController *self, OrgGeogebraCommonEuclidianHits *hits) {
  ...
  if (OrgGeogebraCommonEuclidianEuclidianController_selPoints(self) == 2) {
    IOSObjectArray *points = [IOSObjectArray arrayWithLength:2 type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()];
    ...
    if (centerPoint != nil) {
      ...
      IOSObjectArray *ret = [IOSObjectArray arrayWithObjects:(id[]){ circle } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
      [self clearSelections];
      return ret;
    }
  }
    ...
    if (centerPoint != nil) {
      ...
      IOSObjectArray *ret = [IOSObjectArray arrayWithObjects:(id[]){ circlel } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
      [self clearSelections];
      return ret;
    }
  }
...
OrgGeogebraCommonKernelKernelNDGeoConicND *OrgGeogebraCommonEuclidianEuclidianController_CircleWithOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoQuadricND_(OrgGeogebraCommonEuclidianEuclidianController *self, id<OrgGeogebraCommonKernelKernelNDGeoPointND> A, OrgGeogebraCommonKernelKernelNDGeoQuadricND *c) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoRadius *radius = [new_OrgGeogebraCommonKernelAlgosAlgoRadius_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoQuadricND_(cons, c) autorelease];
...
IOSObjectArray *OrgGeogebraCommonEuclidianEuclidianController_vectorFromPointWithOrgGeogebraCommonEuclidianHits_(OrgGeogebraCommonEuclidianEuclidianController *self, OrgGeogebraCommonEuclidianHits *hits) {
  ...
  if ((OrgGeogebraCommonEuclidianEuclidianController_selPoints(self) == 1) && (OrgGeogebraCommonEuclidianEuclidianController_selVectors(self) == 1)) {
    ...
    [self checkZooming];
    IOSObjectArray *ret = [IOSObjectArray arrayWithObjects:(id[]){ nil } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    IOSObjectArray_Set(ret, 0, [((OrgGeogebraCommonEuclidianEuclidianControllerCompanion *) nil_chk(self->companion_)) vectorPointWithOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(nil_chk(points), 0) withOrgGeogebraCommonKernelKernelNDGeoVectorND:IOSObjectArray_Get(nil_chk(vecs), 0)]);
    return ret;
  }
  return nil;
}
...
void OrgGeogebraCommonEuclidianEuclidianController_macroWithOrgGeogebraCommonEuclidianHits_withOrgGeogebraCommonUtilAsyncOperation_(OrgGeogebraCommonEuclidianEuclidianController *self, OrgGeogebraCommonEuclidianHits *hits, OrgGeogebraCommonUtilAsyncOperation *callback2) {
  ...
  if (objectFound || [((OrgGeogebraCommonKernelGeosTestEnum *) nil_chk(IOSObjectArray_Get(self->macroInput_, self->index_))) isEqual:OrgGeogebraCommonKernelGeosTestEnum_get_GEONUMERIC()] || [((OrgGeogebraCommonKernelGeosTestEnum *) nil_chk(IOSObjectArray_Get(self->macroInput_, self->index_))) isEqual:OrgGeogebraCommonKernelGeosTestEnum_get_GEOANGLE()]) {
    ...
    OrgGeogebraCommonUtilAsyncOperation *callback3 = [new_OrgGeogebraCommonEuclidianEuclidianController_$1_initWithOrgGeogebraCommonEuclidianEuclidianController_withOrgGeogebraCommonUtilAsyncOperation_(self, callback2) autorelease];
...
jboolean OrgGeogebraCommonEuclidianEuclidianController_processModeWithOrgGeogebraCommonEuclidianHits_withBoolean_withOrgGeogebraCommonUtilAsyncOperation_(OrgGeogebraCommonEuclidianEuclidianController *self, OrgGeogebraCommonEuclidianHits *processHits, jboolean isControlDown, OrgGeogebraCommonUtilAsyncOperation *callback) {
  ...
  if (callback == nil) {
    ...
    callback2 = [new_OrgGeogebraCommonEuclidianEuclidianController_$4_initWithOrgGeogebraCommonEuclidianEuclidianController_withOrgGeogebraCommonUtilAsyncOperation_(self, callback) autorelease];
  }
...
void OrgGeogebraCommonEuclidianEuclidianController_rotateObjectWithBoolean_(OrgGeogebraCommonEuclidianEuclidianController *self, jboolean repaint) {
  ...
  if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(self->rotGeoElement_)) isChangeable]) {
    ...
    OrgGeogebraCommonKernelGeosGeoElement_updateCascadeWithJavaUtilArrayList_withJavaUtilTreeSet_withBoolean_(pts, [new_JavaUtilTreeSet_init() autorelease], NO);
...
void OrgGeogebraCommonEuclidianEuclidianController_moveFunctionWithBoolean_(OrgGeogebraCommonEuclidianEuclidianController *self, jboolean repaint) {
  ...
  if (quadratic) {
    ...
    OrgGeogebraCommonKernelArithmeticMyDouble *a = [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, p) autorelease];
    OrgGeogebraCommonKernelArithmeticMyDouble *h = [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, self->vertexX_) autorelease];
    OrgGeogebraCommonKernelArithmeticMyDouble *k = [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, self->vertexY_) autorelease];
    ...
    OrgGeogebraCommonKernelArithmeticExpressionNode *squareE = [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((OrgGeogebraCommonKernelArithmeticExpressionNode *) [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self->kernel_, fv, OrgGeogebraCommonPluginOperationEnum_get_MINUS(), h) autorelease]) powerWithOrgGeogebraCommonKernelArithmeticExpressionValue:[new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, 2) autorelease]])) multiplyWithOrgGeogebraCommonKernelArithmeticExpressionValue:a])) plusWithOrgGeogebraCommonKernelArithmeticExpressionValue:k];
    OrgGeogebraCommonKernelArithmeticFunction *squareF = [new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionVariable_(squareE, fv) autorelease];
    [squareF initFunction];
    OrgGeogebraCommonKernelGeosGeoFunction *square = [new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_([((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) getConstruction]) autorelease];
...
jboolean OrgGeogebraCommonEuclidianEuclidianController_handleMovedElementFreeText(OrgGeogebraCommonEuclidianEuclidianController *self) {
  if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(self->movedGeoElement_)) isGeoText]) {
    ...
    OrgGeogebraCommonEuclidianEuclidianController_set_movedGeoText_(self, (OrgGeogebraCommonKernelGeosGeoText *) check_class_cast(self->movedGeoElement_, [OrgGeogebraCommonKernelGeosGeoText class]));
    ...
    if ([self->movedGeoText_ isAbsoluteScreenLocActive]) {
      ...
      OrgGeogebraCommonEuclidianEuclidianController_set_startLoc_(self, self->mouseLoc_);
    }
      ...
      if (loc == nil) {
        ...
        OrgGeogebraCommonKernelGeosGeoPoint *loc2 = [new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelGeosGeoPoint_(loc) autorelease];
...
void OrgGeogebraCommonEuclidianEuclidianController_handleMousePressedForMoveModeWithOrgGeogebraCommonEuclidianEventAbstractEvent_withBoolean_(OrgGeogebraCommonEuclidianEuclidianController *self, OrgGeogebraCommonEuclidianEventAbstractEvent *e, jboolean drag) {
  ...
  if (geo != nil) {
    ...
    OrgGeogebraCommonEuclidianEuclidianController_set_movedLabelGeoElement_(self, geo);
...
void OrgGeogebraCommonEuclidianEuclidianController_translateHitsByVectorWithOrgGeogebraCommonEuclidianEventPointerEventTypeEnum_(OrgGeogebraCommonEuclidianEuclidianController *self, OrgGeogebraCommonEuclidianEventPointerEventTypeEnum *type) {
  ...
  if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(topHit)) isGeoVector]) {
    ...
    OrgGeogebraCommonKernelAlgosAlgoVector *newVecAlgo = [new_OrgGeogebraCommonKernelAlgosAlgoVector_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_([self->kernel_ getConstruction], nil, self->movedGeoPoint_, p) autorelease];
  ...
  if ([topHit isTranslateable] || [OrgGeogebraCommonKernelGeosGeoPoly_class_() isInstance:topHit]) {
    ...
    [((OrgGeogebraCommonKernelAlgosAlgoDispatcher *) nil_chk([self getAlgoDispatcher])) TranslateNDWithNSString:nil withOrgGeogebraCommonKernelGeosGeoElement:topHit withOrgGeogebraCommonKernelKernelNDGeoVectorND:vec];
    [self setTranslateStartWithOrgGeogebraCommonKernelGeosGeoElement:topHit withOrgGeogebraCommonKernelKernelNDGeoVectorND:vec];
...
OrgGeogebraCommonEuclidianEuclidianPen *OrgGeogebraCommonEuclidianEuclidianController_getPen(OrgGeogebraCommonEuclidianEuclidianController *self) {
  if (self->pen_ == nil) {
    OrgGeogebraCommonEuclidianEuclidianController_setAndConsume_pen_(self, new_OrgGeogebraCommonEuclidianEuclidianPen_initWithOrgGeogebraCommonMainApp_withOrgGeogebraCommonEuclidianEuclidianView_(self->app_, self->view_));
  }
  return self->pen_;
}
...
void OrgGeogebraCommonEuclidianEuclidianController_moveAttachDetachWithBoolean_withOrgGeogebraCommonEuclidianEventAbstractEvent_(OrgGeogebraCommonEuclidianEuclidianController *self, jboolean repaint, OrgGeogebraCommonEuclidianEventAbstractEvent *event) {
  if ([((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(self->movedGeoPoint_)) isPointOnPath] || [self->movedGeoPoint_ isPointInRegion]) {
    ...
    [((OrgGeogebraCommonEuclidianEuclidianView *) nil_chk(self->view_)) setHitsWithOrgGeogebraCommonAwtGPoint:[new_OrgGeogebraCommonAwtGPoint_initWithInt_withInt_([((OrgGeogebraCommonEuclidianEventAbstractEvent *) nil_chk(event)) getX], [event getY]) autorelease] withOrgGeogebraCommonEuclidianEventPointerEventTypeEnum:[event getType]];
  ...
  if ([self->movedGeoPoint_ isPointOnPath] && ![hits containsWithId:[self->movedGeoPoint_ getPath]]) {
    ...
    if (self->detachFrom_ == nil) {
      OrgGeogebraCommonEuclidianEuclidianController_set_detachFrom_(self, [self->movedGeoPoint_ getPath]);
    }
    ...
    if (self->detachFrom_ == nil) {
      OrgGeogebraCommonEuclidianEuclidianController_set_detachFrom_(self, [self->movedGeoPoint_ getRegion]);
    }
...
void OrgGeogebraCommonEuclidianEuclidianController_$1_initWithOrgGeogebraCommonEuclidianEuclidianController_withOrgGeogebraCommonUtilAsyncOperation_(OrgGeogebraCommonEuclidianEuclidianController_$1 *self, OrgGeogebraCommonEuclidianEuclidianController *outer$, OrgGeogebraCommonUtilAsyncOperation *capture$0) {
  OrgGeogebraCommonEuclidianEuclidianController_$1_set_this$0_(self, outer$);
  OrgGeogebraCommonEuclidianEuclidianController_$1_set_val$callback2_(self, capture$0);
...
void OrgGeogebraCommonEuclidianEuclidianController_$2_initWithOrgGeogebraCommonEuclidianEuclidianController_withOrgGeogebraCommonUtilAsyncOperation_(OrgGeogebraCommonEuclidianEuclidianController_$2 *self, OrgGeogebraCommonEuclidianEuclidianController *outer$, OrgGeogebraCommonUtilAsyncOperation *capture$0) {
  OrgGeogebraCommonEuclidianEuclidianController_$2_set_this$0_(self, outer$);
  OrgGeogebraCommonEuclidianEuclidianController_$2_set_val$callback_(self, capture$0);
  OrgGeogebraCommonUtilAsyncOperation_init(self);
}
...
void OrgGeogebraCommonEuclidianEuclidianController_$3_initWithOrgGeogebraCommonEuclidianEuclidianController_withOrgGeogebraCommonEuclidianHits_(OrgGeogebraCommonEuclidianEuclidianController_$3 *self, OrgGeogebraCommonEuclidianEuclidianController *outer$, OrgGeogebraCommonEuclidianHits *capture$0) {
  OrgGeogebraCommonEuclidianEuclidianController_$3_set_this$0_(self, outer$);
  OrgGeogebraCommonEuclidianEuclidianController_$3_set_val$hits2_(self, capture$0);
  OrgGeogebraCommonUtilAsyncOperation_init(self);
}
...
void OrgGeogebraCommonEuclidianEuclidianController_$4_initWithOrgGeogebraCommonEuclidianEuclidianController_withOrgGeogebraCommonUtilAsyncOperation_(OrgGeogebraCommonEuclidianEuclidianController_$4 *self, OrgGeogebraCommonEuclidianEuclidianController *outer$, OrgGeogebraCommonUtilAsyncOperation *capture$0) {
  OrgGeogebraCommonEuclidianEuclidianController_$4_set_this$0_(self, outer$);
  OrgGeogebraCommonEuclidianEuclidianController_$4_set_val$callback_(self, capture$0);
  OrgGeogebraCommonUtilAsyncOperation_init(self);
}
...
void OrgGeogebraCommonEuclidianEuclidianController_$5_initWithOrgGeogebraCommonEuclidianEuclidianController_withOrgGeogebraCommonEuclidianHits_withOrgGeogebraCommonEuclidianEventAbstractEvent_(OrgGeogebraCommonEuclidianEuclidianController_$5 *self, OrgGeogebraCommonEuclidianEuclidianController *outer$, OrgGeogebraCommonEuclidianHits *capture$0, OrgGeogebraCommonEuclidianEventAbstractEvent *capture$1) {
  OrgGeogebraCommonEuclidianEuclidianController_$5_set_this$0_(self, outer$);
  OrgGeogebraCommonEuclidianEuclidianController_$5_set_val$hits2_(self, capture$0);
  OrgGeogebraCommonEuclidianEuclidianController_$5_set_val$event_(self, capture$1);
  OrgGeogebraCommonUtilAsyncOperation_init(self);
}
