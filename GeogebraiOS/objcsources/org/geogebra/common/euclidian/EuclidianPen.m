...
- (void)setDefaults {
  ...
  penColor_ = OrgGeogebraCommonAwtGColor_get_BLACK_();
...
- (void)setPenGeoWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)penGeo {
  if (penGeo == nil) {
    ...
    lastAlgo_ = [penGeo getParentAlgorithm];
  }
}
...
- (void)addPointPenModeWithOrgGeogebraCommonEuclidianEventAbstractEvent:(OrgGeogebraCommonEuclidianEventAbstractEvent *)e
  ...
  if ([((JavaUtilArrayList *) nil_chk(selGeos)) size] == 1 && [[selGeos getWithInt:0] isKindOfClass:[OrgGeogebraCommonKernelGeosGeoPolyLine class]]) {
    lastAlgo_ = [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk([selGeos getWithInt:0])) getParentAlgorithm];
  }
  [((OrgGeogebraCommonEuclidianEuclidianView *) nil_chk(view_)) setTransparentCursor];
  OrgGeogebraCommonAwtGPoint *newPoint = new_OrgGeogebraCommonAwtGPoint_initWithInt_withInt_([((OrgGeogebraCommonEuclidianEventAbstractEvent *) nil_chk(e)) getX], [e getY]);
  ...
  if (startPoint_ == nil) startPoint_ = [e getPoint];
...
- (OrgGeogebraCommonKernelGeosGeoElement *)checkShapesWithInt:(jint)x
  ...
  OrgGeogebraCommonAwtGPoint *newPoint = new_OrgGeogebraCommonAwtGPoint_initWithInt_withInt_(x, y);
  [((JavaUtilArrayList *) nil_chk(penPoints_)) addWithId:newPoint];
  brk_ = [IOSIntArray newArrayWithLength:5];
  a_ = new_OrgGeogebraCommonEuclidianEuclidianPen_Inertia_initWithOrgGeogebraCommonEuclidianEuclidianPen_(self);
  b_ = new_OrgGeogebraCommonEuclidianEuclidianPen_Inertia_initWithOrgGeogebraCommonEuclidianEuclidianPen_(self);
  c_ = new_OrgGeogebraCommonEuclidianEuclidianPen_Inertia_initWithOrgGeogebraCommonEuclidianEuclidianPen_(self);
  d_ = new_OrgGeogebraCommonEuclidianEuclidianPen_Inertia_initWithOrgGeogebraCommonEuclidianEuclidianPen_(self);
  jint j = 0;
  ...
  OrgGeogebraCommonEuclidianEuclidianPen_Inertia *s = new_OrgGeogebraCommonEuclidianEuclidianPen_Inertia_initWithOrgGeogebraCommonEuclidianEuclidianPen_(self);
  ...
  if (n > 0) {
    ...
    if (n == 1) {
      ...
      if (self->initialPoint_ != nil) {
        ...
        p = new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withNSString_withDouble_withDouble_withDouble_([((OrgGeogebraCommonKernelKernel *) nil_chk([((OrgGeogebraCommonMainApp *) nil_chk(app_)) getKernel])) getConstruction], nil, x_first, y_first, 1.0);
      }
      OrgGeogebraCommonKernelGeosGeoPoint *q = new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withNSString_withDouble_withDouble_withDouble_([((OrgGeogebraCommonKernelKernel *) nil_chk([((OrgGeogebraCommonMainApp *) nil_chk(app_)) getKernel])) getConstruction], nil, x_last, y_last, 1.0);
      algo = new_OrgGeogebraCommonKernelAlgosAlgoJoinPointsSegment_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_([((OrgGeogebraCommonKernelKernel *) nil_chk([app_ getKernel])) getConstruction], nil, p, q);
...
void OrgGeogebraCommonEuclidianEuclidianPen_initWithOrgGeogebraCommonMainApp_withOrgGeogebraCommonEuclidianEuclidianView_(OrgGeogebraCommonEuclidianEuclidianPen *self, OrgGeogebraCommonMainApp *app, OrgGeogebraCommonEuclidianEuclidianView *view) {
  ...
  self->lastAlgo_ = nil;
  self->penPoints_ = new_JavaUtilArrayList_init();
  self->temp_ = nil;
  ...
  self->c_ = nil;
  self->d_ = nil;
  self->reco_queue_a_ = new_OrgGeogebraCommonEuclidianEuclidianPen_RecoSegment_initWithOrgGeogebraCommonEuclidianEuclidianPen_(self);
  self->reco_queue_b_ = new_OrgGeogebraCommonEuclidianEuclidianPen_RecoSegment_initWithOrgGeogebraCommonEuclidianEuclidianPen_(self);
  self->reco_queue_c_ = new_OrgGeogebraCommonEuclidianEuclidianPen_RecoSegment_initWithOrgGeogebraCommonEuclidianEuclidianPen_(self);
  self->reco_queue_d_ = new_OrgGeogebraCommonEuclidianEuclidianPen_RecoSegment_initWithOrgGeogebraCommonEuclidianEuclidianPen_(self);
  self->reco_queue_e_ = new_OrgGeogebraCommonEuclidianEuclidianPen_RecoSegment_initWithOrgGeogebraCommonEuclidianEuclidianPen_(self);
  self->gridSize_ = 15;
  self->startPoint_ = nil;
  self->gesture_ = new_JavaLangStringBuffer_init();
  self->deltaX_ = 0;
  self->deltaY_ = 0;
  self->absDeltaX_ = 0;
  self->absDeltaY_ = 0;
  ...
  self->app_ = app;
  [self setDefaults];
  self->DEFAULT_PEN_LINE_ = new_OrgGeogebraCommonEuclidianEuclidianPen_$1_initWithOrgGeogebraCommonEuclidianEuclidianPen_withOrgGeogebraCommonKernelConstruction_(self, [((OrgGeogebraCommonKernelKernel *) nil_chk([((OrgGeogebraCommonMainApp *) nil_chk(app)) getKernel])) getConstruction]);
...
void OrgGeogebraCommonEuclidianEuclidianPen_addPointsToPolyLineWithJavaUtilArrayList_(OrgGeogebraCommonEuclidianEuclidianPen *self, JavaUtilArrayList *penPoints2) {
  ...
  if (self->lastAlgo_ == nil) {
    newPts = [IOSObjectArray newArrayWithLength:[((JavaUtilArrayList *) nil_chk(penPoints2)) size] type:OrgGeogebraCommonKernelGeosGeoPoint_class_()];
    offset = 0;
  }
  else {
    ...
    newPts = [IOSObjectArray newArrayWithLength:[((JavaUtilArrayList *) nil_chk(penPoints2)) size] + 1 + ((IOSObjectArray *) nil_chk(pts))->size_ type:OrgGeogebraCommonKernelGeosGeoPoint_class_()];
    for (jint i = 0; i < pts->size_; i++) {
      (void) IOSObjectArray_Set(newPts, i, (OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast([((OrgGeogebraCommonKernelGeosGeoPoint *) nil_chk(IOSObjectArray_Get(pts, i))) copyInternalWithOrgGeogebraCommonKernelConstruction:cons], [OrgGeogebraCommonKernelGeosGeoPoint class]));
    }
    (void) IOSObjectArray_Set(newPts, pts->size_, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withDouble_withDouble_withDouble_(cons, JavaLangDouble_NaN, JavaLangDouble_NaN, 1));
    offset = pts->size_ + 1;
  }
  id<JavaUtilIterator> it = [((JavaUtilArrayList *) nil_chk(penPoints2)) iterator];
  while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
    OrgGeogebraCommonAwtGPoint *p = [it next];
    (void) IOSObjectArray_Set(nil_chk(newPts), offset++, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withDouble_withDouble_withDouble_(cons, [((OrgGeogebraCommonEuclidianEuclidianView *) nil_chk(self->view_)) toRealWorldCoordXWithDouble:[((OrgGeogebraCommonAwtGPoint *) nil_chk(p)) getX]], [self->view_ toRealWorldCoordYWithDouble:[p getY]], 1));
  }
  ...
  if (!self->absoluteScreenPosition_) {
    newPolyLine = new_OrgGeogebraCommonKernelAlgosAlgoPolyLine_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_withOrgGeogebraCommonKernelGeosGeoList_withBoolean_(cons, nil, newPts, nil, YES);
    algo = newPolyLine;
  }
  else {
    newPolyLine = new_OrgGeogebraCommonKernelAlgosAlgoPolyLine_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_withOrgGeogebraCommonKernelGeosGeoList_withBoolean_(cons, newPts, nil, YES);
    ...
    OrgGeogebraCommonKernelArithmeticMyDouble *evNo = new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernelA, [((id<OrgGeogebraCommonEuclidianEuclidianViewInterfaceCommon>) nil_chk(ev)) getEuclidianViewNo]);
...
void OrgGeogebraCommonEuclidianEuclidianPen_mouseReleasedFreehandWithInt_withInt_(OrgGeogebraCommonEuclidianEuclidianPen *self, jint x, jint y) {
  ...
  IOSDoubleArray *freehand1 = [IOSDoubleArray newArrayWithLength:n];
  ...
  if ([shape isKindOfClass:[OrgGeogebraCommonKernelGeosGeoConic class]] && [((OrgGeogebraCommonKernelGeosGeoConic *) nil_chk(((OrgGeogebraCommonKernelGeosGeoConic *) check_class_cast(shape, [OrgGeogebraCommonKernelGeosGeoConic class])))) isCircle]) {
    ...
    @try {
      (void) [((OrgGeogebraCommonKernelCommandsAlgebraProcessor *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk([((OrgGeogebraCommonMainApp *) nil_chk(self->app_)) getKernel])) getAlgebraProcessor])) processAlgebraCommandNoExceptionHandlingWithNSString:equation withBoolean:YES withBoolean:NO withBoolean:YES withBoolean:YES];
    }
    @catch (JavaLangException *e) {
      [((JavaLangException *) nil_chk(e)) printStackTrace];
    }
  ...
  OrgGeogebraCommonKernelConstruction *cons = [((OrgGeogebraCommonKernelKernel *) nil_chk([((OrgGeogebraCommonMainApp *) nil_chk(self->app_)) getKernel])) getConstruction];
  OrgGeogebraCommonKernelGeosGeoList *list = new_OrgGeogebraCommonKernelGeosGeoList_initWithOrgGeogebraCommonKernelConstruction_(cons);
  [list addWithOrgGeogebraCommonKernelGeosGeoElement:new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons, OrgGeogebraCommonKernelKernel_checkDecimalFractionWithDouble_([((OrgGeogebraCommonEuclidianEuclidianView *) nil_chk(self->view_)) toRealWorldCoordXWithDouble:self->minX_]))];
  [list addWithOrgGeogebraCommonKernelGeosGeoElement:new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons, OrgGeogebraCommonKernelKernel_checkDecimalFractionWithDouble_([self->view_ toRealWorldCoordXWithDouble:self->maxX_]))];
  for (jint i = 0; i < n; i++) {
    [list addWithOrgGeogebraCommonKernelGeosGeoElement:new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons, OrgGeogebraCommonKernelKernel_checkDecimalFractionWithDouble_(IOSDoubleArray_Get(freehand1, i)))];
  }
  (void) [new_OrgGeogebraCommonKernelAlgosAlgoFunctionFreehand_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoList_(cons, nil, list) getGeoElements];
  self->minX_ = JavaLangInteger_MAX_VALUE;
  self->maxX_ = JavaLangInteger_MIN_VALUE;
}
...
jint OrgGeogebraCommonEuclidianEuclidianPen_findPolygonalWithInt_withInt_withInt_withInt_withInt_(OrgGeogebraCommonEuclidianEuclidianPen *self, jint start, jint end, jint n, jint offset1, jint offset2) {
  OrgGeogebraCommonEuclidianEuclidianPen_Inertia *s = new_OrgGeogebraCommonEuclidianEuclidianPen_Inertia_initWithOrgGeogebraCommonEuclidianEuclidianPen_(self);
  OrgGeogebraCommonEuclidianEuclidianPen_Inertia *s1 = new_OrgGeogebraCommonEuclidianEuclidianPen_Inertia_initWithOrgGeogebraCommonEuclidianEuclidianPen_(self);
  OrgGeogebraCommonEuclidianEuclidianPen_Inertia *s2 = new_OrgGeogebraCommonEuclidianEuclidianPen_Inertia_initWithOrgGeogebraCommonEuclidianEuclidianPen_(self);
...
void OrgGeogebraCommonEuclidianEuclidianPen_calc_inertiaWithInt_withInt_withOrgGeogebraCommonEuclidianEuclidianPen_Inertia_(OrgGeogebraCommonEuclidianEuclidianPen *self, jint start, jint end, OrgGeogebraCommonEuclidianEuclidianPen_Inertia *s) {
  jint i;
  jint coeff = 1;
  IOSIntArray *temp1 = [IOSIntArray newArrayWithLength:4];
  jdouble dm = 0;
...
OrgGeogebraCommonKernelGeosGeoConic *OrgGeogebraCommonEuclidianEuclidianPen_makeACircleWithDouble_withDouble_withDouble_(OrgGeogebraCommonEuclidianEuclidianPen *self, jdouble x, jdouble y, jdouble r) {
  self->temp_ = new_JavaUtilArrayList_init();
  jint npts, i = 0;
  npts = J2ObjCFpToInt((2 * r));
  if (npts < 12) npts = 12;
  OrgGeogebraCommonAwtGPoint *p;
  for (i = 0; i <= npts; i++) {
    p = new_OrgGeogebraCommonAwtGPoint_init();
  ...
  OrgGeogebraCommonKernelGeosGeoPoint *p1 = new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withDouble_withDouble_withDouble_([((OrgGeogebraCommonKernelKernel *) nil_chk([((OrgGeogebraCommonMainApp *) nil_chk(self->app_)) getKernel])) getConstruction], x1, y1, 1.0);
  OrgGeogebraCommonKernelGeosGeoPoint *q = new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withDouble_withDouble_withDouble_([((OrgGeogebraCommonKernelKernel *) nil_chk([self->app_ getKernel])) getConstruction], x2, y2, 1.0);
  OrgGeogebraCommonKernelGeosGeoPoint *z = new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withDouble_withDouble_withDouble_([((OrgGeogebraCommonKernelKernel *) nil_chk([self->app_ getKernel])) getConstruction], x3, y3, 1.0);
  OrgGeogebraCommonKernelAlgosAlgoCircleThreePoints *algo = new_OrgGeogebraCommonKernelAlgosAlgoCircleThreePoints_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_([((OrgGeogebraCommonKernelKernel *) nil_chk([self->app_ getKernel])) getConstruction], nil, p1, q, z);
...
OrgGeogebraCommonKernelGeosGeoConic *OrgGeogebraCommonEuclidianEuclidianPen_makeAConic(OrgGeogebraCommonEuclidianEuclidianPen *self) {
  ...
  OrgApacheCommonsMathLinearArray2DRowRealMatrix *M = new_OrgApacheCommonsMathLinearArray2DRowRealMatrix_initWithInt_withInt_(datasize, order * (order + 1));
  IOSDoubleArray *coeffs = [IOSDoubleArray newArrayWithLength:6];
  @try {
    jint r = 0;
    ...
    id<OrgApacheCommonsMathLinearSingularValueDecomposition> svd = new_OrgApacheCommonsMathLinearSingularValueDecompositionImpl_initWithOrgApacheCommonsMathLinearRealMatrix_(M);
  ...
  OrgGeogebraCommonKernelGeosGeoConic *conic = new_OrgGeogebraCommonKernelGeosGeoConic_initWithOrgGeogebraCommonKernelConstruction_withNSString_withDoubleArray_([((OrgGeogebraCommonKernelKernel *) nil_chk([self->app_ getKernel])) getConstruction], nil, coeffs);
  OrgGeogebraCommonKernelGeosGeoPoint *point = new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withDouble_withDouble_withDouble_([((OrgGeogebraCommonKernelKernel *) nil_chk([self->app_ getKernel])) getConstruction], 0, 0, 1);
  jdouble error = 0;
  ...
  if ([conic isDefined] && [conic getHalfAxisWithInt:0] / error > OrgGeogebraCommonEuclidianEuclidianPen_CONIC_AXIS_ERROR_RATIO && [conic getHalfAxisWithInt:1] / error > OrgGeogebraCommonEuclidianEuclidianPen_CONIC_AXIS_ERROR_RATIO) {
    OrgGeogebraCommonKernelAlgosAlgoFocus *algo = new_OrgGeogebraCommonKernelAlgosAlgoFocus_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelKernelNDGeoConicND_(cons, [IOSObjectArray newArrayWithObjects:(id[]){ nil, nil } count:2 type:NSString_class_()], conic);
...
void OrgGeogebraCommonEuclidianEuclidianPen_saveMoveWithNSString_(OrgGeogebraCommonEuclidianEuclidianPen *self, NSString *move) {
  ...
  (void) [self->gesture_ appendWithNSString:move];
}
...
void OrgGeogebraCommonEuclidianEuclidianPen_clearTemporaryInfo(OrgGeogebraCommonEuclidianEuclidianPen *self) {
  self->startPoint_ = nil;
  (void) [self->gesture_ delete__WithInt:0 withInt:[((JavaLangStringBuffer *) nil_chk(self->gesture_)) length]];
}
...
void OrgGeogebraCommonEuclidianEuclidianPen_optimize_polygonalWithInt_(OrgGeogebraCommonEuclidianEuclidianPen *self, jint nsides) {
  ...
  jboolean improved;
  OrgGeogebraCommonEuclidianEuclidianPen_Inertia *temp1 = new_OrgGeogebraCommonEuclidianEuclidianPen_Inertia_initWithOrgGeogebraCommonEuclidianEuclidianPen_(self);
  OrgGeogebraCommonEuclidianEuclidianPen_Inertia *temp2 = new_OrgGeogebraCommonEuclidianEuclidianPen_Inertia_initWithOrgGeogebraCommonEuclidianEuclidianPen_(self);
  for (i = 1; i < nsides; ++i) {
    if ((i - 1) == 0) {
...
OrgGeogebraCommonKernelGeosGeoElement *OrgGeogebraCommonEuclidianEuclidianPen_try_rectangle(OrgGeogebraCommonEuclidianEuclidianPen *self) {
  ...
  IOSDoubleArray *pt = [IOSDoubleArray newArrayWithLength:2];
  OrgGeogebraCommonKernelConstruction *cons = [((OrgGeogebraCommonKernelKernel *) nil_chk([((OrgGeogebraCommonMainApp *) nil_chk(self->app_)) getKernel])) getConstruction];
  OrgGeogebraCommonKernelAlgosAlgoPolygon *algo = nil;
  jdouble x_first = 0;
  jdouble y_first = 0;
  IOSDoubleArray *points = [IOSDoubleArray newArrayWithLength:10];
  ...
  *IOSDoubleArray_GetRef(points, 1) = IOSDoubleArray_Get(points, 9);
  IOSObjectArray *pts = [IOSObjectArray newArrayWithLength:4 type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()];
  ...
  for (i = 0; i < 4; ++i) {
    ...
    if (i == 0 && self->initialPoint_ != nil && [self->initialPoint_ isIndependent]) {
      ...
      (void) IOSObjectArray_Set(pts, 0, self->initialPoint_);
    }
    else {
      (void) IOSObjectArray_Set(pts, i, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withNSString_withDouble_withDouble_withDouble_(cons, nil, x_first, y_first, 1.0));
    }
  }
  algo = new_OrgGeogebraCommonKernelAlgosAlgoPolygon_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_(cons, nil, pts);
...
OrgGeogebraCommonKernelGeosGeoElement *OrgGeogebraCommonEuclidianEuclidianPen_try_arrow(OrgGeogebraCommonEuclidianEuclidianPen *self) {
  ...
  jint i, j;
  IOSDoubleArray *alpha = [IOSDoubleArray newArrayWithLength:3];
  IOSDoubleArray *pt = [IOSDoubleArray newArrayWithLength:2];
  jdouble dist, delta;
  jdouble x1, y1, x2, y2, angle;
  IOSBooleanArray *rev = [IOSBooleanArray newArrayWithLength:3];
  OrgGeogebraCommonKernelConstruction *cons = [((OrgGeogebraCommonKernelKernel *) nil_chk([((OrgGeogebraCommonMainApp *) nil_chk(self->app_)) getKernel])) getConstruction];
  ...
  p = new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withDouble_withDouble_withDouble_(cons, x_first, y_first, 1.0);
  q = new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withDouble_withDouble_withDouble_(cons, x_last, y_last, 1.0);
  algo = new_OrgGeogebraCommonKernelAlgosAlgoJoinPointsSegment_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_(cons, nil, p, q);
  OrgGeogebraCommonKernelGeosGeoElement *line = IOSObjectArray_Get(nil_chk([algo getGeoElements]), 0);
  [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(line)) updateRepaint];
...
OrgGeogebraCommonKernelGeosGeoElement *OrgGeogebraCommonEuclidianEuclidianPen_try_closed_polygonWithInt_(OrgGeogebraCommonEuclidianEuclidianPen *self, jint nsides) {
  ...
  jdouble x_first = 0;
  jdouble y_first = 0;
  IOSDoubleArray *points = [IOSDoubleArray newArrayWithLength:nsides * 2 + 2];
  ...
  *IOSDoubleArray_GetRef(points, 1) = IOSDoubleArray_Get(points, 2 * nsides + 1);
  IOSObjectArray *pts = [IOSObjectArray newArrayWithLength:nsides type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()];
  for (i = 0; i < nsides; ++i) {
...
void OrgGeogebraCommonEuclidianEuclidianPen_$1_initWithOrgGeogebraCommonEuclidianEuclidianPen_withOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonEuclidianEuclidianPen_$1 *self, OrgGeogebraCommonEuclidianEuclidianPen *outer$, OrgGeogebraCommonKernelConstruction *arg$0) {
  self->this$0_ = outer$;
  (void) OrgGeogebraCommonKernelGeosGeoPolyLine_initWithOrgGeogebraCommonKernelConstruction_(self, arg$0);
}
