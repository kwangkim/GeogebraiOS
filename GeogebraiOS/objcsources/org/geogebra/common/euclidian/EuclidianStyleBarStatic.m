...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/euclidian/EuclidianStyleBarStatic.java
//
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonEuclidianEuclidianStyleBarStatic class]) {
    JreStrongAssignAndConsume(&OrgGeogebraCommonEuclidianEuclidianStyleBarStatic_bracketArray_, nil, [IOSObjectArray newArrayWithObjects:(id[]){ @"\u00d8", @"{ }", @"( )", @"[ ]", @"| |", @"|| ||" } count:6 type:NSString_class_()]);
    JreStrongAssignAndConsume(&OrgGeogebraCommonEuclidianEuclidianStyleBarStatic_bracketArray2_, nil, [IOSObjectArray newArrayWithObjects:(id[]){ @"\u00d8", @"{ }", @"( )", @"[ ]", @"||", @"||||" } count:6 type:NSString_class_()]);
...
JavaUtilHashMap *OrgGeogebraCommonEuclidianEuclidianStyleBarStatic_createDefaultMap() {
  ...
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_POINT) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_POINT_ALL_BUT_COMPLEX)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_COMPLEX_NUMBER) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_POINT_COMPLEX)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_POINT_ON_OBJECT) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_POINT_ALL_BUT_COMPLEX)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_INTERSECT) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_POINT_DEPENDENT)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_MIDPOINT) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_POINT_DEPENDENT)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_JOIN) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_LINE)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_SEGMENT) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_SEGMENT)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_SEGMENT_FIXED) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_SEGMENT)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_RAY) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_RAY)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_VECTOR) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_VECTOR)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_VECTOR_FROM_POINT) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_VECTOR)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_ORTHOGONAL) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_LINE)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_PARALLEL) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_LINE)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_LINE_BISECTOR) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_LINE)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_ANGULAR_BISECTOR) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_LINE)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_TANGENTS) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_LINE)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_POLAR_DIAMETER) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_LINE)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_FITLINE) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_LINE)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_CREATE_LIST) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_LIST)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_LOCUS) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_LOCUS)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_POLYGON) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_POLYGON)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_REGULAR_POLYGON) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_POLYGON)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_RIGID_POLYGON) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_POLYGON)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_VECTOR_POLYGON) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_POLYGON)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_POLYLINE) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_POLYLINE)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_CIRCLE_TWO_POINTS) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_CONIC)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_CIRCLE_POINT_RADIUS) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_CONIC)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_COMPASSES) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_CONIC)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_CIRCLE_THREE_POINTS) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_CONIC)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_SEMICIRCLE) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_CONIC)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_CIRCLE_ARC_THREE_POINTS) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_CONIC)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_CIRCUMCIRCLE_ARC_THREE_POINTS) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_CONIC)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_CIRCLE_SECTOR_THREE_POINTS) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_CONIC_SECTOR)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_CIRCUMCIRCLE_SECTOR_THREE_POINTS) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_CONIC_SECTOR)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_ELLIPSE_THREE_POINTS) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_CONIC)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_HYPERBOLA_THREE_POINTS) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_CONIC)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_PARABOLA) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_CONIC)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_CONIC_FIVE_POINTS) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_CONIC)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_ANGLE) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_ANGLE)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_ANGLE_FIXED) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_ANGLE)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_DISTANCE) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_TEXT)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_AREA) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_TEXT)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_SLOPE) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_POLYGON)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_MIRROR_AT_LINE) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_NONE)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_MIRROR_AT_POINT) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_NONE)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_MIRROR_AT_CIRCLE) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_NONE)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_ROTATE_BY_ANGLE) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_NONE)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_TRANSLATE_BY_VECTOR) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_NONE)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_DILATE_FROM_POINT) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_NONE)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_TEXT) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_TEXT)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_SLIDER) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_NUMBER)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_IMAGE) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_IMAGE)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_SHOW_HIDE_CHECKBOX) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_BOOLEAN)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_BUTTON_ACTION) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_NONE)];
  [defaultGeoMap putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonEuclidianEuclidianConstants_MODE_TEXTFIELD_ACTION) withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_NONE)];
