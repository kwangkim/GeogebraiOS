...
+ (void)initialize {
  if (self == [OrgGeogebraCommonEuclidianEuclidianStatic class]) {
    JreStrongAssign(&OrgGeogebraCommonEuclidianEuclidianStatic_standardStroke_, nil, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newMyBasicStrokeWithFloat:1.0f]);
    JreStrongAssign(&OrgGeogebraCommonEuclidianEuclidianStatic_selStroke_, nil, [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newMyBasicStrokeWithFloat:1.0f + OrgGeogebraCommonPluginEuclidianStyleConstants_SELECTION_ADD]);
...
OrgGeogebraCommonAwtGPoint *OrgGeogebraCommonEuclidianEuclidianStatic_drawIndexedStringWithOrgGeogebraCommonMainApp_withOrgGeogebraCommonAwtGGraphics2D_withNSString_withFloat_withFloat_withBoolean_withBoolean_(OrgGeogebraCommonMainApp *app, id<OrgGeogebraCommonAwtGGraphics2D> g3, NSString *str, jfloat xPos, jfloat yPos, jboolean serif, jboolean precise) {
  ...
  return [new_OrgGeogebraCommonAwtGPoint_initWithInt_withInt_(JavaLangMath_roundWithFloat_(x - xPos), JavaLangMath_roundWithFloat_(maxY - yPos)) autorelease];
}
