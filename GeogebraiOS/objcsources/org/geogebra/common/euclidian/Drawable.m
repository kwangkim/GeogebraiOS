...
- (void)drawMultilineTextWithOrgGeogebraCommonAwtGGraphics2D:(id<OrgGeogebraCommonAwtGGraphics2D>)g2
  ...
  if (oldLabelDesc_ == labelDesc_ && !labelHasIndex_) {
    ...
    OrgGeogebraCommonEuclidianDrawable_set_oldLabelDesc_(self, labelDesc_);
    jint lineBegin = 0;
...
- (void)updateStrokesJustLineThicknessWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)fromGeo {
  OrgGeogebraCommonEuclidianDrawable_set_strokedShape_(self, nil);
  OrgGeogebraCommonEuclidianDrawable_set_strokedShape2_(self, nil);
...
- (void)fillWithOrgGeogebraCommonAwtGGraphics2D:(id<OrgGeogebraCommonAwtGGraphics2D>)g2
  ...
  if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(geo_)) isHatchingEnabled]) {
    if (hatchPaint_ == nil) {
      OrgGeogebraCommonEuclidianDrawable_setAndConsume_hatchPaint_(self, new_JavaUtilArrayList_init());
    }
...
- (void)setShapeWithOrgGeogebraCommonAwtGArea:(id<OrgGeogebraCommonAwtGArea>)shape {
  OrgGeogebraCommonEuclidianDrawable_set_shape_(self, shape);
}
...
- (void)resetHatch {
  OrgGeogebraCommonEuclidianDrawable_set_hatchPaint_(self, nil);
}
...
void OrgGeogebraCommonEuclidianDrawable_drawLabelWithOrgGeogebraCommonAwtGGraphics2D_(OrgGeogebraCommonEuclidianDrawable *self, id<OrgGeogebraCommonAwtGGraphics2D> g2) {
  ...
  if (self->oldLabelDesc_ == self->labelDesc_ && !self->labelHasIndex_ && self->lastFontSize_ == fontSize) {
    ...
    OrgGeogebraCommonEuclidianDrawable_set_oldLabelDesc_(self, self->labelDesc_);
...
void OrgGeogebraCommonEuclidianDrawable_updateStrokesWithOrgGeogebraCommonKernelKernelNDGeoElementND_withInt_(OrgGeogebraCommonEuclidianDrawable *self, id<OrgGeogebraCommonKernelKernelNDGeoElementND> fromGeo, jint minThickness) {
  ...
  if (self->lineThickness_ != [((id<OrgGeogebraCommonKernelKernelNDGeoElementND>) nil_chk(fromGeo)) getLineThickness]) {
    ...
    OrgGeogebraCommonEuclidianDrawable_set_objStroke_(self, OrgGeogebraCommonEuclidianEuclidianStatic_getStrokeWithFloat_withInt_(width, self->lineType_));
    OrgGeogebraCommonEuclidianDrawable_set_decoStroke_(self, OrgGeogebraCommonEuclidianEuclidianStatic_getStrokeWithFloat_withInt_(width, OrgGeogebraCommonPluginEuclidianStyleConstants_LINE_TYPE_FULL));
    OrgGeogebraCommonEuclidianDrawable_set_selStroke_(self, OrgGeogebraCommonEuclidianEuclidianStatic_getStrokeWithFloat_withInt_(width + OrgGeogebraCommonPluginEuclidianStyleConstants_SELECTION_ADD, OrgGeogebraCommonPluginEuclidianStyleConstants_LINE_TYPE_FULL));
  }
...
OrgGeogebraCommonEuclidianHatchingHandler *OrgGeogebraCommonEuclidianDrawable_getHatchingHandler(OrgGeogebraCommonEuclidianDrawable *self) {
  if (self->hatchingHandler_ == nil) {
    OrgGeogebraCommonEuclidianDrawable_setAndConsume_hatchingHandler_(self, new_OrgGeogebraCommonEuclidianHatchingHandler_init());
  }
...
void OrgGeogebraCommonEuclidianDrawable_init(OrgGeogebraCommonEuclidianDrawable *self) {
  ...
  OrgGeogebraCommonEuclidianDrawable_set_objStroke_(self, OrgGeogebraCommonEuclidianEuclidianStatic_getDefaultStroke());
  OrgGeogebraCommonEuclidianDrawable_set_selStroke_(self, OrgGeogebraCommonEuclidianEuclidianStatic_getDefaultSelectionStroke());
  OrgGeogebraCommonEuclidianDrawable_set_decoStroke_(self, OrgGeogebraCommonEuclidianEuclidianStatic_getDefaultStroke());
  self->lineThickness_ = -1;
  self->lineType_ = -1;
  self->labelHasIndex_ = NO;
  OrgGeogebraCommonEuclidianDrawable_set_labelRectangle_(self, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newRectangleWithInt:0 withInt:0]);
