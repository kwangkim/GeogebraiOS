...
OrgGeogebraCommonEuclidianDrawableND *OrgGeogebraCommonEuclidianEuclidianDraw_newDrawableWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoElement_(OrgGeogebraCommonEuclidianEuclidianView *ev, OrgGeogebraCommonKernelGeosGeoElement *geo) {
  ...
  OrgGeogebraCommonEuclidianDrawable *d = nil;
  {
    ...
    switch ([[((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(geo)) getGeoClassType] ordinal]) {
      ...
      d = [new_OrgGeogebraCommonEuclidianDrawDrawBoolean_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoBoolean_(ev, (OrgGeogebraCommonKernelGeosGeoBoolean *) check_class_cast(geo, [OrgGeogebraCommonKernelGeosGeoBoolean class])) autorelease];
      break;
      case OrgGeogebraCommonPluginGeoClass_BUTTON:
      d = [new_OrgGeogebraCommonEuclidianDrawDrawButton_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoButton_(ev, (OrgGeogebraCommonKernelGeosGeoButton *) check_class_cast(geo, [OrgGeogebraCommonKernelGeosGeoButton class])) autorelease];
      break;
      case OrgGeogebraCommonPluginGeoClass_TEXTFIELD:
      d = [new_OrgGeogebraCommonEuclidianDrawDrawTextField_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoTextField_(ev, (OrgGeogebraCommonKernelGeosGeoTextField *) check_class_cast(geo, [OrgGeogebraCommonKernelGeosGeoTextField class])) autorelease];
      break;
      case OrgGeogebraCommonPluginGeoClass_POINT:
      case OrgGeogebraCommonPluginGeoClass_POINT3D:
      d = [new_OrgGeogebraCommonEuclidianDrawDrawPoint_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDGeoPointND_(ev, (id<OrgGeogebraCommonKernelKernelNDGeoPointND>) check_protocol_cast(geo, @protocol(OrgGeogebraCommonKernelKernelNDGeoPointND))) autorelease];
      break;
      case OrgGeogebraCommonPluginGeoClass_SEGMENT:
      case OrgGeogebraCommonPluginGeoClass_SEGMENT3D:
      d = [new_OrgGeogebraCommonEuclidianDrawDrawSegment_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDGeoLineND_(ev, (id<OrgGeogebraCommonKernelKernelNDGeoSegmentND>) check_protocol_cast(geo, @protocol(OrgGeogebraCommonKernelKernelNDGeoSegmentND))) autorelease];
      break;
      case OrgGeogebraCommonPluginGeoClass_RAY:
      case OrgGeogebraCommonPluginGeoClass_RAY3D:
      d = [new_OrgGeogebraCommonEuclidianDrawDrawRay_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDGeoLineND_(ev, (id<OrgGeogebraCommonKernelKernelNDGeoRayND>) check_protocol_cast(geo, @protocol(OrgGeogebraCommonKernelKernelNDGeoRayND))) autorelease];
      break;
      case OrgGeogebraCommonPluginGeoClass_LINE:
      case OrgGeogebraCommonPluginGeoClass_LINE3D:
      d = [new_OrgGeogebraCommonEuclidianDrawDrawLine_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDGeoLineND_(ev, (id<OrgGeogebraCommonKernelKernelNDGeoLineND>) check_protocol_cast(geo, @protocol(OrgGeogebraCommonKernelKernelNDGeoLineND))) autorelease];
      break;
      case OrgGeogebraCommonPluginGeoClass_POLYGON:
      case OrgGeogebraCommonPluginGeoClass_POLYGON3D:
      d = [new_OrgGeogebraCommonEuclidianDrawDrawPolygon_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoPolygon_(ev, (OrgGeogebraCommonKernelGeosGeoPolygon *) check_class_cast(geo, [OrgGeogebraCommonKernelGeosGeoPolygon class])) autorelease];
      break;
      case OrgGeogebraCommonPluginGeoClass_PENSTROKE:
      case OrgGeogebraCommonPluginGeoClass_POLYLINE:
      d = [new_OrgGeogebraCommonEuclidianDrawDrawPolyLine_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoPolyLine_(ev, (OrgGeogebraCommonKernelGeosGeoPolyLine *) check_class_cast(geo, [OrgGeogebraCommonKernelGeosGeoPolyLine class])) autorelease];
      break;
      ...
      if ([((OrgGeogebraCommonKernelGeosGeoFunctionNVar *) check_class_cast(geo, [OrgGeogebraCommonKernelGeosGeoFunctionNVar class])) isBooleanFunction] && [((OrgGeogebraCommonKernelGeosGeoFunctionNVar *) check_class_cast(geo, [OrgGeogebraCommonKernelGeosGeoFunctionNVar class])) getVarNumber] < 3) {
        d = [new_OrgGeogebraCommonEuclidianDrawDrawInequality_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelArithmeticFunctionalNVar_(ev, (OrgGeogebraCommonKernelGeosGeoFunctionNVar *) check_class_cast(geo, [OrgGeogebraCommonKernelGeosGeoFunctionNVar class])) autorelease];
      }
      break;
      ...
      if ([((OrgGeogebraCommonKernelGeosGeoFunction *) check_class_cast(geo, [OrgGeogebraCommonKernelGeosGeoFunction class])) isBooleanFunction]) {
        d = [new_OrgGeogebraCommonEuclidianDrawDrawInequality_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelArithmeticFunctionalNVar_(ev, (OrgGeogebraCommonKernelGeosGeoFunction *) check_class_cast(geo, [OrgGeogebraCommonKernelGeosGeoFunction class])) autorelease];
      }
      break;
      ...
      if ([geo isIndependent]) {
        ...
        d = [new_OrgGeogebraCommonEuclidianDrawDrawSlider_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoNumeric_(ev, (OrgGeogebraCommonKernelGeosGeoNumeric *) check_class_cast(geo, [OrgGeogebraCommonKernelGeosGeoNumeric class])) autorelease];
      }
      else {
      ...
      if (algo == nil) {
        ...
        d = [new_OrgGeogebraCommonEuclidianDrawDrawSlope_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoNumeric_(ev, (OrgGeogebraCommonKernelGeosGeoNumeric *) check_class_cast(geo, [OrgGeogebraCommonKernelGeosGeoNumeric class])) autorelease];
      }
      else if ([algo isKindOfClass:[OrgGeogebraCommonKernelCasAlgoIntegralDefinite class]]) {
        d = [new_OrgGeogebraCommonEuclidianDrawDrawIntegral_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoNumeric_withBoolean_(ev, (OrgGeogebraCommonKernelGeosGeoNumeric *) check_class_cast(geo, [OrgGeogebraCommonKernelGeosGeoNumeric class]), NO) autorelease];
      }
      else if ([algo isKindOfClass:[OrgGeogebraCommonKernelCasAlgoIntegralFunctions class]]) {
        d = [new_OrgGeogebraCommonEuclidianDrawDrawIntegralFunctions_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoNumeric_withBoolean_(ev, (OrgGeogebraCommonKernelGeosGeoNumeric *) check_class_cast(geo, [OrgGeogebraCommonKernelGeosGeoNumeric class]), NO) autorelease];
      }
      else if ([algo isKindOfClass:[OrgGeogebraCommonKernelAlgosAlgoFunctionAreaSums class]]) {
        d = [new_OrgGeogebraCommonEuclidianDrawDrawUpperLowerSum_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoNumeric_(ev, (OrgGeogebraCommonKernelGeosGeoNumeric *) check_class_cast(geo, [OrgGeogebraCommonKernelGeosGeoNumeric class])) autorelease];
      }
      else if ([algo isKindOfClass:[OrgGeogebraCommonKernelAlgosAlgoBoxPlot class]]) {
        d = [new_OrgGeogebraCommonEuclidianDrawDrawBoxPlot_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoNumeric_(ev, (OrgGeogebraCommonKernelGeosGeoNumeric *) check_class_cast(geo, [OrgGeogebraCommonKernelGeosGeoNumeric class])) autorelease];
      }
      else if ([algo isKindOfClass:[OrgGeogebraCommonKernelAlgosAlgoBarChart class]]) {
        d = [new_OrgGeogebraCommonEuclidianDrawDrawBarGraph_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoNumeric_(ev, (OrgGeogebraCommonKernelGeosGeoNumeric *) check_class_cast(geo, [OrgGeogebraCommonKernelGeosGeoNumeric class])) autorelease];
      }
        ...
        if ([((OrgGeogebraCommonKernelArithmeticValidExpression *) nil_chk(ve)) isTopLevelCommand]) {
          ...
          if ([@"IntegralBetween" isEqual:name] && [cmd getArgumentNumber] == 4) {
            d = [new_OrgGeogebraCommonEuclidianDrawDrawIntegralFunctions_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoNumeric_withBoolean_(ev, (OrgGeogebraCommonKernelGeosGeoNumeric *) check_class_cast(geo, [OrgGeogebraCommonKernelGeosGeoNumeric class]), YES) autorelease];
          }
          else if ([@"Integral" isEqual:name] && [cmd getArgumentNumber] == 3) {
            d = [new_OrgGeogebraCommonEuclidianDrawDrawIntegral_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoNumeric_withBoolean_(ev, (OrgGeogebraCommonKernelGeosGeoNumeric *) check_class_cast(geo, [OrgGeogebraCommonKernelGeosGeoNumeric class]), YES) autorelease];
          }
        }
      }
      if (d != nil) {
      ...
      d = [new_OrgGeogebraCommonEuclidianDrawDrawVector_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDGeoVectorND_(ev, (id<OrgGeogebraCommonKernelKernelNDGeoVectorND>) check_protocol_cast(geo, @protocol(OrgGeogebraCommonKernelKernelNDGeoVectorND))) autorelease];
      break;
      case OrgGeogebraCommonPluginGeoClass_CONICPART:
      d = [new_OrgGeogebraCommonEuclidianDrawDrawConicPart_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDGeoConicPartND_(ev, (id<OrgGeogebraCommonKernelKernelNDGeoConicPartND>) check_protocol_cast(geo, @protocol(OrgGeogebraCommonKernelKernelNDGeoConicPartND))) autorelease];
      break;
      case OrgGeogebraCommonPluginGeoClass_CONIC:
      case OrgGeogebraCommonPluginGeoClass_CONIC3D:
      d = [new_OrgGeogebraCommonEuclidianDrawDrawConic_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDGeoConicND_withBoolean_(ev, (OrgGeogebraCommonKernelKernelNDGeoConicND *) check_class_cast(geo, [OrgGeogebraCommonKernelKernelNDGeoConicND class]), NO) autorelease];
      break;
      case OrgGeogebraCommonPluginGeoClass_CONICSECTION:
      d = [new_OrgGeogebraCommonEuclidianDrawDrawConicSection_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDGeoConicND_(ev, (OrgGeogebraCommonKernelKernelNDGeoConicND *) check_class_cast(geo, [OrgGeogebraCommonKernelKernelNDGeoConicND class])) autorelease];
      break;
      case OrgGeogebraCommonPluginGeoClass_IMPLICIT_POLY:
      d = [new_OrgGeogebraCommonEuclidianDrawDrawImplicitPoly_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelImplicitGeoImplicitPoly_(ev, (OrgGeogebraCommonKernelImplicitGeoImplicitPoly *) check_class_cast(geo, [OrgGeogebraCommonKernelImplicitGeoImplicitPoly class])) autorelease];
      break;
      case OrgGeogebraCommonPluginGeoClass_IMPLICIT_CURVE:
      d = [new_OrgGeogebraCommonEuclidianDrawDrawImplicitCurve_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelImplicitGeoImplicitCurve_(ev, (OrgGeogebraCommonKernelImplicitGeoImplicitCurve *) check_class_cast(geo, [OrgGeogebraCommonKernelImplicitGeoImplicitCurve class])) autorelease];
      break;
      case OrgGeogebraCommonPluginGeoClass_FUNCTION:
      case OrgGeogebraCommonPluginGeoClass_FUNCTIONCONDITIONAL:
      if ([((OrgGeogebraCommonKernelGeosGeoFunction *) check_class_cast(geo, [OrgGeogebraCommonKernelGeosGeoFunction class])) isBooleanFunction]) {
        d = [new_OrgGeogebraCommonEuclidianDrawDrawInequality_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelArithmeticFunctionalNVar_(ev, (id<OrgGeogebraCommonKernelArithmeticFunctionalNVar>) check_protocol_cast(geo, @protocol(OrgGeogebraCommonKernelArithmeticFunctionalNVar))) autorelease];
      }
      else {
        d = [new_OrgGeogebraCommonEuclidianDrawDrawParametricCurve_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDCurveEvaluable_(ev, (id<OrgGeogebraCommonKernelGeosParametricCurve>) check_protocol_cast(geo, @protocol(OrgGeogebraCommonKernelGeosParametricCurve))) autorelease];
      }
      break;
      ...
      d = [new_OrgGeogebraCommonEuclidianDrawDrawText_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoText_(ev, text) autorelease];
      break;
      case OrgGeogebraCommonPluginGeoClass_IMAGE:
      d = [new_OrgGeogebraCommonEuclidianDrawDrawImage_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoImage_(ev, (OrgGeogebraCommonKernelGeosGeoImage *) check_class_cast(geo, [OrgGeogebraCommonKernelGeosGeoImage class])) autorelease];
      break;
      case OrgGeogebraCommonPluginGeoClass_LOCUS:
      d = [new_OrgGeogebraCommonEuclidianDrawDrawLocus_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoLocusND_(ev, (OrgGeogebraCommonKernelGeosGeoLocusND *) check_class_cast(geo, [OrgGeogebraCommonKernelGeosGeoLocusND class])) autorelease];
      break;
      case OrgGeogebraCommonPluginGeoClass_CURVE_CARTESIAN:
      d = [new_OrgGeogebraCommonEuclidianDrawDrawParametricCurve_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDCurveEvaluable_(ev, (OrgGeogebraCommonKernelGeosGeoCurveCartesian *) check_class_cast(geo, [OrgGeogebraCommonKernelGeosGeoCurveCartesian class])) autorelease];
      break;
      ...
      if ([[geo getParentAlgorithm] isKindOfClass:[OrgGeogebraCommonKernelAlgosAlgoTransferFunction class]]) {
        d = [new_OrgGeogebraCommonEuclidianDrawDrawNyquist_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoTransferFunction_(ev, (OrgGeogebraCommonKernelGeosGeoTransferFunction *) check_class_cast(geo, [OrgGeogebraCommonKernelGeosGeoTransferFunction class])) autorelease];
      }
      break;
      ...
      if ([algo isKindOfClass:[OrgGeogebraCommonKernelStatisticsAlgoDotPlot class]]) {
        ...
        d = [new_OrgGeogebraCommonEuclidianDrawDrawList_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoList_(ev, (OrgGeogebraCommonKernelGeosGeoList *) check_class_cast(geo, [OrgGeogebraCommonKernelGeosGeoList class])) autorelease];
      }
      break;
      case OrgGeogebraCommonPluginGeoClass_TURTLE:
      d = [new_OrgGeogebraCommonEuclidianDrawDrawTurtle_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoTurtle_(ev, (OrgGeogebraCommonKernelGeosGeoTurtle *) check_class_cast(geo, [OrgGeogebraCommonKernelGeosGeoTurtle class])) autorelease];
      break;
    }
  }
  return d;
