...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/euclidian/clipping/DoubleArrayFactory.java
//
...
void OrgGeogebraCommonEuclidianClippingDoubleArrayFactory_init(OrgGeogebraCommonEuclidianClippingDoubleArrayFactory *self) {
  NSObject_init(self);
  OrgGeogebraCommonEuclidianClippingDoubleArrayFactory_setAndConsume_double2_(self, [IOSDoubleArray newArrayWithLength:2]);
  OrgGeogebraCommonEuclidianClippingDoubleArrayFactory_setAndConsume_double6_(self, [IOSDoubleArray newArrayWithLength:6]);
  self->d2free_ = YES;
  self->d6free_ = YES;
}
