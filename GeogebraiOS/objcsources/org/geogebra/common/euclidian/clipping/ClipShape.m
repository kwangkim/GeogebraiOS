...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/euclidian/clipping/ClipShape.java
//
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonEuclidianClippingClipShape class]) {
    JreStrongAssignAndConsume(&OrgGeogebraCommonEuclidianClippingClipShape_doubleFactory_, nil, new_OrgGeogebraCommonEuclidianClippingDoubleArrayFactory_init());
...
id<OrgGeogebraCommonAwtGGeneralPath> OrgGeogebraCommonEuclidianClippingClipShape_clipToRectWithOrgGeogebraCommonAwtGShape_withOrgGeogebraCommonAwtGAffineTransform_withOrgGeogebraCommonAwtGRectangle2D_(id<OrgGeogebraCommonAwtGShape> s, id<OrgGeogebraCommonAwtGAffineTransform> t, id<OrgGeogebraCommonAwtGRectangle2D> r) {
  ...
  OrgGeogebraCommonEuclidianClippingClipShape_ClippedPath *p = [new_OrgGeogebraCommonEuclidianClippingClipShape_ClippedPath_initWithInt_([((id<OrgGeogebraCommonAwtGPathIterator>) nil_chk(i)) getWindingRule]) autorelease];
  jdouble initialX = 0;
  jdouble initialY = 0;
  jint k;
  ...
  OrgGeogebraCommonEuclidianClippingClipShape_LFunction *lxf = [new_OrgGeogebraCommonEuclidianClippingClipShape_LFunction_init() autorelease];
  OrgGeogebraCommonEuclidianClippingClipShape_LFunction *lyf = [new_OrgGeogebraCommonEuclidianClippingClipShape_LFunction_init() autorelease];
  OrgGeogebraCommonEuclidianClippingClipShape_QFunction *qxf = [new_OrgGeogebraCommonEuclidianClippingClipShape_QFunction_init() autorelease];
  OrgGeogebraCommonEuclidianClippingClipShape_QFunction *qyf = [new_OrgGeogebraCommonEuclidianClippingClipShape_QFunction_init() autorelease];
  OrgGeogebraCommonEuclidianClippingClipShape_CFunction *cxf = [new_OrgGeogebraCommonEuclidianClippingClipShape_CFunction_init() autorelease];
  OrgGeogebraCommonEuclidianClippingClipShape_CFunction *cyf = [new_OrgGeogebraCommonEuclidianClippingClipShape_CFunction_init() autorelease];
...
void OrgGeogebraCommonEuclidianClippingClipShape_ClippedPath_initWithInt_(OrgGeogebraCommonEuclidianClippingClipShape_ClippedPath *self, jint windingRule) {
  NSObject_init(self);
  OrgGeogebraCommonEuclidianClippingClipShape_ClippedPath_setAndConsume_uncommittedPoints_(self, new_JavaUtilStack_init());
  OrgGeogebraCommonEuclidianClippingClipShape_ClippedPath_set_g_(self, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newGeneralPathWithInt:windingRule]);
}
...
- (jint)evaluateInverseWithDouble:(jdouble)x
                  withDoubleArray:(IOSDoubleArray *)dest
                          withInt:(jint)offset {
  if (eqn_ == nil) OrgGeogebraCommonEuclidianClippingClipShape_CFunction_setAndConsume_eqn_(self, [IOSDoubleArray newArrayWithLength:4]);
  ...
  *IOSDoubleArray_GetRef(eqn_, 3) = a_;
  ...
  if (t2_ == nil) OrgGeogebraCommonEuclidianClippingClipShape_CFunction_setAndConsume_t2_(self, [IOSDoubleArray newArrayWithLength:3]);
