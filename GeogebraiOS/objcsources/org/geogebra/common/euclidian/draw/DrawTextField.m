...
void OrgGeogebraCommonEuclidianDrawDrawTextField_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoTextField_(OrgGeogebraCommonEuclidianDrawDrawTextField *self, OrgGeogebraCommonEuclidianEuclidianView *view, OrgGeogebraCommonKernelGeosGeoTextField *geo) {
  ...
  OrgGeogebraCommonEuclidianDrawDrawTextField_set_geoTextField_(self, geo);
  OrgGeogebraCommonEuclidianDrawable_set_geo_(self, geo);
  OrgGeogebraCommonEuclidianDrawDrawTextField_set_box_(self, [((OrgGeogebraCommonFactoriesSwingFactory *) nil_chk([((OrgGeogebraCommonMainApp *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk([((OrgGeogebraCommonKernelGeosGeoTextField *) nil_chk(geo)) getKernel])) getApplication])) getSwingFactory])) createHorizontalBoxWithOrgGeogebraCommonEuclidianEuclidianController:[((OrgGeogebraCommonEuclidianEuclidianView *) nil_chk(view)) getEuclidianController]]);
  OrgGeogebraCommonEuclidianDrawDrawTextField_setAndConsume_ifListener_(self, new_OrgGeogebraCommonEuclidianDrawDrawTextField_InputFieldListener_initWithOrgGeogebraCommonEuclidianDrawDrawTextField_(self));
  OrgGeogebraCommonEuclidianDrawDrawTextField_setAndConsume_ifKeyListener_(self, new_OrgGeogebraCommonEuclidianDrawDrawTextField_InputFieldKeyListener_initWithOrgGeogebraCommonEuclidianDrawDrawTextField_(self));
  OrgGeogebraCommonEuclidianDrawDrawTextField_set_textField_(self, [((OrgGeogebraCommonKernelGeosGeoTextField *) nil_chk(self->geoTextField_)) getTextFieldWithInt:[view getViewID] withOrgGeogebraCommonEuclidianDrawDrawTextField:self]);
  ...
  OrgGeogebraCommonEuclidianDrawDrawTextField_set_label_(self, [((OrgGeogebraCommonFactoriesSwingFactory *) nil_chk([((OrgGeogebraCommonMainApp *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk([geo getKernel])) getApplication])) getSwingFactory])) newJLabelWithNSString:@"Label" withBoolean:NO]);
...
void OrgGeogebraCommonEuclidianDrawDrawTextField_update(OrgGeogebraCommonEuclidianDrawDrawTextField *self) {
  ...
  if ([self->geo_ isLabelVisible]) {
    ...
    if (![((NSString *) nil_chk(caption)) isEqual:self->oldCaption_]) {
      OrgGeogebraCommonEuclidianDrawDrawTextField_set_oldCaption_(self, caption);
...
- (void)focusGainedWithOrgGeogebraCommonEuclidianEventFocusEvent:(OrgGeogebraCommonEuclidianEventFocusEvent *)e {
  ...
  OrgGeogebraCommonEuclidianDrawDrawTextField_InputFieldListener_set_initialText_(self, [((id<OrgGeogebraCommonGuiInputfieldAutoCompleteTextField>) nil_chk(this$0_->textField_)) getText]);
}
...
void OrgGeogebraCommonEuclidianDrawDrawTextField_InputFieldListener_initWithOrgGeogebraCommonEuclidianDrawDrawTextField_(OrgGeogebraCommonEuclidianDrawDrawTextField_InputFieldListener *self, OrgGeogebraCommonEuclidianDrawDrawTextField *outer$) {
  OrgGeogebraCommonEuclidianDrawDrawTextField_InputFieldListener_set_this$0_(self, outer$);
...
void OrgGeogebraCommonEuclidianDrawDrawTextField_InputFieldKeyListener_initWithOrgGeogebraCommonEuclidianDrawDrawTextField_(OrgGeogebraCommonEuclidianDrawDrawTextField_InputFieldKeyListener *self, OrgGeogebraCommonEuclidianDrawDrawTextField *outer$) {
  OrgGeogebraCommonEuclidianDrawDrawTextField_InputFieldKeyListener_set_this$0_(self, outer$);
  NSObject_init(self);
}
