...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/euclidian/draw/DrawBoolean.java
//
...
- (void)drawWithOrgGeogebraCommonAwtGGraphics2D:(id<OrgGeogebraCommonAwtGGraphics2D>)g2 {
  if (isVisible_) {
    ...
    OrgGeogebraCommonEuclidianDrawDrawBoolean_set_textSize_(self, OrgGeogebraCommonEuclidianEuclidianStatic_drawIndexedStringWithOrgGeogebraCommonMainApp_withOrgGeogebraCommonAwtGGraphics2D_withNSString_withFloat_withFloat_withBoolean_withBoolean_([view_ getApplication], g2, labelDesc_, geoBool_->labelOffsetX_ + size + 9, geoBool_->labelOffsetY_ + (size + 9) / 2 + 5, NO, NO));
    OrgGeogebraCommonEuclidianDrawDrawBoolean_updateLabel(self);
  }
}
...
void OrgGeogebraCommonEuclidianDrawDrawBoolean_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoBoolean_(OrgGeogebraCommonEuclidianDrawDrawBoolean *self, OrgGeogebraCommonEuclidianEuclidianView *view, OrgGeogebraCommonKernelGeosGeoBoolean *geoBool) {
  ...
  OrgGeogebraCommonEuclidianDrawDrawBoolean_setAndConsume_textSize_(self, new_OrgGeogebraCommonAwtGPoint_initWithInt_withInt_(0, 0));
  OrgGeogebraCommonEuclidianDrawable_set_view_(self, view);
  OrgGeogebraCommonEuclidianDrawDrawBoolean_set_geoBool_(self, geoBool);
  OrgGeogebraCommonEuclidianDrawable_set_geo_(self, geoBool);
  OrgGeogebraCommonEuclidianDrawDrawBoolean_setAndConsume_checkBoxIcon_(self, new_OrgGeogebraCommonEuclidianDrawDrawBoolean_CheckBoxIcon_initWithOrgGeogebraCommonEuclidianEuclidianView_(view));
  OrgGeogebraCommonEuclidianDrawDrawBoolean_update(self);
}
...
void OrgGeogebraCommonEuclidianDrawDrawBoolean_update(OrgGeogebraCommonEuclidianDrawDrawBoolean *self) {
  ...
  if ([self->geo_ isLabelVisible]) {
    ...
    if (![((NSString *) nil_chk(caption)) isEqual:self->oldCaption_]) {
      OrgGeogebraCommonEuclidianDrawDrawBoolean_set_oldCaption_(self, caption);
      OrgGeogebraCommonEuclidianDrawable_set_labelDesc_(self, caption);
    }
  }
  else {
    OrgGeogebraCommonEuclidianDrawDrawBoolean_set_oldCaption_(self, @"");
    OrgGeogebraCommonEuclidianDrawable_set_labelDesc_(self, @"");
  }
  OrgGeogebraCommonEuclidianDrawDrawBoolean_updateLabel(self);
}
    ...
    if (checked) {
      if (csize == 13) {
        if (OrgGeogebraCommonEuclidianDrawDrawBoolean_CheckBoxIcon_stroke13_ == nil) {
          JreStrongAssign(&OrgGeogebraCommonEuclidianDrawDrawBoolean_CheckBoxIcon_stroke13_, nil, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newBasicStrokeWithFloat:2.0f withInt:OrgGeogebraCommonAwtGBasicStroke_CAP_ROUND withInt:OrgGeogebraCommonAwtGBasicStroke_JOIN_ROUND]);
        }
        ...
        if (OrgGeogebraCommonEuclidianDrawDrawBoolean_CheckBoxIcon_stroke26_ == nil) {
          JreStrongAssign(&OrgGeogebraCommonEuclidianDrawDrawBoolean_CheckBoxIcon_stroke26_, nil, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newBasicStrokeWithFloat:4.0f withInt:OrgGeogebraCommonAwtGBasicStroke_CAP_ROUND withInt:OrgGeogebraCommonAwtGBasicStroke_JOIN_ROUND]);
        }
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonEuclidianDrawDrawBoolean_CheckBoxIcon class]) {
    JreStrongAssign(&OrgGeogebraCommonEuclidianDrawDrawBoolean_CheckBoxIcon_highlightBackground_, nil, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newColorWithInt:248 withInt:248 withInt:248]);
...
void OrgGeogebraCommonEuclidianDrawDrawBoolean_CheckBoxIcon_initWithOrgGeogebraCommonEuclidianEuclidianView_(OrgGeogebraCommonEuclidianDrawDrawBoolean_CheckBoxIcon *self, OrgGeogebraCommonEuclidianEuclidianView *ev) {
  NSObject_init(self);
  OrgGeogebraCommonEuclidianDrawDrawBoolean_CheckBoxIcon_set_ev_(self, ev);
}
