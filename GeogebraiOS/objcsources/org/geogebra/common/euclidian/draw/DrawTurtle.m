...
void OrgGeogebraCommonEuclidianDrawDrawTurtle_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoTurtle_(OrgGeogebraCommonEuclidianDrawDrawTurtle *self, OrgGeogebraCommonEuclidianEuclidianView *view, OrgGeogebraCommonKernelGeosGeoTurtle *turtle) {
  ...
  self->turnAngle_ = 0.0;
  self->turtleImageBounds_ = [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newRectangle];
  self->imageSize_ = 10;
  self->currentCoords_ = [IOSDoubleArray newArrayWithLength:2];
  self->at_ = [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newAffineTransform];
  self->ellipse_ = [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newEllipse2DDouble];
  self->stroke1_ = [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newBasicStrokeWithFloat:1.0f];
  self->stroke2_ = [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newBasicStrokeWithFloat:2.0f];
  self->gPath_ = [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newGeneralPath];
  self->view_ = view;
  self->turtle_ = turtle;
  self->geo_ = turtle;
...
void OrgGeogebraCommonEuclidianDrawDrawTurtle_update(OrgGeogebraCommonEuclidianDrawDrawTurtle *self) {
  ...
  if (self->isVisible_) {
    ...
    if (self->pathList_ == nil) {
      self->pathList_ = new_JavaUtilArrayList_init();
    }
    else {
      [self->pathList_ clear];
    }
    OrgGeogebraCommonEuclidianDrawDrawTurtle_DrawState *ds = new_OrgGeogebraCommonEuclidianDrawDrawTurtle_DrawState_initWithOrgGeogebraCommonEuclidianDrawDrawTurtle_(self);
...
id<OrgGeogebraCommonAwtGRectangle> OrgGeogebraCommonEuclidianDrawDrawTurtle_getBounds(OrgGeogebraCommonEuclidianDrawDrawTurtle *self) {
  ...
  self->boundRect_ = self->turtleImageBounds_;
  for (OrgGeogebraCommonEuclidianDrawDrawTurtle_PartialPath * __strong path in nil_chk(self->pathList_)) {
    self->boundRect_ = [((id<OrgGeogebraCommonAwtGRectangle>) nil_chk(self->boundRect_)) union__WithOrgGeogebraCommonAwtGRectangle:[((OrgGeogebraCommonEuclidianGeneralPathClipped *) nil_chk(((OrgGeogebraCommonEuclidianDrawDrawTurtle_PartialPath *) nil_chk(path))->path1_)) getBounds]];
  }
...
void OrgGeogebraCommonEuclidianDrawDrawTurtle_updateTurtleShape(OrgGeogebraCommonEuclidianDrawDrawTurtle *self) {
  ...
  [self->gPath_ moveToWithFloat:0 withFloat:0];
  [self->gPath_ lineToWithFloat:x withFloat:-y];
  self->legs_ = [self->gPath_ createTransformedShapeWithOrgGeogebraCommonAwtGAffineTransform:self->at_];
  ...
  self->head_ = [((id<OrgGeogebraCommonAwtGAffineTransform>) nil_chk(self->at_)) createTransformedShapeWithOrgGeogebraCommonAwtGShape:self->ellipse_];
  [self->ellipse_ setFrameWithDouble:-r withDouble:-r withDouble:2 * r withDouble:1.8 * r];
  self->body_ = [self->at_ createTransformedShapeWithOrgGeogebraCommonAwtGShape:self->ellipse_];
  [self->ellipse_ setFrameWithDouble:-3 withDouble:-3 withDouble:6 withDouble:6];
  self->dot_ = [self->at_ createTransformedShapeWithOrgGeogebraCommonAwtGShape:self->ellipse_];
}
...
void OrgGeogebraCommonEuclidianDrawDrawTurtle_PartialPath_initWithOrgGeogebraCommonAwtGColor_withInt_withOrgGeogebraCommonEuclidianGeneralPathClipped_(OrgGeogebraCommonEuclidianDrawDrawTurtle_PartialPath *self, OrgGeogebraCommonAwtGColor *c, jint th, OrgGeogebraCommonEuclidianGeneralPathClipped *p) {
  ...
  self->thickness_ = th;
  self->path1_ = p;
  self->stroke_ = [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newBasicStrokeWithFloat:self->thickness_];
}
...
- (void)partialMoveWithOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)newPosition
                                                      withDouble:(jdouble)progress {
  IOSDoubleArray *newCoords = [IOSDoubleArray newArrayWithLength:2];
...
- (void)finishPartialPath {
  if (nlines_ > 0) {
    [((JavaUtilArrayList *) nil_chk(this$0_->pathList_)) addWithId:new_OrgGeogebraCommonEuclidianDrawDrawTurtle_PartialPath_initWithOrgGeogebraCommonAwtGColor_withInt_withOrgGeogebraCommonEuclidianGeneralPathClipped_(penColor_, penThickness_, currentPath_)];
  }
  currentPath_ = new_OrgGeogebraCommonEuclidianGeneralPathClipped_initWithOrgGeogebraCommonEuclidianEuclidianViewInterfaceSlim_([this$0_ getView]);
...
void OrgGeogebraCommonEuclidianDrawDrawTurtle_DrawState_initWithOrgGeogebraCommonEuclidianDrawDrawTurtle_(OrgGeogebraCommonEuclidianDrawDrawTurtle_DrawState *self, OrgGeogebraCommonEuclidianDrawDrawTurtle *outer$) {
  ...
  self->currentPath_ = new_OrgGeogebraCommonEuclidianGeneralPathClipped_initWithOrgGeogebraCommonEuclidianEuclidianViewInterfaceSlim_([outer$ getView]);
  self->penDown_ = NO;
