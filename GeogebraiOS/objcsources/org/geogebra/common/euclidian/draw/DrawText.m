...
- (jboolean)doUpdateFontSize {
  ...
  if (([text_ getTextString] != nil && [((OrgGeogebraCommonAwtGFont *) nil_chk(textFont_)) canDisplayUpToWithNSString:[text_ getTextString]] != -1) || fontSize_ != newFontSize || fontStyle_ != newFontStyle || newSerifFont != serifFont_) {
    ...
    OrgGeogebraCommonEuclidianDrawDrawText_set_textFont_(self, [((OrgGeogebraCommonMainApp *) nil_chk(app)) getFontCanDisplayWithNSString:[text_ getTextString] withBoolean:serifFont_ withInt:fontStyle_ withInt:fontSize_]);
    return YES;
  }
  return NO;
}
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonEuclidianDrawDrawText class]) {
    JreStrongAssign(&OrgGeogebraCommonEuclidianDrawDrawText_HIGHLIGHT_COLOR_, nil, OrgGeogebraCommonAwtGColor_get_LIGHT_GRAY_());
...
void OrgGeogebraCommonEuclidianDrawDrawText_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoText_(OrgGeogebraCommonEuclidianDrawDrawText *self, OrgGeogebraCommonEuclidianEuclidianView *view, OrgGeogebraCommonKernelGeosGeoText *text) {
  ...
  OrgGeogebraCommonEuclidianDrawDrawText_set_text_(self, text);
  OrgGeogebraCommonEuclidianDrawable_set_geo_(self, text);
  OrgGeogebraCommonEuclidianDrawDrawText_set_textFont_(self, [((OrgGeogebraCommonAwtGFont *) nil_chk([((OrgGeogebraCommonMainApp *) nil_chk([((OrgGeogebraCommonEuclidianEuclidianView *) nil_chk(view)) getApplication])) getPlainFontCommon])) deriveFontWithInt:OrgGeogebraCommonAwtGFont_PLAIN withInt:[view getFontSize]]);
...
void OrgGeogebraCommonEuclidianDrawDrawText_update(OrgGeogebraCommonEuclidianDrawDrawText *self) {
  ...
  OrgGeogebraCommonEuclidianDrawable_set_labelDesc_(self, newText);
  ...
  if ([self->text_ isAbsoluteScreenLocActive]) {
    ...
    OrgGeogebraCommonEuclidianDrawDrawText_set_loc_(self, [self->text_ getStartPoint]);
    if (self->loc_ == nil) {
