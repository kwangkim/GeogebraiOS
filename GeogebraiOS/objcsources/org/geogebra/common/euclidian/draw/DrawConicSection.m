...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/euclidian/draw/DrawConicSection.java
//
...
- (void)updateEllipse {
  ...
  for (jint j = 0; j < 2; j++) {
    IOSObjectArray_Set(nil_chk(ev_), j, [view_ getCoordsForViewWithOrgGeogebraCommonKernelMatrixCoords:[conic_ getEigenvec3DWithInt:j]]);
  ...
  if (arc_DrawConicSection_ == nil) {
    OrgGeogebraCommonEuclidianDrawDrawConicSection_set_arc_DrawConicSection_(self, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newArc2D]);
  }
  ...
  if (xradius < BIG_RADIUS && yradius < BIG_RADIUS) {
    OrgGeogebraCommonEuclidianDrawDrawConic_set_shape_DrawConic_(self, [transform_ createTransformedShapeWithOrgGeogebraCommonAwtGShape:arcs]);
  }
  else {
...
- (void)updateLines {
  if (endPoints_ == nil) {
    OrgGeogebraCommonEuclidianDrawDrawConicSection_setAndConsume_endPoints_(self, [IOSObjectArray newArrayWithLength:4 type:OrgGeogebraCommonKernelMatrixCoords_class_()]);
  }
  ...
  IOSObjectArray_Set(nil_chk(endPoints_), 0, [((OrgGeogebraCommonEuclidianEuclidianView *) nil_chk(view_)) getCoordsForViewWithOrgGeogebraCommonKernelMatrixCoords:[((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(m)) addWithOrgGeogebraCommonKernelMatrixCoords:[((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(d)) mulWithDouble:[self getStartWithInt:0]]]]);
  IOSObjectArray_Set(endPoints_, 1, [view_ getCoordsForViewWithOrgGeogebraCommonKernelMatrixCoords:[m addWithOrgGeogebraCommonKernelMatrixCoords:[d mulWithDouble:[self getEndWithInt:0]]]]);
  m = [conic_ getOrigin3DWithInt:1];
  d = [conic_ getDirection3DWithInt:1];
  IOSObjectArray_Set(endPoints_, 3, [view_ getCoordsForViewWithOrgGeogebraCommonKernelMatrixCoords:[((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(m)) addWithOrgGeogebraCommonKernelMatrixCoords:[((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(d)) mulWithDouble:[self getStartWithInt:1]]]]);
  IOSObjectArray_Set(endPoints_, 2, [view_ getCoordsForViewWithOrgGeogebraCommonKernelMatrixCoords:[m addWithOrgGeogebraCommonKernelMatrixCoords:[d mulWithDouble:[self getEndWithInt:1]]]]);
    ...
    if (OrgGeogebraCommonKernelKernel_isZeroWithDouble_([((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(IOSObjectArray_Get(endPoints_, i))) getZ])) {
      if (numPoints == -1) {
        ...
        if (lines_DrawConicSection_ == nil) {
          OrgGeogebraCommonEuclidianDrawDrawConicSection_setAndConsume_lines_DrawConicSection_(self, [IOSObjectArray newArrayWithLength:4 type:OrgGeogebraCommonAwtGLine2D_class_()]);
        }
        if (IOSObjectArray_Get(nil_chk(lines_DrawConicSection_), numPoints) == nil) IOSObjectArray_Set(lines_DrawConicSection_, numPoints, [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newLine2D]);
  ...
  [((id<OrgGeogebraCommonAwtGAffineTransform>) nil_chk(transform_)) setTransformWithOrgGeogebraCommonAwtGAffineTransform:[view_ getCoordTransform]];
  OrgGeogebraCommonEuclidianDrawDrawConic_set_shape_DrawConic_(self, [transform_ createTransformedShapeWithOrgGeogebraCommonAwtGShape:path]);
}
...
- (void)updateDoubleLine {
  ...
  if (OrgGeogebraCommonKernelKernel_isZeroWithDouble_([((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(A)) getZ]) && OrgGeogebraCommonKernelKernel_isZeroWithDouble_([((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(B)) getZ])) {
    if (line_ == nil) OrgGeogebraCommonEuclidianDrawDrawConicSection_set_line_(self, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newLine2D]);
  ...
  [((id<OrgGeogebraCommonAwtGAffineTransform>) nil_chk(transform_)) setTransformWithOrgGeogebraCommonAwtGAffineTransform:[view_ getCoordTransform]];
  OrgGeogebraCommonEuclidianDrawDrawConic_set_shape_DrawConic_(self, [transform_ createTransformedShapeWithOrgGeogebraCommonAwtGShape:line_]);
}
...
- (jboolean)hitLinesWithInt:(jint)screenx
  ...
  for (jint i = 0; i < 4; i++) {
    OrgGeogebraCommonEuclidianDrawDrawConicSection_set_line_(self, IOSObjectArray_Get(nil_chk(lines_DrawConicSection_), i));
    if (line_ != nil) {
...
- (void)updateHyperbolaResetPaths {
  if (firstHyperbola_) {
    ...
    OrgGeogebraCommonEuclidianDrawDrawConicSection_setAndConsume_hyp_(self, new_OrgGeogebraCommonEuclidianGeneralPathClipped_initWithOrgGeogebraCommonEuclidianEuclidianViewInterfaceSlim_(view_));
  }
  else {
...
- (void)updateHyperbolaSetShape {
  OrgGeogebraCommonEuclidianDrawDrawConic_set_shape_DrawConic_(self, hyp_);
}
...
void OrgGeogebraCommonEuclidianDrawDrawConicSection_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDGeoConicND_(OrgGeogebraCommonEuclidianDrawDrawConicSection *self, OrgGeogebraCommonEuclidianEuclidianView *view, OrgGeogebraCommonKernelKernelNDGeoConicND *c) {
  OrgGeogebraCommonEuclidianDrawDrawConic_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDGeoConicND_withBoolean_(self, view, c, NO);
}
...
void OrgGeogebraCommonEuclidianDrawDrawConicSection_updateEllipseEdge(OrgGeogebraCommonEuclidianDrawDrawConicSection *self) {
  ...
  if (OrgGeogebraCommonKernelKernel_isZeroWithDouble_([((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(B)) getZ])) {
    if (self->line_ == nil) OrgGeogebraCommonEuclidianDrawDrawConicSection_set_line_(self, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newLine2D]);
  ...
  OrgGeogebraCommonEuclidianDrawDrawConic_set_shape_DrawConic_(self, [self->transform_ createTransformedShapeWithOrgGeogebraCommonAwtGShape:self->line_]);
}
