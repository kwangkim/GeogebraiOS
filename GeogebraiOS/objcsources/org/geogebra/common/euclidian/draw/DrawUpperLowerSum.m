...
void OrgGeogebraCommonEuclidianDrawDrawUpperLowerSum_init__(OrgGeogebraCommonEuclidianDrawDrawUpperLowerSum *self) {
  self->algo_ = (OrgGeogebraCommonKernelAlgosAlgoFunctionAreaSums *) check_class_cast([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(self->geo_)) getDrawAlgorithm], [OrgGeogebraCommonKernelAlgosAlgoFunctionAreaSums class]);
