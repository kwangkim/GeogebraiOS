...
void OrgGeogebraCommonEuclidianDrawDrawLocus_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoLocusND_(OrgGeogebraCommonEuclidianDrawDrawLocus *self, OrgGeogebraCommonEuclidianEuclidianView *view, OrgGeogebraCommonKernelGeosGeoLocusND *locus) {
  ...
  OrgGeogebraCommonEuclidianDrawDrawLocus_set_locus_(self, locus);
  OrgGeogebraCommonEuclidianDrawable_set_geo_(self, locus);
  OrgGeogebraCommonEuclidianDrawDrawLocus_update(self);
}
...
void OrgGeogebraCommonEuclidianDrawDrawLocus_buildGeneralPathWithJavaUtilArrayList_(OrgGeogebraCommonEuclidianDrawDrawLocus *self, JavaUtilArrayList *pointList) {
  if (self->gp_ == nil) OrgGeogebraCommonEuclidianDrawDrawLocus_setAndConsume_gp_(self, new_OrgGeogebraCommonEuclidianPlotGeneralPathClippedForCurvePlotter_initWithOrgGeogebraCommonEuclidianEuclidianViewInterfaceSlim_(self->view_));
  else [self->gp_ reset];
  OrgGeogebraCommonEuclidianDrawDrawLocus_set_lastPointCoords_(self, OrgGeogebraCommonEuclidianPlotCurvePlotter_drawWithOrgGeogebraCommonEuclidianPlotPathPlotter_withJavaUtilArrayList_(self->gp_, pointList));
}
