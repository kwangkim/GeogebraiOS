...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/euclidian/draw/DrawPolyLine.java
//
...
void OrgGeogebraCommonEuclidianDrawDrawPolyLine_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoPolyLine_(OrgGeogebraCommonEuclidianDrawDrawPolyLine *self, OrgGeogebraCommonEuclidianEuclidianView *view, OrgGeogebraCommonKernelGeosGeoPolyLine *poly) {
  ...
  OrgGeogebraCommonEuclidianDrawDrawPolyLine_setAndConsume_coords_(self, [IOSDoubleArray newArrayWithLength:2]);
  OrgGeogebraCommonEuclidianDrawDrawPolyLine_set_endPoint_(self, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newPoint2D]);
  OrgGeogebraCommonEuclidianDrawable_set_view_(self, view);
  OrgGeogebraCommonEuclidianDrawDrawPolyLine_set_poly_(self, poly);
...
void OrgGeogebraCommonEuclidianDrawDrawPolyLine_initWithOrgGeogebraCommonEuclidianEuclidianView_withJavaUtilArrayList_(OrgGeogebraCommonEuclidianDrawDrawPolyLine *self, OrgGeogebraCommonEuclidianEuclidianView *view, JavaUtilArrayList *points) {
  ...
  OrgGeogebraCommonEuclidianDrawDrawPolyLine_set_endPoint_(self, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newPoint2D]);
  OrgGeogebraCommonEuclidianDrawable_set_view_(self, view);
  OrgGeogebraCommonEuclidianDrawDrawPolyLine_set_points_(self, points);
...
void OrgGeogebraCommonEuclidianDrawDrawPolyLine_addPointsToPathWithOrgGeogebraCommonKernelKernelNDGeoPointNDArray_(OrgGeogebraCommonEuclidianDrawDrawPolyLine *self, IOSObjectArray *pts) {
  if (self->gp_ == nil) {
    OrgGeogebraCommonEuclidianDrawDrawPolyLine_setAndConsume_gp_(self, new_OrgGeogebraCommonEuclidianGeneralPathClipped_initWithOrgGeogebraCommonEuclidianEuclidianViewInterfaceSlim_(self->view_));
  }
  else {
    [self->gp_ reset];
  }
...
void OrgGeogebraCommonEuclidianDrawDrawPolyLine_updatePreview(OrgGeogebraCommonEuclidianDrawDrawPolyLine *self) {
  ...
  if (self->isVisible_) {
    IOSObjectArray *pointsArray = [IOSObjectArray arrayWithLength:size type:OrgGeogebraCommonKernelGeosGeoPoint_class_()];
    for (jint i = 0; i < size; i++) {
      IOSObjectArray_Set(pointsArray, i, (OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast([self->points_ getWithInt:i], [OrgGeogebraCommonKernelGeosGeoPoint class]));
    }
