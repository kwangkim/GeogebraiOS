...
void OrgGeogebraCommonEuclidianDrawDrawAngle_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoAngle_(OrgGeogebraCommonEuclidianDrawDrawAngle *self, OrgGeogebraCommonEuclidianEuclidianView *view, OrgGeogebraCommonKernelGeosGeoAngle *angle) {
  ...
  self->drawArc_ = [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newArc2D];
  self->polygon_ = [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newGeneralPath];
  self->m_ = [IOSDoubleArray newArrayWithLength:2];
  self->coords_ = [IOSDoubleArray newArrayWithLength:2];
  self->firstVec_ = [IOSDoubleArray newArrayWithLength:2];
  self->decoArc_ = [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newArc2D];
  self->angleTick_ = [IOSDoubleArray newArrayWithLength:2];
  self->view_ = view;
  self->angle_ = angle;
  self->geo_ = angle;
  OrgGeogebraCommonEuclidianDrawDrawAngle_init__(self);
...
void OrgGeogebraCommonEuclidianDrawDrawAngle_initWithOrgGeogebraCommonEuclidianEuclidianView_withJavaUtilArrayList_(OrgGeogebraCommonEuclidianDrawDrawAngle *self, OrgGeogebraCommonEuclidianEuclidianView *view, JavaUtilArrayList *points) {
  ...
  self->previewTempPoints_ = [IOSObjectArray newArrayWithLength:3 type:OrgGeogebraCommonKernelGeosGeoPoint_class_()];
...
void OrgGeogebraCommonEuclidianDrawDrawAngle_init__(OrgGeogebraCommonEuclidianDrawDrawAngle *self) {
  self->firstVec_ = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 1, 0 } count:2];
  self->m_ = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 0, 0 } count:2];
  if ([[((OrgGeogebraCommonKernelGeosGeoAngle *) nil_chk(self->angle_)) getDrawAlgorithm] isKindOfClass:[OrgGeogebraCommonKernelAlgosAlgoAngle class]]) {
    self->algo_ = ((OrgGeogebraCommonKernelAlgosAlgoAngle *) check_class_cast([self->angle_ getDrawAlgorithm], [OrgGeogebraCommonKernelAlgosAlgoAngle class]));
  }
}

void OrgGeogebraCommonEuclidianDrawDrawAngle_setNotVisible(OrgGeogebraCommonEuclidianDrawDrawAngle *self) {
  self->isVisible_ = NO;
  self->shape_DrawAngle_ = nil;
...
void OrgGeogebraCommonEuclidianDrawDrawAngle_update(OrgGeogebraCommonEuclidianDrawDrawAngle *self) {
  ...
  *IOSDoubleArray_GetRef(self->coords_, 1) = IOSDoubleArray_Get(self->m_, 1);
  ...
  if (self->show90degrees_) {
    {
      ...
      switch ([self->view_ getRightAngleStyle]) {
        ...
        if (self->square_ == nil) self->square_ = [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newGeneralPath];
        ...
        self->shape_DrawAngle_ = self->square_;
        break;
        ...
        self->drawDot_ = YES;
        if (self->dot90degree_ == nil) self->dot90degree_ = [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newEllipse2DDouble];
        ...
        *IOSDoubleArray_GetRef(self->coords_, 1) = IOSDoubleArray_Get(self->m_, 1) + radius * JavaLangMath_sinWithDouble_(labelAngle);
        ...
        self->shape_DrawAngle_ = [((id<OrgGeogebraCommonAwtGAffineTransform>) nil_chk([self->view_ getCoordTransform])) createTransformedShapeWithOrgGeogebraCommonAwtGShape:self->drawArc_];
        break;
      }
    }
  }
    ...
    jdouble rdiff;
    {
      ...
      switch (self->geo_->decorationType_) {
        ...
        self->shapeArc1_ = [((id<OrgGeogebraCommonAwtGAffineTransform>) nil_chk([self->view_ getCoordTransform])) createTransformedShapeWithOrgGeogebraCommonAwtGShape:self->decoArc_];
        break;
        ...
        self->shapeArc2_ = [((id<OrgGeogebraCommonAwtGAffineTransform>) nil_chk([self->view_ getCoordTransform])) createTransformedShapeWithOrgGeogebraCommonAwtGShape:self->decoArc_];
        break;
        ...
        *IOSDoubleArray_GetRef(self->angleTick_, 0) = -angSt - angExt / 2;
        ...
        n2 = [IOSDoubleArray newArrayWithLength:2];
        n = [IOSDoubleArray newArrayWithLength:2];
        v = [IOSDoubleArray newArrayWithLength:2];
        rotateangle = 0.25;
        ...
        p1 = [IOSDoubleArray newArrayWithLength:2];
        p2 = [IOSDoubleArray newArrayWithLength:2];
        p3 = [IOSDoubleArray newArrayWithLength:2];
        rdiff = 4 + self->geo_->lineThickness_ / 2.0;
  ...
  if (self->labelVisible_) {
    ...
    *IOSDoubleArray_GetRef(self->coords_, 1) = IOSDoubleArray_Get(self->m_, 1) + radius * JavaLangMath_sinWithDouble_(labelAngle);
    [self->view_ toScreenCoordsWithDoubleArray:self->coords_];
    self->labelDesc_ = [self->angle_ getLabelDescription];
...
void OrgGeogebraCommonEuclidianDrawDrawAngle_updateTickWithDouble_withInt_withInt_(OrgGeogebraCommonEuclidianDrawDrawAngle *self, jdouble angle1, jint radius, jint id_) {
  if (self->tick_ == nil) {
    self->tick_ = [IOSObjectArray newArrayWithLength:3 type:OrgGeogebraCommonAwtGLine2D_class_()];
    for (jint i = 0; i < self->tick_->size_; i++) {
      (void) IOSObjectArray_Set(self->tick_, i, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newLine2D]);
    }
  }
...
void OrgGeogebraCommonEuclidianDrawDrawAngle_initPreview(OrgGeogebraCommonEuclidianDrawDrawAngle *self) {
  ...
  self->geo_ = [algoPreview getAngle];
  self->angle_ = (OrgGeogebraCommonKernelGeosGeoAngle *) check_class_cast(self->geo_, [OrgGeogebraCommonKernelGeosGeoAngle class]);
