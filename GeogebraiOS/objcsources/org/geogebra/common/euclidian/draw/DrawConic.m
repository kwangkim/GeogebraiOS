...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/euclidian/draw/DrawConic.java
//
...
- (void)updateLines {
  OrgGeogebraCommonEuclidianDrawDrawConic_set_shape_DrawConic_(self, nil);
  if (firstLines_) {
    firstLines_ = NO;
    OrgGeogebraCommonEuclidianDrawDrawConic_set_lines_(self, [((OrgGeogebraCommonKernelKernelNDGeoConicND *) nil_chk(conic_)) getLines]);
    OrgGeogebraCommonEuclidianDrawDrawConic_setAndConsume_drawLines__(self, [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonEuclidianDrawDrawLine_class_()]);
    IOSObjectArray_SetAndConsume(drawLines__, 0, new_OrgGeogebraCommonEuclidianDrawDrawLine_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDGeoLineND_(view_, IOSObjectArray_Get(nil_chk(lines_), 0)));
    IOSObjectArray_SetAndConsume(drawLines__, 1, new_OrgGeogebraCommonEuclidianDrawDrawLine_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDGeoLineND_(view_, IOSObjectArray_Get(lines_, 1)));
  ...
  if (((OrgGeogebraCommonKernelKernelNDGeoConicND *) nil_chk(conic_))->type_ == OrgGeogebraCommonKernelKernelNDGeoConicNDConstants_CONIC_PARALLEL_LINES || conic_->type_ == OrgGeogebraCommonKernelKernelNDGeoConicNDConstants_CONIC_INTERSECTING_LINES || conic_->type_ == OrgGeogebraCommonKernelKernelNDGeoConicNDConstants_CONIC_LINE) {
    OrgGeogebraCommonEuclidianDrawDrawConic_set_shape_DrawConic_(self, [((OrgGeogebraCommonEuclidianDrawDrawLine *) nil_chk(IOSObjectArray_Get(nil_chk(drawLines__), 0))) getShapeWithBoolean:YES]);
    ...
    if (OrgGeogebraCommonEuclidianDrawDrawConic_negativeColored(self)) {
      ...
      OrgGeogebraCommonEuclidianDrawDrawConic_set_shape_DrawConic_(self, complement);
    }
  }
}
...
- (void)updateCircle {
  ...
  if (firstCircle_) {
    firstCircle_ = NO;
    OrgGeogebraCommonEuclidianDrawDrawConic_set_arc_(self, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newArc2D]);
    if (ellipse_ == nil) OrgGeogebraCommonEuclidianDrawDrawConic_set_ellipse_(self, [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newEllipse2DDouble]);
  }
  jint i = -1;
  jint BIG_RADIUS = [view_ getWidth] + [view_ getHeight];
  if (radius_ < BIG_RADIUS && yradius_ < BIG_RADIUS) {
    OrgGeogebraCommonEuclidianDrawDrawConic_set_circle_(self, ellipse_);
    OrgGeogebraCommonEuclidianDrawDrawConic_set_arcFiller_(self, nil);
    ...
    if (mx_ < 0.0) {
      ...
      OrgGeogebraCommonEuclidianDrawDrawConic_set_shape_DrawConic_(self, OrgGeogebraCommonEuclidianDrawDrawConic_set_circle_(self, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newRectangleWithInt:-1 withInt:-1 withInt:[view_ getWidth] + 2 withInt:[view_ getHeight] + 2]));
      OrgGeogebraCommonEuclidianDrawDrawConic_set_arcFiller_(self, nil);
      xLabel_ = -100;
      yLabel_ = -100;
      return;
    ...
    OrgGeogebraCommonEuclidianDrawDrawConic_set_circle_(self, arc_);
    ...
    if ([conic_ getAlphaValue] > 0.0f || [conic_ isHatchingEnabled]) {
      if (gp_ == nil) OrgGeogebraCommonEuclidianDrawDrawConic_setAndConsume_gp_(self, new_OrgGeogebraCommonEuclidianGeneralPathClipped_initWithOrgGeogebraCommonEuclidianEuclidianViewInterfaceSlim_(view_));
      else [gp_ reset];
      ...
      switch (i) {
        ...
        break;
        default:
        OrgGeogebraCommonEuclidianDrawDrawConic_set_gp_(self, nil);
      }
      OrgGeogebraCommonEuclidianDrawDrawConic_set_arcFiller_(self, gp_);
    }
  }
  OrgGeogebraCommonEuclidianDrawDrawConic_set_shape_DrawConic_(self, circle_);
...
- (void)updateEllipse {
  ...
  if (ev_ == nil) {
    OrgGeogebraCommonEuclidianDrawDrawConic_setAndConsume_ev_(self, [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonKernelMatrixCoords_class_()]);
  }
  if (isPreview_) {
    for (jint j = 0; j < 2; j++) {
      IOSObjectArray_Set(nil_chk(ev_), j, [((OrgGeogebraCommonKernelKernelNDGeoConicND *) nil_chk(conic_)) getEigenvecWithInt:j]);
    }
  }
  else {
    for (jint j = 0; j < 2; j++) {
      IOSObjectArray_Set(nil_chk(ev_), j, [view_ getCoordsForViewWithOrgGeogebraCommonKernelMatrixCoords:[((OrgGeogebraCommonKernelKernelNDGeoConicND *) nil_chk(conic_)) getEigenvec3DWithInt:j]]);
  ...
  if (firstEllipse_) {
    firstEllipse_ = NO;
    if (ellipse_ == nil) OrgGeogebraCommonEuclidianDrawDrawConic_set_ellipse_(self, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newEllipse2DDouble]);
  }
  ...
  if (xRadius < BIG_RADIUS && yRadius < BIG_RADIUS) {
    OrgGeogebraCommonEuclidianDrawDrawConic_set_shape_DrawConic_(self, [transform_ createTransformedShapeWithOrgGeogebraCommonAwtGShape:ellipse_]);
  }
  else {
...
- (void)updateHyperbola {
  ...
  if (isPreview_) {
    ...
    for (jint j = 0; j < 2; j++) {
      IOSObjectArray_Set(nil_chk(ev_), j, [((OrgGeogebraCommonEuclidianEuclidianView *) nil_chk(view_)) getCoordsForViewWithOrgGeogebraCommonKernelMatrixCoords:[((OrgGeogebraCommonKernelKernelNDGeoConicND *) nil_chk(conic_)) getEigenvec3DWithInt:j]]);
      if (!OrgGeogebraCommonKernelKernel_isZeroWithDouble_([((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(IOSObjectArray_Get(ev_, j))) getZ])) {
        isVisible_ = NO;
        return;
      }
...
- (void)updateHyperbolaResetPaths {
  if (firstHyperbola_) {
    ...
    OrgGeogebraCommonEuclidianDrawDrawConic_setAndConsume_hypRight_(self, new_OrgGeogebraCommonEuclidianGeneralPathClipped_initWithOrgGeogebraCommonEuclidianEuclidianViewInterfaceSlim_(view_));
    OrgGeogebraCommonEuclidianDrawDrawConic_setAndConsume_hypLeft_(self, new_OrgGeogebraCommonEuclidianGeneralPathClipped_initWithOrgGeogebraCommonEuclidianEuclidianViewInterfaceSlim_(view_));
  }
  else {
...
- (void)updateParabola {
  ...
  if (isPreview_) {
    ...
    for (jint j = 0; j < 2; j++) {
      IOSObjectArray_Set(nil_chk(ev_), j, [((OrgGeogebraCommonEuclidianEuclidianView *) nil_chk(view_)) getCoordsForViewWithOrgGeogebraCommonKernelMatrixCoords:[conic_ getEigenvec3DWithInt:j]]);
      if (!OrgGeogebraCommonKernelKernel_isZeroWithDouble_([((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(IOSObjectArray_Get(ev_, j))) getZ])) {
        isVisible_ = NO;
        return;
      }
  ...
  if (firstParabola_) {
    firstParabola_ = NO;
    OrgGeogebraCommonEuclidianDrawDrawConic_set_parabola_(self, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newGeneralPath]);
  }
  ...
  *IOSDoubleArray_GetRef(parpoints_, 7) = -y0_;
  ...
  OrgGeogebraCommonEuclidianDrawDrawConic_set_shape_DrawConic_(self, parabola_);
...
- (jboolean)hitWithInt:(jint)hitX
  ...
  switch (type_) {
    ...
    if (strokedShape_ == nil) {
      OrgGeogebraCommonEuclidianDrawable_set_strokedShape_(self, [((id<OrgGeogebraCommonAwtGBasicStroke>) nil_chk(objStroke_)) createStrokedShapeWithOrgGeogebraCommonAwtGShape:shape_DrawConic_]);
    }
...
- (jboolean)hitHyperbolaWithInt:(jint)hitX
                        ...
                        withInt:(jint)hitThreshold {
  if (strokedShape_ == nil) {
    OrgGeogebraCommonEuclidianDrawable_set_strokedShape_(self, [((id<OrgGeogebraCommonAwtGBasicStroke>) nil_chk(objStroke_)) createStrokedShapeWithOrgGeogebraCommonAwtGShape:hypLeft_]);
    OrgGeogebraCommonEuclidianDrawable_set_strokedShape2_(self, [objStroke_ createStrokedShapeWithOrgGeogebraCommonAwtGShape:hypRight_]);
  }
...
- (void)updatePreview {
  switch (previewMode_) {
    ...
    if (isVisible_) {
      ...
      OrgGeogebraCommonKernelArithmeticMyDouble *distance = [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_([((OrgGeogebraCommonKernelConstruction *) nil_chk(cons)) getKernel], [((OrgGeogebraCommonKernelGeosGeoPoint *) nil_chk(IOSObjectArray_Get(previewTempPoints_, 1))) distanceWithOrgGeogebraCommonKernelGeosGeoPoint:IOSObjectArray_Get(previewTempPoints_, 0)]) autorelease];
...
void OrgGeogebraCommonEuclidianDrawDrawConic_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDGeoConicND_withBoolean_(OrgGeogebraCommonEuclidianDrawDrawConic *self, OrgGeogebraCommonEuclidianEuclidianView *view, OrgGeogebraCommonKernelKernelNDGeoConicND *c, jboolean ignoreSingularities) {
  ...
  OrgGeogebraCommonEuclidianDrawDrawConic_setAndConsume_labelCoords_(self, [IOSDoubleArray newArrayWithLength:2]);
  self->firstPoint_ = YES;
  self->firstLines_ = YES;
  self->firstCircle_ = YES;
  OrgGeogebraCommonEuclidianDrawDrawConic_set_transform_(self, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newAffineTransform]);
  self->firstEllipse_ = YES;
  self->firstParabola_ = YES;
  OrgGeogebraCommonEuclidianDrawDrawConic_setAndConsume_parpoints_(self, [IOSDoubleArray newArrayWithLength:8]);
...
void OrgGeogebraCommonEuclidianDrawDrawConic_initConicWithOrgGeogebraCommonKernelKernelNDGeoConicND_(OrgGeogebraCommonEuclidianDrawDrawConic *self, OrgGeogebraCommonKernelKernelNDGeoConicND *c) {
  OrgGeogebraCommonEuclidianDrawDrawConic_set_conic_(self, c);
  OrgGeogebraCommonEuclidianDrawable_set_geo_(self, c);
  OrgGeogebraCommonEuclidianDrawDrawConic_set_vertex_(self, [((OrgGeogebraCommonKernelKernelNDGeoConicND *) nil_chk(c)) getTranslationVector]);
  OrgGeogebraCommonEuclidianDrawDrawConic_set_midpoint_(self, self->vertex_);
  OrgGeogebraCommonEuclidianDrawDrawConic_set_halfAxes_(self, [c getHalfAxes]);
...
void OrgGeogebraCommonEuclidianDrawDrawConic_initWithOrgGeogebraCommonEuclidianEuclidianView_withInt_withJavaUtilArrayList_(OrgGeogebraCommonEuclidianDrawDrawConic *self, OrgGeogebraCommonEuclidianEuclidianView *view, jint mode, JavaUtilArrayList *points) {
  ...
  self->isPreview_ = NO;
  OrgGeogebraCommonEuclidianDrawable_set_view_(self, view);
  OrgGeogebraCommonEuclidianDrawDrawConic_set_prevPoints_(self, points);
  ...
  OrgGeogebraCommonEuclidianDrawDrawConic_setAndConsume_previewTempPoints_(self, [IOSObjectArray newArrayWithLength:self->neededPrevPoints_ + 1 type:OrgGeogebraCommonKernelGeosGeoPoint_class_()]);
...
void OrgGeogebraCommonEuclidianDrawDrawConic_initWithOrgGeogebraCommonEuclidianEuclidianView_withJavaUtilArrayList_withJavaUtilArrayList_(OrgGeogebraCommonEuclidianDrawDrawConic *self, OrgGeogebraCommonEuclidianEuclidianView *view, JavaUtilArrayList *points, JavaUtilArrayList *selectedLines) {
  ...
  OrgGeogebraCommonEuclidianDrawable_set_view_(self, view);
  OrgGeogebraCommonEuclidianDrawDrawConic_set_prevPoints_(self, points);
  OrgGeogebraCommonEuclidianDrawDrawConic_set_prevLines_(self, selectedLines);
  self->neededPrevPoints_ = 1;
  ...
  if ([((JavaUtilArrayList *) nil_chk(selectedLines)) size] == 0) {
    OrgGeogebraCommonEuclidianDrawDrawConic_setAndConsume_previewTempLine_(self, new_OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelConstruction_(cons));
  }
  else {
    OrgGeogebraCommonEuclidianDrawDrawConic_set_previewTempLine_(self, (OrgGeogebraCommonKernelGeosGeoLine *) check_class_cast([selectedLines getWithInt:0], [OrgGeogebraCommonKernelGeosGeoLine class]));
  }
  OrgGeogebraCommonEuclidianDrawDrawConic_setAndConsume_previewTempPoints_(self, [IOSObjectArray newArrayWithLength:1 type:OrgGeogebraCommonKernelGeosGeoPoint_class_()]);
  IOSObjectArray_SetAndConsume(self->previewTempPoints_, 0, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons));
  OrgGeogebraCommonEuclidianDrawDrawConic_initPreview(self);
}
...
void OrgGeogebraCommonEuclidianDrawDrawConic_initWithOrgGeogebraCommonEuclidianEuclidianView_withInt_withJavaUtilArrayList_withJavaUtilArrayList_withJavaUtilArrayList_(OrgGeogebraCommonEuclidianDrawDrawConic *self, OrgGeogebraCommonEuclidianEuclidianView *view, jint mode, JavaUtilArrayList *points, JavaUtilArrayList *segments, JavaUtilArrayList *conics) {
  ...
  OrgGeogebraCommonEuclidianDrawable_set_view_(self, view);
  OrgGeogebraCommonEuclidianDrawDrawConic_set_prevPoints_(self, points);
  OrgGeogebraCommonEuclidianDrawDrawConic_set_prevSegments_(self, segments);
  OrgGeogebraCommonEuclidianDrawDrawConic_set_prevConics_(self, conics);
  self->previewMode_ = mode;
  OrgGeogebraCommonKernelConstruction *cons = [((OrgGeogebraCommonKernelKernel *) nil_chk([((OrgGeogebraCommonEuclidianEuclidianView *) nil_chk(view)) getKernel])) getConstruction];
  OrgGeogebraCommonEuclidianDrawDrawConic_setAndConsume_previewTempRadius_(self, new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(cons));
  OrgGeogebraCommonEuclidianDrawDrawConic_setAndConsume_previewTempPoints_(self, [IOSObjectArray newArrayWithLength:1 type:OrgGeogebraCommonKernelGeosGeoPoint_class_()]);
  IOSObjectArray_SetAndConsume(self->previewTempPoints_, 0, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons));
  OrgGeogebraCommonEuclidianDrawDrawConic_initPreview(self);
}
...
void OrgGeogebraCommonEuclidianDrawDrawConic_updateSinglePoint(OrgGeogebraCommonEuclidianDrawDrawConic *self) {
  ...
  if (self->firstPoint_) {
    self->firstPoint_ = NO;
    OrgGeogebraCommonEuclidianDrawDrawConic_set_point_(self, [((OrgGeogebraCommonKernelKernelNDGeoConicND *) nil_chk(self->conic_)) getSinglePoint]);
    if (self->point_ == nil) OrgGeogebraCommonEuclidianDrawDrawConic_setAndConsume_point_(self, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_([self->conic_ getConstruction]));
    OrgGeogebraCommonEuclidianDrawDrawConic_setAndConsume_drawPoint_(self, new_OrgGeogebraCommonEuclidianDrawDrawPoint_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDGeoPointND_withBoolean_(self->view_, self->point_, self->isPreview_));
...
void OrgGeogebraCommonEuclidianDrawDrawConic_initPreview(OrgGeogebraCommonEuclidianDrawDrawConic *self) {
  ...
  self->isPreview_ = YES;
  {
    ...
    switch (self->previewMode_) {
      case OrgGeogebraCommonEuclidianEuclidianConstants_MODE_CIRCLE_TWO_POINTS:
      algo = [new_OrgGeogebraCommonKernelAlgosAlgoCircleTwoPoints_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_(cons, IOSObjectArray_Get(self->previewTempPoints_, 0), IOSObjectArray_Get(self->previewTempPoints_, 1)) autorelease];
      ...
      distance = [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_([((OrgGeogebraCommonKernelConstruction *) nil_chk(cons)) getKernel], [((OrgGeogebraCommonKernelGeosGeoPoint *) nil_chk(IOSObjectArray_Get(self->previewTempPoints_, 1))) distanceWithOrgGeogebraCommonKernelGeosGeoPoint:IOSObjectArray_Get(self->previewTempPoints_, 0)]) autorelease];
      algoCircleRadius = [new_OrgGeogebraCommonKernelAlgosAlgoCirclePointRadius_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons, IOSObjectArray_Get(self->previewTempPoints_, 0), distance) autorelease];
      [cons removeFromConstructionListWithOrgGeogebraCommonKernelAlgosConstructionElement:algoCircleRadius];
      OrgGeogebraCommonEuclidianDrawDrawConic_initConicWithOrgGeogebraCommonKernelKernelNDGeoConicND_(self, [algoCircleRadius getCircle]);
      break;
      case OrgGeogebraCommonEuclidianEuclidianConstants_MODE_CONIC_FIVE_POINTS:
      ...
      algo0 = [new_OrgGeogebraCommonKernelAlgosAlgoConicFivePoints_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_(cons, pts) autorelease];
      ...
      break;
      case OrgGeogebraCommonEuclidianEuclidianConstants_MODE_COMPASSES:
      algo5 = [new_OrgGeogebraCommonKernelAlgosAlgoCirclePointRadius_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons, IOSObjectArray_Get(self->previewTempPoints_, 0), self->previewTempRadius_) autorelease];
      ...
      break;
      case OrgGeogebraCommonEuclidianEuclidianConstants_MODE_PARABOLA:
      algo6 = [new_OrgGeogebraCommonKernelAlgosAlgoParabolaPointLine_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoLineND_(cons, IOSObjectArray_Get(self->previewTempPoints_, 0), self->previewTempLine_) autorelease];
