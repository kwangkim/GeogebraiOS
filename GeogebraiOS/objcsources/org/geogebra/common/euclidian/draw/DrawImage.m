...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/euclidian/draw/DrawImage.java
//
...
- (void)drawWithOrgGeogebraCommonAwtGGraphics2D:(id<OrgGeogebraCommonAwtGGraphics2D>)g3 {
  if (isVisible_) {
    ...
    if (alpha_ >= 0.0f && alpha_ < 1.0f) {
      if (alphaComp_ == nil) OrgGeogebraCommonEuclidianDrawDrawImage_set_alphaComp_(self, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newAlphaCompositeWithInt:OrgGeogebraCommonAwtGAlphaComposite_SRC_OVER withFloat:alpha_]);
    ...
    if (absoluteLocation_) {
      ...
      if (!isInBackground__ && [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(geo_)) doHighlighting]) {
        ...
        [((id<OrgGeogebraCommonAwtGAffineTransform>) nil_chk(at_)) transformWithOrgGeogebraCommonAwtGPoint2D:corner1 withOrgGeogebraCommonAwtGPoint2D:corner1];
        [at_ transformWithOrgGeogebraCommonAwtGPoint2D:corner2 withOrgGeogebraCommonAwtGPoint2D:corner2];
        [at_ transformWithOrgGeogebraCommonAwtGPoint2D:corner3 withOrgGeogebraCommonAwtGPoint2D:corner3];
        [at_ transformWithOrgGeogebraCommonAwtGPoint2D:corner4 withOrgGeogebraCommonAwtGPoint2D:corner4];
        if (highlighting_ == nil) OrgGeogebraCommonEuclidianDrawDrawImage_set_highlighting_(self, [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newGeneralPath]);
...
void OrgGeogebraCommonEuclidianDrawDrawImage_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoImage_(OrgGeogebraCommonEuclidianDrawDrawImage *self, OrgGeogebraCommonEuclidianEuclidianView *view, OrgGeogebraCommonKernelGeosGeoImage *geoImage) {
  ...
  OrgGeogebraCommonEuclidianDrawDrawImage_setAndConsume_hitCoords_(self, [IOSDoubleArray newArrayWithLength:2]);
  OrgGeogebraCommonEuclidianDrawable_set_view_(self, view);
  OrgGeogebraCommonEuclidianDrawDrawImage_set_geoImage_(self, geoImage);
  OrgGeogebraCommonEuclidianDrawable_set_geo_(self, geoImage);
  OrgGeogebraCommonEuclidianDrawDrawImage_set_at_(self, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newAffineTransform]);
  OrgGeogebraCommonEuclidianDrawDrawImage_set_tempAT_(self, [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newAffineTransform]);
  OrgGeogebraCommonEuclidianDrawDrawImage_set_boundingBox_(self, [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newRectangle]);
  OrgGeogebraCommonEuclidianDrawable_set_selStroke_(self, [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newMyBasicStrokeWithFloat:1.5f]);
  OrgGeogebraCommonEuclidianDrawDrawImage_update(self);
}
...
void OrgGeogebraCommonEuclidianDrawDrawImage_update(OrgGeogebraCommonEuclidianDrawDrawImage *self) {
  ...
  if ([self->geo_ getAlphaValue] != self->alpha_) {
    ...
    OrgGeogebraCommonEuclidianDrawDrawImage_set_alphaComp_(self, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newAlphaCompositeWithInt:OrgGeogebraCommonAwtGAlphaComposite_SRC_OVER withFloat:self->alpha_]);
  }
  OrgGeogebraCommonEuclidianDrawDrawImage_set_image_(self, [((OrgGeogebraCommonKernelGeosGeoImage *) nil_chk(self->geoImage_)) getFillImage]);
  ...
  if (self->absoluteLocation_) {
    ...
    OrgGeogebraCommonEuclidianDrawDrawImage_set_boundingBox_(self, [((id<OrgGeogebraCommonAwtGShape>) nil_chk(shape)) getBounds]);
    @try {
      OrgGeogebraCommonEuclidianDrawDrawImage_set_atInverse_(self, [self->at_ createInverse]);
    }
