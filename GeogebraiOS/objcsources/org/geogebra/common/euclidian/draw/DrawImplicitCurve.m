...
void OrgGeogebraCommonEuclidianDrawDrawImplicitCurve_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelImplicitGeoImplicitCurve_(OrgGeogebraCommonEuclidianDrawDrawImplicitCurve *self, OrgGeogebraCommonEuclidianEuclidianView *view, OrgGeogebraCommonKernelImplicitGeoImplicitCurve *implicitCurve) {
  OrgGeogebraCommonEuclidianDrawDrawLocus_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoLocusND_(self, view, [((OrgGeogebraCommonKernelImplicitGeoImplicitCurve *) nil_chk(implicitCurve)) getLocus]);
  OrgGeogebraCommonEuclidianDrawable_set_view_(self, view);
  OrgGeogebraCommonEuclidianDrawDrawImplicitCurve_set_implicitCurve_(self, implicitCurve);
  OrgGeogebraCommonEuclidianDrawable_set_geo_(self, implicitCurve);
  [self update];
}
