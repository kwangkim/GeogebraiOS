...
void OrgGeogebraCommonEuclidianDrawDrawInequality_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelArithmeticFunctionalNVar_(OrgGeogebraCommonEuclidianDrawDrawInequality *self, OrgGeogebraCommonEuclidianEuclidianView *view, id<OrgGeogebraCommonKernelArithmeticFunctionalNVar> function) {
  ...
  self->view_ = view;
  self->geo_ = (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(function, [OrgGeogebraCommonKernelGeosGeoElement class]);
  self->function_ = function;
  self->operation_ = [((OrgGeogebraCommonKernelArithmeticIneqTree *) nil_chk([((id<OrgGeogebraCommonKernelArithmeticFunctionalNVar>) nil_chk(function)) getIneqs])) getOperation];
  if ([((OrgGeogebraCommonKernelArithmeticIneqTree *) nil_chk([function getIneqs])) getLeft] != nil) self->left_ = new_OrgGeogebraCommonEuclidianDrawDrawInequality_initWithOrgGeogebraCommonKernelArithmeticIneqTree_withOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoElement_([((OrgGeogebraCommonKernelArithmeticIneqTree *) nil_chk([function getIneqs])) getLeft], view, self->geo_);
  if ([((OrgGeogebraCommonKernelArithmeticIneqTree *) nil_chk([function getIneqs])) getRight] != nil) self->right_ = new_OrgGeogebraCommonEuclidianDrawDrawInequality_initWithOrgGeogebraCommonKernelArithmeticIneqTree_withOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoElement_([((OrgGeogebraCommonKernelArithmeticIneqTree *) nil_chk([function getIneqs])) getRight], view, self->geo_);
  if ([((OrgGeogebraCommonKernelArithmeticIneqTree *) nil_chk([function getIneqs])) getIneq] != nil) self->ineq_ = [((OrgGeogebraCommonKernelArithmeticIneqTree *) nil_chk([function getIneqs])) getIneq];
  OrgGeogebraCommonEuclidianDrawDrawInequality_update(self);
}
...
void OrgGeogebraCommonEuclidianDrawDrawInequality_update(OrgGeogebraCommonEuclidianDrawDrawInequality *self) {
  ...
  if (([self->geo_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoFunction class]]) && [((OrgGeogebraCommonKernelGeosGeoFunction *) check_class_cast(self->geo_, [OrgGeogebraCommonKernelGeosGeoFunction class])) showOnAxis] && ![@"y" isEqual:[((OrgGeogebraCommonKernelGeosGeoFunction *) check_class_cast(self->geo_, [OrgGeogebraCommonKernelGeosGeoFunction class])) getVarStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]]) {
    JavaUtilTreeSet *zeros = new_JavaUtilTreeSet_init();
    ...
    self->gpAxis_ = [IOSObjectArray newArrayWithLength:[zeros size] type:OrgGeogebraCommonEuclidianGeneralPathClipped_class_()];
    ...
    for (JavaLangDouble * __strong zero in zeros) {
      if (last != nil) {
        ...
        if (value) {
          (void) IOSObjectArray_Set(self->gpAxis_, gpCount, new_OrgGeogebraCommonEuclidianGeneralPathClipped_initWithOrgGeogebraCommonEuclidianEuclidianViewInterfaceSlim_(self->view_));
...
void OrgGeogebraCommonEuclidianDrawDrawInequality_updateRecursiveWithOrgGeogebraCommonKernelArithmeticIneqTree_(OrgGeogebraCommonEuclidianDrawDrawInequality *self, OrgGeogebraCommonKernelArithmeticIneqTree *it) {
  OrgGeogebraCommonEuclidianDrawDrawInequality_updateTreesWithOrgGeogebraCommonKernelArithmeticIneqTree_(self, it);
  self->operation_ = [((OrgGeogebraCommonKernelArithmeticIneqTree *) nil_chk(it)) getOperation];
  OrgGeogebraCommonEuclidianDrawDrawInequality_updateShape(self);
  if (self->left_ != nil) {
    self->yLabel_ = self->left_->yLabel_;
    self->xLabel_ = self->left_->xLabel_;
  }
  if (self->ineq_ != [it getIneq]) self->ineq_ = [it getIneq];
  if (self->ineq_ != nil) {
...
void OrgGeogebraCommonEuclidianDrawDrawInequality_createDrawable(OrgGeogebraCommonEuclidianDrawDrawInequality *self) {
  switch ([[((OrgGeogebraCommonKernelArithmeticInequality *) nil_chk(self->ineq_)) getType] ordinal]) {
    ...
    self->drawable_ = new_OrgGeogebraCommonEuclidianDrawDrawParametricInequality_initWithOrgGeogebraCommonKernelArithmeticInequality_withOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoElement_(self->ineq_, self->view_, self->geo_);
    break;
    ...
    self->drawable_ = new_OrgGeogebraCommonEuclidianDrawDrawInequality1Var_initWithOrgGeogebraCommonKernelArithmeticInequality_withOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoElement_withBoolean_(self->ineq_, self->view_, self->geo_, NO);
    break;
    case OrgGeogebraCommonKernelArithmeticInequality_IneqType_INEQUALITY_1VAR_Y:
    self->drawable_ = new_OrgGeogebraCommonEuclidianDrawDrawInequality1Var_initWithOrgGeogebraCommonKernelArithmeticInequality_withOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoElement_withBoolean_(self->ineq_, self->view_, self->geo_, YES);
    break;
    case OrgGeogebraCommonKernelArithmeticInequality_IneqType_INEQUALITY_CONIC:
    self->drawable_ = new_OrgGeogebraCommonEuclidianDrawDrawConic_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDGeoConicND_withBoolean_(self->view_, [self->ineq_ getConicBorder], ![self->ineq_ isStrict] == [self->ineq_ isAboveBorder]);
    [((OrgGeogebraCommonKernelGeosGeoConic *) nil_chk([self->ineq_ getConicBorder])) setInverseFillWithBoolean:[self->ineq_ isAboveBorder]];
    break;
    case OrgGeogebraCommonKernelArithmeticInequality_IneqType_INEQUALITY_LINEAR:
    self->drawable_ = new_OrgGeogebraCommonEuclidianDrawDrawLine_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDGeoLineND_(self->view_, [self->ineq_ getLineBorder]);
...
void OrgGeogebraCommonEuclidianDrawDrawInequality_updateTreesWithOrgGeogebraCommonKernelArithmeticIneqTree_(OrgGeogebraCommonEuclidianDrawDrawInequality *self, OrgGeogebraCommonKernelArithmeticIneqTree *it) {
  if ([((OrgGeogebraCommonKernelArithmeticIneqTree *) nil_chk(it)) getLeft] != nil && self->left_ == nil) {
    self->left_ = new_OrgGeogebraCommonEuclidianDrawDrawInequality_initWithOrgGeogebraCommonKernelArithmeticIneqTree_withOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoElement_([it getLeft], self->view_, self->geo_);
  }
  if ([it getLeft] != nil) {
  ...
  if ([it getRight] != nil && self->right_ == nil) {
    self->right_ = new_OrgGeogebraCommonEuclidianDrawDrawInequality_initWithOrgGeogebraCommonKernelArithmeticIneqTree_withOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoElement_([it getLeft], self->view_, self->geo_);
  }
...
jboolean OrgGeogebraCommonEuclidianDrawDrawInequality_hit2WithInt_withInt_(OrgGeogebraCommonEuclidianDrawDrawInequality *self, jint x, jint y) {
  IOSDoubleArray *coords = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ [((OrgGeogebraCommonEuclidianEuclidianView *) nil_chk(self->view_)) toRealWorldCoordXWithDouble:x], [self->view_ toRealWorldCoordYWithDouble:y] } count:2];
