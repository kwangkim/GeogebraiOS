...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/javasources/org/geogebra/common/euclidian/draw/DrawParametricCurve.java
//
...
- (jboolean)hitWithInt:(jint)x
  ...
  if (isVisible_) {
    ...
    if (strokedShape_ == nil) {
      OrgGeogebraCommonEuclidianDrawable_set_strokedShape_(self, [((id<OrgGeogebraCommonAwtGBasicStroke>) nil_chk(objStroke_)) createStrokedShapeWithOrgGeogebraCommonAwtGShape:gp_]);
    }
...
void OrgGeogebraCommonEuclidianDrawDrawParametricCurve_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDCurveEvaluable_(OrgGeogebraCommonEuclidianDrawDrawParametricCurve *self, OrgGeogebraCommonEuclidianEuclidianView *view, id<OrgGeogebraCommonKernelKernelNDCurveEvaluable> curve) {
  ...
  OrgGeogebraCommonEuclidianDrawDrawParametricCurve_setAndConsume_labelSB_(self, new_JavaLangStringBuilder_init());
  OrgGeogebraCommonEuclidianDrawable_set_view_(self, view);
  OrgGeogebraCommonEuclidianDrawDrawParametricCurve_set_curve_(self, curve);
  OrgGeogebraCommonEuclidianDrawable_set_geo_(self, [((id<OrgGeogebraCommonKernelKernelNDCurveEvaluable>) nil_chk(curve)) toGeoElement]);
  OrgGeogebraCommonEuclidianDrawDrawParametricCurve_update(self);
}
...
void OrgGeogebraCommonEuclidianDrawDrawParametricCurve_update(OrgGeogebraCommonEuclidianDrawDrawParametricCurve *self) {
  ...
  if (self->gp_ == nil) OrgGeogebraCommonEuclidianDrawDrawParametricCurve_setAndConsume_gp_(self, new_OrgGeogebraCommonEuclidianPlotGeneralPathClippedForCurvePlotter_initWithOrgGeogebraCommonEuclidianEuclidianViewInterfaceSlim_(self->view_));
  ...
  if (OrgGeogebraCommonKernelKernel_isEqualWithDouble_withDouble_(min, max)) {
    ...
    labelPoint = [new_OrgGeogebraCommonAwtGPoint_initWithInt_withInt_(J2ObjCFpToInt(IOSDoubleArray_Get(eval, 0)), J2ObjCFpToInt(IOSDoubleArray_Get(eval, 1))) autorelease];
  }
  else {
  ...
  if (labelPoint != nil) {
    ...
    self->yLabel_ = labelPoint->y_;
    {
      ...
      switch (self->geo_->labelMode_) {
        ...
        [self->labelSB_ appendWithNSString:[self->geo_ getLabelWithOrgGeogebraCommonKernelStringTemplate:tpl]];
        [self->labelSB_ appendWithChar:'('];
        [self->labelSB_ appendWithNSString:[((id<OrgGeogebraCommonKernelVarString>) check_protocol_cast(self->geo_, @protocol(OrgGeogebraCommonKernelVarString))) getVarStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
        [self->labelSB_ appendWithNSString:@")\\;=\\;"];
        [self->labelSB_ appendWithNSString:[self->geo_ getLaTeXdescription]];
        [self->labelSB_ appendWithChar:'$'];
        OrgGeogebraCommonEuclidianDrawable_set_labelDesc_(self, [self->labelSB_ description]);
        break;
