...
- (void)update {
  if (gp_ == nil) gp_ = new_OrgGeogebraCommonEuclidianPlotGeneralPathClippedForCurvePlotter_initWithOrgGeogebraCommonEuclidianEuclidianViewInterfaceSlim_(view_);
  else [gp_ reset];
  ...
  if ([paramIneq_ getType] == OrgGeogebraCommonKernelArithmeticInequality_IneqTypeEnum_get_INEQUALITY_PARAMETRIC_X()) {
    ...
    (void) [border evaluateCurveWithDouble:ax];
  }
