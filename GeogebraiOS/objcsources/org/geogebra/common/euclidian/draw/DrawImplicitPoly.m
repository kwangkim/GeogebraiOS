...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/euclidian/draw/DrawImplicitPoly.java
//
...
void OrgGeogebraCommonEuclidianDrawDrawImplicitPoly_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelImplicitGeoImplicitPoly_(OrgGeogebraCommonEuclidianDrawDrawImplicitPoly *self, OrgGeogebraCommonEuclidianEuclidianView *view, OrgGeogebraCommonKernelImplicitGeoImplicitPoly *implicitPoly) {
  (void) OrgGeogebraCommonEuclidianDrawDrawLocus_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoLocusND_(self, view, [((OrgGeogebraCommonKernelImplicitGeoImplicitPoly *) nil_chk(implicitPoly)) getLocus]);
  self->view_ = view;
  self->implicitPoly_ = implicitPoly;
  self->geo_ = implicitPoly;
  [self update];
}
