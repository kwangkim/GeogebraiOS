...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/euclidian/draw/DrawPoint.java
//
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonEuclidianDrawDrawPoint class]) {
    JreStrongAssign(&OrgGeogebraCommonEuclidianDrawDrawPoint_borderStroke_, nil, OrgGeogebraCommonEuclidianEuclidianStatic_getDefaultStroke());
    JreStrongAssignAndConsume(&OrgGeogebraCommonEuclidianDrawDrawPoint_fillStrokes_, nil, [IOSObjectArray newArrayWithLength:10 type:OrgGeogebraCommonAwtGBasicStroke_class_()]);
    JreStrongAssignAndConsume(&OrgGeogebraCommonEuclidianDrawDrawPoint_emptyStrokes_, nil, [IOSObjectArray newArrayWithLength:10 type:OrgGeogebraCommonAwtGBasicStroke_class_()]);
...
void OrgGeogebraCommonEuclidianDrawDrawPoint_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDGeoPointND_(OrgGeogebraCommonEuclidianDrawDrawPoint *self, OrgGeogebraCommonEuclidianEuclidianView *view, id<OrgGeogebraCommonKernelKernelNDGeoPointND> P) {
  OrgGeogebraCommonEuclidianDrawDrawPoint_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDGeoPointND_withBoolean_(self, view, P, NO);
}
...
void OrgGeogebraCommonEuclidianDrawDrawPoint_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDGeoPointND_withBoolean_(OrgGeogebraCommonEuclidianDrawDrawPoint *self, OrgGeogebraCommonEuclidianEuclidianView *view, id<OrgGeogebraCommonKernelKernelNDGeoPointND> P, jboolean isPreview) {
  ...
  OrgGeogebraCommonEuclidianDrawDrawPoint_set_circle_(self, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newEllipse2DDouble]);
  OrgGeogebraCommonEuclidianDrawDrawPoint_set_circleHighlight_(self, [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newEllipse2DDouble]);
  OrgGeogebraCommonEuclidianDrawDrawPoint_set_gp_(self, nil);
  OrgGeogebraCommonEuclidianDrawDrawPoint_setAndConsume_coords1_(self, [IOSDoubleArray newArrayWithLength:2]);
  OrgGeogebraCommonEuclidianDrawable_set_view_(self, view);
  OrgGeogebraCommonEuclidianDrawDrawPoint_set_P_(self, P);
  OrgGeogebraCommonEuclidianDrawable_set_geo_(self, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(P, [OrgGeogebraCommonKernelGeosGeoElement class]));
  self->isPreview_ = isPreview;
  OrgGeogebraCommonEuclidianDrawDrawPoint_setAndConsume_coords_(self, [IOSDoubleArray newArrayWithLength:2]);
  OrgGeogebraCommonEuclidianDrawDrawPoint_update(self);
}
...
void OrgGeogebraCommonEuclidianDrawDrawPoint_updateWithDoubleArray_(OrgGeogebraCommonEuclidianDrawDrawPoint *self, IOSDoubleArray *coords2) {
  ...
  OrgGeogebraCommonEuclidianDrawDrawPoint_set_coords_(self, coords2);
  ...
  jdouble root3over2;
  {
    ...
    switch (pointStyle) {
      ...
      if (self->gp_ == nil) {
        OrgGeogebraCommonEuclidianDrawDrawPoint_set_gp_(self, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newGeneralPath]);
      }
      ...
      yB = IOSDoubleArray_Get(self->coords_, 1) + self->pointSize_;
      if (self->line1_ == nil) {
        OrgGeogebraCommonEuclidianDrawDrawPoint_set_line1_(self, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newLine2D]);
        OrgGeogebraCommonEuclidianDrawDrawPoint_set_line2_(self, [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newLine2D]);
      }
      if (self->line3_ == nil) {
        OrgGeogebraCommonEuclidianDrawDrawPoint_set_line3_(self, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newLine2D]);
        OrgGeogebraCommonEuclidianDrawDrawPoint_set_line4_(self, [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newLine2D]);
      }
...
void OrgGeogebraCommonEuclidianDrawDrawPoint_drawClippedSectionWithOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonAwtGGraphics2D_(OrgGeogebraCommonEuclidianDrawDrawPoint *self, OrgGeogebraCommonKernelGeosGeoElement *geo2, id<OrgGeogebraCommonAwtGGraphics2D> g2) {
  switch ([[((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(geo2)) getGeoClassType] ordinal]) {
    ...
    OrgGeogebraCommonEuclidianDrawDrawPoint_setAndConsume_drawable_(self, new_OrgGeogebraCommonEuclidianDrawDrawLine_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDGeoLineND_(self->view_, (OrgGeogebraCommonKernelGeosGeoLine *) check_class_cast(geo2, [OrgGeogebraCommonKernelGeosGeoLine class])));
    break;
    case OrgGeogebraCommonPluginGeoClass_SEGMENT:
    OrgGeogebraCommonEuclidianDrawDrawPoint_setAndConsume_drawable_(self, new_OrgGeogebraCommonEuclidianDrawDrawSegment_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDGeoLineND_(self->view_, (OrgGeogebraCommonKernelGeosGeoSegment *) check_class_cast(geo2, [OrgGeogebraCommonKernelGeosGeoSegment class])));
    break;
    case OrgGeogebraCommonPluginGeoClass_RAY:
    OrgGeogebraCommonEuclidianDrawDrawPoint_setAndConsume_drawable_(self, new_OrgGeogebraCommonEuclidianDrawDrawRay_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDGeoLineND_(self->view_, (id<OrgGeogebraCommonKernelKernelNDGeoLineND>) check_protocol_cast(geo2, @protocol(OrgGeogebraCommonKernelKernelNDGeoLineND))));
    break;
    case OrgGeogebraCommonPluginGeoClass_CONIC:
    OrgGeogebraCommonEuclidianDrawDrawPoint_setAndConsume_drawable_(self, new_OrgGeogebraCommonEuclidianDrawDrawConic_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDGeoConicND_withBoolean_(self->view_, (OrgGeogebraCommonKernelGeosGeoConic *) check_class_cast(geo2, [OrgGeogebraCommonKernelGeosGeoConic class]), NO));
    break;
    case OrgGeogebraCommonPluginGeoClass_FUNCTION:
    OrgGeogebraCommonEuclidianDrawDrawPoint_setAndConsume_drawable_(self, new_OrgGeogebraCommonEuclidianDrawDrawParametricCurve_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDCurveEvaluable_(self->view_, (OrgGeogebraCommonKernelGeosGeoFunction *) check_class_cast(geo2, [OrgGeogebraCommonKernelGeosGeoFunction class])));
    break;
    case OrgGeogebraCommonPluginGeoClass_AXIS:
    OrgGeogebraCommonEuclidianDrawDrawPoint_set_drawable_(self, nil);
    break;
    case OrgGeogebraCommonPluginGeoClass_CONICPART:
    OrgGeogebraCommonEuclidianDrawDrawPoint_setAndConsume_drawable_(self, new_OrgGeogebraCommonEuclidianDrawDrawConicPart_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDGeoConicPartND_(self->view_, (OrgGeogebraCommonKernelGeosGeoConicPart *) check_class_cast(geo2, [OrgGeogebraCommonKernelGeosGeoConicPart class])));
    break;
    default:
    OrgGeogebraCommonEuclidianDrawDrawPoint_set_drawable_(self, nil);
...
id<OrgGeogebraCommonAwtGBasicStroke> OrgGeogebraCommonEuclidianDrawDrawPoint_getEmptyStrokeWithInt_(jint pointSize) {
  ...
  if (IOSObjectArray_Get(nil_chk(OrgGeogebraCommonEuclidianDrawDrawPoint_emptyStrokes_), pointSize) == nil) IOSObjectArray_Set(OrgGeogebraCommonEuclidianDrawDrawPoint_emptyStrokes_, pointSize, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newBasicStrokeJoinMitreWithFloat:pointSize / 2.0f]);
