...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/euclidian/draw/DrawConicPart.java
//
...
- (jboolean)intersectsRectangleWithOrgGeogebraCommonAwtGRectangle:(id<OrgGeogebraCommonAwtGRectangle>)rect {
  ...
  switch (draw_type_) {
    ...
    if (strokedShape_ == nil) {
      strokedShape_ = [((id<OrgGeogebraCommonAwtGBasicStroke>) nil_chk(objStroke_)) createStrokedShapeWithOrgGeogebraCommonAwtGShape:shape_DrawConicPart_];
    }
...
void OrgGeogebraCommonEuclidianDrawDrawConicPart_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDGeoConicPartND_(OrgGeogebraCommonEuclidianDrawDrawConicPart *self, OrgGeogebraCommonEuclidianEuclidianView *view, id<OrgGeogebraCommonKernelKernelNDGeoConicPartND> conicPart) {
  ...
  self->arc_ = [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newArc2D];
  self->transform_ = [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newAffineTransform];
...
void OrgGeogebraCommonEuclidianDrawDrawConicPart_initConicPartWithOrgGeogebraCommonKernelKernelNDGeoConicPartND_(OrgGeogebraCommonEuclidianDrawDrawConicPart *self, id<OrgGeogebraCommonKernelKernelNDGeoConicPartND> initConicPart) {
  self->conicPart_ = initConicPart;
  self->geo_ = (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(initConicPart, [OrgGeogebraCommonKernelGeosGeoElement class]);
  self->halfAxes_ = [((OrgGeogebraCommonKernelKernelNDGeoConicND *) nil_chk(((OrgGeogebraCommonKernelKernelNDGeoConicND *) check_class_cast(initConicPart, [OrgGeogebraCommonKernelKernelNDGeoConicND class])))) getHalfAxes];
...
void OrgGeogebraCommonEuclidianDrawDrawConicPart_updateEllipse(OrgGeogebraCommonEuclidianDrawDrawConicPart *self) {
  ...
  if (self->ev_ == nil) {
    self->ev_ = [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonKernelMatrixCoords_class_()];
  }
  for (jint j = 0; j < 2; j++) {
    if (self->isPreview_) {
      (void) IOSObjectArray_Set(nil_chk(self->ev_), j, [((OrgGeogebraCommonKernelKernelNDGeoConicND *) nil_chk(((OrgGeogebraCommonKernelKernelNDGeoConicND *) check_class_cast(self->conicPart_, [OrgGeogebraCommonKernelKernelNDGeoConicND class])))) getEigenvec3DWithInt:j]);
    }
    else {
      (void) IOSObjectArray_Set(nil_chk(self->ev_), j, [self->view_ getCoordsForViewWithOrgGeogebraCommonKernelMatrixCoords:[((OrgGeogebraCommonKernelKernelNDGeoConicND *) nil_chk(((OrgGeogebraCommonKernelKernelNDGeoConicND *) check_class_cast(self->conicPart_, [OrgGeogebraCommonKernelKernelNDGeoConicND class])))) getEigenvec3DWithInt:j]]);
...
void OrgGeogebraCommonEuclidianDrawDrawConicPart_updateParallelLines(OrgGeogebraCommonEuclidianDrawDrawConicPart *self) {
  if (self->drawSegment_ == nil || ([((id<OrgGeogebraCommonKernelKernelNDGeoConicPartND>) nil_chk(self->conicPart_)) positiveOrientation] && self->draw_type_ != OrgGeogebraCommonEuclidianDrawDrawConicPart_DRAW_TYPE_SEGMENT) || (![self->conicPart_ positiveOrientation] && self->draw_type_ != OrgGeogebraCommonEuclidianDrawDrawConicPart_DRAW_TYPE_RAYS)) {
    ...
    self->drawSegment_ = new_OrgGeogebraCommonEuclidianDrawDrawSegment_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDGeoLineND_(self->view_, IOSObjectArray_Get(nil_chk(lines), 0));
    self->drawRay1_ = new_OrgGeogebraCommonEuclidianDrawDrawRay_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDGeoLineND_(self->view_, IOSObjectArray_Get(lines, 0));
    self->drawRay2_ = new_OrgGeogebraCommonEuclidianDrawDrawRay_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDGeoLineND_(self->view_, IOSObjectArray_Get(lines, 1));
...
void OrgGeogebraCommonEuclidianDrawDrawConicPart_initPreview(OrgGeogebraCommonEuclidianDrawDrawConicPart *self) {
  ...
  jint arcMode;
  {
    ...
    switch (self->previewMode_) {
      ...
      alg = new_OrgGeogebraCommonKernelAlgosAlgoSemicircle_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_(cons, IOSObjectArray_Get(self->previewTempPoints_, 0), IOSObjectArray_Get(self->previewTempPoints_, 1));
