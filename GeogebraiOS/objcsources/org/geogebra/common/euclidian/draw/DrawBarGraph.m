...
- (void)update {
  ...
  OrgGeogebraCommonEuclidianDrawDrawBarGraph_setAndConsume_gp_(self, [IOSObjectArray newArrayWithLength:[((OrgGeogebraCommonKernelAlgosAlgoBarChart *) nil_chk(algo_)) getIntervals] type:OrgGeogebraCommonEuclidianGeneralPathClipped_class_()]);
  for (jint i = 0; i < gp_->size_; i++) {
    IOSObjectArray_SetAndConsume(gp_, i, new_OrgGeogebraCommonEuclidianGeneralPathClipped_initWithOrgGeogebraCommonEuclidianEuclidianViewInterfaceSlim_(view_));
  ...
  OrgGeogebraCommonEuclidianDrawDrawBarGraph_set_drawType_(self, [algo_ getDrawType]);
...
void OrgGeogebraCommonEuclidianDrawDrawBarGraph_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoNumeric_(OrgGeogebraCommonEuclidianDrawDrawBarGraph *self, OrgGeogebraCommonEuclidianEuclidianView *view, OrgGeogebraCommonKernelGeosGeoNumeric *n) {
  ...
  OrgGeogebraCommonEuclidianDrawDrawBarGraph_set_drawType_(self, OrgGeogebraCommonEuclidianDrawDrawBarGraph_DrawTypeEnum_get_VERTICAL_BAR());
  self->pointType_ = OrgGeogebraCommonEuclidianDrawDrawBarGraph_POINT_NONE;
  OrgGeogebraCommonEuclidianDrawDrawBarGraph_setAndConsume_coords_(self, [IOSDoubleArray newArrayWithLength:2]);
  OrgGeogebraCommonEuclidianDrawable_set_view_(self, view);
  OrgGeogebraCommonEuclidianDrawDrawBarGraph_set_sum_(self, n);
...
void OrgGeogebraCommonEuclidianDrawDrawBarGraph_init__(OrgGeogebraCommonEuclidianDrawDrawBarGraph *self) {
  OrgGeogebraCommonEuclidianDrawDrawBarGraph_set_algo_(self, (OrgGeogebraCommonKernelAlgosAlgoBarChart *) check_class_cast([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(self->geo_)) getDrawAlgorithm], [OrgGeogebraCommonKernelAlgosAlgoBarChart class]));
  OrgGeogebraCommonEuclidianDrawDrawBarGraph_set_drawType_(self, [((OrgGeogebraCommonKernelAlgosAlgoBarChart *) nil_chk(self->algo_)) getDrawType]);
  if ([self->algo_ hasPoints]) {
    OrgGeogebraCommonEuclidianDrawDrawBarGraph_setAndConsume_pts_(self, new_JavaUtilArrayList_init());
    OrgGeogebraCommonEuclidianDrawDrawBarGraph_setAndConsume_drawPoints_(self, new_JavaUtilArrayList_init());
    OrgGeogebraCommonEuclidianDrawDrawBarGraph_updatePointLists(self);
  }
}
...
void OrgGeogebraCommonEuclidianDrawDrawBarGraph_addPt(OrgGeogebraCommonEuclidianDrawDrawBarGraph *self) {
  OrgGeogebraCommonKernelGeosGeoPoint *p = [new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_([((OrgGeogebraCommonKernelKernel *) nil_chk([((OrgGeogebraCommonEuclidianEuclidianView *) nil_chk(self->view_)) getKernel])) getConstruction]) autorelease];
  [p setLabelVisibleWithBoolean:NO];
  OrgGeogebraCommonEuclidianDrawDrawPoint *d = [new_OrgGeogebraCommonEuclidianDrawDrawPoint_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDGeoPointND_(self->view_, p) autorelease];
