...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/euclidian/draw/DrawRay.java
//
...
- (void)updateWithBoolean:(jboolean)showLabel {
  ...
  if (isVisible_) {
    ...
    if (tmpCoords2_ == nil) {
      tmpCoords2_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(2);
    }
...
- (void)updateWithOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)startPoint
  ...
  *IOSDoubleArray_GetRef(v_, 1) = [direction getY] * [view_ getYscale];
  ...
  if (labelVisible_) {
    labelDesc_ = [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(geo_)) getLabelDescription];
...
void OrgGeogebraCommonEuclidianDrawDrawRay_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDGeoLineND_(OrgGeogebraCommonEuclidianDrawDrawRay *self, OrgGeogebraCommonEuclidianEuclidianView *view, id<OrgGeogebraCommonKernelKernelNDGeoLineND> ray) {
  ...
  self->line_ = [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newLine2D];
  self->a_ = [IOSDoubleArray newArrayWithLength:2];
  self->v_ = [IOSDoubleArray newArrayWithLength:2];
  self->endPoint_ = [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newPoint2D];
  self->view_ = view;
  self->ray_ = ray;
  self->geo_ = (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(ray, [OrgGeogebraCommonKernelGeosGeoElement class]);
  OrgGeogebraCommonEuclidianDrawDrawRay_update(self);
}
