...
+ (void)initialize {
  if (self == [OrgGeogebraCommonEuclidianDrawDrawSlider class]) {
    JreStrongAssign(&OrgGeogebraCommonEuclidianDrawDrawSlider_borderStroke_, nil, OrgGeogebraCommonEuclidianEuclidianStatic_getDefaultStroke());
...
void OrgGeogebraCommonEuclidianDrawDrawSlider_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoNumeric_(OrgGeogebraCommonEuclidianDrawDrawSlider *self, OrgGeogebraCommonEuclidianEuclidianView *view, OrgGeogebraCommonKernelGeosGeoNumeric *number) {
  ...
  OrgGeogebraCommonEuclidianDrawDrawSlider_setAndConsume_coordsRW_(self, [IOSDoubleArray newArrayWithLength:2]);
  OrgGeogebraCommonEuclidianDrawDrawSlider_setAndConsume_coordsScreen_(self, [IOSDoubleArray newArrayWithLength:2]);
  OrgGeogebraCommonEuclidianDrawDrawSlider_set_circle_(self, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newEllipse2DDouble]);
  OrgGeogebraCommonEuclidianDrawDrawSlider_set_circleOuter_(self, [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newEllipse2DDouble]);
  OrgGeogebraCommonEuclidianDrawDrawSlider_set_circleHighlight_(self, [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newEllipse2DDouble]);
  OrgGeogebraCommonEuclidianDrawDrawSlider_setAndConsume_coords_(self, [IOSDoubleArray newArrayWithLength:2]);
  OrgGeogebraCommonEuclidianDrawDrawSlider_set_line_(self, [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newLine2D]);
  OrgGeogebraCommonEuclidianDrawable_set_view_(self, view);
  OrgGeogebraCommonEuclidianDrawDrawSlider_set_number_(self, number);
  OrgGeogebraCommonEuclidianDrawable_set_geo_(self, number);
  OrgGeogebraCommonEuclidianDrawDrawSlider_update(self);
}
