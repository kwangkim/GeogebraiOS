  ...
  if (isVisible_) {
    OrgGeogebraCommonKernelMatrixCoords *coords;
    {
      ...
      switch ([previewMode_ ordinal]) {
        ...
        g1 = new_OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelConstruction_([((OrgGeogebraCommonKernelKernel *) nil_chk([((OrgGeogebraCommonEuclidianEuclidianView *) nil_chk(view_)) getKernel])) getConstruction]);
        h = new_OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelConstruction_([((OrgGeogebraCommonKernelKernel *) nil_chk([view_ getKernel])) getConstruction]);
        ...
        coords = [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk([previewPoint2_ getCoordsInD2])) crossProductWithOrgGeogebraCommonKernelMatrixCoords:new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_(xRW, yRW, 1)];
...
- (id<OrgGeogebraCommonAwtGArea>)getShapeWithBoolean:(jboolean)forConic {
  OrgGeogebraCommonEuclidianGeneralPathClipped *gpc = new_OrgGeogebraCommonEuclidianGeneralPathClipped_initWithOrgGeogebraCommonEuclidianEuclidianViewInterfaceSlim_(view_);
...
void OrgGeogebraCommonEuclidianDrawDrawLine_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDGeoLineND_(OrgGeogebraCommonEuclidianDrawDrawLine *self, OrgGeogebraCommonEuclidianEuclidianView *view, id<OrgGeogebraCommonKernelKernelNDGeoLineND> g) {
  ...
  self->attr1_ = [IOSBooleanArray newArrayWithLength:4];
  self->attr2_ = [IOSBooleanArray newArrayWithLength:4];
  self->previewMode_ = OrgGeogebraCommonEuclidianDrawDrawLine_PreviewTypeEnum_get_NONE();
  ...
  self->view_ = view;
  self->g_ = g;
  self->geo_ = (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(g, [OrgGeogebraCommonKernelGeosGeoElement class]);
  [self update];
}
...
void OrgGeogebraCommonEuclidianDrawDrawLine_initWithOrgGeogebraCommonEuclidianEuclidianView_withJavaUtilArrayList_withOrgGeogebraCommonEuclidianDrawDrawLine_PreviewTypeEnum_(OrgGeogebraCommonEuclidianDrawDrawLine *self, OrgGeogebraCommonEuclidianEuclidianView *view, JavaUtilArrayList *points, OrgGeogebraCommonEuclidianDrawDrawLine_PreviewTypeEnum *previewMode) {
  ...
  self->g_ = new_OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelConstruction_([((OrgGeogebraCommonKernelKernel *) nil_chk([((OrgGeogebraCommonEuclidianEuclidianView *) nil_chk(view)) getKernel])) getConstruction]);
  self->geo_ = [((OrgGeogebraCommonKernelConstructionDefaults *) nil_chk([((OrgGeogebraCommonKernelConstruction *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk([view getKernel])) getConstruction])) getConstructionDefaults])) getDefaultGeoWithInt:OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_LINE];
  OrgGeogebraCommonEuclidianDrawDrawLine_updatePreview(self);
}
...
void OrgGeogebraCommonEuclidianDrawDrawLine_initWithOrgGeogebraCommonEuclidianEuclidianView_withJavaUtilArrayList_withJavaUtilArrayList_withBoolean_(OrgGeogebraCommonEuclidianDrawDrawLine *self, OrgGeogebraCommonEuclidianEuclidianView *view, JavaUtilArrayList *points, JavaUtilArrayList *lines, jboolean parallel) {
  ...
  self->previewMode_ = OrgGeogebraCommonEuclidianDrawDrawLine_PreviewTypeEnum_get_NONE();
  self->endPoint_ = [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newPoint2D];
  if (parallel) self->previewMode_ = OrgGeogebraCommonEuclidianDrawDrawLine_PreviewTypeEnum_get_PARALLEL();
  else self->previewMode_ = OrgGeogebraCommonEuclidianDrawDrawLine_PreviewTypeEnum_get_PERPENDICULAR();
  self->view_ = view;
  self->points_ = points;
  self->lines_ = lines;
  self->g_ = new_OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelConstruction_([((OrgGeogebraCommonKernelKernel *) nil_chk([((OrgGeogebraCommonEuclidianEuclidianView *) nil_chk(view)) getKernel])) getConstruction]);
...
void OrgGeogebraCommonEuclidianDrawDrawLine_updatePreview(OrgGeogebraCommonEuclidianDrawDrawLine *self) {
  switch ([self->previewMode_ ordinal]) {
    ...
    if (self->isVisible_) {
      self->startPoint_ = [self->points_ getWithInt:0];
    }
    break;
    case OrgGeogebraCommonEuclidianDrawDrawLine_PreviewType_PARALLEL:
    case OrgGeogebraCommonEuclidianDrawDrawLine_PreviewType_PERPENDICULAR:
    ...
    if (self->isVisible_) {
      self->startPoint_ = [self->points_ getWithInt:0];
      self->previewPoint2_ = [self->points_ getWithInt:1];
    }
    break;
  }
}
