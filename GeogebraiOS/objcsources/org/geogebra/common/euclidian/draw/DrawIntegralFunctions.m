...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/euclidian/draw/DrawIntegralFunctions.java
//
...
void OrgGeogebraCommonEuclidianDrawDrawIntegralFunctions_init__(OrgGeogebraCommonEuclidianDrawDrawIntegralFunctions *self) {
  ...
  self->f_ = [((OrgGeogebraCommonKernelCasAlgoIntegralFunctions *) nil_chk(algo)) getF];
  self->g_ = [algo getG];
  self->a_ = [algo getA];
  self->b_ = [algo getB];
}
...
void OrgGeogebraCommonEuclidianDrawDrawIntegralFunctions_initFromCasObject(OrgGeogebraCommonEuclidianDrawDrawIntegralFunctions *self) {
  ...
  self->f_ = new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticFunction_([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel)) getConstruction], new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([cmd getArgumentWithInt:0])) wrap])) replaceCasCommands]));
  self->g_ = new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticFunction_([kernel getConstruction], new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([cmd getArgumentWithInt:1])) wrap])) replaceCasCommands]));
  self->a_ = new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_([cmd getKernel], [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([cmd getArgumentWithInt:2])) wrap])) replaceCasCommands])) evaluateDouble]);
  self->b_ = new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_([cmd getKernel], [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([cmd getArgumentWithInt:3])) wrap])) replaceCasCommands])) evaluateDouble]);
}
...
void OrgGeogebraCommonEuclidianDrawDrawIntegralFunctions_update(OrgGeogebraCommonEuclidianDrawDrawIntegralFunctions *self) {
  ...
  if (self->gp_ == nil) {
    self->gp_ = new_OrgGeogebraCommonEuclidianPlotGeneralPathClippedForCurvePlotter_initWithOrgGeogebraCommonEuclidianEuclidianViewInterfaceSlim_(self->view_);
  }
