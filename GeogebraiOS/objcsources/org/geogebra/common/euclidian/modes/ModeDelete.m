...
void OrgGeogebraCommonEuclidianModesModeDelete_initWithOrgGeogebraCommonEuclidianEuclidianView_(OrgGeogebraCommonEuclidianModesModeDelete *self, OrgGeogebraCommonEuclidianEuclidianView *view) {
  ...
  self->objDeleteMode_ = NO;
  self->penDeleteMode_ = NO;
  OrgGeogebraCommonEuclidianModesModeDelete_set_rect_(self, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newRectangleWithInt:0 withInt:0 withInt:100 withInt:100]);
  OrgGeogebraCommonEuclidianModesModeDelete_set_ec_(self, [((OrgGeogebraCommonEuclidianEuclidianView *) nil_chk(view)) getEuclidianController]);
  OrgGeogebraCommonEuclidianModesModeDelete_set_kernel_(self, [view getKernel]);
  OrgGeogebraCommonEuclidianModesModeDelete_set_view_(self, view);
}
