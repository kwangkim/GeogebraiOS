...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/euclidian/EuclidianView.java
//
...
- (OrgGeogebraCommonEuclidianEuclidianViewCompanion *)newEuclidianViewCompanion {
  return [new_OrgGeogebraCommonEuclidianEuclidianViewCompanion_initWithOrgGeogebraCommonEuclidianEuclidianView_(self) autorelease];
}
...
- (void)initAxesValues {
  OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_axesNumberFormat_(self, [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonUtilNumberFormatAdapter_class_()]);
  OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_showAxesNumbers_(self, [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ YES, YES } count:2]);
  OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_axesLabels_(self, [IOSObjectArray newArrayWithObjects:(id[]){ nil, nil } count:2 type:NSString_class_()]);
  OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_axesLabelsStyle_(self, [IOSIntArray newArrayWithInts:(jint[]){ OrgGeogebraCommonAwtGFont_PLAIN, OrgGeogebraCommonAwtGFont_PLAIN } count:2]);
  OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_axesUnitLabels_(self, [IOSObjectArray newArrayWithObjects:(id[]){ nil, nil } count:2 type:NSString_class_()]);
  OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_axesTickStyles_(self, [IOSIntArray newArrayWithInts:(jint[]){ OrgGeogebraCommonPluginEuclidianStyleConstants_AXES_TICK_STYLE_MAJOR, OrgGeogebraCommonPluginEuclidianStyleConstants_AXES_TICK_STYLE_MAJOR } count:2]);
  OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_automaticAxesNumberingDistances_(self, [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ YES, YES } count:2]);
  OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_axesNumberingDistances_(self, [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 2, 2 } count:2]);
  OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_drawBorderAxes_(self, [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ NO, NO } count:2]);
  OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_axisCross_(self, [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 0, 0 } count:2]);
  OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_positiveAxes_(self, [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ NO, NO } count:2]);
  OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_piAxisUnit_(self, [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ NO, NO } count:2]);
  ...
  OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_AxesTickInterval_(self, [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 1, 1 } count:2]);
}

- (void)setAxesColorWithOrgGeogebraCommonAwtGColor:(OrgGeogebraCommonAwtGColor *)axesColor {
  if (axesColor != nil) {
    OrgGeogebraCommonEuclidianEuclidianView_set_axesColor_(self, axesColor);
  }
}
...
- (void)setLockedAxesRatioWithJavaLangDouble:(JavaLangDouble *)flag {
  OrgGeogebraCommonEuclidianEuclidianView_set_lockedAxesRatio_(self, flag);
  if (flag != nil) {
...
- (void)setXminObjectWithOrgGeogebraCommonKernelArithmeticNumberValue:(id<OrgGeogebraCommonKernelArithmeticNumberValue>)xminObjectNew {
  ...
  if (xminObjectNew == nil) {
    OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_xminObject_(self, new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) getConstruction]));
    [self updateBoundObjects];
  }
  else {
    OrgGeogebraCommonEuclidianEuclidianView_set_xminObject_(self, xminObjectNew);
  }
...
- (void)setXmaxObjectWithOrgGeogebraCommonKernelArithmeticNumberValue:(id<OrgGeogebraCommonKernelArithmeticNumberValue>)xmaxObjectNew {
  ...
  if (xmaxObjectNew == nil) {
    OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_xmaxObject_(self, new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) getConstruction]));
    [self updateBoundObjects];
  }
  else {
    OrgGeogebraCommonEuclidianEuclidianView_set_xmaxObject_(self, xmaxObjectNew);
  }
  OrgGeogebraCommonEuclidianEuclidianView_setSizeListeners(self);
}
...
- (void)setYminObjectWithOrgGeogebraCommonKernelArithmeticNumberValue:(id<OrgGeogebraCommonKernelArithmeticNumberValue>)yminObjectNew {
  ...
  if (yminObjectNew == nil) {
    OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_yminObject_(self, new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) getConstruction]));
    [self updateBoundObjects];
  }
  else {
    OrgGeogebraCommonEuclidianEuclidianView_set_yminObject_(self, yminObjectNew);
  }
  OrgGeogebraCommonEuclidianEuclidianView_setSizeListeners(self);
}
...
- (void)setYmaxObjectWithOrgGeogebraCommonKernelArithmeticNumberValue:(id<OrgGeogebraCommonKernelArithmeticNumberValue>)ymaxObjectNew {
  ...
  if (ymaxObjectNew == nil) {
    OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_ymaxObject_(self, new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) getConstruction]));
    [self updateBoundObjects];
  }
  else {
    OrgGeogebraCommonEuclidianEuclidianView_set_ymaxObject_(self, ymaxObjectNew);
  }
  OrgGeogebraCommonEuclidianEuclidianView_setSizeListeners(self);
}
...
- (NSString *)getXYscaleRatioString {
  ...
  if ([self getXscale] >= [self getYscale]) {
    ...
    [ratioSb appendWithNSString:[((id<OrgGeogebraCommonUtilNumberFormatAdapter>) nil_chk(printScaleNF_)) formatWithDouble:[self getXscale] / [self getYscale]]];
  }
  else {
    [ratioSb appendWithNSString:[((id<OrgGeogebraCommonUtilNumberFormatAdapter>) nil_chk(printScaleNF_)) formatWithDouble:[self getYscale] / [self getXscale]]];
    [ratioSb appendWithNSString:@" : 1"];
  }
...
- (void)setAxesIntervalsWithDouble:(jdouble)scale_
  ...
  *IOSDoubleArray_GetRef(nil_chk(AxesTickInterval_), axis) = IOSDoubleArray_Get(nil_chk(axesNumberingDistances_), axis) / 2.0;
  if ((IOSDoubleArray_Get(axesNumberingDistances_, axis) < 10E-6) || (IOSDoubleArray_Get(axesNumberingDistances_, axis) > 10E6)) {
    ...
    IOSObjectArray_Set(nil_chk(axesNumberFormat_), axis, [((OrgGeogebraCommonFactoriesFormatFactory *) nil_chk(OrgGeogebraCommonFactoriesFormatFactory_get_prototype_())) getNumberFormatWithNSString:@"0.##E0" withInt:maxFractionDigtis]);
  }
  else {
    IOSObjectArray_Set(nil_chk(axesNumberFormat_), axis, [((OrgGeogebraCommonFactoriesFormatFactory *) nil_chk(OrgGeogebraCommonFactoriesFormatFactory_get_prototype_())) getNumberFormatWithNSString:@"###0.##" withInt:maxFractionDigtis]);
  }
...
- (void)setHitsWithOrgGeogebraCommonAwtGPoint:(OrgGeogebraCommonAwtGPoint *)p
  ...
  if (hitPointOrBoundary_ == nil) {
    OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_hitPointOrBoundary_(self, new_JavaUtilArrayList_init());
    OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_hitFilling_(self, new_JavaUtilArrayList_init());
    OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_hitLabel_(self, new_JavaUtilArrayList_init());
  }
  else {
...
- (void)replaceBoundObjectWithOrgGeogebraCommonKernelGeosGeoNumeric:(OrgGeogebraCommonKernelGeosGeoNumeric *)num
  ...
  if (xmaxObject_ == num) {
    OrgGeogebraCommonEuclidianEuclidianView_set_xmaxObject_(self, num2);
  }
  if (xminObject_ == num) {
    OrgGeogebraCommonEuclidianEuclidianView_set_xminObject_(self, num2);
  }
  if (ymaxObject_ == num) {
    OrgGeogebraCommonEuclidianEuclidianView_set_ymaxObject_(self, num2);
  }
  if (yminObject_ == num) {
    OrgGeogebraCommonEuclidianEuclidianView_set_yminObject_(self, num2);
  }
  [self updateBoundsWithBoolean:YES withBoolean:YES];
}
...
- (void)setGridDistancesWithDoubleArray:(IOSDoubleArray *)dist {
  ...
  OrgGeogebraCommonEuclidianEuclidianView_set_gridDistances_(self, dist);
...
- (id<OrgGeogebraCommonAwtGAffineTransform>)getCoordTransform {
  if (coordTransform_ == nil) OrgGeogebraCommonEuclidianEuclidianView_set_coordTransform_(self, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newAffineTransform]);
...
- (void)setCoordTransformWithOrgGeogebraCommonAwtGAffineTransform:(id<OrgGeogebraCommonAwtGAffineTransform>)coordTransform {
  OrgGeogebraCommonEuclidianEuclidianView_set_coordTransform_(self, coordTransform);
}
...
- (void)setSelectionRectangleWithOrgGeogebraCommonAwtGRectangle:(id<OrgGeogebraCommonAwtGRectangle>)selectionRectangle {
  OrgGeogebraCommonEuclidianEuclidianView_set_selectionRectangle_(self, selectionRectangle);
}
...
- (void)setAxesCrossWithDoubleArray:(IOSDoubleArray *)axisCross {
  OrgGeogebraCommonEuclidianEuclidianView_set_axisCross_(self, axisCross);
}
...
- (void)setPositiveAxesWithBooleanArray:(IOSBooleanArray *)positiveAxis {
  OrgGeogebraCommonEuclidianEuclidianView_set_positiveAxes_(self, positiveAxis);
}
...
- (void)setDrawBorderAxesWithBooleanArray:(IOSBooleanArray *)drawBorderAxes {
  OrgGeogebraCommonEuclidianEuclidianView_set_drawBorderAxes_(self, drawBorderAxes);
  ...
  if (addBoldItalicTags) {
    for (jint axis = 0; axis < axesLabels_->size_; axis++) {
      if (IOSObjectArray_Get(axesLabels_, axis) != nil && self->settings_ != nil) {
        IOSObjectArray_Set(ret, axis, [self->settings_ axisLabelForXMLWithInt:axis]);
      }
    }
  }
  return ret;
...
- (void)setShowAxesNumbersWithBooleanArray:(IOSBooleanArray *)showAxesNumbers {
  OrgGeogebraCommonEuclidianEuclidianView_set_showAxesNumbers_(self, showAxesNumbers);
}
...
- (void)setAxesUnitLabelsWithNSStringArray:(IOSObjectArray *)axesUnitLabels {
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(self->axesUnitLabels_))->size_; i++) {
    IOSObjectArray_Set(self->axesUnitLabels_, i, IOSObjectArray_Get(nil_chk(axesUnitLabels), i));
  }
...
- (void)setAxesTickStylesWithIntArray:(IOSIntArray *)axesTickStyles {
  OrgGeogebraCommonEuclidianEuclidianView_set_axesTickStyles_(self, axesTickStyles);
}
...
- (id<OrgGeogebraCommonEuclidianPreviewable>)createPreviewLineWithJavaUtilArrayList:(JavaUtilArrayList *)selectedPoints {
  return [new_OrgGeogebraCommonEuclidianDrawDrawLine_initWithOrgGeogebraCommonEuclidianEuclidianView_withJavaUtilArrayList_withOrgGeogebraCommonEuclidianDrawDrawLine_PreviewTypeEnum_(self, selectedPoints, OrgGeogebraCommonEuclidianDrawDrawLine_PreviewTypeEnum_get_LINE()) autorelease];
}
...
- (id<OrgGeogebraCommonEuclidianPreviewable>)createPreviewPerpendicularBisectorWithJavaUtilArrayList:(JavaUtilArrayList *)selectedPoints {
  return [new_OrgGeogebraCommonEuclidianDrawDrawLine_initWithOrgGeogebraCommonEuclidianEuclidianView_withJavaUtilArrayList_withOrgGeogebraCommonEuclidianDrawDrawLine_PreviewTypeEnum_(self, selectedPoints, OrgGeogebraCommonEuclidianDrawDrawLine_PreviewTypeEnum_get_PERPENDICULAR_BISECTOR()) autorelease];
}
...
- (id<OrgGeogebraCommonEuclidianPreviewable>)createPreviewAngleBisectorWithJavaUtilArrayList:(JavaUtilArrayList *)selectedPoints {
  return [new_OrgGeogebraCommonEuclidianDrawDrawLine_initWithOrgGeogebraCommonEuclidianEuclidianView_withJavaUtilArrayList_withOrgGeogebraCommonEuclidianDrawDrawLine_PreviewTypeEnum_(self, selectedPoints, OrgGeogebraCommonEuclidianDrawDrawLine_PreviewTypeEnum_get_ANGLE_BISECTOR()) autorelease];
}

- (id<OrgGeogebraCommonEuclidianPreviewable>)createPreviewSegmentWithJavaUtilArrayList:(JavaUtilArrayList *)selectedPoints {
  return [new_OrgGeogebraCommonEuclidianDrawDrawSegment_initWithOrgGeogebraCommonEuclidianEuclidianView_withJavaUtilArrayList_(self, selectedPoints) autorelease];
}

- (id<OrgGeogebraCommonEuclidianPreviewable>)createPreviewRayWithJavaUtilArrayList:(JavaUtilArrayList *)selectedPoints {
  return [new_OrgGeogebraCommonEuclidianDrawDrawRay_initWithOrgGeogebraCommonEuclidianEuclidianView_withJavaUtilArrayList_(self, selectedPoints) autorelease];
}

- (id<OrgGeogebraCommonEuclidianPreviewable>)createPreviewVectorWithJavaUtilArrayList:(JavaUtilArrayList *)selectedPoints {
  return [new_OrgGeogebraCommonEuclidianDrawDrawVector_initWithOrgGeogebraCommonEuclidianEuclidianView_withJavaUtilArrayList_(self, selectedPoints) autorelease];
}
...
- (id<OrgGeogebraCommonEuclidianPreviewable>)createPreviewConicWithInt:(jint)mode1
  ...
  return [new_OrgGeogebraCommonEuclidianDrawDrawConic_initWithOrgGeogebraCommonEuclidianEuclidianView_withInt_withJavaUtilArrayList_(self, mode1, selectedPoints) autorelease];
}
...
- (id<OrgGeogebraCommonEuclidianPreviewable>)createPreviewParabolaWithJavaUtilArrayList:(JavaUtilArrayList *)selectedPoints
  ...
  return [new_OrgGeogebraCommonEuclidianDrawDrawConic_initWithOrgGeogebraCommonEuclidianEuclidianView_withJavaUtilArrayList_withJavaUtilArrayList_(self, selectedPoints, selectedLines) autorelease];
}

- (id<OrgGeogebraCommonEuclidianPreviewable>)createPreviewPolygonWithJavaUtilArrayList:(JavaUtilArrayList *)selectedPoints {
  return [new_OrgGeogebraCommonEuclidianDrawDrawPolygon_initWithOrgGeogebraCommonEuclidianEuclidianView_withJavaUtilArrayList_(self, selectedPoints) autorelease];
}

- (id<OrgGeogebraCommonEuclidianPreviewable>)createPreviewAngleWithJavaUtilArrayList:(JavaUtilArrayList *)selectedPoints {
  return [new_OrgGeogebraCommonEuclidianDrawDrawAngle_initWithOrgGeogebraCommonEuclidianEuclidianView_withJavaUtilArrayList_(self, selectedPoints) autorelease];
}

- (id<OrgGeogebraCommonEuclidianPreviewable>)createPreviewPolyLineWithJavaUtilArrayList:(JavaUtilArrayList *)selectedPoints {
  return [new_OrgGeogebraCommonEuclidianDrawDrawPolyLine_initWithOrgGeogebraCommonEuclidianEuclidianView_withJavaUtilArrayList_(self, selectedPoints) autorelease];
}
...
- (id<OrgGeogebraCommonEuclidianPreviewable>)createPreviewParallelLineWithJavaUtilArrayList:(JavaUtilArrayList *)selectedPoints
                                                                      withJavaUtilArrayList:(JavaUtilArrayList *)selectedLines {
  return [new_OrgGeogebraCommonEuclidianDrawDrawLine_initWithOrgGeogebraCommonEuclidianEuclidianView_withJavaUtilArrayList_withJavaUtilArrayList_withBoolean_(self, selectedPoints, selectedLines, YES) autorelease];
}
...
- (id<OrgGeogebraCommonEuclidianPreviewable>)createPreviewPerpendicularLineWithJavaUtilArrayList:(JavaUtilArrayList *)selectedPoints
                                                                           withJavaUtilArrayList:(JavaUtilArrayList *)selectedLines {
  return [new_OrgGeogebraCommonEuclidianDrawDrawLine_initWithOrgGeogebraCommonEuclidianEuclidianView_withJavaUtilArrayList_withJavaUtilArrayList_withBoolean_(self, selectedPoints, selectedLines, NO) autorelease];
}

- (void)setApplicationWithOrgGeogebraCommonMainApp:(OrgGeogebraCommonMainApp *)application {
  OrgGeogebraCommonEuclidianEuclidianView_set_app_(self, application);
}
...
- (void)setReInitingWithBoolean:(jboolean)reiniting {
  ...
  if (reiniting) {
    firstPaint_ = YES;
    OrgGeogebraCommonEuclidianEuclidianView_set_bgImage_(self, nil);
    OrgGeogebraCommonEuclidianEuclidianView_set_bgGraphics_(self, nil);
  }
}
...
- (void)drawMouseCoordsWithOrgGeogebraCommonAwtGGraphics2D:(id<OrgGeogebraCommonAwtGGraphics2D>)g2 {
  ...
  [sb appendWithChar:'('];
  [sb appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) formatWithDouble:OrgGeogebraCommonKernelKernel_checkDecimalFractionWithDouble_(euclidianController_->xRW_) withOrgGeogebraCommonKernelStringTemplate:tpl]];
  ...
  [sb appendWithNSString:[kernel_ formatWithDouble:OrgGeogebraCommonKernelKernel_checkDecimalFractionWithDouble_(euclidianController_->yRW_) withOrgGeogebraCommonKernelStringTemplate:tpl]];
  [sb appendWithChar:')'];
  [((id<OrgGeogebraCommonAwtGGraphics2D>) nil_chk(g2)) setColorWithOrgGeogebraCommonAwtGColor:OrgGeogebraCommonAwtGColor_get_DARK_GRAY_()];
...
- (void)drawAxesWithOrgGeogebraCommonAwtGGraphics2D:(id<OrgGeogebraCommonAwtGGraphics2D>)g2 {
  ...
  if (filled && gp_ == nil) {
    OrgGeogebraCommonEuclidianEuclidianView_set_gp_(self, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newGeneralPath]);
  }
  ...
  if (bold) {
    OrgGeogebraCommonEuclidianEuclidianView_set_axesStroke_(self, OrgGeogebraCommonEuclidianEuclidianView_boldAxesStroke_);
    OrgGeogebraCommonEuclidianEuclidianView_set_tickStroke_(self, OrgGeogebraCommonEuclidianEuclidianView_boldAxesStroke_);
    ySmall2++;
    xSmall2--;
    arrowSize += 1;
  }
  else {
    OrgGeogebraCommonEuclidianEuclidianView_set_axesStroke_(self, OrgGeogebraCommonEuclidianEuclidianView_defAxesStroke_);
    OrgGeogebraCommonEuclidianEuclidianView_set_tickStroke_(self, OrgGeogebraCommonEuclidianEuclidianView_defAxesStroke_);
  }
      ...
      if (pix >= xAxisStart && pix <= maxX) {
        if (IOSBooleanArray_Get(nil_chk(showAxesNumbers_), 0)) {
          ...
          if ((labelno % unitsPerLabelX) == 0) {
            ...
            [((JavaUtilArrayList *) nil_chk(axesLabelsPositionsX_)) addWithId:[new_JavaLangInteger_initWithInt_(J2ObjCFpToInt((pix + OrgGeogebraCommonKernelKernel_MIN_PRECISION))) autorelease]];
          }
        }
      ...
      if (pix >= maxY && pix <= yAxisEnd) {
        if (IOSBooleanArray_Get(nil_chk(showAxesNumbers_), 1)) {
          ...
          if ((labelno % unitsPerLabelY) == 0) {
            ...
            [((JavaUtilArrayList *) nil_chk(axesLabelsPositionsY_)) addWithId:[new_JavaLangInteger_initWithInt_(J2ObjCFpToInt((pix + OrgGeogebraCommonKernelKernel_MIN_PRECISION))) autorelease]];
          }
        }
  ...
  if (showAxesCornerCoords_) {
    if (IOSBooleanArray_Get(nil_chk(showAxes_), 0) && IOSBooleanArray_Get(showAxes_, 1) && (!OrgGeogebraCommonEuclidianEuclidianView_xAxisOnscreen(self) || !OrgGeogebraCommonEuclidianEuclidianView_yAxisOnscreen(self))) {
      ...
      [sb setLengthWithInt:0];
      [sb appendWithChar:'('];
      [sb appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) formatPiEWithDouble:[self getXmin] withOrgGeogebraCommonUtilNumberFormatAdapter:IOSObjectArray_Get(nil_chk(axesNumberFormat_), 0) withOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]];
      [sb appendWithChar:((OrgGeogebraCommonMainLocalization *) nil_chk([((OrgGeogebraCommonMainApp *) nil_chk(app_)) getLocalization]))->unicodeComma_];
      [sb appendWithNSString:@" "];
      [sb appendWithNSString:[kernel_ formatPiEWithDouble:[self getYmax] withOrgGeogebraCommonUtilNumberFormatAdapter:IOSObjectArray_Get(axesNumberFormat_, 1) withOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]];
      [sb appendWithChar:')'];
      ...
      [sb setLengthWithInt:0];
      [sb appendWithChar:'('];
      [sb appendWithNSString:[kernel_ formatPiEWithDouble:[self getXmax] withOrgGeogebraCommonUtilNumberFormatAdapter:IOSObjectArray_Get(axesNumberFormat_, 0) withOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]];
      [sb appendWithChar:((OrgGeogebraCommonMainLocalization *) nil_chk([app_ getLocalization]))->unicodeComma_];
      [sb appendWithNSString:@" "];
      [sb appendWithNSString:[kernel_ formatPiEWithDouble:[self getYmin] withOrgGeogebraCommonUtilNumberFormatAdapter:IOSObjectArray_Get(axesNumberFormat_, 1) withOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]];
      [sb appendWithChar:')'];
...
- (void)setGridColorWithOrgGeogebraCommonAwtGColor:(OrgGeogebraCommonAwtGColor *)gridColor {
  if (gridColor != nil) {
    OrgGeogebraCommonEuclidianEuclidianView_set_gridColor_(self, gridColor);
  }
}

- (void)setGridLineStyleWithInt:(jint)gridLineStyle {
  self->gridLineStyle_ = gridLineStyle;
  OrgGeogebraCommonEuclidianEuclidianView_set_gridStroke_(self, OrgGeogebraCommonEuclidianEuclidianStatic_getStrokeWithFloat_withInt_(gridIsBold_ ? 2.0f : 1.0f, gridLineStyle));
}
...
- (OrgGeogebraCommonEuclidianGeneralPathClipped *)getBoundingPath {
  OrgGeogebraCommonEuclidianGeneralPathClipped *gs = [new_OrgGeogebraCommonEuclidianGeneralPathClipped_initWithOrgGeogebraCommonEuclidianEuclidianViewInterfaceSlim_(self) autorelease];
...
- (void)setPreviewWithOrgGeogebraCommonEuclidianPreviewable:(id<OrgGeogebraCommonEuclidianPreviewable>)p {
  ...
  OrgGeogebraCommonEuclidianEuclidianView_set_previewDrawable_(self, p);
}
...
- (OrgGeogebraCommonAwtGPoint *)getMaximumLabelSizeWithOrgGeogebraCommonAwtGGraphics2D:(id<OrgGeogebraCommonAwtGGraphics2D>)g2 {
  OrgGeogebraCommonAwtGPoint *max = [new_OrgGeogebraCommonAwtGPoint_initWithInt_withInt_(0, 0) autorelease];
...
- (void)startXMLWithJavaLangStringBuilder:(JavaLangStringBuilder *)sbxml
  ...
  [sbxml appendWithInt:[self getPointCapturingMode] > OrgGeogebraCommonPluginEuclidianStyleConstants_POINT_CAPTURING_XML_MAX ? OrgGeogebraCommonPluginEuclidianStyleConstants_POINT_CAPTURING_DEFAULT : [self getPointCapturingMode]];
  [sbxml appendWithNSString:@"\" rightAngleStyle=\""];
  [sbxml appendWithInt:((OrgGeogebraCommonMainApp *) nil_chk([self getApplication]))->rightAngleStyle_];
  if (asPreference) {
    ...
    [sbxml appendWithInt:OrgGeogebraCommonEuclidianEuclidianView_getAllowToolTips(self)];
    [sbxml appendWithNSString:@"\" deleteToolSize=\""];
    [sbxml appendWithInt:[((OrgGeogebraCommonEuclidianEuclidianController *) nil_chk([self getEuclidianController])) getDeleteToolSize]];
  }
  [sbxml appendWithNSString:@"\" checkboxSize=\""];
  [sbxml appendWithInt:[((OrgGeogebraCommonMainApp *) nil_chk(app_)) getCheckboxSize]];
  [sbxml appendWithNSString:@"\" gridType=\""];
  [sbxml appendWithInt:OrgGeogebraCommonEuclidianEuclidianView_getGridType(self)];
  ...
  [sbxml appendWithInt:[((OrgGeogebraCommonAwtGColor *) nil_chk([self getBackgroundCommon])) getRed]];
  [sbxml appendWithNSString:@"\" g=\""];
  [sbxml appendWithInt:[((OrgGeogebraCommonAwtGColor *) nil_chk([self getBackgroundCommon])) getGreen]];
  [sbxml appendWithNSString:@"\" b=\""];
  [sbxml appendWithInt:[((OrgGeogebraCommonAwtGColor *) nil_chk([self getBackgroundCommon])) getBlue]];
  [sbxml appendWithNSString:@"\"/>\n"];
  [sbxml appendWithNSString:@"\t<axesColor r=\""];
  [sbxml appendWithInt:[((OrgGeogebraCommonAwtGColor *) nil_chk(axesColor_)) getRed]];
  [sbxml appendWithNSString:@"\" g=\""];
  ...
  [sbxml appendWithInt:[((OrgGeogebraCommonAwtGColor *) nil_chk(gridColor_)) getRed]];
  [sbxml appendWithNSString:@"\" g=\""];
...
- (void)drawPointsWithOrgGeogebraCommonKernelGeosGeoImage:(OrgGeogebraCommonKernelGeosGeoImage *)ge
  ...
  for (jint i = 0; i < ((IOSDoubleArray *) nil_chk(x))->size_; i++) {
    ...
    [ptList addWithId:[new_OrgGeogebraCommonAwtGPoint_initWithInt_withInt_(xi, yi) autorelease]];
  }
...
- (void)zoomWithDouble:(jdouble)px
  ...
  if (zoomer_ == nil) {
    OrgGeogebraCommonEuclidianEuclidianView_set_zoomer_(self, [self newZoomer]);
  }
...
- (void)zoomAxesRatioWithDouble:(jdouble)newRatio
  ...
  if (axesRatioZoomer_ == nil) {
    OrgGeogebraCommonEuclidianEuclidianView_set_axesRatioZoomer_(self, [self newZoomer]);
  }
...
- (void)setAnimatedCoordSystemWithDouble:(jdouble)originX
  ...
  if (!OrgGeogebraCommonKernelKernel_isEqualWithDouble_withDouble_([self getXscale], newScale)) {
    ...
    if (mover_ == nil) {
      OrgGeogebraCommonEuclidianEuclidianView_set_mover_(self, [self newZoomer]);
    }
...
- (void)setOptionPanelWithOrgGeogebraCommonGuiDialogOptionsOptionsEuclidian:(OrgGeogebraCommonGuiDialogOptionsOptionsEuclidian *)optionPanel {
  OrgGeogebraCommonEuclidianEuclidianView_set_optionPanel_(self, optionPanel);
}
...
- (void)setDeletionRectangleWithOrgGeogebraCommonAwtGRectangle:(id<OrgGeogebraCommonAwtGRectangle>)deletionRectangle {
  OrgGeogebraCommonEuclidianEuclidianView_set_deletionRectangle_(self, deletionRectangle);
}
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonEuclidianEuclidianView class]) {
    JreStrongAssign(&OrgGeogebraCommonEuclidianEuclidianView_colZoomRectangle_, nil, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newColorWithInt:200 withInt:200 withInt:230]);
    JreStrongAssign(&OrgGeogebraCommonEuclidianEuclidianView_colZoomRectangleFill_, nil, [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newColorWithInt:200 withInt:200 withInt:230 withInt:50]);
    JreStrongAssign(&OrgGeogebraCommonEuclidianEuclidianView_colDeletionSquare_, nil, [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newColorWithInt:128 withInt:0 withInt:0]);
    JreStrongAssign(&OrgGeogebraCommonEuclidianEuclidianView_strokeDeletionSquare_, nil, [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newBasicStrokeWithFloat:1.0f]);
    JreStrongAssign(&OrgGeogebraCommonEuclidianEuclidianView_defAxesStroke_, nil, [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newBasicStrokeWithFloat:1.0f withInt:OrgGeogebraCommonAwtGBasicStroke_CAP_BUTT withInt:OrgGeogebraCommonAwtGBasicStroke_JOIN_MITER]);
    JreStrongAssign(&OrgGeogebraCommonEuclidianEuclidianView_boldAxesStroke_, nil, [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newBasicStrokeWithFloat:2.0f withInt:OrgGeogebraCommonAwtGBasicStroke_CAP_BUTT withInt:OrgGeogebraCommonAwtGBasicStroke_JOIN_MITER]);
...
IOSObjectArray *OrgGeogebraCommonEuclidianEuclidianView_getPointStyles() {
  OrgGeogebraCommonEuclidianEuclidianView_initialize();
  IOSObjectArray *ret = [IOSObjectArray arrayWithObjects:(id[]){ [new_JavaLangInteger_initWithInt_(OrgGeogebraCommonPluginEuclidianStyleConstants_POINT_STYLE_DOT) autorelease], [new_JavaLangInteger_initWithInt_(OrgGeogebraCommonPluginEuclidianStyleConstants_POINT_STYLE_CROSS) autorelease], [new_JavaLangInteger_initWithInt_(OrgGeogebraCommonPluginEuclidianStyleConstants_POINT_STYLE_CIRCLE) autorelease], [new_JavaLangInteger_initWithInt_(OrgGeogebraCommonPluginEuclidianStyleConstants_POINT_STYLE_PLUS) autorelease], [new_JavaLangInteger_initWithInt_(OrgGeogebraCommonPluginEuclidianStyleConstants_POINT_STYLE_FILLED_DIAMOND) autorelease], [new_JavaLangInteger_initWithInt_(OrgGeogebraCommonPluginEuclidianStyleConstants_POINT_STYLE_EMPTY_DIAMOND) autorelease], [new_JavaLangInteger_initWithInt_(OrgGeogebraCommonPluginEuclidianStyleConstants_POINT_STYLE_TRIANGLE_NORTH) autorelease], [new_JavaLangInteger_initWithInt_(OrgGeogebraCommonPluginEuclidianStyleConstants_POINT_STYLE_TRIANGLE_SOUTH) autorelease], [new_JavaLangInteger_initWithInt_(OrgGeogebraCommonPluginEuclidianStyleConstants_POINT_STYLE_TRIANGLE_EAST) autorelease], [new_JavaLangInteger_initWithInt_(OrgGeogebraCommonPluginEuclidianStyleConstants_POINT_STYLE_TRIANGLE_WEST) autorelease] } count:10 type:JavaLangInteger_class_()];
  return ret;
}
...
void OrgGeogebraCommonEuclidianEuclidianView_initWithOrgGeogebraCommonEuclidianEuclidianController_withInt_withOrgGeogebraCommonMainSettingsEuclidianSettings_(OrgGeogebraCommonEuclidianEuclidianView *self, OrgGeogebraCommonEuclidianEuclidianController *ec, jint viewNo, OrgGeogebraCommonMainSettingsEuclidianSettings *settings) {
  ...
  OrgGeogebraCommonEuclidianEuclidianView_set_coordTransform_(self, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newAffineTransform]);
  OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_showAxes_(self, [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ YES, YES } count:2]);
  ...
  OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_DrawableMap_(self, new_JavaUtilHashMap_initWithInt_(500));
  OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_stickyPointList_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_allDrawableList_(self, new_OrgGeogebraCommonEuclidianDrawableList_init());
  OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_bgImageList_(self, new_OrgGeogebraCommonEuclidianDrawableList_init());
  OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_automaticAxesNumberingDistances_(self, [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ YES, YES } count:2]);
  OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_geosWaiting_(self, new_JavaUtilArrayList_init());
  self->reIniting_ = NO;
  OrgGeogebraCommonEuclidianEuclidianView_set_circle_(self, [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newEllipse2DDouble]);
  OrgGeogebraCommonEuclidianEuclidianView_set_tempLine_(self, [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newLine2D]);
  OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_axesLabelsPositionsY_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_axesLabelsPositionsX_(self, new_JavaUtilArrayList_init());
  self->yLabelMaxWidth_ = 0;
  self->xLabelHeights_ = 0;
  self->tracing_ = NO;
  OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_tempArrayList_(self, new_OrgGeogebraCommonEuclidianHits_init());
  OrgGeogebraCommonEuclidianEuclidianView_set_optionPanel_(self, nil);
  [self setEuclidianViewNoWithInt:viewNo];
  OrgGeogebraCommonEuclidianEuclidianView_set_companion_(self, [self newEuclidianViewCompanion]);
  OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_drawLayers_(self, [IOSObjectArray newArrayWithLength:OrgGeogebraCommonPluginEuclidianStyleConstants_MAX_LAYERS + 1 type:OrgGeogebraCommonEuclidianDrawableList_class_()]);
  for (jint k = 0; k <= OrgGeogebraCommonPluginEuclidianStyleConstants_MAX_LAYERS; k++) {
    IOSObjectArray_SetAndConsume(self->drawLayers_, k, new_OrgGeogebraCommonEuclidianDrawableList_init());
  }
  [self initAxesValues];
  OrgGeogebraCommonEuclidianEuclidianView_set_euclidianController_(self, ec);
  OrgGeogebraCommonEuclidianEuclidianView_set_kernel_(self, [((OrgGeogebraCommonEuclidianEuclidianController *) nil_chk(ec)) getKernel]);
  OrgGeogebraCommonEuclidianEuclidianView_set_app_(self, [((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) getApplication]);
  OrgGeogebraCommonEuclidianEuclidianView_set_settings_(self, settings);
  OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_xminObject_(self, new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_([self->kernel_ getConstruction]));
  OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_xmaxObject_(self, new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_([self->kernel_ getConstruction]));
  OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_yminObject_(self, new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_([self->kernel_ getConstruction]));
  OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_ymaxObject_(self, new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_([self->kernel_ getConstruction]));
  OrgGeogebraCommonEuclidianEuclidianView_setAndConsume_hits_(self, new_OrgGeogebraCommonEuclidianHits_init());
  OrgGeogebraCommonEuclidianEuclidianView_set_printScaleNF_(self, [((OrgGeogebraCommonFactoriesFormatFactory *) nil_chk(OrgGeogebraCommonFactoriesFormatFactory_get_prototype_())) getNumberFormatWithNSString:@"#.#####" withInt:5]);
}
...
void OrgGeogebraCommonEuclidianEuclidianView_setFontPointWithOrgGeogebraCommonAwtGFont_(OrgGeogebraCommonEuclidianEuclidianView *self, OrgGeogebraCommonAwtGFont *fontPoint) {
  OrgGeogebraCommonEuclidianEuclidianView_set_fontPoint_(self, fontPoint);
}
...
void OrgGeogebraCommonEuclidianEuclidianView_setFontCoordsWithOrgGeogebraCommonAwtGFont_(OrgGeogebraCommonEuclidianEuclidianView *self, OrgGeogebraCommonAwtGFont *fontCoords) {
  OrgGeogebraCommonEuclidianEuclidianView_set_fontCoords_(self, fontCoords);
}
    ...
    switch (self->gridType_) {
      ...
      for (jint i = 0; pix <= [self getWidth]; i++) {
        if (!IOSBooleanArray_Get(nil_chk(self->showAxes_), 1) || JavaLangMath_absWithDouble_(pix - xCrossPix) > 2.0) {
          if ([((JavaUtilArrayList *) nil_chk(self->axesLabelsPositionsX_)) containsWithId:[new_JavaLangInteger_initWithInt_(J2ObjCFpToInt((pix + OrgGeogebraCommonKernelKernel_MIN_PRECISION))) autorelease]]) {
      ...
      for (jint j = 0; pix <= [self getHeight]; j++) {
        if (!IOSBooleanArray_Get(nil_chk(self->showAxes_), 0) || JavaLangMath_absWithDouble_(pix - yCrossPix) > 2.0) {
          if ([((JavaUtilArrayList *) nil_chk(self->axesLabelsPositionsY_)) containsWithId:[new_JavaLangInteger_initWithInt_(J2ObjCFpToInt((pix + OrgGeogebraCommonKernelKernel_MIN_PRECISION))) autorelease]]) {
...
void OrgGeogebraCommonEuclidianEuclidianView_setAnimatedRealWorldCoordSystemWithDouble_withDouble_withDouble_withDouble_withInt_withBoolean_(OrgGeogebraCommonEuclidianEuclidianView *self, jdouble xmin, jdouble xmax, jdouble ymin, jdouble ymax, jint steps, jboolean storeUndo) {
  if (self->zoomerRW_ == nil) {
    OrgGeogebraCommonEuclidianEuclidianView_set_zoomerRW_(self, [self newZoomer]);
  }
...
id<OrgGeogebraCommonEuclidianEuclidianStyleBar> OrgGeogebraCommonEuclidianEuclidianView_getStyleBar(OrgGeogebraCommonEuclidianEuclidianView *self) {
  if (self->styleBar_ == nil) {
    OrgGeogebraCommonEuclidianEuclidianView_set_styleBar_(self, [self newEuclidianStyleBar]);
  }
