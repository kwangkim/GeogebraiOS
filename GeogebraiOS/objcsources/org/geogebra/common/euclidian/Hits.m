...
- (OrgGeogebraCommonEuclidianHits *)newHits {
  return new_OrgGeogebraCommonEuclidianHits_init();
}
...
- (OrgGeogebraCommonEuclidianHits *)absorbWithJavaUtilArrayList:(JavaUtilArrayList *)hits2 {
  OrgGeogebraCommonEuclidianHits *ret = new_OrgGeogebraCommonEuclidianHits_init();
...
- (void)removeAllPoints {
  for (jint i = [self size] - 1; i >= 0; i--) {
    ...
    if (geo == nil || [geo isGeoPoint]) (void) [self removeWithInt:i];
  }
}
...
- (void)removeAllDimElements {
  for (jint i = [self size] - 1; i >= 0; i--) {
    OrgGeogebraCommonKernelGeosGeoElement *geo = [self getWithInt:i];
    if (geo == nil || ([geo isRegion] && ([geo getAlphaValue] < 0.1f || [geo getLineThickness] < 0.5f)) || ([geo isPath] && [geo getLineThickness] < 0.5f)) (void) [self removeWithInt:i];
  }
}
...
- (void)removeAllPolygons {
  for (jint i = [self size] - 1; i >= 0; i--) {
    OrgGeogebraCommonKernelGeosGeoElement *geo = [self getWithInt:i];
    if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(geo)) isGeoPolygon]) (void) [self removeWithInt:i];
  }
}
...
- (void)removeAllPlanes {
  for (jint i = [self size] - 1; i >= 0; i--) {
    OrgGeogebraCommonKernelGeosGeoElement *geo = [self getWithInt:i];
    if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(geo)) isGeoPlane]) (void) [self removeWithInt:i];
  }
}
...
- (void)removeImages {
  for (jint i = [self size] - 1; i >= 0; i--) {
    OrgGeogebraCommonKernelGeosGeoElement *geo = [self getWithInt:i];
    if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(geo)) isGeoImage]) (void) [self removeWithInt:i];
  }
}
...
- (OrgGeogebraCommonEuclidianHits *)getSelectableHits {
  ...
  OrgGeogebraCommonEuclidianHits *selectableList = new_OrgGeogebraCommonEuclidianHits_init();
  for (jint i = 0; i < [self size]; ++i) {
...
- (OrgGeogebraCommonEuclidianHits *)getMoveablesWithOrgGeogebraCommonEuclidianEuclidianViewInterfaceSlim:(id<OrgGeogebraCommonEuclidianEuclidianViewInterfaceSlim>)view
                                                           ...
                                                           withOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)rotCenter {
  OrgGeogebraCommonKernelGeosGeoElement *geo;
  OrgGeogebraCommonEuclidianHits *moveableList = new_OrgGeogebraCommonEuclidianHits_init();
  for (jint i = 0; i < [self size]; ++i) {
    geo = [self getWithInt:i];
    switch ([test ordinal]) {
...
- (OrgGeogebraCommonEuclidianHits *)getTopHits {
  ...
  OrgGeogebraCommonEuclidianHits *topHitsList = new_OrgGeogebraCommonEuclidianHits_init();
  if (OrgGeogebraCommonEuclidianHits_containsGeoPointWithOrgGeogebraCommonEuclidianHits_(self, topHitsList)) {
    (void) OrgGeogebraCommonEuclidianHits_getHitsWithOrgGeogebraCommonKernelGeosTestEnum_withBoolean_withOrgGeogebraCommonEuclidianHits_(self, OrgGeogebraCommonKernelGeosTestEnum_get_GEOPOINTND(), NO, topHitsList);
    return topHitsList;
  }
  if (OrgGeogebraCommonEuclidianHits_containsGeoTextfieldWithOrgGeogebraCommonEuclidianHits_(self, topHitsList)) {
    (void) OrgGeogebraCommonEuclidianHits_getHitsWithOrgGeogebraCommonKernelGeosTestEnum_withBoolean_withOrgGeogebraCommonEuclidianHits_(self, OrgGeogebraCommonKernelGeosTestEnum_get_GEOTEXTFIELD(), NO, topHitsList);
    return topHitsList;
  }
  if (OrgGeogebraCommonEuclidianHits_containsGeoTextWithOrgGeogebraCommonEuclidianHits_(self, topHitsList)) {
    (void) OrgGeogebraCommonEuclidianHits_getHitsWithOrgGeogebraCommonKernelGeosTestEnum_withBoolean_withOrgGeogebraCommonEuclidianHits_(self, OrgGeogebraCommonKernelGeosTestEnum_get_GEOTEXT(), NO, topHitsList);
    return topHitsList;
  }
  return [self clone];
}
...
- (OrgGeogebraCommonEuclidianHits *)getFiniteVolumeIncludingMetaHits {
  OrgGeogebraCommonEuclidianHits *result = new_OrgGeogebraCommonEuclidianHits_init();
