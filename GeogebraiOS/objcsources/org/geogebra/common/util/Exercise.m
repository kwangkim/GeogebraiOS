...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/util/Exercise.java
//
...
- (void)checkExercise {
  for (OrgGeogebraCommonUtilAssignment * __strong assignment in nil_chk(assignments_)) {
    [((OrgGeogebraCommonUtilAssignment *) nil_chk(assignment)) checkAssignmentWithOrgGeogebraCommonKernelConstruction:construction_];
  }
}

- (JavaUtilArrayList *)getResults {
  JavaUtilArrayList *results = [new_JavaUtilArrayList_init() autorelease];
  for (OrgGeogebraCommonUtilAssignment * __strong assignment in nil_chk(assignments_)) {
...
- (JavaUtilArrayList *)getHints {
  JavaUtilArrayList *hints = [new_JavaUtilArrayList_init() autorelease];
  for (OrgGeogebraCommonUtilAssignment * __strong assignment in nil_chk(assignments_)) {
...
- (void)addAssignmentWithOrgGeogebraCommonKernelMacro:(OrgGeogebraCommonKernelMacro *)macro {
  [((JavaUtilArrayList *) nil_chk(assignments_)) addWithId:[new_OrgGeogebraCommonUtilAssignment_initWithOrgGeogebraCommonKernelMacro_(macro) autorelease]];
}
...
void OrgGeogebraCommonUtilExercise_initWithOrgGeogebraCommonMainApp_(OrgGeogebraCommonUtilExercise *self, OrgGeogebraCommonMainApp *app) {
  NSObject_init(self);
  OrgGeogebraCommonUtilExercise_set_kernel_(self, [((OrgGeogebraCommonMainApp *) nil_chk(app)) getKernel]);
  OrgGeogebraCommonUtilExercise_set_construction_(self, [((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) getConstruction]);
  OrgGeogebraCommonUtilExercise_setAndConsume_assignments_(self, new_JavaUtilArrayList_init());
  if ([((OrgGeogebraCommonKernelKernel *) nil_chk([app getKernel])) hasMacros]) {
    ...
    for (OrgGeogebraCommonKernelMacro * __strong macro in nil_chk(macros)) {
      [self->assignments_ addWithId:[new_OrgGeogebraCommonUtilAssignment_initWithOrgGeogebraCommonKernelMacro_(macro) autorelease]];
    }
  }
}
