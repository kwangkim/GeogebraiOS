...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/util/CopyPaste.java
//
...
- (void)beforeSavingToXMLWithJavaUtilArrayList:(JavaUtilArrayList *)conels
                         withJavaUtilArrayList:(JavaUtilArrayList *)geostohide
                                   ...
                                   withBoolean:(jboolean)putdown {
  if (samewindow) OrgGeogebraCommonUtilCopyPaste_setAndConsume_copiedXMLlabelsforSameWindow_(self, new_JavaUtilArrayList_init());
  else OrgGeogebraCommonUtilCopyPaste_setAndConsume_copiedXMLlabels_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonKernelAlgosConstructionElement *geo;
  NSString *label;
...
- (void)copyToXMLWithOrgGeogebraCommonMainApp:(OrgGeogebraCommonMainApp *)app
  ...
  OrgGeogebraCommonUtilCopyPaste_setAndConsume_copiedXML_(self, new_JavaLangStringBuilder_init());
  OrgGeogebraCommonUtilCopyPaste_setAndConsume_copiedXMLlabels_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonUtilCopyPaste_setAndConsume_copiedXMLforSameWindow_(self, new_JavaLangStringBuilder_init());
  OrgGeogebraCommonUtilCopyPaste_setAndConsume_copiedXMLlabelsforSameWindow_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonUtilCopyPaste_set_copySource_(self, [app getActiveEuclidianView]);
  OrgGeogebraCommonUtilCopyPaste_set_copyObject_(self, [((OrgGeogebraCommonKernelUndoManager *) nil_chk([((OrgGeogebraCommonKernelConstruction *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk([app getKernel])) getConstruction])) getUndoManager])) getCurrentUndoInfo]);
  OrgGeogebraCommonUtilCopyPaste_setAndConsume_copiedMacros_(self, new_JavaUtilHashSet_init());
...
- (void)clearClipboard {
  OrgGeogebraCommonUtilCopyPaste_set_copiedXML_(self, nil);
  OrgGeogebraCommonUtilCopyPaste_setAndConsume_copiedXMLlabels_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonUtilCopyPaste_set_copiedXMLforSameWindow_(self, nil);
  OrgGeogebraCommonUtilCopyPaste_setAndConsume_copiedXMLlabelsforSameWindow_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonUtilCopyPaste_set_copySource_(self, nil);
  OrgGeogebraCommonUtilCopyPaste_set_copyObject_(self, nil);
  OrgGeogebraCommonUtilCopyPaste_set_copyObject2_(self, nil);
  OrgGeogebraCommonUtilCopyPaste_set_copiedMacros_(self, nil);
}
...
- (void)pasteFromXMLWithOrgGeogebraCommonMainApp:(OrgGeogebraCommonMainApp *)app
  ...
  OrgGeogebraCommonUtilCopyPaste_set_copyObject2_(self, [((OrgGeogebraCommonKernelUndoManager *) nil_chk([((OrgGeogebraCommonKernelConstruction *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk([app getKernel])) getConstruction])) getUndoManager])) getCurrentUndoInfo]);
  ...
  if ([self pasteFastWithOrgGeogebraCommonMainApp:app] && !putdown) {
    ...
    if (![((JavaUtilHashSet *) nil_chk(copiedMacros_)) isEmpty]) {
      @try {
        [app addMacroXMLWithNSString:[((OrgGeogebraCommonIoMyXMLio *) nil_chk([((OrgGeogebraCommonMainApp *) nil_chk([((id<OrgGeogebraCommonEuclidianEuclidianViewInterfaceCommon>) nil_chk(copySource_)) getApplication])) getXMLio])) getFullMacroXMLWithJavaUtilArrayList:[new_JavaUtilArrayList_initWithJavaUtilCollection_(copiedMacros_) autorelease]]];
      }
...
- (void)pastePutDownCallbackWithOrgGeogebraCommonMainApp:(OrgGeogebraCommonMainApp *)app {
  if ([self pasteFastWithOrgGeogebraCommonMainApp:app]) {
    OrgGeogebraCommonUtilCopyPaste_set_copyObject_(self, [((OrgGeogebraCommonKernelUndoManager *) nil_chk([((OrgGeogebraCommonKernelConstruction *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk([((OrgGeogebraCommonMainApp *) nil_chk(app)) getKernel])) getConstruction])) getUndoManager])) getCurrentUndoInfo]);
    OrgGeogebraCommonUtilCopyPaste_set_copyObject2_(self, nil);
  }
}
