...
IOSDoubleArray *OrgGeogebraCommonUtilPolyGamma_dpsifnWithDouble_withInt_withInt_withInt_(jdouble x, jint n, jint kode, jint m) {
  ...
  IOSDoubleArray *ans = [IOSDoubleArray newArrayWithLength:n + 1];
  ...
  jdouble xq, yint;
  IOSDoubleArray *trm = [IOSDoubleArray newArrayWithLength:23], *trmr = [IOSDoubleArray newArrayWithLength:OrgGeogebraCommonUtilPolyGamma_kMaxValue + 1];
  jboolean flag1 = NO;
  ...
  if (x <= 0.) {
    ...
    (void) OrgGeogebraCommonUtilPolyGamma_dpsifnWithDouble_withInt_withInt_withInt_(1. - x, n, 1, m);
...
jdouble OrgGeogebraCommonUtilPolyGamma_digammaWithDouble_(jdouble x) {
  ...
  if (ans == nil) @throw new_JavaLangArithmeticException_initWithNSString_(OrgGeogebraCommonUtilPolyGamma_sErrorDomain_);
