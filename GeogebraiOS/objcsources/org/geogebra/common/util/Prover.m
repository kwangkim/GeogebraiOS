...
- (void)decideStatement {
  if (statement_ == nil) {
    ...
    OrgGeogebraCommonUtilProver_set_result_(self, OrgGeogebraCommonUtilProver_ProofResultEnum_get_UNKNOWN());
    return;
  }
  ...
  if (algoParent == nil) {
    if ([((NSString *) nil_chk([statement_ getValueForInputBar])) isEqual:@"true"]) OrgGeogebraCommonUtilProver_set_result_(self, OrgGeogebraCommonUtilProver_ProofResultEnum_get_TRUE());
    else if ([((NSString *) nil_chk([statement_ getValueForInputBar])) isEqual:@"false"]) OrgGeogebraCommonUtilProver_set_result_(self, OrgGeogebraCommonUtilProver_ProofResultEnum_get_FALSE());
    else OrgGeogebraCommonUtilProver_set_result_(self, OrgGeogebraCommonUtilProver_ProofResultEnum_get_UNKNOWN());
    return;
  }
...
void OrgGeogebraCommonUtilProver_init(OrgGeogebraCommonUtilProver *self) {
  NSObject_init(self);
  self->timeout_ = 5;
  OrgGeogebraCommonUtilProver_set_engine_(self, OrgGeogebraCommonUtilProver_ProverEngineEnum_get_AUTO());
  OrgGeogebraCommonUtilProver_setAndConsume_ndgConditions_(self, new_JavaUtilHashSet_init());
  OrgGeogebraCommonUtilProver_setAndConsume_proveAutoOrder_(self, new_JavaUtilArrayList_init());
  ...
  OrgGeogebraCommonUtilProver_setAndConsume_proveDetailsAutoOrder_(self, new_JavaUtilArrayList_init());
...
void OrgGeogebraCommonUtilProver_callEngineWithOrgGeogebraCommonUtilProver_ProverEngineEnum_(OrgGeogebraCommonUtilProver *self, OrgGeogebraCommonUtilProver_ProverEngineEnum *currentEngine) {
  ...
  if (currentEngine == OrgGeogebraCommonUtilProver_ProverEngineEnum_get_BOTANAS_PROVER()) {
    OrgGeogebraCommonUtilProver_set_result_(self, OrgGeogebraCommonUtilProver_overrideWithOrgGeogebraCommonUtilProver_ProofResultEnum_(self, OrgGeogebraCommonKernelProverProverBotanasMethod_proveWithOrgGeogebraCommonUtilProver_(self)));
    return;
  }
  else if (currentEngine == OrgGeogebraCommonUtilProver_ProverEngineEnum_get_RECIOS_PROVER()) {
    OrgGeogebraCommonUtilProver_set_result_(self, OrgGeogebraCommonUtilProver_overrideWithOrgGeogebraCommonUtilProver_ProofResultEnum_(self, [((OrgGeogebraCommonKernelProverAbstractProverReciosMethod *) nil_chk(OrgGeogebraCommonUtilProver_reciosProver_)) proveWithOrgGeogebraCommonUtilProver:self]));
    return;
  }
  else if (currentEngine == OrgGeogebraCommonUtilProver_ProverEngineEnum_get_PURE_SYMBOLIC_PROVER()) {
    OrgGeogebraCommonUtilProver_set_result_(self, OrgGeogebraCommonUtilProver_overrideWithOrgGeogebraCommonUtilProver_ProofResultEnum_(self, OrgGeogebraCommonKernelProverProverPureSymbolicMethod_proveWithOrgGeogebraCommonUtilProver_(self)));
    return;
  }
    ...
    OrgGeogebraCommonUtilProver_set_result_(self, OrgGeogebraCommonUtilProver_overrideWithOrgGeogebraCommonUtilProver_ProofResultEnum_(self, [self openGeoProverWithOrgGeogebraCommonUtilProver_ProverEngineEnum:currentEngine]));
    return;
  }
}
...
- (void)setConditionWithNSString:(NSString *)condition {
  OrgGeogebraCommonUtilProver_NDGCondition_set_condition_(self, condition);
}
...
- (void)setGeosWithOrgGeogebraCommonKernelGeosGeoElementArray:(IOSObjectArray *)object {
  OrgGeogebraCommonUtilProver_NDGCondition_set_geos_(self, object);
}
...
- (void)rewriteWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)cons {
  ...
  if ([@"ArePerpendicular" isEqual:cond] && ((IOSObjectArray *) nil_chk(self->geos_))->size_ == 3) {
    ...
    if (l1 != nil && l2 != nil) {
      OrgGeogebraCommonUtilProver_NDGCondition_setAndConsume_geos_(self, [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonKernelGeosGeoElement_class_()]);
...
OrgGeogebraCommonKernelGeosGeoLine *OrgGeogebraCommonUtilProver_NDGCondition_lineWithOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonKernelGeosGeoPoint *P1, OrgGeogebraCommonKernelGeosGeoPoint *P2, OrgGeogebraCommonKernelConstruction *cons) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoJoinPoints *ajp = [new_OrgGeogebraCommonKernelAlgosAlgoJoinPoints_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_(cons, nil, P1, P2) autorelease];
...
OrgGeogebraCommonKernelGeosGeoSegment *OrgGeogebraCommonUtilProver_NDGCondition_segmentWithOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonKernelGeosGeoPoint *P1, OrgGeogebraCommonKernelGeosGeoPoint *P2, OrgGeogebraCommonKernelConstruction *cons) {
  ...
  jboolean oldMacroMode = [cons isSuppressLabelsActive];
  [cons setSuppressLabelCreationWithBoolean:NO];
  OrgGeogebraCommonKernelAlgosAlgoJoinPointsSegment *ajp = [new_OrgGeogebraCommonKernelAlgosAlgoJoinPointsSegment_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_(cons, nil, P1, P2) autorelease];
...
void OrgGeogebraCommonUtilProver_NDGCondition_sortGeos(OrgGeogebraCommonUtilProver_NDGCondition *self) {
  JavaUtilArrays_sortWithNSObjectArray_withJavaUtilComparator_(self->geos_, [new_OrgGeogebraCommonUtilProver_NDGCondition_$1_init() autorelease]);
}
