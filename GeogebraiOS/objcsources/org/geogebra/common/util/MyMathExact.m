...
- (OrgGeogebraCommonUtilMyMathExact_MyDecimal *)copy__ {
  return new_OrgGeogebraCommonUtilMyMathExact_MyDecimal_initWithInt_withJavaMathBigDecimal_([self getScale], self);
}

- (OrgGeogebraCommonUtilMyMathExact_MyDecimal *)negate {
  return new_OrgGeogebraCommonUtilMyMathExact_MyDecimal_initWithInt_withJavaMathBigDecimal_([self getScale], [super negate]);
}
...
- (OrgGeogebraCommonUtilMyMathExact_MyDecimal *)addWithOrgGeogebraCommonUtilMyMathExact_MyDecimal:(OrgGeogebraCommonUtilMyMathExact_MyDecimal *)md {
  return new_OrgGeogebraCommonUtilMyMathExact_MyDecimal_initWithInt_withJavaMathBigDecimal_([self getScale], [super addWithJavaMathBigDecimal:md]);
}
...
- (OrgGeogebraCommonUtilMyMathExact_MyDecimal *)multiplyWithOrgGeogebraCommonUtilMyMathExact_MyDecimal:(OrgGeogebraCommonUtilMyMathExact_MyDecimal *)md {
  return new_OrgGeogebraCommonUtilMyMathExact_MyDecimal_initWithInt_withJavaMathBigDecimal_([self getScale], [super multiplyWithJavaMathBigDecimal:md]);
}
...
- (OrgGeogebraCommonUtilMyMathExact_MyDecimal *)subtractWithOrgGeogebraCommonUtilMyMathExact_MyDecimal:(OrgGeogebraCommonUtilMyMathExact_MyDecimal *)md {
  return new_OrgGeogebraCommonUtilMyMathExact_MyDecimal_initWithInt_withJavaMathBigDecimal_([self getScale], [super subtractWithJavaMathBigDecimal:md]);
}
...
- (OrgGeogebraCommonUtilMyMathExact_MyDecimal *)divideWithOrgGeogebraCommonUtilMyMathExact_MyDecimal:(OrgGeogebraCommonUtilMyMathExact_MyDecimal *)md {
  return new_OrgGeogebraCommonUtilMyMathExact_MyDecimal_initWithInt_withJavaMathBigDecimal_([self getScale], [super divideWithJavaMathBigDecimal:md withInt:[self getScale] withInt:JavaMathBigDecimal_ROUND_HALF_EVEN]);
}

- (OrgGeogebraCommonUtilMyMathExact_MyDecimal *)sqrt {
  if ([self isEqual:JavaMathBigDecimal_get_ZERO_()]) {
    return new_OrgGeogebraCommonUtilMyMathExact_MyDecimal_initWithJavaMathBigDecimal_(JavaMathBigDecimal_get_ZERO_());
  }
  OrgGeogebraCommonUtilMyMathExact_MyDecimal *TWO = new_OrgGeogebraCommonUtilMyMathExact_MyDecimal_initWithJavaMathBigDecimal_([((JavaMathBigDecimal *) nil_chk(JavaMathBigDecimal_get_ONE_())) addWithJavaMathBigDecimal:JavaMathBigDecimal_get_ONE_()]);
  ...
  OrgGeogebraCommonUtilMyMathExact_MyDecimal *ret = new_OrgGeogebraCommonUtilMyMathExact_MyDecimal_initWithInt_withDouble_(thisScalePlusOne, lower_bound);
  OrgGeogebraCommonUtilMyMathExact_MyDecimal *radicand = new_OrgGeogebraCommonUtilMyMathExact_MyDecimal_initWithInt_withJavaMathBigDecimal_(thisScalePlusOne, self);
  jint iterCount = 0;
  while ([((JavaMathBigDecimal *) nil_chk([((OrgGeogebraCommonUtilMyMathExact_MyDecimal *) nil_chk([((OrgGeogebraCommonUtilMyMathExact_MyDecimal *) nil_chk([((OrgGeogebraCommonUtilMyMathExact_MyDecimal *) nil_chk([((OrgGeogebraCommonUtilMyMathExact_MyDecimal *) nil_chk([ret multiplyWithOrgGeogebraCommonUtilMyMathExact_MyDecimal:ret])) subtractWithOrgGeogebraCommonUtilMyMathExact_MyDecimal:radicand])) divideWithOrgGeogebraCommonUtilMyMathExact_MyDecimal:radicand])) divideWithOrgGeogebraCommonUtilMyMathExact_MyDecimal:new_OrgGeogebraCommonUtilMyMathExact_MyDecimal_initWithInt_withDouble_(thisScalePlusOne, lower_bound * 2)])) abs])) doubleValue] > JavaLangMath_powWithDouble_withDouble_(10, -thisScale) && iterCount < 5) {
  ...
  return new_OrgGeogebraCommonUtilMyMathExact_MyDecimal_initWithInt_withJavaMathBigDecimal_(thisScale, ret);
}
...
void OrgGeogebraCommonUtilMyMathExact_MyDecimal_initWithInt_(OrgGeogebraCommonUtilMyMathExact_MyDecimal *self, jint significance) {
  (void) JavaMathBigDecimal_initWithInt_(self, 0);
  self->roundingMode_ = JavaMathBigDecimal_ROUND_HALF_EVEN;
  (void) [self setScaleWithInt:significance];
...
void OrgGeogebraCommonUtilMyMathExact_MyDecimal_initWithInt_withDouble_(OrgGeogebraCommonUtilMyMathExact_MyDecimal *self, jint significance, jdouble val) {
  (void) JavaMathBigDecimal_initWithDouble_(self, val);
  self->roundingMode_ = JavaMathBigDecimal_ROUND_HALF_EVEN;
  (void) OrgGeogebraCommonUtilMyMathExact_MyDecimal_super$_setScaleWithInt_withInt_(self, @selector(setScaleWithInt:withInt:), significance, self->roundingMode_);
  self->fixedScale_ = significance;
}
...
void OrgGeogebraCommonUtilMyMathExact_MyDecimal_initWithOrgGeogebraCommonUtilMyMathExact_MyDecimal_(OrgGeogebraCommonUtilMyMathExact_MyDecimal *self, OrgGeogebraCommonUtilMyMathExact_MyDecimal *md) {
  (void) JavaMathBigDecimal_initWithJavaMathBigInteger_withInt_(self, [((OrgGeogebraCommonUtilMyMathExact_MyDecimal *) nil_chk(md)) unscaledValue], [md scale__]);
  self->roundingMode_ = JavaMathBigDecimal_ROUND_HALF_EVEN;
...
void OrgGeogebraCommonUtilMyMathExact_MyDecimal_initWithJavaMathBigDecimal_(OrgGeogebraCommonUtilMyMathExact_MyDecimal *self, JavaMathBigDecimal *bd) {
  (void) JavaMathBigDecimal_initWithJavaMathBigInteger_withInt_(self, [((JavaMathBigDecimal *) nil_chk(bd)) unscaledValue], [bd scale__]);
  self->roundingMode_ = JavaMathBigDecimal_ROUND_HALF_EVEN;
...
void OrgGeogebraCommonUtilMyMathExact_MyDecimal_initWithInt_withJavaMathBigDecimal_(OrgGeogebraCommonUtilMyMathExact_MyDecimal *self, jint significance, JavaMathBigDecimal *bd) {
  (void) JavaMathBigDecimal_initWithJavaMathBigInteger_withInt_(self, [((JavaMathBigDecimal *) nil_chk(bd)) unscaledValue], [bd scale__]);
  self->roundingMode_ = JavaMathBigDecimal_ROUND_HALF_EVEN;
  (void) [self setScaleWithInt:significance withInt:self->roundingMode_];
  self->fixedScale_ = significance;
}
...
withOrgGeogebraCommonUtilMyMathExact_MyDecimal:(OrgGeogebraCommonUtilMyMathExact_MyDecimal *)md {
  (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(nil_chk(data_), i)), j, new_OrgGeogebraCommonUtilMyMathExact_MyDecimal_initWithInt_withJavaMathBigDecimal_(fixedScale_, md));
}

- (OrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix *)copy__ {
  OrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix *mdm = new_OrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix_initWithInt_withInt_withInt_(fixedScale_, rowD_, colD_);
...
- (IOSObjectArray *)getColumnWithInt:(jint)j {
  IOSObjectArray *ret = [IOSObjectArray newArrayWithLength:[self getRowDimension] type:OrgGeogebraCommonUtilMyMathExact_MyDecimal_class_()];
  for (jint i = 0; i < [self getRowDimension]; i++) {
    (void) IOSObjectArray_Set(ret, i, [self getEntryWithInt:i withInt:j]);
  }
  return ret;
}
...
- (IOSObjectArray *)getRowWithInt:(jint)i {
  IOSObjectArray *ret = [IOSObjectArray newArrayWithLength:[self getColumnDimension] type:OrgGeogebraCommonUtilMyMathExact_MyDecimal_class_()];
  for (jint j = 0; j < [self getColumnDimension]; j++) {
    (void) IOSObjectArray_Set(ret, j, [self getEntryWithInt:i withInt:j]);
  }
  return ret;
}
...
- (OrgGeogebraCommonUtilMyMathExact_MyDecimal *)frobNormSqWithOrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix:(OrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix *)matrix
                                                                                                       withInt:(jint)m
                                                                                                       withInt:(jint)n {
  OrgGeogebraCommonUtilMyMathExact_MyDecimal *ret = new_OrgGeogebraCommonUtilMyMathExact_MyDecimal_initWithJavaMathBigDecimal_(JavaMathBigDecimal_get_ZERO_());
...
- (OrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix *)multiplyWithOrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix:(OrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix *)m {
  if ([self getColumnDimension] != [((OrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix *) nil_chk(m)) getRowDimension]) {
    @throw OrgApacheCommonsMathMathRuntimeException_createIllegalArgumentExceptionWithNSString_withNSObjectArray_(JreStrcat("$I$I$I$I$", @"Cannot multiply ", [self getRowDimension], @" x ", [self getColumnDimension], @" and ", [m getRowDimension], @" x ", [m getColumnDimension], @"matrices!"), [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
  }
  OrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix *ret = new_OrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix_initWithInt_withInt_withInt_([self getScale], [self getRowDimension], [m getColumnDimension]);
  for (jint i = 0; i < [self getRowDimension]; i++) {
    for (jint j = 0; j < [m getColumnDimension]; j++) {
      OrgGeogebraCommonUtilMyMathExact_MyDecimal *entry_ = new_OrgGeogebraCommonUtilMyMathExact_MyDecimal_initWithInt_withDouble_(self->fixedScale_, 0);
...
void OrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix_initWithInt_withInt_withInt_(OrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix *self, jint significance, jint rowD, jint colD) {
  ...
  self->rowD_ = rowD;
  self->colD_ = colD;
  self->data_ = [IOSObjectArray newArrayWithDimensions:2 lengths:(jint[]){ rowD, colD } type:OrgGeogebraCommonUtilMyMathExact_MyDecimal_class_()];
}
