...
+ (void)initialize {
  if (self == [OrgGeogebraCommonUtilValidation class]) {
    JreStrongAssignAndConsume(&OrgGeogebraCommonUtilValidation_validation_, nil, new_OrgGeogebraCommonUtilValidation_init());
...
jdouble OrgGeogebraCommonUtilValidation_validateDoubleWithOrgGeogebraCommonUtilTextObject_withDouble_(id<OrgGeogebraCommonUtilTextObject> tf, jdouble def) {
  ...
  return OrgGeogebraCommonUtilValidation_DoubleValidator_validateDoubleWithOrgGeogebraCommonUtilTextObject_withDouble_([new_OrgGeogebraCommonUtilValidation_DoubleValidator_initWithOrgGeogebraCommonUtilValidation_(OrgGeogebraCommonUtilValidation_validation_) autorelease], tf, def);
}
...
jdouble OrgGeogebraCommonUtilValidation_validateDoublePositiveWithOrgGeogebraCommonUtilTextObject_withDouble_(id<OrgGeogebraCommonUtilTextObject> tf, jdouble def) {
  OrgGeogebraCommonUtilValidation_initialize();
    OrgGeogebraCommonUtilValidation_DoubleValidator *dv;// = [new_OrgGeogebraCommonUtilValidation_$1_initWithOrgGeogebraCommonUtilValidation_withOrgGeogebraCommonUtilValidation_(self, OrgGeogebraCommonUtilValidation_validation_) autorelease];
...
void OrgGeogebraCommonUtilValidation_$1_initWithOrgGeogebraCommonUtilValidation_withOrgGeogebraCommonUtilValidation_(OrgGeogebraCommonUtilValidation_$1 *self, OrgGeogebraCommonUtilValidation *outer$, OrgGeogebraCommonUtilValidation *superOuter$) {
  OrgGeogebraCommonUtilValidation_DoubleValidator_initWithOrgGeogebraCommonUtilValidation_(self, superOuter$);
}
