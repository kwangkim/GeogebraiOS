...
- (OrgGeogebraCommonUtilAssignment_ResultEnum *)checkAssignmentWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)cons {
  OrgGeogebraCommonUtilAssignment_set_res_(self, OrgGeogebraCommonUtilAssignment_ResultEnum_get_UNKNOWN());
  ...
  IOSObjectArray *inputGeos = [IOSObjectArray arrayWithLength:[possibleInputGeos size] type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
  ...
  if (((IOSObjectArray *) nil_chk([macro_ getInputTypes]))->size_ > [possibleInputGeos size]) {
    OrgGeogebraCommonUtilAssignment_set_res_(self, OrgGeogebraCommonUtilAssignment_ResultEnum_get_NOT_ENOUGH_INPUTS());
  }
  else if ([possibleOutputGeos isEmpty]) {
    OrgGeogebraCommonUtilAssignment_set_res_(self, OrgGeogebraCommonUtilAssignment_ResultEnum_get_WRONG_OUTPUT_TYPE());
  }
  else {
    IOSObjectArray *input = [IOSObjectArray arrayWithLength:((IOSObjectArray *) nil_chk(inputTypes))->size_ type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    OrgGeogebraCommonUtilPermutationOfGeOElementsUtil *permutationUtil = [new_OrgGeogebraCommonUtilPermutationOfGeOElementsUtil_initWithOrgGeogebraCommonKernelGeosGeoElementArray_withInt_(inputGeos, inputTypes->size_) autorelease];
    ...
    while (inputNextPermutation != nil && (res_ == OrgGeogebraCommonUtilAssignment_ResultEnum_get_WRONG() || res_ == OrgGeogebraCommonUtilAssignment_ResultEnum_get_UNKNOWN())) {
      ...
      if (typesOK) {
        OrgGeogebraCommonUtilAssignment_set_res_(self, OrgGeogebraCommonUtilAssignment_checkEqualityOfGeosWithOrgGeogebraCommonKernelGeosGeoElementArray_withJavaUtilArrayList_withOrgGeogebraCommonKernelConstruction_(self, input, [new_JavaUtilArrayList_initWithJavaUtilCollection_(possibleOutputGeos) autorelease], cons));
      }
      inputNextPermutation = [permutationUtil next];
    }
    if (res_ == OrgGeogebraCommonUtilAssignment_ResultEnum_get_UNKNOWN()) {
      if (typesOK) {
        OrgGeogebraCommonUtilAssignment_set_res_(self, OrgGeogebraCommonUtilAssignment_ResultEnum_get_WRONG());
      }
      else {
        OrgGeogebraCommonUtilAssignment_set_res_(self, OrgGeogebraCommonUtilAssignment_ResultEnum_get_WRONG_INPUT_TYPES());
      }
    }
  }
  return res_;
...
- (void)setFractionForResultWithOrgGeogebraCommonUtilAssignment_ResultEnum:(OrgGeogebraCommonUtilAssignment_ResultEnum *)res
                                                                 withFloat:(jfloat)f {
  [((JavaUtilHashMap *) nil_chk(fractionForResult_)) putWithId:res withId:JavaLangFloat_valueOfWithFloat_(f)];
}
...
- (void)setHintForResultWithOrgGeogebraCommonUtilAssignment_ResultEnum:(OrgGeogebraCommonUtilAssignment_ResultEnum *)res
  ...
  [((JavaUtilHashMap *) nil_chk(self->hintForResult_)) putWithId:res withId:hint];
}
...
- (void)dealloc {
  RELEASE_(macro_);
  RELEASE_(fractionForResult_);
  RELEASE_(hintForResult_);
  RELEASE_(res_);
  [super dealloc];
}
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonUtilAssignment class]) {
    JreStrongAssignAndConsume(&OrgGeogebraCommonUtilAssignment_FRACTIONS_, nil, [IOSFloatArray newArrayWithFloats:(jfloat[]){ 0.0f, 0.1f, 0.125f, 0.2f, 0.25f, 0.3333f, 0.5f, 1.0f } count:8]);
...
void OrgGeogebraCommonUtilAssignment_initWithOrgGeogebraCommonKernelMacro_(OrgGeogebraCommonUtilAssignment *self, OrgGeogebraCommonKernelMacro *macro) {
  NSObject_init(self);
  OrgGeogebraCommonUtilAssignment_set_macro_(self, macro);
  OrgGeogebraCommonUtilAssignment_setAndConsume_fractionForResult_(self, new_JavaUtilHashMap_init());
  OrgGeogebraCommonUtilAssignment_setAndConsume_hintForResult_(self, new_JavaUtilHashMap_init());
  OrgGeogebraCommonUtilAssignment_set_res_(self, OrgGeogebraCommonUtilAssignment_ResultEnum_get_UNKNOWN());
}
...
OrgGeogebraCommonUtilAssignment_ResultEnum *OrgGeogebraCommonUtilAssignment_checkEqualityOfGeosWithOrgGeogebraCommonKernelGeosGeoElementArray_withJavaUtilArrayList_withOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonUtilAssignment *self, IOSObjectArray *input, JavaUtilArrayList *possibleOutputGeos, OrgGeogebraCommonKernelConstruction *cons) {
  OrgGeogebraCommonKernelAlgosAlgoMacro *algoMacro = [new_OrgGeogebraCommonKernelAlgosAlgoMacro_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelMacro_withOrgGeogebraCommonKernelGeosGeoElementArray_(cons, nil, self->macro_, input) autorelease];
  ...
  while (i < [((JavaUtilArrayList *) nil_chk(possibleOutputGeos)) size] && (self->res_ == OrgGeogebraCommonUtilAssignment_ResultEnum_get_UNKNOWN() || self->res_ == OrgGeogebraCommonUtilAssignment_ResultEnum_get_WRONG())) {
    OrgGeogebraCommonKernelProverAlgoAreEqual *algoEqual = [new_OrgGeogebraCommonKernelProverAlgoAreEqual_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoElement_(cons, @"", IOSObjectArray_Get(nil_chk(macroOutput), 0), [possibleOutputGeos getWithInt:i]) autorelease];
    OrgGeogebraCommonUtilAssignment_set_res_(self, [((OrgGeogebraCommonKernelGeosGeoBoolean *) nil_chk([algoEqual getResult])) getBoolean] ? OrgGeogebraCommonUtilAssignment_ResultEnum_get_CORRECT() : OrgGeogebraCommonUtilAssignment_ResultEnum_get_WRONG());
    jint j = 0;
    while (j < ((IOSObjectArray *) nil_chk(input))->size_ && self->res_ == OrgGeogebraCommonUtilAssignment_ResultEnum_get_CORRECT()) {
      if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(IOSObjectArray_Get(input, j))) isRandomizable]) {
        ...
        OrgGeogebraCommonUtilAssignment_set_res_(self, [((OrgGeogebraCommonKernelGeosGeoBoolean *) nil_chk([algoEqual getResult])) getBoolean] ? OrgGeogebraCommonUtilAssignment_ResultEnum_get_CORRECT() : OrgGeogebraCommonUtilAssignment_ResultEnum_get_WRONG_AFTER_RANDOMIZE());
...
- (IOSObjectArray *)next {
  ...
  IOSObjectArray *res = [IOSObjectArray arrayWithLength:((IOSIntArray *) nil_chk(permSwappings_))->size_ type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
  ...
  if (i < 0) {
    OrgGeogebraCommonUtilPermutationOfGeOElementsUtil_set_arr_(self, nil);
  }
  else {
...
void OrgGeogebraCommonUtilPermutationOfGeOElementsUtil_initWithOrgGeogebraCommonKernelGeosGeoElementArray_(OrgGeogebraCommonUtilPermutationOfGeOElementsUtil *self, IOSObjectArray *arr) {
  OrgGeogebraCommonUtilPermutationOfGeOElementsUtil_initWithOrgGeogebraCommonKernelGeosGeoElementArray_withInt_(self, arr, ((IOSObjectArray *) nil_chk(arr))->size_);
}
...
void OrgGeogebraCommonUtilPermutationOfGeOElementsUtil_initWithOrgGeogebraCommonKernelGeosGeoElementArray_withInt_(OrgGeogebraCommonUtilPermutationOfGeOElementsUtil *self, IOSObjectArray *arr, jint permSize) {
  NSObject_init(self);
  OrgGeogebraCommonUtilPermutationOfGeOElementsUtil_setAndConsume_arr_(self, [IOSObjectArray newArrayWithLength:((IOSObjectArray *) nil_chk(arr))->size_ type:OrgGeogebraCommonKernelGeosGeoElement_class_()]);
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(arr, 0, self->arr_, 0, arr->size_);
  OrgGeogebraCommonUtilPermutationOfGeOElementsUtil_setAndConsume_permSwappings_(self, [IOSIntArray newArrayWithLength:permSize]);
