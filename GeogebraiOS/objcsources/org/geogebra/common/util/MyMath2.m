...
+ (void)initialize {
  if (self == [OrgGeogebraCommonUtilMyMath2 class]) {
    OrgGeogebraCommonUtilMyMath2_factorialTable_ = [IOSDoubleArray newArrayWithLength:33];
    {
...
OrgApacheCommonsMathComplexComplex *OrgGeogebraCommonUtilMyMath2_cisiWithDouble_(jdouble a2) {
  ...
  one = new_OrgApacheCommonsMathComplexComplex_initWithDouble_withDouble_(1, 0);
  two = new_OrgApacheCommonsMathComplexComplex_initWithDouble_withDouble_(2, 0);
  t = JavaLangMath_absWithDouble_(a2);
  if (t == 0.0) {
    return new_OrgApacheCommonsMathComplexComplex_initWithDouble_withDouble_(JavaLangDouble_NEGATIVE_INFINITY, 0);
  }
  if (t > OrgGeogebraCommonUtilMyMath2_TMIN_) {
    b = new_OrgApacheCommonsMathComplexComplex_initWithDouble_withDouble_(1, t);
    c = new_OrgApacheCommonsMathComplexComplex_initWithDouble_withDouble_(1000, 0);
    ...
    h = [((OrgApacheCommonsMathComplexComplex *) nil_chk(h)) multiplyWithId:new_OrgApacheCommonsMathComplexComplex_initWithDouble_withDouble_(JavaLangMath_cosWithDouble_(t), -JavaLangMath_sinWithDouble_(t))];
    return new_OrgApacheCommonsMathComplexComplex_initWithDouble_withDouble_(-[((OrgApacheCommonsMathComplexComplex *) nil_chk(h)) getReal], JavaLangMath_signumWithDouble_(a2) * (OrgGeogebraCommonKernelKernel_PI_HALF + [h getImaginary]));
  }
  if (t < JavaLangMath_sqrtWithDouble_(OrgGeogebraCommonKernelKernel_STANDARD_PRECISION)) {
    ...
    if (k > OrgGeogebraCommonUtilMyMath2_MAXIT_) return new_OrgApacheCommonsMathComplexComplex_initWithDouble_withDouble_(JavaLangDouble_NaN, JavaLangDouble_NaN);
  }
  return new_OrgApacheCommonsMathComplexComplex_initWithDouble_withDouble_(sumc + JavaLangMath_logWithDouble_(t) + OrgGeogebraCommonUtilMyMath2_EULER_, JavaLangMath_signumWithDouble_(a2) * sums);
}
...
jdouble OrgGeogebraCommonUtilMyMath2_zetaWithDouble_(jdouble val) {
  ...
  IOSDoubleArray *s = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ val, 0 } count:2];
