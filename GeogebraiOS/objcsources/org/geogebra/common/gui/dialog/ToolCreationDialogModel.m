...
- (void)updateInputList {
  ...
  JavaUtilTreeSet *freeParents = new_JavaUtilTreeSet_init();
...
- (jboolean)createTool {
  ...
  IOSObjectArray *output = [((OrgGeogebraCommonGuiDialogToolInputOutputList *) nil_chk(outputList_)) toGeoElements];
  @try {
    newTool_ = new_OrgGeogebraCommonKernelMacro_initWithOrgGeogebraCommonKernelKernel_withNSString_withOrgGeogebraCommonKernelGeosGeoElementArray_withOrgGeogebraCommonKernelGeosGeoElementArray_(kernel_, @"newTool", input, output);
    return YES;
  }
...
- (void)moveOutputUpWithJavaUtilArrayList:(JavaUtilArrayList *)selIndices {
  for (jint i = 0; i < [((JavaUtilArrayList *) nil_chk(selIndices)) size]; i++) {
    ...
    if (selectedIndex > 0) {
      ...
      (void) [selIndices setWithInt:i withId:JavaLangInteger_valueOfWithInt_(selectedIndex - 1)];
    }
  }
  [((id<OrgGeogebraCommonGuiDialogToolInputOutputListener>) nil_chk(listener_)) updateLists];
}
...
void OrgGeogebraCommonGuiDialogToolCreationDialogModel_initLists(OrgGeogebraCommonGuiDialogToolCreationDialogModel *self) {
  self->inputAddList_ = new_OrgGeogebraCommonGuiDialogToolCreationDialogModel_$1_initWithOrgGeogebraCommonGuiDialogToolCreationDialogModel_(self);
  self->outputAddList_ = new_OrgGeogebraCommonGuiDialogToolInputOutputList_init();
  self->inputList_ = new_OrgGeogebraCommonGuiDialogToolCreationDialogModel_$2_initWithOrgGeogebraCommonGuiDialogToolCreationDialogModel_(self);
  self->outputList_ = new_OrgGeogebraCommonGuiDialogToolCreationDialogModel_$3_initWithOrgGeogebraCommonGuiDialogToolCreationDialogModel_(self);
}
...
void OrgGeogebraCommonGuiDialogToolCreationDialogModel_$1_initWithOrgGeogebraCommonGuiDialogToolCreationDialogModel_(OrgGeogebraCommonGuiDialogToolCreationDialogModel_$1 *self, OrgGeogebraCommonGuiDialogToolCreationDialogModel *outer$) {
  self->this$0_ = outer$;
  (void) OrgGeogebraCommonGuiDialogToolInputOutputList_init(self);
}
