...
- (void)setEditGeoWithOrgGeogebraCommonKernelGeosGeoText:(OrgGeogebraCommonKernelGeosGeoText *)editGeo {
  OrgGeogebraCommonGuiDialogOptionsModelTextOptionsModel_set_editGeo_(self, editGeo);
  OrgGeogebraCommonGuiDialogOptionsModelTextOptionsModel_set_lastGeo_(self, editGeo);
}
...
- (void)applyEditedGeoWithNSString:(NSString *)text
  ...
  [geo0 updateRepaint];
  OrgGeogebraCommonGuiDialogOptionsModelTextOptionsModel_set_editGeo_(self, nil);
}
...
void OrgGeogebraCommonGuiDialogOptionsModelTextOptionsModel_initWithOrgGeogebraCommonMainApp_withOrgGeogebraCommonGuiDialogOptionsModelTextOptionsModel_ITextOptionsListener_(OrgGeogebraCommonGuiDialogOptionsModelTextOptionsModel *self, OrgGeogebraCommonMainApp *app, id<OrgGeogebraCommonGuiDialogOptionsModelTextOptionsModel_ITextOptionsListener> listener) {
  ...
  OrgGeogebraCommonGuiDialogOptionsModelTextOptionsModel_setAndConsume_fonts_(self, [IOSObjectArray newArrayWithObjects:(id[]){ @"Sans Serif", @"Serif" } count:2 type:NSString_class_()]);
  OrgGeogebraCommonGuiDialogOptionsModelTextOptionsModel_set_listener_(self, listener);
  OrgGeogebraCommonGuiDialogOptionsModelTextOptionsModel_set_app_(self, app);
  OrgGeogebraCommonGuiDialogOptionsModelTextOptionsModel_set_loc_(self, [((OrgGeogebraCommonMainApp *) nil_chk(app)) getLocalization]);
  OrgGeogebraCommonGuiDialogOptionsModelTextOptionsModel_setAndConsume_dTProcessor_(self, new_OrgGeogebraCommonGuiInputfieldDynamicTextProcessor_initWithOrgGeogebraCommonMainApp_(app));
  OrgGeogebraCommonGuiDialogOptionsModelTextOptionsModel_set_editGeo_(self, nil);
  OrgGeogebraCommonGuiDialogOptionsModelTextOptionsModel_set_lastGeo_(self, nil);
}
