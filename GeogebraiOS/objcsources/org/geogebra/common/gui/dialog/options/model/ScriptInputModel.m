...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/gui/dialog/options/model/ScriptInputModel.java
//
...
- (void)setGeoWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  ...
  OrgGeogebraCommonGuiDialogOptionsModelScriptInputModel_set_geo_(self, geo);
  if (geo != nil) {
...
- (void)setGlobal {
  ...
  handlingDocumentEventOff_ = YES;
  OrgGeogebraCommonGuiDialogOptionsModelScriptInputModel_set_geo_(self, nil);
  global_ = YES;
...
- (void)setScriptTypeWithOrgGeogebraCommonPluginScriptTypeEnum:(OrgGeogebraCommonPluginScriptTypeEnum *)scriptType {
  OrgGeogebraCommonGuiDialogOptionsModelScriptInputModel_set_scriptType_(self, scriptType);
  NSString *scriptStr;
...
void OrgGeogebraCommonGuiDialogOptionsModelScriptInputModel_initWithOrgGeogebraCommonMainApp_withOrgGeogebraCommonGuiDialogOptionsModelScriptInputModel_IScriptInputListener_withBoolean_withBoolean_(OrgGeogebraCommonGuiDialogOptionsModelScriptInputModel *self, OrgGeogebraCommonMainApp *app, id<OrgGeogebraCommonGuiDialogOptionsModelScriptInputModel_IScriptInputListener> listener, jboolean updateScript, jboolean forceJavaScript) {
  ...
  self->global_ = NO;
  OrgGeogebraCommonGuiDialogOptionsModelScriptInputModel_set_scriptType_(self, OrgGeogebraCommonPluginScriptTypeEnum_get_GGBSCRIPT());
  self->updateScript_ = NO;
  self->handlingDocumentEventOff_ = NO;
  self->editOccurred_ = NO;
  OrgGeogebraCommonGuiDialogOptionsModelScriptInputModel_set_app_(self, app);
  OrgGeogebraCommonGuiDialogOptionsModelScriptInputModel_set_listener_(self, listener);
  self->updateScript_ = updateScript;
  OrgGeogebraCommonGuiDialogOptionsModelScriptInputModel_setAndConsume_inputHandler_(self, new_OrgGeogebraCommonGuiDialogOptionsModelScriptInputModel_TextInputHandler_initWithOrgGeogebraCommonGuiDialogOptionsModelScriptInputModel_(self));
}
...
void OrgGeogebraCommonGuiDialogOptionsModelScriptInputModel_TextInputHandler_initWithOrgGeogebraCommonGuiDialogOptionsModelScriptInputModel_(OrgGeogebraCommonGuiDialogOptionsModelScriptInputModel_TextInputHandler *self, OrgGeogebraCommonGuiDialogOptionsModelScriptInputModel *outer$) {
  OrgGeogebraCommonGuiDialogOptionsModelScriptInputModel_TextInputHandler_set_this$0_(self, outer$);
  NSObject_init(self);
  OrgGeogebraCommonGuiDialogOptionsModelScriptInputModel_TextInputHandler_set_kernel_(self, [((OrgGeogebraCommonMainApp *) nil_chk(outer$->app_)) getKernel]);
}
