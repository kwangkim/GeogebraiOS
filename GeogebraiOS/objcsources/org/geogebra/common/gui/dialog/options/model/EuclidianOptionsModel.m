...
- (void)fillTooltipCombo {
  IOSObjectArray *tooltipItems = [IOSObjectArray arrayWithObjects:(id[]){ [((OrgGeogebraCommonMainApp *) nil_chk(app_)) getPlainWithNSString:@"On"], [app_ getPlainWithNSString:@"Automatic"], [app_ getPlainWithNSString:@"Off"] } count:3 type:NSString_class_()];
  {
...
- (void)fillGridTypeCombo {
  ...
  IOSObjectArray_Set(gridTypes, OrgGeogebraCommonEuclidianEuclidianView_GRID_CARTESIAN, [((OrgGeogebraCommonMainApp *) nil_chk(app_)) getMenuWithNSString:@"Cartesian"]);
  IOSObjectArray_Set(gridTypes, OrgGeogebraCommonEuclidianEuclidianView_GRID_ISOMETRIC, [app_ getMenuWithNSString:@"Isometric"]);
  IOSObjectArray_Set(gridTypes, OrgGeogebraCommonEuclidianEuclidianView_GRID_POLAR, [app_ getMenuWithNSString:@"Polar"]);
  {
...
void OrgGeogebraCommonGuiDialogOptionsModelEuclidianOptionsModel_initWithOrgGeogebraCommonMainApp_withOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonGuiDialogOptionsModelEuclidianOptionsModel_IEuclidianOptionsListener_(OrgGeogebraCommonGuiDialogOptionsModelEuclidianOptionsModel *self, OrgGeogebraCommonMainApp *app, OrgGeogebraCommonEuclidianEuclidianView *view, id<OrgGeogebraCommonGuiDialogOptionsModelEuclidianOptionsModel_IEuclidianOptionsListener> listener) {
  NSObject_init(self);
  OrgGeogebraCommonGuiDialogOptionsModelEuclidianOptionsModel_set_app_(self, app);
  OrgGeogebraCommonGuiDialogOptionsModelEuclidianOptionsModel_set_view_(self, view);
  OrgGeogebraCommonGuiDialogOptionsModelEuclidianOptionsModel_set_listener_(self, listener);
}
