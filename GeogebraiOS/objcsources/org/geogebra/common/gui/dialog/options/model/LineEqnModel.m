...
- (id<JavaUtilList>)getChoichesWithOrgGeogebraCommonMainLocalization:(OrgGeogebraCommonMainLocalization *)loc {
  return JavaUtilArrays_asListWithNSObjectArray_([IOSObjectArray newArrayWithObjects:(id[]){ [((OrgGeogebraCommonMainLocalization *) nil_chk(loc)) getPlainWithNSString:@"ImplicitLineEquation"], [loc getPlainWithNSString:@"ExplicitLineEquation"], [loc getPlainWithNSString:@"ParametricForm"] } count:3 type:NSString_class_()]);
}
