...
- (id<JavaUtilList>)getChoichesWithOrgGeogebraCommonMainLocalization:(OrgGeogebraCommonMainLocalization *)loc {
  return JavaUtilArrays_asListWithNSObjectArray_([IOSObjectArray newArrayWithObjects:(id[]){ [((OrgGeogebraCommonMainLocalization *) nil_chk(loc)) getMenuWithNSString:@"Filling.Standard"], [loc getMenuWithNSString:@"Filling.Hatch"], [loc getMenuWithNSString:@"Filling.Crosshatch"], [loc getMenuWithNSString:@"Filling.Chessboard"], [loc getMenuWithNSString:@"Filling.Dotted"], [loc getMenuWithNSString:@"Filling.Honeycomb"], [loc getMenuWithNSString:@"Filling.Brick"], [loc getMenuWithNSString:@"Filling.Weaving"], [loc getMenuWithNSString:@"Filling.Symbol"], [loc getMenuWithNSString:@"Filling.Image"] } count:10 type:NSString_class_()]);
}
...
- (void)applyFillTypeWithInt:(jint)index {
  fillType_ = [self getFillTypeAtWithInt:index];
  OrgGeogebraCommonKernelGeosGeoElement *geo0 = [self getGeoAtWithInt:0];
