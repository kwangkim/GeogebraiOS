...
- (void)addWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  OrgGeogebraCommonGuiDialogOptionsOptionsObject_set_geoAdded_(self, geo);
}

- (void)forgetGeoAdded {
  OrgGeogebraCommonGuiDialogOptionsOptionsObject_set_geoAdded_(self, nil);
}
...
- (NSString *)getSelectionDescription {
  if (selection_ == nil || [selection_ size] == 0) {
    ...
    [sb_ appendWithNSString:[((OrgGeogebraCommonMainLocalization *) nil_chk([((OrgGeogebraCommonMainApp *) nil_chk(app_)) getLocalization])) getPlainWithNSString:@"PropertiesOfA" withNSString:[((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(geo)) getNameDescriptionHTMLWithBoolean:NO withBoolean:NO]]];
    [sb_ appendWithNSString:@"</html>"];
...
void OrgGeogebraCommonGuiDialogOptionsOptionsObject_init(OrgGeogebraCommonGuiDialogOptionsOptionsObject *self) {
  ...
  OrgGeogebraCommonGuiDialogOptionsOptionsObject_set_geoAdded_(self, nil);
  self->firstTime_ = YES;
  OrgGeogebraCommonGuiDialogOptionsOptionsObject_setAndConsume_sb_(self, new_JavaLangStringBuilder_init());
}
