...
- (void)setTextWithNSString:(NSString *)text1 {
  OrgGeogebraCommonGuiInputfieldColorProvider_set_text_(self, text1);
...
- (void)setIsCasInputWithBoolean:(jboolean)isCasInput1 {
  if (isCasInput_ != isCasInput1) {
    ...
    OrgGeogebraCommonGuiInputfieldColorProvider_set_assignmentReg_(self, OrgGeogebraCommonGuiInputfieldColorProvider_createAssignmentRegExpWithBoolean_(isCasInput_));
  }
}
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonGuiInputfieldColorProvider class]) {
    JreStrongAssign(&OrgGeogebraCommonGuiInputfieldColorProvider_COLOR_DEFINED_, nil, OrgGeogebraCommonMainGeoGebraColorConstants_get_DEFINED_OBJECT_COLOR_());
    JreStrongAssign(&OrgGeogebraCommonGuiInputfieldColorProvider_COLOR_UNDEFINED_, nil, OrgGeogebraCommonMainGeoGebraColorConstants_get_UNDEFINED_OBJECT_COLOR_());
    JreStrongAssign(&OrgGeogebraCommonGuiInputfieldColorProvider_COLOR_LOCAL_, nil, OrgGeogebraCommonMainGeoGebraColorConstants_get_LOCAL_OBJECT_COLOR_());
    JreStrongAssign(&OrgGeogebraCommonGuiInputfieldColorProvider_COLOR_DEFAULT_, nil, OrgGeogebraCommonMainGeoGebraColorConstants_get_BLACK_());
...
void OrgGeogebraCommonGuiInputfieldColorProvider_initWithOrgGeogebraCommonMainApp_withBoolean_(OrgGeogebraCommonGuiInputfieldColorProvider *self, OrgGeogebraCommonMainApp *app, jboolean isCasInput1) {
  NSObject_init(self);
  OrgGeogebraCommonGuiInputfieldColorProvider_set_commandReg_(self, ComGoogleGwtRegexpSharedRegExp_compileWithNSString_withNSString_(JreStrcat("$$$$", OrgGeogebraCommonGuiInputfieldColorProvider_LABEL_REGEX_STRING_, @"\\[(", OrgGeogebraCommonGuiInputfieldColorProvider_STRING_, @"|,)\\]"), @"g"));
  OrgGeogebraCommonGuiInputfieldColorProvider_set_commandParamReg_(self, ComGoogleGwtRegexpSharedRegExp_compileWithNSString_withNSString_(@"<(\\p{L}\\p{M}*| |\\-)*>", @"g"));
  OrgGeogebraCommonGuiInputfieldColorProvider_set_splitter_(self, ComGoogleGwtRegexpSharedRegExp_compileWithNSString_(@","));
  OrgGeogebraCommonGuiInputfieldColorProvider_set_assignmentReg_(self, OrgGeogebraCommonGuiInputfieldColorProvider_createAssignmentRegExpWithBoolean_(self->isCasInput_));
  OrgGeogebraCommonGuiInputfieldColorProvider_set_kernel_(self, [((OrgGeogebraCommonMainApp *) nil_chk(app)) getKernel]);
  [self setIsCasInputWithBoolean:isCasInput1];
  OrgGeogebraCommonGuiInputfieldColorProvider_set_labels_(self, nil);
  OrgGeogebraCommonGuiInputfieldColorProvider_set_locals_(self, nil);
  OrgGeogebraCommonGuiInputfieldColorProvider_setAndConsume_definedObjectsIntervals_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonGuiInputfieldColorProvider_setAndConsume_undefinedObjectsIntervals_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonGuiInputfieldColorProvider_setAndConsume_ignoreIntervals_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonGuiInputfieldColorProvider_setAndConsume_localVariableIntervals_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonGuiInputfieldColorProvider_set_pf_(self, [app getParserFunctions]);
  OrgGeogebraCommonGuiInputfieldColorProvider_set_text_(self, @"");
}
...
void OrgGeogebraCommonGuiInputfieldColorProvider_getIntervals(OrgGeogebraCommonGuiInputfieldColorProvider *self) {
  if (self->isCasInput_) {
    OrgGeogebraCommonGuiInputfieldColorProvider_set_labels_(self, [((OrgGeogebraCommonKernelConstruction *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) getConstruction])) getAllLabels]);
  }
  else {
    OrgGeogebraCommonGuiInputfieldColorProvider_set_labels_(self, [((OrgGeogebraCommonKernelConstruction *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) getConstruction])) getAllGeoLabels]);
  }
  OrgGeogebraCommonGuiInputfieldColorProvider_setAndConsume_locals_(self, new_JavaUtilHashSet_init());
...
void OrgGeogebraCommonGuiInputfieldColorProvider_getIntervalsRecursivelyWithNSString_withInt_(OrgGeogebraCommonGuiInputfieldColorProvider *self, NSString *text1, jint startIndex) {
  OrgGeogebraCommonGuiInputfieldColorProvider_MyLabelParamRegExp *labelParam = [new_OrgGeogebraCommonGuiInputfieldColorProvider_MyLabelParamRegExp_initWithOrgGeogebraCommonGuiInputfieldColorProvider_withNSString_(self, text1) autorelease];
...
void OrgGeogebraCommonGuiInputfieldColorProvider_MyMatchResult_initWithOrgGeogebraCommonGuiInputfieldColorProvider_withInt_withNSString_withJavaUtilList_withBoolean_(OrgGeogebraCommonGuiInputfieldColorProvider_MyMatchResult *self, OrgGeogebraCommonGuiInputfieldColorProvider *outer$, jint index, NSString *input, id<JavaUtilList> groups, jboolean isCommand) {
  NSObject_init(self);
  self->index_ = index;
  OrgGeogebraCommonGuiInputfieldColorProvider_MyMatchResult_set_input_(self, input);
  OrgGeogebraCommonGuiInputfieldColorProvider_MyMatchResult_set_groups_(self, groups);
...
- (OrgGeogebraCommonGuiInputfieldColorProvider_MyMatchResult *)exec {
  ...
  ret = [new_OrgGeogebraCommonGuiInputfieldColorProvider_MyMatchResult_initWithOrgGeogebraCommonGuiInputfieldColorProvider_withInt_withNSString_withJavaUtilList_withBoolean_(this$0_, index_ + [res getIndex], input_, groups, [@"[" isEqual:openingBracket]) autorelease];
  index_ += step;
  OrgGeogebraCommonGuiInputfieldColorProvider_MyLabelParamRegExp_set_text_(self, [((NSString *) nil_chk(text_)) substring:step]);
  return ret;
}

- (void)setTextWithNSString:(NSString *)text {
  OrgGeogebraCommonGuiInputfieldColorProvider_MyLabelParamRegExp_set_text_(self, text);
  OrgGeogebraCommonGuiInputfieldColorProvider_MyLabelParamRegExp_set_input_(self, text);
  index_ = 0;
}
...
void OrgGeogebraCommonGuiInputfieldColorProvider_MyLabelParamRegExp_initWithOrgGeogebraCommonGuiInputfieldColorProvider_withNSString_(OrgGeogebraCommonGuiInputfieldColorProvider_MyLabelParamRegExp *self, OrgGeogebraCommonGuiInputfieldColorProvider *outer$, NSString *text) {
  OrgGeogebraCommonGuiInputfieldColorProvider_MyLabelParamRegExp_set_this$0_(self, outer$);
  NSObject_init(self);
  OrgGeogebraCommonGuiInputfieldColorProvider_MyLabelParamRegExp_set_regExp_(self, ComGoogleGwtRegexpSharedRegExp_compileWithNSString_(OrgGeogebraCommonGuiInputfieldColorProvider_get_LABEL_PARAM_()));
