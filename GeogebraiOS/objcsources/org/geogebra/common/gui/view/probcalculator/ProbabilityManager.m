...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/gui/view/probcalculator/ProbabilityManager.java
//
...
- (JavaUtilHashMap *)getDistributionMap {
  JavaUtilHashMap *plotMap = new_JavaUtilHashMap_init();
  (void) [plotMap putWithId:OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_NORMAL() withId:[((OrgGeogebraCommonMainLocalization *) nil_chk(loc_)) getMenuWithNSString:@"Distribution.Normal"]];
  (void) [plotMap putWithId:OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_STUDENT() withId:[loc_ getMenuWithNSString:@"Distribution.StudentT"]];
  (void) [plotMap putWithId:OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_CHISQUARE() withId:[loc_ getMenuWithNSString:@"Distribution.ChiSquare"]];
  (void) [plotMap putWithId:OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_F() withId:[loc_ getMenuWithNSString:@"Distribution.F"]];
  (void) [plotMap putWithId:OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_EXPONENTIAL() withId:[loc_ getMenuWithNSString:@"Distribution.Exponential"]];
  (void) [plotMap putWithId:OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_CAUCHY() withId:[loc_ getMenuWithNSString:@"Distribution.Cauchy"]];
  (void) [plotMap putWithId:OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_WEIBULL() withId:[loc_ getMenuWithNSString:@"Distribution.Weibull"]];
  (void) [plotMap putWithId:OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_LOGISTIC() withId:[loc_ getCommandWithNSString:@"Logistic"]];
  (void) [plotMap putWithId:OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_LOGNORMAL() withId:[loc_ getCommandWithNSString:@"LogNormal"]];
  (void) [plotMap putWithId:OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_GAMMA() withId:[loc_ getMenuWithNSString:@"Distribution.Gamma"]];
  (void) [plotMap putWithId:OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_BINOMIAL() withId:[loc_ getMenuWithNSString:@"Distribution.Binomial"]];
  (void) [plotMap putWithId:OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_PASCAL() withId:[loc_ getMenuWithNSString:@"Distribution.Pascal"]];
  (void) [plotMap putWithId:OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_POISSON() withId:[loc_ getMenuWithNSString:@"Distribution.Poisson"]];
  (void) [plotMap putWithId:OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_HYPERGEOMETRIC() withId:[loc_ getMenuWithNSString:@"Distribution.Hypergeometric"]];
  return plotMap;
}

- (JavaUtilHashMap *)getReverseDistributionMap {
  JavaUtilHashMap *plotMap = [self getDistributionMap];
  JavaUtilHashMap *plotMapReverse = new_JavaUtilHashMap_init();
  for (OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum * __strong key in nil_chk([((JavaUtilHashMap *) nil_chk(plotMap)) keySet])) {
    (void) [plotMapReverse putWithId:[plotMap getWithId:key] withId:key];
  }
...
- (IOSDoubleArray *)getPlotDimensionsWithOrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum:(OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum *)selectedDist
  ...
  IOSDoubleArray *d = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ xMin, xMax, yMin, yMax } count:4];
  return d;
}
...
- (IOSObjectArray *)getDistributionMeasuresWithOrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum:(OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum *)selectedDist
  ...
  IOSObjectArray *d = [IOSObjectArray newArrayWithObjects:(id[]){ mean, sigma } count:2 type:JavaLangDouble_class_()];
  return d;
}
...
withOrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum:(OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum *)distType
  ...
  if (((IOSDoubleArray *) nil_chk(parms))->size_ > 0) {
    param1 = new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel, IOSDoubleArray_Get(parms, 0));
  }
  if (parms->size_ > 1) {
    param2 = new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel, IOSDoubleArray_Get(parms, 1));
  }
  if (parms->size_ > 2) {
    param3 = new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel, IOSDoubleArray_Get(parms, 2));
  }
  OrgGeogebraCommonKernelStatisticsAlgoDistribution *algo = OrgGeogebraCommonGuiViewProbcalculatorProbabilityManager_getCommandWithOrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_withOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withBoolean_(distType, cons, param1, param2, param3, new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel, value), isCumulative);
...
IOSObjectArray *OrgGeogebraCommonGuiViewProbcalculatorProbabilityManager_getParameterLabelArrayWithOrgGeogebraCommonMainApp_(OrgGeogebraCommonMainApp *app) {
  ...
  IOSObjectArray *parameterLabels = [IOSObjectArray newArrayWithDimensions:2 lengths:(jint[]){ OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_get_distCount_(), 4 } type:NSString_class_()];
  (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(parameterLabels, [((OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum *) nil_chk(OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_NORMAL())) ordinal])), 0, [((OrgGeogebraCommonMainApp *) nil_chk(app)) getMenuWithNSString:@"Mean.short"]);
  (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(parameterLabels, [OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_NORMAL() ordinal])), 1, [app getMenuWithNSString:@"StandardDeviation.short"]);
  (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(parameterLabels, [((OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum *) nil_chk(OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_STUDENT())) ordinal])), 0, [app getMenuWithNSString:@"DegreesOfFreedom.short"]);
  (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(parameterLabels, [((OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum *) nil_chk(OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_CHISQUARE())) ordinal])), 0, [app getMenuWithNSString:@"DegreesOfFreedom.short"]);
  (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(parameterLabels, [((OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum *) nil_chk(OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_F())) ordinal])), 0, [app getMenuWithNSString:@"DegreesOfFreedom1.short"]);
  (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(parameterLabels, [OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_F() ordinal])), 1, [app getMenuWithNSString:@"DegreesOfFreedom2.short"]);
  (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(parameterLabels, [((OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum *) nil_chk(OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_EXPONENTIAL())) ordinal])), 0, JreStrcat("C", OrgGeogebraCommonUtilUnicode_lambda));
  (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(parameterLabels, [((OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum *) nil_chk(OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_CAUCHY())) ordinal])), 0, [app getMenuWithNSString:@"Median"]);
  (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(parameterLabels, [OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_CAUCHY() ordinal])), 1, [app getMenuWithNSString:@"Distribution.Scale"]);
  (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(parameterLabels, [((OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum *) nil_chk(OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_WEIBULL())) ordinal])), 0, [app getMenuWithNSString:@"Distribution.Shape"]);
  (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(parameterLabels, [OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_WEIBULL() ordinal])), 1, [app getMenuWithNSString:@"Distribution.Scale"]);
  (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(parameterLabels, [((OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum *) nil_chk(OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_LOGISTIC())) ordinal])), 0, [app getMenuWithNSString:@"Mean.short"]);
  (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(parameterLabels, [OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_LOGISTIC() ordinal])), 1, [app getMenuWithNSString:@"Distribution.Scale"]);
  (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(parameterLabels, [((OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum *) nil_chk(OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_LOGNORMAL())) ordinal])), 0, [app getMenuWithNSString:@"Mean.short"]);
  (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(parameterLabels, [OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_LOGNORMAL() ordinal])), 1, [app getMenuWithNSString:@"StandardDeviation.short"]);
  (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(parameterLabels, [((OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum *) nil_chk(OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_GAMMA())) ordinal])), 0, [app getMenuWithNSString:@"Alpha.short"]);
  (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(parameterLabels, [OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_GAMMA() ordinal])), 1, [app getMenuWithNSString:@"Beta.short"]);
  (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(parameterLabels, [((OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum *) nil_chk(OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_BINOMIAL())) ordinal])), 0, [app getMenuWithNSString:@"Binomial.number"]);
  (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(parameterLabels, [OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_BINOMIAL() ordinal])), 1, [app getMenuWithNSString:@"Binomial.probability"]);
  (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(parameterLabels, [((OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum *) nil_chk(OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_PASCAL())) ordinal])), 0, [app getMenuWithNSString:@"Binomial.number"]);
  (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(parameterLabels, [OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_PASCAL() ordinal])), 1, [app getMenuWithNSString:@"Binomial.probability"]);
  (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(parameterLabels, [((OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum *) nil_chk(OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_POISSON())) ordinal])), 0, [app getMenuWithNSString:@"Mean.short"]);
  (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(parameterLabels, [((OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum *) nil_chk(OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_HYPERGEOMETRIC())) ordinal])), 0, [app getMenuWithNSString:@"Hypergeometric.population"]);
  (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(parameterLabels, [OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_HYPERGEOMETRIC() ordinal])), 1, [app getMenuWithNSString:@"Hypergeometric.number"]);
  (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(parameterLabels, [OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_HYPERGEOMETRIC() ordinal])), 2, [app getMenuWithNSString:@"Hypergeometric.sample"]);
...
OrgGeogebraCommonKernelStatisticsAlgoDistribution *OrgGeogebraCommonGuiViewProbcalculatorProbabilityManager_getInverseCommandWithOrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_withOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_(OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum *d, OrgGeogebraCommonKernelConstruction *cons, id<OrgGeogebraCommonKernelArithmeticNumberValue> param1, id<OrgGeogebraCommonKernelArithmeticNumberValue> param2, id<OrgGeogebraCommonKernelArithmeticNumberValue> param3, id<OrgGeogebraCommonKernelArithmeticNumberValue> x) {
  ...
  switch ([d ordinal]) {
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_NORMAL:
    ret = new_OrgGeogebraCommonKernelStatisticsAlgoInverseNormal_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons, param1, param2, x);
    break;
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_LOGNORMAL:
    ret = new_OrgGeogebraCommonKernelStatisticsAlgoInverseLogNormal_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons, param1, param2, x);
    break;
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_LOGISTIC:
    ret = new_OrgGeogebraCommonKernelStatisticsAlgoInverseLogistic_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons, param1, param2, x);
    break;
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_STUDENT:
    ret = new_OrgGeogebraCommonKernelStatisticsAlgoInverseTDistribution_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons, param1, x);
    break;
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_CHISQUARE:
    ret = new_OrgGeogebraCommonKernelStatisticsAlgoInverseChiSquared_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons, param1, x);
    break;
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_F:
    ret = new_OrgGeogebraCommonKernelStatisticsAlgoInverseFDistribution_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons, param1, param2, x);
    break;
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_CAUCHY:
    ret = new_OrgGeogebraCommonKernelStatisticsAlgoInverseCauchy_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons, param1, param2, x);
    break;
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_EXPONENTIAL:
    ret = new_OrgGeogebraCommonKernelStatisticsAlgoInverseExponential_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons, param1, x);
    break;
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_GAMMA:
    ret = new_OrgGeogebraCommonKernelStatisticsAlgoInverseGamma_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons, param1, param2, x);
    break;
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_WEIBULL:
    ret = new_OrgGeogebraCommonKernelStatisticsAlgoInverseWeibull_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons, param1, param2, x);
    break;
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_BINOMIAL:
    ret = new_OrgGeogebraCommonKernelStatisticsAlgoInverseBinomial_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons, param1, param2, x);
    break;
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_PASCAL:
    ret = new_OrgGeogebraCommonKernelStatisticsAlgoInversePascal_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons, param1, param2, x);
    break;
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_POISSON:
    ret = new_OrgGeogebraCommonKernelStatisticsAlgoInversePoisson_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons, param1, x);
    break;
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_HYPERGEOMETRIC:
    ret = new_OrgGeogebraCommonKernelStatisticsAlgoInverseHyperGeometric_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons, nil, param1, param2, param3, x);
    break;
  }
  if (ret != nil) {
...
OrgGeogebraCommonKernelStatisticsAlgoDistribution *OrgGeogebraCommonGuiViewProbcalculatorProbabilityManager_getCommandWithOrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_withOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withBoolean_(OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum *d, OrgGeogebraCommonKernelConstruction *cons, id<OrgGeogebraCommonKernelArithmeticNumberValue> param1, id<OrgGeogebraCommonKernelArithmeticNumberValue> param2, id<OrgGeogebraCommonKernelArithmeticNumberValue> param3, id<OrgGeogebraCommonKernelArithmeticNumberValue> x, jboolean isCumulative) {
  ...
  switch ([d ordinal]) {
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_NORMAL:
    ret = new_OrgGeogebraCommonKernelStatisticsAlgoNormal_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons, param1, param2, x);
    break;
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_STUDENT:
    ret = new_OrgGeogebraCommonKernelStatisticsAlgoTDistribution_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons, param1, x);
    break;
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_CHISQUARE:
    ret = new_OrgGeogebraCommonKernelStatisticsAlgoChiSquared_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons, param1, x);
    break;
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_F:
    ret = new_OrgGeogebraCommonKernelStatisticsAlgoFDistribution_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons, param1, param2, x);
    break;
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_CAUCHY:
    ret = new_OrgGeogebraCommonKernelStatisticsAlgoCauchy_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons, param1, param2, x);
    break;
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_EXPONENTIAL:
    ret = new_OrgGeogebraCommonKernelStatisticsAlgoExponential_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons, param1, x);
    break;
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_GAMMA:
    ret = new_OrgGeogebraCommonKernelStatisticsAlgoGamma_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons, param1, param2, x);
    break;
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_WEIBULL:
    ret = new_OrgGeogebraCommonKernelStatisticsAlgoWeibull_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons, param1, param2, x);
    break;
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_BINOMIAL:
    ...
    break;
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_LOGNORMAL:
    ret = new_OrgGeogebraCommonKernelStatisticsAlgoLogNormal_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons, param1, param2, x);
    break;
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_LOGISTIC:
    ret = new_OrgGeogebraCommonKernelStatisticsAlgoLogistic_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons, param1, param2, x);
    break;
    default:
    OrgGeogebraCommonMainApp_errorWithNSString_(@"missing case");
  }
...
jint OrgGeogebraCommonGuiViewProbcalculatorProbabilityManager_getParmCountWithOrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_(OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum *d) {
  ...
  switch ([d ordinal]) {
    ...
    return 3;
    default:
    @throw new_JavaLangError_initWithNSString_(@"unknown distribution");
  }
}
...
IOSDoubleArray *OrgGeogebraCommonGuiViewProbcalculatorProbabilityManager_getDefaultParametersWithOrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_(OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum *d) {
  OrgGeogebraCommonGuiViewProbcalculatorProbabilityManager_initialize();
  JavaUtilHashMap *defaultParameterMap = new_JavaUtilHashMap_init();
  switch ([d ordinal]) {
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_NORMAL:
    return [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 0, 1 } count:2];
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_STUDENT:
    return [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 10 } count:1];
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_CHISQUARE:
    return [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 6 } count:1];
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_F:
    return [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 5, 2 } count:2];
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_EXPONENTIAL:
    return [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 1 } count:1];
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_GAMMA:
    return [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 3, 2 } count:2];
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_CAUCHY:
    return [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 0, 1 } count:2];
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_WEIBULL:
    return [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 5, 1 } count:2];
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_LOGNORMAL:
    return [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 0, 1 } count:2];
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_LOGISTIC:
    return [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 5, 2 } count:2];
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_BINOMIAL:
    return [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 20, 0.5 } count:2];
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_PASCAL:
    return [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 10, 0.5 } count:2];
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_POISSON:
    return [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 4 } count:1];
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_HYPERGEOMETRIC:
    return [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 60, 10, 20 } count:3];
    default:
    OrgGeogebraCommonMainApp_errorWithNSString_(@"missing case");
  }
  return nil;
