...
- (void)setLabelArrays {
  distributionMap_ = [((OrgGeogebraCommonGuiViewProbcalculatorProbabilityManager *) nil_chk(probManager_)) getDistributionMap];
  reverseDistributionMap_ = [probManager_ getReverseDistributionMap];
  parameterLabels_ = OrgGeogebraCommonGuiViewProbcalculatorProbabilityManager_getParameterLabelArrayWithOrgGeogebraCommonMainApp_(app_);
}
...
- (void)setProbabilityCalculatorWithOrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum:(OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum *)distributionType
  ...
  self->selectedDist_ = distributionType;
  self->isCumulative__ = isCumulative;
  self->parameters_ = parameters;
  if (parameters == nil) self->parameters_ = OrgGeogebraCommonGuiViewProbcalculatorProbabilityManager_getDefaultParametersWithOrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_(selectedDist_);
  [self updateAll];
}
...
- (void)createGeoElements {
  ...
  OrgGeogebraCommonKernelAlgosAlgoPointOnPath *algoLow = new_OrgGeogebraCommonKernelAlgosAlgoPointOnPath_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelPath_withDouble_withDouble_(cons_, path, 0.0, 0.0);
  ...
  lowPoint_ = (OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast(IOSObjectArray_Get(nil_chk([algoLow getGeoElements]), 0), [OrgGeogebraCommonKernelGeosGeoPoint class]);
  ...
  OrgGeogebraCommonKernelAlgosAlgoPointOnPath *algoHigh = new_OrgGeogebraCommonKernelAlgosAlgoPointOnPath_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelPath_withDouble_withDouble_(cons_, path, 0.0, 0.0);
  [cons_ removeFromConstructionListWithOrgGeogebraCommonKernelAlgosConstructionElement:algoHigh];
  highPoint_ = (OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast(IOSObjectArray_Get(nil_chk([algoHigh getGeoElements]), 0), [OrgGeogebraCommonKernelGeosGeoPoint class]);
  ...
  if ([((OrgGeogebraCommonGuiViewProbcalculatorProbabilityManager *) nil_chk(probManager_)) isDiscreteWithOrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum:selectedDist_]) {
    ...
    if (graphType_ == OrgGeogebraCommonGuiViewProbcalculatorProbabilityCalculatorView_GRAPH_STEP) {
      ...
      if (graphType_ == OrgGeogebraCommonGuiViewProbcalculatorProbabilityCalculatorView_GRAPH_LINE) {
        id<OrgGeogebraCommonKernelArithmeticNumberValue> zeroWidth = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons_, 0);
        algoBarChart = new_OrgGeogebraCommonKernelAlgosAlgoBarChart_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons_, discreteValueList_, discreteProbList_, zeroWidth);
      }
      else {
        id<OrgGeogebraCommonKernelArithmeticNumberValue> oneWidth = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons_, 1);
        algoBarChart = new_OrgGeogebraCommonKernelAlgosAlgoBarChart_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons_, discreteValueList_, discreteProbList_, oneWidth);
      }
      [cons_ removeFromConstructionListWithOrgGeogebraCommonKernelAlgosConstructionElement:algoBarChart];
      discreteGraph_ = IOSObjectArray_Get(nil_chk([((OrgGeogebraCommonKernelAlgosAlgoBarChart *) nil_chk(algoBarChart)) getGeoElements]), 0);
    }
    ...
    OrgGeogebraCommonKernelArithmeticMyDouble *offset = new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, 1.0 - firstX + 0.5);
    ...
    if (isCumulative__) xLow = new_OrgGeogebraCommonKernelAlgosAlgoDependentNumber_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticExpressionNode_withBoolean_(cons_, highPlusOffset, NO);
    else xLow = new_OrgGeogebraCommonKernelAlgosAlgoDependentNumber_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticExpressionNode_withBoolean_(cons_, lowPlusOffset, NO);
    [cons_ removeFromConstructionListWithOrgGeogebraCommonKernelAlgosConstructionElement:xLow];
    OrgGeogebraCommonKernelAlgosAlgoDependentNumber *xHigh = new_OrgGeogebraCommonKernelAlgosAlgoDependentNumber_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticExpressionNode_withBoolean_(cons_, highPlusOffset, NO);
    [cons_ removeFromConstructionListWithOrgGeogebraCommonKernelAlgosConstructionElement:xHigh];
    OrgGeogebraCommonKernelAlgosAlgoTake *take = new_OrgGeogebraCommonKernelAlgosAlgoTake_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelGeosGeoNumeric_(cons_, discreteValueList_, (OrgGeogebraCommonKernelGeosGeoNumeric *) check_class_cast(IOSObjectArray_Get(nil_chk([((OrgGeogebraCommonKernelAlgosAlgoDependentNumber *) nil_chk(xLow)) getGeoElements]), 0), [OrgGeogebraCommonKernelGeosGeoNumeric class]), (OrgGeogebraCommonKernelGeosGeoNumeric *) check_class_cast(IOSObjectArray_Get(nil_chk([xHigh getGeoElements]), 0), [OrgGeogebraCommonKernelGeosGeoNumeric class]));
    [cons_ removeFromConstructionListWithOrgGeogebraCommonKernelAlgosConstructionElement:take];
    intervalValueList_ = (OrgGeogebraCommonKernelGeosGeoList *) check_class_cast(IOSObjectArray_Get(nil_chk([take getGeoElements]), 0), [OrgGeogebraCommonKernelGeosGeoList class]);
    OrgGeogebraCommonKernelAlgosAlgoTake *take2 = new_OrgGeogebraCommonKernelAlgosAlgoTake_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelGeosGeoNumeric_(cons_, discreteProbList_, (OrgGeogebraCommonKernelGeosGeoNumeric *) check_class_cast(IOSObjectArray_Get(nil_chk([xLow getGeoElements]), 0), [OrgGeogebraCommonKernelGeosGeoNumeric class]), (OrgGeogebraCommonKernelGeosGeoNumeric *) check_class_cast(IOSObjectArray_Get(nil_chk([xHigh getGeoElements]), 0), [OrgGeogebraCommonKernelGeosGeoNumeric class]));
    [cons_ removeFromConstructionListWithOrgGeogebraCommonKernelAlgosConstructionElement:take2];
    intervalProbList_ = (OrgGeogebraCommonKernelGeosGeoList *) check_class_cast(IOSObjectArray_Get(nil_chk([take2 getGeoElements]), 0), [OrgGeogebraCommonKernelGeosGeoList class]);
    if (isCumulative__) {
      OrgGeogebraCommonKernelGeosGeoBoolean *t = new_OrgGeogebraCommonKernelGeosGeoBoolean_initWithOrgGeogebraCommonKernelConstruction_(cons_);
      [t setValueWithBoolean:YES];
      OrgGeogebraCommonKernelAlgosAlgoStickGraph *algoStickGraph = new_OrgGeogebraCommonKernelAlgosAlgoStickGraph_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelGeosGeoBoolean_(cons_, intervalValueList_, intervalProbList_, t);
      [cons_ removeFromConstructionListWithOrgGeogebraCommonKernelAlgosConstructionElement:algoStickGraph];
      discreteIntervalGraph_ = IOSObjectArray_Get(nil_chk([algoStickGraph getGeoElements]), 0);
    }
      ...
      discreteIntervalGraph_ = IOSObjectArray_Get(nil_chk([algoStepGraph2 getGeoElements]), 0);
    }
    else {
      OrgGeogebraCommonKernelAlgosAlgoBarChart *barChart;
      if (graphType_ == OrgGeogebraCommonGuiViewProbcalculatorProbabilityCalculatorView_GRAPH_LINE) {
        id<OrgGeogebraCommonKernelArithmeticNumberValue> zeroWidth2 = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons_, 0.0);
        barChart = new_OrgGeogebraCommonKernelAlgosAlgoBarChart_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons_, intervalValueList_, intervalProbList_, zeroWidth2);
      }
      else {
        id<OrgGeogebraCommonKernelArithmeticNumberValue> oneWidth2 = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons_, 1);
        barChart = new_OrgGeogebraCommonKernelAlgosAlgoBarChart_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons_, intervalValueList_, intervalProbList_, oneWidth2);
      }
      discreteIntervalGraph_ = IOSObjectArray_Get(nil_chk([((OrgGeogebraCommonKernelAlgosAlgoBarChart *) nil_chk(barChart)) getGeoElements]), 0);
    ...
    OrgGeogebraCommonKernelGeosGeoLine *axis = new_OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelConstruction_(cons_);
    ...
    densityCurve_ = OrgGeogebraCommonGuiViewProbcalculatorProbabilityCalculatorView_buildDensityCurveExpressionWithOrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_withBoolean_(self, selectedDist_, isCumulative__);
    if (isCumulative__ && (selectedDist_ == OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_F() || selectedDist_ == OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_EXPONENTIAL())) {
      pdfCurve_ = OrgGeogebraCommonGuiViewProbcalculatorProbabilityCalculatorView_buildDensityCurveExpressionWithOrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_withBoolean_(self, selectedDist_, NO);
    ...
    if (hasIntegral_) {
      OrgGeogebraCommonKernelGeosGeoBoolean *f = new_OrgGeogebraCommonKernelGeosGeoBoolean_initWithOrgGeogebraCommonKernelConstruction_(cons_);
      ...
      integral_ = IOSObjectArray_Get(nil_chk([algoIntegral getGeoElements]), 0);
    ...
    if (isCumulative__) {
      ...
      OrgGeogebraCommonKernelArithmeticMyVecNode *curveVec = new_OrgGeogebraCommonKernelArithmeticMyVecNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, highPointX, curveY);
      OrgGeogebraCommonKernelArithmeticExpressionNode *curvePointNode = new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, curveVec, OrgGeogebraCommonPluginOperationEnum_get_NO_OPERATION(), nil);
      [curvePointNode setForcePoint];
      OrgGeogebraCommonKernelAlgosAlgoDependentPoint *pAlgo = new_OrgGeogebraCommonKernelAlgosAlgoDependentPoint_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticExpressionNode_withBoolean_(cons_, curvePointNode, NO);
      [cons_ removeFromConstructionListWithOrgGeogebraCommonKernelAlgosConstructionElement:pAlgo];
      curvePoint_ = (OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast(IOSObjectArray_Get(nil_chk([pAlgo getGeoElements]), 0), [OrgGeogebraCommonKernelGeosGeoPoint class]);
      ...
      OrgGeogebraCommonKernelArithmeticExpressionNode *point = new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, vec, OrgGeogebraCommonPluginOperationEnum_get_NO_OPERATION(), nil);
      [point setForcePoint];
      OrgGeogebraCommonKernelAlgosAlgoDependentPoint *pointAlgo = new_OrgGeogebraCommonKernelAlgosAlgoDependentPoint_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticExpressionNode_withBoolean_(cons_, point, NO);
      ...
      xSegment_ = IOSObjectArray_Get(nil_chk([seg1 getGeoElements]), 0);
      ...
      OrgGeogebraCommonKernelArithmeticExpressionNode *pointy = new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, vecy, OrgGeogebraCommonPluginOperationEnum_get_NO_OPERATION(), nil);
      [pointy setForcePoint];
      OrgGeogebraCommonKernelGeosGeoVector *v = new_OrgGeogebraCommonKernelGeosGeoVector_initWithOrgGeogebraCommonKernelConstruction_(cons_);
      [v setCoordsWithDouble:-1.0 withDouble:0.0 withDouble:1.0];
      OrgGeogebraCommonKernelAlgosAlgoRayPointVector *seg2 = new_OrgGeogebraCommonKernelAlgosAlgoRayPointVector_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoVector_(cons_, curvePoint_, v);
      [cons_ removeFromConstructionListWithOrgGeogebraCommonKernelAlgosConstructionElement:seg2];
      ySegment_ = IOSObjectArray_Get(nil_chk([seg2 getGeoElements]), 0);
  ...
  if (showNormalOverlay_) {
    ...
    if (IOSObjectArray_Get(nil_chk(m), 0) != nil && IOSObjectArray_Get(m, 1) != nil) {
      normalOverlay_ = [self createNormalCurveOverlayWithDouble:[((JavaLangDouble *) nil_chk(IOSObjectArray_Get(m, 0))) doubleValue] withDouble:[((JavaLangDouble *) nil_chk(IOSObjectArray_Get(m, 1))) doubleValue]];
...
- (OrgGeogebraCommonKernelAlgosAlgoPolyLine *)createStepFunctionWithOrgGeogebraCommonKernelGeosGeoList:(OrgGeogebraCommonKernelGeosGeoList *)xList
  ...
  IOSDoubleArray *xCoords = [IOSDoubleArray newArrayWithLength:[((OrgGeogebraCommonKernelGeosGeoList *) nil_chk(xList)) size]];
  IOSDoubleArray *yCoords = [IOSDoubleArray newArrayWithLength:[((OrgGeogebraCommonKernelGeosGeoList *) nil_chk(probList)) size]];
  ...
  IOSObjectArray *points = [IOSObjectArray newArrayWithLength:2 * n - 1 type:OrgGeogebraCommonKernelGeosGeoPoint_class_()];
  ...
  (void) IOSObjectArray_Set(points, 0, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withNSString_withDouble_withDouble_withDouble_(cons_, nil, IOSDoubleArray_Get(xCoords, 0), IOSDoubleArray_Get(yCoords, 0), 1.0));
  for (jint i = 1; i < n; i++) {
    (void) IOSObjectArray_Set(points, 2 * i - 1, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withNSString_withDouble_withDouble_withDouble_(cons_, nil, IOSDoubleArray_Get(xCoords, i), IOSDoubleArray_Get(yCoords, i - 1), 1.0));
    (void) IOSObjectArray_Set(points, 2 * i, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withNSString_withDouble_withDouble_withDouble_(cons_, nil, IOSDoubleArray_Get(xCoords, i), IOSDoubleArray_Get(yCoords, i), 1.0));
  }
  [cons_ setSuppressLabelCreationWithBoolean:suppressLabelCreation];
  OrgGeogebraCommonKernelAlgosAlgoPolyLine *polyLine = new_OrgGeogebraCommonKernelAlgosAlgoPolyLine_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_withBoolean_(cons_, points, NO);
  return polyLine;
}

- (OrgGeogebraCommonKernelGeosGeoElement *)createNormalCurveOverlayWithDouble:(jdouble)mean
                                                                   withDouble:(jdouble)sigma {
  OrgGeogebraCommonKernelStatisticsAlgoNormalDF *algo = new_OrgGeogebraCommonKernelStatisticsAlgoNormalDF_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticBooleanValue_(cons_, new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons_, mean), new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons_, sigma), new_OrgGeogebraCommonKernelGeosGeoBoolean_initWithOrgGeogebraCommonKernelConstruction_withBoolean_(cons_, isCumulative__));
...
- (void)updatePlotSettings {
  ...
  if (plotSettings_ == nil) plotSettings_ = new_OrgGeogebraCommonGuiViewDataPlotSettings_init();
...
- (void)exportGeosToEVWithInt:(jint)euclidianViewID {
  ...
  JavaUtilArrayList *newGeoList = new_JavaUtilArrayList_init();
  NSString *expr;
  @try {
    [app_ storeUndoInfo];
...
- (jboolean)isValidParameterWithDouble:(jdouble)parameter
                               withInt:(jint)index {
  IOSBooleanArray *isValid = [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ YES, YES, YES } count:3];
  switch ([selectedDist_ ordinal]) {
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_F:
...
- (IOSIntArray *)generateFirstXLastXCommon {
  IOSIntArray *firstXLastX = [IOSIntArray newArrayWithLength:2];
  if (discreteValueList_ == nil) {
    OrgGeogebraCommonGuiViewProbcalculatorProbabilityCalculatorView_createDiscreteLists(self);
  }
...
- (void)getXMLWithJavaLangStringBuilder:(JavaLangStringBuilder *)sb {
  ...
  (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"<probabilityCalculator>\n"];
  (void) [sb appendWithNSString:@"\t<distribution"];
  (void) [sb appendWithNSString:@" type=\""];
  (void) [sb appendWithInt:[((OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum *) nil_chk(selectedDist_)) ordinal]];
  (void) [sb appendWithNSString:@"\""];
  (void) [sb appendWithNSString:@" isCumulative=\""];
  (void) [sb appendWithNSString:isCumulative__ ? @"true" : @"false"];
  (void) [sb appendWithNSString:@"\""];
  (void) [sb appendWithNSString:@" parameters=\""];
  for (jint i = 0; i < ((IOSDoubleArray *) nil_chk(parameters_))->size_; i++) {
    (void) [sb appendWithDouble:IOSDoubleArray_Get(parameters_, i)];
    (void) [sb appendWithNSString:@","];
  }
  (void) [sb deleteCharAtWithInt:[sb lastIndexOfWithNSString:@","]];
  (void) [sb appendWithNSString:@"\""];
  (void) [sb appendWithNSString:@"/>\n"];
  (void) [sb appendWithNSString:@"\t<interval"];
  (void) [sb appendWithNSString:@" mode=\""];
  (void) [sb appendWithInt:self->probMode_];
  (void) [sb appendWithNSString:@"\""];
  (void) [sb appendWithNSString:@" low=\""];
  (void) [sb appendWithDouble:[self getLow]];
  (void) [sb appendWithNSString:@"\""];
  (void) [sb appendWithNSString:@" high=\""];
  (void) [sb appendWithDouble:[self getHigh]];
  (void) [sb appendWithNSString:@"\""];
  (void) [sb appendWithNSString:@"/>\n"];
  (void) [sb appendWithNSString:@"</probabilityCalculator>\n"];
}
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonGuiViewProbcalculatorProbabilityCalculatorView class]) {
    OrgGeogebraCommonGuiViewProbcalculatorProbabilityCalculatorView_COLOR_PDF_ = OrgGeogebraCommonMainGeoGebraColorConstants_get_DARKBLUE_();
    OrgGeogebraCommonGuiViewProbcalculatorProbabilityCalculatorView_COLOR_NORMALOVERLAY_ = OrgGeogebraCommonMainGeoGebraColorConstants_get_RED_();
    OrgGeogebraCommonGuiViewProbcalculatorProbabilityCalculatorView_COLOR_PDF_FILL_ = OrgGeogebraCommonMainGeoGebraColorConstants_get_BLUE_();
    OrgGeogebraCommonGuiViewProbcalculatorProbabilityCalculatorView_COLOR_POINT_ = OrgGeogebraCommonAwtGColor_get_BLACK_();
...
void OrgGeogebraCommonGuiViewProbcalculatorProbabilityCalculatorView_initWithOrgGeogebraCommonMainApp_(OrgGeogebraCommonGuiViewProbcalculatorProbabilityCalculatorView *self, OrgGeogebraCommonMainApp *app) {
  ...
  self->selectedDist_ = OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_get_NORMAL();
  ...
  self->probManager_ = new_OrgGeogebraCommonGuiViewProbcalculatorProbabilityManager_initWithOrgGeogebraCommonMainApp_withOrgGeogebraCommonGuiViewProbcalculatorProbabilityCalculatorView_(app, self);
  self->plotSettings_ = new_OrgGeogebraCommonGuiViewDataPlotSettings_init();
  self->plotGeoList_ = new_JavaUtilArrayList_init();
}
...
void OrgGeogebraCommonGuiViewProbcalculatorProbabilityCalculatorView_createDiscreteLists(OrgGeogebraCommonGuiViewProbcalculatorProbabilityCalculatorView *self) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoDependentNumber *plusOneAlgo;
  {
    ...
    switch ([self->selectedDist_ ordinal]) {
      case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_BINOMIAL:
      k = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(self->cons_);
      k2 = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(self->cons_);
      nGeo = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(self->cons_, IOSDoubleArray_Get(nil_chk(self->parameters_), 0));
      nPlusOneGeo = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(self->cons_, IOSDoubleArray_Get(self->parameters_, 0) + 1);
      pGeo = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(self->cons_, IOSDoubleArray_Get(self->parameters_, 1));
      algoSeq = new_OrgGeogebraCommonKernelAlgosAlgoSequence_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_(self->cons_, k2, k2, new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, 0.0), nGeo, nil);
      self->discreteValueList_ = (OrgGeogebraCommonKernelGeosGeoList *) check_class_cast(IOSObjectArray_Get(nil_chk([algoSeq getGeoElements]), 0), [OrgGeogebraCommonKernelGeosGeoList class]);
      algo = new_OrgGeogebraCommonKernelAlgosAlgoListElement_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelArithmeticNumberValue_(self->cons_, self->discreteValueList_, k);
      ...
      algoSeq = new_OrgGeogebraCommonKernelAlgosAlgoSequence_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_(self->cons_, k, k, new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, 0.0), (id<OrgGeogebraCommonKernelArithmeticNumberValue>) check_protocol_cast(n2Geo, @protocol(OrgGeogebraCommonKernelArithmeticNumberValue)), nil);
      ...
      self->discreteValueList_ = (OrgGeogebraCommonKernelGeosGeoList *) check_class_cast(IOSObjectArray_Get(nil_chk([algoSeq getGeoElements]), 0), [OrgGeogebraCommonKernelGeosGeoList class]);
      algo = new_OrgGeogebraCommonKernelAlgosAlgoListElement_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelArithmeticNumberValue_(self->cons_, self->discreteValueList_, k2);
      ...
      break;
      case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_POISSON:
      meanGeo = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(self->cons_, IOSDoubleArray_Get(nil_chk(self->parameters_), 0));
      k = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(self->cons_);
      k2 = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(self->cons_);
      ...
      lowGeo = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(self->cons_, lowBound);
      highGeo = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(self->cons_, highBound);
      lengthGeo = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(self->cons_, length);
      pGeo = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(self->cons_, p);
      nGeo = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(self->cons_, n);
      sGeo = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(self->cons_, s);
      k = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(self->cons_);
      k2 = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(self->cons_);
...
JavaUtilTreeSet *OrgGeogebraCommonGuiViewProbcalculatorProbabilityCalculatorView_getTempSet(OrgGeogebraCommonGuiViewProbcalculatorProbabilityCalculatorView *self) {
  if (self->tempSet_ == nil) {
    self->tempSet_ = new_JavaUtilTreeSet_init();
  }
...
OrgGeogebraCommonKernelGeosGeoFunction *OrgGeogebraCommonGuiViewProbcalculatorProbabilityCalculatorView_buildDensityCurveExpressionWithOrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum_withBoolean_(OrgGeogebraCommonGuiViewProbcalculatorProbabilityCalculatorView *self, OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DISTEnum *type, jboolean cumulative) {
  ...
  if (((IOSDoubleArray *) nil_chk(self->parameters_))->size_ > 0) {
    param1 = new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, IOSDoubleArray_Get(self->parameters_, 0));
  }
  if (self->parameters_->size_ > 1) {
    param2 = new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, IOSDoubleArray_Get(self->parameters_, 1));
  }
  id<OrgGeogebraCommonKernelStatisticsAlgoDistributionDF> ret = nil;
  OrgGeogebraCommonKernelGeosGeoBoolean *cumulativeGeo = new_OrgGeogebraCommonKernelGeosGeoBoolean_initWithOrgGeogebraCommonKernelConstruction_withBoolean_(self->cons_, cumulative);
  switch ([type ordinal]) {
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_NORMAL:
    ret = new_OrgGeogebraCommonKernelStatisticsAlgoNormalDF_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticBooleanValue_(self->cons_, param1, param2, cumulativeGeo);
    break;
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_STUDENT:
    ret = new_OrgGeogebraCommonKernelStatisticsAlgoTDistributionDF_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticBooleanValue_(self->cons_, param1, cumulativeGeo);
    break;
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_CHISQUARE:
    ret = new_OrgGeogebraCommonKernelStatisticsAlgoChiSquaredDF_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticBooleanValue_(self->cons_, param1, cumulativeGeo);
    break;
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_F:
    ret = new_OrgGeogebraCommonKernelStatisticsAlgoFDistributionDF_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticBooleanValue_(self->cons_, param1, param2, cumulativeGeo);
    break;
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_CAUCHY:
    ret = new_OrgGeogebraCommonKernelStatisticsAlgoCauchyDF_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticBooleanValue_(self->cons_, param1, param2, cumulativeGeo);
    break;
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_EXPONENTIAL:
    ret = new_OrgGeogebraCommonKernelStatisticsAlgoExponentialDF_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticBooleanValue_(self->cons_, param1, cumulativeGeo);
    break;
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_GAMMA:
    ret = new_OrgGeogebraCommonKernelStatisticsAlgoGammaDF_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticBooleanValue_(self->cons_, param1, param2, cumulativeGeo);
    break;
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_WEIBULL:
    ret = new_OrgGeogebraCommonKernelStatisticsAlgoWeibullDF_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticBooleanValue_(self->cons_, param1, param2, cumulativeGeo);
    break;
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_LOGNORMAL:
    ret = new_OrgGeogebraCommonKernelStatisticsAlgoLogNormalDF_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticBooleanValue_(self->cons_, param1, param2, cumulativeGeo);
    break;
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_LOGISTIC:
    ret = new_OrgGeogebraCommonKernelStatisticsAlgoLogisticDF_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticBooleanValue_(self->cons_, param1, param2, cumulativeGeo);
    break;
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_BINOMIAL:
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_PASCAL:
    case OrgGeogebraCommonMainSettingsProbabilityCalculatorSettings_DIST_POISSON:
