...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/gui/view/probcalculator/StatisticsCalculatorProcessor.java
//
...
- (void)doCalculate {
  ...
  switch ([[((OrgGeogebraCommonGuiViewProbcalculatorStatisticsCalculator *) nil_chk(statCalc_)) getSelectedProcedure] ordinal]) {
    ...
    algo = new_OrgGeogebraCommonKernelStatisticsAlgoZMeanEstimate_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelGeosGeoNumeric_(cons_, mean_, sd_, n_, level_);
    [((OrgGeogebraCommonKernelConstruction *) nil_chk(cons_)) removeFromConstructionListWithOrgGeogebraCommonKernelAlgosConstructionElement:algo];
    result = [algo getOutput];
    ...
    algo = new_OrgGeogebraCommonKernelStatisticsAlgoTMeanEstimate_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelGeosGeoNumeric_(cons_, mean_, sd_, n_, level_);
    [((OrgGeogebraCommonKernelConstruction *) nil_chk(cons_)) removeFromConstructionListWithOrgGeogebraCommonKernelAlgosConstructionElement:algo];
    result = [algo getOutput];
    OrgGeogebraCommonGuiViewProbcalculatorStatisticsCalculatorProcessor_setIntervalResultsWithOrgGeogebraCommonKernelGeosGeoElement_(self, IOSObjectArray_Get(nil_chk(result), 0));
    ...
    algo = new_OrgGeogebraCommonKernelStatisticsAlgoZProportionEstimate_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelGeosGeoNumeric_(cons_, proportion_, n_, level_);
    [((OrgGeogebraCommonKernelConstruction *) nil_chk(cons_)) removeFromConstructionListWithOrgGeogebraCommonKernelAlgosConstructionElement:algo];
    result = [algo getOutput];
    OrgGeogebraCommonGuiViewProbcalculatorStatisticsCalculatorProcessor_setIntervalResultsWithOrgGeogebraCommonKernelGeosGeoElement_(self, IOSObjectArray_Get(nil_chk(result), 0));
...
void OrgGeogebraCommonGuiViewProbcalculatorStatisticsCalculatorProcessor_createGeos(OrgGeogebraCommonGuiViewProbcalculatorStatisticsCalculatorProcessor *self) {
  self->geos_ = new_JavaUtilArrayList_init();
  self->n_ = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(self->cons_);
  [self->geos_ addWithId:self->n_];
  self->n2_ = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(self->cons_);
  [self->geos_ addWithId:self->n2_];
  self->mean_ = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(self->cons_);
  [self->geos_ addWithId:self->mean_];
  self->mean2_ = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(self->cons_);
  [self->geos_ addWithId:self->mean2_];
  self->sd_ = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(self->cons_);
  [self->geos_ addWithId:self->sd_];
  self->sd2_ = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(self->cons_);
  [self->geos_ addWithId:self->sd2_];
  self->proportion_ = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(self->cons_);
  [self->geos_ addWithId:self->proportion_];
  self->proportion2_ = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(self->cons_);
  [self->geos_ addWithId:self->proportion2_];
  self->nullHyp_ = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(self->cons_);
  [self->geos_ addWithId:self->nullHyp_];
  self->level_ = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(self->cons_);
  [self->geos_ addWithId:self->level_];
  self->tail_ = new_OrgGeogebraCommonKernelGeosGeoText_initWithOrgGeogebraCommonKernelConstruction_(self->cons_);
  [self->geos_ addWithId:self->tail_];
  self->pooled_ = new_OrgGeogebraCommonKernelGeosGeoBoolean_initWithOrgGeogebraCommonKernelConstruction_(self->cons_);
...
id<OrgApacheCommonsMathDistributionChiSquaredDistribution> OrgGeogebraCommonGuiViewProbcalculatorStatisticsCalculatorProcessor_getChiSquaredDistributionWithDouble_(OrgGeogebraCommonGuiViewProbcalculatorStatisticsCalculatorProcessor *self, jdouble df) {
  if (self->chisquared_ == nil || [self->chisquared_ getDegreesOfFreedom] != df) self->chisquared_ = new_OrgApacheCommonsMathDistributionChiSquaredDistributionImpl_initWithDouble_(df);
