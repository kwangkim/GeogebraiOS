...
- (IOSObjectArray *)getColumnNames {
  IOSObjectArray *names = [IOSObjectArray newArrayWithObjects:(id[]){ @" ", [((OrgGeogebraCommonMainApp *) nil_chk(app_)) getMenuWithNSString:@"Mean"], [app_ getMenuWithNSString:@"SampleStandardDeviation.short"], [app_ getMenuWithNSString:@"Length.short"] } count:4 type:NSString_class_()];
  return names;
}
...
- (void)setSelectedDataIndexWithJavaLangIntegerArray:(IOSObjectArray *)selectedDataIndex {
  self->selectedDataIndex_ = selectedDataIndex;
}
...
- (void)setSelectedDataIndex0WithInt:(jint)idx {
  (void) IOSObjectArray_Set(nil_chk(selectedDataIndex_), 0, JavaLangInteger_valueOfWithInt_(idx));
}

- (void)setSelectedDataIndex1WithInt:(jint)idx {
  (void) IOSObjectArray_Set(nil_chk(selectedDataIndex_), 1, JavaLangInteger_valueOfWithInt_(idx));
}
...
void OrgGeogebraCommonGuiViewDataTwoVarStatModel_initWithOrgGeogebraCommonMainApp_withBoolean_withOrgGeogebraCommonGuiViewDataTwoVarStatModel_TwoVarStatListener_(OrgGeogebraCommonGuiViewDataTwoVarStatModel *self, OrgGeogebraCommonMainApp *app, jboolean isPairedData, id<OrgGeogebraCommonGuiViewDataTwoVarStatModel_TwoVarStatListener> listener) {
  ...
  self->selectedDataIndex_ = [IOSObjectArray newArrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(0), JavaLangInteger_valueOfWithInt_(1) } count:2 type:JavaLangInteger_class_()];
