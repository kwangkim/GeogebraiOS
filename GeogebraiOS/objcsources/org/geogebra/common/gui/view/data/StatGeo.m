...
- (OrgGeogebraCommonKernelGeosGeoElement *)createNormalCurveOverlayWithOrgGeogebraCommonKernelGeosGeoList:(OrgGeogebraCommonKernelGeosGeoList *)dataList {
  OrgGeogebraCommonKernelGeosGeoElement *geo;
  OrgGeogebraCommonKernelStatisticsAlgoMean *mean = new_OrgGeogebraCommonKernelStatisticsAlgoMean_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoList_(cons_, dataList);
  OrgGeogebraCommonKernelStatisticsAlgoStandardDeviation *sd = new_OrgGeogebraCommonKernelStatisticsAlgoStandardDeviation_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoList_(cons_, dataList);
  ...
  normal = new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, normal, OrgGeogebraCommonPluginOperationEnum_get_DIVIDE(), new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, JavaLangMath_sqrtWithDouble_(2 * JavaLangMath_PI)));
  normal = new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, normal, OrgGeogebraCommonPluginOperationEnum_get_DIVIDE(), sdGeo);
...
- (OrgGeogebraCommonKernelGeosGeoElement *)createBarChartNumericWithOrgGeogebraCommonKernelGeosGeoList:(OrgGeogebraCommonKernelGeosGeoList *)dataList
  ...
  if ([((OrgGeogebraCommonGuiViewDataStatPanelSettings *) nil_chk(settings)) groupType] == OrgGeogebraCommonGuiViewDataDataVariable_GroupTypeEnum_get_RAWDATA()) {
    if ([settings isAutomaticBarWidth]) {
      OrgGeogebraCommonKernelAdvancedAlgoUnique *algo = new_OrgGeogebraCommonKernelAdvancedAlgoUnique_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoList_(cons_, dataList);
...
- (OrgGeogebraCommonKernelGeosGeoElement *)createFrequencyTableGeoWithOrgGeogebraCommonKernelGeosGeoNumeric:(OrgGeogebraCommonKernelGeosGeoNumeric *)chart
  ...
  switch ([plotType ordinal]) {
    ...
    al = new_OrgGeogebraCommonKernelStatisticsAlgoFrequencyTable_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoNumeric_(cons_, chart);
    break;
...
- (IOSObjectArray *)createBoxPlotTitlesWithOrgGeogebraCommonGuiViewDataDataAnalysisModel:(OrgGeogebraCommonGuiViewDataDataAnalysisModel *)statDialog
  ...
  for (jint i = 0; i < dataTitles->size_; i++) {
    OrgGeogebraCommonKernelGeosGeoPoint *p = new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withDouble_withDouble_withDouble_(cons_, ((OrgGeogebraCommonGuiViewDataStatPanelSettings *) nil_chk(settings))->xMin_, i + 1.0, 1.0);
    OrgGeogebraCommonKernelGeosGeoText *t = new_OrgGeogebraCommonKernelGeosGeoText_initWithOrgGeogebraCommonKernelConstruction_withNSString_(cons_, JreStrcat("$$", @"  ", IOSObjectArray_Get(dataTitles, dataTitles->size_ - i - 1)));
    ...
    (void) IOSObjectArray_Set(ret, i, IOSObjectArray_Get(nil_chk([text getGeoElements]), 0));
...
- (OrgGeogebraCommonKernelGeosGeoElement *)createDotPlotWithOrgGeogebraCommonKernelGeosGeoList:(OrgGeogebraCommonKernelGeosGeoList *)dataList {
  OrgGeogebraCommonKernelStatisticsAlgoDotPlot *algoDotPlot = new_OrgGeogebraCommonKernelStatisticsAlgoDotPlot_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoList_(cons_, dataList);
...
- (void)updateDotPlotWithOrgGeogebraCommonKernelGeosGeoList:(OrgGeogebraCommonKernelGeosGeoList *)dataList
  ...
  if ([((OrgGeogebraCommonGuiViewDataStatPanelSettings *) nil_chk(settings)) isAutomaticWindow]) {
    ...
    OrgGeogebraCommonKernelAlgosAlgoDependentListExpression *list = new_OrgGeogebraCommonKernelAlgosAlgoDependentListExpression_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticExpressionNode_(cons_, en);
    OrgGeogebraCommonKernelAlgosAlgoListMax *max = new_OrgGeogebraCommonKernelAlgosAlgoListMax_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoList_(cons_, (OrgGeogebraCommonKernelGeosGeoList *) check_class_cast(IOSObjectArray_Get(nil_chk([list getGeoElements]), 0), [OrgGeogebraCommonKernelGeosGeoList class]));
...
- (OrgGeogebraCommonKernelGeosGeoElement *)createNormalQuantilePlotWithOrgGeogebraCommonKernelGeosGeoList:(OrgGeogebraCommonKernelGeosGeoList *)dataList {
  OrgGeogebraCommonKernelStatisticsAlgoNormalQuantilePlot *algoNormalQPlot = new_OrgGeogebraCommonKernelStatisticsAlgoNormalQuantilePlot_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoList_(cons_, dataList);
...
- (OrgGeogebraCommonKernelGeosGeoElement *)createScatterPlotLineWithOrgGeogebraCommonKernelGeosGeoList:(OrgGeogebraCommonKernelGeosGeoList *)points {
  OrgGeogebraCommonKernelAlgosAlgoPolyLine *polyLine = new_OrgGeogebraCommonKernelAlgosAlgoPolyLine_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelGeosGeoList_(cons_, nil, points);
...
- (OrgGeogebraCommonKernelGeosGeoElement *)createRegressionPlotWithOrgGeogebraCommonKernelGeosGeoList:(OrgGeogebraCommonKernelGeosGeoList *)dataList
  ...
  switch ([reg ordinal]) {
    ...
    algo = new_OrgGeogebraCommonKernelStatisticsAlgoFitLog_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoList_(cons_, dataList);
    break;
    ...
    algo = new_OrgGeogebraCommonKernelStatisticsAlgoFitPow_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoList_(cons_, dataList);
    break;
    case OrgGeogebraCommonGuiViewDataDataAnalysisModel_Regression_EXP:
    algo = new_OrgGeogebraCommonKernelStatisticsAlgoFitExp_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoList_(cons_, dataList);
    break;
    case OrgGeogebraCommonGuiViewDataDataAnalysisModel_Regression_GROWTH:
    algo = new_OrgGeogebraCommonKernelStatisticsAlgoFitGrowth_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoList_(cons_, dataList);
    break;
    case OrgGeogebraCommonGuiViewDataDataAnalysisModel_Regression_SIN:
    algo = new_OrgGeogebraCommonKernelStatisticsAlgoFitSin_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoList_(cons_, dataList);
    break;
    case OrgGeogebraCommonGuiViewDataDataAnalysisModel_Regression_LOGISTIC:
    algo = new_OrgGeogebraCommonKernelStatisticsAlgoFitLogistic_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoList_(cons_, dataList);
    break;
    ...
    default:
    algo = new_OrgGeogebraCommonKernelStatisticsAlgoFitLineY_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoList_(cons_, dataList);
    break;
  }
...
void OrgGeogebraCommonGuiViewDataStatGeo_getDataBoundsWithOrgGeogebraCommonKernelGeosGeoList_withBoolean_withBoolean_(OrgGeogebraCommonGuiViewDataStatGeo *self, OrgGeogebraCommonKernelGeosGeoList *dataList, jboolean isPointList, jboolean isMatrix) {
  ...
  self->removeFromConstruction__ = YES;
  IOSDoubleArray *dataBounds = [IOSDoubleArray newArrayWithLength:4];
  if (isMatrix) {
    OrgGeogebraCommonKernelGeosGeoNumeric *index = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(self->cons_, 1);
    OrgGeogebraCommonKernelAlgosAlgoListElement *le = new_OrgGeogebraCommonKernelAlgosAlgoListElement_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelArithmeticNumberValue_(self->cons_, dataList, index);
    ...
    OrgGeogebraCommonKernelAlgosAlgoListMax *maxAlgo = new_OrgGeogebraCommonKernelAlgosAlgoListMax_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoList_(self->cons_, list);
    OrgGeogebraCommonKernelAlgosAlgoListMin *minAlgo = new_OrgGeogebraCommonKernelAlgosAlgoListMin_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoList_(self->cons_, list);
    ...
    *IOSDoubleArray_GetRef(dataBounds, 3) = [((OrgGeogebraCommonKernelGeosGeoNumeric *) nil_chk(((OrgGeogebraCommonKernelGeosGeoNumeric *) check_class_cast(IOSObjectArray_Get(nil_chk([maxY getGeoElements]), 0), [OrgGeogebraCommonKernelGeosGeoNumeric class])))) getDouble];
    ...
    OrgGeogebraCommonKernelAlgosAlgoListMax *max = new_OrgGeogebraCommonKernelAlgosAlgoListMax_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoList_(self->cons_, dataList);
    OrgGeogebraCommonKernelAlgosAlgoListMin *min = new_OrgGeogebraCommonKernelAlgosAlgoListMin_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoList_(self->cons_, dataList);
...
OrgGeogebraCommonKernelAlgosAlgoPolyLine *OrgGeogebraCommonGuiViewDataStatGeo_createFrequencyPolygonWithOrgGeogebraCommonKernelStatisticsAlgoHistogram_withBoolean_(OrgGeogebraCommonGuiViewDataStatGeo *self, OrgGeogebraCommonKernelStatisticsAlgoHistogram *histogram, jboolean doCumulative) {
  ...
  IOSObjectArray *points = [IOSObjectArray newArrayWithLength:size type:OrgGeogebraCommonKernelGeosGeoPoint_class_()];
  ...
  if (doCumulative) {
    (void) IOSObjectArray_Set(points, 0, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withNSString_withDouble_withDouble_withDouble_(self->cons_, nil, IOSDoubleArray_Get(nil_chk(leftBorder), 0), 0.0, 1.0));
    for (jint i = 0; i < ((IOSDoubleArray *) nil_chk(yValue))->size_ - 1; i++) {
      (void) IOSObjectArray_Set(points, i + 1, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withNSString_withDouble_withDouble_withDouble_(self->cons_, nil, IOSDoubleArray_Get(leftBorder, i + 1), IOSDoubleArray_Get(yValue, i), 1.0));
    }
  }
  else {
    ...
    (void) IOSObjectArray_Set(points, 0, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withNSString_withDouble_withDouble_withDouble_(self->cons_, nil, midpoint, 0.0, 1.0));
    for (jint i = 0; i < ((IOSDoubleArray *) nil_chk(yValue))->size_ - 1; i++) {
      midpoint = 0.5 * (IOSDoubleArray_Get(leftBorder, i + 1) + IOSDoubleArray_Get(leftBorder, i));
      (void) IOSObjectArray_Set(points, i + 1, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withNSString_withDouble_withDouble_withDouble_(self->cons_, nil, midpoint, IOSDoubleArray_Get(yValue, i), 1.0));
    }
    midpoint = 1.5 * IOSDoubleArray_Get(leftBorder, yValue->size_ - 1) - .5 * (IOSDoubleArray_Get(leftBorder, yValue->size_ - 2));
    (void) IOSObjectArray_Set(points, yValue->size_, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withNSString_withDouble_withDouble_withDouble_(self->cons_, nil, midpoint, 0.0, 1.0));
  }
  [self->cons_ setSuppressLabelCreationWithBoolean:suppressLabelCreation];
  OrgGeogebraCommonKernelAlgosAlgoPolyLine *polyLine = new_OrgGeogebraCommonKernelAlgosAlgoPolyLine_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_withBoolean_(self->cons_, nil, points, NO);
  return polyLine;
}
