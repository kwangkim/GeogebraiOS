...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/gui/view/data/DataSource.java
//
...
- (IOSObjectArray *)getTableDataWithInt:(jint)dataIndex {
  ...
  IOSObjectArray *data = [IOSObjectArray newArrayWithDimensions:2 lengths:(jint[]){ rowCount, [list size] } type:NSString_class_()];
  for (jint c = 0; c < [list size]; c++) {
    for (jint r = 0; r < ((IOSObjectArray *) nil_chk([list getWithInt:c]))->size_; r++) {
      (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(data, r)), c, IOSObjectArray_Get(nil_chk([list getWithInt:c]), r));
    }
  }
  return data;
}
...
- (IOSObjectArray *)getTitlesWithInt:(jint)dataIndex {
  ...
  IOSObjectArray *s = [list toArrayWithNSObjectArray:[IOSObjectArray newArrayWithLength:[list size] type:NSString_class_()]];
  return s;
}
...
- (IOSObjectArray *)getDescriptions {
  ...
  return [list toArrayWithNSObjectArray:[IOSObjectArray newArrayWithLength:[((JavaUtilArrayList *) nil_chk(list)) size] type:NSString_class_()]];
}
...
void OrgGeogebraCommonGuiViewDataDataSource_initWithOrgGeogebraCommonMainApp_(OrgGeogebraCommonGuiViewDataDataSource *self, OrgGeogebraCommonMainApp *app) {
  ...
  self->defaultGroupType_ = OrgGeogebraCommonGuiViewDataDataVariable_GroupTypeEnum_get_RAWDATA();
  self->app_ = app;
  self->selection_ = [((OrgGeogebraCommonMainApp *) nil_chk(app)) getSelectionManager];
  self->dataList_ = new_JavaUtilArrayList_init();
...
OrgGeogebraCommonGuiViewDataDataItem *OrgGeogebraCommonGuiViewDataDataSource_createDataItemFromGeoSelection(OrgGeogebraCommonGuiViewDataDataSource *self) {
  ...
  if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(geo)) isGeoList]) {
    return new_OrgGeogebraCommonGuiViewDataDataItem_initWithOrgGeogebraCommonKernelGeosGeoList_((OrgGeogebraCommonKernelGeosGeoList *) check_class_cast(geo, [OrgGeogebraCommonKernelGeosGeoList class]));
  }
  else if ([geo getSpreadsheetCoords] != nil) {
    return new_OrgGeogebraCommonGuiViewDataDataItem_initWithJavaUtilArrayList_(OrgGeogebraCommonGuiViewSpreadsheetCellRangeProcessor_cloneWithJavaUtilArrayList_([((id<OrgGeogebraCommonGuiViewSpreadsheetMyTable>) nil_chk(OrgGeogebraCommonGuiViewDataDataSource_spreadsheetTable(self))) getSelectedCellRanges]));
  }
  return nil;
}
...
void OrgGeogebraCommonGuiViewDataDataSource_setDataListFromGeoListWithInt_(OrgGeogebraCommonGuiViewDataDataSource *self, jint mode) {
  ...
  JavaUtilArrayList *itemList = new_JavaUtilArrayList_init();
  OrgGeogebraCommonGuiViewDataDataVariable *var = new_OrgGeogebraCommonGuiViewDataDataVariable_initWithOrgGeogebraCommonMainApp_(self->app_);
  switch (mode) {
    case OrgGeogebraCommonGuiViewDataDataAnalysisModel_MODE_ONEVAR:
    [itemList addWithId:new_OrgGeogebraCommonGuiViewDataDataItem_initWithOrgGeogebraCommonKernelGeosGeoList_([list getWithInt:0])];
    ...
    if ([((OrgGeogebraCommonKernelGeosGeoList *) nil_chk([list getWithInt:0])) getElementType] == OrgGeogebraCommonPluginGeoClassEnum_get_POINT()) {
      ...
      [itemList addWithId:new_OrgGeogebraCommonGuiViewDataDataItem_initWithOrgGeogebraCommonKernelGeosGeoList_([list getWithInt:0])];
      if ([list size] == 1) {
        [itemList addWithId:new_OrgGeogebraCommonGuiViewDataDataItem_init()];
      }
      [var setDataVariableAsRawDataWithOrgGeogebraCommonPluginGeoClassEnum:OrgGeogebraCommonPluginGeoClassEnum_get_NUMERIC() withJavaUtilArrayList:itemList];
    }
    break;
    ...
    for (OrgGeogebraCommonKernelGeosGeoList * __strong geo in list) {
      [itemList addWithId:new_OrgGeogebraCommonGuiViewDataDataItem_initWithOrgGeogebraCommonKernelGeosGeoList_(geo)];
    }
    [var setDataVariableAsRawDataWithOrgGeogebraCommonPluginGeoClassEnum:OrgGeogebraCommonPluginGeoClassEnum_get_NUMERIC() withJavaUtilArrayList:itemList];
    break;
  }
...
void OrgGeogebraCommonGuiViewDataDataSource_setDataListFromSpreadsheetWithInt_withOrgGeogebraCommonGuiViewDataDataVariable_GroupTypeEnum_(OrgGeogebraCommonGuiViewDataDataSource *self, jint mode, OrgGeogebraCommonGuiViewDataDataVariable_GroupTypeEnum *groupType) {
  ...
  JavaUtilArrayList *itemList = new_JavaUtilArrayList_init();
  {
    ...
    switch (mode) {
      case OrgGeogebraCommonGuiViewDataDataAnalysisModel_MODE_ONEVAR:
      [itemList addWithId:new_OrgGeogebraCommonGuiViewDataDataItem_initWithJavaUtilArrayList_(rangeList)];
      [var setDataVariableAsRawDataWithOrgGeogebraCommonPluginGeoClassEnum:OrgGeogebraCommonPluginGeoClassEnum_get_NUMERIC() withJavaUtilArrayList:itemList];
      break;
      case OrgGeogebraCommonGuiViewDataDataAnalysisModel_MODE_REGRESSION:
      ...
      for (OrgGeogebraCommonGuiViewSpreadsheetCellRange * __strong cr in nil_chk(rangeList)) {
        if ([((OrgGeogebraCommonGuiViewSpreadsheetCellRange *) nil_chk(cr)) isRow] || [cr isPartialRow]) {
          ...
          for (OrgGeogebraCommonGuiViewSpreadsheetCellRange * __strong cr2 in nil_chk(r)) {
            [itemList addWithId:new_OrgGeogebraCommonGuiViewDataDataItem_initWithOrgGeogebraCommonGuiViewSpreadsheetCellRange_(cr2)];
          }
        }
        else {
...
void OrgGeogebraCommonGuiViewDataDataSource_add1DCellRangesWithJavaUtilArrayList_withJavaUtilArrayList_(JavaUtilArrayList *rangeList, JavaUtilArrayList *itemList) {
  ...
  if ([rangeList size] == 1) {
    ...
    if (r != nil) {
      if ([r size] > 0) [((JavaUtilArrayList *) nil_chk(itemList)) addWithId:new_OrgGeogebraCommonGuiViewDataDataItem_initWithOrgGeogebraCommonGuiViewSpreadsheetCellRange_([r getWithInt:0])];
      if ([r size] > 1) [((JavaUtilArrayList *) nil_chk(itemList)) addWithId:new_OrgGeogebraCommonGuiViewDataDataItem_initWithOrgGeogebraCommonGuiViewSpreadsheetCellRange_([r getWithInt:1])];
    }
  }
  else if ([rangeList size] == 2) {
    if (scanByColumn) {
      [((JavaUtilArrayList *) nil_chk(itemList)) addWithId:new_OrgGeogebraCommonGuiViewDataDataItem_initWithOrgGeogebraCommonGuiViewSpreadsheetCellRange_([((JavaUtilArrayList *) nil_chk([((OrgGeogebraCommonGuiViewSpreadsheetCellRange *) nil_chk([rangeList getWithInt:0])) toPartialColumnList])) getWithInt:0])];
      [itemList addWithId:new_OrgGeogebraCommonGuiViewDataDataItem_initWithOrgGeogebraCommonGuiViewSpreadsheetCellRange_([((JavaUtilArrayList *) nil_chk([((OrgGeogebraCommonGuiViewSpreadsheetCellRange *) nil_chk([rangeList getWithInt:1])) toPartialColumnList])) getWithInt:0])];
    }
    else {
      [((JavaUtilArrayList *) nil_chk(itemList)) addWithId:new_OrgGeogebraCommonGuiViewDataDataItem_initWithOrgGeogebraCommonGuiViewSpreadsheetCellRange_([((JavaUtilArrayList *) nil_chk([((OrgGeogebraCommonGuiViewSpreadsheetCellRange *) nil_chk([rangeList getWithInt:0])) toPartialRowList])) getWithInt:0])];
      [itemList addWithId:new_OrgGeogebraCommonGuiViewDataDataItem_initWithOrgGeogebraCommonGuiViewSpreadsheetCellRange_([((JavaUtilArrayList *) nil_chk([((OrgGeogebraCommonGuiViewSpreadsheetCellRange *) nil_chk([rangeList getWithInt:1])) toPartialRowList])) getWithInt:0])];
    }
  }
}
