...
void OrgGeogebraCommonGuiViewDataPlotSettings_init(OrgGeogebraCommonGuiViewDataPlotSettings *self) {
  ...
  self->gridInterval_ = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 1, 1 } count:2];
  ...
  self->isEdgeAxis_ = [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ NO, NO } count:2];
  self->isPositiveOnly_ = [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ NO, NO } count:2];
  self->showGrid_ = NO;
}
