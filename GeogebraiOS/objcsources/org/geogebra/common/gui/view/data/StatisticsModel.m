...
void OrgGeogebraCommonGuiViewDataStatisticsModel_createLabelMap(OrgGeogebraCommonGuiViewDataStatisticsModel *self) {
  if (self->labelMap_ == nil) self->labelMap_ = new_JavaUtilHashMap_init();
  [((JavaUtilHashMap *) nil_chk(self->labelMap_)) clear];
  (void) [self->labelMap_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonGuiViewDataStatisticsModel_INFER_TTEST) withId:[((OrgGeogebraCommonMainApp *) nil_chk(self->app_)) getMenuWithNSString:@"TMeanTest"]];
  (void) [self->labelMap_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonGuiViewDataStatisticsModel_INFER_TINT) withId:[self->app_ getMenuWithNSString:@"TMeanInterval"]];
  (void) [self->labelMap_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonGuiViewDataStatisticsModel_INFER_ZTEST) withId:[self->app_ getMenuWithNSString:@"ZMeanTest"]];
  (void) [self->labelMap_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonGuiViewDataStatisticsModel_INFER_ZINT) withId:[self->app_ getMenuWithNSString:@"ZMeanInterval"]];
  (void) [self->labelMap_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonGuiViewDataStatisticsModel_INFER_ANOVA) withId:[self->app_ getMenuWithNSString:@"ANOVA"]];
  (void) [self->labelMap_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonGuiViewDataStatisticsModel_SUMMARY_STATISTICS) withId:[self->app_ getMenuWithNSString:@"Statistics"]];
  (void) [self->labelMap_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonGuiViewDataStatisticsModel_INFER_TTEST_2MEANS) withId:[self->app_ getMenuWithNSString:@"TTestDifferenceOfMeans"]];
  (void) [self->labelMap_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonGuiViewDataStatisticsModel_INFER_TTEST_PAIRED) withId:[self->app_ getMenuWithNSString:@"TTestPairedDifferences"]];
  (void) [self->labelMap_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonGuiViewDataStatisticsModel_INFER_TINT_2MEANS) withId:[self->app_ getMenuWithNSString:@"TEstimateDifferenceOfMeans"]];
  (void) [self->labelMap_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonGuiViewDataStatisticsModel_INFER_TINT_PAIRED) withId:[self->app_ getMenuWithNSString:@"TEstimatePairedDifferences"]];
  self->labelMapReverse_ = new_JavaUtilHashMap_init();
  for (JavaLangInteger * __strong key in nil_chk([self->labelMap_ keySet])) {
    (void) [self->labelMapReverse_ putWithId:[self->labelMap_ getWithId:key] withId:key];
  }
}
