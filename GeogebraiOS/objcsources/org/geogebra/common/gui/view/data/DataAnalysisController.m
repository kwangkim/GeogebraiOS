...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/gui/view/data/DataAnalysisController.java
//
...
- (void)setRegressionModelWithOrgGeogebraCommonKernelGeosGeoFunction:(OrgGeogebraCommonKernelGeosGeoFunction *)regressionModel {
  OrgGeogebraCommonGuiViewDataDataAnalysisController_set_geoRegression_(self, regressionModel);
}
...
- (void)setDataSourceWithOrgGeogebraCommonGuiViewDataDataSource:(OrgGeogebraCommonGuiViewDataDataSource *)dataSource {
  OrgGeogebraCommonGuiViewDataDataAnalysisController_set_dataSource_(self, dataSource);
}
...
- (void)loadDataListsWithBoolean:(jboolean)doCopy {
  ...
  if ([((JavaUtilArrayList *) nil_chk(list)) size] == 1) {
    OrgGeogebraCommonGuiViewDataDataAnalysisController_set_dataSelected_(self, [list getWithInt:0]);
  }
  else {
    OrgGeogebraCommonGuiViewDataDataAnalysisController_setAndConsume_dataSelected_(self, new_OrgGeogebraCommonKernelGeosGeoList_initWithOrgGeogebraCommonKernelConstruction_(cons_));
...
- (void)removeRegressionGeo {
  if (geoRegression_ != nil) {
    ...
    OrgGeogebraCommonGuiViewDataDataAnalysisController_set_geoRegression_(self, nil);
  }
}

- (void)disposeDataListSelected {
  OrgGeogebraCommonGuiViewDataDataAnalysisController_set_dataSelected_(self, nil);
}
...
- (void)setModelWithOrgGeogebraCommonGuiViewDataDataAnalysisModel:(OrgGeogebraCommonGuiViewDataDataAnalysisModel *)model {
  OrgGeogebraCommonGuiViewDataDataAnalysisController_set_model_(self, model);
  OrgGeogebraCommonGuiViewDataDataAnalysisController_set_statGeo_(self, [((OrgGeogebraCommonGuiViewDataDataAnalysisModel *) nil_chk(model)) getStatGeo]);
}
...
void OrgGeogebraCommonGuiViewDataDataAnalysisController_initWithOrgGeogebraCommonMainApp_(OrgGeogebraCommonGuiViewDataDataAnalysisController *self, OrgGeogebraCommonMainApp *app) {
  ...
  OrgGeogebraCommonGuiViewDataDataAnalysisController_set_app_(self, app);
  OrgGeogebraCommonGuiViewDataDataAnalysisController_set_kernel_(self, [((OrgGeogebraCommonMainApp *) nil_chk(app)) getKernel]);
  OrgGeogebraCommonGuiViewDataDataAnalysisController_set_cons_(self, [((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) getConstruction]);
}
...
void OrgGeogebraCommonGuiViewDataDataAnalysisController_loadDataPanelArray(OrgGeogebraCommonGuiViewDataDataAnalysisController *self) {
  if (self->dataSelected_ != nil) {
    if (self->dataArray_ == nil) OrgGeogebraCommonGuiViewDataDataAnalysisController_setAndConsume_dataArray_(self, new_JavaUtilArrayList_init());
