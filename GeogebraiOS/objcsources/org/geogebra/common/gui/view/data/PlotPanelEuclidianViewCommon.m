...
- (void)setPlotSettingsWithOrgGeogebraCommonGuiViewDataPlotSettings:(OrgGeogebraCommonGuiViewDataPlotSettings *)plotSettings {
  OrgGeogebraCommonGuiViewDataPlotPanelEuclidianViewCommon_set_plotSettings_(self, plotSettings);
}
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonGuiViewDataPlotPanelEuclidianViewCommon class]) {
    JreStrongAssignAndConsume(&OrgGeogebraCommonGuiViewDataPlotPanelEuclidianViewCommon_showAxes_, nil, [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ YES, YES } count:2]);
