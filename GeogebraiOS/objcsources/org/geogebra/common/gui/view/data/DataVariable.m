...
- (void)setGroupTypeWithOrgGeogebraCommonGuiViewDataDataVariable_GroupTypeEnum:(OrgGeogebraCommonGuiViewDataDataVariable_GroupTypeEnum *)groupType {
  ...
  switch ([groupType ordinal]) {
    ...
    if ([((JavaUtilArrayList *) nil_chk(values_)) size] == 0) {
      [values_ addWithId:new_OrgGeogebraCommonGuiViewDataDataItem_init()];
    }
    break;
    case OrgGeogebraCommonGuiViewDataDataVariable_GroupType_FREQUENCY:
    if (frequency_ == nil) {
      frequency_ = new_OrgGeogebraCommonGuiViewDataDataItem_init();
    ...
    if (classes_ == nil) {
      classes_ = new_OrgGeogebraCommonGuiViewDataDataItem_initWithJavaLangDoubleArray_([IOSObjectArray newArrayWithLength:0 type:JavaLangDouble_class_()]);
...
- (void)setValueItemsWithOrgGeogebraCommonGuiViewDataDataItemArray:(IOSObjectArray *)valueItem {
  values_ = new_JavaUtilArrayList_init();
  {
...
withOrgGeogebraCommonGuiViewDataDataItem:(OrgGeogebraCommonGuiViewDataDataItem *)item {
  if (itemIndex < [((JavaUtilArrayList *) nil_chk(values_)) size]) {
    (void) [values_ setWithInt:itemIndex withId:item];
  }
  else {
    frequency_ = item;
  }
...
- (void)removeLastValue {
  ...
  (void) [values_ removeWithInt:[values_ size] - 1];
}
...
- (void)addNewValue {
  ...
  OrgGeogebraCommonGuiViewDataDataItem *item = new_OrgGeogebraCommonGuiViewDataDataItem_init();
...
void OrgGeogebraCommonGuiViewDataDataVariable_updateAutomaticClasses(OrgGeogebraCommonGuiViewDataDataVariable *self) {
  ...
  IOSObjectArray *leftBorder = [IOSObjectArray newArrayWithLength:numClasses + 1 type:JavaLangDouble_class_()];
  (void) IOSObjectArray_Set(leftBorder, 0, JavaLangDouble_valueOfWithDouble_(self->classStart_));
  for (jint i = 1; i < leftBorder->size_; i++) {
    (void) IOSObjectArray_Set(leftBorder, i, JavaLangDouble_valueOfWithDouble_([((JavaLangDouble *) nil_chk(IOSObjectArray_Get(leftBorder, i - 1))) doubleValue] + self->classWidth_));
  }
...
OrgGeogebraCommonKernelGeosGeoList *OrgGeogebraCommonGuiViewDataDataVariable_createPointGeoListWithOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelGeosGeoList_withBoolean_withBoolean_(OrgGeogebraCommonGuiViewDataDataVariable *self, OrgGeogebraCommonKernelGeosGeoList *xList, OrgGeogebraCommonKernelGeosGeoList *yList, jboolean byValue, jboolean leftToRight) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoDependentList *dl = new_OrgGeogebraCommonKernelAlgosAlgoDependentList_initWithOrgGeogebraCommonKernelConstruction_withJavaUtilArrayList_withBoolean_(cons, list, NO);
