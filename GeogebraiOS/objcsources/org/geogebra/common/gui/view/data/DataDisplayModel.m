  ...
  @try {
    {
      ...
      switch ([selectedPlot_ ordinal]) {
        ...
        if (doCreate) {
          ...
          if (dataListSelected != nil) {
            histogram_ = [((OrgGeogebraCommonGuiViewDataStatGeo *) nil_chk(statGeo_)) createHistogramWithOrgGeogebraCommonKernelGeosGeoList:dataListSelected withOrgGeogebraCommonGuiViewDataStatPanelSettings:settings_ withBoolean:NO];
          ...
          if ([((OrgGeogebraCommonGuiViewDataStatPanelSettings *) nil_chk(settings_)) isHasOverlayPolygon]) {
            frequencyPolygon_ = [((OrgGeogebraCommonGuiViewDataStatGeo *) nil_chk(statGeo_)) createHistogramWithOrgGeogebraCommonKernelGeosGeoList:dataListSelected withOrgGeogebraCommonGuiViewDataStatPanelSettings:settings_ withBoolean:YES];
          ...
          if ([settings_ isHasOverlayNormal]) {
            normalCurve_ = [((OrgGeogebraCommonGuiViewDataStatGeo *) nil_chk(statGeo_)) createNormalCurveOverlayWithOrgGeogebraCommonKernelGeosGeoList:dataListSelected];
        ...
        if (doCreate) {
          ...
          boxPlot_ = [((OrgGeogebraCommonGuiViewDataStatGeo *) nil_chk(statGeo_)) createBoxPlotWithOrgGeogebraCommonKernelGeosGeoList:dataListSelected withOrgGeogebraCommonGuiViewDataStatPanelSettings:settings_];
        ...
        if (doCreate) {
          ...
          if ([((OrgGeogebraCommonGuiViewDataStatPanelSettings *) nil_chk(settings_)) isNumericData]) {
            barChart_ = [((OrgGeogebraCommonGuiViewDataStatGeo *) nil_chk(statGeo_)) createBarChartNumericWithOrgGeogebraCommonKernelGeosGeoList:dataListSelected withOrgGeogebraCommonGuiViewDataStatPanelSettings:settings_];
            [((JavaUtilArrayList *) nil_chk(plotGeoList_)) addWithId:barChart_];
          }
          else {
            barChart_ = [((OrgGeogebraCommonGuiViewDataStatGeo *) nil_chk(statGeo_)) createBarChartTextWithOrgGeogebraCommonKernelGeosGeoList:dataListSelected withOrgGeogebraCommonGuiViewDataStatPanelSettings:settings_];
          }
          [((JavaUtilArrayList *) nil_chk(plotGeoList_)) addWithId:barChart_];
          if (freqTableGeo_ != nil) {
            [freqTableGeo_ remove];
        ...
        if (doCreate) {
          ...
          dotPlot_ = [((OrgGeogebraCommonGuiViewDataStatGeo *) nil_chk(statGeo_)) createDotPlotWithOrgGeogebraCommonKernelGeosGeoList:dataListSelected];
        ...
        if (doCreate) {
          ...
          nqPlot_ = [((OrgGeogebraCommonGuiViewDataStatGeo *) nil_chk(statGeo_)) createNormalQuantilePlotWithOrgGeogebraCommonKernelGeosGeoList:dataListSelected];
        ...
        if (doCreate) {
          ...
          scatterPlot_ = [((OrgGeogebraCommonGuiViewDataStatGeo *) nil_chk(statGeo_)) createScatterPlotWithOrgGeogebraCommonKernelGeosGeoList:dataListSelected];
          ...
          if ([((OrgGeogebraCommonGuiViewDataStatPanelSettings *) nil_chk(settings_)) isShowScatterplotLine]) {
            scatterPlotLine_ = [statGeo_ createScatterPlotLineWithOrgGeogebraCommonKernelGeosGeoList:(OrgGeogebraCommonKernelGeosGeoList *) check_class_cast(scatterPlot_, [OrgGeogebraCommonKernelGeosGeoList class])];
        ...
        if (doCreate) {
          if (![((OrgGeogebraCommonGuiViewDataDataAnalysisModel_RegressionEnum *) nil_chk([daModel_ getRegressionMode])) isEqual:OrgGeogebraCommonGuiViewDataDataAnalysisModel_RegressionEnum_get_NONE()]) {
            residualPlot_ = [((OrgGeogebraCommonGuiViewDataStatGeo *) nil_chk(statGeo_)) createRegressionPlotWithOrgGeogebraCommonKernelGeosGeoList:dataListSelected withOrgGeogebraCommonGuiViewDataDataAnalysisModel_RegressionEnum:[daModel_ getRegressionMode] withInt:[daModel_ getRegressionOrder] withBoolean:YES];
        ...
        [listener_ updatePlotPanelSettings];
        boxPlotTitles_ = [statGeo_ createBoxPlotTitlesWithOrgGeogebraCommonGuiViewDataDataAnalysisModel:daModel_ withOrgGeogebraCommonGuiViewDataStatPanelSettings:settings_];
...
- (void)exportGeosToEVWithInt:(jint)euclidianViewID {
  ...
  @try {
    ...
    histogram_ = nil;
    dotPlot_ = nil;
    frequencyPolygon_ = nil;
    normalCurve_ = nil;
    scatterPlotLine_ = nil;
    scatterPlot_ = nil;
    nqPlot_ = nil;
    boxPlot_ = nil;
    barChart_ = nil;
...
- (void)setSelectedPlotWithOrgGeogebraCommonGuiViewDataDataDisplayModel_PlotTypeEnum:(OrgGeogebraCommonGuiViewDataDataDisplayModel_PlotTypeEnum *)selectedPlot {
  self->selectedPlot_ = selectedPlot;
}
...
void OrgGeogebraCommonGuiViewDataDataDisplayModel_initWithOrgGeogebraCommonGuiViewDataDataAnalysisModel_withOrgGeogebraCommonGuiViewDataDataDisplayModel_IDataDisplayListener_(OrgGeogebraCommonGuiViewDataDataDisplayModel *self, OrgGeogebraCommonGuiViewDataDataAnalysisModel *daModel, id<OrgGeogebraCommonGuiViewDataDataDisplayModel_IDataDisplayListener> listener) {
  ...
  self->daModel_ = daModel;
  self->app_ = [((OrgGeogebraCommonGuiViewDataDataAnalysisModel *) nil_chk(daModel)) getApp];
  self->loc_ = [((OrgGeogebraCommonMainApp *) nil_chk(self->app_)) getLocalization];
  self->statGeo_ = [daModel getStatGeo];
  self->listener_ = listener;
  self->plotGeoList_ = new_JavaUtilArrayList_init();
  self->settings_ = new_OrgGeogebraCommonGuiViewDataStatPanelSettings_init();
