...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/gui/view/spreadsheet/CellRange.java
//
...
- (IOSIntArray *)getActualDimensions {
  IOSIntArray *d = [IOSIntArray newArrayWithLength:2];
...
- (JavaUtilArrayList *)toPartialColumnList {
  ...
  if ([self isColumn]) {
    for (jint col = minColumn_; col <= maxColumn_; col++) {
      OrgGeogebraCommonGuiViewSpreadsheetCellRange *cr = new_OrgGeogebraCommonGuiViewSpreadsheetCellRange_initWithOrgGeogebraCommonMainApp_withInt_withInt_withInt_withInt_withInt_withInt_(app_, col, -1, col, 0, col, maxRow_);
      [list addWithId:cr];
    }
  }
  else {
    for (jint col = minColumn_; col <= maxColumn_; col++) {
      [list addWithId:new_OrgGeogebraCommonGuiViewSpreadsheetCellRange_initWithOrgGeogebraCommonMainApp_withInt_withInt_withInt_withInt_(app_, col, minRow_, col, maxRow_)];
    }
  }
  return list;
}
...
- (JavaUtilArrayList *)toPartialRowList {
  JavaUtilArrayList *list = new_JavaUtilArrayList_init();
  if ([self isRow]) {
    for (jint row = minRow_; row <= maxRow_; row++) [list addWithId:new_OrgGeogebraCommonGuiViewSpreadsheetCellRange_initWithOrgGeogebraCommonMainApp_withInt_withInt_withInt_withInt_withInt_withInt_(app_, 0, row, -1, row, maxColumn_, row)];
  }
  else {
    for (jint row = minRow_; row <= maxRow_; row++) [list addWithId:new_OrgGeogebraCommonGuiViewSpreadsheetCellRange_initWithOrgGeogebraCommonMainApp_withInt_withInt_withInt_withInt_(app_, minColumn_, row, maxColumn_, row)];
  }
  return list;
}
...
- (JavaUtilArrayList *)toCellListWithBoolean:(jboolean)scanByColumn {
  ...
  if (scanByColumn) {
    for (jint col = minColumn_; col <= maxColumn_; ++col) {
      for (jint row = minRow_; row <= maxRow_; ++row) {
        [list addWithId:new_OrgGeogebraCommonAwtGPoint_initWithInt_withInt_(col, row)];
      }
    }
  }
  else {
...
- (OrgGeogebraCommonGuiViewSpreadsheetCellRange *)clone {
  OrgGeogebraCommonGuiViewSpreadsheetCellRange *cr = new_OrgGeogebraCommonGuiViewSpreadsheetCellRange_initWithOrgGeogebraCommonMainApp_(app_);
