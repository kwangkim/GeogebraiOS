...
- (void)updateFields {
  OrgGeogebraCommonGuiViewSpreadsheetSpreadsheetContextMenu_set_app_(self, [((id<OrgGeogebraCommonGuiViewSpreadsheetMyTable>) nil_chk(table_)) getApplication]);
  OrgGeogebraCommonGuiViewSpreadsheetSpreadsheetContextMenu_set_cp_(self, [table_ getCellRangeProcessor]);
  ...
  OrgGeogebraCommonGuiViewSpreadsheetSpreadsheetContextMenu_set_selectedCellRanges_(self, [table_ getSelectedCellRanges]);
  OrgGeogebraCommonGuiViewSpreadsheetSpreadsheetContextMenu_set_geos_(self, [((OrgGeogebraCommonMainSelectionManager *) nil_chk([((OrgGeogebraCommonMainApp *) nil_chk(app_)) getSelectionManager])) getSelectedGeos]);
}
...
- (void)doCommandWithNSString:(NSString *)cmdString {
  ...
  switch ([OrgGeogebraCommonGuiViewSpreadsheetSpreadsheetContextMenu_MenuCommandEnum_valueOfWithNSString_(cmdString) ordinal]) {
    ...
    [((OrgGeogebraCommonGuiViewSpreadsheetCellRangeProcessor *) nil_chk(cp_)) createListWithJavaUtilArrayList:selectedCellRanges_ withBoolean:YES withBoolean:NO];
    break;
    ...
    [((OrgGeogebraCommonGuiViewSpreadsheetCellRangeProcessor *) nil_chk(cp_)) createMatrixWithInt:column1_ withInt:column2_ withInt:row1_ withInt:row2_ withBoolean:NO];
    break;
    case OrgGeogebraCommonGuiViewSpreadsheetSpreadsheetContextMenu_MenuCommand_Table:
    [((OrgGeogebraCommonGuiViewSpreadsheetCellRangeProcessor *) nil_chk(cp_)) createTableTextWithInt:column1_ withInt:column2_ withInt:row1_ withInt:row2_ withBoolean:NO withBoolean:NO];
    break;
...
void OrgGeogebraCommonGuiViewSpreadsheetSpreadsheetContextMenu_initWithOrgGeogebraCommonGuiViewSpreadsheetMyTable_(OrgGeogebraCommonGuiViewSpreadsheetSpreadsheetContextMenu *self, id<OrgGeogebraCommonGuiViewSpreadsheetMyTable> table) {
  NSObject_init(self);
  OrgGeogebraCommonGuiViewSpreadsheetSpreadsheetContextMenu_set_table_(self, nil);
  self->row1_ = -1;
  self->row2_ = -1;
  self->column1_ = -1;
  self->column2_ = -1;
  OrgGeogebraCommonGuiViewSpreadsheetSpreadsheetContextMenu_set_table_(self, table);
  [self updateFields];
  [self createGUI];
}
