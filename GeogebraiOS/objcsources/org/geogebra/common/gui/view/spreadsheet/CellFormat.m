...
- (id)getCellFormatWithInt:(jint)x
  ...
  id formatObject = nil;
  OrgGeogebraCommonAwtGPoint *rowKey = [new_OrgGeogebraCommonAwtGPoint_initWithInt_withInt_(-1, y) autorelease];
  OrgGeogebraCommonAwtGPoint *columnKey = [new_OrgGeogebraCommonAwtGPoint_initWithInt_withInt_(x, -1) autorelease];
  OrgGeogebraCommonAwtGPoint *cellKey = [new_OrgGeogebraCommonAwtGPoint_initWithInt_withInt_(x, y) autorelease];
...
- (void)setFormatWithOrgGeogebraCommonAwtGPoint:(OrgGeogebraCommonAwtGPoint *)cell
  ...
  [crList addWithId:[new_OrgGeogebraCommonGuiViewSpreadsheetCellRange_initWithOrgGeogebraCommonMainApp_withInt_withInt_(app_, ((OrgGeogebraCommonAwtGPoint *) nil_chk(cell))->x_, cell->y_) autorelease]];
...
- (void)setFormatWithJavaUtilArrayList:(JavaUtilArrayList *)crList
  ...
  OrgGeogebraCommonAwtGPoint *testCell = [new_OrgGeogebraCommonAwtGPoint_init() autorelease];
  OrgGeogebraCommonAwtGPoint *testRow = [new_OrgGeogebraCommonAwtGPoint_init() autorelease];
  OrgGeogebraCommonAwtGPoint *testColumn = [new_OrgGeogebraCommonAwtGPoint_init() autorelease];
  for (OrgGeogebraCommonGuiViewSpreadsheetCellRange * __strong cr in nil_chk(crList)) {
    if ([((OrgGeogebraCommonGuiViewSpreadsheetCellRange *) nil_chk(cr)) isRow]) {
      ...
      for (jint r = [cr getMinRow]; r <= [cr getMaxRow]; ++r) {
        [((JavaUtilHashMap *) nil_chk(formatTable)) putWithId:[new_OrgGeogebraCommonAwtGPoint_initWithInt_withInt_(-1, r) autorelease] withId:value];
      ...
      for (jint c = [cr getMinColumn]; c <= [cr getMaxColumn]; ++c) {
        [((JavaUtilHashMap *) nil_chk(formatTable)) putWithId:[new_OrgGeogebraCommonAwtGPoint_initWithInt_withInt_(c, -1) autorelease] withId:value];
      ...
      if (highestIndexRow_ < [cr getMaxRow]) highestIndexRow_ = [cr getMaxRow];
      if (highestIndexColumn_ < [cr getMaxColumn]) highestIndexColumn_ = [cr getMaxColumn];
      for (OrgGeogebraCommonAwtGPoint * __strong cellPoint in nil_chk([cr toCellListWithBoolean:YES])) [((JavaUtilHashMap *) nil_chk(formatTable)) putWithId:cellPoint withId:value];
    }
  }
...
- (void)setBorderStyleWithOrgGeogebraCommonGuiViewSpreadsheetCellRange:(OrgGeogebraCommonGuiViewSpreadsheetCellRange *)cr
  ...
  OrgGeogebraCommonAwtGPoint *cell = [new_OrgGeogebraCommonAwtGPoint_init() autorelease];
  OrgGeogebraCommonAwtGPoint *cell2 = [new_OrgGeogebraCommonAwtGPoint_init() autorelease];
  ...
  if ([cr isRow]) {
    switch (borderStyle) {
      ...
      if ([cr getMinRow] < [cr getMaxRow]) {
        ...
        [self setFormatWithOrgGeogebraCommonGuiViewSpreadsheetCellRange:[new_OrgGeogebraCommonGuiViewSpreadsheetCellRange_initWithOrgGeogebraCommonMainApp_withInt_withInt_withInt_withInt_(app_, -1, [cr getMinRow] + 1, -1, [cr getMaxRow]) autorelease] withInt:OrgGeogebraCommonGuiViewSpreadsheetCellFormat_FORMAT_BORDER withId:JavaLangByte_valueOfWithByte_(b)];
      }
      break;
      ...
      [self setFormatWithOrgGeogebraCommonGuiViewSpreadsheetCellRange:[new_OrgGeogebraCommonGuiViewSpreadsheetCellRange_initWithOrgGeogebraCommonMainApp_withInt_withInt_withInt_withInt_(app_, -1, [cr getMaxRow], -1, [cr getMaxRow]) autorelease] withInt:OrgGeogebraCommonGuiViewSpreadsheetCellFormat_FORMAT_BORDER withId:JavaLangByte_valueOfWithByte_(OrgGeogebraCommonGuiViewSpreadsheetCellFormat_BORDER_BOTTOM)];
      break;
    }
    return;
  }
  if ([cr isColumn]) {
    switch (borderStyle) {
      ...
      break;
      case OrgGeogebraCommonGuiViewSpreadsheetCellFormat_BORDER_STYLE_INSIDE:
      [self setFormatWithOrgGeogebraCommonGuiViewSpreadsheetCellRange:[new_OrgGeogebraCommonGuiViewSpreadsheetCellRange_initWithOrgGeogebraCommonMainApp_withInt_withInt_withInt_withInt_(app_, [cr getMinColumn], -1, [cr getMinColumn], -1) autorelease] withInt:OrgGeogebraCommonGuiViewSpreadsheetCellFormat_FORMAT_BORDER withId:JavaLangByte_valueOfWithByte_(OrgGeogebraCommonGuiViewSpreadsheetCellFormat_BORDER_TOP)];
      if ([cr getMinColumn] < [cr getMaxColumn]) {
        jbyte b = OrgGeogebraCommonGuiViewSpreadsheetCellFormat_BORDER_LEFT + OrgGeogebraCommonGuiViewSpreadsheetCellFormat_BORDER_TOP;
        [self setFormatWithOrgGeogebraCommonGuiViewSpreadsheetCellRange:[new_OrgGeogebraCommonGuiViewSpreadsheetCellRange_initWithOrgGeogebraCommonMainApp_withInt_withInt_withInt_withInt_(app_, [cr getMinColumn] + 1, -1, [cr getMaxColumn], -1) autorelease] withInt:OrgGeogebraCommonGuiViewSpreadsheetCellFormat_FORMAT_BORDER withId:JavaLangByte_valueOfWithByte_(b)];
      }
      break;
      case OrgGeogebraCommonGuiViewSpreadsheetCellFormat_BORDER_STYLE_FRAME:
      [self setFormatWithOrgGeogebraCommonGuiViewSpreadsheetCellRange:[new_OrgGeogebraCommonGuiViewSpreadsheetCellRange_initWithOrgGeogebraCommonMainApp_withInt_withInt_withInt_withInt_(app_, [cr getMinColumn], -1, [cr getMinColumn], -1) autorelease] withInt:OrgGeogebraCommonGuiViewSpreadsheetCellFormat_FORMAT_BORDER withId:JavaLangByte_valueOfWithByte_(OrgGeogebraCommonGuiViewSpreadsheetCellFormat_BORDER_LEFT)];
      [self setFormatWithOrgGeogebraCommonGuiViewSpreadsheetCellRange:[new_OrgGeogebraCommonGuiViewSpreadsheetCellRange_initWithOrgGeogebraCommonMainApp_withInt_withInt_withInt_withInt_(app_, [cr getMaxColumn], -1, [cr getMaxColumn], -1) autorelease] withInt:OrgGeogebraCommonGuiViewSpreadsheetCellFormat_FORMAT_BORDER withId:JavaLangByte_valueOfWithByte_(OrgGeogebraCommonGuiViewSpreadsheetCellFormat_BORDER_RIGHT)];
      break;
    }
    return;
  }
...
- (JavaLangStringBuilder *)encodeFormats {
  ...
  for (OrgGeogebraCommonAwtGPoint * __strong cell in masterKeySet) {
    [sb appendWithNSString:OrgGeogebraCommonGuiViewSpreadsheetCellFormat_cellDelimiter_];
    [sb appendWithInt:((OrgGeogebraCommonAwtGPoint *) nil_chk(cell))->x_];
    [sb appendWithNSString:OrgGeogebraCommonGuiViewSpreadsheetCellFormat_formatDelimiter_];
    ...
    if (align != nil) {
      [sb appendWithNSString:OrgGeogebraCommonGuiViewSpreadsheetCellFormat_formatDelimiter_];
      [sb appendWithNSString:OrgGeogebraCommonGuiViewSpreadsheetCellFormat_alignToken_];
      [sb appendWithNSString:OrgGeogebraCommonGuiViewSpreadsheetCellFormat_formatDelimiter_];
    ...
    if (border != nil) {
      [sb appendWithNSString:OrgGeogebraCommonGuiViewSpreadsheetCellFormat_formatDelimiter_];
      [sb appendWithNSString:OrgGeogebraCommonGuiViewSpreadsheetCellFormat_borderToken_];
      [sb appendWithNSString:OrgGeogebraCommonGuiViewSpreadsheetCellFormat_formatDelimiter_];
    ...
    if (bgColor != nil) {
      [sb appendWithNSString:OrgGeogebraCommonGuiViewSpreadsheetCellFormat_formatDelimiter_];
      [sb appendWithNSString:OrgGeogebraCommonGuiViewSpreadsheetCellFormat_bgColorToken_];
      [sb appendWithNSString:OrgGeogebraCommonGuiViewSpreadsheetCellFormat_formatDelimiter_];
    ...
    if (fStyle != nil) {
      [sb appendWithNSString:OrgGeogebraCommonGuiViewSpreadsheetCellFormat_formatDelimiter_];
      [sb appendWithNSString:OrgGeogebraCommonGuiViewSpreadsheetCellFormat_fontStyleToken_];
      [sb appendWithNSString:OrgGeogebraCommonGuiViewSpreadsheetCellFormat_formatDelimiter_];
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonGuiViewSpreadsheetCellFormat class]) {
    JreStrongAssignAndConsume(&OrgGeogebraCommonGuiViewSpreadsheetCellFormat_formatTokenMap_, nil, new_JavaUtilHashMap_init());
    {
      [OrgGeogebraCommonGuiViewSpreadsheetCellFormat_formatTokenMap_ putWithId:OrgGeogebraCommonGuiViewSpreadsheetCellFormat_alignToken_ withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonGuiViewSpreadsheetCellFormat_FORMAT_ALIGN)];
      [OrgGeogebraCommonGuiViewSpreadsheetCellFormat_formatTokenMap_ putWithId:OrgGeogebraCommonGuiViewSpreadsheetCellFormat_borderToken_ withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonGuiViewSpreadsheetCellFormat_FORMAT_BORDER)];
      [OrgGeogebraCommonGuiViewSpreadsheetCellFormat_formatTokenMap_ putWithId:OrgGeogebraCommonGuiViewSpreadsheetCellFormat_fontStyleToken_ withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonGuiViewSpreadsheetCellFormat_FORMAT_FONTSTYLE)];
      [OrgGeogebraCommonGuiViewSpreadsheetCellFormat_formatTokenMap_ putWithId:OrgGeogebraCommonGuiViewSpreadsheetCellFormat_bgColorToken_ withId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonGuiViewSpreadsheetCellFormat_FORMAT_BGCOLOR)];
    }
...
void OrgGeogebraCommonGuiViewSpreadsheetCellFormat_initWithOrgGeogebraCommonGuiViewSpreadsheetMyTableInterface_(OrgGeogebraCommonGuiViewSpreadsheetCellFormat *self, id<OrgGeogebraCommonGuiViewSpreadsheetMyTableInterface> table) {
  ...
  self->formatCount_ = 5;
  OrgGeogebraCommonGuiViewSpreadsheetCellFormat_set_table_(self, table);
  OrgGeogebraCommonGuiViewSpreadsheetCellFormat_set_app_(self, [((id<OrgGeogebraCommonGuiViewSpreadsheetMyTableInterface>) nil_chk(table)) getApplication]);
  OrgGeogebraCommonGuiViewSpreadsheetCellFormat_setAndConsume_formatMapArray_(self, [IOSObjectArray newArrayWithLength:self->formatCount_ type:OrgGeogebraCommonGuiViewSpreadsheetCellFormat_MyHashMap_class_()]);
  for (jint i = 0; i < self->formatCount_; i++) {
    IOSObjectArray_SetAndConsume(self->formatMapArray_, i, new_OrgGeogebraCommonGuiViewSpreadsheetCellFormat_MyHashMap_init());
  }
}
...
void OrgGeogebraCommonGuiViewSpreadsheetCellFormat_shiftRowsUpWithOrgGeogebraCommonGuiViewSpreadsheetCellFormat_MyHashMap_withInt_withInt_(OrgGeogebraCommonGuiViewSpreadsheetCellFormat *self, OrgGeogebraCommonGuiViewSpreadsheetCellFormat_MyHashMap *formatMap, jint rowStart, jint shiftAmount) {
  ...
  for (jint r = rowStart; r <= self->highestIndexRow_; r++) {
    key = [new_OrgGeogebraCommonAwtGPoint_initWithInt_withInt_(-1, r) autorelease];
    if ([((OrgGeogebraCommonGuiViewSpreadsheetCellFormat_MyHashMap *) nil_chk(formatMap)) containsKeyWithId:key]) {
      shiftKey = [new_OrgGeogebraCommonAwtGPoint_initWithInt_withInt_(-1, r - shiftAmount) autorelease];
      [formatMap putWithId:shiftKey withId:[formatMap removeWithId:key]];
    }
  }
  for (jint r = rowStart; r <= self->highestIndexRow_; r++) {
    for (jint c = 0; c <= self->highestIndexColumn_; c++) {
      key = [new_OrgGeogebraCommonAwtGPoint_initWithInt_withInt_(c, r) autorelease];
      if ([((OrgGeogebraCommonGuiViewSpreadsheetCellFormat_MyHashMap *) nil_chk(formatMap)) containsKeyWithId:key]) {
        shiftKey = [new_OrgGeogebraCommonAwtGPoint_initWithInt_withInt_(c, r - shiftAmount) autorelease];
        [formatMap putWithId:shiftKey withId:[formatMap removeWithId:key]];
      }
    }
  }
...
void OrgGeogebraCommonGuiViewSpreadsheetCellFormat_shiftColumnsLeftWithOrgGeogebraCommonGuiViewSpreadsheetCellFormat_MyHashMap_withInt_withInt_(OrgGeogebraCommonGuiViewSpreadsheetCellFormat *self, OrgGeogebraCommonGuiViewSpreadsheetCellFormat_MyHashMap *formatMap, jint columnStart, jint shiftAmount) {
  ...
  for (jint c = columnStart; c <= self->highestIndexColumn_; c++) {
    key = [new_OrgGeogebraCommonAwtGPoint_initWithInt_withInt_(c, -1) autorelease];
    if ([((OrgGeogebraCommonGuiViewSpreadsheetCellFormat_MyHashMap *) nil_chk(formatMap)) containsKeyWithId:key]) {
      shiftKey = [new_OrgGeogebraCommonAwtGPoint_initWithInt_withInt_(c - shiftAmount, -1) autorelease];
      [formatMap putWithId:shiftKey withId:[formatMap removeWithId:key]];
    }
  }
  for (jint c = columnStart; c <= self->highestIndexColumn_; c++) {
    for (jint r = 0; r <= self->highestIndexRow_; r++) {
      key = [new_OrgGeogebraCommonAwtGPoint_initWithInt_withInt_(c, r) autorelease];
      if ([((OrgGeogebraCommonGuiViewSpreadsheetCellFormat_MyHashMap *) nil_chk(formatMap)) containsKeyWithId:key]) {
        shiftKey = [new_OrgGeogebraCommonAwtGPoint_initWithInt_withInt_(c - shiftAmount, r) autorelease];
        [formatMap putWithId:shiftKey withId:[formatMap removeWithId:key]];
      }
    }
  }
...
void OrgGeogebraCommonGuiViewSpreadsheetCellFormat_setCellFormatString(OrgGeogebraCommonGuiViewSpreadsheetCellFormat *self) {
  ...
  if (sb == nil) {
    OrgGeogebraCommonGuiViewSpreadsheetCellFormat_set_cellFormatString_(self, nil);
  }
  else {
    OrgGeogebraCommonGuiViewSpreadsheetCellFormat_set_cellFormatString_(self, [sb description]);
  }
...
void OrgGeogebraCommonGuiViewSpreadsheetCellFormat_processCellFormatStringWithNSString_(OrgGeogebraCommonGuiViewSpreadsheetCellFormat *self, NSString *formatStr) {
  ...
  OrgGeogebraCommonAwtGPoint *cell = [new_OrgGeogebraCommonAwtGPoint_initWithInt_withInt_(JavaLangInteger_parseIntWithNSString_(IOSObjectArray_Get(nil_chk(f), 0)), JavaLangInteger_parseIntWithNSString_(IOSObjectArray_Get(f, 1))) autorelease];
  jint formatType;
  id formatValue;
