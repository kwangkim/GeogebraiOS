...
- (jboolean)doDragCopyWithInt:(jint)sx1
  ...
  @try {
    ...
    jboolean patternOK = OrgGeogebraCommonGuiViewSpreadsheetRelativeCopy_isPatternSourceWithOrgGeogebraCommonGuiViewSpreadsheetCellRange_([new_OrgGeogebraCommonGuiViewSpreadsheetCellRange_initWithOrgGeogebraCommonMainApp_withInt_withInt_withInt_withInt_(app_, sx1, sy1, sx2, sy2) autorelease]);
    if ((sx1 == dx1) && (sx2 == dx2)) {
      if (dy2 < sy1) {
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonGuiViewSpreadsheetRelativeCopy class]) {
    JreStrongAssign(&OrgGeogebraCommonGuiViewSpreadsheetRelativeCopy_pattern2_, nil, ComGoogleGwtRegexpSharedRegExp_compileWithNSString_(@"(::|\\$)([A-Z]+)(::|\\$)([0-9]+)"));
...
void OrgGeogebraCommonGuiViewSpreadsheetRelativeCopy_initWithOrgGeogebraCommonKernelKernel_(OrgGeogebraCommonGuiViewSpreadsheetRelativeCopy *self, OrgGeogebraCommonKernelKernel *kernel0) {
  NSObject_init(self);
  OrgGeogebraCommonGuiViewSpreadsheetRelativeCopy_set_kernel_(self, kernel0);
  OrgGeogebraCommonGuiViewSpreadsheetRelativeCopy_set_app_(self, [((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) getApplication]);
}
...
OrgGeogebraCommonKernelGeosGeoElement *OrgGeogebraCommonGuiViewSpreadsheetRelativeCopy_doCopyNoStoringUndoInfo0WithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonMainApp_withOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoElement_withInt_withInt_(OrgGeogebraCommonKernelKernel *kernel, OrgGeogebraCommonMainApp *app, OrgGeogebraCommonKernelGeosGeoElement *value, OrgGeogebraCommonKernelGeosGeoElement *oldValue, jint dx, jint dy) {
  ...
  if (value == nil) {
    if (oldValue != nil) {
      ...
      OrgGeogebraCommonGuiViewSpreadsheetRelativeCopy_prepareAddingValueToTableNoStoringUndoInfoWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonMainApp_withNSString_withOrgGeogebraCommonKernelGeosGeoElement_withInt_withInt_(kernel, app, nil, oldValue, column, row);
    }
    return nil;
  }
  NSString *text = nil;
  ...
  if ([OrgGeogebraCommonKernelLocateable_class_() isInstance:value]) {
    ...
    if (pts != nil) {
      ...
      for (jint i = 0; i < pts->size_; i++) {
        IOSObjectArray_Set(startPoints, i, [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(((OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(IOSObjectArray_Get(pts, i), [OrgGeogebraCommonKernelGeosGeoElement class])))) getLabelWithOrgGeogebraCommonKernelStringTemplate:highPrecision]);
        if ([((ComGoogleGwtRegexpSharedRegExp *) nil_chk(OrgGeogebraCommonKernelGeosGeoElementSpreadsheet_get_spreadsheetPattern_())) testWithNSString:IOSObjectArray_Get(startPoints, i)]) {
          IOSObjectArray_Set(startPoints, i, OrgGeogebraCommonGuiViewSpreadsheetRelativeCopy_updateCellNameWithOffsetWithNSString_withInt_withInt_(IOSObjectArray_Get(startPoints, i), dx, dy));
        }
      }
    }
  }
...
void OrgGeogebraCommonGuiViewSpreadsheetRelativeCopy_updateCellReferencesWithOrgGeogebraCommonKernelArithmeticValidExpression_withInt_withInt_(OrgGeogebraCommonKernelArithmeticValidExpression *exp, jint dx, jint dy) {
  OrgGeogebraCommonGuiViewSpreadsheetRelativeCopy_initialize();
  OrgGeogebraCommonKernelArithmeticTraversing_SpreadsheetVariableRenamer *replacer = [new_OrgGeogebraCommonKernelArithmeticTraversing_SpreadsheetVariableRenamer_initWithInt_withInt_(dx, dy) autorelease];
  [((OrgGeogebraCommonKernelArithmeticValidExpression *) nil_chk(exp)) traverseWithOrgGeogebraCommonKernelArithmeticTraversing:replacer];
}
...
IOSObjectArray *OrgGeogebraCommonGuiViewSpreadsheetRelativeCopy_getDependentObjectsWithOrgGeogebraCommonKernelGeosGeoElement_(OrgGeogebraCommonKernelGeosGeoElement *geo) {
  ...
  return [((JavaUtilTreeSet *) nil_chk(geoTree)) toArrayWithNSObjectArray:[IOSObjectArray arrayWithLength:0 type:OrgGeogebraCommonKernelGeosGeoElement_class_()]];
}
...
IOSObjectArray *OrgGeogebraCommonGuiViewSpreadsheetRelativeCopy_getValuesWithOrgGeogebraCommonMainApp_withInt_withInt_withInt_withInt_(OrgGeogebraCommonMainApp *app, jint column1, jint row1, jint column2, jint row2) {
  OrgGeogebraCommonGuiViewSpreadsheetRelativeCopy_initialize();
  IOSObjectArray *values = [IOSObjectArray arrayWithDimensions:2 lengths:(jint[]){ (column2 - column1) + 1, (row2 - row1) + 1 } type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
  for (jint r = row1; r <= row2; ++r) {
    for (jint c = column1; c <= column2; ++c) {
      IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(values, c - column1)), r - row1, OrgGeogebraCommonGuiViewSpreadsheetRelativeCopy_getValueWithOrgGeogebraCommonMainApp_withInt_withInt_(app, c, r));
    }
  }
  return values;
}
