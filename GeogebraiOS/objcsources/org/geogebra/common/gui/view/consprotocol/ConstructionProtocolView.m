...
- (NSString *)getConsProtocolXML {
  ...
  (void) [sb appendWithNSString:@"\t<consProtColumns "];
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(((OrgGeogebraCommonGuiViewConsprotocolConstructionProtocolView_ConstructionTableData *) nil_chk(data_))->columns_))->size_; i++) {
    (void) [sb appendWithNSString:@" col"];
    (void) [sb appendWithInt:i];
    (void) [sb appendWithNSString:@"=\""];
    (void) [sb appendWithBoolean:[((OrgGeogebraCommonGuiViewConsprotocolConstructionProtocolView_ColumnData *) nil_chk(IOSObjectArray_Get(data_->columns_, i))) isVisible]];
    (void) [sb appendWithNSString:@"\""];
  }
  (void) [sb appendWithNSString:@"/>\n"];
  (void) [sb appendWithNSString:@"\t<consProtocol "];
  (void) [sb appendWithNSString:@"useColors=\""];
  (void) [sb appendWithBoolean:useColors_];
  (void) [sb appendWithNSString:@"\""];
  (void) [sb appendWithNSString:@" addIcons=\""];
  (void) [sb appendWithBoolean:addIcons_];
  (void) [sb appendWithNSString:@"\""];
  (void) [sb appendWithNSString:@" showOnlyBreakpoints=\""];
  (void) [sb appendWithBoolean:[((OrgGeogebraCommonKernelConstruction *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) getConstruction])) showOnlyBreakpoints]];
  (void) [sb appendWithNSString:@"\""];
  (void) [sb appendWithNSString:@"/>\n"];
...
void OrgGeogebraCommonGuiViewConsprotocolConstructionProtocolView_init(OrgGeogebraCommonGuiViewConsprotocolConstructionProtocolView *self) {
  ...
  self->navigationBars_ = new_JavaUtilArrayList_init();
}
...
- (void)updateAlgebraAndName {
  if ([geo_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoText class]]) algebra_ = JreStrcat("C$C", '"', [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(geo_)) toValueStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()], '"');
  else algebra_ = [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(geo_)) getAlgebraDescriptionTextOrHTMLDefaultWithOrgGeogebraCommonUtilIndexHTMLBuilder:new_OrgGeogebraCommonUtilIndexHTMLBuilder_initWithBoolean_(YES)];
  name_ = [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(geo_)) getNameDescriptionTextOrHTML];
}

- (void)updateCaption {
  caption_ = [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(geo_)) getCaptionDescriptionHTMLWithBoolean:YES withOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()];
}
...
- (void)updateAll {
  ...
  if (m != -1 && index != prevIndex) toolbarIcon_ = [self getModeIconWithInt:m];
  else toolbarIcon_ = nil;
  name_ = [geo_ getNameDescriptionTextOrHTML];
  if ([geo_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoText class]]) algebra_ = JreStrcat("C$C", '"', [geo_ toValueStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()], '"');
  else algebra_ = [geo_ getAlgebraDescriptionTextOrHTMLDefaultWithOrgGeogebraCommonUtilIndexHTMLBuilder:new_OrgGeogebraCommonUtilIndexHTMLBuilder_initWithBoolean_(YES)];
  definition_ = [geo_ getDefinitionDescriptionHTMLWithBoolean:YES];
  command_ = [geo_ getCommandDescriptionHTMLWithBoolean:YES];
  [self updateCaption];
  consProtocolVisible_ = new_JavaLangBoolean_initWithBoolean_([geo_ isConsProtocolBreakpoint]);
...
- (void)addWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  ...
  if (row == nil) {
    ...
    row = new_OrgGeogebraCommonGuiViewConsprotocolConstructionProtocolView_RowData_initWithOrgGeogebraCommonGuiViewConsprotocolConstructionProtocolView_withOrgGeogebraCommonKernelGeosGeoElement_(this$0_, geo);
    if (pos < size) {
    ...
    (void) [geoMap_ putWithId:geo withId:row];
...
void OrgGeogebraCommonGuiViewConsprotocolConstructionProtocolView_ConstructionTableData_initWithOrgGeogebraCommonGuiViewConsprotocolConstructionProtocolView_withOrgGeogebraCommonGuiSetLabels_(OrgGeogebraCommonGuiViewConsprotocolConstructionProtocolView_ConstructionTableData *self, OrgGeogebraCommonGuiViewConsprotocolConstructionProtocolView *outer$, id<OrgGeogebraCommonGuiSetLabels> gui) {
  ...
  (void) NSObject_init(self);
  self->ctData_ = self;
  self->columns_ = [IOSObjectArray newArrayWithObjects:(id[]){ new_OrgGeogebraCommonGuiViewConsprotocolConstructionProtocolView_ColumnData_initWithOrgGeogebraCommonGuiViewConsprotocolConstructionProtocolView_withNSString_withInt_withInt_withInt_withBoolean_(outer$, @"No.", 35, 35, OrgGeogebraCommonJavaxSwingSwingConstants_RIGHT, YES), new_OrgGeogebraCommonGuiViewConsprotocolConstructionProtocolView_ColumnData_initWithOrgGeogebraCommonGuiViewConsprotocolConstructionProtocolView_withNSString_withInt_withInt_withInt_withBoolean_(outer$, @"Name", 80, 50, OrgGeogebraCommonJavaxSwingSwingConstants_LEFT, YES), new_OrgGeogebraCommonGuiViewConsprotocolConstructionProtocolView_ColumnData_initWithOrgGeogebraCommonGuiViewConsprotocolConstructionProtocolView_withNSString_withInt_withInt_withInt_withBoolean_(outer$, @"ToolbarIcon", 35, 35, OrgGeogebraCommonJavaxSwingSwingConstants_CENTER, NO), new_OrgGeogebraCommonGuiViewConsprotocolConstructionProtocolView_ColumnData_initWithOrgGeogebraCommonGuiViewConsprotocolConstructionProtocolView_withNSString_withInt_withInt_withInt_withBoolean_(outer$, @"Definition", 150, 50, OrgGeogebraCommonJavaxSwingSwingConstants_LEFT, YES), new_OrgGeogebraCommonGuiViewConsprotocolConstructionProtocolView_ColumnData_initWithOrgGeogebraCommonGuiViewConsprotocolConstructionProtocolView_withNSString_withInt_withInt_withInt_withBoolean_(outer$, @"Command", 150, 50, OrgGeogebraCommonJavaxSwingSwingConstants_LEFT, NO), new_OrgGeogebraCommonGuiViewConsprotocolConstructionProtocolView_ColumnData_initWithOrgGeogebraCommonGuiViewConsprotocolConstructionProtocolView_withNSString_withInt_withInt_withInt_withBoolean_(outer$, @"Value", 150, 50, OrgGeogebraCommonJavaxSwingSwingConstants_LEFT, YES), new_OrgGeogebraCommonGuiViewConsprotocolConstructionProtocolView_ColumnData_initWithOrgGeogebraCommonGuiViewConsprotocolConstructionProtocolView_withNSString_withInt_withInt_withInt_withBoolean_(outer$, @"Caption", 150, 50, OrgGeogebraCommonJavaxSwingSwingConstants_LEFT, YES), new_OrgGeogebraCommonGuiViewConsprotocolConstructionProtocolView_ColumnData_initWithOrgGeogebraCommonGuiViewConsprotocolConstructionProtocolView_withNSString_withInt_withInt_withInt_withBoolean_(outer$, @"Breakpoint", 70, 35, OrgGeogebraCommonJavaxSwingSwingConstants_CENTER, NO) } count:8 type:OrgGeogebraCommonGuiViewConsprotocolConstructionProtocolView_ColumnData_class_()];
  self->columnsCount_ = self->columns_->size_;
  self->rowList_ = new_JavaUtilArrayList_init();
  self->geoMap_ = new_JavaUtilHashMap_init();
  self->gui_ = gui;
}
