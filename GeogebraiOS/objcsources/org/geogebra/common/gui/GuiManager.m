...
- (void)getConsProtocolXMLWithJavaLangStringBuilder:(JavaLangStringBuilder *)sb {
  if ([self isUsingConstructionProtocol]) (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:[((OrgGeogebraCommonGuiViewConsprotocolConstructionProtocolView *) nil_chk([self getConstructionProtocolView])) getConsProtocolXML]];
  if ([((OrgGeogebraCommonMainApp *) nil_chk((app_))) showConsProtNavigation]) {
    (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"\t<consProtNavigationBar "];
    (void) [sb appendWithNSString:@"show=\""];
    (void) [sb appendWithBoolean:[((OrgGeogebraCommonMainApp *) nil_chk((app_))) showConsProtNavigation]];
    (void) [sb appendWithChar:'"'];
    (void) [sb appendWithNSString:@" playButton=\""];
    (void) [sb appendWithBoolean:[((OrgGeogebraCommonGuiViewConsprotocolConstructionProtocolNavigation *) nil_chk([self getConstructionProtocolNavigation])) isPlayButtonVisible]];
    (void) [sb appendWithChar:'"'];
    (void) [sb appendWithNSString:@" playDelay=\""];
    (void) [sb appendWithDouble:[((OrgGeogebraCommonGuiViewConsprotocolConstructionProtocolNavigation *) nil_chk([self getConstructionProtocolNavigation])) getPlayDelay]];
    (void) [sb appendWithChar:'"'];
    (void) [sb appendWithNSString:@" protButton=\""];
    (void) [sb appendWithBoolean:[((OrgGeogebraCommonGuiViewConsprotocolConstructionProtocolNavigation *) nil_chk([self getConstructionProtocolNavigation])) isConsProtButtonVisible]];
    (void) [sb appendWithChar:'"'];
    (void) [sb appendWithNSString:@" consStep=\""];
    (void) [sb appendWithInt:[((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) getConstructionStep]];
    (void) [sb appendWithChar:'"'];
...
- (void)setShowConstructionProtocolNavigationWithBoolean:(jboolean)show {
  ...
  if (show) {
    ...
    (void) [self getConstructionProtocolView];
  }
}
...
- (JavaUtilHashMap *)getPlotPanelIDMap {
  if (plotPanelIDMap_ == nil) plotPanelIDMap_ = new_JavaUtilHashMap_init();
...
- (jint)assignPlotPanelIDWithOrgGeogebraCommonGuiViewDataPlotPanelEuclidianViewInterface:(id<OrgGeogebraCommonGuiViewDataPlotPanelEuclidianViewInterface>)plotPanel {
  ...
  (void) [((JavaUtilHashMap *) nil_chk([self getPlotPanelIDMap])) putWithId:JavaLangInteger_valueOfWithInt_(viewID) withId:plotPanel];
...
- (NSString *)getHelpURLWithOrgGeogebraCommonGuiGuiManager_HelpEnum:(OrgGeogebraCommonGuiGuiManager_HelpEnum *)type
  ...
  JavaLangStringBuilder *urlSB = new_JavaLangStringBuilder_init();
  (void) [urlSB appendWithNSString:OrgGeogebraCommonGeoGebraConstants_get_GEOGEBRA_WEBSITE_()];
  (void) [urlSB appendWithNSString:@"help/"];
  (void) [urlSB appendWithNSString:[((OrgGeogebraCommonMainLocalization *) nil_chk([((OrgGeogebraCommonMainApp *) nil_chk(app_)) getLocalization])) getLanguage]];
  switch ([type ordinal]) {
    case OrgGeogebraCommonGuiGuiManager_Help_COMMAND:
    pageName = [app_ getEnglishCommandWithNSString:pageName];
    (void) [urlSB appendWithNSString:@"/cmd/"];
    (void) [urlSB appendWithNSString:pageName];
    break;
    case OrgGeogebraCommonGuiGuiManager_Help_TOOL:
    (void) [urlSB appendWithNSString:@"/tool/"];
    (void) [urlSB appendWithNSString:pageName];
    break;
    case OrgGeogebraCommonGuiGuiManager_Help_GENERIC:
    (void) [urlSB appendWithNSString:@"/article/"];
    (void) [urlSB appendWithNSString:pageName];
    break;
    default:
...
- (void)refreshCustomToolsInToolBar {
  ...
  JavaLangStringBuilder *customToolBar = new_JavaLangStringBuilder_initWithNSString_(@"");
  for (jint i = 0; i < macroCount; i++) {
    ...
    if ([((OrgGeogebraCommonKernelMacro *) nil_chk(macro)) isShowInToolBar] && !([((NSString *) nil_chk([self getToolbarDefinition])) contains:NSString_valueOfInt_(macroMode)])) {
      (void) [customToolBar appendWithNSString:JreStrcat("CI", ' ', macroMode)];
    }
  }
