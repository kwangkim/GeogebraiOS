...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/io/layout/PerspectiveDecoder.java
//
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonIoLayoutPerspectiveDecoder class]) {
    JreStrongAssignAndConsume(&OrgGeogebraCommonIoLayoutPerspectiveDecoder_viewCodes_, nil, new_JavaUtilHashMap_init());
    {
      [OrgGeogebraCommonIoLayoutPerspectiveDecoder_viewCodes_ putWithId:@"G" withId:[new_OrgGeogebraCommonIoLayoutDockPanelData_initWithInt_withNSString_withBoolean_withBoolean_withBoolean_withOrgGeogebraCommonAwtGRectangle_withNSString_withInt_(OrgGeogebraCommonMainApp_VIEW_EUCLIDIAN, nil, YES, NO, NO, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newRectangleWithInt:100 withInt:100 withInt:600 withInt:400], @"1", 500) autorelease]];
      [OrgGeogebraCommonIoLayoutPerspectiveDecoder_viewCodes_ putWithId:@"A" withId:[new_OrgGeogebraCommonIoLayoutDockPanelData_initWithInt_withNSString_withBoolean_withBoolean_withBoolean_withOrgGeogebraCommonAwtGRectangle_withNSString_withInt_(OrgGeogebraCommonMainApp_VIEW_ALGEBRA, nil, NO, NO, NO, [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newRectangleWithInt:100 withInt:100 withInt:250 withInt:400], @"3,3", 200) autorelease]];
      [OrgGeogebraCommonIoLayoutPerspectiveDecoder_viewCodes_ putWithId:@"S" withId:[new_OrgGeogebraCommonIoLayoutDockPanelData_initWithInt_withNSString_withBoolean_withBoolean_withBoolean_withOrgGeogebraCommonAwtGRectangle_withNSString_withInt_(OrgGeogebraCommonMainApp_VIEW_SPREADSHEET, nil, YES, NO, NO, [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newRectangleWithInt:100 withInt:100 withInt:600 withInt:400], @"3", 300) autorelease]];
      [OrgGeogebraCommonIoLayoutPerspectiveDecoder_viewCodes_ putWithId:@"C" withId:[new_OrgGeogebraCommonIoLayoutDockPanelData_initWithInt_withNSString_withBoolean_withBoolean_withBoolean_withOrgGeogebraCommonAwtGRectangle_withNSString_withInt_(OrgGeogebraCommonMainApp_VIEW_CAS, nil, NO, NO, NO, [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newRectangleWithInt:100 withInt:100 withInt:600 withInt:400], @"3,1", 300) autorelease]];
      [OrgGeogebraCommonIoLayoutPerspectiveDecoder_viewCodes_ putWithId:@"P" withId:[new_OrgGeogebraCommonIoLayoutDockPanelData_initWithInt_withNSString_withBoolean_withBoolean_withBoolean_withOrgGeogebraCommonAwtGRectangle_withNSString_withInt_(OrgGeogebraCommonMainApp_VIEW_PROPERTIES, nil, NO, NO, YES, [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newRectangleWithInt:100 withInt:100 withInt:700 withInt:550], @"1,1", 400) autorelease]];
      [OrgGeogebraCommonIoLayoutPerspectiveDecoder_viewCodes_ putWithId:@"L" withId:[new_OrgGeogebraCommonIoLayoutDockPanelData_initWithInt_withNSString_withBoolean_withBoolean_withBoolean_withOrgGeogebraCommonAwtGRectangle_withNSString_withInt_(OrgGeogebraCommonMainApp_VIEW_CONSTRUCTION_PROTOCOL, nil, NO, NO, YES, [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newRectangleWithInt:100 withInt:100 withInt:700 withInt:550], @"1,1", 400) autorelease]];
      [OrgGeogebraCommonIoLayoutPerspectiveDecoder_viewCodes_ putWithId:@"D" withId:[new_OrgGeogebraCommonIoLayoutDockPanelData_initWithInt_withNSString_withBoolean_withBoolean_withBoolean_withOrgGeogebraCommonAwtGRectangle_withNSString_withInt_(OrgGeogebraCommonMainApp_VIEW_EUCLIDIAN2, nil, NO, NO, YES, [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newRectangleWithInt:100 withInt:100 withInt:700 withInt:550], @"1,1", 400) autorelease]];
      [OrgGeogebraCommonIoLayoutPerspectiveDecoder_viewCodes_ putWithId:@"T" withId:[new_OrgGeogebraCommonIoLayoutDockPanelData_initWithInt_withNSString_withBoolean_withBoolean_withBoolean_withOrgGeogebraCommonAwtGRectangle_withNSString_withInt_(OrgGeogebraCommonMainApp_VIEW_EUCLIDIAN3D, nil, NO, NO, YES, [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newRectangleWithInt:100 withInt:100 withInt:700 withInt:550], @"1,1", 400) autorelease]];
      [OrgGeogebraCommonIoLayoutPerspectiveDecoder_viewCodes_ putWithId:@"B" withId:[new_OrgGeogebraCommonIoLayoutDockPanelData_initWithInt_withNSString_withBoolean_withBoolean_withBoolean_withOrgGeogebraCommonAwtGRectangle_withNSString_withInt_(OrgGeogebraCommonMainApp_VIEW_PROBABILITY_CALCULATOR, nil, NO, NO, YES, [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newRectangleWithInt:100 withInt:100 withInt:700 withInt:550], @"1,1", 400) autorelease]];
      [OrgGeogebraCommonIoLayoutPerspectiveDecoder_viewCodes_ putWithId:@"R" withId:[new_OrgGeogebraCommonIoLayoutDockPanelData_initWithInt_withNSString_withBoolean_withBoolean_withBoolean_withOrgGeogebraCommonAwtGRectangle_withNSString_withInt_(OrgGeogebraCommonMainApp_VIEW_DATA_ANALYSIS, nil, NO, NO, YES, [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newRectangleWithInt:100 withInt:100 withInt:700 withInt:550], @"1,1", 400) autorelease]];
      [OrgGeogebraCommonIoLayoutPerspectiveDecoder_viewCodes_ putWithId:@"F" withId:[new_OrgGeogebraCommonIoLayoutDockPanelData_initWithInt_withNSString_withBoolean_withBoolean_withBoolean_withOrgGeogebraCommonAwtGRectangle_withNSString_withInt_(OrgGeogebraCommonMainApp_VIEW_FUNCTION_INSPECTOR, nil, NO, NO, YES, [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newRectangleWithInt:100 withInt:100 withInt:700 withInt:550], @"1,1", 400) autorelease]];
      [OrgGeogebraCommonIoLayoutPerspectiveDecoder_viewCodes_ putWithId:@"M" withId:[new_OrgGeogebraCommonIoLayoutDockPanelData_initWithInt_withNSString_withBoolean_withBoolean_withBoolean_withOrgGeogebraCommonAwtGRectangle_withNSString_withInt_(OrgGeogebraCommonMainApp_VIEW_DATA_COLLECTION, nil, YES, NO, NO, [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newRectangleWithInt:100 withInt:100 withInt:600 withInt:400], @"3", 300) autorelease]];
    }
...
OrgGeogebraCommonIoLayoutPerspective *OrgGeogebraCommonIoLayoutPerspectiveDecoder_decodeWithNSString_withOrgGeogebraCommonKernelParserParser_withNSString_(NSString *code, OrgGeogebraCommonKernelParserParser *parser, NSString *defToolbar) {
  ...
  if ([splitList isEmpty]) {
    [splitList addWithId:[new_OrgGeogebraCommonIoLayoutDockSplitPaneData_initWithNSString_withDouble_withInt_(@"", 1.0, 1) autorelease]];
  }
  IOSObjectArray *spData = [IOSObjectArray arrayWithLength:[splitList size] type:OrgGeogebraCommonIoLayoutDockSplitPaneData_class_()];
  [splitList toArrayWithNSObjectArray:spData];
  IOSObjectArray *dpData = [IOSObjectArray arrayWithLength:[panelList size] type:OrgGeogebraCommonIoLayoutDockPanelData_class_()];
  [panelList toArrayWithNSObjectArray:dpData];
  return [new_OrgGeogebraCommonIoLayoutPerspective_initWithNSString_withOrgGeogebraCommonIoLayoutDockSplitPaneDataArray_withOrgGeogebraCommonIoLayoutDockPanelDataArray_withNSString_withBoolean_withBoolean_withBoolean_withBoolean_withBoolean_withOrgGeogebraCommonMainApp_InputPositonEnum_(@"Custom", spData, dpData, defToolbar, YES, NO, YES, YES, YES, OrgGeogebraCommonMainApp_InputPositonEnum_get_algebraView()) autorelease];
}
...
void OrgGeogebraCommonIoLayoutPerspectiveDecoder_buildPerspectiveWithOrgGeogebraCommonKernelArithmeticExpressionValue_withNSString_withNSString_withJavaUtilArrayList_withJavaUtilArrayList_withDouble_withDouble_(id<OrgGeogebraCommonKernelArithmeticExpressionValue> expr, NSString *panelPath, NSString *splitPath, JavaUtilArrayList *panelList, JavaUtilArrayList *splitList, jdouble totalWidth, jdouble totalHeight) {
  ...
  if ([expr isKindOfClass:[OrgGeogebraCommonKernelArithmeticVariable class]]) {
    ...
    [((JavaUtilArrayList *) nil_chk(splitList)) addWithId:[new_OrgGeogebraCommonIoLayoutDockSplitPaneData_initWithNSString_withDouble_withInt_(((jint) [((NSString *) nil_chk(splitPath)) length]) > 0 ? [splitPath substring:1] : @"", horizontal ? width1 : height1, horizontal ? 1 : 0) autorelease]];
