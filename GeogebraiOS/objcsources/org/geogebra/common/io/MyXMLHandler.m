...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/io/MyXMLHandler.java
//
...
- (void)endDocument {
  if (mode_ == OrgGeogebraCommonIoMyXMLHandler_MODE_INVALID) @throw [new_OrgXmlSaxSAXException_initWithNSString_([((OrgGeogebraCommonMainLocalization *) nil_chk(loc_)) getPlainWithNSString:@"XMLTagANotFound" withNSString:@"<geogebra>"]) autorelease];
}
  ...
  switch (mode_) {
    ...
    if ([@"geogebra" isEqual:eName]) {
      ...
      @catch (JavaLangException *e) {
        @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSString_(loc_, @"FileFormatUnknown") autorelease];
      }
...
- (void)endElementWithNSString:(NSString *)eName {
  switch (mode_) {
    ...
    if ([@"euclidianView" isEqual:eName]) {
      OrgGeogebraCommonIoMyXMLHandler_set_evSet_(self, nil);
      mode_ = OrgGeogebraCommonIoMyXMLHandler_MODE_GEOGEBRA;
    }
    break;
    case OrgGeogebraCommonIoMyXMLHandler_MODE_EUCLIDIAN_VIEW3D:
...
- (id<OrgGeogebraCommonKernelKernelNDGeoPointND>)handleAbsoluteStartPointWithJavaUtilLinkedHashMap:(JavaUtilLinkedHashMap *)attrs {
  ...
  OrgGeogebraCommonKernelGeosGeoPoint *p = [new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonIoMyXMLHandler class]) {
    ...
    JreStrongAssignAndConsume(&OrgGeogebraCommonIoMyXMLHandler_menuFontSizes_, nil, [IOSIntArray newArrayWithInts:(jint[]){ 12, 14, 16, 18, 20, 24, 28, 32, 48 } count:9]);
    JreStrongAssignAndConsume(&OrgGeogebraCommonIoMyXMLHandler_tooltipTimeouts_, nil, [IOSObjectArray newArrayWithObjects:(id[]){ @"1", @"3", @"5", @"10", @"20", @"30", @"60", @"0" } count:8 type:NSString_class_()]);
    JreStrongAssignAndConsume(&OrgGeogebraCommonIoMyXMLHandler_cbTimeoutOptions_, nil, [IOSObjectArray newArrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(5), JavaLangInteger_valueOfWithInt_(10), JavaLangInteger_valueOfWithInt_(20), JavaLangInteger_valueOfWithInt_(30), JavaLangInteger_valueOfWithInt_(60) } count:5 type:JavaLangInteger_class_()]);
...
void OrgGeogebraCommonIoMyXMLHandler_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonIoMyXMLHandler *self, OrgGeogebraCommonKernelKernel *kernel, OrgGeogebraCommonKernelConstruction *cons) {
  NSObject_init(self);
  OrgGeogebraCommonIoMyXMLHandler_setAndConsume_startPointList_(self, new_JavaUtilLinkedList_init());
  OrgGeogebraCommonIoMyXMLHandler_setAndConsume_linkedGeoList_(self, new_JavaUtilLinkedList_init());
  OrgGeogebraCommonIoMyXMLHandler_setAndConsume_showObjectConditionList_(self, new_JavaUtilLinkedList_init());
  OrgGeogebraCommonIoMyXMLHandler_setAndConsume_dynamicColorList_(self, new_JavaUtilLinkedList_init());
  OrgGeogebraCommonIoMyXMLHandler_setAndConsume_animationSpeedList_(self, new_JavaUtilLinkedList_init());
  OrgGeogebraCommonIoMyXMLHandler_setAndConsume_animationStepList_(self, new_JavaUtilLinkedList_init());
  OrgGeogebraCommonIoMyXMLHandler_setAndConsume_animatingList_(self, new_JavaUtilLinkedList_init());
  OrgGeogebraCommonIoMyXMLHandler_setAndConsume_minMaxList_(self, new_JavaUtilLinkedList_init());
  self->hasGuiElement_ = NO;
  OrgGeogebraCommonIoMyXMLHandler_setAndConsume_tmp_perspectives_(self, new_JavaUtilArrayList_init());
  self->resetEVsettingsNeeded_ = NO;
  OrgGeogebraCommonIoMyXMLHandler_set_evSet_(self, nil);
  OrgGeogebraCommonIoMyXMLHandler_setAndConsume_xmin_(self, new_JavaUtilHashMap_init());
  OrgGeogebraCommonIoMyXMLHandler_setAndConsume_xmax_(self, new_JavaUtilHashMap_init());
  OrgGeogebraCommonIoMyXMLHandler_setAndConsume_ymin_(self, new_JavaUtilHashMap_init());
  OrgGeogebraCommonIoMyXMLHandler_setAndConsume_ymax_(self, new_JavaUtilHashMap_init());
  OrgGeogebraCommonIoMyXMLHandler_set_origKernel_(self, kernel);
  OrgGeogebraCommonIoMyXMLHandler_set_origCons_(self, cons);
  OrgGeogebraCommonIoMyXMLHandler_setAndConsume_origParser_(self, new_OrgGeogebraCommonKernelParserParser_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelConstruction_(self->origKernel_, self->origCons_));
  OrgGeogebraCommonIoMyXMLHandler_set_app_(self, [((OrgGeogebraCommonKernelKernel *) nil_chk(self->origKernel_)) getApplication]);
  OrgGeogebraCommonIoMyXMLHandler_set_loc_(self, [((OrgGeogebraCommonMainApp *) nil_chk(self->app_)) getLocalization]);
  OrgGeogebraCommonIoMyXMLHandler_initKernelVars(self);
...
void OrgGeogebraCommonIoMyXMLHandler_initKernelVars(OrgGeogebraCommonIoMyXMLHandler *self) {
  OrgGeogebraCommonIoMyXMLHandler_set_kernel_(self, self->origKernel_);
  OrgGeogebraCommonIoMyXMLHandler_set_parser_(self, self->origParser_);
  OrgGeogebraCommonIoMyXMLHandler_set_cons_(self, [((OrgGeogebraCommonKernelKernel *) nil_chk(self->origKernel_)) getConstruction]);
}
...
void OrgGeogebraCommonIoMyXMLHandler_startGeoGebraElementWithNSString_withJavaUtilLinkedHashMap_(OrgGeogebraCommonIoMyXMLHandler *self, NSString *eName, JavaUtilLinkedHashMap *attrs) {
  if ([@"euclidianView" isEqual:eName]) {
    ...
    OrgGeogebraCommonIoMyXMLHandler_setAndConsume_tmp_perspective_(self, new_OrgGeogebraCommonIoLayoutPerspective_initWithNSString_(@"tmp"));
...
void OrgGeogebraCommonIoMyXMLHandler_startMacroElementWithNSString_withJavaUtilLinkedHashMap_(OrgGeogebraCommonIoMyXMLHandler *self, NSString *eName, JavaUtilLinkedHashMap *attrs) {
  if ([@"macroInput" isEqual:eName]) {
    OrgGeogebraCommonIoMyXMLHandler_set_macroInputLabels_(self, OrgGeogebraCommonIoMyXMLHandler_getAttributeStringsWithJavaUtilLinkedHashMap_(attrs));
  }
  else if ([@"macroOutput" isEqual:eName]) {
    OrgGeogebraCommonIoMyXMLHandler_set_macroOutputLabels_(self, OrgGeogebraCommonIoMyXMLHandler_getAttributeStringsWithJavaUtilLinkedHashMap_(attrs));
  }
  else if ([@"construction" isEqual:eName]) {
    self->mode_ = OrgGeogebraCommonIoMyXMLHandler_MODE_CONSTRUCTION;
    OrgGeogebraCommonIoMyXMLHandler_handleConstructionWithJavaUtilLinkedHashMap_(self, attrs);
...
void OrgGeogebraCommonIoMyXMLHandler_startEuclidianViewElementWithNSString_withJavaUtilLinkedHashMap_(OrgGeogebraCommonIoMyXMLHandler *self, NSString *eName, JavaUtilLinkedHashMap *attrs) {
  if ([@"viewNumber" isEqual:eName]) {
    ...
    if (number == 2) OrgGeogebraCommonIoMyXMLHandler_set_evSet_(self, [((OrgGeogebraCommonMainSettingsSettings *) nil_chk([((OrgGeogebraCommonMainApp *) nil_chk(self->app_)) getSettings])) getEuclidianWithInt:2]);
    else OrgGeogebraCommonIoMyXMLHandler_set_evSet_(self, [((OrgGeogebraCommonMainSettingsSettings *) nil_chk([((OrgGeogebraCommonMainApp *) nil_chk(self->app_)) getSettings])) getEuclidianWithInt:1]);
  }
  else {
    [self startEuclidianViewElementCheckViewIdWithNSString:eName withJavaUtilLinkedHashMap:attrs];
  }
  if (self->evSet_ == nil) OrgGeogebraCommonIoMyXMLHandler_set_evSet_(self, [((OrgGeogebraCommonMainSettingsSettings *) nil_chk([((OrgGeogebraCommonMainApp *) nil_chk(self->app_)) getSettings])) getEuclidianWithInt:1]);
...
jboolean OrgGeogebraCommonIoMyXMLHandler_handleSpreadsheetInitalSelectionWithJavaUtilLinkedHashMap_(OrgGeogebraCommonIoMyXMLHandler *self, JavaUtilLinkedHashMap *attrs) {
  ...
  @try {
    ...
    [((OrgGeogebraCommonMainSettingsSpreadsheetSettings *) nil_chk(settings)) setScrollPositionWithOrgGeogebraCommonAwtGPoint:[new_OrgGeogebraCommonAwtGPoint_initWithInt_withInt_(hScroll, vScroll) autorelease]];
    ...
    [settings setScrollPositionWithOrgGeogebraCommonAwtGPoint:[new_OrgGeogebraCommonAwtGPoint_initWithInt_withInt_(row, column) autorelease]];
    return YES;
  }
  @catch (JavaLangException *e) {
    return NO;
...
void OrgGeogebraCommonIoMyXMLHandler_createCompabilityLayout(OrgGeogebraCommonIoMyXMLHandler *self) {
  ...
  IOSObjectArray *dpXml = [IOSObjectArray arrayWithObjects:(id[]){ [new_OrgGeogebraCommonIoLayoutDockPanelData_initWithInt_withNSString_withBoolean_withBoolean_withBoolean_withOrgGeogebraCommonAwtGRectangle_withNSString_withInt_(OrgGeogebraCommonMainApp_VIEW_EUCLIDIAN, nil, YES, NO, NO, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newRectangleWithInt:400 withInt:400], defEV, width) autorelease], [new_OrgGeogebraCommonIoLayoutDockPanelData_initWithInt_withNSString_withBoolean_withBoolean_withBoolean_withOrgGeogebraCommonAwtGRectangle_withNSString_withInt_(OrgGeogebraCommonMainApp_VIEW_ALGEBRA, nil, self->tmp_showAlgebra_, NO, NO, [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newRectangleWithInt:200 withInt:400], defAV, (self->tmp_showAlgebra_ && self->tmp_sp2_ > 0) ? self->tmp_sp2_ : 200) autorelease], [new_OrgGeogebraCommonIoLayoutDockPanelData_initWithInt_withNSString_withBoolean_withBoolean_withBoolean_withOrgGeogebraCommonAwtGRectangle_withNSString_withInt_(OrgGeogebraCommonMainApp_VIEW_SPREADSHEET, nil, self->tmp_showSpreadsheet_, NO, NO, [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newRectangleWithInt:400 withInt:400], defSV, ssize) autorelease] } count:3 type:OrgGeogebraCommonIoLayoutDockPanelData_class_()];
  ...
  if (self->tmp_showSpreadsheet_ && self->tmp_showAlgebra_) {
    ...
    spXml = [IOSObjectArray arrayWithObjects:(id[]){ [new_OrgGeogebraCommonIoLayoutDockSplitPaneData_initWithNSString_withDouble_withInt_(@"", relative1, splitOrientation) autorelease], [new_OrgGeogebraCommonIoLayoutDockSplitPaneData_initWithNSString_withDouble_withInt_((splitOrientation == OrgGeogebraCommonIoMyXMLHandler_JSplitPane_HORIZONTAL_SPLIT ? @"1" : @"2"), relative2, splitOrientation) autorelease] } count:2 type:OrgGeogebraCommonIoLayoutDockSplitPaneData_class_()];
  }
  else {
    jint total = (splitOrientation == OrgGeogebraCommonIoMyXMLHandler_JSplitPane_HORIZONTAL_SPLIT ? width : height);
    jfloat relative;
    ...
    spXml = [IOSObjectArray arrayWithObjects:(id[]){ [new_OrgGeogebraCommonIoLayoutDockSplitPaneData_initWithNSString_withDouble_withInt_(@"", relative, splitOrientation) autorelease] } count:1 type:OrgGeogebraCommonIoLayoutDockSplitPaneData_class_()];
  }
  width += 15;
  height += 90;
...
jboolean OrgGeogebraCommonIoMyXMLHandler_handlePerspectiveWithJavaUtilLinkedHashMap_(OrgGeogebraCommonIoMyXMLHandler *self, JavaUtilLinkedHashMap *attrs) {
  @try {
    OrgGeogebraCommonIoMyXMLHandler_setAndConsume_tmp_perspective_(self, new_OrgGeogebraCommonIoLayoutPerspective_initWithNSString_([((JavaUtilLinkedHashMap *) nil_chk(attrs)) getWithId:@"id"]));
    [((JavaUtilArrayList *) nil_chk(self->tmp_perspectives_)) addWithId:self->tmp_perspective_];
    if (self->tmp_panes_ == nil) {
      OrgGeogebraCommonIoMyXMLHandler_setAndConsume_tmp_panes_(self, new_JavaUtilArrayList_init());
    }
    else {
      [self->tmp_panes_ clear];
    }
    if (self->tmp_views_ == nil) {
      OrgGeogebraCommonIoMyXMLHandler_setAndConsume_tmp_views_(self, new_JavaUtilArrayList_init());
    }
    else {
...
void OrgGeogebraCommonIoMyXMLHandler_endGuiPerspectiveElement(OrgGeogebraCommonIoMyXMLHandler *self) {
  IOSObjectArray *dpInfo = [IOSObjectArray arrayWithLength:[((JavaUtilArrayList *) nil_chk(self->tmp_views_)) size] type:OrgGeogebraCommonIoLayoutDockPanelData_class_()];
  IOSObjectArray *spInfo = [IOSObjectArray arrayWithLength:[((JavaUtilArrayList *) nil_chk(self->tmp_panes_)) size] type:OrgGeogebraCommonIoLayoutDockSplitPaneData_class_()];
...
jboolean OrgGeogebraCommonIoMyXMLHandler_handlePaneWithJavaUtilLinkedHashMap_(OrgGeogebraCommonIoMyXMLHandler *self, JavaUtilLinkedHashMap *attrs) {
  @try {
    ...
    [((JavaUtilArrayList *) nil_chk(self->tmp_panes_)) addWithId:[new_OrgGeogebraCommonIoLayoutDockSplitPaneData_initWithNSString_withDouble_withInt_(location, dividerLocation, orientation) autorelease]];
    return YES;
  }
  @catch (JavaLangException *e) {
    OrgGeogebraCommonMainApp_debugWithNSString_(JreStrcat("$$@", [((JavaLangException *) nil_chk(e)) getMessage], @": ", [e getCause]));
...
void OrgGeogebraCommonIoMyXMLHandler_initMacroWithJavaUtilLinkedHashMap_(OrgGeogebraCommonIoMyXMLHandler *self, JavaUtilLinkedHashMap *attrs) {
  @try {
    ...
    OrgGeogebraCommonIoMyXMLHandler_setAndConsume_macro_(self, new_OrgGeogebraCommonKernelMacro_initWithOrgGeogebraCommonKernelKernel_withNSString_(self->kernel_, myCmdName));
    ...
    OrgGeogebraCommonIoMyXMLHandler_set_kernel_(self, macroKernel);
    OrgGeogebraCommonIoMyXMLHandler_set_cons_(self, [macroKernel getConstruction]);
    OrgGeogebraCommonIoMyXMLHandler_setAndConsume_parser_(self, new_OrgGeogebraCommonKernelParserParser_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelConstruction_(macroKernel, self->cons_));
  }
  @catch (JavaLangException *e) {
...
void OrgGeogebraCommonIoMyXMLHandler_endCasCellWithNSString_(OrgGeogebraCommonIoMyXMLHandler *self, NSString *eName) {
  switch (self->casMode_) {
    ...
    if ([@"cascell" isEqual:eName]) {
      ...
      OrgGeogebraCommonIoMyXMLHandler_set_geoCasCell_(self, nil);
    }
    break;
    case OrgGeogebraCommonIoMyXMLHandler_MODE_CAS_CELL_PAIR:
    if ([@"cellPair" isEqual:eName]) {
...
void OrgGeogebraCommonIoMyXMLHandler_startCellPair(OrgGeogebraCommonIoMyXMLHandler *self) {
  OrgGeogebraCommonIoMyXMLHandler_setAndConsume_geoCasCell_(self, new_OrgGeogebraCommonKernelGeosGeoCasCell_initWithOrgGeogebraCommonKernelConstruction_(self->cons_));
}
...
void OrgGeogebraCommonIoMyXMLHandler_endCellPairWithNSString_(OrgGeogebraCommonIoMyXMLHandler *self, NSString *eName) {
  ...
  @try {
    ...
    if (independentCell) {
      ...
      OrgGeogebraCommonKernelKernelCAS_DependentCasCellWithOrgGeogebraCommonKernelGeosGeoCasCell_(self->geoCasCell_);
    }
  }
  @catch (JavaLangException *e) {
...
void OrgGeogebraCommonIoMyXMLHandler_startDefaultWithNSString_withJavaUtilLinkedHashMap_(OrgGeogebraCommonIoMyXMLHandler *self, NSString *eName, JavaUtilLinkedHashMap *attrs) {
  switch (self->constMode_) {
    ...
    if ([@"element" isEqual:eName]) {
      ...
      OrgGeogebraCommonIoMyXMLHandler_set_geo_(self, OrgGeogebraCommonIoMyXMLHandler_getGeoElementWithJavaUtilLinkedHashMap_(self, attrs));
...
void OrgGeogebraCommonIoMyXMLHandler_startConstructionElementWithNSString_withJavaUtilLinkedHashMap_(OrgGeogebraCommonIoMyXMLHandler *self, NSString *eName, JavaUtilLinkedHashMap *attrs) {
  switch (self->constMode_) {
    ...
    if ([@"element" isEqual:eName]) {
      ...
      OrgGeogebraCommonIoMyXMLHandler_set_cmd_(self, OrgGeogebraCommonIoMyXMLHandler_getCommandWithJavaUtilLinkedHashMap_(self, attrs));
    }
...
jboolean OrgGeogebraCommonIoMyXMLHandler_handleObjColorWithJavaUtilLinkedHashMap_(OrgGeogebraCommonIoMyXMLHandler *self, JavaUtilLinkedHashMap *attrs) {
  ...
  if (red != nil && green != nil && blue != nil) @try {
    if (![red isEqual:@""] || ![green isEqual:@""] || ![blue isEqual:@""]) {
      ...
      [sb appendWithChar:'}'];
      [((JavaUtilLinkedList *) nil_chk(self->dynamicColorList_)) addWithId:[new_OrgGeogebraCommonIoMyXMLHandler_GeoExpPair_initWithOrgGeogebraCommonIoMyXMLHandler_withOrgGeogebraCommonKernelGeosGeoElement_withNSString_(self, self->geo_, [sb description]) autorelease]];
...
jboolean OrgGeogebraCommonIoMyXMLHandler_handleListenersWithJavaUtilLinkedHashMap_(OrgGeogebraCommonIoMyXMLHandler *self, JavaUtilLinkedHashMap *attrs) {
  @try {
    if ([@"objectUpdate" isEqual:[((JavaUtilLinkedHashMap *) nil_chk(attrs)) getWithId:@"type"]]) {
      [((JavaUtilHashMap *) nil_chk([((OrgGeogebraCommonPluginScriptManager *) nil_chk([((OrgGeogebraCommonMainApp *) nil_chk(self->app_)) getScriptManager])) getUpdateListenerMap])) putWithId:self->geo_ withId:[attrs getWithId:@"val"]];
    }
    if ([@"objectClick" isEqual:[attrs getWithId:@"type"]]) {
      [((JavaUtilHashMap *) nil_chk([((OrgGeogebraCommonPluginScriptManager *) nil_chk([((OrgGeogebraCommonMainApp *) nil_chk(self->app_)) getScriptManager])) getClickListenerMap])) putWithId:self->geo_ withId:[attrs getWithId:@"val"]];
    }
    return YES;
  }
  @catch (JavaLangException *e) {
...
jboolean OrgGeogebraCommonIoMyXMLHandler_handleConditionWithJavaUtilLinkedHashMap_(OrgGeogebraCommonIoMyXMLHandler *self, JavaUtilLinkedHashMap *attrs) {
  @try {
    ...
    if (strShowObjectCond != nil) {
      [((JavaUtilLinkedList *) nil_chk(self->showObjectConditionList_)) addWithId:[new_OrgGeogebraCommonIoMyXMLHandler_GeoExpPair_initWithOrgGeogebraCommonIoMyXMLHandler_withOrgGeogebraCommonKernelGeosGeoElement_withNSString_(self, self->geo_, strShowObjectCond) autorelease]];
    }
    return YES;
  }
  @catch (JavaLangException *e) {
...
jboolean OrgGeogebraCommonIoMyXMLHandler_handleSliderWithJavaUtilLinkedHashMap_(OrgGeogebraCommonIoMyXMLHandler *self, JavaUtilLinkedHashMap *attrs) {
  ...
  @try {
    ...
    if (strMin != nil || strMax != nil) {
      [((JavaUtilLinkedList *) nil_chk(self->minMaxList_)) addWithId:[new_OrgGeogebraCommonIoMyXMLHandler_GeoNumericMinMax_initWithOrgGeogebraCommonIoMyXMLHandler_withOrgGeogebraCommonKernelGeosGeoElement_withNSString_withNSString_(self, self->geo_, strMin, strMax) autorelease]];
    }
...
jboolean OrgGeogebraCommonIoMyXMLHandler_handleAnimationWithJavaUtilLinkedHashMap_(OrgGeogebraCommonIoMyXMLHandler *self, JavaUtilLinkedHashMap *attrs) {
  @try {
    ...
    if (strStep != nil) {
      [((JavaUtilLinkedList *) nil_chk(self->animationStepList_)) addWithId:[new_OrgGeogebraCommonIoMyXMLHandler_GeoExpPair_initWithOrgGeogebraCommonIoMyXMLHandler_withOrgGeogebraCommonKernelGeosGeoElement_withNSString_(self, self->geo_, strStep) autorelease]];
    }
    NSString *strSpeed = [attrs getWithId:@"speed"];
    if (strSpeed != nil) {
      [((JavaUtilLinkedList *) nil_chk(self->animationSpeedList_)) addWithId:[new_OrgGeogebraCommonIoMyXMLHandler_GeoExpPair_initWithOrgGeogebraCommonIoMyXMLHandler_withOrgGeogebraCommonKernelGeosGeoElement_withNSString_(self, self->geo_, strSpeed) autorelease]];
    }
    NSString *type = [attrs getWithId:@"type"];
...
jboolean OrgGeogebraCommonIoMyXMLHandler_handleStartPointWithJavaUtilLinkedHashMap_(OrgGeogebraCommonIoMyXMLHandler *self, JavaUtilLinkedHashMap *attrs) {
  ...
  if (exp != nil) {
    [((JavaUtilLinkedList *) nil_chk(self->startPointList_)) addWithId:[new_OrgGeogebraCommonIoMyXMLHandler_LocateableExpPair_initWithOrgGeogebraCommonIoMyXMLHandler_withOrgGeogebraCommonKernelLocateable_withNSString_withInt_(self, locGeo, exp, number) autorelease]];
    ...
    @try {
      ...
      if (number == 0) {
        ...
        [((JavaUtilLinkedList *) nil_chk(self->startPointList_)) addWithId:[new_OrgGeogebraCommonIoMyXMLHandler_LocateableExpPair_initWithOrgGeogebraCommonIoMyXMLHandler_withOrgGeogebraCommonKernelLocateable_withOrgGeogebraCommonKernelKernelNDGeoPointND_withInt_(self, locGeo, p, number) autorelease]];
        [((id<OrgGeogebraCommonKernelLocateable>) nil_chk(locGeo)) setWaitForStartPoint];
      }
    }
    @catch (JavaLangException *e) {
...
void OrgGeogebraCommonIoMyXMLHandler_processStartPointList(OrgGeogebraCommonIoMyXMLHandler *self) {
  ...
  @catch (JavaLangException *e) {
    [((JavaUtilLinkedList *) nil_chk(self->startPointList_)) clear];
    [((JavaLangException *) nil_chk(e)) printStackTrace];
    @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSString_(self->loc_, JreStrcat("$$", @"processStartPointList: ", [e description])) autorelease];
  }
  [((JavaUtilLinkedList *) nil_chk(self->startPointList_)) clear];
}
...
jboolean OrgGeogebraCommonIoMyXMLHandler_handleLengthWithJavaUtilLinkedHashMap_(OrgGeogebraCommonIoMyXMLHandler *self, JavaUtilLinkedHashMap *attrs) {
  ...
  if ([self->geo_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoTextField class]]) {
    ...
    @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSString_(self->loc_, JreStrcat("$@", @"handleLength: ", [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(self->geo_)) getGeoClassType])) autorelease];
  }
  return YES;
}
...
jboolean OrgGeogebraCommonIoMyXMLHandler_handleLinkedGeoWithJavaUtilLinkedHashMap_(OrgGeogebraCommonIoMyXMLHandler *self, JavaUtilLinkedHashMap *attrs) {
  NSString *exp = [((JavaUtilLinkedHashMap *) nil_chk(attrs)) getWithId:@"exp"];
  if (exp != nil) {
    [((JavaUtilLinkedList *) nil_chk(self->linkedGeoList_)) addWithId:[new_OrgGeogebraCommonIoMyXMLHandler_GeoExpPair_initWithOrgGeogebraCommonIoMyXMLHandler_withOrgGeogebraCommonKernelGeosGeoElement_withNSString_(self, self->geo_, exp) autorelease]];
  }
  else return NO;
  return YES;
}
...
void OrgGeogebraCommonIoMyXMLHandler_processLinkedGeoList(OrgGeogebraCommonIoMyXMLHandler *self) {
  ...
  @catch (JavaLangException *e) {
    [((JavaUtilLinkedList *) nil_chk(self->linkedGeoList_)) clear];
    [((JavaLangException *) nil_chk(e)) printStackTrace];
    @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSString_(self->loc_, JreStrcat("$$", @"processlinkedGeoList: ", [e description])) autorelease];
  }
  [((JavaUtilLinkedList *) nil_chk(self->linkedGeoList_)) clear];
}
...
void OrgGeogebraCommonIoMyXMLHandler_processShowObjectConditionList(OrgGeogebraCommonIoMyXMLHandler *self) {
  ...
  @catch (JavaLangException *e) {
    [((JavaUtilLinkedList *) nil_chk(self->showObjectConditionList_)) clear];
    [((JavaLangException *) nil_chk(e)) printStackTrace];
    @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSString_(self->loc_, JreStrcat("$$", @"processShowObjectConditionList: ", [e description])) autorelease];
  }
  [((JavaUtilLinkedList *) nil_chk(self->showObjectConditionList_)) clear];
}
...
void OrgGeogebraCommonIoMyXMLHandler_processAnimationSpeedList(OrgGeogebraCommonIoMyXMLHandler *self) {
  ...
  @catch (JavaLangException *e) {
    [((JavaUtilLinkedList *) nil_chk(self->animationSpeedList_)) clear];
    [((JavaLangException *) nil_chk(e)) printStackTrace];
    @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSString_(self->loc_, JreStrcat("$$", @"processAnimationSpeedList: ", [e description])) autorelease];
  }
  [((JavaUtilLinkedList *) nil_chk(self->animationSpeedList_)) clear];
}
...
void OrgGeogebraCommonIoMyXMLHandler_processAnimationStepList(OrgGeogebraCommonIoMyXMLHandler *self) {
  ...
  @catch (JavaLangException *e) {
    [((JavaUtilLinkedList *) nil_chk(self->animationStepList_)) clear];
    [((JavaLangException *) nil_chk(e)) printStackTrace];
    @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSString_(self->loc_, JreStrcat("$$", @"processAnimationStepList: ", [e description])) autorelease];
  }
  [((JavaUtilLinkedList *) nil_chk(self->animationSpeedList_)) clear];
}
...
void OrgGeogebraCommonIoMyXMLHandler_processAnimatingList(OrgGeogebraCommonIoMyXMLHandler *self) {
  ...
  @catch (JavaLangException *e) {
    [((JavaUtilLinkedList *) nil_chk(self->animatingList_)) clear];
    [((JavaLangException *) nil_chk(e)) printStackTrace];
    @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSString_(self->loc_, JreStrcat("$$", @"processAnimatingList: ", [e description])) autorelease];
  }
  [((JavaUtilLinkedList *) nil_chk(self->animatingList_)) clear];
}
...
void OrgGeogebraCommonIoMyXMLHandler_processMinMaxList(OrgGeogebraCommonIoMyXMLHandler *self) {
  ...
  @catch (JavaLangException *e) {
    [((JavaUtilLinkedList *) nil_chk(self->minMaxList_)) clear];
    [((JavaLangException *) nil_chk(e)) printStackTrace];
    @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSString_(self->loc_, JreStrcat("$$", @"processMinMaxList: ", [e description])) autorelease];
  }
  [((JavaUtilLinkedList *) nil_chk(self->minMaxList_)) clear];
}
...
void OrgGeogebraCommonIoMyXMLHandler_processDynamicColorList(OrgGeogebraCommonIoMyXMLHandler *self) {
  ...
  @catch (JavaLangException *e) {
    [((JavaUtilLinkedList *) nil_chk(self->dynamicColorList_)) clear];
    [((JavaLangException *) nil_chk(e)) printStackTrace];
    @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSString_(self->loc_, JreStrcat("$$", @"dynamicColorList: ", [e description])) autorelease];
  }
  [((JavaUtilLinkedList *) nil_chk(self->dynamicColorList_)) clear];
}
...
OrgGeogebraCommonKernelArithmeticCommand *OrgGeogebraCommonIoMyXMLHandler_getCommandWithJavaUtilLinkedHashMap_(OrgGeogebraCommonIoMyXMLHandler *self, JavaUtilLinkedHashMap *attrs) {
  ...
  if (name != nil) command = [new_OrgGeogebraCommonKernelArithmeticCommand_initWithOrgGeogebraCommonKernelKernel_withNSString_withBoolean_(self->kernel_, name, NO) autorelease];
  else @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSString_(self->loc_, @"name missing in <command>") autorelease];
  return command;
}
...
void OrgGeogebraCommonIoMyXMLHandler_startCommandElementWithNSString_withJavaUtilLinkedHashMap_(OrgGeogebraCommonIoMyXMLHandler *self, NSString *eName, JavaUtilLinkedHashMap *attrs) {
  jboolean ok = YES;
  if ([@"input" isEqual:eName]) {
    if (self->cmd_ == nil) @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSString_(self->loc_, @"no command set for <input>") autorelease];
  ...
  for (NSString * __strong key in keys) {
    @try {
      ...
      if (geo1 != nil && [((NSString *) nil_chk(arg)) indexOf:'$'] < 0) {
        en = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self->kernel_, geo1) autorelease];
      }
      else {
    ...
    @catch (JavaLangException *e) {
      [((JavaLangException *) nil_chk(e)) printStackTrace];
      @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSString_(self->loc_, JreStrcat("$$", @"unknown command input: ", arg)) autorelease];
    }
...
jboolean OrgGeogebraCommonIoMyXMLHandler_handleCmdOutputWithJavaUtilLinkedHashMap_(OrgGeogebraCommonIoMyXMLHandler *self, JavaUtilLinkedHashMap *attrs) {
  @try {
    ...
    OrgGeogebraCommonIoMyXMLHandler_set_cmdOutput_(self, [((OrgGeogebraCommonKernelCommandsAlgebraProcessor *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) getAlgebraProcessor])) processCommandWithOrgGeogebraCommonKernelArithmeticCommand:self->cmd_ withBoolean:YES]);
    ...
    if (self->cmdOutput_ == nil) @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSString_(self->loc_, JreStrcat("$@$", @"processing of command ", self->cmd_, @" failed")) autorelease];
    OrgGeogebraCommonIoMyXMLHandler_set_cmd_(self, nil);
  ...
  @catch (JavaLangException *e) {
    [((JavaLangException *) nil_chk(e)) printStackTrace];
    @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSString_(self->loc_, JreStrcat("$@", @"processing of command: ", self->cmd_)) autorelease];
  }
}
...
void OrgGeogebraCommonIoMyXMLHandler_startExpressionElementWithJavaUtilLinkedHashMap_(OrgGeogebraCommonIoMyXMLHandler *self, JavaUtilLinkedHashMap *attrs) {
  ...
  if (exp == nil) @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSString_(self->loc_, @"exp missing in <expression>") autorelease];
  NSString *type = [attrs getWithId:@"type"];
  @try {
  ...
  @catch (JavaLangException *e) {
    ...
    [((JavaLangException *) nil_chk(e)) printStackTrace];
    @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSString_(self->loc_, msg) autorelease];
  }
  @catch (JavaLangError *e) {
    NSString *msg = JreStrcat("$$$$", @"error in <expression>: label = ", label, @", exp = ", exp);
    OrgGeogebraCommonMainApp_errorWithNSString_(msg);
...
- (void)setGeoWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  OrgGeogebraCommonIoMyXMLHandler_GeoExpPair_set_geoElement_(self, geo);
}
...
void OrgGeogebraCommonIoMyXMLHandler_GeoExpPair_initWithOrgGeogebraCommonIoMyXMLHandler_withOrgGeogebraCommonKernelGeosGeoElement_withNSString_(OrgGeogebraCommonIoMyXMLHandler_GeoExpPair *self, OrgGeogebraCommonIoMyXMLHandler *outer$, OrgGeogebraCommonKernelGeosGeoElement *g, NSString *exp) {
  ...
  OrgGeogebraCommonIoMyXMLHandler_GeoExpPair_set_exp_(self, exp);
}
...
- (void)setGeoWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  OrgGeogebraCommonIoMyXMLHandler_GeoNumericMinMax_set_geoElement_(self, geo);
}
...
void OrgGeogebraCommonIoMyXMLHandler_GeoNumericMinMax_initWithOrgGeogebraCommonIoMyXMLHandler_withOrgGeogebraCommonKernelGeosGeoElement_withNSString_withNSString_(OrgGeogebraCommonIoMyXMLHandler_GeoNumericMinMax *self, OrgGeogebraCommonIoMyXMLHandler *outer$, OrgGeogebraCommonKernelGeosGeoElement *g, NSString *min, NSString *max) {
  NSObject_init(self);
  [self setGeoWithOrgGeogebraCommonKernelGeosGeoElement:g];
  OrgGeogebraCommonIoMyXMLHandler_GeoNumericMinMax_set_min_(self, min);
  OrgGeogebraCommonIoMyXMLHandler_GeoNumericMinMax_set_max_(self, max);
}
...
void OrgGeogebraCommonIoMyXMLHandler_LocateableExpPair_initWithOrgGeogebraCommonIoMyXMLHandler_withOrgGeogebraCommonKernelLocateable_withNSString_withInt_(OrgGeogebraCommonIoMyXMLHandler_LocateableExpPair *self, OrgGeogebraCommonIoMyXMLHandler *outer$, id<OrgGeogebraCommonKernelLocateable> g, NSString *s, jint n) {
  NSObject_init(self);
  OrgGeogebraCommonIoMyXMLHandler_LocateableExpPair_set_locateable_(self, g);
  OrgGeogebraCommonIoMyXMLHandler_LocateableExpPair_set_exp_(self, s);
  self->number_ = n;
}
...
void OrgGeogebraCommonIoMyXMLHandler_LocateableExpPair_initWithOrgGeogebraCommonIoMyXMLHandler_withOrgGeogebraCommonKernelLocateable_withOrgGeogebraCommonKernelKernelNDGeoPointND_withInt_(OrgGeogebraCommonIoMyXMLHandler_LocateableExpPair *self, OrgGeogebraCommonIoMyXMLHandler *outer$, id<OrgGeogebraCommonKernelLocateable> g, id<OrgGeogebraCommonKernelKernelNDGeoPointND> p, jint n) {
  NSObject_init(self);
  OrgGeogebraCommonIoMyXMLHandler_LocateableExpPair_set_locateable_(self, g);
  OrgGeogebraCommonIoMyXMLHandler_LocateableExpPair_set_point_(self, p);
  self->number_ = n;
}
