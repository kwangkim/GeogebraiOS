...
void OrgGeogebraCommonExportTextGraphics_init(OrgGeogebraCommonExportTextGraphics *self) {
  ...
  self->font_ = [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newFontWithNSString:@"SansSerif" withInt:OrgGeogebraCommonAwtGFont_PLAIN withInt:12];
