  ...
  if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(g)) isGeoList]) {
    ...
    if ([g isGeoPoint]) {
      ...
      if ([self isSinglePointConicWithOrgGeogebraCommonKernelGeosGeoElement:g]) {
        ...
        OrgGeogebraCommonEuclidianDrawDrawPoint *drawPoint = [new_OrgGeogebraCommonEuclidianDrawDrawPoint_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDGeoPointND_(euclidianView_, point) autorelease];
        ...
        IOSObjectArray *drawLines = [IOSObjectArray arrayWithLength:2 type:OrgGeogebraCommonEuclidianDrawDrawLine_class_()];
        for (jint i = 0; i < 2; i++) {
        ...
        IOSObjectArray_SetAndConsume(drawLines, 0, new_OrgGeogebraCommonEuclidianDrawDrawLine_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDGeoLineND_(euclidianView_, IOSObjectArray_Get(nil_chk(lines), 0)));
        IOSObjectArray_SetAndConsume(drawLines, 1, new_OrgGeogebraCommonEuclidianDrawDrawLine_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelKernelNDGeoLineND_(euclidianView_, IOSObjectArray_Get(lines, 1)));
...
- (void)setFrameWithOrgGeogebraCommonExportPstricksExportSettings:(id<OrgGeogebraCommonExportPstricksExportSettings>)settingsFrame {
  OrgGeogebraCommonExportPstricksGeoGebraExport_set_frame_(self, settingsFrame);
}
...
- (void)drawGeoInequalitiesWithOrgGeogebraCommonKernelGeosGeoFunctionNVar:(OrgGeogebraCommonKernelGeosGeoFunctionNVar *)geo
  ...
  OrgGeogebraCommonEuclidianDrawDrawInequality *drawable = [new_OrgGeogebraCommonEuclidianDrawDrawInequality_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelArithmeticFunctionalNVar_(euclidianView_, ef) autorelease];
...
- (JavaLangStringBuilder *)drawNoLatexFunctionWithOrgGeogebraCommonKernelGeosGeoFunction:(OrgGeogebraCommonKernelGeosGeoFunction *)geo
  ...
  OrgGeogebraCommonKernelGeosGeoCurveCartesian *curve = [new_OrgGeogebraCommonKernelGeosGeoCurveCartesian_initWithOrgGeogebraCommonKernelConstruction_([((OrgGeogebraCommonKernelKernel *) nil_chk([((OrgGeogebraCommonMainApp *) nil_chk(app_)) getKernel])) getConstruction]) autorelease];
  ...
  for (; x <= xrangemax; x += step) {
    ...
    if (JavaLangMath_absWithDouble_(yprec - y) < (ymax_ - ymin_)) {
      if (OrgGeogebraCommonEuclidianPlotCurvePlotter_isContinuousWithOrgGeogebraCommonKernelKernelNDCurveEvaluable_withDouble_withDouble_withInt_(curve, xprec, x, 8)) {
        [lineBuilder appendWithId:OrgGeogebraCommonUtilStringUtil_formatWithNSString_withDouble_withDouble_withDouble_withDouble_(template_, xprec, yprec, x, y)];
      }
    }
    yprec = y;
    xprec = x;
...
- (JavaLangStringBuilder *)drawNyquistDiagramWithOrgGeogebraCommonKernelGeosGeoTransferFunction:(OrgGeogebraCommonKernelGeosGeoTransferFunction *)geo
  ...
  for (jint i = 1; i < [coordsList size] - 10; i += 10) {
    ...
    [lineBuilder appendWithId:OrgGeogebraCommonUtilStringUtil_formatWithNSString_withDouble_withDouble_withDouble_withDouble_(sub, xprec, yprec, x, y)];
    xprec = x;
    yprec = y;
  }
  flag = YES;
...
void OrgGeogebraCommonExportPstricksGeoGebraExport_initWithOrgGeogebraCommonMainApp_(OrgGeogebraCommonExportPstricksGeoGebraExport *self, OrgGeogebraCommonMainApp *app) {
  ...
  self->format__ = 0;
  self->isBeamer_ = NO;
  OrgGeogebraCommonExportPstricksGeoGebraExport_set_app_(self, app);
  OrgGeogebraCommonExportPstricksGeoGebraExport_set_kernel_(self, [((OrgGeogebraCommonMainApp *) nil_chk(app)) getKernel]);
  OrgGeogebraCommonExportPstricksGeoGebraExport_set_construction_(self, [((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) getConstruction]);
  OrgGeogebraCommonExportPstricksGeoGebraExport_set_euclidianView_(self, (OrgGeogebraCommonEuclidianEuclidianView *) check_class_cast([app getActiveEuclidianView], [OrgGeogebraCommonEuclidianEuclidianView class]));
  OrgGeogebraCommonExportPstricksGeoGebraExport_set_tpl_(self, OrgGeogebraCommonKernelStringTemplate_printFiguresWithOrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_withInt_withBoolean_(OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_PSTRICKS(), 12, NO));
  OrgGeogebraCommonExportPstricksGeoGebraExport_initBounds(self);
}
...
void OrgGeogebraCommonExportPstricksGeoGebraExport_drawCurveCartesianWithOrgGeogebraCommonKernelGeosGeoElement_(OrgGeogebraCommonExportPstricksGeoGebraExport *self, OrgGeogebraCommonKernelGeosGeoElement *geo) {
  if (![self isLatexFunctionWithNSString:[((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(geo)) toValueStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_noLocalDefault_()]]) {
    ...
    IOSObjectArray *curves = [IOSObjectArray arrayWithLength:exlsv->size_ type:OrgGeogebraCommonKernelGeosGeoCurveCartesian_class_()];
    ...
    for (jint i = 0; i < exlsv->size_; i++) {
      ...
      IOSObjectArray_SetAndConsume(curves, i, new_OrgGeogebraCommonKernelGeosGeoCurveCartesian_initWithOrgGeogebraCommonKernelConstruction_(self->construction_));
...
void OrgGeogebraCommonExportPstricksGeoGebraExport_Info_initWithOrgGeogebraCommonExportPstricksGeoGebraExport_withOrgGeogebraCommonKernelGeosGeoElement_(OrgGeogebraCommonExportPstricksGeoGebraExport_Info *self, OrgGeogebraCommonExportPstricksGeoGebraExport *outer$, OrgGeogebraCommonKernelGeosGeoElement *geo) {
  ...
  OrgGeogebraCommonExportPstricksGeoGebraExport_Info_set_fillType_(self, [geo getFillType]);
  OrgGeogebraCommonExportPstricksGeoGebraExport_Info_set_linecolor_(self, [geo getObjectColor]);
  ...
  if ([[geo getParentAlgorithm] isKindOfClass:[OrgGeogebraCommonKernelAlgosAlgoBarChart class]]) {
    ...
    if ([((OrgGeogebraCommonKernelAlgosAlgoBarChart *) nil_chk(algo)) getBarColorWithInt:outer$->barNumber_] != nil) {
      ...
      OrgGeogebraCommonExportPstricksGeoGebraExport_Info_set_linecolor_(self, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newColorWithFloat:IOSFloatArray_Get(rgb, 0) withFloat:IOSFloatArray_Get(rgb, 1) withFloat:IOSFloatArray_Get(rgb, 2) withFloat:IOSFloatArray_Get(rgb, 3)]);
    }
    ...
    if ([algo getBarFillTypeWithInt:outer$->barNumber_] != nil) {
      OrgGeogebraCommonExportPstricksGeoGebraExport_Info_set_fillType_(self, IOSObjectArray_Get(nil_chk(OrgGeogebraCommonKernelGeosGeoElement_FillTypeEnum_values()), [((OrgGeogebraCommonKernelGeosGeoElement_FillTypeEnum *) nil_chk([algo getBarFillTypeWithInt:outer$->barNumber_])) ordinal]));
    }
