...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/export/pstricks/GeoGebraToPgf.java
//
...
- (void)generateAllCode {
  ...
  if (format__ == OrgGeogebraCommonExportPstricksGeoGebraToPgf_FORMAT_LATEX) {
    ...
    (void) [codeBeginDoc_ appendWithNSString:@"\\begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x="];
    (void) [codeBeginDoc_ appendWithDouble:xunit_];
    (void) [codeBeginDoc_ appendWithNSString:@"cm,y="];
    (void) [codeBeginDoc_ appendWithDouble:yunit_];
    (void) [codeBeginDoc_ appendWithNSString:@"cm]\n"];
  }
  else if (format__ == OrgGeogebraCommonExportPstricksGeoGebraToPgf_FORMAT_PLAIN_TEX) {
    (void) [codePreamble_ appendWithNSString:@"%Uncomment next line if XeTeX is used\n%\\def\\pgfsysdriver{pgfsys-xetex.def}\n\n"];
    (void) [codePreamble_ appendWithNSString:@"\\input pgf.tex\n\\input tikz.tex\n"];
    (void) [codePreamble_ appendWithNSString:@"\\usetikzlibrary{arrows}\n"];
    (void) [codePreamble_ appendWithNSString:@"\\baselineskip="];
    (void) [codePreamble_ appendWithInt:[frame_ getFontSize]];
    (void) [codePreamble_ appendWithNSString:@"pt\n\\hsize=6.3truein\n\\vsize=8.7truein\n"];
    (void) [codeBeginDoc_ appendWithNSString:@"\\tikzpicture[line cap=round,line join=round,>=triangle 45,x="];
    (void) [codeBeginDoc_ appendWithDouble:xunit_];
    (void) [codeBeginDoc_ appendWithNSString:@"cm,y="];
    (void) [codeBeginDoc_ appendWithDouble:yunit_];
    (void) [codeBeginDoc_ appendWithNSString:@"cm]\n"];
    ...
    (void) [codePreamble_ appendWithNSString:JreStrcat("$I$", @"\\setupbodyfont[", [frame_ getFontSize], @"pt]\n")];
    (void) [codePreamble_ appendWithNSString:@"\\usemodule[tikz]\n\\usemodule[pgf]\n"];
    (void) [codePreamble_ appendWithNSString:@"\\usetikzlibrary[arrows]\n\\setuppagenumbering[location=]\n"];
    (void) [codeBeginDoc_ appendWithNSString:@"\\startTEXpage\n\\starttikzpicture[line cap=round,line join=round,>=triangle 45,x="];
    (void) [codeBeginDoc_ appendWithDouble:xunit_];
    (void) [codeBeginDoc_ appendWithNSString:@"cm,y="];
    (void) [codeBeginDoc_ appendWithDouble:yunit_];
    (void) [codeBeginDoc_ appendWithNSString:@"cm]\n"];
  ...
  (void) [codeFilledObject_ appendWithNSString:@"\\clip"];
  ...
  (void) [codeFilledObject_ appendWithNSString:@" rectangle "];
  ...
  if (format__ == OrgGeogebraCommonExportPstricksGeoGebraToPgf_FORMAT_LATEX) {
    (void) [code_ appendWithNSString:@"\\end{tikzpicture}\n"];
    if (isBeamer_) (void) [code_ appendWithNSString:@"\\end{frame}\n"];
    (void) [code_ appendWithNSString:@"\\end{document}"];
    (void) [codeBeginDoc_ insertWithInt:0 withNSString:@"\\begin{document}\n"];
  }
  else if (format__ == OrgGeogebraCommonExportPstricksGeoGebraToPgf_FORMAT_PLAIN_TEX) {
    (void) [code_ appendWithNSString:@"\\endtikzpicture\n\\bye\n"];
  }
  else if (format__ == OrgGeogebraCommonExportPstricksGeoGebraToPgf_FORMAT_CONTEXT) {
    (void) [code_ appendWithNSString:@"\\stoptikzpicture\n\\stopTEXpage\n\\stoptext"];
    (void) [codeBeginDoc_ insertWithInt:0 withNSString:@"\\starttext\n"];
  }
...
- (void)drawLocusWithOrgGeogebraCommonKernelGeosGeoLocus:(OrgGeogebraCommonKernelGeosGeoLocus *)g {
  ...
  (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"\\draw"];
  ...
  while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
    ...
    if (x > xmin_ && x < xmax_ && y > ymin_ && y < ymax_) {
      if (b && !first) (void) [code_ appendWithNSString:@" -- "];
...
- (void)drawBoxPlotWithOrgGeogebraCommonKernelGeosGeoNumeric:(OrgGeogebraCommonKernelGeosGeoNumeric *)geo {
  ...
  (void) [((JavaLangStringBuilder *) nil_chk(codeFilledObject_)) appendWithNSString:@"\\draw "];
  NSString *s = [self LineOptionCodeWithOrgGeogebraCommonKernelGeosGeoElement:geo withBoolean:YES];
  if (((jint) [((NSString *) nil_chk(s)) length]) != 0) s = JreStrcat("C$$", '[', s, @"] ");
  (void) [codeFilledObject_ appendWithNSString:s];
  ...
  (void) [codeFilledObject_ appendWithNSString:@";\n"];
  if (isBeamer_) (void) [codeFilledObject_ appendWithNSString:@"  "];
  (void) [codeFilledObject_ appendWithNSString:@"\\draw"];
  if (((jint) [s length]) != 0) (void) [codeFilledObject_ appendWithNSString:s];
...
- (void)drawSumTrapezoidalWithOrgGeogebraCommonKernelGeosGeoNumeric:(OrgGeogebraCommonKernelGeosGeoNumeric *)geo {
  ...
  for (jint i = 0; i < n; i++) {
    (void) [((JavaLangStringBuilder *) nil_chk(codeFilledObject_)) appendWithNSString:@"\\draw"];
    NSString *s = [self LineOptionCodeWithOrgGeogebraCommonKernelGeosGeoElement:geo withBoolean:YES];
    if (((jint) [((NSString *) nil_chk(s)) length]) != 0) (void) [codeFilledObject_ appendWithNSString:JreStrcat("C$$", '[', s, @"] ")];
...
- (void)drawSumUpperLowerWithOrgGeogebraCommonKernelGeosGeoNumeric:(OrgGeogebraCommonKernelGeosGeoNumeric *)geo {
  ...
  for (jint i = 0; i < n; i++) {
    ...
    (void) [codeFilledObject_ appendWithNSString:@";\n"];
    if (i != -1 && isBeamer_) (void) [codeFilledObject_ appendWithNSString:@"  "];
  }
  [self endBeamerWithJavaLangStringBuilder:codeFilledObject_];
}
...
- (void)drawIntegralFunctionsWithOrgGeogebraCommonKernelGeosGeoNumeric:(OrgGeogebraCommonKernelGeosGeoNumeric *)geo {
  ...
  if (((jint) [((NSString *) nil_chk(s)) length]) != 0) {
    (void) [codeFilledObject_ appendWithNSString:JreStrcat("C$$", '[', s, @"] ")];
  }
  (void) [codeFilledObject_ appendWithNSString:@"{"];
  if (plotWithGnuplot) {
    (void) [codeFilledObject_ appendWithNSString:@" plot[raw gnuplot, id=func"];
    (void) [codeFilledObject_ appendWithInt:functionIdentifier_];
    functionIdentifier_++;
    (void) [codeFilledObject_ appendWithNSString:@"] function{set samples 100; set xrange ["];
    (void) [codeFilledObject_ appendWithDouble:a];
    (void) [codeFilledObject_ appendWithNSString:@":"];
    (void) [codeFilledObject_ appendWithDouble:b];
    (void) [codeFilledObject_ appendWithNSString:@"]; plot "];
    ...
    (void) [codeFilledObject_ appendWithNSString:@"["];
    (void) [codeFilledObject_ appendWithNSString:@"smooth,samples=50,domain="];
    (void) [codeFilledObject_ appendWithDouble:a];
    (void) [codeFilledObject_ appendWithNSString:@":"];
    (void) [codeFilledObject_ appendWithDouble:b];
    (void) [codeFilledObject_ appendWithNSString:@"] plot"];
    (void) [codeFilledObject_ appendWithNSString:@"(\\x,{"];
  ...
  if (plotWithGnuplot) {
    ...
    (void) [codeFilledObject_ appendWithInt:functionIdentifier_];
    functionIdentifier_++;
    (void) [codeFilledObject_ appendWithNSString:@"] function{set parametric ; set samples 100; set trange ["];
    (void) [codeFilledObject_ appendWithDouble:a];
    (void) [codeFilledObject_ appendWithNSString:@":"];
    (void) [codeFilledObject_ appendWithDouble:b];
    (void) [codeFilledObject_ appendWithNSString:@"]; plot "];
    NSString *variable = JreStrcat("$$", [self formatWithDouble:b + a], @"-t");
    (void) [codeFilledObject_ appendWithNSString:variable];
    (void) [codeFilledObject_ appendWithNSString:@","];
...
- (void)drawIntegralWithOrgGeogebraCommonKernelGeosGeoNumeric:(OrgGeogebraCommonKernelGeosGeoNumeric *)geo {
  ...
  if (![self isLatexFunctionWithNSString:[f toValueStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_noLocalDefault_()]]) {
    ...
    if (plotWithGnuplot) {
      ...
      if (((jint) [s length]) != 0) (void) [codeFilledObject_ appendWithNSString:@", "];
      else (void) [codeFilledObject_ appendWithNSString:@"["];
      (void) [codeFilledObject_ appendWithNSString:@"smooth,samples=50,domain="];
      (void) [codeFilledObject_ appendWithDouble:a];
      (void) [codeFilledObject_ appendWithNSString:@":"];
      (void) [codeFilledObject_ appendWithDouble:b];
...
- (void)drawSlopeWithOrgGeogebraCommonKernelGeosGeoNumeric:(OrgGeogebraCommonKernelGeosGeoNumeric *)geo {
  ...
  (void) [((JavaLangStringBuilder *) nil_chk(codePoint_)) appendWithNSString:@"\\draw[color="];
  ...
  (void) [codePoint_ appendWithNSString:@" node[anchor=south west] {"];
...
- (void)drawAngleWithOrgGeogebraCommonKernelGeosGeoAngle:(OrgGeogebraCommonKernelGeosGeoAngle *)geo {
  ...
  if (OrgGeogebraCommonKernelKernel_isEqualWithDouble_withDouble_([geo getValue], OrgGeogebraCommonKernelKernel_PI_HALF) && [geo isEmphasizeRightAngle] && [euclidianView_ getRightAngleStyle] == OrgGeogebraCommonPluginEuclidianStyleConstants_RIGHT_ANGLE_STYLE_SQUARE) {
    ...
    *IOSDoubleArray_GetRef(x, 7) = IOSDoubleArray_Get(m, 1);
    ...
    [self startBeamerWithJavaLangStringBuilder:codeFilledObject_];
    (void) [((JavaLangStringBuilder *) nil_chk(codeFilledObject_)) appendWithNSString:@"\\draw [shift={"];
    ...
    (void) [codeFilledObject_ appendWithNSString:@"(0,0) -- ("];
    (void) [codeFilledObject_ appendWithNSString:[self formatWithDouble:angStDeg]];
    (void) [codeFilledObject_ appendWithNSString:@":"];
    (void) [codeFilledObject_ appendWithNSString:[self formatWithDouble:r]];
    (void) [codeFilledObject_ appendWithNSString:@") arc ("];
    (void) [codeFilledObject_ appendWithNSString:[self formatWithDouble:angStDeg]];
    (void) [codeFilledObject_ appendWithNSString:@":"];
    (void) [codeFilledObject_ appendWithNSString:[self formatWithDouble:angEndDeg]];
    (void) [codeFilledObject_ appendWithNSString:@":"];
    (void) [codeFilledObject_ appendWithNSString:[self formatWithDouble:r]];
    (void) [codeFilledObject_ appendWithNSString:@") -- cycle;\n"];
    [self endBeamerWithJavaLangStringBuilder:codeFilledObject_];
    if (OrgGeogebraCommonKernelKernel_isEqualWithDouble_withDouble_([geo getValue], OrgGeogebraCommonKernelKernel_PI_HALF) && [geo isEmphasizeRightAngle] && [euclidianView_ getRightAngleStyle] == OrgGeogebraCommonPluginEuclidianStyleConstants_RIGHT_ANGLE_STYLE_DOT) {
      ...
      [self startBeamerWithJavaLangStringBuilder:code_];
      (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"\\fill"];
      s = [self LineOptionCodeWithOrgGeogebraCommonKernelGeosGeoElement:geo withBoolean:YES];
      if (((jint) [((NSString *) nil_chk(s)) length]) != 0) (void) [code_ appendWithNSString:JreStrcat("C$$", '[', s, @"] ")];
      OrgGeogebraCommonExportPstricksGeoGebraToPgf_writePointWithDouble_withDouble_withJavaLangStringBuilder_(self, x1, x2, code_);
      (void) [code_ appendWithNSString:@" circle ("];
      (void) [code_ appendWithNSString:[self formatWithDouble:diameter / 2]];
      (void) [code_ appendWithNSString:@");\n"];
      [self endBeamerWithJavaLangStringBuilder:code_];
    }
  }
...
- (void)drawArrowArcWithOrgGeogebraCommonKernelGeosGeoAngle:(OrgGeogebraCommonKernelGeosGeoAngle *)geo
  ...
  (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"\\draw [shift={"];
  ...
  if (((jint) [((NSString *) nil_chk(s)) length]) != 0) {
    (void) [code_ appendWithNSString:JreStrcat("C$$", ',', s, @"] ")];
  }
  else {
    (void) [code_ appendWithNSString:@"] "];
  }
  (void) [code_ appendWithNSString:@"("];
  (void) [code_ appendWithNSString:[self formatWithDouble:angStDeg]];
  (void) [code_ appendWithNSString:@":"];
  (void) [code_ appendWithNSString:[self formatWithDouble:r]];
  (void) [code_ appendWithNSString:@") arc ("];
  (void) [code_ appendWithNSString:[self formatWithDouble:angStDeg]];
  (void) [code_ appendWithNSString:@":"];
  (void) [code_ appendWithNSString:[self formatWithDouble:angEndDeg]];
  (void) [code_ appendWithNSString:@":"];
  (void) [code_ appendWithNSString:[self formatWithDouble:r]];
  (void) [code_ appendWithNSString:@");\n"];
}
...
- (void)drawPolygonWithOrgGeogebraCommonKernelGeosGeoPolygon:(OrgGeogebraCommonKernelGeosGeoPolygon *)geo {
  ...
  [self startBeamerWithJavaLangStringBuilder:codeFilledObject_];
  (void) [((JavaLangStringBuilder *) nil_chk(codeFilledObject_)) appendWithNSString:@"\\fill"];
  NSString *s = [self LineOptionCodeWithOrgGeogebraCommonKernelGeosGeoElement:geo withBoolean:YES];
  if (((jint) [((NSString *) nil_chk(s)) length]) != 0) {
    s = JreStrcat("C$$", '[', s, @"] ");
    (void) [codeFilledObject_ appendWithNSString:s];
...
- (void)drawTextWithOrgGeogebraCommonKernelGeosGeoText:(OrgGeogebraCommonKernelGeosGeoText *)geo {
  ...
  if (id_ == -1) {
    ...
    if (![((OrgGeogebraCommonAwtGColor *) nil_chk(geocolor)) isEqual:OrgGeogebraCommonAwtGColor_get_BLACK_()]) {
      (void) [code_ appendWithNSString:@"[color="];
      [self ColorCodeWithOrgGeogebraCommonAwtGColor:geocolor withJavaLangStringBuilder:code_];
      (void) [code_ appendWithNSString:@"]"];
    }
    OrgGeogebraCommonExportPstricksGeoGebraToPgf_writePointWithDouble_withDouble_withJavaLangStringBuilder_(self, x, y, code_);
    (void) [code_ appendWithNSString:@" node[anchor=north west] {"];
...
- (void)drawGeoConicPartWithOrgGeogebraCommonKernelGeosGeoConicPart:(OrgGeogebraCommonKernelGeosGeoConicPart *)geo {
  ...
  if ([geo getConicPartType] == OrgGeogebraCommonKernelKernelNDGeoConicNDConstants_CONIC_PART_SECTOR) {
    ...
    (void) [sb1 appendWithNSString:@"*cos(\\t r)"];
    JavaLangStringBuilder *sb2 = new_JavaLangStringBuilder_init();
    (void) [sb2 appendWithNSString:[self formatWithDouble:r2]];
    (void) [sb2 appendWithNSString:@"*sin(\\t r)"];
    (void) [code_ appendWithNSString:@" plot[domain="];
    (void) [code_ appendWithNSString:[self formatWithDouble:startAngle]];
    (void) [code_ appendWithNSString:@":"];
    (void) [code_ appendWithNSString:[self formatWithDouble:endAngle]];
    (void) [code_ appendWithNSString:@",variable=\\t]({"];
    ...
    (void) [code_ appendWithJavaLangCharSequence:sb2];
    (void) [code_ appendWithNSString:@"})"];
    (void) [code_ appendWithNSString:@" -- cycle ;\n"];
  }
...
- (void)drawGeoConicWithOrgGeogebraCommonKernelGeosGeoConic:(OrgGeogebraCommonKernelGeosGeoConic *)geo {
  {
    ...
    switch ([((OrgGeogebraCommonKernelGeosGeoConic *) nil_chk(geo)) getType]) {
      ...
      [self startBeamerWithJavaLangStringBuilder:code_];
      (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"\\draw [rotate around={"];
      ...
      (void) [code_ appendWithNSString:@"] "];
      OrgGeogebraCommonExportPstricksGeoGebraToPgf_writePointWithDouble_withDouble_withJavaLangStringBuilder_(self, x1, y1, code_);
      (void) [code_ appendWithNSString:@" ellipse ("];
      (void) [code_ appendWithNSString:[self formatWithDouble:r1 * xunit_]];
      (void) [code_ appendWithNSString:@"cm and "];
      (void) [code_ appendWithNSString:[self formatWithDouble:r2 * yunit_]];
      (void) [code_ appendWithNSString:@"cm);\n"];
      [self endBeamerWithJavaLangStringBuilder:code_];
      break;
      ...
      [self startBeamerWithJavaLangStringBuilder:code_];
      (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"\\draw [samples=50,rotate around={"];
      (void) [code_ appendWithNSString:[self formatWithDouble:angle]];
      (void) [code_ appendWithNSString:@":"];
      OrgGeogebraCommonExportPstricksGeoGebraToPgf_writePointWithDouble_withDouble_withJavaLangStringBuilder_(self, x1, y1, code_);
      (void) [code_ appendWithNSString:@"},xshift="];
      (void) [code_ appendWithNSString:[self formatWithDouble:x1 * xunit_]];
      (void) [code_ appendWithNSString:@"cm,yshift="];
      (void) [code_ appendWithNSString:[self formatWithDouble:y1 * yunit_]];
      (void) [code_ appendWithNSString:@"cm"];
      s = [self LineOptionCodeWithOrgGeogebraCommonKernelGeosGeoElement:geo withBoolean:YES];
      if (((jint) [((NSString *) nil_chk(s)) length]) != 0) {
        (void) [code_ appendWithNSString:@","];
      ...
      (void) [code_ appendWithNSString:@",domain="];
      (void) [code_ appendWithDouble:-x0];
      (void) [code_ appendWithNSString:@":"];
      (void) [code_ appendWithDouble:x0];
      (void) [code_ appendWithNSString:@")] plot (\\x,{(\\x)^2/2/"];
      (void) [code_ appendWithDouble:p];
      (void) [code_ appendWithNSString:@"});\n"];
      [self endBeamerWithJavaLangStringBuilder:code_];
      break;
      ...
      angle = JavaLangMath_toDegreesWithDouble_(JavaLangMath_atan2WithDouble_withDouble_(eigenvecY, eigenvecX));
      [self startBeamerWithJavaLangStringBuilder:code_];
      (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"\\draw [samples=50,domain=-0.99:0.99,rotate around={"];
      (void) [code_ appendWithNSString:[self formatWithDouble:angle]];
      (void) [code_ appendWithNSString:@":"];
      OrgGeogebraCommonExportPstricksGeoGebraToPgf_writePointWithDouble_withDouble_withJavaLangStringBuilder_(self, x1, y1, code_);
      (void) [code_ appendWithNSString:@"},xshift="];
      ...
      (void) [code_ appendWithNSString:@"] plot ({"];
      (void) [code_ appendWithNSString:[self formatWithDouble:r1]];
      (void) [code_ appendWithNSString:@"*(1+(\\x)^2)/(1-(\\x)^2)},{"];
      (void) [code_ appendWithNSString:[self formatWithDouble:r2]];
      (void) [code_ appendWithNSString:@"*2*(\\x)/(1-(\\x)^2)});\n"];
      if (isBeamer_) (void) [code_ appendWithNSString:@"  "];
      (void) [code_ appendWithNSString:@"\\draw [samples=50,domain=-0.99:0.99,rotate around={"];
      (void) [code_ appendWithNSString:[self formatWithDouble:angle]];
      (void) [code_ appendWithNSString:@":"];
      OrgGeogebraCommonExportPstricksGeoGebraToPgf_writePointWithDouble_withDouble_withJavaLangStringBuilder_(self, x1, y1, code_);
      (void) [code_ appendWithNSString:@"},xshift="];
...
- (void)drawGeoPointWithOrgGeogebraCommonKernelGeosGeoPoint:(OrgGeogebraCommonKernelGeosGeoPoint *)gp {
  if ([((id<OrgGeogebraCommonExportPstricksExportSettings>) nil_chk(frame_)) getExportPointSymbol]) {
    ...
    if (dotstyle == OrgGeogebraCommonPluginEuclidianStyleConstants_POINT_STYLE_CIRCLE) {
      ...
      (void) [codePoint_ appendWithNSString:@" circle ("];
      (void) [codePoint_ appendWithDouble:dotsize / 2];
      (void) [codePoint_ appendWithNSString:@"pt);\n"];
    }
      ...
      (void) [codePoint_ appendWithDouble:dotsize / 2];
      (void) [codePoint_ appendWithNSString:@"pt) -- ++("];
      (void) [codePoint_ appendWithDouble:dotsize];
      (void) [codePoint_ appendWithNSString:@"pt,"];
      (void) [codePoint_ appendWithDouble:dotsize];
      (void) [codePoint_ appendWithNSString:@"pt) ++(-"];
      (void) [codePoint_ appendWithDouble:dotsize];
      (void) [codePoint_ appendWithNSString:@"pt,0) -- ++("];
      (void) [codePoint_ appendWithDouble:dotsize];
      (void) [codePoint_ appendWithNSString:@"pt,-"];
      (void) [codePoint_ appendWithDouble:dotsize];
      (void) [codePoint_ appendWithNSString:@"pt);\n"];
      ...
      (void) [codePoint_ appendWithNSString:@" ++(-"];
      (void) [codePoint_ appendWithDouble:dotsize / 2];
      (void) [codePoint_ appendWithNSString:@"pt,0 pt) -- ++("];
      (void) [codePoint_ appendWithDouble:dotsize / 2];
      (void) [codePoint_ appendWithNSString:@"pt,"];
      (void) [codePoint_ appendWithDouble:dotsize / 2];
      (void) [codePoint_ appendWithNSString:@"pt)--++("];
      ...
      (void) [((JavaLangStringBuilder *) nil_chk(codePoint_)) appendWithNSString:@"\\draw [fill="];
      [self ColorCodeWithOrgGeogebraCommonAwtGColor:dotcolor withJavaLangStringBuilder:codePoint_];
      (void) [codePoint_ appendWithNSString:@"] "];
      OrgGeogebraCommonExportPstricksGeoGebraToPgf_writePointWithDouble_withDouble_withJavaLangStringBuilder_(self, x, y, codePoint_);
      (void) [codePoint_ appendWithNSString:@" ++(-"];
      ...
      (void) [((JavaLangStringBuilder *) nil_chk(codePoint_)) appendWithNSString:@"\\draw [fill="];
      [self ColorCodeWithOrgGeogebraCommonAwtGColor:dotcolor withJavaLangStringBuilder:codePoint_];
      (void) [codePoint_ appendWithNSString:@",shift={"];
      OrgGeogebraCommonExportPstricksGeoGebraToPgf_writePointWithDouble_withDouble_withJavaLangStringBuilder_(self, x, y, codePoint_);
      (void) [codePoint_ appendWithNSString:@"},rotate=270] (0,0)"];
      (void) [codePoint_ appendWithNSString:@" ++(0 pt,"];
      (void) [codePoint_ appendWithDouble:radius];
      (void) [codePoint_ appendWithNSString:@"pt) -- ++("];
      (void) [codePoint_ appendWithNSString:[self formatWithDouble:radius / 2 * JavaLangMath_sqrtWithDouble_(3)]];
      (void) [codePoint_ appendWithNSString:@"pt,-"];
      (void) [codePoint_ appendWithDouble:radius / 2 * 3];
      (void) [codePoint_ appendWithNSString:@"pt)--++(-"];
      (void) [codePoint_ appendWithNSString:[self formatWithDouble:radius * JavaLangMath_sqrtWithDouble_(3)]];
      (void) [codePoint_ appendWithNSString:@"pt,0 pt) -- ++("];
      (void) [codePoint_ appendWithNSString:[self formatWithDouble:radius / 2 * JavaLangMath_sqrtWithDouble_(3)]];
      (void) [codePoint_ appendWithNSString:@"pt,"];
      (void) [codePoint_ appendWithDouble:3 * radius / 2];
      (void) [codePoint_ appendWithNSString:@"pt);\n"];
    }
      ...
      (void) [codePoint_ appendWithNSString:@",shift={"];
      OrgGeogebraCommonExportPstricksGeoGebraToPgf_writePointWithDouble_withDouble_withJavaLangStringBuilder_(self, x, y, codePoint_);
      (void) [codePoint_ appendWithNSString:@"}] (0,0)"];
      (void) [codePoint_ appendWithNSString:@" ++(0 pt,"];
      (void) [codePoint_ appendWithDouble:radius];
      (void) [codePoint_ appendWithNSString:@"pt) -- ++("];
      (void) [codePoint_ appendWithNSString:[self formatWithDouble:radius / 2 * JavaLangMath_sqrtWithDouble_(3)]];
      ...
      (void) [codePoint_ appendWithNSString:@",shift={"];
      OrgGeogebraCommonExportPstricksGeoGebraToPgf_writePointWithDouble_withDouble_withJavaLangStringBuilder_(self, x, y, codePoint_);
      (void) [codePoint_ appendWithNSString:@"},rotate=180] (0,0)"];
      (void) [codePoint_ appendWithNSString:@" ++(0 pt,"];
      (void) [codePoint_ appendWithDouble:radius];
      (void) [codePoint_ appendWithNSString:@"pt) -- ++("];
      (void) [codePoint_ appendWithNSString:[self formatWithDouble:radius / 2 * JavaLangMath_sqrtWithDouble_(3)]];
      ...
      (void) [codePoint_ appendWithNSString:@",shift={"];
      OrgGeogebraCommonExportPstricksGeoGebraToPgf_writePointWithDouble_withDouble_withJavaLangStringBuilder_(self, x, y, codePoint_);
      (void) [codePoint_ appendWithNSString:@"},rotate=90] (0,0)"];
      (void) [codePoint_ appendWithNSString:@" ++(0 pt,"];
      (void) [codePoint_ appendWithDouble:radius];
      (void) [codePoint_ appendWithNSString:@"pt) -- ++("];
      (void) [codePoint_ appendWithNSString:[self formatWithDouble:radius / 2 * JavaLangMath_sqrtWithDouble_(3)]];
  ...
  if ([((OrgGeogebraCommonKernelGeosGeoPoint *) nil_chk(gp)) getShowTrimmedIntersectionLines]) {
    ...
    if ([algo isKindOfClass:[OrgGeogebraCommonKernelAlgosAlgoIntersectAbstract class]]) {
      ...
      if (format__ == OrgGeogebraCommonExportPstricksGeoGebraToPgf_FORMAT_LATEX) (void) [s appendWithNSString:@"\\begin{scope}\n"];
      else if (format__ == OrgGeogebraCommonExportPstricksGeoGebraToPgf_FORMAT_CONTEXT) (void) [s appendWithNSString:@"\\startscope\n"];
      else if (format__ == OrgGeogebraCommonExportPstricksGeoGebraToPgf_FORMAT_PLAIN_TEX) (void) [s appendWithNSString:@"\\scope\n"];
      (void) [s appendWithNSString:@"\\clip ("];
...
- (void)drawGeoLineWithOrgGeogebraCommonKernelGeosGeoLine:(OrgGeogebraCommonKernelGeosGeoLine *)geo {
  ...
  if (b != 0) {
    ...
    if (((jint) [((NSString *) nil_chk(option)) length]) != 0) {
      (void) [code_ appendWithNSString:option];
      (void) [code_ appendWithNSString:@","];
    }
    (void) [code_ appendWithNSString:@"domain="];
    ...
    (void) [code_ appendWithNSString:@"] plot(\\x,{(-"];
    (void) [code_ appendWithNSString:[self formatWithDouble:c]];
    (void) [code_ appendWithNSString:@"-"];
    (void) [code_ appendWithNSString:[self formatWithDouble:a]];
    ...
    else (void) [code_ appendWithDouble:b];
    (void) [code_ appendWithNSString:@"});\n"];
  }
  else if (b == 0) {
    (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"\\draw "];
...
- (void)drawGeoRayWithOrgGeogebraCommonKernelGeosGeoRay:(OrgGeogebraCommonKernelGeosGeoRay *)geo {
  ...
  if (b != 0) {
    ...
    (void) [code_ appendWithNSString:@"domain="];
    (void) [code_ appendWithDouble:inf];
    (void) [code_ appendWithNSString:@":"];
    (void) [code_ appendWithDouble:sup];
    (void) [code_ appendWithNSString:@"] plot(\\x,{(-"];
    (void) [code_ appendWithNSString:[self formatWithDouble:c]];
    (void) [code_ appendWithNSString:@"-"];
    (void) [code_ appendWithNSString:[self formatWithDouble:a]];
...
- (void)drawLabelWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo
  ...
  @try {
    if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(geo)) isLabelVisible]) {
      ...
      IOSDoubleArray *translation = [IOSDoubleArray newArrayWithLength:2];
      ...
      *IOSDoubleArray_GetRef(translation, 1) = [euclidianView_ toRealWorldCoordYWithDouble:IOSDoubleArray_Get(translation, 1)];
      ...
      (void) [codePoint_ appendWithNSString:@" node {"];
...
- (NSString *)LineOptionCodeWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo
  ...
  if (linethickness != OrgGeogebraCommonPluginEuclidianStyleConstants_DEFAULT_LINE_THICKNESS) {
    coma = YES;
    (void) [sb appendWithNSString:@"line width="];
  ...
  if (![((OrgGeogebraCommonAwtGColor *) nil_chk([info getLinecolor])) isEqual:OrgGeogebraCommonAwtGColor_get_BLACK_()]) {
    ...
    if (transparency && [geo isFillable] && [info getFillType] == OrgGeogebraCommonKernelGeosGeoElement_FillTypeEnum_get_IMAGE()) (void) [sb appendWithNSString:@"pattern "];
  ...
  if (transparency && [geo isFillable]) {
    {
      ...
      switch ([[info getFillType] ordinal]) {
        ...
        if ([info getAlpha] > 0.0f) {
          ...
          (void) [sb appendWithNSString:@"fill="];
          [self ColorCodeWithOrgGeogebraCommonAwtGColor:[info getLinecolor] withJavaLangStringBuilder:sb];
          (void) [sb appendWithNSString:@",fill opacity="];
        ...
        (void) [sb appendWithNSString:@"fill="];
        [self ColorCodeWithOrgGeogebraCommonAwtGColor:[info getLinecolor] withJavaLangStringBuilder:sb];
        (void) [sb appendWithNSString:@",pattern="];
        if (format__ == OrgGeogebraCommonExportPstricksGeoGebraToPgf_FORMAT_CONTEXT) {
          if ([((JavaLangStringBuilder *) nil_chk(codePreamble_)) indexOfWithNSString:@"usetikzlibrary{patterns}"] == -1) (void) [codePreamble_ appendWithNSString:@"\\usetikzlibrary{patterns}\n"];
        }
        else {
          if ([((JavaLangStringBuilder *) nil_chk(codePreamble_)) indexOfWithNSString:@"usetikzlibrary[patterns]"] == -1) (void) [codePreamble_ appendWithNSString:@"\\usetikzlibrary[patterns]\n"];
        }
        ...
        if ([info getFillType] == OrgGeogebraCommonKernelGeosGeoElement_FillTypeEnum_get_DOTTED()) {
          (void) [sb appendWithNSString:@"dots"];
        }
        else {
          if (angle < 20) (void) [sb appendWithNSString:@"horizontal lines"];
          else if (angle < 70) (void) [sb appendWithNSString:@"north east lines"];
          else if (angle < 110) (void) [sb appendWithNSString:@"vertical lines"];
          else if (angle < 160) (void) [sb appendWithNSString:@"north west lines"];
          else (void) [sb appendWithNSString:@"horizontal lines"];
        }
        (void) [sb appendWithNSString:@",pattern color="];
        [self ColorCodeWithOrgGeogebraCommonAwtGColor:[info getLinecolor] withJavaLangStringBuilder:sb];
        break;
      }
    }
...
- (void)ColorCodeWithOrgGeogebraCommonAwtGColor:(OrgGeogebraCommonAwtGColor *)c
  ...
  if ([((id<OrgGeogebraCommonExportPstricksExportSettings>) nil_chk(frame_)) isGrayscale]) {
    if ([((OrgGeogebraCommonAwtGColor *) nil_chk(c)) isEqual:OrgGeogebraCommonAwtGColor_get_BLACK_()]) {
      (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"black"];
      return;
    }
    NSString *colorname = @"";
    jint red = [c getRed];
    ...
    if ([((JavaUtilHashMap *) nil_chk(CustomColor_)) containsKeyWithId:c]) {
      ...
      if ([((OrgGeogebraCommonAwtGColor *) nil_chk(c)) isEqual:OrgGeogebraCommonAwtGColor_get_BLACK_()]) {
        ...
        (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"red"];
        return;
      }
      else if ([c isEqual:OrgGeogebraCommonAwtGColor_get_BLUE_()]) {
        (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"blue"];
        return;
      }
      else if ([c isEqual:OrgGeogebraCommonAwtGColor_get_GREEN_()]) {
        (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"green"];
        return;
      }
      ...
      if (format__ == OrgGeogebraCommonExportPstricksGeoGebraToPgf_FORMAT_LATEX || format__ == OrgGeogebraCommonExportPstricksGeoGebraToPgf_FORMAT_PLAIN_TEX) {
        (void) [((JavaLangStringBuilder *) nil_chk(codeBeginDoc_)) insertWithInt:0 withNSString:JreStrcat("$$$$C$C$$", @"\\definecolor{", colorname, @"}{rgb}{", [self formatWithDouble:grayscale / 255.0], ',', [self formatWithDouble:grayscale / 255.0], ',', [self formatWithDouble:grayscale / 255.0], @"}\n")];
        (void) [CustomColor_ putWithId:c withId:colorname];
      }
      else if (format__ == OrgGeogebraCommonExportPstricksGeoGebraToPgf_FORMAT_CONTEXT) {
        (void) [((JavaLangStringBuilder *) nil_chk(codeBeginDoc_)) insertWithInt:0 withNSString:JreStrcat("$$$$$$$$$", @"\\definecolor[", colorname, @"][r=", [self formatWithDouble:grayscale / 255.0], @",g=", [self formatWithDouble:grayscale / 255.0], @",b=", [self formatWithDouble:grayscale / 255.0], @"]\n")];
        (void) [CustomColor_ putWithId:c withId:colorname];
      }
    }
    if ([((OrgGeogebraCommonAwtGColor *) nil_chk(c)) isEqual:OrgGeogebraCommonAwtGColor_get_BLACK_()]) {
    ...
    if ([((JavaUtilHashMap *) nil_chk(CustomColor_)) containsKeyWithId:c]) {
      ...
      colorname = [self createCustomColorWithInt:red withInt:green withInt:blue];
      if (format__ == OrgGeogebraCommonExportPstricksGeoGebraToPgf_FORMAT_LATEX || format__ == OrgGeogebraCommonExportPstricksGeoGebraToPgf_FORMAT_PLAIN_TEX) {
        (void) [((JavaLangStringBuilder *) nil_chk(codeBeginDoc_)) insertWithInt:0 withNSString:JreStrcat("$$$$C$C$$", @"\\definecolor{", colorname, @"}{rgb}{", [self formatWithDouble:red / 255.0], ',', [self formatWithDouble:green / 255.0], ',', [self formatWithDouble:blue / 255.0], @"}\n")];
        (void) [CustomColor_ putWithId:c withId:colorname];
      }
      else if (format__ == OrgGeogebraCommonExportPstricksGeoGebraToPgf_FORMAT_CONTEXT) {
        (void) [((JavaLangStringBuilder *) nil_chk(codeBeginDoc_)) insertWithInt:0 withNSString:JreStrcat("$$$$$$$$$", @"\\definecolor[", colorname, @"][r=", [self formatWithDouble:red / 255.0], @",g=", [self formatWithDouble:green / 255.0], @",b=", [self formatWithDouble:blue / 255.0], @"]\n")];
        (void) [CustomColor_ putWithId:c withId:colorname];
      }
    }
    (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:colorname];
...
- (void)drawImplicitPolyWithOrgGeogebraCommonKernelImplicitGeoImplicitPoly:(OrgGeogebraCommonKernelImplicitGeoImplicitPoly *)geo {
  ...
  (void) [code_ appendWithNSString:@"%Rather try PSTricks export\n"];
  (void) [code_ appendWithNSString:@"%Cannot draw "];
...
- (void)drawPolyLineWithOrgGeogebraCommonKernelGeosGeoPolyLine:(OrgGeogebraCommonKernelGeosGeoPolyLine *)geo {
  ...
  (void) [str appendWithNSString:@"\\draw "];
  NSString *s = [self LineOptionCodeWithOrgGeogebraCommonKernelGeosGeoElement:geo withBoolean:YES];
  if (((jint) [((NSString *) nil_chk(s)) length]) != 0) s = JreStrcat("C$$", '[', s, @"] ");
  (void) [str appendWithNSString:s];
...
- (jboolean)fillSplineWithOrgGeogebraCommonKernelGeosGeoCurveCartesianArray:(IOSObjectArray *)curves {
  ...
  jdouble x = xprec;
  (void) [fill appendWithNSString:JreStrcat("$DCD$", @"\\pgfmoveto{\\pgfxy(", x, ',', y, @")}")];
  for (jint i = 0; i < curves->size_; i++) {
    ...
    for (; p <= [((OrgGeogebraCommonKernelGeosGeoCurveCartesian *) nil_chk(IOSObjectArray_Get(curves, i))) getMaxParameter]; p += step) {
      ...
      (void) [fill appendWithId:OrgGeogebraCommonUtilStringUtil_formatWithNSString_withDouble_withDouble_withDouble_withDouble_(template_, xprec, yprec, x, y)];
      yprec = y;
      xprec = x;
    }
  }
  (void) [fill appendWithNSString:JreStrcat("$$CDCD$", @"\\draw", liopco, '(', x, ',', y, @") circle(0pt);\n")];
...
void OrgGeogebraCommonExportPstricksGeoGebraToPgf_addTextWithNSString_withBoolean_withInt_(OrgGeogebraCommonExportPstricksGeoGebraToPgf *self, NSString *st, jboolean isLatex, jint style) {
  if (self->format__ == OrgGeogebraCommonExportPstricksGeoGebraToPgf_FORMAT_LATEX) {
    ...
    switch (style) {
      case 1:
      (void) [((JavaLangStringBuilder *) nil_chk(self->code_)) appendWithNSString:@"{\\bf "];
      break;
      case 2:
      (void) [((JavaLangStringBuilder *) nil_chk(self->code_)) appendWithNSString:@"{\\em "];
      break;
      case 3:
      (void) [((JavaLangStringBuilder *) nil_chk(self->code_)) appendWithNSString:@"{\\em \\bf"];
      break;
    }
    (void) [((JavaLangStringBuilder *) nil_chk(self->code_)) appendWithNSString:st];
    switch (style) {
    ...
    if (isLatex && ![((NSString *) nil_chk(st)) hasSuffix:@"$"]) (void) [((JavaLangStringBuilder *) nil_chk(self->code_)) appendWithNSString:@"$"];
    switch (style) {
      case 1:
      (void) [((JavaLangStringBuilder *) nil_chk(self->code_)) appendWithNSString:@"\\bf{"];
      break;
      case 2:
      (void) [((JavaLangStringBuilder *) nil_chk(self->code_)) appendWithNSString:@"\\it{ "];
      break;
      case 3:
      (void) [((JavaLangStringBuilder *) nil_chk(self->code_)) appendWithNSString:@"\\it{\\bf{"];
      break;
    }
    (void) [((JavaLangStringBuilder *) nil_chk(self->code_)) appendWithNSString:st];
    switch (style) {
...
IOSBooleanArray *OrgGeogebraCommonExportPstricksGeoGebraToPgf_hasFractionalOrTrigoExponentWithOrgGeogebraCommonKernelArithmeticExpressionNode_(OrgGeogebraCommonExportPstricksGeoGebraToPgf *self, OrgGeogebraCommonKernelArithmeticExpressionNode *en) {
  IOSBooleanArray *v = [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ NO, NO } count:2];
...
void OrgGeogebraCommonExportPstricksGeoGebraToPgf_drawPgfStandardWithOrgGeogebraCommonKernelGeosGeoFunction_withJavaLangStringBuilder_withNSString_withDouble_withDouble_(OrgGeogebraCommonExportPstricksGeoGebraToPgf *self, OrgGeogebraCommonKernelGeosGeoFunction *geo, JavaLangStringBuilder *sb, NSString *value, jdouble xrangemax, jdouble xrangemin) {
  (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"\\draw"];
  NSString *s = [self LineOptionCodeWithOrgGeogebraCommonKernelGeosGeoElement:geo withBoolean:YES];
  if (((jint) [((NSString *) nil_chk(s)) length]) != 0) {
  ...
  (void) [sb appendWithNSString:@"smooth,samples=100,domain="];
  (void) [sb appendWithDouble:xrangemin];
  (void) [sb appendWithNSString:@":"];
  (void) [sb appendWithDouble:xrangemax];
  (void) [sb appendWithNSString:@"] plot"];
...
void OrgGeogebraCommonExportPstricksGeoGebraToPgf_drawGnuPlotWithOrgGeogebraCommonKernelGeosGeoFunction_withJavaLangStringBuilder_withNSString_withDouble_withDouble_(OrgGeogebraCommonExportPstricksGeoGebraToPgf *self, OrgGeogebraCommonKernelGeosGeoFunction *geo, JavaLangStringBuilder *sb, NSString *value, jdouble xrangemax, jdouble xrangemin) {
  ...
  (void) [sb appendWithNSString:@" plot[raw gnuplot, id=func"];
  (void) [sb appendWithInt:self->functionIdentifier_];
  self->functionIdentifier_++;
  (void) [sb appendWithNSString:@"] function{set samples 100; set xrange ["];
  (void) [sb appendWithDouble:xrangemin + 0.1];
  (void) [sb appendWithNSString:@":"];
  (void) [sb appendWithDouble:xrangemax - 0.1];
  (void) [sb appendWithNSString:@"]; plot "];
  NSString *valueGnu = [((NSString *) nil_chk(value)) replaceAll:@"\\^" withReplacement:@"**"];
  (void) [sb appendWithNSString:valueGnu];
  (void) [sb appendWithNSString:@"};\n"];
}
...
void OrgGeogebraCommonExportPstricksGeoGebraToPgf_drawNoLatexFunctionWithOrgGeogebraCommonKernelGeosGeoFunction_withJavaLangStringBuilder_withDouble_withDouble_withBoolean_withOrgGeogebraCommonKernelGeosGeoNumeric_(OrgGeogebraCommonExportPstricksGeoGebraToPgf *self, OrgGeogebraCommonKernelGeosGeoFunction *geo, JavaLangStringBuilder *sb, jdouble xrangemax, jdouble xrangemin, jboolean integral, OrgGeogebraCommonKernelGeosGeoNumeric *geo1) {
  ...
  if (integral) {
    ...
    (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:JreStrcat("$$C", @"\\draw[", [self LineOptionCodeWithOrgGeogebraCommonKernelGeosGeoElement:geo1 withBoolean:YES], ']')];
    template_ = @" (%0,%1) -- (%2,%3) --";
    cycle = @"cycle;\n";
  }
  ...
  (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:JreStrcat("$$$", [((JavaLangStringBuilder *) nil_chk(lineBuilder)) description], close, cycle)];
}
...
void OrgGeogebraCommonExportPstricksGeoGebraToPgf_drawSingleCurveWithOrgGeogebraCommonKernelGeosGeoCurveCartesian_withJavaLangStringBuilder_(OrgGeogebraCommonExportPstricksGeoGebraToPgf *self, OrgGeogebraCommonKernelGeosGeoCurveCartesian *geo, JavaLangStringBuilder *sb) {
  ...
  if (warning) (void) [((JavaLangStringBuilder *) nil_chk(self->code_)) appendWithNSString:@"% WARNING: You have to use the special variable t in parametric plot"];
  [self startBeamerWithJavaLangStringBuilder:sb];
  (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"\\draw"];
  NSString *s = [self LineOptionCodeWithOrgGeogebraCommonKernelGeosGeoElement:geo withBoolean:YES];
  if (((jint) [((NSString *) nil_chk(s)) length]) != 0) {
  ...
  (void) [sb appendWithNSString:@"smooth,samples=100,domain="];
  (void) [sb appendWithDouble:start];
  (void) [sb appendWithNSString:@":"];
  (void) [sb appendWithDouble:end];
  (void) [sb appendWithNSString:@"] plot[parametric] function{"];
  (void) [sb appendWithNSString:fx];
  (void) [sb appendWithNSString:@","];
  (void) [sb appendWithNSString:fy];
  (void) [sb appendWithNSString:@"};\n"];
  [self endBeamerWithJavaLangStringBuilder:sb];
}
...
NSString *OrgGeogebraCommonExportPstricksGeoGebraToPgf_replaceXWithNSString_withNSString_(NSString *name, NSString *substitute) {
  ...
  JavaLangStringBuilder *sb = new_JavaLangStringBuilder_initWithNSString_(name);
  if (((jint) [((NSString *) nil_chk(name)) length]) > 0 && [name charAtWithInt:0] == '-') (void) [sb insertWithInt:0 withNSString:@"0"];
  jint i = 0;
  while (i < [sb length]) {
    jchar before = '1';
    jchar after = '1';
    ...
    if (character == 'x') {
      ...
      if (id1 != -1 && id2 != -1) {
        (void) [sb deleteCharAtWithInt:i];
        (void) [sb insertWithInt:i withNSString:substitute];
...
void OrgGeogebraCommonExportPstricksGeoGebraToPgf_addWarningGnuplot(OrgGeogebraCommonExportPstricksGeoGebraToPgf *self) {
  ...
  (void) [self->codePreamble_ appendWithNSString:@"% PGF/Tikz doesn't support the following mathematical functions:\n"];
  (void) [self->codePreamble_ appendWithNSString:@"% cosh, acosh, sinh, asinh, tanh, atanh,\n"];
  (void) [self->codePreamble_ appendWithNSString:@"% x^r with r not integer\n\n"];
  (void) [self->codePreamble_ appendWithNSString:@"% Plotting will be done using GNUPLOT\n"];
  (void) [self->codePreamble_ appendWithNSString:@"% GNUPLOT must be installed and you must allow Latex to call external programs by\n"];
  (void) [self->codePreamble_ appendWithNSString:@"% Adding the following option to your compiler\n"];
  (void) [self->codePreamble_ appendWithNSString:@"% shell-escape    OR    enable-write18 \n"];
  (void) [self->codePreamble_ appendWithNSString:@"% Example: pdflatex --shell-escape file.tex \n\n"];
}
...
void OrgGeogebraCommonExportPstricksGeoGebraToPgf_addWarningHatch(OrgGeogebraCommonExportPstricksGeoGebraToPgf *self) {
  ...
  (void) [((JavaLangStringBuilder *) nil_chk(self->codePreamble_)) appendWithNSString:@" \n\n%<<<<<<<WARNING>>>>>>>\n"];
  (void) [self->codePreamble_ appendWithNSString:@"% PGF/Tikz doesn't support hatch filling very well\n"];
  (void) [self->codePreamble_ appendWithNSString:@"% Use PStricks for a perfect hatching export\n\n"];
}
...
void OrgGeogebraCommonExportPstricksGeoGebraToPgf_drawCircleWithOrgGeogebraCommonKernelGeosGeoConic_(OrgGeogebraCommonExportPstricksGeoGebraToPgf *self, OrgGeogebraCommonKernelGeosGeoConic *geo) {
  JavaLangStringBuilder *build = new_JavaLangStringBuilder_init();
  if (self->xunit_ == self->yunit_) {
    ...
    (void) [build appendWithNSString:@"\\draw"];
    NSString *s = [self LineOptionCodeWithOrgGeogebraCommonKernelGeosGeoElement:geo withBoolean:YES];
    if (((jint) [((NSString *) nil_chk(s)) length]) != 0) s = JreStrcat("$$$", @" [", s, @"] ");
    (void) [build appendWithNSString:s];
    OrgGeogebraCommonExportPstricksGeoGebraToPgf_writePointWithDouble_withDouble_withJavaLangStringBuilder_(self, x, y, build);
    (void) [build appendWithNSString:@" circle ("];
    NSString *tmpr = [self formatWithDouble:r * self->xunit_];
    if ([((OrgGeogebraCommonKernelCommandsAlgebraProcessor *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) getAlgebraProcessor])) evaluateToDoubleWithNSString:tmpr] != 0) (void) [build appendWithNSString:tmpr];
    else (void) [build appendWithDouble:r];
    (void) [build appendWithNSString:@"cm);\n"];
    ...
    (void) [build appendWithNSString:@" ellipse ("];
    (void) [build appendWithNSString:[self formatWithDouble:r1 * self->xunit_]];
    (void) [build appendWithNSString:@"cm and "];
    (void) [build appendWithNSString:[self formatWithDouble:r2 * self->yunit_]];
    (void) [build appendWithNSString:@"cm);\n"];
    [self endBeamerWithJavaLangStringBuilder:build];
  }
  if ([((OrgGeogebraCommonKernelGeosGeoConic *) nil_chk(geo)) getAlphaValue] > 0.0f) {
    (void) [((JavaLangStringBuilder *) nil_chk(self->codeFilledObject_)) appendWithJavaLangCharSequence:build];
  }
  else {
    (void) [((JavaLangStringBuilder *) nil_chk(self->code_)) appendWithJavaLangCharSequence:build];
  }
}
...
void OrgGeogebraCommonExportPstricksGeoGebraToPgf_drawGrid(OrgGeogebraCommonExportPstricksGeoGebraToPgf *self) {
  ...
  (void) [((JavaLangStringBuilder *) nil_chk(self->codeBeginDoc_)) appendWithNSString:@"\\draw [color="];
  [self ColorCodeWithOrgGeogebraCommonAwtGColor:gridCol withJavaLangStringBuilder:self->codeBeginDoc_];
  (void) [self->codeBeginDoc_ appendWithNSString:@","];
  ...
  (void) [self->codeBeginDoc_ appendWithNSString:@", xstep="];
  (void) [self->codeBeginDoc_ appendWithNSString:[self sci2decWithDouble:IOSDoubleArray_Get(nil_chk(GridDist), 0) * self->xunit_]];
  (void) [self->codeBeginDoc_ appendWithNSString:@"cm,ystep="];
  (void) [self->codeBeginDoc_ appendWithNSString:[self sci2decWithDouble:IOSDoubleArray_Get(GridDist, 1) * self->yunit_]];
  (void) [self->codeBeginDoc_ appendWithNSString:@"cm] "];
  ...
  (void) [self->codeBeginDoc_ appendWithNSString:@" grid "];
...
void OrgGeogebraCommonExportPstricksGeoGebraToPgf_drawAxis(OrgGeogebraCommonExportPstricksGeoGebraToPgf *self) {
  ...
  if (showAxis) {
    (void) [((JavaLangStringBuilder *) nil_chk(self->codeBeginDoc_)) appendWithNSString:JreStrcat("$$$", @"\\draw[", OrgGeogebraCommonExportPstricksGeoGebraToPgf_handleAxesStyle(self), @"color=")];
    ...
    JavaLangStringBuilder *tmp = new_JavaLangStringBuilder_init();
    while (xstart < self->xmax_) {
      if (JavaLangMath_absWithDouble_(xstart) > 0.1) (void) [tmp appendWithNSString:[self formatWithDouble:xstart]];
      xstart += spaceTick;
      x1++;
      if (xstart < self->xmax_ && JavaLangMath_absWithDouble_(xstart) > 0.1) (void) [tmp appendWithNSString:@","];
    }
    JavaLangStringBuilder *buffer = new_JavaLangStringBuilder_init();
    (void) [buffer appendWithNSString:@"\\foreach \\x in {"];
    (void) [buffer appendWithJavaLangCharSequence:tmp];
    (void) [buffer appendWithNSString:@"}\n"];
    (void) [buffer appendWithNSString:@"\\draw[shift={(\\x,0)},color="];
    [self ColorCodeWithOrgGeogebraCommonAwtGColor:color withJavaLangStringBuilder:buffer];
    JavaLangStringBuilder *ticks = new_JavaLangStringBuilder_init();
    if (tickStyle != OrgGeogebraCommonPluginEuclidianStyleConstants_AXES_TICK_STYLE_NONE) (void) [ticks appendWithNSString:@"] (0pt,2pt) -- (0pt,-2pt)"];
    else (void) [ticks appendWithNSString:@"] (0pt,-2pt)"];
    if (showNumbers) {
      ...
      if (OrgGeogebraCommonExportPstricksGeoGebraToPgf_hasMeasureUnitWithNSStringArray_withDouble_withInt_(self, units, spaceTick, 0)) {
        ...
        if (![((NSString *) nil_chk(unit)) contains:@"p"]) {
          (void) [self->codeBeginDoc_ appendWithJavaLangCharSequence:buffer];
          (void) [self->codeBeginDoc_ appendWithJavaLangCharSequence:ticks];
          (void) [self->codeBeginDoc_ appendWithNSString:@" node[below] {"];
          if ([unit contains:@"c"]) {
            (void) [self->codeBeginDoc_ appendWithNSString:OrgGeogebraCommonExportPstricksGeoGebraToPgf_footnotesizeWithNSString_(self, JreStrcat("$$", @"\\x", unit))];
          }
          else {
            (void) [self->codeBeginDoc_ appendWithNSString:JreStrcat("$$", OrgGeogebraCommonExportPstricksGeoGebraToPgf_footnotesizeWithNSString_(self, @"\\x"), unit)];
          }
          (void) [self->codeBeginDoc_ appendWithNSString:@"};\n"];
        }
        else {
          if (![unit contains:@"2"]) {
            for (jint i = xstartInt; i < x1; i++) {
              if (i != 0) {
                (void) [self->codeBeginDoc_ appendWithNSString:JreStrcat("$D$", @"\\draw[shift={(", (i * JavaLangMath_PI), @",0)},color=")];
                [self ColorCodeWithOrgGeogebraCommonAwtGColor:color withJavaLangStringBuilder:self->codeBeginDoc_];
                (void) [self->codeBeginDoc_ appendWithJavaLangCharSequence:ticks];
                (void) [self->codeBeginDoc_ appendWithNSString:@" node[below] {"];
                if (i == -1) {
                  (void) [self->codeBeginDoc_ appendWithNSString:OrgGeogebraCommonExportPstricksGeoGebraToPgf_footnotesizeWithNSString_(self, JreStrcat("C$", '-', unit))];
                }
                else {
                  if (i == 1) {
                    (void) [self->codeBeginDoc_ appendWithNSString:OrgGeogebraCommonExportPstricksGeoGebraToPgf_footnotesizeWithNSString_(self, unit)];
                  }
                  else {
                    (void) [self->codeBeginDoc_ appendWithNSString:OrgGeogebraCommonExportPstricksGeoGebraToPgf_footnotesizeWithNSString_(self, JreStrcat("I$", i, unit))];
                  }
                }
                (void) [self->codeBeginDoc_ appendWithNSString:@"};\n"];
              }
            ...
            for (jint i = xstartInt; i < x1; i++) {
              if (i != 0) {
                (void) [self->codeBeginDoc_ appendWithNSString:JreStrcat("$D$", @"\\draw[shift={(", (i * JavaLangMath_PI / 2), @",0)},color=")];
                [self ColorCodeWithOrgGeogebraCommonAwtGColor:color withJavaLangStringBuilder:self->codeBeginDoc_];
                (void) [self->codeBeginDoc_ appendWithJavaLangCharSequence:ticks];
                (void) [self->codeBeginDoc_ appendWithNSString:@" node[below] {"];
                if (i == -1) {
                  ...
                  if (i == 1) {
                    ...
                    OrgApacheCommonsMathFractionFraction *f = new_OrgApacheCommonsMathFractionFraction_initWithInt_withInt_(i, 2);
                    if ([f doubleValue] == -1) {
                      (void) [self->codeBeginDoc_ appendWithNSString:OrgGeogebraCommonExportPstricksGeoGebraToPgf_footnotesizeWithNSString_(self, @"-\\pi")];
                    }
                    else {
                      if ([f doubleValue] == 1) {
                        (void) [self->codeBeginDoc_ appendWithNSString:OrgGeogebraCommonExportPstricksGeoGebraToPgf_footnotesizeWithNSString_(self, @"\\pi")];
                        ...
                        (void) [self->codeBeginDoc_ appendWithNSString:OrgGeogebraCommonExportPstricksGeoGebraToPgf_footnotesizeWithNSString_(self, foot)];
                      }
                    }
                  }
                }
        ...
        (void) [self->codeBeginDoc_ appendWithJavaLangCharSequence:ticks];
        (void) [self->codeBeginDoc_ appendWithNSString:@" node[below] {"];
        (void) [self->codeBeginDoc_ appendWithNSString:OrgGeogebraCommonExportPstricksGeoGebraToPgf_footnotesizeWithNSString_(self, @"\\x")];
        (void) [self->codeBeginDoc_ appendWithNSString:@"};\n"];
      }
    }
    else {
    ...
    if (nil != IOSObjectArray_Get(nil_chk(label), 0)) {
      (void) [self->codeBeginDoc_ appendWithNSString:@"\\draw[color="];
      [self ColorCodeWithOrgGeogebraCommonAwtGColor:color withJavaLangStringBuilder:self->codeBeginDoc_];
      (void) [self->codeBeginDoc_ appendWithNSString:@"] "];
      ...
      (void) [self->codeBeginDoc_ appendWithNSString:@" node [anchor=south west] { "];
      (void) [self->codeBeginDoc_ appendWithNSString:IOSObjectArray_Get(label, 0)];
      (void) [self->codeBeginDoc_ appendWithNSString:@"};\n"];
    }
  }
  ...
  if (showAxis) {
    ...
    while (ystart < self->ymax_) {
      if (JavaLangMath_absWithDouble_(ystart) > 0.1) (void) [tmp appendWithNSString:[self formatWithDouble:ystart]];
      ystart += spaceTick;
      y1++;
      if (ystart < self->ymax_ && JavaLangMath_absWithDouble_(ystart) > 0.1) (void) [tmp appendWithNSString:@","];
    }
    JavaLangStringBuilder *buffer = new_JavaLangStringBuilder_init();
    (void) [buffer appendWithNSString:@"\\foreach \\y in {"];
    (void) [buffer appendWithJavaLangCharSequence:tmp];
    (void) [buffer appendWithNSString:@"}\n"];
    (void) [buffer appendWithNSString:@"\\draw[shift={(0,\\y)},color="];
    [self ColorCodeWithOrgGeogebraCommonAwtGColor:color withJavaLangStringBuilder:buffer];
    JavaLangStringBuilder *ticks = new_JavaLangStringBuilder_init();
    if (tickStyle != OrgGeogebraCommonPluginEuclidianStyleConstants_AXES_TICK_STYLE_NONE) (void) [ticks appendWithNSString:@"] (2pt,0pt) -- (-2pt,0pt)"];
    else (void) [ticks appendWithNSString:@"] (-2pt,0pt)"];
    if (showNumbers) {
      IOSObjectArray *units = [self->euclidianView_ getAxesUnitLabels];
      if (OrgGeogebraCommonExportPstricksGeoGebraToPgf_hasMeasureUnitWithNSStringArray_withDouble_withInt_(self, units, spaceTick, 1)) {
        ...
        if (![((NSString *) nil_chk(unit)) contains:@"p"]) {
          (void) [self->codeBeginDoc_ appendWithJavaLangCharSequence:buffer];
          (void) [self->codeBeginDoc_ appendWithJavaLangCharSequence:ticks];
          (void) [self->codeBeginDoc_ appendWithNSString:@" node[left] {"];
          if ([unit contains:@"c"]) {
            (void) [self->codeBeginDoc_ appendWithNSString:OrgGeogebraCommonExportPstricksGeoGebraToPgf_footnotesizeWithNSString_(self, JreStrcat("$$", @"\\y", unit))];
          }
          else {
            (void) [self->codeBeginDoc_ appendWithNSString:JreStrcat("$$", OrgGeogebraCommonExportPstricksGeoGebraToPgf_footnotesizeWithNSString_(self, @"\\y"), unit)];
          }
          (void) [self->codeBeginDoc_ appendWithNSString:@"};\n"];
        }
        else {
          if (![unit contains:@"2"]) {
            for (jint i = ystartInt; i < y1; i++) {
              if (i != 0) {
                (void) [self->codeBeginDoc_ appendWithNSString:JreStrcat("$D$", @"\\draw[shift={(0,", (i * JavaLangMath_PI), @")},color=")];
                [self ColorCodeWithOrgGeogebraCommonAwtGColor:color withJavaLangStringBuilder:self->codeBeginDoc_];
                (void) [self->codeBeginDoc_ appendWithJavaLangCharSequence:ticks];
                (void) [self->codeBeginDoc_ appendWithNSString:@" node[left] {"];
                if (i == -1) {
            ...
            for (jint i = ystartInt; i < y1; i++) {
              if (i != 0) {
                (void) [self->codeBeginDoc_ appendWithNSString:JreStrcat("$D$", @"\\draw[shift={(0,", (i * JavaLangMath_PI / 2), @")},color=")];
                [self ColorCodeWithOrgGeogebraCommonAwtGColor:color withJavaLangStringBuilder:self->codeBeginDoc_];
                (void) [self->codeBeginDoc_ appendWithJavaLangCharSequence:ticks];
                (void) [self->codeBeginDoc_ appendWithNSString:@" node[left] {"];
                if (i == -1) {
        ...
        (void) [self->codeBeginDoc_ appendWithJavaLangCharSequence:ticks];
        (void) [self->codeBeginDoc_ appendWithNSString:@" node[left] {"];
        (void) [self->codeBeginDoc_ appendWithNSString:OrgGeogebraCommonExportPstricksGeoGebraToPgf_footnotesizeWithNSString_(self, @"\\y")];
        (void) [self->codeBeginDoc_ appendWithNSString:@"};\n"];
      }
    }
    else {
    ...
    if (nil != IOSObjectArray_Get(nil_chk(label), 1)) {
      ...
      OrgGeogebraCommonExportPstricksGeoGebraToPgf_writePointWithDouble_withDouble_withJavaLangStringBuilder_(self, x, y, self->codeBeginDoc_);
      (void) [self->codeBeginDoc_ appendWithNSString:@" node [anchor=west] { "];
      (void) [self->codeBeginDoc_ appendWithNSString:IOSObjectArray_Get(label, 1)];
      (void) [self->codeBeginDoc_ appendWithNSString:@"};\n"];
    }
  }
  ...
  if (!notOrigin && (IOSBooleanArray_Get(nil_chk([self->euclidianView_ getShowAxesNumbers]), 0) || IOSBooleanArray_Get(nil_chk([self->euclidianView_ getShowAxesNumbers]), 1))) {
    (void) [((JavaLangStringBuilder *) nil_chk(self->codeBeginDoc_)) appendWithNSString:@"\\draw[color="];
    [self ColorCodeWithOrgGeogebraCommonAwtGColor:color withJavaLangStringBuilder:self->codeBeginDoc_];
    (void) [self->codeBeginDoc_ appendWithNSString:@"] (0pt,-10pt) node[right] {"];
    (void) [self->codeBeginDoc_ appendWithNSString:OrgGeogebraCommonExportPstricksGeoGebraToPgf_footnotesizeWithNSString_(self, @"0")];
    (void) [self->codeBeginDoc_ appendWithNSString:@"};\n"];
  }
}
...
void OrgGeogebraCommonExportPstricksGeoGebraToPgf_writePointWithDouble_withDouble_withJavaLangStringBuilder_(OrgGeogebraCommonExportPstricksGeoGebraToPgf *self, jdouble x, jdouble y, JavaLangStringBuilder *sb) {
  ...
  (void) [sb appendWithNSString:[self formatWithDouble:x]];
  (void) [sb appendWithNSString:@","];
  (void) [sb appendWithNSString:[self formatWithDouble:y]];
  (void) [sb appendWithNSString:@")"];
}
...
void OrgGeogebraCommonExportPstricksGeoGebraToPgf_LinestyleCodeWithInt_withJavaLangStringBuilder_(OrgGeogebraCommonExportPstricksGeoGebraToPgf *self, jint linestyle, JavaLangStringBuilder *sb) {
  {
    ...
    switch (linestyle) {
      ...
      (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"dash pattern=on "];
      size = [self resizePtWithInt:4];
      (void) [sb appendWithInt:size];
      (void) [sb appendWithNSString:@"pt off "];
      (void) [sb appendWithInt:size];
      (void) [sb appendWithNSString:@"pt"];
      break;
      ...
      (void) [sb appendWithNSString:@"pt off "];
      (void) [sb appendWithInt:size4];
      (void) [sb appendWithNSString:@"pt on "];
      (void) [sb appendWithInt:size8];
      (void) [sb appendWithNSString:@"pt off "];
      (void) [sb appendWithInt:4];
      (void) [sb appendWithNSString:@"pt"];
      break;
    }
  }
