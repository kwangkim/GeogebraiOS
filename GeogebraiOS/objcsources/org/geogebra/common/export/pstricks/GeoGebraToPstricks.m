...
- (void)generateAllCode {
  ...
  OrgGeogebraCommonExportPstricksGeoGebraToPstricks_setAndConsume_codeBeginPic_(self, new_JavaLangStringBuilder_init());
...
- (void)drawLocusWithOrgGeogebraCommonKernelGeosGeoLocus:(OrgGeogebraCommonKernelGeosGeoLocus *)g {
  ...
  [code_ appendWithNSString:[self LineOptionCodeWithOrgGeogebraCommonKernelGeosGeoElement:g withBoolean:YES]];
...
- (void)drawBoxPlotWithOrgGeogebraCommonKernelGeosGeoNumeric:(OrgGeogebraCommonKernelGeosGeoNumeric *)geo {
  ...
  [codeFilledObject_ appendWithNSString:[self LineOptionCodeWithOrgGeogebraCommonKernelGeosGeoElement:geo withBoolean:YES]];
...
- (void)drawAngleWithOrgGeogebraCommonKernelGeosGeoAngle:(OrgGeogebraCommonKernelGeosGeoAngle *)geo {
  ...
  if (OrgGeogebraCommonKernelKernel_isEqualWithDouble_withDouble_([geo getValue], OrgGeogebraCommonKernelKernel_PI_HALF) && [geo isEmphasizeRightAngle] && [euclidianView_ getRightAngleStyle] == OrgGeogebraCommonPluginEuclidianStyleConstants_RIGHT_ANGLE_STYLE_SQUARE) {
    ...
    *IOSDoubleArray_GetRef(x, 7) = IOSDoubleArray_Get(m, 1);
    ...
    if (![((OrgGeogebraCommonAwtGColor *) nil_chk(geocolor)) isEqual:OrgGeogebraCommonAwtGColor_get_BLACK_()]) {
      [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"\\pscustom"];
      [code_ appendWithNSString:[self LineOptionCodeWithOrgGeogebraCommonKernelGeosGeoElement:geo withBoolean:YES]];
      [code_ appendWithNSString:@"{\n"];
    }
...
- (void)drawArrowArcWithOrgGeogebraCommonKernelGeosGeoAngle:(OrgGeogebraCommonKernelGeosGeoAngle *)geo
  ...
  [code_ appendWithNSString:[self LineOptionCodeWithOrgGeogebraCommonKernelGeosGeoElement:geo withBoolean:NO]];
...
- (void)drawSingleCurveCartesianWithOrgGeogebraCommonKernelGeosGeoCurveCartesian:(OrgGeogebraCommonKernelGeosGeoCurveCartesian *)geo
  ...
  [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"\\parametricplot"];
  [code_ appendWithNSString:[self LineOptionCodeWithOrgGeogebraCommonKernelGeosGeoElement:geo withBoolean:trasparency]];
...
- (void)drawFunctionWithOrgGeogebraCommonKernelGeosGeoFunction:(OrgGeogebraCommonKernelGeosGeoFunction *)geo
  ...
  while (xrangemax < b) {
    ...
    if (![self isLatexFunctionWithNSString:[f toValueStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_noLocalDefault_()]]) {
      ...
      if (integral) {
        [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:[self LineOptionCodeWithOrgGeogebraCommonKernelGeosGeoElement:geo1 withBoolean:YES]];
        pre = @"{";
...
- (void)drawGeoLineWithOrgGeogebraCommonKernelGeosGeoLine:(OrgGeogebraCommonKernelGeosGeoLine *)geo {
  ...
  [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:[self LineOptionCodeWithOrgGeogebraCommonKernelGeosGeoElement:geo withBoolean:YES]];
  if (y != 0) {
    [code_ appendWithNSString:@"{"];
...
- (void)ColorCodeWithOrgGeogebraCommonAwtGColor:(OrgGeogebraCommonAwtGColor *)c
  ...
  if ([((id<OrgGeogebraCommonExportPstricksExportSettings>) nil_chk(frame_)) isGrayscale]) {
    ...
    else if ([c isEqual:OrgGeogebraCommonAwtGColor_get_DARK_GRAY_()]) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"darkgray"];
    else if ([c isEqual:OrgGeogebraCommonAwtGColor_get_GRAY_()]) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"gray"];
    else if ([c isEqual:OrgGeogebraCommonAwtGColor_get_LIGHT_GRAY_()]) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"lightgray"];
    ...
    else if ([c isEqual:OrgGeogebraCommonAwtGColor_get_CYAN_()]) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"cyan"];
    else if ([c isEqual:OrgGeogebraCommonAwtGColor_get_MAGENTA_()]) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"magenta"];
...
- (void)drawHistogramOrBarChartBoxWithDoubleArray:(IOSDoubleArray *)y
  ...
  if ([((NSString *) nil_chk(command)) contains:@"Binomial"] && [command contains:@"true"]) {
    [((JavaLangStringBuilder *) nil_chk(codeFilledObject_)) appendWithNSString:@"\\psline"];
    [codeFilledObject_ appendWithNSString:[self LineOptionCodeWithOrgGeogebraCommonKernelGeosGeoElement:g withBoolean:YES]];
    [codeFilledObject_ appendWithNSString:@"("];
    [codeFilledObject_ appendWithNSString:[self formatWithDouble:IOSDoubleArray_Get(nil_chk(x), 0) + width / 2]];
    [codeFilledObject_ appendWithNSString:@",0)("];
    [codeFilledObject_ appendWithNSString:[self formatWithDouble:IOSDoubleArray_Get(x, 0) + width / 2]];
    [codeFilledObject_ appendWithNSString:@","];
    [codeFilledObject_ appendWithNSString:[self formatWithDouble:IOSDoubleArray_Get(nil_chk(y), 0)]];
    [codeFilledObject_ appendWithNSString:@")\n"];
    for (jint i = 0; i < length - 1; i++) {
      [codeFilledObject_ appendWithNSString:@"\\psline"];
      [codeFilledObject_ appendWithNSString:[self LineOptionCodeWithOrgGeogebraCommonKernelGeosGeoElement:g withBoolean:YES]];
      [codeFilledObject_ appendWithNSString:@"("];
      [codeFilledObject_ appendWithNSString:[self formatWithDouble:IOSDoubleArray_Get(x, i) + width / 2]];
      ...
      [codeFilledObject_ appendWithNSString:[self formatWithDouble:IOSDoubleArray_Get(x, i + 1) + width / 2]];
      [codeFilledObject_ appendWithNSString:@","];
      [codeFilledObject_ appendWithNSString:[self formatWithDouble:IOSDoubleArray_Get(y, i + 1)]];
      [codeFilledObject_ appendWithNSString:@")\n"];
    }
  }
  else {
...
void OrgGeogebraCommonExportPstricksGeoGebraToPstricks_drawCircleWithOrgGeogebraCommonKernelGeosGeoConic_(OrgGeogebraCommonExportPstricksGeoGebraToPstricks *self, OrgGeogebraCommonKernelGeosGeoConic *geo) {
  ...
  if (self->xunit_ == self->yunit_) {
    ...
    [s appendWithNSString:[self LineOptionCodeWithOrgGeogebraCommonKernelGeosGeoElement:geo withBoolean:YES]];
    [s appendWithNSString:@"("];
    ...
    if ([((OrgGeogebraCommonKernelCommandsAlgebraProcessor *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) getAlgebraProcessor])) evaluateToDoubleWithNSString:tmpr] != 0) [s appendWithNSString:tmpr];
  ...
  if ([((OrgGeogebraCommonKernelGeosGeoConic *) nil_chk(geo)) getAlphaValue] > 0.0f) [((JavaLangStringBuilder *) nil_chk(self->codeFilledObject_)) appendWithJavaLangCharSequence:s];
...
void OrgGeogebraCommonExportPstricksGeoGebraToPstricks_initUnitAndVariable(OrgGeogebraCommonExportPstricksGeoGebraToPstricks *self) {
  ...
  [self->codeBeginPic_ appendWithInt:OrgGeogebraCommonPluginEuclidianStyleConstants_DEFAULT_POINT_SIZE];
  [self->codeBeginPic_ appendWithNSString:@"pt 0"];
  [self->codeBeginPic_ appendWithNSString:@",linewidth="];
  [self->codeBeginPic_ appendWithNSString:[self formatWithDouble:OrgGeogebraCommonPluginEuclidianStyleConstants_DEFAULT_LINE_THICKNESS / 2 * 0.8]];
