...
- (void)generateAllCode {
  ...
  fillType_ = 0;
  usepackage_ = new_JavaUtilTreeSet_init();
  importpackage_ = new_JavaUtilTreeSet_init();
  pointList_ = new_JavaUtilArrayList_init();
  pairNameTable_ = new_JavaUtilHashMap_init();
  functionTable_ = new_JavaUtilHashMap_init();
  implicitPolyTable_ = new_JavaUtilHashMap_init();
  ...
  codePointDecl_ = new_JavaLangStringBuilder_init();
  codeColors_ = new_JavaLangStringBuilder_init();
  codePoint_ = new_JavaLangStringBuilder_init();
  codeFilledObject_ = new_JavaLangStringBuilder_init();
  codeBeginPic_ = new_JavaLangStringBuilder_init();
  codeEndDoc_ = new_JavaLangStringBuilder_init();
  if (pairName_) {
  ...
  if (!compact_) {
    (void) [codePreamble_ appendWithNSString:@" /* Geogebra to Asymptote conversion, "];
    (void) [codePreamble_ appendWithNSString:@"documentation at artofproblemsolving.com/Wiki, go to User:Azjps/geogebra */\n"];
  }
  [importpackage_ addWithId:@"graph"];
  for (NSString * __strong s in importpackage_) (void) [codePreamble_ appendWithNSString:JreStrcat("$$$", @"import ", s, @"; ")];
  for (NSString * __strong s in usepackage_) (void) [codePreamble_ appendWithNSString:JreStrcat("$$$", @"usepackage(\"", s, @"\"); ")];
  (void) [codePreamble_ appendWithNSString:JreStrcat("$$$", @"size(", [self formatWithDouble:[frame_ getLatexWidth]], @"cm); ")];
  ...
  (void) [codeEndDoc_ appendWithNSString:@"\nclip((xmin,ymin)--(xmin,ymax)--(xmax,ymax)--(xmax,ymin)--cycle); "];
  if (![((OrgGeogebraCommonAwtGColor *) nil_chk([euclidianView_ getBackgroundCommon])) isEqual:OrgGeogebraCommonAwtGColor_get_WHITE_()]) {
    if (!compact_) (void) [codeEndDoc_ appendWithNSString:@"\n"];
    (void) [codeEndDoc_ appendWithNSString:@"shipout(bbox("];
    [self ColorCodeWithOrgGeogebraCommonAwtGColor:[euclidianView_ getBackgroundCommon] withJavaLangStringBuilder:codeEndDoc_];
    (void) [codeEndDoc_ appendWithNSString:@",Fill)); "];
  }
  if ([((NSString *) nil_chk([self formatWithDouble:yunit_])) compareToWithId:[self formatWithDouble:xunit_]] != 0) {
    if (!compact_) (void) [codeEndDoc_ appendWithNSString:@"\n /* re-scale y/x */\n"];
    [self packSpaceBetweenWithJavaLangStringBuilder:codeEndDoc_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"currentpicture", @"=", JreStrcat("$$C", @"yscale(", [self formatWithDouble:yunit_ / xunit_], ')'), @"*", @"currentpicture; " } count:5 type:NSString_class_()]];
  }
  if (!compact_) (void) [codeEndDoc_ appendWithNSString:@"\n /* end of picture */"];
  (void) [code_ appendWithNSString:@"\n"];
  if (!compact_) (void) [code_ appendWithNSString:@" /* dots and labels */"];
  (void) [code_ appendWithJavaLangCharSequence:codePoint_];
  if (!compact_) (void) [code_ insertWithInt:0 withNSString:@" /* draw figures */"];
  (void) [code_ insertWithInt:0 withNSString:@"\n"];
  (void) [code_ insertWithInt:0 withJavaLangCharSequence:codeBeginPic_];
  (void) [code_ insertWithInt:0 withJavaLangCharSequence:codeFilledObject_];
  if ([codeFilledObject_ length] != 0) (void) [code_ insertWithInt:0 withNSString:@"\n"];
  (void) [code_ insertWithInt:0 withJavaLangCharSequence:codePointDecl_];
  if (!compact_) (void) [code_ insertWithInt:0 withJavaLangCharSequence:codeColors_];
  else if ([codeColors_ length] != 0) (void) [code_ insertWithInt:0 withNSString:JreStrcat("$$$", @"\npen", [codeColors_ substringWithInt:1], @"; ")];
  (void) [code_ insertWithInt:0 withJavaLangCharSequence:codePreamble_];
  (void) [code_ appendWithJavaLangCharSequence:codeEndDoc_];
  (void) [self convertUnicodeToTextWithJavaLangStringBuilder:code_];
...
- (void)drawLocusWithOrgGeogebraCommonKernelGeosGeoLocus:(OrgGeogebraCommonKernelGeosGeoLocus *)geo {
  ...
  if (!compact_) (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@" /* locus construction */\n"];
  [self startDraw];
  while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
    ...
    if (((OrgGeogebraCommonKernelMyPoint *) nil_chk(mp))->x_ > xmin_ && mp->x_ < xmax_ && mp->y_ > ymin_ && mp->y_ < ymax_) {
      ...
      if (first && first2) {
        (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"("];
        first = NO;
        first2 = NO;
      }
      else if (first) {
      ...
      else if (mp->lineTo_) (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"--("];
      else (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"^^("];
      (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:JreStrcat("$C$C", x, ',', y, ')')];
    }
    else first = YES;
  }
...
- (void)drawBoxPlotWithOrgGeogebraCommonKernelGeosGeoNumeric:(OrgGeogebraCommonKernelGeosGeoNumeric *)geo {
  ...
  (void) [((JavaLangStringBuilder *) nil_chk(codeFilledObject_)) appendWithNSString:@"box("];
...
- (void)drawHistogramOrBarChartBoxWithDoubleArray:(IOSDoubleArray *)y
  ...
  if ([((NSString *) nil_chk(command)) contains:@"Binomial"] && [command contains:@"true"]) {
    [self startTransparentFillWithJavaLangStringBuilder:codeFilledObject_];
    (void) [((JavaLangStringBuilder *) nil_chk(codeFilledObject_)) appendWithNSString:JreStrcat("C$", '(', [self formatWithDouble:IOSDoubleArray_Get(nil_chk(x), 0) + width / 2])];
    ...
    (void) [codeFilledObject_ appendWithNSString:@","];
    (void) [codeFilledObject_ appendWithNSString:JreStrcat("$C", [self formatWithDouble:IOSDoubleArray_Get(nil_chk(y), 0)], ')')];
    ...
    for (jint i = 0; i < length - 1; i++) {
      [self startTransparentFillWithJavaLangStringBuilder:codeFilledObject_];
      (void) [codeFilledObject_ appendWithNSString:JreStrcat("C$", '(', [self formatWithDouble:IOSDoubleArray_Get(x, i) + width / 2])];
      ...
      [self endTransparentFillWithOrgGeogebraCommonKernelGeosGeoElement:g withJavaLangStringBuilder:codeFilledObject_];
      [self startTransparentFillWithJavaLangStringBuilder:codeFilledObject_];
      (void) [codeFilledObject_ appendWithNSString:JreStrcat("C$", '(', [self formatWithDouble:IOSDoubleArray_Get(x, i + 1) + width / 2])];
      (void) [codeFilledObject_ appendWithNSString:JreStrcat("C$$", ',', [self formatWithDouble:IOSDoubleArray_Get(y, i)], @") -- (")];
      (void) [codeFilledObject_ appendWithNSString:[self formatWithDouble:IOSDoubleArray_Get(x, i + 1) + width / 2]];
      (void) [codeFilledObject_ appendWithNSString:@","];
      (void) [codeFilledObject_ appendWithNSString:JreStrcat("$C", [self formatWithDouble:IOSDoubleArray_Get(y, i + 1)], ')')];
      [self endTransparentFillWithOrgGeogebraCommonKernelGeosGeoElement:g withJavaLangStringBuilder:codeFilledObject_];
    }
  }
  else {
...
- (void)drawSumTrapezoidalWithOrgGeogebraCommonKernelGeosGeoNumeric:(OrgGeogebraCommonKernelGeosGeoNumeric *)geo {
  ...
  for (jint i = 0; i < n; i++) {
    [self startTransparentFillWithJavaLangStringBuilder:codeFilledObject_];
    (void) [((JavaLangStringBuilder *) nil_chk(codeFilledObject_)) appendWithNSString:@"("];
    (void) [codeFilledObject_ appendWithNSString:[self formatWithDouble:IOSDoubleArray_Get(nil_chk(x), i)]];
    (void) [codeFilledObject_ appendWithNSString:@",0)--("];
    (void) [codeFilledObject_ appendWithNSString:[self formatWithDouble:IOSDoubleArray_Get(x, i + 1)]];
    (void) [codeFilledObject_ appendWithNSString:@",0)--("];
    ...
    (void) [codeFilledObject_ appendWithNSString:@")--cycle"];
    [self endTransparentFillWithOrgGeogebraCommonKernelGeosGeoElement:geo withJavaLangStringBuilder:codeFilledObject_];
  }
}
...
- (void)drawIntegralFunctionsWithOrgGeogebraCommonKernelGeosGeoNumeric:(OrgGeogebraCommonKernelGeosGeoNumeric *)geo {
  ...
  if (!compact_) (void) [((JavaLangStringBuilder *) nil_chk(codeFilledObject_)) appendWithNSString:@"\n"];
  jint indexFunc = -1;
  ...
  if (indexFunc == -1) {
    functionCount_++;
    [self packSpaceBetweenWithJavaLangStringBuilder:codeFilledObject_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ JreStrcat("$I", @"real f", functionCount_), @"(real x)", @"{", JreStrcat("$$C", @"return ", valueF, ';'), @"} " } count:5 type:NSString_class_()]];
  }
  indexFunc = -1;
  ...
  if (indexFunc == -1) {
    functionCount_++;
    [self packSpaceBetweenWithJavaLangStringBuilder:codeFilledObject_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ JreStrcat("$I", @"real f", functionCount_), @"(real x)", @"{", JreStrcat("$$C", @"return ", valueG, ';'), @"} " } count:5 type:NSString_class_()]];
  }
  [self startTransparentFillWithJavaLangStringBuilder:codeFilledObject_];
  [self packSpaceBetweenWithJavaLangStringBuilder:codeFilledObject_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ JreStrcat("$$C", @"graph(", tempFunctionCountF, ','), JreStrcat("$C", sa, ','), JreStrcat("$C", sb, ')'), @"--", JreStrcat("$$C", @"graph(", tempFunctionCountG, ','), JreStrcat("$C", sb, ','), JreStrcat("$C", sa, ')'), @"--cycle" } count:8 type:NSString_class_()]];
  [self endTransparentFillWithOrgGeogebraCommonKernelGeosGeoElement:geo withJavaLangStringBuilder:codeFilledObject_];
}
...
- (void)drawIntegralWithOrgGeogebraCommonKernelGeosGeoNumeric:(OrgGeogebraCommonKernelGeosGeoNumeric *)geo {
  ...
  if (![self isLatexFunctionWithNSString:[f toValueStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_noLocalDefault_()]]) {
    ...
    if (indexFunc == -1) {
      functionCount_++;
      if (!compact_) (void) [((JavaLangStringBuilder *) nil_chk(codeFilledObject_)) appendWithNSString:@"\n"];
      (void) [((JavaLangStringBuilder *) nil_chk(codeFilledObject_)) appendWithNSString:@"real f"];
      (void) [codeFilledObject_ appendWithInt:functionCount_];
      [self packSpaceWithJavaLangStringBuilder:codeFilledObject_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"(real x)" } count:1 type:NSString_class_()]];
      (void) [codeFilledObject_ appendWithNSString:@"{return "];
      (void) [codeFilledObject_ appendWithNSString:value];
      (void) [codeFilledObject_ appendWithNSString:@";} "];
    }
    [self startTransparentFillWithJavaLangStringBuilder:codeFilledObject_];
    (void) [((JavaLangStringBuilder *) nil_chk(codeFilledObject_)) appendWithNSString:@"graph("];
    (void) [codeFilledObject_ appendWithNSString:tempFunctionCount];
    (void) [codeFilledObject_ appendWithNSString:@","];
...
- (void)drawSlopeWithOrgGeogebraCommonKernelGeosGeoNumeric:(OrgGeogebraCommonKernelGeosGeoNumeric *)geo {
  ...
  if (!compact_) (void) [((JavaLangStringBuilder *) nil_chk(codePoint_)) appendWithNSString:@"\n"];
  [self packSpaceAfterWithJavaLangStringBuilder:codePoint_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ JreStrcat("$I$", @"label(\"$", slopeTriangleSize, @"$\","), JreStrcat("C$C", '(', [self formatWithDouble:xLabelHor], ','), JreStrcat("$$", [self formatWithDouble:yLabelHor], @"),"), @"NE", @"*" } count:5 type:NSString_class_()]];
  if (compact_) (void) [((JavaLangStringBuilder *) nil_chk(codePoint_)) appendWithNSString:@"lsf"];
  else (void) [((JavaLangStringBuilder *) nil_chk(codePoint_)) appendWithNSString:@"labelscalefactor"];
  if (![((OrgGeogebraCommonAwtGColor *) nil_chk(geocolor)) isEqual:OrgGeogebraCommonAwtGColor_get_BLACK_()]) {
    (void) [((JavaLangStringBuilder *) nil_chk(codePoint_)) appendWithNSString:@","];
...
- (void)drawAngleWithOrgGeogebraCommonKernelGeosGeoAngle:(OrgGeogebraCommonKernelGeosGeoAngle *)geo {
  ...
  if (OrgGeogebraCommonKernelKernel_isEqualWithDouble_withDouble_([geo getValue], OrgGeogebraCommonKernelKernel_PI_HALF) && [geo isEmphasizeRightAngle] && [euclidianView_ getRightAngleStyle] == OrgGeogebraCommonPluginEuclidianStyleConstants_RIGHT_ANGLE_STYLE_SQUARE) {
    ...
    *IOSDoubleArray_GetRef(x, 7) = IOSDoubleArray_Get(m, 1);
    ...
    (void) [((JavaLangStringBuilder *) nil_chk(codeFilledObject_)) appendWithNSString:@"cycle"];
    [self endTransparentFillWithOrgGeogebraCommonKernelGeosGeoElement:geo withJavaLangStringBuilder:codeFilledObject_];
  }
  else {
    (void) [((JavaLangStringBuilder *) nil_chk(codeFilledObject_)) appendWithNSString:@"arc("];
    ...
    (void) [codeFilledObject_ appendWithNSString:@","];
    (void) [codeFilledObject_ appendWithNSString:[self formatWithDouble:r]];
    (void) [codeFilledObject_ appendWithNSString:@","];
    (void) [codeFilledObject_ appendWithNSString:[self formatWithDouble:JavaLangMath_toDegreesWithDouble_(angSt)]];
    (void) [codeFilledObject_ appendWithNSString:@","];
    (void) [codeFilledObject_ appendWithNSString:[self formatWithDouble:JavaLangMath_toDegreesWithDouble_(angExt)]];
    (void) [codeFilledObject_ appendWithNSString:@")--("];
    (void) [codeFilledObject_ appendWithNSString:[self formatWithDouble:IOSDoubleArray_Get(m, 0)]];
    (void) [codeFilledObject_ appendWithNSString:@","];
    (void) [codeFilledObject_ appendWithNSString:[self formatWithDouble:IOSDoubleArray_Get(m, 1)]];
    (void) [codeFilledObject_ appendWithNSString:@")--cycle"];
    [self endTransparentFillWithOrgGeogebraCommonKernelGeosGeoElement:geo withJavaLangStringBuilder:codeFilledObject_];
    if (OrgGeogebraCommonKernelKernel_isEqualWithDouble_withDouble_([geo getValue], OrgGeogebraCommonKernelKernel_PI_HALF) && [geo isEmphasizeRightAngle] && [euclidianView_ getRightAngleStyle] == OrgGeogebraCommonPluginEuclidianStyleConstants_RIGHT_ANGLE_STYLE_DOT) {
      ...
      [self startDraw];
      if (compactcse5_) (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"CR("];
      else (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"circle("];
...
- (void)drawArrowArcWithOrgGeogebraCommonKernelGeosGeoAngle:(OrgGeogebraCommonKernelGeosGeoAngle *)geo
  ...
  angEnd = angEnd - angle;
  [self startDraw];
  (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"arc("];
  ...
  if (OrgGeogebraCommonExportPstricksGeoGebraToAsymptote_LineOptionCodeWithOrgGeogebraCommonKernelGeosGeoElement_withBoolean_(self, geo, YES) != nil) {
    [self packSpaceAfterWithJavaLangStringBuilder:code_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"," } count:1 type:NSString_class_()]];
    (void) [code_ appendWithNSString:OrgGeogebraCommonExportPstricksGeoGebraToAsymptote_LineOptionCodeWithOrgGeogebraCommonKernelGeosGeoElement_withBoolean_(self, geo, YES)];
  }
  if (anticlockwise) (void) [code_ appendWithNSString:@",EndArcArrow(6)"];
  else (void) [code_ appendWithNSString:@",BeginArcArrow(6)"];
  (void) [code_ appendWithNSString:@"); "];
}
...
- (void)drawTextWithOrgGeogebraCommonKernelGeosGeoText:(OrgGeogebraCommonKernelGeosGeoText *)geo {
  ...
  if ([((NSString *) nil_chk(st)) indexOfString:@"\u20ac"] != -1) {
    ...
    if (!eurosym_) (void) [((JavaLangStringBuilder *) nil_chk(codePreamble_)) appendWithNSString:@"usepackage(\"eurosym\"); "];
  }
  OrgGeogebraCommonAwtGColor *geocolor = [geo getObjectColor];
  ...
  jboolean comma = NO;
  if (id_ == -1) {
    if (!compact_) (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"\n"];
    (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"label(\""];
    OrgGeogebraCommonExportPstricksGeoGebraToAsymptote_addTextWithNSString_withBoolean_withInt_(self, st, isLatex, style);
    (void) [code_ appendWithNSString:@"\","];
    [self addPointWithNSString:[self formatWithDouble:x] withNSString:[self formatWithDouble:y] withJavaLangStringBuilder:code_];
    (void) [code_ appendWithNSString:@",SE*"];
    if (compact_) (void) [code_ appendWithNSString:@"lsf"];
    else (void) [code_ appendWithNSString:@"labelscalefactor"];
    if (![((OrgGeogebraCommonAwtGColor *) nil_chk(geocolor)) isEqual:OrgGeogebraCommonAwtGColor_get_BLACK_()]) {
      (void) [code_ appendWithNSString:@","];
      comma = YES;
    ...
    if (size != [((OrgGeogebraCommonMainApp *) nil_chk([self getApp])) getFontSize]) {
      if (!comma) (void) [code_ appendWithNSString:@","];
      else [self packSpaceWithJavaLangStringBuilder:code_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"+" } count:1 type:NSString_class_()]];
      (void) [code_ appendWithNSString:@"fontsize("];
      (void) [code_ appendWithInt:fontsize_ + (size - [((OrgGeogebraCommonMainApp *) nil_chk([self getApp])) getFontSize])];
      (void) [code_ appendWithNSString:@")"];
    }
    else if (compactcse5_) {
      if (!comma) (void) [code_ appendWithNSString:@","];
      else [self packSpaceWithJavaLangStringBuilder:code_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"+" } count:1 type:NSString_class_()]];
      (void) [code_ appendWithNSString:@"fp"];
    }
    (void) [code_ appendWithNSString:@"); "];
  }
  else {
...
- (void)drawGeoConicPartWithOrgGeogebraCommonKernelGeosGeoConicPart:(OrgGeogebraCommonKernelGeosGeoConicPart *)geo {
  JavaLangStringBuilder *tempsb = new_JavaLangStringBuilder_init();
  ...
  if (m11 == 1 && m22 == 1 && m12 == 0 && m21 == 0) {
    ...
    (void) [tempsb appendWithNSString:@"shift("];
    ...
    (void) [tempsb appendWithNSString:@")*xscale("];
    (void) [tempsb appendWithNSString:[self formatWithDouble:r1]];
    (void) [tempsb appendWithNSString:@")*yscale("];
    (void) [tempsb appendWithNSString:[self formatWithDouble:r2]];
    (void) [tempsb appendWithNSString:@")*arc((0,0),1,"];
    (void) [tempsb appendWithNSString:[self formatWithDouble:JavaLangMath_toDegreesWithDouble_(startAngle)]];
    (void) [tempsb appendWithNSString:@","];
    (void) [tempsb appendWithNSString:[self formatWithDouble:JavaLangMath_toDegreesWithDouble_(endAngle)]];
    (void) [tempsb appendWithNSString:@")"];
  }
  else {
    JavaLangStringBuilder *sb1 = new_JavaLangStringBuilder_init(), *sb2 = new_JavaLangStringBuilder_init();
    ...
    arcCount_++;
    if (!compact_) (void) [tempsb appendWithNSString:@"\n"];
    (void) [tempsb appendWithNSString:@"pair arc"];
    (void) [tempsb appendWithInt:arcCount_];
    [self packSpaceWithJavaLangStringBuilder:tempsb withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"(real t)" } count:1 type:NSString_class_()]];
    (void) [tempsb appendWithNSString:@"{return ("];
    (void) [tempsb appendWithNSString:[self formatWithDouble:m11]];
    (void) [tempsb appendWithNSString:@"*"];
    (void) [tempsb appendWithJavaLangCharSequence:sb1];
    (void) [tempsb appendWithNSString:@"+"];
    (void) [tempsb appendWithNSString:[self formatWithDouble:m12]];
    (void) [tempsb appendWithNSString:@"*"];
    (void) [tempsb appendWithJavaLangCharSequence:sb2];
    (void) [tempsb appendWithNSString:@"+"];
    (void) [tempsb appendWithNSString:[self formatWithDouble:tx]];
    (void) [tempsb appendWithNSString:@","];
    (void) [tempsb appendWithNSString:[self formatWithDouble:m21]];
    (void) [tempsb appendWithNSString:@"*"];
    (void) [tempsb appendWithJavaLangCharSequence:sb1];
    (void) [tempsb appendWithNSString:@"+"];
    (void) [tempsb appendWithNSString:[self formatWithDouble:m22]];
    (void) [tempsb appendWithNSString:@"*"];
    (void) [tempsb appendWithJavaLangCharSequence:sb2];
    (void) [tempsb appendWithNSString:@"+"];
    (void) [tempsb appendWithNSString:[self formatWithDouble:ty]];
    (void) [tempsb appendWithNSString:@");} "];
    if ([geo getConicPartType] == OrgGeogebraCommonKernelKernelNDGeoConicNDConstants_CONIC_PART_SECTOR && fillType_ != OrgGeogebraCommonExportPstricksExportSettings_FILL_NONE) [self startTransparentFillWithJavaLangStringBuilder:tempsb];
    else [self startDrawWithJavaLangStringBuilder:tempsb];
    (void) [tempsb appendWithNSString:@"graph(arc"];
    (void) [tempsb appendWithInt:arcCount_];
    (void) [tempsb appendWithNSString:@","];
    (void) [tempsb appendWithNSString:[self formatWithDouble:startAngle]];
    (void) [tempsb appendWithNSString:@","];
    (void) [tempsb appendWithNSString:[self formatWithDouble:endAngle]];
    (void) [tempsb appendWithNSString:@")"];
  }
  if ([geo getConicPartType] == OrgGeogebraCommonKernelKernelNDGeoConicNDConstants_CONIC_PART_SECTOR) {
    (void) [tempsb appendWithNSString:@"--"];
    [self addPointWithNSString:[self formatWithDouble:tx] withNSString:[self formatWithDouble:ty] withJavaLangStringBuilder:tempsb];
    (void) [tempsb appendWithNSString:@"--cycle"];
  ...
  if ([geo getConicPartType] == OrgGeogebraCommonKernelKernelNDGeoConicNDConstants_CONIC_PART_SECTOR && fillType_ != OrgGeogebraCommonExportPstricksExportSettings_FILL_NONE) (void) [((JavaLangStringBuilder *) nil_chk(codeFilledObject_)) appendWithJavaLangCharSequence:tempsb];
  else (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithJavaLangCharSequence:tempsb];
}
...
- (void)drawSingleCurveCartesianWithOrgGeogebraCommonKernelGeosGeoCurveCartesian:(OrgGeogebraCommonKernelGeosGeoCurveCartesian *)geo
  ...
  if (indexFunc == -1) {
    functionCount_++;
    if (!compact_) (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"\n"];
    (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"pair f"];
    (void) [code_ appendWithInt:functionCount_];
    [self packSpaceWithJavaLangStringBuilder:code_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ JreStrcat("$$C", @"(real ", variable, ')') } count:1 type:NSString_class_()]];
    (void) [code_ appendWithNSString:@"{return ("];
  ...
  [self startDraw];
  (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"graph("];
  (void) [code_ appendWithNSString:tempFunctionCount];
  (void) [code_ appendWithNSString:@","];
  (void) [code_ appendWithNSString:[self formatWithDouble:start]];
  (void) [code_ appendWithNSString:@","];
  (void) [code_ appendWithNSString:[self formatWithDouble:end]];
  (void) [code_ appendWithNSString:@")"];
  [self endDrawWithOrgGeogebraCommonKernelGeosGeoElement:geo];
}
...
- (void)drawFunctionWithOrgGeogebraCommonKernelGeosGeoFunction:(OrgGeogebraCommonKernelGeosGeoFunction *)geo
  ...
  while (xrangemax < b) {
    ...
    if (![self isLatexFunctionWithNSString:[f toValueStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_noLocalDefault_()]]) {
      ...
      if (integral) {
        (void) [sb appendWithNSString:JreStrcat("$I$", @"path p", (++functionCount_), @";\n")];
        (void) [sb appendWithNSString:JreStrcat("CIC", 'p', functionCount_, '=')];
        ...
        (void) [((JavaLangStringBuilder *) nil_chk(lineBuilder)) appendWithNSString:JreStrcat("C$$$$", '(', [self formatWithDouble:[geo getIntervalMax]], @",0) -- (", [self formatWithDouble:[geo getIntervalMin]], @",0) -- ")];
        JavaLangStringBuilder *color = new_JavaLangStringBuilder_init();
        ...
        (void) [lineBuilder appendWithNSString:JreStrcat("$$", str, @");\n")];
        (void) [sb appendWithJavaLangCharSequence:lineBuilder];
        lineBuilder = sb;
      }
      else {
      ...
      (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:JreStrcat("$$", [((JavaLangStringBuilder *) nil_chk(lineBuilder)) description], @";\n")];
    }
    else {
      ...
      if (indexFunc == -1) {
        functionCount_++;
        if (!compact_) (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"\n"];
        (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"real "];
        (void) [code_ appendWithNSString:tempFunctionCount];
        [self packSpaceWithJavaLangStringBuilder:code_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"(real x)" } count:1 type:NSString_class_()]];
        (void) [code_ appendWithNSString:@"{return "];
        (void) [code_ appendWithNSString:value];
        (void) [code_ appendWithNSString:@";} "];
      }
      [self startDraw];
      (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"graph("];
      (void) [code_ appendWithNSString:tempFunctionCount];
      (void) [code_ appendWithNSString:@","];
      (void) [code_ appendWithNSString:[self formatWithDouble:xrangemin + 0.01]];
      (void) [code_ appendWithNSString:@","];
      (void) [code_ appendWithNSString:[self formatWithDouble:xrangemax - 0.01]];
      (void) [code_ appendWithNSString:@")"];
      [self endDrawWithOrgGeogebraCommonKernelGeosGeoElement:geo];
    }
...
- (void)drawGeoVectorWithOrgGeogebraCommonKernelGeosGeoVector:(OrgGeogebraCommonKernelGeosGeoVector *)geo {
  ...
  if (!compact_) (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"\n"];
  if (compactcse5_) (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"D("];
  else (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"draw("];
  ...
  if (OrgGeogebraCommonExportPstricksGeoGebraToAsymptote_LineOptionCodeWithOrgGeogebraCommonKernelGeosGeoElement_withBoolean_(self, geo, YES) != nil) {
    (void) [code_ appendWithNSString:@","];
    if (!compact_) (void) [code_ appendWithNSString:@" "];
    (void) [code_ appendWithNSString:OrgGeogebraCommonExportPstricksGeoGebraToAsymptote_LineOptionCodeWithOrgGeogebraCommonKernelGeosGeoElement_withBoolean_(self, geo, YES)];
  }
  (void) [code_ appendWithNSString:@",EndArrow(6)); "];
}
...
- (void)drawGeoConicWithOrgGeogebraCommonKernelGeosGeoConic:(OrgGeogebraCommonKernelGeosGeoConic *)geo {
  {
    ...
    switch ([((OrgGeogebraCommonKernelGeosGeoConic *) nil_chk(geo)) getType]) {
      ...
      if (compactcse5_) if (fillInequality_) (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"filldraw(shift("];
      else (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"D(shift("];
      else if (fillInequality_) (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"filldraw(shift("];
      else (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"draw(shift("];
      [self addPointWithNSString:[self formatWithDouble:x1] withNSString:[self formatWithDouble:y1] withJavaLangStringBuilder:code_];
      (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@")*rotate("];
      (void) [code_ appendWithNSString:[self formatWithDouble:angle]];
      (void) [code_ appendWithNSString:@")*xscale("];
      (void) [code_ appendWithNSString:[self formatWithDouble:r1]];
      (void) [code_ appendWithNSString:@")*yscale("];
      (void) [code_ appendWithNSString:[self formatWithDouble:r2]];
      (void) [code_ appendWithNSString:@")*unitcircle"];
      if (fillInequality_) {
        (void) [code_ appendWithNSString:@",pattern(\"hatch\"),border);\n"];
      }
      [self endDrawWithOrgGeogebraCommonKernelGeosGeoElement:geo];
      break;
      ...
      parabolaCount_++;
      if (!compact_) (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"\n"];
      (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"real p"];
      if (!compact_) (void) [code_ appendWithNSString:@"arabola"];
      (void) [code_ appendWithInt:parabolaCount_];
      [self packSpaceWithJavaLangStringBuilder:code_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"(real x)" } count:1 type:NSString_class_()]];
      (void) [code_ appendWithNSString:@"{return x^2/2/"];
      if (compact_) (void) [code_ appendWithNSString:[self formatWithDouble:p]];
      else (void) [code_ appendWithDouble:p];
      (void) [code_ appendWithNSString:@";} "];
      if (!compact_) (void) [code_ appendWithNSString:@"\n"];
      if (compactcse5_) (void) [code_ appendWithNSString:@"D(shift("];
      else (void) [code_ appendWithNSString:@"draw(shift("];
      [self addPointWithNSString:[self formatWithDouble:x1] withNSString:[self formatWithDouble:y1] withJavaLangStringBuilder:code_];
      (void) [code_ appendWithNSString:@")*rotate("];
      (void) [code_ appendWithNSString:[self formatWithDouble:angle]];
      (void) [code_ appendWithNSString:@")*graph(p"];
      if (!compact_) (void) [code_ appendWithNSString:@"arabola"];
      (void) [code_ appendWithInt:parabolaCount_];
      (void) [code_ appendWithNSString:@","];
      ...
      (void) [code_ appendWithNSString:@")"];
      [self endDrawWithOrgGeogebraCommonKernelGeosGeoElement:geo];
      if (!compact_) (void) [code_ appendWithNSString:@"/* parabola construction */"];
      break;
      ...
      hyperbolaCount_++;
      if (!compact_) (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"\n"];
      if (!compact_) (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"pair hyperbolaLeft"];
      else (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"pair hl"];
      (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithInt:hyperbolaCount_];
      [self packSpaceWithJavaLangStringBuilder:code_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"(real t)" } count:1 type:NSString_class_()]];
      (void) [code_ appendWithNSString:@"{return ("];
      (void) [code_ appendWithNSString:[self formatWithDouble:r1]];
      (void) [code_ appendWithNSString:@"*(1+t^2)/(1-t^2),"];
      (void) [code_ appendWithNSString:[self formatWithDouble:r2]];
      (void) [code_ appendWithNSString:@"*2*t/(1-t^2));} "];
      if (!compact_) (void) [code_ appendWithNSString:@"pair hyperbolaRight"];
      else (void) [code_ appendWithNSString:@"pair hr"];
      (void) [code_ appendWithInt:hyperbolaCount_];
      [self packSpaceWithJavaLangStringBuilder:code_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"(real t)" } count:1 type:NSString_class_()]];
      (void) [code_ appendWithNSString:@"{return ("];
      (void) [code_ appendWithNSString:[self formatWithDouble:r1]];
      (void) [code_ appendWithNSString:@"*(-1-t^2)/(1-t^2),"];
      ...
      (void) [code_ appendWithNSString:@")*rotate("];
      (void) [code_ appendWithNSString:[self formatWithDouble:angle]];
      if (!compact_) (void) [code_ appendWithNSString:@")*graph(hyperbolaLeft"];
      else (void) [code_ appendWithNSString:@")*graph(hl"];
      (void) [code_ appendWithInt:hyperbolaCount_];
      ...
      (void) [code_ appendWithNSString:@")*rotate("];
      (void) [code_ appendWithNSString:[self formatWithDouble:angle]];
      if (!compact_) (void) [code_ appendWithNSString:@")*graph(hyperbolaRight"];
      else (void) [code_ appendWithNSString:@")*graph(hr"];
      (void) [code_ appendWithInt:hyperbolaCount_];
      (void) [code_ appendWithNSString:@",-0.99,0.99)"];
      [self endDrawWithOrgGeogebraCommonKernelGeosGeoElement:geo];
      if (!compact_) (void) [code_ appendWithNSString:@"/* hyperbola construction */"];
      break;
    }
  }
}
...
- (void)drawGeoPointWithOrgGeogebraCommonKernelGeosGeoPoint:(OrgGeogebraCommonKernelGeosGeoPoint *)gp {
  if ([((id<OrgGeogebraCommonExportPstricksExportSettings>) nil_chk(frame_)) getExportPointSymbol]) {
    ...
    if (dotstyle != OrgGeogebraCommonPluginEuclidianStyleConstants_POINT_STYLE_DOT) {
      ...
      if (!compact_) (void) [((JavaLangStringBuilder *) nil_chk(codePoint_)) appendWithNSString:@"\n"];
      if (compactcse5_) (void) [((JavaLangStringBuilder *) nil_chk(codePoint_)) appendWithNSString:@"D("];
      else (void) [((JavaLangStringBuilder *) nil_chk(codePoint_)) appendWithNSString:@"dot("];
...
- (void)drawSpecialPointWithOrgGeogebraCommonKernelGeosGeoPoint:(OrgGeogebraCommonKernelGeosGeoPoint *)geo {
  ...
  switch (dotstyle) {
    ...
    [self startDraw];
    (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:JreStrcat("$$C$$", @"shift((", [self formatWithDouble:x], ',', [self formatWithDouble:y], @"))*")];
    (void) [code_ appendWithNSString:@"scale("];
    (void) [code_ appendWithNSString:[self formatWithDouble:radius]];
    (void) [code_ appendWithNSString:@")*(expi(pi/4)--expi(5*pi/4)"];
    if (compactcse5_) (void) [code_ appendWithNSString:@"--(0,0)--"];
    else (void) [code_ appendWithNSString:@"^^"];
    (void) [code_ appendWithNSString:@"expi(3*pi/4)--expi(7*pi/4))"];
    ...
    if (!compactcse5_) {
      (void) [((JavaLangStringBuilder *) nil_chk(codePoint_)) appendWithNSString:@"dot("];
      [self addPointWithNSString:[self formatWithDouble:x] withNSString:[self formatWithDouble:y] withJavaLangStringBuilder:codePoint_];
      ...
      (void) [codePoint_ appendWithNSString:@",UnFill(0)); "];
    }
    else {
      [self startDraw];
      (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"CR(("];
      (void) [code_ appendWithNSString:JreStrcat("$C$$", [self formatWithDouble:x], ',', [self formatWithDouble:y], @"),")];
      (void) [code_ appendWithNSString:[self formatWithDouble:radius]];
      (void) [code_ appendWithNSString:@")"];
      [self endPointWithOrgGeogebraCommonAwtGColor:dotcolor];
    }
    ...
    (void) [code_ appendWithNSString:@"scale("];
    (void) [code_ appendWithNSString:[self formatWithDouble:radius]];
    (void) [code_ appendWithNSString:@")*((1,0)--(0,1)--(-1,0)--(0,-1)--cycle)"];
    [self endPointWithOrgGeogebraCommonAwtGColor:dotcolor];
    break;
    case OrgGeogebraCommonPluginEuclidianStyleConstants_POINT_STYLE_FILLED_DIAMOND:
    if (!compact_) (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"\n"];
    [self packSpaceBetweenWithNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ JreStrcat("$$C$$", @"fill(shift((", [self formatWithDouble:x], ',', [self formatWithDouble:y], @"))"), @"*", JreStrcat("$$C", @"scale(", [self formatWithDouble:radius], ')'), @"*", @"((1,0)--(0,1)--(-1,0)--(0,-1)--cycle)" } count:5 type:NSString_class_()]];
    [self endPointWithOrgGeogebraCommonAwtGColor:dotcolor];
    break;
    case OrgGeogebraCommonPluginEuclidianStyleConstants_POINT_STYLE_PLUS:
    [self startDraw];
    [self packSpaceBetweenWithNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ JreStrcat("$$C$$", @"shift((", [self formatWithDouble:x], ',', [self formatWithDouble:y], @"))"), @"*", JreStrcat("$$C", @"scale(", [self formatWithDouble:radius], ')'), @"*", @"((0,1)--(0,-1)" } count:5 type:NSString_class_()]];
    if (compactcse5_) (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"--(0,0)--"];
    else (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"^^"];
    (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"(1,0)--(-1,0))"];
    [self endPointWithOrgGeogebraCommonAwtGColor:dotcolor];
    break;
    case OrgGeogebraCommonPluginEuclidianStyleConstants_POINT_STYLE_TRIANGLE_EAST:
    if (!compact_) (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"\n"];
    [self packSpaceBetweenWithNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ JreStrcat("$$C$$", @"fill(shift((", [self formatWithDouble:x], ',', [self formatWithDouble:y], @"))"), @"*", JreStrcat("$$C", @"scale(", [self formatWithDouble:radius], ')'), @"*", @"((1,0)--expi(2*pi/3)--expi(4*pi/3)--cycle)" } count:5 type:NSString_class_()]];
    [self endPointWithOrgGeogebraCommonAwtGColor:dotcolor];
    break;
    case OrgGeogebraCommonPluginEuclidianStyleConstants_POINT_STYLE_TRIANGLE_NORTH:
    if (!compact_) (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"\n"];
    [self packSpaceBetweenWithNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ JreStrcat("$$C$$", @"fill(shift((", [self formatWithDouble:x], ',', [self formatWithDouble:y], @"))"), @"*", @"rotate(90)", @"*", JreStrcat("$$C", @"scale(", [self formatWithDouble:radius], ')'), @"*", @"((1,0)--expi(2*pi/3)--expi(4*pi/3)--cycle)" } count:7 type:NSString_class_()]];
    [self endPointWithOrgGeogebraCommonAwtGColor:dotcolor];
    break;
    case OrgGeogebraCommonPluginEuclidianStyleConstants_POINT_STYLE_TRIANGLE_SOUTH:
    if (!compact_) (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"\n"];
    [self packSpaceBetweenWithNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ JreStrcat("$$C$$", @"fill(shift((", [self formatWithDouble:x], ',', [self formatWithDouble:y], @"))"), @"*", @"rotate(270)", @"*", JreStrcat("$$C", @"scale(", [self formatWithDouble:radius], ')'), @"*", @"((1,0)--expi(2*pi/3)--expi(4*pi/3)--cycle)" } count:7 type:NSString_class_()]];
    [self endPointWithOrgGeogebraCommonAwtGColor:dotcolor];
    break;
    case OrgGeogebraCommonPluginEuclidianStyleConstants_POINT_STYLE_TRIANGLE_WEST:
    if (!compact_) (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"\n"];
    [self packSpaceBetweenWithNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ JreStrcat("$$C$$", @"fill(shift((", [self formatWithDouble:x], ',', [self formatWithDouble:y], @"))"), @"*", @"rotate(180)", @"*", JreStrcat("$$C", @"scale(", [self formatWithDouble:radius], ')'), @"*", @"((1,0)--expi(2*pi/3)--expi(4*pi/3)--cycle)" } count:7 type:NSString_class_()]];
    [self endPointWithOrgGeogebraCommonAwtGColor:dotcolor];
    break;
    default:
    break;
  }
  if (!compact_) (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"/* special point */"];
}
...
- (void)drawGeoLineWithOrgGeogebraCommonKernelGeosGeoLine:(OrgGeogebraCommonKernelGeosGeoLine *)geo {
  ...
  if (y != 0) {
    [self startDraw];
    [self packSpaceAfterWithJavaLangStringBuilder:code_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"(xmin," } count:1 type:NSString_class_()]];
    (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:[self formatWithDouble:-x / y]];
    (void) [code_ appendWithNSString:@"*xmin"];
    if (z / y < 0 || [((NSString *) nil_chk([self formatWithDouble:-z / y])) isEqual:@"0"]) [self packSpaceWithJavaLangStringBuilder:code_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"+" } count:1 type:NSString_class_()]];
    (void) [code_ appendWithNSString:[self formatWithDouble:-z / y]];
    (void) [code_ appendWithNSString:@")"];
    [self packSpaceAfterWithJavaLangStringBuilder:code_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"--(xmax," } count:1 type:NSString_class_()]];
    (void) [code_ appendWithNSString:[self formatWithDouble:-x / y]];
    (void) [code_ appendWithNSString:@"*xmax"];
    if (z / y < 0 || [((NSString *) nil_chk([self formatWithDouble:-z / y])) isEqual:@"0"]) [self packSpaceWithJavaLangStringBuilder:code_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"+" } count:1 type:NSString_class_()]];
    (void) [code_ appendWithNSString:[self formatWithDouble:-z / y]];
    (void) [code_ appendWithNSString:@")"];
    [self endDrawWithOrgGeogebraCommonKernelGeosGeoElement:geo];
    ...
    (void) [code_ appendWithNSString:@",ymin)--("];
    (void) [code_ appendWithNSString:s];
    (void) [code_ appendWithNSString:@",ymax)"];
    [self endDrawWithOrgGeogebraCommonKernelGeosGeoElement:geo];
  }
  if (!compact_) (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"/* line */"];
}

- (void)drawGeoSegmentWithOrgGeogebraCommonKernelGeosGeoSegment:(OrgGeogebraCommonKernelGeosGeoSegment *)geo {
  IOSDoubleArray *A = [IOSDoubleArray newArrayWithLength:2], *B = [IOSDoubleArray newArrayWithLength:2];
  ...
  if (!compact_) (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"\n"];
  if (!compactcse5_) (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"draw("];
  else (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"D("];
  [self addPointWithNSString:x1 withNSString:y1 withJavaLangStringBuilder:code_];
  (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"--"];
  [self addPointWithNSString:x2 withNSString:y2 withJavaLangStringBuilder:code_];
  [self endDrawWithOrgGeogebraCommonKernelGeosGeoElement:geo];
...
- (void)drawGeoRayWithOrgGeogebraCommonKernelGeosGeoRay:(OrgGeogebraCommonKernelGeosGeoRay *)geo {
  ...
  if (y != 0) {
    ...
    [self packSpaceAfterWithJavaLangStringBuilder:code_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"," } count:1 type:NSString_class_()]];
    if (-x > 0) (void) [code_ appendWithNSString:@"ymax"];
    else (void) [code_ appendWithNSString:@"ymin"];
    (void) [code_ appendWithNSString:@")"];
    [self endDrawWithOrgGeogebraCommonKernelGeosGeoElement:geo];
  }
  if (!compact_) (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"/* ray */"];
}
...
- (void)drawImplicitPolyWithOrgGeogebraCommonKernelImplicitGeoImplicitPoly:(OrgGeogebraCommonKernelImplicitGeoImplicitPoly *)geo {
  ...
  if (!compact_ || ![((id<JavaUtilMap>) nil_chk(implicitPolyTable_)) containsKeyWithId:polynomial]) {
    if (compact_) {
      if ([((id<JavaUtilMap>) nil_chk(implicitPolyTable_)) isEmpty]) (void) [implicitPolyTable_ putWithId:polynomial withId:JavaLangInteger_valueOfWithInt_(1)];
      else {
        implicitFuncName = [implicitPolyTable_ size] + 1;
        (void) [implicitPolyTable_ putWithId:polynomial withId:JavaLangInteger_valueOfWithInt_(implicitFuncName)];
      }
    }
    if (!compact_) (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"\n"];
    (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"real implicitf"];
    (void) [code_ appendWithInt:implicitFuncName];
    [self packSpaceWithNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"(real x, real y)", @"{" } count:2 type:NSString_class_()]];
    (void) [code_ appendWithNSString:JreStrcat("$$", @"return ", polynomial)];
    [self packSpaceAfterWithNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @";" } count:1 type:NSString_class_()]];
    (void) [code_ appendWithNSString:@"} "];
  }
  else implicitFuncName = [((JavaLangInteger *) nil_chk([implicitPolyTable_ getWithId:polynomial])) intValue];
  [self startDraw];
  (void) [((JavaLangStringBuilder *) nil_chk(code_)) appendWithNSString:@"contour(implicitf"];
  (void) [code_ appendWithInt:implicitFuncName];
  [self packSpaceBetweenWithJavaLangStringBuilder:code_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @",", @"(xmin,ymin),", @"(xmax,ymax),", @"new real[]{0},", @"500)" } count:5 type:NSString_class_()]];
  [self endDrawWithOrgGeogebraCommonKernelGeosGeoElement:geo];
}
...
- (void)drawPolyLineWithOrgGeogebraCommonKernelGeosGeoPolyLine:(OrgGeogebraCommonKernelGeosGeoPolyLine *)geo {
  ...
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(points))->size_; i++) {
    ...
    if (i != points->size_ - 1) (void) [str appendWithNSString:@"--"];
  }
  [self endDrawWithOrgGeogebraCommonKernelGeosGeoElement:geo withJavaLangStringBuilder:str];
  NSString *s = [str description];
  JavaLangStringBuilder *sb = new_JavaLangStringBuilder_init();
  if (OrgGeogebraCommonExportPstricksGeoGebraToAsymptote_LineOptionCodeWithOrgGeogebraCommonKernelGeosGeoElement_withBoolean_(self, geo, YES) != nil) {
    [self packSpaceAfterWithJavaLangStringBuilder:sb withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"," } count:1 type:NSString_class_()]];
    (void) [sb appendWithNSString:OrgGeogebraCommonExportPstricksGeoGebraToAsymptote_LineOptionCodeWithOrgGeogebraCommonKernelGeosGeoElement_withBoolean_(self, geo, YES)];
  }
  (void) [sb appendWithNSString:@"); "];
  JavaLangStringBuilder *sa = new_JavaLangStringBuilder_init();
  if (!compact_) (void) [sa appendWithNSString:@"\n"];
  if (compactcse5_) (void) [sa appendWithNSString:@"D("];
  else (void) [sa appendWithNSString:@"draw("];
...
- (void)drawLabelWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo
  ...
  @try {
    if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(geo)) isLabelVisible]) {
      ...
      OrgGeogebraCommonAwtGColor *geocolor = [geo getObjectColor];
      if (!compact_) (void) [((JavaLangStringBuilder *) nil_chk(codePoint_)) appendWithNSString:@"\n"];
      if (compactcse5_ && [geo getLabelMode] != OrgGeogebraCommonKernelGeosGeoElement_LABEL_CAPTION) (void) [((JavaLangStringBuilder *) nil_chk(codePoint_)) appendWithNSString:@"MP(\""];
      else (void) [((JavaLangStringBuilder *) nil_chk(codePoint_)) appendWithNSString:@"label(\""];
      (void) [((JavaLangStringBuilder *) nil_chk(codePoint_)) appendWithNSString:name];
      [self packSpaceBetweenWithJavaLangStringBuilder:codePoint_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"\",", @"(" } count:2 type:NSString_class_()]];
      ...
      (void) [codePoint_ appendWithNSString:@"),"];
      if (!compact_) (void) [codePoint_ appendWithNSString:@" "];
      (void) [codePoint_ appendWithNSString:@"NE"];
      [self packSpaceWithJavaLangStringBuilder:codePoint_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"*" } count:1 type:NSString_class_()]];
      if (compact_) (void) [codePoint_ appendWithNSString:@"lsf"];
      if (!compact_) (void) [codePoint_ appendWithNSString:@"labelscalefactor"];
      ...
      if (isPointLabel && ![((id<OrgGeogebraCommonExportPstricksExportSettings>) nil_chk(frame_)) getKeepDotColors]) {
        ...
        if (compactcse5_) (void) [codePoint_ appendWithNSString:@",fp+"];
        else (void) [codePoint_ appendWithNSString:@","];
        [self ColorCodeWithOrgGeogebraCommonAwtGColor:geocolor withJavaLangStringBuilder:codePoint_];
      }
      (void) [codePoint_ appendWithNSString:@"); "];
    }
...
- (void)ColorCodeWithOrgGeogebraCommonAwtGColor:(OrgGeogebraCommonAwtGColor *)c
  ...
  if (grayscale_) {
    ...
    if ([((JavaUtilHashMap *) nil_chk(CustomColor_)) containsKeyWithId:c]) {
      ...
      if (!compact_) (void) [((JavaLangStringBuilder *) nil_chk(codeColors_)) appendWithNSString:@"pen "];
      else (void) [((JavaLangStringBuilder *) nil_chk(codeColors_)) appendWithNSString:@", "];
      (void) [((JavaLangStringBuilder *) nil_chk(codeColors_)) appendWithNSString:colorname];
      [self packSpaceWithJavaLangStringBuilder:codeColors_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"=" } count:1 type:NSString_class_()]];
      (void) [codeColors_ appendWithNSString:JreStrcat("$$C$C$C", @"rgb(", [self formatWithDouble:grayscale / 255.0], ',', [self formatWithDouble:grayscale / 255.0], ',', [self formatWithDouble:grayscale / 255.0], ')')];
      if (!compact_) (void) [codeColors_ appendWithNSString:@"; "];
    ...
    if ([c isEqual:OrgGeogebraCommonAwtGColor_get_BLACK_()]) (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"black"];
    else if ([c isEqual:OrgGeogebraCommonAwtGColor_get_GRAY_()]) (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"gray"];
    else if ([c isEqual:OrgGeogebraCommonAwtGColor_get_WHITE_()]) (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"white"];
      ...
      if ([((JavaUtilHashMap *) nil_chk(CustomColor_)) containsKeyWithId:c]) {
        ...
        (void) [((JavaLangStringBuilder *) nil_chk(codeColors_)) appendWithNSString:colorname];
        [self packSpaceWithJavaLangStringBuilder:codeColors_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"=" } count:1 type:NSString_class_()]];
        (void) [codeColors_ appendWithNSString:JreStrcat("$$C$C$C", @"rgb(", [self formatWithDouble:red / 255.0], ',', [self formatWithDouble:green / 255.0], ',', [self formatWithDouble:blue / 255.0], ')')];
        if (!compact_) (void) [codeColors_ appendWithNSString:@"; "];
        (void) [CustomColor_ putWithId:c withId:colorname];
      }
...
- (void)ColorLightCodeWithOrgGeogebraCommonAwtGColor:(OrgGeogebraCommonAwtGColor *)c
  ...
  if (grayscale_) {
    ...
    if ([((JavaUtilHashMap *) nil_chk(CustomColor_)) containsKeyWithId:tempc]) {
      ...
      (void) [codeColors_ appendWithNSString:JreStrcat("$$C$C$C", @"rgb(", [self formatWithDouble:grayscale / 255.0], ',', [self formatWithDouble:grayscale / 255.0], ',', [self formatWithDouble:grayscale / 255.0], ')')];
      if (!compact_) (void) [codeColors_ appendWithNSString:@"; "];
      (void) [CustomColor_ putWithId:tempc withId:colorname];
    }
    if ([((OrgGeogebraCommonAwtGColor *) nil_chk(tempc)) isEqual:OrgGeogebraCommonAwtGColor_get_BLACK_()]) (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"black"];
    else if ([tempc isEqual:OrgGeogebraCommonAwtGColor_get_GRAY_()]) (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"gray"];
    else if ([tempc isEqual:OrgGeogebraCommonAwtGColor_get_WHITE_()]) (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"white"];
    else (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:colorname];
  }
  else {
    ...
    else if ([tempc isEqual:OrgGeogebraCommonAwtGColor_get_RED_()]) (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"red"];
    else if ([tempc isEqual:OrgGeogebraCommonAwtGColor_get_GREEN_()]) (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"green"];
    else if ([tempc isEqual:OrgGeogebraCommonAwtGColor_get_BLUE_()]) (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"blue"];
    else if ([tempc isEqual:OrgGeogebraCommonAwtGColor_get_YELLOW_()]) (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"yellow"];
    else {
      NSString *colorname = @"";
      if ([((JavaUtilHashMap *) nil_chk(CustomColor_)) containsKeyWithId:tempc]) {
        colorname = [((NSString *) nil_chk([CustomColor_ getWithId:tempc])) description];
...
- (void)ColorCode2WithOrgGeogebraCommonAwtGColor:(OrgGeogebraCommonAwtGColor *)c
  ...
  if (grayscale_) {
    jint grayscale = (red + green + blue) / 3;
    c = [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newColorWithInt:grayscale withInt:grayscale withInt:grayscale];
    (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:JreStrcat("$$C$C$C", @"\\color[rgb]{", [self formatWithDouble:grayscale / 255.0], ',', [self formatWithDouble:grayscale / 255.0], ',', [self formatWithDouble:grayscale / 255.0], '}')];
    if ([((OrgGeogebraCommonAwtGColor *) nil_chk(c)) isEqual:OrgGeogebraCommonAwtGColor_get_BLACK_()]) (void) [sb appendWithNSString:@"black"];
    else if ([c isEqual:OrgGeogebraCommonAwtGColor_get_GRAY_()]) (void) [sb appendWithNSString:@"gray"];
    else if ([c isEqual:OrgGeogebraCommonAwtGColor_get_WHITE_()]) (void) [sb appendWithNSString:@"white"];
  }
  else {
    if ([c isEqual:OrgGeogebraCommonAwtGColor_get_BLACK_()]) (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"black"];
    else if ([c isEqual:OrgGeogebraCommonAwtGColor_get_GRAY_()]) (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"gray"];
      ...
      (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:JreStrcat("$$C$C$C", @"\\color[rgb]{", [self formatWithDouble:red / 255.0], ',', [self formatWithDouble:green / 255.0], ',', [self formatWithDouble:blue / 255.0], '}')];
    }
  }
}
...
- (void)packSpaceBetweenWithJavaLangStringBuilder:(JavaLangStringBuilder *)sb
  ...
  (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:IOSObjectArray_Get(nil_chk(s), 0)];
  for (jint i = 1; i < s->size_; i++) {
    if (!compact_) (void) [sb appendWithNSString:JreStrcat("C$", ' ', IOSObjectArray_Get(s, i))];
    else (void) [sb appendWithNSString:IOSObjectArray_Get(s, i)];
  }
}
...
- (void)packSpaceAfterWithJavaLangStringBuilder:(JavaLangStringBuilder *)sb
  ...
  if (!compact_) (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@" "];
}
...
- (void)startDrawWithJavaLangStringBuilder:(JavaLangStringBuilder *)sb {
  if (!compact_) (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"\n"];
  if (compactcse5_) (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"D("];
  else (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"draw("];
}
...
- (void)endDrawWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo
  ...
  if (OrgGeogebraCommonExportPstricksGeoGebraToAsymptote_LineOptionCodeWithOrgGeogebraCommonKernelGeosGeoElement_withBoolean_(self, geo, YES) != nil) {
    [self packSpaceAfterWithJavaLangStringBuilder:sb withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"," } count:1 type:NSString_class_()]];
    (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:OrgGeogebraCommonExportPstricksGeoGebraToAsymptote_LineOptionCodeWithOrgGeogebraCommonKernelGeosGeoElement_withBoolean_(self, geo, YES)];
  }
...
- (void)startTransparentFillWithJavaLangStringBuilder:(JavaLangStringBuilder *)sb {
  if (!compact_) (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"\n"];
  if (fillType_ != OrgGeogebraCommonExportPstricksExportSettings_FILL_NONE) (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"filldraw("];
  else if (compactcse5_) (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"D("];
  else (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"draw("];
}
...
- (void)endTransparentFillWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo
  ...
  if (fillType_ == OrgGeogebraCommonExportPstricksExportSettings_FILL_OPAQUE) {
    ...
    else (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"invisible"];
  }
    ...
    [self packSpaceWithJavaLangStringBuilder:sb withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"+" } count:1 type:NSString_class_()]];
    (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"opacity("];
...
- (void)addPointWithNSString:(NSString *)s1
  ...
  if (pairName_ && [((id<JavaUtilMap>) nil_chk(pairNameTable_)) containsKeyWithId:pairString]) (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:[pairNameTable_ getWithId:pairString]];
  else (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:pairString];
}
...
- (JavaLangStringBuilder *)convertUnicodeToTextWithJavaLangStringBuilder:(JavaLangStringBuilder *)sb {
  ...
  (void) [sb delete__WithInt:0 withInt:[sb length]];
  (void) [sb appendWithNSString:tempc];
  return sb;
}
...
- (NSString *)convertUnicodeToLatexWithNSString:(NSString *)s {
  ...
  JavaLangStringBuilder *sb = new_JavaLangStringBuilder_init();
  (void) [sb appendWithChar:[((NSString *) nil_chk(s1)) charAtWithInt:0]];
  for (jint i = 1; i < ((jint) [s1 length]) - 1; i++) {
    if ([s1 charAtWithInt:i - 1] == '\\' && (i == 1 || [s1 charAtWithInt:i - 2] != '\\')) {
      (void) [sb appendWithChar:[s1 charAtWithInt:i]];
      continue;
    }
    else if ([s1 charAtWithInt:i] == '$') (void) [sb appendWithNSString:@"\\$"];
    else (void) [sb appendWithChar:[s1 charAtWithInt:i]];
  }
  if (((jint) [s1 length]) > 1) (void) [sb appendWithChar:[s1 charAtWithInt:((jint) [s1 length]) - 1]];
  s1 = [sb description];
...
- (jboolean)fillSplineWithOrgGeogebraCommonKernelGeosGeoCurveCartesianArray:(IOSObjectArray *)curves {
  ...
  JavaLangStringBuilder *fill = new_JavaLangStringBuilder_init();
  ...
  for (jint i = 0; i < curves->size_; i++) {
    ...
    for (; p <= [((OrgGeogebraCommonKernelGeosGeoCurveCartesian *) nil_chk(IOSObjectArray_Get(curves, i))) getMaxParameter]; p += step) {
      ...
      (void) [fill appendWithNSString:JreStrcat("CDCD$", '(', x, ',', y, @") -- ")];
    }
  }
  (void) [fill appendWithNSString:JreStrcat("$$$", @"cycle", liopco, @");")];
...
void OrgGeogebraCommonExportPstricksGeoGebraToAsymptote_drawCircleWithOrgGeogebraCommonKernelGeosGeoConic_(OrgGeogebraCommonExportPstricksGeoGebraToAsymptote *self, OrgGeogebraCommonKernelGeosGeoConic *geo) {
  ...
  if (self->xunit_ == self->yunit_) {
    ...
    if (nofill) {
      if (!self->compact_) (void) [tempsb appendWithNSString:@"\n"];
      if (self->compactcse5_) (void) [tempsb appendWithNSString:@"D(CR("];
      else (void) [tempsb appendWithNSString:@"draw(circle("];
    }
    else {
      [self startTransparentFillWithJavaLangStringBuilder:tempsb];
      if (self->compactcse5_) (void) [tempsb appendWithNSString:@"CR("];
      else (void) [tempsb appendWithNSString:@"circle("];
    }
    [self addPointWithNSString:[self formatWithDouble:x] withNSString:[self formatWithDouble:y] withJavaLangStringBuilder:tempsb];
    [self packSpaceAfterWithJavaLangStringBuilder:tempsb withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"," } count:1 type:NSString_class_()]];
    if ([((OrgGeogebraCommonKernelCommandsAlgebraProcessor *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) getAlgebraProcessor])) evaluateToDoubleWithNSString:tmpr] != 0) (void) [tempsb appendWithNSString:tmpr];
    else (void) [tempsb appendWithDouble:r];
    (void) [tempsb appendWithNSString:@")"];
    if (nofill) {
    ...
    if (nofill) {
      if (!self->compact_) (void) [tempsb appendWithNSString:@"\n"];
      if (self->compactcse5_) (void) [tempsb appendWithNSString:@"D("];
      else (void) [tempsb appendWithNSString:@"draw("];
    }
    ...
    [self packSpaceBetweenWithJavaLangStringBuilder:tempsb withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @")", @"*", JreStrcat("$$C", @"scale(", [self formatWithDouble:r1], ','), JreStrcat("$$", [self formatWithDouble:r2], @")*unitcircle") } count:4 type:NSString_class_()]];
    if (nofill) [self endDrawWithOrgGeogebraCommonKernelGeosGeoElement:geo withJavaLangStringBuilder:tempsb];
    else [self endTransparentFillWithOrgGeogebraCommonKernelGeosGeoElement:geo withJavaLangStringBuilder:tempsb];
  }
  if (nofill) (void) [((JavaLangStringBuilder *) nil_chk(self->code_)) appendWithJavaLangCharSequence:tempsb];
  else (void) [((JavaLangStringBuilder *) nil_chk(self->codeFilledObject_)) appendWithJavaLangCharSequence:tempsb];
}
...
void OrgGeogebraCommonExportPstricksGeoGebraToAsymptote_initUnitAndVariable(OrgGeogebraCommonExportPstricksGeoGebraToAsymptote *self) {
  if (!self->compact_) {
    (void) [((JavaLangStringBuilder *) nil_chk(self->codePreamble_)) appendWithNSString:@"\nreal labelscalefactor = 0.5; /* changes label-to-point distance */"];
    (void) [self->codePreamble_ appendWithNSString:@"\npen dps = linewidth(0.7) + fontsize("];
    (void) [self->codePreamble_ appendWithInt:self->fontsize_];
    (void) [self->codePreamble_ appendWithNSString:@"); defaultpen(dps); /* default pen style */ "];
    if (![((id<OrgGeogebraCommonExportPstricksExportSettings>) nil_chk(self->frame_)) getKeepDotColors]) (void) [self->codePreamble_ appendWithNSString:@"\npen dotstyle = black; /* point style */ \n"];
  }
  else if (!self->compactcse5_) {
    (void) [((JavaLangStringBuilder *) nil_chk(self->codePreamble_)) appendWithNSString:@"real lsf=0.5; pen dps=linewidth(0.7)+fontsize("];
    (void) [self->codePreamble_ appendWithInt:self->fontsize_];
    (void) [self->codePreamble_ appendWithNSString:@"); defaultpen(dps); "];
    if (![((id<OrgGeogebraCommonExportPstricksExportSettings>) nil_chk(self->frame_)) getKeepDotColors]) (void) [self->codePreamble_ appendWithNSString:@"pen ds=black; "];
  }
  else {
    (void) [((JavaLangStringBuilder *) nil_chk(self->codePreamble_)) appendWithNSString:@"real lsf=0.5; pathpen=linewidth(0.7); pointpen=black; pen fp=fontsize("];
    (void) [self->codePreamble_ appendWithInt:self->fontsize_];
    (void) [self->codePreamble_ appendWithNSString:@"); pointfontpen=fp; "];
  }
  ...
  [self packSpaceBetweenWithJavaLangStringBuilder:self->codePreamble_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"real xmin", @"=", JreStrcat("$C", [self formatWithDouble:assignMinX], ','), @"xmax", @"=", JreStrcat("$C", [self formatWithDouble:self->xmax_], ','), @"ymin", @"=", JreStrcat("$C", [self formatWithDouble:assignMinY], ','), @"ymax", @"=", JreStrcat("$$", [self formatWithDouble:self->ymax_], @"; ") } count:12 type:NSString_class_()]];
  if (!self->compact_) (void) [((JavaLangStringBuilder *) nil_chk(self->codePreamble_)) appendWithNSString:@" /* image dimensions */\n"];
  else {
  }
}
...
void OrgGeogebraCommonExportPstricksGeoGebraToAsymptote_initPointDeclarations(OrgGeogebraCommonExportPstricksGeoGebraToAsymptote *self) {
  ...
  jboolean comma = NO;
  IOSObjectArray *predefinedNames = [IOSObjectArray newArrayWithObjects:(id[]){ @"N", @"S", @"E", @"W", @"NE", @"SE", @"NW", @"SW", @"NNE", @"NNW", @"SSE", @"SSW", @"ENE", @"WNW", @"ESE", @"WSW", @"left", @"right", @"up", @"down" } count:20 type:NSString_class_()];
  while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
    ...
    if ([((OrgGeogebraCommonKernelGeosGeoPoint *) nil_chk(gp)) getPointStyle] == OrgGeogebraCommonPluginEuclidianStyleConstants_POINT_STYLE_DOT || [gp getPointStyle] == OrgGeogebraCommonPluginEuclidianStyleConstants_POINT_STYLE_CIRCLE) {
      ...
      if (![((id<JavaUtilMap>) nil_chk(self->pairNameTable_)) containsKeyWithId:pairString] && isVariable) {
        if (comma) (void) [((JavaLangStringBuilder *) nil_chk(self->codePointDecl_)) appendWithNSString:@", "];
        else comma = YES;
        (void) [self->pairNameTable_ putWithId:pairString withId:pointName];
        (void) [((JavaLangStringBuilder *) nil_chk(self->codePointDecl_)) appendWithNSString:pointName];
        [self packSpaceWithJavaLangStringBuilder:self->codePointDecl_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"=" } count:1 type:NSString_class_()]];
        (void) [self->codePointDecl_ appendWithNSString:pairString];
      }
    }
  }
  if (comma) {
    (void) [((JavaLangStringBuilder *) nil_chk(self->codePointDecl_)) insertWithInt:0 withNSString:@"\npair "];
    (void) [self->codePointDecl_ appendWithNSString:@"; "];
  }
}
...
void OrgGeogebraCommonExportPstricksGeoGebraToAsymptote_drawGrid(OrgGeogebraCommonExportPstricksGeoGebraToAsymptote *self) {
  ...
  if (!self->compact_) {
    (void) [((JavaLangStringBuilder *) nil_chk(self->codeBeginPic_)) appendWithNSString:@"\n /* draw grid of horizontal/vertical lines */"];
    (void) [self->codeBeginPic_ appendWithNSString:@"\npen gridstyle = "];
    if (GridBold) (void) [self->codeBeginPic_ appendWithNSString:@"linewidth(1.0)"];
    else (void) [self->codeBeginPic_ appendWithNSString:@"linewidth(0.7)"];
    (void) [self->codeBeginPic_ appendWithNSString:@" + "];
    ...
    (void) [self->codeBeginPic_ appendWithNSString:@"; real gridx = "];
    (void) [self->codeBeginPic_ appendWithNSString:[self formatWithDouble:IOSDoubleArray_Get(nil_chk(GridDist), 0)]];
    (void) [self->codeBeginPic_ appendWithNSString:@", gridy = "];
    (void) [self->codeBeginPic_ appendWithNSString:[self formatWithDouble:IOSDoubleArray_Get(GridDist, 1)]];
    (void) [self->codeBeginPic_ appendWithNSString:@"; /* grid intervals */\nfor(real i = ceil(xmin/gridx)*gridx; i <= floor(xmax/gridx)*gridx; i += gridx)"];
  ...
  else if (!self->compactcse5_) (void) [((JavaLangStringBuilder *) nil_chk(self->codeBeginPic_)) appendWithNSString:@"\n/*grid*/ "];
  [((id<JavaUtilSet>) nil_chk(self->importpackage_)) addWithId:@"math"];
  (void) [((JavaLangStringBuilder *) nil_chk(self->codeBeginPic_)) appendWithNSString:JreStrcat("$$$$$", @"real gx=", [self formatWithDouble:IOSDoubleArray_Get(nil_chk(GridDist), 0)], @",gy=", [self formatWithDouble:IOSDoubleArray_Get(GridDist, 1)], @"; ")];
  (void) [self->codeBeginPic_ appendWithNSString:@"add(scale(gx,gy)*shift(floor(xmin/gx),floor(ymin/gy))*grid(ceil(xmax-xmin)+1,ceil(ymax-ymin)+1,"];
  if (GridBold) (void) [self->codeBeginPic_ appendWithNSString:@"linewidth(1.0)"];
  else (void) [self->codeBeginPic_ appendWithNSString:@"linewidth(0.7)"];
  (void) [self->codeBeginPic_ appendWithNSString:@"+"];
  [self ColorCodeWithOrgGeogebraCommonAwtGColor:GridCol withJavaLangStringBuilder:self->codeBeginPic_];
...
void OrgGeogebraCommonExportPstricksGeoGebraToAsymptote_drawAxis(OrgGeogebraCommonExportPstricksGeoGebraToAsymptote *self) {
  ...
  if (xAxis || yAxis) {
    (void) [((JavaLangStringBuilder *) nil_chk(self->codeBeginPic_)) appendWithNSString:@"\n"];
    (void) [self->codeBeginPic_ appendWithNSString:@"Label laxis; laxis.p"];
    [self packSpaceWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"=" } count:1 type:NSString_class_()]];
    (void) [self->codeBeginPic_ appendWithNSString:JreStrcat("$I$", @"fontsize(", self->fontsize_, @"); ")];
    if (!bx || !by) {
      if (!self->compact_) (void) [self->codeBeginPic_ appendWithNSString:@"\n"];
      (void) [self->codeBeginPic_ appendWithNSString:@"string blank(real x) {return \"\";} "];
    }
    if (bx || by) {
      if (IOSObjectArray_Get(nil_chk(units), 0) != nil && ![((NSString *) nil_chk(IOSObjectArray_Get(units, 0))) isEqual:@""]) {
        (void) [self->codeBeginPic_ appendWithNSString:@"string "];
        if (self->compact_) (void) [self->codeBeginPic_ appendWithNSString:@"xlbl"];
        else (void) [self->codeBeginPic_ appendWithNSString:@"xaxislabel"];
        [self packSpaceWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"(real x)" } count:1 type:NSString_class_()]];
        [self packSpaceAfterWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"{" } count:1 type:NSString_class_()]];
        if ([((NSString *) nil_chk(IOSObjectArray_Get(units, 0))) isEqual:OrgGeogebraCommonUtilUnicode_get_PI_STRING_()]) {
          [self packSpaceBetweenWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"string s; ", @"int n", @"=", @"round(2*x/pi); " } count:4 type:NSString_class_()]];
          if (!self->compact_) (void) [self->codeBeginPic_ appendWithNSString:@"\n"];
          [self packSpaceBetweenWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"if(abs(n-2*x/pi)", @">", @"1e-3) return string(x); " } count:3 type:NSString_class_()]];
          if (!self->compact_) (void) [self->codeBeginPic_ appendWithNSString:@"\n"];
          [self packSpaceBetweenWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"if(abs(n)", @">", @"2) s = string(round((n%2", @"+", @"1)*x/pi)); " } count:5 type:NSString_class_()]];
          if (!self->compact_) (void) [self->codeBeginPic_ appendWithNSString:@"\n"];
          [self packSpaceBetweenWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"if(n%2", @"==", @"0) return \"$\"+s+\"\\pi$\"; " } count:3 type:NSString_class_()]];
        }
        (void) [self->codeBeginPic_ appendWithNSString:@"return \"$\""];
        [self packSpaceWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"+" } count:1 type:NSString_class_()]];
        if ([((NSString *) nil_chk(IOSObjectArray_Get(units, 0))) isEqual:OrgGeogebraCommonUtilUnicode_get_PI_STRING_()]) [self packSpaceBetweenWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"s", @"+", @"\"\\pi/2" } count:3 type:NSString_class_()]];
        else if ([((NSString *) nil_chk(IOSObjectArray_Get(units, 0))) isEqual:OrgGeogebraCommonUtilUnicode_get_DEGREE_()]) [self packSpaceBetweenWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"string(x)", @"+", @"\"^\\circ" } count:3 type:NSString_class_()]];
        else {
          (void) [self->codeBeginPic_ appendWithNSString:@"string(x)"];
          [self packSpaceWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"+" } count:1 type:NSString_class_()]];
          (void) [self->codeBeginPic_ appendWithNSString:JreStrcat("$$C", @"\"\\,\\mathrm{", IOSObjectArray_Get(units, 0), '}')];
        }
        (void) [self->codeBeginPic_ appendWithNSString:@"$\";} "];
      }
      if (IOSObjectArray_Get(units, 1) != nil && ![((NSString *) nil_chk(IOSObjectArray_Get(units, 1))) isEqual:@""]) {
        (void) [self->codeBeginPic_ appendWithNSString:@"string "];
        if (self->compact_) (void) [self->codeBeginPic_ appendWithNSString:@"ylbl"];
        else (void) [self->codeBeginPic_ appendWithNSString:@"yaxislabel"];
        [self packSpaceWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"(real x)" } count:1 type:NSString_class_()]];
        [self packSpaceAfterWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"{" } count:1 type:NSString_class_()]];
        ...
        (void) [self->codeBeginPic_ appendWithNSString:@"return \"$\""];
        [self packSpaceWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"+" } count:1 type:NSString_class_()]];
        if ([((NSString *) nil_chk(IOSObjectArray_Get(units, 1))) isEqual:OrgGeogebraCommonUtilUnicode_get_PI_STRING_()]) [self packSpaceBetweenWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"s", @"+", @"\"\\pi/2" } count:3 type:NSString_class_()]];
        else if ([((NSString *) nil_chk(IOSObjectArray_Get(units, 1))) isEqual:OrgGeogebraCommonUtilUnicode_get_DEGREE_()]) [self packSpaceBetweenWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"string(x)", @"+", @"\"^\\circ" } count:3 type:NSString_class_()]];
        else {
          (void) [self->codeBeginPic_ appendWithNSString:@"string(x)"];
          [self packSpaceWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"+" } count:1 type:NSString_class_()]];
          (void) [self->codeBeginPic_ appendWithNSString:JreStrcat("$$C", @"\"\\,\\mathrm{", IOSObjectArray_Get(units, 1), '}')];
        }
        (void) [self->codeBeginPic_ appendWithNSString:@"$\";} "];
      }
    }
  ...
  if (xAxis) {
    (void) [((JavaLangStringBuilder *) nil_chk(self->codeBeginPic_)) appendWithNSString:@"xaxis("];
    if (IOSObjectArray_Get(label, 0) != nil) [self packSpaceBetweenWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ JreStrcat("C$$", '"', lx, @"\",") } count:1 type:NSString_class_()]];
    [self packSpaceBetweenWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"xmin,", @"xmax" } count:2 type:NSString_class_()]];
    if (axisColor != OrgGeogebraCommonAwtGColor_get_BLACK_()) {
      (void) [self->codeBeginPic_ appendWithNSString:@","];
      if (self->compactcse5_) (void) [self->codeBeginPic_ appendWithNSString:@"pathpen+"];
      else (void) [self->codeBeginPic_ appendWithNSString:@"defaultpen+"];
      [self ColorCodeWithOrgGeogebraCommonAwtGColor:axisColor withJavaLangStringBuilder:self->codeBeginPic_];
      if (axisBold) {
        (void) [self->codeBeginPic_ appendWithNSString:@"+linewidth(1.2)"];
      }
    }
    else if (axisBold) {
      (void) [self->codeBeginPic_ appendWithNSString:@",linewidth(1.2)"];
    ...
    if (IOSIntArray_Get(nil_chk(tickStyle), 0) == OrgGeogebraCommonPluginEuclidianStyleConstants_AXES_TICK_STYLE_MAJOR) {
      [self packSpaceAfterWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"Ticks(laxis," } count:1 type:NSString_class_()]];
      if (!bx) [self packSpaceAfterWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"blank," } count:1 type:NSString_class_()]];
      else if (IOSObjectArray_Get(nil_chk(units), 0) != nil && ![((NSString *) nil_chk(IOSObjectArray_Get(units, 0))) isEqual:@""]) {
        if (self->compact_) [self packSpaceAfterWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"xlbl," } count:1 type:NSString_class_()]];
        else [self packSpaceAfterWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"xaxislabel," } count:1 type:NSString_class_()]];
      }
      [self packSpaceBetweenWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"Step", @"=", JreStrcat("$C", Dx, ','), @"Size", @"=", @"2" } count:6 type:NSString_class_()]];
      if (yAxis) [self packSpaceBetweenWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @",", @"NoZero" } count:2 type:NSString_class_()]];
      (void) [self->codeBeginPic_ appendWithNSString:@")"];
    }
      ...
      [self packSpaceBetweenWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"n", @"=", @"2,", @"Step", @"=", JreStrcat("$C", Dx, ','), @"Size", @"=", @"2,", @"size", @"=", @"1" } count:12 type:NSString_class_()]];
      (void) [self->codeBeginPic_ appendWithNSString:@")"];
    }
    [self packSpaceBetweenWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @",", @"above", @"=", @"true); " } count:4 type:NSString_class_()]];
  }
  if (xAxis && yAxis && !self->compact_) (void) [((JavaLangStringBuilder *) nil_chk(self->codeBeginPic_)) appendWithNSString:@"\n"];
  if (yAxis) {
    (void) [((JavaLangStringBuilder *) nil_chk(self->codeBeginPic_)) appendWithNSString:@"yaxis("];
    if (IOSObjectArray_Get(label, 1) != nil) [self packSpaceAfterWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ JreStrcat("C$$", '"', ly, @"\",") } count:1 type:NSString_class_()]];
    [self packSpaceBetweenWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"ymin,", @"ymax" } count:2 type:NSString_class_()]];
    if (axisColor != OrgGeogebraCommonAwtGColor_get_BLACK_()) {
      if (self->compactcse5_) (void) [self->codeBeginPic_ appendWithNSString:@",pathpen+"];
      else (void) [self->codeBeginPic_ appendWithNSString:@",defaultpen+"];
      [self ColorCodeWithOrgGeogebraCommonAwtGColor:axisColor withJavaLangStringBuilder:self->codeBeginPic_];
    ...
    if (IOSIntArray_Get(nil_chk(tickStyle), 1) == OrgGeogebraCommonPluginEuclidianStyleConstants_AXES_TICK_STYLE_MAJOR) {
      [self packSpaceAfterWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"Ticks(laxis," } count:1 type:NSString_class_()]];
      if (!by) [self packSpaceAfterWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"blank," } count:1 type:NSString_class_()]];
      else if (IOSObjectArray_Get(nil_chk(units), 1) != nil && ![((NSString *) nil_chk(IOSObjectArray_Get(units, 1))) isEqual:@""]) {
        if (self->compact_) [self packSpaceAfterWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"ylbl," } count:1 type:NSString_class_()]];
        else [self packSpaceAfterWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"yaxislabel," } count:1 type:NSString_class_()]];
      }
      [self packSpaceBetweenWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"Step", @"=", JreStrcat("$C", Dy, ','), @"Size", @"=", @"2" } count:6 type:NSString_class_()]];
      if (xAxis) [self packSpaceBetweenWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @",", @"NoZero" } count:2 type:NSString_class_()]];
      (void) [self->codeBeginPic_ appendWithNSString:@")"];
    }
      ...
      [self packSpaceBetweenWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"n", @"=", @"2,", @"Step", @"=", JreStrcat("$C", Dy, ','), @"Size", @"=", @"2,", @"size", @"=", @"1" } count:12 type:NSString_class_()]];
      (void) [self->codeBeginPic_ appendWithNSString:@")"];
    }
    [self packSpaceBetweenWithJavaLangStringBuilder:self->codeBeginPic_ withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @",", @"above", @"=", @"true); " } count:4 type:NSString_class_()]];
  }
  if ((xAxis || yAxis) && !self->compact_) (void) [((JavaLangStringBuilder *) nil_chk(self->codeBeginPic_)) appendWithNSString:@"/* draws axes; NoZero hides '0' label */ "];
  OrgGeogebraCommonExportPstricksGeoGebraToAsymptote_drawArrowsWithInt_withBoolean_(self, axisStyle, axisBold);
}
...
void OrgGeogebraCommonExportPstricksGeoGebraToAsymptote_drawArrowsWithInt_withBoolean_(OrgGeogebraCommonExportPstricksGeoGebraToAsymptote *self, jint axisStyle, jboolean axisBold) {
  ...
  if (axisRightArrow && axisLeftArrow) {
    ...
    (void) [self->codeBeginPic_ insertWithInt:[((JavaLangStringBuilder *) nil_chk(self->codeBeginPic_)) indexOfWithNSString:@"above"] - 1 withNSString:arrow];
    (void) [self->codeBeginPic_ insertWithInt:[self->codeBeginPic_ lastIndexOfWithNSString:@"above"] - 1 withNSString:arrow];
  }
  else {
    if (axisRightArrow) {
...
void OrgGeogebraCommonExportPstricksGeoGebraToAsymptote_PointOptionCodeWithOrgGeogebraCommonKernelGeosGeoPoint_withJavaLangStringBuilder_withDouble_(OrgGeogebraCommonExportPstricksGeoGebraToAsymptote *self, OrgGeogebraCommonKernelGeosGeoPoint *geo, JavaLangStringBuilder *sb, jdouble dotsize) {
  ...
  if (dotsize != OrgGeogebraCommonPluginEuclidianStyleConstants_DEFAULT_POINT_SIZE) {
    comma = YES;
    (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@",linewidth("];
    (void) [sb appendWithNSString:[self formatWithDouble:dotsize]];
  ...
  if (![((OrgGeogebraCommonAwtGColor *) nil_chk(dotcolor)) isEqual:OrgGeogebraCommonAwtGColor_get_BLACK_()] && [((id<OrgGeogebraCommonExportPstricksExportSettings>) nil_chk(self->frame_)) getKeepDotColors]) {
    if (comma) [self packSpaceWithJavaLangStringBuilder:sb withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"+" } count:1 type:NSString_class_()]];
    else (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@","];
    comma = YES;
    ...
    comma = YES;
    if (!self->compact_) (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"dotstyle"];
    else if (!self->compactcse5_) (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"ds"];
  }
  if (dotstyle != OrgGeogebraCommonPluginEuclidianStyleConstants_POINT_STYLE_DOT) {
    if (comma) [self packSpaceWithJavaLangStringBuilder:sb withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"+" } count:1 type:NSString_class_()]];
    else (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@","];
    comma = YES;
    (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"invisible"];
  }
}
...
NSString *OrgGeogebraCommonExportPstricksGeoGebraToAsymptote_LineOptionCodeWithOrgGeogebraCommonKernelGeosGeoElement_withBoolean_(OrgGeogebraCommonExportPstricksGeoGebraToAsymptote *self, OrgGeogebraCommonKernelGeosGeoElement *geo, jboolean transparency) {
  ...
  if (linestyle != OrgGeogebraCommonPluginEuclidianStyleConstants_DEFAULT_LINE_TYPE) {
    if (!noPlus) [self packSpaceWithJavaLangStringBuilder:sb withNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ @"+" } count:1 type:NSString_class_()]];
    else noPlus = NO;
    OrgGeogebraCommonExportPstricksGeoGebraToAsymptote_LinestyleCodeWithInt_withJavaLangStringBuilder_(linestyle, sb);
  }
...
void OrgGeogebraCommonExportPstricksGeoGebraToAsymptote_LinestyleCodeWithInt_withJavaLangStringBuilder_(jint linestyle, JavaLangStringBuilder *sb) {
  OrgGeogebraCommonExportPstricksGeoGebraToAsymptote_initialize();
  {
    ...
    switch (linestyle) {
      case OrgGeogebraCommonPluginEuclidianStyleConstants_LINE_TYPE_DOTTED:
      (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"dotted"];
      break;
      case OrgGeogebraCommonPluginEuclidianStyleConstants_LINE_TYPE_DASHED_SHORT:
      (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"linetype(\""];
      size = 2;
...
void OrgGeogebraCommonExportPstricksGeoGebraToAsymptote_addTextWithNSString_withBoolean_withInt_(OrgGeogebraCommonExportPstricksGeoGebraToAsymptote *self, NSString *st, jboolean isLatex, jint style) {
  if (isLatex) (void) [((JavaLangStringBuilder *) nil_chk(self->code_)) appendWithNSString:@"$"];
  ...
  (void) [((JavaLangStringBuilder *) nil_chk(self->code_)) appendWithNSString:[st substring:0 endIndex:((jint) [((NSString *) nil_chk(st)) length]) - 1]];
  if (!isLatex || [st charAtWithInt:((jint) [st length]) - 1] != '$') (void) [self->code_ appendWithChar:[st charAtWithInt:((jint) [st length]) - 1]];
  switch (style) {
    case 1:
    case 2:
  ...
  if (isLatex) (void) [self->code_ appendWithNSString:@"$"];
}
...
NSString *OrgGeogebraCommonExportPstricksGeoGebraToAsymptote_killSpaceWithNSString_(NSString *name) {
  ...
  for (jint i = 0; i < ((jint) [((NSString *) nil_chk(name)) length]); i++) {
    ...
    if ([@"*/+-" indexOf:c] != -1) {
      ...
      if (space) (void) [sb appendWithNSString:@"*"];
      (void) [sb appendWithChar:c];
      space = NO;
      operand = NO;
    }
  ...
  OrgGeogebraCommonExportPstricksGeoGebraToAsymptote_renameFuncWithJavaLangStringBuilder_withNSString_withNSString_(sb, @"\u03c8", @"psi");
  OrgGeogebraCommonExportPstricksGeoGebraToAsymptote_renameFuncWithJavaLangStringBuilder_withNSString_withNSString_(sb, @"\u03c9", @"omega");
  IOSObjectArray *greekalpha = [IOSObjectArray newArrayWithObjects:(id[]){ @"alpha", @"beta", @"gamma", @"delta", @"epsilon", @"zeta", @"eta", @"theta", @"iota", @"kappa", @"lambda", @"mu", @"xi", @"pi", @"rho", @"varsigma", @"sigma", @"tau", @"upsilon", @"varphi", @"chi", @"psi", @"omega" } count:23 type:NSString_class_()];
