...
void OrgGeogebraCommonAwtGColor_initColorsWithOrgGeogebraCommonFactoriesAwtFactory_(OrgGeogebraCommonFactoriesAwtFactory *f) {
  ...
  JreStrongAssign(&OrgGeogebraCommonAwtGColor_WHITE_, nil, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(f)) newColorWithInt:255 withInt:255 withInt:255]);
  JreStrongAssign(&OrgGeogebraCommonAwtGColor_BLACK_, nil, [f newColorWithInt:0 withInt:0 withInt:0]);
  JreStrongAssign(&OrgGeogebraCommonAwtGColor_RED_, nil, [f newColorWithInt:255 withInt:0 withInt:0]);
  JreStrongAssign(&OrgGeogebraCommonAwtGColor_ORANGE_, nil, [f newColorWithInt:255 withInt:127 withInt:0]);
  JreStrongAssign(&OrgGeogebraCommonAwtGColor_YELLOW_, nil, [f newColorWithInt:255 withInt:255 withInt:0]);
  JreStrongAssign(&OrgGeogebraCommonAwtGColor_GREEN_, nil, [f newColorWithInt:0 withInt:255 withInt:0]);
  JreStrongAssign(&OrgGeogebraCommonAwtGColor_BLUE_, nil, [f newColorWithInt:0 withInt:0 withInt:255]);
  JreStrongAssign(&OrgGeogebraCommonAwtGColor_CYAN_, nil, [f newColorWithInt:0 withInt:255 withInt:255]);
  JreStrongAssign(&OrgGeogebraCommonAwtGColor_DARK_CYAN_, nil, [f newColorWithInt:99 withInt:219 withInt:219]);
  JreStrongAssign(&OrgGeogebraCommonAwtGColor_DARK_GREEN_, nil, [f newColorWithInt:0 withInt:127 withInt:0]);
  JreStrongAssign(&OrgGeogebraCommonAwtGColor_MAGENTA_, nil, [f newColorWithInt:255 withInt:0 withInt:255]);
  JreStrongAssign(&OrgGeogebraCommonAwtGColor_LIGHT_GRAY_, nil, [f newColorWithInt:192 withInt:192 withInt:192]);
  JreStrongAssign(&OrgGeogebraCommonAwtGColor_GRAY_, nil, [f newColorWithInt:128 withInt:128 withInt:128]);
  JreStrongAssign(&OrgGeogebraCommonAwtGColor_DARK_GRAY_, nil, [f newColorWithInt:68 withInt:68 withInt:68]);
}
