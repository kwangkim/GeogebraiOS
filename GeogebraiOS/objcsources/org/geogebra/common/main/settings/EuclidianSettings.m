...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/main/settings/EuclidianSettings.java
//
...
- (void)resetNoFire {
  OrgGeogebraCommonMainSettingsEuclidianSettings_set_gridDistances_(self, nil);
  OrgGeogebraCommonMainSettingsEuclidianSettings_setAndConsume_axisNumberingDistances_(self, [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ JavaLangDouble_NaN, JavaLangDouble_NaN, JavaLangDouble_NaN } count:3]);
  OrgGeogebraCommonMainSettingsEuclidianSettings_set_xminObject_(self, nil);
  OrgGeogebraCommonMainSettingsEuclidianSettings_set_xmaxObject_(self, nil);
  OrgGeogebraCommonMainSettingsEuclidianSettings_set_yminObject_(self, nil);
  OrgGeogebraCommonMainSettingsEuclidianSettings_set_ymaxObject_(self, nil);
...
- (void)setBackgroundWithOrgGeogebraCommonAwtGColor:(OrgGeogebraCommonAwtGColor *)col {
  if (![((OrgGeogebraCommonAwtGColor *) nil_chk(col)) isEqual:backgroundColor_]) {
    OrgGeogebraCommonMainSettingsEuclidianSettings_set_backgroundColor_(self, col);
    [self settingChanged];
  }
}
...
- (void)setAxesColorWithOrgGeogebraCommonAwtGColor:(OrgGeogebraCommonAwtGColor *)col {
  if (![((OrgGeogebraCommonAwtGColor *) nil_chk(col)) isEqual:axesColor_]) {
    OrgGeogebraCommonMainSettingsEuclidianSettings_set_axesColor_(self, col);
    [self settingChanged];
  }
}
...
- (void)setGridColorWithOrgGeogebraCommonAwtGColor:(OrgGeogebraCommonAwtGColor *)col {
  if (![((OrgGeogebraCommonAwtGColor *) nil_chk(col)) isEqual:gridColor_]) {
    OrgGeogebraCommonMainSettingsEuclidianSettings_set_gridColor_(self, col);
    [self settingChanged];
  }
}
...
- (void)setGridDistancesWithDoubleArray:(IOSDoubleArray *)dists {
  ...
  if (changed) {
    OrgGeogebraCommonMainSettingsEuclidianSettings_set_gridDistances_(self, dists);
    if (dists == nil) {
...
- (void)setAxesUnitLabelsWithNSStringArray:(IOSObjectArray *)axesUnitLabels {
  OrgGeogebraCommonMainSettingsEuclidianSettings_set_axesUnitLabels_(self, axesUnitLabels);
  for (jint i = 0; i < 2; i++) {
...
- (void)setXminObjectWithOrgGeogebraCommonKernelArithmeticNumberValue:(id<OrgGeogebraCommonKernelArithmeticNumberValue>)xminObjectNew
                                                          withBoolean:(jboolean)callsc {
  OrgGeogebraCommonMainSettingsEuclidianSettings_set_xminObject_(self, xminObjectNew);
  if (callsc) {
    [self settingChanged];
  }
}
...
- (void)setXmaxObjectWithOrgGeogebraCommonKernelArithmeticNumberValue:(id<OrgGeogebraCommonKernelArithmeticNumberValue>)xmaxObjectNew
                                                          withBoolean:(jboolean)callsc {
  OrgGeogebraCommonMainSettingsEuclidianSettings_set_xmaxObject_(self, xmaxObjectNew);
  if (callsc) {
    [self settingChanged];
  }
}
...
- (void)setYminObjectWithOrgGeogebraCommonKernelArithmeticNumberValue:(id<OrgGeogebraCommonKernelArithmeticNumberValue>)yminObjectNew
                                                          withBoolean:(jboolean)callsc {
  OrgGeogebraCommonMainSettingsEuclidianSettings_set_yminObject_(self, yminObjectNew);
  if (callsc) {
    [self settingChanged];
  }
}
...
- (void)setYmaxObjectWithOrgGeogebraCommonKernelArithmeticNumberValue:(id<OrgGeogebraCommonKernelArithmeticNumberValue>)ymaxObjectNew
                                                          withBoolean:(jboolean)callsc {
  OrgGeogebraCommonMainSettingsEuclidianSettings_set_ymaxObject_(self, ymaxObjectNew);
  if (callsc) {
    [self settingChanged];
  }
}
...
- (void)setPreferredSizeWithOrgGeogebraCommonAwtGDimension:(OrgGeogebraCommonAwtGDimension *)dimension {
  OrgGeogebraCommonMainSettingsEuclidianSettings_set_preferredSize_(self, dimension);
  [self settingChanged];
}
...
- (void)setLockedAxesRatioWithDouble:(jdouble)ratio {
  ...
  OrgGeogebraCommonMainSettingsEuclidianSettings_set_lockedAxesRatio_(self, JavaLangDouble_valueOfWithDouble_(ratio));
  [self settingChanged];
}
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonMainSettingsEuclidianSettings class]) {
    JreStrongAssignAndConsume(&OrgGeogebraCommonMainSettingsEuclidianSettings_DELETE_SIZES_, nil, [IOSIntArray newArrayWithInts:(jint[]){ 20, 40, 80 } count:3]);
...
void OrgGeogebraCommonMainSettingsEuclidianSettings_initWithOrgGeogebraCommonMainSettingsEuclidianSettings_(OrgGeogebraCommonMainSettingsEuclidianSettings *self, OrgGeogebraCommonMainSettingsEuclidianSettings *euclidianSettings1) {
  ...
  OrgGeogebraCommonMainSettingsEuclidianSettings_set_gridDistances_(self, nil);
  OrgGeogebraCommonMainSettingsEuclidianSettings_setAndConsume_axisCross_(self, [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 0, 0, 0 } count:3]);
  OrgGeogebraCommonMainSettingsEuclidianSettings_setAndConsume_positiveAxes_(self, [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ NO, NO, NO } count:3]);
  OrgGeogebraCommonMainSettingsEuclidianSettings_setAndConsume_drawBorderAxes_(self, [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ NO, NO, NO } count:3]);
  self->tooltipsInThisView_ = OrgGeogebraCommonPluginEuclidianStyleConstants_TOOLTIPS_AUTOMATIC;
  OrgGeogebraCommonMainSettingsEuclidianSettings_setAndConsume_showAxes_(self, [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ YES, YES, YES } count:3]);
  OrgGeogebraCommonMainSettingsEuclidianSettings_setAndConsume_showAxesNumbers_(self, [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ YES, YES, YES } count:3]);
  OrgGeogebraCommonMainSettingsEuclidianSettings_setAndConsume_axesLabels_(self, [IOSObjectArray newArrayWithObjects:(id[]){ nil, nil, nil } count:3 type:NSString_class_()]);
  OrgGeogebraCommonMainSettingsEuclidianSettings_setAndConsume_axesUnitLabels_(self, [IOSObjectArray newArrayWithObjects:(id[]){ nil, nil, nil } count:3 type:NSString_class_()]);
  OrgGeogebraCommonMainSettingsEuclidianSettings_setAndConsume_piAxisUnit_(self, [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ NO, NO, NO } count:3]);
  OrgGeogebraCommonMainSettingsEuclidianSettings_setAndConsume_axesTickStyles_(self, [IOSIntArray newArrayWithInts:(jint[]){ OrgGeogebraCommonPluginEuclidianStyleConstants_AXES_TICK_STYLE_MAJOR, OrgGeogebraCommonPluginEuclidianStyleConstants_AXES_TICK_STYLE_MAJOR, OrgGeogebraCommonPluginEuclidianStyleConstants_AXES_TICK_STYLE_MAJOR } count:3]);
  OrgGeogebraCommonMainSettingsEuclidianSettings_setAndConsume_automaticAxesNumberingDistances_(self, [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ YES, YES, YES } count:3]);
  OrgGeogebraCommonMainSettingsEuclidianSettings_setAndConsume_axisNumberingDistances_(self, [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ JavaLangDouble_NaN, JavaLangDouble_NaN, JavaLangDouble_NaN } count:3]);
  ...
  OrgGeogebraCommonMainSettingsEuclidianSettings_set_lockedAxesRatio_(self, nil);
  ...
  OrgGeogebraCommonMainSettingsEuclidianSettings_set_preferredSize_(self, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newDimensionWithInt:0 withInt:0]);
  [self resetNoFire];
}
