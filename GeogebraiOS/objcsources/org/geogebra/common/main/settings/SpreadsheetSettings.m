...
- (JavaUtilHashMap *)getWidthMap {
  if (widthMap_ == nil) OrgGeogebraCommonMainSettingsSpreadsheetSettings_setAndConsume_widthMap_(self, new_JavaUtilHashMap_init());
  return widthMap_;
}
...
- (JavaUtilHashMap *)getHeightMap {
  if (heightMap_ == nil) OrgGeogebraCommonMainSettingsSpreadsheetSettings_setAndConsume_heightMap_(self, new_JavaUtilHashMap_init());
  return heightMap_;
}
...
- (void)setCellFormatWithNSString:(NSString *)cellFormat {
  ...
  OrgGeogebraCommonMainSettingsSpreadsheetSettings_set_cellFormat__(self, cellFormat);
  [self settingChanged];
}
...
- (void)setScrollPositionWithOrgGeogebraCommonAwtGPoint:(OrgGeogebraCommonAwtGPoint *)scrollPosition {
  if (self->scrollPosition__ == nil || ![self->scrollPosition__ isEqual:scrollPosition]) {
    OrgGeogebraCommonMainSettingsSpreadsheetSettings_set_scrollPosition__(self, scrollPosition);
    [self settingChanged];
  }
}
...
- (void)setSelectedCellWithOrgGeogebraCommonAwtGPoint:(OrgGeogebraCommonAwtGPoint *)selectedCell {
  if (self->selectedCell__ == nil || ![self->selectedCell__ isEqual:selectedCell]) {
    OrgGeogebraCommonMainSettingsSpreadsheetSettings_set_selectedCell__(self, selectedCell);
    [self settingChanged];
  }
}
...
- (void)setPreferredSizeWithOrgGeogebraCommonAwtGDimension:(OrgGeogebraCommonAwtGDimension *)preferredSize {
  if (self->preferredSize__ == nil || ![self->preferredSize__ isEqual:preferredSize]) {
    OrgGeogebraCommonMainSettingsSpreadsheetSettings_set_preferredSize__(self, preferredSize);
    [self settingChanged];
  }
}
...
void OrgGeogebraCommonMainSettingsSpreadsheetSettings_initWithJavaUtilLinkedList_(OrgGeogebraCommonMainSettingsSpreadsheetSettings *self, JavaUtilLinkedList *listeners) {
  ...
  OrgGeogebraCommonMainSettingsSpreadsheetSettings_setAndConsume_scrollPosition__(self, new_OrgGeogebraCommonAwtGPoint_initWithInt_withInt_(0, 0));
  OrgGeogebraCommonMainSettingsSpreadsheetSettings_setAndConsume_selectedCell__(self, new_OrgGeogebraCommonAwtGPoint_initWithInt_withInt_(0, 0));
  OrgGeogebraCommonMainSettingsSpreadsheetSettings_set_preferredSize__(self, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newDimensionWithInt:0 withInt:0]);
}
