...
- (OrgGeogebraCommonKernelKernel *)newKernel {
  return [new_OrgGeogebraCommonKernelKernel_initWithOrgGeogebraCommonMainApp_(app_) autorelease];
}
...
- (OrgGeogebraCommonMainSettingsSettings *)newSettings {
  return [new_OrgGeogebraCommonMainSettingsSettings_initWithInt_(2) autorelease];
}
...
void OrgGeogebraCommonMainAppCompanion_initWithOrgGeogebraCommonMainApp_(OrgGeogebraCommonMainAppCompanion *self, OrgGeogebraCommonMainApp *app) {
  NSObject_init(self);
  OrgGeogebraCommonMainAppCompanion_set_app_(self, app);
}
