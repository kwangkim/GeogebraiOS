...
- (OrgGeogebraCommonUtilLowerCaseDictionary *)newLowerCaseDictionary {
  return new_OrgGeogebraCommonUtilLowerCaseDictionary_initWithOrgGeogebraCommonUtilNormalizerMinimal_(new_OrgGeogebraCommonUtilNormalizerMinimal_init());
}
...
- (void)fillCasCommandDict {
  ...
  commandDictCAS_ = [self newLowerCaseDictionary];
...
- (void)fillCommandDict {
  ...
  if (translateCommandTable_ == nil) {
    translateCommandTable_ = new_JavaUtilHashMap_init();
  }
  commandDict_ = [self newLowerCaseDictionary];
  [((JavaUtilHashMap *) nil_chk(translateCommandTable_)) clear];
  if (subCommandDict_ == nil) {
    subCommandDict_ = [IOSObjectArray newArrayWithLength:OrgGeogebraCommonKernelCommandsCommandDispatcher_tableCount type:OrgGeogebraCommonUtilLowerCaseDictionary_class_()];
    for (jint i = 0; i < subCommandDict_->size_; i++) {
      (void) IOSObjectArray_Set(subCommandDict_, i, [self newLowerCaseDictionary]);
    }
  }
  ...
  }
  {
    ...
    while (b__ < e__) {
      ...
      if (local != nil) {
        local = [local trim];
        (void) [translateCommandTable_ putWithId:OrgGeogebraCommonUtilStringUtil_toLowerCaseWithNSString_(local) withId:internal];
...
- (NSString *)getReverseCommandWithNSString:(NSString *)command {
  if ([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) isUsingInternalCommandNames]) {
    @try {
      (void) OrgGeogebraCommonKernelCommandsCommandsEnum_valueOfWithNSString_(command);
      return command;
    }
...
- (void)storeUndoInfoIfSetCoordSystemOccured {
  ...
  storeUndoInfoForSetCoordSystem_ = OrgGeogebraCommonMainApp_StoreUndoInfoForSetCoordSystemEnum_get_NONE();
}
...
- (void)setCoordSystemOccured {
  if (storeUndoInfoForSetCoordSystem_ == OrgGeogebraCommonMainApp_StoreUndoInfoForSetCoordSystemEnum_get_MAY_SET_COORD_SYSTEM()) {
    storeUndoInfoForSetCoordSystem_ = OrgGeogebraCommonMainApp_StoreUndoInfoForSetCoordSystemEnum_get_SET_COORD_SYSTEM_OCCURED();
  }
}
...
- (void)maySetCoordSystem {
  if (storeUndoInfoForSetCoordSystem_ == OrgGeogebraCommonMainApp_StoreUndoInfoForSetCoordSystemEnum_get_NONE()) {
    storeUndoInfoForSetCoordSystem_ = OrgGeogebraCommonMainApp_StoreUndoInfoForSetCoordSystemEnum_get_MAY_SET_COORD_SYSTEM();
  }
}
...
- (OrgGeogebraCommonPluginEventDispatcher *)getEventDispatcher {
  if (eventDispatcher_ == nil) {
    eventDispatcher_ = new_OrgGeogebraCommonPluginEventDispatcher_initWithOrgGeogebraCommonMainApp_(self);
  }
...
- (void)getKeyboardXMLWithJavaLangStringBuilder:(JavaLangStringBuilder *)sb {
  (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"<keyboard width=\""];
  (void) [sb appendWithInt:[((OrgGeogebraCommonMainSettingsKeyboardSettings *) nil_chk([((OrgGeogebraCommonMainSettingsSettings *) nil_chk(OrgGeogebraCommonMainApp_getSettings(self))) getKeyboard])) getKeyboardWidth]];
  (void) [sb appendWithNSString:@"\" height=\""];
  (void) [sb appendWithInt:[((OrgGeogebraCommonMainSettingsKeyboardSettings *) nil_chk([((OrgGeogebraCommonMainSettingsSettings *) nil_chk(OrgGeogebraCommonMainApp_getSettings(self))) getKeyboard])) getKeyboardHeight]];
  (void) [sb appendWithNSString:@"\" opacity=\""];
  (void) [sb appendWithFloat:[((OrgGeogebraCommonMainSettingsKeyboardSettings *) nil_chk([((OrgGeogebraCommonMainSettingsSettings *) nil_chk(OrgGeogebraCommonMainApp_getSettings(self))) getKeyboard])) getKeyboardOpacity]];
  (void) [sb appendWithNSString:@"\" language=\""];
  (void) [sb appendWithNSString:[((OrgGeogebraCommonMainSettingsKeyboardSettings *) nil_chk([((OrgGeogebraCommonMainSettingsSettings *) nil_chk(OrgGeogebraCommonMainApp_getSettings(self))) getKeyboard])) getKeyboardLocale]];
  (void) [sb appendWithNSString:@"\" show=\""];
  (void) [sb appendWithBoolean:[((OrgGeogebraCommonMainSettingsKeyboardSettings *) nil_chk([((OrgGeogebraCommonMainSettingsSettings *) nil_chk(OrgGeogebraCommonMainApp_getSettings(self))) getKeyboard])) isShowKeyboardOnStart]];
...
- (void)setFileVersionWithNSString:(NSString *)version_ {
  ...
  self->version__ = OrgGeogebraCommonMainApp_getSubValuesWithNSString_(version_);
}
...
- (NSString *)getCompleteUserInterfaceXMLWithBoolean:(jboolean)asPreference {
  JavaLangStringBuilder *sb = new_JavaLangStringBuilder_init();
  (void) [sb appendWithNSString:[self getGuiXMLWithBoolean:asPreference]];
...
- (void)initKernel {
  kernel_ = [((OrgGeogebraCommonMainAppCompanion *) nil_chk(companion_)) newKernel];
  (void) [self getSelectionManager];
}

- (void)initEuclidianViews {
  euclidianController_ = [self newEuclidianControllerWithOrgGeogebraCommonKernelKernel:kernel_];
  euclidianView_ = [self newEuclidianViewWithBooleanArray:showAxes_ withBoolean:showGrid_];
...
- (void)setPropertiesViewWithOrgGeogebraCommonGuiViewPropertiesPropertiesView:(OrgGeogebraCommonGuiViewPropertiesPropertiesView *)propertiesView {
  self->propertiesView_ = propertiesView;
}
...
- (NSString *)getGuiXMLWithBoolean:(jboolean)asPreference {
  JavaLangStringBuilder *sb = new_JavaLangStringBuilder_init();
  (void) [sb appendWithNSString:@"<gui>\n"];
  [self getWindowLayoutXMLWithJavaLangStringBuilder:sb withBoolean:asPreference];
  if (asPreference) {
    (void) [sb appendWithNSString:@"\t<mouse reverseWheel=\""];
    (void) [sb appendWithBoolean:[self isMouseWheelReversed]];
    (void) [sb appendWithNSString:@"\"/>\n"];
  }
  (void) [sb appendWithNSString:@"\t<font "];
  (void) [sb appendWithNSString:@" size=\""];
  (void) [sb appendWithInt:[self getFontSize]];
  (void) [sb appendWithNSString:@"\"/>\n"];
  if (asPreference) {
    (void) [sb appendWithNSString:@"\t<menuFont "];
    (void) [sb appendWithNSString:@" size=\""];
    (void) [sb appendWithInt:guiFontSize_];
    (void) [sb appendWithNSString:@"\"/>\n"];
    (void) [sb appendWithNSString:@"\t<tooltipSettings "];
    if ([((OrgGeogebraCommonMainLocalization *) nil_chk([self getLocalization])) getTooltipLanguageString] != nil) {
      (void) [sb appendWithNSString:@" language=\""];
      (void) [sb appendWithNSString:[((OrgGeogebraCommonMainLocalization *) nil_chk([self getLocalization])) getTooltipLanguageString]];
      (void) [sb appendWithNSString:@"\""];
    }
    (void) [sb appendWithNSString:@" timeout=\""];
    (void) [sb appendWithInt:[self getTooltipTimeout]];
    (void) [sb appendWithNSString:@"\""];
    (void) [sb appendWithNSString:@"/>\n"];
  }
  if (!asPreference) {
    (void) [sb appendWithNSString:@"\t<graphicsSettings"];
    (void) [sb appendWithNSString:@" javaLatexFonts=\""];
    (void) [sb appendWithBoolean:[self useJavaFontsForLaTeX]];
    (void) [sb appendWithNSString:@"\"/>\n"];
  }
...
- (void)getWindowLayoutXMLWithJavaLangStringBuilder:(JavaLangStringBuilder *)sb
                                        withBoolean:(jboolean)asPreference {
  (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"\t<window width=\""];
  (void) [sb appendWithNSString:JreStrcat("I", [self getWindowWidth])];
  (void) [sb appendWithNSString:@"\" height=\""];
  (void) [sb appendWithNSString:JreStrcat("I", [self getWindowHeight])];
  (void) [sb appendWithNSString:@"\" />\n"];
  [self getLayoutXMLWithJavaLangStringBuilder:sb withBoolean:asPreference];
  (void) [sb appendWithNSString:@"\t<labelingStyle "];
  (void) [sb appendWithNSString:@" val=\""];
  (void) [sb appendWithInt:[self getLabelingStyle]];
  (void) [sb appendWithNSString:@"\"/>\n"];
}
...
- (void)setShowInputTopWithBoolean:(jboolean)flag
  ...
  showInputTop__ = flag ? OrgGeogebraCommonMainApp_InputPositonEnum_get_top() : OrgGeogebraCommonMainApp_InputPositonEnum_get_bottom();
...
- (void)setRandomSeedWithInt:(jint)seed {
  random_ = new_JavaUtilRandom_initWithLong_(seed);
}
...
- (void)startGeoScriptRunner {
  if (geoScriptRunner_ == nil) {
    geoScriptRunner_ = new_OrgGeogebraCommonPluginGeoScriptRunner_initWithOrgGeogebraCommonMainApp_(self);
...
- (OrgGeogebraCommonGuiMenubarOptionsMenu *)getOptionsMenuWithOrgGeogebraCommonGuiMenubarMenuFactory:(id<OrgGeogebraCommonGuiMenubarMenuFactory>)mf {
  if (optionsMenu_ == nil) {
    optionsMenu_ = new_OrgGeogebraCommonGuiMenubarOptionsMenu_initWithOrgGeogebraCommonMainApp_withOrgGeogebraCommonGuiMenubarMenuFactory_(self, mf);
  }
  return optionsMenu_;
}
...
- (OrgGeogebraCommonMainSelectionManager *)getSelectionManager {
  if (selection_ == nil) {
    selection_ = new_OrgGeogebraCommonMainSelectionManager_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonMainUpdateSelection_(OrgGeogebraCommonMainApp_getKernel(self), self);
  }
  return selection_;
}
...
- (OrgGeogebraCommonMainAppCompanion *)newAppCompanion {
  return new_OrgGeogebraCommonMainAppCompanion_initWithOrgGeogebraCommonMainApp_(self);
}
...
- (void)registerOpenFileListenerWithOrgGeogebraCommonMainOpenFileListener:(id<OrgGeogebraCommonMainOpenFileListener>)o {
  if (openFileListener_ == nil) {
    self->openFileListener_ = new_JavaUtilArrayList_init();
  }
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonMainApp class]) {
    OrgGeogebraCommonMainApp_roundingMenuLookup_ = [IOSIntArray newArrayWithInts:(jint[]){ 0, 1, 2, 3, 4, 5, 10, 15, -1, 3, 5, 10, 15 } count:13];
    OrgGeogebraCommonMainApp_decimalsLookup_ = [IOSIntArray newArrayWithInts:(jint[]){ 0, 1, 2, 3, 4, 5, -1, -1, -1, -1, 6, -1, -1, -1, -1, 7 } count:16];
    OrgGeogebraCommonMainApp_figuresLookup_ = [IOSIntArray newArrayWithInts:(jint[]){ -1, -1, -1, 9, -1, 10, -1, -1, -1, -1, 11, -1, -1, -1, -1, 12 } count:16];
    OrgGeogebraCommonMainApp_strDecimalSpacesAC_ = [IOSObjectArray newArrayWithObjects:(id[]){ @"0 decimals", @"1 decimals", @"2 decimals", @"3 decimals", @"4 decimals", @"5 decimals", @"10 decimals", @"15 decimals", @"", @"3 figures", @"5 figures", @"10 figures", @"15 figures" } count:13 type:NSString_class_()];
...
void OrgGeogebraCommonMainApp_setCASVersionStringWithNSString_(NSString *string) {
  ...
  OrgGeogebraCommonMainApp_CASVersionString_ = string;
}
...
void OrgGeogebraCommonMainApp_putInTranslateCommandTableWithOrgGeogebraCommonKernelCommandsCommandsEnum_withNSString_(OrgGeogebraCommonMainApp *self, OrgGeogebraCommonKernelCommandsCommandsEnum *comm, NSString *local) {
  ...
  if (![((JavaUtilHashMap *) nil_chk(self->translateCommandTable_)) containsKeyWithId:OrgGeogebraCommonUtilStringUtil_toLowerCaseWithNSString_(internal)]) {
    (void) [self->translateCommandTable_ putWithId:OrgGeogebraCommonUtilStringUtil_toLowerCaseWithNSString_(internal) withId:[((OrgGeogebraCommonKernelCommandsCommandsEnum *) nil_chk(OrgGeogebraCommonKernelCommandsCommandsEnum_englishToInternalWithOrgGeogebraCommonKernelCommandsCommandsEnum_(comm))) name]];
  }
  if ([comm getTable] == OrgGeogebraCommonKernelCommandsCommandsConstants_TABLE_ENGLISH) {
    return;
  }
  if (local != nil) {
    (void) [self->translateCommandTable_ putWithId:OrgGeogebraCommonUtilStringUtil_toLowerCaseWithNSString_(local) withId:[((OrgGeogebraCommonKernelCommandsCommandsEnum *) nil_chk(OrgGeogebraCommonKernelCommandsCommandsEnum_englishToInternalWithOrgGeogebraCommonKernelCommandsCommandsEnum_(comm))) name]];
  }
}
...
void OrgGeogebraCommonMainApp_printStacktraceWithId_(id message) {
  ...
  @try {
    @throw new_JavaLangException_initWithNSString_(message == nil ? @"null" : [message description]);
  }
  @catch (JavaLangException *e) {
    [((JavaLangException *) nil_chk(e)) printStackTrace];
  }
...
void OrgGeogebraCommonMainApp_initializeSingularWS() {
  OrgGeogebraCommonMainApp_initialize();
  OrgGeogebraCommonMainApp_singularWS_ = new_OrgGeogebraCommonCasSingularwsSingularWebService_init();
...
IOSIntArray *OrgGeogebraCommonMainApp_getSubValuesWithNSString_(NSString *version_) {
  ...
  IOSIntArray *ret = [IOSIntArray newArrayWithLength:((IOSObjectArray *) nil_chk(values))->size_];
...
void OrgGeogebraCommonMainApp_getScriptingXMLWithJavaLangStringBuilder_withBoolean_(OrgGeogebraCommonMainApp *self, JavaLangStringBuilder *sb, jboolean asPreference) {
  (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"<scripting"];
  if ([self getScriptingLanguage] != nil) {
    (void) [sb appendWithNSString:@" language=\""];
    (void) [sb appendWithNSString:[self getScriptingLanguage]];
    (void) [sb appendWithNSString:@"\""];
  }
  (void) [sb appendWithNSString:@" blocked=\""];
  (void) [sb appendWithBoolean:[self isBlockUpdateScripts]];
  if (!asPreference) {
    (void) [sb appendWithNSString:@"\" disabled=\""];
    (void) [sb appendWithBoolean:[self isScriptingDisabled]];
  }
  (void) [sb appendWithNSString:@"\"/>\n"];
}
...
OrgGeogebraCommonMainSpreadsheetTraceManager *OrgGeogebraCommonMainApp_getTraceManager(OrgGeogebraCommonMainApp *self) {
  if (self->traceManager_ == nil) self->traceManager_ = new_OrgGeogebraCommonMainSpreadsheetTraceManager_initWithOrgGeogebraCommonMainApp_(self);
...
void OrgGeogebraCommonMainApp_init(OrgGeogebraCommonMainApp *self) {
  ...
  self->scriptManager_ = nil;
  self->isSaved__ = YES;
  self->showResetIcon__ = NO;
  self->runningInFrame_ = NO;
  self->pf_ = new_OrgGeogebraCommonKernelParserCashandlersParserFunctions_init();
  ...
  self->images_ = new_JavaUtilVector_init();
  self->showInputTop__ = OrgGeogebraCommonMainApp_InputPositonEnum_get_algebraView();
  ...
  self->kimberlingw_ = nil;
  self->cubicw_ = nil;
  self->storeUndoInfoForSetCoordSystem_ = OrgGeogebraCommonMainApp_StoreUndoInfoForSetCoordSystemEnum_get_NONE();
  self->blockUpdateScripts_ = NO;
  self->useBrowserForJavaScript__ = YES;
  self->version__ = nil;
  self->savedListeners_ = new_JavaUtilArrayList_init();
  ...
  self->tmpPerspectives_ = new_JavaUtilArrayList_init();
  ...
  self->tubeID_ = 0;
  self->companion_ = [self newAppCompanion];
}
