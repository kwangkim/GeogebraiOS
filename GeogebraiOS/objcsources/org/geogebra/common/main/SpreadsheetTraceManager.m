...
- (jboolean)isTraceColumnWithInt:(jint)column {
  OrgGeogebraCommonUtilSpreadsheetTraceSettings *t = [new_OrgGeogebraCommonUtilSpreadsheetTraceSettings_init() autorelease];
...
- (OrgGeogebraCommonUtilSpreadsheetTraceSettings *)getDefaultTraceSettings {
  return [new_OrgGeogebraCommonUtilSpreadsheetTraceSettings_init() autorelease];
}
...
- (NSString *)getTraceXMLWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  ...
  [sb appendWithInt:((OrgGeogebraCommonUtilSpreadsheetTraceSettings *) nil_chk(t))->traceColumn1_];
...
- (void)setTraceCellWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)cons
  ...
  if (isUpdateCell) {
    ...
    switch ([geoClassType ordinal]) {
      case OrgGeogebraCommonPluginGeoClass_NUMERIC:
      cell = [new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withNSString_withDouble_(cons, cellName, [((JavaLangDouble *) nil_chk((JavaLangDouble *) check_class_cast(value, [JavaLangDouble class]))) doubleValue]) autorelease];
      break;
      case OrgGeogebraCommonPluginGeoClass_ANGLE:
      cell = [new_OrgGeogebraCommonKernelGeosGeoAngle_initWithOrgGeogebraCommonKernelConstruction_withNSString_withDouble_(cons, cellName, [((JavaLangDouble *) nil_chk((JavaLangDouble *) check_class_cast(value, [JavaLangDouble class]))) doubleValue]) autorelease];
      break;
      case OrgGeogebraCommonPluginGeoClass_TEXT:
      cell = [new_OrgGeogebraCommonKernelGeosGeoText_initWithOrgGeogebraCommonKernelConstruction_withNSString_withNSString_(cons, cellName, (NSString *) check_class_cast(value, [NSString class])) autorelease];
      break;
    }
...
void OrgGeogebraCommonMainSpreadsheetTraceManager_initWithOrgGeogebraCommonMainApp_(OrgGeogebraCommonMainSpreadsheetTraceManager *self, OrgGeogebraCommonMainApp *app) {
  ...
  OrgGeogebraCommonMainSpreadsheetTraceManager_setAndConsume_coords_(self, [IOSDoubleArray newArrayWithLength:3]);
  OrgGeogebraCommonMainSpreadsheetTraceManager_set_app_(self, app);
  OrgGeogebraCommonMainSpreadsheetTraceManager_set_kernel_(self, [((OrgGeogebraCommonMainApp *) nil_chk(app)) getKernel]);
  OrgGeogebraCommonMainSpreadsheetTraceManager_setAndConsume_traceGeoCollection_(self, new_JavaUtilHashMap_init());
  OrgGeogebraCommonMainSpreadsheetTraceManager_setAndConsume_storedTraces_(self, new_JavaUtilHashSet_init());
}
...
void OrgGeogebraCommonMainSpreadsheetTraceManager_createTraceListCellWithOrgGeogebraCommonKernelConstruction_withInt_withInt_(OrgGeogebraCommonMainSpreadsheetTraceManager *self, OrgGeogebraCommonKernelConstruction *cons, jint column, jint row) {
  ...
  @try {
    cell = [new_OrgGeogebraCommonKernelGeosGeoList_initWithOrgGeogebraCommonKernelConstruction_(cons) autorelease];
