...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/main/DialogManager.java
//
...
- (void)showRedefineDialogWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo
  ...
  id<OrgGeogebraCommonGuiInputHandler> handler = [new_OrgGeogebraCommonGuiDialogHandlerRedefineInputHandler_initWithOrgGeogebraCommonMainApp_withOrgGeogebraCommonKernelGeosGeoElement_withNSString_(app_, geo, str) autorelease];
  [self newInputDialogWithOrgGeogebraCommonMainApp:app_ withNSString:[geo getNameDescription] withNSString:[((OrgGeogebraCommonMainApp *) nil_chk(app_)) getPlainWithNSString:@"Redefine"] withNSString:str withBoolean:YES withOrgGeogebraCommonGuiInputHandler:handler withOrgGeogebraCommonKernelGeosGeoElement:geo];
}
...
withOrgGeogebraCommonEuclidianEuclidianController:(OrgGeogebraCommonEuclidianEuclidianController *)ec {
  ...
  OrgGeogebraCommonMainDialogManager_set_defaultAngle_(self, OrgGeogebraCommonMainDialogManager_rotateObjectWithOrgGeogebraCommonMainApp_withNSString_withBoolean_withOrgGeogebraCommonKernelGeosGeoPolygonArray_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_withOrgGeogebraCommonKernelGeosGeoElementArray_withOrgGeogebraCommonEuclidianEuclidianController_(app_, inputString, NO, selectedPolygons, selectedPoints, selGeos, ec));
}
...
- (void)showTextDialogWithOrgGeogebraCommonKernelGeosGeoText:(OrgGeogebraCommonKernelGeosGeoText *)text
  ...
  if (textInputDialog_ == nil) {
    OrgGeogebraCommonMainDialogManager_set_textInputDialog_(self, [self createTextDialogWithOrgGeogebraCommonKernelGeosGeoText:text withOrgGeogebraCommonKernelKernelNDGeoPointND:startPoint withBoolean:rw]);
  }
  else {
...
void OrgGeogebraCommonMainDialogManager_init(OrgGeogebraCommonMainDialogManager *self) {
  NSObject_init(self);
  OrgGeogebraCommonMainDialogManager_set_defaultAngle_(self, OrgGeogebraCommonUtilUnicode_get_FORTY_FIVE_DEGREES_());
}
...
void OrgGeogebraCommonMainDialogManager_initWithOrgGeogebraCommonMainApp_(OrgGeogebraCommonMainDialogManager *self, OrgGeogebraCommonMainApp *app) {
  NSObject_init(self);
  OrgGeogebraCommonMainDialogManager_set_defaultAngle_(self, OrgGeogebraCommonUtilUnicode_get_FORTY_FIVE_DEGREES_());
  OrgGeogebraCommonMainDialogManager_set_app_(self, app);
}
...
jboolean OrgGeogebraCommonMainDialogManager_makeRegularPolygonWithOrgGeogebraCommonMainApp_withOrgGeogebraCommonEuclidianEuclidianController_withNSString_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_(OrgGeogebraCommonMainApp *app, OrgGeogebraCommonEuclidianEuclidianController *ec, NSString *inputString, id<OrgGeogebraCommonKernelKernelNDGeoPointND> geoPoint1, id<OrgGeogebraCommonKernelKernelNDGeoPointND> geoPoint2) {
  ...
  IOSObjectArray *onlypoly = [IOSObjectArray arrayWithObjects:(id[]){ nil } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
  if (geos != nil) {
...
void OrgGeogebraCommonMainDialogManager_doSegmentFixedWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelArithmeticNumberValue_(OrgGeogebraCommonKernelKernel *kernel, id<OrgGeogebraCommonKernelKernelNDGeoPointND> geoPoint1, id<OrgGeogebraCommonKernelArithmeticNumberValue> num) {
  ...
  IOSObjectArray *onlysegment = [IOSObjectArray arrayWithObjects:(id[]){ nil } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
  if (segment != nil) {
