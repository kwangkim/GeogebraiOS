...
- (void)unregisterCellRangeListenerAlgoWithOrgGeogebraCommonKernelStatisticsAlgoCellRange:(OrgGeogebraCommonKernelStatisticsAlgoCellRange *)algo {
  if (algos_ != nil) {
    [algos_ removeWithId:OrgGeogebraCommonMainAlgoCellRangeManager_getKeyWithNSString_withNSString_([((OrgGeogebraCommonKernelStatisticsAlgoCellRange *) nil_chk(algo)) getStart], [algo getEnd])];
  }
}
...
- (OrgGeogebraCommonKernelStatisticsAlgoCellRange *)getAlgoCellRangeWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)cons
                                                                                               ...
                                                                                               withNSString:(NSString *)end {
  if (algos_ == nil) {
    OrgGeogebraCommonMainAlgoCellRangeManager_setAndConsume_algos_(self, new_JavaUtilHashMap_init());
  }
  ...
  if (algo == nil) {
    algo = [new_OrgGeogebraCommonKernelStatisticsAlgoCellRange_initWithOrgGeogebraCommonKernelConstruction_withNSString_withNSString_withNSString_(cons, label, start, end) autorelease];
