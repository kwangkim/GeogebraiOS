...
void OrgGeogebraCommonMainSelectionManager_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonMainUpdateSelection_(OrgGeogebraCommonMainSelectionManager *self, OrgGeogebraCommonKernelKernel *kernel, id<OrgGeogebraCommonMainUpdateSelection> app) {
  NSObject_init(self);
  OrgGeogebraCommonMainSelectionManager_setAndConsume_selectedGeos_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonMainSelectionManager_set_kernel_(self, kernel);
  OrgGeogebraCommonMainSelectionManager_set_listener_(self, app);
  OrgGeogebraCommonMainSelectionManager_setAndConsume_selectionListeners_(self, new_JavaUtilArrayList_init());
}
