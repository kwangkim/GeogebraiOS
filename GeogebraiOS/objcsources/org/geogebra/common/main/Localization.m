...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/main/Localization.java
//
...
- (IOSObjectArray *)getFontSizeStrings {
  if (fontSizeStrings_ == nil) {
    fontSizeStrings_ = [IOSObjectArray newArrayWithObjects:(id[]){ [self getPlainWithNSString:@"ExtraSmall"], [self getPlainWithNSString:@"VerySmall"], [self getPlainWithNSString:@"Small"], [self getPlainWithNSString:@"Medium"], [self getPlainWithNSString:@"Large"], [self getPlainWithNSString:@"VeryLarge"], [self getPlainWithNSString:@"ExtraLarge"] } count:7 type:NSString_class_()];
  }
...
- (NSString *)getPlainWithNSString:(NSString *)key
  ...
  IOSObjectArray *ss = [IOSObjectArray newArrayWithObjects:(id[]){ arg0, arg1 } count:2 type:NSString_class_()];
...
- (NSString *)getPlainWithNSString:(NSString *)key
  ...
  IOSObjectArray *ss = [IOSObjectArray newArrayWithObjects:(id[]){ arg0, arg1, arg2 } count:3 type:NSString_class_()];
  return OrgGeogebraCommonMainLocalization_getPlainWithNSString_withNSStringArray_(self, key, ss);
}
...
- (NSString *)getPlainWithNSString:(NSString *)key
  ...
  IOSObjectArray *ss = [IOSObjectArray newArrayWithObjects:(id[]){ arg0, arg1, arg2, arg3 } count:4 type:NSString_class_()];
  return OrgGeogebraCommonMainLocalization_getPlainWithNSString_withNSStringArray_(self, key, ss);
}
...
- (NSString *)getPlainWithNSString:(NSString *)key
  ...
  IOSObjectArray *ss = [IOSObjectArray newArrayWithObjects:(id[]){ arg0, arg1, arg2, arg3, arg4 } count:5 type:NSString_class_()];
  return OrgGeogebraCommonMainLocalization_getPlainWithNSString_withNSStringArray_(self, key, ss);
}
...
- (NSString *)getOrdinalNumberWithInt:(jint)n {
  ...
  if (sbOrdinal_ == nil) {
    sbOrdinal_ = new_JavaLangStringBuilder_init();
  }
  else {
    [sbOrdinal_ setLengthWithInt:0];
  }
  if ([@"in" isEqual:lang]) {
    (void) [((JavaLangStringBuilder *) nil_chk(sbOrdinal_)) appendWithNSString:@"ke-"];
  }
  else if ([@"iw" isEqual:lang]) {
    (void) [((JavaLangStringBuilder *) nil_chk(sbOrdinal_)) appendWithNSString:@"\u200f\u200e"];
  }
  (void) [((JavaLangStringBuilder *) nil_chk(sbOrdinal_)) appendWithInt:n];
  if ([@"cs" isEqual:lang] || [@"da" isEqual:lang] || [@"et" isEqual:lang] || [@"eu" isEqual:lang] || [@"hr" isEqual:lang] || [@"hu" isEqual:lang] || [@"is" isEqual:lang] || [@"no" isEqual:lang] || [@"sk" isEqual:lang] || [@"sr" isEqual:lang] || [@"tr" isEqual:lang]) {
    (void) [sbOrdinal_ appendWithChar:'.'];
  }
  else if ([@"de" isEqual:lang]) {
    (void) [sbOrdinal_ appendWithNSString:@"th"];
  }
  else if ([@"fi" isEqual:lang]) {
    (void) [sbOrdinal_ appendWithNSString:@":s"];
  }
  else if ([@"el" isEqual:lang]) {
    (void) [sbOrdinal_ appendWithChar:0x03b7];
  }
  else if ([@"ro" isEqual:lang] || [@"es" isEqual:lang] || [@"it" isEqual:lang] || [@"pt" isEqual:lang]) {
    (void) [sbOrdinal_ appendWithChar:OrgGeogebraCommonUtilUnicode_FEMININE_ORDINAL_INDICATOR];
  }
  else if ([@"bs" isEqual:lang] || [@"sl" isEqual:lang]) {
    (void) [sbOrdinal_ appendWithNSString:@"-ti"];
  }
    ...
    switch (n) {
      ...
      break;
      case 1:
      (void) [sbOrdinal_ appendWithNSString:@"r"];
      break;
      case 2:
      (void) [sbOrdinal_ appendWithNSString:@"n"];
      break;
      case 3:
      (void) [sbOrdinal_ appendWithNSString:@"r"];
      break;
      case 4:
      (void) [sbOrdinal_ appendWithNSString:@"t"];
      break;
      default:
      (void) [sbOrdinal_ appendWithNSString:@"e"];
      break;
    }
  }
  else if ([@"sq" isEqual:lang]) {
    (void) [sbOrdinal_ appendWithNSString:@"-te"];
  }
  else if ([@"gl" isEqual:lang]) {
    (void) [sbOrdinal_ appendWithNSString:@"ava"];
  }
  else if ([@"mk" isEqual:lang]) {
    (void) [sbOrdinal_ appendWithNSString:@"-\u0442\u0438"];
  }
  else if ([@"ka" isEqual:lang]) {
    (void) [sbOrdinal_ appendWithNSString:@"-\u10d4"];
  }
  else if ([@"iw" isEqual:lang]) {
    (void) [sbOrdinal_ appendWithNSString:@"\u200e\u200f"];
  }
  else if ([@"ru" isEqual:lang] || [@"uk" isEqual:lang]) {
    (void) [sbOrdinal_ appendWithNSString:@"-\u0433\u043e"];
  }
  else if ([@"fr" isEqual:lang]) {
    if (n == 1) {
      (void) [sbOrdinal_ appendWithNSString:@"er"];
    }
    else {
      (void) [sbOrdinal_ appendWithNSString:@"e"];
    }
    ...
    if ((unitsDigit == 1) || (unitsDigit == 2)) {
      (void) [sbOrdinal_ appendWithNSString:@":a"];
    }
    else {
      (void) [sbOrdinal_ appendWithNSString:@":e"];
    }
...
void OrgGeogebraCommonMainLocalization_initWithInt_withInt_(OrgGeogebraCommonMainLocalization *self, jint dimension, jint maxFigures) {
  ...
  self->unicodeComma_ = ',';
  self->unicodeZero_ = '0';
  self->sbPlain_ = new_JavaLangStringBuilder_init();
  self->sbOrdinal_ = new_JavaLangStringBuilder_init();
...
NSString *OrgGeogebraCommonMainLocalization_translationFixHuWithNSString_(NSString *inputText) {
  ...
  IOSObjectArray *affixesList = [IOSObjectArray newArrayWithObjects:(id[]){ @"-ra/-re", @"-nak/-nek", @"-ba/-be", @"-ban/-ben", @"-hoz/-hez", @"-val/-vel" } count:6 type:NSString_class_()];
  IOSObjectArray *endE2 = [IOSObjectArray newArrayWithObjects:(id[]){ @"10", @"40", @"50", @"70", @"90" } count:5 type:NSString_class_()];
  IOSObjectArray *endO2 = [IOSObjectArray newArrayWithObjects:(id[]){ @"00", @"20", @"30", @"60", @"80" } count:5 type:NSString_class_()];
  {
  ...
  if ([@"-ra/-re" isEqual:affixes]) {
    ...
    if (((jint) [((NSString *) nil_chk(prevChars)) length]) == 1) {
      ...
      if (index > -1) {
        ...
        IOSObjectArray *valVelTo2 = [IOSObjectArray newArrayWithObjects:(id[]){ @"sz", @"gy", @"gy" } count:3 type:NSString_class_()];
  ...
  for (jint i = 0; i < ((jint) [((NSString *) nil_chk(str)) length]); i++) {
    ...
    if (ch == '%') {
      ...
      if ((pos >= 0) && (pos < ((IOSObjectArray *) nil_chk(args))->size_)) {
        (void) [self->sbPlain_ appendWithNSString:IOSObjectArray_Get(args, pos)];
        found = YES;
      }
      else {
        (void) [self->sbPlain_ appendWithChar:ch];
      }
    }
    else {
      (void) [self->sbPlain_ appendWithChar:ch];
  ...
  if (!found) {
    {
      ...
      while (b__ < e__) {
        NSString *arg = *b__++;
        (void) [self->sbPlain_ appendWithNSString:@" "];
        (void) [self->sbPlain_ appendWithNSString:arg];
      }
    }
  }
...
NSString *OrgGeogebraCommonMainLocalization_getPlainWithNSString_withNSString_(OrgGeogebraCommonMainLocalization *self, NSString *key, NSString *arg0) {
  IOSObjectArray *ss = [IOSObjectArray newArrayWithObjects:(id[]){ arg0 } count:1 type:NSString_class_()];
  return OrgGeogebraCommonMainLocalization_getPlainWithNSString_withNSStringArray_(self, key, ss);
}
