...
- (JavaUtilTreeSet *)getTempSet {
  if (tempSet_ == nil) {
    OrgGeogebraCommonMainGlobalKeyDispatcher_setAndConsume_tempSet_(self, new_JavaUtilTreeSet_init());
  }
  return tempSet_;
}
...
- (jboolean)handleArrowKeyMovementWithJavaUtilArrayList:(JavaUtilArrayList *)geos
  ...
  if (tempVec_ == nil) OrgGeogebraCommonMainGlobalKeyDispatcher_setAndConsume_tempVec_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4));
...
void OrgGeogebraCommonMainGlobalKeyDispatcher_initWithOrgGeogebraCommonMainApp_(OrgGeogebraCommonMainGlobalKeyDispatcher *self, OrgGeogebraCommonMainApp *app2) {
  NSObject_init(self);
  OrgGeogebraCommonMainGlobalKeyDispatcher_set_app_(self, app2);
  OrgGeogebraCommonMainGlobalKeyDispatcher_set_selection_(self, [((OrgGeogebraCommonMainApp *) nil_chk(self->app_)) getSelectionManager]);
}
