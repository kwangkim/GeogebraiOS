...
- (void)addMacroWithOrgGeogebraCommonKernelMacro:(OrgGeogebraCommonKernelMacro *)macro {
  (void) [((JavaUtilHashMap *) nil_chk(macroMap_)) putWithId:OrgGeogebraCommonUtilStringUtil_toLowerCaseWithNSString_([((OrgGeogebraCommonKernelMacro *) nil_chk(macro)) getCommandName]) withId:macro];
...
- (void)removeMacroWithOrgGeogebraCommonKernelMacro:(OrgGeogebraCommonKernelMacro *)macro {
  (void) [((JavaUtilHashMap *) nil_chk(macroMap_)) removeWithId:OrgGeogebraCommonUtilStringUtil_toLowerCaseWithNSString_([((OrgGeogebraCommonKernelMacro *) nil_chk(macro)) getCommandName])];
...
- (void)setMacroCommandNameWithOrgGeogebraCommonKernelMacro:(OrgGeogebraCommonKernelMacro *)macro
  ...
  (void) [macroMap_ putWithId:OrgGeogebraCommonUtilStringUtil_toLowerCaseWithNSString_([macro getCommandName]) withId:macro];
}
...
void OrgGeogebraCommonKernelMacroManager_initWithOrgGeogebraCommonMainApp_(OrgGeogebraCommonKernelMacroManager *self, OrgGeogebraCommonMainApp *app) {
  ...
  self->macroMap_ = new_JavaUtilHashMap_init();
  self->macroList_ = new_JavaUtilArrayList_init();
}
