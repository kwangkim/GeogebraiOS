...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/kernel/prover/AlgoAreConcurrent.java
//
...
- (void)setInputOutput {
  ...
  (void) IOSObjectArray_Set(input_, 2, inputLine3_);
...
- (IOSObjectArray *)getBotanaPolynomials {
  ...
  if (inputLine1_ != nil && inputLine2_ != nil && inputLine3_ != nil) {
    IOSObjectArray *v = [IOSObjectArray newArrayWithDimensions:2 lengths:(jint[]){ 3, 4 } type:OrgGeogebraCommonKernelProverPolynomialVariable_class_()];
    (void) IOSObjectArray_Set(v, 0, [inputLine1_ getBotanaVarsWithOrgGeogebraCommonKernelGeosGeoElement:inputLine1_]);
    (void) IOSObjectArray_Set(v, 1, [inputLine2_ getBotanaVarsWithOrgGeogebraCommonKernelGeosGeoElement:inputLine2_]);
    (void) IOSObjectArray_Set(v, 2, [inputLine3_ getBotanaVarsWithOrgGeogebraCommonKernelGeosGeoElement:inputLine3_]);
    IOSObjectArray *nv = [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonKernelProverPolynomialVariable_class_()];
    (void) IOSObjectArray_Set(nv, 0, new_OrgGeogebraCommonKernelProverPolynomialVariable_init());
    (void) IOSObjectArray_Set(nv, 1, new_OrgGeogebraCommonKernelProverPolynomialVariable_init());
    botanaPolynomials_ = [IOSObjectArray newArrayWithDimensions:2 lengths:(jint[]){ 1, 3 } type:OrgGeogebraCommonKernelProverPolynomialPolynomial_class_()];
    for (jint i = 0; i < 3; ++i) (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(botanaPolynomials_, 0)), i, OrgGeogebraCommonKernelProverPolynomialPolynomial_collinearWithOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_(IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(v, i)), 0), IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(v, i)), 1), IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(v, i)), 2), IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(v, i)), 3), IOSObjectArray_Get(nv, 0), IOSObjectArray_Get(nv, 1)));
    return botanaPolynomials_;
  }
  @throw new_OrgGeogebraCommonKernelProverNoSymbolicParametersException_init();
}
...
void OrgGeogebraCommonKernelProverAlgoAreConcurrent_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoLine_withOrgGeogebraCommonKernelGeosGeoLine_withOrgGeogebraCommonKernelGeosGeoLine_(OrgGeogebraCommonKernelProverAlgoAreConcurrent *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelGeosGeoLine *inputLine1, OrgGeogebraCommonKernelGeosGeoLine *inputLine2, OrgGeogebraCommonKernelGeosGeoLine *inputLine3) {
  ...
  self->inputLine1_ = inputLine1;
  self->inputLine2_ = inputLine2;
  self->inputLine3_ = inputLine3;
