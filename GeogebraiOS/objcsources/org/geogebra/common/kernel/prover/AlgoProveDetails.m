...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/prover/AlgoProveDetails.java
//
...
- (void)compute {
  ...
  [list_ clear];
  if (result_ != nil) {
    OrgGeogebraCommonKernelGeosGeoBoolean *answer = [new_OrgGeogebraCommonKernelGeosGeoBoolean_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
    ...
    if ([result_ booleanValue]) {
      OrgGeogebraCommonKernelGeosGeoList *ndgConditionsList = [new_OrgGeogebraCommonKernelGeosGeoList_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
      ...
      JavaUtilTreeSet *sortedSet = [new_JavaUtilTreeSet_initWithJavaUtilComparator_(OrgGeogebraCommonKernelGeosGeoText_getComparator()) autorelease];
      while (![((JavaLangBoolean *) nil_chk(unreadable_)) booleanValue] && [((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
        OrgGeogebraCommonKernelGeosGeoText *ndgConditionText = [new_OrgGeogebraCommonKernelGeosGeoText_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
...
void OrgGeogebraCommonKernelProverAlgoProveDetails_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoElement_(OrgGeogebraCommonKernelProverAlgoProveDetails *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelGeosGeoElement *root) {
  ...
  OrgGeogebraCommonKernelProverAlgoProveDetails_set_root_(self, root);
  OrgGeogebraCommonKernelProverAlgoProveDetails_setAndConsume_list_(self, new_OrgGeogebraCommonKernelGeosGeoList_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  OrgGeogebraCommonKernelProverAlgoProveDetails_initialCompute(self);
  [self compute];
...
void OrgGeogebraCommonKernelProverAlgoProveDetails_initialCompute(OrgGeogebraCommonKernelProverAlgoProveDetails *self) {
  ...
  OrgGeogebraCommonKernelProverAlgoProveDetails_set_result_(self, [p getYesNoAnswer]);
  OrgGeogebraCommonKernelProverAlgoProveDetails_set_ndgresult_(self, [p getNDGConditions]);
  ...
  if (proofresult == OrgGeogebraCommonUtilProver_ProofResultEnum_get_TRUE_NDG_UNREADABLE()) {
    OrgGeogebraCommonKernelProverAlgoProveDetails_set_unreadable_(self, JavaLangBoolean_valueOfWithBoolean_(YES));
  }
  if (proofresult == OrgGeogebraCommonUtilProver_ProofResultEnum_get_TRUE()) {
    OrgGeogebraCommonKernelProverAlgoProveDetails_set_unreadable_(self, JavaLangBoolean_valueOfWithBoolean_(NO));
  }
