...
- (jint)compareToWithId:(OrgGeogebraCommonKernelProverPolynomialVariable *)v {
  check_class_cast(v, [OrgGeogebraCommonKernelProverPolynomialVariable class]);
...
- (void)setTwinWithOrgGeogebraCommonKernelProverPolynomialVariable:(OrgGeogebraCommonKernelProverPolynomialVariable *)twin {
  [((JavaUtilHashMap *) nil_chk(OrgGeogebraCommonKernelProverPolynomialVariable_twins_)) putWithId:JavaLangInteger_valueOfWithInt_(id__) withId:twin];
}
...
- (void)setParentWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)parent {
  OrgGeogebraCommonKernelProverPolynomialVariable_set_parent_(self, parent);
}
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonKernelProverPolynomialVariable class]) {
    {
      JreStrongAssignAndConsume(&OrgGeogebraCommonKernelProverPolynomialVariable_twins_, nil, new_JavaUtilHashMap_init());
    }
