...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/kernel/prover/polynomial/ParseException.java
//
...
void OrgGeogebraCommonKernelProverPolynomialParseException_initWithOrgGeogebraCommonKernelProverPolynomialToken_withIntArray2_withNSStringArray_(OrgGeogebraCommonKernelProverPolynomialParseException *self, OrgGeogebraCommonKernelProverPolynomialToken *currentTokenVal, IOSObjectArray *expectedTokenSequencesVal, IOSObjectArray *tokenImageVal) {
  (void) JavaLangException_initWithNSString_(self, OrgGeogebraCommonKernelProverPolynomialParseException_initialiseWithOrgGeogebraCommonKernelProverPolynomialToken_withIntArray2_withNSStringArray_(currentTokenVal, expectedTokenSequencesVal, tokenImageVal));
