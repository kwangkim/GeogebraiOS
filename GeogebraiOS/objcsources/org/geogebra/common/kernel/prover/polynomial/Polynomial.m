...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/javasources/org/geogebra/common/kernel/prover/polynomial/Polynomial.java
//
...
- (OrgGeogebraCommonKernelProverPolynomialPolynomial *)addWithOrgGeogebraCommonKernelProverPolynomialPolynomial:(OrgGeogebraCommonKernelProverPolynomialPolynomial *)poly {
  ...
  return [new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithJavaUtilTreeMap_(result) autorelease];
}
...
- (jint)compareToWithId:(OrgGeogebraCommonKernelProverPolynomialPolynomial *)poly {
  check_class_cast(poly, [OrgGeogebraCommonKernelProverPolynomialPolynomial class]);
  if (self == poly) {
    return 0;
  }
...
- (OrgGeogebraCommonKernelProverPolynomialPolynomial *)substituteWithJavaUtilMap:(id<JavaUtilMap>)substitutions {
  ...
  while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
    ...
    JavaUtilTreeMap *term = [new_JavaUtilTreeMap_initWithJavaUtilSortedMap_([((OrgGeogebraCommonKernelProverPolynomialTerm *) nil_chk(t1)) getTerm]) autorelease];
    ...
    OrgGeogebraCommonKernelProverPolynomialTerm *t = [new_OrgGeogebraCommonKernelProverPolynomialTerm_initWithJavaUtilTreeMap_(term) autorelease];
...
- (jboolean)isConstant {
  ...
  if ([((OrgGeogebraCommonKernelProverPolynomialTerm *) nil_chk([terms_ firstKey])) isEqual:[new_OrgGeogebraCommonKernelProverPolynomialTerm_init() autorelease]]) {
    return YES;
  }
  return NO;
}
...
- (jboolean)isOne {
  return [self isEqual:[new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithInt_(1) autorelease]];
}
...
void OrgGeogebraCommonKernelProverPolynomialPolynomial_init(OrgGeogebraCommonKernelProverPolynomialPolynomial *self) {
  NSObject_init(self);
  OrgGeogebraCommonKernelProverPolynomialPolynomial_setAndConsume_terms_(self, new_JavaUtilTreeMap_init());
}
...
void OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialPolynomial_(OrgGeogebraCommonKernelProverPolynomialPolynomial *self, OrgGeogebraCommonKernelProverPolynomialPolynomial *poly) {
  NSObject_init(self);
  OrgGeogebraCommonKernelProverPolynomialPolynomial_setAndConsume_terms_(self, new_JavaUtilTreeMap_initWithJavaUtilSortedMap_([((OrgGeogebraCommonKernelProverPolynomialPolynomial *) nil_chk(poly)) getTerms]));
}
...
void OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithJavaUtilTreeMap_(OrgGeogebraCommonKernelProverPolynomialPolynomial *self, JavaUtilTreeMap *terms) {
  NSObject_init(self);
  OrgGeogebraCommonKernelProverPolynomialPolynomial_set_terms_(self, terms);
}
...
void OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithInt_(OrgGeogebraCommonKernelProverPolynomialPolynomial *self, jint coeff) {
  OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithInt_withOrgGeogebraCommonKernelProverPolynomialTerm_(self, coeff, [new_OrgGeogebraCommonKernelProverPolynomialTerm_init() autorelease]);
}
...
void OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(OrgGeogebraCommonKernelProverPolynomialPolynomial *self, OrgGeogebraCommonKernelProverPolynomialVariable *fv) {
  OrgGeogebraCommonKernelProverPolynomialPolynomial_init(self);
  [((JavaUtilTreeMap *) nil_chk(self->terms_)) putWithId:[new_OrgGeogebraCommonKernelProverPolynomialTerm_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(fv) autorelease] withId:JavaLangInteger_valueOfWithInt_(1)];
}
...
void OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithInt_withOrgGeogebraCommonKernelProverPolynomialVariable_(OrgGeogebraCommonKernelProverPolynomialPolynomial *self, jint coeff, OrgGeogebraCommonKernelProverPolynomialVariable *variable) {
  OrgGeogebraCommonKernelProverPolynomialPolynomial_init(self);
  if (coeff != 0) [((JavaUtilTreeMap *) nil_chk(self->terms_)) putWithId:[new_OrgGeogebraCommonKernelProverPolynomialTerm_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(variable) autorelease] withId:JavaLangInteger_valueOfWithInt_(coeff)];
}
...
void OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithInt_withOrgGeogebraCommonKernelProverPolynomialVariable_withInt_(OrgGeogebraCommonKernelProverPolynomialPolynomial *self, jint coeff, OrgGeogebraCommonKernelProverPolynomialVariable *variable, jint power) {
  OrgGeogebraCommonKernelProverPolynomialPolynomial_init(self);
  if (coeff != 0) [((JavaUtilTreeMap *) nil_chk(self->terms_)) putWithId:[new_OrgGeogebraCommonKernelProverPolynomialTerm_initWithOrgGeogebraCommonKernelProverPolynomialVariable_withInt_(variable, power) autorelease] withId:JavaLangInteger_valueOfWithInt_(coeff)];
}
...
NSString *OrgGeogebraCommonKernelProverPolynomialPolynomial_getVarsAsCommaSeparatedStringWithOrgGeogebraCommonKernelProverPolynomialPolynomialArray_withJavaUtilHashSet_withJavaLangBoolean_(IOSObjectArray *polys, JavaUtilHashSet *extraVars, JavaLangBoolean *free) {
  ...
  while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
    ...
    if ((free == nil) || ([free booleanValue] && [((OrgGeogebraCommonKernelProverPolynomialVariable *) nil_chk(fv)) isFree]) || (![free booleanValue] && ![((OrgGeogebraCommonKernelProverPolynomialVariable *) nil_chk(fv)) isFree])) [sb appendWithNSString:JreStrcat("C@", ',', fv)];
  }
...
NSString *OrgGeogebraCommonKernelProverPolynomialPolynomial_getPolysAsCommaSeparatedStringWithOrgGeogebraCommonKernelProverPolynomialPolynomialArray_(IOSObjectArray *polys) {
  OrgGeogebraCommonKernelProverPolynomialPolynomial_initialize();
  JavaLangStringBuilder *sb = [new_JavaLangStringBuilder_init() autorelease];
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(polys))->size_; ++i) [sb appendWithNSString:JreStrcat("C$", ',', [((OrgGeogebraCommonKernelProverPolynomialPolynomial *) nil_chk(IOSObjectArray_Get(polys, i))) description])];
  if ([sb length] > 0) return [sb substringWithInt:1];
  return @"";
}
...
OrgGeogebraCommonKernelProverPolynomialPolynomial *OrgGeogebraCommonKernelProverPolynomialPolynomial_collinearWithOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_(OrgGeogebraCommonKernelProverPolynomialVariable *fv1, OrgGeogebraCommonKernelProverPolynomialVariable *fv2, OrgGeogebraCommonKernelProverPolynomialVariable *fv3, OrgGeogebraCommonKernelProverPolynomialVariable *fv4, OrgGeogebraCommonKernelProverPolynomialVariable *fv5, OrgGeogebraCommonKernelProverPolynomialVariable *fv6) {
  ...
  OrgGeogebraCommonKernelProverPolynomialPolynomial *a = [new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(fv1) autorelease];
  OrgGeogebraCommonKernelProverPolynomialPolynomial *b = [new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(fv2) autorelease];
  OrgGeogebraCommonKernelProverPolynomialPolynomial *c = [new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(fv3) autorelease];
  OrgGeogebraCommonKernelProverPolynomialPolynomial *d = [new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(fv4) autorelease];
  OrgGeogebraCommonKernelProverPolynomialPolynomial *e = [new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(fv5) autorelease];
  OrgGeogebraCommonKernelProverPolynomialPolynomial *f = [new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(fv6) autorelease];
...
OrgGeogebraCommonKernelProverPolynomialPolynomial *OrgGeogebraCommonKernelProverPolynomialPolynomial_perpendicularWithOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_(OrgGeogebraCommonKernelProverPolynomialVariable *v1, OrgGeogebraCommonKernelProverPolynomialVariable *v2, OrgGeogebraCommonKernelProverPolynomialVariable *v3, OrgGeogebraCommonKernelProverPolynomialVariable *v4, OrgGeogebraCommonKernelProverPolynomialVariable *v5, OrgGeogebraCommonKernelProverPolynomialVariable *v6, OrgGeogebraCommonKernelProverPolynomialVariable *v7, OrgGeogebraCommonKernelProverPolynomialVariable *v8) {
  ...
  OrgGeogebraCommonKernelProverPolynomialPolynomial *a1 = [new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(v1) autorelease];
  OrgGeogebraCommonKernelProverPolynomialPolynomial *a2 = [new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(v2) autorelease];
  OrgGeogebraCommonKernelProverPolynomialPolynomial *b1 = [new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(v3) autorelease];
  OrgGeogebraCommonKernelProverPolynomialPolynomial *b2 = [new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(v4) autorelease];
  OrgGeogebraCommonKernelProverPolynomialPolynomial *c1 = [new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(v5) autorelease];
  OrgGeogebraCommonKernelProverPolynomialPolynomial *c2 = [new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(v6) autorelease];
  OrgGeogebraCommonKernelProverPolynomialPolynomial *d1 = [new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(v7) autorelease];
  OrgGeogebraCommonKernelProverPolynomialPolynomial *d2 = [new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(v8) autorelease];
...
NSString *OrgGeogebraCommonKernelProverPolynomialPolynomial_createEliminateFactorizedScriptWithOrgGeogebraCommonKernelProverPolynomialPolynomialArray_withOrgGeogebraCommonKernelProverPolynomialVariableArray_withJavaUtilSet_(IOSObjectArray *polys, IOSObjectArray *pVariables, id<JavaUtilSet> dependentVariables) {
  ...
  if (![@"" isEqual:vars]) {
    [ret appendWithNSString:vars];
    if ([((id<JavaUtilSet>) nil_chk(dependentVariables)) isEmpty]) {
      [((JavaLangStringBuffer *) nil_chk([ret appendWithNSString:@","])) appendWithNSString:dummyVar];
    }
  }
  ...
  [ret appendWithNSString:OrgGeogebraCommonKernelProverPolynomialPolynomial_getPolysAsCommaSeparatedStringWithOrgGeogebraCommonKernelProverPolynomialPolynomialArray_(polys)];
  [ret appendWithNSString:@";"];
  [ret appendWithNSString:@"ideal "];
...
JavaLangBoolean *OrgGeogebraCommonKernelProverPolynomialPolynomial_solvableWithOrgGeogebraCommonKernelProverPolynomialPolynomialArray_withJavaUtilHashMap_withOrgGeogebraCommonKernelKernel_withBoolean_(IOSObjectArray *polys, JavaUtilHashMap *substitutions, OrgGeogebraCommonKernelKernel *kernel, jboolean transcext) {
  ...
  if (OrgGeogebraCommonMainApp_get_singularWS_() != nil && [OrgGeogebraCommonMainApp_get_singularWS_() isAvailable]) {
    ...
    @catch (JavaLangThrowable *e) {
      @throw [new_OrgGeogebraCommonKernelCASException_initWithNSString_(@"Couldn't compute ") autorelease];
    }
...
OrgGeogebraCommonKernelProverPolynomialPolynomial *OrgGeogebraCommonKernelProverPolynomialPolynomial_sqrDistanceWithOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_(OrgGeogebraCommonKernelProverPolynomialVariable *a1, OrgGeogebraCommonKernelProverPolynomialVariable *a2, OrgGeogebraCommonKernelProverPolynomialVariable *b1, OrgGeogebraCommonKernelProverPolynomialVariable *b2) {
  OrgGeogebraCommonKernelProverPolynomialPolynomial_initialize();
  return [((OrgGeogebraCommonKernelProverPolynomialPolynomial *) nil_chk(OrgGeogebraCommonKernelProverPolynomialPolynomial_sqrWithOrgGeogebraCommonKernelProverPolynomialPolynomial_([((OrgGeogebraCommonKernelProverPolynomialPolynomial *) [new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(a1) autorelease]) subtractWithOrgGeogebraCommonKernelProverPolynomialPolynomial:[new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(b1) autorelease]]))) addWithOrgGeogebraCommonKernelProverPolynomialPolynomial:OrgGeogebraCommonKernelProverPolynomialPolynomial_sqrWithOrgGeogebraCommonKernelProverPolynomialPolynomial_([((OrgGeogebraCommonKernelProverPolynomialPolynomial *) [new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(a2) autorelease]) subtractWithOrgGeogebraCommonKernelProverPolynomialPolynomial:[new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(b2) autorelease]])];
}
...
id<JavaUtilSet> OrgGeogebraCommonKernelProverPolynomialPolynomial_eliminateWithOrgGeogebraCommonKernelProverPolynomialPolynomialArray_withJavaUtilHashMap_withOrgGeogebraCommonKernelKernel_withInt_(IOSObjectArray *eqSystem, JavaUtilHashMap *substitutions, OrgGeogebraCommonKernelKernel *kernel, jint permutation) {
  ...
  JavaUtilTreeSet *variables = [new_JavaUtilTreeSet_initWithJavaUtilCollection_(OrgGeogebraCommonKernelProverPolynomialPolynomial_getVarsWithOrgGeogebraCommonKernelProverPolynomialPolynomialArray_(eqSystem)) autorelease];
  ...
  if (substitutions != nil) {
    eqSystemSubstituted = [IOSObjectArray arrayWithLength:((IOSObjectArray *) nil_chk(eqSystem))->size_ type:OrgGeogebraCommonKernelProverPolynomialPolynomial_class_()];
    for (jint i = 0; i < eqSystem->size_; i++) {
      IOSObjectArray_Set(eqSystemSubstituted, i, [((OrgGeogebraCommonKernelProverPolynomialPolynomial *) nil_chk(IOSObjectArray_Get(eqSystem, i))) substituteWithJavaUtilMap:substitutions]);
    }
  ...
  if (OrgGeogebraCommonMainApp_get_singularWS_() != nil && [OrgGeogebraCommonMainApp_get_singularWS_() isAvailable]) {
    ...
    IOSObjectArray *aVariables = [IOSObjectArray arrayWithLength:vSize type:OrgGeogebraCommonKernelProverPolynomialVariable_class_()];
    ...
    IOSObjectArray *pVariables = [IOSObjectArray arrayWithLength:[variables size] type:OrgGeogebraCommonKernelProverPolynomialVariable_class_()];
    NSString *debug = @"";
    ...
    @catch (JavaLangThrowable *e) {
      @throw [new_OrgGeogebraCommonKernelCASException_initWithNSString_(@"Cannot compute elimination with SingularWS") autorelease];
    }
  }
  else {
    OrgGeogebraCommonCasGeoGebraCAS *cas = (OrgGeogebraCommonCasGeoGebraCAS *) check_class_cast([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel)) getGeoGebraCAS], [OrgGeogebraCommonCasGeoGebraCAS class]);
  ...
  if ([@"empty list" isEqual:elimResult] || [@"[0]" isEqual:elimResult]) {
    ...
    [polys addWithId:[new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithInt_(0) autorelease]];
    [ret addWithId:polys];
    return ret;
  }
