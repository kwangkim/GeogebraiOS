...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/javasources/org/geogebra/common/kernel/prover/polynomial/SimpleCharStream.java
//
...
@implementation OrgGeogebraCommonKernelProverPolynomialSimpleCharStream
...
- (void)ExpandBuffWithBoolean:(jboolean)wrapAround {
  ...
  @try {
    if (wrapAround) {
      ...
      OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_set_buffer_(self, newbuffer);
      ...
      OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_set_bufline_(self, newbufline);
      ...
      OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_set_bufcolumn_(self, newbufcolumn);
...
- (instancetype)initWithJavaIoReader:(JavaIoReader *)dstream
  ...
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoReader_withInt_withInt_withInt_(self, dstream, startline, startcolumn, buffersize);
  return self;
}
...
- (instancetype)initWithJavaIoReader:(JavaIoReader *)dstream
                             withInt:(jint)startline
                             withInt:(jint)startcolumn {
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoReader_withInt_withInt_(self, dstream, startline, startcolumn);
  return self;
}

- (instancetype)initWithJavaIoReader:(JavaIoReader *)dstream {
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoReader_(self, dstream);
  return self;
}
...
- (void)ReInitWithJavaIoReader:(JavaIoReader *)dstream
                       ...
                       withInt:(jint)startcolumn
                       withInt:(jint)buffersize {
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_set_inputStream_(self, dstream);
  line_ = startline;
  column_ = startcolumn - 1;
  if (buffer_ == nil || buffersize != buffer_->size_) {
    available_ = bufsize_ = buffersize;
    OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_setAndConsume_buffer_(self, [IOSCharArray newArrayWithLength:buffersize]);
    OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_setAndConsume_bufline_(self, [IOSIntArray newArrayWithLength:buffersize]);
    OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_setAndConsume_bufcolumn_(self, [IOSIntArray newArrayWithLength:buffersize]);
  }
...
- (instancetype)initWithJavaIoInputStream:(JavaIoInputStream *)dstream
                             withNSString:(NSString *)encoding
                                  ...
                                  withInt:(jint)startcolumn
                                  withInt:(jint)buffersize {
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoInputStream_withNSString_withInt_withInt_withInt_(self, dstream, encoding, startline, startcolumn, buffersize);
  return self;
}
...
- (instancetype)initWithJavaIoInputStream:(JavaIoInputStream *)dstream
                                  ...
                                  withInt:(jint)startcolumn
                                  withInt:(jint)buffersize {
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoInputStream_withInt_withInt_withInt_(self, dstream, startline, startcolumn, buffersize);
  return self;
}
...
- (instancetype)initWithJavaIoInputStream:(JavaIoInputStream *)dstream
                             withNSString:(NSString *)encoding
                                  withInt:(jint)startline
                                  withInt:(jint)startcolumn {
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoInputStream_withNSString_withInt_withInt_(self, dstream, encoding, startline, startcolumn);
  return self;
}
...
- (instancetype)initWithJavaIoInputStream:(JavaIoInputStream *)dstream
                                  withInt:(jint)startline
                                  withInt:(jint)startcolumn {
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoInputStream_withInt_withInt_(self, dstream, startline, startcolumn);
  return self;
}

- (instancetype)initWithJavaIoInputStream:(JavaIoInputStream *)dstream
                             withNSString:(NSString *)encoding {
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoInputStream_withNSString_(self, dstream, encoding);
  return self;
}

- (instancetype)initWithJavaIoInputStream:(JavaIoInputStream *)dstream {
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoInputStream_(self, dstream);
  return self;
}
...
- (void)Done {
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_set_buffer_(self, nil);
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_set_bufline_(self, nil);
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_set_bufcolumn_(self, nil);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "staticFlag_", NULL, 0x19, "Z", NULL, NULL, .constantValue.asBOOL = OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_staticFlag },
  ...
  static const J2ObjcClassInfo _OrgGeogebraCommonKernelProverPolynomialSimpleCharStream = { 2, "SimpleCharStream", "org.geogebra.common.kernel.prover.polynomial", NULL, 0x1, 36, methods, 16, fields, 0, NULL, 0, NULL, NULL, NULL };
  return &_OrgGeogebraCommonKernelProverPolynomialSimpleCharStream;
}

@end

void OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoReader_withInt_withInt_withInt_(OrgGeogebraCommonKernelProverPolynomialSimpleCharStream *self, JavaIoReader *dstream, jint startline, jint startcolumn, jint buffersize) {
  NSObject_init(self);
  self->bufpos_ = -1;
  self->column_ = 0;
  self->line_ = 1;
...
OrgGeogebraCommonKernelProverPolynomialSimpleCharStream *new_OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoReader_withInt_withInt_withInt_(JavaIoReader *dstream, jint startline, jint startcolumn, jint buffersize) {
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream *self = [OrgGeogebraCommonKernelProverPolynomialSimpleCharStream alloc];
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoReader_withInt_withInt_withInt_(self, dstream, startline, startcolumn, buffersize);
  return self;
}

void OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoReader_withInt_withInt_(OrgGeogebraCommonKernelProverPolynomialSimpleCharStream *self, JavaIoReader *dstream, jint startline, jint startcolumn) {
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoReader_withInt_withInt_withInt_(self, dstream, startline, startcolumn, 4096);
}

OrgGeogebraCommonKernelProverPolynomialSimpleCharStream *new_OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoReader_withInt_withInt_(JavaIoReader *dstream, jint startline, jint startcolumn) {
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream *self = [OrgGeogebraCommonKernelProverPolynomialSimpleCharStream alloc];
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoReader_withInt_withInt_(self, dstream, startline, startcolumn);
  return self;
}

void OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoReader_(OrgGeogebraCommonKernelProverPolynomialSimpleCharStream *self, JavaIoReader *dstream) {
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoReader_withInt_withInt_withInt_(self, dstream, 1, 1, 4096);
}

OrgGeogebraCommonKernelProverPolynomialSimpleCharStream *new_OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoReader_(JavaIoReader *dstream) {
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream *self = [OrgGeogebraCommonKernelProverPolynomialSimpleCharStream alloc];
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoReader_(self, dstream);
  return self;
}

void OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoInputStream_withNSString_withInt_withInt_withInt_(OrgGeogebraCommonKernelProverPolynomialSimpleCharStream *self, JavaIoInputStream *dstream, NSString *encoding, jint startline, jint startcolumn, jint buffersize) {
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoReader_withInt_withInt_withInt_(self, encoding == nil ? [new_JavaIoInputStreamReader_initWithJavaIoInputStream_(dstream) autorelease] : [new_JavaIoInputStreamReader_initWithJavaIoInputStream_withNSString_(dstream, encoding) autorelease], startline, startcolumn, buffersize);
}

OrgGeogebraCommonKernelProverPolynomialSimpleCharStream *new_OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoInputStream_withNSString_withInt_withInt_withInt_(JavaIoInputStream *dstream, NSString *encoding, jint startline, jint startcolumn, jint buffersize) {
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream *self = [OrgGeogebraCommonKernelProverPolynomialSimpleCharStream alloc];
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoInputStream_withNSString_withInt_withInt_withInt_(self, dstream, encoding, startline, startcolumn, buffersize);
  return self;
}

void OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoInputStream_withInt_withInt_withInt_(OrgGeogebraCommonKernelProverPolynomialSimpleCharStream *self, JavaIoInputStream *dstream, jint startline, jint startcolumn, jint buffersize) {
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoReader_withInt_withInt_withInt_(self, [new_JavaIoInputStreamReader_initWithJavaIoInputStream_(dstream) autorelease], startline, startcolumn, buffersize);
}

OrgGeogebraCommonKernelProverPolynomialSimpleCharStream *new_OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoInputStream_withInt_withInt_withInt_(JavaIoInputStream *dstream, jint startline, jint startcolumn, jint buffersize) {
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream *self = [OrgGeogebraCommonKernelProverPolynomialSimpleCharStream alloc];
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoInputStream_withInt_withInt_withInt_(self, dstream, startline, startcolumn, buffersize);
  return self;
}

void OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoInputStream_withNSString_withInt_withInt_(OrgGeogebraCommonKernelProverPolynomialSimpleCharStream *self, JavaIoInputStream *dstream, NSString *encoding, jint startline, jint startcolumn) {
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoInputStream_withNSString_withInt_withInt_withInt_(self, dstream, encoding, startline, startcolumn, 4096);
}

OrgGeogebraCommonKernelProverPolynomialSimpleCharStream *new_OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoInputStream_withNSString_withInt_withInt_(JavaIoInputStream *dstream, NSString *encoding, jint startline, jint startcolumn) {
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream *self = [OrgGeogebraCommonKernelProverPolynomialSimpleCharStream alloc];
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoInputStream_withNSString_withInt_withInt_(self, dstream, encoding, startline, startcolumn);
  return self;
}

void OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoInputStream_withInt_withInt_(OrgGeogebraCommonKernelProverPolynomialSimpleCharStream *self, JavaIoInputStream *dstream, jint startline, jint startcolumn) {
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoInputStream_withInt_withInt_withInt_(self, dstream, startline, startcolumn, 4096);
}

OrgGeogebraCommonKernelProverPolynomialSimpleCharStream *new_OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoInputStream_withInt_withInt_(JavaIoInputStream *dstream, jint startline, jint startcolumn) {
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream *self = [OrgGeogebraCommonKernelProverPolynomialSimpleCharStream alloc];
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoInputStream_withInt_withInt_(self, dstream, startline, startcolumn);
  return self;
}

void OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoInputStream_withNSString_(OrgGeogebraCommonKernelProverPolynomialSimpleCharStream *self, JavaIoInputStream *dstream, NSString *encoding) {
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoInputStream_withNSString_withInt_withInt_withInt_(self, dstream, encoding, 1, 1, 4096);
}

OrgGeogebraCommonKernelProverPolynomialSimpleCharStream *new_OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoInputStream_withNSString_(JavaIoInputStream *dstream, NSString *encoding) {
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream *self = [OrgGeogebraCommonKernelProverPolynomialSimpleCharStream alloc];
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoInputStream_withNSString_(self, dstream, encoding);
  return self;
}

void OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoInputStream_(OrgGeogebraCommonKernelProverPolynomialSimpleCharStream *self, JavaIoInputStream *dstream) {
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoInputStream_withInt_withInt_withInt_(self, dstream, 1, 1, 4096);
}

OrgGeogebraCommonKernelProverPolynomialSimpleCharStream *new_OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoInputStream_(JavaIoInputStream *dstream) {
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream *self = [OrgGeogebraCommonKernelProverPolynomialSimpleCharStream alloc];
  OrgGeogebraCommonKernelProverPolynomialSimpleCharStream_initWithJavaIoInputStream_(self, dstream);
  return self;
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgGeogebraCommonKernelProverPolynomialSimpleCharStream)
