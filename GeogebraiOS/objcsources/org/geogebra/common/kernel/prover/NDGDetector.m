...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/prover/NDGDetector.java
//
...
- (OrgGeogebraCommonUtilProver_NDGCondition *)detectWithOrgGeogebraCommonKernelProverPolynomialPolynomial:(OrgGeogebraCommonKernelProverPolynomialPolynomial *)p {
  ...
  OrgGeogebraCommonKernelProverCombinations *triplets = [new_OrgGeogebraCommonKernelProverCombinations_initWithJavaUtilSet_withInt_(freePointsSet, 3) autorelease];
  while ([triplets hasNext]) {
    ...
    jint i = 0;
    IOSObjectArray *points = [IOSObjectArray arrayWithLength:[triplet size] type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
      IOSObjectArray_Set(points, i, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast([it next], [OrgGeogebraCommonKernelGeosGeoElement class]));
      i++;
    }
    ...
    if (OrgGeogebraCommonKernelProverPolynomialPolynomial_areAssociates1WithOrgGeogebraCommonKernelProverPolynomialPolynomial_withOrgGeogebraCommonKernelProverPolynomialPolynomial_(p, coll)) {
      ...
      ndgc = [new_OrgGeogebraCommonUtilProver_NDGCondition_init() autorelease];
  ...
  OrgGeogebraCommonKernelProverCombinations *pairs = [new_OrgGeogebraCommonKernelProverCombinations_initWithJavaUtilSet_withInt_(freePointsSet, 2) autorelease];
  while ([pairs hasNext]) {
    ...
    jint i = 0;
    IOSObjectArray *points = [IOSObjectArray arrayWithLength:[pair size] type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
      IOSObjectArray_Set(points, i, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast([it next], [OrgGeogebraCommonKernelGeosGeoElement class]));
      i++;
    }
  ...
  pairs = [new_OrgGeogebraCommonKernelProverCombinations_initWithJavaUtilSet_withInt_(freeXvars, 2) autorelease];
  while ([pairs hasNext]) {
    JavaUtilHashSet *pair = (JavaUtilHashSet *) check_class_cast([pairs next], [JavaUtilHashSet class]);
    id<JavaUtilIterator> itc = [((JavaUtilHashSet *) nil_chk(pair)) iterator];
    jint i = 0;
    IOSObjectArray *coords = [IOSObjectArray arrayWithLength:[pair size] type:OrgGeogebraCommonKernelProverPolynomialVariable_class_()];
    IOSObjectArray *points = [IOSObjectArray arrayWithLength:[pair size] type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    while ([((id<JavaUtilIterator>) nil_chk(itc)) hasNext]) {
      IOSObjectArray_Set(coords, i, (OrgGeogebraCommonKernelProverPolynomialVariable *) check_class_cast([itc next], [OrgGeogebraCommonKernelProverPolynomialVariable class]));
      IOSObjectArray_Set(points, i, [xvarGeo getWithId:IOSObjectArray_Get(coords, i)]);
      i++;
    }
    OrgGeogebraCommonKernelProverPolynomialPolynomial *xeq = [((OrgGeogebraCommonKernelProverPolynomialPolynomial *) nil_chk(([((OrgGeogebraCommonKernelProverPolynomialPolynomial *) [new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(IOSObjectArray_Get(coords, 0)) autorelease]) subtractWithOrgGeogebraCommonKernelProverPolynomialPolynomial:[new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(IOSObjectArray_Get(coords, 1)) autorelease]]))) substituteWithJavaUtilMap:substitutions_];
  ...
  pairs = [new_OrgGeogebraCommonKernelProverCombinations_initWithJavaUtilSet_withInt_(freeYvars, 2) autorelease];
  while ([pairs hasNext]) {
    JavaUtilHashSet *pair = (JavaUtilHashSet *) check_class_cast([pairs next], [JavaUtilHashSet class]);
    id<JavaUtilIterator> itc = [((JavaUtilHashSet *) nil_chk(pair)) iterator];
    jint i = 0;
    ...
    OrgGeogebraCommonKernelProverPolynomialPolynomial *yeq = [((OrgGeogebraCommonKernelProverPolynomialPolynomial *) nil_chk(([((OrgGeogebraCommonKernelProverPolynomialPolynomial *) [new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(IOSObjectArray_Get(coords, 0)) autorelease]) subtractWithOrgGeogebraCommonKernelProverPolynomialPolynomial:[new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(IOSObjectArray_Get(coords, 1)) autorelease]]))) substituteWithJavaUtilMap:substitutions_];
  ...
  OrgGeogebraCommonKernelProverCombinations *pairs1 = [new_OrgGeogebraCommonKernelProverCombinations_initWithJavaUtilSet_withInt_(freePointsSet, 2) autorelease];
  while ([pairs1 hasNext]) {
    ...
    jint i = 0;
    IOSObjectArray *points = [IOSObjectArray arrayWithLength:4 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    while ([((id<JavaUtilIterator>) nil_chk(it1)) hasNext]) {
      IOSObjectArray_Set(points, i, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast([it1 next], [OrgGeogebraCommonKernelGeosGeoElement class]));
      i++;
    }
    OrgGeogebraCommonKernelProverCombinations *pairs2 = [new_OrgGeogebraCommonKernelProverCombinations_initWithJavaUtilSet_withInt_(freePointsSet, 2) autorelease];
    while ([pairs2 hasNext]) {
      ...
      while ([((id<JavaUtilIterator>) nil_chk(it2)) hasNext]) {
        IOSObjectArray_Set(points, i, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast([it2 next], [OrgGeogebraCommonKernelGeosGeoElement class]));
        i++;
      }
      IOSObjectArray *fv1 = [((id<OrgGeogebraCommonKernelAlgosSymbolicParametersBotanaAlgo>) nil_chk(((id<OrgGeogebraCommonKernelAlgosSymbolicParametersBotanaAlgo>) check_protocol_cast(IOSObjectArray_Get(points, 0), @protocol(OrgGeogebraCommonKernelAlgosSymbolicParametersBotanaAlgo))))) getBotanaVarsWithOrgGeogebraCommonKernelGeosGeoElement:IOSObjectArray_Get(points, 0)];
      IOSObjectArray *fv2 = [((id<OrgGeogebraCommonKernelAlgosSymbolicParametersBotanaAlgo>) nil_chk(((id<OrgGeogebraCommonKernelAlgosSymbolicParametersBotanaAlgo>) check_protocol_cast(IOSObjectArray_Get(points, 1), @protocol(OrgGeogebraCommonKernelAlgosSymbolicParametersBotanaAlgo))))) getBotanaVarsWithOrgGeogebraCommonKernelGeosGeoElement:IOSObjectArray_Get(points, 1)];
  ...
  pairs = [new_OrgGeogebraCommonKernelProverCombinations_initWithJavaUtilSet_withInt_(freePointsSet, 2) autorelease];
  while ([pairs hasNext]) {
    JavaUtilHashSet *pair = (JavaUtilHashSet *) check_class_cast([pairs next], [JavaUtilHashSet class]);
...
void OrgGeogebraCommonKernelProverNDGDetector_initWithOrgGeogebraCommonUtilProver_withJavaUtilHashMap_(OrgGeogebraCommonKernelProverNDGDetector *self, OrgGeogebraCommonUtilProver *prover, JavaUtilHashMap *substitutions) {
  NSObject_init(self);
  OrgGeogebraCommonKernelProverNDGDetector_setAndConsume_lookupTable_(self, new_JavaUtilHashMap_init());
  OrgGeogebraCommonKernelProverNDGDetector_set_prover_(self, prover);
  OrgGeogebraCommonKernelProverNDGDetector_set_substitutions_(self, substitutions);
}
