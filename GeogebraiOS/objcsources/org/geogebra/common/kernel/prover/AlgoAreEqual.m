...
- (IOSObjectArray *)getPolynomials {
  ...
  if (inputElement1_ != nil && inputElement2_ != nil) {
    if ((([inputElement1_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoPoint class]]) && ([inputElement2_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoPoint class]])) || (([inputElement1_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoLine class]]) && ([inputElement2_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoLine class]])) || (([inputElement1_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoVector class]]) && ([inputElement2_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoVector class]]))) {
      ...
      OrgGeogebraCommonKernelProverAlgoAreEqual_setAndConsume_polynomials_(self, [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonKernelProverPolynomialPolynomial_class_()]);
      IOSObjectArray_Set(polynomials_, 0, [((OrgGeogebraCommonKernelProverPolynomialPolynomial *) nil_chk([((OrgGeogebraCommonKernelProverPolynomialPolynomial *) nil_chk(IOSObjectArray_Get(nil_chk(coords1), 0))) multiplyWithOrgGeogebraCommonKernelProverPolynomialPolynomial:IOSObjectArray_Get(nil_chk(coords2), 2)])) subtractWithOrgGeogebraCommonKernelProverPolynomialPolynomial:[((OrgGeogebraCommonKernelProverPolynomialPolynomial *) nil_chk(IOSObjectArray_Get(coords2, 0))) multiplyWithOrgGeogebraCommonKernelProverPolynomialPolynomial:IOSObjectArray_Get(coords1, 2)]]);
      IOSObjectArray_Set(polynomials_, 1, [((OrgGeogebraCommonKernelProverPolynomialPolynomial *) nil_chk([((OrgGeogebraCommonKernelProverPolynomialPolynomial *) nil_chk(IOSObjectArray_Get(coords1, 1))) multiplyWithOrgGeogebraCommonKernelProverPolynomialPolynomial:IOSObjectArray_Get(coords2, 2)])) subtractWithOrgGeogebraCommonKernelProverPolynomialPolynomial:[((OrgGeogebraCommonKernelProverPolynomialPolynomial *) nil_chk(IOSObjectArray_Get(coords2, 1))) multiplyWithOrgGeogebraCommonKernelProverPolynomialPolynomial:IOSObjectArray_Get(coords1, 2)]]);
      return polynomials_;
    }
  }
  @throw [new_OrgGeogebraCommonKernelProverNoSymbolicParametersException_init() autorelease];
...
- (IOSObjectArray *)getBotanaPolynomials {
  ...
  if ([inputElement1_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoPoint class]] && [inputElement2_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoPoint class]]) {
    OrgGeogebraCommonKernelProverAlgoAreEqual_setAndConsume_botanaPolynomials_(self, [IOSObjectArray newArrayWithDimensions:2 lengths:(jint[]){ 2, 1 } type:OrgGeogebraCommonKernelProverPolynomialPolynomial_class_()]);
    IOSObjectArray *v1 = [IOSObjectArray arrayWithLength:2 type:OrgGeogebraCommonKernelProverPolynomialVariable_class_()];
    IOSObjectArray *v2 = [IOSObjectArray arrayWithLength:2 type:OrgGeogebraCommonKernelProverPolynomialVariable_class_()];
    ...
    IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(botanaPolynomials_, 0)), 0, [((OrgGeogebraCommonKernelProverPolynomialPolynomial *) [new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(IOSObjectArray_Get(nil_chk(v1), 0)) autorelease]) subtractWithOrgGeogebraCommonKernelProverPolynomialPolynomial:[new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(IOSObjectArray_Get(nil_chk(v2), 0)) autorelease]]);
    IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(botanaPolynomials_, 1)), 0, [((OrgGeogebraCommonKernelProverPolynomialPolynomial *) [new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(IOSObjectArray_Get(v1, 1)) autorelease]) subtractWithOrgGeogebraCommonKernelProverPolynomialPolynomial:[new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(IOSObjectArray_Get(v2, 1)) autorelease]]);
    return botanaPolynomials_;
  }
  if ([inputElement1_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoSegment class]] && [inputElement2_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoSegment class]]) {
    OrgGeogebraCommonKernelProverAlgoAreEqual_setAndConsume_botanaPolynomials_(self, [IOSObjectArray newArrayWithDimensions:2 lengths:(jint[]){ 1, 1 } type:OrgGeogebraCommonKernelProverPolynomialPolynomial_class_()]);
    ...
    OrgGeogebraCommonKernelProverPolynomialPolynomial *a1 = [new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(IOSObjectArray_Get(nil_chk(v1), 0)) autorelease];
    OrgGeogebraCommonKernelProverPolynomialPolynomial *a2 = [new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(IOSObjectArray_Get(v1, 1)) autorelease];
    OrgGeogebraCommonKernelProverPolynomialPolynomial *b1 = [new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(IOSObjectArray_Get(v1, 2)) autorelease];
    OrgGeogebraCommonKernelProverPolynomialPolynomial *b2 = [new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(IOSObjectArray_Get(v1, 3)) autorelease];
    OrgGeogebraCommonKernelProverPolynomialPolynomial *c1 = [new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(IOSObjectArray_Get(nil_chk(v2), 0)) autorelease];
    OrgGeogebraCommonKernelProverPolynomialPolynomial *c2 = [new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(IOSObjectArray_Get(v2, 1)) autorelease];
    OrgGeogebraCommonKernelProverPolynomialPolynomial *d1 = [new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(IOSObjectArray_Get(v2, 2)) autorelease];
    OrgGeogebraCommonKernelProverPolynomialPolynomial *d2 = [new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(IOSObjectArray_Get(v2, 3)) autorelease];
    IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(botanaPolynomials_, 0)), 0, [((OrgGeogebraCommonKernelProverPolynomialPolynomial *) nil_chk(([((OrgGeogebraCommonKernelProverPolynomialPolynomial *) nil_chk(([((OrgGeogebraCommonKernelProverPolynomialPolynomial *) nil_chk(OrgGeogebraCommonKernelProverPolynomialPolynomial_sqrWithOrgGeogebraCommonKernelProverPolynomialPolynomial_([a1 subtractWithOrgGeogebraCommonKernelProverPolynomialPolynomial:b1]))) addWithOrgGeogebraCommonKernelProverPolynomialPolynomial:OrgGeogebraCommonKernelProverPolynomialPolynomial_sqrWithOrgGeogebraCommonKernelProverPolynomialPolynomial_([a2 subtractWithOrgGeogebraCommonKernelProverPolynomialPolynomial:b2])]))) subtractWithOrgGeogebraCommonKernelProverPolynomialPolynomial:OrgGeogebraCommonKernelProverPolynomialPolynomial_sqrWithOrgGeogebraCommonKernelProverPolynomialPolynomial_([c1 subtractWithOrgGeogebraCommonKernelProverPolynomialPolynomial:d1])]))) subtractWithOrgGeogebraCommonKernelProverPolynomialPolynomial:OrgGeogebraCommonKernelProverPolynomialPolynomial_sqrWithOrgGeogebraCommonKernelProverPolynomialPolynomial_([c2 subtractWithOrgGeogebraCommonKernelProverPolynomialPolynomial:d2])]);
    return botanaPolynomials_;
  }
  if ([inputElement1_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoLine class]] && [inputElement2_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoLine class]]) {
    ...
    IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(botanaPolynomials_, 1)), 0, OrgGeogebraCommonKernelProverPolynomialPolynomial_collinearWithOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_(IOSObjectArray_Get(v1, 0), IOSObjectArray_Get(v1, 1), IOSObjectArray_Get(v1, 2), IOSObjectArray_Get(v1, 3), IOSObjectArray_Get(v2, 2), IOSObjectArray_Get(v2, 3)));
    return botanaPolynomials_;
  }
  @throw [new_OrgGeogebraCommonKernelProverNoSymbolicParametersException_init() autorelease];
}
...
void OrgGeogebraCommonKernelProverAlgoAreEqual_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoElement_(OrgGeogebraCommonKernelProverAlgoAreEqual *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelGeosGeoElement *inputElement1, OrgGeogebraCommonKernelGeosGeoElement *inputElement2) {
  ...
  OrgGeogebraCommonKernelProverAlgoAreEqual_set_inputElement1_(self, inputElement1);
  OrgGeogebraCommonKernelProverAlgoAreEqual_set_inputElement2_(self, inputElement2);
  OrgGeogebraCommonKernelProverAlgoAreEqual_setAndConsume_outputBoolean_(self, new_OrgGeogebraCommonKernelGeosGeoBoolean_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  OrgGeogebraCommonKernelProverAlgoAreEqual_compute(self);
}
