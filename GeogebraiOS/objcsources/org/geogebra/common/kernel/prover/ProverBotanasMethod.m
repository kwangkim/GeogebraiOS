...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/kernel/prover/ProverBotanasMethod.java
//
...
void OrgGeogebraCommonKernelProverProverBotanasMethod_updateBotanaVarsInvWithOrgGeogebraCommonKernelGeosGeoElement_(OrgGeogebraCommonKernelGeosGeoElement *statement) {
  ...
  if (OrgGeogebraCommonKernelProverProverBotanasMethod_botanaVarsInv_ == nil) OrgGeogebraCommonKernelProverProverBotanasMethod_botanaVarsInv_ = new_JavaUtilHashMap_init();
  ...
  while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
    ...
    if (vars != nil) {
      ...
      (void) [((JavaUtilHashMap *) nil_chk(OrgGeogebraCommonKernelProverProverBotanasMethod_botanaVarsInv_)) putWithId:varsList withId:geo];
    }
  }
}
...
id<JavaUtilList> OrgGeogebraCommonKernelProverProverBotanasMethod_getFreePointsWithOrgGeogebraCommonKernelGeosGeoElement_(OrgGeogebraCommonKernelGeosGeoElement *statement) {
  OrgGeogebraCommonKernelProverProverBotanasMethod_initialize();
  id<JavaUtilList> freePoints = new_JavaUtilArrayList_init();
  id<JavaUtilIterator> it = [((JavaUtilTreeSet *) nil_chk([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(statement)) getAllPredecessors])) iterator];
  while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
    OrgGeogebraCommonKernelGeosGeoElement *geo = [it next];
...
id<JavaUtilList> OrgGeogebraCommonKernelProverProverBotanasMethod_getCircleCentersWithOrgGeogebraCommonKernelGeosGeoElement_(OrgGeogebraCommonKernelGeosGeoElement *statement) {
  OrgGeogebraCommonKernelProverProverBotanasMethod_initialize();
  id<JavaUtilList> circleCenters = new_JavaUtilArrayList_init();
  id<JavaUtilIterator> it = [((JavaUtilTreeSet *) nil_chk([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(statement)) getAllPredecessors])) iterator];
  while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
    OrgGeogebraCommonKernelGeosGeoElement *geo = [it next];
    if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(geo)) isGeoConic]) {
      if ([[geo getParentAlgorithm] isKindOfClass:[OrgGeogebraCommonKernelAlgosAlgoCircleTwoPoints class]] || [[geo getParentAlgorithm] isKindOfClass:[OrgGeogebraCommonKernelAlgosAlgoCircleThreePoints class]]) {
        ...
        IOSObjectArray *center = [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonKernelProverPolynomialVariable_class_()];
        (void) IOSObjectArray_Set(center, 0, IOSObjectArray_Get(nil_chk(vars), 0));
        (void) IOSObjectArray_Set(center, 1, IOSObjectArray_Get(vars, 1));
...
IOSObjectArray *OrgGeogebraCommonKernelProverProverBotanasMethod_create3FreePointsNeverCollinearNDGWithOrgGeogebraCommonUtilProver_(OrgGeogebraCommonUtilProver *prover) {
  ...
  OrgGeogebraCommonUtilProver_NDGCondition *ndgc = new_OrgGeogebraCommonUtilProver_NDGCondition_init();
  if (setSize > 3) [ndgc setConditionWithNSString:@"DegeneratePolygon"];
  else [ndgc setConditionWithNSString:@"AreCollinear"];
  IOSObjectArray *geos = [IOSObjectArray newArrayWithLength:setSize type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
  jint i = 0;
  id<JavaUtilIterator> it = [freePoints iterator];
  while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
    (void) IOSObjectArray_Set(geos, i++, [it next]);
  }
  ...
  IOSObjectArray *ret = [IOSObjectArray newArrayWithLength:setSize * (setSize - 1) * (setSize - 2) / 6 type:OrgGeogebraCommonKernelProverPolynomialPolynomial_class_()];
  i = 0;
  JavaUtilHashSet *triplets = new_JavaUtilHashSet_init();
      ...
      if (![((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(geo1)) isEqualWithOrgGeogebraCommonKernelGeosGeoElement:geo2]) {
        ...
        while ([((id<JavaUtilIterator>) nil_chk(it3)) hasNext]) {
          ...
          if (![geo1 isEqualWithOrgGeogebraCommonKernelGeosGeoElement:geo3] && ![((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(geo2)) isEqualWithOrgGeogebraCommonKernelGeosGeoElement:geo3]) {
            JavaUtilHashSet *triplet = new_JavaUtilHashSet_init();
...
JavaUtilHashMap *OrgGeogebraCommonKernelProverProverBotanasMethod_fixValuesWithOrgGeogebraCommonUtilProver_withInt_(OrgGeogebraCommonUtilProver *prover, jint coords) {
  OrgGeogebraCommonKernelProverProverBotanasMethod_initialize();
  IOSIntArray *fixCoords = [IOSIntArray newArrayWithInts:(jint[]){ 0, 0, 0, 1 } count:4];
  ...
  id<JavaUtilList> fixedPoints = new_JavaUtilArrayList_init();
  for (OrgGeogebraCommonKernelGeosGeoElement * __strong ge in nil_chk(freePoints)) {
    [fixedPoints addWithId:ge];
  }
  JavaUtilHashMap *ret = new_JavaUtilHashMap_init();
  id<JavaUtilIterator> it = [fixedPoints iterator];
  IOSObjectArray *geos = [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
  jint i = 0, j = 0;
  while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext] && i < 2 && j < coords) {
    ...
    (void) IOSObjectArray_Set(geos, i, geo);
    (void) [ret putWithId:IOSObjectArray_Get(nil_chk(fv), 0) withId:JavaLangInteger_valueOfWithInt_(IOSIntArray_Get(fixCoords, j))];
    ++j;
    if (j < coords) {
      (void) [ret putWithId:IOSObjectArray_Get(fv, 1) withId:JavaLangInteger_valueOfWithInt_(IOSIntArray_Get(fixCoords, j))];
      ++i;
      ++j;
    }
  }
...
OrgGeogebraCommonUtilProver_ProofResultEnum *OrgGeogebraCommonKernelProverProverBotanasMethod_proveWithOrgGeogebraCommonUtilProver_(OrgGeogebraCommonUtilProver *prover) {
      ...
      @try {
        ...
        if (!([@"" isEqual:command])) {
          ...
          if (![((NSString *) nil_chk(description_)) hasPrefix:@"xOyPlane"]) {
            ...
            IOSObjectArray *v = [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonKernelProverPolynomialVariable_class_()];
        ...
        if (geoPolys != nil) {
          ...
          IOSObjectArray *allPolys = [IOSObjectArray newArrayWithLength:nHypotheses + geoPolys->size_ type:OrgGeogebraCommonKernelProverPolynomialPolynomial_class_()];
          for (jint i = 0; i < nHypotheses; ++i) {
            (void) IOSObjectArray_Set(allPolys, i, IOSObjectArray_Get(nil_chk(hypotheses), i));
          }
          ...
          for (jint i = 0; i < geoPolys->size_; ++i) {
            ...
            (void) IOSObjectArray_Set(allPolys, nHypotheses + i, IOSObjectArray_Get(geoPolys, i));
            if (OrgGeogebraCommonMainProverSettings_get_captionAlgebra_()) {
  ...
  @try {
    ...
    if (OrgGeogebraCommonMainProverSettings_get_freePointsNeverCollinear_() == nil) {
      if (OrgGeogebraCommonMainApp_get_singularWS_() != nil && [OrgGeogebraCommonMainApp_get_singularWS_() isAvailable]) {
        (void) OrgGeogebraCommonMainProverSettings_set_freePointsNeverCollinear_(JavaLangBoolean_valueOfWithBoolean_(NO));
      }
      else {
        (void) OrgGeogebraCommonMainProverSettings_set_freePointsNeverCollinear_(JavaLangBoolean_valueOfWithBoolean_(YES));
      }
    }
    ...
    IOSObjectArray *eqSystem = [IOSObjectArray newArrayWithLength:nHypotheses + nNdgConditions + nExtraPolysNonDenied + 1 type:OrgGeogebraCommonKernelProverPolynomialPolynomial_class_()];
    for (jint j = 0; j < nHypotheses; ++j) (void) IOSObjectArray_Set(eqSystem, j, IOSObjectArray_Get(nil_chk(hypotheses), j));
    ...
    for (jint j = 0; j < nNdgConditions; ++j) {
      ...
      (void) IOSObjectArray_Set(eqSystem, j + nHypotheses, IOSObjectArray_Get(ndgConditions, j));
    }
    ...
    for (jint i = 0; i < nStatements; ++i) {
      for (jint j = 0; j < ((IOSObjectArray *) nil_chk(IOSObjectArray_Get(nil_chk(statements), i)))->size_ - 1; ++j) {
        ...
        (void) IOSObjectArray_Set(eqSystem, k, IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(statements, i)), j));
        ++k;
      }
    }
    OrgGeogebraCommonMainApp_debugWithNSString_(@"Thesis reductio ad absurdum (denied statement), product of factors:");
    OrgGeogebraCommonKernelProverPolynomialPolynomial *spoly = new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithInt_(1);
    for (jint i = 0; i < nStatements; ++i) {
    ...
    if ([prover isReturnExtraNDGs]) {
      ...
      OrgGeogebraCommonKernelProverNDGDetector *ndgd = new_OrgGeogebraCommonKernelProverNDGDetector_initWithOrgGeogebraCommonUtilProver_withJavaUtilHashMap_(prover, substitutions);
      jboolean found = NO;
      jint permutation = 0;
      ...
      while (!found && permutation < MAX_PERMUTATIONS) {
        ...
        id<JavaUtilList> xEqualSet = new_JavaUtilArrayList_initWithJavaUtilCollection_(new_JavaUtilHashSet_init());
        id<JavaUtilList> yEqualSet = new_JavaUtilArrayList_initWithJavaUtilCollection_(new_JavaUtilHashSet_init());
        jboolean xyRewrite = [eliminationIdeal size] == 2;
        id<JavaUtilList> bestNdgSet = new_JavaUtilArrayList_init();
        ...
        while ([((id<JavaUtilIterator>) nil_chk(ndgSet)) hasNext]) {
          ...
          id<JavaUtilList> ndgcl = new_JavaUtilArrayList_init();
          jdouble score = 0.0;
          ...
          while ([((id<JavaUtilIterator>) nil_chk(ndg)) hasNext] && readable) {
            ...
            if ([((OrgGeogebraCommonKernelProverPolynomialPolynomial *) nil_chk(poly)) isZero]) {
              ...
              if (nStatements != 1) {
                IOSObjectArray *eqSystem2 = [IOSObjectArray newArrayWithLength:nHypotheses + nNdgConditions + nExtraPolysNonDenied + nStatements type:OrgGeogebraCommonKernelProverPolynomialPolynomial_class_()];
                for (jint i = 0; i < nHypotheses + nNdgConditions + nExtraPolysNonDenied; ++i) {
                  (void) IOSObjectArray_Set(eqSystem2, i, IOSObjectArray_Get(eqSystem, i));
                }
                eqSystem = eqSystem2;
              }
              jint j = nHypotheses + nNdgConditions + nExtraPolysNonDenied;
              for (jint i = 0; i < nStatements; ++i) {
                (void) IOSObjectArray_Set(eqSystem, j + i, IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(nil_chk(statements), i)), ((IOSObjectArray *) nil_chk(IOSObjectArray_Get(statements, i)))->size_ - 1));
              }
              eliminationIdeal = OrgGeogebraCommonKernelProverPolynomialPolynomial_eliminateWithOrgGeogebraCommonKernelProverPolynomialPolynomialArray_withJavaUtilHashMap_withOrgGeogebraCommonKernelKernel_withInt_(eqSystem, substitutions, [statement getKernel], permutation++);
              if (eliminationIdeal == nil) {
              ...
              if (ndgc == nil) readable = NO;
                ...
                if (xyRewrite) {
                  if ([((NSString *) nil_chk([ndgc getCondition])) isEqual:@"xAreEqual"]) {
                    id<JavaUtilSet> points = new_JavaUtilHashSet_init();
