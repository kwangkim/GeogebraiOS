...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/prover/AlgoAreParallel.java
//
...
@interface OrgGeogebraCommonKernelProverAlgoAreParallel () {
 @public
...
J2OBJC_FIELD_SETTER(OrgGeogebraCommonKernelProverAlgoAreParallel, inputLine1_, OrgGeogebraCommonKernelGeosGeoLine *)
J2OBJC_FIELD_SETTER(OrgGeogebraCommonKernelProverAlgoAreParallel, inputLine2_, OrgGeogebraCommonKernelGeosGeoLine *)
J2OBJC_FIELD_SETTER(OrgGeogebraCommonKernelProverAlgoAreParallel, outputBoolean_, OrgGeogebraCommonKernelGeosGeoBoolean *)
J2OBJC_FIELD_SETTER(OrgGeogebraCommonKernelProverAlgoAreParallel, polynomials_, IOSObjectArray *)
J2OBJC_FIELD_SETTER(OrgGeogebraCommonKernelProverAlgoAreParallel, botanaPolynomials_, IOSObjectArray *)

__attribute__((unused)) static void OrgGeogebraCommonKernelProverAlgoAreParallel_compute(OrgGeogebraCommonKernelProverAlgoAreParallel *self);

@implementation OrgGeogebraCommonKernelProverAlgoAreParallel
...
- (instancetype)initWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)cons
  ...
  OrgGeogebraCommonKernelProverAlgoAreParallel_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoElement_(self, cons, label, inputLine1, inputLine2);
  return self;
}

- (OrgGeogebraCommonKernelCommandsCommandsEnum *)getClassName {
  return OrgGeogebraCommonKernelCommandsCommandsEnum_get_AreParallel();
}
...
- (void)compute {
  OrgGeogebraCommonKernelProverAlgoAreParallel_compute(self);
}
...
- (IOSIntArray *)getDegrees {
  if (inputLine1_ != nil && inputLine2_ != nil) {
    ...
    *IOSIntArray_GetRef(degree, 0) = JavaLangMath_maxWithInt_withInt_(IOSIntArray_Get(nil_chk(degree1), 0) + IOSIntArray_Get(nil_chk(degree2), 1), IOSIntArray_Get(degree1, 1) + IOSIntArray_Get(degree2, 0));
    return degree;
  }
  @throw [new_OrgGeogebraCommonKernelProverNoSymbolicParametersException_init() autorelease];
}
...
- (IOSObjectArray *)getExactCoordinatesWithJavaUtilHashMap:(JavaUtilHashMap *)values {
  if (inputLine1_ != nil && inputLine2_ != nil) {
    ...
    IOSObjectArray_Set(coords, 0, [((JavaMathBigInteger *) nil_chk([((JavaMathBigInteger *) nil_chk(IOSObjectArray_Get(nil_chk(coords1), 0))) multiplyWithJavaMathBigInteger:IOSObjectArray_Get(nil_chk(coords2), 1)])) subtractWithJavaMathBigInteger:[((JavaMathBigInteger *) nil_chk(IOSObjectArray_Get(coords1, 1))) multiplyWithJavaMathBigInteger:IOSObjectArray_Get(coords2, 0)]]);
    return coords;
  }
  @throw [new_OrgGeogebraCommonKernelProverNoSymbolicParametersException_init() autorelease];
}
...
- (IOSObjectArray *)getPolynomials {
  ...
  if (inputLine1_ != nil && inputLine2_ != nil) {
    ...
    OrgGeogebraCommonKernelProverAlgoAreParallel_setAndConsume_polynomials_(self, [IOSObjectArray newArrayWithLength:1 type:OrgGeogebraCommonKernelProverPolynomialPolynomial_class_()]);
    IOSObjectArray_Set(polynomials_, 0, [((OrgGeogebraCommonKernelProverPolynomialPolynomial *) nil_chk([((OrgGeogebraCommonKernelProverPolynomialPolynomial *) nil_chk(IOSObjectArray_Get(nil_chk(coords1), 0))) multiplyWithOrgGeogebraCommonKernelProverPolynomialPolynomial:IOSObjectArray_Get(nil_chk(coords2), 1)])) subtractWithOrgGeogebraCommonKernelProverPolynomialPolynomial:[((OrgGeogebraCommonKernelProverPolynomialPolynomial *) nil_chk(IOSObjectArray_Get(coords1, 1))) multiplyWithOrgGeogebraCommonKernelProverPolynomialPolynomial:IOSObjectArray_Get(coords2, 0)]]);
    return polynomials_;
  }
  @throw [new_OrgGeogebraCommonKernelProverNoSymbolicParametersException_init() autorelease];
}
...
- (IOSObjectArray *)getBotanaPolynomials {
  ...
  if (inputLine1_ != nil && inputLine2_ != nil) {
    IOSObjectArray *v1 = [IOSObjectArray arrayWithLength:4 type:OrgGeogebraCommonKernelProverPolynomialVariable_class_()];
    IOSObjectArray *v2 = [IOSObjectArray arrayWithLength:4 type:OrgGeogebraCommonKernelProverPolynomialVariable_class_()];
    ...
    OrgGeogebraCommonKernelProverAlgoAreParallel_setAndConsume_botanaPolynomials_(self, [IOSObjectArray newArrayWithDimensions:2 lengths:(jint[]){ 1, 1 } type:OrgGeogebraCommonKernelProverPolynomialPolynomial_class_()]);
    IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(botanaPolynomials_, 0)), 0, OrgGeogebraCommonKernelProverPolynomialPolynomial_parallelWithOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_(IOSObjectArray_Get(nil_chk(v1), 0), IOSObjectArray_Get(v1, 1), IOSObjectArray_Get(v1, 2), IOSObjectArray_Get(v1, 3), IOSObjectArray_Get(nil_chk(v2), 0), IOSObjectArray_Get(v2, 1), IOSObjectArray_Get(v2, 2), IOSObjectArray_Get(v2, 3)));
    return botanaPolynomials_;
  }
  return nil;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithOrgGeogebraCommonKernelConstruction:withNSString:withOrgGeogebraCommonKernelGeosGeoElement:withOrgGeogebraCommonKernelGeosGeoElement:", "AlgoAreParallel", NULL, 0x1, NULL, NULL },
  ...
  static const J2ObjcClassInfo _OrgGeogebraCommonKernelProverAlgoAreParallel = { 2, "AlgoAreParallel", "org.geogebra.common.kernel.prover", NULL, 0x1, 11, methods, 5, fields, 0, NULL, 0, NULL, NULL, NULL };
  return &_OrgGeogebraCommonKernelProverAlgoAreParallel;
}
...
void OrgGeogebraCommonKernelProverAlgoAreParallel_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoElement_(OrgGeogebraCommonKernelProverAlgoAreParallel *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelGeosGeoElement *inputLine1, OrgGeogebraCommonKernelGeosGeoElement *inputLine2) {
  ...
  OrgGeogebraCommonKernelProverAlgoAreParallel_set_inputLine1_(self, (OrgGeogebraCommonKernelGeosGeoLine *) check_class_cast(inputLine1, [OrgGeogebraCommonKernelGeosGeoLine class]));
  OrgGeogebraCommonKernelProverAlgoAreParallel_set_inputLine2_(self, (OrgGeogebraCommonKernelGeosGeoLine *) check_class_cast(inputLine2, [OrgGeogebraCommonKernelGeosGeoLine class]));
  OrgGeogebraCommonKernelProverAlgoAreParallel_setAndConsume_outputBoolean_(self, new_OrgGeogebraCommonKernelGeosGeoBoolean_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  OrgGeogebraCommonKernelProverAlgoAreParallel_compute(self);
}

OrgGeogebraCommonKernelProverAlgoAreParallel *new_OrgGeogebraCommonKernelProverAlgoAreParallel_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoElement_(OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelGeosGeoElement *inputLine1, OrgGeogebraCommonKernelGeosGeoElement *inputLine2) {
  OrgGeogebraCommonKernelProverAlgoAreParallel *self = [OrgGeogebraCommonKernelProverAlgoAreParallel alloc];
  OrgGeogebraCommonKernelProverAlgoAreParallel_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoElement_(self, cons, label, inputLine1, inputLine2);
  return self;
}

void OrgGeogebraCommonKernelProverAlgoAreParallel_compute(OrgGeogebraCommonKernelProverAlgoAreParallel *self) {
  [((OrgGeogebraCommonKernelGeosGeoBoolean *) nil_chk(self->outputBoolean_)) setValueWithBoolean:[((OrgGeogebraCommonKernelGeosGeoLine *) nil_chk(self->inputLine1_)) isParallelWithOrgGeogebraCommonKernelGeosGeoLine:self->inputLine2_]];
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgGeogebraCommonKernelProverAlgoAreParallel)
