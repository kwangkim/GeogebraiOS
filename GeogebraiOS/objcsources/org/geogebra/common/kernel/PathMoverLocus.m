...
- (void)init__WithOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)p
  ...
  if ([[((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(p)) getPath] isKindOfClass:[OrgGeogebraCommonKernelGeosGeoLocusND class]]) {
    OrgGeogebraCommonKernelPathMoverLocus_set_myPointList_(self, [((OrgGeogebraCommonKernelGeosGeoLocusND *) nil_chk(((OrgGeogebraCommonKernelGeosGeoLocusND *) check_class_cast([p getPath], [OrgGeogebraCommonKernelGeosGeoLocusND class])))) getPoints]);
  }
...
void OrgGeogebraCommonKernelPathMoverLocus_initWithOrgGeogebraCommonKernelGeosGeoLocusND_(OrgGeogebraCommonKernelPathMoverLocus *self, OrgGeogebraCommonKernelGeosGeoLocusND *locus) {
  OrgGeogebraCommonKernelPathMoverGeneric_initWithOrgGeogebraCommonKernelPath_(self, locus);
  OrgGeogebraCommonKernelPathMoverLocus_set_myPointList_(self, [((OrgGeogebraCommonKernelGeosGeoLocusND *) nil_chk(locus)) getPoints]);
}
