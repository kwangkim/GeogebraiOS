...
- (OrgGeogebraCommonKernelMatrixCoords *)getEigenvecWithInt:(jint)i {
  return [new_OrgGeogebraCommonKernelMatrixCoords_initWithDoubleArray_([((OrgGeogebraCommonKernelGeosGeoVec2D *) nil_chk(IOSObjectArray_Get(nil_chk(eigenvec_), i))) getCoords]) autorelease];
}
...
- (void)pointChangedWithOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)P
  ...
  [((OrgGeogebraCommonKernelPathParameter *) nil_chk(pp)) setPathTypeWithInt:type_];
  {
    ...
    switch (type_) {
      ...
      OrgGeogebraCommonKernelKernelNDGeoConicND_getLines(self);
...
- (void)setPointsOnConicWithJavaUtilArrayList:(JavaUtilArrayList *)points {
  OrgGeogebraCommonKernelKernelNDGeoConicND_set_pointsOnConic_(self, points);
}

- (void)addPointOnConicWithOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)pt {
  if (pointsOnConic_ == nil) OrgGeogebraCommonKernelKernelNDGeoConicND_setAndConsume_pointsOnConic_(self, new_JavaUtilArrayList_init());
...
- (void)setWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  ...
  *IOSDoubleArray_GetRef(mu_, 1) = IOSDoubleArray_Get(co->mu_, 1);
  ...
  if (co->singlePoint__ != nil) {
    if (singlePoint__ == nil) OrgGeogebraCommonKernelKernelNDGeoConicND_setAndConsume_singlePoint__(self, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons_));
    [singlePoint__ setCoordsWithOrgGeogebraCommonKernelGeosGeoVec3D:co->singlePoint__];
  }
  if (co->startPoints_ != nil) {
    if (startPoints_ == nil) {
      OrgGeogebraCommonKernelKernelNDGeoConicND_setAndConsume_startPoints_(self, [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonKernelGeosGeoPoint_class_()]);
      for (jint i = 0; i < 2; i++) {
        IOSObjectArray_SetAndConsume(startPoints_, i, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons_));
      }
    }
    for (jint i = 0; i < 2; i++) {
...
- (JavaLangStringBuilder *)buildValueStringWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl
  ...
  *IOSDoubleArray_GetRef(coeffs_, 4) = 2 * IOSDoubleArray_Get(matrix1, 5);
  if ([((OrgGeogebraCommonKernelStringTemplate *) nil_chk(tpl)) hasTypeWithOrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_GIAC()]) {
    ...
    [sb appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) formatWithDouble:IOSDoubleArray_Get(coeffs_, 0) withOrgGeogebraCommonKernelStringTemplate:tpl]];
    [sb appendWithNSString:@")*"];
    [sb appendWithNSString:x];
    [sb appendWithNSString:@"^2+("];
    [sb appendWithNSString:[kernel_ formatWithDouble:IOSDoubleArray_Get(coeffs_, 1) withOrgGeogebraCommonKernelStringTemplate:tpl]];
    [sb appendWithNSString:@")*"];
    [sb appendWithNSString:x];
    [sb appendWithNSString:@"*"];
    [sb appendWithNSString:y];
    [sb appendWithNSString:@"+("];
    [sb appendWithNSString:[kernel_ formatWithDouble:IOSDoubleArray_Get(coeffs_, 2) withOrgGeogebraCommonKernelStringTemplate:tpl]];
    [sb appendWithNSString:@")*"];
    [sb appendWithNSString:y];
    [sb appendWithNSString:@"^2+("];
    [sb appendWithNSString:[kernel_ formatWithDouble:IOSDoubleArray_Get(coeffs_, 3) withOrgGeogebraCommonKernelStringTemplate:tpl]];
    [sb appendWithNSString:@")*"];
    [sb appendWithNSString:x];
    [sb appendWithNSString:@"+("];
    [sb appendWithNSString:[kernel_ formatWithDouble:IOSDoubleArray_Get(coeffs_, 4) withOrgGeogebraCommonKernelStringTemplate:tpl]];
    [sb appendWithNSString:@")*"];
    [sb appendWithNSString:y];
    [sb appendWithNSString:@"="];
    [sb appendWithNSString:[kernel_ formatWithDouble:-IOSDoubleArray_Get(coeffs_, 5) withOrgGeogebraCommonKernelStringTemplate:tpl]];
    return sb;
  }
  ...
  switch (toStringMode_) {
    ...
    switch (type_) {
      ...
      if (OrgGeogebraCommonKernelKernel_isZeroWithDouble_(IOSDoubleArray_Get(coeffs_, 1))) {
        ...
        [sbToValueString appendWithNSString:@" / "];
        [sbToValueString appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) formatWithDouble:coeff0 * coeff0 withOrgGeogebraCommonKernelStringTemplate:tpl]];
        [sbToValueString appendWithNSString:@" + "];
        ...
        [sbToValueString appendWithNSString:@" / "];
        [sbToValueString appendWithNSString:[kernel_ formatWithDouble:coeff1 * coeff1 withOrgGeogebraCommonKernelStringTemplate:tpl]];
      ...
      if (OrgGeogebraCommonKernelKernel_isZeroWithDouble_(IOSDoubleArray_Get(coeffs_, 1))) {
        ...
        [sbToValueString appendWithNSString:@" / "];
        [sbToValueString appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) formatWithDouble:IOSDoubleArray_Get(nil_chk(halfAxes_), 0) * IOSDoubleArray_Get(halfAxes_, 0) withOrgGeogebraCommonKernelStringTemplate:tpl]];
        [sbToValueString appendWithNSString:@" - "];
        ...
        [sbToValueString appendWithNSString:@" / "];
        [sbToValueString appendWithNSString:[kernel_ formatWithDouble:IOSDoubleArray_Get(halfAxes_, 1) * IOSDoubleArray_Get(halfAxes_, 1) withOrgGeogebraCommonKernelStringTemplate:tpl]];
        [sbToValueString appendWithNSString:@" = 1"];
        return sbToValueString;
      }
      return [((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) buildImplicitEquationWithDoubleArray:coeffs_ withNSStringArray:myVars withBoolean:OrgGeogebraCommonKernelKernelNDGeoConicND_KEEP_LEADING_SIGN_ withBoolean:YES withBoolean:NO withChar:'=' withOrgGeogebraCommonKernelStringTemplate:tpl];
...
- (void)getXMLtagsWithJavaLangStringBuilder:(JavaLangStringBuilder *)sb {
  ...
  [sb appendWithNSString:JreStrcat("$DC", @" x0=\"", [((OrgGeogebraCommonKernelGeosGeoVec2D *) nil_chk(IOSObjectArray_Get(nil_chk(eigenvec_), 0))) getX], '"')];
  [sb appendWithNSString:JreStrcat("$DC", @" y0=\"", [((OrgGeogebraCommonKernelGeosGeoVec2D *) nil_chk(IOSObjectArray_Get(eigenvec_, 0))) getY], '"')];
  [sb appendWithNSString:@" z0=\"1.0\""];
  [sb appendWithNSString:JreStrcat("$DC", @" x1=\"", [((OrgGeogebraCommonKernelGeosGeoVec2D *) nil_chk(IOSObjectArray_Get(eigenvec_, 1))) getX], '"')];
  [sb appendWithNSString:JreStrcat("$DC", @" y1=\"", [((OrgGeogebraCommonKernelGeosGeoVec2D *) nil_chk(IOSObjectArray_Get(eigenvec_, 1))) getY], '"')];
...
- (void)toGeoCurveCartesianWithOrgGeogebraCommonKernelGeosGeoCurveCartesian:(OrgGeogebraCommonKernelGeosGeoCurveCartesian *)curve {
  OrgGeogebraCommonKernelArithmeticFunctionVariable *fv = [new_OrgGeogebraCommonKernelArithmeticFunctionVariable_initWithOrgGeogebraCommonKernelKernel_withNSString_(kernel_, @"t") autorelease];
  ...
  if (type_ == OrgGeogebraCommonKernelKernelNDGeoConicNDConstants_CONIC_CIRCLE) {
    ...
    [((OrgGeogebraCommonKernelGeosGeoCurveCartesian *) nil_chk(curve)) setFunctionXWithOrgGeogebraCommonKernelArithmeticFunction:[new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionVariable_(rwX, fv) autorelease]];
    [curve setFunctionYWithOrgGeogebraCommonKernelArithmeticFunction:[new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionVariable_(rwY, fv) autorelease]];
  ...
  if (type_ == OrgGeogebraCommonKernelKernelNDGeoConicNDConstants_CONIC_ELLIPSE) {
    ...
    evY = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, fv, OrgGeogebraCommonPluginOperationEnum_get_SINH(), nil) autorelease], OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY(), [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, IOSDoubleArray_Get(halfAxes_, 1)) autorelease]) autorelease];
    min = -2 * JavaLangMath_PI;
    max = 2 * JavaLangMath_PI;
  }
  else if (type_ == OrgGeogebraCommonKernelKernelNDGeoConicNDConstants_CONIC_PARABOLA) {
    evY = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, fv) autorelease], OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY(), [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, JavaLangMath_sqrtWithDouble_(2 * p_)) autorelease]) autorelease];
    evX = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, fv, OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY(), fv) autorelease];
    min = [((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) getXminForFunctions];
    max = [kernel_ getXmaxForFunctions];
  }
  else return;
  OrgGeogebraCommonKernelArithmeticExpressionNode *rwX = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, evX, OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY(), [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, [((OrgGeogebraCommonKernelGeosGeoVec2D *) nil_chk(IOSObjectArray_Get(nil_chk(eigenvec_), 0))) getX]) autorelease]) autorelease], OrgGeogebraCommonPluginOperationEnum_get_PLUS(), [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, evY, OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY(), [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, [((OrgGeogebraCommonKernelGeosGeoVec2D *) nil_chk(IOSObjectArray_Get(eigenvec_, 0))) getY]) autorelease]) autorelease]) autorelease], OrgGeogebraCommonPluginOperationEnum_get_PLUS(), [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, [((OrgGeogebraCommonKernelGeosGeoVec2D *) nil_chk(b_)) getX]) autorelease]) autorelease];
  OrgGeogebraCommonKernelArithmeticExpressionNode *rwY = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, evX, OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY(), [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, [((OrgGeogebraCommonKernelGeosGeoVec2D *) nil_chk(IOSObjectArray_Get(eigenvec_, 0))) getY]) autorelease]) autorelease], OrgGeogebraCommonPluginOperationEnum_get_PLUS(), [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, evY, OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY(), [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, -[((OrgGeogebraCommonKernelGeosGeoVec2D *) nil_chk(IOSObjectArray_Get(eigenvec_, 0))) getX]) autorelease]) autorelease]) autorelease], OrgGeogebraCommonPluginOperationEnum_get_PLUS(), [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, [b_ getY]) autorelease]) autorelease];
  [((OrgGeogebraCommonKernelGeosGeoCurveCartesian *) nil_chk(curve)) setFunctionXWithOrgGeogebraCommonKernelArithmeticFunction:[new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionVariable_(rwX, fv) autorelease]];
  [curve setFunctionYWithOrgGeogebraCommonKernelArithmeticFunction:[new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionVariable_(rwY, fv) autorelease]];
...
- (jdouble)distanceWithOrgGeogebraCommonKernelGeosGeoPoint:(OrgGeogebraCommonKernelGeosGeoPoint *)pt {
  ...
  OrgGeogebraCommonKernelGeosGeoPoint *closestPoint = [new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withNSString_withDouble_withDouble_withDouble_(cons_, nil, ((OrgGeogebraCommonKernelGeosGeoPoint *) nil_chk(pt))->x_, pt->y_, pt->z_) autorelease];
...
- (void)setLastHitTypeWithOrgGeogebraCommonKernelGeosGeoElement_HitTypeEnum:(OrgGeogebraCommonKernelGeosGeoElement_HitTypeEnum *)type {
  OrgGeogebraCommonKernelKernelNDGeoConicND_set_lastHitType_(self, type);
}
...
- (OrgGeogebraCommonKernelMatrixCoords *)getLabelPosition {
  if (labelPosition_ == nil) {
    OrgGeogebraCommonKernelKernelNDGeoConicND_setAndConsume_labelPosition_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_(0, 0, 1));
    OrgGeogebraCommonKernelKernelNDGeoConicND_setAndConsume_labelParameter_(self, new_OrgGeogebraCommonKernelPathParameter_initWithDouble_(0));
  }
...
- (void)addMetaWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)limitedQuadric {
  if (metas_ == nil) {
    OrgGeogebraCommonKernelKernelNDGeoConicND_setAndConsume_metas_(self, new_JavaUtilTreeSet_init());
  }
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonKernelKernelNDGeoConicND class]) {
    JreStrongAssignAndConsume(&OrgGeogebraCommonKernelKernelNDGeoConicND_vars_, nil, [IOSObjectArray newArrayWithObjects:(id[]){ @"x\u00b2", @"x y", @"y\u00b2", @"x", @"y" } count:5 type:NSString_class_()]);
    JreStrongAssignAndConsume(&OrgGeogebraCommonKernelKernelNDGeoConicND_varsLateX_, nil, [IOSObjectArray newArrayWithObjects:(id[]){ @"x^{2}", @"x y", @"y^{2}", @"x", @"y" } count:5 type:NSString_class_()]);
    JreStrongAssignAndConsume(&OrgGeogebraCommonKernelKernelNDGeoConicND_varsCAS_, nil, [IOSObjectArray newArrayWithObjects:(id[]){ @"x^2", @"x*y", @"y^2", @"x", @"y" } count:5 type:NSString_class_()]);
...
void OrgGeogebraCommonKernelKernelNDGeoConicND_initWithOrgGeogebraCommonKernelConstruction_withInt_(OrgGeogebraCommonKernelKernelNDGeoConicND *self, OrgGeogebraCommonKernelConstruction *c, jint dimension) {
  OrgGeogebraCommonKernelKernelNDGeoConicND_initWithOrgGeogebraCommonKernelConstruction_withInt_withBoolean_(self, c, dimension, NO);
}
...
void OrgGeogebraCommonKernelKernelNDGeoConicND_initWithOrgGeogebraCommonKernelConstruction_withInt_withBoolean_(OrgGeogebraCommonKernelKernelNDGeoConicND *self, OrgGeogebraCommonKernelConstruction *c, jint dimension, jboolean isIntersection) {
  ...
  OrgGeogebraCommonKernelKernelNDGeoConicND_setAndConsume_eigenvec_(self, [IOSObjectArray newArrayWithObjects:(id[]){ [new_OrgGeogebraCommonKernelGeosGeoVec2D_initWithOrgGeogebraCommonKernelKernel_withDouble_withDouble_(self->kernel_, 1, 0) autorelease], [new_OrgGeogebraCommonKernelGeosGeoVec2D_initWithOrgGeogebraCommonKernelKernel_withDouble_withDouble_(self->kernel_, 0, 1) autorelease] } count:2 type:OrgGeogebraCommonKernelGeosGeoVec2D_class_()]);
  OrgGeogebraCommonKernelKernelNDGeoConicND_setAndConsume_b_(self, new_OrgGeogebraCommonKernelGeosGeoVec2D_initWithOrgGeogebraCommonKernelKernel_(self->kernel_));
  self->index_ = 0;
  OrgGeogebraCommonKernelKernelNDGeoConicND_setAndConsume_c_(self, new_OrgGeogebraCommonKernelGeosGeoVec2D_initWithOrgGeogebraCommonKernelKernel_(self->kernel_));
  self->errDetS_ = OrgGeogebraCommonKernelKernel_STANDARD_PRECISION;
  OrgGeogebraCommonKernelKernelNDGeoConicND_setAndConsume_coeffs_(self, [IOSDoubleArray newArrayWithLength:6]);
  self->eigenvectorsSetOnLoad_ = NO;
  self->isEndOfQuadric__ = NO;
  OrgGeogebraCommonKernelKernelNDGeoConicND_set_lastHitType_(self, OrgGeogebraCommonKernelGeosGeoElement_HitTypeEnum_get_NONE());
...
jboolean OrgGeogebraCommonKernelKernelNDGeoConicND_isOnFullConicWithOrgGeogebraCommonKernelMatrixCoords_withDouble_(OrgGeogebraCommonKernelKernelNDGeoConicND *self, OrgGeogebraCommonKernelMatrixCoords *P, jdouble eps) {
  {
    ...
    switch (self->type_) {
      case OrgGeogebraCommonKernelKernelNDGeoConicNDConstants_CONIC_SINGLE_POINT:
      singlePointCoords = [new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_(((OrgGeogebraCommonKernelGeosGeoPoint *) nil_chk(self->singlePoint__))->x_, self->singlePoint__->y_, self->singlePoint__->z_) autorelease];
...
IOSObjectArray *OrgGeogebraCommonKernelKernelNDGeoConicND_getLines(OrgGeogebraCommonKernelKernelNDGeoConicND *self) {
  if (self->lines_ == nil) {
    OrgGeogebraCommonKernelKernelNDGeoConicND_setAndConsume_lines_(self, [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonKernelGeosGeoLine_class_()]);
    IOSObjectArray_SetAndConsume(self->lines_, 0, new_OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelConstruction_(self->cons_));
    IOSObjectArray_SetAndConsume(self->lines_, 1, new_OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelConstruction_(self->cons_));
  }
  return self->lines_;
}
...
id<OrgGeogebraCommonAwtGAffineTransform> OrgGeogebraCommonKernelKernelNDGeoConicND_getAffineTransform(OrgGeogebraCommonKernelKernelNDGeoConicND *self) {
  if (self->transform_ == nil) OrgGeogebraCommonKernelKernelNDGeoConicND_set_transform_(self, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newAffineTransform]);
...
void OrgGeogebraCommonKernelKernelNDGeoConicND_makePathParametersInvalid(OrgGeogebraCommonKernelKernelNDGeoConicND *self) {
  ...
  OrgGeogebraCommonKernelKernelNDGeoConicND_getAffineTransform(self);
  if (self->oldTransform_ == nil) OrgGeogebraCommonKernelKernelNDGeoConicND_set_oldTransform_(self, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newAffineTransform]);
...
void OrgGeogebraCommonKernelKernelNDGeoConicND_singlePoint(OrgGeogebraCommonKernelKernelNDGeoConicND *self) {
  ...
  if (self->singlePoint__ == nil) OrgGeogebraCommonKernelKernelNDGeoConicND_setAndConsume_singlePoint__(self, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(self->cons_));
...
void OrgGeogebraCommonKernelKernelNDGeoConicND_setStartPointsForLines(OrgGeogebraCommonKernelKernelNDGeoConicND *self) {
  if (self->startPoints_ == nil) {
    OrgGeogebraCommonKernelKernelNDGeoConicND_setAndConsume_startPoints_(self, [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonKernelGeosGeoPoint_class_()]);
    for (jint i = 0; i < 2; i++) {
      IOSObjectArray_SetAndConsume(self->startPoints_, i, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(self->cons_));
    }
  }
  for (jint i = 0; i < 2; i++) {
...
void OrgGeogebraCommonKernelKernelNDGeoConicND_polarPointWithDouble_withDouble_withDouble_withOrgGeogebraCommonKernelGeosGeoPoint_(OrgGeogebraCommonKernelKernelNDGeoConicND *self, jdouble x, jdouble y, jdouble z, OrgGeogebraCommonKernelGeosGeoPoint *polar) {
  ...
  if (self->polarMatrix_ == nil) {
    OrgGeogebraCommonKernelKernelNDGeoConicND_setAndConsume_polarMatrix_(self, new_OrgGeogebraCommonUtilGgbMat_initWithInt_withInt_(3, 3));
  }
