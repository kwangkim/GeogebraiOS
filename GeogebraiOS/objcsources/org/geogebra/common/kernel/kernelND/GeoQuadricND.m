...
- (OrgGeogebraCommonKernelMatrixCoordMatrix *)getSymetricMatrixWithDoubleArray:(IOSDoubleArray *)vals {
  if (symetricMatrix_ == nil) {
    OrgGeogebraCommonKernelKernelNDGeoQuadricND_setAndConsume_symetricMatrix_(self, new_OrgGeogebraCommonKernelMatrixCoordMatrix_initWithInt_withInt_(4, 4));
  }
...
- (void)setMatrixFromEigen {
  if (tmpEigenMatrix_ == nil) {
    OrgGeogebraCommonKernelKernelNDGeoQuadricND_setAndConsume_tmpEigenMatrix_(self, new_OrgGeogebraCommonKernelMatrixCoordMatrix_initWithInt_withInt_(4, 4));
  }
...
- (NSString *)toStringWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  ...
  [sbToString appendWithNSString:[((JavaLangStringBuilder *) nil_chk([self buildValueStringWithOrgGeogebraCommonKernelStringTemplate:tpl])) description]];
...
- (void)buildSphereNDStringWithJavaLangStringBuilder:(JavaLangStringBuilder *)sbToValueString
  ...
  for (jint i = 0; i < dimension_; i++) {
    if (OrgGeogebraCommonKernelKernel_isZeroWithDouble_([((OrgGeogebraCommonKernelMatrixCoords *) nil_chk([self getMidpoint])) getWithInt:i + 1])) {
      [((JavaLangStringBuilder *) nil_chk(sbToValueString)) appendWithChar:IOSCharArray_Get(nil_chk(OrgGeogebraCommonKernelKernelNDGeoQuadricND_VAR_STRING_), i)];
      [sbToValueString appendWithNSString:squared];
    }
    else {
      [((JavaLangStringBuilder *) nil_chk(sbToValueString)) appendWithNSString:@"("];
      [sbToValueString appendWithChar:IOSCharArray_Get(nil_chk(OrgGeogebraCommonKernelKernelNDGeoQuadricND_VAR_STRING_), i)];
  ...
  [((JavaLangStringBuilder *) nil_chk(sbToValueString)) appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) formatWithDouble:[self getHalfAxisWithInt:0] * [self getHalfAxisWithInt:0] withOrgGeogebraCommonKernelStringTemplate:tpl]];
}
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonKernelKernelNDGeoQuadricND class]) {
    JreStrongAssignAndConsume(&OrgGeogebraCommonKernelKernelNDGeoQuadricND_VAR_STRING_, nil, [IOSCharArray newArrayWithChars:(jchar[]){ 'x', 'y', 'z' } count:3]);
...
void OrgGeogebraCommonKernelKernelNDGeoQuadricND_initWithOrgGeogebraCommonKernelConstruction_withInt_(OrgGeogebraCommonKernelKernelNDGeoQuadricND *self, OrgGeogebraCommonKernelConstruction *c, jint dimension) {
  OrgGeogebraCommonKernelKernelNDGeoQuadricND_initWithOrgGeogebraCommonKernelConstruction_withInt_withBoolean_(self, c, dimension, NO);
}
...
void OrgGeogebraCommonKernelKernelNDGeoQuadricND_initWithOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonKernelKernelNDGeoQuadricND *self, OrgGeogebraCommonKernelConstruction *c) {
  ...
  self->type_ = -1;
  self->defined_ = YES;
  OrgGeogebraCommonKernelKernelNDGeoQuadricND_setAndConsume_mu_(self, [IOSDoubleArray newArrayWithLength:2]);
  OrgGeogebraCommonKernelKernelNDGeoQuadricND_set_changeableCoordParent_(self, nil);
}
...
void OrgGeogebraCommonKernelKernelNDGeoQuadricND_initWithOrgGeogebraCommonKernelConstruction_withInt_withBoolean_(OrgGeogebraCommonKernelKernelNDGeoQuadricND *self, OrgGeogebraCommonKernelConstruction *c, jint dimension, jboolean isIntersection) {
  ...
  OrgGeogebraCommonKernelKernelNDGeoQuadricND_setAndConsume_matrix_(self, [IOSDoubleArray newArrayWithLength:self->matrixDim_]);
  OrgGeogebraCommonKernelKernelNDGeoQuadricND_setAndConsume_halfAxes_(self, [IOSDoubleArray newArrayWithLength:dimension]);
  OrgGeogebraCommonKernelKernelNDGeoQuadricND_setAndConsume_midpoint_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(dimension + 1));
  [self->midpoint_ setWithInt:dimension + 1 withDouble:1];
  OrgGeogebraCommonKernelKernelNDGeoQuadricND_setAndConsume_eigenval_(self, [IOSDoubleArray newArrayWithLength:dimension + 1]);
  OrgGeogebraCommonKernelKernelNDGeoQuadricND_setAndConsume_mu_(self, [IOSDoubleArray newArrayWithLength:dimension]);
}
...
void OrgGeogebraCommonKernelKernelNDGeoQuadricND_setChangeableCoordParentWithOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelGeosGeoElement_(OrgGeogebraCommonKernelKernelNDGeoQuadricND *self, OrgGeogebraCommonKernelGeosGeoNumeric *number, OrgGeogebraCommonKernelGeosGeoElement *direction) {
  OrgGeogebraCommonKernelKernelNDGeoQuadricND_setAndConsume_changeableCoordParent_(self, new_OrgGeogebraCommonKernelGeosChangeableCoordParent_initWithOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelGeosGeoElement_(self, number, direction));
}
