...
withOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)p {
  ...
  if (didSetIntersectionPointArray_ == nil) {
    OrgGeogebraCommonKernelKernelNDAlgoIntersectND_setAndConsume_didSetIntersectionPointArray_(self, [IOSBooleanArray newArrayWithLength:((IOSObjectArray *) nil_chk(points))->size_]);
  }
    ...
    OrgGeogebraCommonKernelKernelNDAlgoIntersectND_set_didSetIntersectionPointArray_(self, temp);
  }
...
void OrgGeogebraCommonKernelKernelNDAlgoIntersectND_initWithOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonKernelKernelNDAlgoIntersectND *self, OrgGeogebraCommonKernelConstruction *c) {
  OrgGeogebraCommonKernelAlgosAlgoIntersectAbstract_initWithOrgGeogebraCommonKernelConstruction_(self, c);
