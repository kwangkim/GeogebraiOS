...
void OrgGeogebraCommonKernelMacroConstruction_initWithOrgGeogebraCommonKernelMacroKernel_(OrgGeogebraCommonKernelMacroConstruction *self, OrgGeogebraCommonKernelMacroKernel *kernel) {
  OrgGeogebraCommonKernelConstruction_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelConstruction_(self, kernel, [((OrgGeogebraCommonKernelKernel *) nil_chk([((OrgGeogebraCommonKernelMacroKernel *) nil_chk(kernel)) getParentKernel])) getConstruction]);
  self->globalVariableLookup_ = NO;
  OrgGeogebraCommonKernelMacroConstruction_set_parentCons_(self, [((OrgGeogebraCommonKernelKernel *) nil_chk([kernel getParentKernel])) getConstruction]);
  OrgGeogebraCommonKernelMacroConstruction_setAndConsume_reservedLabels_(self, new_JavaUtilHashSet_init());
