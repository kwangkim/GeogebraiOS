...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/ConstructionDefaults.java
//
...
- (void)createDefaultGeoElements {
  OrgGeogebraCommonKernelConstructionDefaults_setAndConsume_defaultGeoElements_(self, new_JavaUtilHashMap_init());
  OrgGeogebraCommonKernelGeosGeoPoint *freePoint = [new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
  ...
  [defaultGeoElements_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_POINT_FREE) withId:freePoint];
  OrgGeogebraCommonKernelGeosGeoPoint *depPoint = [new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
  ...
  [defaultGeoElements_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_POINT_DEPENDENT) withId:depPoint];
  OrgGeogebraCommonKernelGeosGeoPoint *pathPoint = [new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
  ...
  [defaultGeoElements_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_POINT_ON_PATH) withId:pathPoint];
  OrgGeogebraCommonKernelGeosGeoPoint *regionPoint = [new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
  ...
  [defaultGeoElements_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_POINT_IN_REGION) withId:regionPoint];
  OrgGeogebraCommonKernelGeosGeoPoint *complexPoint = [new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
  ...
  [defaultGeoElements_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_POINT_COMPLEX) withId:complexPoint];
  OrgGeogebraCommonKernelGeosGeoLine *line = [new_OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
  ...
  [defaultGeoElements_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_LINE) withId:line];
  OrgGeogebraCommonKernelGeosGeoSegment *seg = [new_OrgGeogebraCommonKernelGeosGeoSegment_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
  ...
  [defaultGeoElements_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_SEGMENT) withId:seg];
  OrgGeogebraCommonKernelGeosGeoRay *ray = [new_OrgGeogebraCommonKernelGeosGeoRay_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
  ...
  [defaultGeoElements_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_RAY) withId:ray];
  OrgGeogebraCommonKernelGeosGeoFunctionNVar *inequality = [new_OrgGeogebraCommonKernelGeosGeoFunctionNVar_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
  ...
  [defaultGeoElements_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_INEQUALITY) withId:inequality];
  OrgGeogebraCommonKernelGeosGeoFunction *inequality1 = [new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
  [inequality1 setDefaultGeoTypeWithInt:OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_INEQUALITY_1VAR];
  [defaultGeoElements_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_INEQUALITY_1VAR) withId:inequality1];
  OrgGeogebraCommonKernelGeosGeoFunctionNVar *functionNV = [new_OrgGeogebraCommonKernelGeosGeoFunctionNVar_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
  ...
  [defaultGeoElements_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_FUNCTION_NVAR) withId:functionNV];
  OrgGeogebraCommonKernelGeosGeoVector *vector = [new_OrgGeogebraCommonKernelGeosGeoVector_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
  ...
  [defaultGeoElements_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_VECTOR) withId:vector];
  OrgGeogebraCommonKernelGeosGeoPolygon *polygon = [new_OrgGeogebraCommonKernelGeosGeoPolygon_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_(cons_, nil) autorelease];
  ...
  [defaultGeoElements_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_POLYGON) withId:polygon];
  OrgGeogebraCommonKernelGeosGeoPolyLine *polyline = [new_OrgGeogebraCommonKernelGeosGeoPolyLine_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
  ...
  [defaultGeoElements_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_POLYLINE) withId:polyline];
  OrgGeogebraCommonKernelGeosGeoConic *conic = [new_OrgGeogebraCommonKernelGeosGeoConic_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
  ...
  [defaultGeoElements_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_CONIC) withId:conic];
  OrgGeogebraCommonKernelGeosGeoConicPart *conicSector = [new_OrgGeogebraCommonKernelGeosGeoConicPart_initWithOrgGeogebraCommonKernelConstruction_withInt_(cons_, OrgGeogebraCommonKernelKernelNDGeoConicNDConstants_CONIC_PART_SECTOR) autorelease];
  ...
  [defaultGeoElements_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_CONIC_SECTOR) withId:conicSector];
  OrgGeogebraCommonKernelGeosGeoNumeric *number = [new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
  ...
  [defaultGeoElements_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_NUMBER) withId:number];
  ...
  [defaultGeoElements_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_ANGLE) withId:angle];
  OrgGeogebraCommonKernelGeosGeoFunction *function = [new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
  ...
  [defaultGeoElements_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_FUNCTION) withId:function];
  OrgGeogebraCommonKernelGeosGeoLocus *locus = [new_OrgGeogebraCommonKernelGeosGeoLocus_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
  ...
  [defaultGeoElements_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_LOCUS) withId:locus];
  OrgGeogebraCommonKernelGeosGeoText *text = [new_OrgGeogebraCommonKernelGeosGeoText_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
  ...
  [defaultGeoElements_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_TEXT) withId:text];
  OrgGeogebraCommonKernelGeosGeoImage *img = [new_OrgGeogebraCommonKernelGeosGeoImage_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
  ...
  [defaultGeoElements_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_IMAGE) withId:img];
  OrgGeogebraCommonKernelGeosGeoBoolean *bool_ = [new_OrgGeogebraCommonKernelGeosGeoBoolean_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
  ...
  [defaultGeoElements_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_BOOLEAN) withId:bool_];
  ...
  [defaultGeoElements_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_LIST) withId:list];
}
...
- (void)getDefaultsXMLWithJavaLangStringBuilder:(JavaLangStringBuilder *)sb2d
  ...
  [((JavaLangStringBuilder *) nil_chk(sb2d)) appendWithNSString:@"<defaults>\n"];
  if (sb3d != nil) {
    ...
    [sb3d appendWithNSString:@"<defaults>\n"];
  }
  for (OrgGeogebraCommonKernelGeosGeoElement * __strong geo in nil_chk([((JavaUtilHashMap *) nil_chk(defaultGeoElements_)) values])) {
  ...
  [sb2d appendWithNSString:@"</defaults>\n</geogebra>"];
  if (sb3d != nil) {
    [sb3d appendWithNSString:@"</defaults>\n</geogebra>"];
  }
}
...
- (void)dealloc {
  ...
  RELEASE_(colorSequence_);
  [super dealloc];
}

+ (void)initialize {
  if (self == [OrgGeogebraCommonKernelConstructionDefaults class]) {
    JreStrongAssign(&OrgGeogebraCommonKernelConstructionDefaults_colPoint_, nil, OrgGeogebraCommonAwtGColor_get_BLUE_());
    JreStrongAssign(&OrgGeogebraCommonKernelConstructionDefaults_colDepPoint_, nil, OrgGeogebraCommonAwtGColor_get_DARK_GRAY_());
    JreStrongAssign(&OrgGeogebraCommonKernelConstructionDefaults_colPathPoint_, nil, OrgGeogebraCommonMainGeoGebraColorConstants_get_LIGHTBLUE_());
    JreStrongAssign(&OrgGeogebraCommonKernelConstructionDefaults_colRegionPoint_, nil, OrgGeogebraCommonKernelConstructionDefaults_colPathPoint_);
    JreStrongAssign(&OrgGeogebraCommonKernelConstructionDefaults_colComplexPoint_, nil, OrgGeogebraCommonKernelConstructionDefaults_colPoint_);
    JreStrongAssign(&OrgGeogebraCommonKernelConstructionDefaults_colLine_, nil, OrgGeogebraCommonAwtGColor_get_BLACK_());
    JreStrongAssign(&OrgGeogebraCommonKernelConstructionDefaults_colInequality_, nil, OrgGeogebraCommonAwtGColor_get_BLUE_());
    JreStrongAssign(&OrgGeogebraCommonKernelConstructionDefaults_colConic_, nil, OrgGeogebraCommonAwtGColor_get_BLACK_());
    JreStrongAssign(&OrgGeogebraCommonKernelConstructionDefaults_colPolygon_, nil, OrgGeogebraCommonMainGeoGebraColorConstants_get_BROWN_());
    JreStrongAssign(&OrgGeogebraCommonKernelConstructionDefaults_colAngle_, nil, OrgGeogebraCommonMainGeoGebraColorConstants_get_DARKGREEN_());
    JreStrongAssign(&OrgGeogebraCommonKernelConstructionDefaults_colLocus_, nil, OrgGeogebraCommonAwtGColor_get_BLACK_());
    JreStrongAssign(&OrgGeogebraCommonKernelConstructionDefaults_colFunction_, nil, OrgGeogebraCommonAwtGColor_get_BLACK_());
    JreStrongAssign(&OrgGeogebraCommonKernelConstructionDefaults_colList_, nil, OrgGeogebraCommonMainGeoGebraColorConstants_get_DARKGREEN_());
    JreStrongAssign(&OrgGeogebraCommonKernelConstructionDefaults_colQuadric_, nil, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newColorWithInt:255 withInt:0 withInt:0]);
    JreStrongAssign(&OrgGeogebraCommonKernelConstructionDefaults_colPreview_, nil, OrgGeogebraCommonAwtGColor_get_DARK_GRAY_());
    JreStrongAssign(&OrgGeogebraCommonKernelConstructionDefaults_colPreviewFill_, nil, [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newColorWithInt:[((OrgGeogebraCommonAwtGColor *) nil_chk(OrgGeogebraCommonKernelConstructionDefaults_colPolygon_)) getRed] withInt:[OrgGeogebraCommonKernelConstructionDefaults_colPolygon_ getGreen] withInt:[OrgGeogebraCommonKernelConstructionDefaults_colPolygon_ getBlue] withInt:J2ObjCFpToInt((OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_POLYGON_ALPHA * 255))]);
...
void OrgGeogebraCommonKernelConstructionDefaults_initWithOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonKernelConstructionDefaults *self, OrgGeogebraCommonKernelConstruction *cons2) {
  ...
  OrgGeogebraCommonKernelConstructionDefaults_set_strFree_(self, @" (free)");
  OrgGeogebraCommonKernelConstructionDefaults_set_strDependent_(self, @" (dependent)");
  self->colorIndex_ = 0;
  OrgGeogebraCommonKernelConstructionDefaults_setAndConsume_colorSequence_(self, [IOSIntArray newArrayWithInts:(jint[]){ (jint) 0x3333CC, (jint) 0x006600, (jint) 0xFF3300, (jint) 0x990066, (jint) 0x9966FF, (jint) 0x339900, (jint) 0xCC0099, (jint) 0x0066FF, (jint) 0x009999, (jint) 0x660000, (jint) 0x333333 } count:11]);
  OrgGeogebraCommonKernelConstructionDefaults_set_cons_(self, cons2);
