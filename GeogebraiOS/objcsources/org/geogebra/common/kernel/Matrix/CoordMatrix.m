...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/kernel/Matrix/CoordMatrix.java
//
...
- (OrgGeogebraCommonKernelMatrixCoordMatrix *)subMatrixWithInt:(jint)i
                                                       withInt:(jint)j {
  OrgGeogebraCommonKernelMatrixCoordMatrix *ret = new_OrgGeogebraCommonKernelMatrixCoordMatrix_initWithInt_withInt_([self getRows] - 1, [self getColumns] - 1);
...
- (OrgGeogebraCommonKernelGeosGeoList *)getGeoListWithOrgGeogebraCommonKernelGeosGeoList:(OrgGeogebraCommonKernelGeosGeoList *)outputList
  ...
  for (jint r = 0; r < rows_; r++) {
    OrgGeogebraCommonKernelGeosGeoList *columnList = new_OrgGeogebraCommonKernelGeosGeoList_initWithOrgGeogebraCommonKernelConstruction_(cons);
    for (jint c = 0; c < columns_; c++) {
      OrgGeogebraCommonKernelGeosGeoNumeric *num = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(cons);
...
- (OrgGeogebraCommonKernelMatrixCoordMatrix *)copy__ {
  OrgGeogebraCommonKernelMatrixCoordMatrix *result = new_OrgGeogebraCommonKernelMatrixCoordMatrix_initWithInt_withInt_([self getRows], [self getColumns]);
...
- (OrgGeogebraCommonKernelMatrixCoordMatrix *)transposeCopy {
  OrgGeogebraCommonKernelMatrixCoordMatrix *result = new_OrgGeogebraCommonKernelMatrixCoordMatrix_initWithInt_withInt_(columns_, rows_);
...
- (OrgGeogebraCommonKernelMatrixCoords *)mulWithOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)v {
  OrgGeogebraCommonKernelMatrixCoords *result = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_([self getRows]);
...
- (OrgGeogebraCommonKernelMatrixCoordMatrix *)mulWithOrgGeogebraCommonKernelMatrixCoordMatrix:(OrgGeogebraCommonKernelMatrixCoordMatrix *)m {
  OrgGeogebraCommonKernelMatrixCoordMatrix *result = new_OrgGeogebraCommonKernelMatrixCoordMatrix_initWithInt_withInt_([self getRows], [((OrgGeogebraCommonKernelMatrixCoordMatrix *) nil_chk(m)) getColumns]);
...
- (OrgGeogebraCommonKernelMatrixCoordMatrix *)inverse {
  if (inverse__ == nil) {
    inverse__ = new_OrgGeogebraCommonKernelMatrixCoordMatrix_initWithInt_withInt_([self getRows], [self getColumns]);
  }
  if (pivotInverseMatrix_ == nil) {
    pivotInverseMatrix_ = new_OrgGeogebraCommonKernelMatrixCoordMatrix_PivotInverseMatrix_init();
    pivotInverseMatrix_->matrixRes_ = [IOSDoubleArray newArrayWithLength:columns_ * columns_];
    for (jint c = 0; c < columns_; c++) {
      *IOSDoubleArray_GetRef(pivotInverseMatrix_->matrixRes_, c * rows_ + c) = 1;
    }
    pivotInverseMatrix_->inverse_ = ((OrgGeogebraCommonKernelMatrixCoordMatrix *) nil_chk(inverse__))->vectors_;
...
- (OrgGeogebraCommonKernelMatrixCoords *)solveWithOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)v {
  OrgGeogebraCommonKernelMatrixCoords *sol = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_([((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(v)) getLength]);
...
- (void)pivotWithOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)sol
  ...
  OrgGeogebraCommonKernelMatrixCoordMatrix_updatePivotMatrix(self);
  if (pivotSolRes_ == nil) {
    pivotSolRes_ = new_OrgGeogebraCommonKernelMatrixCoordMatrix_PivotSolRes_init();
  }
  ((OrgGeogebraCommonKernelMatrixCoordMatrix_PivotSolRes *) nil_chk(pivotSolRes_))->res_ = [IOSDoubleArray newArrayWithLength:[((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(res)) getLength]];
  for (jint r = 0; r < rows_; r++) {
    *IOSDoubleArray_GetRef(pivotSolRes_->res_, r) = IOSDoubleArray_Get(nil_chk(res->val_), r);
  }
  pivotSolRes_->sol_ = ((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(sol))->val_;
...
void OrgGeogebraCommonKernelMatrixCoordMatrix_initWithInt_withInt_withDoubleArray_(OrgGeogebraCommonKernelMatrixCoordMatrix *self, jint rows, jint columns, IOSDoubleArray *val) {
  ...
  self->vectors_ = [IOSObjectArray newArrayWithLength:columns type:OrgGeogebraCommonKernelMatrixCoords_class_()];
  for (jint j = 0; j < columns; j++) {
    (void) IOSObjectArray_Set(self->vectors_, j, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(rows));
...
void OrgGeogebraCommonKernelMatrixCoordMatrix_initialiseWithInt_withInt_(OrgGeogebraCommonKernelMatrixCoordMatrix *self, jint rows, jint columns) {
  ...
  for (jint i = 0; i < columns; i++) {
    (void) IOSObjectArray_Set(self->vectors_, i, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(rows));
  }
}
...
OrgGeogebraCommonKernelMatrixCoordMatrix *OrgGeogebraCommonKernelMatrixCoordMatrix_IdentityWithInt_(jint n) {
  ...
  OrgGeogebraCommonKernelMatrixCoordMatrix *m = new_OrgGeogebraCommonKernelMatrixCoordMatrix_initWithInt_withInt_(n, n);
  for (jint i = 1; i <= n; i++) {
...
OrgGeogebraCommonKernelMatrixCoordMatrix *OrgGeogebraCommonKernelMatrixCoordMatrix_ScaleMatrixWithDoubleArray_(IOSDoubleArray *v) {
  OrgGeogebraCommonKernelMatrixCoordMatrix_initialize();
  return OrgGeogebraCommonKernelMatrixCoordMatrix_ScaleMatrixWithOrgGeogebraCommonKernelMatrixCoords_(new_OrgGeogebraCommonKernelMatrixCoords_initWithDoubleArray_(v));
}
...
OrgGeogebraCommonKernelMatrixCoordMatrix *OrgGeogebraCommonKernelMatrixCoordMatrix_ScaleMatrixWithOrgGeogebraCommonKernelMatrixCoords_(OrgGeogebraCommonKernelMatrixCoords *v) {
  ...
  OrgGeogebraCommonKernelMatrixCoordMatrix *m = new_OrgGeogebraCommonKernelMatrixCoordMatrix_initWithInt_withInt_(n + 1, n + 1);
  for (jint i = 1; i <= n; i++) {
...
OrgGeogebraCommonKernelMatrixCoordMatrix *OrgGeogebraCommonKernelMatrixCoordMatrix_TranslationMatrixWithDoubleArray_(IOSDoubleArray *v) {
  OrgGeogebraCommonKernelMatrixCoordMatrix_initialize();
  return OrgGeogebraCommonKernelMatrixCoordMatrix_TranslationMatrixWithOrgGeogebraCommonKernelMatrixCoords_(new_OrgGeogebraCommonKernelMatrixCoords_initWithDoubleArray_(v));
}
...
OrgGeogebraCommonKernelMatrixCoordMatrix *OrgGeogebraCommonKernelMatrixCoordMatrix_Rotation3DMatrixWithInt_withDouble_(jint axe, jdouble angle) {
  OrgGeogebraCommonKernelMatrixCoordMatrix_initialize();
  OrgGeogebraCommonKernelMatrixCoordMatrix *m = new_OrgGeogebraCommonKernelMatrixCoordMatrix_initWithInt_withInt_(4, 4);
  switch (axe) {
...
void OrgGeogebraCommonKernelMatrixCoordMatrix_solveWithDoubleArray_withOrgGeogebraCommonKernelMatrixCoords_withOrgGeogebraCommonKernelMatrixCoordsArray_(IOSDoubleArray *sol, OrgGeogebraCommonKernelMatrixCoords *res, IOSObjectArray *columns) {
  ...
  IOSObjectArray *matrix = [IOSObjectArray newArrayWithLength:size type:IOSClass_doubleArray(1)];
  for (jint i = 0; i < size; i++) {
    (void) IOSObjectArray_SetAndConsume(matrix, i, [IOSDoubleArray newArrayWithLength:size]);
  ...
  OrgGeogebraCommonKernelMatrixCoordMatrix_PivotSolRes *pivotSolRes = new_OrgGeogebraCommonKernelMatrixCoordMatrix_PivotSolRes_init();
  pivotSolRes->res_ = [IOSDoubleArray newArrayWithLength:size];
  [res copy__WithDoubleArray:pivotSolRes->res_];
  pivotSolRes->sol_ = sol;
...
void OrgGeogebraCommonKernelMatrixCoordMatrix_updatePivotMatrix(OrgGeogebraCommonKernelMatrixCoordMatrix *self) {
  if (self->pivotMatrix_ == nil) {
    self->pivotMatrix_ = [IOSObjectArray newArrayWithLength:self->columns_ type:IOSClass_doubleArray(1)];
  }
  for (jint c = 0; c < self->columns_; c++) {
    (void) IOSObjectArray_SetAndConsume(nil_chk(self->pivotMatrix_), c, [IOSDoubleArray newArrayWithLength:self->rows_]);
...
void OrgGeogebraCommonKernelMatrixCoordMatrix_pivotWithDoubleArray2_withOrgGeogebraCommonKernelMatrixCoordMatrix_PivotInterface_withInt_withJavaUtilArrayList_(IOSObjectArray *matrix, id<OrgGeogebraCommonKernelMatrixCoordMatrix_PivotInterface> psr, jint step, JavaUtilArrayList *stack) {
  ...
  if (step == 0) {
    ...
    (void) [stack removeWithInt:stackIndex];
...
void OrgGeogebraCommonKernelMatrixCoordMatrix_test() {
  OrgGeogebraCommonKernelMatrixCoordMatrix_initialize();
  OrgGeogebraCommonKernelMatrixCoordMatrix *matrix = new_OrgGeogebraCommonKernelMatrixCoordMatrix4x4_init();
  [matrix setVxWithOrgGeogebraCommonKernelMatrixCoords:new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_(1, 1, -1, 0)];
  [matrix setVyWithOrgGeogebraCommonKernelMatrixCoords:new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_(-1, 1, -1, 0)];
  [matrix setVzWithOrgGeogebraCommonKernelMatrixCoords:new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_(1, 2, 5, 0)];
  [matrix setOriginWithOrgGeogebraCommonKernelMatrixCoords:new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_(4, 5, 6, 1)];
  ...
  matrix->pivotInverseMatrix_ = new_OrgGeogebraCommonKernelMatrixCoordMatrix_PivotInverseMatrix_init();
  matrix->pivotInverseMatrix_->matrixRes_ = [IOSDoubleArray newArrayWithLength:4 * 4];
  for (jint c = 0; c < 4; c++) {
    *IOSDoubleArray_GetRef(matrix->pivotInverseMatrix_->matrixRes_, c * 4 + c) = 1;
  }
  matrix->pivotInverseMatrix_->inverse_ = ((OrgGeogebraCommonKernelMatrixCoordMatrix *) nil_chk(matrix->inverse__))->vectors_;
  matrix->pivotInverseMatrix_->columns_ = [matrix getColumns];
  IOSObjectArray *matrixD = [IOSObjectArray newArrayWithLength:matrix->columns_ type:IOSClass_doubleArray(1)];
  for (jint c = 0; c < matrix->columns_; c++) {
    (void) IOSObjectArray_SetAndConsume(matrixD, c, [IOSDoubleArray newArrayWithLength:matrix->rows_]);
