...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/Matrix/CoordSys.java
//
...
- (void)setWithOrgGeogebraCommonKernelMatrixCoordSys:(OrgGeogebraCommonKernelMatrixCoordSys *)cs {
  ...
  if (drawingMatrix_ == nil) OrgGeogebraCommonKernelMatrixCoordSys_setAndConsume_drawingMatrix_(self, new_OrgGeogebraCommonKernelMatrixCoordMatrix4x4_init());
...
- (OrgGeogebraCommonKernelMatrixCoords *)getPointForDrawingWithDouble:(jdouble)x
                                                           withDouble:(jdouble)y {
  return [((OrgGeogebraCommonKernelMatrixCoordMatrix4x4 *) nil_chk(drawingMatrix_)) mulWithOrgGeogebraCommonKernelMatrixCoords:[new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_(x, y, 0, 1) autorelease]];
}
...
- (void)completeCoordSys2D {
  {
    ...
    switch ([self getMadeCoordSys]) {
      ...
      case 1:
      vx = [self getVx];
      if (OrgGeogebraCommonKernelKernel_isZeroWithDouble_([((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(vx)) getX])) [self addVectorWithoutCheckMadeCoordSysWithOrgGeogebraCommonKernelMatrixCoords:[new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_(0, -[vx getZ], [vx getY], 0) autorelease]];
      else [self addVectorWithoutCheckMadeCoordSysWithOrgGeogebraCommonKernelMatrixCoords:[new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_(-[vx getY], [vx getX], 0, 0) autorelease]];
      break;
    }
  }
}
...
- (jboolean)makeOrthoMatrixWithBoolean:(jboolean)projectOrigin
  ...
  if (dimension_ == 1) {
    OrgGeogebraCommonKernelMatrixCoords *vy = [([new_OrgGeogebraCommonKernelMatrixCoords_initWithDoubleArray_([IOSDoubleArray arrayWithDoubles:(jdouble[]){ 0, 0, 1, 0 } count:4]) autorelease]) crossProductWithOrgGeogebraCommonKernelMatrixCoords:[self getVx]];
    if ([((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(vy)) equalsForKernelWithDouble:0 withDouble:OrgGeogebraCommonKernelKernel_STANDARD_PRECISION]) {
      [self setVyWithOrgGeogebraCommonKernelMatrixCoords:[new_OrgGeogebraCommonKernelMatrixCoords_initWithDoubleArray_([IOSDoubleArray arrayWithDoubles:(jdouble[]){ 1, 0, 0, 0 } count:4]) autorelease]];
      [self setVzWithOrgGeogebraCommonKernelMatrixCoords:[new_OrgGeogebraCommonKernelMatrixCoords_initWithDoubleArray_([IOSDoubleArray arrayWithDoubles:(jdouble[]){ 0, 1, 0, 0 } count:4]) autorelease]];
    }
    else {
    ...
    [((OrgGeogebraCommonKernelMatrixCoordMatrix4x4 *) nil_chk(matrixOrthonormal_)) setWithOrgGeogebraCommonKernelMatrixCoordsArray:[IOSObjectArray arrayWithObjects:(id[]){ [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk([self getVx])) normalized], [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk([self getVy])) normalized], [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk([self getVz])) normalized], tmpCoords1_ } count:4 type:OrgGeogebraCommonKernelMatrixCoords_class_()]];
    return YES;
  }
  if (dimension_ == 2) {
    OrgGeogebraCommonKernelMatrixCoords *vx, *vy, *vz;
    if (firstVectorParallelToXOY) {
      vz = [new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_(0, 0, 1, 0) autorelease];
      ...
      if (![((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(vx)) equalsForKernelWithDouble:0 withDouble:OrgGeogebraCommonKernelKernel_STANDARD_PRECISION]) {
        ...
        [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(vy)) normalize];
        vz = [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk([self getVz])) normalized];
      }
      else {
        vx = [new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_(1, 0, 0, 0) autorelease];
        vy = [new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_(0, 1, 0, 0) autorelease];
      }
    }
    else {
...
- (void)setSimpleCoordSysWithOriginWithOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)m {
  ...
  OrgGeogebraCommonKernelMatrixCoordSys_set_matrixOrthonormal_(self, OrgGeogebraCommonKernelMatrixCoordMatrix4x4_Identity());
  ...
  OrgGeogebraCommonKernelMatrixCoordSys_set_drawingMatrix_(self, OrgGeogebraCommonKernelMatrixCoordMatrix4x4_Identity());
...
withOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)center {
  if (tempMatrix3x3_ == nil) {
    OrgGeogebraCommonKernelMatrixCoordSys_setAndConsume_tempMatrix3x3_(self, new_OrgGeogebraCommonKernelMatrixCoordMatrix_initWithInt_withInt_(3, 3));
  }
  ...
  OrgGeogebraCommonKernelMatrixCoords *o = [((OrgGeogebraCommonKernelMatrixCoordMatrix4x4 *) nil_chk(matrixOrthonormal_)) getOrigin];
  OrgGeogebraCommonKernelMatrixCoordSys_set_matrixOrthonormal_(self, [((OrgGeogebraCommonKernelMatrixCoordMatrix *) nil_chk(tempMatrix3x3_)) mul3x3WithOrgGeogebraCommonKernelMatrixCoordMatrix:matrixOrthonormal_]);
...
- (void)rotateWithOrgGeogebraCommonKernelMatrixCoordMatrix:(OrgGeogebraCommonKernelMatrixCoordMatrix *)rot
  ...
  OrgGeogebraCommonKernelMatrixCoords *vz = [new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4) autorelease];
...
withOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)point {
  ...
  [self setOriginWithOrgGeogebraCommonKernelMatrixCoords:newOrigin];
  if (r < 0) {
    [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk([self getVx])) mulInsideWithDouble:-1];
  }
  if (dimension_ == 2) {
    if (r < 0) {
      [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk([self getVy])) mulInsideWithDouble:-1];
      [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk([self getVz])) mulInsideWithDouble:-1];
    }
    OrgGeogebraCommonKernelMatrixCoordSys_setDrawingMatrixFromMatrixOrthonormal(self);
  }
}
...
- (void)updateToContainPointWithOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)point {
  ...
  [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(tmpCoords1_)) setSubWithOrgGeogebraCommonKernelMatrixCoords:point withOrgGeogebraCommonKernelMatrixCoords:tmpCoords1_];
...
- (void)updateContinuousPointVxWithOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)point
  ...
  [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(point)) projectPlaneWithOrgGeogebraCommonKernelMatrixCoordMatrix:matrixOrthonormal_ withOrgGeogebraCommonKernelMatrixCoords:tmpCoords1_];
  [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(tmpCoords1_)) setSubWithOrgGeogebraCommonKernelMatrixCoords:point withOrgGeogebraCommonKernelMatrixCoords:tmpCoords1_];
  [tmpCoords1_ setAddWithOrgGeogebraCommonKernelMatrixCoords:tmpCoords1_ withOrgGeogebraCommonKernelMatrixCoords:[((OrgGeogebraCommonKernelMatrixCoordMatrix4x4 *) nil_chk(matrixOrthonormal_)) getOrigin]];
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonKernelMatrixCoordSys class]) {
    {
      JreStrongAssignAndConsume(&OrgGeogebraCommonKernelMatrixCoordSys_Identity3D_, nil, new_OrgGeogebraCommonKernelMatrixCoordSys_initWithInt_(2));
      [OrgGeogebraCommonKernelMatrixCoordSys_Identity3D_ makeCoordSysWithDoubleArray:[IOSDoubleArray arrayWithDoubles:(jdouble[]){ 0, 0, 1, 0 } count:4]];
...
void OrgGeogebraCommonKernelMatrixCoordSys_initWithInt_(OrgGeogebraCommonKernelMatrixCoordSys *self, jint dimension) {
  ...
  OrgGeogebraCommonKernelMatrixCoordSys_setAndConsume_tmpCoords1_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4));
  OrgGeogebraCommonKernelMatrixCoordSys_setAndConsume_tmpCoords2_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4));
  OrgGeogebraCommonKernelMatrixCoordSys_setAndConsume_tmpCoords3_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4));
  OrgGeogebraCommonKernelMatrixCoordSys_setAndConsume_tmpCoords4_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4));
  OrgGeogebraCommonKernelMatrixCoordSys_setAndConsume_matrix_(self, new_OrgGeogebraCommonKernelMatrixCoordMatrix_initWithInt_withInt_(4, 4));
  OrgGeogebraCommonKernelMatrixCoordSys_setAndConsume_matrixOrthonormal_(self, new_OrgGeogebraCommonKernelMatrixCoordMatrix4x4_init());
  OrgGeogebraCommonKernelMatrixCoordSys_setAndConsume_drawingMatrix_(self, new_OrgGeogebraCommonKernelMatrixCoordMatrix4x4_init());
  self->dimension_ = dimension;
  OrgGeogebraCommonKernelMatrixCoordSys_setAndConsume_origin_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(self->spaceDimension_ + 1));
  [self->origin_ setWithInt:self->spaceDimension_ + 1 withDouble:1];
  OrgGeogebraCommonKernelMatrixCoordSys_setAndConsume_vectors_(self, [IOSObjectArray newArrayWithLength:self->spaceDimension_ type:OrgGeogebraCommonKernelMatrixCoords_class_()]);
  for (jint i = 0; i < self->spaceDimension_; i++) {
    IOSObjectArray_SetAndConsume(self->vectors_, i, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(self->spaceDimension_ + 1));
  }
  OrgGeogebraCommonKernelMatrixCoordSys_setAndConsume_equationVector_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(self->spaceDimension_ + 1));
  [self resetCoordSys];
}
...
void OrgGeogebraCommonKernelMatrixCoordSys_checkEquationVectorHasJustOneNegativeCoeff(OrgGeogebraCommonKernelMatrixCoordSys *self) {
  ...
  if (zeros == 2 && negative) {
    [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(self->equationVector_)) mulInsideWithDouble:-1];
  }
}
