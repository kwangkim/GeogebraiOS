...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/javasources/org/geogebra/common/kernel/statistics/AlgoFit.java
//
...
void OrgGeogebraCommonKernelStatisticsAlgoFit_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelGeosGeoList_(OrgGeogebraCommonKernelStatisticsAlgoFit *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelGeosGeoList *pointlist, OrgGeogebraCommonKernelGeosGeoList *functionlist) {
  ...
  OrgGeogebraCommonKernelStatisticsAlgoFit_set_functionarray_(self, nil);
  OrgGeogebraCommonKernelStatisticsAlgoFit_set_M_(self, nil);
  OrgGeogebraCommonKernelStatisticsAlgoFit_set_Y_(self, nil);
  OrgGeogebraCommonKernelStatisticsAlgoFit_set_P_(self, nil);
  OrgGeogebraCommonKernelStatisticsAlgoFit_set_pointlist_(self, pointlist);
  OrgGeogebraCommonKernelStatisticsAlgoFit_set_functionlist_(self, functionlist);
  OrgGeogebraCommonKernelStatisticsAlgoFit_setAndConsume_fitfunction_(self, new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  OrgGeogebraCommonKernelStatisticsAlgoFit_compute(self);
...
void OrgGeogebraCommonKernelStatisticsAlgoFit_compute(OrgGeogebraCommonKernelStatisticsAlgoFit *self) {
  ...
  OrgGeogebraCommonKernelStatisticsAlgoFit_setAndConsume_functionarray_(self, [IOSObjectArray newArrayWithLength:self->functionsize_ type:OrgGeogebraCommonKernelGeosGeoFunctionable_class_()]);
  OrgGeogebraCommonKernelStatisticsAlgoFit_setAndConsume_M_(self, new_OrgApacheCommonsMathLinearArray2DRowRealMatrix_initWithInt_withInt_(self->datasize_, self->functionsize_));
  OrgGeogebraCommonKernelStatisticsAlgoFit_setAndConsume_Y_(self, new_OrgApacheCommonsMathLinearArray2DRowRealMatrix_initWithInt_withInt_(self->datasize_, 1));
  OrgGeogebraCommonKernelStatisticsAlgoFit_setAndConsume_P_(self, new_OrgApacheCommonsMathLinearArray2DRowRealMatrix_initWithInt_withInt_(self->functionsize_, 1));
  ...
  @try {
    ...
    if ([((id<OrgApacheCommonsMathLinearDecompositionSolver>) nil_chk(solver)) isNonSingular]) {
      OrgGeogebraCommonKernelStatisticsAlgoFit_set_P_(self, [solver solveWithOrgApacheCommonsMathLinearRealMatrix:self->Y_]);
      OrgGeogebraCommonKernelStatisticsAlgoFit_set_fitfunction_(self, OrgGeogebraCommonKernelStatisticsAlgoFit_makeFunction(self));
    }
    else {
      [((OrgGeogebraCommonKernelGeosGeoFunction *) nil_chk(self->fitfunction_)) setUndefined];
    }
...
jboolean OrgGeogebraCommonKernelStatisticsAlgoFit_makeMatrixes(OrgGeogebraCommonKernelStatisticsAlgoFit *self) {
  ...
  for (jint i = 0; i < self->functionsize_; i++) {
    ...
    IOSObjectArray_Set(nil_chk(self->functionarray_), i, (id<OrgGeogebraCommonKernelGeosGeoFunctionable>) check_protocol_cast([self->functionlist_ getWithInt:i], @protocol(OrgGeogebraCommonKernelGeosGeoFunctionable)));
  }
  OrgGeogebraCommonKernelStatisticsAlgoFit_setAndConsume_M_(self, new_OrgApacheCommonsMathLinearArray2DRowRealMatrix_initWithInt_withInt_(self->datasize_, self->functionsize_));
  OrgGeogebraCommonKernelStatisticsAlgoFit_setAndConsume_Y_(self, new_OrgApacheCommonsMathLinearArray2DRowRealMatrix_initWithInt_withInt_(self->datasize_, 1));
...
OrgGeogebraCommonKernelGeosGeoFunction *OrgGeogebraCommonKernelStatisticsAlgoFit_makeFunction(OrgGeogebraCommonKernelStatisticsAlgoFit *self) {
  ...
  OrgGeogebraCommonKernelGeosGeoFunction *product = [new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_(self->cons_) autorelease];
  ...
  OrgGeogebraCommonKernelStatisticsAlgoFit_set_fitfunction_(self, OrgGeogebraCommonKernelGeosGeoFunction_multWithOrgGeogebraCommonKernelGeosGeoFunction_withDouble_withOrgGeogebraCommonKernelGeosGeoFunction_(self->fitfunction_, p, gf));
  for (jint i = 1; i < self->functionsize_; i++) {
    ...
    OrgGeogebraCommonKernelStatisticsAlgoFit_set_fitfunction_(self, OrgGeogebraCommonKernelGeosGeoFunction_addWithOrgGeogebraCommonKernelGeosGeoFunction_withOrgGeogebraCommonKernelGeosGeoFunction_withOrgGeogebraCommonKernelGeosGeoFunction_(self->fitfunction_, self->fitfunction_, product));
  }
