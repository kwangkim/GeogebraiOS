...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/statistics/AlgoCellRange.java
//
...
- (void)updateListWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo
  ...
  if ([((JavaUtilArrayList *) nil_chk(listItems_)) containsWithId:geo]) {
    ...
    OrgGeogebraCommonKernelStatisticsAlgoCellRange_set_listItems_(self, OrgGeogebraCommonKernelStatisticsAlgoCellRange_initCellRangeListWithOrgGeogebraCommonAwtGPoint_withOrgGeogebraCommonAwtGPoint_(self, startCoords_, endCoords_));
  }
...
- (void)setInputOutput {
  OrgGeogebraCommonKernelStatisticsAlgoCellRange_set_startCoords_(self, OrgGeogebraCommonKernelGeosGeoElementSpreadsheet_getSpreadsheetCoordsForLabelWithNSString_(startCell_));
  OrgGeogebraCommonKernelStatisticsAlgoCellRange_set_endCoords_(self, OrgGeogebraCommonKernelGeosGeoElementSpreadsheet_getSpreadsheetCoordsForLabelWithNSString_(endCell_));
  OrgGeogebraCommonKernelStatisticsAlgoCellRange_set_toStringOutput_(self, JreStrcat("$C$", startCell_, ':', endCell_));
  OrgGeogebraCommonKernelStatisticsAlgoCellRange_setAndConsume_cellRange_(self, new_OrgGeogebraCommonGuiViewSpreadsheetCellRange_initWithOrgGeogebraCommonMainApp_withInt_withInt_withInt_withInt_([((OrgGeogebraCommonKernelConstruction *) nil_chk(cons_)) getApplication], ((OrgGeogebraCommonAwtGPoint *) nil_chk(startCoords_))->x_, startCoords_->y_, ((OrgGeogebraCommonAwtGPoint *) nil_chk(endCoords_))->x_, endCoords_->y_));
  OrgGeogebraCommonKernelStatisticsAlgoCellRange_set_listItems_(self, OrgGeogebraCommonKernelStatisticsAlgoCellRange_initCellRangeListWithOrgGeogebraCommonAwtGPoint_withOrgGeogebraCommonAwtGPoint_(self, startCoords_, endCoords_));
  OrgGeogebraCommonKernelStatisticsAlgoCellRange_setAndConsume_geoList_(self, new_OrgGeogebraCommonKernelGeosGeoListForCellRange_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelStatisticsAlgoCellRange_(cons_, self));
...
- (IOSObjectArray *)getRectangle {
  ...
  IOSObjectArray *ret = [IOSObjectArray arrayWithObjects:(id[]){ startCoords, endCoords } count:2 type:OrgGeogebraCommonAwtGPoint_class_()];
  return ret;
}
...
void OrgGeogebraCommonKernelStatisticsAlgoCellRange_initWithOrgGeogebraCommonKernelConstruction_withNSString_withNSString_withNSString_(OrgGeogebraCommonKernelStatisticsAlgoCellRange *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, NSString *startCell, NSString *endCell) {
  ...
  OrgGeogebraCommonKernelStatisticsAlgoCellRange_set_startCell_(self, startCell);
  OrgGeogebraCommonKernelStatisticsAlgoCellRange_set_endCell_(self, endCell);
  [self setInputOutput];
