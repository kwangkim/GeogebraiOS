...
void OrgGeogebraCommonKernelStatisticsAlgoFitGrowth_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoList_(OrgGeogebraCommonKernelStatisticsAlgoFitGrowth *self, OrgGeogebraCommonKernelConstruction *cons, OrgGeogebraCommonKernelGeosGeoList *geolist) {
  ...
  OrgGeogebraCommonKernelStatisticsAlgoFitGrowth_setAndConsume_regMath_(self, new_OrgGeogebraCommonKernelStatisticsRegressionMath_init());
  OrgGeogebraCommonKernelStatisticsAlgoFitGrowth_set_geolist_(self, geolist);
  OrgGeogebraCommonKernelStatisticsAlgoFitGrowth_setAndConsume_geofunction_(self, new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  OrgGeogebraCommonKernelStatisticsAlgoFitGrowth_compute(self);
}
