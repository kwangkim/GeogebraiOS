...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/statistics/AlgoSample.java
//
...
- (void)setInputOutput {
  OrgGeogebraCommonKernelAlgosAlgoElement_setAndConsume_input_(self, [IOSObjectArray newArrayWithLength:replacement_ == nil ? 2 : 3 type:OrgGeogebraCommonKernelGeosGeoElement_class_()]);
...
void OrgGeogebraCommonKernelStatisticsAlgoSample_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelGeosGeoBoolean_(OrgGeogebraCommonKernelStatisticsAlgoSample *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelGeosGeoList *inputList, id<OrgGeogebraCommonKernelArithmeticNumberValue> num, OrgGeogebraCommonKernelGeosGeoBoolean *replacement) {
  ...
  OrgGeogebraCommonKernelStatisticsAlgoSample_set_inputList_(self, inputList);
  OrgGeogebraCommonKernelStatisticsAlgoSample_set_replacement_(self, replacement);
  OrgGeogebraCommonKernelStatisticsAlgoSample_set_num_(self, num);
  OrgGeogebraCommonKernelStatisticsAlgoSample_setAndConsume_outputList_(self, new_OrgGeogebraCommonKernelGeosGeoList_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  OrgGeogebraCommonKernelStatisticsAlgoSample_compute(self);
