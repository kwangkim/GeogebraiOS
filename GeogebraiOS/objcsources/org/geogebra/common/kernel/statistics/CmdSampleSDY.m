...
- (OrgGeogebraCommonKernelGeosGeoElement *)doCommandWithNSString:(NSString *)a
  ...
  OrgGeogebraCommonKernelStatisticsAlgoListSampleSDY *algo = [new_OrgGeogebraCommonKernelStatisticsAlgoListSampleSDY_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoList_(cons_, a, b) autorelease];
