...
- (void)setInputOutput {
  ...
  IOSObjectArray_Set(input_, 0, [((id<OrgGeogebraCommonKernelArithmeticNumberValue>) nil_chk(v_)) toGeoElement]);
...
- (void)compute {
  ...
  OrgGeogebraCommonKernelArithmeticExpressionNode *vEn = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, v_) autorelease];
  OrgGeogebraCommonKernelArithmeticExpressionNode *xEn = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, x) autorelease];
  OrgGeogebraCommonKernelArithmeticExpressionNode *div = vEn;
  OrgGeogebraCommonKernelArithmeticExpressionNode *pi = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, JavaLangMath_PI) autorelease];
  if (cumulative_ != nil && [cumulative_ getBoolean]) {
    id<OrgGeogebraCommonKernelArithmeticExpressionValue> half = [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, 0.5) autorelease];
    ...
    en = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, half) autorelease];
    ...
    en = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, v_) autorelease];
    OrgGeogebraCommonKernelArithmeticExpressionNode *mult = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, x) autorelease];
  ...
  OrgGeogebraCommonKernelArithmeticFunction *tempFun = [new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionVariable_(en, x) autorelease];
...
void OrgGeogebraCommonKernelStatisticsAlgoTDistributionDF_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticBooleanValue_(OrgGeogebraCommonKernelStatisticsAlgoTDistributionDF *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, id<OrgGeogebraCommonKernelArithmeticNumberValue> mean, id<OrgGeogebraCommonKernelArithmeticBooleanValue> cumulative) {
  OrgGeogebraCommonKernelStatisticsAlgoTDistributionDF_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticBooleanValue_(self, cons, mean, cumulative);
...
void OrgGeogebraCommonKernelStatisticsAlgoTDistributionDF_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticBooleanValue_(OrgGeogebraCommonKernelStatisticsAlgoTDistributionDF *self, OrgGeogebraCommonKernelConstruction *cons, id<OrgGeogebraCommonKernelArithmeticNumberValue> a, id<OrgGeogebraCommonKernelArithmeticBooleanValue> cumulative) {
  ...
  OrgGeogebraCommonKernelStatisticsAlgoTDistributionDF_set_v_(self, a);
  OrgGeogebraCommonKernelStatisticsAlgoTDistributionDF_set_cumulative_(self, cumulative);
  OrgGeogebraCommonKernelStatisticsAlgoTDistributionDF_setAndConsume_ret_(self, new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  [self compute];
}
