...
- (IOSObjectArray *)processWithOrgGeogebraCommonKernelArithmeticCommand:(OrgGeogebraCommonKernelArithmeticCommand *)c {
  ...
  IOSObjectArray *arg;
  {
    ...
    switch (n) {
        ...
        if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(geo)) isGeoLocus]) {
          ...
          for (jint i = 0; i < length; i++) {
            ...
            @try {
              ...
              [((OrgGeogebraCommonKernelGeosGeoElementSpreadsheet *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk(kernelA_)) getGeoElementSpreadsheet])) setSpreadsheetCellWithOrgGeogebraCommonMainApp:app_ withInt:row withInt:minCol withOrgGeogebraCommonKernelGeosGeoElement:new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons_, ((OrgGeogebraCommonKernelMyPoint *) nil_chk(p))->x_)];
              [((OrgGeogebraCommonKernelGeosGeoElementSpreadsheet *) nil_chk([kernelA_ getGeoElementSpreadsheet])) setSpreadsheetCellWithOrgGeogebraCommonMainApp:app_ withInt:row withInt:minCol + 1 withOrgGeogebraCommonKernelGeosGeoElement:new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons_, p->y_)];
            }
      ...
      {
        (void) [((OrgGeogebraCommonKernelKernel *) nil_chk([app_ getKernel])) getGeoElementSpreadsheet];
      ...
      ret = [IOSObjectArray newArrayWithObjects:(id[]){  } count:0 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
      [app_ storeUndoInfo];
      [app_ setScrollToShowWithBoolean:YES];
      return ret;
      default:
