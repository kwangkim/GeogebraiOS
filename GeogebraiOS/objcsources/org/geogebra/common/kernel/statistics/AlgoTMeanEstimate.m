...
void OrgGeogebraCommonKernelStatisticsAlgoTMeanEstimate_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelGeosGeoNumeric_(OrgGeogebraCommonKernelStatisticsAlgoTMeanEstimate *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelGeosGeoList *geoList, OrgGeogebraCommonKernelGeosGeoNumeric *geoLevel) {
  ...
  OrgGeogebraCommonKernelStatisticsAlgoTMeanEstimate_set_geoList_(self, geoList);
  OrgGeogebraCommonKernelStatisticsAlgoTMeanEstimate_set_geoLevel_(self, geoLevel);
  OrgGeogebraCommonKernelStatisticsAlgoTMeanEstimate_set_geoMean_(self, nil);
  OrgGeogebraCommonKernelStatisticsAlgoTMeanEstimate_set_geoSD_(self, nil);
  OrgGeogebraCommonKernelStatisticsAlgoTMeanEstimate_set_geoN_(self, nil);
  OrgGeogebraCommonKernelStatisticsAlgoTMeanEstimate_setAndConsume_result_(self, new_OrgGeogebraCommonKernelGeosGeoList_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  OrgGeogebraCommonKernelStatisticsAlgoTMeanEstimate_compute(self);
...
void OrgGeogebraCommonKernelStatisticsAlgoTMeanEstimate_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelGeosGeoNumeric_(OrgGeogebraCommonKernelStatisticsAlgoTMeanEstimate *self, OrgGeogebraCommonKernelConstruction *cons, OrgGeogebraCommonKernelGeosGeoNumeric *geoMean, OrgGeogebraCommonKernelGeosGeoNumeric *geoSD, OrgGeogebraCommonKernelGeosGeoNumeric *geoN, OrgGeogebraCommonKernelGeosGeoNumeric *geoLevel) {
  OrgGeogebraCommonKernelAlgosAlgoElement_initWithOrgGeogebraCommonKernelConstruction_(self, cons);
  OrgGeogebraCommonKernelStatisticsAlgoTMeanEstimate_set_geoList_(self, nil);
  OrgGeogebraCommonKernelStatisticsAlgoTMeanEstimate_set_geoLevel_(self, geoLevel);
  OrgGeogebraCommonKernelStatisticsAlgoTMeanEstimate_set_geoMean_(self, geoMean);
  OrgGeogebraCommonKernelStatisticsAlgoTMeanEstimate_set_geoSD_(self, geoSD);
  OrgGeogebraCommonKernelStatisticsAlgoTMeanEstimate_set_geoN_(self, geoN);
  OrgGeogebraCommonKernelStatisticsAlgoTMeanEstimate_setAndConsume_result_(self, new_OrgGeogebraCommonKernelGeosGeoList_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  OrgGeogebraCommonKernelStatisticsAlgoTMeanEstimate_compute(self);
}
...
jdouble OrgGeogebraCommonKernelStatisticsAlgoTMeanEstimate_getMarginOfErrorWithDouble_withDouble_withDouble_(OrgGeogebraCommonKernelStatisticsAlgoTMeanEstimate *self, jdouble sd, jdouble n, jdouble confLevel) {
  OrgGeogebraCommonKernelStatisticsAlgoTMeanEstimate_setAndConsume_tDist_(self, new_OrgApacheCommonsMathDistributionTDistributionImpl_initWithDouble_(n - 1));
...
void OrgGeogebraCommonKernelStatisticsAlgoTMeanEstimate_compute(OrgGeogebraCommonKernelStatisticsAlgoTMeanEstimate *self) {
  @try {
    if (((IOSObjectArray *) nil_chk(self->input_))->size_ == 2) {
      ...
      OrgGeogebraCommonKernelStatisticsAlgoTMeanEstimate_setAndConsume_val_(self, [IOSDoubleArray newArrayWithLength:size]);
      ...
      OrgGeogebraCommonKernelStatisticsAlgoTMeanEstimate_setAndConsume_stats_(self, new_OrgApacheCommonsMathStatDescriptiveSummaryStatistics_init());
    ...
    [self->result_ addWithOrgGeogebraCommonKernelGeosGeoElement:[new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(self->cons_, self->mean_ - self->me_) autorelease]];
    [self->result_ addWithOrgGeogebraCommonKernelGeosGeoElement:[new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(self->cons_, self->mean_ + self->me_) autorelease]];
