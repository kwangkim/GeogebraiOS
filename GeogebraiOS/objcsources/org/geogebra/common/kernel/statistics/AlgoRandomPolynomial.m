...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/kernel/statistics/AlgoRandomPolynomial.java
//
...
- (void)compute {
  ...
  OrgGeogebraCommonKernelArithmeticExpressionNode *varExpr = new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, fv_);
...
void OrgGeogebraCommonKernelStatisticsAlgoRandomPolynomial_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_(OrgGeogebraCommonKernelStatisticsAlgoRandomPolynomial *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, id<OrgGeogebraCommonKernelArithmeticNumberValue> degree, id<OrgGeogebraCommonKernelArithmeticNumberValue> min, id<OrgGeogebraCommonKernelArithmeticNumberValue> max) {
  ...
  self->f_ = new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionVariable_(new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self->kernel_, self->fv_), self->fv_);
  self->polynomial_ = new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_(cons);
  [self setInputOutput];
  [self compute];
...
OrgGeogebraCommonKernelArithmeticExpressionNode *OrgGeogebraCommonKernelStatisticsAlgoRandomPolynomial_randomCoefWithBoolean_(OrgGeogebraCommonKernelStatisticsAlgoRandomPolynomial *self, jboolean acceptZero) {
  ...
  if (acceptZero || JavaLangMath_signumWithDouble_(maxD) == JavaLangMath_signumWithDouble_(minD)) {
    return new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, [((OrgGeogebraCommonMainApp *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) getApplication])) getRandomIntegerBetweenWithDouble:minD withDouble:maxD]);
  }
  ...
  return new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, rnd >= 0 ? rnd + 1 : rnd);
}
