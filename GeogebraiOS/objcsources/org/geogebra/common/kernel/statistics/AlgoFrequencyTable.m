...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/kernel/statistics/AlgoFrequencyTable.java
//
...
- (void)setInputOutput {
  {
    ...
    switch ([type_ ordinal]) {
      ...
      (void) IOSObjectArray_Set(input_, 0, chart_);
      break;
...
void OrgGeogebraCommonKernelStatisticsAlgoFrequencyTable_createTable(OrgGeogebraCommonKernelStatisticsAlgoFrequencyTable *self) {
  self->table_ = new_OrgGeogebraCommonKernelGeosGeoText_initWithOrgGeogebraCommonKernelConstruction_(self->cons_);
...
void OrgGeogebraCommonKernelStatisticsAlgoFrequencyTable_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoBoolean_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelGeosGeoBoolean_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelGeosGeoNumeric_(OrgGeogebraCommonKernelStatisticsAlgoFrequencyTable *self, OrgGeogebraCommonKernelConstruction *cons, OrgGeogebraCommonKernelGeosGeoBoolean *isCumulative, OrgGeogebraCommonKernelGeosGeoList *classList, OrgGeogebraCommonKernelGeosGeoList *dataList, OrgGeogebraCommonKernelGeosGeoBoolean *useDensity, OrgGeogebraCommonKernelGeosGeoNumeric *density, OrgGeogebraCommonKernelGeosGeoNumeric *scale_) {
  ...
  self->scale__ = scale_;
  self->freq_ = new_OrgGeogebraCommonKernelStatisticsAlgoFrequency_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoBoolean_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelGeosGeoBoolean_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelGeosGeoNumeric_(cons, isCumulative, classList, dataList, useDensity, density, scale_);
  ...
  OrgGeogebraCommonKernelStatisticsAlgoFrequencyTable_createTable(self);
  self->type_ = OrgGeogebraCommonKernelStatisticsAlgoFrequencyTable_inputTypeEnum_get_STANDARD();
  [self setInputOutput];
  OrgGeogebraCommonKernelStatisticsAlgoFrequencyTable_compute(self);
...
void OrgGeogebraCommonKernelStatisticsAlgoFrequencyTable_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoNumeric_(OrgGeogebraCommonKernelStatisticsAlgoFrequencyTable *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelGeosGeoNumeric *chart) {
  (void) OrgGeogebraCommonKernelStatisticsAlgoFrequencyTable_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoNumeric_(self, cons, chart);
  [((OrgGeogebraCommonKernelGeosGeoText *) nil_chk(self->table_)) setLabelWithNSString:label];
}
...
void OrgGeogebraCommonKernelStatisticsAlgoFrequencyTable_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoNumeric_(OrgGeogebraCommonKernelStatisticsAlgoFrequencyTable *self, OrgGeogebraCommonKernelConstruction *cons, OrgGeogebraCommonKernelGeosGeoNumeric *chart) {
  ...
  if ([algo isKindOfClass:[OrgGeogebraCommonKernelStatisticsAlgoHistogram class]]) {
    self->type_ = OrgGeogebraCommonKernelStatisticsAlgoFrequencyTable_inputTypeEnum_get_HISTOGRAM();
  }
  else {
    self->type_ = OrgGeogebraCommonKernelStatisticsAlgoFrequencyTable_inputTypeEnum_get_BARCHART();
  }
  self->chart_ = chart;
  OrgGeogebraCommonKernelStatisticsAlgoFrequencyTable_createTable(self);
  [self setInputOutput];
...
void OrgGeogebraCommonKernelStatisticsAlgoFrequencyTable_compute(OrgGeogebraCommonKernelStatisticsAlgoFrequencyTable *self) {
  {
    ...
    switch ([self->type_ ordinal]) {
      ...
      self->strHeader_ = [IOSObjectArray newArrayWithLength:2 type:NSString_class_()];
      (void) IOSObjectArray_Set(self->strHeader_, 0, [((OrgGeogebraCommonMainLocalization *) nil_chk([self getLoc])) getMenuWithNSString:@"Interval"]);
      if ([((OrgGeogebraCommonKernelStatisticsAlgoHistogram *) nil_chk(algoHistogram)) getUseDensityGeo] != nil && [((OrgGeogebraCommonKernelGeosGeoBoolean *) nil_chk(((OrgGeogebraCommonKernelGeosGeoBoolean *) check_class_cast([algoHistogram getUseDensityGeo], [OrgGeogebraCommonKernelGeosGeoBoolean class])))) getBoolean]) {
        (void) IOSObjectArray_Set(self->strHeader_, 1, [((OrgGeogebraCommonMainLocalization *) nil_chk([self getLoc])) getMenuWithNSString:@"Frequency"]);
      }
      else {
        (void) IOSObjectArray_Set(self->strHeader_, 1, [((OrgGeogebraCommonMainLocalization *) nil_chk([self getLoc])) getMenuWithNSString:@"Count"]);
      }
      leftBorder = [algoHistogram getLeftBorder];
      f = [algoHistogram getYValue];
      self->strValue_ = [IOSObjectArray newArrayWithLength:((IOSDoubleArray *) nil_chk(f))->size_ type:NSString_class_()];
      self->strFrequency_ = [IOSObjectArray newArrayWithLength:f->size_ type:NSString_class_()];
      for (jint i = 0; i < f->size_; i++) {
        (void) IOSObjectArray_Set(self->strValue_, i, [((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) formatWithDouble:IOSDoubleArray_Get(nil_chk(leftBorder), i) withOrgGeogebraCommonKernelStringTemplate:[((OrgGeogebraCommonKernelGeosGeoText *) nil_chk(self->table_)) getStringTemplate]]);
        (void) IOSObjectArray_Set(self->strFrequency_, i, [self->kernel_ formatWithDouble:IOSDoubleArray_Get(f, i) withOrgGeogebraCommonKernelStringTemplate:[self->table_ getStringTemplate]]);
      }
      ...
      self->strHeader_ = [IOSObjectArray newArrayWithLength:2 type:NSString_class_()];
      (void) IOSObjectArray_Set(self->strHeader_, 0, [((OrgGeogebraCommonMainLocalization *) nil_chk([self getLoc])) getMenuWithNSString:@"Value"]);
      (void) IOSObjectArray_Set(self->strHeader_, 1, [((OrgGeogebraCommonMainLocalization *) nil_chk([self getLoc])) getMenuWithNSString:@"Count"]);
      self->strValue_ = [((OrgGeogebraCommonKernelAlgosAlgoBarChart *) nil_chk(algoBarChart)) getValue];
      f2 = [algoBarChart getYValue];
      self->strFrequency_ = [IOSObjectArray newArrayWithLength:((IOSDoubleArray *) nil_chk(f2))->size_ type:NSString_class_()];
      for (jint i = 0; i < f2->size_; i++) {
        (void) IOSObjectArray_Set(self->strFrequency_, i, [((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) formatWithDouble:IOSDoubleArray_Get(f2, i) withOrgGeogebraCommonKernelStringTemplate:[((OrgGeogebraCommonKernelGeosGeoText *) nil_chk(self->table_)) getStringTemplate]]);
      }
      ...
      if (self->classList_ == nil) {
        ...
        if (useDens) {
          if (self->scale__ != nil) {
            ...
            if (OrgGeogebraCommonKernelKernel_isEqualWithDouble_withDouble_(scaleValue, 1.0)) {
              (void) IOSObjectArray_Set(self->strHeader_, 1, [((OrgGeogebraCommonMainLocalization *) nil_chk([self getLoc])) getMenuWithNSString:@"FrequencyTable.Count"]);
            }
              ...
              (void) IOSObjectArray_Set(self->strHeader_, 1, [((OrgGeogebraCommonMainLocalization *) nil_chk([self getLoc])) getMenuWithNSString:@"FrequencyTable.RelativeFrequency"]);
            }
            else {
              (void) IOSObjectArray_Set(self->strHeader_, 1, [((OrgGeogebraCommonMainLocalization *) nil_chk([self getLoc])) getMenuWithNSString:@"FrequencyTable.Frequency"]);
            }
          }
          else {
            (void) IOSObjectArray_Set(self->strHeader_, 1, [((OrgGeogebraCommonMainLocalization *) nil_chk([self getLoc])) getMenuWithNSString:@"FrequencyTable.Frequency"]);
        ...
        self->strValue_ = [IOSObjectArray newArrayWithLength:length type:NSString_class_()];
        self->strFrequency_ = [IOSObjectArray newArrayWithLength:length type:NSString_class_()];
        OrgGeogebraCommonKernelGeosGeoList *va = [self->freq_ getValue];
        for (jint i = 0; i < length; i++) {
          (void) IOSObjectArray_Set(self->strValue_, i, [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk([((OrgGeogebraCommonKernelGeosGeoList *) nil_chk(va)) getWithInt:i])) toValueStringWithOrgGeogebraCommonKernelStringTemplate:[((OrgGeogebraCommonKernelGeosGeoText *) nil_chk(self->table_)) getStringTemplate]]);
          (void) IOSObjectArray_Set(self->strFrequency_, i, [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk([fr getWithInt:i])) toValueStringWithOrgGeogebraCommonKernelStringTemplate:[self->table_ getStringTemplate]]);
        }
        OrgGeogebraCommonKernelStatisticsAlgoFrequencyTable_createLaTeXTableWithBoolean_(self, NO);
      }
      else {
        ...
        self->strHeader_ = [IOSObjectArray newArrayWithLength:2 type:NSString_class_()];
        (void) IOSObjectArray_Set(self->strHeader_, 0, [((OrgGeogebraCommonMainLocalization *) nil_chk([self getLoc])) getMenuWithNSString:@"Interval"]);
        (void) IOSObjectArray_Set(self->strHeader_, 1, useDens ? [((OrgGeogebraCommonMainLocalization *) nil_chk([self getLoc])) getMenuWithNSString:@"Frequency"] : [((OrgGeogebraCommonMainLocalization *) nil_chk([self getLoc])) getMenuWithNSString:@"Count"]);
        self->strValue_ = [IOSObjectArray newArrayWithLength:length + 1 type:NSString_class_()];
        self->strFrequency_ = [IOSObjectArray newArrayWithLength:length + 1 type:NSString_class_()];
        for (jint i = 0; i < length; i++) {
          (void) IOSObjectArray_Set(self->strValue_, i, [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk([self->classList_ getWithInt:i])) toValueStringWithOrgGeogebraCommonKernelStringTemplate:[((OrgGeogebraCommonKernelGeosGeoText *) nil_chk(self->table_)) getStringTemplate]]);
          (void) IOSObjectArray_Set(self->strFrequency_, i, [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk([fr getWithInt:i])) toValueStringWithOrgGeogebraCommonKernelStringTemplate:[self->table_ getStringTemplate]]);
        }
        (void) IOSObjectArray_Set(self->strValue_, length, [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk([self->classList_ getWithInt:length])) toValueStringWithOrgGeogebraCommonKernelStringTemplate:[((OrgGeogebraCommonKernelGeosGeoText *) nil_chk(self->table_)) getStringTemplate]]);
        OrgGeogebraCommonKernelStatisticsAlgoFrequencyTable_createLaTeXTableWithBoolean_(self, YES);
      }
      break;
    }
...
void OrgGeogebraCommonKernelStatisticsAlgoFrequencyTable_createLaTeXTableDWithBoolean_(OrgGeogebraCommonKernelStatisticsAlgoFrequencyTable *self, jboolean useClassList) {
  ...
  (void) [self->sb_ appendWithNSString:@"\\begin{array}{c|c}"];
  (void) [self->sb_ appendWithNSString:IOSObjectArray_Get(nil_chk(self->strHeader_), 0)];
  (void) [self->sb_ appendWithNSString:@"&\\text{"];
  (void) [self->sb_ appendWithNSString:IOSObjectArray_Get(self->strHeader_, 1)];
  (void) [self->sb_ appendWithNSString:@"} \\\\\\hline "];
  if (useClassList) {
    for (jint i = 0; i < ((IOSObjectArray *) nil_chk(self->strFrequency_))->size_ - 1; i++) {
      (void) [self->sb_ appendWithNSString:IOSObjectArray_Get(nil_chk(self->strValue_), i)];
      (void) [self->sb_ appendWithNSString:@"\\text{ -- }"];
      (void) [self->sb_ appendWithNSString:IOSObjectArray_Get(self->strValue_, i + 1)];
      (void) [self->sb_ appendWithNSString:@"&"];
      (void) [self->sb_ appendWithNSString:IOSObjectArray_Get(self->strFrequency_, i)];
      (void) [self->sb_ appendWithNSString:@"\\\\"];
    }
  }
  else {
  ...
  (void) [self->sb_ appendWithNSString:@"\\end{array}"];
}
...
void OrgGeogebraCommonKernelStatisticsAlgoFrequencyTable_createLaTeXTableMQWithBoolean_(OrgGeogebraCommonKernelStatisticsAlgoFrequencyTable *self, jboolean useClassList) {
  [((JavaLangStringBuilder *) nil_chk(self->sb_)) setLengthWithInt:0];
  (void) [self->sb_ appendWithNSString:@"\\ggbtable{\\ggbtrlb{\\ggbtd{"];
  (void) [self->sb_ appendWithNSString:IOSObjectArray_Get(nil_chk(self->strHeader_), 0)];
  (void) [self->sb_ appendWithNSString:@"}\\ggbtdll{\\text{"];
  (void) [self->sb_ appendWithNSString:IOSObjectArray_Get(self->strHeader_, 1)];
  (void) [self->sb_ appendWithNSString:@"}}}\\ggbtr{\\ggbtd{ "];
  if (useClassList) {
    for (jint i = 0; i < ((IOSObjectArray *) nil_chk(self->strFrequency_))->size_ - 1; i++) {
      (void) [self->sb_ appendWithNSString:IOSObjectArray_Get(nil_chk(self->strValue_), i)];
      (void) [self->sb_ appendWithNSString:@"\\text{ -- }"];
      (void) [self->sb_ appendWithNSString:IOSObjectArray_Get(self->strValue_, i + 1)];
      (void) [self->sb_ appendWithNSString:@"}\\ggbtdll{"];
      (void) [self->sb_ appendWithNSString:IOSObjectArray_Get(self->strFrequency_, i)];
      (void) [self->sb_ appendWithNSString:@"}\\ggbtr{\\ggbtd{"];
    }
  }
