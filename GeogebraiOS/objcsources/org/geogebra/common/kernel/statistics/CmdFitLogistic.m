...
- (OrgGeogebraCommonKernelGeosGeoElement *)doCommandWithNSString:(NSString *)a
  ...
  OrgGeogebraCommonKernelStatisticsAlgoFitLogistic *algo = [new_OrgGeogebraCommonKernelStatisticsAlgoFitLogistic_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoList_(cons_, a, b) autorelease];
