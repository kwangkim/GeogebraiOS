...
- (OrgGeogebraCommonKernelGeosGeoElement *)doCommandWithNSString:(NSString *)a
  ...
  OrgGeogebraCommonKernelStatisticsAlgoHarmonicMean *algo = [new_OrgGeogebraCommonKernelStatisticsAlgoHarmonicMean_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoList_(cons_, a, b) autorelease];
