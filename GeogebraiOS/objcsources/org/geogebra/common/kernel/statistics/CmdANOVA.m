  ...
  arg = [self resArgsWithOrgGeogebraCommonKernelArithmeticCommand:c];
  {
    ...
    switch (n) {
      ...
      *IOSBooleanArray_GetRef(ok, 0) = ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(IOSObjectArray_Get(nil_chk(arg), 0))) isGeoList]);
      ...
      if (list != nil) {
        IOSObjectArray *ret = [IOSObjectArray newArrayWithObjects:(id[]){ OrgGeogebraCommonKernelStatisticsCmdANOVA_ANOVATestWithNSString_withOrgGeogebraCommonKernelGeosGeoList_(self, [c getLabel], list) } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
        return ret;
      }
      for (jint i = 0; i <= n; i++) {
...
OrgGeogebraCommonKernelGeosGeoList *OrgGeogebraCommonKernelStatisticsCmdANOVA_ANOVATestWithNSString_withOrgGeogebraCommonKernelGeosGeoList_(OrgGeogebraCommonKernelStatisticsCmdANOVA *self, NSString *label, OrgGeogebraCommonKernelGeosGeoList *dataArrayList) {
  OrgGeogebraCommonKernelStatisticsAlgoANOVA *algo = new_OrgGeogebraCommonKernelStatisticsAlgoANOVA_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoList_(self->cons_, label, dataArrayList);
