...
void OrgGeogebraCommonKernelStatisticsAlgoFitPoly_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelArithmeticNumberValue_(OrgGeogebraCommonKernelStatisticsAlgoFitPoly *self, OrgGeogebraCommonKernelConstruction *cons, OrgGeogebraCommonKernelGeosGeoList *geolist, id<OrgGeogebraCommonKernelArithmeticNumberValue> degree) {
  ...
  OrgGeogebraCommonKernelStatisticsAlgoFitPoly_setAndConsume_regMath_(self, new_OrgGeogebraCommonKernelStatisticsRegressionMath_init());
  OrgGeogebraCommonKernelStatisticsAlgoFitPoly_set_geolist_(self, geolist);
  OrgGeogebraCommonKernelStatisticsAlgoFitPoly_set_degree_(self, degree);
  OrgGeogebraCommonKernelStatisticsAlgoFitPoly_set_geodegree_(self, [((id<OrgGeogebraCommonKernelArithmeticNumberValue>) nil_chk(degree)) toGeoElement]);
  OrgGeogebraCommonKernelStatisticsAlgoFitPoly_setAndConsume_geofunction_(self, new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  OrgGeogebraCommonKernelStatisticsAlgoFitPoly_compute(self);
}
