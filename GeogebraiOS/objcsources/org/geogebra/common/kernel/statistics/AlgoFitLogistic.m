...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/statistics/AlgoFitLogistic.java
//
...
- (IOSDoubleArray *)getCoeffs {
  IOSDoubleArray *ret = [IOSDoubleArray arrayWithDoubles:(jdouble[]){ OrgGeogebraCommonKernelStatisticsAlgoFitLogistic_a__, OrgGeogebraCommonKernelStatisticsAlgoFitLogistic_b_, OrgGeogebraCommonKernelStatisticsAlgoFitLogistic_c__ } count:3];
  return ret;
}
...
void OrgGeogebraCommonKernelStatisticsAlgoFitLogistic_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoList_(OrgGeogebraCommonKernelStatisticsAlgoFitLogistic *self, OrgGeogebraCommonKernelConstruction *cons, OrgGeogebraCommonKernelGeosGeoList *geolist) {
  ...
  OrgGeogebraCommonKernelStatisticsAlgoFitLogistic_set_geolist_(self, geolist);
  OrgGeogebraCommonKernelStatisticsAlgoFitLogistic_setAndConsume_geofunction_(self, new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  OrgGeogebraCommonKernelStatisticsAlgoFitLogistic_compute(self);
}
...
void OrgGeogebraCommonKernelStatisticsAlgoFitLogistic_compute(OrgGeogebraCommonKernelStatisticsAlgoFitLogistic *self) {
  ...
  if (!OrgGeogebraCommonKernelStatisticsAlgoFitLogistic_error_) {
    OrgGeogebraCommonKernelArithmeticMyDouble *A = [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, OrgGeogebraCommonKernelStatisticsAlgoFitLogistic_a__) autorelease];
    OrgGeogebraCommonKernelArithmeticMyDouble *B = [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, -OrgGeogebraCommonKernelStatisticsAlgoFitLogistic_b_) autorelease];
    OrgGeogebraCommonKernelArithmeticMyDouble *C = [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, OrgGeogebraCommonKernelStatisticsAlgoFitLogistic_c__) autorelease];
    OrgGeogebraCommonKernelArithmeticMyDouble *ONE = [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, 1.0) autorelease];
    ...
    expr = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self->kernel_, ONE, OrgGeogebraCommonPluginOperationEnum_get_PLUS(), expr) autorelease];
...
void OrgGeogebraCommonKernelStatisticsAlgoFitLogistic_getPoints(OrgGeogebraCommonKernelStatisticsAlgoFitLogistic *self) {
  ...
  xlist = [IOSDoubleArray arrayWithLength:OrgGeogebraCommonKernelStatisticsAlgoFitLogistic_size_];
  ylist = [IOSDoubleArray arrayWithLength:OrgGeogebraCommonKernelStatisticsAlgoFitLogistic_size_];
  ...
  JreStrongAssign(&OrgGeogebraCommonKernelStatisticsAlgoFitLogistic_xd_, nil, xlist);
  JreStrongAssign(&OrgGeogebraCommonKernelStatisticsAlgoFitLogistic_yd_, nil, ylist);
  if (OrgGeogebraCommonKernelStatisticsAlgoFitLogistic_error_) {
