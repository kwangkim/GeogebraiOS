...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/statistics/AlgoFitNL.java
//
...
void OrgGeogebraCommonKernelStatisticsAlgoFitNL_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelGeosGeoFunction_(OrgGeogebraCommonKernelStatisticsAlgoFitNL *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelGeosGeoList *pointlist, OrgGeogebraCommonKernelGeosGeoFunction *inputfunction) {
  ...
  self->datasize_ = 0;
  OrgGeogebraCommonKernelStatisticsAlgoFitNL_set_xdata_(self, nil);
  OrgGeogebraCommonKernelStatisticsAlgoFitNL_set_ydata_(self, nil);
  OrgGeogebraCommonKernelStatisticsAlgoFitNL_set_prfunction_(self, nil);
  OrgGeogebraCommonKernelStatisticsAlgoFitNL_setAndConsume_LMO_(self, new_OrgApacheCommonsMathOptimizationGeneralLevenbergMarquardtOptimizer_init());
  OrgGeogebraCommonKernelStatisticsAlgoFitNL_setAndConsume_curvefitter_(self, new_OrgApacheCommonsMathOptimizationFittingCurveFitter_initWithOrgApacheCommonsMathOptimizationDifferentiableMultivariateVectorialOptimizer_(self->LMO_));
  OrgGeogebraCommonKernelStatisticsAlgoFitNL_set_pointlist_(self, pointlist);
  OrgGeogebraCommonKernelStatisticsAlgoFitNL_set_inputfunction_(self, inputfunction);
  OrgGeogebraCommonKernelStatisticsAlgoFitNL_setAndConsume_outputfunction_(self, new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  OrgGeogebraCommonKernelStatisticsAlgoFitNL_compute(self);
...
void OrgGeogebraCommonKernelStatisticsAlgoFitNL_compute(OrgGeogebraCommonKernelStatisticsAlgoFitNL *self) {
  ...
  @try {
    ...
    OrgGeogebraCommonKernelStatisticsAlgoFitNL_setAndConsume_prfunction_(self, new_OrgGeogebraCommonKernelOptimizationFitRealFunction_initWithOrgGeogebraCommonKernelArithmeticFunction_([((OrgGeogebraCommonKernelGeosGeoFunction *) nil_chk(self->inputfunction_)) getFunction]));
...
jboolean OrgGeogebraCommonKernelStatisticsAlgoFitNL_makeDataArrays(OrgGeogebraCommonKernelStatisticsAlgoFitNL *self) {
  ...
  self->datasize_ = [((OrgGeogebraCommonKernelGeosGeoList *) nil_chk(self->pointlist_)) size];
  OrgGeogebraCommonKernelStatisticsAlgoFitNL_setAndConsume_xdata_(self, [IOSDoubleArray newArrayWithLength:self->datasize_]);
  OrgGeogebraCommonKernelStatisticsAlgoFitNL_setAndConsume_ydata_(self, [IOSDoubleArray newArrayWithLength:self->datasize_]);
  for (jint i = 0; i < self->datasize_; i++) {
