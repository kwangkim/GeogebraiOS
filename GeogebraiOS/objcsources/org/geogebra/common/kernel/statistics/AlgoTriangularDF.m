...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/kernel/statistics/AlgoTriangularDF.java
//
...
- (void)setInputOutput {
  ...
  input_ = [IOSObjectArray newArrayWithLength:cumulative_ == nil ? 4 : 5 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
  ...
  (void) IOSObjectArray_Set(input_, 2, [((id<OrgGeogebraCommonKernelArithmeticNumberValue>) nil_chk(mode_)) toGeoElement]);
  (void) IOSObjectArray_Set(input_, 3, dummyFun);
  if (cumulative_ != nil) {
    (void) IOSObjectArray_Set(input_, 4, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(cumulative_, [OrgGeogebraCommonKernelGeosGeoElement class]));
  }
...
- (void)compute {
  ...
  OrgGeogebraCommonKernelArithmeticExpressionNode *bEn = new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, b_);
  OrgGeogebraCommonKernelArithmeticExpressionNode *modeEn = new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, mode_);
