...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/statistics/AlgoNpR.java
//
...
- (void)setInputOutput {
  ...
  OrgGeogebraCommonKernelAlgosAlgoElement_setAndConsume_input_(self, [IOSObjectArray newArrayWithObjects:(id[]){ [((id<OrgGeogebraCommonKernelArithmeticNumberValue>) nil_chk(num1_)) toGeoElement], [((id<OrgGeogebraCommonKernelArithmeticNumberValue>) nil_chk(num2_)) toGeoElement] } count:2 type:OrgGeogebraCommonKernelGeosGeoElement_class_()]);
...
void OrgGeogebraCommonKernelStatisticsAlgoNpR_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_(OrgGeogebraCommonKernelStatisticsAlgoNpR *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, id<OrgGeogebraCommonKernelArithmeticNumberValue> num1, id<OrgGeogebraCommonKernelArithmeticNumberValue> num2) {
  ...
  OrgGeogebraCommonKernelStatisticsAlgoNpR_set_num1_(self, num1);
  OrgGeogebraCommonKernelStatisticsAlgoNpR_set_num2_(self, num2);
  OrgGeogebraCommonKernelStatisticsAlgoNpR_setAndConsume_result_(self, new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  [self compute];
