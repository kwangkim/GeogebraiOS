...
- (jboolean)doPolyNWithOrgGeogebraCommonKernelGeosGeoList:(OrgGeogebraCommonKernelGeosGeoList *)gl
                                                  withInt:(jint)degree {
  error_ = NO;
  OrgGeogebraCommonKernelStatisticsRegressionMath_set_geolist_(self, gl);
  ...
  @try {
    ...
    OrgGeogebraCommonKernelStatisticsRegressionMath_set_pararray_(self, [((id<OrgApacheCommonsMathLinearRealMatrix>) nil_chk(P)) getColumnWithInt:0]);
  }
...
void OrgGeogebraCommonKernelStatisticsRegressionMath_getPoints(OrgGeogebraCommonKernelStatisticsRegressionMath *self) {
  ...
  OrgGeogebraCommonKernelStatisticsRegressionMath_setAndConsume_xlist_(self, [IOSDoubleArray newArrayWithLength:self->size_]);
  OrgGeogebraCommonKernelStatisticsRegressionMath_setAndConsume_ylist_(self, [IOSDoubleArray newArrayWithLength:self->size_]);
  for (jint i = 0; i < self->size_; i++) {
...
void OrgGeogebraCommonKernelStatisticsRegressionMath_makeMatrixArraysWithInt_(OrgGeogebraCommonKernelStatisticsRegressionMath *self, jint degree) {
  OrgGeogebraCommonKernelStatisticsRegressionMath_setAndConsume_marray_(self, [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ self->size_, degree + 1 }]);
  OrgGeogebraCommonKernelStatisticsRegressionMath_setAndConsume_yarray_(self, [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ self->size_, 1 }]);
  for (jint i = 0; i < self->size_; i++) {
