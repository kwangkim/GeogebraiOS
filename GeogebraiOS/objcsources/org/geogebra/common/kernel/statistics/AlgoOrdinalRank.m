...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/kernel/statistics/AlgoOrdinalRank.java
//
...
void OrgGeogebraCommonKernelStatisticsAlgoOrdinalRank_compute(OrgGeogebraCommonKernelStatisticsAlgoOrdinalRank *self) {
  ...
  if ([OrgGeogebraCommonKernelArithmeticNumberValue_class_() isInstance:geo0]) {
    sortedSet = new_JavaUtilTreeSet_initWithJavaUtilComparator_(OrgGeogebraCommonKernelStatisticsAlgoOrdinalRank_getComparator());
  }
  else {
    [((OrgGeogebraCommonKernelGeosGeoList *) nil_chk(self->outputList_)) setUndefined];
    return;
  ...
  for (jint i = 0; i < self->size_; i++) {
    ...
    if ([OrgGeogebraCommonKernelArithmeticNumberValue_class_() isInstance:geo]) {
      ...
      OrgGeogebraCommonKernelStatisticsAlgoOrdinalRank_OrderedPair *pair = new_OrgGeogebraCommonKernelStatisticsAlgoOrdinalRank_OrderedPair_initWithOrgGeogebraCommonKernelStatisticsAlgoOrdinalRank_withDouble_withInt_(self, [((id<OrgGeogebraCommonKernelArithmeticNumberValue>) nil_chk(num)) getDouble], i);
  ...
  IOSDoubleArray *list = [IOSDoubleArray newArrayWithLength:self->size_];
  jint i = 1;
  ...
  for (i = 0; i < self->size_; i++) {
    [self->outputList_ addWithOrgGeogebraCommonKernelGeosGeoElement:new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(self->cons_, IOSDoubleArray_Get(list, i))];
  }
}
...
id<JavaUtilComparator> OrgGeogebraCommonKernelStatisticsAlgoOrdinalRank_getComparator() {
  ...
  if (OrgGeogebraCommonKernelStatisticsAlgoOrdinalRank_comparator_ == nil) {
    OrgGeogebraCommonKernelStatisticsAlgoOrdinalRank_comparator_ = new_OrgGeogebraCommonKernelStatisticsAlgoOrdinalRank_$1_init();
  }
