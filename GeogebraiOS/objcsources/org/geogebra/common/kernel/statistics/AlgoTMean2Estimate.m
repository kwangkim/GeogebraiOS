...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/statistics/AlgoTMean2Estimate.java
//
...
void OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelGeosGeoBoolean_(OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelGeosGeoList *geoList1, OrgGeogebraCommonKernelGeosGeoList *geoList2, OrgGeogebraCommonKernelGeosGeoNumeric *geoLevel, OrgGeogebraCommonKernelGeosGeoBoolean *geoPooled) {
  ...
  OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate_set_geoList1_(self, geoList1);
  OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate_set_geoList2_(self, geoList2);
  OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate_set_geoLevel_(self, geoLevel);
  OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate_set_geoPooled_(self, geoPooled);
  OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate_set_geoMean1_(self, nil);
  OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate_set_geoSD1_(self, nil);
  OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate_set_geoN1_(self, nil);
  OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate_set_geoMean2_(self, nil);
  OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate_set_geoSD2_(self, nil);
  OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate_set_geoN2_(self, nil);
  OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate_setAndConsume_result_(self, new_OrgGeogebraCommonKernelGeosGeoList_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate_compute(self);
...
void OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelGeosGeoBoolean_(OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate *self, OrgGeogebraCommonKernelConstruction *cons, OrgGeogebraCommonKernelGeosGeoNumeric *geoMean1, OrgGeogebraCommonKernelGeosGeoNumeric *geoSD1, OrgGeogebraCommonKernelGeosGeoNumeric *geoN1, OrgGeogebraCommonKernelGeosGeoNumeric *geoMean2, OrgGeogebraCommonKernelGeosGeoNumeric *geoSD2, OrgGeogebraCommonKernelGeosGeoNumeric *geoN2, OrgGeogebraCommonKernelGeosGeoNumeric *geoLevel, OrgGeogebraCommonKernelGeosGeoBoolean *geoPooled) {
  OrgGeogebraCommonKernelAlgosAlgoElement_initWithOrgGeogebraCommonKernelConstruction_(self, cons);
  OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate_set_geoList1_(self, nil);
  OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate_set_geoList2_(self, nil);
  OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate_set_geoLevel_(self, geoLevel);
  OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate_set_geoPooled_(self, geoPooled);
  OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate_set_geoMean1_(self, geoMean1);
  OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate_set_geoSD1_(self, geoSD1);
  OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate_set_geoN1_(self, geoN1);
  OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate_set_geoMean2_(self, geoMean2);
  OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate_set_geoSD2_(self, geoSD2);
  OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate_set_geoN2_(self, geoN2);
  OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate_setAndConsume_result_(self, new_OrgGeogebraCommonKernelGeosGeoList_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate_compute(self);
}
...
jdouble OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate_getMarginOfErrorWithDouble_withDouble_withDouble_withDouble_withDouble_withBoolean_(OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate *self, jdouble v1, jdouble n1, jdouble v2, jdouble n2, jdouble confLevel, jboolean pooled) {
  if (pooled) {
    ...
    OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate_setAndConsume_tDist_(self, new_OrgApacheCommonsMathDistributionTDistributionImpl_initWithDouble_(OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate_getDegreeOfFreedomWithDouble_withDouble_withDouble_withDouble_withBoolean_(v1, v2, n1, n2, pooled)));
...
void OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate_compute(OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate *self) {
  @try {
    if (((IOSObjectArray *) nil_chk(self->input_))->size_ == 4) {
      ...
      OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate_setAndConsume_val1_(self, [IOSDoubleArray newArrayWithLength:self->size1_]);
      ...
      OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate_setAndConsume_val2_(self, [IOSDoubleArray newArrayWithLength:self->size2_]);
      ...
      OrgGeogebraCommonKernelStatisticsAlgoTMean2Estimate_setAndConsume_stats_(self, new_OrgApacheCommonsMathStatDescriptiveSummaryStatistics_init());
    ...
    [self->result_ addWithOrgGeogebraCommonKernelGeosGeoElement:[new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(self->cons_, self->difference_ - self->me_) autorelease]];
    [self->result_ addWithOrgGeogebraCommonKernelGeosGeoElement:[new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(self->cons_, self->difference_ + self->me_) autorelease]];
