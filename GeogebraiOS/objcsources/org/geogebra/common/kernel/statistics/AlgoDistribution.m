...
- (id<OrgApacheCommonsMathDistributionTDistribution>)getTDistributionWithDouble:(jdouble)param {
  if (t_ == nil || [t_ getDegreesOfFreedom] != param) OrgGeogebraCommonKernelStatisticsAlgoDistribution_setAndConsume_t_(self, new_OrgApacheCommonsMathDistributionTDistributionImpl_initWithDouble_(param));
  return t_;
}

- (id<OrgApacheCommonsMathDistributionFDistribution>)getFDistributionWithDouble:(jdouble)param
                                                                     withDouble:(jdouble)param2 {
  if (f_ == nil || [f_ getDenominatorDegreesOfFreedom] != param2 || [f_ getNumeratorDegreesOfFreedom] != param) OrgGeogebraCommonKernelStatisticsAlgoDistribution_setAndConsume_f_(self, new_OrgApacheCommonsMathDistributionFDistributionImpl_initWithDouble_withDouble_(param, param2));
  return f_;
}

- (id<OrgApacheCommonsMathDistributionGammaDistribution>)getGammaDistributionWithDouble:(jdouble)param
                                                                             withDouble:(jdouble)param2 {
  if (gamma_ == nil || [gamma_ getBeta] != param2 || [gamma_ getAlpha] != param) OrgGeogebraCommonKernelStatisticsAlgoDistribution_setAndConsume_gamma_(self, new_OrgApacheCommonsMathDistributionGammaDistributionImpl_initWithDouble_withDouble_(param, param2));
  return gamma_;
}

- (id<OrgApacheCommonsMathDistributionCauchyDistribution>)getCauchyDistributionWithDouble:(jdouble)param
                                                                               withDouble:(jdouble)param2 {
  if (cauchy_ == nil || [cauchy_ getMedian] != param || [cauchy_ getScale] != param2) OrgGeogebraCommonKernelStatisticsAlgoDistribution_setAndConsume_cauchy_(self, new_OrgApacheCommonsMathDistributionCauchyDistributionImpl_initWithDouble_withDouble_(param, param2));
  return cauchy_;
}

- (id<OrgApacheCommonsMathDistributionChiSquaredDistribution>)getChiSquaredDistributionWithDouble:(jdouble)param {
  if (chisquared_ == nil || [chisquared_ getDegreesOfFreedom] != param) OrgGeogebraCommonKernelStatisticsAlgoDistribution_setAndConsume_chisquared_(self, new_OrgApacheCommonsMathDistributionChiSquaredDistributionImpl_initWithDouble_(param));
  return chisquared_;
}

- (id<OrgApacheCommonsMathDistributionExponentialDistribution>)getExponentialDistributionWithDouble:(jdouble)param {
  if (exponential_ == nil || [exponential_ getMean] != param) OrgGeogebraCommonKernelStatisticsAlgoDistribution_setAndConsume_exponential_(self, new_OrgApacheCommonsMathDistributionExponentialDistributionImpl_initWithDouble_(1.0 / param));
  return exponential_;
}
...
- (id<OrgApacheCommonsMathDistributionHypergeometricDistribution>)getHypergeometricDistributionWithInt:(jint)param
                                                                                               withInt:(jint)param2
                                                                                               withInt:(jint)param3 {
  if (hypergeometric_ == nil || [hypergeometric_ getNumberOfSuccesses] != param2 || [hypergeometric_ getPopulationSize] != param || [hypergeometric_ getSampleSize] != param3) OrgGeogebraCommonKernelStatisticsAlgoDistribution_setAndConsume_hypergeometric_(self, new_OrgApacheCommonsMathDistributionHypergeometricDistributionImpl_initWithInt_withInt_withInt_(param, param2, param3));
  return hypergeometric_;
}

- (id<OrgApacheCommonsMathDistributionPascalDistribution>)getPascalDistributionWithInt:(jint)param
                                                                            withDouble:(jdouble)param2 {
  if (pascal_ == nil || [pascal_ getNumberOfSuccesses] != param || [pascal_ getProbabilityOfSuccess] != param2) OrgGeogebraCommonKernelStatisticsAlgoDistribution_setAndConsume_pascal_(self, new_OrgApacheCommonsMathDistributionPascalDistributionImpl_initWithInt_withDouble_(param, param2));
  return pascal_;
}

- (id<OrgApacheCommonsMathDistributionPoissonDistribution>)getPoissonDistributionWithDouble:(jdouble)param {
  if (poisson_ == nil || [poisson_ getMean] != param) OrgGeogebraCommonKernelStatisticsAlgoDistribution_setAndConsume_poisson_(self, new_OrgApacheCommonsMathDistributionPoissonDistributionImpl_initWithDouble_(param));
  return poisson_;
}

- (id<OrgApacheCommonsMathDistributionBinomialDistribution>)getBinomialDistributionWithInt:(jint)param
                                                                                withDouble:(jdouble)param2 {
  if (binomial_ == nil || [binomial_ getNumberOfTrials] != param || [binomial_ getProbabilityOfSuccess] != param2) OrgGeogebraCommonKernelStatisticsAlgoDistribution_setAndConsume_binomial_(self, new_OrgApacheCommonsMathDistributionBinomialDistributionImpl_initWithInt_withDouble_(param, param2));
  return binomial_;
}

- (id<OrgApacheCommonsMathDistributionWeibullDistribution>)getWeibullDistributionWithDouble:(jdouble)param
                                                                                 withDouble:(jdouble)param2 {
  if (weibull_ == nil || [weibull_ getShape] != param || [weibull_ getScale] != param2) OrgGeogebraCommonKernelStatisticsAlgoDistribution_setAndConsume_weibull_(self, new_OrgApacheCommonsMathDistributionWeibullDistributionImpl_initWithDouble_withDouble_(param, param2));
  return weibull_;
}

- (id<OrgApacheCommonsMathDistributionNormalDistribution>)getNormalDistributionWithDouble:(jdouble)param
                                                                               withDouble:(jdouble)param2 {
  if (normal_ == nil || [normal_ getMean] != param || [normal_ getStandardDeviation] != param2) OrgGeogebraCommonKernelStatisticsAlgoDistribution_setAndConsume_normal_(self, new_OrgApacheCommonsMathDistributionNormalDistributionImpl_initWithDouble_withDouble_(param, param2));
  return normal_;
}

- (id<OrgApacheCommonsMathDistributionZipfDistribution>)getZipfDistributionWithInt:(jint)param
                                                                        withDouble:(jdouble)param2 {
  if (zipf_ == nil || [zipf_ getNumberOfElements] != param || [zipf_ getExponent] != param2) OrgGeogebraCommonKernelStatisticsAlgoDistribution_setAndConsume_zipf_(self, new_OrgApacheCommonsMathDistributionZipfDistributionImpl_initWithInt_withDouble_(param, param2));
  return zipf_;
}
...
void OrgGeogebraCommonKernelStatisticsAlgoDistribution_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_(OrgGeogebraCommonKernelStatisticsAlgoDistribution *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, id<OrgGeogebraCommonKernelArithmeticNumberValue> a, id<OrgGeogebraCommonKernelArithmeticNumberValue> b, id<OrgGeogebraCommonKernelArithmeticNumberValue> c, id<OrgGeogebraCommonKernelArithmeticNumberValue> d) {
  ...
  OrgGeogebraCommonKernelStatisticsAlgoDistribution_set_t_(self, nil);
  OrgGeogebraCommonKernelStatisticsAlgoDistribution_set_chisquared_(self, nil);
  OrgGeogebraCommonKernelStatisticsAlgoDistribution_set_f_(self, nil);
  OrgGeogebraCommonKernelStatisticsAlgoDistribution_set_gamma_(self, nil);
  OrgGeogebraCommonKernelStatisticsAlgoDistribution_set_cauchy_(self, nil);
  OrgGeogebraCommonKernelStatisticsAlgoDistribution_set_exponential_(self, nil);
  OrgGeogebraCommonKernelStatisticsAlgoDistribution_set_hypergeometric_(self, nil);
  OrgGeogebraCommonKernelStatisticsAlgoDistribution_set_pascal_(self, nil);
  OrgGeogebraCommonKernelStatisticsAlgoDistribution_set_binomial_(self, nil);
  OrgGeogebraCommonKernelStatisticsAlgoDistribution_set_weibull_(self, nil);
  OrgGeogebraCommonKernelStatisticsAlgoDistribution_set_zipf_(self, nil);
  OrgGeogebraCommonKernelStatisticsAlgoDistribution_set_normal_(self, nil);
  OrgGeogebraCommonKernelStatisticsAlgoDistribution_set_poisson_(self, nil);
  OrgGeogebraCommonKernelStatisticsAlgoDistribution_set_a_(self, a);
  OrgGeogebraCommonKernelStatisticsAlgoDistribution_set_b_(self, b);
  OrgGeogebraCommonKernelStatisticsAlgoDistribution_set_c_(self, c);
  OrgGeogebraCommonKernelStatisticsAlgoDistribution_set_d_(self, d);
  OrgGeogebraCommonKernelStatisticsAlgoDistribution_setAndConsume_num_(self, new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  [self compute];
...
void OrgGeogebraCommonKernelStatisticsAlgoDistribution_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelGeosGeoBoolean_(OrgGeogebraCommonKernelStatisticsAlgoDistribution *self, OrgGeogebraCommonKernelConstruction *cons, id<OrgGeogebraCommonKernelArithmeticNumberValue> a, id<OrgGeogebraCommonKernelArithmeticNumberValue> b, id<OrgGeogebraCommonKernelArithmeticNumberValue> c, OrgGeogebraCommonKernelGeosGeoBoolean *isCumulative) {
  ...
  OrgGeogebraCommonKernelStatisticsAlgoDistribution_set_b_(self, b);
  OrgGeogebraCommonKernelStatisticsAlgoDistribution_set_c_(self, c);
  OrgGeogebraCommonKernelStatisticsAlgoDistribution_set_isCumulative_(self, isCumulative);
  OrgGeogebraCommonKernelStatisticsAlgoDistribution_setAndConsume_num_(self, new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  [self compute];
}
