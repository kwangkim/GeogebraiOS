...
- (OrgGeogebraCommonKernelGeosGeoElement *)doCommandWithNSString:(NSString *)a
  ...
  OrgGeogebraCommonKernelStatisticsAlgoSampleVariance *algo = [new_OrgGeogebraCommonKernelStatisticsAlgoSampleVariance_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoList_(cons_, a, b) autorelease];
...
- (OrgGeogebraCommonKernelGeosGeoElement *)doCommandWithNSString:(NSString *)a
  ...
  OrgGeogebraCommonKernelStatisticsAlgoSampleVariance *algo = [new_OrgGeogebraCommonKernelStatisticsAlgoSampleVariance_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelGeosGeoList_(cons_, a, list, freq) autorelease];
  return [algo getResult];
}
