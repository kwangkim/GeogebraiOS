...
- (IOSDoubleArray *)getCoeffs {
  IOSDoubleArray *ret = [IOSDoubleArray arrayWithDoubles:(jdouble[]){ OrgGeogebraCommonKernelStatisticsAlgoFitSin_a_, OrgGeogebraCommonKernelStatisticsAlgoFitSin_b_, OrgGeogebraCommonKernelStatisticsAlgoFitSin_c_, OrgGeogebraCommonKernelStatisticsAlgoFitSin_d_ } count:4];
  return ret;
}
...
void OrgGeogebraCommonKernelStatisticsAlgoFitSin_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoList_(OrgGeogebraCommonKernelStatisticsAlgoFitSin *self, OrgGeogebraCommonKernelConstruction *cons, OrgGeogebraCommonKernelGeosGeoList *geolist) {
  ...
  OrgGeogebraCommonKernelStatisticsAlgoFitSin_set_geolist_(self, geolist);
  OrgGeogebraCommonKernelStatisticsAlgoFitSin_setAndConsume_geofunction_(self, new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  OrgGeogebraCommonKernelStatisticsAlgoFitSin_compute(self);
}
...
void OrgGeogebraCommonKernelStatisticsAlgoFitSin_compute(OrgGeogebraCommonKernelStatisticsAlgoFitSin *self) {
  ...
  if (!OrgGeogebraCommonKernelStatisticsAlgoFitSin_error_) {
    OrgGeogebraCommonKernelArithmeticMyDouble *A = [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, OrgGeogebraCommonKernelStatisticsAlgoFitSin_a_) autorelease];
    OrgGeogebraCommonKernelArithmeticMyDouble *B = [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, OrgGeogebraCommonKernelStatisticsAlgoFitSin_b_) autorelease];
    OrgGeogebraCommonKernelArithmeticMyDouble *C = [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, OrgGeogebraCommonKernelStatisticsAlgoFitSin_c_) autorelease];
    OrgGeogebraCommonKernelArithmeticMyDouble *D = [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, OrgGeogebraCommonKernelStatisticsAlgoFitSin_d_) autorelease];
...
void OrgGeogebraCommonKernelStatisticsAlgoFitSin_getPoints(OrgGeogebraCommonKernelStatisticsAlgoFitSin *self) {
  ...
  jint i = 0;
  xlist = [IOSDoubleArray arrayWithLength:OrgGeogebraCommonKernelStatisticsAlgoFitSin_size_];
  ylist = [IOSDoubleArray arrayWithLength:OrgGeogebraCommonKernelStatisticsAlgoFitSin_size_];
  ...
  JreStrongAssign(&OrgGeogebraCommonKernelStatisticsAlgoFitSin_xd_, nil, xlist);
  JreStrongAssign(&OrgGeogebraCommonKernelStatisticsAlgoFitSin_yd_, nil, ylist);
  if (OrgGeogebraCommonKernelStatisticsAlgoFitSin_error_) {
