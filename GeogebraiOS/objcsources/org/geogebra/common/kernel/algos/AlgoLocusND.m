...
- (void)createMaxDistances {
  maxXdist_ = [IOSDoubleArray newArrayWithLength:3];
  maxYdist_ = [IOSDoubleArray newArrayWithLength:3];
}
...
- (void)setInputOutput {
  ...
  efficientInput_AlgoLocusND_ = [IOSObjectArray newArrayWithLength:[inSet size] type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
  it = [inSet iterator];
  jint i = 0;
  while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
    (void) IOSObjectArray_Set(efficientInput_AlgoLocusND_, i, [it next]);
    i++;
  }
  standardInput_ = [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
  (void) IOSObjectArray_Set(standardInput_, 0, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(locusPoint_, [OrgGeogebraCommonKernelGeosGeoElement class]));
  (void) IOSObjectArray_Set(standardInput_, 1, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(movingPoint_, [OrgGeogebraCommonKernelGeosGeoElement class]));
...
void OrgGeogebraCommonKernelAlgosAlgoLocusND_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_withInt_withBoolean_(OrgGeogebraCommonKernelAlgosAlgoLocusND *self, OrgGeogebraCommonKernelConstruction *cons, id<OrgGeogebraCommonKernelKernelNDGeoPointND> Q, id<OrgGeogebraCommonKernelKernelNDGeoPointND> P, jint min_steps, jboolean registerCE) {
  ...
  self->xmin_ = [IOSDoubleArray newArrayWithLength:3];
  self->xmax_ = [IOSDoubleArray newArrayWithLength:3];
  self->ymin_ = [IOSDoubleArray newArrayWithLength:3];
  self->ymax_ = [IOSDoubleArray newArrayWithLength:3];
  self->farXmin_ = [IOSDoubleArray newArrayWithLength:3];
  self->farXmax_ = [IOSDoubleArray newArrayWithLength:3];
  self->farYmin_ = [IOSDoubleArray newArrayWithLength:3];
  self->farYmax_ = [IOSDoubleArray newArrayWithLength:3];
  self->nearToScreenRect_ = [IOSObjectArray newArrayWithObjects:(id[]){ [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newRectangle2D], [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newRectangle2D], [OrgGeogebraCommonFactoriesAwtFactory_get_prototype_() newRectangle2D] } count:3 type:OrgGeogebraCommonAwtGRectangle2D_class_()];
  self->lastFarAway_ = [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ NO, NO, NO } count:3];
  self->views_ = 1;
  self->paramCache_ = [IOSDoubleArray newArrayWithLength:3];
  self->qcopyCache_ = [self createQCopyCache];
  self->cacheIndex_ = 0;
  self->visibleEV_ = [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ NO, NO, NO } count:3];
  [self createMaxDistances];
  self->MIN_STEPS_INSTANCE_ = min_steps;
  self->movingPoint_ = P;
  self->locusPoint_ = Q;
  self->path_ = [((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(P)) getPath];
  self->pathMover_ = [((id<OrgGeogebraCommonKernelPath>) nil_chk(self->path_)) createPathMover];
  [self createStartPosWithOrgGeogebraCommonKernelConstruction:cons];
  self->locus_ = [self newGeoLocusWithOrgGeogebraCommonKernelConstruction:cons];
  OrgGeogebraCommonKernelAlgosAlgoLocusND_init__(self);
  [self updateScreenBorders];
  [self setInputOutput];
  if (registerCE) {
...
void OrgGeogebraCommonKernelAlgosAlgoLocusND_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_(OrgGeogebraCommonKernelAlgosAlgoLocusND *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, id<OrgGeogebraCommonKernelKernelNDGeoPointND> Q, id<OrgGeogebraCommonKernelKernelNDGeoPointND> P) {
  (void) OrgGeogebraCommonKernelAlgosAlgoLocusND_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_withInt_withBoolean_(self, cons, Q, P, OrgGeogebraCommonKernelPathMover_MIN_STEPS, YES);
...
void OrgGeogebraCommonKernelAlgosAlgoLocusND_init__(OrgGeogebraCommonKernelAlgosAlgoLocusND *self) {
  self->Qin_ = [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(((OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(self->locusPoint_, [OrgGeogebraCommonKernelGeosGeoElement class])))) getAllPredecessors];
  self->locusConsOrigElements_ = new_JavaUtilTreeSet_init();
...
void OrgGeogebraCommonKernelAlgosAlgoLocusND_buildLocusMacroConstructionWithJavaUtilTreeSet_(OrgGeogebraCommonKernelAlgosAlgoLocusND *self, JavaUtilTreeSet *locusConsElements) {
  self->macroKernel_ = [((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) newMacroKernel];
...
void OrgGeogebraCommonKernelAlgosAlgoLocusND_clearCache(OrgGeogebraCommonKernelAlgosAlgoLocusND *self) {
  for (jint i = 0; i < ((IOSDoubleArray *) nil_chk(self->paramCache_))->size_; i++) {
    *IOSDoubleArray_GetRef(self->paramCache_, i) = JavaLangDouble_NaN;
    if (IOSObjectArray_Get(nil_chk(self->qcopyCache_), i) == nil) (void) IOSObjectArray_Set(self->qcopyCache_, i, [self newCache]);
  }
}
...
jboolean OrgGeogebraCommonKernelAlgosAlgoLocusND_distanceOKWithOrgGeogebraCommonKernelKernelNDGeoPointND_(OrgGeogebraCommonKernelAlgosAlgoLocusND *self, id<OrgGeogebraCommonKernelKernelNDGeoPointND> Q) {
  IOSBooleanArray *distanceOK = [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ NO, NO, NO } count:3];
