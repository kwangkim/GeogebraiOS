...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/kernel/algos/AlgoIntersectLineCurve.java
//
...
- (OrgGeogebraCommonKernelAlgosAlgoElement_OutputHandler *)createOutputPoints {
  return new_OrgGeogebraCommonKernelAlgosAlgoElement_OutputHandler_initWithOrgGeogebraCommonKernelAlgosAlgoElement_withOrgGeogebraCommonKernelAlgosAlgoElement_elementFactory_(self, new_OrgGeogebraCommonKernelAlgosAlgoIntersectLineCurve_$1_initWithOrgGeogebraCommonKernelAlgosAlgoIntersectLineCurve_(self));
}
...
- (void)setInputOutput {
  ...
  (void) IOSObjectArray_Set(input_, 0, line_);
  (void) IOSObjectArray_Set(input_, 1, curve_);
...
- (void)compute {
  ...
  jint outputSize = -1;
  JavaUtilArrayList *polyRoots = new_JavaUtilArrayList_init();
  ...
  if ([polyRoots size] > 0) {
    ...
    roots = [IOSDoubleArray newArrayWithLength:outputSize];
