...
- (void)setInputPoints {
  OrgGeogebraCommonKernelAlgosAlgoElement_set_input_(self, P_);
}
...
- (IOSObjectArray *)getAllPoints {
  IOSObjectArray *copy_ = [IOSObjectArray arrayWithLength:((IOSObjectArray *) nil_chk([self getPoints]))->size_ type:OrgGeogebraCommonKernelGeosGeoPoint_class_()];
...
void OrgGeogebraCommonKernelAlgosAlgoConicFivePoints_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_(OrgGeogebraCommonKernelAlgosAlgoConicFivePoints *self, OrgGeogebraCommonKernelConstruction *cons, IOSObjectArray *inputP) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoConicFivePoints_set_P_(self, [self createPoints2DWithOrgGeogebraCommonKernelKernelNDGeoPointNDArray:inputP]);
  OrgGeogebraCommonKernelAlgosAlgoConicFivePoints_set_conic_(self, [self newGeoConicWithOrgGeogebraCommonKernelConstruction:cons]);
  [self setInputOutput];
  OrgGeogebraCommonKernelAlgosAlgoConicFivePoints_setAndConsume_line_(self, [IOSObjectArray newArrayWithLength:4 type:OrgGeogebraCommonKernelGeosGeoVec3D_class_()]);
  for (self->i_ = 0; self->i_ < 4; self->i_++) {
    IOSObjectArray_SetAndConsume(self->line_, self->i_, new_OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelConstruction_(cons));
  }
  OrgGeogebraCommonKernelAlgosAlgoConicFivePoints_setAndConsume_A_(self, [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ 3, 3 }]);
  OrgGeogebraCommonKernelAlgosAlgoConicFivePoints_setAndConsume_B_(self, [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ 3, 3 }]);
  OrgGeogebraCommonKernelAlgosAlgoConicFivePoints_setAndConsume_C_(self, [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ 3, 3 }]);
  OrgGeogebraCommonKernelAlgosAlgoConicFivePoints_checkCriticalCase(self);
  [self initCoords];
  [self compute];
  OrgGeogebraCommonKernelAlgosAlgoConicFivePoints_addIncidence(self);
