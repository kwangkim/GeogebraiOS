...
- (void)createPointsWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)cons {
  OrgGeogebraCommonKernelAlgosAlgoCommonTangentsND_setAndConsume_P_(self, [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonKernelGeosGeoPoint_class_()]);
  IOSObjectArray_SetAndConsume(P_, 0, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons));
  IOSObjectArray_SetAndConsume(P_, 1, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons));
}
...
- (void)initTangents {
  OrgGeogebraCommonKernelAlgosAlgoCommonTangentsND_setAndConsume_tangents_(self, [IOSObjectArray newArrayWithLength:2 + 2 type:OrgGeogebraCommonKernelGeosGeoLine_class_()]);
  ...
  IOSObjectArray_SetAndConsume(tangents_, 0 + 2, new_OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelConstruction_(cons_));
  IOSObjectArray_SetAndConsume(tangents_, 1 + 2, new_OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelConstruction_(cons_));
...
- (OrgGeogebraCommonKernelKernelNDAlgoIntersectND *)createAlgoWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)cons
  ...
  return [new_OrgGeogebraCommonKernelAlgosAlgoIntersectLineConic_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoLine_withOrgGeogebraCommonKernelGeosGeoConic_(cons, line, (OrgGeogebraCommonKernelGeosGeoConic *) check_class_cast(conic, [OrgGeogebraCommonKernelGeosGeoConic class])) autorelease];
}
