...
#ifndef _OrgGeogebraCommonKernelAlgosAlgoLineBisectorSegment_H_
#define _OrgGeogebraCommonKernelAlgosAlgoLineBisectorSegment_H_
...
@interface OrgGeogebraCommonKernelAlgosAlgoLineBisectorSegment : OrgGeogebraCommonKernelAlgosAlgoElement < OrgGeogebraCommonKernelAlgosSymbolicParametersAlgo, OrgGeogebraCommonKernelAlgosSymbolicParametersBotanaAlgo >
...
J2OBJC_EMPTY_STATIC_INIT(OrgGeogebraCommonKernelAlgosAlgoLineBisectorSegment)
...
FOUNDATION_EXPORT OrgGeogebraCommonKernelAlgosAlgoLineBisectorSegment *new_OrgGeogebraCommonKernelAlgosAlgoLineBisectorSegment_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoSegment_(OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelGeosGeoSegment *s) NS_RETURNS_RETAINED;

J2OBJC_TYPE_LITERAL_HEADER(OrgGeogebraCommonKernelAlgosAlgoLineBisectorSegment)

#endif // _OrgGeogebraCommonKernelAlgosAlgoLineBisectorSegment_H_
