...
- (void)setInputOutput {
  ...
  IOSObjectArray_Set(input_, 2, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(Q_, [OrgGeogebraCommonKernelGeosGeoElement class]));
...
- (void)setTransformedObjectWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)g
  ...
  OrgGeogebraCommonKernelAlgosAlgoRotatePoint_set_inGeo_(self, g);
  OrgGeogebraCommonKernelAlgosAlgoRotatePoint_set_outGeo_(self, g2);
  if (!([outGeo_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoList class]])) OrgGeogebraCommonKernelAlgosAlgoRotatePoint_set_out_(self, (id<OrgGeogebraCommonKernelGeosPointRotateable>) check_protocol_cast(outGeo_, @protocol(OrgGeogebraCommonKernelGeosPointRotateable)));
}
...
void OrgGeogebraCommonKernelAlgosAlgoRotatePoint_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelKernelNDGeoPointND_(OrgGeogebraCommonKernelAlgosAlgoRotatePoint *self, OrgGeogebraCommonKernelConstruction *cons, OrgGeogebraCommonKernelGeosGeoElement *A, id<OrgGeogebraCommonKernelArithmeticNumberValue> angle, id<OrgGeogebraCommonKernelKernelNDGeoPointND> Q) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoRotatePoint_set_angle_(self, angle);
  OrgGeogebraCommonKernelAlgosAlgoRotatePoint_set_Q_(self, Q);
  OrgGeogebraCommonKernelAlgosAlgoRotatePoint_set_angleGeo_(self, [((id<OrgGeogebraCommonKernelArithmeticNumberValue>) nil_chk(angle)) toGeoElement]);
  OrgGeogebraCommonKernelAlgosAlgoRotatePoint_set_inGeo_(self, A);
  OrgGeogebraCommonKernelAlgosAlgoRotatePoint_set_outGeo_(self, [self getResultTemplateWithOrgGeogebraCommonKernelGeosGeoElement:self->inGeo_]);
  if ([OrgGeogebraCommonKernelGeosPointRotateable_class_() isInstance:self->outGeo_]) OrgGeogebraCommonKernelAlgosAlgoRotatePoint_set_out_(self, (id<OrgGeogebraCommonKernelGeosPointRotateable>) check_protocol_cast(self->outGeo_, @protocol(OrgGeogebraCommonKernelGeosPointRotateable)));
  [self setInputOutput];
  OrgGeogebraCommonKernelAlgosAlgoRotatePoint_compute(self);
