...
- (OrgGeogebraCommonKernelMatrixCoords *)getVectorCoords {
  ...
  return [new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_(((OrgGeogebraCommonKernelGeosGeoVec3D *) nil_chk(vec))->x_, vec->y_, vec->z_) autorelease];
}
...
- (void)setTransformedObjectWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)g
  ...
  OrgGeogebraCommonKernelAlgosAlgoTranslate_set_inGeo_(self, g);
  OrgGeogebraCommonKernelAlgosAlgoTranslate_set_outGeo_(self, g2);
  if (!([outGeo_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoList class]])) {
    OrgGeogebraCommonKernelAlgosAlgoTranslate_set_out_(self, (id<OrgGeogebraCommonKernelGeosTranslateable>) check_protocol_cast(outGeo_, @protocol(OrgGeogebraCommonKernelGeosTranslateable)));
  }
}
...
- (IOSObjectArray *)getPolynomials {
  ...
  if ([inGeo_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoPoint class]] && [v_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoVector class]]) {
    ...
    OrgGeogebraCommonKernelAlgosAlgoTranslate_setAndConsume_polynomials_(self, [IOSObjectArray newArrayWithLength:3 type:OrgGeogebraCommonKernelProverPolynomialPolynomial_class_()]);
    IOSObjectArray_Set(polynomials_, 0, [((OrgGeogebraCommonKernelProverPolynomialPolynomial *) nil_chk([((OrgGeogebraCommonKernelProverPolynomialPolynomial *) nil_chk(IOSObjectArray_Get(nil_chk(coords1), 0))) multiplyWithOrgGeogebraCommonKernelProverPolynomialPolynomial:IOSObjectArray_Get(nil_chk(coords2), 2)])) addWithOrgGeogebraCommonKernelProverPolynomialPolynomial:[((OrgGeogebraCommonKernelProverPolynomialPolynomial *) nil_chk(IOSObjectArray_Get(coords2, 0))) multiplyWithOrgGeogebraCommonKernelProverPolynomialPolynomial:IOSObjectArray_Get(coords1, 2)]]);
    ...
    IOSObjectArray_Set(polynomials_, 2, [((OrgGeogebraCommonKernelProverPolynomialPolynomial *) nil_chk(IOSObjectArray_Get(coords1, 2))) multiplyWithOrgGeogebraCommonKernelProverPolynomialPolynomial:IOSObjectArray_Get(coords2, 2)]);
    return polynomials_;
  }
  @throw [new_OrgGeogebraCommonKernelProverNoSymbolicParametersException_init() autorelease];
}
...
void OrgGeogebraCommonKernelAlgosAlgoTranslate_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoElement_(OrgGeogebraCommonKernelAlgosAlgoTranslate *self, OrgGeogebraCommonKernelConstruction *cons, OrgGeogebraCommonKernelGeosGeoElement *inArg, OrgGeogebraCommonKernelGeosGeoElement *v) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoTranslate_set_v_(self, v);
  OrgGeogebraCommonKernelAlgosAlgoTranslate_set_inGeo_(self, inArg);
  OrgGeogebraCommonKernelAlgosAlgoTranslate_set_outGeo_(self, [self getResultTemplateWithOrgGeogebraCommonKernelGeosGeoElement:self->inGeo_]);
  if ([OrgGeogebraCommonKernelGeosTranslateable_class_() isInstance:self->outGeo_]) OrgGeogebraCommonKernelAlgosAlgoTranslate_set_out_(self, (id<OrgGeogebraCommonKernelGeosTranslateable>) check_protocol_cast(self->outGeo_, @protocol(OrgGeogebraCommonKernelGeosTranslateable)));
  [self setInputOutput];
  OrgGeogebraCommonKernelAlgosAlgoTranslate_compute(self);
}
