...
- (void)initElements {
  if (isDefinedAsTangent_) {
    P_ = [IOSObjectArray newArrayWithLength:1 type:OrgGeogebraCommonKernelGeosGeoPoint_class_()];
    (void) IOSObjectArray_Set(P_, 0, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons_));
  }
  else {
    P_ = [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonKernelGeosGeoPoint_class_()];
    D_ = [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonKernelGeosGeoPoint_class_()];
    Q_ = [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonKernelGeosGeoPoint_class_()];
    distTable_ = [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ 2, 2 }];
    age_ = [IOSIntArray newArrayWithLength:2];
    permutation_ = [IOSIntArray newArrayWithLength:2];
    isQonPath_ = [IOSBooleanArray newArrayWithLength:2];
    isPalive_ = [IOSBooleanArray newArrayWithLength:2];
    for (jint i = 0; i < 2; i++) {
      (void) IOSObjectArray_Set(Q_, i, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons_));
      (void) IOSObjectArray_Set(P_, i, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons_));
      (void) IOSObjectArray_Set(D_, i, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons_));
    }
...
- (IOSObjectArray *)getBotanaPolynomialsWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  ...
  if (g_ != nil && c_ != nil && [c_ isCircle]) {
    ...
    (void) IOSObjectArray_Set(nil_chk(botanaPolynomialsThis), 0, OrgGeogebraCommonKernelProverPolynomialPolynomial_collinearWithOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_(IOSObjectArray_Get(nil_chk(vg), 0), IOSObjectArray_Get(vg, 1), IOSObjectArray_Get(vg, 2), IOSObjectArray_Get(vg, 3), IOSObjectArray_Get(nil_chk(botanaVarsThis), 0), IOSObjectArray_Get(botanaVarsThis, 1)));
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonKernelAlgosAlgoIntersectLineConic class]) {
    OrgGeogebraCommonKernelAlgosAlgoIntersectLineConic_xyz_ = [IOSDoubleArray newArrayWithLength:3];
...
void OrgGeogebraCommonKernelAlgosAlgoIntersectLineConic_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoLine_withOrgGeogebraCommonKernelGeosGeoConic_(OrgGeogebraCommonKernelAlgosAlgoIntersectLineConic *self, OrgGeogebraCommonKernelConstruction *cons, OrgGeogebraCommonKernelGeosGeoLine *g, OrgGeogebraCommonKernelGeosGeoConic *c) {
  ...
  if ([OrgGeogebraCommonKernelAlgosTangentAlgo_class_() isInstance:[g getParentAlgorithm]]) {
    ...
    self->tangentPoint_ = [((id<OrgGeogebraCommonKernelAlgosTangentAlgo>) nil_chk(algo)) getTangentPointWithOrgGeogebraCommonKernelGeosGeoElement:c withOrgGeogebraCommonKernelGeosGeoLine:g];
...
jint OrgGeogebraCommonKernelAlgosAlgoIntersectLineConic_intersectLineConicWithOrgGeogebraCommonKernelGeosGeoLine_withOrgGeogebraCommonKernelKernelNDGeoConicND_withOrgGeogebraCommonKernelGeosGeoPointArray_withDouble_(OrgGeogebraCommonKernelGeosGeoLine *g, OrgGeogebraCommonKernelKernelNDGeoConicND *c, IOSObjectArray *sol, jdouble eps) {
  ...
  @synchronized(OrgGeogebraCommonKernelAlgosAlgoIntersectLineConic_class_()) {
    ...
    (void) [((OrgGeogebraCommonKernelGeosGeoLine *) nil_chk(g)) getnormalizedCoefficientsWithDoubleArray:OrgGeogebraCommonKernelAlgosAlgoIntersectLineConic_xyz_];
