...
- (void)setInputOutput {
  ...
  IOSObjectArray_Set(input_, 1, [((id<OrgGeogebraCommonKernelArithmeticNumberValue>) nil_chk(viewID_)) toGeoElement]);
  IOSObjectArray_Set(input_, 2, [((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(corner1_)) toGeoElement]);
  IOSObjectArray_Set(input_, 3, [((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(corner3_)) toGeoElement]);
  IOSObjectArray_Set(input_, 4, [((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(screenCorner1_)) toGeoElement]);
  IOSObjectArray_Set(input_, 5, [((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(screenCorner3_)) toGeoElement]);
...
- (void)setTransformedObjectWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)g
  ...
  OrgGeogebraCommonKernelAlgosAlgoAttachCopyToView_set_inGeo_(self, g);
  OrgGeogebraCommonKernelAlgosAlgoAttachCopyToView_set_outGeo_(self, g2);
  if (!([out_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoList class]]) && ([OrgGeogebraCommonKernelMatrixTransformable_class_() isInstance:outGeo_])) {
    OrgGeogebraCommonKernelAlgosAlgoAttachCopyToView_set_out_(self, (id<OrgGeogebraCommonKernelMatrixTransformable>) check_protocol_cast(outGeo_, @protocol(OrgGeogebraCommonKernelMatrixTransformable)));
  }
}
...
- (OrgGeogebraCommonKernelGeosGeoElement *)getResultTemplateWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  if ([geo isKindOfClass:[OrgGeogebraCommonKernelGeosGeoFunction class]]) {
    return [new_OrgGeogebraCommonKernelGeosGeoCurveCartesian_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
  }
...
- (void)setEVWithInt:(jint)viewID2 {
  ...
  OrgGeogebraCommonKernelAlgosAlgoAttachCopyToView_setAndConsume_viewID_(self, new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons_, viewID2));
...
void OrgGeogebraCommonKernelAlgosAlgoAttachCopyToView_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_(OrgGeogebraCommonKernelAlgosAlgoAttachCopyToView *self, OrgGeogebraCommonKernelConstruction *cons, OrgGeogebraCommonKernelGeosGeoElement *inArg, id<OrgGeogebraCommonKernelArithmeticNumberValue> viewID, id<OrgGeogebraCommonKernelKernelNDGeoPointND> corner1, id<OrgGeogebraCommonKernelKernelNDGeoPointND> corner3, id<OrgGeogebraCommonKernelKernelNDGeoPointND> screenCorner1, id<OrgGeogebraCommonKernelKernelNDGeoPointND> screenCorner3) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoAttachCopyToView_set_viewID_(self, viewID);
  OrgGeogebraCommonKernelAlgosAlgoAttachCopyToView_set_corner1_(self, corner1);
  OrgGeogebraCommonKernelAlgosAlgoAttachCopyToView_set_corner3_(self, corner3);
  OrgGeogebraCommonKernelAlgosAlgoAttachCopyToView_set_screenCorner1_(self, screenCorner1);
  OrgGeogebraCommonKernelAlgosAlgoAttachCopyToView_set_screenCorner3_(self, screenCorner3);
  OrgGeogebraCommonKernelAlgosAlgoAttachCopyToView_set_inGeo_(self, [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(inArg)) toGeoElement]);
  if (([OrgGeogebraCommonKernelGeosGeoPoly_class_() isInstance:self->inGeo_]) || [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(self->inGeo_)) isLimitedPath]) {
    OrgGeogebraCommonKernelAlgosAlgoAttachCopyToView_set_outGeo_(self, [inArg copyInternalWithOrgGeogebraCommonKernelConstruction:cons]);
    OrgGeogebraCommonKernelAlgosAlgoAttachCopyToView_set_out_(self, (id<OrgGeogebraCommonKernelMatrixTransformable>) check_protocol_cast(self->outGeo_, @protocol(OrgGeogebraCommonKernelMatrixTransformable)));
  }
  else if ([self->inGeo_ isGeoList]) {
    OrgGeogebraCommonKernelAlgosAlgoAttachCopyToView_setAndConsume_outGeo_(self, new_OrgGeogebraCommonKernelGeosGeoList_initWithOrgGeogebraCommonKernelConstruction_(cons));
  }
  else if ([self->inGeo_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoFunction class]]) {
    OrgGeogebraCommonKernelAlgosAlgoAttachCopyToView_set_outGeo_(self, [self->inGeo_ copy__]);
  }
  else {
    OrgGeogebraCommonKernelAlgosAlgoAttachCopyToView_set_out_(self, (id<OrgGeogebraCommonKernelMatrixTransformable>) check_protocol_cast([self->inGeo_ copy__], @protocol(OrgGeogebraCommonKernelMatrixTransformable)));
    OrgGeogebraCommonKernelAlgosAlgoAttachCopyToView_set_outGeo_(self, [((id<OrgGeogebraCommonKernelMatrixTransformable>) nil_chk(self->out_)) toGeoElement]);
  }
  [self setInputOutput];
  OrgGeogebraCommonKernelAlgosAlgoAttachCopyToView_compute(self);
