...
void OrgGeogebraCommonKernelAlgosAlgoCircumferenceConic_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoConicND_(OrgGeogebraCommonKernelAlgosAlgoCircumferenceConic *self, OrgGeogebraCommonKernelConstruction *cons, OrgGeogebraCommonKernelKernelNDGeoConicND *conic) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoCircumferenceConic_set_ellipticArcLength_(self, nil);
  OrgGeogebraCommonKernelAlgosAlgoCircumferenceConic_set_conic_(self, conic);
  OrgGeogebraCommonKernelAlgosAlgoCircumferenceConic_setAndConsume_circum_(self, new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  OrgGeogebraCommonKernelAlgosAlgoCircumferenceConic_compute(self);
}
...
void OrgGeogebraCommonKernelAlgosAlgoCircumferenceConic_compute(OrgGeogebraCommonKernelAlgosAlgoCircumferenceConic *self) {
  ...
  }
  {
    ...
    switch (type) {
      ...
      if (self->ellipticArcLength_ == nil) OrgGeogebraCommonKernelAlgosAlgoCircumferenceConic_setAndConsume_ellipticArcLength_(self, new_OrgGeogebraCommonKernelIntegrationEllipticArcLength_initWithOrgGeogebraCommonKernelKernelNDGeoConicND_(self->conic_));
