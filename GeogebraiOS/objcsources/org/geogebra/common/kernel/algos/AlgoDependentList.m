...
- (void)updateListWithJavaUtilArrayList:(JavaUtilArrayList *)listItems {
  OrgGeogebraCommonKernelAlgosAlgoDependentList_set_listItems_(self, listItems);
  [self setInputOutput];
...
- (void)setInputOutput {
  ...
  OrgGeogebraCommonKernelAlgosAlgoElement_setAndConsume_input_(self, [IOSObjectArray newArrayWithLength:size type:OrgGeogebraCommonKernelGeosGeoElement_class_()]);
...
- (void)setCellRangeStringWithNSString:(NSString *)cellRangeString {
  OrgGeogebraCommonKernelAlgosAlgoDependentList_set_cellRangeString_(self, cellRangeString);
}
...
- (NSString *)toStringWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  ...
  if (sb_ == nil) OrgGeogebraCommonKernelAlgosAlgoDependentList_setAndConsume_sb_(self, new_JavaLangStringBuilder_init());
  ...
  if (((IOSObjectArray *) nil_chk(input_))->size_ > 0) {
    for (jint i = 0; i < input_->size_ - 1; i++) {
      [sb_ appendWithNSString:[((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(IOSObjectArray_Get(input_, i))) getLabelWithOrgGeogebraCommonKernelStringTemplate:tpl]];
      [sb_ appendWithNSString:@", "];
    }
    [sb_ appendWithNSString:[((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(IOSObjectArray_Get(input_, input_->size_ - 1))) getLabelWithOrgGeogebraCommonKernelStringTemplate:tpl]];
  }
  [sb_ appendWithNSString:@"}"];
...
void OrgGeogebraCommonKernelAlgosAlgoDependentList_initWithOrgGeogebraCommonKernelConstruction_withNSString_withJavaUtilArrayList_(OrgGeogebraCommonKernelAlgosAlgoDependentList *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, JavaUtilArrayList *listItems) {
  OrgGeogebraCommonKernelAlgosAlgoDependentList_initWithOrgGeogebraCommonKernelConstruction_withJavaUtilArrayList_withBoolean_(self, cons, listItems, NO);
...
void OrgGeogebraCommonKernelAlgosAlgoDependentList_initWithOrgGeogebraCommonKernelConstruction_withJavaUtilArrayList_withBoolean_(OrgGeogebraCommonKernelAlgosAlgoDependentList *self, OrgGeogebraCommonKernelConstruction *cons, JavaUtilArrayList *listItems, jboolean isCellRange) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoDependentList_setAndConsume_geoList_(self, new_OrgGeogebraCommonKernelGeosGeoList_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  OrgGeogebraCommonKernelAlgosAlgoDependentList_compute(self);
}
