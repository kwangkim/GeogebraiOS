...
- (void)compute {
  ...
  for (jint i = 0; i < outsize; i++) {
    ...
    if (i < [outputList_ size]) {
      ...
      OrgGeogebraCommonKernelGeosGeoPoint *p = new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withNSString_withDouble_withDouble_withDouble_(cons_, nil, ((OrgGeogebraCommonKernelMyPoint *) nil_chk(mp))->x_, mp->y_, 1.0);
...
void OrgGeogebraCommonKernelAlgosAlgoFirstLocus_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoLocus_withOrgGeogebraCommonKernelGeosGeoNumeric_(OrgGeogebraCommonKernelAlgosAlgoFirstLocus *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelGeosGeoLocus *inputLocus, OrgGeogebraCommonKernelGeosGeoNumeric *n) {
  (void) OrgGeogebraCommonKernelAlgosAlgoFirst_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoNumeric_(self, cons, label, inputLocus, n);
}
