...
- (IOSObjectArray *)getPolynomials {
  ...
  if (P_ != nil && l_ != nil) {
    ...
    OrgGeogebraCommonKernelAlgosAlgoOrthoLinePointLine_setAndConsume_polynomials_(self, [IOSObjectArray newArrayWithLength:3 type:OrgGeogebraCommonKernelProverPolynomialPolynomial_class_()]);
    IOSObjectArray_Set(polynomials_, 0, [((OrgGeogebraCommonKernelProverPolynomialPolynomial *) nil_chk([((OrgGeogebraCommonKernelProverPolynomialPolynomial *) nil_chk(IOSObjectArray_Get(nil_chk(pL), 1))) multiplyWithOrgGeogebraCommonKernelProverPolynomialPolynomial:IOSObjectArray_Get(nil_chk(pP), 2)])) negate]);
    IOSObjectArray_Set(polynomials_, 1, [((OrgGeogebraCommonKernelProverPolynomialPolynomial *) nil_chk(IOSObjectArray_Get(pL, 0))) multiplyWithOrgGeogebraCommonKernelProverPolynomialPolynomial:IOSObjectArray_Get(pP, 2)]);
...
- (IOSObjectArray *)getBotanaPolynomialsWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  ...
  if (P_ != nil && l_ != nil) {
    ...
    if (botanaVars_ == nil) {
      OrgGeogebraCommonKernelAlgosAlgoOrthoLinePointLine_setAndConsume_botanaVars_(self, [IOSObjectArray newArrayWithLength:4 type:OrgGeogebraCommonKernelProverPolynomialVariable_class_()]);
    ...
    OrgGeogebraCommonKernelAlgosAlgoOrthoLinePointLine_setAndConsume_botanaPolynomials_(self, [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonKernelProverPolynomialPolynomial_class_()]);
    OrgGeogebraCommonKernelProverPolynomialPolynomial *p1 = [new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(IOSObjectArray_Get(nil_chk(vP), 0)) autorelease];
    OrgGeogebraCommonKernelProverPolynomialPolynomial *p2 = [new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(IOSObjectArray_Get(vP, 1)) autorelease];
    ...
    OrgGeogebraCommonKernelProverPolynomialPolynomial *n1 = [new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(IOSObjectArray_Get(nil_chk(botanaVars_), 0)) autorelease];
    OrgGeogebraCommonKernelProverPolynomialPolynomial *n2 = [new_OrgGeogebraCommonKernelProverPolynomialPolynomial_initWithOrgGeogebraCommonKernelProverPolynomialVariable_(IOSObjectArray_Get(botanaVars_, 1)) autorelease];
    IOSObjectArray_Set(botanaPolynomials_, 0, [((OrgGeogebraCommonKernelProverPolynomialPolynomial *) nil_chk([((OrgGeogebraCommonKernelProverPolynomialPolynomial *) nil_chk([b1 subtractWithOrgGeogebraCommonKernelProverPolynomialPolynomial:a1])) addWithOrgGeogebraCommonKernelProverPolynomialPolynomial:p2])) subtractWithOrgGeogebraCommonKernelProverPolynomialPolynomial:n2]);
    IOSObjectArray_Set(botanaPolynomials_, 1, [((OrgGeogebraCommonKernelProverPolynomialPolynomial *) nil_chk([((OrgGeogebraCommonKernelProverPolynomialPolynomial *) nil_chk([p1 subtractWithOrgGeogebraCommonKernelProverPolynomialPolynomial:b2])) addWithOrgGeogebraCommonKernelProverPolynomialPolynomial:a2])) subtractWithOrgGeogebraCommonKernelProverPolynomialPolynomial:n1]);
    return botanaPolynomials_;
  }
  @throw [new_OrgGeogebraCommonKernelProverNoSymbolicParametersException_init() autorelease];
}
...
void OrgGeogebraCommonKernelAlgosAlgoOrthoLinePointLine_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoLine_(OrgGeogebraCommonKernelAlgosAlgoOrthoLinePointLine *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelGeosGeoPoint *P, OrgGeogebraCommonKernelGeosGeoLine *l) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoOrthoLinePointLine_set_P_(self, P);
  OrgGeogebraCommonKernelAlgosAlgoOrthoLinePointLine_set_l_(self, l);
  OrgGeogebraCommonKernelAlgosAlgoOrthoLinePointLine_setAndConsume_g_(self, new_OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelConstruction_(cons));
