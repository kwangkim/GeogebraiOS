...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/algos/AlgoLocusList.java
//
...
- (void)setInputOutput {
  ...
  OrgGeogebraCommonKernelAlgosAlgoLocusList_set_Qin_(self, [((OrgGeogebraCommonKernelGeosGeoPoint *) nil_chk(locusPoint_)) getAllPredecessors]);
  ...
  OrgGeogebraCommonKernelAlgosAlgoLocusList_setAndConsume_efficientInput_AlgoLocusList_(self, [IOSObjectArray newArrayWithLength:[inSet size] type:OrgGeogebraCommonKernelGeosGeoElement_class_()]);
  it = [inSet iterator];
  jint i = 0;
  while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoLocusList_setAndConsume_standardInput_(self, [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonKernelGeosGeoElement_class_()]);
...
void OrgGeogebraCommonKernelAlgosAlgoLocusList_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_withInt_(OrgGeogebraCommonKernelAlgosAlgoLocusList *self, OrgGeogebraCommonKernelConstruction *cons, OrgGeogebraCommonKernelGeosGeoPoint *Q, OrgGeogebraCommonKernelGeosGeoPoint *P, jint try_steps) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoLocusList_set_movingPoint_(self, P);
  OrgGeogebraCommonKernelAlgosAlgoLocusList_set_locusPoint_(self, Q);
  OrgGeogebraCommonKernelAlgosAlgoLocusList_set_path_(self, [((OrgGeogebraCommonKernelGeosGeoPoint *) nil_chk(P)) getPath]);
  OrgGeogebraCommonKernelAlgosAlgoLocusList_setAndConsume_locus_(self, new_OrgGeogebraCommonKernelGeosGeoLocus_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  OrgGeogebraCommonKernelAlgosAlgoLocusList_compute(self);
...
void OrgGeogebraCommonKernelAlgosAlgoLocusList_fillLocusArrayWithOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_(OrgGeogebraCommonKernelAlgosAlgoLocusList *self, OrgGeogebraCommonKernelGeosGeoPoint *Q, OrgGeogebraCommonKernelGeosGeoPoint *P) {
  if (self->arrLocus_ == nil) OrgGeogebraCommonKernelAlgosAlgoLocusList_setAndConsume_arrLocus_(self, new_JavaUtilArrayList_init());
      ...
      if (actel != nil && [OrgGeogebraCommonKernelPath_class_() isInstance:actel]) {
        ...
        if ([actel isKindOfClass:[OrgGeogebraCommonKernelGeosGeoList class]]) {
          if ([((OrgGeogebraCommonKernelGeosGeoList *) check_class_cast(actel, [OrgGeogebraCommonKernelGeosGeoList class])) shouldUseAlgoLocusListWithBoolean:YES]) {
            actal = [new_OrgGeogebraCommonKernelAlgosAlgoLocusList_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_withInt_(self->cons_, Q, P, try_steps) autorelease];
            ...
            actal = [new_OrgGeogebraCommonKernelAlgosAlgoLocus_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_withInt_withBoolean_(self->cons_, Q, P, try_steps, NO) autorelease];
