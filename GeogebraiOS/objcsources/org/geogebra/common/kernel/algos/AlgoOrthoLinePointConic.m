...
- (void)setInputOutput {
  ...
  IOSObjectArray_Set(input_, 1, [((OrgGeogebraCommonKernelGeosGeoConic *) nil_chk(l_)) toGeoElement]);
...
void OrgGeogebraCommonKernelAlgosAlgoOrthoLinePointConic_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoConic_(OrgGeogebraCommonKernelAlgosAlgoOrthoLinePointConic *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelGeosGeoPoint *P, OrgGeogebraCommonKernelGeosGeoConic *l) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoOrthoLinePointConic_set_P_(self, P);
  OrgGeogebraCommonKernelAlgosAlgoOrthoLinePointConic_set_l_(self, l);
  OrgGeogebraCommonKernelAlgosAlgoOrthoLinePointConic_setAndConsume_g_(self, [IOSObjectArray newArrayWithLength:4 type:OrgGeogebraCommonKernelGeosGeoLine_class_()]);
  OrgGeogebraCommonKernelAlgosAlgoOrthoLinePointConic_setAndConsume_n_(self, [IOSObjectArray newArrayWithLength:4 type:OrgGeogebraCommonKernelGeosGeoNumeric_class_()]);
  OrgGeogebraCommonKernelAlgosAlgoOrthoLinePointConic_setAndConsume_algoPoint_(self, [IOSObjectArray newArrayWithLength:4 type:OrgGeogebraCommonKernelAlgosAlgoPointOnPath_class_()]);
  OrgGeogebraCommonKernelAlgosAlgoOrthoLinePointConic_setAndConsume_closestPoint_(self, new_OrgGeogebraCommonKernelAlgosAlgoClosestPoint_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelPath_withOrgGeogebraCommonKernelKernelNDGeoPointND_(cons, l, P));
  for (jint i = 0; i < 4; i++) {
    IOSObjectArray_SetAndConsume(self->g_, i, new_OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelConstruction_(cons));
    ...
    IOSObjectArray_SetAndConsume(self->n_, i, new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(cons));
    IOSObjectArray_SetAndConsume(self->algoPoint_, i, new_OrgGeogebraCommonKernelAlgosAlgoPointOnPath_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelPath_withDouble_withDouble_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons, l, 0, 0, IOSObjectArray_Get(self->n_, i)));
