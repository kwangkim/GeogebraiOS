...
void OrgGeogebraCommonKernelAlgosAlgoDependentLine_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticEquation_(OrgGeogebraCommonKernelAlgosAlgoDependentLine *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelArithmeticEquation *equ) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoDependentLine_setAndConsume_ev_(self, [IOSObjectArray newArrayWithLength:3 type:OrgGeogebraCommonKernelArithmeticExpressionValue_class_()]);
  OrgGeogebraCommonKernelAlgosAlgoDependentLine_set_equation_(self, equ);
  ...
  OrgGeogebraCommonKernelAlgosAlgoDependentLine_setAndConsume_g_(self, new_OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  OrgGeogebraCommonKernelAlgosAlgoDependentLine_compute(self);
