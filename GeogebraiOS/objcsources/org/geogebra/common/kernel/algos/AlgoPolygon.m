...
- (void)createPolygonWithBoolean:(jboolean)createSegments {
  poly_ = new_OrgGeogebraCommonKernelGeosGeoPolygon_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_(self->cons_, self->points_);
}
...
- (IOSObjectArray *)createEfficientInput {
  ...
  if (geoList_ != nil) {
    efficientInput = [IOSObjectArray newArrayWithLength:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    (void) IOSObjectArray_Set(efficientInput, 0, geoList_);
  }
  else {
    efficientInput = [IOSObjectArray newArrayWithLength:((IOSObjectArray *) nil_chk(points_))->size_ type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    for (jint i = 0; i < points_->size_; i++) (void) IOSObjectArray_Set(efficientInput, i, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(IOSObjectArray_Get(points_, i), [OrgGeogebraCommonKernelGeosGeoElement class]));
  }
...
- (void)setInputOutput {
  ...
  if (polyhedron_ == nil) {
    ...
    input_ = [IOSObjectArray newArrayWithLength:((IOSObjectArray *) nil_chk(efficientInput))->size_ + 1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    for (jint i = 0; i < efficientInput->size_; i++) (void) IOSObjectArray_Set(input_, i, IOSObjectArray_Get(efficientInput, i));
    (void) IOSObjectArray_Set(input_, efficientInput->size_, polyhedron_);
  }
...
- (void)createStringBuilderWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  ...
  if (geoList_ != nil) {
    ...
    for (jint i = 0; i < last; i++) {
      (void) [((JavaLangStringBuilder *) nil_chk(sb_)) appendWithNSString:[((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(IOSObjectArray_Get(points_, i))) getLabelWithOrgGeogebraCommonKernelStringTemplate:tpl]];
      (void) [sb_ appendWithNSString:@", "];
    }
    (void) [((JavaLangStringBuilder *) nil_chk(sb_)) appendWithNSString:[((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(IOSObjectArray_Get(points_, last))) getLabelWithOrgGeogebraCommonKernelStringTemplate:tpl]];
    label = [sb_ description];
    [sb_ setLengthWithInt:0];
  }
  (void) [((JavaLangStringBuilder *) nil_chk(sb_)) appendWithNSString:[((OrgGeogebraCommonMainLocalization *) nil_chk([self getLoc])) getPlainWithNSString:@"PolygonA" withNSString:label]];
}
...
void OrgGeogebraCommonKernelAlgosAlgoPolygon_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelGeosGeoList_(OrgGeogebraCommonKernelAlgosAlgoPolygon *self, OrgGeogebraCommonKernelConstruction *cons, IOSObjectArray *labels, OrgGeogebraCommonKernelGeosGeoList *geoList) {
  (void) OrgGeogebraCommonKernelAlgosAlgoPolygon_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_withOrgGeogebraCommonKernelGeosGeoList_(self, cons, labels, nil, geoList);
}
...
void OrgGeogebraCommonKernelAlgosAlgoPolygon_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_(OrgGeogebraCommonKernelAlgosAlgoPolygon *self, OrgGeogebraCommonKernelConstruction *cons, IOSObjectArray *labels, IOSObjectArray *points) {
  (void) OrgGeogebraCommonKernelAlgosAlgoPolygon_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_withOrgGeogebraCommonKernelGeosGeoList_(self, cons, labels, points, nil);
}
