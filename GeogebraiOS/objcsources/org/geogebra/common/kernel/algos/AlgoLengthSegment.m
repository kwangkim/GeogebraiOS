...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/javasources/org/geogebra/common/kernel/algos/AlgoLengthSegment.java
//
...
- (void)setInputOutput {
  ...
  IOSObjectArray_Set(input_, 0, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(seg_, [OrgGeogebraCommonKernelGeosGeoElement class]));
...
void OrgGeogebraCommonKernelAlgosAlgoLengthSegment_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelKernelNDGeoSegmentND_(OrgGeogebraCommonKernelAlgosAlgoLengthSegment *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, id<OrgGeogebraCommonKernelKernelNDGeoSegmentND> seg) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoLengthSegment_set_seg_(self, seg);
  OrgGeogebraCommonKernelAlgosAlgoLengthSegment_setAndConsume_num_(self, new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  OrgGeogebraCommonKernelAlgosAlgoLengthSegment_compute(self);
