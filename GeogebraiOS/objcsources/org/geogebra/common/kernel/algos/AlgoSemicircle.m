...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/algos/AlgoSemicircle.java
//
...
void OrgGeogebraCommonKernelAlgosAlgoSemicircle_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_(OrgGeogebraCommonKernelAlgosAlgoSemicircle *self, OrgGeogebraCommonKernelConstruction *cons, OrgGeogebraCommonKernelGeosGeoPoint *A, OrgGeogebraCommonKernelGeosGeoPoint *B) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoSemicircle_set_A_(self, A);
  OrgGeogebraCommonKernelAlgosAlgoSemicircle_set_B_(self, B);
  OrgGeogebraCommonKernelAlgosAlgoMidpoint *algom = [new_OrgGeogebraCommonKernelAlgosAlgoMidpoint_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_(cons, A, B) autorelease];
  ...
  OrgGeogebraCommonKernelAlgosAlgoSemicircle_set_M_(self, [algom getPoint]);
  OrgGeogebraCommonKernelAlgosAlgoCircleTwoPoints *algo = [new_OrgGeogebraCommonKernelAlgosAlgoCircleTwoPoints_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_(cons, self->M_, B) autorelease];
  [cons removeFromConstructionListWithOrgGeogebraCommonKernelAlgosConstructionElement:algo];
  OrgGeogebraCommonKernelAlgosAlgoSemicircle_set_conic_(self, [algo getCircle]);
  OrgGeogebraCommonKernelAlgosAlgoSemicircle_setAndConsume_conicPart_(self, new_OrgGeogebraCommonKernelGeosGeoConicPart_initWithOrgGeogebraCommonKernelConstruction_withInt_(cons, OrgGeogebraCommonKernelKernelNDGeoConicNDConstants_CONIC_PART_ARC));
