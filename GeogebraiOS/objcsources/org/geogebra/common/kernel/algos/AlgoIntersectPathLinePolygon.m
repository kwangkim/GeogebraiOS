...
- (void)setFirstInputWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  OrgGeogebraCommonKernelAlgosAlgoIntersectPathLinePolygon_set_g_(self, (id<OrgGeogebraCommonKernelKernelNDGeoLineND>) check_protocol_cast(geo, @protocol(OrgGeogebraCommonKernelKernelNDGeoLineND)));
}
...
- (void)setSecondInputWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  OrgGeogebraCommonKernelAlgosAlgoIntersectPathLinePolygon_set_p_(self, (OrgGeogebraCommonKernelGeosGeoPolygon *) check_class_cast(geo, [OrgGeogebraCommonKernelGeosGeoPolygon class]));
}
...
- (void)setIntersectionLine {
  OrgGeogebraCommonKernelAlgosAlgoIntersectPathLinePolygon_set_o1_(self, [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk([((id<OrgGeogebraCommonKernelKernelNDGeoLineND>) nil_chk(g_)) getPointInDWithInt:3 withDouble:0])) getInhomCoordsInSameDimension]);
  OrgGeogebraCommonKernelAlgosAlgoIntersectPathLinePolygon_set_d1_(self, [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk([((OrgGeogebraCommonKernelMatrixCoords *) nil_chk([g_ getPointInDWithInt:3 withDouble:1])) getInhomCoordsInSameDimension])) subWithOrgGeogebraCommonKernelMatrixCoords:o1_]);
}
...
- (void)intersectionsCoordsWithOrgGeogebraCommonKernelGeosGeoPolygon:(OrgGeogebraCommonKernelGeosGeoPolygon *)p {
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk([((OrgGeogebraCommonKernelGeosGeoPolygon *) nil_chk(p)) getSegments]))->size_; i++) {
    ...
    if ([((id<OrgGeogebraCommonKernelKernelNDGeoSegmentND>) nil_chk(seg)) isDefined]) {
      ...
      if (project1_ == nil) {
        OrgGeogebraCommonKernelAlgosAlgoIntersectPathLinePolygon_setAndConsume_project1_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4));
        OrgGeogebraCommonKernelAlgosAlgoIntersectPathLinePolygon_setAndConsume_project2_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4));
        OrgGeogebraCommonKernelAlgosAlgoIntersectPathLinePolygon_setAndConsume_lineCoords_(self, [IOSDoubleArray newArrayWithLength:2]);
        OrgGeogebraCommonKernelAlgosAlgoIntersectPathLinePolygon_setAndConsume_tmp_(self, [IOSDoubleArray newArrayWithLength:4]);
      }
...
- (void)addStartEndPoints {
  if ([g_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoSegment class]]) {
    [((JavaUtilTreeMap *) nil_chk(newCoords_)) putWithId:JavaLangDouble_valueOfWithDouble_(0.0) withId:[((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk([((id<OrgGeogebraCommonKernelKernelNDGeoLineND>) nil_chk(g_)) getStartPoint])) getInhomCoordsInD2]];
    [newCoords_ putWithId:JavaLangDouble_valueOfWithDouble_(1.0) withId:[((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk([g_ getEndPoint])) getInhomCoordsInD2]];
  }
  else if ([g_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoRay class]]) [((JavaUtilTreeMap *) nil_chk(newCoords_)) putWithId:JavaLangDouble_valueOfWithDouble_(0.0) withId:[((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk([((id<OrgGeogebraCommonKernelKernelNDGeoLineND>) nil_chk(g_)) getStartPoint])) getInhomCoordsInD2]];
}
...
withOrgGeogebraCommonKernelKernelNDGeoElementND:(id<OrgGeogebraCommonKernelKernelNDGeoElementND>)parent {
  [((JavaUtilTreeMap *) nil_chk(newCoords_)) putWithId:JavaLangDouble_valueOfWithDouble_(parameter) withId:[new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_([((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(coords)) getX], [coords getY]) autorelease]];
}
...
- (void)compute {
  ...
  if ([((JavaUtilTreeMap *) nil_chk(newCoords_)) size] < 2) {
    ...
    IOSObjectArray *points = [IOSObjectArray arrayWithLength:[newCoords_ size] type:OrgGeogebraCommonKernelMatrixCoords_class_()];
    ...
    for (jint i = 1; i < [newCoords_ size]; i++) {
      ...
      if ([self checkMidpointWithOrgGeogebraCommonKernelGeosGeoPolygon:p_ withOrgGeogebraCommonKernelMatrixCoords:a withOrgGeogebraCommonKernelMatrixCoords:b]) {
        ...
        if (startSegment != nil) {
          [segmentList addWithId:[IOSObjectArray arrayWithObjects:(id[]){ startSegment, endSegment } count:2 type:OrgGeogebraCommonKernelMatrixCoords_class_()]];
          startSegment = nil;
        }
      }
    }
    if (startSegment != nil) [segmentList addWithId:[IOSObjectArray arrayWithObjects:(id[]){ startSegment, endSegment } count:2 type:OrgGeogebraCommonKernelMatrixCoords_class_()]];
...
void OrgGeogebraCommonKernelAlgosAlgoIntersectPathLinePolygon_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoElement_(OrgGeogebraCommonKernelAlgosAlgoIntersectPathLinePolygon *self, OrgGeogebraCommonKernelConstruction *c, OrgGeogebraCommonKernelGeosGeoElement *geo, OrgGeogebraCommonKernelGeosGeoElement *p) {
  ...
  self->hasLabels_ = NO;
  OrgGeogebraCommonKernelAlgosAlgoIntersectPathLinePolygon_set_project_(self, OrgGeogebraCommonKernelMatrixCoords_createInhomCoorsInD3());
  OrgGeogebraCommonKernelAlgosAlgoIntersectPathLinePolygon_setAndConsume_parameters_(self, [IOSDoubleArray newArrayWithLength:2]);
  OrgGeogebraCommonKernelAlgosAlgoIntersectPathLinePolygon_set_outputSegments_(self, [self createOutputSegments]);
  ...
  OrgGeogebraCommonKernelAlgosAlgoIntersectPathLinePolygon_setAndConsume_newCoords_(self, new_JavaUtilTreeMap_initWithJavaUtilComparator_(OrgGeogebraCommonKernelKernel_DoubleComparatorWithDouble_(OrgGeogebraCommonKernelKernel_STANDARD_PRECISION)));
  [self setInputOutput];
}
...
- (OrgGeogebraCommonKernelGeosGeoSegment *)newElement {
  OrgGeogebraCommonKernelGeosGeoSegment *a = [new_OrgGeogebraCommonKernelGeosGeoSegment_initWithOrgGeogebraCommonKernelConstruction_(this$0_->cons_) autorelease];
  OrgGeogebraCommonKernelGeosGeoPoint *aS = [new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(this$0_->cons_) autorelease];
  [aS setCoordsWithDouble:0 withDouble:0 withDouble:1];
  OrgGeogebraCommonKernelGeosGeoPoint *aE = [new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(this$0_->cons_) autorelease];
...
void OrgGeogebraCommonKernelAlgosAlgoIntersectPathLinePolygon_$1_initWithOrgGeogebraCommonKernelAlgosAlgoIntersectPathLinePolygon_(OrgGeogebraCommonKernelAlgosAlgoIntersectPathLinePolygon_$1 *self, OrgGeogebraCommonKernelAlgosAlgoIntersectPathLinePolygon *outer$) {
  OrgGeogebraCommonKernelAlgosAlgoIntersectPathLinePolygon_$1_set_this$0_(self, outer$);
  NSObject_init(self);
}
