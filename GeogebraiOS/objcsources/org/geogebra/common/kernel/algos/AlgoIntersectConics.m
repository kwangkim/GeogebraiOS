...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/algos/AlgoIntersectConics.java
//
...
- (IOSObjectArray *)getBotanaPolynomialsWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  ...
  if (A_ != nil && B_ != nil && [A_ isCircle] && [B_ isCircle]) {
    ...
    if (botanaVars_ == nil) {
      OrgGeogebraCommonKernelAlgosAlgoIntersectConics_setAndConsume_botanaVars_(self, new_JavaUtilHashMap_init());
    }
    ...
    IOSObjectArray_Set(nil_chk(botanaPolynomialsThis), 0, OrgGeogebraCommonKernelProverPolynomialPolynomial_equidistantWithOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_(IOSObjectArray_Get(nil_chk(vA), 2), IOSObjectArray_Get(vA, 3), IOSObjectArray_Get(vA, 0), IOSObjectArray_Get(vA, 1), IOSObjectArray_Get(nil_chk(botanaVarsThis), 0), IOSObjectArray_Get(botanaVarsThis, 1)));
    ...
    if (botanaPolynomials_ == nil) {
      OrgGeogebraCommonKernelAlgosAlgoIntersectConics_setAndConsume_botanaPolynomials_(self, new_JavaUtilHashMap_init());
    }
...
void OrgGeogebraCommonKernelAlgosAlgoIntersectConics_initWithOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonKernelAlgosAlgoIntersectConics *self, OrgGeogebraCommonKernelConstruction *cons) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoIntersectConics_setAndConsume_pointList_(self, new_OrgGeogebraCommonKernelPointPairList_init());
  OrgGeogebraCommonKernelAlgosAlgoIntersectConics_set_eqnSolver_(self, [((OrgGeogebraCommonKernelKernel *) nil_chk([((OrgGeogebraCommonKernelConstruction *) nil_chk(cons)) getKernel])) getEquationSolver]);
  OrgGeogebraCommonKernelAlgosAlgoIntersectConics_set_sysSolver_(self, [((OrgGeogebraCommonKernelKernel *) nil_chk([cons getKernel])) getSystemOfEquationsSolverWithOrgGeogebraCommonKernelEquationSolverInterface:self->eqnSolver_]);
  OrgGeogebraCommonKernelAlgosAlgoIntersectConics_setAndConsume_degConic_(self, new_OrgGeogebraCommonKernelGeosGeoConic_initWithOrgGeogebraCommonKernelConstruction_(cons));
}
...
void OrgGeogebraCommonKernelAlgosAlgoIntersectConics_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoConic_withOrgGeogebraCommonKernelGeosGeoConic_(OrgGeogebraCommonKernelAlgosAlgoIntersectConics *self, OrgGeogebraCommonKernelConstruction *cons, OrgGeogebraCommonKernelGeosGeoConic *A, OrgGeogebraCommonKernelGeosGeoConic *B) {
  OrgGeogebraCommonKernelAlgosAlgoIntersectConics_initWithOrgGeogebraCommonKernelConstruction_(self, cons);
  OrgGeogebraCommonKernelAlgosAlgoIntersectConics_set_A_(self, A);
  OrgGeogebraCommonKernelAlgosAlgoIntersectConics_set_B_(self, B);
  ...
  OrgGeogebraCommonKernelAlgosAlgoIntersectConics_setAndConsume_P_(self, [IOSObjectArray newArrayWithLength:4 type:OrgGeogebraCommonKernelGeosGeoPoint_class_()]);
  OrgGeogebraCommonKernelAlgosAlgoIntersectConics_setAndConsume_D_(self, [IOSObjectArray newArrayWithLength:4 type:OrgGeogebraCommonKernelGeosGeoPoint_class_()]);
  OrgGeogebraCommonKernelAlgosAlgoIntersectConics_setAndConsume_Q_(self, [IOSObjectArray newArrayWithLength:4 type:OrgGeogebraCommonKernelGeosGeoPoint_class_()]);
  OrgGeogebraCommonKernelAlgosAlgoIntersectConics_setAndConsume_preexistPoints_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonKernelAlgosAlgoIntersectConics_setAndConsume_newPoints_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonKernelAlgosAlgoIntersectConics_setAndConsume_isQonPath_(self, [IOSBooleanArray newArrayWithLength:4]);
  OrgGeogebraCommonKernelAlgosAlgoIntersectConics_setAndConsume_isPalive_(self, [IOSBooleanArray newArrayWithLength:4]);
  OrgGeogebraCommonKernelAlgosAlgoIntersectConics_setAndConsume_age_(self, [IOSIntArray newArrayWithLength:4]);
  OrgGeogebraCommonKernelAlgosAlgoIntersectConics_setAndConsume_permutation_(self, [IOSIntArray newArrayWithInts:(jint[]){ 0, 1, 2, 3 } count:4]);
  OrgGeogebraCommonKernelAlgosAlgoIntersectConics_setAndConsume_distTable_(self, [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ 4, 4 }]);
  for (jint i = 0; i < 4; i++) {
    IOSObjectArray_SetAndConsume(self->P_, i, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons));
    IOSObjectArray_SetAndConsume(self->Q_, i, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons));
    IOSObjectArray_SetAndConsume(self->D_, i, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons));
  }
...
jboolean OrgGeogebraCommonKernelAlgosAlgoIntersectConics_intersectConicsWithEqualSubmatrixSWithOrgGeogebraCommonKernelGeosGeoConic_withOrgGeogebraCommonKernelGeosGeoConic_withOrgGeogebraCommonKernelGeosGeoPointArray_withDouble_(OrgGeogebraCommonKernelAlgosAlgoIntersectConics *self, OrgGeogebraCommonKernelGeosGeoConic *c1, OrgGeogebraCommonKernelGeosGeoConic *c2, IOSObjectArray *points, jdouble eps) {
  if (self->tempLine_ == nil) {
    OrgGeogebraCommonKernelAlgosAlgoIntersectConics_setAndConsume_tempLine_(self, new_OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelConstruction_(self->cons_));
  }
