...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/algos/AlgoFunctionInterval.java
//
...
void OrgGeogebraCommonKernelAlgosAlgoFunctionInterval_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoFunction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_(OrgGeogebraCommonKernelAlgosAlgoFunctionInterval *self, OrgGeogebraCommonKernelConstruction *cons, OrgGeogebraCommonKernelGeosGeoFunction *f, id<OrgGeogebraCommonKernelArithmeticNumberValue> a, id<OrgGeogebraCommonKernelArithmeticNumberValue> b) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoFunctionInterval_set_f_(self, f);
  OrgGeogebraCommonKernelAlgosAlgoFunctionInterval_set_a_(self, a);
  OrgGeogebraCommonKernelAlgosAlgoFunctionInterval_set_b_(self, b);
  OrgGeogebraCommonKernelAlgosAlgoFunctionInterval_set_ageo_(self, [((id<OrgGeogebraCommonKernelArithmeticNumberValue>) nil_chk(a)) toGeoElement]);
  OrgGeogebraCommonKernelAlgosAlgoFunctionInterval_set_bgeo_(self, [((id<OrgGeogebraCommonKernelArithmeticNumberValue>) nil_chk(b)) toGeoElement]);
  OrgGeogebraCommonKernelAlgosAlgoFunctionInterval_set_g_(self, (OrgGeogebraCommonKernelGeosGeoFunction *) check_class_cast([((OrgGeogebraCommonKernelGeosGeoFunction *) nil_chk(f)) copyInternalWithOrgGeogebraCommonKernelConstruction:cons], [OrgGeogebraCommonKernelGeosGeoFunction class]));
  [self setInputOutput];
  OrgGeogebraCommonKernelAlgosAlgoFunctionInterval_compute(self);
}
...
jboolean OrgGeogebraCommonKernelAlgosAlgoFunctionInterval_hasEqualExpressionsWithOrgGeogebraCommonKernelGeosGeoFunction_(OrgGeogebraCommonKernelAlgosAlgoFunctionInterval *self, OrgGeogebraCommonKernelGeosGeoFunction *f) {
  ...
  equal = (self->exp_ == en);
  OrgGeogebraCommonKernelAlgosAlgoFunctionInterval_set_exp_(self, en);
  return equal;
}
