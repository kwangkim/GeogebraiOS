...
- (void)setInputOutput {
  OrgGeogebraCommonKernelAlgosAlgoElement_setAndConsume_input_(self, [IOSObjectArray newArrayWithLength:num_ == nil ? 2 : 3 type:OrgGeogebraCommonKernelGeosGeoElement_class_()]);
...
- (void)setTransformedObjectWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)g
  ...
  OrgGeogebraCommonKernelAlgosAlgoShearOrStretch_set_inGeo_(self, g);
  OrgGeogebraCommonKernelAlgosAlgoShearOrStretch_set_outGeo_(self, g2);
  if (!([outGeo_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoList class]])) OrgGeogebraCommonKernelAlgosAlgoShearOrStretch_set_out_(self, (id<OrgGeogebraCommonKernelMatrixTransformable>) check_protocol_cast(outGeo_, @protocol(OrgGeogebraCommonKernelMatrixTransformable)));
}
...
void OrgGeogebraCommonKernelAlgosAlgoShearOrStretch_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoVec3D_withOrgGeogebraCommonKernelArithmeticNumberValue_withBoolean_(OrgGeogebraCommonKernelAlgosAlgoShearOrStretch *self, OrgGeogebraCommonKernelConstruction *cons, OrgGeogebraCommonKernelGeosGeoElement *inArg, OrgGeogebraCommonKernelGeosGeoVec3D *l, id<OrgGeogebraCommonKernelArithmeticNumberValue> num, jboolean shear) {
  ...
  self->shear_ = shear;
  OrgGeogebraCommonKernelAlgosAlgoShearOrStretch_set_line_(self, l);
  OrgGeogebraCommonKernelAlgosAlgoShearOrStretch_set_num_(self, num);
  OrgGeogebraCommonKernelAlgosAlgoShearOrStretch_set_inGeo_(self, inArg);
  if ([OrgGeogebraCommonKernelGeosGeoPoly_class_() isInstance:self->inGeo_] || [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(self->inGeo_)) isLimitedPath]) {
    OrgGeogebraCommonKernelAlgosAlgoShearOrStretch_set_outGeo_(self, [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(inArg)) copyInternalWithOrgGeogebraCommonKernelConstruction:cons]);
    OrgGeogebraCommonKernelAlgosAlgoShearOrStretch_set_out_(self, (id<OrgGeogebraCommonKernelMatrixTransformable>) check_protocol_cast(self->outGeo_, @protocol(OrgGeogebraCommonKernelMatrixTransformable)));
  }
  else if ([self->inGeo_ isGeoList]) {
    OrgGeogebraCommonKernelAlgosAlgoShearOrStretch_setAndConsume_outGeo_(self, new_OrgGeogebraCommonKernelGeosGeoList_initWithOrgGeogebraCommonKernelConstruction_(cons));
  }
  else if ([self->inGeo_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoFunction class]]) {
    OrgGeogebraCommonKernelAlgosAlgoShearOrStretch_setAndConsume_out_(self, new_OrgGeogebraCommonKernelGeosGeoCurveCartesian_initWithOrgGeogebraCommonKernelConstruction_(cons));
    OrgGeogebraCommonKernelAlgosAlgoShearOrStretch_set_outGeo_(self, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(self->out_, [OrgGeogebraCommonKernelGeosGeoElement class]));
  }
  else {
    OrgGeogebraCommonKernelAlgosAlgoShearOrStretch_set_out_(self, (id<OrgGeogebraCommonKernelMatrixTransformable>) check_protocol_cast([self->inGeo_ copy__], @protocol(OrgGeogebraCommonKernelMatrixTransformable)));
    OrgGeogebraCommonKernelAlgosAlgoShearOrStretch_set_outGeo_(self, [((id<OrgGeogebraCommonKernelMatrixTransformable>) nil_chk(self->out_)) toGeoElement]);
  }
  [self setInputOutput];
  OrgGeogebraCommonKernelAlgosAlgoShearOrStretch_compute(self);
...
void OrgGeogebraCommonKernelAlgosAlgoShearOrStretch_compute(OrgGeogebraCommonKernelAlgosAlgoShearOrStretch *self) {
  ...
  [((id<OrgGeogebraCommonKernelGeosTranslateable>) nil_chk(tranOut)) translateWithOrgGeogebraCommonKernelMatrixCoords:[new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_(qx, qy, 0) autorelease]];
  if (self->shear_) {
  ...
  [tranOut translateWithOrgGeogebraCommonKernelMatrixCoords:[new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_(-qx, -qy, 0) autorelease]];
