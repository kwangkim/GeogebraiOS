...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/algos/AlgoNSolveODE.java
//
...
- (void)setInputOutput {
  ...
  OrgGeogebraCommonKernelAlgosAlgoNSolveODE_setAndConsume_out_(self, [IOSObjectArray newArrayWithLength:dim_ type:OrgGeogebraCommonKernelGeosGeoLocus_class_()]);
  for (jint i = 0; i < dim_; i++) {
    IOSObjectArray_SetAndConsume(out_, i, new_OrgGeogebraCommonKernelGeosGeoLocus_initWithOrgGeogebraCommonKernelConstruction_(cons_));
  }
...
- (void)compute {
  ...
  OrgGeogebraCommonKernelAlgosAlgoNSolveODE_setAndConsume_al_(self, [IOSObjectArray newArrayWithLength:dim_ type:JavaUtilArrayList_class_()]);
  for (jint i = 0; i < dim_; i++) {
  ...
  id<OrgApacheCommonsMathOdeFirstOrderDifferentialEquations> ode = [new_OrgGeogebraCommonKernelAlgosAlgoNSolveODE_ODEN_initWithOrgGeogebraCommonKernelAlgosAlgoNSolveODE_withOrgGeogebraCommonKernelGeosGeoList_(self, fun_) autorelease];
  [integrator addStepHandlerWithOrgApacheCommonsMathOdeSamplingStepHandler:stepHandler_];
  for (jint i = 0; i < dim_; i++) {
    [((JavaUtilArrayList *) nil_chk(IOSObjectArray_Get(al_, i))) addWithId:[new_OrgGeogebraCommonKernelMyPoint_initWithDouble_withDouble_withBoolean_([startX_ getDouble], IOSDoubleArray_Get(nil_chk(y0_), i), NO) autorelease]];
  }
  @try {
...
void OrgGeogebraCommonKernelAlgosAlgoNSolveODE_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelGeosGeoNumeric_(OrgGeogebraCommonKernelAlgosAlgoNSolveODE *self, OrgGeogebraCommonKernelConstruction *cons, IOSObjectArray *labels, OrgGeogebraCommonKernelGeosGeoList *fun, OrgGeogebraCommonKernelGeosGeoNumeric *startX, OrgGeogebraCommonKernelGeosGeoList *startY, OrgGeogebraCommonKernelGeosGeoNumeric *endX) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoNSolveODE_setAndConsume_stepHandler_(self, new_OrgGeogebraCommonKernelAlgosAlgoNSolveODE_$1_initWithOrgGeogebraCommonKernelAlgosAlgoNSolveODE_(self));
  OrgGeogebraCommonKernelAlgosAlgoNSolveODE_set_fun_(self, fun);
  OrgGeogebraCommonKernelAlgosAlgoNSolveODE_set_startY_(self, startY);
  OrgGeogebraCommonKernelAlgosAlgoNSolveODE_set_startX_(self, startX);
  OrgGeogebraCommonKernelAlgosAlgoNSolveODE_set_endX_(self, endX);
  self->dim_ = [((OrgGeogebraCommonKernelGeosGeoList *) nil_chk(fun)) size];
  OrgGeogebraCommonKernelAlgosAlgoNSolveODE_setAndConsume_y0_(self, [IOSDoubleArray newArrayWithLength:self->dim_]);
  [self setInputOutput];
  [self compute];
...
void OrgGeogebraCommonKernelAlgosAlgoNSolveODE_ODEN_initWithOrgGeogebraCommonKernelAlgosAlgoNSolveODE_withOrgGeogebraCommonKernelGeosGeoList_(OrgGeogebraCommonKernelAlgosAlgoNSolveODE_ODEN *self, OrgGeogebraCommonKernelAlgosAlgoNSolveODE *outer$, OrgGeogebraCommonKernelGeosGeoList *fun) {
  OrgGeogebraCommonKernelAlgosAlgoNSolveODE_ODEN_set_this$0_(self, outer$);
  NSObject_init(self);
  OrgGeogebraCommonKernelAlgosAlgoNSolveODE_ODEN_set_fun1_(self, fun);
}
...
- (void)handleStepWithOrgApacheCommonsMathOdeSamplingStepInterpolator:(id<OrgApacheCommonsMathOdeSamplingStepInterpolator>)interpolator
  ...
  for (jint i = 0; i < ((IOSDoubleArray *) nil_chk(y1))->size_; i++) {
    [((JavaUtilArrayList *) nil_chk(IOSObjectArray_Get(nil_chk(this$0_->al_), i))) addWithId:[new_OrgGeogebraCommonKernelMyPoint_initWithDouble_withDouble_withBoolean_(t, IOSDoubleArray_Get(y1, i), YES) autorelease]];
  }
}
...
void OrgGeogebraCommonKernelAlgosAlgoNSolveODE_$1_initWithOrgGeogebraCommonKernelAlgosAlgoNSolveODE_(OrgGeogebraCommonKernelAlgosAlgoNSolveODE_$1 *self, OrgGeogebraCommonKernelAlgosAlgoNSolveODE *outer$) {
  OrgGeogebraCommonKernelAlgosAlgoNSolveODE_$1_set_this$0_(self, outer$);
  NSObject_init(self);
}
