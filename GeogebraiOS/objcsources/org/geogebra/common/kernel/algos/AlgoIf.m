...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/algos/AlgoIf.java
//
...
- (void)setInputOutput {
  OrgGeogebraCommonKernelAlgosAlgoElement_setAndConsume_input_(self, [IOSObjectArray newArrayWithLength:[((JavaUtilArrayList *) nil_chk(conditions_)) size] + [((JavaUtilArrayList *) nil_chk(alternatives_)) size] type:OrgGeogebraCommonKernelGeosGeoElement_class_()]);
...
- (OrgGeogebraCommonKernelArithmeticExpressionNode *)toExpression {
  if ([((JavaUtilArrayList *) nil_chk(self->alternatives_)) size] == 1) {
    ...
    return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, [new_OrgGeogebraCommonKernelArithmeticMyNumberPair_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, [((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) convertNumberValueToExpressionNodeWithOrgGeogebraCommonKernelGeosGeoElement:[self->conditions_ getWithInt:0]], [kernel_ convertNumberValueToExpressionNodeWithOrgGeogebraCommonKernelGeosGeoElement:[self->alternatives_ getWithInt:0]]) autorelease], OrgGeogebraCommonPluginOperationEnum_get_IF_ELSE(), [kernel_ convertNumberValueToExpressionNodeWithOrgGeogebraCommonKernelGeosGeoElement:[self->alternatives_ getWithInt:1]]) autorelease];
  }
  OrgGeogebraCommonKernelArithmeticMyList *cond = [new_OrgGeogebraCommonKernelArithmeticMyList_initWithOrgGeogebraCommonKernelKernel_(kernel_) autorelease], *funs = [new_OrgGeogebraCommonKernelArithmeticMyList_initWithOrgGeogebraCommonKernelKernel_(kernel_) autorelease];
  ...
  return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, cond, OrgGeogebraCommonPluginOperationEnum_get_IF_LIST(), funs) autorelease];
}
...
void OrgGeogebraCommonKernelAlgosAlgoIf_initWithOrgGeogebraCommonKernelConstruction_withNSString_withJavaUtilArrayList_withJavaUtilArrayList_(OrgGeogebraCommonKernelAlgosAlgoIf *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, JavaUtilArrayList *conditions, JavaUtilArrayList *alternatives) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoIf_set_conditions_(self, conditions);
  OrgGeogebraCommonKernelAlgosAlgoIf_set_alternatives_(self, alternatives);
  OrgGeogebraCommonKernelAlgosAlgoIf_set_result_(self, [((JavaUtilArrayList *) nil_chk(alternatives)) getWithInt:0]);
  jint i = 1;
  while (i < [alternatives size] && OrgGeogebraCommonKernelGeosTestEnum_canSetWithOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoElement_([alternatives getWithInt:i], self->result_)) {
    OrgGeogebraCommonKernelAlgosAlgoIf_set_result_(self, [alternatives getWithInt:i]);
    i++;
  }
  OrgGeogebraCommonKernelAlgosAlgoIf_set_result_(self, [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(self->result_)) copyInternalWithOrgGeogebraCommonKernelConstruction:cons]);
  [self setInputOutput];
  OrgGeogebraCommonKernelAlgosAlgoIf_compute(self);
