...
- (void)setInputOutput {
  OrgGeogebraCommonKernelAlgosAlgoElement_set_input_(self, [((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk(fun_)) getGeoElementVariables]);
  OrgGeogebraCommonKernelAlgosAlgoDependentFunction_set_unconditionalInput_(self, [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([fun_ getFunctionExpression])) getUnconditionalVars]);
...
- (NSString *)toStringWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  if (sb_ == nil) OrgGeogebraCommonKernelAlgosAlgoDependentFunction_setAndConsume_sb_(self, new_JavaLangStringBuilder_init());
  ...
  [((JavaLangStringBuilder *) nil_chk(sb_)) appendWithNSString:[((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk(fun_)) toStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
...
void OrgGeogebraCommonKernelAlgosAlgoDependentFunction_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticFunction_(OrgGeogebraCommonKernelAlgosAlgoDependentFunction *self, OrgGeogebraCommonKernelConstruction *cons, OrgGeogebraCommonKernelArithmeticFunction *fun) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoDependentFunction_setAndConsume_f_(self, new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self->f_ setFunctionWithOrgGeogebraCommonKernelArithmeticFunction:fun];
  [self->f_ initFunction];
  OrgGeogebraCommonKernelAlgosAlgoDependentFunction_set_expression_(self, [((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk(fun)) getExpression]);
  ...
  if (self->expContainsFunctions_) {
    OrgGeogebraCommonKernelAlgosAlgoDependentFunction_setAndConsume_expandedFun_(self, new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticFunction_withOrgGeogebraCommonKernelKernel_(fun, self->kernel_));
  }
  [self setInputOutput];
  OrgGeogebraCommonKernelAlgosAlgoDependentFunction_compute(self);
}
