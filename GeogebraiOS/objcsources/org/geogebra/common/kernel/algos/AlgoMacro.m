...
void OrgGeogebraCommonKernelAlgosAlgoMacro_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelMacro_withOrgGeogebraCommonKernelGeosGeoElementArray_(OrgGeogebraCommonKernelAlgosAlgoMacro *self, OrgGeogebraCommonKernelConstruction *cons, IOSObjectArray *labels, OrgGeogebraCommonKernelMacro *macro, IOSObjectArray *input) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoMacro_set_macro_(self, macro);
  OrgGeogebraCommonKernelAlgosAlgoMacro_set_macroInput_(self, [((OrgGeogebraCommonKernelMacro *) nil_chk(macro)) getMacroInput]);
  OrgGeogebraCommonKernelAlgosAlgoMacro_set_macroOutput_(self, [macro getMacroOutput]);
...
void OrgGeogebraCommonKernelAlgosAlgoMacro_initMap(OrgGeogebraCommonKernelAlgosAlgoMacro *self) {
  OrgGeogebraCommonKernelAlgosAlgoMacro_setAndConsume_macroToAlgoMap_(self, new_JavaUtilHashMap_init());
  OrgGeogebraCommonKernelAlgosAlgoMacro_setAndConsume_macroOutputAndReferencedGeos_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonKernelAlgosAlgoMacro_setAndConsume_algoOutputAndReferencedGeos_(self, new_JavaUtilArrayList_init());
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(self->macroInput_))->size_; i++) {
