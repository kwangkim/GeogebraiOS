...
- (void)setInputOutput {
  ...
  efficientInput_AlgoLocusSliderND_ = [IOSObjectArray newArrayWithLength:[inSet size] type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
  it = [inSet iterator];
  jint i = 0;
  while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
    (void) IOSObjectArray_Set(efficientInput_AlgoLocusSliderND_, i, [it next]);
    i++;
  }
  standardInput_ = [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
  (void) IOSObjectArray_Set(standardInput_, 0, [((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(locusPoint_)) toGeoElement]);
  (void) IOSObjectArray_Set(standardInput_, 1, movingSlider_);
...
void OrgGeogebraCommonKernelAlgosAlgoLocusSliderND_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelGeosGeoNumeric_(OrgGeogebraCommonKernelAlgosAlgoLocusSliderND *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, id<OrgGeogebraCommonKernelKernelNDGeoPointND> Q, OrgGeogebraCommonKernelGeosGeoNumeric *P) {
  ...
  self->movingSlider_ = P;
  self->locusPoint_ = Q;
  self->sliderMover_ = new_OrgGeogebraCommonKernelSliderMover_initWithOrgGeogebraCommonKernelGeosGeoNumeric_(P);
  [self createStartPosWithOrgGeogebraCommonKernelConstruction:cons];
  self->PstartPos_ = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(cons);
...
void OrgGeogebraCommonKernelAlgosAlgoLocusSliderND_init__(OrgGeogebraCommonKernelAlgosAlgoLocusSliderND *self) {
  self->Qin_ = [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk([((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(self->locusPoint_)) toGeoElement])) getAllPredecessors];
...
void OrgGeogebraCommonKernelAlgosAlgoLocusSliderND_buildLocusMacroConstructionWithJavaUtilTreeSet_(OrgGeogebraCommonKernelAlgosAlgoLocusSliderND *self, JavaUtilTreeSet *locusConsElements) {
  ...
  @try {
    ...
    self->Pcopy_ = (OrgGeogebraCommonKernelGeosGeoNumeric *) check_class_cast([self->macroKernel_ lookupLabelWithNSString:[((OrgGeogebraCommonKernelGeosGeoNumeric *) nil_chk(self->movingSlider_)) getLabelSimple]], [OrgGeogebraCommonKernelGeosGeoNumeric class]);
