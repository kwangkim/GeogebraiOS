...
- (NSString *)description {
  ...
  while (cur != nil) {
    ...
    [sb appendWithNSString:JreStrcat("@$I$J", ((OrgGeogebraCommonKernelAlgosAlgorithmSet_Link *) nil_chk(cur))->algo_, @", constIndex: ", [((OrgGeogebraCommonKernelAlgosAlgoElement *) nil_chk(cur->algo_)) getConstructionIndex], @", ceID: ", [cur->algo_ getID])];
    cur = cur->next_;
  }
  [sb appendWithNSString:@"]"];
...
- (OrgGeogebraCommonKernelAlgosAlgorithmSet_AlgorithmSetIterator *)getIterator {
  return [new_OrgGeogebraCommonKernelAlgosAlgorithmSet_AlgorithmSetIterator_initWithOrgGeogebraCommonKernelAlgosAlgorithmSet_(self) autorelease];
}
...
- (void)setHeadWithOrgGeogebraCommonKernelAlgosAlgorithmSet_Link:(OrgGeogebraCommonKernelAlgosAlgorithmSet_Link *)head {
  OrgGeogebraCommonKernelAlgosAlgorithmSet_set_head_(self, head);
}
...
jboolean OrgGeogebraCommonKernelAlgosAlgorithmSet_addWithOrgGeogebraCommonKernelAlgosAlgoElement_(OrgGeogebraCommonKernelAlgosAlgorithmSet *self, OrgGeogebraCommonKernelAlgosAlgoElement *algo) {
  ...
  if ([self getHead] == nil) {
    if (self->hashMap_ == nil) {
      OrgGeogebraCommonKernelAlgosAlgorithmSet_setAndConsume_hashMap_(self, new_JavaUtilHashMap_init());
    }
    [((JavaUtilHashMap *) nil_chk(self->hashMap_)) putWithId:algo withId:algo];
    [self setHeadWithOrgGeogebraCommonKernelAlgosAlgorithmSet_Link:[new_OrgGeogebraCommonKernelAlgosAlgorithmSet_Link_initWithOrgGeogebraCommonKernelAlgosAlgorithmSet_withOrgGeogebraCommonKernelAlgosAlgoElement_withOrgGeogebraCommonKernelAlgosAlgorithmSet_Link_(self, algo, nil) autorelease]];
    OrgGeogebraCommonKernelAlgosAlgorithmSet_set_tail_(self, [self getHead]);
    self->size_++;
    return YES;
  }
  ...
  if (parentAlgo == nil || parentAlgo == self->tail_->algo_ || !OrgGeogebraCommonKernelAlgosAlgorithmSet_containsWithOrgGeogebraCommonKernelAlgosAlgoElement_(self, parentAlgo)) {
    OrgGeogebraCommonKernelAlgosAlgorithmSet_Link_setAndConsume_next_(self->tail_, new_OrgGeogebraCommonKernelAlgosAlgorithmSet_Link_initWithOrgGeogebraCommonKernelAlgosAlgorithmSet_withOrgGeogebraCommonKernelAlgosAlgoElement_withOrgGeogebraCommonKernelAlgosAlgorithmSet_Link_(self, algo, nil));
    OrgGeogebraCommonKernelAlgosAlgorithmSet_set_tail_(self, self->tail_->next_);
  }
  else {
    OrgGeogebraCommonKernelAlgosAlgorithmSet_Link *cur = [self getHead];
    ...
    OrgGeogebraCommonKernelAlgosAlgorithmSet_Link_setAndConsume_next_(nil_chk(cur), new_OrgGeogebraCommonKernelAlgosAlgorithmSet_Link_initWithOrgGeogebraCommonKernelAlgosAlgorithmSet_withOrgGeogebraCommonKernelAlgosAlgoElement_withOrgGeogebraCommonKernelAlgosAlgorithmSet_Link_(self, algo, cur->next_));
  }
  [((JavaUtilHashMap *) nil_chk(self->hashMap_)) putWithId:algo withId:algo];
  self->size_++;
  return YES;
  ...
  while (cur != nil) {
    if (((OrgGeogebraCommonKernelAlgosAlgorithmSet_Link *) nil_chk(cur))->algo_ == algo) {
      if (prev == nil) {
        ...
        if ([self getHead] == nil) OrgGeogebraCommonKernelAlgosAlgorithmSet_set_tail_(self, nil);
      }
      else {
        OrgGeogebraCommonKernelAlgosAlgorithmSet_Link_set_next_(prev, cur->next_);
        if (prev->next_ == nil) OrgGeogebraCommonKernelAlgosAlgorithmSet_set_tail_(self, prev);
      }
      self->size_--;
      return YES;
    }
...
void OrgGeogebraCommonKernelAlgosAlgorithmSet_Link_initWithOrgGeogebraCommonKernelAlgosAlgorithmSet_withOrgGeogebraCommonKernelAlgosAlgoElement_withOrgGeogebraCommonKernelAlgosAlgorithmSet_Link_(OrgGeogebraCommonKernelAlgosAlgorithmSet_Link *self, OrgGeogebraCommonKernelAlgosAlgorithmSet *outer$, OrgGeogebraCommonKernelAlgosAlgoElement *a, OrgGeogebraCommonKernelAlgosAlgorithmSet_Link *n) {
  NSObject_init(self);
  OrgGeogebraCommonKernelAlgosAlgorithmSet_Link_set_algo_(self, a);
  OrgGeogebraCommonKernelAlgosAlgorithmSet_Link_set_next_(self, n);
}
...
- (void)remove {
  ...
  OrgGeogebraCommonKernelAlgosAlgorithmSet_AlgorithmSetIterator_set_cur_(self, cur_->next_);
}
...
void OrgGeogebraCommonKernelAlgosAlgorithmSet_AlgorithmSetIterator_initWithOrgGeogebraCommonKernelAlgosAlgorithmSet_(OrgGeogebraCommonKernelAlgosAlgorithmSet_AlgorithmSetIterator *self, OrgGeogebraCommonKernelAlgosAlgorithmSet *outer$) {
  OrgGeogebraCommonKernelAlgosAlgorithmSet_AlgorithmSetIterator_set_this$0_(self, outer$);
  NSObject_init(self);
  OrgGeogebraCommonKernelAlgosAlgorithmSet_AlgorithmSetIterator_set_cur_(self, [outer$ getHead]);
}
