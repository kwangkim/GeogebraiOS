...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/algos/AlgoLineBisectorSegment.java
//
...
- (IOSObjectArray *)getPolynomials {
  ...
  if (A != nil && B != nil) {
    ...
    OrgGeogebraCommonKernelAlgosAlgoLineBisectorSegment_setAndConsume_polynomials_(self, [IOSObjectArray newArrayWithLength:3 type:OrgGeogebraCommonKernelProverPolynomialPolynomial_class_()]);
...
- (IOSObjectArray *)getBotanaPolynomialsWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  ...
  if (s_ != nil) {
    ...
    if (botanaVars_ == nil) {
      OrgGeogebraCommonKernelAlgosAlgoLineBisectorSegment_setAndConsume_botanaVars_(self, [IOSObjectArray newArrayWithLength:4 type:OrgGeogebraCommonKernelProverPolynomialVariable_class_()]);
...
void OrgGeogebraCommonKernelAlgosAlgoLineBisectorSegment_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoSegment_(OrgGeogebraCommonKernelAlgosAlgoLineBisectorSegment *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelGeosGeoSegment *s) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoLineBisectorSegment_set_s_(self, s);
  OrgGeogebraCommonKernelAlgosAlgoLineBisectorSegment_setAndConsume_g_(self, new_OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelConstruction_(cons));
  OrgGeogebraCommonKernelAlgosAlgoLineBisectorSegment_setAndConsume_midPoint_(self, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons));
