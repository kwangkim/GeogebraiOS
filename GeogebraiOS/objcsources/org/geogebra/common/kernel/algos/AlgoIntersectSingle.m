...
- (void)setInputOutput {
  if (refPoint_ == nil) {
    ...
    (void) IOSObjectArray_Set(input_, 0, IOSObjectArray_Get(((OrgGeogebraCommonKernelAlgosAlgoIntersect *) nil_chk(algo_))->input_, 0));
    (void) IOSObjectArray_Set(input_, 1, IOSObjectArray_Get(algo_->input_, 1));
    (void) IOSObjectArray_Set(input_, 2, [((id<OrgGeogebraCommonKernelGeosGeoNumberValue>) nil_chk(index_)) toGeoElement]);
  }
  else {
    input_ = [IOSObjectArray newArrayWithLength:3 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    (void) IOSObjectArray_Set(input_, 0, IOSObjectArray_Get(((OrgGeogebraCommonKernelAlgosAlgoIntersect *) nil_chk(algo_))->input_, 0));
    (void) IOSObjectArray_Set(input_, 1, IOSObjectArray_Get(algo_->input_, 1));
    (void) IOSObjectArray_Set(input_, 2, refPoint_);
  }
...
- (void)compute {
  ...
  parentOutput_ = [((OrgGeogebraCommonKernelAlgosAlgoIntersect *) nil_chk(algo_)) getIntersectionPoints];
  if (point_ != nil) {
...
void OrgGeogebraCommonKernelAlgosAlgoIntersectSingle_initWithNSString_withOrgGeogebraCommonKernelAlgosAlgoIntersect_withOrgGeogebraCommonKernelGeosGeoPoint_(OrgGeogebraCommonKernelAlgosAlgoIntersectSingle *self, NSString *label, OrgGeogebraCommonKernelAlgosAlgoIntersect *algo, OrgGeogebraCommonKernelGeosGeoPoint *refPoint) {
  (void) OrgGeogebraCommonKernelAlgosAlgoIntersect_initWithOrgGeogebraCommonKernelConstruction_(self, ((OrgGeogebraCommonKernelAlgosAlgoIntersect *) nil_chk(algo))->cons_);
  self->algo_ = algo;
  [algo addUser];
  self->refPoint_ = refPoint;
  self->point_ = new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(algo->cons_);
  [self setInputOutput];
  OrgGeogebraCommonKernelAlgosAlgoIntersectSingle_initForNearToRelationship(self);
  [self compute];
...
void OrgGeogebraCommonKernelAlgosAlgoIntersectSingle_initWithNSString_withOrgGeogebraCommonKernelAlgosAlgoIntersect_withInt_(OrgGeogebraCommonKernelAlgosAlgoIntersectSingle *self, NSString *label, OrgGeogebraCommonKernelAlgosAlgoIntersect *algo, jint index) {
  (void) OrgGeogebraCommonKernelAlgosAlgoIntersectSingle_initWithNSString_withOrgGeogebraCommonKernelAlgosAlgoIntersect_withOrgGeogebraCommonKernelGeosGeoNumberValue_(self, label, algo, new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_([((OrgGeogebraCommonKernelAlgosAlgoIntersect *) nil_chk(algo)) getConstruction], index + 1));
}
...
void OrgGeogebraCommonKernelAlgosAlgoIntersectSingle_initForNearToRelationship(OrgGeogebraCommonKernelAlgosAlgoIntersectSingle *self) {
  self->parentOutput_ = [((OrgGeogebraCommonKernelAlgosAlgoIntersect *) nil_chk(self->algo_)) getIntersectionPoints];
