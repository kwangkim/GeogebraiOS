...
- (void)setPointsWithOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)A
                 withOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)B
                 withOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)C {
  OrgGeogebraCommonKernelAlgosAlgoCircleThreePoints_set_A_(self, A);
  OrgGeogebraCommonKernelAlgosAlgoCircleThreePoints_set_B_(self, B);
  OrgGeogebraCommonKernelAlgosAlgoCircleThreePoints_set_C_(self, C);
}

- (void)createCircle {
  OrgGeogebraCommonKernelAlgosAlgoCircleThreePoints_setAndConsume_circle_(self, new_OrgGeogebraCommonKernelGeosGeoConic_initWithOrgGeogebraCommonKernelConstruction_(cons_));
}
...
- (void)setInput {
  ...
  IOSObjectArray_Set(input_, 1, [((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(B_)) toGeoElement]);
  IOSObjectArray_Set(input_, 2, [((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(C_)) toGeoElement]);
}
...
- (IOSObjectArray *)getBotanaPolynomialsWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  ...
  IOSObjectArray *circle2vars = [IOSObjectArray arrayWithLength:2 type:OrgGeogebraCommonKernelProverPolynomialVariable_class_()];
  IOSObjectArray *circle3vars = [IOSObjectArray arrayWithLength:2 type:OrgGeogebraCommonKernelProverPolynomialVariable_class_()];
  ...
  if (botanaVars_ == nil) {
    OrgGeogebraCommonKernelAlgosAlgoCircleThreePoints_setAndConsume_botanaVars_(self, [IOSObjectArray newArrayWithLength:4 type:OrgGeogebraCommonKernelProverPolynomialVariable_class_()]);
  ...
  IOSObjectArray *centerVars = [IOSObjectArray arrayWithObjects:(id[]){ IOSObjectArray_Get(nil_chk(botanaVars_), 0), IOSObjectArray_Get(botanaVars_, 1) } count:2 type:OrgGeogebraCommonKernelProverPolynomialVariable_class_()];
  ...
  OrgGeogebraCommonKernelAlgosAlgoCircleThreePoints_setAndConsume_botanaPolynomials_(self, [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonKernelProverPolynomialPolynomial_class_()]);
  ...
  IOSObjectArray_Set(botanaPolynomials_, 1, OrgGeogebraCommonKernelProverPolynomialPolynomial_equidistantWithOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_withOrgGeogebraCommonKernelProverPolynomialVariable_(IOSObjectArray_Get(circle1vars, 0), IOSObjectArray_Get(circle1vars, 1), IOSObjectArray_Get(centerVars, 0), IOSObjectArray_Get(centerVars, 1), IOSObjectArray_Get(nil_chk(circle3vars), 0), IOSObjectArray_Get(circle3vars, 1)));
  return botanaPolynomials_;
}
...
void OrgGeogebraCommonKernelAlgosAlgoCircleThreePoints_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_(OrgGeogebraCommonKernelAlgosAlgoCircleThreePoints *self, OrgGeogebraCommonKernelConstruction *cons, id<OrgGeogebraCommonKernelKernelNDGeoPointND> A, id<OrgGeogebraCommonKernelKernelNDGeoPointND> B, id<OrgGeogebraCommonKernelKernelNDGeoPointND> C) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoCircleThreePoints_setAndConsume_det_(self, [IOSDoubleArray newArrayWithLength:3]);
  ...
  OrgGeogebraCommonKernelAlgosAlgoCircleThreePoints_setAndConsume_s0_(self, new_OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelConstruction_(cons));
  OrgGeogebraCommonKernelAlgosAlgoCircleThreePoints_setAndConsume_s1_(self, new_OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelConstruction_(cons));
  OrgGeogebraCommonKernelAlgosAlgoCircleThreePoints_setAndConsume_center_(self, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  [self compute];
  OrgGeogebraCommonKernelAlgosAlgoCircleThreePoints_setIncidence(self);
}
