...
- (OrgGeogebraCommonKernelGeosGeoPoint *)PointWithNSString:(NSString *)label
  ...
  OrgGeogebraCommonKernelGeosGeoPoint *p = new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withInt_(cons_, mode);
...
- (OrgGeogebraCommonKernelGeosGeoPoint *)PointWithNSString:(NSString *)label
  ...
  if (param == nil) {
    algo = new_OrgGeogebraCommonKernelAlgosAlgoPointOnPath_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelPath_withDouble_withDouble_(cons_, label, path, 0, 0);
  }
  else {
    algo = new_OrgGeogebraCommonKernelAlgosAlgoPointOnPath_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelPath_withDouble_withDouble_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons_, label, path, 0, 0, param);
  }
...
- (OrgGeogebraCommonKernelGeosGeoLine *)LineWithNSString:(NSString *)label
  ...
  OrgGeogebraCommonKernelAlgosAlgoJoinPoints *algo = new_OrgGeogebraCommonKernelAlgosAlgoJoinPoints_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_(cons_, label, P, Q);
...
- (OrgGeogebraCommonKernelGeosGeoRay *)RayWithNSString:(NSString *)label
               withOrgGeogebraCommonKernelGeosGeoPoint:(OrgGeogebraCommonKernelGeosGeoPoint *)P
               withOrgGeogebraCommonKernelGeosGeoPoint:(OrgGeogebraCommonKernelGeosGeoPoint *)Q {
  OrgGeogebraCommonKernelAlgosAlgoJoinPointsRay *algo = new_OrgGeogebraCommonKernelAlgosAlgoJoinPointsRay_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_(cons_, label, P, Q);
  return [algo getRay];
}
...
- (OrgGeogebraCommonKernelGeosGeoRay *)RayWithNSString:(NSString *)label
  ...
  OrgGeogebraCommonKernelAlgosAlgoRayPointVector *algo = new_OrgGeogebraCommonKernelAlgosAlgoRayPointVector_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoVector_(cons_, label, P, v);
  return [algo getRay];
}
...
- (OrgGeogebraCommonKernelGeosGeoLine *)LineWithNSString:(NSString *)label
  ...
  OrgGeogebraCommonKernelAlgosAlgoLinePointLine *algo = new_OrgGeogebraCommonKernelAlgosAlgoLinePointLine_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoLine_(cons_, label, P, l);
  OrgGeogebraCommonKernelGeosGeoLine *g = [algo getLine];
  return g;
}
...
- (OrgGeogebraCommonKernelGeosGeoLine *)OrthogonalLineWithNSString:(NSString *)label
                           withOrgGeogebraCommonKernelGeosGeoPoint:(OrgGeogebraCommonKernelGeosGeoPoint *)P
                          withOrgGeogebraCommonKernelGeosGeoVector:(OrgGeogebraCommonKernelGeosGeoVector *)v {
  OrgGeogebraCommonKernelAlgosAlgoOrthoLinePointVector *algo = new_OrgGeogebraCommonKernelAlgosAlgoOrthoLinePointVector_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoVector_(cons_, label, P, v);
  OrgGeogebraCommonKernelGeosGeoLine *g = [algo getLine];
  return g;
}
...
- (OrgGeogebraCommonKernelGeosGeoLine *)OrthogonalLineWithNSString:(NSString *)label
                           withOrgGeogebraCommonKernelGeosGeoPoint:(OrgGeogebraCommonKernelGeosGeoPoint *)P
                            withOrgGeogebraCommonKernelGeosGeoLine:(OrgGeogebraCommonKernelGeosGeoLine *)l {
  OrgGeogebraCommonKernelAlgosAlgoOrthoLinePointLine *algo = new_OrgGeogebraCommonKernelAlgosAlgoOrthoLinePointLine_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoLine_(cons_, label, P, l);
  OrgGeogebraCommonKernelGeosGeoLine *g = [algo getLine];
  return g;
}
...
- (OrgGeogebraCommonKernelGeosGeoLine *)LineBisectorWithNSString:(NSString *)label
  ...
  OrgGeogebraCommonKernelAlgosAlgoLineBisector *algo = new_OrgGeogebraCommonKernelAlgosAlgoLineBisector_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_(cons_, label, A, B);
  OrgGeogebraCommonKernelGeosGeoLine *g = [algo getLine];
  return g;
}
...
- (OrgGeogebraCommonKernelGeosGeoLine *)LineBisectorWithNSString:(NSString *)label
  ...
  OrgGeogebraCommonKernelAlgosAlgoLineBisectorSegment *algo = new_OrgGeogebraCommonKernelAlgosAlgoLineBisectorSegment_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoSegment_(cons_, label, s);
  OrgGeogebraCommonKernelGeosGeoLine *g = [algo getLine];
  return g;
}
...
- (IOSObjectArray *)AngularBisectorWithNSStringArray:(IOSObjectArray *)labels
  ...
  OrgGeogebraCommonKernelAlgosAlgoAngularBisectorLines *algo = new_OrgGeogebraCommonKernelAlgosAlgoAngularBisectorLines_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelGeosGeoLine_withOrgGeogebraCommonKernelGeosGeoLine_(cons_, labels, g, h);
...
- (OrgGeogebraCommonKernelGeosGeoVector *)VectorWithNSString:(NSString *)label
                     withOrgGeogebraCommonKernelGeosGeoPoint:(OrgGeogebraCommonKernelGeosGeoPoint *)P
                     withOrgGeogebraCommonKernelGeosGeoPoint:(OrgGeogebraCommonKernelGeosGeoPoint *)Q {
  OrgGeogebraCommonKernelAlgosAlgoVector *algo = new_OrgGeogebraCommonKernelAlgosAlgoVector_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_(cons_, label, P, Q);
...
- (id<OrgGeogebraCommonKernelKernelNDGeoVectorND>)createVectorWithNSString:(NSString *)label
                             withOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)P {
  OrgGeogebraCommonKernelAlgosAlgoVectorPoint *algo = new_OrgGeogebraCommonKernelAlgosAlgoVectorPoint_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelKernelNDGeoPointND_(cons_, label, P);
  return [algo getVector];
}

- (OrgGeogebraCommonKernelGeosGeoNumeric *)SlopeWithNSString:(NSString *)label
                      withOrgGeogebraCommonKernelGeosGeoLine:(OrgGeogebraCommonKernelGeosGeoLine *)g {
  OrgGeogebraCommonKernelAlgosAlgoSlope *algo = new_OrgGeogebraCommonKernelAlgosAlgoSlope_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoLine_(cons_, label, g);
...
- (OrgGeogebraCommonKernelGeosGeoList *)ListWithNSString:(NSString *)label
  ...
  OrgGeogebraCommonKernelAlgosAlgoDependentList *algoList = new_OrgGeogebraCommonKernelAlgosAlgoDependentList_initWithOrgGeogebraCommonKernelConstruction_withNSString_withJavaUtilArrayList_(cons_, label, geoElementList);
...
- (OrgGeogebraCommonKernelGeosGeoTextField *)textfieldWithNSString:(NSString *)label
  ...
  OrgGeogebraCommonKernelAlgosAlgoTextfield *at = new_OrgGeogebraCommonKernelAlgosAlgoTextfield_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoElement_(cons_, label, geoElement);
  return [at getResult];
}
...
- (OrgGeogebraCommonKernelGeosGeoLine *)LineWithNSString:(NSString *)label
                 withOrgGeogebraCommonKernelGeosGeoPoint:(OrgGeogebraCommonKernelGeosGeoPoint *)P
                withOrgGeogebraCommonKernelGeosGeoVector:(OrgGeogebraCommonKernelGeosGeoVector *)v {
  OrgGeogebraCommonKernelAlgosAlgoLinePointVector *algo = new_OrgGeogebraCommonKernelAlgosAlgoLinePointVector_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoVector_(cons_, label, P, v);
  OrgGeogebraCommonKernelGeosGeoLine *g = [algo getLine];
  return g;
}
...
withOrgGeogebraCommonKernelArithmeticNumberValue:(id<OrgGeogebraCommonKernelArithmeticNumberValue>)n {
  ...
  OrgGeogebraCommonKernelAlgosAlgoCirclePointRadius *algoCircle = new_OrgGeogebraCommonKernelAlgosAlgoCirclePointRadius_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons_, A, n);
...
withOrgGeogebraCommonKernelGeosGeoNumberValue:(id<OrgGeogebraCommonKernelGeosGeoNumberValue>)alpha
  ...
  IOSObjectArray *ret = [IOSObjectArray newArrayWithObjects:(id[]){ angle, C } count:2 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
  return ret;
}
...
withOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)Q {
  OrgGeogebraCommonKernelTransform *t = new_OrgGeogebraCommonKernelTransformRotate_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoNumberValue_withOrgGeogebraCommonKernelKernelNDGeoPointND_(cons_, phi, Q);
...
- (OrgGeogebraCommonKernelGeosGeoAngle *)AngleWithNSString:(NSString *)label
  ...
  OrgGeogebraCommonKernelAlgosAlgoAngleVectors *algo = new_OrgGeogebraCommonKernelAlgosAlgoAngleVectors_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelKernelNDGeoVectorND_withOrgGeogebraCommonKernelKernelNDGeoVectorND_(cons_, label, v, w);
...
- (IOSObjectArray *)AnglesWithNSStringArray:(IOSObjectArray *)labels
  ...
  OrgGeogebraCommonKernelAlgosAlgoAnglePolygon *algo = new_OrgGeogebraCommonKernelAlgosAlgoAnglePolygon_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelGeosGeoPolygon_(cons_, labels, poly);
...
- (OrgGeogebraCommonKernelGeosGeoConic *)CircleWithNSString:(NSString *)label
  ...
  OrgGeogebraCommonKernelAlgosAlgoCirclePointRadius *algo = new_OrgGeogebraCommonKernelAlgosAlgoCirclePointRadius_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoSegment_withBoolean_(cons_, label, A, segment, YES);
  OrgGeogebraCommonKernelGeosGeoConic *circle = [algo getCircle];
  [((OrgGeogebraCommonKernelGeosGeoConic *) nil_chk(circle)) setToSpecific];
  [circle update];
  return circle;
...
- (OrgGeogebraCommonKernelGeosGeoConic *)CircleWithNSString:(NSString *)label
                    ...
                    withOrgGeogebraCommonKernelGeosGeoPoint:(OrgGeogebraCommonKernelGeosGeoPoint *)P {
  OrgGeogebraCommonKernelAlgosAlgoCircleTwoPoints *algo = new_OrgGeogebraCommonKernelAlgosAlgoCircleTwoPoints_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_(cons_, label, M, P);
  OrgGeogebraCommonKernelGeosGeoConic *circle = [algo getCircle];
  [((OrgGeogebraCommonKernelGeosGeoConic *) nil_chk(circle)) setToSpecific];
  [circle update];
  return circle;
...
- (OrgGeogebraCommonKernelGeosGeoConicPart *)SemicircleWithNSString:(NSString *)label
                            withOrgGeogebraCommonKernelGeosGeoPoint:(OrgGeogebraCommonKernelGeosGeoPoint *)M
                            withOrgGeogebraCommonKernelGeosGeoPoint:(OrgGeogebraCommonKernelGeosGeoPoint *)P {
  OrgGeogebraCommonKernelAlgosAlgoSemicircle *algo = new_OrgGeogebraCommonKernelAlgosAlgoSemicircle_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_(cons_, label, M, P);
...
- (OrgGeogebraCommonKernelKernelNDGeoConicND *)ParabolaWithNSString:(NSString *)label
  ...
  OrgGeogebraCommonKernelAlgosAlgoParabolaPointLine *algo = new_OrgGeogebraCommonKernelAlgosAlgoParabolaPointLine_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoLineND_(cons_, label, F, l);
...
- (OrgGeogebraCommonKernelKernelNDGeoConicND *)ConicWithNSString:(NSString *)label
  ...
  OrgGeogebraCommonKernelAlgosAlgoConicFivePoints *algo = new_OrgGeogebraCommonKernelAlgosAlgoConicFivePoints_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_(cons_, label, points);
...
- (OrgGeogebraCommonKernelGeosGeoElement *)DiameterLineWithNSString:(NSString *)label
                      ...
                      withOrgGeogebraCommonKernelKernelNDGeoConicND:(OrgGeogebraCommonKernelKernelNDGeoConicND *)c {
  OrgGeogebraCommonKernelAlgosAlgoDiameterLine *algo = new_OrgGeogebraCommonKernelAlgosAlgoDiameterLine_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelKernelNDGeoConicND_withOrgGeogebraCommonKernelKernelNDGeoLineND_(cons_, label, c, g);
...
- (OrgGeogebraCommonKernelGeosGeoElement *)DiameterLineWithNSString:(NSString *)label
                     withOrgGeogebraCommonKernelKernelNDGeoVectorND:(id<OrgGeogebraCommonKernelKernelNDGeoVectorND>)v
                      withOrgGeogebraCommonKernelKernelNDGeoConicND:(OrgGeogebraCommonKernelKernelNDGeoConicND *)c {
  OrgGeogebraCommonKernelAlgosAlgoDiameterVector *algo = new_OrgGeogebraCommonKernelAlgosAlgoDiameterVector_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelKernelNDGeoConicND_withOrgGeogebraCommonKernelKernelNDGeoVectorND_(cons_, label, c, v);
  return (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast([algo getDiameter], [OrgGeogebraCommonKernelGeosGeoElement class]);
}
...
- (OrgGeogebraCommonKernelGeosGeoNumeric *)AreaWithNSString:(NSString *)label
              withOrgGeogebraCommonKernelKernelNDGeoConicND:(OrgGeogebraCommonKernelKernelNDGeoConicND *)c {
  OrgGeogebraCommonKernelAlgosAlgoAreaConic *algo = new_OrgGeogebraCommonKernelAlgosAlgoAreaConic_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelKernelNDGeoConicND_(cons_, label, c);
...
- (OrgGeogebraCommonKernelGeosGeoNumeric *)PerimeterWithNSString:(NSString *)label
  ...
  OrgGeogebraCommonKernelAlgosAlgoPerimeterPoly *algo = new_OrgGeogebraCommonKernelAlgosAlgoPerimeterPoly_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoPolygon_(cons_, label, polygon);
...
- (OrgGeogebraCommonKernelGeosGeoNumeric *)CircumferenceWithNSString:(NSString *)label
  ...
  OrgGeogebraCommonKernelAlgosAlgoCircumferenceConic *algo = new_OrgGeogebraCommonKernelAlgosAlgoCircumferenceConic_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelKernelNDGeoConicND_(cons_, label, conic);
  return [algo getCircumference];
}
...
withOrgGeogebraCommonKernelGeosGeoPoint:(OrgGeogebraCommonKernelGeosGeoPoint *)S {
  OrgGeogebraCommonKernelTransform *t = new_OrgGeogebraCommonKernelTransformDilate_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelKernelNDGeoPointND_(cons_, r, S);
...
- (OrgGeogebraCommonKernelGeosGeoNumeric *)DistanceWithNSString:(NSString *)label
                  withOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)P
                  withOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)Q {
  OrgGeogebraCommonKernelAlgosAlgoDistancePoints *algo = new_OrgGeogebraCommonKernelAlgosAlgoDistancePoints_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_(cons_, label, P, Q);
...
- (OrgGeogebraCommonKernelGeosGeoNumeric *)DistanceWithNSString:(NSString *)label
  ...
  OrgGeogebraCommonKernelAlgosAlgoDistancePointObject *algo = new_OrgGeogebraCommonKernelAlgosAlgoDistancePointObject_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelGeosGeoElement_(cons_, label, P, g);
  OrgGeogebraCommonKernelGeosGeoNumeric *num = [algo getDistance];
  return num;
}
...
- (OrgGeogebraCommonKernelImplicitGeoImplicitPoly *)ImplicitPolyWithNSString:(NSString *)label
  ...
  OrgGeogebraCommonKernelImplicitAlgoImplicitPolyFunction *algo = new_OrgGeogebraCommonKernelImplicitAlgoImplicitPolyFunction_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoFunctionNVar_(cons_, label, func);
...
- (OrgGeogebraCommonKernelGeosGeoPoint *)MidpointWithNSString:(NSString *)label
                      withOrgGeogebraCommonKernelGeosGeoPoint:(OrgGeogebraCommonKernelGeosGeoPoint *)P
                      withOrgGeogebraCommonKernelGeosGeoPoint:(OrgGeogebraCommonKernelGeosGeoPoint *)Q {
  OrgGeogebraCommonKernelAlgosAlgoMidpoint *algo = new_OrgGeogebraCommonKernelAlgosAlgoMidpoint_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_(cons_, label, P, Q);
...
- (OrgGeogebraCommonKernelGeosGeoPoint *)MidpointWithNSString:(NSString *)label
                    withOrgGeogebraCommonKernelGeosGeoSegment:(OrgGeogebraCommonKernelGeosGeoSegment *)s {
  OrgGeogebraCommonKernelAlgosAlgoMidpointSegment *algo = new_OrgGeogebraCommonKernelAlgosAlgoMidpointSegment_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoSegment_(cons_, label, s);
  OrgGeogebraCommonKernelGeosGeoPoint *M = [algo getPoint];
  return M;
}
...
- (OrgGeogebraCommonKernelGeosGeoNumeric *)LengthWithNSString:(NSString *)label
  ...
  OrgGeogebraCommonKernelAlgosAlgoListLength *algo = new_OrgGeogebraCommonKernelAlgosAlgoListLength_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoList_(cons_, label, list);
  return [algo getLength];
}

- (OrgGeogebraCommonKernelGeosGeoNumeric *)LengthWithNSString:(NSString *)label
                      withOrgGeogebraCommonKernelGeosGeoLocus:(OrgGeogebraCommonKernelGeosGeoLocus *)locus {
  OrgGeogebraCommonKernelAlgosAlgoLengthLocus *algo = new_OrgGeogebraCommonKernelAlgosAlgoLengthLocus_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoLocus_(cons_, label, locus);
  return [algo getLength];
}
...
withOrgGeogebraCommonKernelKernelNDGeoPointNDArray:(IOSObjectArray *)P {
  OrgGeogebraCommonKernelAlgosAlgoPolygon *algo = new_OrgGeogebraCommonKernelAlgosAlgoPolygon_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_(cons_, labels, P);
  return [algo getOutput];
}

- (IOSObjectArray *)PolygonWithNSStringArray:(IOSObjectArray *)labels
      withOrgGeogebraCommonKernelGeosGeoList:(OrgGeogebraCommonKernelGeosGeoList *)pointList {
  OrgGeogebraCommonKernelAlgosAlgoPolygon *algo = new_OrgGeogebraCommonKernelAlgosAlgoPolygon_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelGeosGeoList_(cons_, labels, pointList);
  return [algo getOutput];
}
...
withOrgGeogebraCommonKernelKernelNDGeoPointNDArray:(IOSObjectArray *)P
  ...
  OrgGeogebraCommonKernelAlgosAlgoPolyLine *algo = new_OrgGeogebraCommonKernelAlgosAlgoPolyLine_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_withBoolean_(cons_, labels, P, penStroke);
  return [algo getOutput];
}
...
- (IOSObjectArray *)IntersectPolygonsWithNSStringArray:(IOSObjectArray *)labels
  ...
  OrgGeogebraCommonKernelAlgosAlgoPolygonIntersection *algo = new_OrgGeogebraCommonKernelAlgosAlgoPolygonIntersection_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelGeosGeoPolygon_withOrgGeogebraCommonKernelGeosGeoPolygon_(cons_, labels, poly0, poly1);
...
- (IOSObjectArray *)UnionWithNSStringArray:(IOSObjectArray *)labels
 withOrgGeogebraCommonKernelGeosGeoPolygon:(OrgGeogebraCommonKernelGeosGeoPolygon *)poly0
 withOrgGeogebraCommonKernelGeosGeoPolygon:(OrgGeogebraCommonKernelGeosGeoPolygon *)poly1 {
  OrgGeogebraCommonKernelAlgosAlgoPolygonUnion *algo = new_OrgGeogebraCommonKernelAlgosAlgoPolygonUnion_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelGeosGeoPolygon_withOrgGeogebraCommonKernelGeosGeoPolygon_(cons_, labels, poly0, poly1);
  IOSObjectArray *polygon = [algo getOutput];
  return polygon;
}
...
- (IOSObjectArray *)IntersectLinePolyLineWithNSStringArray:(IOSObjectArray *)labels
  ...
  OrgGeogebraCommonKernelAlgosAlgoIntersectLinePolyLine *algo = new_OrgGeogebraCommonKernelAlgosAlgoIntersectLinePolyLine_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelKernelNDGeoLineND_withOrgGeogebraCommonKernelGeosGeoPoly_(cons_, labels, g, p);
  return [algo getOutput];
}
...
- (IOSObjectArray *)IntersectLineCurveWithNSStringArray:(IOSObjectArray *)labels
  ...
  OrgGeogebraCommonKernelAlgosAlgoIntersectLineCurve *algo = new_OrgGeogebraCommonKernelAlgosAlgoIntersectLineCurve_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelGeosGeoLine_withOrgGeogebraCommonKernelGeosGeoCurveCartesian_(cons_, labels, g, p);
  return [algo getOutput];
}
...
- (IOSObjectArray *)IntersectCurveCurveWithNSStringArray:(IOSObjectArray *)labels
        ...
        withOrgGeogebraCommonKernelGeosGeoCurveCartesian:(OrgGeogebraCommonKernelGeosGeoCurveCartesian *)p {
  OrgGeogebraCommonKernelAlgosAlgoIntersectCurveCurve *algo = new_OrgGeogebraCommonKernelAlgosAlgoIntersectCurveCurve_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelGeosGeoCurveCartesian_withOrgGeogebraCommonKernelGeosGeoCurveCartesian_(cons_, labels, g, p);
  return [algo getOutput];
}
...
- (IOSObjectArray *)IntersectCurveCurveSingleWithNSStringArray:(IOSObjectArray *)labels
              ...
              withOrgGeogebraCommonKernelGeosGeoCurveCartesian:(OrgGeogebraCommonKernelGeosGeoCurveCartesian *)c2
                                                    withDouble:(jdouble)x
                                                    withDouble:(jdouble)y {
  OrgGeogebraCommonKernelGeosGeoPoint *p = new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withDouble_withDouble_withDouble_(cons_, x, y, 1.0);
...
- (IOSObjectArray *)IntersectPolynomialsWithNSStringArray:(IOSObjectArray *)labels
  ...
  if (![((OrgGeogebraCommonKernelGeosGeoFunction *) nil_chk(a)) isPolynomialFunctionWithBoolean:NO] || ![((OrgGeogebraCommonKernelGeosGeoFunction *) nil_chk(b)) isPolynomialFunctionWithBoolean:NO]) {
    OrgGeogebraCommonKernelGeosGeoPoint *A = new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons_);
    [A setZero];
    NSString *label = labels == nil ? nil : IOSObjectArray_Get(labels, 0);
    OrgGeogebraCommonKernelAlgosAlgoIntersectFunctionsNewton *algo = new_OrgGeogebraCommonKernelAlgosAlgoIntersectFunctionsNewton_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoFunction_withOrgGeogebraCommonKernelGeosGeoFunction_withOrgGeogebraCommonKernelGeosGeoPoint_(cons_, label, a, b, A);
    IOSObjectArray *ret = [IOSObjectArray newArrayWithObjects:(id[]){ [algo getIntersectionPoint] } count:1 type:OrgGeogebraCommonKernelGeosGeoPoint_class_()];
    return ret;
  }
...
- (OrgGeogebraCommonKernelGeosGeoPoint *)IntersectPolynomialsSingleWithNSString:(NSString *)label
  ...
  OrgGeogebraCommonKernelAlgosAlgoIntersectSingle *salgo = new_OrgGeogebraCommonKernelAlgosAlgoIntersectSingle_initWithNSString_withOrgGeogebraCommonKernelAlgosAlgoIntersect_withInt_(label, algo, index);
...
- (OrgGeogebraCommonKernelAlgosAlgoIntersectPolynomialConic *)getIntersectionAlgorithmWithOrgGeogebraCommonKernelGeosGeoFunction:(OrgGeogebraCommonKernelGeosGeoFunction *)f
  ...
  OrgGeogebraCommonKernelAlgosAlgoIntersectPolynomialConic *algo = new_OrgGeogebraCommonKernelAlgosAlgoIntersectPolynomialConic_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoFunction_withOrgGeogebraCommonKernelGeosGeoConic_(cons_, f, c);
...
- (OrgGeogebraCommonKernelAlgosAlgoIntersectLineConic *)getIntersectionAlgorithmWithOrgGeogebraCommonKernelGeosGeoLine:(OrgGeogebraCommonKernelGeosGeoLine *)g
  ...
  OrgGeogebraCommonKernelAlgosAlgoIntersectLineConic *algo = new_OrgGeogebraCommonKernelAlgosAlgoIntersectLineConic_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoLine_withOrgGeogebraCommonKernelGeosGeoConic_(cons_, g, c);
  [algo setPrintedInXMLWithBoolean:NO];
  [((JavaUtilArrayList *) nil_chk(intersectionAlgos_)) addWithId:algo];
  return algo;
}
...
- (OrgGeogebraCommonKernelAlgosAlgoIntersectConics *)getIntersectionAlgorithmWithOrgGeogebraCommonKernelGeosGeoConic:(OrgGeogebraCommonKernelGeosGeoConic *)a
  ...
  OrgGeogebraCommonKernelAlgosAlgoIntersectConics *algo = new_OrgGeogebraCommonKernelAlgosAlgoIntersectConics_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoConic_withOrgGeogebraCommonKernelGeosGeoConic_(cons_, a, b);
  [algo setPrintedInXMLWithBoolean:NO];
  [((JavaUtilArrayList *) nil_chk(intersectionAlgos_)) addWithId:algo];
  return algo;
}
...
- (OrgGeogebraCommonKernelAlgosAlgoIntersectPolynomials *)getIntersectionAlgorithmWithOrgGeogebraCommonKernelGeosGeoFunction:(OrgGeogebraCommonKernelGeosGeoFunction *)a
  ...
  OrgGeogebraCommonKernelAlgosAlgoIntersectPolynomials *algo = new_OrgGeogebraCommonKernelAlgosAlgoIntersectPolynomials_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoFunction_withOrgGeogebraCommonKernelGeosGeoFunction_(cons_, a, b);
  [algo setPrintedInXMLWithBoolean:NO];
  [((JavaUtilArrayList *) nil_chk(intersectionAlgos_)) addWithId:algo];
  return algo;
}
...
- (OrgGeogebraCommonKernelAlgosAlgoIntersectPolynomialLine *)getIntersectionAlgorithmWithOrgGeogebraCommonKernelGeosGeoFunction:(OrgGeogebraCommonKernelGeosGeoFunction *)a
  ...
  OrgGeogebraCommonKernelAlgosAlgoIntersectPolynomialLine *algo = new_OrgGeogebraCommonKernelAlgosAlgoIntersectPolynomialLine_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoFunction_withOrgGeogebraCommonKernelGeosGeoLine_(cons_, a, l);
  [algo setPrintedInXMLWithBoolean:NO];
  [((JavaUtilArrayList *) nil_chk(intersectionAlgos_)) addWithId:algo];
  return algo;
}
...
- (OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolyParametric *)getIntersectionAlgorithmWithOrgGeogebraCommonKernelImplicitGeoImplicitPoly:(OrgGeogebraCommonKernelImplicitGeoImplicitPoly *)p
  ...
  OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolyParametric *algo = new_OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolyParametric_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelImplicitGeoImplicitPoly_withOrgGeogebraCommonKernelGeosGeoLine_(cons_, p, l);
  [algo setPrintedInXMLWithBoolean:NO];
  [((JavaUtilArrayList *) nil_chk(intersectionAlgos_)) addWithId:algo];
  return algo;
}
...
- (OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolyParametric *)getIntersectionAlgorithmWithOrgGeogebraCommonKernelImplicitGeoImplicitPoly:(OrgGeogebraCommonKernelImplicitGeoImplicitPoly *)p
  ...
  if (existingAlgo != nil) return (OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolyParametric *) check_class_cast(existingAlgo, [OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolyParametric class]);
  OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolyParametric *algo = new_OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolyParametric_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelImplicitGeoImplicitPoly_withOrgGeogebraCommonKernelGeosGeoFunction_(cons_, p, f);
  [algo setPrintedInXMLWithBoolean:NO];
  [((JavaUtilArrayList *) nil_chk(intersectionAlgos_)) addWithId:algo];
  return algo;
}
...
- (OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolys *)getIntersectionAlgorithmWithOrgGeogebraCommonKernelImplicitGeoImplicitPoly:(OrgGeogebraCommonKernelImplicitGeoImplicitPoly *)p1
  ...
  OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolys *algo = new_OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolys_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelImplicitGeoImplicitPoly_withOrgGeogebraCommonKernelImplicitGeoImplicitPoly_(cons_, p1, p2);
  [algo setPrintedInXMLWithBoolean:NO];
  [((JavaUtilArrayList *) nil_chk(intersectionAlgos_)) addWithId:algo];
  return algo;
}
...
- (OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolys *)getIntersectionAlgorithmWithOrgGeogebraCommonKernelImplicitGeoImplicitPoly:(OrgGeogebraCommonKernelImplicitGeoImplicitPoly *)p1
  ...
  if (existingAlgo != nil) return (OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolys *) check_class_cast(existingAlgo, [OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolys class]);
  OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolys *algo = new_OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolys_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelImplicitGeoImplicitPoly_withOrgGeogebraCommonKernelGeosGeoConic_(cons_, p1, c1);
  [algo setPrintedInXMLWithBoolean:NO];
  [((JavaUtilArrayList *) nil_chk(intersectionAlgos_)) addWithId:algo];
  return algo;
}
...
withOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)P
withOrgGeogebraCommonKernelKernelNDGeoConicND:(OrgGeogebraCommonKernelKernelNDGeoConicND *)c {
  OrgGeogebraCommonKernelAlgosAlgoTangentPoint *algo = new_OrgGeogebraCommonKernelAlgosAlgoTangentPoint_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoConicND_(cons_, labels, P, c);
  return [algo getOutput];
}
...
- (IOSObjectArray *)CommonTangentsWithNSStringArray:(IOSObjectArray *)labels
  ...
  OrgGeogebraCommonKernelAlgosAlgoCommonTangents *algo = new_OrgGeogebraCommonKernelAlgosAlgoCommonTangents_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelKernelNDGeoConicND_withOrgGeogebraCommonKernelKernelNDGeoConicND_(cons_, labels, c1, c2);
  return [algo getOutput];
}
...
withOrgGeogebraCommonKernelKernelNDGeoLineND:(id<OrgGeogebraCommonKernelKernelNDGeoLineND>)g
withOrgGeogebraCommonKernelKernelNDGeoConicND:(OrgGeogebraCommonKernelKernelNDGeoConicND *)c {
  OrgGeogebraCommonKernelAlgosAlgoTangentLine *algo = new_OrgGeogebraCommonKernelAlgosAlgoTangentLine_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelKernelNDGeoLineND_withOrgGeogebraCommonKernelKernelNDGeoConicND_(cons_, labels, g, c);
  return [algo getOutput];
}
...
withOrgGeogebraCommonKernelImplicitGeoImplicitPoly:(OrgGeogebraCommonKernelImplicitGeoImplicitPoly *)p {
  OrgGeogebraCommonKernelImplicitAlgoTangentImplicitpoly *algo = new_OrgGeogebraCommonKernelImplicitAlgoTangentImplicitpoly_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelImplicitGeoImplicitPoly_withOrgGeogebraCommonKernelKernelNDGeoPointND_(cons_, labels, p, R);
  [algo setLabelsWithNSStringArray:labels];
...
withOrgGeogebraCommonKernelGeosGeoPoint:(OrgGeogebraCommonKernelGeosGeoPoint *)Q {
  OrgGeogebraCommonKernelTransform *t = new_OrgGeogebraCommonKernelTransformMirror_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoPoint_(cons_, Q);
...
withOrgGeogebraCommonKernelGeosGeoConic:(OrgGeogebraCommonKernelGeosGeoConic *)conic {
  OrgGeogebraCommonKernelTransform *t = new_OrgGeogebraCommonKernelTransformMirror_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoConic_(cons_, conic);
...
withOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geoMir
withOrgGeogebraCommonKernelGeosGeoLine:(OrgGeogebraCommonKernelGeosGeoLine *)g {
  OrgGeogebraCommonKernelTransform *t = new_OrgGeogebraCommonKernelTransformMirror_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoLine_(cons_, g);
  return [t transformWithOrgGeogebraCommonKernelGeosGeoElement:geoMir withNSString:label];
}
...
- (id<OrgGeogebraCommonKernelKernelNDGeoPointND>)copyFreePointWithOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)point
  ...
  return new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withNSString_withDouble_withDouble_withDouble_(cons_, nil, [((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(point)) getInhomX] + xOffset, [point getInhomY] + yOffset, 1.0);
}
...
- (jboolean)detachWithOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)point
  ...
  @try {
    ...
    OrgGeogebraCommonKernelGeosGeoPoint *newPoint = new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withNSString_withDouble_withDouble_withDouble_(cons_, nil, d, e, 1.0);
    [cons_ setSuppressLabelCreationWithBoolean:oldLabelCreationFlag];
...
- (OrgGeogebraCommonKernelGeosGeoPoint *)IntersectPolynomialConicSingleWithNSString:(NSString *)label
  ...
  OrgGeogebraCommonKernelAlgosAlgoIntersectSingle *salgo = new_OrgGeogebraCommonKernelAlgosAlgoIntersectSingle_initWithNSString_withOrgGeogebraCommonKernelAlgosAlgoIntersect_withInt_(label, algo, idx);
  OrgGeogebraCommonKernelGeosGeoPoint *point = [salgo getPoint];
  return point;
}
...
- (OrgGeogebraCommonKernelAlgosAlgoClosestPoint *)getNewAlgoClosestPointWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)cons2
  ...
  return new_OrgGeogebraCommonKernelAlgosAlgoClosestPoint_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelPath_withOrgGeogebraCommonKernelKernelNDGeoPointND_(cons2, path, point);
}
...
- (OrgGeogebraCommonKernelAlgosAlgoVertexPolygon *)newAlgoVertexPolygonWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)cons
  ...
  return new_OrgGeogebraCommonKernelAlgosAlgoVertexPolygon_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelGeosGeoPoly_(cons, labels, p);
}
...
void OrgGeogebraCommonKernelAlgosAlgoDispatcher_initWithOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonKernelAlgosAlgoDispatcher *self, OrgGeogebraCommonKernelConstruction *cons) {
  ...
  self->intersectionAlgos_ = new_JavaUtilArrayList_init();
  self->cons_ = cons;
}
...
OrgGeogebraCommonKernelGeosGeoVector *OrgGeogebraCommonKernelAlgosAlgoDispatcher_VectorWithDouble_withDouble_(OrgGeogebraCommonKernelAlgosAlgoDispatcher *self, jdouble x, jdouble y) {
  OrgGeogebraCommonKernelGeosGeoVector *v = new_OrgGeogebraCommonKernelGeosGeoVector_initWithOrgGeogebraCommonKernelConstruction_(self->cons_);
...
OrgGeogebraCommonKernelGeosGeoPoint *OrgGeogebraCommonKernelAlgosAlgoDispatcher_PointWithNSString_withOrgGeogebraCommonKernelPath_withDouble_withDouble_withBoolean_withBoolean_withBoolean_(OrgGeogebraCommonKernelAlgosAlgoDispatcher *self, NSString *label, id<OrgGeogebraCommonKernelPath> path, jdouble x, jdouble y, jboolean addToConstruction, jboolean complex, jboolean coords2D) {
  ...
  if (!addToConstruction) {
    algo = new_OrgGeogebraCommonKernelAlgosAlgoPointOnPath_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelPath_withDouble_withDouble_withDouble_withBoolean_(self->cons_, path, x, y, 0, NO);
  }
  else {
    algo = new_OrgGeogebraCommonKernelAlgosAlgoPointOnPath_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelPath_withDouble_withDouble_withDouble_(self->cons_, label, path, x, y, 0);
  }
  OrgGeogebraCommonKernelGeosGeoPoint *p = (OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast([((OrgGeogebraCommonKernelAlgosAlgoPointOnPath *) nil_chk(algo)) getP], [OrgGeogebraCommonKernelGeosGeoPoint class]);
  if (complex) {
...
OrgGeogebraCommonKernelGeosGeoSegment *OrgGeogebraCommonKernelAlgosAlgoDispatcher_SegmentWithNSString_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_(OrgGeogebraCommonKernelAlgosAlgoDispatcher *self, NSString *label, OrgGeogebraCommonKernelGeosGeoPoint *P, OrgGeogebraCommonKernelGeosGeoPoint *Q) {
  OrgGeogebraCommonKernelAlgosAlgoJoinPointsSegment *algo = new_OrgGeogebraCommonKernelAlgosAlgoJoinPointsSegment_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_(self->cons_, label, P, Q);
  OrgGeogebraCommonKernelGeosGeoSegment *s = [algo getSegment];
  return s;
}

OrgGeogebraCommonKernelGeosGeoAngle *OrgGeogebraCommonKernelAlgosAlgoDispatcher_AngleWithNSString_withOrgGeogebraCommonKernelGeosGeoLine_withOrgGeogebraCommonKernelGeosGeoLine_(OrgGeogebraCommonKernelAlgosAlgoDispatcher *self, NSString *label, OrgGeogebraCommonKernelGeosGeoLine *g, OrgGeogebraCommonKernelGeosGeoLine *h) {
  OrgGeogebraCommonKernelAlgosAlgoAngleLines *algo = new_OrgGeogebraCommonKernelAlgosAlgoAngleLines_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelKernelNDGeoLineND_withOrgGeogebraCommonKernelKernelNDGeoLineND_(self->cons_, label, g, h);
  OrgGeogebraCommonKernelGeosGeoAngle *angle = [algo getAngle];
  return angle;
}
...
OrgGeogebraCommonKernelGeosGeoPoint *OrgGeogebraCommonKernelAlgosAlgoDispatcher_PointInWithNSString_withOrgGeogebraCommonKernelRegion_withDouble_withDouble_withBoolean_withBoolean_withBoolean_(OrgGeogebraCommonKernelAlgosAlgoDispatcher *self, NSString *label, id<OrgGeogebraCommonKernelRegion> region, jdouble x, jdouble y, jboolean addToConstruction, jboolean complex, jboolean coords2D) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoPointInRegion *algo = new_OrgGeogebraCommonKernelAlgosAlgoPointInRegion_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelRegion_withDouble_withDouble_(self->cons_, label, region, x, y);
...
IOSObjectArray *OrgGeogebraCommonKernelAlgosAlgoDispatcher_TranslateWithNSString_withOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoVec3D_(OrgGeogebraCommonKernelAlgosAlgoDispatcher *self, NSString *label, OrgGeogebraCommonKernelGeosGeoElement *geoTrans, OrgGeogebraCommonKernelGeosGeoVec3D *v) {
  OrgGeogebraCommonKernelTransform *t = new_OrgGeogebraCommonKernelTransformTranslate_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoVec3D_(self->cons_, v);
