...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/kernel/algos/AlgoDistancePointObject.java
//
...
jdouble OrgGeogebraCommonKernelAlgosAlgoDistancePointObject_getClosestFunctionValueToPointWithOrgGeogebraCommonKernelArithmeticFunction_withDouble_withDouble_(OrgGeogebraCommonKernelArithmeticFunction *function, jdouble x, jdouble y) {
  ...
  if (polyFunction != nil) {
    ...
    IOSDoubleArray *eq = [IOSDoubleArray newArrayWithLength:(m + n < 1) ? 2 : m + n + 1];
    ...
    *IOSDoubleArray_GetRef(eq, 0) -= 2 * x;
    OrgGeogebraCommonKernelEquationSolver *solver = new_OrgGeogebraCommonKernelEquationSolver_initWithOrgGeogebraCommonKernelKernel_(kernel);
  ...
  OrgGeogebraCommonKernelArithmeticFunction *func = new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionVariable_(expr, fVar);
  OrgGeogebraCommonKernelGeosGeoFunction *geoFunc = new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticFunction_([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel)) getConstruction], func);
