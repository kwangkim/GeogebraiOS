...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/algos/AlgoPolyLine.java
//
...
- (void)createPolyLine {
  if (penStroke_) {
    OrgGeogebraCommonKernelAlgosAlgoPolyLine_setAndConsume_poly_(self, new_OrgGeogebraCommonKernelGeosGeoPenStroke_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_(self->cons_, self->points_));
  }
  else {
    OrgGeogebraCommonKernelAlgosAlgoPolyLine_setAndConsume_poly_(self, new_OrgGeogebraCommonKernelGeosGeoPolyLine_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_(self->cons_, self->points_));
  }
}
...
- (void)setInputOutput {
  if (geoList_ != nil) {
    if (penStroke_) {
      ...
      IOSObjectArray_SetAndConsume(input_, 1, new_OrgGeogebraCommonKernelGeosGeoBoolean_initWithOrgGeogebraCommonKernelConstruction_withBoolean_(cons_, YES));
    }
    else {
    ...
    OrgGeogebraCommonKernelAlgosAlgoElement_setAndConsume_input_(self, [IOSObjectArray newArrayWithLength:((IOSObjectArray *) nil_chk(points_))->size_ + (penStroke_ ? 1 : 0) type:OrgGeogebraCommonKernelGeosGeoElement_class_()]);
    for (jint i = 0; i < points_->size_; i++) {
      IOSObjectArray_Set(input_, i, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(IOSObjectArray_Get(points_, i), [OrgGeogebraCommonKernelGeosGeoElement class]));
    }
    if (penStroke_) {
      IOSObjectArray_SetAndConsume(input_, points_->size_, new_OrgGeogebraCommonKernelGeosGeoBoolean_initWithOrgGeogebraCommonKernelConstruction_withBoolean_(cons_, YES));
    }
  }
...
- (NSString *)toStringWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  if (sb_ == nil) OrgGeogebraCommonKernelAlgosAlgoPolyLine_setAndConsume_sb_(self, new_JavaLangStringBuilder_init());
  else [sb_ setLengthWithInt:0];
  [((JavaLangStringBuilder *) nil_chk(sb_)) appendWithNSString:[((OrgGeogebraCommonMainLocalization *) nil_chk([self getLoc])) getPlainWithNSString:@"PolyLine"]];
  [sb_ appendWithChar:' '];
  if (geoList_ != nil) {
    [sb_ appendWithNSString:[geoList_ getLabelWithOrgGeogebraCommonKernelStringTemplate:tpl]];
  }
  else if (((IOSObjectArray *) nil_chk(points_))->size_ < 20) {
    jint last = points_->size_ - 1;
    for (jint i = 0; i < last; i++) {
      [sb_ appendWithNSString:[((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(IOSObjectArray_Get(points_, i))) getLabelWithOrgGeogebraCommonKernelStringTemplate:tpl]];
      [sb_ appendWithNSString:@", "];
    }
    [sb_ appendWithNSString:[((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(IOSObjectArray_Get(points_, last))) getLabelWithOrgGeogebraCommonKernelStringTemplate:tpl]];
  }
  else {
    return @"";
  }
...
- (void)setPointsListWithOrgGeogebraCommonKernelGeosGeoList:(OrgGeogebraCommonKernelGeosGeoList *)newPts {
  OrgGeogebraCommonKernelAlgosAlgoPolyLine_set_geoList_(self, newPts);
}
...
void OrgGeogebraCommonKernelAlgosAlgoPolyLine_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelGeosGeoList_(OrgGeogebraCommonKernelAlgosAlgoPolyLine *self, OrgGeogebraCommonKernelConstruction *cons, IOSObjectArray *labels, OrgGeogebraCommonKernelGeosGeoList *geoList) {
  OrgGeogebraCommonKernelAlgosAlgoPolyLine_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_withOrgGeogebraCommonKernelGeosGeoList_(self, cons, labels, nil, geoList);
}
...
void OrgGeogebraCommonKernelAlgosAlgoPolyLine_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelGeosGeoList_withBoolean_(OrgGeogebraCommonKernelAlgosAlgoPolyLine *self, OrgGeogebraCommonKernelConstruction *cons, IOSObjectArray *labels, OrgGeogebraCommonKernelGeosGeoList *geoList, jboolean penStroke) {
  OrgGeogebraCommonKernelAlgosAlgoPolyLine_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_withOrgGeogebraCommonKernelGeosGeoList_withBoolean_(self, cons, labels, nil, geoList, penStroke);
}
...
void OrgGeogebraCommonKernelAlgosAlgoPolyLine_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoList_(OrgGeogebraCommonKernelAlgosAlgoPolyLine *self, OrgGeogebraCommonKernelConstruction *cons, OrgGeogebraCommonKernelGeosGeoList *geoList) {
  OrgGeogebraCommonKernelAlgosAlgoPolyLine_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_withOrgGeogebraCommonKernelGeosGeoList_withBoolean_(self, cons, nil, geoList, NO);
}
...
void OrgGeogebraCommonKernelAlgosAlgoPolyLine_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_withBoolean_(OrgGeogebraCommonKernelAlgosAlgoPolyLine *self, OrgGeogebraCommonKernelConstruction *cons, IOSObjectArray *labels, IOSObjectArray *points, jboolean penStroke) {
  OrgGeogebraCommonKernelAlgosAlgoPolyLine_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_withOrgGeogebraCommonKernelGeosGeoList_withBoolean_(self, cons, labels, points, nil, penStroke);
}
...
void OrgGeogebraCommonKernelAlgosAlgoPolyLine_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_withBoolean_(OrgGeogebraCommonKernelAlgosAlgoPolyLine *self, OrgGeogebraCommonKernelConstruction *cons, IOSObjectArray *points, jboolean penStroke) {
  OrgGeogebraCommonKernelAlgosAlgoPolyLine_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_withOrgGeogebraCommonKernelGeosGeoList_withBoolean_(self, cons, points, nil, penStroke);
}
...
void OrgGeogebraCommonKernelAlgosAlgoPolyLine_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_withOrgGeogebraCommonKernelGeosGeoList_(OrgGeogebraCommonKernelAlgosAlgoPolyLine *self, OrgGeogebraCommonKernelConstruction *cons, IOSObjectArray *labels, IOSObjectArray *points, OrgGeogebraCommonKernelGeosGeoList *geoList) {
  OrgGeogebraCommonKernelAlgosAlgoPolyLine_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_withOrgGeogebraCommonKernelGeosGeoList_withBoolean_(self, cons, points, geoList, NO);
...
void OrgGeogebraCommonKernelAlgosAlgoPolyLine_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_withOrgGeogebraCommonKernelGeosGeoList_withBoolean_(OrgGeogebraCommonKernelAlgosAlgoPolyLine *self, OrgGeogebraCommonKernelConstruction *cons, IOSObjectArray *points, OrgGeogebraCommonKernelGeosGeoList *geoList, jboolean penStroke) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoPolyLine_set_points_(self, points);
  OrgGeogebraCommonKernelAlgosAlgoPolyLine_set_geoList_(self, geoList);
...
void OrgGeogebraCommonKernelAlgosAlgoPolyLine_updatePointArrayWithOrgGeogebraCommonKernelGeosGeoList_(OrgGeogebraCommonKernelAlgosAlgoPolyLine *self, OrgGeogebraCommonKernelGeosGeoList *pointList) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoPolyLine_setAndConsume_points_(self, [IOSObjectArray newArrayWithLength:size type:OrgGeogebraCommonKernelGeosGeoPoint_class_()]);
