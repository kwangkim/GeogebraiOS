...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/kernel/algos/AlgoIntegralODE.java
//
...
- (void)setInputOutput {
  ...
  (void) IOSObjectArray_Set(input_, 1, p_);
...
void OrgGeogebraCommonKernelAlgosAlgoIntegralODE_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoPoint_(OrgGeogebraCommonKernelAlgosAlgoIntegralODE *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelGeosGeoElement *geo, OrgGeogebraCommonKernelGeosGeoPoint *p) {
  ...
  self->f0_ = nil;
  self->stepHandler_ = new_OrgGeogebraCommonKernelAlgosAlgoIntegralODE_$1_initWithOrgGeogebraCommonKernelAlgosAlgoIntegralODE_(self);
  self->geo_ = geo;
  self->p_ = p;
  if ([OrgGeogebraCommonKernelArithmeticFunctionalNVar_class_() isInstance:geo]) {
    self->f0_ = (id<OrgGeogebraCommonKernelArithmeticFunctionalNVar>) check_protocol_cast(geo, @protocol(OrgGeogebraCommonKernelArithmeticFunctionalNVar));
  }
    ...
    if ([((id<OrgGeogebraCommonKernelAlgosGetCommand>) nil_chk([((OrgGeogebraCommonKernelAlgosAlgoElement *) nil_chk(algo)) getClassName])) isEqual:OrgGeogebraCommonKernelCommandsCommandsEnum_get_SlopeField()]) {
      self->f0_ = (id<OrgGeogebraCommonKernelArithmeticFunctionalNVar>) check_protocol_cast(IOSObjectArray_Get(nil_chk([algo getInput]), 0), @protocol(OrgGeogebraCommonKernelArithmeticFunctionalNVar));
    }
  }
  self->numAlgo_ = new_OrgGeogebraCommonKernelAlgosAlgoNumerator_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticFunctionalNVar_(cons, self->f0_);
  self->denAlgo_ = new_OrgGeogebraCommonKernelAlgosAlgoDenominator_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticFunctionalNVar_(cons, self->f0_);
...
void OrgGeogebraCommonKernelAlgosAlgoIntegralODE_compute(OrgGeogebraCommonKernelAlgosAlgoIntegralODE *self) {
  ...
  id<OrgApacheCommonsMathOdeFirstOrderIntegrator> integrator = new_OrgApacheCommonsMathOdeNonstiffClassicalRungeKuttaIntegrator_initWithDouble_(OrgGeogebraCommonKernelAlgosAlgoIntegralODE_step);
  id<OrgApacheCommonsMathOdeFirstOrderDifferentialEquations> ode;
  if (!self->quotient_) {
    ode = new_OrgGeogebraCommonKernelAlgosAlgoIntegralODE_ODE_initWithOrgGeogebraCommonKernelArithmeticFunctionalNVar_(self->f0_);
  }
  else {
    ode = new_OrgGeogebraCommonKernelAlgosAlgoIntegralODE_ODE2_initWithOrgGeogebraCommonKernelArithmeticFunctionalNVar_withOrgGeogebraCommonKernelArithmeticFunctionalNVar_(self->num_, self->den_);
  }
  [integrator addStepHandlerWithOrgApacheCommonsMathOdeSamplingStepHandler:self->stepHandler_];
  [((JavaUtilArrayList *) nil_chk(self->al_)) addWithId:new_OrgGeogebraCommonKernelMyPoint_initWithDouble_withDouble_withBoolean_(((OrgGeogebraCommonKernelGeosGeoPoint *) nil_chk(self->p_))->inhomX_, self->p_->inhomY_, NO)];
  IOSDoubleArray *yy = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ self->p_->inhomY_ } count:1];
  IOSDoubleArray *yy2 = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ self->p_->inhomX_, self->p_->inhomY_ } count:2];
  IOSDoubleArray *yya = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ self->p_->inhomY_ } count:1];
  IOSDoubleArray *yy2a = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ self->p_->inhomX_, self->p_->inhomY_ } count:2];
  if (!self->quotient_) {
    if (self->p_->inhomX_ < xmax) {
      ...
      [self->al_ addWithId:new_OrgGeogebraCommonKernelMyPoint_initWithDouble_withDouble_withBoolean_(self->p_->inhomX_, self->p_->inhomY_, NO)];
    }
...
- (void)computeDerivativesWithDouble:(jdouble)t
                     withDoubleArray:(IOSDoubleArray *)y
                     withDoubleArray:(IOSDoubleArray *)yDot {
  IOSDoubleArray *input = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ t, IOSDoubleArray_Get(nil_chk(y), 0) } count:2];
...
- (void)computeDerivativesWithDouble:(jdouble)t
                     withDoubleArray:(IOSDoubleArray *)y
                     withDoubleArray:(IOSDoubleArray *)yDot {
  IOSDoubleArray *input = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ IOSDoubleArray_Get(nil_chk(y), 0), IOSDoubleArray_Get(y, 1) } count:2];
...
- (void)handleStepWithOrgApacheCommonsMathOdeSamplingStepInterpolator:(id<OrgApacheCommonsMathOdeSamplingStepInterpolator>)interpolator
  ...
  if (!this$0_->quotient_) {
    [((JavaUtilArrayList *) nil_chk(this$0_->al_)) addWithId:new_OrgGeogebraCommonKernelMyPoint_initWithDouble_withDouble_withBoolean_(t, IOSDoubleArray_Get(nil_chk(y), 0), YES)];
  }
  else {
    [((JavaUtilArrayList *) nil_chk(this$0_->al_)) addWithId:new_OrgGeogebraCommonKernelMyPoint_initWithDouble_withDouble_withBoolean_(IOSDoubleArray_Get(nil_chk(y), 0), IOSDoubleArray_Get(y, 1), YES)];
  }
}
