...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/kernel/algos/AlgoIntersectCurveCurve.java
//
...
- (void)setInputOutput {
  if (t1_ != nil) {
    ...
    (void) IOSObjectArray_Set(input_, 2, [t1_ toGeoElement]);
    (void) IOSObjectArray_Set(input_, 3, [((id<OrgGeogebraCommonKernelGeosGeoNumberValue>) nil_chk(t2_)) toGeoElement]);
  }
  else {
    input_ = [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
  }
  (void) IOSObjectArray_Set(nil_chk(input_), 0, curve_);
  (void) IOSObjectArray_Set(input_, 1, curve2_);
...
- (void)compute {
  ...
  if (numeric_) {
    ...
    (void) [sb appendWithNSString:@"Solve[{"];
    (void) [sb appendWithNSString:c1X];
    (void) [sb appendWithChar:'='];
    (void) [sb appendWithNSString:c2X];
    (void) [sb appendWithChar:','];
    (void) [sb appendWithNSString:c1Y];
    (void) [sb appendWithChar:'='];
    (void) [sb appendWithNSString:c2Y];
    (void) [sb appendWithNSString:@"},{"];
    (void) [sb appendWithNSString:fv1];
    (void) [sb appendWithChar:','];
    (void) [sb appendWithNSString:fv2];
    (void) [sb appendWithNSString:@"}]"];
    NSString *result = @"";
    @try {
...
void OrgGeogebraCommonKernelAlgosAlgoIntersectCurveCurve_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelGeosGeoCurveCartesian_withOrgGeogebraCommonKernelGeosGeoCurveCartesian_(OrgGeogebraCommonKernelAlgosAlgoIntersectCurveCurve *self, OrgGeogebraCommonKernelConstruction *c, IOSObjectArray *labels, OrgGeogebraCommonKernelGeosGeoCurveCartesian *c1, OrgGeogebraCommonKernelGeosGeoCurveCartesian *c2) {
  (void) OrgGeogebraCommonKernelAlgosAlgoIntersectLineCurve_initWithOrgGeogebraCommonKernelConstruction_(self, c);
  self->numeric_ = NO;
