...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/kernel/algos/AlgoLaTeX.java
//
...
- (void)setInputOutput {
  ...
  input_ = [IOSObjectArray newArrayWithLength:[geos size] type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
  for (jint i = 0; i < input_->size_; i++) {
    (void) IOSObjectArray_Set(input_, i, [geos getWithInt:i]);
  }
