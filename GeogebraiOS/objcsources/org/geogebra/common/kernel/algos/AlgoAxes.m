...
- (void)createInput {
  OrgGeogebraCommonKernelAlgosAlgoAxesQuadricND_setAndConsume_axes_(self, [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonKernelGeosGeoLine_class_()]);
  IOSObjectArray_SetAndConsume(axes_, 0, new_OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelConstruction_(cons_));
  IOSObjectArray_SetAndConsume(axes_, 1, new_OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelConstruction_(cons_));
  OrgGeogebraCommonKernelAlgosAlgoAxes_setAndConsume_P_(self, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons_));
