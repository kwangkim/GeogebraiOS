...
void OrgGeogebraCommonKernelAlgosAlgoPolygonRegularND_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelKernelNDGeoDirectionND_(OrgGeogebraCommonKernelAlgosAlgoPolygonRegularND *self, OrgGeogebraCommonKernelConstruction *c, IOSObjectArray *labels, id<OrgGeogebraCommonKernelKernelNDGeoPointND> A1, id<OrgGeogebraCommonKernelKernelNDGeoPointND> B1, id<OrgGeogebraCommonKernelArithmeticNumberValue> num, id<OrgGeogebraCommonKernelKernelNDGeoDirectionND> direction) {
  ...
  self->centerPoint_ = (id<OrgGeogebraCommonKernelKernelNDGeoPointND>) check_protocol_cast([self newGeoPointWithOrgGeogebraCommonKernelConstruction:c], @protocol(OrgGeogebraCommonKernelKernelNDGeoPointND));
  self->rotAngle_ = new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_(self->kernel_);
  self->outputPolygon_ = new_OrgGeogebraCommonKernelAlgosAlgoElement_OutputHandler_initWithOrgGeogebraCommonKernelAlgosAlgoElement_withOrgGeogebraCommonKernelAlgosAlgoElement_elementFactory_(self, new_OrgGeogebraCommonKernelAlgosAlgoPolygonRegularND_$1_initWithOrgGeogebraCommonKernelAlgosAlgoPolygonRegularND_(self));
  self->outputSegments_ = new_OrgGeogebraCommonKernelAlgosAlgoElement_OutputHandler_initWithOrgGeogebraCommonKernelAlgosAlgoElement_withOrgGeogebraCommonKernelAlgosAlgoElement_elementFactory_(self, new_OrgGeogebraCommonKernelAlgosAlgoPolygonRegularND_$2_initWithOrgGeogebraCommonKernelAlgosAlgoPolygonRegularND_(self));
...
void OrgGeogebraCommonKernelAlgosAlgoPolygonRegularND_computeWithInt_(OrgGeogebraCommonKernelAlgosAlgoPolygonRegularND *self, jint nd) {
  ...
  IOSObjectArray *points = [IOSObjectArray newArrayWithLength:self->n_ type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()];
  (void) IOSObjectArray_Set(points, 0, self->A_);
  (void) IOSObjectArray_Set(points, 1, self->B_);
  for (jint i = 2; i < self->n_; i++) (void) IOSObjectArray_Set(points, i, (id<OrgGeogebraCommonKernelKernelNDGeoPointND>) check_protocol_cast([((OrgGeogebraCommonKernelAlgosAlgoElement_OutputHandler *) nil_chk(self->outputPoints_)) getElementWithInt:i - 2], @protocol(OrgGeogebraCommonKernelKernelNDGeoPointND)));
  ...
  IOSObjectArray *segments = [IOSObjectArray newArrayWithLength:self->n_ type:OrgGeogebraCommonKernelKernelNDGeoSegmentND_class_()];
  for (jint i = 0; i < self->n_; i++) {
    (void) IOSObjectArray_Set(segments, i, (id<OrgGeogebraCommonKernelKernelNDGeoSegmentND>) check_protocol_cast([((OrgGeogebraCommonKernelAlgosAlgoElement_OutputHandler *) nil_chk(self->outputSegments_)) getElementWithInt:i], @protocol(OrgGeogebraCommonKernelKernelNDGeoSegmentND)));
  }
