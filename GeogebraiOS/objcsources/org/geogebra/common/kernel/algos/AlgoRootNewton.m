...
void OrgGeogebraCommonKernelAlgosAlgoRootNewton_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoFunction_withOrgGeogebraCommonKernelArithmeticNumberValue_(OrgGeogebraCommonKernelAlgosAlgoRootNewton *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelGeosGeoFunction *f, id<OrgGeogebraCommonKernelArithmeticNumberValue> start) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoRootNewton_set_f_(self, f);
  OrgGeogebraCommonKernelAlgosAlgoRootNewton_set_start_(self, start);
  OrgGeogebraCommonKernelAlgosAlgoRootNewton_set_startGeo_(self, [((id<OrgGeogebraCommonKernelArithmeticNumberValue>) nil_chk(start)) toGeoElement]);
  OrgGeogebraCommonKernelAlgosAlgoRootNewton_setAndConsume_rootPoint_(self, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  [self compute];
...
jdouble OrgGeogebraCommonKernelAlgosAlgoRootNewton_calcRootWithOrgGeogebraCommonKernelArithmeticFunction_withDouble_(OrgGeogebraCommonKernelAlgosAlgoRootNewton *self, OrgGeogebraCommonKernelArithmeticFunction *fun, jdouble start) {
  ...
  if (self->rootFinderBrent_ == nil) OrgGeogebraCommonKernelAlgosAlgoRootNewton_setAndConsume_rootFinderBrent_(self, new_OrgApacheCommonsMathAnalysisSolversBrentSolver_initWithDouble_(OrgGeogebraCommonKernelKernel_STANDARD_PRECISION));
  @try {
    jdouble step = 1;
    root = [((OrgApacheCommonsMathAnalysisSolversBrentSolver *) nil_chk(self->rootFinderBrent_)) solveWithInt:OrgGeogebraCommonKernelAlgosAlgoRootNewton_MAX_ITERATIONS withOrgApacheCommonsMathAnalysisUnivariateRealFunction:[new_OrgGeogebraCommonKernelRootsRealRootAdapter_initWithOrgGeogebraCommonKernelRootsRealRootFunction_(fun) autorelease] withDouble:start - step withDouble:start + step withDouble:start];
  ...
  @try {
    root = [((OrgApacheCommonsMathAnalysisSolversBrentSolver *) nil_chk(self->rootFinderBrent_)) solveWithInt:OrgGeogebraCommonKernelAlgosAlgoRootNewton_MAX_ITERATIONS withOrgApacheCommonsMathAnalysisUnivariateRealFunction:[new_OrgGeogebraCommonKernelRootsRealRootAdapter_initWithOrgGeogebraCommonKernelRootsRealRootFunction_(fun) autorelease] withDouble:IOSDoubleArray_Get(nil_chk(borders), 0) withDouble:IOSDoubleArray_Get(borders, 1) withDouble:start];
    if (OrgGeogebraCommonKernelAlgosAlgoRootNewton_checkRootWithOrgGeogebraCommonKernelArithmeticFunction_withDouble_(fun, root)) {
      return root;
    }
  }
