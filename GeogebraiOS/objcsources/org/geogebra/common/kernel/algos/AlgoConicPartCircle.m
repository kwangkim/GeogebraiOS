...
void OrgGeogebraCommonKernelAlgosAlgoConicPartCircle_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_withInt_(OrgGeogebraCommonKernelAlgosAlgoConicPartCircle *self, OrgGeogebraCommonKernelConstruction *cons, OrgGeogebraCommonKernelGeosGeoPoint *center, OrgGeogebraCommonKernelGeosGeoPoint *startPoint, OrgGeogebraCommonKernelGeosGeoPoint *endPoint, jint type) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoConicPartCircle_set_center_(self, center);
  OrgGeogebraCommonKernelAlgosAlgoConicPartCircle_set_startPoint_(self, startPoint);
  OrgGeogebraCommonKernelAlgosAlgoConicPartCircle_set_endPoint_(self, endPoint);
  OrgGeogebraCommonKernelAlgosAlgoCircleTwoPoints *algo = [new_OrgGeogebraCommonKernelAlgosAlgoCircleTwoPoints_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_(cons, center, startPoint) autorelease];
  ...
  OrgGeogebraCommonKernelAlgosAlgoConicPartCircle_setAndConsume_P_(self, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons));
  OrgGeogebraCommonKernelAlgosAlgoConicPartCircle_setAndConsume_Q_(self, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons));
  OrgGeogebraCommonKernelAlgosAlgoConicPart_setAndConsume_conicPart_(self, new_OrgGeogebraCommonKernelGeosGeoConicPart_initWithOrgGeogebraCommonKernelConstruction_withInt_(cons, type));
