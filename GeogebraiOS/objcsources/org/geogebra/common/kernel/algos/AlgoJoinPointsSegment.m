...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/algos/AlgoJoinPointsSegment.java
//
...
- (void)setInputOutput {
  IOSObjectArray *efficientInput = [IOSObjectArray arrayWithLength:2 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
...
- (void)modifyInputPointsWithOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)A
  ...
  OrgGeogebraCommonKernelAlgosAlgoJoinPointsSegment_set_P_(self, (OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast(A, [OrgGeogebraCommonKernelGeosGeoPoint class]));
  OrgGeogebraCommonKernelAlgosAlgoJoinPointsSegment_set_Q_(self, (OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast(B, [OrgGeogebraCommonKernelGeosGeoPoint class]));
...
- (IOSObjectArray *)getBotanaVarsWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  ...
  OrgGeogebraCommonKernelAlgosAlgoJoinPointsSegment_set_botanaVars_(self, OrgGeogebraCommonKernelAlgosSymbolicParameters_addBotanaVarsJoinPointsWithOrgGeogebraCommonKernelGeosGeoElementArray_(input_));
  return botanaVars_;
}
...
- (IOSObjectArray *)getPolynomials {
  ...
  if (P_ != nil && Q_ != nil) {
    ...
    if (coords1 != nil && coords2 != nil) {
      OrgGeogebraCommonKernelAlgosAlgoJoinPointsSegment_set_polynomials_(self, OrgGeogebraCommonKernelProverPolynomialPolynomial_crossProductWithOrgGeogebraCommonKernelProverPolynomialPolynomialArray_withOrgGeogebraCommonKernelProverPolynomialPolynomialArray_(coords1, coords2));
      return polynomials_;
    }
  }
  @throw [new_OrgGeogebraCommonKernelProverNoSymbolicParametersException_init() autorelease];
...
void OrgGeogebraCommonKernelAlgosAlgoJoinPointsSegment_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_(OrgGeogebraCommonKernelAlgosAlgoJoinPointsSegment *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelGeosGeoPoint *P, OrgGeogebraCommonKernelGeosGeoPoint *Q) {
  OrgGeogebraCommonKernelAlgosAlgoJoinPointsSegment_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPolygon_(self, cons, P, Q, nil);
...
void OrgGeogebraCommonKernelAlgosAlgoJoinPointsSegment_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPolygon_(OrgGeogebraCommonKernelAlgosAlgoJoinPointsSegment *self, OrgGeogebraCommonKernelConstruction *cons, OrgGeogebraCommonKernelGeosGeoPoint *P, OrgGeogebraCommonKernelGeosGeoPoint *Q, OrgGeogebraCommonKernelGeosGeoPolygon *poly) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoJoinPointsSegment_set_poly_(self, poly);
  OrgGeogebraCommonKernelAlgosAlgoJoinPointsSegment_set_P_(self, P);
  OrgGeogebraCommonKernelAlgosAlgoJoinPointsSegment_set_Q_(self, Q);
  OrgGeogebraCommonKernelAlgosAlgoJoinPointsSegment_setAndConsume_s_(self, new_OrgGeogebraCommonKernelGeosGeoSegment_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_(cons, P, Q));
