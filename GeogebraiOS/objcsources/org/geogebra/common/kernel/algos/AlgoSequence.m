...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/algos/AlgoSequence.java
//
...
- (void)setInputOutput {
  if (isSimple_) {
    ...
    OrgGeogebraCommonKernelAlgosAlgoElement_setAndConsume_input_(self, [IOSObjectArray newArrayWithLength:len type:OrgGeogebraCommonKernelGeosGeoElement_class_()]);
...
- (IOSObjectArray *)getInputForUpdateSetPropagation {
  ...
  IOSObjectArray *realInput = [IOSObjectArray arrayWithLength:((IOSObjectArray *) nil_chk(input_))->size_ - 1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
...
void OrgGeogebraCommonKernelAlgosAlgoSequence_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_(OrgGeogebraCommonKernelAlgosAlgoSequence *self, OrgGeogebraCommonKernelConstruction *cons, OrgGeogebraCommonKernelGeosGeoElement *expression, OrgGeogebraCommonKernelGeosGeoNumeric *var, id<OrgGeogebraCommonKernelArithmeticNumberValue> var_from, id<OrgGeogebraCommonKernelArithmeticNumberValue> var_to, id<OrgGeogebraCommonKernelArithmeticNumberValue> var_step) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoSequence_set_expression_(self, expression);
  OrgGeogebraCommonKernelAlgosAlgoSequence_set_var_(self, var);
  OrgGeogebraCommonKernelAlgosAlgoSequence_set_var_from_(self, var_from);
  OrgGeogebraCommonKernelAlgosAlgoSequence_set_var_from_geo_(self, [((id<OrgGeogebraCommonKernelArithmeticNumberValue>) nil_chk(var_from)) toGeoElement]);
  OrgGeogebraCommonKernelAlgosAlgoSequence_set_var_to_(self, var_to);
  OrgGeogebraCommonKernelAlgosAlgoSequence_set_var_to_geo_(self, [((id<OrgGeogebraCommonKernelArithmeticNumberValue>) nil_chk(var_to)) toGeoElement]);
  OrgGeogebraCommonKernelAlgosAlgoSequence_set_var_step_(self, var_step);
  if (var_step != nil) OrgGeogebraCommonKernelAlgosAlgoSequence_set_var_step_geo_(self, [var_step toGeoElement]);
  OrgGeogebraCommonKernelAlgosAlgoSequence_set_expressionParentAlgo_(self, [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(expression)) getParentAlgorithm]);
  self->expIsFunctionOrCurve_ = [OrgGeogebraCommonKernelGeosCasEvaluableFunction_class_() isInstance:expression];
  self->isSimple_ = NO;
  OrgGeogebraCommonKernelAlgosAlgoSequence_setAndConsume_list_(self, new_OrgGeogebraCommonKernelGeosGeoList_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  OrgGeogebraCommonKernelAlgosAlgoSequence_compute(self);
}
...
void OrgGeogebraCommonKernelAlgosAlgoSequence_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoNumberValue_(OrgGeogebraCommonKernelAlgosAlgoSequence *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, id<OrgGeogebraCommonKernelGeosGeoNumberValue> upTo) {
  ...
  self->updateRunning_ = NO;
  self->isSimple_ = YES;
  OrgGeogebraCommonKernelAlgosAlgoSequence_set_var_to_(self, upTo);
  OrgGeogebraCommonKernelAlgosAlgoSequence_set_var_to_geo_(self, [((id<OrgGeogebraCommonKernelArithmeticNumberValue>) nil_chk(self->var_to_)) toGeoElement]);
  OrgGeogebraCommonKernelAlgosAlgoSequence_setAndConsume_list_(self, new_OrgGeogebraCommonKernelGeosGeoList_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  OrgGeogebraCommonKernelAlgosAlgoSequence_compute(self);
...
void OrgGeogebraCommonKernelAlgosAlgoSequence_computeSimple(OrgGeogebraCommonKernelAlgosAlgoSequence *self) {
  ...
  if (self->last_to_ < to) for (jint k = J2ObjCFpToInt(self->last_to_); k < to; k++) if (k >= 0) [((OrgGeogebraCommonKernelGeosGeoList *) nil_chk(self->list_)) addWithOrgGeogebraCommonKernelGeosGeoElement:[new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(self->cons_, k + 1) autorelease]];
