...
- (void)setConstructionWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)c {
  OrgGeogebraCommonKernelAlgosConstructionElement_set_cons_(self, c);
  OrgGeogebraCommonKernelAlgosConstructionElement_set_kernel_(self, [((OrgGeogebraCommonKernelConstruction *) nil_chk(c)) getKernel]);
}
