...
- (jboolean)getCoordsInD3WithOrgGeogebraCommonKernelMatrixCoordsArray:(IOSObjectArray *)drawCoords {
  (void) IOSObjectArray_Set(nil_chk(drawCoords), 0, [((OrgGeogebraCommonKernelGeosGeoConic *) nil_chk(c_)) getMidpoint3D]);
  (void) IOSObjectArray_Set(drawCoords, 1, OrgGeogebraCommonKernelMatrixCoords_get_VX_());
  (void) IOSObjectArray_Set(drawCoords, 2, [c_ getEigenvec3DWithInt:0]);
  return YES;
}
