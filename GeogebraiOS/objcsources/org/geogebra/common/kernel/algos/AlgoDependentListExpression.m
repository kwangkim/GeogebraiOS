...
void OrgGeogebraCommonKernelAlgosAlgoDependentListExpression_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticExpressionNode_(OrgGeogebraCommonKernelAlgosAlgoDependentListExpression *self, OrgGeogebraCommonKernelConstruction *cons, OrgGeogebraCommonKernelArithmeticExpressionNode *root) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoDependentListExpression_set_root_(self, root);
  OrgGeogebraCommonKernelAlgosAlgoDependentListExpression_setAndConsume_list_(self, new_OrgGeogebraCommonKernelGeosGeoList_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  OrgGeogebraCommonKernelAlgosAlgoDependentListExpression_compute(self);
}
...
void OrgGeogebraCommonKernelAlgosAlgoDependentListExpression_compute(OrgGeogebraCommonKernelAlgosAlgoDependentListExpression *self) {
  ...
  for (jint i = 0; i < evalListSize; i++) {
    ...
    if ([OrgGeogebraCommonKernelArithmeticNumberValue_class_() isInstance:element]) {
      ...
      if (geo == nil) {
        geo = [new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(self->cons_, val) autorelease];
      }
      ...
      if (geo == nil) {
        OrgGeogebraCommonKernelGeosGeoPoint *point = [new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(self->cons_) autorelease];
      ...
      OrgGeogebraCommonKernelGeosGeoList *list2 = [new_OrgGeogebraCommonKernelGeosGeoList_initWithOrgGeogebraCommonKernelConstruction_(self->cons_) autorelease];
      [list2 clear];
      for (jint j = 0; j < [((OrgGeogebraCommonKernelArithmeticMyList *) nil_chk(myList2)) size]; j++) {
        ...
        if ([ev isKindOfClass:[OrgGeogebraCommonKernelArithmeticMyDouble class]]) {
          OrgGeogebraCommonKernelGeosGeoNumeric *geo2 = [new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(self->cons_) autorelease];
      ...
      if (geo == nil) {
        OrgGeogebraCommonKernelGeosGeoBoolean *geoBool = [new_OrgGeogebraCommonKernelGeosGeoBoolean_initWithOrgGeogebraCommonKernelConstruction_(self->cons_) autorelease];
      ...
      if (geo == nil) {
        OrgGeogebraCommonKernelGeosGeoFunction *geoFun = [new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_(self->cons_) autorelease];
      ...
      if (geo == nil) {
        OrgGeogebraCommonKernelGeosGeoText *geoFun = [new_OrgGeogebraCommonKernelGeosGeoText_initWithOrgGeogebraCommonKernelConstruction_(self->cons_) autorelease];
