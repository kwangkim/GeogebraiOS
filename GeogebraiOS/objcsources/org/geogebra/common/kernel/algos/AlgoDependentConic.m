...
void OrgGeogebraCommonKernelAlgosAlgoDependentConic_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticEquation_(OrgGeogebraCommonKernelAlgosAlgoDependentConic *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelArithmeticEquation *equ) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoDependentConic_setAndConsume_ev_(self, [IOSObjectArray newArrayWithLength:6 type:OrgGeogebraCommonKernelArithmeticExpressionValue_class_()]);
  OrgGeogebraCommonKernelAlgosAlgoDependentConic_set_equation_(self, equ);
  ...
  OrgGeogebraCommonKernelAlgosAlgoDependentConic_setAndConsume_conic_(self, new_OrgGeogebraCommonKernelGeosGeoConic_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  OrgGeogebraCommonKernelAlgosAlgoDependentConic_compute(self);
