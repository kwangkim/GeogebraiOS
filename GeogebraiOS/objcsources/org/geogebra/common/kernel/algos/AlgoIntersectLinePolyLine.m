...
- (void)setInputOutput {
  ...
  (void) IOSObjectArray_Set(input_, 1, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(pi_, [OrgGeogebraCommonKernelGeosGeoElement class]));
  ...
  for (jint i = 0; i < [((OrgGeogebraCommonKernelGeosGeoPolyLine *) nil_chk(p)) getNumPoints] - 1; i++) {
    ...
    if (OrgGeogebraCommonKernelKernel_isZeroWithDouble_([((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(coords)) getLast])) {
      if ([((OrgGeogebraCommonKernelGeosGeoLine *) check_class_cast(g, [OrgGeogebraCommonKernelGeosGeoLine class])) isOnPathWithOrgGeogebraCommonKernelMatrixCoords:segStart withDouble:OrgGeogebraCommonKernelKernel_STANDARD_PRECISION] && [((OrgGeogebraCommonKernelGeosGeoLine *) check_class_cast(g, [OrgGeogebraCommonKernelGeosGeoLine class])) isOnPathWithOrgGeogebraCommonKernelMatrixCoords:segEnd withDouble:OrgGeogebraCommonKernelKernel_STANDARD_PRECISION]) {
        (void) [((JavaUtilTreeMap *) nil_chk(newCoords)) putWithId:JavaLangDouble_valueOfWithDouble_([((OrgGeogebraCommonKernelGeosGeoLine *) check_class_cast(g, [OrgGeogebraCommonKernelGeosGeoLine class])) getPossibleParameterWithOrgGeogebraCommonKernelMatrixCoords:segStart]) withId:segStart];
        (void) [newCoords putWithId:JavaLangDouble_valueOfWithDouble_([((OrgGeogebraCommonKernelGeosGeoLine *) check_class_cast(g, [OrgGeogebraCommonKernelGeosGeoLine class])) getPossibleParameterWithOrgGeogebraCommonKernelMatrixCoords:segEnd]) withId:segEnd];
      }
    }
      ...
      if (t >= min && t <= max) (void) [((JavaUtilTreeMap *) nil_chk(newCoords)) putWithId:JavaLangDouble_valueOfWithDouble_(t) withId:coords];
    }
  }
}
...
- (void)compute {
  ...
  self->p_ = (OrgGeogebraCommonKernelGeosGeoPolyLine *) check_class_cast([((id<OrgGeogebraCommonKernelGeosGeoPoly>) nil_chk(pi_)) getBoundary], [OrgGeogebraCommonKernelGeosGeoPolyLine class]);
