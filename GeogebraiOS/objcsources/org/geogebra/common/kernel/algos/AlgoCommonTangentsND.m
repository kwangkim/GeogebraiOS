...
- (void)setInputOutput {
  ...
  (void) IOSObjectArray_Set(input_, 0, IOSObjectArray_Get(nil_chk(c_), 0));
  (void) IOSObjectArray_Set(input_, 1, IOSObjectArray_Get(c_, 1));
...
void OrgGeogebraCommonKernelAlgosAlgoCommonTangentsND_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelKernelNDGeoConicND_withOrgGeogebraCommonKernelKernelNDGeoConicND_(OrgGeogebraCommonKernelAlgosAlgoCommonTangentsND *self, OrgGeogebraCommonKernelConstruction *cons, IOSObjectArray *labels, OrgGeogebraCommonKernelKernelNDGeoConicND *c, OrgGeogebraCommonKernelKernelNDGeoConicND *c2) {
  (void) OrgGeogebraCommonKernelAlgosAlgoCommonTangentsND_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoConicND_withOrgGeogebraCommonKernelKernelNDGeoConicND_(self, cons, c, c2);
...
void OrgGeogebraCommonKernelAlgosAlgoCommonTangentsND_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoConicND_withOrgGeogebraCommonKernelKernelNDGeoConicND_(OrgGeogebraCommonKernelAlgosAlgoCommonTangentsND *self, OrgGeogebraCommonKernelConstruction *cons, OrgGeogebraCommonKernelKernelNDGeoConicND *c, OrgGeogebraCommonKernelKernelNDGeoConicND *c2) {
  ...
  self->c_ = [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonKernelKernelNDGeoConicND_class_()];
  (void) IOSObjectArray_Set(self->c_, 0, c);
  (void) IOSObjectArray_Set(self->c_, 1, c2);
  ...
  self->polar_ = new_OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelConstruction_(cons);
  self->algoIntersect_ = [self createAlgoWithOrgGeogebraCommonKernelConstruction:cons withOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(nil_chk(self->P_), 0) withOrgGeogebraCommonKernelGeosGeoLine:self->polar_ withOrgGeogebraCommonKernelKernelNDGeoConicND:IOSObjectArray_Get(self->c_, 0)];
  ...
  self->tangentPoints_ = [((OrgGeogebraCommonKernelKernelNDAlgoIntersectND *) nil_chk(self->algoIntersect_)) getIntersectionPoints];
  ...
  self->polar2_ = new_OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelConstruction_(cons);
  self->algoIntersect2_ = [self createAlgoWithOrgGeogebraCommonKernelConstruction:cons withOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(self->P_, 1) withOrgGeogebraCommonKernelGeosGeoLine:self->polar2_ withOrgGeogebraCommonKernelKernelNDGeoConicND:IOSObjectArray_Get(self->c_, 1)];
  [cons removeFromConstructionListWithOrgGeogebraCommonKernelAlgosConstructionElement:self->algoIntersect2_];
  self->tangentPoints2_ = [((OrgGeogebraCommonKernelKernelNDAlgoIntersectND *) nil_chk(self->algoIntersect2_)) getIntersectionPoints];
  [self initTangents];
  [self setInputOutput];
  OrgGeogebraCommonKernelAlgosAlgoCommonTangentsND_compute(self);
