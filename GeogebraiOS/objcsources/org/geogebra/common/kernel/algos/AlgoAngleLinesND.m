...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/algos/AlgoAngleLinesND.java
//
...
- (void)setInputWithOrgGeogebraCommonKernelKernelNDGeoLineND:(id<OrgGeogebraCommonKernelKernelNDGeoLineND>)g
                withOrgGeogebraCommonKernelKernelNDGeoLineND:(id<OrgGeogebraCommonKernelKernelNDGeoLineND>)h
           withOrgGeogebraCommonKernelKernelNDGeoDirectionND:(id<OrgGeogebraCommonKernelKernelNDGeoDirectionND>)orientation {
  OrgGeogebraCommonKernelAlgosAlgoAngleLinesND_set_g_(self, g);
  OrgGeogebraCommonKernelAlgosAlgoAngleLinesND_set_h_(self, h);
}
...
- (jboolean)getCoordsInD3WithOrgGeogebraCommonKernelMatrixCoordsArray:(IOSObjectArray *)drawCoords {
  ...
  if (OrgGeogebraCommonKernelKernel_isZeroWithDouble_(IOSDoubleArray_Get(nil_chk(n), 2))) {
    ...
    center = [new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_(IOSDoubleArray_Get(n, 0) / IOSDoubleArray_Get(n, 2), IOSDoubleArray_Get(n, 1) / IOSDoubleArray_Get(n, 2), 0, 1) autorelease];
  }
  IOSObjectArray_Set(nil_chk(drawCoords), 0, center);
  IOSObjectArray_Set(drawCoords, 1, [((id<OrgGeogebraCommonKernelKernelNDGeoLineND>) nil_chk(g_)) getDirectionInD3]);
  IOSObjectArray_Set(drawCoords, 2, [((id<OrgGeogebraCommonKernelKernelNDGeoLineND>) nil_chk(h_)) getDirectionInD3]);
  return YES;
}
