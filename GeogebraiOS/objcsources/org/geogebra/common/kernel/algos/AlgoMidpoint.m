...
- (IOSObjectArray *)getPolynomials {
  ...
  if (P != nil && Q != nil) {
    ...
    OrgGeogebraCommonKernelAlgosAlgoMidpoint_setAndConsume_polynomials_(self, [IOSObjectArray newArrayWithLength:3 type:OrgGeogebraCommonKernelProverPolynomialPolynomial_class_()]);
...
- (IOSObjectArray *)getBotanaPolynomialsWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  ...
  OrgGeogebraCommonKernelGeosGeoPoint *P = [self getP];
  OrgGeogebraCommonKernelGeosGeoPoint *Q = [self getQ];
  if (P == nil || Q == nil) @throw [new_OrgGeogebraCommonKernelProverNoSymbolicParametersException_init() autorelease];
  if (botanaVars_ == nil) {
    OrgGeogebraCommonKernelAlgosAlgoMidpoint_setAndConsume_botanaVars_(self, [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonKernelProverPolynomialVariable_class_()]);
  ...
  OrgGeogebraCommonKernelAlgosAlgoMidpoint_set_botanaPolynomials_(self, OrgGeogebraCommonKernelAlgosSymbolicParameters_botanaPolynomialsMidpointWithOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelProverPolynomialVariableArray_(P, Q, botanaVars_));
  return botanaPolynomials_;
}
