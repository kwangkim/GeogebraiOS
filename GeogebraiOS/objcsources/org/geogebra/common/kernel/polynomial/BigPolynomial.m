...
- (OrgGeogebraCommonKernelPolynomialBigPolynomial *)copy__ {
  return [new_OrgGeogebraCommonKernelPolynomialBigPolynomial_initWithOrgGeogebraCommonKernelPolynomialBigPolynomial_(self) autorelease];
}
...
- (OrgGeogebraCommonKernelPolynomialBigPolynomial *)addWithOrgGeogebraCommonKernelPolynomialBigPolynomial:(OrgGeogebraCommonKernelPolynomialBigPolynomial *)p {
  ...
  return [new_OrgGeogebraCommonKernelPolynomialBigPolynomial_initWithOrgGeogebraCommonKernelPolynomialBigPolynomial_withJavaMathBigDecimalArray_(self, coeff) autorelease];
}
...
- (OrgGeogebraCommonKernelPolynomialBigPolynomial *)divideWithOrgGeogebraCommonKernelPolynomialBigPolynomial:(OrgGeogebraCommonKernelPolynomialBigPolynomial *)divisor {
  ...
  if (k < degD) {
    return [new_OrgGeogebraCommonKernelPolynomialBigPolynomial_initWithOrgGeogebraCommonKernelPolynomialBigPolynomial_withJavaMathBigDecimalArray_(self, [IOSObjectArray arrayWithObjects:(id[]){ JavaMathBigDecimal_get_ZERO_() } count:1 type:JavaMathBigDecimal_class_()]) autorelease];
  }
  ...
  return [new_OrgGeogebraCommonKernelPolynomialBigPolynomial_initWithOrgGeogebraCommonKernelPolynomialBigPolynomial_withJavaMathBigDecimalArray_(self, quotient) autorelease];
}
...
- (NSString *)description {
  if (((jint) [((NSString *) nil_chk(representation_)) length]) == 0) {
    ...
    OrgGeogebraCommonKernelPolynomialBigPolynomial_set_representation_(self, [sb description]);
  }
...
- (OrgGeogebraCommonKernelPolynomialBigComplex *)rootPolishingWithOrgGeogebraCommonKernelPolynomialBigComplex:(OrgGeogebraCommonKernelPolynomialBigComplex *)x {
  ...
  for (jint i = 0; i < MAX_ITER; i++) {
    ...
    OrgGeogebraCommonKernelPolynomialBigComplex *px = [new_OrgGeogebraCommonKernelPolynomialBigComplex_initWithJavaMathBigDecimal_(IOSObjectArray_Get(coefficients_, n)) autorelease];
...
- (IOSObjectArray *)getRootsLaguerreWithJavaMathMathContext:(JavaMathMathContext *)mc {
  if (((IOSObjectArray *) nil_chk(coefficients_))->size_ <= 1) {
    return [IOSObjectArray arrayWithLength:0 type:OrgGeogebraCommonKernelPolynomialBigComplex_class_()];
  }
  IOSObjectArray *coeff = [IOSObjectArray arrayWithLength:coefficients_->size_ type:OrgGeogebraCommonKernelPolynomialBigComplex_class_()];
  IOSObjectArray *roots = [IOSObjectArray arrayWithLength:coefficients_->size_ - 1 type:OrgGeogebraCommonKernelPolynomialBigComplex_class_()];
  for (jint i = 0; i < coeff->size_; i++) {
    IOSObjectArray_SetAndConsume(coeff, i, new_OrgGeogebraCommonKernelPolynomialBigComplex_initWithJavaMathBigDecimal_(IOSObjectArray_Get(coefficients_, i)));
  }
  for (jint i = 0; i < roots->size_ - 1; i++) {
    IOSObjectArray_Set(roots, i, [self getRootWithOrgGeogebraCommonKernelPolynomialBigComplexArray:coeff withOrgGeogebraCommonKernelPolynomialBigComplex:OrgGeogebraCommonKernelPolynomialBigComplex_get_ONE_() withJavaMathMathContext:mc]);
    IOSObjectArray *newCoeff = [IOSObjectArray arrayWithLength:coeff->size_ - 1 type:OrgGeogebraCommonKernelPolynomialBigComplex_class_()];
  ...
  IOSObjectArray_Set(roots, roots->size_ - 1, [((OrgGeogebraCommonKernelPolynomialBigComplex *) nil_chk([((OrgGeogebraCommonKernelPolynomialBigComplex *) nil_chk(IOSObjectArray_Get(coeff, 0))) negate])) divideWithOrgGeogebraCommonKernelPolynomialBigComplex:IOSObjectArray_Get(coeff, 1) withJavaMathMathContext:mc]);
  return roots;
}
...
- (OrgGeogebraCommonKernelPolynomialBigComplex *)getRootWithOrgGeogebraCommonKernelPolynomialBigComplexArray:(IOSObjectArray *)coeff
  ...
  for (jint i = 0; i < OrgGeogebraCommonKernelPolynomialBigPolynomial_MAX_ITERATIONS_; i++) {
    ...
    if ([((JavaMathBigDecimal *) nil_chk(abp)) compareToWithId:JavaMathBigDecimal_get_ZERO_()] > 0) {
      dx = [([new_OrgGeogebraCommonKernelPolynomialBigComplex_initWithJavaMathBigDecimal_(JavaMathBigDecimal_valueOfWithLong_(n)) autorelease]) divideWithOrgGeogebraCommonKernelPolynomialBigComplex:gp withJavaMathMathContext:mc];
    }
    else {
...
void OrgGeogebraCommonKernelPolynomialBigPolynomial_init(OrgGeogebraCommonKernelPolynomialBigPolynomial *self) {
  NSObject_init(self);
  OrgGeogebraCommonKernelPolynomialBigPolynomial_set_representation_(self, @"");
  OrgGeogebraCommonKernelPolynomialBigPolynomial_set_mc_(self, JavaMathMathContext_get_UNLIMITED_());
}
...
void OrgGeogebraCommonKernelPolynomialBigPolynomial_initWithOrgGeogebraCommonKernelPolynomialBigPolynomial_(OrgGeogebraCommonKernelPolynomialBigPolynomial *self, OrgGeogebraCommonKernelPolynomialBigPolynomial *p) {
  OrgGeogebraCommonKernelPolynomialBigPolynomial_initWithOrgGeogebraCommonKernelPolynomialBigPolynomial_withJavaMathBigDecimalArray_(self, p, [((OrgGeogebraCommonKernelPolynomialBigPolynomial *) nil_chk(p)) getCoefficients]);
}
...
void OrgGeogebraCommonKernelPolynomialBigPolynomial_initWithOrgGeogebraCommonKernelPolynomialBigPolynomial_withJavaMathBigDecimalArray_(OrgGeogebraCommonKernelPolynomialBigPolynomial *self, OrgGeogebraCommonKernelPolynomialBigPolynomial *p, IOSObjectArray *coeff) {
  OrgGeogebraCommonKernelPolynomialBigPolynomial_init(self);
  OrgGeogebraCommonKernelPolynomialBigPolynomial_set_mc_(self, ((OrgGeogebraCommonKernelPolynomialBigPolynomial *) nil_chk(p))->mc_);
  OrgGeogebraCommonKernelPolynomialBigPolynomial_set_plusEps_(self, p->plusEps_);
  OrgGeogebraCommonKernelPolynomialBigPolynomial_set_minusEps_(self, p->minusEps_);
  OrgGeogebraCommonKernelPolynomialBigPolynomial_set_coefficients_(self, coeff);
}
...
void OrgGeogebraCommonKernelPolynomialBigPolynomial_initWithJavaMathBigDecimalArray_(OrgGeogebraCommonKernelPolynomialBigPolynomial *self, IOSObjectArray *coeff) {
  ...
  OrgGeogebraCommonKernelPolynomialBigPolynomial_set_coefficients_(self, coefficients_clone);
}
...
void OrgGeogebraCommonKernelPolynomialBigPolynomial_initWithJavaMathBigDecimalArray_withJavaMathBigDecimal_withJavaMathMathContext_(OrgGeogebraCommonKernelPolynomialBigPolynomial *self, IOSObjectArray *coeff, JavaMathBigDecimal *eps, JavaMathMathContext *mc) {
  OrgGeogebraCommonKernelPolynomialBigPolynomial_initWithJavaMathBigDecimalArray_(self, coeff);
  OrgGeogebraCommonKernelPolynomialBigPolynomial_set_plusEps_(self, eps);
  OrgGeogebraCommonKernelPolynomialBigPolynomial_set_minusEps_(self, [((JavaMathBigDecimal *) nil_chk(self->plusEps_)) negate]);
  OrgGeogebraCommonKernelPolynomialBigPolynomial_set_mc_(self, mc);
}
...
void OrgGeogebraCommonKernelPolynomialBigPolynomial_initWithDoubleArray_withJavaMathMathContext_(OrgGeogebraCommonKernelPolynomialBigPolynomial *self, IOSDoubleArray *coeff, JavaMathMathContext *mc) {
  OrgGeogebraCommonKernelPolynomialBigPolynomial_init(self);
  OrgGeogebraCommonKernelPolynomialBigPolynomial_setAndConsume_coefficients_(self, [IOSObjectArray newArrayWithLength:((IOSDoubleArray *) nil_chk(coeff))->size_ type:JavaMathBigDecimal_class_()]);
  for (jint i = 0; i < coeff->size_; i++) {
  ...
  OrgGeogebraCommonKernelPolynomialBigPolynomial_set_mc_(self, mc);
  OrgGeogebraCommonKernelPolynomialBigPolynomial_setAndConsume_plusEps_(self, new_JavaMathBigDecimal_initWithJavaMathBigInteger_withInt_(JavaMathBigInteger_get_ONE_(), [((JavaMathMathContext *) nil_chk(mc)) getPrecision] / 2));
  OrgGeogebraCommonKernelPolynomialBigPolynomial_set_minusEps_(self, [self->plusEps_ negate]);
}
...
void OrgGeogebraCommonKernelPolynomialBigPolynomial_initWithDoubleArray_withInt_(OrgGeogebraCommonKernelPolynomialBigPolynomial *self, IOSDoubleArray *coeff, jint precision) {
  OrgGeogebraCommonKernelPolynomialBigPolynomial_initWithDoubleArray_withJavaMathMathContext_(self, coeff, [new_JavaMathMathContext_initWithInt_(precision) autorelease]);
}
...
void OrgGeogebraCommonKernelPolynomialBigPolynomial_initWithDouble_withInt_(OrgGeogebraCommonKernelPolynomialBigPolynomial *self, jdouble constant, jint precision) {
  OrgGeogebraCommonKernelPolynomialBigPolynomial_initWithDoubleArray_withInt_(self, [IOSDoubleArray arrayWithDoubles:(jdouble[]){ constant } count:1], precision);
}
