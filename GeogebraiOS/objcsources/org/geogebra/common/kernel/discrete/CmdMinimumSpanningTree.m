...
- (OrgGeogebraCommonKernelGeosGeoElement *)doCommandWithNSString:(NSString *)a
  ...
  OrgGeogebraCommonKernelDiscreteAlgoMinimumSpanningTree *algo = [new_OrgGeogebraCommonKernelDiscreteAlgoMinimumSpanningTree_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoList_(cons_, a, b) autorelease];
