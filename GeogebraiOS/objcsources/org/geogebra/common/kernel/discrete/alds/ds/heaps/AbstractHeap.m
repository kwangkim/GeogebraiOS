...
- (OrgGeogebraCommonKernelDiscreteAldsSortableObject *)extract {
  ...
  if ([list_ size] - 1 > 0) {
    (void) [list_ setWithInt:0 withId:[list_ removeWithInt:[list_ size] - 1]];
...
- (void)swapWithInt:(jint)pos1
  ...
  (void) [list_ setWithInt:pos1 withId:[list_ getWithInt:pos2]];
  (void) [list_ setWithInt:pos2 withId:object];
}
