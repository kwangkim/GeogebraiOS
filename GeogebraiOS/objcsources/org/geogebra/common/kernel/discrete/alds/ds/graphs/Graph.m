...
- (OrgGeogebraCommonKernelDiscreteAldsDsGraphsGraph *)cloneGraph {
  OrgGeogebraCommonKernelDiscreteAldsDsGraphsGraph *graph = [new_OrgGeogebraCommonKernelDiscreteAldsDsGraphsGraph_initWithOrgGeogebraCommonKernelDiscreteAldsDsGraphsGraph_TypeEnum_(self->type_) autorelease];
  OrgGeogebraCommonKernelDiscreteAldsDsGraphsGraph_setAndConsume_adjacencyList_(graph, [IOSObjectArray newArrayWithLength:((IOSObjectArray *) nil_chk(self->adjacencyList_))->size_ type:IOSClass_arrayType(OrgGeogebraCommonKernelDiscreteAldsDsGraphsVertex_class_(), 1)]);
  for (jint i = 0; i < self->adjacencyList_->size_; i++) {
    IOSObjectArray_Set(graph->adjacencyList_, i, OrgGeogebraCommonKernelDiscreteAldsDsGraphsGraph_cloneVertexListWithOrgGeogebraCommonKernelDiscreteAldsDsGraphsVertexArray_(self, IOSObjectArray_Get(self->adjacencyList_, i)));
  }
...
- (OrgGeogebraCommonKernelDiscreteAldsDsGraphsGraph *)addVertexWithOrgGeogebraCommonKernelDiscreteAldsDsGraphsVertex:(OrgGeogebraCommonKernelDiscreteAldsDsGraphsVertex *)vertex {
  ...
  OrgGeogebraCommonKernelDiscreteAldsDsGraphsGraph_increaseVertices(self);
  IOSObjectArray_SetAndConsume(adjacencyList_, preLength, [IOSObjectArray newArrayWithLength:1 type:OrgGeogebraCommonKernelDiscreteAldsDsGraphsVertex_class_()]);
...
- (OrgGeogebraCommonKernelDiscreteAldsDsGraphsGraph *)addEdgeWithOrgGeogebraCommonKernelDiscreteAldsDsGraphsVertex:(OrgGeogebraCommonKernelDiscreteAldsDsGraphsVertex *)a
  ...
  [self addVertexWithOrgGeogebraCommonKernelDiscreteAldsDsGraphsVertex:a];
  [self addVertexWithOrgGeogebraCommonKernelDiscreteAldsDsGraphsVertex:b];
...
- (IOSObjectArray *)getAllAdjacentVerticesWithOrgGeogebraCommonKernelDiscreteAldsDsGraphsVertex:(OrgGeogebraCommonKernelDiscreteAldsDsGraphsVertex *)vertex {
  if (OrgGeogebraCommonKernelDiscreteAldsDsGraphsGraph_containsVertexWithOrgGeogebraCommonKernelDiscreteAldsDsGraphsVertex_(self, vertex)) {
    ...
    if (((IOSObjectArray *) nil_chk(vertexs))->size_ > 1) {
      IOSObjectArray *adjacent = [IOSObjectArray arrayWithLength:vertexs->size_ - 1 type:OrgGeogebraCommonKernelDiscreteAldsDsGraphsVertex_class_()];
...
void OrgGeogebraCommonKernelDiscreteAldsDsGraphsGraph_initWithOrgGeogebraCommonKernelDiscreteAldsDsGraphsGraph_TypeEnum_(OrgGeogebraCommonKernelDiscreteAldsDsGraphsGraph *self, OrgGeogebraCommonKernelDiscreteAldsDsGraphsGraph_TypeEnum *type) {
  NSObject_init(self);
  OrgGeogebraCommonKernelDiscreteAldsDsGraphsGraph_setAndConsume_adjacencyList_(self, [IOSObjectArray newArrayWithLength:0 type:IOSClass_arrayType(OrgGeogebraCommonKernelDiscreteAldsDsGraphsVertex_class_(), 1)]);
  OrgGeogebraCommonKernelDiscreteAldsDsGraphsGraph_set_type_(self, type);
}
...
IOSObjectArray *OrgGeogebraCommonKernelDiscreteAldsDsGraphsGraph_cloneVertexListWithOrgGeogebraCommonKernelDiscreteAldsDsGraphsVertexArray_(OrgGeogebraCommonKernelDiscreteAldsDsGraphsGraph *self, IOSObjectArray *vertices) {
  IOSObjectArray *newVertices = [IOSObjectArray arrayWithLength:((IOSObjectArray *) nil_chk(vertices))->size_ type:OrgGeogebraCommonKernelDiscreteAldsDsGraphsVertex_class_()];
...
IOSObjectArray *OrgGeogebraCommonKernelDiscreteAldsDsGraphsGraph_deleteVertexFromAdjacentVerticiesWithOrgGeogebraCommonKernelDiscreteAldsDsGraphsVertexArray_withOrgGeogebraCommonKernelDiscreteAldsDsGraphsVertex_(OrgGeogebraCommonKernelDiscreteAldsDsGraphsGraph *self, IOSObjectArray *vertexs, OrgGeogebraCommonKernelDiscreteAldsDsGraphsVertex *b) {
  IOSObjectArray *vertexs2 = [IOSObjectArray arrayWithLength:((IOSObjectArray *) nil_chk(vertexs))->size_ - 1 type:OrgGeogebraCommonKernelDiscreteAldsDsGraphsVertex_class_()];
  jint j = 0;
...
IOSObjectArray *OrgGeogebraCommonKernelDiscreteAldsDsGraphsGraph_increaseSizeWithOrgGeogebraCommonKernelDiscreteAldsDsGraphsVertexArray_(OrgGeogebraCommonKernelDiscreteAldsDsGraphsGraph *self, IOSObjectArray *vertexs) {
  IOSObjectArray *newVertexs = [IOSObjectArray arrayWithLength:((IOSObjectArray *) nil_chk(vertexs))->size_ + 1 type:OrgGeogebraCommonKernelDiscreteAldsDsGraphsVertex_class_()];
  for (jint i = 0; i < vertexs->size_; i++) {
...
IOSObjectArray *OrgGeogebraCommonKernelDiscreteAldsDsGraphsGraph_increaseVertices(OrgGeogebraCommonKernelDiscreteAldsDsGraphsGraph *self) {
  IOSObjectArray *newAdjacencyList = [IOSObjectArray arrayWithLength:((IOSObjectArray *) nil_chk(self->adjacencyList_))->size_ + 1 type:IOSClass_arrayType(OrgGeogebraCommonKernelDiscreteAldsDsGraphsVertex_class_(), 1)];
  for (jint i = 0; i < self->adjacencyList_->size_; i++) {
    IOSObjectArray_Set(newAdjacencyList, i, IOSObjectArray_Get(self->adjacencyList_, i));
  }
  OrgGeogebraCommonKernelDiscreteAldsDsGraphsGraph_set_adjacencyList_(self, newAdjacencyList);
...
void OrgGeogebraCommonKernelDiscreteAldsDsGraphsGraph_buildAdjacencyMatrix(OrgGeogebraCommonKernelDiscreteAldsDsGraphsGraph *self) {
  ...
  OrgGeogebraCommonKernelDiscreteAldsDsGraphsGraph_set_adjacencyMatrix_(self, matrix);
}
