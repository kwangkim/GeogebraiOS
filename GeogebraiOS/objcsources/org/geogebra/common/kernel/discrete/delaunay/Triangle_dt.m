...
- (OrgGeogebraCommonKernelDiscreteDelaunayBoundingBox *)getBoundingBox {
  ...
  upperRight = [new_OrgGeogebraCommonKernelDiscreteDelaunayPoint_dt_initWithDouble_withDouble_(JavaLangMath_maxWithDouble_withDouble_([a_ x], JavaLangMath_maxWithDouble_withDouble_([b_ x], [c_ x])), JavaLangMath_maxWithDouble_withDouble_([a_ y], JavaLangMath_maxWithDouble_withDouble_([b_ y], [c_ y]))) autorelease];
  return [new_OrgGeogebraCommonKernelDiscreteDelaunayBoundingBox_initWithOrgGeogebraCommonKernelDiscreteDelaunayPoint_dt_withOrgGeogebraCommonKernelDiscreteDelaunayPoint_dt_(lowerLeft, upperRight) autorelease];
}
...
- (void)switchneighborsWithOrgGeogebraCommonKernelDiscreteDelaunayTriangle_dt:(OrgGeogebraCommonKernelDiscreteDelaunayTriangle_dt *)Old
  ...
  if (abnext_ == Old) OrgGeogebraCommonKernelDiscreteDelaunayTriangle_dt_set_abnext_(self, New);
  else if (bcnext_ == Old) OrgGeogebraCommonKernelDiscreteDelaunayTriangle_dt_set_bcnext_(self, New);
  else if (canext_ == Old) OrgGeogebraCommonKernelDiscreteDelaunayTriangle_dt_set_canext_(self, New);
...
- (OrgGeogebraCommonKernelDiscreteDelaunayCircle_dt *)circumcircle {
  ...
  if (den == 0) OrgGeogebraCommonKernelDiscreteDelaunayTriangle_dt_setAndConsume_circum_(self, new_OrgGeogebraCommonKernelDiscreteDelaunayCircle_dt_initWithOrgGeogebraCommonKernelDiscreteDelaunayPoint_dt_withDouble_(a_, JavaLangDouble_POSITIVE_INFINITY));
  else {
    OrgGeogebraCommonKernelDiscreteDelaunayPoint_dt *cen = [new_OrgGeogebraCommonKernelDiscreteDelaunayPoint_dt_initWithDouble_withDouble_((u * (b_->y__ - c_->y__) - v * (a_->y__ - b_->y__)) / den, (v * (a_->x__ - b_->x__) - u * (b_->x__ - c_->x__)) / den) autorelease];
    OrgGeogebraCommonKernelDiscreteDelaunayTriangle_dt_setAndConsume_circum_(self, new_OrgGeogebraCommonKernelDiscreteDelaunayCircle_dt_initWithOrgGeogebraCommonKernelDiscreteDelaunayPoint_dt_withDouble_(cen, [cen distance2WithOrgGeogebraCommonKernelDiscreteDelaunayPoint_dt:a_]));
  }
  return circum_;
}
...
- (jdouble)zWithDouble:(jdouble)x
  ...
  return [self z_valueWithOrgGeogebraCommonKernelDiscreteDelaunayPoint_dt:[new_OrgGeogebraCommonKernelDiscreteDelaunayPoint_dt_initWithDouble_withDouble_(x, y) autorelease]];
}
...
- (OrgGeogebraCommonKernelDiscreteDelaunayPoint_dt *)zWithOrgGeogebraCommonKernelDiscreteDelaunayPoint_dt:(OrgGeogebraCommonKernelDiscreteDelaunayPoint_dt *)q {
  ...
  return [new_OrgGeogebraCommonKernelDiscreteDelaunayPoint_dt_initWithDouble_withDouble_withDouble_(((OrgGeogebraCommonKernelDiscreteDelaunayPoint_dt *) nil_chk(q))->x__, q->y__, z) autorelease];
}
...
void OrgGeogebraCommonKernelDiscreteDelaunayTriangle_dt_initWithOrgGeogebraCommonKernelDiscreteDelaunayPoint_dt_withOrgGeogebraCommonKernelDiscreteDelaunayPoint_dt_withOrgGeogebraCommonKernelDiscreteDelaunayPoint_dt_(OrgGeogebraCommonKernelDiscreteDelaunayTriangle_dt *self, OrgGeogebraCommonKernelDiscreteDelaunayPoint_dt *A, OrgGeogebraCommonKernelDiscreteDelaunayPoint_dt *B, OrgGeogebraCommonKernelDiscreteDelaunayPoint_dt *C) {
  ...
  self->halfplane_ = NO;
  self->_mark_ = NO;
  OrgGeogebraCommonKernelDiscreteDelaunayTriangle_dt_set_a_(self, A);
  ...
  if ((res <= OrgGeogebraCommonKernelDiscreteDelaunayPoint_dt_LEFT) || (res == OrgGeogebraCommonKernelDiscreteDelaunayPoint_dt_INFRONTOFA) || (res == OrgGeogebraCommonKernelDiscreteDelaunayPoint_dt_BEHINDB)) {
    OrgGeogebraCommonKernelDiscreteDelaunayTriangle_dt_set_b_(self, B);
    OrgGeogebraCommonKernelDiscreteDelaunayTriangle_dt_set_c_(self, C);
  }
  else {
    ...
    OrgGeogebraCommonKernelDiscreteDelaunayTriangle_dt_set_b_(self, C);
    OrgGeogebraCommonKernelDiscreteDelaunayTriangle_dt_set_c_(self, B);
  }
  [self circumcircle];
}
