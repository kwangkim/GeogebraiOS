...
- (void)setInputOutput {
  OrgGeogebraCommonKernelAlgosAlgoElement_setAndConsume_input_(self, [IOSObjectArray newArrayWithLength:percentage_ == nil ? 1 : 2 type:OrgGeogebraCommonKernelGeosGeoElement_class_()]);
...
- (void)compute {
  ...
  if (vl_ == nil) OrgGeogebraCommonKernelDiscreteAlgoHull_setAndConsume_vl_(self, new_JavaUtilArrayList_init());
  else [vl_ clear];
  IOSDoubleArray *inhom = [IOSDoubleArray arrayWithLength:2];
  OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationTriangulationTriangulationRepresentation_CalcCutOff *calccutoff = [new_OrgGeogebraCommonKernelDiscreteAlgoHull_$1_initWithOrgGeogebraCommonKernelDiscreteAlgoHull_(self) autorelease];
  ...
  OrgGeogebraCommonKernelDiscreteAlgoHull_TestRepresentationWrapper *representationwrapper = [new_OrgGeogebraCommonKernelDiscreteAlgoHull_TestRepresentationWrapper_initWithOrgGeogebraCommonKernelDiscreteAlgoHull_(self) autorelease];
  OrgGeogebraCommonKernelDiscreteAlgoHull_TestRepresentationWrapper_set_innerrepresentation_(representationwrapper, representation);
  ...
  for (jint i = 0; i < [((JavaUtilArrayList *) nil_chk(edge)) size]; i++) {
    ...
    [((JavaUtilArrayList *) nil_chk(al_)) addWithId:[new_OrgGeogebraCommonKernelMyPoint_initWithDouble_withDouble_withBoolean_(((OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiVPoint *) nil_chk(p))->x_, p->y_, i != 0) autorelease]];
  }
...
void OrgGeogebraCommonKernelDiscreteAlgoHull_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelGeosGeoNumeric_(OrgGeogebraCommonKernelDiscreteAlgoHull *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelGeosGeoList *inputList, OrgGeogebraCommonKernelGeosGeoNumeric *percentage) {
  ...
  OrgGeogebraCommonKernelDiscreteAlgoHull_set_inputList_(self, inputList);
  OrgGeogebraCommonKernelDiscreteAlgoHull_set_percentage_(self, percentage);
  OrgGeogebraCommonKernelDiscreteAlgoHull_setAndConsume_locus_(self, new_OrgGeogebraCommonKernelGeosGeoLocus_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  [self compute];
...
- (void)circleEventWithOrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiStatusstructureVLinkedNode:(OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiStatusstructureVLinkedNode *)n1
  ...
  [((JavaUtilArrayList *) nil_chk(circleevents_)) addWithId:[new_OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiVPoint_initWithDouble_withDouble_(circle_x, circle_y) autorelease]];
  if (innerrepresentation_ != nil) {
...
void OrgGeogebraCommonKernelDiscreteAlgoHull_TestRepresentationWrapper_initWithOrgGeogebraCommonKernelDiscreteAlgoHull_(OrgGeogebraCommonKernelDiscreteAlgoHull_TestRepresentationWrapper *self, OrgGeogebraCommonKernelDiscreteAlgoHull *outer$) {
  NSObject_init(self);
  OrgGeogebraCommonKernelDiscreteAlgoHull_TestRepresentationWrapper_setAndConsume_circleevents_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonKernelDiscreteAlgoHull_TestRepresentationWrapper_set_innerrepresentation_(self, nil);
}
...
void OrgGeogebraCommonKernelDiscreteAlgoHull_$1_initWithOrgGeogebraCommonKernelDiscreteAlgoHull_(OrgGeogebraCommonKernelDiscreteAlgoHull_$1 *self, OrgGeogebraCommonKernelDiscreteAlgoHull *outer$) {
  OrgGeogebraCommonKernelDiscreteAlgoHull_$1_set_this$0_(self, outer$);
