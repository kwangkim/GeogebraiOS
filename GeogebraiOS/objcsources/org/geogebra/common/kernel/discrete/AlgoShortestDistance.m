...
- (void)setInputOutput {
  ...
  IOSObjectArray_Set(input_, 1, [((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(start_)) toGeoElement]);
  IOSObjectArray_Set(input_, 2, [((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(end_)) toGeoElement]);
...
void OrgGeogebraCommonKernelDiscreteAlgoShortestDistance_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelGeosGeoBoolean_(OrgGeogebraCommonKernelDiscreteAlgoShortestDistance *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelGeosGeoList *inputList, id<OrgGeogebraCommonKernelKernelNDGeoPointND> start, id<OrgGeogebraCommonKernelKernelNDGeoPointND> end, OrgGeogebraCommonKernelGeosGeoBoolean *weighted) {
  ...
  self->edgeCount_ = 0;
  OrgGeogebraCommonKernelDiscreteAlgoShortestDistance_set_inputList_(self, inputList);
  OrgGeogebraCommonKernelDiscreteAlgoShortestDistance_set_start_(self, start);
  OrgGeogebraCommonKernelDiscreteAlgoShortestDistance_set_end_(self, end);
  OrgGeogebraCommonKernelDiscreteAlgoShortestDistance_set_weighted_(self, weighted);
  OrgGeogebraCommonKernelDiscreteAlgoShortestDistance_setAndConsume_locus_(self, new_OrgGeogebraCommonKernelGeosGeoLocus_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  OrgGeogebraCommonKernelDiscreteAlgoShortestDistance_compute(self);
...
void OrgGeogebraCommonKernelDiscreteAlgoShortestDistance_compute(OrgGeogebraCommonKernelDiscreteAlgoShortestDistance *self) {
  ...
  for (jint i = 0; i < size; i++) {
    ...
    if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(geo)) isDefined] && [geo isGeoSegment]) {
      ...
      if (node1 == nil) {
        node1 = [new_OrgGeogebraCommonKernelDiscreteMyNode_initWithOrgGeogebraCommonKernelKernelNDGeoPointND_(p1) autorelease];
        [nodes putWithId:p1 withId:node1];
      }
      if (node2 == nil) {
        node2 = [new_OrgGeogebraCommonKernelDiscreteMyNode_initWithOrgGeogebraCommonKernelKernelNDGeoPointND_(p2) autorelease];
  ...
  if (self->al_ == nil) OrgGeogebraCommonKernelDiscreteAlgoShortestDistance_setAndConsume_al_(self, new_JavaUtilArrayList_init());
  else [self->al_ clear];
  ...
  if ([((OrgGeogebraCommonKernelGeosGeoBoolean *) nil_chk(self->weighted_)) getBoolean] == YES) {
    id<OrgApacheCommonsCollections15Transformer> wtTransformer = [new_OrgGeogebraCommonKernelDiscreteAlgoShortestDistance_$1_init() autorelease];
  ...
  OrgGeogebraCommonKernelMyPoint *pt = [new_OrgGeogebraCommonKernelMyPoint_initWithDouble_withDouble_withBoolean_(IOSDoubleArray_Get(inhomLast, 0), IOSDoubleArray_Get(inhomLast, 1), NO) autorelease];
  ...
  for (jint i = 0; i < [list size]; i++) {
    ...
    if (IOSDoubleArray_Get(inhom1, 1) == IOSDoubleArray_Get(inhomLast, 1) && IOSDoubleArray_Get(inhom1, 0) == IOSDoubleArray_Get(inhomLast, 0)) {
      pt = [new_OrgGeogebraCommonKernelMyPoint_initWithDouble_withDouble_withBoolean_(IOSDoubleArray_Get(inhom2, 0), IOSDoubleArray_Get(inhom2, 1), YES) autorelease];
      ...
      *IOSDoubleArray_GetRef(inhomLast, 1) = IOSDoubleArray_Get(inhom2, 1);
      ...
      pt = [new_OrgGeogebraCommonKernelMyPoint_initWithDouble_withDouble_withBoolean_(IOSDoubleArray_Get(inhom1, 0), IOSDoubleArray_Get(inhom1, 1), YES) autorelease];
...
void OrgGeogebraCommonKernelDiscreteAlgoShortestDistance_MyLink_initWithOrgGeogebraCommonKernelDiscreteAlgoShortestDistance_withDouble_withDouble_withOrgGeogebraCommonKernelDiscreteMyNode_withOrgGeogebraCommonKernelDiscreteMyNode_(OrgGeogebraCommonKernelDiscreteAlgoShortestDistance_MyLink *self, OrgGeogebraCommonKernelDiscreteAlgoShortestDistance *outer$, jdouble weight, jdouble capacity, OrgGeogebraCommonKernelDiscreteMyNode *n1, OrgGeogebraCommonKernelDiscreteMyNode *n2) {
  ...
  OrgGeogebraCommonKernelDiscreteAlgoShortestDistance_MyLink_set_n1_(self, n1);
  OrgGeogebraCommonKernelDiscreteAlgoShortestDistance_MyLink_set_n2_(self, n2);
}
