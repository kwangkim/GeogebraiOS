...
- (void)setPolygonWithOrgGeogebraCommonKernelGeosGeoPolygon:(OrgGeogebraCommonKernelGeosGeoPolygon *)p {
  OrgGeogebraCommonKernelDiscretePolygonTriangulation_set_polygon_(self, p);
}
...
- (void)clear {
  ...
  maxPointIndex_ = 0;
  OrgGeogebraCommonKernelDiscretePolygonTriangulation_set_firstPoint_(self, nil);
  OrgGeogebraCommonKernelDiscretePolygonTriangulation_set_comparedSameOrientationSegment_(self, nil);
}
...
- (jint)updatePoints {
  ...
  OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point *point = [new_OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_initWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_withDouble_withDouble_withInt_(self, [polygon_ getPointXWithInt:0], [polygon_ getPointYWithInt:0], 0) autorelease];
  ...
  OrgGeogebraCommonKernelDiscretePolygonTriangulation_set_firstPoint_(self, point);
  ...
  if (OrgGeogebraCommonKernelKernel_isEqualWithDouble_withDouble_withDouble_(point->x_, firstPoint_->x_, OrgGeogebraCommonKernelDiscretePolygonTriangulation_POINT_DELTA) && OrgGeogebraCommonKernelKernel_isEqualWithDouble_withDouble_withDouble_(point->y_, firstPoint_->y_, OrgGeogebraCommonKernelDiscretePolygonTriangulation_POINT_DELTA)) {
    OrgGeogebraCommonKernelDiscretePolygonTriangulation_set_firstPoint_(self, firstPoint_->next_);
    n--;
  }
  if (n < 3) {
    return n;
  }
  OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_set_next_(point, firstPoint_);
  OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_set_prev_(nil_chk(firstPoint_), point);
  ...
  for (jint i = 0; i < n && removedPoints < n - 1; i++) {
    ...
    if (OrgGeogebraCommonKernelKernel_isZeroWithDouble_withDouble_(delta, OrgGeogebraCommonKernelDiscretePolygonTriangulation_ORIENTATION_DELTA)) {
      OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_set_next_(prevPoint, nextPoint);
      OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_set_prev_(nextPoint, prevPoint);
      removedPoints++;
      point = nextPoint;
    }
      ...
      if (OrgGeogebraCommonKernelKernel_isEqualWithDouble_withDouble_withDouble_(nextPoint->x_, prevPoint->x_, OrgGeogebraCommonKernelDiscretePolygonTriangulation_POINT_DELTA) && OrgGeogebraCommonKernelKernel_isEqualWithDouble_withDouble_withDouble_(nextPoint->y_, prevPoint->y_, OrgGeogebraCommonKernelDiscretePolygonTriangulation_POINT_DELTA)) {
        ...
        OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_set_next_(point, nextPoint->next_);
        OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_set_prev_(nil_chk(nextPoint->next_), point);
        removedPoints += 2;
      }
...
- (void)cutAfterComparisonToRightWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment:(OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment *)segment2 {
  if (comparedSameOrientationSegment_ != nil) {
    ...
    if (((OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment *) nil_chk(segment2))->rightPoint_ == segment2->leftPoint_) {
      @throw [new_OrgGeogebraCommonKernelDiscretePolygonTriangulation_TriangulationException_initWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_TriangulationException_TypeEnum_(OrgGeogebraCommonKernelDiscretePolygonTriangulation_TriangulationException_TypeEnum_get_ZERO_SEGMENT()) autorelease];
    }
    if (comparedSameOrientationValue_ < 0) {
      ...
      OrgGeogebraCommonKernelDiscretePolygonTriangulation_set_comparedSameOrientationSegment_(self, nil);
      [s removeFromPoints];
      OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_leftPoint_(s, segment2->rightPoint_);
      segment2->usable_++;
      ...
      OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_leftPoint_(segment2, s->rightPoint_);
      s->usable_++;
      [s addToPoints];
      OrgGeogebraCommonKernelDiscretePolygonTriangulation_set_comparedSameOrientationSegment_(self, nil);
      [segment2 addToPoints];
...
- (void)cutAfterComparisonToLeftWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment:(OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment *)segment2 {
  if (comparedSameOrientationSegment_ != nil) {
    ...
    if (comparedSameOrientationValue_ > 0) {
      ...
      OrgGeogebraCommonKernelDiscretePolygonTriangulation_set_comparedSameOrientationSegment_(self, nil);
      [s removeFromPoints];
      OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_rightPoint_(s, segment2->leftPoint_);
      segment2->usable_++;
      [segment2 addToPoints];
      OrgGeogebraCommonKernelDiscretePolygonTriangulation_set_comparedSameOrientationSegment_(self, nil);
      [s addToPoints];
      ...
      OrgGeogebraCommonKernelDiscretePolygonTriangulation_set_comparedSameOrientationSegment_(self, nil);
      [segment2 removeFromPoints];
      OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_rightPoint_(segment2, s->leftPoint_);
      s->usable_++;
      [s addToPoints];
      OrgGeogebraCommonKernelDiscretePolygonTriangulation_set_comparedSameOrientationSegment_(self, nil);
      [segment2 addToPoints];
...
- (void)setIntersections {
  ...
  OrgGeogebraCommonKernelDiscretePolygonTriangulation_MyTreeSet *pointSet = [new_OrgGeogebraCommonKernelDiscretePolygonTriangulation_MyTreeSet_initWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_(self) autorelease];
  for (point = firstPoint_; ((OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point *) nil_chk(point))->next_ != firstPoint_; point = point->next_) {
  ...
  [pointSet addWithId:point];
  if ([pointSet size] > 3) {
    OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment *top = [new_OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_initWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_(self) autorelease];
    OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment *bottom = [new_OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_initWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_(self) autorelease];
    OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_above_(bottom, top);
    OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_below_(top, bottom);
    for (OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point *pt = [pointSet first]; pt != [pointSet last]; pt = [pointSet higherWithId:pt]) {
      ...
      if (pt->toLeft_ != nil && ![pt->toLeft_ isEmpty]) {
        ...
        OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_above_(below, above);
        OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_below_(above, below);
        ...
        for (OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment *segment = bottom->above_; segment != top && go; segment = segment->above_) {
          ...
          if (OrgGeogebraCommonKernelKernel_isEqualWithDouble_withDouble_withDouble_(orientation, segment->orientation_, OrgGeogebraCommonKernelDiscretePolygonTriangulation_ORIENTATION_DELTA)) {
            ...
            OrgGeogebraCommonKernelDiscretePolygonTriangulation_cutWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_withOrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_(self, segment, pt);
      ...
      if (pt->toRight_ != nil) {
        ...
        for (OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment * __strong seg in pt->toRight_) {
          OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_above_(nil_chk(below), seg);
          OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_below_(nil_chk(seg), below);
          below = seg;
        }
        OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_above_(nil_chk(below), above);
        OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_below_(nil_chk(above), below);
...
- (void)triangulateWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment:(OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment *)firstBelow
  ...
  [stack pushWithId:((OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment *) nil_chk(firstAbove))->leftPoint_];
  ...
  while (firstAbove != nil && firstBelow != nil) {
    ...
    if (viChain != chain) {
      ...
      currentTriangleFan = [new_OrgGeogebraCommonKernelDiscretePolygonTriangulation_TriangleFan_initWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_withInt_withBoolean_(self, ((OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point *) nil_chk(vi))->id__, clockWise) autorelease];
...
- (IOSObjectArray *)getCompleteVerticesWithOrgGeogebraCommonKernelMatrixCoordsArray:(IOSObjectArray *)vertices
  ...
  if (((IOSObjectArray *) nil_chk(completeVertices_))->size_ < maxPointIndex_) {
    OrgGeogebraCommonKernelDiscretePolygonTriangulation_setAndConsume_completeVertices_(self, [IOSObjectArray newArrayWithLength:maxPointIndex_ type:OrgGeogebraCommonKernelMatrixCoords_class_()]);
  }
  ...
  for (jint i = length; i < maxPointIndex_; i++) {
    ...
    if (point != nil) {
      IOSObjectArray_Set(completeVertices_, i, [((OrgGeogebraCommonKernelMatrixCoordSys *) nil_chk(cs)) getPointWithDouble:point->x_ withDouble:point->y_]);
    }
  }
...
- (void)setCornersWithOrgGeogebraCommonKernelMatrixCoordsArray:(IOSObjectArray *)corners {
  OrgGeogebraCommonKernelDiscretePolygonTriangulation_set_corners_(self, corners);
}
...
void OrgGeogebraCommonKernelDiscretePolygonTriangulation_init(OrgGeogebraCommonKernelDiscretePolygonTriangulation *self) {
  NSObject_init(self);
  OrgGeogebraCommonKernelDiscretePolygonTriangulation_set_nextNewPointForNonSelfIntersectingPolygon_(self, nil);
  OrgGeogebraCommonKernelDiscretePolygonTriangulation_setAndConsume_nonSelfIntersectingPolygonPointComparator_(self, new_OrgGeogebraCommonKernelDiscretePolygonTriangulation_$1_initWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_(self));
  OrgGeogebraCommonKernelDiscretePolygonTriangulation_setAndConsume_completeVertices_(self, [IOSObjectArray newArrayWithLength:0 type:OrgGeogebraCommonKernelMatrixCoords_class_()]);
  OrgGeogebraCommonKernelDiscretePolygonTriangulation_set_corners_(self, nil);
  OrgGeogebraCommonKernelDiscretePolygonTriangulation_setAndConsume_polygonPointsList_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonKernelDiscretePolygonTriangulation_setAndConsume_fansList_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonKernelDiscretePolygonTriangulation_setAndConsume_pointsArray_(self, [IOSObjectArray newArrayWithLength:0 type:OrgGeogebraCommonAwtGPoint2D_Double_class_()]);
}
...
OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point *OrgGeogebraCommonKernelDiscretePolygonTriangulation_addPointToChainWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_withDouble_withDouble_withNSString_withInt_(OrgGeogebraCommonKernelDiscretePolygonTriangulation *self, OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point *point, jdouble x, jdouble y, NSString *name, jint nameId) {
  if (!OrgGeogebraCommonKernelKernel_isEqualWithDouble_withDouble_withDouble_(((OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point *) nil_chk(point))->x_, x, OrgGeogebraCommonKernelDiscretePolygonTriangulation_POINT_DELTA) || !OrgGeogebraCommonKernelKernel_isEqualWithDouble_withDouble_withDouble_(point->y_, y, OrgGeogebraCommonKernelDiscretePolygonTriangulation_POINT_DELTA)) {
    OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_setAndConsume_next_(point, new_OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_initWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_withDouble_withDouble_withInt_(self, x, y, point->id__ + 1));
    ...
    OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_set_prev_(point->next_, point);
    return point->next_;
  }
  return point;
}
...
OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment *OrgGeogebraCommonKernelDiscretePolygonTriangulation_cutWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_withOrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_(OrgGeogebraCommonKernelDiscretePolygonTriangulation *self, OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment *segment, OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point *pt) {
  ...
  OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_rightPoint_(segment, pt);
  [segment addToPoints];
  OrgGeogebraCommonKernelDiscretePolygonTriangulation_set_comparedSameOrientationSegment_(self, nil);
  [segment2 addToPoints];
...
void OrgGeogebraCommonKernelDiscretePolygonTriangulation_setNonSelfIntersectingWithJavaUtilTreeSet_(OrgGeogebraCommonKernelDiscretePolygonTriangulation *self, JavaUtilTreeSet *pointSet) {
  if (((IOSObjectArray *) nil_chk(self->pointsArray_))->size_ < self->maxPointIndex_) {
    OrgGeogebraCommonKernelDiscretePolygonTriangulation_setAndConsume_pointsArray_(self, [IOSObjectArray newArrayWithLength:self->maxPointIndex_ type:OrgGeogebraCommonAwtGPoint2D_Double_class_()]);
  }
  ...
  while (![((JavaUtilTreeSet *) nil_chk(pointSet)) isEmpty]) {
    OrgGeogebraCommonKernelDiscretePolygonTriangulation_PolygonPoints *polygonPoints = [new_OrgGeogebraCommonKernelDiscretePolygonTriangulation_PolygonPoints_initWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_withJavaUtilComparator_(self, self->nonSelfIntersectingPolygonPointComparator_) autorelease];
    ...
    if (segStart->usable_ == 0) {
      ...
      if ([start hasNoSegment]) {
        ...
        IOSObjectArray_SetAndConsume(self->pointsArray_, start->id__, new_OrgGeogebraCommonAwtGPoint2D_Double_initWithDouble_withDouble_(start->x_, start->y_));
      }
      ...
      while (running != OrgGeogebraCommonKernelDiscretePolygonTriangulation_RunningEnum_get_STOP()) {
        OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_running_(segment, running);
        ...
        }
        {
          ...
          switch (segment->usable_) {
            ...
            break;
            case 0:
            @throw [new_OrgGeogebraCommonKernelDiscretePolygonTriangulation_TriangulationException_initWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_TriangulationException_TypeEnum_(OrgGeogebraCommonKernelDiscretePolygonTriangulation_TriangulationException_TypeEnum_get_DEAD_END()) autorelease];
            default:
            segment->usable_--;
            clone = [segment clone];
            OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_running_(nil_chk(clone), segment->running_);
            segment = clone;
            break;
          }
        }
        ...
        if (segment->running_ == OrgGeogebraCommonKernelDiscretePolygonTriangulation_RunningEnum_get_RIGHT()) {
          OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_leftPoint_(segment, currentPointNew);
          OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_rightPoint_(segment, nextPointNew);
        }
        else {
          OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_leftPoint_(segment, nextPointNew);
          OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_rightPoint_(segment, currentPointNew);
        }
        ...
        OrgGeogebraCommonKernelDiscretePolygonTriangulation_set_nextNewPointForNonSelfIntersectingPolygon_(self, nextPointNew);
        ...
        if ([currentPoint hasNoSegment]) {
          ...
          IOSObjectArray_SetAndConsume(self->pointsArray_, currentPoint->id__, new_OrgGeogebraCommonAwtGPoint2D_Double_initWithDouble_withDouble_(currentPoint->x_, currentPoint->y_));
        }
        else {
        }
        segment = next;
...
void OrgGeogebraCommonKernelDiscretePolygonTriangulation_checkIntersectionWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_withOrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_withJavaUtilTreeSet_(OrgGeogebraCommonKernelDiscretePolygonTriangulation *self, OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment *a, OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment *b, JavaUtilTreeSet *pointSet) {
  ...
  if (!OrgGeogebraCommonKernelKernel_isZeroWithDouble_withDouble_(z, OrgGeogebraCommonKernelDiscretePolygonTriangulation_POINT_DELTA)) {
    ...
    if ((al = OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_compareToWithDouble_withDouble_(nil_chk(a->leftPoint_), x1, y1)) > 0 || (ar = OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_compareToWithDouble_withDouble_(nil_chk(a->rightPoint_), x1, y1)) < 0 || (bl = OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_compareToWithDouble_withDouble_(b->leftPoint_, x1, y1)) > 0 || (br = OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_compareToWithDouble_withDouble_(b->rightPoint_, x1, y1)) < 0) {
      ...
      @throw [new_OrgGeogebraCommonKernelDiscretePolygonTriangulation_TriangulationException_initWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_TriangulationException_TypeEnum_(OrgGeogebraCommonKernelDiscretePolygonTriangulation_TriangulationException_TypeEnum_get_LEFT_POINT_INTERSECTION()) autorelease];
    }
    else if (ar == 0) {
      ...
      OrgGeogebraCommonKernelDiscretePolygonTriangulation_cutWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_withOrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_(self, b, pt);
    }
    else if (bl == 0) {
      ...
      OrgGeogebraCommonKernelDiscretePolygonTriangulation_cutWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_withOrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_(self, a, pt);
    }
    else {
      OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point *pt = [new_OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_initWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_withDouble_withDouble_withInt_(self, x / z, y / z, self->maxPointIndex_) autorelease];
      OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_set_name_(pt, JavaLangInteger_toStringWithInt_(pt->id__));
      self->maxPointIndex_++;
      ...
      OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_rightPoint_(a, pt);
      OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_rightPoint_(b, pt);
      [a addToPoints];
      [b addToPoints];
...
void OrgGeogebraCommonKernelDiscretePolygonTriangulation_createSegmentWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_(OrgGeogebraCommonKernelDiscretePolygonTriangulation *self, OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point *point) {
  ...
  if (OrgGeogebraCommonKernelKernel_isGreaterWithDouble_withDouble_(((OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point *) nil_chk(point))->orientationToNext_, -JavaLangMath_PI / 2) && OrgGeogebraCommonKernelKernel_isGreaterEqualWithDouble_withDouble_(JavaLangMath_PI / 2, point->orientationToNext_)) {
    ...
    segment = [new_OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_initWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_withDouble_withOrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_withOrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_(self, OrgGeogebraCommonKernelDiscretePolygonTriangulation_getReverseOrientationWithDouble_(point->orientationToNext_), point->next_, point) autorelease];
  }
      ...
      if (((OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point *) nil_chk(pt))->toLeft_ != nil && ![pt->toLeft_ isEmpty]) {
        ...
        if (pt->needsDiagonal_) {
          if (((OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment *) nil_chk(below))->usable_ > 1) {
            ...
            OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_rightPoint_(below, pt);
            [below addToPoints];
            below = below->below_;
            OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_above_(below, above);
            OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_below_(nil_chk(above), below);
            ...
            OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_rightPoint_(above, pt);
            [above addToPoints];
            above = above->above_;
            OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_above_(below, above);
            OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_below_(above, below);
            ...
            OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment *diagonal = [new_OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_initWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_withDouble_withOrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_withOrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_(self, JavaLangMath_atan2WithDouble_withDouble_(pt->y_ - ((OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point *) nil_chk(pt2))->y_, pt->x_ - pt2->x_), pt2, pt) autorelease];
            [diagonal addToPoints];
            diagonal->usable_++;
          }
        }
    ...
    while (running != OrgGeogebraCommonKernelDiscretePolygonTriangulation_RunningEnum_get_STOP()) {
      ...
      if (oldRunning == OrgGeogebraCommonKernelDiscretePolygonTriangulation_RunningEnum_get_LEFT()) {
        ...
        if (running == OrgGeogebraCommonKernelDiscretePolygonTriangulation_RunningEnum_get_LEFT()) {
          OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_next_(nil_chk(next), segment);
        }
      }
      else {
        if (segment->usable_ > 1) {
        ...
        if (running == OrgGeogebraCommonKernelDiscretePolygonTriangulation_RunningEnum_get_RIGHT()) {
          OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_next_(segment, next);
        }
      }
      if ([currentPoint hasNoSegment]) {
...
void OrgGeogebraCommonKernelDiscretePolygonTriangulation_TriangulationException_initWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_TriangulationException_TypeEnum_(OrgGeogebraCommonKernelDiscretePolygonTriangulation_TriangulationException *self, OrgGeogebraCommonKernelDiscretePolygonTriangulation_TriangulationException_TypeEnum *type) {
  ...
  OrgGeogebraCommonKernelDiscretePolygonTriangulation_TriangulationException_set_type_(self, type);
}
...
- (OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point *)clone {
  OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point *ret = [new_OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_initWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_withDouble_withDouble_withInt_(this$0_, x_, y_, id__) autorelease];
  OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_set_name_(ret, name_);
  return ret;
}
...
- (jboolean)addSegmentToRightWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment:(OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment *)segment {
  if (toRight_ == nil) {
    OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_setAndConsume_toRight_(self, new_OrgGeogebraCommonKernelDiscretePolygonTriangulation_MyTreeSet_initWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_(this$0_));
  }
...
- (jboolean)addSegmentToLeftWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment:(OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment *)segment {
  if (toLeft_ == nil) {
    OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_setAndConsume_toLeft_(self, new_OrgGeogebraCommonKernelDiscretePolygonTriangulation_MyTreeSet_initWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_(this$0_));
  }
...
- (jint)compareToWithId:(OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point *)p2 {
  check_class_cast(p2, [OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point class]);
  ...
  if (toRight_ != nil) {
    if (p2->toRight_ == nil) {
      OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_setAndConsume_toRight_(p2, new_OrgGeogebraCommonKernelDiscretePolygonTriangulation_MyTreeSet_initWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_(this$0_));
    }
    for (OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment * __strong seg in toRight_) {
      OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_leftPoint_(nil_chk(seg), p2);
  ...
  if (toLeft_ != nil) {
    if (p2->toLeft_ == nil) {
      OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_setAndConsume_toLeft_(p2, new_OrgGeogebraCommonKernelDiscretePolygonTriangulation_MyTreeSet_initWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_(this$0_));
    }
    for (OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment * __strong seg in toLeft_) {
      OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_rightPoint_(nil_chk(seg), p2);
...
- (OrgGeogebraCommonAwtGPoint2D_Double *)toDouble {
  return [new_OrgGeogebraCommonAwtGPoint2D_Double_initWithDouble_withDouble_(x_, y_) autorelease];
}
...
void OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_initWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_withDouble_withDouble_withInt_(OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point *self, OrgGeogebraCommonKernelDiscretePolygonTriangulation *outer$, jdouble x, jdouble y, jint id_) {
  OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_set_this$0_(self, outer$);
  NSObject_init(self);
...
- (jint)compareToWithId:(OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment *)seg {
  check_class_cast(seg, [OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment class]);
  if (self == seg) {
    return 0;
  }
  ...
  OrgGeogebraCommonKernelDiscretePolygonTriangulation_set_comparedSameOrientationSegment_(this$0_, seg);
  ...
  OrgGeogebraCommonKernelDiscretePolygonTriangulation_set_comparedSameSegment_(this$0_, seg);
  return 0;
}
...
void OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_initWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_(OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment *self, OrgGeogebraCommonKernelDiscretePolygonTriangulation *outer$) {
  OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_this$0_(self, outer$);
  NSObject_init(self);
  self->usable_ = 1;
  OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_running_(self, OrgGeogebraCommonKernelDiscretePolygonTriangulation_RunningEnum_get_STOP());
...
void OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_initWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_withOrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_withOrgGeogebraCommonKernelDiscretePolygonTriangulation_Point_(OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment *self, OrgGeogebraCommonKernelDiscretePolygonTriangulation *outer$, OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point *leftPoint, OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point *rightPoint) {
  ...
  OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_running_(self, OrgGeogebraCommonKernelDiscretePolygonTriangulation_RunningEnum_get_STOP());
  self->equationNeedsUpdate__ = YES;
  OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_leftPoint_(self, leftPoint);
  OrgGeogebraCommonKernelDiscretePolygonTriangulation_Segment_set_rightPoint_(self, rightPoint);
}
...
- (jint)compareWithId:(OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point *)p1
  ...
  if (((OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point *) nil_chk(p1))->id__ == ((OrgGeogebraCommonKernelDiscretePolygonTriangulation_Point *) nil_chk(p2))->id__) {
    ...
    OrgGeogebraCommonKernelDiscretePolygonTriangulation_set_nextNewPointForNonSelfIntersectingPolygon_(this$0_, p2);
    return 0;
  }
...
void OrgGeogebraCommonKernelDiscretePolygonTriangulation_$1_initWithOrgGeogebraCommonKernelDiscretePolygonTriangulation_(OrgGeogebraCommonKernelDiscretePolygonTriangulation_$1 *self, OrgGeogebraCommonKernelDiscretePolygonTriangulation *outer$) {
  OrgGeogebraCommonKernelDiscretePolygonTriangulation_$1_set_this$0_(self, outer$);
  NSObject_init(self);
}
