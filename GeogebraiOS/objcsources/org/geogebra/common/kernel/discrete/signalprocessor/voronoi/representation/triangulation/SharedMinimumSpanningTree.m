...
+ (void)initialize {
  if (self == [OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationTriangulationSharedMinimumSpanningTree class]) {
    JreStrongAssignAndConsume(&OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationTriangulationSharedMinimumSpanningTree_VERTEX_COMPARATOR_, nil, new_OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationTriangulationSharedMinimumSpanningTree_$1_init());
    JreStrongAssignAndConsume(&OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationTriangulationSharedMinimumSpanningTree_PATH_COMPARATOR_, nil, new_OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationTriangulationSharedMinimumSpanningTree_$2_init());
...
jint OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationTriangulationSharedMinimumSpanningTree_determineMSTUsingPrimsAlgorithmWithOrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationTriangulationVVertex2_(OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationTriangulationVVertex2 *startingvertex) {
  ...
  OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationTriangulationSharedMinimumSpanningTree_VertexList *vertexes = [new_OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationTriangulationSharedMinimumSpanningTree_VertexList_init() autorelease];
  OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationTriangulationSharedMinimumSpanningTree_FuturePathList *futurepaths = [new_OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationTriangulationSharedMinimumSpanningTree_FuturePathList_init() autorelease];
...
jint OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationTriangulationSharedMinimumSpanningTree_determineMSTUsingPrimsAlgorithmWithOrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationTriangulationVVertex2_withDouble_withJavaUtilArrayList_(OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationTriangulationVVertex2 *startingvertex, jdouble gradient_diff_before_cluster_cutoff, JavaUtilArrayList *clusters) {
  ...
  OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationTriangulationVCluster *currentcluster = [new_OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationTriangulationVCluster_init() autorelease];
  ...
  do {
    ...
    if ([((OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationTriangulationVHalfEdge2 *) nil_chk(nextbestpath)) getLength] <= clustercutoff) {
      ...
      currentcluster = [new_OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationTriangulationVCluster_init() autorelease];
...
void OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationTriangulationSharedMinimumSpanningTree_VertexList_init(OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationTriangulationSharedMinimumSpanningTree_VertexList *self) {
  JavaUtilTreeMap_initWithJavaUtilComparator_(self, OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationTriangulationSharedMinimumSpanningTree_get_VERTEX_COMPARATOR_());
}
...
void OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationTriangulationSharedMinimumSpanningTree_FuturePathList_init(OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationTriangulationSharedMinimumSpanningTree_FuturePathList *self) {
  JavaUtilTreeMap_initWithJavaUtilComparator_(self, OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationTriangulationSharedMinimumSpanningTree_get_PATH_COMPARATOR_());
}
