...
void OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationVoronoicellBestVoronoiCells_initWithInt_(OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationVoronoicellBestVoronoiCells *self, jint number) {
  NSObject_init(self);
  OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationVoronoicellBestVoronoiCells_setAndConsume_bestareas_(self, [IOSDoubleArray newArrayWithLength:number]);
  OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationVoronoicellBestVoronoiCells_setAndConsume_bestcells_(self, [IOSObjectArray newArrayWithLength:number type:OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationVoronoicellVVoronoiCell_class_()]);
}
