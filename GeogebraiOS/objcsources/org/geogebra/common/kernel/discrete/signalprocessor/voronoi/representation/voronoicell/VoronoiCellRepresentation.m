...
- (OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiVPoint *)createPointWithDouble:(jdouble)x
  ...
  return [new_OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationVoronoicellVVoronoiCell_initWithDouble_withDouble_(x, y) autorelease];
}

- (void)beginAlgorithmWithJavaUtilCollection:(id<JavaUtilCollection>)points {
  OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationVoronoicellVoronoiCellRepresentation_set_voronoicells_(self, points);
  for (OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiVPoint * __strong point in nil_chk(points)) {
    ...
    OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationVoronoicellVVoronoiCell_set_halfedge_(nil_chk(voronoicell), nil);
...
- (void)siteEventWithOrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiStatusstructureVLinkedNode:(OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiStatusstructureVLinkedNode *)n1
  ...
  OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiStatusstructureBinarysearchtreeimplVInternalNode_setAndConsume_halfedge_in_(nil_chk(parent1), new_OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationVoronoicellVHalfEdge3_init());
  OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiStatusstructureBinarysearchtreeimplVInternalNode_setAndConsume_halfedge_out_(parent1, new_OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationVoronoicellVHalfEdge3_init());
...
- (void)circleEventWithOrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiStatusstructureVLinkedNode:(OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiStatusstructureVLinkedNode *)n1
  ...
  OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationVoronoicellVHalfEdge3 *down_in = [new_OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationVoronoicellVHalfEdge3_initWithInt_withInt_(circle_x, circle_y) autorelease];
  OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationVoronoicellVHalfEdge3 *down_out = [new_OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationVoronoicellVHalfEdge3_init() autorelease];
  ...
  if (((OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationVoronoicellVVoronoiCell *) nil_chk(v1))->halfedge_ == nil) OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationVoronoicellVVoronoiCell_set_halfedge_(v1, left_in);
  if (((OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationVoronoicellVVoronoiCell *) nil_chk(v2))->halfedge_ == nil) OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationVoronoicellVVoronoiCell_set_halfedge_(v2, right_in);
  if (((OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationVoronoicellVVoronoiCell *) nil_chk(v3))->halfedge_ == nil) OrgGeogebraCommonKernelDiscreteSignalprocessorVoronoiRepresentationVoronoicellVVoronoiCell_set_halfedge_(v3, down_out);
}
