...
void OrgGeogebraCommonKernelDiscreteTspUtilHeap_init(OrgGeogebraCommonKernelDiscreteTspUtilHeap *self) {
  OrgGeogebraCommonKernelDiscreteTspUtilHeap_initWithJavaUtilComparator_(self, nil);
}
...
void OrgGeogebraCommonKernelDiscreteTspUtilHeap_initWithInt_(OrgGeogebraCommonKernelDiscreteTspUtilHeap *self, jint initialCapacity) {
  OrgGeogebraCommonKernelDiscreteTspUtilHeap_initWithInt_withJavaUtilComparator_(self, initialCapacity, nil);
}
...
void OrgGeogebraCommonKernelDiscreteTspUtilHeap_initWithJavaUtilComparator_(OrgGeogebraCommonKernelDiscreteTspUtilHeap *self, id<JavaUtilComparator> comparator) {
  OrgGeogebraCommonKernelDiscreteTspUtilHeap_initWithInt_withJavaUtilComparator_(self, OrgGeogebraCommonKernelDiscreteTspUtilHeap_DEFAULT_CAPACITY, comparator);
}
...
void OrgGeogebraCommonKernelDiscreteTspUtilHeap_initWithInt_withJavaUtilComparator_(OrgGeogebraCommonKernelDiscreteTspUtilHeap *self, jint initialCapacity, id<JavaUtilComparator> comparator) {
  ...
  self->size__ = 0;
  OrgGeogebraCommonKernelDiscreteTspUtilHeap_set_entries_(self, (IOSObjectArray *) check_class_cast([IOSObjectArray arrayWithLength:initialCapacity + 1 type:NSObject_class_()], [IOSObjectArray class]));
  OrgGeogebraCommonKernelDiscreteTspUtilHeap_setAndConsume_table_(self, new_JavaUtilHashMap_init());
  OrgGeogebraCommonKernelDiscreteTspUtilHeap_set_comparator_(self, comparator);
}
...
void OrgGeogebraCommonKernelDiscreteTspUtilHeap_growWithInt_(OrgGeogebraCommonKernelDiscreteTspUtilHeap *self, jint index) {
  ...
  OrgGeogebraCommonKernelDiscreteTspUtilHeap_set_entries_(self, newEntrys);
}
