...
- (void)compute {
  ...
  IOSObjectArray *points = [IOSObjectArray newArrayWithLength:size_ type:OrgGeogebraCommonKernelDiscreteDelaunayPoint_dt_class_()];
  for (jint i = 0; i < size_; i++) {
    ...
    if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(geo)) isDefined] && [geo isGeoPoint]) {
      ...
      (void) IOSObjectArray_Set(points, i, new_OrgGeogebraCommonKernelDiscreteDelaunayPoint_dt_initWithDouble_withDouble_(IOSDoubleArray_Get(inhom, 0), IOSDoubleArray_Get(inhom, 1)));
    }
  }
...
id<JavaUtilComparator> OrgGeogebraCommonKernelDiscreteAlgoDelauneyTriangulation_getComparator() {
  ...
  if (OrgGeogebraCommonKernelDiscreteAlgoDelauneyTriangulation_lineComparator_ == nil) {
    OrgGeogebraCommonKernelDiscreteAlgoDelauneyTriangulation_lineComparator_ = new_OrgGeogebraCommonKernelDiscreteAlgoDelauneyTriangulation_$1_init();
  }
