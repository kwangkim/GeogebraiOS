...
- (void)compute {
  if (c1_ != nil) {
    p2_ = new_OrgGeogebraCommonKernelImplicitGeoImplicitPoly_initWithOrgGeogebraCommonKernelKernelNDGeoConicND_(c1_);
  }
  if (valPairs_ == nil) {
    valPairs_ = new_JavaUtilLinkedList_init();
  }
  else {
    [valPairs_ clear];
  }
  ...
  IOSObjectArray *mat = [IOSObjectArray newArrayWithDimensions:2 lengths:(jint[]){ n, n } type:OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction_class_()];
  IOSObjectArray *aNew = [IOSObjectArray newArrayWithLength:m + n type:OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction_class_()];
  IOSObjectArray *bPolys = [IOSObjectArray newArrayWithLength:n + 1 type:OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction_class_()];
  for (jint i = 0; i <= n; ++i) (void) IOSObjectArray_Set(bPolys, i, new_OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction_initWithDoubleArray_(IOSObjectArray_Get(nil_chk([b getCoeff]), i)));
  for (jint i = 0; i < n - 1; ++i) (void) IOSObjectArray_Set(aNew, i, new_OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction_initWithDoubleArray_([IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 0 } count:1]));
  for (jint i = n - 1; i < n + m; ++i) (void) IOSObjectArray_Set(aNew, i, new_OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction_initWithDoubleArray_(IOSObjectArray_Get(nil_chk([a getCoeff]), i - n + 1)));
  ...
  while (leadIndex >= 2 * n) {
    if (!([((OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction *) nil_chk(IOSObjectArray_Get(aNew, leadIndex))) degree] == 0 && IOSDoubleArray_Get(nil_chk([((OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction *) nil_chk(IOSObjectArray_Get(aNew, leadIndex))) getCoefficients]), 0) == 0)) {
      for (jint j = n - 1; j < leadIndex - n; ++j) (void) IOSObjectArray_Set(aNew, j, [((OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction *) nil_chk(IOSObjectArray_Get(aNew, j))) multiplyWithOrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction:IOSObjectArray_Get(bPolys, n)]);
      for (jint j = leadIndex - n; j < leadIndex; ++j) (void) IOSObjectArray_Set(aNew, j, [((OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction *) nil_chk([((OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction *) nil_chk(IOSObjectArray_Get(aNew, j))) multiplyWithOrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction:IOSObjectArray_Get(bPolys, n)])) subtractWithOrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction:[((OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction *) nil_chk(IOSObjectArray_Get(bPolys, j - leadIndex + n))) multiplyWithOrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction:IOSObjectArray_Get(aNew, leadIndex)]]);
    }
    --leadIndex;
  }
  while (leadIndex >= n) {
    ...
    for (jint j = 0; j < n; ++j) (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(mat, 2 * n - 1 - leadIndex)), j, new_OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction_initWithDoubleArray_([((OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction *) nil_chk(IOSObjectArray_Get(aNew, leadIndex - n + j))) getCoefficients]));
    --leadIndex;
  }
  for (jint i = 0; i < n; ++i) {
    ...
    if (reduceFactor != 1) {
      for (jint j = 0; j < n; ++j) {
        (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(mat, i)), j, [((OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction *) nil_chk(IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(mat, i)), j))) multiplyWithOrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction:new_OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction_initWithDoubleArray_([IOSDoubleArray newArrayWithDoubles:(jdouble[]){ reduceFactor } count:1])]);
      }
    }
  }
  OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction *c = new_OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction_initWithDoubleArray_([IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 1 } count:1]);
  ...
  for (jint k = 0; k < n - 1; k++) {
    ...
    if (OrgGeogebraCommonKernelKernel_isZeroWithDouble_(glc)) {
      det = new_OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction_initWithDoubleArray_([IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 0 } count:1]);
      break;
    }
    else if (r > k) {
      for (jint j = k; j < n; j++) {
        OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction *temp = IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(mat, r)), j);
        (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(mat, r)), j, IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(mat, k)), j));
        (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(mat, k)), j, temp);
      }
    }
    for (jint i = k + 1; i < n; i++) {
      for (jint j = k + 1; j < n; j++) {
        ...
        (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(mat, i)), j, OrgGeogebraCommonKernelImplicitPolynomialUtils_polynomialDivisionWithOrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction_withOrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction_(t, c));
      }
    }
  ...
  if (univarType_ == OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolys_PolyX) {
    if ([p1_ getDegY] < [p2_ getDegY]) {
      coeff = [p1_ getCoeff];
      newCoeff = [IOSDoubleArray newArrayWithLength:[p1_ getDegY] + 1];
    }
    else {
      coeff = [p2_ getCoeff];
      newCoeff = [IOSDoubleArray newArrayWithLength:[p2_ getDegY] + 1];
    }
  }
  else {
    if ([p1_ getDegX] < [p2_ getDegX]) {
      coeff = [p1_ getCoeff];
      newCoeff = [IOSDoubleArray newArrayWithLength:[p1_ getDegX] + 1];
    }
    else {
      coeff = [p2_ getCoeff];
      newCoeff = [IOSDoubleArray newArrayWithLength:[p2_ getDegX] + 1];
    }
  }
  for (jint k = 0; k < nrRealRoots; k++) {
    ...
    for (jint i = 0; i < nr; i++) {
      IOSDoubleArray *pair = [IOSDoubleArray newArrayWithLength:2];
      if (univarType_ == OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolys_PolyX) {
...
- (void)addSolutionHintWithOrgGeogebraCommonKernelGeosGeoPoint:(OrgGeogebraCommonKernelGeosGeoPoint *)point {
  if (hints_ == nil) {
    hints_ = new_JavaUtilArrayList_init();
  }
...
void OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolys_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelImplicitGeoImplicitPoly_withOrgGeogebraCommonKernelGeosGeoConic_(OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolys *self, OrgGeogebraCommonKernelConstruction *c, OrgGeogebraCommonKernelImplicitGeoImplicitPoly *p1, OrgGeogebraCommonKernelGeosGeoConic *c1) {
  (void) OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolys_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withBoolean_withOrgGeogebraCommonKernelImplicitGeoImplicitPoly_withOrgGeogebraCommonKernelGeosGeoConic_(self, c, nil, NO, p1, c1);
}
...
void OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolys_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withBoolean_withOrgGeogebraCommonKernelImplicitGeoImplicitPoly_withOrgGeogebraCommonKernelGeosGeoConic_(OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolys *self, OrgGeogebraCommonKernelConstruction *c, IOSObjectArray *labels, jboolean setLabels, OrgGeogebraCommonKernelImplicitGeoImplicitPoly *p1, OrgGeogebraCommonKernelGeosGeoConic *c1) {
  (void) OrgGeogebraCommonKernelAlgosAlgoSimpleRootsPolynomial_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoElementArray_(self, c, [IOSObjectArray newArrayWithObjects:(id[]){ p1, c1 } count:2 type:OrgGeogebraCommonKernelGeosGeoElement_class_()]);
  self->p1_ = p1;
  self->c1_ = c1;
...
void OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolys_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelImplicitGeoImplicitPoly_withOrgGeogebraCommonKernelImplicitGeoImplicitPoly_(OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolys *self, OrgGeogebraCommonKernelConstruction *c, OrgGeogebraCommonKernelImplicitGeoImplicitPoly *p1, OrgGeogebraCommonKernelImplicitGeoImplicitPoly *p2) {
  (void) OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolys_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withBoolean_withOrgGeogebraCommonKernelImplicitGeoImplicitPoly_withOrgGeogebraCommonKernelImplicitGeoImplicitPoly_(self, c, nil, NO, p1, p2);
}
...
void OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolys_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withBoolean_withOrgGeogebraCommonKernelImplicitGeoImplicitPoly_withOrgGeogebraCommonKernelImplicitGeoImplicitPoly_(OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolys *self, OrgGeogebraCommonKernelConstruction *c, IOSObjectArray *labels, jboolean setLabels, OrgGeogebraCommonKernelImplicitGeoImplicitPoly *p1, OrgGeogebraCommonKernelImplicitGeoImplicitPoly *p2) {
  (void) OrgGeogebraCommonKernelAlgosAlgoSimpleRootsPolynomial_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoElementArray_(self, c, [IOSObjectArray newArrayWithObjects:(id[]){ p1, p2 } count:2 type:OrgGeogebraCommonKernelGeosGeoElement_class_()]);
  self->p1_ = p1;
  self->p2_ = p2;
  [self initForNearToRelationship];
  [self compute];
...
jint OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolys_getNearRootsWithDoubleArray_withOrgGeogebraCommonKernelEquationSolverInterface_withDouble_(IOSDoubleArray *roots, id<OrgGeogebraCommonKernelEquationSolverInterface> solver, jdouble epsilon) {
  ...
  OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction *poly = new_OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction_initWithDoubleArray_(roots);
