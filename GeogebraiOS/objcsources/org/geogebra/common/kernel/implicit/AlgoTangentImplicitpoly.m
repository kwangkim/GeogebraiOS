...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/kernel/implicit/AlgoTangentImplicitpoly.java
//
...
- (void)setInputOutput {
  ...
  if (g_ != nil) (void) IOSObjectArray_Set(input_, 0, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(g_, [OrgGeogebraCommonKernelGeosGeoElement class]));
  else (void) IOSObjectArray_Set(input_, 0, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(R_, [OrgGeogebraCommonKernelGeosGeoElement class]));
  tangents_ = new_OrgGeogebraCommonKernelAlgosAlgoElement_OutputHandler_initWithOrgGeogebraCommonKernelAlgosAlgoElement_withOrgGeogebraCommonKernelAlgosAlgoElement_elementFactory_(self, new_OrgGeogebraCommonKernelImplicitAlgoTangentImplicitpoly_$1_initWithOrgGeogebraCommonKernelImplicitAlgoTangentImplicitpoly_(self));
...
- (void)compute {
  ...
  ip_ = [((OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolys *) nil_chk(algoIntersect_)) getIntersectionPoints];
...
- (IOSObjectArray *)getTangents {
  return [tangents_ getOutputWithOrgGeogebraCommonKernelGeosGeoElementArray:[IOSObjectArray newArrayWithLength:[((OrgGeogebraCommonKernelAlgosAlgoElement_OutputHandler *) nil_chk(tangents_)) size] type:OrgGeogebraCommonKernelGeosGeoLine_class_()]];
}
...
void OrgGeogebraCommonKernelImplicitAlgoTangentImplicitpoly_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelImplicitGeoImplicitPoly_withOrgGeogebraCommonKernelKernelNDGeoPointND_(OrgGeogebraCommonKernelImplicitAlgoTangentImplicitpoly *self, OrgGeogebraCommonKernelConstruction *c, IOSObjectArray *labels, OrgGeogebraCommonKernelImplicitGeoImplicitPoly *p, id<OrgGeogebraCommonKernelKernelNDGeoPointND> R) {
  (void) OrgGeogebraCommonKernelImplicitAlgoTangentImplicitpoly_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelImplicitGeoImplicitPoly_(self, c, labels, p);
  self->R_ = R;
  ...
  if (!self->pointOnPath_) {
    ...
    self->algoIntersect_ = new_OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolys_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelImplicitGeoImplicitPoly_withOrgGeogebraCommonKernelImplicitGeoImplicitPoly_(self->cons_, p, tangentCurve);
    ...
    self->ip_ = [self->algoIntersect_ getIntersectionPoints];
  }
  [self setInputOutput];
}
...
- (OrgGeogebraCommonKernelGeosGeoLine *)newElement {
  OrgGeogebraCommonKernelGeosGeoLine *g1 = new_OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelConstruction_([this$0_ getConstruction]);
