...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/implicit/AlgoImplicitPolyTangentCurve.java
//
...
- (void)setInputOutput {
  OrgGeogebraCommonKernelAlgosAlgoElement_setAndConsume_input_(self, [IOSObjectArray newArrayWithObjects:(id[]){ poly_, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(point_, [OrgGeogebraCommonKernelGeosGeoElement class]) } count:2 type:OrgGeogebraCommonKernelGeosGeoElement_class_()]);
...
void OrgGeogebraCommonKernelImplicitAlgoImplicitPolyTangentCurve_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelImplicitGeoImplicitPoly_withOrgGeogebraCommonKernelKernelNDGeoPointND_withNSString_withBoolean_withBoolean_(OrgGeogebraCommonKernelImplicitAlgoImplicitPolyTangentCurve *self, OrgGeogebraCommonKernelConstruction *c, OrgGeogebraCommonKernelImplicitGeoImplicitPoly *poly, id<OrgGeogebraCommonKernelKernelNDGeoPointND> point, NSString *label, jboolean addToConstructionList, jboolean calcPath) {
  ...
  OrgGeogebraCommonKernelImplicitAlgoImplicitPolyTangentCurve_set_poly_(self, poly);
  OrgGeogebraCommonKernelImplicitAlgoImplicitPolyTangentCurve_set_point_(self, point);
  OrgGeogebraCommonKernelImplicitAlgoImplicitPolyTangentCurve_setAndConsume_tangentPoly_(self, new_OrgGeogebraCommonKernelImplicitGeoImplicitPoly_initWithOrgGeogebraCommonKernelConstruction_(c));
  if (!calcPath) {
