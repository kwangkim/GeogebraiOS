...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/implicit/GeoImplicitPoly.java
//
...
- (OrgGeogebraCommonKernelGeosGeoElement *)copy__ {
  return [new_OrgGeogebraCommonKernelImplicitGeoImplicitPoly_initWithOrgGeogebraCommonKernelImplicitGeoImplicitPoly_(self) autorelease];
}
...
- (void)setWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  if ([geo isKindOfClass:[OrgGeogebraCommonKernelKernelNDGeoConicND class]]) {
    ...
    [self setCoeffWithDoubleArray2:[IOSObjectArray arrayWithObjects:(id[]){ [IOSDoubleArray arrayWithDoubles:(jdouble[]){ [((OrgGeogebraCommonKernelGeosGeoLine *) nil_chk(l)) getZ], [l getY] } count:2], [IOSDoubleArray arrayWithDoubles:(jdouble[]){ [l getX], 0 } count:2] } count:2 type:IOSClass_doubleArray(1)]];
    return;
  }
  ...
  for (jint i = ((IOSObjectArray *) nil_chk(coeff_))->size_ - 1; i >= 0; i--) {
    for (jint j = ((IOSDoubleArray *) nil_chk(IOSObjectArray_Get(coeff_, i)))->size_ - 1; j >= 0; j--) {
      if (i == 0 && j == 0) {
        ...
        [sb appendWithNSString:@"= "];
        [sb appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) formatWithDouble:-IOSDoubleArray_Get(nil_chk(IOSObjectArray_Get(coeff_, 0)), 0) withOrgGeogebraCommonKernelStringTemplate:tpl]];
      }
      else {
        ...
        if (![((NSString *) nil_chk(number)) isEqual:@"0"] && IOSDoubleArray_Get(nil_chk(IOSObjectArray_Get(coeff_, i)), j) != 0) {
          ...
          if (i > 0) {
            [sb appendWithNSString:[((OrgGeogebraCommonKernelStringTemplate *) nil_chk(tpl)) printVariableNameWithNSString:@"x"]];
          }
...
- (void)setCoeffWithDoubleArray2:(IOSObjectArray *)c
  ...
  degX_ = -1;
  degY_ = -1;
  OrgGeogebraCommonKernelImplicitGeoImplicitPoly_set_coeffSquarefree_(self, nil);
  degX_ = ((IOSObjectArray *) nil_chk(c))->size_ - 1;
  OrgGeogebraCommonKernelImplicitGeoImplicitPoly_setAndConsume_coeff_(self, [IOSObjectArray newArrayWithLength:c->size_ type:IOSClass_doubleArray(1)]);
...
- (void)setCoeffWithOrgGeogebraCommonKernelArithmeticExpressionValueArray2:(IOSObjectArray *)ev
  ...
  degX_ = -1;
  degY_ = -1;
  OrgGeogebraCommonKernelImplicitGeoImplicitPoly_setAndConsume_coeff_(self, [IOSObjectArray newArrayWithLength:((IOSObjectArray *) nil_chk(ev))->size_ type:IOSClass_doubleArray(1)]);
  degX_ = ev->size_ - 1;
  OrgGeogebraCommonKernelImplicitGeoImplicitPoly_set_coeffSquarefree_(self, nil);
...
- (void)plugInRatPolyWithDoubleArray2:(IOSObjectArray *)pX
  ...
  *IOSDoubleArray_GetRef(nil_chk(IOSObjectArray_Get(ratXCoeff, 0)), 0) = 1;
  ...
  OrgGeogebraCommonKernelImplicitGeoImplicitPoly_set_coeff_(self, OrgGeogebraCommonKernelImplicitPolynomialUtils_coeffMinDegWithDoubleArray2_(newCoeff));
...
- (jdouble)distanceWithOrgGeogebraCommonKernelGeosGeoPoint:(OrgGeogebraCommonKernelGeosGeoPoint *)p {
  OrgGeogebraCommonKernelAlgosAlgoClosestPoint *algo = [new_OrgGeogebraCommonKernelAlgosAlgoClosestPoint_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelPath_withOrgGeogebraCommonKernelKernelNDGeoPointND_(cons_, self, p) autorelease];
  [algo remove];
...
- (void)mirrorWithOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)Q {
  [self plugInPolyWithDoubleArray2:[IOSObjectArray arrayWithObjects:(id[]){ [IOSDoubleArray arrayWithDoubles:(jdouble[]){ 2 * [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(Q)) getX] } count:1], [IOSDoubleArray arrayWithDoubles:(jdouble[]){ -1 } count:1] } count:2 type:IOSClass_doubleArray(1)] withDoubleArray2:[IOSObjectArray arrayWithObjects:(id[]){ [IOSDoubleArray arrayWithDoubles:(jdouble[]){ 2 * [Q getY], -1 } count:2] } count:1 type:IOSClass_doubleArray(1)]];
}
...
- (void)dilateWithOrgGeogebraCommonKernelArithmeticNumberValue:(id<OrgGeogebraCommonKernelArithmeticNumberValue>)rval
  ...
  [self plugInPolyWithDoubleArray2:[IOSObjectArray arrayWithObjects:(id[]){ [IOSDoubleArray arrayWithDoubles:(jdouble[]){ (1 - r) * [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(S)) getX] } count:1], [IOSDoubleArray arrayWithDoubles:(jdouble[]){ r } count:1] } count:2 type:IOSClass_doubleArray(1)] withDoubleArray2:[IOSObjectArray arrayWithObjects:(id[]){ [IOSDoubleArray arrayWithDoubles:(jdouble[]){ (1 - r) * [S getY], r } count:2] } count:1 type:IOSClass_doubleArray(1)]];
}
...
- (void)updatePathWithDouble:(jdouble)rectX
  ...
  OrgGeogebraCommonKernelImplicitGeoImplicitPoly_setAndConsume_singularitiesCollection_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonKernelImplicitGeoImplicitPoly_setAndConsume_boundaryIntersectCollection_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonKernelImplicitGeoImplicitPoly_setAndConsume_grid_(self, [IOSObjectArray newArrayWithDimensions:2 lengths:(jint[]){ gridWidth_, gridHeight_ } type:OrgGeogebraCommonKernelImplicitGeoImplicitPoly_GridRect_class_()]);
  OrgGeogebraCommonKernelImplicitGeoImplicitPoly_setAndConsume_remember_(self, [IOSBooleanArray newArrayWithDimensions:2 lengths:(jint[]){ gridWidth_, gridHeight_ }]);
  jdouble prec = 5;
  ...
  for (jint w = 0; w < gridWidth_; w++) {
    ...
    for (jint h = 0; h < gridHeight_; h++) {
      ...
      IOSObjectArray_SetAndConsume(nil_chk(IOSObjectArray_Get(grid_, w)), h, new_OrgGeogebraCommonKernelImplicitGeoImplicitPoly_GridRect_initWithDouble_withDouble_withDouble_withDouble_(x, y, grw, grh));
...
void OrgGeogebraCommonKernelImplicitGeoImplicitPoly_initWithOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonKernelImplicitGeoImplicitPoly *self, OrgGeogebraCommonKernelConstruction *c) {
  ...
  self->degX_ = -1;
  self->degY_ = -1;
  OrgGeogebraCommonKernelImplicitGeoImplicitPoly_setAndConsume_coeffSquarefree_(self, [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ 0, 0 }]);
  OrgGeogebraCommonKernelImplicitGeoImplicitPoly_setAndConsume_coeff_(self, [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ 0, 0 }]);
  OrgGeogebraCommonKernelImplicitGeoImplicitPoly_setAndConsume_locus_(self, new_OrgGeogebraCommonKernelGeosGeoLocus_initWithOrgGeogebraCommonKernelConstruction_(c));
...
void OrgGeogebraCommonKernelImplicitGeoImplicitPoly_initWithOrgGeogebraCommonKernelConstruction_withNSString_withDoubleArray2_(OrgGeogebraCommonKernelImplicitGeoImplicitPoly *self, OrgGeogebraCommonKernelConstruction *c, NSString *label, IOSObjectArray *coeff) {
  OrgGeogebraCommonKernelImplicitGeoImplicitPoly_initWithOrgGeogebraCommonKernelConstruction_withNSString_withDoubleArray2_withBoolean_(self, c, label, coeff, YES);
}
...
void OrgGeogebraCommonKernelImplicitGeoImplicitPoly_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticPolynomial_(OrgGeogebraCommonKernelImplicitGeoImplicitPoly *self, OrgGeogebraCommonKernelConstruction *c, NSString *label, OrgGeogebraCommonKernelArithmeticPolynomial *poly) {
  OrgGeogebraCommonKernelImplicitGeoImplicitPoly_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticPolynomial_withBoolean_(self, c, label, poly, YES);
}
...
OrgGeogebraCommonKernelImplicitGeoImplicitPoly *OrgGeogebraCommonKernelImplicitGeoImplicitPoly_createImplicitPolyWithoutPathWithOrgGeogebraCommonKernelConstruction_withDoubleArray2_(OrgGeogebraCommonKernelConstruction *c, IOSObjectArray *coeff) {
  ...
  return [new_OrgGeogebraCommonKernelImplicitGeoImplicitPoly_initWithOrgGeogebraCommonKernelConstruction_withNSString_withDoubleArray2_withBoolean_(c, nil, coeff, NO) autorelease];
}
...
void OrgGeogebraCommonKernelImplicitGeoImplicitPoly_initWithOrgGeogebraCommonKernelImplicitGeoImplicitPoly_(OrgGeogebraCommonKernelImplicitGeoImplicitPoly *self, OrgGeogebraCommonKernelImplicitGeoImplicitPoly *g) {
  OrgGeogebraCommonKernelImplicitGeoImplicitPoly_initWithOrgGeogebraCommonKernelConstruction_(self, ((OrgGeogebraCommonKernelImplicitGeoImplicitPoly *) nil_chk(g))->cons_);
...
void OrgGeogebraCommonKernelImplicitGeoImplicitPoly_initWithOrgGeogebraCommonKernelKernelNDGeoConicND_(OrgGeogebraCommonKernelImplicitGeoImplicitPoly *self, OrgGeogebraCommonKernelKernelNDGeoConicND *c) {
  OrgGeogebraCommonKernelImplicitGeoImplicitPoly_initWithOrgGeogebraCommonKernelConstruction_(self, [((OrgGeogebraCommonKernelKernelNDGeoConicND *) nil_chk(c)) getConstruction]);
  OrgGeogebraCommonKernelImplicitGeoImplicitPoly_set_coeff_(self, OrgGeogebraCommonKernelImplicitGeoImplicitPoly_coeffFromConicWithOrgGeogebraCommonKernelKernelNDGeoConicND_(c));
  self->degX_ = 2;
  self->degY_ = 2;
}
...
void OrgGeogebraCommonKernelImplicitGeoImplicitPoly_startPathWithInt_withInt_withDouble_withDouble_withOrgGeogebraCommonKernelGeosGeoLocus_(OrgGeogebraCommonKernelImplicitGeoImplicitPoly *self, jint width, jint height, jdouble x, jdouble y, OrgGeogebraCommonKernelGeosGeoLocus *loc1) {
  ...
  [firstDirPoints addWithId:[new_OrgGeogebraCommonKernelMyPoint_initWithDouble_withDouble_withBoolean_(x, y, YES) autorelease]];
  jint s = 0;
  jint lastW = w;
  jint lastH = h;
  jint startW = w;
  ...
  while (s < OrgGeogebraCommonKernelImplicitGeoImplicitPoly_MAX_STEPS) {
    ...
    if (!reachedEnd || reachedSingularity) {
      if (reachedSingularity || ((lx - sx) * (lx - sx) + (ly - sy) * (ly - sy) > self->minGap_ * self->minGap_)) {
        if (firstDirPoints != nil) {
          [firstDirPoints addWithId:[new_OrgGeogebraCommonKernelMyPoint_initWithDouble_withDouble_withBoolean_(sx, sy, YES) autorelease]];
        }
        else {
...
void OrgGeogebraCommonKernelImplicitGeoImplicitPoly_GridRect_initWithDouble_withDouble_withDouble_withDouble_(OrgGeogebraCommonKernelImplicitGeoImplicitPoly_GridRect *self, jdouble x, jdouble y, jdouble width, jdouble height) {
  ...
  self->width_ = width;
  self->height_ = height;
  OrgGeogebraCommonKernelImplicitGeoImplicitPoly_GridRect_setAndConsume_eval_(self, [IOSIntArray newArrayWithLength:4]);
}
