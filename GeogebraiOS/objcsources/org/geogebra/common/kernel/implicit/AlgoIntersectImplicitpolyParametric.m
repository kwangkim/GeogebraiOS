...
- (void)compute {
  ...
  if (f_ != nil) {
    ...
    OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolyParametric_setAndConsume_tx_(self, new_OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction_initWithDoubleArray_([IOSDoubleArray arrayWithDoubles:(jdouble[]){ 0, 1 } count:2]));
    OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolyParametric_setAndConsume_ty_(self, new_OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction_initWithDoubleArray_([((OrgGeogebraCommonKernelArithmeticPolyFunction *) nil_chk([((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk([f_ getFunction])) getNumericPolynomialDerivativeWithInt:0 withBoolean:NO])) getCoeffs]));
    ...
    OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolyParametric_setAndConsume_tx_(self, new_OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction_initWithDoubleArray_([IOSDoubleArray arrayWithDoubles:(jdouble[]){ IOSDoubleArray_Get(startP, 0), [l_ getY] } count:2]));
    OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolyParametric_setAndConsume_ty_(self, new_OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction_initWithDoubleArray_([IOSDoubleArray arrayWithDoubles:(jdouble[]){ IOSDoubleArray_Get(startP, 1), -[l_ getX] } count:2]));
    ...
    if ([[l_ getParentAlgorithm] isKindOfClass:[OrgGeogebraCommonKernelImplicitAlgoTangentImplicitpoly class]]) {
      OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolyParametric_set_tangentPoints_(self, [((OrgGeogebraCommonKernelImplicitAlgoTangentImplicitpoly *) nil_chk(((OrgGeogebraCommonKernelImplicitAlgoTangentImplicitpoly *) check_class_cast([l_ getParentAlgorithm], [OrgGeogebraCommonKernelImplicitAlgoTangentImplicitpoly class])))) getTangentPoints]);
    }
  }
  else {
    return;
...
void OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolyParametric_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelImplicitGeoImplicitPoly_withOrgGeogebraCommonKernelGeosGeoLine_(OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolyParametric *self, OrgGeogebraCommonKernelConstruction *c, OrgGeogebraCommonKernelImplicitGeoImplicitPoly *p, OrgGeogebraCommonKernelGeosGeoLine *l) {
  OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolyParametric_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withBoolean_withOrgGeogebraCommonKernelImplicitGeoImplicitPoly_withOrgGeogebraCommonKernelGeosGeoLine_(self, c, nil, NO, p, l);
}
...
void OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolyParametric_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelImplicitGeoImplicitPoly_withOrgGeogebraCommonKernelGeosGeoFunction_(OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolyParametric *self, OrgGeogebraCommonKernelConstruction *c, OrgGeogebraCommonKernelImplicitGeoImplicitPoly *p, OrgGeogebraCommonKernelGeosGeoFunction *f) {
  OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolyParametric_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withBoolean_withOrgGeogebraCommonKernelImplicitGeoImplicitPoly_withOrgGeogebraCommonKernelGeosGeoFunction_(self, c, nil, NO, p, f);
}
...
void OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolyParametric_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withBoolean_withOrgGeogebraCommonKernelImplicitGeoImplicitPoly_withOrgGeogebraCommonKernelGeosGeoLine_(OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolyParametric *self, OrgGeogebraCommonKernelConstruction *c, IOSObjectArray *labels, jboolean setLabels, OrgGeogebraCommonKernelImplicitGeoImplicitPoly *p, OrgGeogebraCommonKernelGeosGeoLine *l) {
  OrgGeogebraCommonKernelAlgosAlgoSimpleRootsPolynomial_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoElementArray_(self, c, [IOSObjectArray arrayWithObjects:(id[]){ p, l } count:2 type:OrgGeogebraCommonKernelGeosGeoElement_class_()]);
  OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolyParametric_set_p_(self, p);
  OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolyParametric_set_l_(self, l);
  [self compute];
}
...
void OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolyParametric_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withBoolean_withOrgGeogebraCommonKernelImplicitGeoImplicitPoly_withOrgGeogebraCommonKernelGeosGeoFunction_(OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolyParametric *self, OrgGeogebraCommonKernelConstruction *c, IOSObjectArray *labels, jboolean setLabels, OrgGeogebraCommonKernelImplicitGeoImplicitPoly *p, OrgGeogebraCommonKernelGeosGeoFunction *f) {
  OrgGeogebraCommonKernelAlgosAlgoSimpleRootsPolynomial_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoElementArray_(self, c, [IOSObjectArray arrayWithObjects:(id[]){ p, f } count:2 type:OrgGeogebraCommonKernelGeosGeoElement_class_()]);
  OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolyParametric_set_p_(self, p);
  OrgGeogebraCommonKernelImplicitAlgoIntersectImplicitpolyParametric_set_f_(self, f);
  [self compute];
}
