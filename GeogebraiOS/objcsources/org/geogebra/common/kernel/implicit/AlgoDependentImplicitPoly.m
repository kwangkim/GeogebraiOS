...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/kernel/implicit/AlgoDependentImplicitPoly.java
//
...
- (void)setInputOutput {
  if (input_ == nil) {
    ...
    dependentFromFunctions_ = new_JavaUtilHashSet_init();
    [self addAllFunctionalDescendentsWithOrgGeogebraCommonKernelAlgosAlgoElement:self withJavaUtilSet:dependentFromFunctions_ withJavaUtilSet:new_JavaUtilTreeSet_init()];
  }
...
void OrgGeogebraCommonKernelImplicitAlgoDependentImplicitPoly_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticEquation_withBoolean_(OrgGeogebraCommonKernelImplicitAlgoDependentImplicitPoly *self, OrgGeogebraCommonKernelConstruction *c, OrgGeogebraCommonKernelArithmeticEquation *equ, jboolean simplify) {
  ...
  self->coeff_ = [((OrgGeogebraCommonKernelArithmeticPolynomial *) nil_chk(lhs)) getCoeff];
    ...
    for (jint j = 0; j < ((IOSObjectArray *) nil_chk(IOSObjectArray_Get(self->coeff_, i)))->size_; j++) {
      if (IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(self->coeff_, i)), j) != nil) {
        if (simplify && ![((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(self->coeff_, i)), j))) inspectWithOrgGeogebraCommonKernelArithmeticInspecting:OrgGeogebraCommonKernelArithmeticInspecting_get_dynamicGeosFinder_()]) {
          (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(self->coeff_, i)), j, [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(self->coeff_, i)), j))) evaluateWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]);
        }
  ...
  if ([equ isForcedLine]) {
    self->geoElement_ = new_OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelConstruction_(c);
  }
  else if ([equ isForcedConic]) {
    self->geoElement_ = new_OrgGeogebraCommonKernelGeosGeoConic_initWithOrgGeogebraCommonKernelConstruction_(c);
  }
  else if ([equ isForcedImplicitPoly]) {
    self->geoElement_ = new_OrgGeogebraCommonKernelImplicitGeoImplicitPoly_initWithOrgGeogebraCommonKernelConstruction_(c);
  }
  else {
    switch ([equ degree]) {
      case 1:
...
void OrgGeogebraCommonKernelImplicitAlgoDependentImplicitPoly_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticEquation_withBoolean_(OrgGeogebraCommonKernelImplicitAlgoDependentImplicitPoly *self, OrgGeogebraCommonKernelConstruction *c, NSString *label, OrgGeogebraCommonKernelArithmeticEquation *equ, jboolean simplify) {
  (void) OrgGeogebraCommonKernelImplicitAlgoDependentImplicitPoly_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticEquation_withBoolean_(self, c, equ, simplify);
...
void OrgGeogebraCommonKernelImplicitAlgoDependentImplicitPoly_computeWithBoolean_(OrgGeogebraCommonKernelImplicitAlgoDependentImplicitPoly *self, jboolean first) {
  if (!first) {
    if ([((OrgGeogebraCommonKernelArithmeticEquation *) nil_chk(self->equation_)) isFunctionDependent]) {
      id<JavaUtilSet> functions = new_JavaUtilHashSet_init();
      [self addAllFunctionalDescendentsWithOrgGeogebraCommonKernelAlgosAlgoElement:self withJavaUtilSet:functions withJavaUtilSet:new_JavaUtilTreeSet_init()];
      if (![functions isEqual:self->dependentFromFunctions_]) {
        [self->equation_ initEquation];
        self->coeff_ = [((OrgGeogebraCommonKernelArithmeticPolynomial *) nil_chk([self->equation_ getNormalForm])) getCoeff];
        self->dependentFromFunctions_ = functions;
      }
    }
  ...
  switch (degree) {
    ...
    if ([self->geoElement_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoLine class]]) {
      ...
      if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(self->geoElement_)) hasChildren]) [self->geoElement_ setUndefined];
        ...
        [self replaceGeoElementWithOrgGeogebraCommonKernelGeosGeoElement:new_OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelConstruction_([self getConstruction])];
        OrgGeogebraCommonKernelImplicitAlgoDependentImplicitPoly_setLine(self);
      }
    }
    break;
    ...
    if ([self->geoElement_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoConic class]]) {
      ...
      if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(self->geoElement_)) hasChildren]) [self->geoElement_ setUndefined];
        ...
        [self replaceGeoElementWithOrgGeogebraCommonKernelGeosGeoElement:new_OrgGeogebraCommonKernelGeosGeoConic_initWithOrgGeogebraCommonKernelConstruction_([self getConstruction])];
        OrgGeogebraCommonKernelImplicitAlgoDependentImplicitPoly_setConic(self);
      }
    }
    break;
    ...
    if ([self->geoElement_ isKindOfClass:[OrgGeogebraCommonKernelImplicitGeoImplicitPoly class]]) {
      ...
      if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(self->geoElement_)) hasChildren]) [self->geoElement_ setUndefined];
        ...
        [self replaceGeoElementWithOrgGeogebraCommonKernelGeosGeoElement:new_OrgGeogebraCommonKernelImplicitGeoImplicitPoly_initWithOrgGeogebraCommonKernelConstruction_([self getConstruction])];
...
void OrgGeogebraCommonKernelImplicitAlgoDependentImplicitPoly_setLine(OrgGeogebraCommonKernelImplicitAlgoDependentImplicitPoly *self) {
  IOSObjectArray *expr = [IOSObjectArray newArrayWithLength:3 type:OrgGeogebraCommonKernelArithmeticExpressionValue_class_()];
  (void) IOSObjectArray_Set(expr, 2, IOSObjectArray_Set(expr, 1, IOSObjectArray_Set(expr, 0, nil)));
  if (((IOSObjectArray *) nil_chk(self->coeff_))->size_ > 0) {
    if (((IOSObjectArray *) nil_chk(IOSObjectArray_Get(self->coeff_, 0)))->size_ > 0) {
      (void) IOSObjectArray_Set(expr, 2, IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(self->coeff_, 0)), 0));
      if (((IOSObjectArray *) nil_chk(IOSObjectArray_Get(self->coeff_, 0)))->size_ > 1) {
        (void) IOSObjectArray_Set(expr, 1, IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(self->coeff_, 0)), 1));
      }
    }
    if (self->coeff_->size_ > 1) {
      if (((IOSObjectArray *) nil_chk(IOSObjectArray_Get(self->coeff_, 1)))->size_ > 0) {
        (void) IOSObjectArray_Set(expr, 0, IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(self->coeff_, 1)), 0));
      }
    }
  }
  IOSDoubleArray *dCoeff = [IOSDoubleArray newArrayWithLength:expr->size_];
...
void OrgGeogebraCommonKernelImplicitAlgoDependentImplicitPoly_setConic(OrgGeogebraCommonKernelImplicitAlgoDependentImplicitPoly *self) {
  IOSObjectArray *expr = [IOSObjectArray newArrayWithLength:6 type:OrgGeogebraCommonKernelArithmeticExpressionValue_class_()];
  for (jint i = 0; i < 6; i++) {
    (void) IOSObjectArray_Set(expr, i, nil);
  }
  if (((IOSObjectArray *) nil_chk(self->coeff_))->size_ > 0) {
    if (((IOSObjectArray *) nil_chk(IOSObjectArray_Get(self->coeff_, 0)))->size_ > 0) {
      (void) IOSObjectArray_Set(expr, 5, IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(self->coeff_, 0)), 0));
      if (((IOSObjectArray *) nil_chk(IOSObjectArray_Get(self->coeff_, 0)))->size_ > 1) {
        (void) IOSObjectArray_Set(expr, 4, IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(self->coeff_, 0)), 1));
        if (((IOSObjectArray *) nil_chk(IOSObjectArray_Get(self->coeff_, 0)))->size_ > 2) {
          (void) IOSObjectArray_Set(expr, 2, IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(self->coeff_, 0)), 2));
        }
      }
    }
    if (self->coeff_->size_ > 1) {
      if (((IOSObjectArray *) nil_chk(IOSObjectArray_Get(self->coeff_, 1)))->size_ > 0) {
        (void) IOSObjectArray_Set(expr, 3, IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(self->coeff_, 1)), 0));
        if (((IOSObjectArray *) nil_chk(IOSObjectArray_Get(self->coeff_, 1)))->size_ > 1) {
          (void) IOSObjectArray_Set(expr, 1, IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(self->coeff_, 1)), 1));
        }
      }
      if (self->coeff_->size_ > 2) {
        if (((IOSObjectArray *) nil_chk(IOSObjectArray_Get(self->coeff_, 2)))->size_ > 0) {
          (void) IOSObjectArray_Set(expr, 0, IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(self->coeff_, 2)), 0));
        }
      }
    }
  }
