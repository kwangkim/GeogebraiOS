...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/implicit/GeoImplicitCurve.java
//
...
- (OrgGeogebraCommonKernelGeosGeoElement *)copy__ {
  OrgGeogebraCommonKernelImplicitGeoImplicitCurve *curve = [new_OrgGeogebraCommonKernelImplicitGeoImplicitCurve_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
...
- (void)updatePathWithDouble:(jdouble)rectX
  ...
  OrgGeogebraCommonKernelImplicitGeoImplicitCurve_setAndConsume_grid_(self, [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ gridHeight_, gridWidth_ }]);
...
void OrgGeogebraCommonKernelImplicitGeoImplicitCurve_initWithOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonKernelImplicitGeoImplicitCurve *self, OrgGeogebraCommonKernelConstruction *c) {
  ...
  self->defined_ = YES;
  OrgGeogebraCommonKernelImplicitGeoImplicitCurve_setAndConsume_evalArray_(self, [IOSDoubleArray newArrayWithLength:2]);
  OrgGeogebraCommonKernelImplicitGeoImplicitCurve_setAndConsume_eval_(self, [IOSDoubleArray newArrayWithLength:2]);
  OrgGeogebraCommonKernelImplicitGeoImplicitCurve_setAndConsume_locus_(self, new_OrgGeogebraCommonKernelGeosGeoLocus_initWithOrgGeogebraCommonKernelConstruction_(c));
...
void OrgGeogebraCommonKernelImplicitGeoImplicitCurve_fromEquationWithOrgGeogebraCommonKernelArithmeticEquation_(OrgGeogebraCommonKernelImplicitGeoImplicitCurve *self, OrgGeogebraCommonKernelArithmeticEquation *equation) {
  OrgGeogebraCommonKernelImplicitGeoImplicitCurve_set_equation_(self, equation);
  ...
  [functionExpression traverseWithOrgGeogebraCommonKernelArithmeticTraversing:repl];
  OrgGeogebraCommonKernelImplicitGeoImplicitCurve_setAndConsume_expression_(self, new_OrgGeogebraCommonKernelArithmeticFunctionNVar_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionVariableArray_(functionExpression, [IOSObjectArray arrayWithObjects:(id[]){ x, y } count:2 type:OrgGeogebraCommonKernelArithmeticFunctionVariable_class_()]));
}
...
IOSObjectArray *OrgGeogebraCommonKernelImplicitGeoImplicitCurve_getPointsForGridWithInt_withInt_(OrgGeogebraCommonKernelImplicitGeoImplicitCurve *self, jint i, jint j) {
  ...
  switch ([gridType ordinal]) {
    ...
    P = [new_OrgGeogebraCommonKernelMyPoint_initWithDouble_withDouble_withBoolean_(px, py, NO) autorelease];
    Q = [new_OrgGeogebraCommonKernelMyPoint_initWithDouble_withDouble_withBoolean_(qx, qy, YES) autorelease];
    return [IOSObjectArray arrayWithObjects:(id[]){ P, Q } count:2 type:OrgGeogebraCommonKernelMyPoint_class_()];
    ...
    P = [new_OrgGeogebraCommonKernelMyPoint_initWithDouble_withDouble_withBoolean_(0, 0, NO) autorelease];
    Q = [new_OrgGeogebraCommonKernelMyPoint_initWithDouble_withDouble_withBoolean_(0, 0, YES) autorelease];
    return [IOSObjectArray arrayWithObjects:(id[]){ P, Q } count:2 type:OrgGeogebraCommonKernelMyPoint_class_()];
