...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/kernel/SystemOfEquationsSolver.java
//
...
@interface OrgGeogebraCommonKernelSystemOfEquationsSolver () {
 @public
  jdouble epsilon_;
...
J2OBJC_FIELD_SETTER(OrgGeogebraCommonKernelSystemOfEquationsSolver, eqnSolver_, id<OrgGeogebraCommonKernelEquationSolverInterface>)

@implementation OrgGeogebraCommonKernelSystemOfEquationsSolver
...
- (instancetype)initWithOrgGeogebraCommonKernelEquationSolverInterface:(id<OrgGeogebraCommonKernelEquationSolverInterface>)eqnSolver {
  OrgGeogebraCommonKernelSystemOfEquationsSolver_initWithOrgGeogebraCommonKernelEquationSolverInterface_(self, eqnSolver);
  return self;
}
...
- (jint)solveSystemOfQuadraticEquationsWithDoubleArray:(IOSDoubleArray *)eqn1
  ...
  JavaUtilArrayList *xs = new_JavaUtilArrayList_init();
  JavaUtilArrayList *ys = new_JavaUtilArrayList_init();
  ...
  IOSDoubleArray *quarticParams = [IOSDoubleArray newArrayWithLength:5];
  ...
  *IOSDoubleArray_GetRef(quarticParams, 4) = d01 * d13 - d22 * d22;
  IOSDoubleArray *quarticRoots = [IOSDoubleArray newArrayWithLength:4];
  jint solnr = [((id<OrgGeogebraCommonKernelEquationSolverInterface>) nil_chk(eqnSolver_)) solveQuarticWithDoubleArray:quarticParams withDoubleArray:quarticRoots withDouble:eps];
  JavaUtilArrays_sortWithDoubleArray_withInt_withInt_(quarticRoots, 0, solnr);
  for (jint i = 0; i < solnr; i++) {
    IOSDoubleArray *quadraticParams = [IOSDoubleArray newArrayWithLength:3];
    ...
    *IOSDoubleArray_GetRef(quadraticParams, 0) = a02 * IOSDoubleArray_Get(quarticRoots, i) * IOSDoubleArray_Get(quarticRoots, i) + a01 * IOSDoubleArray_Get(quarticRoots, i) + a00;
    IOSDoubleArray *quadraticRoots = [IOSDoubleArray newArrayWithLength:3];
  ...
  for (jint i = 0; i < [xs size]; i++) for (jint j = i + 1; j < [xs size]; j++) if (JavaLangMath_absWithDouble_([((JavaLangDouble *) nil_chk([xs getWithInt:i])) doubleValue] - [((JavaLangDouble *) nil_chk([xs getWithInt:j])) doubleValue]) < epsilon_ && JavaLangMath_absWithDouble_([((JavaLangDouble *) nil_chk([ys getWithInt:i])) doubleValue] - [((JavaLangDouble *) nil_chk([ys getWithInt:j])) doubleValue]) < epsilon_) {
    (void) [xs removeWithInt:j];
    (void) [ys removeWithInt:j];
    j--;
  }
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithOrgGeogebraCommonKernelEquationSolverInterface:", "SystemOfEquationsSolver", NULL, 0x1, NULL, NULL },
  ...
  static const J2ObjcClassInfo _OrgGeogebraCommonKernelSystemOfEquationsSolver = { 2, "SystemOfEquationsSolver", "org.geogebra.common.kernel", NULL, 0x1, 3, methods, 2, fields, 0, NULL, 0, NULL, NULL, NULL };
  return &_OrgGeogebraCommonKernelSystemOfEquationsSolver;
}

@end

void OrgGeogebraCommonKernelSystemOfEquationsSolver_initWithOrgGeogebraCommonKernelEquationSolverInterface_(OrgGeogebraCommonKernelSystemOfEquationsSolver *self, id<OrgGeogebraCommonKernelEquationSolverInterface> eqnSolver) {
  (void) NSObject_init(self);
  self->epsilon_ = OrgGeogebraCommonKernelKernel_STANDARD_PRECISION;
  self->eqnSolver_ = eqnSolver;
}

OrgGeogebraCommonKernelSystemOfEquationsSolver *new_OrgGeogebraCommonKernelSystemOfEquationsSolver_initWithOrgGeogebraCommonKernelEquationSolverInterface_(id<OrgGeogebraCommonKernelEquationSolverInterface> eqnSolver) {
  OrgGeogebraCommonKernelSystemOfEquationsSolver *self = [OrgGeogebraCommonKernelSystemOfEquationsSolver alloc];
  OrgGeogebraCommonKernelSystemOfEquationsSolver_initWithOrgGeogebraCommonKernelEquationSolverInterface_(self, eqnSolver);
  return self;
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgGeogebraCommonKernelSystemOfEquationsSolver)
