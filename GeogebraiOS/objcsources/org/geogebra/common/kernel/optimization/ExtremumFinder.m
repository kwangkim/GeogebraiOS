...
withOrgGeogebraCommonKernelRootsRealRootFunction:(id<OrgGeogebraCommonKernelRootsRealRootFunction>)maxfunction
  ...
  OrgGeogebraCommonKernelOptimizationNegativeRealRootFunction *minfunc = [new_OrgGeogebraCommonKernelOptimizationNegativeRealRootFunction_initWithOrgGeogebraCommonKernelRootsRealRootFunction_(maxfunction) autorelease];
