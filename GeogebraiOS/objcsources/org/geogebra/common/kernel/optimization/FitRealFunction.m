...
- (IOSDoubleArray *)gradientWithDouble:(jdouble)x
  ...
  IOSDoubleArray *gradient = [IOSDoubleArray newArrayWithLength:numberOfParameters_];
...
- (void)setFunctionWithOrgGeogebraCommonKernelArithmeticFunction:(OrgGeogebraCommonKernelArithmeticFunction *)f {
  kernel_ = [((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk(f)) getKernel];
  ...
  if (hash_ == nil) {
    ...
    gliders_ = [hash_ toArray];
  }
  numberOfParameters_ = ((IOSObjectArray *) nil_chk(gliders_))->size_;
  mydoubles_ = [IOSObjectArray newArrayWithLength:numberOfParameters_ type:OrgGeogebraCommonKernelArithmeticMyDouble_class_()];
  jdouble temp;
  for (jint i = 0; i < numberOfParameters_; i++) {
    ...
    (void) IOSObjectArray_Set(mydoubles_, i, new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_(kernel_));
  ...
  self->newf_ = new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionVariable_(enf, fvar);
}
...
- (IOSDoubleArray *)getStartValues {
  IOSDoubleArray *startvalues = [IOSDoubleArray newArrayWithLength:numberOfParameters_];
  for (jint i = 0; i < numberOfParameters_; i++) {
