...
- (NSString *)plusStringWithOrgGeogebraCommonKernelArithmeticExpressionValue:(id<OrgGeogebraCommonKernelArithmeticExpressionValue>)l
  ...
  switch ([stringType_ ordinal]) {
    ...
    if ([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(left)) evaluatesToList] && [OrgGeogebraCommonKernelArithmeticNumberValue_class_() isInstance:right]) {
      ...
      (void) [sb appendWithNSString:@",ggx->ggx+"];
      ...
      (void) [sb appendWithNSString:@"point(real("];
      (void) [sb appendWithNSString:rightStr];
      (void) [sb appendWithNSString:@"[1])+"];
      (void) [sb appendWithNSString:leftStr];
      (void) [sb appendWithNSString:@",im("];
      (void) [sb appendWithNSString:rightStr];
      (void) [sb appendWithNSString:@"[1])+"];
      (void) [sb appendWithNSString:leftStr];
    ...
    if ([left isKindOfClass:[OrgGeogebraCommonKernelArithmeticEquation class]]) {
      (void) [sb appendWithNSString:[self leftBracket]];
      (void) [sb appendWithNSString:leftStr];
      (void) [sb appendWithNSString:[self rightBracket]];
    }
    else {
      (void) [sb appendWithNSString:leftStr];
    }
    if ([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(left)) evaluatesToText] && (![((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(right)) isLeaf] || ([right isGeoElement] && ![((OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(right, [OrgGeogebraCommonKernelGeosGeoElement class])) isLabelSet]))) {
      ...
      if ([((NSString *) nil_chk(rightStr)) charAtWithInt:0] == '-') {
        ...
        (void) [sb appendWithNSString:[rightStr substring:1]];
      }
...
- (NSString *)minusStringWithOrgGeogebraCommonKernelArithmeticExpressionValue:(id<OrgGeogebraCommonKernelArithmeticExpressionValue>)l
  ...
  switch ([stringType_ ordinal]) {
    ...
    if ([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(left)) evaluatesToList] && [OrgGeogebraCommonKernelArithmeticNumberValue_class_() isInstance:right]) {
      ...
      (void) [sb appendWithNSString:@"map("];
      (void) [sb appendWithNSString:rightStr];
      (void) [sb appendWithNSString:@",ggx->"];
      (void) [sb appendWithNSString:leftStr];
      (void) [sb appendWithNSString:@"-ggx)"];
    }
    else if ([OrgGeogebraCommonKernelArithmeticNumberValue_class_() isInstance:left] && [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(right)) evaluatesToNonComplex2DVector]) {
      (void) [sb appendWithNSString:@"point("];
      (void) [sb appendWithNSString:leftStr];
      (void) [sb appendWithNSString:@"-real("];
      (void) [sb appendWithNSString:rightStr];
      (void) [sb appendWithNSString:@"[1])"];
      (void) [sb appendWithNSString:@","];
      (void) [sb appendWithNSString:leftStr];
    ...
    if ([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(right)) isLeaf] || (OrgGeogebraCommonKernelArithmeticExpressionNode_opIDWithOrgGeogebraCommonKernelArithmeticExpressionValue_(right) >= [((OrgGeogebraCommonPluginOperationEnum *) nil_chk(OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY())) ordinal])) {
      if ([((NSString *) nil_chk(rightStr)) charAtWithInt:0] == '-') {
        ...
        (void) [sb appendWithNSString:[rightStr substring:3]];
      }
      else {
        if ([((OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum *) nil_chk(stringType_)) isEqual:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_LATEX()] && [self isInsertLineBreaks]) {
          (void) [sb appendWithNSString:@" \\-- "];
  ...
  OrgGeogebraCommonPluginOperationEnum *operation = OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY();
  {
    ...
    switch ([stringType_ ordinal]) {
      ...
      if (OrgGeogebraCommonKernelArithmeticExpressionNode_isEqualStringWithOrgGeogebraCommonKernelArithmeticExpressionValue_withDouble_withBoolean_(left, 1, !valueForm)) {
        ...
        if (rtl) {
          (void) [sb appendWithNSString:OrgGeogebraCommonUtilUnicode_get_DEGREE_()];
        }
      ...
      if ([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(left)) isLeaf] || (OrgGeogebraCommonKernelArithmeticExpressionNode_opIDWithOrgGeogebraCommonKernelArithmeticExpressionValue_(left) >= [((OrgGeogebraCommonPluginOperationEnum *) nil_chk(OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY())) ordinal])) {
        if (OrgGeogebraCommonKernelArithmeticExpressionNode_isEqualStringWithOrgGeogebraCommonKernelArithmeticExpressionValue_withDouble_withBoolean_(left, -1, !valueForm)) {
          ...
          if ([((NSString *) nil_chk(leftStr)) hasPrefix:OrgGeogebraCommonUtilUnicode_get_RightToLeftUnaryMinusSign_()]) {
            (void) [sb appendWithChar:OrgGeogebraCommonUtilUnicode_RightToLeftMark];
            (void) [sb appendWithNSString:[self leftBracket]];
            (void) [sb appendWithNSString:leftStr];
            (void) [sb appendWithNSString:[self rightBracket]];
            (void) [sb appendWithChar:OrgGeogebraCommonUtilUnicode_RightToLeftMark];
      ...
      if ([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(right)) isLeaf] || (opIDright >= [((OrgGeogebraCommonPluginOperationEnum *) nil_chk(OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY())) ordinal])) {
        ...
        if (nounary) {
          ...
          if (showMultiplicationSign) {
            (void) [sb appendWithNSString:[self multiplicationSign]];
          }
          else if (multiplicationSpaceNeeded) {
            (void) [sb appendWithNSString:[self multiplicationSpace]];
          }
        }
        jboolean rtlMinus;
      ...
      if ([left isKindOfClass:[OrgGeogebraCommonKernelArithmeticMySpecialDouble class]] && [right isKindOfClass:[OrgGeogebraCommonKernelArithmeticExpressionNode class]] && [((OrgGeogebraCommonPluginOperationEnum *) nil_chk([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(((OrgGeogebraCommonKernelArithmeticExpressionNode *) check_class_cast(right, [OrgGeogebraCommonKernelArithmeticExpressionNode class])))) getOperation])) isInequality]) {
        ...
        (void) [sb appendWithNSString:leftStr];
        (void) [sb appendWithNSString:@")*("];
        (void) [sb appendWithNSString:[self expToStringWithOrgGeogebraCommonKernelArithmeticExpressionValue:[((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(((OrgGeogebraCommonKernelArithmeticExpressionNode *) check_class_cast(right, [OrgGeogebraCommonKernelArithmeticExpressionNode class])))) getLeft] withBoolean:valueForm]];
        (void) [sb appendWithChar:')'];
        (void) [sb appendWithNSString:OrgGeogebraCommonKernelStringTemplate_opWithOrgGeogebraCommonKernelArithmeticExpressionNode_withBoolean_((OrgGeogebraCommonKernelArithmeticExpressionNode *) check_class_cast(right, [OrgGeogebraCommonKernelArithmeticExpressionNode class]), reverse)];
        (void) [sb appendWithChar:'('];
        (void) [sb appendWithNSString:leftStr];
        (void) [sb appendWithNSString:@")*("];
        (void) [sb appendWithNSString:[self expToStringWithOrgGeogebraCommonKernelArithmeticExpressionValue:[((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(((OrgGeogebraCommonKernelArithmeticExpressionNode *) check_class_cast(right, [OrgGeogebraCommonKernelArithmeticExpressionNode class])))) getRight] withBoolean:valueForm]];
        (void) [sb appendWithChar:')'];
      }
        ...
        (void) [sb appendWithNSString:rightStr];
        (void) [sb appendWithNSString:@")*("];
        (void) [sb appendWithNSString:[self expToStringWithOrgGeogebraCommonKernelArithmeticExpressionValue:[((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(((OrgGeogebraCommonKernelArithmeticExpressionNode *) check_class_cast(left, [OrgGeogebraCommonKernelArithmeticExpressionNode class])))) getLeft] withBoolean:valueForm]];
        (void) [sb appendWithChar:')'];
        (void) [sb appendWithNSString:OrgGeogebraCommonKernelStringTemplate_opWithOrgGeogebraCommonKernelArithmeticExpressionNode_withBoolean_((OrgGeogebraCommonKernelArithmeticExpressionNode *) check_class_cast(left, [OrgGeogebraCommonKernelArithmeticExpressionNode class]), reverse)];
        (void) [sb appendWithChar:'('];
        (void) [sb appendWithNSString:rightStr];
        (void) [sb appendWithNSString:@")*("];
        (void) [sb appendWithNSString:[self expToStringWithOrgGeogebraCommonKernelArithmeticExpressionValue:[((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(((OrgGeogebraCommonKernelArithmeticExpressionNode *) check_class_cast(left, [OrgGeogebraCommonKernelArithmeticExpressionNode class])))) getRight] withBoolean:valueForm]];
        (void) [sb appendWithChar:')'];
      }
...
withOrgGeogebraCommonPluginOperationEnum:(OrgGeogebraCommonPluginOperationEnum *)op {
  if ([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(ev)) isLeaf] || ((OrgGeogebraCommonKernelArithmeticExpressionNode_opIDWithOrgGeogebraCommonKernelArithmeticExpressionValue_(ev) >= [((OrgGeogebraCommonPluginOperationEnum *) nil_chk(op)) ordinal]) && (!OrgGeogebraCommonKernelArithmeticExpressionNode_chainedBooleanOpWithOrgGeogebraCommonPluginOperationEnum_(op) || !OrgGeogebraCommonKernelArithmeticExpressionNode_chainedBooleanOpWithOrgGeogebraCommonPluginOperationEnum_([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([ev wrap])) getOperation])))) {
    (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:str];
  }
  else {
    (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:[self leftBracket]];
...
- (NSString *)divideStringWithOrgGeogebraCommonKernelArithmeticExpressionValue:(id<OrgGeogebraCommonKernelArithmeticExpressionValue>)left
  ...
  switch ([stringType_ ordinal]) {
    ...
    if (([((NSString *) nil_chk(leftStr)) charAtWithInt:0] == '-') && ([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(left)) isLeaf] || ([left isKindOfClass:[OrgGeogebraCommonKernelArithmeticExpressionNode class]] && OrgGeogebraCommonKernelArithmeticExpressionNode_isMultiplyOrDivideWithOrgGeogebraCommonKernelArithmeticExpressionNode_((OrgGeogebraCommonKernelArithmeticExpressionNode *) check_class_cast(left, [OrgGeogebraCommonKernelArithmeticExpressionNode class]))))) {
      (void) [sb appendWithNSString:@"-\\frac{"];
      (void) [sb appendWithNSString:[leftStr substring:1]];
      (void) [sb appendWithNSString:@"}{"];
      (void) [sb appendWithNSString:rightStr];
      (void) [sb appendWithNSString:@"}"];
    }
    ...
    (void) [sb appendWithNSString:@"{ "];
    (void) [sb appendWithNSString:leftStr];
    (void) [sb appendWithNSString:@" } over { "];
    (void) [sb appendWithNSString:rightStr];
    (void) [sb appendWithNSString:@" }"];
    break;
    case OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringType_GIAC:
...
- (NSString *)notStringWithOrgGeogebraCommonKernelArithmeticExpressionValue:(id<OrgGeogebraCommonKernelArithmeticExpressionValue>)left
  ...
  if ([((OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum *) nil_chk(stringType_)) isEqual:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_MATHML()]) {
    ...
    switch ([stringType_ ordinal]) {
      ...
      break;
      case OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringType_LIBRE_OFFICE:
      (void) [sb appendWithNSString:@"neg "];
      break;
      default:
      (void) [sb appendWithNSString:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_get_strNOT_()];
    }
    if ([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(left)) isLeaf]) {
      (void) [sb appendWithNSString:leftStr];
    }
...
- (NSString *)orStringWithOrgGeogebraCommonKernelArithmeticExpressionValue:(id<OrgGeogebraCommonKernelArithmeticExpressionValue>)left
  ...
  if ([((OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum *) nil_chk(stringType_)) isEqual:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_MATHML()]) {
    ...
    switch ([stringType_ ordinal]) {
      ...
      (void) [sb appendWithNSString:@"\\vee"];
      break;
      case OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringType_LIBRE_OFFICE:
      ...
      break;
      default:
      (void) [sb appendWithNSString:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_get_strOR_()];
    }
    (void) [sb appendWithChar:' '];
...
withOrgGeogebraCommonKernelArithmeticExpressionValue:(id<OrgGeogebraCommonKernelArithmeticExpressionValue>)right
  ...
  (void) [sb appendWithNSString:operationString];
  (void) [sb appendWithChar:' '];
...
- (NSString *)andIntervalStringWithOrgGeogebraCommonKernelArithmeticExpressionValue:(id<OrgGeogebraCommonKernelArithmeticExpressionValue>)left
  ...
  if ([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(right)) isExpressionNode]) {
    (void) [sb appendWithNSString:[((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(left)) wrap])) getCASstringWithOrgGeogebraCommonKernelStringTemplate:self withBoolean:!valueForm]];
    (void) [sb appendWithChar:' '];
    ...
    (void) [sb appendWithChar:' '];
    (void) [sb appendWithNSString:[((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((OrgGeogebraCommonKernelArithmeticExpressionNode *) check_class_cast(right, [OrgGeogebraCommonKernelArithmeticExpressionNode class])) getRightTree])) getCASstringWithOrgGeogebraCommonKernelStringTemplate:self withBoolean:!valueForm]];
    return [sb description];
  }
  return [self andStringWithOrgGeogebraCommonKernelArithmeticExpressionValue:left withOrgGeogebraCommonKernelArithmeticExpressionValue:right withNSString:leftStr withNSString:rightStr];
}
...
- (NSString *)andStringWithOrgGeogebraCommonKernelArithmeticExpressionValue:(id<OrgGeogebraCommonKernelArithmeticExpressionValue>)left
  ...
  if ([((OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum *) nil_chk(stringType_)) isEqual:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_MATHML()]) {
    ...
    switch ([stringType_ ordinal]) {
      ...
      (void) [sb appendWithNSString:@"\\wedge"];
      break;
      case OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringType_LIBRE_OFFICE:
      (void) [sb appendWithNSString:@"and"];
      break;
      case OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringType_GIAC:
      (void) [sb appendWithNSString:@"&&"];
      break;
      default:
      (void) [sb appendWithNSString:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_get_strAND_()];
    }
    (void) [sb appendWithChar:' '];
  ...
  if ([((OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum *) nil_chk(stringType_)) isEqual:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_MATHML()]) {
    ...
    if ([stringType_ isEqual:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_LATEX()] && [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(left)) isExpressionNode]) {
      {
        ...
        switch ([[((OrgGeogebraCommonKernelArithmeticExpressionNode *) check_class_cast(left, [OrgGeogebraCommonKernelArithmeticExpressionNode class])) getOperation] ordinal]) {
          ...
          if (!(JavaLangDouble_isInfiniteWithDouble_(indexD) || JavaLangDouble_isNaNWithDouble_(indexD)) && (index > 0)) {
            ...
            (void) [sb appendWithNSString:[leftStrTrimmed substring:0 endIndex:spaceIndex]];
            (void) [sb appendWithNSString:@" ^{"];
            (void) [sb appendWithNSString:rightStr];
            (void) [sb appendWithNSString:@"}"];
            (void) [sb appendWithNSString:[leftStrTrimmed substring:spaceIndex + 1]];
            finished = YES;
            break;
          }
          default:
    ...
    switch ([stringType_ ordinal]) {
      ...
      if ([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(right)) isExpressionNode] && [((OrgGeogebraCommonKernelArithmeticExpressionNode *) check_class_cast(right, [OrgGeogebraCommonKernelArithmeticExpressionNode class])) getOperation] == OrgGeogebraCommonPluginOperationEnum_get_DIVIDE()) {
        ...
        (void) [sb appendWithNSString:@"simplify(surd("];
        (void) [sb appendWithNSString:leftStr];
        (void) [sb appendWithChar:','];
        (void) [sb appendWithNSString:[self expToStringWithOrgGeogebraCommonKernelArithmeticExpressionValue:[enR getRight] withBoolean:valueForm]];
        (void) [sb appendWithNSString:@")"];
        (void) [sb appendWithNSString:@"^("];
        (void) [sb appendWithNSString:[self expToStringWithOrgGeogebraCommonKernelArithmeticExpressionValue:[enR getLeft] withBoolean:valueForm]];
        (void) [sb appendWithNSString:@"))"];
      }
      else {
        (void) [sb appendWithNSString:@"("];
      ...
      switch ([stringType_ ordinal]) {
        ...
        if ([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(right)) isLeaf] || ((OrgGeogebraCommonKernelArithmeticExpressionNode_opIDWithOrgGeogebraCommonKernelArithmeticExpressionValue_(right) > [((OrgGeogebraCommonPluginOperationEnum *) nil_chk(OrgGeogebraCommonPluginOperationEnum_get_POWER())) ordinal]) && (OrgGeogebraCommonKernelArithmeticExpressionNode_opIDWithOrgGeogebraCommonKernelArithmeticExpressionValue_(right) != [((OrgGeogebraCommonPluginOperationEnum *) nil_chk(OrgGeogebraCommonPluginOperationEnum_get_EXP())) ordinal]))) {
          @try {
            ...
            NSString *index = @"";
            if (i < 0) {
              (void) [sb appendWithChar:0x207b];
              i = -i;
            }
            if (i == 0) {
              (void) [sb appendWithChar:0x2070];
            }
            else {
              while (i > 0) {
                switch (i % 10) {
...
- (NSString *)convertScientificNotationWithNSString:(NSString *)scientificStr {
  ...
  JavaLangStringBuilder *sb = new_JavaLangStringBuilder_initWithInt_(((jint) [((NSString *) nil_chk(scientificStr)) length]) * 2);
  jboolean Efound = NO;
  for (jint i = 0; i < ((jint) [scientificStr length]); i++) {
    ...
    if (ch == 'E') {
      if ([self hasTypeWithOrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_LATEX()]) {
        (void) [sb appendWithNSString:@" \\cdot 10^{"];
      }
      else {
        (void) [sb appendWithNSString:@"*10^("];
      }
      Efound = YES;
    }
    else if (ch != '+') {
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonKernelStringTemplate class]) {
    OrgGeogebraCommonKernelStringTemplate_noLocalDefault_ = new_OrgGeogebraCommonKernelStringTemplate_initWithNSString_(@"nonLocalDefault");
    {
      OrgGeogebraCommonKernelStringTemplate_noLocalDefault_->localizeCmds_ = NO;
    }
    OrgGeogebraCommonKernelStringTemplate_prefixedDefault_ = new_OrgGeogebraCommonKernelStringTemplate_$1_initWithNSString_(@"prefixedDefault");
    {
      ...
      OrgGeogebraCommonKernelStringTemplate_prefixedDefault_->nf_ = [((OrgGeogebraCommonFactoriesFormatFactory *) nil_chk(OrgGeogebraCommonFactoriesFormatFactory_get_prototype_())) getNumberFormatWithInt:15];
    }
    OrgGeogebraCommonKernelStringTemplate_defaultTemplate_ = new_OrgGeogebraCommonKernelStringTemplate_initWithNSString_(@"defaultTemplate");
    OrgGeogebraCommonKernelStringTemplate_defaultTemplateLocal_ = new_OrgGeogebraCommonKernelStringTemplate_initWithNSString_(@"defaultTemplateLocal");
    {
      OrgGeogebraCommonKernelStringTemplate_defaultTemplateLocal_->localizeCmds_ = YES;
    }
    OrgGeogebraCommonKernelStringTemplate_realTemplate_ = new_OrgGeogebraCommonKernelStringTemplate_initWithNSString_(@"realTemplate");
    {
      OrgGeogebraCommonKernelStringTemplate_realTemplate_->useRealLabels_ = YES;
    }
    OrgGeogebraCommonKernelStringTemplate_latexTemplate_ = new_OrgGeogebraCommonKernelStringTemplate_initWithNSString_(@"latexTemplate");
    {
    ...
    OrgGeogebraCommonKernelStringTemplate_latexTemplateMQ_ = new_OrgGeogebraCommonKernelStringTemplate_$2_initWithNSString_(@"latexTemplate");
    {
    ...
    OrgGeogebraCommonKernelStringTemplate_mathmlTemplate_ = new_OrgGeogebraCommonKernelStringTemplate_initWithNSString_(@"mathmlTemplate");
    {
    ...
    OrgGeogebraCommonKernelStringTemplate_libreofficeTemplate_ = new_OrgGeogebraCommonKernelStringTemplate_initWithNSString_(@"libreOfficeTemplate");
    {
    ...
    OrgGeogebraCommonKernelStringTemplate_giacTemplate_ = new_OrgGeogebraCommonKernelStringTemplate_initWithNSString_(@"giacTemplate");
    {
      ...
      OrgGeogebraCommonKernelStringTemplate_giacTemplate_->nf_ = [OrgGeogebraCommonFactoriesFormatFactory_get_prototype_() getNumberFormatWithInt:15];
    }
    OrgGeogebraCommonKernelStringTemplate_xmlTemplate_ = new_OrgGeogebraCommonKernelStringTemplate_$3_initWithNSString_(@"xmlTemplate");
    {
      ...
      OrgGeogebraCommonKernelStringTemplate_xmlTemplate_->sf_ = [OrgGeogebraCommonFactoriesFormatFactory_get_prototype_() getScientificFormatWithInt:15 withInt:20 withBoolean:NO];
    }
    OrgGeogebraCommonKernelStringTemplate_editTemplate_ = new_OrgGeogebraCommonKernelStringTemplate_initWithNSString_(@"editTemplate");
    {
      OrgGeogebraCommonKernelStringTemplate_editTemplate_->sf_ = [OrgGeogebraCommonFactoriesFormatFactory_get_prototype_() getScientificFormatWithInt:OrgGeogebraCommonKernelGeosGeoElement_MIN_EDITING_PRINT_PRECISION withInt:20 withBoolean:NO];
      OrgGeogebraCommonKernelStringTemplate_editTemplate_->nf_ = [OrgGeogebraCommonFactoriesFormatFactory_get_prototype_() getNumberFormatWithInt:OrgGeogebraCommonKernelGeosGeoElement_MIN_EDITING_PRINT_PRECISION];
    ...
    OrgGeogebraCommonKernelStringTemplate_regression_ = new_OrgGeogebraCommonKernelStringTemplate_initWithNSString_(@"regression");
    {
      OrgGeogebraCommonKernelStringTemplate_regression_->sf_ = [OrgGeogebraCommonFactoriesFormatFactory_get_prototype_() getScientificFormatWithInt:6 withInt:20 withBoolean:NO];
      OrgGeogebraCommonKernelStringTemplate_regression_->nf_ = [OrgGeogebraCommonFactoriesFormatFactory_get_prototype_() getNumberFormatWithInt:6];
    ...
    OrgGeogebraCommonKernelStringTemplate_ogpTemplate_ = new_OrgGeogebraCommonKernelStringTemplate_initWithNSString_(@"ogpTemplate");
    {
      ...
      OrgGeogebraCommonKernelStringTemplate_ogpTemplate_->nf_ = [OrgGeogebraCommonFactoriesFormatFactory_get_prototype_() getNumberFormatWithInt:0];
    }
    OrgGeogebraCommonKernelStringTemplate_maxPrecision_ = new_OrgGeogebraCommonKernelStringTemplate_initWithNSString_(@"maxPrecision");
    {
      OrgGeogebraCommonKernelStringTemplate_maxPrecision_->sf_ = [OrgGeogebraCommonFactoriesFormatFactory_get_prototype_() getScientificFormatWithInt:15 withInt:20 withBoolean:NO];
    ...
    OrgGeogebraCommonKernelStringTemplate_maxPrecision13_ = new_OrgGeogebraCommonKernelStringTemplate_initWithNSString_(@"maxPrecision13");
    {
      OrgGeogebraCommonKernelStringTemplate_maxPrecision13_->sf_ = [OrgGeogebraCommonFactoriesFormatFactory_get_prototype_() getScientificFormatWithInt:13 withInt:20 withBoolean:NO];
      ...
      OrgGeogebraCommonKernelStringTemplate_maxPrecision13_->casPrintFormPI_ = @"3.141592653590";
    }
    OrgGeogebraCommonKernelStringTemplate_numericDefault_ = new_OrgGeogebraCommonKernelStringTemplate_initWithNSString_(@"numericDefault");
    {
      OrgGeogebraCommonKernelStringTemplate_numericDefault_->allowMoreDigits__ = YES;
    }
    OrgGeogebraCommonKernelStringTemplate_numericNoLocal_ = new_OrgGeogebraCommonKernelStringTemplate_initWithNSString_(@"numericNoLocal");
    {
    ...
    OrgGeogebraCommonKernelStringTemplate_numericLatex_ = new_OrgGeogebraCommonKernelStringTemplate_initWithNSString_(@"numericLatex");
    {
      OrgGeogebraCommonKernelStringTemplate_numericLatex_->stringType_ = OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_LATEX();
    ...
    OrgGeogebraCommonKernelStringTemplate_testTemplate_ = new_OrgGeogebraCommonKernelStringTemplate_initWithNSString_(@"testTemplate");
    {
      ...
      OrgGeogebraCommonKernelStringTemplate_testTemplate_->sf_ = [OrgGeogebraCommonFactoriesFormatFactory_get_prototype_() getScientificFormatWithInt:15 withInt:20 withBoolean:NO];
    }
    OrgGeogebraCommonKernelStringTemplate_testTemplateJSON_ = new_OrgGeogebraCommonKernelStringTemplate_initWithNSString_(@"testTemplate");
    {
      OrgGeogebraCommonKernelStringTemplate_testTemplate_->internationalizeDigits__ = NO;
      OrgGeogebraCommonKernelStringTemplate_testTemplate_->sf_ = [OrgGeogebraCommonFactoriesFormatFactory_get_prototype_() getScientificFormatWithInt:15 withInt:20 withBoolean:NO];
    }
    OrgGeogebraCommonKernelStringTemplate_testNumeric_ = new_OrgGeogebraCommonKernelStringTemplate_initWithNSString_(@"testNumeric");
    {
      ...
      OrgGeogebraCommonKernelStringTemplate_testNumeric_->sf_ = [OrgGeogebraCommonFactoriesFormatFactory_get_prototype_() getScientificFormatWithInt:15 withInt:20 withBoolean:NO];
    }
...
void OrgGeogebraCommonKernelStringTemplate_initWithNSString_(OrgGeogebraCommonKernelStringTemplate *self, NSString *name) {
  ...
  self->hideLHS_ = NO;
  self->precisions_ = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 1, 1E-1, 1E-2, 1E-3, 1E-4, 1E-5, 1E-6, 1E-7, 1E-8, 1E-9, 1E-10, 1E-11, 1E-12, 1E-13, 1E-14, 1E-15, 1E-16 } count:17];
...
OrgGeogebraCommonKernelStringTemplate *OrgGeogebraCommonKernelStringTemplate_getWithOrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_(OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum *t) {
  ...
  OrgGeogebraCommonKernelStringTemplate *tpl = new_OrgGeogebraCommonKernelStringTemplate_initWithNSString_(JreStrcat("$@", @"TemplateFor:", t));
...
void OrgGeogebraCommonKernelStringTemplate_setTypeWithOrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_(OrgGeogebraCommonKernelStringTemplate *self, OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum *t) {
  ...
  switch ([t ordinal]) {
    ...
    break;
    default:
    self->casPrintFormPI_ = OrgGeogebraCommonUtilUnicode_get_PI_STRING_();
  }
}
...
OrgGeogebraCommonKernelStringTemplate *OrgGeogebraCommonKernelStringTemplate_printDecimalsWithOrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_withInt_withBoolean_(OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum *type, jint decimals, jboolean allowMore) {
  OrgGeogebraCommonKernelStringTemplate_initialize();
  OrgGeogebraCommonKernelStringTemplate *tpl = new_OrgGeogebraCommonKernelStringTemplate_initWithNSString_(JreStrcat("$@$ICZ", @"TemplateFor:", type, @",Decimals:", decimals, ',', allowMore));
  tpl->forceNF_ = YES;
  ...
  tpl->nf_ = [((OrgGeogebraCommonFactoriesFormatFactory *) nil_chk(OrgGeogebraCommonFactoriesFormatFactory_get_prototype_())) getNumberFormatWithInt:decimals];
  return tpl;
}
...
OrgGeogebraCommonKernelStringTemplate *OrgGeogebraCommonKernelStringTemplate_printFiguresWithOrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_withInt_withBoolean_(OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum *type, jint decimals, jboolean allowMore) {
  OrgGeogebraCommonKernelStringTemplate_initialize();
  OrgGeogebraCommonKernelStringTemplate *tpl = new_OrgGeogebraCommonKernelStringTemplate_initWithNSString_(JreStrcat("$@$ICZ", @"TemplateFor:", type, @",Figures:", decimals, ',', allowMore));
  tpl->forceSF_ = YES;
  tpl->allowMoreDigits__ = allowMore;
  OrgGeogebraCommonKernelStringTemplate_setTypeWithOrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_(tpl, type);
  tpl->sf_ = [((OrgGeogebraCommonFactoriesFormatFactory *) nil_chk(OrgGeogebraCommonFactoriesFormatFactory_get_prototype_())) getScientificFormatWithInt:decimals withInt:20 withBoolean:NO];
  return tpl;
}
...
OrgGeogebraCommonKernelStringTemplate *OrgGeogebraCommonKernelStringTemplate_fullFiguresWithOrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_(OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum *type) {
  OrgGeogebraCommonKernelStringTemplate_initialize();
  OrgGeogebraCommonKernelStringTemplate *tpl = new_OrgGeogebraCommonKernelStringTemplate_initWithNSString_(JreStrcat("$@", @"FullFiguresFor:", type));
  tpl->forceSF_ = YES;
  tpl->allowMoreDigits__ = YES;
  OrgGeogebraCommonKernelStringTemplate_setTypeWithOrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_(tpl, type);
  tpl->sf_ = [((OrgGeogebraCommonFactoriesFormatFactory *) nil_chk(OrgGeogebraCommonFactoriesFormatFactory_get_prototype_())) getScientificFormatWithInt:16 withInt:350 withBoolean:NO];
  return tpl;
}
...
OrgGeogebraCommonKernelStringTemplate *OrgGeogebraCommonKernelStringTemplate_printScientificWithOrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_withInt_withBoolean_(OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum *type, jint decimals, jboolean allowMore) {
  OrgGeogebraCommonKernelStringTemplate_initialize();
  OrgGeogebraCommonKernelStringTemplate *tpl = new_OrgGeogebraCommonKernelStringTemplate_initWithNSString_(JreStrcat("$@$ICZ", @"TemplateForScientific:", type, @",Decimals:", decimals, ',', allowMore));
  tpl->forceSF_ = YES;
  tpl->allowMoreDigits__ = allowMore;
  OrgGeogebraCommonKernelStringTemplate_setTypeWithOrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_(tpl, type);
  tpl->sf_ = [((OrgGeogebraCommonFactoriesFormatFactory *) nil_chk(OrgGeogebraCommonFactoriesFormatFactory_get_prototype_())) getScientificFormatWithInt:decimals withInt:20 withBoolean:YES];
  return tpl;
}
...
OrgGeogebraCommonKernelStringTemplate *OrgGeogebraCommonKernelStringTemplate_copy__(OrgGeogebraCommonKernelStringTemplate *self) {
  OrgGeogebraCommonKernelStringTemplate *result = new_OrgGeogebraCommonKernelStringTemplate_initWithNSString_(JreStrcat("$$", @"CopyOf:", self->name_));
  result->stringType_ = self->stringType_;
  result->nf_ = self->nf_;
  result->sf_ = self->sf_;
  result->usePrefix_ = self->usePrefix_;
  result->allowMoreDigits__ = self->allowMoreDigits__;
  result->casPrintFormPI_ = self->casPrintFormPI_;
...
NSString *OrgGeogebraCommonKernelStringTemplate_addTempVariablePrefixWithNSString_(OrgGeogebraCommonKernelStringTemplate *self, NSString *label) {
  ...
  JavaLangStringBuilder *sb = new_JavaLangStringBuilder_init();
  (void) [sb appendWithNSString:OrgGeogebraCommonKernelKernel_get_TMP_VARIABLE_PREFIX_()];
  (void) [sb appendWithNSString:[((NSString *) nil_chk(label)) replaceAll:@"'" withReplacement:@"unicode39u"]];
  return [sb description];
}
...
NSString *OrgGeogebraCommonKernelStringTemplate_convertScientificNotationGiacWithNSString_(NSString *originalString) {
  ...
  if ([((NSString *) nil_chk(originalString)) indexOfString:@"E-"] > -1) {
    ...
    if (dotIndex > -1) {
      ...
      (void) IOSObjectArray_Set(s, 0, [((NSString *) nil_chk(IOSObjectArray_Get(s, 0))) replace:@"." withSequence:@""]);
    }
...
void OrgGeogebraCommonKernelStringTemplate_$1_initWithNSString_(OrgGeogebraCommonKernelStringTemplate_$1 *self, NSString *arg$0) {
  (void) OrgGeogebraCommonKernelStringTemplate_initWithNSString_(self, arg$0);
}
