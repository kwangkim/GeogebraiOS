...
- (jint)compareToWithId:(OrgGeogebraCommonKernelConstructionElementCycle *)cycle {
  check_class_cast(cycle, [OrgGeogebraCommonKernelConstructionElementCycle class]);
...
- (NSString *)description {
  ...
  for (jint i = 0; i < [self size]; i++) {
    [sb appendWithNSString:[((OrgGeogebraCommonKernelAlgosConstructionElement *) nil_chk(OrgGeogebraCommonKernelConstructionElementCycle_getCycleNext(self))) description]];
...
OrgGeogebraCommonKernelConstructionElementCycle *OrgGeogebraCommonKernelConstructionElementCycle_SegmentDescriptionWithOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoElement_(OrgGeogebraCommonKernelGeosGeoElement *P1, OrgGeogebraCommonKernelGeosGeoElement *P2) {
  ...
  OrgGeogebraCommonKernelConstructionElementCycle *cycle = [new_OrgGeogebraCommonKernelConstructionElementCycle_init() autorelease];
  [cycle addWithId:P1];
  [cycle addWithId:P2];
  return cycle;
}
