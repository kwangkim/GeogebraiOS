...
- (IOSObjectArray *)processWithOrgGeogebraCommonKernelArithmeticCommand:(OrgGeogebraCommonKernelArithmeticCommand *)c {
  jint n = [((OrgGeogebraCommonKernelArithmeticCommand *) nil_chk(c)) getArgumentNumber];
  {
    ...
    switch (n) {
      case 0:
      monthStr1 = [new_OrgGeogebraCommonKernelGeosGeoText_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
      dayStr1 = [new_OrgGeogebraCommonKernelGeosGeoText_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
      cal = [new_JavaUtilDate_init() autorelease];
      mins1 = [new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons_, [cal getMinutes]) autorelease];
      d = [cal getDay] + 1;
      day = [new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons_, d) autorelease];
      m = [cal getMonth] + 1;
      month1 = [new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons_, m) autorelease];
      year1 = [new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons_, [cal getYear] + 1900) autorelease];
      secs1 = [new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons_, [cal getSeconds]) autorelease];
      hours1 = [new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons_, [cal getHours]) autorelease];
      date1 = [new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons_, [cal getDate]) autorelease];
      ms1 = [new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons_, [cal getTime] % 1000) autorelease];
      ...
      list = [new_OrgGeogebraCommonKernelGeosGeoList_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
      ...
      [list update];
      ret = [IOSObjectArray arrayWithObjects:(id[]){ list } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
      return ret;
      case 1:
      date = OrgGeogebraCommonKernelCommandsCmdGetTime_buildLocalizedDateWithNSString_withJavaUtilDate_withOrgGeogebraCommonMainLocalization_([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([c getArgumentWithInt:0])) toValueStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()], [new_JavaUtilDate_init() autorelease], loc_);
      rettext = [new_OrgGeogebraCommonKernelGeosGeoText_initWithOrgGeogebraCommonKernelConstruction_withNSString_withNSString_(cons_, [c getLabel], date) autorelease];
      ret1 = [IOSObjectArray arrayWithObjects:(id[]){ rettext } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
      return ret1;
      default:
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonKernelCommandsCmdGetTime class]) {
    JreStrongAssignAndConsume(&OrgGeogebraCommonKernelCommandsCmdGetTime_month_days_, nil, [IOSIntArray newArrayWithInts:(jint[]){ 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31 } count:12]);
