...
- (IOSObjectArray *)processWithOrgGeogebraCommonKernelArithmeticCommand:(OrgGeogebraCommonKernelArithmeticCommand *)c {
  ...
  arg = [self resArgsWithOrgGeogebraCommonKernelArithmeticCommand:c];
  {
    ...
    switch (n) {
      ...
      points = [IOSObjectArray newArrayWithLength:size type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()];
      is3D = NO;
...
- (IOSObjectArray *)PolyLineWithNSStringArray:(IOSObjectArray *)labels
  ...
  OrgGeogebraCommonKernelAlgosAlgoPolyLine *algo = new_OrgGeogebraCommonKernelAlgosAlgoPolyLine_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelGeosGeoList_(cons_, labels, pointList);
