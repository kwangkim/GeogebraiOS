...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/commands/CmdIf.java
//
...
- (IOSObjectArray *)processWithOrgGeogebraCommonKernelArithmeticCommand:(OrgGeogebraCommonKernelArithmeticCommand *)c {
  ...
  if ([((OrgGeogebraCommonKernelConstruction *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk(kernelA_)) getConstruction])) getRegisteredFunctionVariable] != nil) {
    ...
    IOSObjectArray *fv = [IOSObjectArray arrayWithLength:((IOSObjectArray *) nil_chk(varName))->size_ type:OrgGeogebraCommonKernelArithmeticFunctionVariable_class_()];
  ...
  if ([IOSObjectArray_Get(nil_chk(arg), 0) isKindOfClass:[OrgGeogebraCommonKernelGeosGeoBoolean class]]) {
    ...
    return [((OrgGeogebraCommonKernelAlgosAlgoIf *) [new_OrgGeogebraCommonKernelAlgosAlgoIf_initWithOrgGeogebraCommonKernelConstruction_withNSString_withJavaUtilArrayList_withJavaUtilArrayList_(cons_, [c getLabel], cond, alternatives) autorelease]) getOutput];
  }
  ...
  return [IOSObjectArray arrayWithObjects:(id[]){ OrgGeogebraCommonKernelCommandsCmdIf_IfWithNSString_withJavaUtilArrayList_withJavaUtilArrayList_withInt_(self, [c getLabel], conditions, functions, vars) } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
}
...
jint OrgGeogebraCommonKernelCommandsCmdIf_replaceVariablesWithOrgGeogebraCommonKernelArithmeticExpressionNode_withNSStringArray_withOrgGeogebraCommonKernelArithmeticFunctionVariableArray_(OrgGeogebraCommonKernelCommandsCmdIf *self, OrgGeogebraCommonKernelArithmeticExpressionNode *argument, IOSObjectArray *varName, IOSObjectArray *fv) {
  ...
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(varName))->size_; i++) {
    if (IOSObjectArray_Get(nil_chk(fv), i) == nil) {
      IOSObjectArray_SetAndConsume(fv, i, new_OrgGeogebraCommonKernelArithmeticFunctionVariable_initWithOrgGeogebraCommonKernelKernel_withNSString_(self->kernelA_, IOSObjectArray_Get(varName, i)));
    }
...
OrgGeogebraCommonKernelGeosGeoElement *OrgGeogebraCommonKernelCommandsCmdIf_IfWithNSString_withJavaUtilArrayList_withJavaUtilArrayList_withInt_(OrgGeogebraCommonKernelCommandsCmdIf *self, NSString *label, JavaUtilArrayList *conditions, JavaUtilArrayList *functions, jint vars) {
  ...
  if ([functions size] == 1) {
    ...
    expr = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self->kernelA_, [new_OrgGeogebraCommonKernelArithmeticMyNumberPair_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self->kernelA_, OrgGeogebraCommonKernelCommandsCmdIf_wrapWithOrgGeogebraCommonKernelArithmeticFunctionalNVar_withOrgGeogebraCommonKernelArithmeticFunctionVariableArray_withBoolean_(self, [conditions getWithInt:0], fv, mayUseIndependent), OrgGeogebraCommonKernelCommandsCmdIf_wrapWithOrgGeogebraCommonKernelArithmeticFunctionalNVar_withOrgGeogebraCommonKernelArithmeticFunctionVariableArray_withBoolean_(self, [functions getWithInt:0], fv, mayUseIndependent)) autorelease], OrgGeogebraCommonPluginOperationEnum_get_IF_ELSE(), OrgGeogebraCommonKernelCommandsCmdIf_wrapWithOrgGeogebraCommonKernelArithmeticFunctionalNVar_withOrgGeogebraCommonKernelArithmeticFunctionVariableArray_withBoolean_(self, [functions getWithInt:1], fv, mayUseIndependent)) autorelease];
  }
  else {
    OrgGeogebraCommonKernelArithmeticMyList *cond = [new_OrgGeogebraCommonKernelArithmeticMyList_initWithOrgGeogebraCommonKernelKernel_(self->kernelA_) autorelease], *funs = [new_OrgGeogebraCommonKernelArithmeticMyList_initWithOrgGeogebraCommonKernelKernel_(self->kernelA_) autorelease];
    ...
    expr = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self->kernelA_, cond, OrgGeogebraCommonPluginOperationEnum_get_IF_LIST(), funs) autorelease];
  }
  if (vars < 2) {
    OrgGeogebraCommonKernelArithmeticFunction *fun = [new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionVariable_(expr, IOSObjectArray_Get(nil_chk(fv), 0)) autorelease];
    if (mayUseIndependent) {
      return [new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticFunction_(self->cons_, label, fun) autorelease];
    }
    OrgGeogebraCommonKernelAlgosAlgoDependentFunction *algo = [new_OrgGeogebraCommonKernelAlgosAlgoDependentFunction_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticFunction_(self->cons_, label, fun) autorelease];
    return [algo getFunction];
  }
  OrgGeogebraCommonKernelArithmeticFunctionNVar *fun = [new_OrgGeogebraCommonKernelArithmeticFunctionNVar_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionVariableArray_(expr, fv) autorelease];
  if (mayUseIndependent) {
    return [new_OrgGeogebraCommonKernelGeosGeoFunctionNVar_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticFunctionNVar_(self->cons_, label, fun) autorelease];
  }
