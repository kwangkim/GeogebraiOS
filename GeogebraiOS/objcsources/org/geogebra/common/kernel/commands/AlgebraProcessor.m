...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/commands/AlgebraProcessor.java
//
...
- (OrgGeogebraCommonKernelGeosGeoElement *)changeGeoElementNoExceptionHandlingWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo
  ...
  @try {
    ...
    if ([((NSString *) nil_chk(newLabel)) isEqual:oldLabel]) {
      ...
      @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSStringArray_(loc_, str) autorelease];
    }
  }
  @catch (OrgGeogebraCommonKernelCircularDefinitionException *e) {
...
- (IOSObjectArray *)processAlgebraCommandNoExceptionHandlingWithNSString:(NSString *)cmd
  ...
  @try {
    ...
    OrgGeogebraCommonKernelArithmeticTraversing_CollectUndefinedVariables *collecter = [new_OrgGeogebraCommonKernelArithmeticTraversing_CollectUndefinedVariables_init() autorelease];
    [((OrgGeogebraCommonKernelArithmeticValidExpression *) nil_chk(ve)) traverseWithOrgGeogebraCommonKernelArithmeticTraversing:collecter];
    JavaUtilTreeSet *undefinedVariables = [collecter getResult];
    OrgGeogebraCommonKernelArithmeticTraversing_CollectFunctionVariables *fvCollecter = [new_OrgGeogebraCommonKernelArithmeticTraversing_CollectFunctionVariables_init() autorelease];
    [ve traverseWithOrgGeogebraCommonKernelArithmeticTraversing:fvCollecter];
    ...
    if (fvX == nil) {
      fvX = [new_OrgGeogebraCommonKernelArithmeticFunctionVariable_initWithOrgGeogebraCommonKernelKernel_withNSString_(kernel_, @"x") autorelease];
    }
  ...
  @catch (OrgGeogebraCommonMainBracketsError *e) {
    ...
    @throw [new_OrgGeogebraCommonKernelCommandsMyException_initWithOrgGeogebraCommonMainMyError_withInt_(e, OrgGeogebraCommonKernelCommandsMyException_IMBALANCED_BRACKETS) autorelease];
  }
  @catch (JavaLangError *e) {
    [((JavaLangError *) nil_chk(e)) printStackTrace];
    if (allowErrorDialog) {
 ...
 withOrgGeogebraCommonKernelArithmeticValidExpression:(OrgGeogebraCommonKernelArithmeticValidExpression *)ve {
  ...
  @catch (OrgGeogebraCommonMainMyError *e) {
    ...
    if (allowErrorDialog) {
      ...
      @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSString_withNSString_withJavaLangThrowable_(loc_, [e getLocalizedMessage], [e getcommandName], e) autorelease];
    }
    return nil;
  }
  @catch (OrgGeogebraCommonKernelCircularDefinitionException *e) {
...
- (void)replaceUndefinedVariablesWithOrgGeogebraCommonKernelArithmeticValidExpression:(OrgGeogebraCommonKernelArithmeticValidExpression *)ve {
  OrgGeogebraCommonKernelArithmeticTraversing_ReplaceUndefinedVariables *replacer = [new_OrgGeogebraCommonKernelArithmeticTraversing_ReplaceUndefinedVariables_initWithOrgGeogebraCommonKernelKernel_(self->kernel_) autorelease];
  [((OrgGeogebraCommonKernelArithmeticValidExpression *) nil_chk(ve)) traverseWithOrgGeogebraCommonKernelArithmeticTraversing:replacer];
}
  ...
  @try {
    ...
    if ([IOSObjectArray_Get(nil_chk(temp), 0) isKindOfClass:[OrgGeogebraCommonKernelGeosGeoFunctionNVar class]]) {
      ...
      if ([((OrgGeogebraCommonKernelGeosGeoFunction *) nil_chk(((OrgGeogebraCommonKernelGeosGeoFunction *) check_class_cast(IOSObjectArray_Get(temp, 0), [OrgGeogebraCommonKernelGeosGeoFunction class])))) isFunctionOfY]) {
        funVars = [IOSObjectArray arrayWithObjects:(id[]){ [((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk([((OrgGeogebraCommonKernelGeosGeoFunction *) nil_chk(((OrgGeogebraCommonKernelGeosGeoFunction *) check_class_cast(IOSObjectArray_Get(temp, 0), [OrgGeogebraCommonKernelGeosGeoFunction class])))) getFunction])) getFunctionVariable], [new_OrgGeogebraCommonKernelArithmeticFunctionVariable_initWithOrgGeogebraCommonKernelKernel_withNSString_(kernel_, @"y") autorelease] } count:2 type:OrgGeogebraCommonKernelArithmeticFunctionVariable_class_()];
      }
      else {
        funVars = [IOSObjectArray arrayWithObjects:(id[]){ [new_OrgGeogebraCommonKernelArithmeticFunctionVariable_initWithOrgGeogebraCommonKernelKernel_withNSString_(kernel_, @"y") autorelease], [((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk([((OrgGeogebraCommonKernelGeosGeoFunction *) nil_chk(((OrgGeogebraCommonKernelGeosGeoFunction *) check_class_cast(IOSObjectArray_Get(temp, 0), [OrgGeogebraCommonKernelGeosGeoFunction class])))) getFunction])) getFunctionVariable] } count:2 type:OrgGeogebraCommonKernelArithmeticFunctionVariable_class_()];
      }
      OrgGeogebraCommonKernelArithmeticFunctionNVar *fn = [new_OrgGeogebraCommonKernelArithmeticFunctionNVar_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionVariableArray_([((OrgGeogebraCommonKernelGeosGeoFunction *) nil_chk(((OrgGeogebraCommonKernelGeosGeoFunction *) check_class_cast(IOSObjectArray_Get(temp, 0), [OrgGeogebraCommonKernelGeosGeoFunction class])))) getFunctionExpression], funVars) autorelease];
      func = [new_OrgGeogebraCommonKernelGeosGeoFunctionNVar_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticFunctionNVar_(cons_, fn) autorelease];
    }
    else if ([IOSObjectArray_Get(temp, 0) isKindOfClass:[OrgGeogebraCommonKernelGeosGeoNumeric class]]) {
      IOSObjectArray *funVars = [IOSObjectArray arrayWithObjects:(id[]){ [new_OrgGeogebraCommonKernelArithmeticFunctionVariable_initWithOrgGeogebraCommonKernelKernel_withNSString_(kernel_, @"x") autorelease], [new_OrgGeogebraCommonKernelArithmeticFunctionVariable_initWithOrgGeogebraCommonKernelKernel_withNSString_(kernel_, @"y") autorelease] } count:2 type:OrgGeogebraCommonKernelArithmeticFunctionVariable_class_()];
    ...
    for (jint i = 0; i < labels->size_; i++) {
      ...
      if (geo != nil) {
        if ([geo isFixed]) {
          ...
          @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSStringArray_(loc_, strs) autorelease];
        }
        if (firstTime) {
          replaceable = geo;
          firstTime = NO;
  ...
  if (replaceable != nil && ((IOSObjectArray *) nil_chk(ret))->size_ > 0) {
    if (!redefineIndependent && [replaceable isChangeable] && !([replaceable isGeoText])) {
      ...
      @catch (JavaLangException *e) {
        ...
        @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSString_(loc_, errStr) autorelease];
      }
    }
    else {
      @try {
        if ([replaceable isIndependent] && [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(IOSObjectArray_Get(ret, 0))) isIndependent] && OrgGeogebraCommonKernelCommandsAlgebraProcessor_compatibleTypesWithOrgGeogebraCommonPluginGeoClassEnum_withOrgGeogebraCommonPluginGeoClassEnum_([replaceable getGeoClassType], [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(IOSObjectArray_Get(ret, 0))) getGeoClassType])) {
          ...
          IOSObjectArray_Set(ret, 0, [((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) lookupLabelWithNSString:newLabel]);
        }
      }
      @catch (OrgGeogebraCommonKernelCircularDefinitionException *e) {
        @throw e;
      ...
      @catch (JavaLangException *e) {
        [((JavaLangException *) nil_chk(e)) printStackTrace];
        @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSString_(loc_, @"ReplaceFailed") autorelease];
      }
      @catch (OrgGeogebraCommonMainMyError *e) {
        [((OrgGeogebraCommonMainMyError *) nil_chk(e)) printStackTrace];
        @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSString_(loc_, @"ReplaceFailed") autorelease];
...
- (IOSObjectArray *)processParametricFunctionWithOrgGeogebraCommonKernelArithmeticExpressionNode:(OrgGeogebraCommonKernelArithmeticExpressionNode *)exp
  ...
  if ([OrgGeogebraCommonKernelArithmeticVectorValue_class_() isInstance:ev] && [((id<OrgGeogebraCommonKernelArithmeticVectorValue>) nil_chk(((id<OrgGeogebraCommonKernelArithmeticVectorValue>) check_protocol_cast(ev, @protocol(OrgGeogebraCommonKernelArithmeticVectorValue))))) getMode] != OrgGeogebraCommonKernelKernel_COORD_COMPLEX) {
    OrgGeogebraCommonKernelGeosGeoNumeric *loc = [new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
    [loc setLocalVariableLabelWithNSString:[((OrgGeogebraCommonKernelArithmeticFunctionVariable *) nil_chk(fv)) getSetVarString]];
    [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(exp)) replaceWithOrgGeogebraCommonKernelArithmeticExpressionValue:fv withOrgGeogebraCommonKernelArithmeticExpressionValue:loc];
    ...
    IOSObjectArray *coefX = [IOSObjectArray arrayWithLength:5 type:OrgGeogebraCommonKernelArithmeticExpressionValue_class_()], *coefY = [IOSObjectArray arrayWithLength:5 type:OrgGeogebraCommonKernelArithmeticExpressionValue_class_()];
    if (OrgGeogebraCommonKernelCommandsAlgebraProcessor_getTrigCoeffsWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticExpressionValueArray_withOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelGeosGeoElement_(self, cx, coefX, [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, 1.0) autorelease], loc) && OrgGeogebraCommonKernelCommandsAlgebraProcessor_getTrigCoeffsWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticExpressionValueArray_withOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelGeosGeoElement_(self, cy, coefY, [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, 1.0) autorelease], loc)) {
      OrgGeogebraCommonKernelArithmeticExpressionNode *a, *b, *c, *d, *xx, *xy, *yy;
      OrgGeogebraCommonKernelArithmeticExpressionNode *x = [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((OrgGeogebraCommonKernelArithmeticFunctionVariable *) [new_OrgGeogebraCommonKernelArithmeticFunctionVariable_initWithOrgGeogebraCommonKernelKernel_withNSString_(kernel_, @"x") autorelease]) wrap])) subtractWithOrgGeogebraCommonKernelArithmeticExpressionValue:OrgGeogebraCommonKernelCommandsAlgebraProcessor_exprWithOrgGeogebraCommonKernelArithmeticExpressionValue_(self, IOSObjectArray_Get(coefX, 0))];
      OrgGeogebraCommonKernelArithmeticExpressionNode *y = [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((OrgGeogebraCommonKernelArithmeticFunctionVariable *) [new_OrgGeogebraCommonKernelArithmeticFunctionVariable_initWithOrgGeogebraCommonKernelKernel_withNSString_(kernel_, @"y") autorelease]) wrap])) subtractWithOrgGeogebraCommonKernelArithmeticExpressionValue:OrgGeogebraCommonKernelCommandsAlgebraProcessor_exprWithOrgGeogebraCommonKernelArithmeticExpressionValue_(self, IOSObjectArray_Get(coefY, 0))];
    ...
    OrgGeogebraCommonKernelAlgosAlgoDependentNumber *ny = [new_OrgGeogebraCommonKernelAlgosAlgoDependentNumber_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticExpressionNode_withBoolean_(cons_, cy, NO) autorelease];
    [cons_ removeFromConstructionListWithOrgGeogebraCommonKernelAlgosConstructionElement:ny];
    OrgGeogebraCommonKernelGeosGeoNumeric *from = [new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons_, -10) autorelease];
    OrgGeogebraCommonKernelGeosGeoNumeric *to = [new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons_, 10) autorelease];
    OrgGeogebraCommonKernelAlgosAlgoCurveCartesian *ac = [new_OrgGeogebraCommonKernelAlgosAlgoCurveCartesian_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticNumberValueArray_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons_, label, [IOSObjectArray arrayWithObjects:(id[]){ [nx getNumber], [ny getNumber] } count:2 type:OrgGeogebraCommonKernelArithmeticNumberValue_class_()], loc, from, to) autorelease];
    return [ac getOutput];
  }
  ...
  @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSString_([((OrgGeogebraCommonMainApp *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) getApplication])) getLocalization], @"InvalidFunction") autorelease];
}

- (IOSObjectArray *)arrayOfZerosWithInt:(jint)length {
  IOSObjectArray *ret = [IOSObjectArray arrayWithLength:length type:OrgGeogebraCommonKernelArithmeticExpressionValue_class_()];
  for (jint i = 0; i < length; i++) {
    IOSObjectArray_SetAndConsume(ret, i, new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, 0));
  }
  return ret;
}
...
- (OrgGeogebraCommonKernelArithmeticExpressionNode *)computeCoordWithOrgGeogebraCommonKernelArithmeticExpressionNode:(OrgGeogebraCommonKernelArithmeticExpressionNode *)exp
                                                                                                             withInt:(jint)i {
  IOSObjectArray *ops = [IOSObjectArray arrayWithObjects:(id[]){ OrgGeogebraCommonPluginOperationEnum_get_XCOORD(), OrgGeogebraCommonPluginOperationEnum_get_YCOORD(), OrgGeogebraCommonPluginOperationEnum_get_ZCOORD() } count:3 type:OrgGeogebraCommonPluginOperationEnum_class_()];
  ...
  switch ([[exp getOperation] ordinal]) {
    ...
    default:
    return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, exp, IOSObjectArray_Get(ops, i), nil) autorelease];
  }
}
...
- (IOSObjectArray *)processFunctionNVarWithOrgGeogebraCommonKernelArithmeticFunctionNVar:(OrgGeogebraCommonKernelArithmeticFunctionNVar *)fun {
  ...
  if (isIndependent) {
    IOSObjectArray_SetAndConsume(ret, 0, new_OrgGeogebraCommonKernelGeosGeoFunctionNVar_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticFunctionNVar_(cons_, label, fun));
  }
  else {
    IOSObjectArray_Set(ret, 0, OrgGeogebraCommonKernelCommandsAlgebraProcessor_DependentFunctionNVarWithNSString_withOrgGeogebraCommonKernelArithmeticFunctionNVar_(self, label, fun));
  }
  return ret;
}
...
- (IOSObjectArray *)processLineWithOrgGeogebraCommonKernelArithmeticEquation:(OrgGeogebraCommonKernelArithmeticEquation *)equ {
  ...
  if (isIndependent) {
    ...
    line = [new_OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelConstruction_withNSString_withDouble_withDouble_withDouble_(cons_, label, a, b, c) autorelease];
  }
...
- (IOSObjectArray *)processConicWithOrgGeogebraCommonKernelArithmeticEquation:(OrgGeogebraCommonKernelArithmeticEquation *)equ {
  ...
  if (isIndependent) {
    ...
    conic = [new_OrgGeogebraCommonKernelGeosGeoConic_initWithOrgGeogebraCommonKernelConstruction_withNSString_withDoubleArray_(cons_, label, coeffs) autorelease];
  }
...
- (IOSObjectArray *)processImplicitPolyWithOrgGeogebraCommonKernelArithmeticEquation:(OrgGeogebraCommonKernelArithmeticEquation *)equ {
  ...
  OrgGeogebraCommonKernelGeosGeoElement *geo = nil;
  if (isIndependent) {
    poly = [new_OrgGeogebraCommonKernelImplicitGeoImplicitPoly_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticPolynomial_(cons_, label, lhs) autorelease];
    [poly setUserInputWithOrgGeogebraCommonKernelArithmeticValidExpression:equ];
    geo = poly;
  }
  else {
    OrgGeogebraCommonKernelImplicitAlgoDependentImplicitPoly *algo = [new_OrgGeogebraCommonKernelImplicitAlgoDependentImplicitPoly_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticEquation_withBoolean_(cons_, label, equ, YES) autorelease];
    geo = [algo getGeo];
...
- (IOSObjectArray *)processImplicitCurveWithOrgGeogebraCommonKernelArithmeticEquation:(OrgGeogebraCommonKernelArithmeticEquation *)equ {
  ...
  OrgGeogebraCommonKernelGeosGeoElement *geo = nil;
  if (isIndependent) {
    poly = [new_OrgGeogebraCommonKernelImplicitGeoImplicitCurve_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticEquation_(cons_, label, equ) autorelease];
    geo = poly;
  }
  else {
    OrgGeogebraCommonKernelImplicitAlgoDependentImplicitCurve *algo = [new_OrgGeogebraCommonKernelImplicitAlgoDependentImplicitCurve_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticEquation_withBoolean_(cons_, label, equ, YES) autorelease];
    geo = [algo getGeo];
  }
  IOSObjectArray_Set(ret, 0, geo);
  [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(IOSObjectArray_Get(ret, 0))) updateRepaint];
...
- (IOSObjectArray *)processExpressionNodeWithOrgGeogebraCommonKernelArithmeticExpressionNode:(OrgGeogebraCommonKernelArithmeticExpressionNode *)node {
  ...
  if ([n containsFreeFunctionVariableWithNSString:nil]) {
    ...
    [n traverseWithOrgGeogebraCommonKernelArithmeticTraversing:fvc];
    if ([fvSet size] == 1) {
      ...
      IOSObjectArray *fvArray = [IOSObjectArray arrayWithLength:[fvSet size] type:OrgGeogebraCommonKernelArithmeticFunctionVariable_class_()];
      id<JavaUtilIterator> it = [fvSet iterator];
      jint i = 0;
      while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
        IOSObjectArray_SetAndConsume(fvArray, i++, new_OrgGeogebraCommonKernelArithmeticFunctionVariable_initWithOrgGeogebraCommonKernelKernel_withNSString_(kernel_, [it next]));
      }
  ...
  if ([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(eval)) isGeoElement] && [n getLabel] == nil && !([((OrgGeogebraCommonPluginOperationEnum *) nil_chk([n getOperation])) isEqual:OrgGeogebraCommonPluginOperationEnum_get_ELEMENT_OF()])) {
    {
      ...
      switch ([[((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(myNode)) getOperation] ordinal]) {
        ...
        break;
        default:
        ret = [IOSObjectArray arrayWithObjects:(id[]){ (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(eval, [OrgGeogebraCommonKernelGeosGeoElement class]) } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
        return ret;
      }
    }
  }
...
- (OrgGeogebraCommonKernelArithmeticMyStringBuffer *)getXBracket {
  if (xBracket_ == nil) OrgGeogebraCommonKernelCommandsAlgebraProcessor_setAndConsume_xBracket_(self, new_OrgGeogebraCommonKernelArithmeticMyStringBuffer_initWithOrgGeogebraCommonKernelKernel_withNSString_(kernel_, @"x("));
  return xBracket_;
}

- (OrgGeogebraCommonKernelArithmeticMyStringBuffer *)getYBracket {
  if (yBracket_ == nil) OrgGeogebraCommonKernelCommandsAlgebraProcessor_setAndConsume_yBracket_(self, new_OrgGeogebraCommonKernelArithmeticMyStringBuffer_initWithOrgGeogebraCommonKernelKernel_withNSString_(kernel_, @"y("));
  return yBracket_;
}

- (OrgGeogebraCommonKernelArithmeticMyStringBuffer *)getZBracket {
  if (zBracket_ == nil) OrgGeogebraCommonKernelCommandsAlgebraProcessor_setAndConsume_zBracket_(self, new_OrgGeogebraCommonKernelArithmeticMyStringBuffer_initWithOrgGeogebraCommonKernelKernel_withNSString_(kernel_, @"z("));
  return zBracket_;
}

- (OrgGeogebraCommonKernelArithmeticMyStringBuffer *)getCloseBracket {
  if (closeBracket_ == nil) OrgGeogebraCommonKernelCommandsAlgebraProcessor_setAndConsume_closeBracket_(self, new_OrgGeogebraCommonKernelArithmeticMyStringBuffer_initWithOrgGeogebraCommonKernelKernel_withNSString_(kernel_, @")"));
...
void OrgGeogebraCommonKernelCommandsAlgebraProcessor_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelCommandsCommandDispatcher_(OrgGeogebraCommonKernelCommandsAlgebraProcessor *self, OrgGeogebraCommonKernelKernel *kernel, OrgGeogebraCommonKernelCommandsCommandDispatcher *commandDispatcher) {
  NSObject_init(self);
  OrgGeogebraCommonKernelCommandsAlgebraProcessor_set_xBracket_(self, nil);
  OrgGeogebraCommonKernelCommandsAlgebraProcessor_set_yBracket_(self, nil);
  OrgGeogebraCommonKernelCommandsAlgebraProcessor_set_zBracket_(self, nil);
  OrgGeogebraCommonKernelCommandsAlgebraProcessor_set_closeBracket_(self, nil);
  OrgGeogebraCommonKernelCommandsAlgebraProcessor_set_kernel_(self, kernel);
  OrgGeogebraCommonKernelCommandsAlgebraProcessor_set_cons_(self, [((OrgGeogebraCommonKernelKernel *) nil_chk(kernel)) getConstruction]);
  OrgGeogebraCommonKernelCommandsAlgebraProcessor_set_cmdDispatcher_(self, commandDispatcher);
  OrgGeogebraCommonKernelCommandsAlgebraProcessor_set_app_(self, [kernel getApplication]);
  OrgGeogebraCommonKernelCommandsAlgebraProcessor_set_loc_(self, [((OrgGeogebraCommonMainApp *) nil_chk(self->app_)) getLocalization]);
  OrgGeogebraCommonKernelCommandsAlgebraProcessor_set_parser_(self, [kernel getParser]);
}
  ...
  if (prevFree) {
    if (nowFree) {
      ...
      if ([casCell isOutputEmpty] && ![casCell hasChildren]) {
        ...
        OrgGeogebraCommonKernelKernelCAS_DependentCasCellWithOrgGeogebraCommonKernelGeosGeoCasCell_(casCell);
        needsRedefinition = NO;
...
OrgGeogebraCommonKernelArithmeticValidExpression *OrgGeogebraCommonKernelCommandsAlgebraProcessor_checkParametricEquationFWithOrgGeogebraCommonKernelArithmeticValidExpression_withOrgGeogebraCommonKernelArithmeticValidExpression_(OrgGeogebraCommonKernelCommandsAlgebraProcessor *self, OrgGeogebraCommonKernelArithmeticValidExpression *ve, OrgGeogebraCommonKernelArithmeticValidExpression *fallback) {
  ...
  if ([((JavaUtilTreeSet *) nil_chk(undefinedVariables)) size] == 1) {
    @try {
      ...
      OrgGeogebraCommonKernelArithmeticFunctionVariable *fv = [new_OrgGeogebraCommonKernelArithmeticFunctionVariable_initWithOrgGeogebraCommonKernelKernel_withNSString_(self->kernel_, varName) autorelease];
...
IOSObjectArray *OrgGeogebraCommonKernelCommandsAlgebraProcessor_parseMathmlWithNSString_withBoolean_withBoolean_withBoolean_withBoolean_withOrgGeogebraCommonUtilAsyncOperation_(OrgGeogebraCommonKernelCommandsAlgebraProcessor *self, NSString *cmd, jboolean storeUndo, jboolean allowErrorDialog, jboolean throwMyError, jboolean autoCreateSliders, OrgGeogebraCommonUtilAsyncOperation *callback0) {
  if (self->mathmlParserGGB_ == nil) {
    OrgGeogebraCommonKernelCommandsAlgebraProcessor_setAndConsume_mathmlParserGGB_(self, new_OrgGeogebraCommonIoMathMLParser_initWithBoolean_(YES));
  }
  IOSObjectArray *ret = nil;
  @try {
  ...
  if (self->mathmlParserLaTeX_ == nil) {
    OrgGeogebraCommonKernelCommandsAlgebraProcessor_setAndConsume_mathmlParserLaTeX_(self, new_OrgGeogebraCommonIoMathMLParser_initWithBoolean_(NO));
  }
  ...
  OrgGeogebraCommonKernelGeosGeoText *arg = [new_OrgGeogebraCommonKernelGeosGeoText_initWithOrgGeogebraCommonKernelConstruction_withNSString_(self->cons_, latex) autorelease];
  OrgGeogebraCommonKernelAlgosAlgoLaTeX *texAlgo = [new_OrgGeogebraCommonKernelAlgosAlgoLaTeX_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoElement_(self->cons_, nil, arg) autorelease];
  return [IOSObjectArray arrayWithObjects:(id[]){ [texAlgo getOutputWithInt:0] } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
}
...
IOSObjectArray *OrgGeogebraCommonKernelCommandsAlgebraProcessor_processFunctionWithOrgGeogebraCommonKernelArithmeticFunction_(OrgGeogebraCommonKernelCommandsAlgebraProcessor *self, OrgGeogebraCommonKernelArithmeticFunction *fun) {
  ...
  if ([((OrgGeogebraCommonPluginOperationEnum *) nil_chk([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(en)) getOperation])) isEqual:OrgGeogebraCommonPluginOperationEnum_get_AND()] || [((OrgGeogebraCommonPluginOperationEnum *) nil_chk([en getOperation])) isEqual:OrgGeogebraCommonPluginOperationEnum_get_AND_INTERVAL()]) {
    ...
    if ([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(left)) isExpressionNode] && [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(right)) isExpressionNode]) {
      ...
      if (leftDir * rightDir < 0) {
        if (isIndependent) {
          f = [new_OrgGeogebraCommonKernelGeosGeoInterval_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticFunction_(self->cons_, label, fun) autorelease];
        }
        else {
  ...
  if (isIndependent) {
    f = [new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticFunction_(self->cons_, label, fun) autorelease];
  }
  else {
...
OrgGeogebraCommonKernelArithmeticExpressionNode *OrgGeogebraCommonKernelCommandsAlgebraProcessor_exprWithOrgGeogebraCommonKernelArithmeticExpressionValue_(OrgGeogebraCommonKernelCommandsAlgebraProcessor *self, id<OrgGeogebraCommonKernelArithmeticExpressionValue> ev) {
  if (ev == nil) {
    return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, 0) autorelease];
  }
...
void OrgGeogebraCommonKernelCommandsAlgebraProcessor_addWithOrgGeogebraCommonKernelArithmeticExpressionValueArray_withInt_withOrgGeogebraCommonKernelArithmeticExpressionNode_(OrgGeogebraCommonKernelCommandsAlgebraProcessor *self, IOSObjectArray *coefX, jint i, OrgGeogebraCommonKernelArithmeticExpressionNode *scale_) {
  if (IOSObjectArray_Get(nil_chk(coefX), i) == nil) {
    ...
    IOSObjectArray_Set(coefX, i, [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(scale_)) plusWithOrgGeogebraCommonKernelArithmeticExpressionValue:IOSObjectArray_Get(coefX, i)]);
  }
}
...
OrgGeogebraCommonKernelGeosGeoFunction *OrgGeogebraCommonKernelCommandsAlgebraProcessor_DependentIntervalWithNSString_withOrgGeogebraCommonKernelArithmeticFunction_(OrgGeogebraCommonKernelCommandsAlgebraProcessor *self, NSString *label, OrgGeogebraCommonKernelArithmeticFunction *fun) {
  OrgGeogebraCommonKernelAlgosAlgoDependentInterval *algo = [new_OrgGeogebraCommonKernelAlgosAlgoDependentInterval_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticFunction_(self->cons_, label, fun) autorelease];
...
OrgGeogebraCommonKernelGeosGeoElement *OrgGeogebraCommonKernelCommandsAlgebraProcessor_DependentGeoCopyWithNSString_withOrgGeogebraCommonKernelGeosGeoElement_(OrgGeogebraCommonKernelCommandsAlgebraProcessor *self, NSString *label, OrgGeogebraCommonKernelGeosGeoElement *origGeoNode) {
  OrgGeogebraCommonKernelAlgosAlgoDependentGeoCopy *algo = [new_OrgGeogebraCommonKernelAlgosAlgoDependentGeoCopy_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoElement_(self->cons_, label, origGeoNode) autorelease];
  return [algo getGeo];
}
...
OrgGeogebraCommonKernelGeosGeoFunctionNVar *OrgGeogebraCommonKernelCommandsAlgebraProcessor_DependentFunctionNVarWithNSString_withOrgGeogebraCommonKernelArithmeticFunctionNVar_(OrgGeogebraCommonKernelCommandsAlgebraProcessor *self, NSString *label, OrgGeogebraCommonKernelArithmeticFunctionNVar *fun) {
  OrgGeogebraCommonKernelAlgosAlgoDependentFunctionNVar *algo = [new_OrgGeogebraCommonKernelAlgosAlgoDependentFunctionNVar_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticFunctionNVar_(self->cons_, label, fun) autorelease];
...
IOSObjectArray *OrgGeogebraCommonKernelCommandsAlgebraProcessor_processEquationWithOrgGeogebraCommonKernelArithmeticEquation_withBoolean_(OrgGeogebraCommonKernelCommandsAlgebraProcessor *self, OrgGeogebraCommonKernelArithmeticEquation *equ, jboolean allowConstant) {
  ...
  jint deg = [equ mayBePolynomial] && ![equ hasVariableDegree] ? [equ degree] : -1;
  {
    ...
    switch (deg) {
      ...
      case 0:
      if (!allowConstant) {
        @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSString_([((OrgGeogebraCommonMainApp *) nil_chk(self->app_)) getLocalization], @"InvalidEquation") autorelease];
      }
      default:
      ...
      if ([((NSString *) nil_chk(lhsStr)) isEqual:@"y"] && ![((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([equ getRHS])) containsFreeFunctionVariableWithNSString:@"y"]) {
        OrgGeogebraCommonKernelArithmeticFunction *fun = [new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_([equ getRHS]) autorelease];
      ...
      @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSStringArray_(self->loc_, errors) autorelease];
    }
  }
}
...
OrgGeogebraCommonKernelGeosGeoLine *OrgGeogebraCommonKernelCommandsAlgebraProcessor_DependentLineWithNSString_withOrgGeogebraCommonKernelArithmeticEquation_(OrgGeogebraCommonKernelCommandsAlgebraProcessor *self, NSString *label, OrgGeogebraCommonKernelArithmeticEquation *equ) {
  OrgGeogebraCommonKernelAlgosAlgoDependentLine *algo = [new_OrgGeogebraCommonKernelAlgosAlgoDependentLine_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticEquation_(self->cons_, label, equ) autorelease];
...
OrgGeogebraCommonKernelGeosGeoConic *OrgGeogebraCommonKernelCommandsAlgebraProcessor_DependentConicWithNSString_withOrgGeogebraCommonKernelArithmeticEquation_(OrgGeogebraCommonKernelCommandsAlgebraProcessor *self, NSString *label, OrgGeogebraCommonKernelArithmeticEquation *equ) {
  OrgGeogebraCommonKernelAlgosAlgoDependentConic *algo = [new_OrgGeogebraCommonKernelAlgosAlgoDependentConic_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticEquation_(self->cons_, label, equ) autorelease];
...
IOSObjectArray *OrgGeogebraCommonKernelCommandsAlgebraProcessor_processNumberWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticExpressionValue_(OrgGeogebraCommonKernelCommandsAlgebraProcessor *self, OrgGeogebraCommonKernelArithmeticExpressionNode *n, id<OrgGeogebraCommonKernelArithmeticExpressionValue> evaluate) {
  ...
  if (isIndependent) {
    if (isAngle) IOSObjectArray_SetAndConsume(ret, 0, new_OrgGeogebraCommonKernelGeosGeoAngle_initWithOrgGeogebraCommonKernelConstruction_withNSString_withDouble_withOrgGeogebraCommonKernelGeosGeoAngle_AngleStyleEnum_(self->cons_, label, value, OrgGeogebraCommonKernelGeosGeoAngle_AngleStyleEnum_get_UNBOUNDED()));
    else IOSObjectArray_SetAndConsume(ret, 0, new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withNSString_withDouble_(self->cons_, label, value));
  }
  else {
    IOSObjectArray_Set(ret, 0, OrgGeogebraCommonKernelCommandsAlgebraProcessor_DependentNumberWithNSString_withOrgGeogebraCommonKernelArithmeticExpressionNode_withBoolean_(self, label, n, isAngle));
  }
  if ([n isForcedFunction]) {
    IOSObjectArray_Set(ret, 0, [((id<OrgGeogebraCommonKernelGeosGeoFunctionable>) nil_chk(((id<OrgGeogebraCommonKernelGeosGeoFunctionable>) check_protocol_cast((IOSObjectArray_Get(ret, 0)), @protocol(OrgGeogebraCommonKernelGeosGeoFunctionable))))) getGeoFunction]);
  }
  return ret;
}

OrgGeogebraCommonKernelGeosGeoNumeric *OrgGeogebraCommonKernelCommandsAlgebraProcessor_DependentNumberWithNSString_withOrgGeogebraCommonKernelArithmeticExpressionNode_withBoolean_(OrgGeogebraCommonKernelCommandsAlgebraProcessor *self, NSString *label, OrgGeogebraCommonKernelArithmeticExpressionNode *root, jboolean isAngle) {
  OrgGeogebraCommonKernelAlgosAlgoDependentNumber *algo = [new_OrgGeogebraCommonKernelAlgosAlgoDependentNumber_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticExpressionNode_withBoolean_(self->cons_, label, root, isAngle) autorelease];
...
IOSObjectArray *OrgGeogebraCommonKernelCommandsAlgebraProcessor_processListWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticMyList_(OrgGeogebraCommonKernelCommandsAlgebraProcessor *self, OrgGeogebraCommonKernelArithmeticExpressionNode *n, OrgGeogebraCommonKernelArithmeticMyList *evalList) {
  ...
  if (![n hasOperations] || [n isConstant]) {
    ...
    IOSObjectArray_Set(ret, 0, [((OrgGeogebraCommonKernelAlgosAlgoDispatcher *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) getAlgoDispatcher])) ListWithNSString:label withJavaUtilArrayList:geoElements withBoolean:isIndependent]);
  }
  else {
    IOSObjectArray_Set(ret, 0, OrgGeogebraCommonKernelCommandsAlgebraProcessor_ListExpressionWithNSString_withOrgGeogebraCommonKernelArithmeticExpressionNode_(self, label, n));
  }
  return ret;
}
...
OrgGeogebraCommonKernelGeosGeoList *OrgGeogebraCommonKernelCommandsAlgebraProcessor_ListExpressionWithNSString_withOrgGeogebraCommonKernelArithmeticExpressionNode_(OrgGeogebraCommonKernelCommandsAlgebraProcessor *self, NSString *label, OrgGeogebraCommonKernelArithmeticExpressionNode *root) {
  OrgGeogebraCommonKernelAlgosAlgoDependentListExpression *algo = [new_OrgGeogebraCommonKernelAlgosAlgoDependentListExpression_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticExpressionNode_(self->cons_, label, root) autorelease];
  return [algo getList];
}
...
IOSObjectArray *OrgGeogebraCommonKernelCommandsAlgebraProcessor_processTextWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticExpressionValue_(OrgGeogebraCommonKernelCommandsAlgebraProcessor *self, OrgGeogebraCommonKernelArithmeticExpressionNode *n, id<OrgGeogebraCommonKernelArithmeticExpressionValue> evaluate) {
  ...
  if (isIndependent) {
    ...
    IOSObjectArray_Set(ret, 0, OrgGeogebraCommonKernelCommandsAlgebraProcessor_TextWithNSString_withNSString_(self, label, [((OrgGeogebraCommonKernelArithmeticMyStringBuffer *) nil_chk(val)) toValueStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]));
  }
  else IOSObjectArray_Set(ret, 0, OrgGeogebraCommonKernelCommandsAlgebraProcessor_DependentTextWithNSString_withOrgGeogebraCommonKernelArithmeticExpressionNode_(self, label, n));
  return ret;
}
...
OrgGeogebraCommonKernelGeosGeoText *OrgGeogebraCommonKernelCommandsAlgebraProcessor_DependentTextWithNSString_withOrgGeogebraCommonKernelArithmeticExpressionNode_(OrgGeogebraCommonKernelCommandsAlgebraProcessor *self, NSString *label, OrgGeogebraCommonKernelArithmeticExpressionNode *root) {
  OrgGeogebraCommonKernelAlgosAlgoDependentText *algo = [new_OrgGeogebraCommonKernelAlgosAlgoDependentText_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticExpressionNode_(self->cons_, label, root) autorelease];
...
OrgGeogebraCommonKernelGeosGeoText *OrgGeogebraCommonKernelCommandsAlgebraProcessor_TextWithNSString_withNSString_(OrgGeogebraCommonKernelCommandsAlgebraProcessor *self, NSString *label, NSString *text) {
  OrgGeogebraCommonKernelGeosGeoText *t = [new_OrgGeogebraCommonKernelGeosGeoText_initWithOrgGeogebraCommonKernelConstruction_(self->cons_) autorelease];
...
IOSObjectArray *OrgGeogebraCommonKernelCommandsAlgebraProcessor_processBooleanWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticExpressionValue_(OrgGeogebraCommonKernelCommandsAlgebraProcessor *self, OrgGeogebraCommonKernelArithmeticExpressionNode *n, id<OrgGeogebraCommonKernelArithmeticExpressionValue> evaluate) {
  ...
  jboolean isIndependent = ![n inspectWithOrgGeogebraCommonKernelArithmeticInspecting:OrgGeogebraCommonKernelArithmeticInspecting_get_dynamicGeosFinder_()];
  if (isIndependent) {
    IOSObjectArray_SetAndConsume(ret, 0, new_OrgGeogebraCommonKernelGeosGeoBoolean_initWithOrgGeogebraCommonKernelConstruction_(self->cons_));
    ...
    IOSObjectArray_Set(ret, 0, [([new_OrgGeogebraCommonKernelAlgosAlgoDependentBoolean_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticExpressionNode_(self->cons_, label, n) autorelease]) getGeoBoolean]);
  }
  return ret;
}
...
IOSObjectArray *OrgGeogebraCommonKernelCommandsAlgebraProcessor_processPointVectorWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticExpressionValue_(OrgGeogebraCommonKernelCommandsAlgebraProcessor *self, OrgGeogebraCommonKernelArithmeticExpressionNode *n, id<OrgGeogebraCommonKernelArithmeticExpressionValue> evaluate) {
  ...
  IOSObjectArray *ret = [IOSObjectArray arrayWithLength:1 type:OrgGeogebraCommonKernelGeosGeoVec3D_class_()];
  jboolean isIndependent = ![n inspectWithOrgGeogebraCommonKernelArithmeticInspecting:OrgGeogebraCommonKernelArithmeticInspecting_get_dynamicGeosFinder_()];
  if (complex) {
    [n setForcePoint];
  }
  ...
  if (isIndependent) {
    jdouble x = [p getX];
    jdouble y = [p getY];
    if (isVector) IOSObjectArray_Set(ret, 0, [((OrgGeogebraCommonKernelAlgosAlgoDispatcher *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) getAlgoDispatcher])) VectorWithNSString:label withDouble:x withDouble:y]);
    else IOSObjectArray_Set(ret, 0, [((OrgGeogebraCommonKernelAlgosAlgoDispatcher *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) getAlgoDispatcher])) PointWithNSString:label withDouble:x withDouble:y withBoolean:complex]);
  }
  else {
    if (isVector) IOSObjectArray_Set(ret, 0, OrgGeogebraCommonKernelCommandsAlgebraProcessor_DependentVectorWithNSString_withOrgGeogebraCommonKernelArithmeticExpressionNode_(self, label, n));
    else IOSObjectArray_Set(ret, 0, OrgGeogebraCommonKernelCommandsAlgebraProcessor_DependentPointWithNSString_withOrgGeogebraCommonKernelArithmeticExpressionNode_withBoolean_(self, label, n, complex));
  }
  if (polar) {
...
OrgGeogebraCommonKernelGeosGeoPoint *OrgGeogebraCommonKernelCommandsAlgebraProcessor_DependentPointWithNSString_withOrgGeogebraCommonKernelArithmeticExpressionNode_withBoolean_(OrgGeogebraCommonKernelCommandsAlgebraProcessor *self, NSString *label, OrgGeogebraCommonKernelArithmeticExpressionNode *root, jboolean complex) {
  OrgGeogebraCommonKernelAlgosAlgoDependentPoint *algo = [new_OrgGeogebraCommonKernelAlgosAlgoDependentPoint_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticExpressionNode_withBoolean_(self->cons_, label, root, complex) autorelease];
...
OrgGeogebraCommonKernelGeosGeoVector *OrgGeogebraCommonKernelCommandsAlgebraProcessor_DependentVectorWithNSString_withOrgGeogebraCommonKernelArithmeticExpressionNode_(OrgGeogebraCommonKernelCommandsAlgebraProcessor *self, NSString *label, OrgGeogebraCommonKernelArithmeticExpressionNode *root) {
  OrgGeogebraCommonKernelAlgosAlgoDependentVector *algo = [new_OrgGeogebraCommonKernelAlgosAlgoDependentVector_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticExpressionNode_(self->cons_, label, root) autorelease];
...
IOSObjectArray *OrgGeogebraCommonKernelCommandsAlgebraProcessor_processGeoCopyWithNSString_withOrgGeogebraCommonKernelArithmeticExpressionNode_(OrgGeogebraCommonKernelCommandsAlgebraProcessor *self, NSString *copyLabel, OrgGeogebraCommonKernelArithmeticExpressionNode *origGeoNode) {
  IOSObjectArray *ret = [IOSObjectArray arrayWithLength:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
  IOSObjectArray_Set(ret, 0, OrgGeogebraCommonKernelCommandsAlgebraProcessor_DependentGeoCopyWithNSString_withOrgGeogebraCommonKernelArithmeticExpressionNode_(self, copyLabel, origGeoNode));
  return ret;
}
...
OrgGeogebraCommonKernelGeosGeoElement *OrgGeogebraCommonKernelCommandsAlgebraProcessor_DependentGeoCopyWithNSString_withOrgGeogebraCommonKernelArithmeticExpressionNode_(OrgGeogebraCommonKernelCommandsAlgebraProcessor *self, NSString *label, OrgGeogebraCommonKernelArithmeticExpressionNode *origGeoNode) {
  OrgGeogebraCommonKernelAlgosAlgoDependentGeoCopy *algo = [new_OrgGeogebraCommonKernelAlgosAlgoDependentGeoCopy_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticExpressionNode_(self->cons_, label, origGeoNode) autorelease];
  return [algo getGeo];
}
...
void OrgGeogebraCommonKernelCommandsAlgebraProcessor_$1_initWithOrgGeogebraCommonKernelCommandsAlgebraProcessor_withOrgGeogebraCommonKernelArithmeticValidExpression_withBoolean_withBoolean_withBoolean_withOrgGeogebraCommonUtilAsyncOperation_(OrgGeogebraCommonKernelCommandsAlgebraProcessor_$1 *self, OrgGeogebraCommonKernelCommandsAlgebraProcessor *outer$, OrgGeogebraCommonKernelArithmeticValidExpression *capture$0, jboolean capture$1, jboolean capture$2, jboolean capture$3, OrgGeogebraCommonUtilAsyncOperation *capture$4) {
  OrgGeogebraCommonKernelCommandsAlgebraProcessor_$1_set_this$0_(self, outer$);
  OrgGeogebraCommonKernelCommandsAlgebraProcessor_$1_set_val$ve2_(self, capture$0);
  self->val$storeUndo_ = capture$1;
  self->val$allowErrorDialog_ = capture$2;
  self->val$throwMyError_ = capture$3;
  OrgGeogebraCommonKernelCommandsAlgebraProcessor_$1_set_val$callback0_(self, capture$4);
...
void OrgGeogebraCommonKernelCommandsAlgebraProcessor_$2_initWithOrgGeogebraCommonKernelCommandsAlgebraProcessor_(OrgGeogebraCommonKernelCommandsAlgebraProcessor_$2 *self, OrgGeogebraCommonKernelCommandsAlgebraProcessor *outer$) {
  OrgGeogebraCommonKernelCommandsAlgebraProcessor_$2_set_this$0_(self, outer$);
  NSObject_init(self);
}
