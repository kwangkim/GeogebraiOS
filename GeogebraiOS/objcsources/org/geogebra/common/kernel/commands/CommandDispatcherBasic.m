...
- (OrgGeogebraCommonKernelCommandsCommandProcessor *)dispatchWithOrgGeogebraCommonKernelCommandsCommandsEnum:(OrgGeogebraCommonKernelCommandsCommandsEnum *)c
  ...
  switch ([c ordinal]) {
    ...
    return [new_OrgGeogebraCommonKernelCommandsCmdTangent_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Length:
    return [new_OrgGeogebraCommonKernelCommandsCmdLength_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Sort:
    return [new_OrgGeogebraCommonKernelCommandsCmdSort_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_BarChart:
    return [new_OrgGeogebraCommonKernelCommandsCmdBarChart_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Product:
    return [new_OrgGeogebraCommonKernelCommandsCmdProduct_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Extremum:
    return [new_OrgGeogebraCommonKernelCommandsCmdExtremum_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Join:
    return [new_OrgGeogebraCommonKernelCommandsCmdJoin_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_LCM:
    return [new_OrgGeogebraCommonKernelCommandsCmdLCM_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_GCD:
    return [new_OrgGeogebraCommonKernelCommandsCmdGCD_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Object:
    return [new_OrgGeogebraCommonKernelCommandsCmdObject_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_LetterToUnicode:
    return [new_OrgGeogebraCommonKernelCommandsCmdLetterToUnicode_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_UnicodeToLetter:
    return [new_OrgGeogebraCommonKernelCommandsCmdUnicodeToLetter_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_CountIf:
    return [new_OrgGeogebraCommonKernelCommandsCmdCountIf_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_UnitVector:
    return [new_OrgGeogebraCommonKernelAlgosCmdUnitVector_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    ...
    return [new_OrgGeogebraCommonKernelAlgosCmdUnitOrthogonalVector_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Text:
    return [new_OrgGeogebraCommonKernelCommandsCmdText_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Vector:
    return [new_OrgGeogebraCommonKernelCommandsCmdVector_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Dot:
    return [new_OrgGeogebraCommonKernelCommandsCmdCAStoOperation_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonPluginOperationEnum_(kernel, OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY()) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Cross:
    return [new_OrgGeogebraCommonKernelCommandsCmdCAStoOperation_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonPluginOperationEnum_(kernel, OrgGeogebraCommonPluginOperationEnum_get_VECTORPRODUCT()) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_PolyLine:
    return [new_OrgGeogebraCommonKernelCommandsCmdPolyLine_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_PointIn:
    return [new_OrgGeogebraCommonKernelCommandsCmdPointIn_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Line:
    return [new_OrgGeogebraCommonKernelCommandsCmdLine_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Ray:
    return [new_OrgGeogebraCommonKernelCommandsCmdRay_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_AngleBisector:
    case OrgGeogebraCommonKernelCommandsCommands_AngularBisector:
    return [new_OrgGeogebraCommonKernelCommandsCmdAngularBisector_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Segment:
    return [new_OrgGeogebraCommonKernelCommandsCmdSegment_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Slope:
    return [new_OrgGeogebraCommonKernelCommandsCmdSlope_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Angle:
    return [new_OrgGeogebraCommonKernelCommandsCmdAngle_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Point:
    return [new_OrgGeogebraCommonKernelCommandsCmdPoint_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Midpoint:
    case OrgGeogebraCommonKernelCommandsCommands_Center:
    return [new_OrgGeogebraCommonKernelCommandsCmdMidpoint_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Intersect:
    return [new_OrgGeogebraCommonKernelCommandsCmdIntersect_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Distance:
    return [new_OrgGeogebraCommonKernelCommandsCmdDistance_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Radius:
    return [new_OrgGeogebraCommonKernelCommandsCmdRadius_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Arc:
    return [new_OrgGeogebraCommonKernelCommandsCmdArcSector_initWithOrgGeogebraCommonKernelKernel_withInt_(kernel, OrgGeogebraCommonKernelKernelNDGeoConicNDConstants_CONIC_PART_ARC) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Sector:
    return [new_OrgGeogebraCommonKernelCommandsCmdArcSector_initWithOrgGeogebraCommonKernelKernel_withInt_(kernel, OrgGeogebraCommonKernelKernelNDGeoConicNDConstants_CONIC_PART_SECTOR) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_CircleArc:
    case OrgGeogebraCommonKernelCommandsCommands_CircularArc:
    return [new_OrgGeogebraCommonKernelCommandsCmdCircleArcSector_initWithOrgGeogebraCommonKernelKernel_withInt_(kernel, OrgGeogebraCommonKernelKernelNDGeoConicNDConstants_CONIC_PART_ARC) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_CircleSector:
    case OrgGeogebraCommonKernelCommandsCommands_CircularSector:
    return [new_OrgGeogebraCommonKernelCommandsCmdCircleArcSector_initWithOrgGeogebraCommonKernelKernel_withInt_(kernel, OrgGeogebraCommonKernelKernelNDGeoConicNDConstants_CONIC_PART_SECTOR) autorelease];
    ...
    return [new_OrgGeogebraCommonKernelCommandsCmdCircumcircleSector_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    ...
    return [new_OrgGeogebraCommonKernelCommandsCmdCircumcircleArc_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Polygon:
    return [new_OrgGeogebraCommonKernelCommandsCmdPolygon_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Area:
    return [new_OrgGeogebraCommonKernelCommandsCmdArea_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Circumference:
    return [new_OrgGeogebraCommonKernelCommandsCmdCircumference_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Perimeter:
    return [new_OrgGeogebraCommonKernelCommandsCmdPerimeter_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Locus:
    return [new_OrgGeogebraCommonKernelCommandsCmdLocus_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Vertex:
    return [new_OrgGeogebraCommonKernelCommandsCmdVertex_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_If:
    return [new_OrgGeogebraCommonKernelCommandsCmdIf_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Root:
    return [new_OrgGeogebraCommonKernelCommandsCmdRoot_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_TurningPoint:
    return [new_OrgGeogebraCommonKernelCommandsCmdTurningPoint_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Polynomial:
    return [new_OrgGeogebraCommonKernelCommandsCmdPolynomial_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Function:
    return [new_OrgGeogebraCommonKernelCommandsCmdFunction_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Curve:
    case OrgGeogebraCommonKernelCommandsCommands_CurveCartesian:
    return [new_OrgGeogebraCommonKernelCommandsCmdCurveCartesian_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_LowerSum:
    return [new_OrgGeogebraCommonKernelCommandsCmdLowerSum_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_LeftSum:
    return [new_OrgGeogebraCommonKernelCommandsCmdLeftSum_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_RectangleSum:
    return [new_OrgGeogebraCommonKernelCommandsCmdRectangleSum_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_UpperSum:
    return [new_OrgGeogebraCommonKernelCommandsCmdUpperSum_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_TrapezoidalSum:
    return [new_OrgGeogebraCommonKernelCommandsCmdTrapezoidalSum_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Ellipse:
    return [new_OrgGeogebraCommonKernelCommandsCmdEllipseHyperbola_initWithOrgGeogebraCommonKernelKernel_withInt_(kernel, OrgGeogebraCommonKernelKernelNDGeoConicNDConstants_CONIC_ELLIPSE) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Hyperbola:
    return [new_OrgGeogebraCommonKernelCommandsCmdEllipseHyperbola_initWithOrgGeogebraCommonKernelKernel_withInt_(kernel, OrgGeogebraCommonKernelKernelNDGeoConicNDConstants_CONIC_HYPERBOLA) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Conic:
    return [new_OrgGeogebraCommonKernelCommandsCmdConic_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Circle:
    return [new_OrgGeogebraCommonKernelCommandsCmdCircle_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Semicircle:
    return [new_OrgGeogebraCommonKernelCommandsCmdSemicircle_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Parabola:
    return [new_OrgGeogebraCommonKernelCommandsCmdParabola_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Focus:
    return [new_OrgGeogebraCommonKernelCommandsCmdFocus_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Element:
    return [new_OrgGeogebraCommonKernelCommandsCmdElement_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Sequence:
    return [new_OrgGeogebraCommonKernelCommandsCmdSequence_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Reflect:
    case OrgGeogebraCommonKernelCommandsCommands_Mirror:
    return [new_OrgGeogebraCommonKernelCommandsCmdMirror_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Dilate:
    return [new_OrgGeogebraCommonKernelCommandsCmdDilate_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Rotate:
    return [new_OrgGeogebraCommonKernelCommandsCmdRotate_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Translate:
    return [new_OrgGeogebraCommonKernelCommandsCmdTranslate_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Shear:
    return [new_OrgGeogebraCommonKernelCommandsCmdShear_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Stretch:
    return [new_OrgGeogebraCommonKernelCommandsCmdStretch_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Corner:
    return [new_OrgGeogebraCommonKernelCommandsCmdCorner_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Name:
    return [new_OrgGeogebraCommonKernelCommandsCmdName_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Diameter:
    case OrgGeogebraCommonKernelCommandsCommands_ConjugateDiameter:
    return [new_OrgGeogebraCommonKernelCommandsCmdDiameter_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    ...
    return [new_OrgGeogebraCommonKernelCommandsCmdLineBisector_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    ...
    return [new_OrgGeogebraCommonKernelCommandsCmdOrthogonalLine_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    ...
    return [new_OrgGeogebraCommonKernelCommandsCmdOrthogonalVector_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Random:
    return [new_OrgGeogebraCommonKernelCommandsCmdRandom_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_RandomBetween:
    return [new_OrgGeogebraCommonKernelCommandsCmdRandom_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Sum:
    return [new_OrgGeogebraCommonKernelCommandsCmdSum_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Binomial:
    case OrgGeogebraCommonKernelCommandsCommands_BinomialCoefficient:
    return [new_OrgGeogebraCommonKernelCommandsCmdBinomial_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Mod:
    return [new_OrgGeogebraCommonKernelCommandsCmdMod_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Div:
    return [new_OrgGeogebraCommonKernelCommandsCmdDiv_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Min:
    return [new_OrgGeogebraCommonKernelCommandsCmdMin_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Max:
    return [new_OrgGeogebraCommonKernelCommandsCmdMax_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Append:
    return [new_OrgGeogebraCommonKernelCommandsCmdAppend_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_First:
    return [new_OrgGeogebraCommonKernelCommandsCmdFirst_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Last:
    return [new_OrgGeogebraCommonKernelCommandsCmdLast_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_RemoveUndefined:
    return [new_OrgGeogebraCommonKernelCommandsCmdRemoveUndefined_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Remove:
    return [new_OrgGeogebraCommonKernelCommandsCmdRemove_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Reverse:
    return [new_OrgGeogebraCommonKernelCommandsCmdReverse_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_TableText:
    return [new_OrgGeogebraCommonKernelCommandsCmdTableText_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Take:
    return [new_OrgGeogebraCommonKernelCommandsCmdTake_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_TextToUnicode:
    return [new_OrgGeogebraCommonKernelCommandsCmdTextToUnicode_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_UnicodeToText:
    return [new_OrgGeogebraCommonKernelCommandsCmdUnicodeToText_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_FractionText:
    return [new_OrgGeogebraCommonKernelCommandsCmdFractionText_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_KeepIf:
    return [new_OrgGeogebraCommonKernelCommandsCmdKeepIf_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_IsInteger:
    return [new_OrgGeogebraCommonKernelCommandsCmdIsInteger_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Defined:
    case OrgGeogebraCommonKernelCommandsCommands_IsDefined:
    return [new_OrgGeogebraCommonKernelCommandsCmdDefined_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Spline:
    return [new_OrgGeogebraCommonKernelCommandsCmdSpline_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_FormulaText:
    case OrgGeogebraCommonKernelCommandsCommands_LaTeX:
    return [new_OrgGeogebraCommonKernelCommandsCmdLaTeX_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    default:
    break;
  }
  return nil;
