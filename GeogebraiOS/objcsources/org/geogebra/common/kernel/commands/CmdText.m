...
- (IOSObjectArray *)processWithOrgGeogebraCommonKernelArithmeticCommand:(OrgGeogebraCommonKernelArithmeticCommand *)c {
  ...
  IOSObjectArray *arg;
  {
    ...
    switch (n) {
      ...
      algo = new_OrgGeogebraCommonKernelAlgosAlgoText_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoElement_(cons_, [c getLabel], IOSObjectArray_Get(nil_chk(arg), 0));
      ...
      if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(IOSObjectArray_Get(nil_chk(arg), 1))) isGeoBoolean]) {
        ...
        IOSObjectArray *ret2 = [IOSObjectArray newArrayWithObjects:(id[]){ [algo getGeoText] } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
        return ret2;
      }
