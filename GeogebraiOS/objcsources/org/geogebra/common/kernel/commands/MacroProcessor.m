...
- (IOSObjectArray *)processWithOrgGeogebraCommonKernelArithmeticCommand:(OrgGeogebraCommonKernelArithmeticCommand *)c {
  ...
  if (((IOSObjectArray *) nil_chk(arg))->size_ != ((IOSObjectArray *) nil_chk(macroInputTypes))->size_) {
    ...
    if (arg->size_ > 0 && [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(IOSObjectArray_Get(arg, 0))) isGeoPolygon]) {
      ...
      arg = [IOSObjectArray arrayWithLength:((IOSObjectArray *) nil_chk(points))->size_ type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
      for (jint i = 0; i < points->size_; i++) IOSObjectArray_Set(arg, i, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(IOSObjectArray_Get(points, i), [OrgGeogebraCommonKernelGeosGeoElement class]));
      lengthOk = (arg->size_ == macroInputTypes->size_);
    }
    if (!lengthOk) {
      JavaLangStringBuilder *sb = [new_JavaLangStringBuilder_init() autorelease];
      [sb appendWithNSString:JreStrcat("$C$$", [((OrgGeogebraCommonMainLocalization *) nil_chk(loc_)) getMenuWithNSString:@"Macro"], ' ', [macro getCommandName], @":\n")];
      ...
      @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSString_(loc_, [sb description]) autorelease];
    }
  }
  for (jint i = 0; i < macroInputTypes->size_; i++) {
    if (![((OrgGeogebraCommonKernelGeosTestEnum *) nil_chk(IOSObjectArray_Get(macroInputTypes, i))) checkWithId:IOSObjectArray_Get(arg, i)]) {
      JavaLangStringBuilder *sb = [new_JavaLangStringBuilder_init() autorelease];
      [sb appendWithNSString:JreStrcat("$C$$", [((OrgGeogebraCommonMainLocalization *) nil_chk(loc_)) getPlainWithNSString:@"Macro"], ' ', [macro getCommandName], @":\n")];
      [sb appendWithNSString:JreStrcat("$$", [loc_ getErrorWithNSString:@"IllegalArgument"], @": ")];
      [sb appendWithNSString:[((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(IOSObjectArray_Get(arg, i))) getNameDescription]];
      [sb appendWithNSString:JreStrcat("$$", @"\n\nSyntax:\n", [macro description])];
      @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSString_(loc_, [sb description]) autorelease];
    }
  }
