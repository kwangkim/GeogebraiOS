...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/commands/CmdScripting.java
//
...
- (IOSObjectArray *)processWithOrgGeogebraCommonKernelArithmeticCommand:(OrgGeogebraCommonKernelArithmeticCommand *)c {
  OrgGeogebraCommonKernelGeosGeoScriptAction *sa = [new_OrgGeogebraCommonKernelGeosGeoScriptAction_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelCommandsCmdScripting_withOrgGeogebraCommonKernelArithmeticCommand_(cons_, self, c) autorelease];
  return [IOSObjectArray arrayWithObjects:(id[]){ sa } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
}
