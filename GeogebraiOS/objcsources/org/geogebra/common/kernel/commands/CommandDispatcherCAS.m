...
- (OrgGeogebraCommonKernelCommandsCommandProcessor *)dispatchWithOrgGeogebraCommonKernelCommandsCommandsEnum:(OrgGeogebraCommonKernelCommandsCommandsEnum *)c
  ...
  switch ([c ordinal]) {
    ...
    return new_OrgGeogebraCommonKernelCasCmdCASCommand1Arg_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelCommandsCommandsEnum_(kernel, c);
    case OrgGeogebraCommonKernelCommandsCommands_Simplify:
    return new_OrgGeogebraCommonKernelCasCmdSimplify_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_SurdText:
    return new_OrgGeogebraCommonKernelCasCmdSurdText_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_ParametricDerivative:
    return new_OrgGeogebraCommonKernelCasCmdParametricDerivative_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Derivative:
    return new_OrgGeogebraCommonKernelCommandsCmdDerivative_initWithOrgGeogebraCommonKernelKernel_(kernel);
    ...
    return new_OrgGeogebraCommonKernelCasCmdIntegral_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelCommandsCommandsEnum_(kernel, c);
    case OrgGeogebraCommonKernelCommandsCommands_TrigExpand:
    return new_OrgGeogebraCommonKernelCasCmdTrigExpand_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_TrigCombine:
    return new_OrgGeogebraCommonKernelCasCmdTrigCombine_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Limit:
    return new_OrgGeogebraCommonKernelCasCmdLimit_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_LimitBelow:
    return new_OrgGeogebraCommonKernelCasCmdLimitBelow_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_LimitAbove:
    return new_OrgGeogebraCommonKernelCasCmdLimitAbove_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Degree:
    return new_OrgGeogebraCommonKernelCasCmdDegree_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Coefficients:
    return new_OrgGeogebraCommonKernelCasCmdCoefficients_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_PartialFractions:
    return new_OrgGeogebraCommonKernelCasCmdPartialFractions_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_SolveODE:
    return new_OrgGeogebraCommonKernelCasCmdSolveODE_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_ImplicitDerivative:
    return new_OrgGeogebraCommonKernelCasCmdImplicitDerivative_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_NextPrime:
    return new_OrgGeogebraCommonKernelCasCmdNextPreviousPrime_initWithOrgGeogebraCommonKernelKernel_withBoolean_(kernel, YES);
    case OrgGeogebraCommonKernelCommandsCommands_PreviousPrime:
    return new_OrgGeogebraCommonKernelCasCmdNextPreviousPrime_initWithOrgGeogebraCommonKernelKernel_withBoolean_(kernel, NO);
    default:
    break;
  }
  return nil;
