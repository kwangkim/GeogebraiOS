...
- (id<OrgGeogebraCommonKernelKernelNDGeoPointND>)pointWithNSString:(NSString *)label
  ...
  OrgGeogebraCommonKernelAlgosAlgoPointVector *algo = new_OrgGeogebraCommonKernelAlgosAlgoPointVector_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoVectorND_(cons_, label, point, vector);
  return [algo getQ];
}
