...
- (OrgGeogebraCommonKernelCommandsCommandProcessor *)dispatchWithOrgGeogebraCommonKernelCommandsCommandsEnum:(OrgGeogebraCommonKernelCommandsCommandsEnum *)c
  ...
  switch ([c ordinal]) {
    ...
    return new_OrgGeogebraCommonKernelAdvancedCmdFactors_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_IntersectPath:
    case OrgGeogebraCommonKernelCommandsCommands_IntersectRegion:
    return new_OrgGeogebraCommonKernelAdvancedCmdIntersectPath_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Direction:
    return new_OrgGeogebraCommonKernelAdvancedCmdDirection_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_TaylorPolynomial:
    case OrgGeogebraCommonKernelCommandsCommands_TaylorSeries:
    return new_OrgGeogebraCommonKernelAdvancedCmdTaylorSeries_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_SecondAxis:
    case OrgGeogebraCommonKernelCommandsCommands_MinorAxis:
    return new_OrgGeogebraCommonKernelAdvancedCmdSecondAxis_initWithOrgGeogebraCommonKernelKernel_(kernel);
    ...
    return new_OrgGeogebraCommonKernelAdvancedCmdSecondAxisLength_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Directrix:
    return new_OrgGeogebraCommonKernelAdvancedCmdDirectrix_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Numerator:
    return new_OrgGeogebraCommonKernelAdvancedCmdNumerator_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Denominator:
    return new_OrgGeogebraCommonKernelAdvancedCmdDenominator_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_ComplexRoot:
    return new_OrgGeogebraCommonKernelAdvancedCmdComplexRoot_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_SlopeField:
    return new_OrgGeogebraCommonKernelAdvancedCmdSlopeField_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Iteration:
    return new_OrgGeogebraCommonKernelAdvancedCmdIteration_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_PathParameter:
    return new_OrgGeogebraCommonKernelAdvancedCmdPathParameter_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Asymptote:
    return new_OrgGeogebraCommonKernelAdvancedCmdAsymptote_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_CurvatureVector:
    return new_OrgGeogebraCommonKernelAdvancedCmdCurvatureVector_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Curvature:
    return new_OrgGeogebraCommonKernelAdvancedCmdCurvature_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_OsculatingCircle:
    return new_OrgGeogebraCommonKernelAdvancedCmdOsculatingCircle_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_IterationList:
    return new_OrgGeogebraCommonKernelAdvancedCmdIterationList_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_RootList:
    return new_OrgGeogebraCommonKernelAdvancedCmdRootList_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_ImplicitCurve:
    return new_OrgGeogebraCommonKernelAdvancedCmdImplicitPoly_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Roots:
    return new_OrgGeogebraCommonKernelAdvancedCmdRoots_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_AffineRatio:
    return new_OrgGeogebraCommonKernelAdvancedCmdAffineRatio_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_CrossRatio:
    return new_OrgGeogebraCommonKernelAdvancedCmdCrossRatio_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_ClosestPoint:
    return new_OrgGeogebraCommonKernelAdvancedCmdClosestPoint_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_IsInRegion:
    return new_OrgGeogebraCommonKernelAdvancedCmdIsInRegion_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_PrimeFactors:
    return new_OrgGeogebraCommonKernelAdvancedCmdPrimeFactors_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_CompleteSquare:
    return new_OrgGeogebraCommonKernelAdvancedCmdCompleteSquare_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Union:
    return new_OrgGeogebraCommonKernelAdvancedCmdUnion_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_ScientificText:
    return new_OrgGeogebraCommonKernelAdvancedCmdScientificText_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_VerticalText:
    return new_OrgGeogebraCommonKernelAdvancedCmdVerticalText_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_RotateText:
    return new_OrgGeogebraCommonKernelAdvancedCmdRotateText_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Ordinal:
    return new_OrgGeogebraCommonKernelAdvancedCmdOrdinal_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Parameter:
    return new_OrgGeogebraCommonKernelAdvancedCmdParameter_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Incircle:
    return new_OrgGeogebraCommonKernelAdvancedCmdIncircle_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_SelectedElement:
    return new_OrgGeogebraCommonKernelAdvancedCmdSelectedElement_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_SelectedIndex:
    return new_OrgGeogebraCommonKernelAdvancedCmdSelectedIndex_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Unique:
    return new_OrgGeogebraCommonKernelAdvancedCmdUnique_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Zip:
    return new_OrgGeogebraCommonKernelAdvancedCmdZip_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Intersection:
    return new_OrgGeogebraCommonKernelAdvancedCmdIntersection_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_PointList:
    return new_OrgGeogebraCommonKernelCommandsCmdPointList_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_ApplyMatrix:
    return new_OrgGeogebraCommonKernelAdvancedCmdApplyMatrix_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Invert:
    return new_OrgGeogebraCommonKernelAdvancedCmdInvert_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Transpose:
    return new_OrgGeogebraCommonKernelAdvancedCmdTranspose_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_ReducedRowEchelonForm:
    return new_OrgGeogebraCommonKernelAdvancedCmdReducedRowEchelonForm_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Determinant:
    return new_OrgGeogebraCommonKernelAdvancedCmdDeterminant_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Identity:
    return new_OrgGeogebraCommonKernelAdvancedCmdIdentity_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Centroid:
    return new_OrgGeogebraCommonKernelAdvancedCmdCentroid_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_MajorAxis:
    case OrgGeogebraCommonKernelCommandsCommands_FirstAxis:
    return new_OrgGeogebraCommonKernelAdvancedCmdFirstAxis_initWithOrgGeogebraCommonKernelKernel_(kernel);
    ...
    return new_OrgGeogebraCommonKernelAdvancedCmdFirstAxisLength_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_AxisStepX:
    return new_OrgGeogebraCommonKernelAdvancedCmdAxisStepX_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_AxisStepY:
    return new_OrgGeogebraCommonKernelAdvancedCmdAxisStepY_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_ConstructionStep:
    return new_OrgGeogebraCommonKernelAdvancedCmdConstructionStep_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Polar:
    return new_OrgGeogebraCommonKernelAdvancedCmdPolar_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_LinearEccentricity:
    case OrgGeogebraCommonKernelCommandsCommands_Excentricity:
    return new_OrgGeogebraCommonKernelAdvancedCmdExcentricity_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Eccentricity:
    return new_OrgGeogebraCommonKernelAdvancedCmdEccentricity_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Axes:
    return new_OrgGeogebraCommonKernelAdvancedCmdAxes_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_IndexOf:
    return new_OrgGeogebraCommonKernelAdvancedCmdIndexOf_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Flatten:
    return new_OrgGeogebraCommonKernelAdvancedCmdFlatten_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Insert:
    return new_OrgGeogebraCommonKernelAdvancedCmdInsert_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Prove:
    return new_OrgGeogebraCommonKernelAdvancedCmdProve_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_ProveDetails:
    return new_OrgGeogebraCommonKernelAdvancedCmdProveDetails_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_DynamicCoordinates:
    return new_OrgGeogebraCommonKernelAdvancedCmdDynamicCoordinates_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Maximize:
    return new_OrgGeogebraCommonKernelAdvancedCmdMaximize_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Minimize:
    return new_OrgGeogebraCommonKernelAdvancedCmdMinimize_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_AreCollinear:
    return new_OrgGeogebraCommonKernelAdvancedCmdAreCollinear_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_AreParallel:
    return new_OrgGeogebraCommonKernelAdvancedCmdAreParallel_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_AreConcyclic:
    return new_OrgGeogebraCommonKernelAdvancedCmdAreConcyclic_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_ArePerpendicular:
    return new_OrgGeogebraCommonKernelAdvancedCmdArePerpendicular_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_AreEqual:
    return new_OrgGeogebraCommonKernelAdvancedCmdAreEqual_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_AreConcurrent:
    return new_OrgGeogebraCommonKernelAdvancedCmdAreConcurrent_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_ToBase:
    return new_OrgGeogebraCommonKernelAdvancedCmdToBase_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_FromBase:
    return new_OrgGeogebraCommonKernelAdvancedCmdFromBase_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_ContinuedFraction:
    return new_OrgGeogebraCommonKernelAdvancedCmdContinuedFraction_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_AttachCopyToView:
    return new_OrgGeogebraCommonKernelAdvancedCmdAttachCopyToView_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Divisors:
    return new_OrgGeogebraCommonKernelAdvancedCmdDivisorsOrDivisorsSum_initWithOrgGeogebraCommonKernelKernel_withBoolean_(kernel, NO);
    case OrgGeogebraCommonKernelCommandsCommands_DivisorsSum:
    return new_OrgGeogebraCommonKernelAdvancedCmdDivisorsOrDivisorsSum_initWithOrgGeogebraCommonKernelKernel_withBoolean_(kernel, YES);
    case OrgGeogebraCommonKernelCommandsCommands_Dimension:
    return new_OrgGeogebraCommonKernelAdvancedCmdDimension_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_DivisorsList:
    return new_OrgGeogebraCommonKernelAdvancedCmdDivisorsList_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_IsPrime:
    return new_OrgGeogebraCommonKernelAdvancedCmdIsPrime_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_LeftSide:
    return new_OrgGeogebraCommonKernelAdvancedCmdLeftRightSide_initWithOrgGeogebraCommonKernelKernel_withBoolean_(kernel, YES);
    case OrgGeogebraCommonKernelCommandsCommands_RightSide:
    return new_OrgGeogebraCommonKernelAdvancedCmdLeftRightSide_initWithOrgGeogebraCommonKernelKernel_withBoolean_(kernel, NO);
    case OrgGeogebraCommonKernelCommandsCommands_Division:
    return new_OrgGeogebraCommonKernelAdvancedCmdDivision_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_MatrixRank:
    return new_OrgGeogebraCommonKernelAdvancedCmdMatrixRank_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_CommonDenominator:
    return new_OrgGeogebraCommonKernelAdvancedCmdCommonDenominator_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_ToPoint:
    return new_OrgGeogebraCommonKernelAdvancedCmdToComplexPolar_initWithOrgGeogebraCommonKernelKernel_withInt_(kernel, OrgGeogebraCommonKernelKernel_COORD_CARTESIAN);
    case OrgGeogebraCommonKernelCommandsCommands_ToComplex:
    return new_OrgGeogebraCommonKernelAdvancedCmdToComplexPolar_initWithOrgGeogebraCommonKernelKernel_withInt_(kernel, OrgGeogebraCommonKernelKernel_COORD_COMPLEX);
    case OrgGeogebraCommonKernelCommandsCommands_ToPolar:
    return new_OrgGeogebraCommonKernelAdvancedCmdToComplexPolar_initWithOrgGeogebraCommonKernelKernel_withInt_(kernel, OrgGeogebraCommonKernelKernel_COORD_POLAR);
    case OrgGeogebraCommonKernelCommandsCommands_NSolveODE:
    return new_OrgGeogebraCommonKernelAdvancedCmdNSolveODE_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Rate:
    return new_OrgGeogebraCommonKernelAdvancedCmdFinancialRate_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Periods:
    return new_OrgGeogebraCommonKernelAdvancedCmdFinancialNper_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_Payment:
    return new_OrgGeogebraCommonKernelAdvancedCmdFinancialPmt_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_PresentValue:
    return new_OrgGeogebraCommonKernelAdvancedCmdFinancialPV_initWithOrgGeogebraCommonKernelKernel_(kernel);
    case OrgGeogebraCommonKernelCommandsCommands_FutureValue:
    return new_OrgGeogebraCommonKernelAdvancedCmdFinancialFV_initWithOrgGeogebraCommonKernelKernel_(kernel);
    default:
    break;
  }
  return nil;
