  ...
  switch (n) {
    ...
    if ((*IOSBooleanArray_GetRef(ok, 0) = (([OrgGeogebraCommonKernelArithmeticFunctionalNVar_class_() isInstance:IOSObjectArray_Get(nil_chk(arg), 0)]) || [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(IOSObjectArray_Get(arg, 0))) isGeoLocus])) && (*IOSBooleanArray_GetRef(ok, 1) = [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(IOSObjectArray_Get(arg, 1))) isGeoPoint])) {
      ...
      if ([((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(p2)) isPointOnPath]) {
        IOSObjectArray *ret = [IOSObjectArray arrayWithObjects:(id[]){ [self locusWithNSString:[c getLabel] withOrgGeogebraCommonKernelKernelNDGeoPointND:p1 withOrgGeogebraCommonKernelKernelNDGeoPointND:p2] } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
        return ret;
      }
      IOSObjectArray *ret = [IOSObjectArray arrayWithObjects:(id[]){ [self locusWithNSString:[c getLabel] withOrgGeogebraCommonKernelKernelNDGeoPointND:p2 withOrgGeogebraCommonKernelKernelNDGeoPointND:p1] } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
      return ret;
    }
      ...
      IOSObjectArray *ret = [IOSObjectArray arrayWithObjects:(id[]){ [self locusWithNSString:[c getLabel] withOrgGeogebraCommonKernelKernelNDGeoPointND:p1 withOrgGeogebraCommonKernelGeosGeoNumeric:p2] } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
      return ret;
    }
    else {
