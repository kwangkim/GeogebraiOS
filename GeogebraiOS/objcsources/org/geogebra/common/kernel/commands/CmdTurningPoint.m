  ...
  switch (n) {
    ...
    if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(IOSObjectArray_Get(nil_chk(arg), 0))) isGeoFunctionable]) {
      ...
      if ([((OrgGeogebraCommonPluginOperationEnum *) nil_chk([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(exp)) getOperation])) isEqual:OrgGeogebraCommonPluginOperationEnum_get_IF()]) {
        OrgGeogebraCommonKernelAlgosAlgoTurningPointPolynomialInterval *algo = new_OrgGeogebraCommonKernelAlgosAlgoTurningPointPolynomialInterval_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelGeosGeoFunction_(cons_, [c getLabels], f);
        IOSObjectArray *g = [algo getRootPoints];
        return g;
      }
      OrgGeogebraCommonKernelAlgosAlgoTurningPointPolynomial *algo = new_OrgGeogebraCommonKernelAlgosAlgoTurningPointPolynomial_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelGeosGeoFunction_(cons_, [c getLabels], f);
