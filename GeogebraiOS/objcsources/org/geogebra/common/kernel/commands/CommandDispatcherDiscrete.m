...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/commands/CommandDispatcherDiscrete.java
//
...
- (OrgGeogebraCommonKernelCommandsCommandProcessor *)dispatchWithOrgGeogebraCommonKernelCommandsCommandsEnum:(OrgGeogebraCommonKernelCommandsCommandsEnum *)c
  ...
  switch ([c ordinal]) {
    ...
    return [new_OrgGeogebraCommonKernelBarycentricCmdKimberling_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Barycenter:
    return [new_OrgGeogebraCommonKernelBarycentricCmdBarycenter_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Trilinear:
    return [new_OrgGeogebraCommonKernelBarycentricCmdTrilinear_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Cubic:
    return [new_OrgGeogebraCommonKernelBarycentricCmdCubic_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_TriangleCurve:
    return [new_OrgGeogebraCommonKernelBarycentricCmdTriangleCurve_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Voronoi:
    return [new_OrgGeogebraCommonKernelDiscreteCmdVoronoi_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_Hull:
    return [new_OrgGeogebraCommonKernelDiscreteCmdHull_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_ConvexHull:
    return [new_OrgGeogebraCommonKernelDiscreteCmdConvexHull_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_MinimumSpanningTree:
    return [new_OrgGeogebraCommonKernelDiscreteCmdMinimumSpanningTree_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_DelauneyTriangulation:
    return [new_OrgGeogebraCommonKernelDiscreteCmdDelauneyTriangulation_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_TravelingSalesman:
    return [new_OrgGeogebraCommonKernelDiscreteCmdTravelingSalesman_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    case OrgGeogebraCommonKernelCommandsCommands_ShortestDistance:
    return [new_OrgGeogebraCommonKernelDiscreteCmdShortestDistance_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
    default:
    break;
  }
  return nil;
