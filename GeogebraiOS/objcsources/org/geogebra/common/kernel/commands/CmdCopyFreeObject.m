    ...
    switch (n) {
      ...
      if ([OrgGeogebraCommonKernelArithmeticFunctionalNVar_class_() isInstance:IOSObjectArray_Get(nil_chk(arg), 0)]) {
        ...
        if (label != nil) {
          ...
          [command appendWithNSString:[((id<OrgGeogebraCommonKernelArithmeticFunctionalNVar>) nil_chk(f)) getVarStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]];
        ...
        [command appendWithNSString:[((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(IOSObjectArray_Get(arg, 0))) toOutputValueStringWithOrgGeogebraCommonKernelStringTemplate:highPrecision]];
        @try {
      ...
      ret = [IOSObjectArray arrayWithObjects:(id[]){ geo } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
      if (![((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(IOSObjectArray_Get(arg, 0))) isLabelSet]) [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(IOSObjectArray_Get(arg, 0))) remove];
      return ret;
      default:
