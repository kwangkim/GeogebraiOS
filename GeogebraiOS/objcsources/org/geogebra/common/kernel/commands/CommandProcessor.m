...
- (IOSObjectArray *)resArgsWithOrgGeogebraCommonKernelArithmeticCommand:(OrgGeogebraCommonKernelArithmeticCommand *)c
  ...
  IOSObjectArray *result = [IOSObjectArray newArrayWithLength:((IOSObjectArray *) nil_chk(arg))->size_ type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
  for (jint i = 0; i < arg->size_; ++i) {
    ...
    if (keepCAScells && [[((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(IOSObjectArray_Get(arg, i))) unwrap] isKindOfClass:[OrgGeogebraCommonKernelGeosGeoCasCell class]]) {
      (void) IOSObjectArray_Set(result, i, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(IOSObjectArray_Get(arg, i))) unwrap], [OrgGeogebraCommonKernelGeosGeoElement class]));
    }
    else {
      (void) IOSObjectArray_Set(result, i, IOSObjectArray_Get(nil_chk(OrgGeogebraCommonKernelCommandsCommandProcessor_resArgWithOrgGeogebraCommonKernelArithmeticExpressionNode_(self, IOSObjectArray_Get(arg, i))), 0));
    }
  }
...
- (IOSObjectArray *)resArgsLocalNumVarWithOrgGeogebraCommonKernelArithmeticCommand:(OrgGeogebraCommonKernelArithmeticCommand *)c
  ...
  if (localVarName == nil) {
    ...
    localVarName = @"i";
    OrgGeogebraCommonKernelArithmeticVariable *localVar = new_OrgGeogebraCommonKernelArithmeticVariable_initWithOrgGeogebraCommonKernelKernel_withNSString_(kernelA_, localVarName);
    (void) [c traverseWithOrgGeogebraCommonKernelArithmeticTraversing:OrgGeogebraCommonKernelArithmeticTraversing_Replacer_getReplacerWithOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonKernelArithmeticExpressionValue_([((OrgGeogebraCommonKernelKernel *) nil_chk(kernelA_)) getImaginaryUnit], localVar)];
  }
  ...
  OrgGeogebraCommonKernelGeosGeoNumeric *num = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(cmdCons);
  ...
  [c setArgumentWithInt:varPos withOrgGeogebraCommonKernelArithmeticExpressionNode:new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_([c getKernel], num)];
...
- (OrgGeogebraCommonKernelGeosGeoElement *)resArgsForZipWithOrgGeogebraCommonKernelArithmeticCommand:(OrgGeogebraCommonKernelArithmeticCommand *)c
  ...
  for (jint varPos = 1; varPos < numArgs; varPos += 2) {
    ...
    if (gl == nil) {
      num = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(cons_);
    }
    else if ([gl size] == 0) {
    ...
    OrgGeogebraCommonKernelCommandsCommandProcessor_replaceZvarIfNeededWithNSString_withOrgGeogebraCommonKernelArithmeticCommand_(self, localVarName, c);
    [c setArgumentWithInt:varPos withOrgGeogebraCommonKernelArithmeticExpressionNode:new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_([c getKernel], num)];
    (void) IOSObjectArray_Set(nil_chk(vars), varPos / 2, [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(num)) toGeoElement]);
    if (gl != nil) {
      (void) IOSObjectArray_Set(nil_chk(over), varPos / 2, gl);
    }
  }
...
- (IOSObjectArray *)resArgsLocalNumVarWithOrgGeogebraCommonKernelArithmeticCommand:(OrgGeogebraCommonKernelArithmeticCommand *)c
  ...
  IOSObjectArray *localVarName = [IOSObjectArray newArrayWithLength:((IOSIntArray *) nil_chk(varPos))->size_ type:NSString_class_()];
  for (jint i = 0; i < varPos->size_; i++) {
    (void) IOSObjectArray_Set(localVarName, i, [((OrgGeogebraCommonKernelArithmeticCommand *) nil_chk(c)) getVariableNameWithInt:IOSIntArray_Get(varPos, i)]);
    if (IOSObjectArray_Get(localVarName, i) == nil) {
      ...
      (void) IOSObjectArray_Set(localVarName, i, @"i");
      OrgGeogebraCommonKernelArithmeticVariable *localVar = new_OrgGeogebraCommonKernelArithmeticVariable_initWithOrgGeogebraCommonKernelKernel_withNSString_(kernelA_, IOSObjectArray_Get(localVarName, i));
      (void) [c traverseWithOrgGeogebraCommonKernelArithmeticTraversing:OrgGeogebraCommonKernelArithmeticTraversing_Replacer_getReplacerWithOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonKernelArithmeticExpressionValue_([((OrgGeogebraCommonKernelKernel *) nil_chk(kernelA_)) getImaginaryUnit], localVar)];
    }
    else if ([((NSString *) nil_chk(IOSObjectArray_Get(localVarName, i))) isEqual:OrgGeogebraCommonUtilUnicode_get_EULER_STRING_()]) {
      (void) IOSObjectArray_Set(localVarName, i, @"e");
      OrgGeogebraCommonKernelArithmeticVariable *localVar = new_OrgGeogebraCommonKernelArithmeticVariable_initWithOrgGeogebraCommonKernelKernel_withNSString_(kernelA_, IOSObjectArray_Get(localVarName, i));
      (void) [c traverseWithOrgGeogebraCommonKernelArithmeticTraversing:OrgGeogebraCommonKernelArithmeticTraversing_Replacer_getReplacerWithOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonKernelArithmeticExpressionValue_(OrgGeogebraCommonKernelArithmeticMySpecialDouble_getEulerConstantWithOrgGeogebraCommonKernelKernel_(kernelA_), localVar)];
    }
  }
  ...
  IOSObjectArray *num = [IOSObjectArray newArrayWithLength:varPos->size_ type:OrgGeogebraCommonKernelGeosGeoNumeric_class_()];
  for (jint i = 0; i < varPos->size_; i++) {
    (void) IOSObjectArray_Set(num, i, new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(cmdCons));
...
- (OrgGeogebraCommonMainMyError *)argNumErrWithOrgGeogebraCommonMainApp:(OrgGeogebraCommonMainApp *)app1
  ...
  return new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSString_withNSString_withJavaLangThrowable_([app1 getLocalization], [((JavaLangStringBuilder *) nil_chk(sb_)) description], cmd, nil);
}
...
void OrgGeogebraCommonKernelCommandsCommandProcessor_initWithOrgGeogebraCommonKernelKernel_(OrgGeogebraCommonKernelCommandsCommandProcessor *self, OrgGeogebraCommonKernelKernel *kernel) {
  ...
  self->algProcessor_ = [kernel getAlgebraProcessor];
}
...
IOSObjectArray *OrgGeogebraCommonKernelCommandsCommandProcessor_resArgWithOrgGeogebraCommonKernelArithmeticExpressionNode_(OrgGeogebraCommonKernelCommandsCommandProcessor *self, OrgGeogebraCommonKernelArithmeticExpressionNode *arg) {
  ...
  IOSObjectArray *str = [IOSObjectArray newArrayWithObjects:(id[]){ @"IllegalArgument", [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(arg)) toStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()] } count:2 type:NSString_class_()];
  @throw new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSStringArray_(self->loc_, str);
}
...
OrgGeogebraCommonMainMyError *OrgGeogebraCommonKernelCommandsCommandProcessor_argErrWithOrgGeogebraCommonMainLocalization_withNSString_withOrgGeogebraCommonKernelArithmeticExpressionValue_(OrgGeogebraCommonKernelCommandsCommandProcessor *self, OrgGeogebraCommonMainLocalization *app1, NSString *cmd, id<OrgGeogebraCommonKernelArithmeticExpressionValue> arg) {
  ...
  if (self->sb_ == nil) self->sb_ = new_JavaLangStringBuilder_init();
  else [self->sb_ setLengthWithInt:0];
  jboolean reverseOrder = [app1 isReverseNameDescriptionLanguage];
  if (!reverseOrder) {
    (void) [((JavaLangStringBuilder *) nil_chk(self->sb_)) appendWithNSString:[app1 getCommandWithNSString:@"Command"]];
    (void) [self->sb_ appendWithChar:' '];
    (void) [self->sb_ appendWithNSString:localName];
  }
  else {
    (void) [((JavaLangStringBuilder *) nil_chk(self->sb_)) appendWithNSString:localName];
    (void) [self->sb_ appendWithChar:' '];
    (void) [self->sb_ appendWithNSString:[((NSString *) nil_chk([app1 getCommandWithNSString:@"Command"])) lowercaseString]];
  }
  (void) [((JavaLangStringBuilder *) nil_chk(self->sb_)) appendWithNSString:@":\n"];
  (void) [self->sb_ appendWithNSString:[app1 getErrorWithNSString:@"IllegalArgument"]];
  (void) [self->sb_ appendWithNSString:@": "];
  if ([arg isKindOfClass:[OrgGeogebraCommonKernelGeosGeoElement class]]) (void) [self->sb_ appendWithNSString:[((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(((OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(arg, [OrgGeogebraCommonKernelGeosGeoElement class])))) getNameDescription]];
  else if (arg != nil) (void) [self->sb_ appendWithNSString:[arg toStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]];
  (void) [self->sb_ appendWithNSString:@"\n\n"];
  (void) [self->sb_ appendWithNSString:[app1 getPlainWithNSString:@"Syntax"]];
  (void) [self->sb_ appendWithNSString:@":\n"];
  (void) [self->sb_ appendWithNSString:[app1 getCommandSyntaxWithNSString:cmd]];
  return new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSString_withNSString_withJavaLangThrowable_(app1, [self->sb_ description], cmd, nil);
}
...
void OrgGeogebraCommonKernelCommandsCommandProcessor_getCommandSyntaxWithJavaLangStringBuilder_withOrgGeogebraCommonMainLocalization_withNSString_withInt_(JavaLangStringBuilder *sb, OrgGeogebraCommonMainLocalization *app, NSString *cmd, jint argNumber) {
  ...
  if (!reverseOrder) {
    (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:[app getCommandWithNSString:@"Command"]];
    (void) [sb appendWithChar:' '];
    (void) [sb appendWithNSString:[app getCommandWithNSString:cmd]];
  }
  else {
    (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:[app getCommandWithNSString:cmd]];
    (void) [sb appendWithChar:' '];
    (void) [sb appendWithNSString:[((NSString *) nil_chk([app getCommandWithNSString:@"Command"])) lowercaseString]];
  }
  if (argNumber > -1) {
    (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@":\n"];
    (void) [sb appendWithNSString:[app getErrorWithNSString:@"IllegalArgumentNumber"]];
    (void) [sb appendWithNSString:@": "];
    (void) [sb appendWithInt:argNumber];
  }
  (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"\n\n"];
  (void) [sb appendWithNSString:[app getPlainWithNSString:@"Syntax"]];
  (void) [sb appendWithNSString:@":\n"];
  (void) [sb appendWithNSString:[app getCommandSyntaxWithNSString:cmd]];
}
...
OrgGeogebraCommonMainMyError *OrgGeogebraCommonKernelCommandsCommandProcessor_chDepErrWithOrgGeogebraCommonMainApp_withOrgGeogebraCommonKernelGeosGeoElement_(OrgGeogebraCommonMainApp *app1, OrgGeogebraCommonKernelGeosGeoElement *geo) {
  OrgGeogebraCommonKernelCommandsCommandProcessor_initialize();
  IOSObjectArray *strs = [IOSObjectArray newArrayWithObjects:(id[]){ @"ChangeDependent", [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(geo)) getLongDescription] } count:2 type:NSString_class_()];
  return new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSStringArray_([((OrgGeogebraCommonMainApp *) nil_chk(app1)) getLocalization], strs);
}
...
OrgGeogebraCommonKernelGeosGeoList *OrgGeogebraCommonKernelCommandsCommandProcessor_wrapInListWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelGeosGeoElementArray_withInt_withOrgGeogebraCommonPluginGeoClassEnum_(OrgGeogebraCommonKernelKernel *kernel, IOSObjectArray *args, jint length, OrgGeogebraCommonPluginGeoClassEnum *type) {
  ...
  JavaUtilArrayList *geoElementList = new_JavaUtilArrayList_init();
