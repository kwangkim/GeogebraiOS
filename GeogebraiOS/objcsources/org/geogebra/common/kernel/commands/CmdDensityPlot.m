...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/commands/CmdDensityPlot.java
//
...
- (IOSObjectArray *)processWithOrgGeogebraCommonKernelArithmeticCommand:(OrgGeogebraCommonKernelArithmeticCommand *)c {
  jint n = [((OrgGeogebraCommonKernelArithmeticCommand *) nil_chk(c)) getArgumentNumber];
  {
    ...
    switch (n) {
      case 1:
      OrgGeogebraCommonKernelCommandsCmdDensityPlot_set_args_(self, [self resArgsWithOrgGeogebraCommonKernelArithmeticCommand:c]);
      ...
      algo = [new_OrgGeogebraCommonKernelAlgosAlgoDensityPlot_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoFunctionNVar_(cons_, (OrgGeogebraCommonKernelGeosGeoFunctionNVar *) check_class_cast(IOSObjectArray_Get(args_, 0), [OrgGeogebraCommonKernelGeosGeoFunctionNVar class])) autorelease];
      ...
      case 6:
      OrgGeogebraCommonKernelCommandsCmdDensityPlot_controlWithOrgGeogebraCommonKernelArithmeticCommand_(self, c);
      algo = [new_OrgGeogebraCommonKernelAlgosAlgoDensityPlot_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoFunctionNVar_withDouble_withDouble_withDouble_withDouble_withBoolean_(cons_, (OrgGeogebraCommonKernelGeosGeoFunctionNVar *) check_class_cast(IOSObjectArray_Get(nil_chk(args_), 0), [OrgGeogebraCommonKernelGeosGeoFunctionNVar class]), lowX_, highX_, lowY_, highY_, [((OrgGeogebraCommonKernelGeosGeoBoolean *) nil_chk(((OrgGeogebraCommonKernelGeosGeoBoolean *) check_class_cast(IOSObjectArray_Get(args_, 5), [OrgGeogebraCommonKernelGeosGeoBoolean class])))) getBoolean]) autorelease];
      ret = [IOSObjectArray arrayWithLength:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
      IOSObjectArray_Set(ret, 0, [algo getResult]);
      return ret;
      default:
