...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/commands/CommandDispatcher.java
//
...
- (IOSObjectArray *)processCommandWithOrgGeogebraCommonKernelArithmeticCommand:(OrgGeogebraCommonKernelArithmeticCommand *)c
  ...
  @catch (JavaLangException *e) {
    ...
    @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSString_withNSString_withJavaLangThrowable_([((OrgGeogebraCommonMainApp *) nil_chk(app_)) getLocalization], @"CAS.GeneralErrorMessage", [c getName], e) autorelease];
  }
  @finally {
    [cons_ setSuppressLabelCreationWithBoolean:oldMacroMode];
  }
...
- (void)initCmdTable {
  OrgGeogebraCommonKernelCommandsCommandDispatcher_setAndConsume_macroProc_(self, new_OrgGeogebraCommonKernelCommandsMacroProcessor_initWithOrgGeogebraCommonKernelKernel_(kernel_));
  OrgGeogebraCommonKernelCommandsCommandDispatcher_setAndConsume_cmdTable_(self, new_JavaUtilHashMap_initWithInt_(500));
  OrgGeogebraCommonKernelCommandsCommandDispatcher_setAndConsume_casTable_(self, new_JavaUtilHashMap_initWithInt_(500));
  {
    ...
    while (b__ < e__) {
      ...
      [cmdTable_ putWithId:[((OrgGeogebraCommonKernelCommandsCommandsEnum *) nil_chk(comm)) name] withId:nil];
    }
  }
...
- (void)fillInternalCmdTable {
  OrgGeogebraCommonKernelCommandsCommandDispatcher_setAndConsume_internalCmdTable_(self, new_JavaUtilHashMap_init());
  [internalCmdTable_ putWithId:@"diff" withId:[new_OrgGeogebraCommonKernelCommandsCmdDerivative_initWithOrgGeogebraCommonKernelKernel_(kernel_) autorelease]];
}
...
- (OrgGeogebraCommonKernelCommandsCommandProcessor *)commandTableSwitchWithNSString:(NSString *)cmdName {
  @try {
    ...
    switch ([command ordinal]) {
      ...
      return [new_OrgGeogebraCommonKernelCommandsCAScmdProcessor_initWithOrgGeogebraCommonKernelKernel_(kernel_) autorelease];
...
- (id<OrgGeogebraCommonKernelCommandsCommandDispatcherInterface>)getDiscreteDispatcher {
  if (discreteDispatcher_ == nil) {
    OrgGeogebraCommonKernelCommandsCommandDispatcher_setAndConsume_discreteDispatcher_(self, new_OrgGeogebraCommonKernelCommandsCommandDispatcherDiscrete_init());
  }
...
- (id<OrgGeogebraCommonKernelCommandsCommandDispatcherInterface>)getCASDispatcher {
  if (casDispatcher_ == nil) {
    OrgGeogebraCommonKernelCommandsCommandDispatcher_setAndConsume_casDispatcher_(self, new_OrgGeogebraCommonKernelCommandsCommandDispatcherCAS_init());
  }
...
- (id<OrgGeogebraCommonKernelCommandsCommandDispatcherInterface>)getScriptingDispatcher {
  if (scriptingDispatcher_ == nil) {
    OrgGeogebraCommonKernelCommandsCommandDispatcher_setAndConsume_scriptingDispatcher_(self, new_OrgGeogebraCommonKernelCommandsCommandDispatcherScripting_init());
  }
...
- (id<OrgGeogebraCommonKernelCommandsCommandDispatcherInterface>)getAdvancedDispatcher {
  if (advancedDispatcher_ == nil) {
    OrgGeogebraCommonKernelCommandsCommandDispatcher_setAndConsume_advancedDispatcher_(self, new_OrgGeogebraCommonKernelCommandsCommandDispatcherAdvanced_init());
  }
...
void OrgGeogebraCommonKernelCommandsCommandDispatcher_initWithOrgGeogebraCommonKernelKernel_(OrgGeogebraCommonKernelCommandsCommandDispatcher *self, OrgGeogebraCommonKernelKernel *kernel2) {
  ...
  OrgGeogebraCommonKernelCommandsCommandDispatcher_set_statsDispatcher_(self, nil);
  OrgGeogebraCommonKernelCommandsCommandDispatcher_set_discreteDispatcher_(self, nil);
  OrgGeogebraCommonKernelCommandsCommandDispatcher_set_casDispatcher_(self, nil);
  OrgGeogebraCommonKernelCommandsCommandDispatcher_set_scriptingDispatcher_(self, nil);
  OrgGeogebraCommonKernelCommandsCommandDispatcher_set_advancedDispatcher_(self, nil);
  OrgGeogebraCommonKernelCommandsCommandDispatcher_set_basicDispatcher_(self, nil);
  OrgGeogebraCommonKernelCommandsCommandDispatcher_set_kernel_(self, kernel2);
  OrgGeogebraCommonKernelCommandsCommandDispatcher_set_cons_(self, [((OrgGeogebraCommonKernelKernel *) nil_chk(kernel2)) getConstruction]);
  OrgGeogebraCommonKernelCommandsCommandDispatcher_set_app_(self, [kernel2 getApplication]);
}
...
OrgGeogebraCommonKernelCommandsCommandDispatcherStats *OrgGeogebraCommonKernelCommandsCommandDispatcher_getStatsDispatcher(OrgGeogebraCommonKernelCommandsCommandDispatcher *self) {
  if (self->statsDispatcher_ == nil) {
    OrgGeogebraCommonKernelCommandsCommandDispatcher_setAndConsume_statsDispatcher_(self, new_OrgGeogebraCommonKernelCommandsCommandDispatcherStats_init());
  }
...
OrgGeogebraCommonKernelCommandsCommandDispatcherBasic *OrgGeogebraCommonKernelCommandsCommandDispatcher_getBasicDispatcher(OrgGeogebraCommonKernelCommandsCommandDispatcher *self) {
  if (self->basicDispatcher_ == nil) {
    OrgGeogebraCommonKernelCommandsCommandDispatcher_setAndConsume_basicDispatcher_(self, new_OrgGeogebraCommonKernelCommandsCommandDispatcherBasic_init());
  }
