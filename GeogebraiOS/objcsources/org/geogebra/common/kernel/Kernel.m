...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/kernel/Kernel.java
//
...
- (OrgGeogebraCommonKernelCommandsAlgebraProcessor *)getAlgebraProcessor {
  if (algProcessor_ == nil) {
    algProcessor_ = [self newAlgebraProcessorWithOrgGeogebraCommonKernelKernel:self];
  }
...
- (OrgGeogebraCommonKernelCommandsAlgebraProcessor *)newAlgebraProcessorWithOrgGeogebraCommonKernelKernel:(OrgGeogebraCommonKernelKernel *)kernel {
  return new_OrgGeogebraCommonKernelCommandsAlgebraProcessor_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelCommandsCommandDispatcher_(kernel, [((OrgGeogebraCommonMainApp *) nil_chk(app_)) getCommandDispatcherWithOrgGeogebraCommonKernelKernel:kernel]);
}
...
- (void)newConstruction {
  cons_ = new_OrgGeogebraCommonKernelConstruction_initWithOrgGeogebraCommonKernelKernel_(self);
}
...
- (OrgGeogebraCommonIoMyXMLHandler *)newMyXMLHandlerWithOrgGeogebraCommonKernelKernel:(OrgGeogebraCommonKernelKernel *)kernel
  ...
  return new_OrgGeogebraCommonIoMyXMLHandler_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelConstruction_(kernel, cons1);
}
...
- (OrgGeogebraCommonKernelEquationSolver *)getEquationSolver {
  if (eqnSolver_ == nil) eqnSolver_ = new_OrgGeogebraCommonKernelEquationSolver_initWithOrgGeogebraCommonKernelKernel_(self);
  return eqnSolver_;
}
...
- (OrgGeogebraCommonKernelSystemOfEquationsSolver *)getSystemOfEquationsSolverWithOrgGeogebraCommonKernelEquationSolverInterface:(id<OrgGeogebraCommonKernelEquationSolverInterface>)eSolver {
  if (sysEqSolv_ == nil) sysEqSolv_ = new_OrgGeogebraCommonKernelSystemOfEquationsSolver_initWithOrgGeogebraCommonKernelEquationSolverInterface_(eSolver);
  return sysEqSolv_;
}

- (OrgGeogebraCommonKernelOptimizationExtremumFinder *)getExtremumFinder {
  if (extrFinder_ == nil) extrFinder_ = new_OrgGeogebraCommonKernelOptimizationExtremumFinder_init();
  return extrFinder_;
}

- (OrgGeogebraCommonKernelParserParser *)getParser {
  if (parser_ == nil) parser_ = new_OrgGeogebraCommonKernelParserParser_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelConstruction_(self, cons_);
  return parser_;
}
...
- (OrgGeogebraCommonKernelArithmeticExpressionNodeEvaluator *)newExpressionNodeEvaluatorWithOrgGeogebraCommonKernelKernel:(OrgGeogebraCommonKernelKernel *)kernel {
  return new_OrgGeogebraCommonKernelArithmeticExpressionNodeEvaluator_initWithOrgGeogebraCommonMainLocalization_withOrgGeogebraCommonKernelKernel_([((OrgGeogebraCommonMainApp *) nil_chk(app_)) getLocalization], kernel);
}

- (OrgGeogebraCommonKernelArithmeticExpressionNodeEvaluator *)getExpressionNodeEvaluator {
  if (expressionNodeEvaluator_ == nil) {
    expressionNodeEvaluator_ = [self newExpressionNodeEvaluatorWithOrgGeogebraCommonKernelKernel:self];
  }
...
- (void)setUsePathAndRegionParametersWithOrgGeogebraCommonKernelPathRegionHandlingEnum:(OrgGeogebraCommonKernelPathRegionHandlingEnum *)flag {
  self->usePathAndRegionParameters__ = flag;
}
...
- (NSString *)internationalizeDigitsWithNSString:(NSString *)num
  ...
  if (formatSB_ == nil) {
    formatSB_ = new_JavaLangStringBuilder_initWithInt_(17);
  }
  else {
  ...
  if (RTL) {
    (void) [((JavaLangStringBuilder *) nil_chk(formatSB_)) appendWithChar:OrgGeogebraCommonUtilUnicode_RightToLeftMark];
    if (negative) {
      (void) [formatSB_ appendWithNSString:OrgGeogebraCommonUtilUnicode_get_RightToLeftUnaryMinusSign_()];
      start = 1;
    }
  }
  for (jint i = start; i < ((jint) [num length]); i++) {
    ...
    (void) [((JavaLangStringBuilder *) nil_chk(formatSB_)) appendWithChar:c];
  }
  if (RTL) {
    (void) [((JavaLangStringBuilder *) nil_chk(formatSB_)) appendWithChar:OrgGeogebraCommonUtilUnicode_RightToLeftMark];
  }
...
- (JavaLangStringBuilder *)buildLHSWithDoubleArray:(IOSDoubleArray *)numbers
  ...
  if ((JavaLangMath_absWithDouble_(coeff) >= [((OrgGeogebraCommonKernelStringTemplate *) nil_chk(tpl)) getPrecisionWithOrgGeogebraCommonUtilNumberFormatAdapter:nf_]) || useSignificantFigures_) {
    (void) [sbBuildLHS_ appendWithChar:' '];
    (void) [sbBuildLHS_ appendWithChar:OrgGeogebraCommonKernelKernel_signWithDouble_(coeff)];
    (void) [sbBuildLHS_ appendWithChar:' '];
    (void) [sbBuildLHS_ appendWithNSString:OrgGeogebraCommonKernelKernel_formatWithDouble_withOrgGeogebraCommonKernelStringTemplate_(self, JavaLangMath_absWithDouble_(coeff), tpl)];
  }
  return sbBuildLHS_;
}
...
- (JavaLangStringBuilder *)buildExplicitConicEquationWithDoubleArray:(IOSDoubleArray *)numbers
  ...
  (void) [sbBuildExplicitConicEquation_ appendWithNSString:IOSObjectArray_Get(nil_chk(vars), pos)];
  (void) [sbBuildExplicitConicEquation_ appendWithNSString:@" = "];
  if (leadingNonZero == numbers->size_) {
    (void) [sbBuildExplicitConicEquation_ appendWithNSString:@"0"];
    return sbBuildExplicitConicEquation_;
  }
  else if (leadingNonZero == (numbers->size_ - 1)) {
    d = -IOSDoubleArray_Get(numbers, leadingNonZero) / q;
    (void) [sbBuildExplicitConicEquation_ appendWithNSString:OrgGeogebraCommonKernelKernel_formatWithDouble_withOrgGeogebraCommonKernelStringTemplate_(self, d, tpl)];
    return sbBuildExplicitConicEquation_;
  }
  else {
    d = -IOSDoubleArray_Get(numbers, leadingNonZero) / q;
    (void) [sbBuildExplicitConicEquation_ appendWithNSString:OrgGeogebraCommonKernelKernel_formatCoeffWithDouble_withOrgGeogebraCommonKernelStringTemplate_(self, d, tpl)];
    (void) [sbBuildExplicitConicEquation_ appendWithNSString:IOSObjectArray_Get(vars, leadingNonZero)];
    for (i = leadingNonZero + 1; i < vars->size_; i++) {
      if (i != pos) {
        ...
        if ((dabs >= [((OrgGeogebraCommonKernelStringTemplate *) nil_chk(tpl)) getPrecisionWithOrgGeogebraCommonUtilNumberFormatAdapter:nf_]) || useSignificantFigures_) {
          (void) [sbBuildExplicitConicEquation_ appendWithChar:' '];
          (void) [sbBuildExplicitConicEquation_ appendWithChar:OrgGeogebraCommonKernelKernel_signWithDouble_(d)];
          (void) [sbBuildExplicitConicEquation_ appendWithChar:' '];
          (void) [sbBuildExplicitConicEquation_ appendWithNSString:OrgGeogebraCommonKernelKernel_formatCoeffWithDouble_withOrgGeogebraCommonKernelStringTemplate_(self, dabs, tpl)];
          (void) [sbBuildExplicitConicEquation_ appendWithNSString:IOSObjectArray_Get(vars, i)];
        }
      }
    }
    d = -IOSDoubleArray_Get(numbers, i) / q;
    ...
    if ((dabs >= [((OrgGeogebraCommonKernelStringTemplate *) nil_chk(tpl)) getPrecisionWithOrgGeogebraCommonUtilNumberFormatAdapter:nf_]) || useSignificantFigures_) {
      ...
      (void) [sbBuildExplicitConicEquation_ appendWithChar:OrgGeogebraCommonKernelKernel_signWithDouble_(d)];
      (void) [sbBuildExplicitConicEquation_ appendWithChar:' '];
      (void) [sbBuildExplicitConicEquation_ appendWithNSString:OrgGeogebraCommonKernelKernel_formatWithDouble_withOrgGeogebraCommonKernelStringTemplate_(self, dabs, tpl)];
    }
    return sbBuildExplicitConicEquation_;
  }
}
...
withOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl
  ...
  if (OrgGeogebraCommonKernelKernel_isZeroFigureWithDouble_withOrgGeogebraCommonKernelStringTemplate_(self, x, tpl)) {
    ...
    if (plusMinusX) {
      ...
      (void) [((JavaLangStringBuilder *) nil_chk(sbBuildValueString)) appendWithNSString:@" "];
    }
    else {
    ...
    (void) [((JavaLangStringBuilder *) nil_chk(sbBuildValueString)) appendWithNSString:s1];
    if (!OrgGeogebraCommonKernelKernel_isZeroFigureWithDouble_withOrgGeogebraCommonKernelStringTemplate_(self, y, tpl)) {
      (void) [sbBuildValueString appendWithNSString:@" "];
...
withOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl
  ...
  if (OrgGeogebraCommonKernelKernel_isZeroFigureWithDouble_withOrgGeogebraCommonKernelStringTemplate_(self, x, tpl)) {
    ...
    (void) [((JavaLangStringBuilder *) nil_chk(sbBuildValueString)) appendWithNSString:OrgGeogebraCommonKernelKernel_formatWithDouble_withOrgGeogebraCommonKernelStringTemplate_(self, x, tpl)];
    if (!OrgGeogebraCommonKernelKernel_isZeroFigureWithDouble_withOrgGeogebraCommonKernelStringTemplate_(self, y, tpl)) {
      (void) [sbBuildValueString appendWithNSString:@" "];
      OrgGeogebraCommonKernelKernel_formatSignedPlusMinusWithDouble_withJavaLangStringBuilder_withOrgGeogebraCommonKernelStringTemplate_(self, y, sbBuildValueString, tpl);
    }
...
- (JavaLangStringBuilder *)buildExplicitLineEquationWithDoubleArray:(IOSDoubleArray *)numbers
  ...
  if (OrgGeogebraCommonKernelKernel_isZeroWithDouble_(q)) {
    (void) [sbBuildExplicitLineEquation_ appendWithNSString:IOSObjectArray_Get(nil_chk(vars), 0)];
    (void) [sbBuildExplicitLineEquation_ appendWithChar:' '];
    ...
    (void) [sbBuildExplicitLineEquation_ appendWithChar:op];
    (void) [sbBuildExplicitLineEquation_ appendWithChar:' '];
    (void) [sbBuildExplicitLineEquation_ appendWithNSString:OrgGeogebraCommonKernelKernel_formatWithDouble_withOrgGeogebraCommonKernelStringTemplate_(self, -IOSDoubleArray_Get(numbers, 2) / IOSDoubleArray_Get(numbers, 0), tpl)];
    return sbBuildExplicitLineEquation_;
  }
  (void) [sbBuildExplicitLineEquation_ appendWithNSString:IOSObjectArray_Get(nil_chk(vars), 1)];
  (void) [sbBuildExplicitLineEquation_ appendWithChar:' '];
  ...
  dabs = JavaLangMath_absWithDouble_(d);
  if ((dabs >= [((OrgGeogebraCommonKernelStringTemplate *) nil_chk(tpl)) getPrecisionWithOrgGeogebraCommonUtilNumberFormatAdapter:nf_]) || useSignificantFigures_) {
    (void) [sbBuildExplicitLineEquation_ appendWithNSString:OrgGeogebraCommonKernelKernel_formatCoeffWithDouble_withOrgGeogebraCommonKernelStringTemplate_(self, d, tpl)];
    (void) [sbBuildExplicitLineEquation_ appendWithNSString:IOSObjectArray_Get(vars, 0)];
    ...
    if ((dabs >= [tpl getPrecisionWithOrgGeogebraCommonUtilNumberFormatAdapter:nf_]) || useSignificantFigures_) {
      (void) [sbBuildExplicitLineEquation_ appendWithChar:' '];
      (void) [sbBuildExplicitLineEquation_ appendWithChar:OrgGeogebraCommonKernelKernel_signWithDouble_(d)];
      (void) [sbBuildExplicitLineEquation_ appendWithChar:' '];
      (void) [sbBuildExplicitLineEquation_ appendWithNSString:OrgGeogebraCommonKernelKernel_formatWithDouble_withOrgGeogebraCommonKernelStringTemplate_(self, dabs, tpl)];
    }
  }
  else {
    (void) [sbBuildExplicitLineEquation_ appendWithNSString:OrgGeogebraCommonKernelKernel_formatWithDouble_withOrgGeogebraCommonKernelStringTemplate_(self, -IOSDoubleArray_Get(numbers, 2) / q, tpl)];
  }
  return sbBuildExplicitLineEquation_;
}
...
- (void)setPrintDecimalsWithInt:(jint)decimals {
  if (decimals >= 0) {
    ...
    nf_ = [((OrgGeogebraCommonFactoriesFormatFactory *) nil_chk(OrgGeogebraCommonFactoriesFormatFactory_get_prototype_())) getNumberFormatWithInt:decimals];
  }
}
...
- (NSString *)evaluateRawGeoGebraCASWithNSString:(NSString *)exp {
  ...
  (void) [((OrgGeogebraCommonUtilMaxSizeHashMap *) nil_chk([self getCasCache])) putWithId:exp withId:result];
  return result;
}
...
- (OrgGeogebraCommonUtilMaxSizeHashMap *)getCasCache {
  if (ggbCasCache_ == nil) {
    ggbCasCache_ = new_OrgGeogebraCommonUtilMaxSizeHashMap_initWithInt_(OrgGeogebraCommonKernelKernel_GEOGEBRA_CAS_CACHE_SIZE_);
  }
  return ggbCasCache_;
}
...
- (void)setEuclidianViewBoundsWithInt:(jint)viewNo
  ...
  if (view >= ((IOSDoubleArray *) nil_chk(self->xmin_))->size_) {
    self->xmin_ = [self prolongWithDoubleArray:self->xmin_ withInt:viewNo];
    self->xmax_ = [self prolongWithDoubleArray:self->xmin_ withInt:viewNo];
    self->ymin_ = [self prolongWithDoubleArray:self->ymin_ withInt:viewNo];
    self->ymax_ = [self prolongWithDoubleArray:self->ymax_ withInt:viewNo];
    self->xscale_ = [self prolongWithDoubleArray:self->xscale_ withInt:viewNo];
    self->yscale_ = [self prolongWithDoubleArray:self->yscale_ withInt:viewNo];
  }
...
- (IOSDoubleArray *)prolongWithDoubleArray:(IOSDoubleArray *)xmin2
                                   withInt:(jint)viewNo {
  IOSDoubleArray *ret = [IOSDoubleArray newArrayWithLength:viewNo];
...
- (id<OrgGeogebraCommonKernelGeoGebraCasInterface>)getGeoGebraCAS {
  @synchronized(self) {
    if (ggbCAS_ == nil) {
      ggbCAS_ = new_OrgGeogebraCommonCasGeoGebraCAS_initWithOrgGeogebraCommonKernelKernel_(self);
    }
    return ggbCAS_;
  }
}
...
- (OrgGeogebraCommonPluginGeoClassEnum *)getClassTypeWithNSString:(NSString *)type {
  switch ([((NSString *) nil_chk(type)) charAtWithInt:0]) {
    ...
    default:
    @throw new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSString_([((OrgGeogebraCommonMainApp *) nil_chk([((OrgGeogebraCommonKernelConstruction *) nil_chk(cons_)) getApplication])) getLocalization], JreStrcat("$$$", @"Kernel: GeoElement of type ", type, @" could not be created."));
  }
}
...
- (OrgGeogebraCommonKernelAnimationManager *)getAnimatonManager {
  if (animationManager_ == nil) {
    animationManager_ = [((OrgGeogebraCommonMainApp *) nil_chk(OrgGeogebraCommonKernelKernel_getApplication(self))) newAnimationManagerWithOrgGeogebraCommonKernelKernel:self];
  }
...
- (IOSDoubleArray *)getViewBoundsForGeoWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  ...
  IOSDoubleArray *viewBounds = [IOSDoubleArray newArrayWithLength:6];
  for (jint i = 0; i < 6; i++) {
...
- (void)attachWithOrgGeogebraCommonKernelView:(id<OrgGeogebraCommonKernelView>)view {
  ...
  if ([view isKindOfClass:[OrgGeogebraCommonEuclidianEuclidianView class]]) {
    lastAttachedEV_ = (OrgGeogebraCommonEuclidianEuclidianView *) check_class_cast(view, [OrgGeogebraCommonEuclidianEuclidianView class]);
  }
...
- (void)registerRenameListenerAlgoWithOrgGeogebraCommonKernelAlgosAlgoElement:(OrgGeogebraCommonKernelAlgosAlgoElement *)algo {
  if (renameListenerAlgos_ == nil) {
    renameListenerAlgos_ = new_JavaUtilArrayList_init();
  }
...
- (OrgGeogebraCommonKernelArithmeticExpressionNode *)handleTrigPowerWithNSString:(NSString *)image
  ...
  if ([((NSString *) nil_chk(image)) indexOf:OrgGeogebraCommonUtilUnicode_Superscript_Minus] > -1) {
    ...
    @throw new_JavaLangError_initWithNSString_(@"Bad index for trig function");
  }
  return new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self, new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self, en, type, nil), OrgGeogebraCommonPluginOperationEnum_get_POWER(), OrgGeogebraCommonKernelKernel_convertIndexToNumberWithNSString_(self, image));
}
...
- (OrgGeogebraCommonKernelArithmeticExpressionNode *)inverseTrigWithOrgGeogebraCommonPluginOperationEnum:(OrgGeogebraCommonPluginOperationEnum *)type
  ...
  switch ([type ordinal]) {
    ...
    return new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self, en, OrgGeogebraCommonPluginOperationEnum_get_ARCCOS(), nil);
    case OrgGeogebraCommonPluginOperation_TAN:
    return new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self, en, OrgGeogebraCommonPluginOperationEnum_get_ARCTAN(), nil);
    case OrgGeogebraCommonPluginOperation_SINH:
    return new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self, en, OrgGeogebraCommonPluginOperationEnum_get_ASINH(), nil);
    case OrgGeogebraCommonPluginOperation_COSH:
    return new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self, en, OrgGeogebraCommonPluginOperationEnum_get_ACOSH(), nil);
    case OrgGeogebraCommonPluginOperation_TANH:
    return new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self, en, OrgGeogebraCommonPluginOperationEnum_get_ATANH(), nil);
    default:
    @throw new_JavaLangError_initWithNSString_(@"Inverse not supported for trig function");
  }
}
...
- (OrgGeogebraCommonKernelGeosGeoVec2D *)getImaginaryUnit {
  if (imaginaryUnit_ == nil) {
    imaginaryUnit_ = new_OrgGeogebraCommonKernelGeosGeoVec2D_initWithOrgGeogebraCommonKernelKernel_withDouble_withDouble_(self, 0, 1);
...
withOrgGeogebraCommonKernelGeosGeoElementArray:(IOSObjectArray *)input {
  @try {
    OrgGeogebraCommonKernelAlgosAlgoMacro *algo = new_OrgGeogebraCommonKernelAlgosAlgoMacro_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelMacro_withOrgGeogebraCommonKernelGeosGeoElementArray_(cons_, labels, macro, input);
...
- (void)getKernelXMLWithJavaLangStringBuilder:(JavaLangStringBuilder *)sb
  ...
  (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"<kernel>\n"];
  if (OrgGeogebraCommonKernelKernel_kernelHas3DObjects(self)) {
    (void) [sb appendWithNSString:@"\t<uses3D val=\"true\"/>\n"];
  }
  (void) [sb appendWithNSString:@"\t<continuous val=\""];
  (void) [sb appendWithBoolean:OrgGeogebraCommonKernelKernel_isContinuous(self)];
  (void) [sb appendWithNSString:@"\"/>\n"];
  (void) [sb appendWithNSString:@"\t<usePathAndRegionParameters val=\""];
  (void) [sb appendWithNSString:[((OrgGeogebraCommonKernelPathRegionHandlingEnum *) nil_chk(usePathAndRegionParameters__)) getXML]];
  (void) [sb appendWithNSString:@"\"/>\n"];
  if (useSignificantFigures_) {
    (void) [sb appendWithNSString:@"\t<significantfigures val=\""];
    (void) [sb appendWithInt:OrgGeogebraCommonKernelKernel_getPrintFigures(self)];
    (void) [sb appendWithNSString:@"\"/>\n"];
  }
  else {
    (void) [sb appendWithNSString:@"\t<decimals val=\""];
    (void) [sb appendWithInt:OrgGeogebraCommonKernelKernel_getPrintDecimals(self)];
    (void) [sb appendWithNSString:@"\"/>\n"];
  }
  (void) [sb appendWithNSString:@"\t<angleUnit val=\""];
  (void) [sb appendWithNSString:OrgGeogebraCommonKernelKernel_getAngleUnit(self) == OrgGeogebraCommonKernelKernel_ANGLE_RADIANT ? @"radiant" : @"degree"];
  (void) [sb appendWithNSString:@"\"/>\n"];
  (void) [sb appendWithNSString:@"\t<algebraStyle val=\""];
  (void) [sb appendWithInt:algebraStyle_];
  (void) [sb appendWithNSString:@"\"/>\n"];
  (void) [sb appendWithNSString:@"\t<coordStyle val=\""];
  (void) [sb appendWithInt:OrgGeogebraCommonKernelKernel_getCoordStyle(self)];
  (void) [sb appendWithNSString:@"\"/>\n"];
  if (!asPreference) {
    (void) [sb appendWithNSString:@"\t<angleFromInvTrig val=\""];
    (void) [sb appendWithBoolean:[self getInverseTrigReturnsAngle]];
    (void) [sb appendWithNSString:@"\"/>\n"];
  }
  if (OrgGeogebraCommonKernelKernel_isAnimationRunning(self)) {
    (void) [sb appendWithNSString:@"\t<startAnimation val=\""];
    (void) [sb appendWithBoolean:OrgGeogebraCommonKernelKernel_isAnimationRunning(self)];
    (void) [sb appendWithNSString:@"\"/>\n"];
  }
  if (asPreference) {
    (void) [sb appendWithNSString:@"\t<localization"];
    (void) [sb appendWithNSString:@" digits=\""];
    (void) [sb appendWithBoolean:[((OrgGeogebraCommonMainLocalization *) nil_chk([self getLocalization])) isUsingLocalizedDigits]];
    (void) [sb appendWithNSString:@"\""];
    (void) [sb appendWithNSString:@" labels=\""];
    (void) [sb appendWithBoolean:[((OrgGeogebraCommonMainLocalization *) nil_chk([self getLocalization])) isUsingLocalizedLabels]];
    (void) [sb appendWithNSString:@"\""];
    (void) [sb appendWithNSString:@"/>\n"];
    (void) [sb appendWithNSString:@"\t<casSettings"];
    (void) [sb appendWithNSString:@" timeout=\""];
    (void) [sb appendWithId:OrgGeogebraCommonIoMyXMLHandler_getTimeoutOptionWithLong_([((OrgGeogebraCommonMainSettingsCASSettings *) nil_chk([((OrgGeogebraCommonMainSettingsSettings *) nil_chk([((OrgGeogebraCommonMainApp *) nil_chk(app_)) getSettings])) getCasSettings])) getTimeoutMilliseconds] / 1000)];
    (void) [sb appendWithNSString:@"\""];
    (void) [sb appendWithNSString:@" expRoots=\""];
    (void) [sb appendWithBoolean:[((OrgGeogebraCommonMainSettingsCASSettings *) nil_chk([((OrgGeogebraCommonMainSettingsSettings *) nil_chk([app_ getSettings])) getCasSettings])) getShowExpAsRoots]];
    (void) [sb appendWithNSString:@"\""];
    (void) [sb appendWithNSString:@"/>\n"];
  }
  (void) [sb appendWithNSString:@"</kernel>\n"];
}

- (void)addMacroWithOrgGeogebraCommonKernelMacro:(OrgGeogebraCommonKernelMacro *)macro {
  if (macroManager_ == nil) {
    macroManager_ = new_OrgGeogebraCommonKernelMacroManager_initWithOrgGeogebraCommonMainApp_(OrgGeogebraCommonKernelKernel_getApplication(self));
  }
...
- (OrgGeogebraCommonKernelGeosGeoElement *)createGeoElementWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)cons1
  ...
  switch ([((NSString *) nil_chk(type)) charAtWithInt:0]) {
    case 'a':
    if ([type isEqual:@"angle"]) return new_OrgGeogebraCommonKernelGeosGeoAngle_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    return new_OrgGeogebraCommonKernelGeosGeoAxis_initWithOrgGeogebraCommonKernelConstruction_withInt_(cons1, 1);
    case 'b':
    if ([type isEqual:@"boolean"]) {
      return new_OrgGeogebraCommonKernelGeosGeoBoolean_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    }
    return new_OrgGeogebraCommonKernelGeosGeoButton_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    case 'c':
    if ([type isEqual:@"conic"]) return new_OrgGeogebraCommonKernelGeosGeoConic_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    else if ([type isEqual:@"conicpart"]) return new_OrgGeogebraCommonKernelGeosGeoConicPart_initWithOrgGeogebraCommonKernelConstruction_withInt_(cons1, 0);
    else if ([type isEqual:@"curvecartesian"]) return new_OrgGeogebraCommonKernelGeosGeoCurveCartesian_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    else if ([type isEqual:@"cascell"]) return new_OrgGeogebraCommonKernelGeosGeoCasCell_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    else if ([type isEqual:@"circle"]) {
      return new_OrgGeogebraCommonKernelGeosGeoConic_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    }
    case 'd':
    return new_OrgGeogebraCommonKernelGeosGeoConic_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    case 'e':
    ...
    if ([type isEqual:@"function"]) {
      return new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    }
    else if ([type isEqual:@"functionconditional"]) {
      return new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    }
    else {
      return new_OrgGeogebraCommonKernelGeosGeoFunctionNVar_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    }
    case 'h':
    return new_OrgGeogebraCommonKernelGeosGeoConic_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    case 'i':
    if ([type isEqual:@"image"]) return new_OrgGeogebraCommonKernelGeosGeoImage_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    else if ([type isEqual:@"intersectinglines"]) return new_OrgGeogebraCommonKernelGeosGeoConic_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    else if ([type isEqual:@"implicitpoly"]) return new_OrgGeogebraCommonKernelImplicitGeoImplicitPoly_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    else if ([type isEqual:@"interval"]) {
      return new_OrgGeogebraCommonKernelGeosGeoInterval_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    }
    case 'l':
    if ([type isEqual:@"line"]) return new_OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    else if ([type isEqual:@"list"]) return new_OrgGeogebraCommonKernelGeosGeoList_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    else return new_OrgGeogebraCommonKernelGeosGeoLocus_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    case 'n':
    return new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    case 'p':
    if ([type isEqual:@"point"]) return new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    else if ([type isEqual:@"polygon"]) return new_OrgGeogebraCommonKernelGeosGeoPolygon_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_(cons1, nil);
    else if ([type isEqual:@"polyline"]) return new_OrgGeogebraCommonKernelGeosGeoPolyLine_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_(cons1, [IOSObjectArray newArrayWithObjects:(id[]){  } count:0 type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()]);
    else return new_OrgGeogebraCommonKernelGeosGeoConic_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    case 'r':
    return new_OrgGeogebraCommonKernelGeosGeoRay_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoPoint_(cons1, nil);
    case 's':
    return new_OrgGeogebraCommonKernelGeosGeoSegment_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_(cons1, nil, nil);
    case 't':
    if ([type isEqual:@"text"]) {
      return new_OrgGeogebraCommonKernelGeosGeoText_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    }
    return new_OrgGeogebraCommonKernelGeosGeoTextField_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    case 'v':
    return new_OrgGeogebraCommonKernelGeosGeoVector_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    default:
...
- (OrgGeogebraCommonKernelArithmeticExpressionNode *)convertNumberValueToExpressionNodeWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  ...
  id<OrgGeogebraCommonKernelArithmeticTraversing> ifReplacer = new_OrgGeogebraCommonKernelKernel_$2_initWithOrgGeogebraCommonKernelKernel_(self);
  ...
  return new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self, geo);
}
...
withOrgGeogebraCommonKernelKernelNDGeoPointNDArray:(IOSObjectArray *)points {
  ...
  for (jint i = 1; i < points->size_; i++) {
    ...
    OrgGeogebraCommonKernelGeosGeoNumeric *nx = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withNSString_withDouble_(cons_, nil, xC - xA);
    OrgGeogebraCommonKernelGeosGeoNumeric *ny = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withNSString_withDouble_(cons_, nil, yC - yA);
    ...
    (void) [sb appendWithNSString:[nx getLabelWithOrgGeogebraCommonKernelStringTemplate:tpl]];
    (void) [sb appendWithNSString:@"+x("];
    (void) [sb appendWithNSString:[((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(IOSObjectArray_Get(points, 0))) getLabelWithOrgGeogebraCommonKernelStringTemplate:tpl]];
    (void) [sb appendWithNSString:@"),"];
    (void) [sb appendWithNSString:[ny getLabelWithOrgGeogebraCommonKernelStringTemplate:tpl]];
    ...
    @try {
      ...
      (void) IOSObjectArray_Set(points, i, pp);
...
- (IOSObjectArray *)RigidPolygonWithOrgGeogebraCommonKernelGeosGeoPolygon:(OrgGeogebraCommonKernelGeosGeoPolygon *)poly
  ...
  IOSObjectArray *p = [IOSObjectArray newArrayWithLength:[((OrgGeogebraCommonKernelGeosGeoPolygon *) nil_chk(poly)) getPointsLength] type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()];
  (void) IOSObjectArray_Set(p, 0, [((OrgGeogebraCommonKernelGeosGeoPoint *) nil_chk([poly getPointWithInt:0])) copy__]);
  ...
  for (jint i = 2; i < [poly getPointsLength]; i++) {
    [sb setLengthWithInt:0];
    (void) [sb appendWithNSString:@"Rotate["];
    (void) [sb appendWithNSString:[((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(IOSObjectArray_Get(p, i - 1))) getLabelWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]];
    (void) [sb appendWithNSString:@"+ ("];
    (void) [sb appendWithNSString:[((id<OrgGeogebraCommonKernelKernelNDGeoSegmentND>) nil_chk(IOSObjectArray_Get(nil_chk(segs), i - 1))) getLabelWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]];
    (void) [sb appendWithNSString:@", 0), Angle["];
    (void) [sb appendWithNSString:[((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(IOSObjectArray_Get(nil_chk(pts), i))) getLabelWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]];
    (void) [sb appendWithNSString:@"-"];
    (void) [sb appendWithNSString:[((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(IOSObjectArray_Get(pts, i - 1))) getLabelWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]];
    (void) [sb appendWithNSString:@"] + Angle["];
    (void) [sb appendWithNSString:[((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(IOSObjectArray_Get(p, i - 1))) getLabelWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]];
    (void) [sb appendWithNSString:@"-"];
    (void) [sb appendWithNSString:[((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(IOSObjectArray_Get(p, i - 2))) getLabelWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]];
    (void) [sb appendWithNSString:@"] - Angle["];
    (void) [sb appendWithNSString:[((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(IOSObjectArray_Get(pts, i - 1))) getLabelWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]];
    (void) [sb appendWithNSString:@"-"];
    (void) [sb appendWithNSString:[((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(IOSObjectArray_Get(pts, i - 2))) getLabelWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]];
    (void) [sb appendWithNSString:@"],"];
    (void) [sb appendWithNSString:[((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(IOSObjectArray_Get(p, i - 1))) getLabelWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]];
    (void) [sb appendWithNSString:@"]"];
    (void) IOSObjectArray_Set(p, i, [((OrgGeogebraCommonKernelCommandsAlgebraProcessor *) nil_chk([self getAlgebraProcessor])) evaluateToPointWithNSString:[sb description] withBoolean:YES withBoolean:NO]);
  ...
  OrgGeogebraCommonKernelAlgosAlgoPolygon *algo = new_OrgGeogebraCommonKernelAlgosAlgoPolygon_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_(cons_, nil, p);
  IOSObjectArray *ret = [IOSObjectArray newArrayWithObjects:(id[]){ IOSObjectArray_Get(nil_chk([algo getGeoElements]), 0) } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
...
withOrgGeogebraCommonKernelKernelNDGeoPointNDArray:(IOSObjectArray *)points {
  ...
  @try {
    ...
    (void) IOSObjectArray_Set(points, 1, p);
  }
  @catch (JavaLangException *e) {
    [((JavaLangException *) nil_chk(e)) printStackTrace];
    return nil;
  ...
  OrgGeogebraCommonKernelGeosGeoVec2D *a = new_OrgGeogebraCommonKernelGeosGeoVec2D_initWithOrgGeogebraCommonKernelKernel_withDouble_withDouble_([cons_ getKernel], xB - xA, yB - yA);
  OrgGeogebraCommonKernelGeosGeoVec2D *b = new_OrgGeogebraCommonKernelGeosGeoVec2D_initWithOrgGeogebraCommonKernelKernel_withDouble_withDouble_([cons_ getKernel], yA - yB, xB - xA);
  ...
  for (jint i = 2; i < points->size_; i++) {
    jdouble xC = [((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(IOSObjectArray_Get(points, i))) getInhomX];
    jdouble yC = [((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(IOSObjectArray_Get(points, i))) getInhomY];
    OrgGeogebraCommonKernelGeosGeoVec2D *d = new_OrgGeogebraCommonKernelGeosGeoVec2D_initWithOrgGeogebraCommonKernelKernel_withDouble_withDouble_([cons_ getKernel], xC - xA, yC - yA);
    [sb setLengthWithInt:0];
    (void) [sb appendWithNSString:[((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(IOSObjectArray_Get(points, 0))) getLabelWithOrgGeogebraCommonKernelStringTemplate:tpl]];
    (void) [sb appendWithChar:'+'];
    (void) [sb appendWithNSString:OrgGeogebraCommonKernelKernel_formatWithDouble_withOrgGeogebraCommonKernelStringTemplate_(self, [a innerWithOrgGeogebraCommonKernelGeosGeoVec2D:d] / aLength, tpl)];
    (void) [sb appendWithNSString:@"Vector["];
    (void) [sb appendWithNSString:[((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(IOSObjectArray_Get(points, 0))) getLabelWithOrgGeogebraCommonKernelStringTemplate:tpl]];
    (void) [sb appendWithChar:','];
    (void) [sb appendWithNSString:[((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(IOSObjectArray_Get(points, 1))) getLabelWithOrgGeogebraCommonKernelStringTemplate:tpl]];
    (void) [sb appendWithNSString:@"]+"];
    (void) [sb appendWithNSString:OrgGeogebraCommonKernelKernel_formatWithDouble_withOrgGeogebraCommonKernelStringTemplate_(self, [b innerWithOrgGeogebraCommonKernelGeosGeoVec2D:d] / aLength, tpl)];
    (void) [sb appendWithNSString:@"OrthogonalVector[Segment["];
    (void) [sb appendWithNSString:[((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(IOSObjectArray_Get(points, 0))) getLabelWithOrgGeogebraCommonKernelStringTemplate:tpl]];
    (void) [sb appendWithChar:','];
    (void) [sb appendWithNSString:[((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(IOSObjectArray_Get(points, 1))) getLabelWithOrgGeogebraCommonKernelStringTemplate:tpl]];
...
- (OrgGeogebraCommonKernelMacroKernel *)newMacroKernel {
  return new_OrgGeogebraCommonKernelMacroKernel_initWithOrgGeogebraCommonKernelKernel_(self);
}
...
- (void)refreshCASCommands {
  ...
  JavaUtilTreeSet *treeset = new_JavaUtilTreeSet_initWithJavaUtilSortedSet_([((OrgGeogebraCommonKernelConstruction *) nil_chk([self getConstruction])) getGeoSetWithCasCellsConstructionOrder]);
  ...
  OrgGeogebraCommonKernelGeosGeoElement_updateCascadeWithJavaUtilArrayList_withJavaUtilTreeSet_withBoolean_(al, new_JavaUtilTreeSet_init(), YES);
...
- (OrgGeogebraCommonKernelAlgosAlgoDispatcher *)getAlgoDispatcher {
  if (algoDispatcher_ == nil) {
    algoDispatcher_ = [self newAlgoDispatcherWithOrgGeogebraCommonKernelConstruction:cons_];
  }
...
- (OrgGeogebraCommonKernelAlgosAlgoDispatcher *)newAlgoDispatcherWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)cons1 {
  return new_OrgGeogebraCommonKernelAlgosAlgoDispatcher_initWithOrgGeogebraCommonKernelConstruction_(cons1);
}
...
- (void)initAfterAsyncWithOrgGeogebraCommonMainApp:(OrgGeogebraCommonMainApp *)app1 {
  ...
  (void) [self getExpressionNodeEvaluator];
...
- (void)setAlgebraProcessorWithOrgGeogebraCommonKernelCommandsAlgebraProcessor:(OrgGeogebraCommonKernelCommandsAlgebraProcessor *)algebraProcessor {
  algProcessor_ = algebraProcessor;
}
...
- (OrgGeogebraCommonKernelGeosGeoElement *)wrapInVectorWithOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)pt {
  OrgGeogebraCommonKernelAlgosAlgoVectorPoint *algo = new_OrgGeogebraCommonKernelAlgosAlgoVectorPoint_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointND_(cons_, pt);
...
void OrgGeogebraCommonKernelKernel_initWithOrgGeogebraCommonMainApp_(OrgGeogebraCommonKernelKernel *self, OrgGeogebraCommonMainApp *app) {
  (void) OrgGeogebraCommonKernelKernel_init(self);
  self->app_ = app;
  [self newConstruction];
  (void) [self getExpressionNodeEvaluator];
  [self setManager3DWithOrgGeogebraCommonKernelManager3DInterface:[self newManager3DWithOrgGeogebraCommonKernelKernel:self]];
...
void OrgGeogebraCommonKernelKernel_init(OrgGeogebraCommonKernelKernel *self) {
  ...
  self->continuous_ = NO;
  self->usePathAndRegionParameters__ = OrgGeogebraCommonKernelPathRegionHandlingEnum_get_ON();
  ...
  self->sbBuildExplicitLineEquation_ = new_JavaLangStringBuilder_initWithInt_(50);
  self->concurrentModificationLock_ = new_NSObject_init();
  self->showAnimationButton_ = YES;
  self->sbBuildImplicitEquation_ = new_JavaLangStringBuilder_initWithInt_(80);
  self->sbBuildLHS_ = new_JavaLangStringBuilder_initWithInt_(80);
  self->sbBuildExplicitConicEquation_ = new_JavaLangStringBuilder_initWithInt_(80);
  self->libraryJavaScript_ = OrgGeogebraCommonKernelKernel_defaultLibraryJavaScript_;
  self->sbFormatAngle_ = new_JavaLangStringBuilder_initWithInt_(40);
  self->xmin_ = [IOSDoubleArray newArrayWithLength:1];
  self->xmax_ = [IOSDoubleArray newArrayWithLength:1];
  self->ymin_ = [IOSDoubleArray newArrayWithLength:1];
  self->ymax_ = [IOSDoubleArray newArrayWithLength:1];
  self->xscale_ = [IOSDoubleArray newArrayWithLength:1];
  self->yscale_ = [IOSDoubleArray newArrayWithLength:1];
  self->graphicsView2showing_ = NO;
  self->notifyRepaint__ = YES;
  self->lastAttachedEV_ = nil;
  self->notifyViewsActive_ = YES;
  self->selectedGeosNames_ = new_JavaUtilArrayList_init();
  self->ges_ = new_OrgGeogebraCommonKernelGeosGeoElementSpreadsheet_init();
  self->nf_ = [((OrgGeogebraCommonFactoriesFormatFactory *) nil_chk(OrgGeogebraCommonFactoriesFormatFactory_get_prototype_())) getNumberFormatWithInt:2];
  self->sf_ = [OrgGeogebraCommonFactoriesFormatFactory_get_prototype_() getScientificFormatWithInt:5 withInt:16 withBoolean:NO];
  self->userAwarenessListeners_ = new_JavaUtilArrayList_init();
  self->deleteList_ = new_JavaUtilArrayList_init();
}
...
id<JavaUtilComparator> OrgGeogebraCommonKernelKernel_DoubleComparatorWithDouble_(jdouble precision) {
  ...
  id<JavaUtilComparator> ret = new_OrgGeogebraCommonKernelKernel_$1_initWithDouble_(eps);
  return ret;
}
...
JavaLangStringBuilder *OrgGeogebraCommonKernelKernel_buildImplicitEquationWithDoubleArray_withNSStringArray_withBoolean_withBoolean_withBoolean_withChar_withOrgGeogebraCommonKernelStringTemplate_(OrgGeogebraCommonKernelKernel *self, IOSDoubleArray *numbers, IOSObjectArray *vars, jboolean KEEP_LEADING_SIGN, jboolean CANCEL_DOWN, jboolean needsZ, jchar op, OrgGeogebraCommonKernelStringTemplate *tpl) {
  ...
  (void) [self->sbBuildImplicitEquation_ appendWithChar:' '];
  (void) [self->sbBuildImplicitEquation_ appendWithChar:op];
  (void) [self->sbBuildImplicitEquation_ appendWithChar:' '];
  (void) [self->sbBuildImplicitEquation_ appendWithNSString:OrgGeogebraCommonKernelKernel_formatWithDouble_withOrgGeogebraCommonKernelStringTemplate_(self, -IOSDoubleArray_Get(nil_chk(temp), ((IOSObjectArray *) nil_chk(vars))->size_), tpl)];
...
void OrgGeogebraCommonKernelKernel_formatSignedWithDouble_withJavaLangStringBuilder_withOrgGeogebraCommonKernelStringTemplate_(OrgGeogebraCommonKernelKernel *self, jdouble x, JavaLangStringBuilder *sb, OrgGeogebraCommonKernelStringTemplate *tpl) {
  if (x >= 0.0) {
    (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"+ "];
    (void) [sb appendWithNSString:OrgGeogebraCommonKernelKernel_formatWithDouble_withOrgGeogebraCommonKernelStringTemplate_(self, x, tpl)];
    return;
  }
  (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"- "];
  (void) [sb appendWithNSString:OrgGeogebraCommonKernelKernel_formatWithDouble_withOrgGeogebraCommonKernelStringTemplate_(self, -x, tpl)];
...
void OrgGeogebraCommonKernelKernel_formatSignedCoefficientPlusMinusWithDouble_withJavaLangStringBuilder_withOrgGeogebraCommonKernelStringTemplate_(OrgGeogebraCommonKernelKernel *self, jdouble x, JavaLangStringBuilder *sb, OrgGeogebraCommonKernelStringTemplate *tpl) {
  if (x == -1.0) {
    (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:OrgGeogebraCommonKernelKernel_STRING_MINUS_PLUS_];
    return;
  }
  if (x == 1.0) {
    (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:OrgGeogebraCommonKernelKernel_STRING_PLUS_MINUS_];
    return;
  }
  OrgGeogebraCommonKernelKernel_formatSignedPlusMinusWithDouble_withJavaLangStringBuilder_withOrgGeogebraCommonKernelStringTemplate_(self, x, sb, tpl);
}
...
NSString *OrgGeogebraCommonKernelKernel_formatPiERawWithDouble_withOrgGeogebraCommonUtilNumberFormatAdapter_withOrgGeogebraCommonKernelStringTemplate_(OrgGeogebraCommonKernelKernel *self, jdouble x, id<OrgGeogebraCommonUtilNumberFormatAdapter> numF, OrgGeogebraCommonKernelStringTemplate *tpl) {
  ...
  if (self->sbFormat_ == nil) {
    self->sbFormat_ = new_JavaLangStringBuilder_init();
  }
  ...
  if (OrgGeogebraCommonKernelKernel_isEqualWithDouble_withDouble_withDouble_(a, aint, OrgGeogebraCommonKernelKernel_AXES_PRECISION)) {
    {
      ...
      switch (aint) {
        ...
        return @"0";
        case 1:
        (void) [self->sbFormat_ appendWithNSString:[((OrgGeogebraCommonKernelStringTemplate *) nil_chk(tpl)) getPi]];
        (void) [self->sbFormat_ appendWithNSString:@"/2"];
        return [self->sbFormat_ description];
        case -1:
        (void) [self->sbFormat_ appendWithChar:'-'];
        (void) [self->sbFormat_ appendWithNSString:[((OrgGeogebraCommonKernelStringTemplate *) nil_chk(tpl)) getPi]];
        (void) [self->sbFormat_ appendWithNSString:@"/2"];
        return [self->sbFormat_ description];
        case 2:
        ...
        half = aint / 2;
        if (aint == (2 * half)) {
          (void) [self->sbFormat_ appendWithLong:half];
          if (![((OrgGeogebraCommonKernelStringTemplate *) nil_chk(tpl)) hasTypeWithOrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_GEOGEBRA()]) {
            (void) [self->sbFormat_ appendWithNSString:@"*"];
          }
          (void) [self->sbFormat_ appendWithNSString:[tpl getPi]];
          return [self->sbFormat_ description];
        }
        (void) [self->sbFormat_ appendWithInt:aint];
        if (![((OrgGeogebraCommonKernelStringTemplate *) nil_chk(tpl)) hasTypeWithOrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_GEOGEBRA()]) {
          (void) [self->sbFormat_ appendWithNSString:@"*"];
        }
        (void) [self->sbFormat_ appendWithNSString:[tpl getPi]];
  ...
  (void) [self->sbFormat_ appendWithNSString:str];
...
IOSDoubleArray *OrgGeogebraCommonKernelKernel_buildImplicitVarPartWithJavaLangStringBuilder_withDoubleArray_withNSStringArray_withBoolean_withBoolean_withBoolean_withOrgGeogebraCommonKernelStringTemplate_(OrgGeogebraCommonKernelKernel *self, JavaLangStringBuilder *sbBuildImplicitVarPart, IOSDoubleArray *numbers, IOSObjectArray *vars, jboolean KEEP_LEADING_SIGN, jboolean CANCEL_DOWN, jboolean needsZ, OrgGeogebraCommonKernelStringTemplate *tpl) {
  IOSDoubleArray *temp = [IOSDoubleArray newArrayWithLength:((IOSDoubleArray *) nil_chk(numbers))->size_];
  ...
  if (leadingNonZero == -1) {
    (void) [sbBuildImplicitVarPart appendWithNSString:@"0"];
    return temp;
  }
  ...
  (void) [sbBuildImplicitVarPart appendWithNSString:strCoeff];
  (void) [sbBuildImplicitVarPart appendWithNSString:IOSObjectArray_Get(vars, leadingNonZero)];
  NSString *sign;
  jdouble abs;
  for (jint i = leadingNonZero + 1; i < vars->size_; i++) {
    ...
    if ((abs >= [((OrgGeogebraCommonKernelStringTemplate *) nil_chk(tpl)) getPrecisionWithOrgGeogebraCommonUtilNumberFormatAdapter:self->nf_]) || self->useSignificantFigures_ || (needsZ && i == 2)) {
      (void) [sbBuildImplicitVarPart appendWithNSString:sign];
      (void) [sbBuildImplicitVarPart appendWithNSString:OrgGeogebraCommonKernelKernel_formatCoeffWithDouble_withOrgGeogebraCommonKernelStringTemplate_(self, abs, tpl)];
      (void) [sbBuildImplicitVarPart appendWithNSString:IOSObjectArray_Get(vars, i)];
    }
  }
  return temp;
}
...
NSString *OrgGeogebraCommonKernelKernel_formatSFWithDouble_withOrgGeogebraCommonKernelStringTemplate_(OrgGeogebraCommonKernelKernel *self, jdouble x, OrgGeogebraCommonKernelStringTemplate *tpl) {
  if (self->sbFormatSF_ == nil) {
    self->sbFormatSF_ = new_JavaLangStringBuilder_init();
  }
  else {
  ...
  if (x == 0) {
    ...
    (void) [((JavaLangStringBuilder *) nil_chk(self->sbFormatSF_)) appendWithChar:'-'];
    absStr = [((id<OrgGeogebraCommonUtilScientificFormatAdapter>) nil_chk(sfa)) formatWithDouble:-x];
  }
  if ([((NSString *) nil_chk(absStr)) charAtWithInt:0] == '.') {
    (void) [((JavaLangStringBuilder *) nil_chk(self->sbFormatSF_)) appendWithChar:'0'];
  }
  (void) [((JavaLangStringBuilder *) nil_chk(self->sbFormatSF_)) appendWithNSString:absStr];
...
JavaLangStringBuilder *OrgGeogebraCommonKernelKernel_formatAngleWithDouble_withDouble_withOrgGeogebraCommonKernelStringTemplate_withBoolean_(OrgGeogebraCommonKernelKernel *self, jdouble alpha, jdouble precision, OrgGeogebraCommonKernelStringTemplate *tpl, jboolean unbounded) {
  ...
  switch ([[((OrgGeogebraCommonKernelStringTemplate *) nil_chk(tpl)) getStringType] ordinal]) {
    ...
    if (JavaLangDouble_isNaNWithDouble_(phi)) {
      (void) [self->sbFormatAngle_ appendWithNSString:@"?"];
    ...
    if (OrgGeogebraCommonKernelKernel_getAngleUnit(self) == OrgGeogebraCommonKernelKernel_ANGLE_DEGREE) {
      ...
      if (rtl) {
        if ([tpl hasCASType]) {
          (void) [self->sbFormatAngle_ appendWithNSString:@"pi/180*"];
        }
        else {
          (void) [self->sbFormatAngle_ appendWithChar:OrgGeogebraCommonUtilUnicode_DEGREE_CHAR];
        }
      }
      ...
      (void) [self->sbFormatAngle_ appendWithNSString:OrgGeogebraCommonKernelKernel_formatWithDouble_withOrgGeogebraCommonKernelStringTemplate_(self, OrgGeogebraCommonKernelKernel_checkDecimalFractionWithDouble_withDouble_(phi, precision), tpl)];
    ...
    (void) [self->sbFormatAngle_ appendWithNSString:OrgGeogebraCommonKernelKernel_formatWithDouble_withOrgGeogebraCommonKernelStringTemplate_(self, phi, tpl)];
    if (![tpl hasTypeWithOrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_GEOGEBRA_XML()]) {
      (void) [self->sbFormatAngle_ appendWithNSString:@" rad"];
    }
    return self->sbFormatAngle_;
  }
}
...
OrgGeogebraCommonKernelGeosGeoElement *OrgGeogebraCommonKernelKernel_lookupLabelWithNSString_withBoolean_withBoolean_(OrgGeogebraCommonKernelKernel *self, NSString *label, jboolean autoCreate, jboolean useDummies) {
  ...
  if ((geo == nil) && useDummies) {
    ...
    if (geo == nil) {
      geo = new_OrgGeogebraCommonKernelGeosGeoDummyVariable_initWithOrgGeogebraCommonKernelConstruction_withNSString_(self->cons_, label);
    }
  }
  return geo;
}
...
void OrgGeogebraCommonKernelKernel_printAttachedViews(OrgGeogebraCommonKernelKernel *self) {
  @try {
    if (!self->notifyViewsActive_) {
      ...
      JavaLangStringBuilder *sb = new_JavaLangStringBuilder_init();
      (void) [sb appendWithNSString:@"Number of registered views = "];
      (void) [sb appendWithInt:[((JavaUtilArrayList *) nil_chk(self->views_)) size]];
      for (id<OrgGeogebraCommonKernelView> __strong view in self->views_) {
        (void) [sb appendWithNSString:@"\n * "];
        (void) [sb appendWithId:[((id<OrgGeogebraCommonKernelView>) nil_chk(view)) getClass]];
      }
...
OrgGeogebraCommonKernelArithmeticMyDouble *OrgGeogebraCommonKernelKernel_convertIndexToNumberWithNSString_(OrgGeogebraCommonKernelKernel *self, NSString *str) {
  ...
  OrgGeogebraCommonKernelArithmeticMyDouble *md = new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withNSString_(self, [str substring:i endIndex:((jint) [str length]) - 1]);
  return md;
}
