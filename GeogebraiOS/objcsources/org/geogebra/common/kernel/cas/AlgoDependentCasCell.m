...
void OrgGeogebraCommonKernelCasAlgoDependentCasCell_initWithOrgGeogebraCommonKernelGeosGeoCasCell_(OrgGeogebraCommonKernelCasAlgoDependentCasCell *self, OrgGeogebraCommonKernelGeosGeoCasCell *casCell) {
  (void) OrgGeogebraCommonKernelAlgosAlgoElement_initWithOrgGeogebraCommonKernelConstruction_(self, [((OrgGeogebraCommonKernelGeosGeoCasCell *) nil_chk(casCell)) getConstruction]);
  self->casCell_ = casCell;
...
void OrgGeogebraCommonKernelCasAlgoDependentCasCell_initInput(OrgGeogebraCommonKernelCasAlgoDependentCasCell *self) {
  ...
  if (geoVars == nil) {
    self->input_ = [IOSObjectArray newArrayWithLength:0 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
  }
  else {
    IOSObjectArray *geos = [IOSObjectArray newArrayWithLength:[geoVars size] type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    self->input_ = [geoVars toArrayWithNSObjectArray:geos];
  }
}
