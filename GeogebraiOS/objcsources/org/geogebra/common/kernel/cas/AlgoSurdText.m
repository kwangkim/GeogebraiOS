...
- (void)setInputOutput {
  input_ = [IOSObjectArray newArrayWithLength:list_ == nil ? 1 : 2 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
...
- (void)compute {
  ...
  if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(IOSObjectArray_Get(nil_chk(input_), 0))) isDefined]) {
    ...
    if (OrgGeogebraCommonKernelKernel_isEqualWithDouble_withDouble_withDouble_(decimal - JavaLangMath_roundWithDouble_(decimal), 0.0, OrgGeogebraCommonKernelKernel_MAX_PRECISION)) {
      (void) [sb_ appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) formatWithDouble:JavaLangMath_roundWithDouble_(decimal) withOrgGeogebraCommonKernelStringTemplate:tpl]];
    }
    else {
      if (list_ == nil) {
...
- (void)PSLQappendGeneralWithJavaLangStringBuilder:(JavaLangStringBuilder *)sb
  ...
  if (OrgGeogebraCommonKernelKernel_isZeroWithDouble_(num)) {
    (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) formatWithDouble:0 withOrgGeogebraCommonKernelStringTemplate:tpl]];
    return;
  }
  ...
  if (list_ != nil) {
    ...
    testValues = [IOSDoubleArray newArrayWithLength:[values size]];
    testNames = [IOSObjectArray newArrayWithLength:[values size] type:NSString_class_()];
    for (jint i = 0; i < [values size]; i++) {
      *IOSDoubleArray_GetRef(testValues, i) = [((JavaLangDouble *) nil_chk([values getWithInt:i])) doubleValue];
      (void) IOSObjectArray_Set(testNames, i, [names getWithInt:i]);
    }
  }
  else {
    testValues = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ JavaLangMath_sqrtWithDouble_(2.0), JavaLangMath_sqrtWithDouble_(3.0), JavaLangMath_sqrtWithDouble_(5.0), JavaLangMath_sqrtWithDouble_(6.0), JavaLangMath_sqrtWithDouble_(7.0), JavaLangMath_sqrtWithDouble_(10.0), JavaLangMath_PI } count:7];
    testNames = [IOSObjectArray newArrayWithObjects:(id[]){ @"sqrt(2)", @"sqrt(3)", @"sqrt(5)", @"sqrt(6)", @"sqrt(7)", @"sqrt(10)", @"pi" } count:7 type:NSString_class_()];
  }
  ...
  (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) formatWithDouble:num withOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_maxPrecision_()]];
}
...
- (void)appendCombinationWithJavaLangStringBuilder:(JavaLangStringBuilder *)sbToCAS
  ...
  for (jint j = 0; j < numOfAllTerms; j++) {
    (void) [((JavaLangStringBuilder *) nil_chk(sbToCAS)) appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) formatWithDouble:IOSIntArray_Get(coeffs, offset + j * step) withOrgGeogebraCommonKernelStringTemplate:tpl]];
    (void) [sbToCAS appendWithNSString:@"*"];
    (void) [sbToCAS appendWithNSString:IOSObjectArray_Get(vars, j)];
    if (counter > 0) {
      (void) [sbToCAS appendWithNSString:@" + "];
      counter--;
    }
...
- (void)PSLQappendQuarticWithJavaLangStringBuilder:(JavaLangStringBuilder *)sb
                                        withDouble:(jdouble)num1
         withOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  IOSDoubleArray *numPowers = [IOSDoubleArray newArrayWithLength:5];
  jdouble temp = 1.0;
  for (jint i = 4; i >= 0; i--) {
  ...
  if (IOSIntArray_Get(nil_chk(coeffs), 0) == 0 && IOSIntArray_Get(coeffs, 1) == 0) {
    if (IOSIntArray_Get(coeffs, 2) == 0 && IOSIntArray_Get(coeffs, 3) == 0 && IOSIntArray_Get(coeffs, 4) == 0) {
      ...
      if (OrgGeogebraCommonKernelKernel_isZeroWithDouble_(b1)) {
        en = new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, a);
      }
      else {
        en = [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([(new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, b2)) sqrt])) multiplyRWithDouble:b1];
        if (positive) {
      ...
      (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:[((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(en)) toStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
    }
  }
  else if (IOSIntArray_Get(coeffs, 0) == 0) {
    (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"Root of a cubic equation: "];
    (void) [sb appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) formatWithDouble:IOSIntArray_Get(coeffs, 1) withOrgGeogebraCommonKernelStringTemplate:tpl]];
    (void) [sb appendWithNSString:@"x^3 + "];
    (void) [sb appendWithNSString:[kernel_ formatWithDouble:IOSIntArray_Get(coeffs, 2) withOrgGeogebraCommonKernelStringTemplate:tpl]];
    (void) [sb appendWithNSString:@"x^2 + "];
    (void) [sb appendWithNSString:[kernel_ formatWithDouble:IOSIntArray_Get(coeffs, 3) withOrgGeogebraCommonKernelStringTemplate:tpl]];
    (void) [sb appendWithNSString:@"x + "];
    (void) [sb appendWithNSString:[kernel_ formatWithDouble:IOSIntArray_Get(coeffs, 4) withOrgGeogebraCommonKernelStringTemplate:tpl]];
    OrgGeogebraCommonMainApp_debugWithNSString_([sb description]);
  }
  else {
    (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"Root of a quartic equation: "];
    (void) [sb appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) formatWithDouble:IOSIntArray_Get(coeffs, 0) withOrgGeogebraCommonKernelStringTemplate:tpl]];
    (void) [sb appendWithNSString:@"x^4 + "];
    (void) [sb appendWithNSString:[kernel_ formatWithDouble:IOSIntArray_Get(coeffs, 1) withOrgGeogebraCommonKernelStringTemplate:tpl]];
    (void) [sb appendWithNSString:@"x^3 + "];
    (void) [sb appendWithNSString:[kernel_ formatWithDouble:IOSIntArray_Get(coeffs, 2) withOrgGeogebraCommonKernelStringTemplate:tpl]];
    (void) [sb appendWithNSString:@"x^2 + "];
    (void) [sb appendWithNSString:[kernel_ formatWithDouble:IOSIntArray_Get(coeffs, 3) withOrgGeogebraCommonKernelStringTemplate:tpl]];
...
- (void)PSLQappendQuadraticWithJavaLangStringBuilder:(JavaLangStringBuilder *)sb
  ...
  IOSDoubleArray *numPowers = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ num1 * num1, num1, 1.0 } count:3];
...
- (IOSObjectArray *)mPSLQWithInt:(jint)n
  ...
  jint oldp = p;
  jint q;
  OrgGeogebraCommonKernelCasAlgoSurdText_IntRelationFinder *irf = new_OrgGeogebraCommonKernelCasAlgoSurdText_IntRelationFinder_initWithOrgGeogebraCommonKernelCasAlgoSurdText_withInt_withDoubleArray_withInt_withInt_withDouble_withDouble_(self, oldp, x, fullScale_, lessScale_, AccuracyFactor, bound);
  ...
  r2 = new_OrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix_initWithInt_withInt_withInt_([((OrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix *) nil_chk([((OrgGeogebraCommonKernelCasAlgoSurdText_IntRelationFinder_IntRelation *) nil_chk(m)) getBMatrix])) getScale], n, n);
  ...
  for (jint j = 0; j < oldp; j++) {
    if (IOSIntArray_Get(nil_chk(m->orthoIndices_), j) == 0) {
      *IOSDoubleArray_GetRef(nil_chk(x), p++) = [new_JavaLangDouble_initWithNSString_([((OrgGeogebraCommonUtilMyMathExact_MyDecimal *) nil_chk([((OrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix *) nil_chk(m->xB1_)) getEntryWithInt:0 withInt:j])) description]) doubleValue];
    }
  }
  ...
  while (oldp >= 2 && p < oldp && rCols < n - 1) {
    oldp = p;
    p = 0;
    irf = new_OrgGeogebraCommonKernelCasAlgoSurdText_IntRelationFinder_initWithOrgGeogebraCommonKernelCasAlgoSurdText_withInt_withDoubleArray_withInt_withInt_withDouble_withDouble_(self, oldp, x, fullScale_, lessScale_, AccuracyFactor, bound);
  ...
  IOSObjectArray *result = [IOSIntArray newArrayWithDimensions:2 lengths:(jint[]){ n, rCols }];
  for (jint i = 0; i < n; i++) {
...
void OrgGeogebraCommonKernelCasAlgoSurdText_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoNumberValue_withOrgGeogebraCommonKernelGeosGeoList_(OrgGeogebraCommonKernelCasAlgoSurdText *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, id<OrgGeogebraCommonKernelGeosGeoNumberValue> num, OrgGeogebraCommonKernelGeosGeoList *list) {
  (void) OrgGeogebraCommonKernelCasAlgoSurdText_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoNumberValue_withOrgGeogebraCommonKernelGeosGeoList_(self, cons, num, list);
...
void OrgGeogebraCommonKernelCasAlgoSurdText_FractionappendWithJavaLangStringBuilder_withInt_withInt_withOrgGeogebraCommonKernelStringTemplate_(OrgGeogebraCommonKernelCasAlgoSurdText *self, JavaLangStringBuilder *sb, jint numer, jint denom, OrgGeogebraCommonKernelStringTemplate *tpl) {
  ...
  if (denom == 1) {
    ...
    (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) formatWithDouble:numer withOrgGeogebraCommonKernelStringTemplate:tpl]];
    ...
    (void) [sb appendWithNSString:[self->kernel_ formatWithDouble:denom withOrgGeogebraCommonKernelStringTemplate:tpl]];
...
IOSIntArray *OrgGeogebraCommonKernelCasAlgoSurdText_PSLQWithInt_withDoubleArray_withDouble_withInt_withIntArray2_withDoubleArray_withIntArray_(jint n, IOSDoubleArray *x_input, jdouble AccuracyFactor, jint bound, IOSObjectArray *B_mutable, IOSDoubleArray *xB_mutable, IOSIntArray *orthoIndices_mutable) {
  ...
  if (orthoIndices_mutable == nil) orthoIndices = [IOSIntArray newArrayWithLength:n];
  else orthoIndices = orthoIndices_mutable;
  IOSDoubleArray *xB;
  if (xB_mutable == nil) xB = [IOSDoubleArray newArrayWithLength:n];
  else xB = xB_mutable;
  IOSObjectArray *B;
  if (B_mutable == nil) B = [IOSIntArray newArrayWithDimensions:2 lengths:(jint[]){ n, n }];
  else B = B_mutable;
  jdouble normX;
  IOSDoubleArray *ss;
  ...
  ss = [IOSDoubleArray newArrayWithLength:n];
  *IOSDoubleArray_GetRef(ss, n - 1) = IOSDoubleArray_Get(x, n - 1) * IOSDoubleArray_Get(x, n - 1);
  ...
  IOSDoubleArray *Pss = [IOSDoubleArray newArrayWithLength:n - 1];
  for (jint i = 0; i < n - 1; i++) {
    *IOSDoubleArray_GetRef(Pss, i) = IOSDoubleArray_Get(ss, i) * IOSDoubleArray_Get(ss, i + 1);
  }
  H = [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ n, n - 1 }];
  for (jint i = 0; i < n; i++) {
    for (jint j = 0; j < i; j++) {
  ...
  P = [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ n, n }];
  ...
  R = [IOSIntArray newArrayWithDimensions:3 lengths:(jint[]){ n - 1, n, n }];
  ...
  A = [IOSIntArray newArrayWithDimensions:2 lengths:(jint[]){ n, n }];
  ...
  while (itCount < itBound) {
    ...
    D = [IOSIntArray newArrayWithDimensions:2 lengths:(jint[]){ n, n }];
    IOSObjectArray *D0 = [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ n, n }];
    for (jint i = 0; i < n; i++) {
    ...
    E = [IOSIntArray newArrayWithDimensions:2 lengths:(jint[]){ n, n }];
    for (jint i = 0; i < n; i++) {
      for (jint j = n - 1; j >= i + 1; j--) {
    ...
    newH = [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ n, n - 1 }];
    IOSObjectArray *newH0 = [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ n, n - 1 }];
    for (jint i = 0; i < n; i++) {
      for (jint j = 0; j < n - 1; j++) {
    ...
    G = [IOSDoubleArray newArrayWithDimensions:3 lengths:(jint[]){ n - 1, n - 1, n - 1 }];
    ...
    for (jint i = 0; i < n; i++) for (jint j = 0; j < n - 1; j++) *IOSDoubleArray_GetRef(nil_chk(IOSObjectArray_Get(H, i)), j) = IOSDoubleArray_Get(nil_chk(IOSObjectArray_Get(newH, i)), j);
    newAorB = [IOSIntArray newArrayWithDimensions:2 lengths:(jint[]){ n, n }];
    for (jint i = 0; i < n; i++) {
      for (jint j = 0; j < n; j++) {
...
- (void)initialize_full {
  xNorm_ = new_OrgGeogebraCommonUtilMyMathExact_MyDecimal_initWithInt_(lessScale1_);
  for (jint i = 0; i < n_; i++) {
    xNorm_ = [xNorm_ addWithOrgGeogebraCommonUtilMyMathExact_MyDecimal:[((OrgGeogebraCommonUtilMyMathExact_MyDecimal *) nil_chk(IOSObjectArray_Get(nil_chk(x_full_), i))) multiplyWithOrgGeogebraCommonUtilMyMathExact_MyDecimal:IOSObjectArray_Get(x_full_, i)]];
  }
  xNorm_ = [((OrgGeogebraCommonUtilMyMathExact_MyDecimal *) nil_chk(xNorm_)) sqrt];
  for (jint i = 0; i < n_; i++) {
    (void) IOSObjectArray_Set(nil_chk(x_full_), i, [((OrgGeogebraCommonUtilMyMathExact_MyDecimal *) nil_chk(IOSObjectArray_Get(x_full_, i))) divideWithOrgGeogebraCommonUtilMyMathExact_MyDecimal:xNorm_]);
    (void) IOSObjectArray_Set(nil_chk(x_double_), i, new_OrgGeogebraCommonUtilMyMathExact_MyDecimal_initWithInt_withJavaMathBigDecimal_(lessScale1_, IOSObjectArray_Get(x_full_, i)));
  }
  IOSObjectArray *ss = [IOSObjectArray newArrayWithLength:n_ type:OrgGeogebraCommonUtilMyMathExact_MyDecimal_class_()];
  for (jint i = 0; i < n_; i++) {
    (void) IOSObjectArray_Set(ss, i, new_OrgGeogebraCommonUtilMyMathExact_MyDecimal_initWithInt_(fullScale1_));
  }
  (void) IOSObjectArray_Set(ss, n_ - 1, [((OrgGeogebraCommonUtilMyMathExact_MyDecimal *) nil_chk(IOSObjectArray_Get(nil_chk(x_full_), n_ - 1))) multiplyWithOrgGeogebraCommonUtilMyMathExact_MyDecimal:IOSObjectArray_Get(x_full_, n_ - 1)]);
  for (jint i = n_ - 2; i >= 0; i--) {
    (void) IOSObjectArray_Set(ss, i, [((OrgGeogebraCommonUtilMyMathExact_MyDecimal *) nil_chk(IOSObjectArray_Get(ss, i + 1))) addWithOrgGeogebraCommonUtilMyMathExact_MyDecimal:[((OrgGeogebraCommonUtilMyMathExact_MyDecimal *) nil_chk(IOSObjectArray_Get(x_full_, i))) multiplyWithOrgGeogebraCommonUtilMyMathExact_MyDecimal:IOSObjectArray_Get(x_full_, i)]]);
  }
  for (jint i = 0; i < n_; i++) {
    (void) IOSObjectArray_Set(ss, i, [((OrgGeogebraCommonUtilMyMathExact_MyDecimal *) nil_chk(IOSObjectArray_Get(ss, i))) sqrt]);
  }
  IOSObjectArray *Pss = [IOSObjectArray newArrayWithLength:n_ - 1 type:OrgGeogebraCommonUtilMyMathExact_MyDecimal_class_()];
  for (jint i = 0; i < n_ - 1; i++) {
    (void) IOSObjectArray_Set(Pss, i, new_OrgGeogebraCommonUtilMyMathExact_MyDecimal_initWithInt_withJavaMathBigDecimal_(fullScale1_, [((OrgGeogebraCommonUtilMyMathExact_MyDecimal *) nil_chk(IOSObjectArray_Get(ss, i))) multiplyWithOrgGeogebraCommonUtilMyMathExact_MyDecimal:IOSObjectArray_Get(ss, i + 1)]));
  }
  H_full_ = new_OrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix_initWithInt_withInt_withInt_(fullScale1_, n_, n_ - 1);
  for (jint i = 0; i < n_; i++) {
    for (jint j = 0; j < i; j++) {
  ...
  H_ = new_OrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix_initWithInt_withInt_withInt_(lessScale1_, n_, n_ - 1);
  for (jint i = 0; i < n_; i++) {
    for (jint j = 0; j < n_ - 1; j++) {
      [H_ setEntryWithInt:i withInt:j withOrgGeogebraCommonUtilMyMathExact_MyDecimal:new_OrgGeogebraCommonUtilMyMathExact_MyDecimal_initWithInt_withJavaMathBigDecimal_(lessScale1_, [H_full_ getEntryWithInt:i withInt:j])];
    }
  }
  I_ = new_OrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix_initWithInt_withInt_withInt_(lessScale1_, n_, n_);
  for (jint i = 0; i < n_; i++) {
    for (jint j = 0; j < n_; j++) {
  ...
  A_ = [I_ copy__];
  B_ = [I_ copy__];
  xB_ = new_OrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix_initWithInt_withInt_withInt_(lessScale1_, 1, n_);
  for (jint i = 0; i < n_; i++) {
...
void OrgGeogebraCommonKernelCasAlgoSurdText_IntRelationFinder_initWithOrgGeogebraCommonKernelCasAlgoSurdText_withInt_withDoubleArray_withInt_withInt_withDouble_withDouble_(OrgGeogebraCommonKernelCasAlgoSurdText_IntRelationFinder *self, OrgGeogebraCommonKernelCasAlgoSurdText *outer$, jint n, IOSDoubleArray *x, jint fullScale_input, jint lessScale_input, jdouble err, jdouble bound) {
  ...
  self->ZERO_ = new_OrgGeogebraCommonUtilMyMathExact_MyDecimal_initWithInt_withJavaMathBigDecimal_(self->fullScale1_, JavaMathBigDecimal_get_ZERO_());
  self->ZERO_LESS_ = new_OrgGeogebraCommonUtilMyMathExact_MyDecimal_initWithInt_withJavaMathBigDecimal_(self->lessScale1_, JavaMathBigDecimal_get_ZERO_());
  self->ONE_LESS_ = new_OrgGeogebraCommonUtilMyMathExact_MyDecimal_initWithInt_withJavaMathBigDecimal_(self->lessScale1_, JavaMathBigDecimal_get_ONE_());
  if (n < 1) {
    [self->result_ clear];
    return;
  }
  if (n == 1) {
    ...
    self->B_ = new_OrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix_initWithInt_withInt_withInt_(self->lessScale1_, 1, 1);
    [self->B_ setEntryWithInt:0 withInt:0 withOrgGeogebraCommonUtilMyMathExact_MyDecimal:self->ONE_LESS_];
    self->xB_ = new_OrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix_initWithInt_withInt_withInt_(self->lessScale1_, 1, 1);
    [self->xB_ setEntryWithInt:0 withInt:0 withOrgGeogebraCommonUtilMyMathExact_MyDecimal:self->ZERO_LESS_];
    OrgGeogebraCommonKernelCasAlgoSurdText_IntRelationFinder_IntRelation *m = new_OrgGeogebraCommonKernelCasAlgoSurdText_IntRelationFinder_IntRelation_initWithOrgGeogebraCommonKernelCasAlgoSurdText_IntRelationFinder_withInt_withOrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix_withOrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix_withDouble_(self, n, self->B_, self->xB_, 1);
    [self->result_ addWithId:m];
    return;
  }
  self->x_ = [IOSDoubleArray newArrayWithLength:n];
  self->x_full_ = [IOSObjectArray newArrayWithLength:n type:OrgGeogebraCommonUtilMyMathExact_MyDecimal_class_()];
  self->x_double_ = [IOSObjectArray newArrayWithLength:n type:OrgGeogebraCommonUtilMyMathExact_MyDecimal_class_()];
  for (jint i = 0; i < n; i++) {
    *IOSDoubleArray_GetRef(self->x_, i) = IOSDoubleArray_Get(nil_chk(x), i);
    (void) IOSObjectArray_Set(self->x_full_, i, new_OrgGeogebraCommonUtilMyMathExact_MyDecimal_initWithInt_withDouble_(self->fullScale1_, IOSDoubleArray_Get(x, i)));
  }
  self->rho_ = 2;
  self->tau_ = 1.5;
  self->gamma_ = 1 / JavaLangMath_sqrtWithDouble_(1 / self->tau_ / self->tau_ - 1 / self->rho_ / self->rho_);
  [self initialize_full];
  self->b_ = new_OrgGeogebraCommonUtilMyMathExact_MyDecimal_initWithInt_(self->lessScale1_);
  self->l_ = new_OrgGeogebraCommonUtilMyMathExact_MyDecimal_initWithInt_(self->lessScale1_);
  self->d_ = new_OrgGeogebraCommonUtilMyMathExact_MyDecimal_initWithInt_(self->lessScale1_);
  ...
  while (iterCount < iterBound) {
    ...
    if (self->r_ < n - 2) {
      (void) [((OrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix *) nil_chk(self->H_)) getEntryWithInt:self->r_ withInt:self->r_];
      self->b_ = [self->H_ getEntryWithInt:self->r_ + 1 withInt:self->r_];
      self->l_ = [self->H_ getEntryWithInt:self->r_ + 1 withInt:self->r_ + 1];
      self->d_ = [((OrgGeogebraCommonUtilMyMathExact_MyDecimal *) nil_chk([((OrgGeogebraCommonUtilMyMathExact_MyDecimal *) nil_chk([((OrgGeogebraCommonUtilMyMathExact_MyDecimal *) nil_chk(self->b_)) multiplyWithOrgGeogebraCommonUtilMyMathExact_MyDecimal:self->b_])) addWithOrgGeogebraCommonUtilMyMathExact_MyDecimal:[((OrgGeogebraCommonUtilMyMathExact_MyDecimal *) nil_chk(self->l_)) multiplyWithOrgGeogebraCommonUtilMyMathExact_MyDecimal:self->l_]])) sqrt];
    }
    OrgGeogebraCommonUtilMyMathExact_MyDecimal *temp2 = new_OrgGeogebraCommonUtilMyMathExact_MyDecimal_initWithOrgGeogebraCommonUtilMyMathExact_MyDecimal_([((OrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix *) nil_chk(self->xB_)) getEntryWithInt:0 withInt:self->r_]);
    ...
    for (jint j = 0; j < n; j++) {
      ...
      if ([((OrgGeogebraCommonUtilMyMathExact_MyDecimal *) nil_chk([self->xB_ getEntryWithInt:0 withInt:j])) signum] == 0 || [((JavaMathBigDecimal *) nil_chk([((OrgGeogebraCommonUtilMyMathExact_MyDecimal *) nil_chk([self->xB_ getEntryWithInt:0 withInt:j])) abs])) doubleValue] < sumBCol * err) {
        relationFound = YES;
        OrgGeogebraCommonKernelCasAlgoSurdText_IntRelationFinder_IntRelation *m = new_OrgGeogebraCommonKernelCasAlgoSurdText_IntRelationFinder_IntRelation_initWithOrgGeogebraCommonKernelCasAlgoSurdText_IntRelationFinder_withInt_withOrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix_withOrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix_withDouble_(self, n, self->B_, self->xB_, err / maxxB);
        [self->result_ addWithId:m];
        break;
      }
    }
...
void OrgGeogebraCommonKernelCasAlgoSurdText_IntRelationFinder_hermiteReduction(OrgGeogebraCommonKernelCasAlgoSurdText_IntRelationFinder *self) {
  self->D_ = [((OrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix *) nil_chk(self->I_)) copy__];
...
- (jint)compareToWithId:(OrgGeogebraCommonKernelCasAlgoSurdText_IntRelationFinder_IntRelation *)m2 {
  (void) check_class_cast(m2, [OrgGeogebraCommonKernelCasAlgoSurdText_IntRelationFinder_IntRelation class]);
...
void OrgGeogebraCommonKernelCasAlgoSurdText_IntRelationFinder_IntRelation_initWithOrgGeogebraCommonKernelCasAlgoSurdText_IntRelationFinder_withInt_withOrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix_withOrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix_withDouble_(OrgGeogebraCommonKernelCasAlgoSurdText_IntRelationFinder_IntRelation *self, OrgGeogebraCommonKernelCasAlgoSurdText_IntRelationFinder *outer$, jint n, OrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix *B, OrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix *xB, jdouble sig) {
  ...
  if (n == 0) return;
  self->size_ = n;
  self->B1_ = [((OrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix *) nil_chk(B)) copy__];
  self->xB1_ = [((OrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix *) nil_chk(xB)) copy__];
  self->sig_ = sig;
  self->orthoIndices_ = [IOSIntArray newArrayWithLength:n];
  self->nilDim_ = 0;
  for (jint j = 0; j < n; j++) {
    jdouble sumBCol = 0;
    jdouble maxxB = 0;
  ...
  if (self->nilDim_ > 0) {
    self->B_sol_ = new_OrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix_initWithInt_withInt_withInt_([B getScale], self->size_, self->nilDim_);
  }
  else {
    self->B_sol_ = nil;
  }
  if (self->nilDim_ < self->size_) {
    self->B_rest_ = new_OrgGeogebraCommonUtilMyMathExact_MyDecimalMatrix_initWithInt_withInt_withInt_([B getScale], self->size_, self->size_ - self->nilDim_);
  }
  else {
    self->B_rest_ = nil;
  }
...
- (void)computeConstantWithDouble:(jdouble)number {
  numList_ = [IOSDoubleArray newArrayWithLength:numOfConsts_ + 2];
  ...
  *IOSDoubleArray_GetRef(numList_, numOfConsts_ + 1) = number;
  coeffs_ = [this$0_ mPSLQWithInt:numOfConsts_ + 2 withDoubleArray:numList_ withDouble:err_ withInt:coeffBound_];
  if (coeffs_ == nil) {
    return;
  }
  ...
  numOfPenalties_ = 7;
  penalties_ = [IOSIntArray newArrayWithDimensions:2 lengths:(jint[]){ numOfPenalties_, s_ }];
  for (jint j = 0; j < s_; j++) {
  ...
  bestRelation_ = [IOSIntArray newArrayWithLength:numOfConsts_ + 2];
  ...
  (void) [((JavaLangStringBuilder *) nil_chk(formalSolution_)) appendWithNSString:@"("];
  ...
  (void) [formalSolution_ appendWithNSString:@"+"];
  (void) [formalSolution_ appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(this$0_->kernel_)) formatWithDouble:IOSIntArray_Get(bestRelation_, numOfConsts_) withOrgGeogebraCommonKernelStringTemplate:tpl_]];
  (void) [formalSolution_ appendWithNSString:@")/("];
  (void) [formalSolution_ appendWithNSString:[this$0_->kernel_ formatWithDouble:-IOSIntArray_Get(bestRelation_, numOfConsts_ + 1) withOrgGeogebraCommonKernelStringTemplate:tpl_]];
  (void) [formalSolution_ appendWithNSString:@")"];
  return;
}
...
void OrgGeogebraCommonKernelCasAlgoSurdText_AlgebraicFit_initWithOrgGeogebraCommonKernelCasAlgoSurdText_withNSStringArray_withDoubleArray_withOrgGeogebraCommonKernelCasAlgoSurdText_AlgebraicFittingTypeEnum_withOrgGeogebraCommonKernelStringTemplate_(OrgGeogebraCommonKernelCasAlgoSurdText_AlgebraicFit *self, OrgGeogebraCommonKernelCasAlgoSurdText *outer$, IOSObjectArray *constStrings, IOSDoubleArray *constValues, OrgGeogebraCommonKernelCasAlgoSurdText_AlgebraicFittingTypeEnum *aft, OrgGeogebraCommonKernelStringTemplate *tpl) {
  ...
  if (constValues != nil) {
    self->constValues_ = [IOSDoubleArray newArrayWithLength:constValues->size_];
    for (jint i = 0; i < constValues->size_; i++) {
      *IOSDoubleArray_GetRef(self->constValues_, i) = IOSDoubleArray_Get(constValues, i);
    }
  }
  if (constStrings != nil) {
    self->constStrings_ = [IOSObjectArray newArrayWithLength:constStrings->size_ type:NSString_class_()];
    for (jint i = 0; i < constStrings->size_; i++) {
      (void) IOSObjectArray_Set(self->constStrings_, i, IOSObjectArray_Get(constStrings, i));
    }
  }
  self->aft_ = aft;
  self->tpl_ = tpl;
  (void) [outer$ getKernel];
  (void) [outer$ getKernel];
  ...
  self->formalSolution_ = new_JavaLangStringBuilder_init();
...
void OrgGeogebraCommonKernelCasAlgoSurdText_AlgebraicFit_computeQuadraticWithDouble_(OrgGeogebraCommonKernelCasAlgoSurdText_AlgebraicFit *self, jdouble number) {
  self->num1_ = number;
  self->numList_ = [IOSDoubleArray newArrayWithLength:(1 + self->numOfConsts_) * 3];
  jdouble temp;
  ...
  self->coeffs_ = [self->this$0_ mPSLQWithInt:(self->numOfConsts_ + 1) * 3 withDoubleArray:self->numList_ withDouble:self->err_ withInt:self->coeffBound_];
  ...
  IOSObjectArray *termCount = [IOSIntArray newArrayWithDimensions:2 lengths:(jint[]){ self->numOfConsts_ + 1, self->s_ }];
  IOSObjectArray *termMax = [IOSIntArray newArrayWithDimensions:2 lengths:(jint[]){ self->numOfConsts_ + 1, self->s_ }];
  IOSObjectArray *w = [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ 4, self->s_ }];
  self->numOfPenalties_ = 7;
  self->penalties_ = [IOSIntArray newArrayWithDimensions:2 lengths:(jint[]){ self->numOfPenalties_, self->s_ }];
  for (jint j = 0; j < self->s_; j++) {
    ...
    IOSIntArray *wj = [IOSIntArray newArrayWithLength:(self->numOfConsts_ + 1) * 3];
  ...
  self->bestRelation_ = [IOSIntArray newArrayWithLength:(1 + self->numOfConsts_) * 3];
  ...
  if (isAZero && isBZero && isCZero) {
    ...
    if (isBZero) {
      ...
      JavaLangStringBuilder *AString = new_JavaLangStringBuilder_init();
      JavaLangStringBuilder *BString = new_JavaLangStringBuilder_init();
      (void) [AString appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(self->this$0_->kernel_)) formatWithDouble:IOSIntArray_Get(self->bestRelation_, self->numOfConsts_ * 3) withOrgGeogebraCommonKernelStringTemplate:self->tpl_]];
      if (!isARational) {
        (void) [AString appendWithNSString:@"+"];
      ...
      (void) [BString appendWithNSString:[self->this$0_->kernel_ formatWithDouble:IOSIntArray_Get(self->bestRelation_, self->numOfConsts_ * 3 + 1) withOrgGeogebraCommonKernelStringTemplate:self->tpl_]];
      if (!isBRational) {
        (void) [BString appendWithNSString:@"+"];
      ...
      (void) [((JavaLangStringBuilder *) nil_chk(self->formalSolution_)) appendWithNSString:@"-("];
      (void) [self->formalSolution_ appendWithNSString:[AString description]];
      (void) [self->formalSolution_ appendWithNSString:@")/("];
      (void) [self->formalSolution_ appendWithNSString:[BString description]];
      (void) [self->formalSolution_ appendWithNSString:@")"];
    }
  }
  else {
    ...
    JavaLangStringBuilder *AString = new_JavaLangStringBuilder_init();
    JavaLangStringBuilder *BString = new_JavaLangStringBuilder_init();
    JavaLangStringBuilder *CString = new_JavaLangStringBuilder_init();
    (void) [AString appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(self->this$0_->kernel_)) formatWithDouble:IOSIntArray_Get(self->bestRelation_, self->numOfConsts_ * 3) withOrgGeogebraCommonKernelStringTemplate:self->tpl_]];
    if (!isARational) {
      (void) [AString appendWithNSString:@"+"];
      [self->this$0_ appendCombinationWithJavaLangStringBuilder:AString withInt:self->numOfConsts_ withNSStringArray:self->constStrings_ withIntArray:self->bestRelation_ withInt:0 withInt:3 withOrgGeogebraCommonKernelStringTemplate:self->tpl_];
    ...
    (void) [CString appendWithNSString:[self->this$0_->kernel_ formatWithDouble:IOSIntArray_Get(self->bestRelation_, self->numOfConsts_ * 3 + 2) withOrgGeogebraCommonKernelStringTemplate:self->tpl_]];
    if (!isCRational) {
      (void) [CString appendWithNSString:@"+"];
    ...
    if (!OrgGeogebraCommonKernelKernel_isZeroWithDouble_(discr)) {
      ...
      else (void) [self->formalSolution_ appendWithNSString:@"-"];
      (void) [self->formalSolution_ appendWithNSString:@"sqrt("];
      (void) [self->formalSolution_ appendWithNSString:@"("];
      (void) [self->formalSolution_ appendWithNSString:[BString description]];
      (void) [self->formalSolution_ appendWithNSString:@")^2"];
      (void) [self->formalSolution_ appendWithNSString:@"-4*("];
      (void) [self->formalSolution_ appendWithNSString:[CString description]];
      (void) [self->formalSolution_ appendWithNSString:@")*("];
      (void) [self->formalSolution_ appendWithNSString:[AString description]];
      (void) [self->formalSolution_ appendWithNSString:@")"];
      (void) [self->formalSolution_ appendWithNSString:@")"];
...
void OrgGeogebraCommonKernelCasAlgoSurdText_AlgebraicFit_computeRationalNumberWithDouble_(OrgGeogebraCommonKernelCasAlgoSurdText_AlgebraicFit *self, jdouble number) {
  self->numOfConsts_ = 0;
  self->numList_ = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ number, 1 } count:2];
  self->coeffs_ = [self->this$0_ mPSLQWithInt:2 withDoubleArray:self->numList_ withDouble:self->err_ withInt:self->coeffBound_];
  ...
  self->bestIndex_ = OrgGeogebraCommonKernelCasAlgoSurdText_AlgebraicFit_leastPenaltyIndex(self);
  self->bestRelation_ = [IOSIntArray newArrayWithLength:self->numOfConsts_ + 2];
  ...
  (void) [((JavaLangStringBuilder *) nil_chk(self->formalSolution_)) appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(self->this$0_->kernel_)) formatWithDouble:-IOSIntArray_Get(self->bestRelation_, 1) withOrgGeogebraCommonKernelStringTemplate:self->tpl_]];
  (void) [self->formalSolution_ appendWithNSString:@"/("];
  (void) [self->formalSolution_ appendWithNSString:[self->this$0_->kernel_ formatWithDouble:IOSIntArray_Get(self->bestRelation_, 0) withOrgGeogebraCommonKernelStringTemplate:self->tpl_]];
  (void) [self->formalSolution_ appendWithNSString:@")"];
}
...
jint OrgGeogebraCommonKernelCasAlgoSurdText_AlgebraicFit_leastPenaltyIndex(OrgGeogebraCommonKernelCasAlgoSurdText_AlgebraicFit *self) {
  IOSBooleanArray *candidates = [IOSBooleanArray newArrayWithLength:self->s_];
  jint bestIndex1 = -1;
  for (jint j = 0; j < self->s_; j++) {
