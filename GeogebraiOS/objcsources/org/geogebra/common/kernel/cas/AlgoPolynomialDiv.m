...
void OrgGeogebraCommonKernelCasAlgoPolynomialDiv_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoFunction_withOrgGeogebraCommonKernelGeosGeoFunction_(OrgGeogebraCommonKernelCasAlgoPolynomialDiv *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelGeosGeoFunction *f1, OrgGeogebraCommonKernelGeosGeoFunction *f2) {
  ...
  OrgGeogebraCommonKernelCasAlgoPolynomialDiv_setAndConsume_sb_(self, new_JavaLangStringBuilder_init());
  OrgGeogebraCommonKernelCasAlgoPolynomialDiv_setAndConsume_arbconst_(self, new_OrgGeogebraCommonKernelArithmeticMyArbitraryConstant_initWithOrgGeogebraCommonKernelAlgosConstructionElement_(self));
  OrgGeogebraCommonKernelCasAlgoPolynomialDiv_set_f1_(self, f1);
  OrgGeogebraCommonKernelCasAlgoPolynomialDiv_set_f2_(self, f2);
  OrgGeogebraCommonKernelCasAlgoPolynomialDiv_setAndConsume_g_(self, new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  OrgGeogebraCommonKernelCasAlgoPolynomialDiv_compute(self);
