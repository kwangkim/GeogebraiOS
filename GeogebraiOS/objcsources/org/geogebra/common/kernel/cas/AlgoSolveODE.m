...
- (void)setInputOutput {
  input_ = [IOSObjectArray newArrayWithLength:f1_ == nil ? 5 : 6 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
  jint i = 0;
  (void) IOSObjectArray_Set(input_, i++, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(f0_, [OrgGeogebraCommonKernelGeosGeoElement class]));
  if (f1_ != nil) (void) IOSObjectArray_Set(input_, i++, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(f1_, [OrgGeogebraCommonKernelGeosGeoElement class]));
  (void) IOSObjectArray_Set(input_, i++, x_);
  (void) IOSObjectArray_Set(input_, i++, y_);
  (void) IOSObjectArray_Set(input_, i++, end_);
  (void) IOSObjectArray_Set(input_, i++, step_);
...
void OrgGeogebraCommonKernelCasAlgoSolveODE_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticFunctionalNVar_withOrgGeogebraCommonKernelArithmeticFunctionalNVar_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelGeosGeoNumeric_(OrgGeogebraCommonKernelCasAlgoSolveODE *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, id<OrgGeogebraCommonKernelArithmeticFunctionalNVar> f0, id<OrgGeogebraCommonKernelArithmeticFunctionalNVar> f1, OrgGeogebraCommonKernelGeosGeoNumeric *x, OrgGeogebraCommonKernelGeosGeoNumeric *y, OrgGeogebraCommonKernelGeosGeoNumeric *end, OrgGeogebraCommonKernelGeosGeoNumeric *step) {
  ...
  self->stepHandler_ = new_OrgGeogebraCommonKernelCasAlgoSolveODE_$1_initWithOrgGeogebraCommonKernelCasAlgoSolveODE_(self);
  self->f0_ = f0;
  self->f1_ = f1;
  self->x_ = x;
  self->y_ = y;
  ...
  self->step_ = step;
  if (f1 == nil) {
    self->numAlgo_ = new_OrgGeogebraCommonKernelAlgosAlgoNumerator_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticFunctionalNVar_(cons, f0);
    self->denAlgo_ = new_OrgGeogebraCommonKernelAlgosAlgoDenominator_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticFunctionalNVar_(cons, f0);
...
void OrgGeogebraCommonKernelCasAlgoSolveODE_compute(OrgGeogebraCommonKernelCasAlgoSolveODE *self) {
  ...
  if (!self->quotient_) {
    ode = new_OrgGeogebraCommonKernelCasAlgoSolveODE_ODE_initWithOrgGeogebraCommonKernelArithmeticFunctionalNVar_(self->f0_);
  }
  else {
    ode = new_OrgGeogebraCommonKernelCasAlgoSolveODE_ODE2_initWithOrgGeogebraCommonKernelArithmeticFunctionalNVar_withOrgGeogebraCommonKernelArithmeticFunctionalNVar_(self->num_, self->den_);
  }
  ...
  IOSDoubleArray *yy = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ [self->y_ getDouble] } count:1];
  IOSDoubleArray *yy2 = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ [self->x_ getDouble], [self->y_ getDouble] } count:2];
  @try {
...
- (void)handleStepWithOrgApacheCommonsMathOdeSamplingStepInterpolator:(id<OrgApacheCommonsMathOdeSamplingStepInterpolator>)interpolator
  ...
  if (!this$0_->quotient_) {
    ...
    [((JavaUtilArrayList *) nil_chk(this$0_->al_)) addWithId:new_OrgGeogebraCommonKernelMyPoint_initWithDouble_withDouble_withBoolean_(IOSDoubleArray_Get(nil_chk(y1), 0), IOSDoubleArray_Get(y1, 1), YES)];
  }
}
