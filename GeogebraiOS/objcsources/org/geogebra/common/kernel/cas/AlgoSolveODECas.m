...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/cas/AlgoSolveODECas.java
//
...
- (void)setInputOutput {
  if (pt_ == nil) {
    OrgGeogebraCommonKernelAlgosAlgoElement_setAndConsume_input_(self, [IOSObjectArray newArrayWithObjects:(id[]){ [((id<OrgGeogebraCommonKernelGeosCasEvaluableFunction>) nil_chk(f_)) toGeoElement] } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()]);
  }
  else {
    OrgGeogebraCommonKernelAlgosAlgoElement_setAndConsume_input_(self, [IOSObjectArray newArrayWithObjects:(id[]){ [((id<OrgGeogebraCommonKernelGeosCasEvaluableFunction>) nil_chk(f_)) toGeoElement], [pt_ toGeoElement] } count:2 type:OrgGeogebraCommonKernelGeosGeoElement_class_()]);
  }
...
- (void)compute {
  ...
  if (pt_ != nil) {
    ...
    [sb appendWithNSString:[pt_ toValueStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_prefixedDefault_()]];
  }
  [sb appendWithNSString:@")"];
  ...
  if (![((NSString *) nil_chk(casString)) isEqual:oldCASstring_]) {
    ...
    OrgGeogebraCommonKernelCasAlgoSolveODECas_set_oldCASstring_(self, casString);
  }
...
void OrgGeogebraCommonKernelCasAlgoSolveODECas_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosCasEvaluableFunction_(OrgGeogebraCommonKernelCasAlgoSolveODECas *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, id<OrgGeogebraCommonKernelGeosCasEvaluableFunction> f) {
  ...
  OrgGeogebraCommonKernelCasAlgoSolveODECas_setAndConsume_arbconst_(self, new_OrgGeogebraCommonKernelArithmeticMyArbitraryConstant_initWithOrgGeogebraCommonKernelAlgosConstructionElement_(self));
  [((OrgGeogebraCommonKernelConstruction *) nil_chk(cons)) addCASAlgoWithOrgGeogebraCommonKernelAlgosAlgoElement:self];
  OrgGeogebraCommonKernelCasAlgoSolveODECas_set_f_(self, f);
  [self compute];
  [self setInputOutput];
...
void OrgGeogebraCommonKernelCasAlgoSolveODECas_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosCasEvaluableFunction_withOrgGeogebraCommonKernelKernelNDGeoPointND_(OrgGeogebraCommonKernelCasAlgoSolveODECas *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, id<OrgGeogebraCommonKernelGeosCasEvaluableFunction> f, id<OrgGeogebraCommonKernelKernelNDGeoPointND> pt) {
  ...
  [((OrgGeogebraCommonKernelConstruction *) nil_chk(cons)) addCASAlgoWithOrgGeogebraCommonKernelAlgosAlgoElement:self];
  OrgGeogebraCommonKernelCasAlgoSolveODECas_set_f_(self, f);
  OrgGeogebraCommonKernelCasAlgoSolveODECas_set_pt_(self, pt);
  [self compute];
  [self setInputOutput];
  [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(self->g_)) setLabelWithNSString:label];
}
...
void OrgGeogebraCommonKernelCasAlgoSolveODECas_updateGWithNSString_(OrgGeogebraCommonKernelCasAlgoSolveODECas *self, NSString *casString) {
  ...
  @try {
    ...
    if (res != nil && res->size_ > 0) {
      if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(IOSObjectArray_Get(res, 0))) isGeoFunctionable]) {
        IOSObjectArray_Set(res, 0, [((id<OrgGeogebraCommonKernelGeosGeoFunctionable>) nil_chk(((id<OrgGeogebraCommonKernelGeosGeoFunctionable>) check_protocol_cast(IOSObjectArray_Get(res, 0), @protocol(OrgGeogebraCommonKernelGeosGeoFunctionable))))) getGeoFunction]);
      }
      if (self->g_ == nil) {
        OrgGeogebraCommonKernelCasAlgoSolveODECas_set_g_(self, IOSObjectArray_Get(res, 0));
      }
      else {
  ...
  if (!ok) {
    if (self->g_ != nil) {
      ...
      OrgGeogebraCommonKernelCasAlgoSolveODECas_setAndConsume_g_(self, new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_(self->cons_));
    }
  }
}
