...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/cas/AlgoConicCoefficients.java
//
...
void OrgGeogebraCommonKernelCasAlgoConicCoefficients_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoConic_(OrgGeogebraCommonKernelCasAlgoConicCoefficients *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelGeosGeoConic *c) {
  ...
  OrgGeogebraCommonKernelCasAlgoConicCoefficients_set_c_(self, c);
  OrgGeogebraCommonKernelCasAlgoConicCoefficients_setAndConsume_g_(self, new_OrgGeogebraCommonKernelGeosGeoList_initWithOrgGeogebraCommonKernelConstruction_(cons));
  IOSDoubleArray *matrix = [((OrgGeogebraCommonKernelGeosGeoConic *) nil_chk(c)) getFlatMatrix];
  [self->g_ addWithOrgGeogebraCommonKernelGeosGeoElement:[new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons, IOSDoubleArray_Get(nil_chk(matrix), 0)) autorelease]];
  [self->g_ addWithOrgGeogebraCommonKernelGeosGeoElement:[new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons, IOSDoubleArray_Get(matrix, 1)) autorelease]];
  [self->g_ addWithOrgGeogebraCommonKernelGeosGeoElement:[new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons, IOSDoubleArray_Get(matrix, 2)) autorelease]];
  [self->g_ addWithOrgGeogebraCommonKernelGeosGeoElement:[new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons, IOSDoubleArray_Get(matrix, 3) * 2) autorelease]];
  [self->g_ addWithOrgGeogebraCommonKernelGeosGeoElement:[new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons, IOSDoubleArray_Get(matrix, 4) * 2) autorelease]];
  [self->g_ addWithOrgGeogebraCommonKernelGeosGeoElement:[new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons, IOSDoubleArray_Get(matrix, 5) * 2) autorelease]];
  [self setInputOutput];
