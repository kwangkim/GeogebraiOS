...
- (void)setInputOutput {
  if (evaluate_ == nil) {
    ...
    (void) IOSObjectArray_Set(input_, 1, ageo_);
    (void) IOSObjectArray_Set(input_, 2, bgeo_);
    (void) IOSObjectArray_Set(input_, 3, evaluate_);
  }
...
- (void)refreshCASResults {
  OrgGeogebraCommonKernelCasAlgoIntegral *algoInt = new_OrgGeogebraCommonKernelCasAlgoIntegral_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosCasEvaluableFunction_withOrgGeogebraCommonKernelGeosGeoNumeric_withBoolean_(cons_, f_, nil, NO);
  symbIntegral_ = (OrgGeogebraCommonKernelGeosGeoFunction *) check_class_cast([algoInt getResult], [OrgGeogebraCommonKernelGeosGeoFunction class]);
...
void OrgGeogebraCommonKernelCasAlgoIntegralDefinite_initWithOrgGeogebraCommonKernelGeosGeoFunction_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelGeosGeoBoolean_(OrgGeogebraCommonKernelCasAlgoIntegralDefinite *self, OrgGeogebraCommonKernelGeosGeoFunction *f, id<OrgGeogebraCommonKernelArithmeticNumberValue> a, id<OrgGeogebraCommonKernelArithmeticNumberValue> b, OrgGeogebraCommonKernelGeosGeoBoolean *evaluate) {
  (void) OrgGeogebraCommonKernelCasAlgoUsingTempCASalgo_initWithOrgGeogebraCommonKernelConstruction_withBoolean_(self, [((OrgGeogebraCommonKernelGeosGeoFunction *) nil_chk(f)) getConstruction], NO);
  self->f_ = f;
  self->a_ = a;
  self->b_ = b;
  self->evaluate_ = evaluate;
...
void OrgGeogebraCommonKernelCasAlgoIntegralDefinite_computeSpecial(OrgGeogebraCommonKernelCasAlgoIntegralDefinite *self) {
  ...
  (void) [sb appendWithNSString:@"evalf(integrate("];
  (void) [sb appendWithNSString:[((OrgGeogebraCommonKernelGeosGeoFunction *) nil_chk(self->f_)) toValueStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_giacTemplate_()]];
  (void) [sb appendWithNSString:@","];
  (void) [sb appendWithNSString:[self->f_ getVarStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]];
  (void) [sb appendWithNSString:@","];
  (void) [sb appendWithNSString:[((id<OrgGeogebraCommonKernelArithmeticNumberValue>) nil_chk(self->a_)) toValueStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_maxPrecision13_()]];
  (void) [sb appendWithNSString:@","];
  (void) [sb appendWithNSString:[((id<OrgGeogebraCommonKernelArithmeticNumberValue>) nil_chk(self->b_)) toValueStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_maxPrecision13_()]];
  (void) [sb appendWithNSString:@"))"];
  NSString *result;
  @try {
...
jdouble OrgGeogebraCommonKernelCasAlgoIntegralDefinite_doAdaptiveGaussQuadWithOrgGeogebraCommonKernelRootsRealRootFunction_withDouble_withDouble_(id<OrgGeogebraCommonKernelRootsRealRootFunction> fun, jdouble a, jdouble b) {
  ...
  if (OrgGeogebraCommonKernelCasAlgoIntegralDefinite_firstGauss_ == nil) {
    OrgGeogebraCommonKernelCasAlgoIntegralDefinite_firstGauss_ = new_OrgApacheCommonsMathAnalysisIntegrationLegendreGaussIntegrator_initWithInt_withInt_(OrgGeogebraCommonKernelCasAlgoIntegralDefinite_FIRST_ORDER, OrgGeogebraCommonKernelCasAlgoIntegralDefinite_MAX_ITER);
    OrgGeogebraCommonKernelCasAlgoIntegralDefinite_secondGauss_ = new_OrgApacheCommonsMathAnalysisIntegrationLegendreGaussIntegrator_initWithInt_withInt_(OrgGeogebraCommonKernelCasAlgoIntegralDefinite_SECOND_ORDER, OrgGeogebraCommonKernelCasAlgoIntegralDefinite_MAX_ITER);
  }
  jdouble firstSum = 0;
  jdouble secondSum = 0;
  jboolean error = NO;
  @try {
    firstSum = [((OrgApacheCommonsMathAnalysisIntegrationLegendreGaussIntegrator *) nil_chk(OrgGeogebraCommonKernelCasAlgoIntegralDefinite_firstGauss_)) integrateWithOrgApacheCommonsMathAnalysisUnivariateRealFunction:(new_OrgGeogebraCommonKernelRootsRealRootAdapter_initWithOrgGeogebraCommonKernelRootsRealRootFunction_(fun)) withDouble:a withDouble:b];
