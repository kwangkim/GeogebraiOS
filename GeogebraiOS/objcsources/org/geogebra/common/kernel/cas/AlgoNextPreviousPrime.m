...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/javasources/org/geogebra/common/kernel/cas/AlgoNextPreviousPrime.java
//
...
- (void)setInputOutput {
  ...
  OrgGeogebraCommonKernelAlgosAlgoElement_setAndConsume_input_(self, [IOSObjectArray newArrayWithObjects:(id[]){ [((id<OrgGeogebraCommonKernelArithmeticNumberValue>) nil_chk(init__)) toGeoElement] } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()]);
...
- (void)compute {
  ...
  [sb appendWithNSString:[init__ toValueStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_maxPrecision_()]];
...
void OrgGeogebraCommonKernelCasAlgoNextPreviousPrime_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticNumberValue_withBoolean_(OrgGeogebraCommonKernelCasAlgoNextPreviousPrime *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, id<OrgGeogebraCommonKernelArithmeticNumberValue> init_, jboolean next) {
  ...
  OrgGeogebraCommonKernelCasAlgoNextPreviousPrime_setAndConsume_arbconst_(self, new_OrgGeogebraCommonKernelArithmeticMyArbitraryConstant_initWithOrgGeogebraCommonKernelAlgosConstructionElement_(self));
  OrgGeogebraCommonKernelCasAlgoNextPreviousPrime_set_init__(self, init_);
  self->next_ = next;
  OrgGeogebraCommonKernelCasAlgoNextPreviousPrime_setAndConsume_result_(self, new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  [self compute];
