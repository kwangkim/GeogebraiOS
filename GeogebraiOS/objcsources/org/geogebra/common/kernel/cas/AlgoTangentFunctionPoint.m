...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/cas/AlgoTangentFunctionPoint.java
//
...
void OrgGeogebraCommonKernelCasAlgoTangentFunctionPoint_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelGeosGeoFunction_(OrgGeogebraCommonKernelCasAlgoTangentFunctionPoint *self, OrgGeogebraCommonKernelConstruction *cons, id<OrgGeogebraCommonKernelKernelNDGeoPointND> P, OrgGeogebraCommonKernelGeosGeoFunction *f) {
  ...
  OrgGeogebraCommonKernelCasAlgoTangentFunctionPoint_set_P_(self, P);
  OrgGeogebraCommonKernelCasAlgoTangentFunctionPoint_set_f_(self, f);
  OrgGeogebraCommonKernelCasAlgoTangentFunctionPoint_setAndConsume_tangent_(self, new_OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelConstruction_(cons));
  ...
  if (self->pointOnFunction_) OrgGeogebraCommonKernelCasAlgoTangentFunctionPoint_set_T_(self, (OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast(P, [OrgGeogebraCommonKernelGeosGeoPoint class]));
  else OrgGeogebraCommonKernelCasAlgoTangentFunctionPoint_setAndConsume_T_(self, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons));
  ...
  if ([[((OrgGeogebraCommonKernelGeosGeoFunction *) nil_chk(f)) getParentAlgorithm] isKindOfClass:[OrgGeogebraCommonKernelAlgosAlgoFunctionFreehand class]]) {
    self->freehand_ = YES;
    OrgGeogebraCommonKernelCasAlgoTangentFunctionPoint_set_freehandAlgo_(self, (OrgGeogebraCommonKernelAlgosAlgoFunctionFreehand *) check_class_cast([f getParentAlgorithm], [OrgGeogebraCommonKernelAlgosAlgoFunctionFreehand class]));
    OrgGeogebraCommonKernelCasAlgoTangentFunctionPoint_set_freehandList_(self, [((OrgGeogebraCommonKernelAlgosAlgoFunctionFreehand *) nil_chk(self->freehandAlgo_)) getList]);
    OrgGeogebraCommonKernelCasAlgoTangentFunctionPoint_setAndConsume_geoList_(self, new_OrgGeogebraCommonKernelGeosGeoList_initWithOrgGeogebraCommonKernelConstruction_(cons));
    jint steps = 10;
    OrgGeogebraCommonKernelCasAlgoTangentFunctionPoint_setAndConsume_points_(self, [IOSObjectArray newArrayWithLength:steps type:OrgGeogebraCommonKernelGeosGeoPoint_class_()]);
    OrgGeogebraCommonKernelCasAlgoTangentFunctionPoint_setAndConsume_algoFitPoly_(self, new_OrgGeogebraCommonKernelStatisticsAlgoFitPoly_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons, self->geoList_, [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_([((OrgGeogebraCommonKernelConstruction *) nil_chk(cons)) getKernel], 5) autorelease]));
    [cons removeFromConstructionListWithOrgGeogebraCommonKernelAlgosConstructionElement:self->algoFitPoly_];
  }
  else {
    OrgGeogebraCommonKernelCasAlgoTangentFunctionPoint_setAndConsume_algo_(self, new_OrgGeogebraCommonKernelCasAlgoDerivative_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosCasEvaluableFunction_withBoolean_(cons, f, YES));
    OrgGeogebraCommonKernelCasAlgoTangentFunctionPoint_set_deriv_(self, (OrgGeogebraCommonKernelGeosGeoFunction *) check_class_cast([self->algo_ getResult], [OrgGeogebraCommonKernelGeosGeoFunction class]));
...
void OrgGeogebraCommonKernelCasAlgoTangentFunctionPoint_compute(OrgGeogebraCommonKernelCasAlgoTangentFunctionPoint *self) {
  ...
  if (self->freehand_) {
    ...
    for (jint i = 0; i < self->points_->size_; i++) {
      IOSObjectArray_Set(self->points_, i, OrgGeogebraCommonKernelCasAlgoTangentFunctionPoint_newPointWithDouble_(self, a + step * (i - steps / 2) + offset));
...
OrgGeogebraCommonKernelGeosGeoPoint *OrgGeogebraCommonKernelCasAlgoTangentFunctionPoint_newPointWithDouble_(OrgGeogebraCommonKernelCasAlgoTangentFunctionPoint *self, jdouble a) {
  return [new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withDouble_withDouble_withDouble_(self->cons_, a, [((OrgGeogebraCommonKernelGeosGeoFunction *) nil_chk(self->f_)) evaluateWithDouble:a], 1) autorelease];
}
