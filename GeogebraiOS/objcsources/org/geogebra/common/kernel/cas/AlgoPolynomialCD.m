...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/kernel/cas/AlgoPolynomialCD.java
//
...
void OrgGeogebraCommonKernelCasAlgoPolynomialCD_compute(OrgGeogebraCommonKernelCasAlgoPolynomialCD *self) {
  ...
  @try {
    ...
    (void) [self->sb_ appendWithNSString:@"CommonDenominator("];
