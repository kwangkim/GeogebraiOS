...
void OrgGeogebraCommonKernelCasAlgoParametricDerivative_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoCurveCartesian_(OrgGeogebraCommonKernelCasAlgoParametricDerivative *self, OrgGeogebraCommonKernelConstruction *cons, OrgGeogebraCommonKernelGeosGeoCurveCartesian *curve) {
  ...
  OrgGeogebraCommonKernelCasAlgoParametricDerivative_set_curve_(self, curve);
  OrgGeogebraCommonKernelCasAlgoParametricDerivative_set_paramDeriv_(self, (OrgGeogebraCommonKernelGeosGeoCurveCartesian *) check_class_cast([((OrgGeogebraCommonKernelGeosGeoCurveCartesian *) nil_chk(curve)) copyInternalWithOrgGeogebraCommonKernelConstruction:cons], [OrgGeogebraCommonKernelGeosGeoCurveCartesian class]));
  [self setInputOutput];
  OrgGeogebraCommonKernelCasAlgoParametricDerivative_compute(self);
}
