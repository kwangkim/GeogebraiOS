...
- (OrgGeogebraCommonKernelArithmeticPolyFunction *)getDerivative {
  if (derivative_ == nil) {
    OrgGeogebraCommonKernelArithmeticPolyFunction_set_derivative_(self, OrgGeogebraCommonKernelArithmeticPolyFunction_buildDerivative(self));
  }
  return derivative_;
}
...
- (OrgGeogebraCommonKernelArithmeticPolyFunction *)getIntegral {
  if (integral_ == nil) {
    OrgGeogebraCommonKernelArithmeticPolyFunction_set_integral_(self, OrgGeogebraCommonKernelArithmeticPolyFunction_buildIntegral(self));
  }
  return integral_;
}
...
- (OrgGeogebraCommonKernelArithmeticFunction *)getFunctionWithOrgGeogebraCommonKernelKernel:(OrgGeogebraCommonKernelKernel *)kernel
  ...
  OrgGeogebraCommonKernelArithmeticExpressionNode *fvEn = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel, fv) autorelease];
  if (degree_ == 0) {
...
void OrgGeogebraCommonKernelArithmeticPolyFunction_initWithInt_(OrgGeogebraCommonKernelArithmeticPolyFunction *self, jint degree) {
  NSObject_init(self);
  self->degree_ = degree;
  OrgGeogebraCommonKernelArithmeticPolyFunction_setAndConsume_coeffs_(self, [IOSDoubleArray newArrayWithLength:degree + 1]);
}
...
void OrgGeogebraCommonKernelArithmeticPolyFunction_initWithDoubleArray_(OrgGeogebraCommonKernelArithmeticPolyFunction *self, IOSDoubleArray *c) {
  NSObject_init(self);
  OrgGeogebraCommonKernelArithmeticPolyFunction_setAndConsume_coeffs_(self, [IOSDoubleArray newArrayWithLength:((IOSDoubleArray *) nil_chk(c))->size_]);
...
void OrgGeogebraCommonKernelArithmeticPolyFunction_initWithOrgGeogebraCommonKernelArithmeticPolyFunction_(OrgGeogebraCommonKernelArithmeticPolyFunction *self, OrgGeogebraCommonKernelArithmeticPolyFunction *pf) {
  ...
  OrgGeogebraCommonKernelArithmeticPolyFunction_set_coeffs_(self, [pf getCoeffsCopy]);
}
...
OrgGeogebraCommonKernelArithmeticPolyFunction *OrgGeogebraCommonKernelArithmeticPolyFunction_buildDerivative(OrgGeogebraCommonKernelArithmeticPolyFunction *self) {
  if (self->degree_ < 1) return [new_OrgGeogebraCommonKernelArithmeticPolyFunction_initWithInt_(0) autorelease];
  OrgGeogebraCommonKernelArithmeticPolyFunction *deriv = [new_OrgGeogebraCommonKernelArithmeticPolyFunction_initWithInt_(self->degree_ - 1) autorelease];
...
OrgGeogebraCommonKernelArithmeticPolyFunction *OrgGeogebraCommonKernelArithmeticPolyFunction_buildIntegral(OrgGeogebraCommonKernelArithmeticPolyFunction *self) {
  OrgGeogebraCommonKernelArithmeticPolyFunction *integ = [new_OrgGeogebraCommonKernelArithmeticPolyFunction_initWithInt_(self->degree_ + 1) autorelease];
