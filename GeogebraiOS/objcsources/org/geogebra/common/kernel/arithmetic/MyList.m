...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/arithmetic/MyList.java
//
...
- (OrgGeogebraCommonKernelArithmeticMyList *)invert {
  OrgGeogebraCommonUtilGgbMat *g = [new_OrgGeogebraCommonUtilGgbMat_initWithOrgGeogebraCommonKernelArithmeticMyList_(self) autorelease];
  [g inverseImmediate];
  OrgGeogebraCommonKernelArithmeticMyList *gl = [new_OrgGeogebraCommonKernelArithmeticMyList_initWithOrgGeogebraCommonKernelKernel_(kernel_) autorelease];
  ...
  if ([self size] == 0) {
    ...
    if ([((OrgGeogebraCommonMainApp *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) getApplication])) isLatexMathQuillStyleWithOrgGeogebraCommonKernelStringTemplate:tpl]) {
      ...
      for (jint i = 0; i < [self size]; i++) {
        ...
        for (jint j = 0; j < [((id<OrgGeogebraCommonKernelArithmeticListValue>) nil_chk(singleValue)) size]; j++) {
          ...
          [toLaTeXString appendWithNSString:[((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk([singleValue getListElementWithInt:j])) toLaTeXStringWithBoolean:symbolic withOrgGeogebraCommonKernelStringTemplate:tpl]];
      ...
      for (jint i = 0; i < [self size]; i++) {
        ...
        if ([((id<OrgGeogebraCommonKernelArithmeticListValue>) nil_chk(singleValue)) size] > 0) {
          [toLaTeXString appendWithNSString:[((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk([singleValue getListElementWithInt:0])) toLaTeXStringWithBoolean:symbolic withOrgGeogebraCommonKernelStringTemplate:tpl]];
    ...
    if (lastIndex > -1) {
      for (jint i = 0; i < lastIndex; i++) {
        ...
        [toLaTeXString appendWithNSString:[((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(exp)) toLaTeXStringWithBoolean:symbolic withOrgGeogebraCommonKernelStringTemplate:tpl]];
        [toLaTeXString appendWithNSString:@", "];
      }
...
- (id<OrgGeogebraCommonKernelArithmeticExpressionValue>)deepCopyWithOrgGeogebraCommonKernelKernel:(OrgGeogebraCommonKernelKernel *)kernel1 {
  ...
  OrgGeogebraCommonKernelArithmeticMyList *c = [new_OrgGeogebraCommonKernelArithmeticMyList_initWithOrgGeogebraCommonKernelKernel_withInt_(kernel1, [self size]) autorelease];
...
- (void)vectorProductWithOrgGeogebraCommonKernelArithmeticMyList:(OrgGeogebraCommonKernelArithmeticMyList *)list {
  ...
  if ([list size] == 2 || [self size] == 2) {
    ...
    [listElements_ setWithInt:0 withId:[new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, 0.0) autorelease], OrgGeogebraCommonPluginOperationEnum_get_NO_OPERATION(), nil) autorelease]];
    [listElements_ setWithInt:1 withId:[new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, 0.0) autorelease], OrgGeogebraCommonPluginOperationEnum_get_NO_OPERATION(), nil) autorelease]];
    return;
  }
  ...
  en = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, az, OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY(), bx) autorelease];
  en2 = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, ax, OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY(), bz) autorelease];
...
- (OrgGeogebraCommonKernelArithmeticMyList *)getCopyWithOrgGeogebraCommonKernelKernel:(OrgGeogebraCommonKernelKernel *)kernel2 {
  OrgGeogebraCommonKernelArithmeticMyList *ret = [new_OrgGeogebraCommonKernelArithmeticMyList_initWithOrgGeogebraCommonKernelKernel_withInt_(kernel_, [self size]) autorelease];
  for (jint i = 0; i < [self size]; i++) {
...
- (id<OrgGeogebraCommonKernelArithmeticExpressionValue>)traverseWithOrgGeogebraCommonKernelArithmeticTraversing:(id<OrgGeogebraCommonKernelArithmeticTraversing>)t {
  ...
  for (jint i = 0; i < [self size]; i++) {
    id<OrgGeogebraCommonKernelArithmeticExpressionValue> insert = [self getListElementWithInt:i];
    [((JavaUtilArrayList *) nil_chk(listElements_)) setWithInt:i withId:[((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(insert)) traverseWithOrgGeogebraCommonKernelArithmeticTraversing:t]];
  }
  return v;
}
...
- (void)addQueWithDouble:(jdouble)val
  ...
  for (jint read = offset + 1; read < [listElements_ size]; read++) {
    [listElements_ setWithInt:read - 1 withId:[listElements_ getWithInt:read]];
  }
  [removed addWithDouble:val - [((OrgGeogebraCommonKernelArithmeticMyDouble *) nil_chk(removed)) getDouble]];
  [listElements_ setWithInt:[listElements_ size] - 1 withId:removed];
}
...
void OrgGeogebraCommonKernelArithmeticMyList_initWithOrgGeogebraCommonKernelKernel_(OrgGeogebraCommonKernelArithmeticMyList *self, OrgGeogebraCommonKernelKernel *kernel) {
  OrgGeogebraCommonKernelArithmeticMyList_initWithOrgGeogebraCommonKernelKernel_withInt_(self, kernel, 20);
}
...
void OrgGeogebraCommonKernelArithmeticMyList_initWithOrgGeogebraCommonKernelKernel_withInt_(OrgGeogebraCommonKernelArithmeticMyList *self, OrgGeogebraCommonKernelKernel *kernel, jint size) {
  ...
  OrgGeogebraCommonKernelArithmeticMyList_set_kernel_(self, kernel);
  OrgGeogebraCommonKernelArithmeticMyList_setAndConsume_listElements_(self, new_JavaUtilArrayList_initWithInt_(size));
}
...
void OrgGeogebraCommonKernelArithmeticMyList_matrixMultiplyWithOrgGeogebraCommonKernelArithmeticMyList_withOrgGeogebraCommonKernelArithmeticMyList_(OrgGeogebraCommonKernelArithmeticMyList *self, OrgGeogebraCommonKernelArithmeticMyList *LHlist, OrgGeogebraCommonKernelArithmeticMyList *RHlist) {
  ...
  for (jint row = 0; row < LHrows; row++) {
    OrgGeogebraCommonKernelArithmeticMyList *col1 = [new_OrgGeogebraCommonKernelArithmeticMyList_initWithOrgGeogebraCommonKernelKernel_(self->kernel_) autorelease];
    for (jint col = 0; col < RHcols; col++) {
      id<OrgGeogebraCommonKernelArithmeticExpressionValue> totalVal = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self->kernel_, [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, 0.0) autorelease]) autorelease];
      ...
      tempNode = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self->kernel_, totalVal) autorelease];
      [col1 addListElementWithOrgGeogebraCommonKernelArithmeticExpressionValue:tempNode];
    }
    OrgGeogebraCommonKernelArithmeticExpressionNode *col1a = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self->kernel_, col1) autorelease];
...
void OrgGeogebraCommonKernelArithmeticMyList_applyWithOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_withBoolean_withOrgGeogebraCommonKernelStringTemplate_(OrgGeogebraCommonKernelArithmeticMyList *self, OrgGeogebraCommonPluginOperationEnum *operation, id<OrgGeogebraCommonKernelArithmeticExpressionValue> value, jboolean right, OrgGeogebraCommonKernelStringTemplate *tpl) {
  ...
  if (right && operation == OrgGeogebraCommonPluginOperationEnum_get_POWER() && [OrgGeogebraCommonKernelArithmeticNumberValue_class_() isInstance:value] && [self isMatrix]) {
    ...
    if (power < 0) {
      OrgGeogebraCommonKernelArithmeticMyList_set_listElements_(self, ((OrgGeogebraCommonKernelArithmeticMyList *) nil_chk([self invert]))->listElements_);
      power *= -1;
      if (power == 1) {
  ...
  OrgGeogebraCommonKernelArithmeticExpressionNode *tempNode = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self->kernel_, [((JavaUtilArrayList *) nil_chk(self->listElements_)) getWithInt:0]) autorelease];
  ...
  for (jint i = 0; i < size; i++) {
    ...
    if (![((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(operationResult)) isExpressionNode]) {
      operationResult = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self->kernel_, operationResult) autorelease];
    }
...
NSString *OrgGeogebraCommonKernelArithmeticMyList_toStringWithOrgGeogebraCommonKernelStringTemplate_withBoolean_(OrgGeogebraCommonKernelArithmeticMyList *self, OrgGeogebraCommonKernelStringTemplate *tpl, jboolean valueMode) {
  ...
  if (lastIndex > -1) {
    for (jint i = 0; i < lastIndex; i++) {
      ...
      [sb appendWithNSString:valueMode ? [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(exp)) toOutputValueStringWithOrgGeogebraCommonKernelStringTemplate:tpl] : [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(exp)) toStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
      [sb appendWithNSString:@", "];
    }
...
OrgGeogebraCommonKernelArithmeticMyList *OrgGeogebraCommonKernelArithmeticMyList_setDifferenceWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticMyList_withOrgGeogebraCommonKernelArithmeticMyList_(OrgGeogebraCommonKernelKernel *kernel, OrgGeogebraCommonKernelArithmeticMyList *list1, OrgGeogebraCommonKernelArithmeticMyList *list2) {
  ...
  OrgGeogebraCommonKernelArithmeticMyList *ret = [new_OrgGeogebraCommonKernelArithmeticMyList_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
