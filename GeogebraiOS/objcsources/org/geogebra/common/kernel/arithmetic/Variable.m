...
- (id<OrgGeogebraCommonKernelArithmeticExpressionValue>)deepCopyWithOrgGeogebraCommonKernelKernel:(OrgGeogebraCommonKernelKernel *)kernel1 {
  return new_OrgGeogebraCommonKernelArithmeticVariable_initWithOrgGeogebraCommonKernelKernel_withNSString_(kernel1, name_);
}
...
- (OrgGeogebraCommonKernelGeosGeoElement *)resolveWithBoolean:(jboolean)allowAutoCreateGeoElement
  ...
  if ([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) isResolveUnkownVarsAsDummyGeos]) {
    return new_OrgGeogebraCommonKernelGeosGeoDummyVariable_initWithOrgGeogebraCommonKernelConstruction_withNSString_([kernel_ getConstruction], name_);
  }
  ...
  IOSObjectArray *str = [IOSObjectArray newArrayWithObjects:(id[]){ @"UndefinedVariable", name_ } count:2 type:NSString_class_()];
  @throw new_OrgGeogebraCommonMainMyParseError_initWithOrgGeogebraCommonMainLocalization_withNSStringArray_([((OrgGeogebraCommonMainApp *) nil_chk([kernel_ getApplication])) getLocalization], str);
}
...
- (id<OrgGeogebraCommonKernelArithmeticExpressionValue>)resolveAsExpressionValue {
  ...
  if ([((NSString *) nil_chk(name_)) indexOf:'$'] > -1 && !([geo isKindOfClass:[OrgGeogebraCommonKernelGeosGeoCasCell class]]) && !([geo isKindOfClass:[OrgGeogebraCommonKernelGeosGeoDummyVariable class]])) {
    ...
    return new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, geo, operation, nil);
  }
  return geo;
}
...
id<OrgGeogebraCommonKernelArithmeticExpressionValue> OrgGeogebraCommonKernelArithmeticVariable_replacementWithOrgGeogebraCommonKernelKernel_withNSString_(OrgGeogebraCommonKernelKernel *kernel, NSString *name) {
  ...
  IOSIntArray *exponents = [IOSIntArray newArrayWithInts:(jint[]){ 0, 0, 0 } count:3];
  jint i;
  ...
  for (i = ((jint) [((NSString *) nil_chk(name)) length]) - 1; i >= 0; i--) {
    ...
    if (op != nil && op != OrgGeogebraCommonPluginOperationEnum_get_XCOORD() && op != OrgGeogebraCommonPluginOperationEnum_get_YCOORD() && op != OrgGeogebraCommonPluginOperationEnum_get_ZCOORD()) {
      return [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([new_OrgGeogebraCommonKernelArithmeticFunctionVariable_initWithOrgGeogebraCommonKernelKernel_withNSString_(kernel, JreStrcat("C", [name charAtWithInt:i])) wrap])) powerWithOrgGeogebraCommonKernelArithmeticExpressionValue:new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel, IOSIntArray_Get(exponents, [name charAtWithInt:i] - 'x'))])) applyWithOrgGeogebraCommonPluginOperationEnum:op];
    }
    if (geo2 != nil) break;
  }
  if (i > -1 && !([geo2 isKindOfClass:[OrgGeogebraCommonKernelGeosGeoElement class]])) return new_OrgGeogebraCommonKernelArithmeticVariable_initWithOrgGeogebraCommonKernelKernel_withNSString_(kernel, [name substring:0 endIndex:i + 1]);
  if (geo2 == nil) geo2 = new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel, 1.0);
  return new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel, geo2, OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY(), [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel, new_OrgGeogebraCommonKernelArithmeticFunctionVariable_initWithOrgGeogebraCommonKernelKernel_withNSString_(kernel, @"x")) powerWithOrgGeogebraCommonKernelArithmeticExpressionValue:new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel, IOSIntArray_Get(exponents, 0))])) multiplyWithOrgGeogebraCommonKernelArithmeticExpressionValue:[new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel, new_OrgGeogebraCommonKernelArithmeticFunctionVariable_initWithOrgGeogebraCommonKernelKernel_withNSString_(kernel, @"y")) powerWithOrgGeogebraCommonKernelArithmeticExpressionValue:new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel, IOSIntArray_Get(exponents, 1))]])) multiplyWithOrgGeogebraCommonKernelArithmeticExpressionValue:[new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel, new_OrgGeogebraCommonKernelArithmeticFunctionVariable_initWithOrgGeogebraCommonKernelKernel_withNSString_(kernel, @"z")) powerWithOrgGeogebraCommonKernelArithmeticExpressionValue:new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel, IOSIntArray_Get(exponents, 2))]]);
}
