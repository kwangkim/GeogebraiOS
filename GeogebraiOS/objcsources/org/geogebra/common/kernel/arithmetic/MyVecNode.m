...
- (OrgGeogebraCommonKernelGeosGeoVec2D *)getVector {
  OrgGeogebraCommonKernelGeosGeoVec2D *ret = [new_OrgGeogebraCommonKernelGeosGeoVec2D_initWithOrgGeogebraCommonKernelKernel_withDoubleArray_(kernel_, OrgGeogebraCommonKernelArithmeticMyVecNode_getCoords(self)) autorelease];
...
void OrgGeogebraCommonKernelArithmeticMyVecNode_initWithOrgGeogebraCommonKernelKernel_(OrgGeogebraCommonKernelArithmeticMyVecNode *self, OrgGeogebraCommonKernelKernel *kernel) {
  ...
  OrgGeogebraCommonKernelArithmeticMyVecNode_set_kernel_(self, kernel);
}
...
IOSDoubleArray *OrgGeogebraCommonKernelArithmeticMyVecNode_getCoords(OrgGeogebraCommonKernelArithmeticMyVecNode *self) {
  ...
  if (!([OrgGeogebraCommonKernelArithmeticNumberValue_class_() isInstance:evx])) {
    ...
    @throw [new_OrgGeogebraCommonMainMyParseError_initWithOrgGeogebraCommonMainLocalization_withNSStringArray_([((OrgGeogebraCommonMainApp *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) getApplication])) getLocalization], str) autorelease];
  }
