...
- (IOSObjectArray *)getArguments {
  return [((JavaUtilArrayList *) nil_chk(args_)) toArrayWithNSObjectArray:[IOSObjectArray arrayWithLength:0 type:OrgGeogebraCommonKernelArithmeticExpressionNode_class_()]];
}
...
- (id<OrgGeogebraCommonKernelArithmeticExpressionValue>)evaluateWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  if (evalGeos_ == nil) OrgGeogebraCommonKernelArithmeticCommand_set_evalGeos_(self, [self evaluateMultiple]);
...
- (id<OrgGeogebraCommonKernelArithmeticExpressionValue>)deepCopyWithOrgGeogebraCommonKernelKernel:(OrgGeogebraCommonKernelKernel *)kernel1 {
  OrgGeogebraCommonKernelArithmeticCommand *c = [new_OrgGeogebraCommonKernelArithmeticCommand_initWithOrgGeogebraCommonKernelKernel_withNSString_withBoolean_(kernel1, name_, NO) autorelease];
...
- (void)setMacroWithOrgGeogebraCommonKernelMacro:(OrgGeogebraCommonKernelMacro *)macro {
  OrgGeogebraCommonKernelArithmeticCommand_set_macro_(self, macro);
}
...
- (void)setOutputSizesWithIntArray:(IOSIntArray *)sizes {
  OrgGeogebraCommonKernelArithmeticCommand_set_outputSizes_(self, sizes);
}
...
void OrgGeogebraCommonKernelArithmeticCommand_initWithOrgGeogebraCommonKernelKernel_withNSString_withBoolean_(OrgGeogebraCommonKernelArithmeticCommand *self, OrgGeogebraCommonKernelKernel *kernel, NSString *name, jboolean translateName) {
  OrgGeogebraCommonKernelArithmeticCommand_initWithOrgGeogebraCommonKernelKernel_withNSString_withBoolean_withBoolean_(self, kernel, name, translateName, YES);
}
...
void OrgGeogebraCommonKernelArithmeticCommand_initWithOrgGeogebraCommonKernelKernel_withNSString_withBoolean_withBoolean_(OrgGeogebraCommonKernelArithmeticCommand *self, OrgGeogebraCommonKernelKernel *kernel, NSString *name, jboolean translateName, jboolean allowEvaluationForTypeCheck) {
  ...
  OrgGeogebraCommonKernelArithmeticCommand_setAndConsume_args_(self, new_JavaUtilArrayList_init());
  self->allowEvaluationForTypeCheck_ = YES;
  OrgGeogebraCommonKernelArithmeticCommand_set_kernel_(self, kernel);
  OrgGeogebraCommonKernelArithmeticCommand_set_app_(self, [((OrgGeogebraCommonKernelKernel *) nil_chk(kernel)) getApplication]);
  self->allowEvaluationForTypeCheck_ = allowEvaluationForTypeCheck;
  if (translateName && ![kernel isUsingInternalCommandNames]) {
    OrgGeogebraCommonKernelArithmeticCommand_set_name_(self, [((OrgGeogebraCommonMainApp *) nil_chk(self->app_)) getReverseCommandWithNSString:name]);
    if (self->name_ == nil) OrgGeogebraCommonKernelArithmeticCommand_set_name_(self, name);
  }
  else {
    OrgGeogebraCommonKernelArithmeticCommand_set_name_(self, name);
  }
}
...
NSString *OrgGeogebraCommonKernelArithmeticCommand_toStringWithBoolean_withBoolean_withOrgGeogebraCommonKernelStringTemplate_(OrgGeogebraCommonKernelArithmeticCommand *self, jboolean symbolic, jboolean LaTeX, OrgGeogebraCommonKernelStringTemplate *tpl) {
  {
    ...
    switch ([[((OrgGeogebraCommonKernelStringTemplate *) nil_chk(tpl)) getStringType] ordinal]) {
      ...
      if (self->sbToString_ == nil) OrgGeogebraCommonKernelArithmeticCommand_setAndConsume_sbToString_(self, new_JavaLangStringBuilder_init());
      ...
      if ([((NSString *) nil_chk(self->name_)) isEqual:@"Integral"]) {
        ...
        switch ([self getArgumentNumber]) {
          ...
          [self->sbToString_ appendWithNSString:[((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([self getArgumentWithInt:0])) toStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
          break;
          case 2:
          [self->sbToString_ appendWithNSString:@" "];
          [self->sbToString_ appendWithNSString:[((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([self getArgumentWithInt:0])) toStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
          ...
          [self->sbToString_ appendWithNSString:[((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([self getArgumentWithInt:1])) toStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
          [self->sbToString_ appendWithNSString:@"}^{"];
          [self->sbToString_ appendWithNSString:[((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([self getArgumentWithInt:2])) toStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
          [self->sbToString_ appendWithNSString:@"}"];
          [self->sbToString_ appendWithNSString:[((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([self getArgumentWithInt:0])) toStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
          break;
          case 4:
          ...
          [self->sbToString_ appendWithNSString:[((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([self getArgumentWithInt:2])) toStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
          [self->sbToString_ appendWithNSString:@"}^{"];
          [self->sbToString_ appendWithNSString:[((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([self getArgumentWithInt:3])) toStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
          [self->sbToString_ appendWithNSString:@"}"];
          [self->sbToString_ appendWithNSString:[((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([self getArgumentWithInt:0])) toStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
          var = [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([self getArgumentWithInt:1])) toStringWithOrgGeogebraCommonKernelStringTemplate:tpl];
          break;
        ...
        [self->sbToString_ appendWithNSString:[((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((JavaUtilArrayList *) nil_chk(self->args_)) getWithInt:1])) toStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
        [self->sbToString_ appendWithNSString:@"="];
        [self->sbToString_ appendWithNSString:[((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([self->args_ getWithInt:2])) toStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
        [self->sbToString_ appendWithNSString:@"}^{"];
        [self->sbToString_ appendWithNSString:[((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([self->args_ getWithInt:3])) toStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
        [self->sbToString_ appendWithNSString:@"}"];
        [self->sbToString_ appendWithNSString:[((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([self->args_ getWithInt:0])) toStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
        return [self->sbToString_ description];
      }
      ...
      if ([tpl isPrintLocalizedCommandNames]) {
        [self->sbToString_ appendWithNSString:[((OrgGeogebraCommonMainLocalization *) nil_chk([((OrgGeogebraCommonMainApp *) nil_chk(self->app_)) getLocalization])) getCommandWithNSString:self->name_]];
      }
      else {
      ...
      for (jint i = 0; i < size; i++) {
        [self->sbToString_ appendWithNSString:OrgGeogebraCommonKernelArithmeticCommand_toStringWithOrgGeogebraCommonKernelArithmeticExpressionValue_withBoolean_withBoolean_withOrgGeogebraCommonKernelStringTemplate_([self->args_ getWithInt:i], symbolic, LaTeX, tpl)];
        [self->sbToString_ appendWithChar:','];
      }
...
OrgGeogebraCommonKernelArithmeticExpressionNode *OrgGeogebraCommonKernelArithmeticCommand_xyzCASWithOrgGeogebraCommonKernelArithmeticExpressionNode_withInt_withBoolean_withJavaUtilArrayList_(OrgGeogebraCommonKernelArithmeticExpressionNode *en, jint i, jboolean mayCheck, JavaUtilArrayList *undecided) {
  ...
  if ([en evaluatesToList]) {
    OrgGeogebraCommonKernelArithmeticCommand *cmd = [new_OrgGeogebraCommonKernelArithmeticCommand_initWithOrgGeogebraCommonKernelKernel_withNSString_withBoolean_withBoolean_(k, @"Element", YES, mayCheck) autorelease];
    [cmd addArgumentWithOrgGeogebraCommonKernelArithmeticExpressionNode:en];
    [cmd addArgumentWithOrgGeogebraCommonKernelArithmeticExpressionNode:[((OrgGeogebraCommonKernelArithmeticMyDouble *) [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(k, i + 1) autorelease]) wrap]];
    en2 = [cmd wrap];
  }
  else if ([en hasCoords]) {
    en2 = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(k, [en unwrap], IOSObjectArray_Get(ops, i), nil) autorelease];
  }
  else {
    jchar funName = (jchar) ('x' + i);
    en2 = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(k, [new_OrgGeogebraCommonKernelArithmeticFunctionVariable_initWithOrgGeogebraCommonKernelKernel_withNSString_(k, JreStrcat("C", funName)) autorelease], OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY_OR_FUNCTION(), en) autorelease];
