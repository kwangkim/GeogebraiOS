...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/arithmetic/MyDouble.java
//
...
- (id<OrgGeogebraCommonKernelArithmeticExpressionValue>)deepCopyWithOrgGeogebraCommonKernelKernel:(OrgGeogebraCommonKernelKernel *)kernel1 {
  OrgGeogebraCommonKernelArithmeticMyDouble *ret = [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelArithmeticMyDouble_(self) autorelease];
...
- (OrgGeogebraCommonKernelArithmeticMyDouble *)roundWithDouble:(jdouble)digits {
  ...
  OrgGeogebraCommonKernelArithmeticMyDouble_round(self);
  [self setWithDouble:val_ / pow];
  return self;
}
...
- (OrgGeogebraCommonKernelArithmeticMyDouble *)getNumber {
  return [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelArithmeticMyDouble_(self) autorelease];
}
...
- (OrgGeogebraCommonKernelGeosGeoElement *)toGeoElement {
  OrgGeogebraCommonKernelGeosGeoNumeric *num = [new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) getConstruction], val_) autorelease];
  return num;
}
...
- (id<OrgGeogebraCommonKernelArithmeticExpressionValue>)fractionalPart {
  return [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, val_ > 0 ? val_ - JavaLangMath_floorWithDouble_(val_) : val_ - JavaLangMath_ceilWithDouble_(val_)) autorelease];
}

- (id<OrgGeogebraCommonKernelArithmeticExpressionValue>)zeta {
  return [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, OrgGeogebraCommonUtilMyMath2_zetaWithDouble_(val_)) autorelease];
}
...
void OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_(OrgGeogebraCommonKernelArithmeticMyDouble *self, OrgGeogebraCommonKernelKernel *kernel) {
  OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self, kernel, 0.0);
}
...
void OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(OrgGeogebraCommonKernelArithmeticMyDouble *self, OrgGeogebraCommonKernelKernel *kernel, jdouble x) {
  ...
  self->isAngle__ = NO;
  OrgGeogebraCommonKernelArithmeticMyDouble_set_kernel_(self, kernel);
  self->val_ = x;
}
...
void OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelArithmeticMyDouble_(OrgGeogebraCommonKernelArithmeticMyDouble *self, OrgGeogebraCommonKernelArithmeticMyDouble *d) {
  OrgGeogebraCommonKernelArithmeticValidExpression_init(self);
  self->isAngle__ = NO;
  OrgGeogebraCommonKernelArithmeticMyDouble_set_kernel_(self, ((OrgGeogebraCommonKernelArithmeticMyDouble *) nil_chk(d))->kernel_);
  self->val_ = d->val_;
...
jdouble OrgGeogebraCommonKernelArithmeticMyDouble_parseDoubleWithOrgGeogebraCommonMainLocalization_withNSString_(OrgGeogebraCommonMainLocalization *app, NSString *str) {
  ...
  @catch (JavaLangException *e) {
    @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSString_(app, @"InvalidInput") autorelease];
  }
}
