...
void OrgGeogebraCommonKernelArithmeticInequality_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticFunctionVariableArray_withOrgGeogebraCommonKernelArithmeticFunctionalNVar_(OrgGeogebraCommonKernelArithmeticInequality *self, OrgGeogebraCommonKernelKernel *kernel, id<OrgGeogebraCommonKernelArithmeticExpressionValue> lhs, id<OrgGeogebraCommonKernelArithmeticExpressionValue> rhs, OrgGeogebraCommonPluginOperationEnum *op, IOSObjectArray *fv, id<OrgGeogebraCommonKernelArithmeticFunctionalNVar> function) {
  NSObject_init(self);
  OrgGeogebraCommonKernelArithmeticInequality_set_op_(self, OrgGeogebraCommonPluginOperationEnum_get_LESS());
  OrgGeogebraCommonKernelArithmeticInequality_set_op_(self, op);
  OrgGeogebraCommonKernelArithmeticInequality_set_kernel_(self, kernel);
  OrgGeogebraCommonKernelArithmeticInequality_set_fv_(self, fv);
...
void OrgGeogebraCommonKernelArithmeticInequality_update(OrgGeogebraCommonKernelArithmeticInequality *self) {
  if (((IOSObjectArray *) nil_chk(self->fv_))->size_ == 1) {
    ...
    if (![((OrgGeogebraCommonKernelGeosGeoFunction *) nil_chk(self->funBorder_)) isPolynomialFunctionWithBoolean:NO]) {
      OrgGeogebraCommonKernelArithmeticInequality_set_type_(self, OrgGeogebraCommonKernelArithmeticInequality_IneqTypeEnum_get_INEQUALITY_INVALID());
    }
      ...
      OrgGeogebraCommonKernelArithmeticInequality_set_type_(self, OrgGeogebraCommonKernelArithmeticInequality_IneqTypeEnum_get_INEQUALITY_1VAR_Y());
    }
    else OrgGeogebraCommonKernelArithmeticInequality_set_type_(self, OrgGeogebraCommonKernelArithmeticInequality_IneqTypeEnum_get_INEQUALITY_1VAR_X());
    return;
  }
  if (self->zeroDummy0_ != nil) [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(self->normal_)) replaceWithOrgGeogebraCommonKernelArithmeticExpressionValue:self->zeroDummy0_ withOrgGeogebraCommonKernelArithmeticExpressionValue:IOSObjectArray_Get(self->fv_, 0)])) wrap];
  if (self->zeroDummy1_ != nil) [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(self->normal_)) replaceWithOrgGeogebraCommonKernelArithmeticExpressionValue:self->zeroDummy1_ withOrgGeogebraCommonKernelArithmeticExpressionValue:IOSObjectArray_Get(self->fv_, 1)])) wrap];
  ...
  if (coefY != nil && !OrgGeogebraCommonKernelKernel_isZeroWithDouble_([coefY doubleValue]) && !JavaLangDouble_isNaNWithDouble_([coefY doubleValue]) && coefX == nil) {
    OrgGeogebraCommonKernelArithmeticInequality_setAndConsume_coef_(self, new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, -[coefY doubleValue]));
    self->isAboveBorder__ = ([coefY doubleValue] > 0);
    OrgGeogebraCommonKernelArithmeticExpressionNode *m = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self->kernel_, [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self->kernel_, self->normal_, OrgGeogebraCommonPluginOperationEnum_get_DIVIDE(), self->coef_) autorelease], OrgGeogebraCommonPluginOperationEnum_get_PLUS(), IOSObjectArray_Get(self->fv_, 1)) autorelease];
    [m simplifyLeafs];
    fun = [new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionVariable_(m, IOSObjectArray_Get(self->fv_, 0)) autorelease];
    OrgGeogebraCommonKernelArithmeticInequality_set_type_(self, OrgGeogebraCommonKernelArithmeticInequality_IneqTypeEnum_get_INEQUALITY_PARAMETRIC_Y());
  }
    ...
    OrgGeogebraCommonKernelArithmeticInequality_setAndConsume_coef_(self, new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, -[coefX doubleValue]));
    self->isAboveBorder__ = ([coefX doubleValue] > 0);
    OrgGeogebraCommonKernelArithmeticExpressionNode *m = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self->kernel_, [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self->kernel_, self->normal_, OrgGeogebraCommonPluginOperationEnum_get_DIVIDE(), self->coef_) autorelease], OrgGeogebraCommonPluginOperationEnum_get_PLUS(), IOSObjectArray_Get(self->fv_, 0)) autorelease];
    [m simplifyLeafs];
    fun = [new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionVariable_(m, IOSObjectArray_Get(self->fv_, 1)) autorelease];
    OrgGeogebraCommonKernelArithmeticInequality_set_type_(self, OrgGeogebraCommonKernelArithmeticInequality_IneqTypeEnum_get_INEQUALITY_PARAMETRIC_X());
  }
  else if (coefX != nil && OrgGeogebraCommonKernelKernel_isZeroWithDouble_([coefX doubleValue]) && coefY == nil) {
    OrgGeogebraCommonKernelArithmeticInequality_setAndConsume_zeroDummy0_(self, new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, 0));
    [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk([self->normal_ replaceWithOrgGeogebraCommonKernelArithmeticExpressionValue:IOSObjectArray_Get(self->fv_, 0) withOrgGeogebraCommonKernelArithmeticExpressionValue:self->zeroDummy0_])) wrap];
    OrgGeogebraCommonKernelArithmeticInequality_init1varFunctionWithInt_(self, 1);
    OrgGeogebraCommonKernelArithmeticInequality_set_type_(self, [((OrgGeogebraCommonKernelGeosGeoFunction *) nil_chk(self->funBorder_)) isPolynomialFunctionWithBoolean:NO] ? OrgGeogebraCommonKernelArithmeticInequality_IneqTypeEnum_get_INEQUALITY_1VAR_Y() : OrgGeogebraCommonKernelArithmeticInequality_IneqTypeEnum_get_INEQUALITY_INVALID());
  }
  else if (coefY != nil && OrgGeogebraCommonKernelKernel_isZeroWithDouble_([coefY doubleValue]) && coefX == nil) {
    OrgGeogebraCommonKernelArithmeticInequality_setAndConsume_zeroDummy1_(self, new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, 0));
    [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk([self->normal_ replaceWithOrgGeogebraCommonKernelArithmeticExpressionValue:IOSObjectArray_Get(self->fv_, 1) withOrgGeogebraCommonKernelArithmeticExpressionValue:self->zeroDummy1_])) wrap];
    OrgGeogebraCommonKernelArithmeticInequality_init1varFunctionWithInt_(self, 0);
    OrgGeogebraCommonKernelArithmeticInequality_set_type_(self, [((OrgGeogebraCommonKernelGeosGeoFunction *) nil_chk(self->funBorder_)) isPolynomialFunctionWithBoolean:NO] ? OrgGeogebraCommonKernelArithmeticInequality_IneqTypeEnum_get_INEQUALITY_1VAR_X() : OrgGeogebraCommonKernelArithmeticInequality_IneqTypeEnum_get_INEQUALITY_INVALID());
  }
  else {
    ...
    OrgGeogebraCommonKernelArithmeticFunctionVariable *yVar = [new_OrgGeogebraCommonKernelArithmeticFunctionVariable_initWithOrgGeogebraCommonKernelKernel_withNSString_(self->kernel_, @"y") autorelease];
    ...
    if ([((OrgGeogebraCommonKernelArithmeticPolynomial *) nil_chk(newBorder)) degree] < 2) {
      if (self->lineBorder_ == nil) OrgGeogebraCommonKernelArithmeticInequality_setAndConsume_lineBorder_(self, new_OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelConstruction_([((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) getConstruction]));
      ...
      OrgGeogebraCommonKernelArithmeticInequality_set_type_(self, OrgGeogebraCommonKernelArithmeticInequality_IneqTypeEnum_get_INEQUALITY_LINEAR());
      OrgGeogebraCommonKernelArithmeticInequality_set_border_(self, self->lineBorder_);
      ...
      if (self->conicBorder_ == nil) OrgGeogebraCommonKernelArithmeticInequality_setAndConsume_conicBorder_(self, new_OrgGeogebraCommonKernelGeosGeoConic_initWithOrgGeogebraCommonKernelConstruction_([((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) getConstruction]));
      ...
      OrgGeogebraCommonKernelArithmeticInequality_set_type_(self, OrgGeogebraCommonKernelArithmeticInequality_IneqTypeEnum_get_INEQUALITY_CONIC());
      OrgGeogebraCommonKernelArithmeticInequality_set_border_(self, self->conicBorder_);
      OrgGeogebraCommonKernelArithmeticInequality_setAboveBorderFromConic(self);
    }
    else {
      OrgGeogebraCommonKernelArithmeticInequality_set_type_(self, OrgGeogebraCommonKernelArithmeticInequality_IneqTypeEnum_get_INEQUALITY_INVALID());
  ...
  if (self->type_ == OrgGeogebraCommonKernelArithmeticInequality_IneqTypeEnum_get_INEQUALITY_PARAMETRIC_X() || self->type_ == OrgGeogebraCommonKernelArithmeticInequality_IneqTypeEnum_get_INEQUALITY_PARAMETRIC_Y()) {
    OrgGeogebraCommonKernelArithmeticInequality_setAndConsume_funBorder_(self, new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_([((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) getConstruction]));
  ...
  if (self->funBorder_ != nil) OrgGeogebraCommonKernelArithmeticInequality_set_border_(self, self->funBorder_);
  if ([self isStrict]) {
...
void OrgGeogebraCommonKernelArithmeticInequality_init1varFunctionWithInt_(OrgGeogebraCommonKernelArithmeticInequality *self, jint varIndex) {
  ...
  OrgGeogebraCommonKernelArithmeticInequality_setAndConsume_funBorder_(self, new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self->funBorder_ setFunctionWithOrgGeogebraCommonKernelArithmeticFunction:[new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionVariable_(self->normal_, IOSObjectArray_Get(nil_chk(self->fv_), varIndex)) autorelease]];
  OrgGeogebraCommonKernelArithmeticInequality_set_zeros_(self, OrgGeogebraCommonKernelArithmeticInequality_RootMultipleWithOrgGeogebraCommonKernelGeosGeoFunction_(self->funBorder_));
  [cons setSuppressLabelCreationWithBoolean:supress];
  OrgGeogebraCommonKernelArithmeticInequality_set_border_(self, self->funBorder_);
  if ([self isStrict]) {
...
IOSObjectArray *OrgGeogebraCommonKernelArithmeticInequality_RootMultipleWithOrgGeogebraCommonKernelGeosGeoFunction_(OrgGeogebraCommonKernelGeosGeoFunction *f) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoRootsPolynomial *algo = [new_OrgGeogebraCommonKernelAlgosAlgoRootsPolynomial_initWithOrgGeogebraCommonKernelGeosGeoFunction_(f) autorelease];
