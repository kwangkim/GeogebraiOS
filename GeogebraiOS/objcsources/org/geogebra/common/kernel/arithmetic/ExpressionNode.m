...
- (void)setOperationWithOrgGeogebraCommonPluginOperationEnum:(OrgGeogebraCommonPluginOperationEnum *)op {
  OrgGeogebraCommonKernelArithmeticExpressionNode_set_operation_(self, op);
}
...
- (OrgGeogebraCommonKernelArithmeticExpressionNode *)getLeftTree {
  ...
  return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, left_) autorelease];
}
...
- (OrgGeogebraCommonKernelArithmeticExpressionNode *)getRightTree {
  ...
  return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, right_) autorelease];
}
...
- (OrgGeogebraCommonKernelArithmeticExpressionNode *)getCopyWithOrgGeogebraCommonKernelKernel:(OrgGeogebraCommonKernelKernel *)kernel1 {
  ...
  if (lev != nil) {
    newNode = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel1, lev, operation_, rev) autorelease];
    newNode->leaf_ = leaf_;
  }
  else {
    return nil;
  ...
  switch ([operation_ ordinal]) {
    ...
    if (([OrgGeogebraCommonKernelArithmeticNumberValue_class_() isInstance:left_]) && ([((id<OrgGeogebraCommonKernelArithmeticNumberValue>) nil_chk(((id<OrgGeogebraCommonKernelArithmeticNumberValue>) check_protocol_cast(left_, @protocol(OrgGeogebraCommonKernelArithmeticNumberValue))))) getDouble] == JavaLangMath_E)) {
      ...
      if ((geo != nil) && [geo needsReplacingInExpressionNode]) {
        OrgGeogebraCommonKernelArithmeticExpressionNode_set_operation_(self, OrgGeogebraCommonPluginOperationEnum_get_EXP());
        OrgGeogebraCommonKernelArithmeticExpressionNode_set_left_(self, right_);
    ...
    if (([OrgGeogebraCommonKernelArithmeticNumberValue_class_() isInstance:left_]) && ([((id<OrgGeogebraCommonKernelArithmeticNumberValue>) nil_chk(((id<OrgGeogebraCommonKernelArithmeticNumberValue>) check_protocol_cast(left_, @protocol(OrgGeogebraCommonKernelArithmeticNumberValue))))) getDouble] == JavaLangMath_E)) {
      ...
      OrgGeogebraCommonKernelGeosGeoElement *geo = [((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) lookupLabelWithNSString:@"e"];
      if ((geo != nil) && [geo needsReplacingInExpressionNode]) {
        OrgGeogebraCommonKernelArithmeticExpressionNode_setAndConsume_right_(self, new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, 1.0) autorelease], OrgGeogebraCommonPluginOperationEnum_get_EXP(), nil));
        [((OrgGeogebraCommonKernelConstruction *) nil_chk([kernel_ getConstruction])) removeLabelWithOrgGeogebraCommonKernelGeosGeoElement:geo];
      }
    }
    break;
...
- (jint)replaceXYZnodesWithOrgGeogebraCommonKernelArithmeticFunctionVariable:(OrgGeogebraCommonKernelArithmeticFunctionVariable *)xVar
  ...
  switch ([operation_ ordinal]) {
    ...
    if (xVar != nil) {
      ...
      OrgGeogebraCommonKernelArithmeticExpressionNode_set_operation_(self, OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY_OR_FUNCTION());
      OrgGeogebraCommonKernelArithmeticExpressionNode_set_right_(self, left_);
      OrgGeogebraCommonKernelArithmeticExpressionNode_set_left_(self, xVar);
    }
    break;
    ...
    if (yVar != nil) {
      ...
      OrgGeogebraCommonKernelArithmeticExpressionNode_set_operation_(self, OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY_OR_FUNCTION());
      OrgGeogebraCommonKernelArithmeticExpressionNode_set_right_(self, left_);
      OrgGeogebraCommonKernelArithmeticExpressionNode_set_left_(self, yVar);
    }
    break;
    ...
    if (zVar != nil) {
      ...
      OrgGeogebraCommonKernelArithmeticExpressionNode_set_operation_(self, OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY_OR_FUNCTION());
      OrgGeogebraCommonKernelArithmeticExpressionNode_set_right_(self, left_);
      OrgGeogebraCommonKernelArithmeticExpressionNode_set_left_(self, zVar);
    }
    break;
    case OrgGeogebraCommonPluginOperation_POWER:
    if ([left_ isExpressionNode] && ((OrgGeogebraCommonKernelArithmeticExpressionNode *) check_class_cast(left_, [OrgGeogebraCommonKernelArithmeticExpressionNode class]))->operation_ == OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY_OR_FUNCTION() && ![((OrgGeogebraCommonKernelArithmeticExpressionNode *) check_class_cast(left_, [OrgGeogebraCommonKernelArithmeticExpressionNode class])) hasBrackets]) {
      ...
      OrgGeogebraCommonKernelArithmeticExpressionNode_set_left_(self, OrgGeogebraCommonKernelArithmeticExpressionNode_getLeft(((OrgGeogebraCommonKernelArithmeticExpressionNode *) check_class_cast(left_, [OrgGeogebraCommonKernelArithmeticExpressionNode class]))));
      OrgGeogebraCommonKernelArithmeticExpressionNode_set_operation_(self, OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY());
    }
    break;
    ...
    if ([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(left_)) isExpressionNode] && ((OrgGeogebraCommonKernelArithmeticExpressionNode *) check_class_cast(left_, [OrgGeogebraCommonKernelArithmeticExpressionNode class]))->operation_ == OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY_OR_FUNCTION() && ![((OrgGeogebraCommonKernelArithmeticExpressionNode *) check_class_cast(left_, [OrgGeogebraCommonKernelArithmeticExpressionNode class])) hasBrackets]) {
      OrgGeogebraCommonKernelArithmeticExpressionNode_set_right_(self, OrgGeogebraCommonKernelArithmeticExpressionNode_getRight(((OrgGeogebraCommonKernelArithmeticExpressionNode *) check_class_cast(left_, [OrgGeogebraCommonKernelArithmeticExpressionNode class]))));
...
- (id<OrgGeogebraCommonKernelArithmeticExpressionValue>)traverseWithOrgGeogebraCommonKernelArithmeticTraversing:(id<OrgGeogebraCommonKernelArithmeticTraversing>)t {
  ...
  OrgGeogebraCommonKernelArithmeticExpressionNode_set_left_(self, [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(left_)) traverseWithOrgGeogebraCommonKernelArithmeticTraversing:t]);
  if (right_ != nil) OrgGeogebraCommonKernelArithmeticExpressionNode_set_right_(self, [right_ traverseWithOrgGeogebraCommonKernelArithmeticTraversing:t]);
...
- (void)replaceChildrenByValuesWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  if ([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(left_)) isGeoElement]) {
    ...
    if ((left_ == geo) || [treeGeo isChildOfWithOrgGeogebraCommonKernelGeosGeoElement:geo]) {
      OrgGeogebraCommonKernelArithmeticExpressionNode_set_left_(self, [treeGeo copyInternalWithOrgGeogebraCommonKernelConstruction:[treeGeo getConstruction]]);
    }
  }
  ...
  if (right_ != nil) {
    if ([right_ isGeoElement]) {
      ...
      if ((right_ == geo) || [treeGeo isChildOfWithOrgGeogebraCommonKernelGeosGeoElement:geo]) {
        OrgGeogebraCommonKernelArithmeticExpressionNode_set_right_(self, [treeGeo copyInternalWithOrgGeogebraCommonKernelConstruction:[treeGeo getConstruction]]);
      }
    }
...
- (OrgGeogebraCommonKernelArithmeticExpressionNode *)sec {
  return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, self, OrgGeogebraCommonPluginOperationEnum_get_SEC(), nil) autorelease];
}

- (OrgGeogebraCommonKernelArithmeticExpressionNode *)tan {
  return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, self, OrgGeogebraCommonPluginOperationEnum_get_TAN(), nil) autorelease];
}
...
- (OrgGeogebraCommonKernelArithmeticExpressionNode *)tanh {
  return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, self, OrgGeogebraCommonPluginOperationEnum_get_TANH(), nil) autorelease];
}
...
- (OrgGeogebraCommonKernelArithmeticExpressionNode *)cosec {
  return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, self, OrgGeogebraCommonPluginOperationEnum_get_CSC(), nil) autorelease];
}
...
- (OrgGeogebraCommonKernelArithmeticExpressionNode *)factorial {
  return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, self, OrgGeogebraCommonPluginOperationEnum_get_FACTORIAL(), nil) autorelease];
}
...
- (OrgGeogebraCommonKernelArithmeticExpressionNode *)gamma {
  return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, self, OrgGeogebraCommonPluginOperationEnum_get_GAMMA(), nil) autorelease];
}
...
- (OrgGeogebraCommonKernelArithmeticExpressionNode *)gammaIncompleteWithOrgGeogebraCommonKernelArithmeticExpressionValue:(id<OrgGeogebraCommonKernelArithmeticExpressionValue>)v2 {
  return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, self, OrgGeogebraCommonPluginOperationEnum_get_GAMMA_INCOMPLETE(), v2) autorelease];
}
...
- (OrgGeogebraCommonKernelArithmeticExpressionNode *)betaWithOrgGeogebraCommonKernelArithmeticExpressionValue:(id<OrgGeogebraCommonKernelArithmeticExpressionValue>)v2 {
  return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, self, OrgGeogebraCommonPluginOperationEnum_get_BETA(), v2) autorelease];
}

- (OrgGeogebraCommonKernelArithmeticExpressionNode *)exp {
  return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, self, OrgGeogebraCommonPluginOperationEnum_get_EXP(), nil) autorelease];
}

- (OrgGeogebraCommonKernelArithmeticExpressionNode *)polygammaWithDouble:(jdouble)n {
  return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, OrgGeogebraCommonKernelArithmeticExpressionNode_wrapWithDouble_(self, n), OrgGeogebraCommonPluginOperationEnum_get_POLYGAMMA(), self) autorelease];
}

- (OrgGeogebraCommonKernelArithmeticExpressionNode *)sin {
  return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, self, OrgGeogebraCommonPluginOperationEnum_get_SIN(), nil) autorelease];
}

- (OrgGeogebraCommonKernelArithmeticExpressionNode *)sinh {
  return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, self, OrgGeogebraCommonPluginOperationEnum_get_SINH(), nil) autorelease];
}

- (OrgGeogebraCommonKernelArithmeticExpressionNode *)cosh {
  return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, self, OrgGeogebraCommonPluginOperationEnum_get_COSH(), nil) autorelease];
}

- (OrgGeogebraCommonKernelArithmeticExpressionNode *)cos {
  return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, self, OrgGeogebraCommonPluginOperationEnum_get_COS(), nil) autorelease];
}

- (OrgGeogebraCommonKernelArithmeticExpressionNode *)reciprocate {
  return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, self, OrgGeogebraCommonPluginOperationEnum_get_POWER(), [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, -1) autorelease]) autorelease];
}

- (OrgGeogebraCommonKernelArithmeticExpressionNode *)sqrt {
  return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, self, OrgGeogebraCommonPluginOperationEnum_get_SQRT(), nil) autorelease];
}

- (OrgGeogebraCommonKernelArithmeticExpressionNode *)cbrt {
  return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, self, OrgGeogebraCommonPluginOperationEnum_get_CBRT(), nil) autorelease];
}

- (OrgGeogebraCommonKernelArithmeticExpressionNode *)sgn {
  return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, self, OrgGeogebraCommonPluginOperationEnum_get_SGN(), nil) autorelease];
}

- (OrgGeogebraCommonKernelArithmeticExpressionNode *)atan {
  return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, self, OrgGeogebraCommonPluginOperationEnum_get_ARCTAN(), nil) autorelease];
}
...
- (OrgGeogebraCommonKernelArithmeticExpressionNode *)reverseSign2 {
  return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, 0.0) autorelease], OrgGeogebraCommonPluginOperationEnum_get_MINUS(), self) autorelease];
}
...
- (OrgGeogebraCommonKernelArithmeticExpressionNode *)plusRWithDouble:(jdouble)d {
  ...
  return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, d) autorelease], OrgGeogebraCommonPluginOperationEnum_get_PLUS(), self) autorelease];
}
...
- (OrgGeogebraCommonKernelArithmeticExpressionNode *)multiplyWithDouble:(jdouble)d {
  if (d == 0 || OrgGeogebraCommonKernelArithmeticExpressionNode_isConstantDoubleWithOrgGeogebraCommonKernelArithmeticExpressionValue_withDouble_(self, 0)) {
    return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, 0) autorelease];
  }
...
- (OrgGeogebraCommonKernelArithmeticExpressionNode *)multiplyRWithDouble:(jdouble)d {
  ...
  return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, d) autorelease], OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY(), self) autorelease];
}
...
- (OrgGeogebraCommonKernelArithmeticExpressionNode *)powerWithDouble:(jdouble)d {
  if (OrgGeogebraCommonKernelKernel_isZeroWithDouble_(d)) {
    return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, 1) autorelease];
  }
...
- (OrgGeogebraCommonKernelArithmeticExpressionNode *)subtractRWithDouble:(jdouble)d {
  if (d == 0) {
    return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, -1) autorelease], OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY(), self) autorelease];
  }
  return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, d) autorelease], OrgGeogebraCommonPluginOperationEnum_get_MINUS(), self) autorelease];
}
...
- (OrgGeogebraCommonKernelArithmeticExpressionNode *)multiplyRWithOrgGeogebraCommonKernelArithmeticExpressionValue:(id<OrgGeogebraCommonKernelArithmeticExpressionValue>)v2 {
  ...
  return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, self, OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY(), v2) autorelease];
}
...
- (OrgGeogebraCommonKernelArithmeticExpressionNode *)powerWithOrgGeogebraCommonKernelArithmeticExpressionValue:(id<OrgGeogebraCommonKernelArithmeticExpressionValue>)v2 {
  if (OrgGeogebraCommonKernelArithmeticExpressionNode_isConstantDoubleWithOrgGeogebraCommonKernelArithmeticExpressionValue_withDouble_(v2, 0)) return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, 1) autorelease];
  if (OrgGeogebraCommonKernelArithmeticExpressionNode_isConstantDoubleWithOrgGeogebraCommonKernelArithmeticExpressionValue_withDouble_(v2, 1)) return self;
  return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, self, OrgGeogebraCommonPluginOperationEnum_get_POWER(), v2) autorelease];
}

- (OrgGeogebraCommonKernelArithmeticExpressionNode *)powerRWithDouble:(jdouble)d {
  return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, d) autorelease], OrgGeogebraCommonPluginOperationEnum_get_POWER(), self) autorelease];
}
...
- (OrgGeogebraCommonKernelArithmeticExpressionNode *)and__WithOrgGeogebraCommonKernelArithmeticExpressionValue:(id<OrgGeogebraCommonKernelArithmeticExpressionValue>)v2 {
  return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, self, OrgGeogebraCommonPluginOperationEnum_get_AND(), v2) autorelease];
}
...
- (OrgGeogebraCommonKernelArithmeticExpressionNode *)negation {
  ...
  if ([((OrgGeogebraCommonPluginOperationEnum *) nil_chk(OrgGeogebraCommonPluginOperationEnum_get_NOT())) isEqual:opNegated]) {
    return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, self, OrgGeogebraCommonPluginOperationEnum_get_NOT(), nil) autorelease];
  }
  return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, left_, opNegated, right_) autorelease];
}
...
- (jboolean)replacePowersRootsWithBoolean:(jboolean)toRoot
  ...
  if (toRoot && OrgGeogebraCommonKernelArithmeticExpressionNode_getOperation(self) == OrgGeogebraCommonPluginOperationEnum_get_POWER() && [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(OrgGeogebraCommonKernelArithmeticExpressionNode_getRight(self))) isExpressionNode]) {
    ...
    if ((OrgGeogebraCommonKernelArithmeticExpressionNode_getOperation(nil_chk(rightLeaf)) == OrgGeogebraCommonPluginOperationEnum_get_DIVIDE()) && OrgGeogebraCommonKernelArithmeticExpressionNode_isConstant(rightLeaf)) {
      ...
      if (hit) {
        ...
        if ([((NSString *) nil_chk([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(OrgGeogebraCommonKernelArithmeticExpressionNode_getLeft(rightLeaf))) toStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()])) isEqual:@"1"]) {
          if (operation_ != OrgGeogebraCommonPluginOperationEnum_get_NROOT()) OrgGeogebraCommonKernelArithmeticExpressionNode_setRightWithOrgGeogebraCommonKernelArithmeticExpressionValue_(self, [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, JavaLangDouble_NaN) autorelease]);
        }
        else {
          jdouble c = 1;
          ...
          if (c < 0) {
            OrgGeogebraCommonKernelArithmeticExpressionNode_setRightWithOrgGeogebraCommonKernelArithmeticExpressionValue_(self, [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(OrgGeogebraCommonKernelArithmeticExpressionNode_getLeft(self))) wrap])) powerWithDouble:-c], OrgGeogebraCommonKernelArithmeticExpressionNode_getOperation(self), OrgGeogebraCommonKernelArithmeticExpressionNode_getRight(self)) autorelease]);
            [self setOperationWithOrgGeogebraCommonPluginOperationEnum:OrgGeogebraCommonPluginOperationEnum_get_DIVIDE()];
            OrgGeogebraCommonKernelArithmeticExpressionNode_setLeftWithOrgGeogebraCommonKernelArithmeticExpressionValue_(self, [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, 1.0) autorelease]);
          }
          else OrgGeogebraCommonKernelArithmeticExpressionNode_setLeftWithOrgGeogebraCommonKernelArithmeticExpressionValue_(self, [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, OrgGeogebraCommonKernelArithmeticExpressionNode_getLeft(self), OrgGeogebraCommonPluginOperationEnum_get_POWER(), OrgGeogebraCommonKernelArithmeticExpressionNode_getLeft(rightLeaf)) autorelease]);
        }
      }
    }
  }
    ...
    if (OrgGeogebraCommonKernelArithmeticExpressionNode_getOperation(self) == OrgGeogebraCommonPluginOperationEnum_get_SQRT()) {
      ...
      power = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, 1) autorelease], OrgGeogebraCommonPluginOperationEnum_get_DIVIDE(), right_) autorelease];
      hit = YES;
    }
    if (hit) {
      didReplacement = YES;
...
- (OrgGeogebraCommonKernelGeosGeoFunction *)buildFunctionWithOrgGeogebraCommonKernelArithmeticFunctionVariable:(OrgGeogebraCommonKernelArithmeticFunctionVariable *)fv {
  OrgGeogebraCommonKernelArithmeticFunction *tempFun = [new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionVariable_(self, fv) autorelease];
  [tempFun initFunction];
  return [new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticFunction_([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) getConstruction], tempFun) autorelease];
}
...
- (OrgGeogebraCommonKernelArithmeticExpressionNode *)derivativeWithOrgGeogebraCommonKernelArithmeticFunctionVariable:(OrgGeogebraCommonKernelArithmeticFunctionVariable *)fv
                                                                                   withOrgGeogebraCommonKernelKernel:(OrgGeogebraCommonKernelKernel *)kernel {
  {
    ...
    switch ([operation_ ordinal]) {
      ...
      case OrgGeogebraCommonPluginOperation_YCOORD:
      case OrgGeogebraCommonPluginOperation_ZCOORD:
      return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel, 0.0) autorelease];
      case OrgGeogebraCommonPluginOperation_POWER:
      if ([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(right_)) isNumberValue] && ![right_ containsWithOrgGeogebraCommonKernelArithmeticExpressionValue:fv]) {
        if (OrgGeogebraCommonKernelKernel_isZeroWithDouble_([right_ evaluateDouble])) {
          return OrgGeogebraCommonKernelArithmeticExpressionNode_wrapWithOrgGeogebraCommonKernelArithmeticExpressionValue_(self, [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel, 0.0) autorelease]);
        }
        if ([right_ isConstant]) {
          ...
          if (!OrgGeogebraCommonKernelKernel_isIntegerWithDouble_(rightDoub)) {
            ...
            if (b == 0) {
              return OrgGeogebraCommonKernelArithmeticExpressionNode_wrapWithOrgGeogebraCommonKernelArithmeticExpressionValue_(self, [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel, JavaLangDouble_NaN) autorelease]);
            }
            OrgGeogebraCommonKernelArithmeticExpressionNode *newPower = [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(OrgGeogebraCommonKernelArithmeticExpressionNode_wrapWithOrgGeogebraCommonKernelArithmeticExpressionValue_(self, [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel, a - b) autorelease]))) divideWithOrgGeogebraCommonKernelArithmeticExpressionValue:[new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel, b) autorelease]];
      ...
      return [((OrgGeogebraCommonKernelArithmeticExpressionNode *) [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel, left_, OrgGeogebraCommonPluginOperationEnum_get_COS(), nil) autorelease]) multiplyWithOrgGeogebraCommonKernelArithmeticExpressionValue:[((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk((left_))) derivativeWithOrgGeogebraCommonKernelArithmeticFunctionVariable:fv withOrgGeogebraCommonKernelKernel:kernel]];
      case OrgGeogebraCommonPluginOperation_COS:
      return [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((OrgGeogebraCommonKernelArithmeticExpressionNode *) [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel, left_, OrgGeogebraCommonPluginOperationEnum_get_SIN(), nil) autorelease]) multiplyWithOrgGeogebraCommonKernelArithmeticExpressionValue:[((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk((left_))) derivativeWithOrgGeogebraCommonKernelArithmeticFunctionVariable:fv withOrgGeogebraCommonKernelKernel:kernel]])) multiplyWithDouble:-1];
      case OrgGeogebraCommonPluginOperation_TAN:
      return [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((OrgGeogebraCommonKernelArithmeticExpressionNode *) [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel, left_, OrgGeogebraCommonPluginOperationEnum_get_SEC(), nil) autorelease]) square])) multiplyWithOrgGeogebraCommonKernelArithmeticExpressionValue:[((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk((left_))) derivativeWithOrgGeogebraCommonKernelArithmeticFunctionVariable:fv withOrgGeogebraCommonKernelKernel:kernel]];
      case OrgGeogebraCommonPluginOperation_SEC:
      return [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((OrgGeogebraCommonKernelArithmeticExpressionNode *) [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel, left_, OrgGeogebraCommonPluginOperationEnum_get_SEC(), nil) autorelease]) multiplyWithOrgGeogebraCommonKernelArithmeticExpressionValue:[new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel, left_, OrgGeogebraCommonPluginOperationEnum_get_TAN(), nil) autorelease]])) multiplyWithOrgGeogebraCommonKernelArithmeticExpressionValue:[((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk((left_))) derivativeWithOrgGeogebraCommonKernelArithmeticFunctionVariable:fv withOrgGeogebraCommonKernelKernel:kernel]];
      case OrgGeogebraCommonPluginOperation_CSC:
      return [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((OrgGeogebraCommonKernelArithmeticExpressionNode *) [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel, left_, OrgGeogebraCommonPluginOperationEnum_get_CSC(), nil) autorelease]) multiplyWithOrgGeogebraCommonKernelArithmeticExpressionValue:[new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel, left_, OrgGeogebraCommonPluginOperationEnum_get_COT(), nil) autorelease]])) multiplyWithOrgGeogebraCommonKernelArithmeticExpressionValue:[((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk((left_))) derivativeWithOrgGeogebraCommonKernelArithmeticFunctionVariable:fv withOrgGeogebraCommonKernelKernel:kernel]])) multiplyWithDouble:-1];
      case OrgGeogebraCommonPluginOperation_COT:
      return [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((OrgGeogebraCommonKernelArithmeticExpressionNode *) [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel, left_, OrgGeogebraCommonPluginOperationEnum_get_CSC(), nil) autorelease]) square])) multiplyWithOrgGeogebraCommonKernelArithmeticExpressionValue:[((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk((left_))) derivativeWithOrgGeogebraCommonKernelArithmeticFunctionVariable:fv withOrgGeogebraCommonKernelKernel:kernel]])) multiplyWithDouble:-1];
      ...
      return [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(OrgGeogebraCommonKernelArithmeticExpressionNode_wrapWithOrgGeogebraCommonKernelArithmeticExpressionValue_(self, [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel, 0) autorelease]))) divideWithOrgGeogebraCommonKernelArithmeticExpressionValue:fv];
      ...
      rtDiff = [new_OrgGeogebraCommonKernelArithmeticMyList_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
      ...
      return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel, left_, OrgGeogebraCommonPluginOperationEnum_get_IF_LIST(), rtDiff) autorelease];
      ...
      if ([left_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoFunction class]]) {
        ...
        OrgGeogebraCommonKernelArithmeticFunction *fun2 = [new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionVariable_((OrgGeogebraCommonKernelArithmeticExpressionNode *) check_class_cast(deriv, [OrgGeogebraCommonKernelArithmeticExpressionNode class]), fv2) autorelease];
        OrgGeogebraCommonKernelGeosGeoFunction *geoFun = [new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticFunction_([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel)) getConstruction], fun2) autorelease];
        OrgGeogebraCommonKernelArithmeticExpressionNode *ret = [((OrgGeogebraCommonKernelArithmeticExpressionNode *) [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel, geoFun, OrgGeogebraCommonPluginOperationEnum_get_FUNCTION(), right_) autorelease]) multiplyWithOrgGeogebraCommonKernelArithmeticExpressionValue:[((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(right_)) derivativeWithOrgGeogebraCommonKernelArithmeticFunctionVariable:fv withOrgGeogebraCommonKernelKernel:kernel]];
        return ret;
      }
      break;
...
- (OrgGeogebraCommonKernelArithmeticExpressionNode *)integralWithOrgGeogebraCommonKernelArithmeticFunctionVariable:(OrgGeogebraCommonKernelArithmeticFunctionVariable *)fv
                                                                                 withOrgGeogebraCommonKernelKernel:(OrgGeogebraCommonKernelKernel *)kernel {
  {
    ...
    switch ([operation_ ordinal]) {
      ...
      case OrgGeogebraCommonPluginOperation_YCOORD:
      case OrgGeogebraCommonPluginOperation_ZCOORD:
      return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel, self, OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY(), fv) autorelease];
      case OrgGeogebraCommonPluginOperation_POWER:
      if (left_ == fv && ![((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(right_)) containsWithOrgGeogebraCommonKernelArithmeticExpressionValue:fv]) {
        ...
        if (!JavaLangDouble_isNaNWithDouble_(index) && !JavaLangDouble_isInfiniteWithDouble_(index)) {
          if (OrgGeogebraCommonKernelKernel_isZeroWithDouble_(index + 1)) {
            return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel, left_, OrgGeogebraCommonPluginOperationEnum_get_LOG(), nil) autorelease];
          }
...
- (OrgGeogebraCommonKernelArithmeticExpressionNode *)ifElseWithOrgGeogebraCommonKernelArithmeticExpressionValue:(id<OrgGeogebraCommonKernelArithmeticExpressionValue>)ifBranch
  ...
  return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, [new_OrgGeogebraCommonKernelArithmeticMyNumberPair_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, self, ifBranch) autorelease], OrgGeogebraCommonPluginOperationEnum_get_IF_ELSE(), elseBranch) autorelease];
}
...
- (OrgGeogebraCommonKernelArithmeticExpressionNode *)applyWithOrgGeogebraCommonPluginOperationEnum:(OrgGeogebraCommonPluginOperationEnum *)operation2 {
  return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, self, operation2, nil) autorelease];
}

- (OrgGeogebraCommonKernelArithmeticExpressionNode *)applyWithOrgGeogebraCommonPluginOperationEnum:(OrgGeogebraCommonPluginOperationEnum *)operation2
                                              withOrgGeogebraCommonKernelArithmeticExpressionValue:(id<OrgGeogebraCommonKernelArithmeticExpressionValue>)arg {
  return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, self, operation2, arg) autorelease];
}
...
- (void)getFractionWithOrgGeogebraCommonKernelArithmeticExpressionValueArray:(IOSObjectArray *)parts
  ...
  switch ([operation_ ordinal]) {
    case OrgGeogebraCommonPluginOperation_MULTIPLY:
    IOSObjectArray_Set(nil_chk(parts), 0, [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(numL)) wrap])) multiplyWithOrgGeogebraCommonKernelArithmeticExpressionValue:numR]);
    IOSObjectArray_Set(parts, 1, OrgGeogebraCommonKernelArithmeticExpressionNode_multiplyCheckWithOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self, denR, denL));
    return;
    case OrgGeogebraCommonPluginOperation_DIVIDE:
    IOSObjectArray_Set(nil_chk(parts), 0, OrgGeogebraCommonKernelArithmeticExpressionNode_multiplyCheckWithOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self, denR, numL));
    IOSObjectArray_Set(parts, 1, OrgGeogebraCommonKernelArithmeticExpressionNode_multiplyCheckWithOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self, denL, numR));
    return;
    case OrgGeogebraCommonPluginOperation_PLUS:
    if (expandPlus) {
      IOSObjectArray_Set(nil_chk(parts), 0, [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(OrgGeogebraCommonKernelArithmeticExpressionNode_multiplyCheckWithOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self, denR, numL))) wrap])) plusWithOrgGeogebraCommonKernelArithmeticExpressionValue:OrgGeogebraCommonKernelArithmeticExpressionNode_multiplyCheckWithOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self, denL, numR)]);
      IOSObjectArray_Set(parts, 1, OrgGeogebraCommonKernelArithmeticExpressionNode_multiplyCheckWithOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self, denR, denL));
      return;
    }
    case OrgGeogebraCommonPluginOperation_MINUS:
    ...
    default:
    IOSObjectArray_Set(nil_chk(parts), 0, self);
    IOSObjectArray_Set(parts, 1, nil);
    return;
  }
}
...
void OrgGeogebraCommonKernelArithmeticExpressionNode_init(OrgGeogebraCommonKernelArithmeticExpressionNode *self) {
  ...
  OrgGeogebraCommonKernelArithmeticExpressionNode_set_operation_(self, OrgGeogebraCommonPluginOperationEnum_get_NO_OPERATION());
...
void OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(OrgGeogebraCommonKernelArithmeticExpressionNode *self, OrgGeogebraCommonKernelKernel *kernel, id<OrgGeogebraCommonKernelArithmeticExpressionValue> left, OrgGeogebraCommonPluginOperationEnum *operation, id<OrgGeogebraCommonKernelArithmeticExpressionValue> right) {
  ...
  self->holdsLaTeXtext_ = NO;
  self->leaf_ = NO;
  OrgGeogebraCommonKernelArithmeticExpressionNode_set_kernel_(self, kernel);
  OrgGeogebraCommonKernelArithmeticExpressionNode_set_loc_(self, [((OrgGeogebraCommonKernelKernel *) nil_chk(kernel)) getLocalization]);
  OrgGeogebraCommonKernelArithmeticExpressionNode_set_operation_(self, operation);
  ...
  if (right != nil) {
    ...
    OrgGeogebraCommonKernelArithmeticExpressionNode_setRightWithOrgGeogebraCommonKernelArithmeticExpressionValue_(self, [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel, JavaLangDouble_NaN) autorelease]);
  }
}
...
void OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_(OrgGeogebraCommonKernelArithmeticExpressionNode *self, OrgGeogebraCommonKernelArithmeticExpressionNode *node) {
  ...
  self->holdsLaTeXtext_ = NO;
  self->leaf_ = NO;
  OrgGeogebraCommonKernelArithmeticExpressionNode_set_kernel_(self, ((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(node))->kernel_);
  OrgGeogebraCommonKernelArithmeticExpressionNode_set_loc_(self, node->loc_);
  self->leaf_ = node->leaf_;
  OrgGeogebraCommonKernelArithmeticExpressionNode_set_operation_(self, node->operation_);
...
void OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withDouble_(OrgGeogebraCommonKernelArithmeticExpressionNode *self, OrgGeogebraCommonKernelKernel *kernel2, jdouble d) {
  OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self, kernel2, [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel2, d) autorelease]);
}
...
void OrgGeogebraCommonKernelArithmeticExpressionNode_setLeftWithOrgGeogebraCommonKernelArithmeticExpressionValue_(OrgGeogebraCommonKernelArithmeticExpressionNode *self, id<OrgGeogebraCommonKernelArithmeticExpressionValue> l) {
  OrgGeogebraCommonKernelArithmeticExpressionNode_set_left_(self, l);
...
void OrgGeogebraCommonKernelArithmeticExpressionNode_setRightWithOrgGeogebraCommonKernelArithmeticExpressionValue_(OrgGeogebraCommonKernelArithmeticExpressionNode *self, id<OrgGeogebraCommonKernelArithmeticExpressionValue> r) {
  OrgGeogebraCommonKernelArithmeticExpressionNode_set_right_(self, r);
  if (self->right_ != nil) {
...
void OrgGeogebraCommonKernelArithmeticExpressionNode_simplifyLeafs(OrgGeogebraCommonKernelArithmeticExpressionNode *self) {
  if ([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(self->left_)) isExpressionNode]) {
    ...
    if (node->leaf_) {
      OrgGeogebraCommonKernelArithmeticExpressionNode_set_left_(self, node->left_);
      OrgGeogebraCommonKernelArithmeticExpressionNode_simplifyLeafs(self);
    }
  }
  if (self->right_ != nil) {
    if ([self->right_ isExpressionNode]) {
      ...
      if (node->leaf_) {
        OrgGeogebraCommonKernelArithmeticExpressionNode_set_right_(self, node->left_);
        OrgGeogebraCommonKernelArithmeticExpressionNode_simplifyLeafs(self);
      }
    }
  }
...
void OrgGeogebraCommonKernelArithmeticExpressionNode_simplifyAndEvalCommands(OrgGeogebraCommonKernelArithmeticExpressionNode *self) {
  ...
  if ([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(self->left_)) isExpressionNode]) {
    ...
    OrgGeogebraCommonKernelArithmeticExpressionNode_set_left_(self, [((OrgGeogebraCommonKernelArithmeticCommand *) check_class_cast(self->left_, [OrgGeogebraCommonKernelArithmeticCommand class])) evaluateWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]);
  }
  if (self->right_ != nil) {
    if ([self->right_ isExpressionNode]) {
      ...
      OrgGeogebraCommonKernelArithmeticExpressionNode_set_right_(self, [((OrgGeogebraCommonKernelArithmeticCommand *) check_class_cast(self->right_, [OrgGeogebraCommonKernelArithmeticCommand class])) evaluateWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]);
    }
  }
}
...
void OrgGeogebraCommonKernelArithmeticExpressionNode_simplifyConstantIntegers(OrgGeogebraCommonKernelArithmeticExpressionNode *self) {
    ...
    if ([self->left_ isConstant]) {
      ...
      if ([OrgGeogebraCommonKernelArithmeticNumberValue_class_() isInstance:eval]) {
        if (OrgGeogebraCommonKernelKernel_isIntegerWithDouble_([((id<OrgGeogebraCommonKernelArithmeticNumberValue>) nil_chk(((id<OrgGeogebraCommonKernelArithmeticNumberValue>) check_protocol_cast(eval, @protocol(OrgGeogebraCommonKernelArithmeticNumberValue))))) getDouble])) {
          OrgGeogebraCommonKernelArithmeticExpressionNode_set_left_(self, eval);
        }
      }
      else {
        OrgGeogebraCommonKernelArithmeticExpressionNode_set_left_(self, eval);
  ...
  if ((self->right_ != nil) && [self->right_ isExpressionNode]) {
    ...
    if ([self->right_ isConstant]) {
      ...
      if ([OrgGeogebraCommonKernelArithmeticNumberValue_class_() isInstance:eval]) {
        if (OrgGeogebraCommonKernelKernel_isIntegerWithDouble_([((id<OrgGeogebraCommonKernelArithmeticNumberValue>) nil_chk(((id<OrgGeogebraCommonKernelArithmeticNumberValue>) check_protocol_cast(eval, @protocol(OrgGeogebraCommonKernelArithmeticNumberValue))))) getDouble])) {
          OrgGeogebraCommonKernelArithmeticExpressionNode_set_right_(self, eval);
        }
      }
      else {
        OrgGeogebraCommonKernelArithmeticExpressionNode_set_right_(self, eval);
...
void OrgGeogebraCommonKernelArithmeticExpressionNode_doResolveVariables(OrgGeogebraCommonKernelArithmeticExpressionNode *self) {
  if ([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(self->left_)) isVariable]) {
    OrgGeogebraCommonKernelArithmeticExpressionNode_set_left_(self, [((OrgGeogebraCommonKernelArithmeticVariable *) check_class_cast(self->left_, [OrgGeogebraCommonKernelArithmeticVariable class])) resolveAsExpressionValue]);
  }
  else {
  ...
  if (self->right_ != nil) {
    if ([self->right_ isVariable]) {
      OrgGeogebraCommonKernelArithmeticExpressionNode_set_right_(self, [((OrgGeogebraCommonKernelArithmeticVariable *) check_class_cast(self->right_, [OrgGeogebraCommonKernelArithmeticVariable class])) resolveAsExpressionValue]);
    }
    else {
...
jint OrgGeogebraCommonKernelArithmeticExpressionNode_replaceVariablesWithNSString_withOrgGeogebraCommonKernelArithmeticFunctionVariable_(OrgGeogebraCommonKernelArithmeticExpressionNode *self, NSString *varName, OrgGeogebraCommonKernelArithmeticFunctionVariable *fVar) {
  ...
  if ([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(self->left_)) isExpressionNode]) {
    ...
    if ([((NSString *) nil_chk(varName)) isEqual:[((OrgGeogebraCommonKernelArithmeticVariable *) check_class_cast(self->left_, [OrgGeogebraCommonKernelArithmeticVariable class])) getNameWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]]) {
      OrgGeogebraCommonKernelArithmeticExpressionNode_set_left_(self, fVar);
      replacements++;
    }
  }
  else if ([self->left_ isKindOfClass:[OrgGeogebraCommonKernelArithmeticCommand class]]) {
  ...
  if (self->right_ != nil) {
    if ([self->right_ isExpressionNode]) {
      ...
      if ([((NSString *) nil_chk(varName)) isEqual:[((OrgGeogebraCommonKernelArithmeticVariable *) check_class_cast(self->right_, [OrgGeogebraCommonKernelArithmeticVariable class])) getNameWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]]) {
        OrgGeogebraCommonKernelArithmeticExpressionNode_set_right_(self, fVar);
        replacements++;
      }
    }
...
OrgGeogebraCommonKernelArithmeticPolynomial *OrgGeogebraCommonKernelArithmeticExpressionNode_makePolynomialTreeWithOrgGeogebraCommonKernelArithmeticEquation_(OrgGeogebraCommonKernelArithmeticExpressionNode *self, OrgGeogebraCommonKernelArithmeticEquation *equ) {
  ...
  if (self->operation_ == OrgGeogebraCommonPluginOperationEnum_get_FUNCTION_NVAR()) {
    if (([OrgGeogebraCommonKernelArithmeticFunctionalNVar_class_() isInstance:self->left_]) && ([self->right_ isKindOfClass:[OrgGeogebraCommonKernelArithmeticMyList class]])) {
      ...
      if (((IOSObjectArray *) nil_chk([func getFunctionVariables]))->size_ == [((OrgGeogebraCommonKernelArithmeticMyList *) nil_chk(list)) size]) {
        ...
        @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSStringArray_(self->loc_, [IOSObjectArray arrayWithObjects:(id[]){ @"IllegalArgumentNumber" } count:1 type:NSString_class_()]) autorelease];
      }
      if ([((OrgGeogebraCommonKernelArithmeticEquation *) nil_chk(equ)) isFunctionDependent]) {
  ...
  if ([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(self->left_)) isExpressionNode]) {
    ...
    lt = [new_OrgGeogebraCommonKernelArithmeticPolynomial_initWithOrgGeogebraCommonKernelKernel_withNSString_(self->kernel_, [((OrgGeogebraCommonKernelArithmeticFunctionVariable *) check_class_cast(self->left_, [OrgGeogebraCommonKernelArithmeticFunctionVariable class])) getSetVarString]) autorelease];
  }
  else {
    lt = [new_OrgGeogebraCommonKernelArithmeticPolynomial_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticTerm_(self->kernel_, [new_OrgGeogebraCommonKernelArithmeticTerm_initWithOrgGeogebraCommonKernelArithmeticExpressionValue_withNSString_(self->left_, @"") autorelease]) autorelease];
  }
  if (self->right_ != nil) {
    if ([self->right_ isExpressionNode]) {
      ...
      rt = [new_OrgGeogebraCommonKernelArithmeticPolynomial_initWithOrgGeogebraCommonKernelKernel_withNSString_(self->kernel_, [((OrgGeogebraCommonKernelArithmeticFunctionVariable *) check_class_cast(self->right_, [OrgGeogebraCommonKernelArithmeticFunctionVariable class])) getSetVarString]) autorelease];
    }
    else {
      if ([self->right_ isKindOfClass:[OrgGeogebraCommonKernelArithmeticMyList class]]) {
        ...
        for (jint i = 0; i < [list size]; i++) {
          id<OrgGeogebraCommonKernelArithmeticExpressionValue> ev = [list getListElementWithInt:i];
          if ([ev isKindOfClass:[OrgGeogebraCommonKernelArithmeticExpressionNode class]]) {
            OrgGeogebraCommonKernelArithmeticExpressionNode_makePolynomialTreeWithOrgGeogebraCommonKernelArithmeticEquation_(nil_chk(((OrgGeogebraCommonKernelArithmeticExpressionNode *) check_class_cast(ev, [OrgGeogebraCommonKernelArithmeticExpressionNode class]))), equ);
          }
        }
      }
    ...
    switch ([operation ordinal]) {
      ...
      if ([((OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum *) nil_chk(stringType)) isEqual:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_MATHML()]) {
        ...
        switch ([stringType ordinal]) {
          ...
          break;
          default:
          [sb appendWithNSString:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_get_strIMPLIES_()];
        }
        [sb appendWithChar:' '];
      ...
      if ([((OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum *) nil_chk(stringType)) isEqual:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_MATHML()]) {
        ...
        switch ([stringType ordinal]) {
          ...
          break;
          default:
          [sb appendWithNSString:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_get_strIS_ELEMENT_OF_()];
        }
        [sb appendWithChar:' '];
        [tpl appendWithJavaLangStringBuilder:sb withNSString:rightStr withOrgGeogebraCommonKernelArithmeticExpressionValue:right withOrgGeogebraCommonPluginOperationEnum:operation];
      }
      ...
      if ([((OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum *) nil_chk(stringType)) isEqual:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_MATHML()]) {
        ...
        switch ([stringType ordinal]) {
          ...
          break;
          default:
          [sb appendWithNSString:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_get_strSET_DIFFERENCE_()];
        }
        [sb appendWithChar:' '];
      ...
      if ([((OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum *) nil_chk(stringType)) isEqual:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_MATHML()]) {
        ...
        switch ([stringType ordinal]) {
          ...
          break;
          default:
          [sb appendWithNSString:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_get_strVECTORPRODUCT_()];
        }
        [sb appendWithChar:' '];
        [tpl appendWithJavaLangStringBuilder:sb withNSString:rightStr withOrgGeogebraCommonKernelArithmeticExpressionValue:right withOrgGeogebraCommonPluginOperationEnum:operation];
      }
      ...
      if ([((OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum *) nil_chk(stringType)) isEqual:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_MATHML()]) {
        ...
        switch ([stringType ordinal]) {
          ...
          [sb appendWithNSString:OrgGeogebraCommonKernelArithmeticExpressionNode_degFixWithNSString_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonKernelKernel_(@"atan2", left, kernel)];
          [sb appendWithNSString:@"("];
          break;
          default:
          [sb appendWithNSString:@"atan2("];
      ...
      case OrgGeogebraCommonPluginOperation_EXP:
      {
        ...
        switch ([stringType ordinal]) {
          ...
          break;
          default:
          [sb appendWithNSString:OrgGeogebraCommonUtilUnicode_get_EULER_STRING_()];
      ...
      switch ([stringType ordinal]) {
        ...
        [sb appendWithNSString:leftStr];
        if ([((OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum *) nil_chk(stringType)) isEqual:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_LIBRE_OFFICE()]) [sb appendWithNSString:@"\",\""];
      ...
      switch ([stringType ordinal]) {
        ...
        [sb appendWithNSString:[((OrgGeogebraCommonMainLocalization *) nil_chk(loc)) getFunctionWithNSString:@"nroot"]];
        [sb appendWithNSString:@"("];
        [sb appendWithNSString:leftStr];
        [sb appendWithChar:','];
        [sb appendWithNSString:rightStr];
      ...
      switch ([stringType ordinal]) {
        ...
        break;
        case OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringType_LATEX:
        [sb appendWithNSString:@"\\alt \\left( "];
        [sb appendWithNSString:leftStr];
        [sb appendWithNSString:@"\\right)"];
        break;
        case OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringType_GIAC:
        [sb appendWithNSString:@"ggbalt("];
        [sb appendWithNSString:leftStr];
        [sb appendWithChar:')'];
        break;
        case OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringType_LIBRE_OFFICE:
      ...
      if (stringType != OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_GIAC() && valueForm && [OrgGeogebraCommonKernelArithmeticVectorValue_class_() isInstance:(leftEval = [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(left)) evaluateWithOrgGeogebraCommonKernelStringTemplate:tpl])]) {
        ...
        [sb appendWithNSString:[kernel formatWithDouble:IOSDoubleArray_Get(nil_chk([((id<OrgGeogebraCommonKernelArithmetic3DVector3DValue>) nil_chk(((id<OrgGeogebraCommonKernelArithmetic3DVector3DValue>) check_protocol_cast(leftEval, @protocol(OrgGeogebraCommonKernelArithmetic3DVector3DValue))))) getPointAsDouble]), 0) withOrgGeogebraCommonKernelStringTemplate:tpl]];
      }
        ...
        [sb appendWithNSString:[kernel formatWithDouble:[((OrgGeogebraCommonKernelGeosGeoLine *) nil_chk(((OrgGeogebraCommonKernelGeosGeoLine *) check_class_cast(leftEval, [OrgGeogebraCommonKernelGeosGeoLine class])))) getX] withOrgGeogebraCommonKernelStringTemplate:tpl]];
      }
      else {
        switch ([stringType ordinal]) {
          case OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringType_LATEX:
      ...
      if (stringType != OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_GIAC() && valueForm && [OrgGeogebraCommonKernelArithmeticVectorValue_class_() isInstance:leftEval]) {
        ...
        [sb appendWithNSString:[kernel formatWithDouble:IOSDoubleArray_Get(nil_chk([((id<OrgGeogebraCommonKernelArithmetic3DVector3DValue>) nil_chk(((id<OrgGeogebraCommonKernelArithmetic3DVector3DValue>) check_protocol_cast(leftEval, @protocol(OrgGeogebraCommonKernelArithmetic3DVector3DValue))))) getPointAsDouble]), 1) withOrgGeogebraCommonKernelStringTemplate:tpl]];
      }
        ...
        [sb appendWithNSString:[kernel formatWithDouble:[((OrgGeogebraCommonKernelGeosGeoLine *) nil_chk(((OrgGeogebraCommonKernelGeosGeoLine *) check_class_cast(leftEval, [OrgGeogebraCommonKernelGeosGeoLine class])))) getY] withOrgGeogebraCommonKernelStringTemplate:tpl]];
      }
      else {
        switch ([stringType ordinal]) {
          case OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringType_LATEX:
      ...
      if (stringType != OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_GIAC() && valueForm && [OrgGeogebraCommonKernelArithmetic3DVector3DValue_class_() isInstance:(leftEval = [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(left)) evaluateWithOrgGeogebraCommonKernelStringTemplate:tpl])]) {
        [sb appendWithNSString:[kernel formatWithDouble:IOSDoubleArray_Get(nil_chk([((id<OrgGeogebraCommonKernelArithmetic3DVector3DValue>) nil_chk(((id<OrgGeogebraCommonKernelArithmetic3DVector3DValue>) check_protocol_cast(leftEval, @protocol(OrgGeogebraCommonKernelArithmetic3DVector3DValue))))) getPointAsDouble]), 2) withOrgGeogebraCommonKernelStringTemplate:tpl]];
      }
      else if (valueForm && ([(leftEval = [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(left)) evaluateWithOrgGeogebraCommonKernelStringTemplate:tpl]) isKindOfClass:[OrgGeogebraCommonKernelGeosGeoLine class]])) {
        [sb appendWithNSString:[kernel formatWithDouble:[((OrgGeogebraCommonKernelGeosGeoLine *) nil_chk(((OrgGeogebraCommonKernelGeosGeoLine *) check_class_cast(leftEval, [OrgGeogebraCommonKernelGeosGeoLine class])))) getZ] withOrgGeogebraCommonKernelStringTemplate:tpl]];
      }
      else {
        switch ([stringType ordinal]) {
          case OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringType_LATEX:
      ...
      if (stringType == OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_GIAC() && [OrgGeogebraCommonKernelArithmeticListValue_class_() isInstance:right]) {
        ...
        [sb appendWithInt:[((id<OrgGeogebraCommonKernelArithmeticListValue>) nil_chk(list)) size] - 1];
        [sb appendWithChar:')'];
        break;
      }
      if ([left isKindOfClass:[OrgGeogebraCommonKernelGeosGeoFunction class]]) {
        ...
        if ([((OrgGeogebraCommonKernelGeosGeoFunction *) nil_chk(geo)) isLabelSet]) {
          if ([((OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum *) nil_chk(stringType)) isEqual:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_LIBRE_OFFICE()]) [sb appendWithNSString:@"func "];
          [sb appendWithNSString:[geo getLabelWithOrgGeogebraCommonKernelStringTemplate:tpl]];
          [sb appendWithNSString:[tpl leftBracket]];
          [sb appendWithNSString:rightStr];
          [sb appendWithNSString:[tpl rightBracket]];
        }
      ...
      break;
      case OrgGeogebraCommonPluginOperation_ELEMENT_OF:
      [sb appendWithNSString:[((OrgGeogebraCommonMainLocalization *) nil_chk(loc)) getCommandWithNSString:@"Element"]];
      [sb appendWithChar:'['];
      if ([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(left)) isGeoElement]) {
        [sb appendWithNSString:[((OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(left, [OrgGeogebraCommonKernelGeosGeoElement class])) getLabelWithOrgGeogebraCommonKernelStringTemplate:tpl]];
      }
      else {
        [sb appendWithNSString:leftStr];
      }
      [sb appendWithNSString:@", "];
      [sb appendWithNSString:[((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk([((OrgGeogebraCommonKernelArithmeticMyList *) nil_chk(((OrgGeogebraCommonKernelArithmeticMyList *) check_class_cast(right, [OrgGeogebraCommonKernelArithmeticMyList class])))) getListElementWithInt:0])) toStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
      [sb appendWithChar:']'];
      break;
      case OrgGeogebraCommonPluginOperation_FUNCTION_NVAR:
      if (valueForm) {
        if (([OrgGeogebraCommonKernelArithmeticFunctionalNVar_class_() isInstance:left]) && ([right isKindOfClass:[OrgGeogebraCommonKernelArithmeticMyList class]])) {
          ...
          [sb appendWithNSString:OrgGeogebraCommonKernelArithmeticExpressionNode_toValueStringWithOrgGeogebraCommonKernelStringTemplate_(nil_chk(en), tpl)];
      ...
      break;
      case OrgGeogebraCommonPluginOperation_FREEHAND:
      [sb appendWithNSString:[((OrgGeogebraCommonMainLocalization *) nil_chk(loc)) getPlainWithNSString:@"Function.freehand"]];
      [sb appendWithChar:'('];
      [sb appendWithNSString:leftStr];
      [sb appendWithChar:')'];
      break;
      ...
      if ([tpl isPrintLocalizedCommandNames]) {
        [sb appendWithNSString:[((OrgGeogebraCommonMainLocalization *) nil_chk(loc)) getCommandWithNSString:@"DataFunction"]];
      }
      else {
        [sb appendWithNSString:@"DataFunction"];
      }
      [sb appendWithChar:'['];
      ...
      if (stringType == OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_LATEX()) {
        ...
        [sb appendWithNSString:@"}^{"];
        [sb appendWithNSString:[((OrgGeogebraCommonKernelArithmeticMyNumberPair *) nil_chk(((OrgGeogebraCommonKernelArithmeticMyNumberPair *) check_class_cast(right, [OrgGeogebraCommonKernelArithmeticMyNumberPair class]))))->y_ toStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
        [sb appendWithNSString:@"}"];
        [sb appendWithNSString:[((OrgGeogebraCommonKernelArithmeticMyNumberPair *) nil_chk(((OrgGeogebraCommonKernelArithmeticMyNumberPair *) check_class_cast(left, [OrgGeogebraCommonKernelArithmeticMyNumberPair class]))))->x_ toStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
      }
      else if (stringType == OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_LIBRE_OFFICE()) {
      ...
      if (stringType == OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_GIAC()) {
        ...
        if ([tpl isPrintLocalizedCommandNames]) {
          [sb appendWithNSString:[((OrgGeogebraCommonMainLocalization *) nil_chk(loc)) getCommandWithNSString:@"If"]];
        }
        else {
      ...
      case OrgGeogebraCommonPluginOperation_IF_LIST:
      if (stringType == OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_GIAC()) {
        [sb appendWithNSString:[((OrgGeogebraCommonMainLocalization *) nil_chk(loc)) getCommandWithNSString:@"piecewise("]];
      }
      ...
      [sb appendWithNSString:stringType == OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_GIAC() ? @")" : @"]"];
      break;
      default:
  ...
  if ([((OrgGeogebraCommonKernelStringTemplate *) nil_chk(tpl)) hasTypeWithOrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_MATHML()]) {
    ...
    switch ([[tpl getStringType] ordinal]) {
      ...
      if ([((OrgGeogebraCommonMainApp *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel)) getApplication])) isLatexMathQuillStyleWithOrgGeogebraCommonKernelStringTemplate:tpl]) {
        ...
        [sb appendWithNSString:[((OrgGeogebraCommonMainLocalization *) nil_chk(loc)) getFunctionWithNSString:key]];
        [sb appendWithNSString:@"}"];
      }
      else {
      ...
      default:
      if ([tpl isPrintLocalizedCommandNames]) {
        [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:[((OrgGeogebraCommonMainLocalization *) nil_chk(loc)) getFunctionWithNSString:key]];
      }
      else {
...
OrgGeogebraCommonKernelArithmeticExpressionNode *OrgGeogebraCommonKernelArithmeticExpressionNode_wrapWithDouble_(OrgGeogebraCommonKernelArithmeticExpressionNode *self, jdouble n) {
  return [((OrgGeogebraCommonKernelArithmeticMyDouble *) [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, n) autorelease]) wrap];
}
...
id<OrgGeogebraCommonKernelArithmeticExpressionValue> OrgGeogebraCommonKernelArithmeticExpressionNode_multiplySpecialWithOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonKernelKernel_withBoolean_(id<OrgGeogebraCommonKernelArithmeticExpressionValue> ret, id<OrgGeogebraCommonKernelArithmeticExpressionValue> f, OrgGeogebraCommonKernelKernel *kernel, jboolean giacParsing) {
  ...
  if ([ret isKindOfClass:[OrgGeogebraCommonKernelArithmeticVariable class]]) {
    ...
    if (op != nil && [kernel lookupLabelWithNSString:leftImg] == nil && ![@"x" isEqual:leftImg] && ![@"y" isEqual:leftImg] && ![@"z" isEqual:leftImg]) {
      return [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel, f, op, nil) autorelease];
    }
  }
    ...
    if (op != nil && [kernel lookupLabelWithNSString:leftImg] == nil && ![@"x" isEqual:leftImg] && ![@"y" isEqual:leftImg] && ![@"z" isEqual:leftImg]) {
      ...
      return [((OrgGeogebraCommonKernelArithmeticExpressionNode *) [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel, f, op, nil) autorelease]) powerWithOrgGeogebraCommonKernelArithmeticExpressionValue:exponent];
    }
  }
    ...
    return bf == nil ? nil : [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel, OrgGeogebraCommonKernelArithmeticExpressionNode_getLeft(nil_chk(((OrgGeogebraCommonKernelArithmeticExpressionNode *) check_class_cast(ret, [OrgGeogebraCommonKernelArithmeticExpressionNode class])))), OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY(), bf) autorelease];
  }
  if (giacParsing) {
    if ([ret isKindOfClass:[OrgGeogebraCommonKernelArithmeticVariable class]]) {
