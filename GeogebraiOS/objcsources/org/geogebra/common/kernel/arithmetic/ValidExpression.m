...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/arithmetic/ValidExpression.java
//
...
- (NSString *)toAssignmentStringWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl
  ...
  [sb appendWithNSString:[self toStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
...
- (NSString *)toAssignmentLaTeXStringWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl
  ...
  switch ([assignmentType ordinal]) {
    case OrgGeogebraCommonKernelArithmeticAssignmentType_DEFAULT:
    [sb appendWithNSString:[((OrgGeogebraCommonKernelStringTemplate *) nil_chk(tpl)) printVariableNameWithNSString:[self getLabelForAssignment]]];
  ...
  [sb appendWithNSString:[self toLaTeXStringWithBoolean:YES withOrgGeogebraCommonKernelStringTemplate:tpl]];
  return [sb description];
}
...
- (jboolean)containsFunctionVariable {
  return [self inspectWithOrgGeogebraCommonKernelArithmeticInspecting:[new_OrgGeogebraCommonKernelArithmeticValidExpression_$1_init() autorelease]];
}

- (jboolean)containsFunctionVariableWithNSString:(NSString *)name {
  return [self inspectWithOrgGeogebraCommonKernelArithmeticInspecting:[new_OrgGeogebraCommonKernelArithmeticValidExpression_$2_initWithNSString_(name) autorelease]];
}
...
void OrgGeogebraCommonKernelArithmeticValidExpression_initLabels(OrgGeogebraCommonKernelArithmeticValidExpression *self) {
  if (self->labels_ == nil) OrgGeogebraCommonKernelArithmeticValidExpression_setAndConsume_labels_(self, new_JavaUtilVector_init());
}
...
NSString *OrgGeogebraCommonKernelArithmeticValidExpression_debugStringWithOrgGeogebraCommonKernelArithmeticExpressionValue_(id<OrgGeogebraCommonKernelArithmeticExpressionValue> s) {
  ...
  if ([s isKindOfClass:[OrgGeogebraCommonKernelArithmeticCommand class]]) {
    ...
    [sb appendWithNSString:[((OrgGeogebraCommonKernelArithmeticCommand *) nil_chk(((OrgGeogebraCommonKernelArithmeticCommand *) check_class_cast(s, [OrgGeogebraCommonKernelArithmeticCommand class])))) getName]];
...
void OrgGeogebraCommonKernelArithmeticValidExpression_$2_initWithNSString_(OrgGeogebraCommonKernelArithmeticValidExpression_$2 *self, NSString *capture$0) {
  OrgGeogebraCommonKernelArithmeticValidExpression_$2_set_val$name_(self, capture$0);
  NSObject_init(self);
}
