...
- (OrgGeogebraCommonKernelArithmeticFunctionNVar *)deepCopyWithOrgGeogebraCommonKernelKernel:(OrgGeogebraCommonKernelKernel *)kernel1 {
  return new_OrgGeogebraCommonKernelArithmeticFunctionNVar_initWithOrgGeogebraCommonKernelArithmeticFunctionNVar_withOrgGeogebraCommonKernelKernel_(self, kernel1);
}
...
- (JavaLangStringBuilder *)appendVarStringWithJavaLangStringBuilder:(JavaLangStringBuilder *)sb
  ...
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(fVars_))->size_ - 1; i++) {
    (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:[((OrgGeogebraCommonKernelArithmeticFunctionVariable *) nil_chk(IOSObjectArray_Get(fVars_, i))) toStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
    (void) [sb appendWithNSString:@", "];
  }
  (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:[((OrgGeogebraCommonKernelArithmeticFunctionVariable *) nil_chk(IOSObjectArray_Get(fVars_, fVars_->size_ - 1))) toStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
  return sb;
}
...
- (jboolean)initFunction {
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(fVars_))->size_; i++) {
    ...
    (void) [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(expression_)) traverseWithOrgGeogebraCommonKernelArithmeticTraversing:s];
...
- (OrgGeogebraCommonKernelArithmeticFunctionNVar *)evalCasCommandWithNSString:(NSString *)ggbCasCmd
  ...
  if (casEvalExpression_ != expression_ || (symbolic && casEvalStringSymbolic_ == nil)) {
    casEvalExpression_ = expression_;
    if (symbolic) {
      casEvalStringSymbolic_ = [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(expression_)) getCASstringWithOrgGeogebraCommonKernelStringTemplate:tpl withBoolean:YES];
    }
  ...
  @try {
    ...
    (void) [sb appendWithNSString:[self getVarStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]];
    (void) [sb appendWithNSString:@") = "];
  ...
  if (useCaching && resultFun != nil) {
    (void) [((OrgGeogebraCommonUtilMaxSizeHashMap *) nil_chk(OrgGeogebraCommonKernelArithmeticFunctionNVar_getCasEvalMap(self))) putWithId:casString withId:resultFun];
  }
  return resultFun;
}
...
- (NSString *)getLabelForAssignment {
  JavaLangStringBuilder *sb = new_JavaLangStringBuilder_init();
  (void) [sb appendWithNSString:[self getLabel]];
  (void) [sb appendWithNSString:@"("];
  (void) [sb appendWithNSString:[self getVarStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]];
  (void) [sb appendWithNSString:@")"];
...
- (jboolean)initIneqsWithOrgGeogebraCommonKernelArithmeticExpressionNode:(OrgGeogebraCommonKernelArithmeticExpressionNode *)fe
                     withOrgGeogebraCommonKernelArithmeticFunctionalNVar:(id<OrgGeogebraCommonKernelArithmeticFunctionalNVar>)functional {
  if (ineqs_ == nil || fe == OrgGeogebraCommonKernelArithmeticFunctionNVar_getExpression(self)) ineqs_ = new_OrgGeogebraCommonKernelArithmeticIneqTree_init();
...
- (jdouble)evaluateWithOrgGeogebraCommonKernelGeosGeoPoint:(OrgGeogebraCommonKernelGeosGeoPoint *)pt {
  if (((IOSObjectArray *) nil_chk(fVars_))->size_ == 1 && [@"y" isEqual:[((OrgGeogebraCommonKernelArithmeticFunctionVariable *) nil_chk(IOSObjectArray_Get(fVars_, 0))) toStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]]) return OrgGeogebraCommonKernelArithmeticFunctionNVar_evaluateWithDoubleArray_(self, [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ ((OrgGeogebraCommonKernelGeosGeoPoint *) nil_chk(pt))->y_ / pt->z_ } count:1]);
  return OrgGeogebraCommonKernelArithmeticFunctionNVar_evaluateWithDoubleArray_(self, [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ ((OrgGeogebraCommonKernelGeosGeoPoint *) nil_chk(pt))->x_ / pt->z_, pt->y_ / pt->z_ } count:2]);
}
...
- (jboolean)evaluateBooleanWithOrgGeogebraCommonKernelGeosGeoPoint:(OrgGeogebraCommonKernelGeosGeoPoint *)pt {
  ...
  return OrgGeogebraCommonKernelArithmeticFunctionNVar_evaluateBooleanWithDoubleArray_(self, [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ ((OrgGeogebraCommonKernelGeosGeoPoint *) nil_chk(pt))->x_ / pt->z_, pt->y_ / pt->z_ } count:2]);
}
...
- (void)matrixTransformWithDouble:(jdouble)a00
  ...
  OrgGeogebraCommonKernelArithmeticExpressionNode *dummy = new_OrgGeogebraCommonKernelArithmeticExpressionNode_init();
  (void) [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(expression_)) replaceWithOrgGeogebraCommonKernelArithmeticExpressionValue:IOSObjectArray_Get(nil_chk(fVars_), 0) withOrgGeogebraCommonKernelArithmeticExpressionValue:dummy])) wrap];
  OrgGeogebraCommonKernelArithmeticMyDouble *ma00 = new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, a00);
  OrgGeogebraCommonKernelArithmeticMyDouble *ma01 = new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, a01);
  OrgGeogebraCommonKernelArithmeticMyDouble *ma10 = new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, a10);
  OrgGeogebraCommonKernelArithmeticMyDouble *ma11 = new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, a11);
  OrgGeogebraCommonKernelArithmeticExpressionNode *newX = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, ma00, OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY(), IOSObjectArray_Get(fVars_, 0)) plusWithOrgGeogebraCommonKernelArithmeticExpressionValue:new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, ma01, OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY(), IOSObjectArray_Get(fVars_, 1))];
  OrgGeogebraCommonKernelArithmeticExpressionNode *newY = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, ma10, OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY(), IOSObjectArray_Get(fVars_, 0)) plusWithOrgGeogebraCommonKernelArithmeticExpressionValue:new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, ma11, OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY(), IOSObjectArray_Get(fVars_, 1))];
  expression_ = [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk([expression_ replaceWithOrgGeogebraCommonKernelArithmeticExpressionValue:IOSObjectArray_Get(fVars_, 1) withOrgGeogebraCommonKernelArithmeticExpressionValue:newY])) wrap];
  expression_ = [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(expression_)) replaceWithOrgGeogebraCommonKernelArithmeticExpressionValue:dummy withOrgGeogebraCommonKernelArithmeticExpressionValue:newX])) wrap];
...
- (void)matrixTransformWithDouble:(jdouble)a00
  ...
  OrgGeogebraCommonKernelArithmeticExpressionNode *dummy = new_OrgGeogebraCommonKernelArithmeticExpressionNode_init();
  expression_ = [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(expression_)) replaceWithOrgGeogebraCommonKernelArithmeticExpressionValue:IOSObjectArray_Get(nil_chk(fVars_), 0) withOrgGeogebraCommonKernelArithmeticExpressionValue:dummy])) wrap];
  ...
  IOSObjectArray *mbTrans = [IOSObjectArray newArrayWithDimensions:2 lengths:(jint[]){ 3, 3 } type:OrgGeogebraCommonKernelArithmeticMyDouble_class_()];
  for (jint i = 0; i < 3; i++) for (jint j = 0; j < 3; j++) (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(mbTrans, i)), j, new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, IOSDoubleArray_Get(nil_chk(IOSObjectArray_Get(nil_chk(b), j)), i)));
  OrgGeogebraCommonKernelArithmeticExpressionNode *newZ = [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(mbTrans, 2)), 0), OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY(), IOSObjectArray_Get(fVars_, 0)) plusWithOrgGeogebraCommonKernelArithmeticExpressionValue:new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(mbTrans, 2)), 1), OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY(), IOSObjectArray_Get(fVars_, 1))])) plusWithOrgGeogebraCommonKernelArithmeticExpressionValue:IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(mbTrans, 2)), 2)];
  OrgGeogebraCommonKernelArithmeticExpressionNode *newX = [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(mbTrans, 0)), 0), OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY(), IOSObjectArray_Get(fVars_, 0)) plusWithOrgGeogebraCommonKernelArithmeticExpressionValue:new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(mbTrans, 0)), 1), OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY(), IOSObjectArray_Get(fVars_, 1))])) plusWithOrgGeogebraCommonKernelArithmeticExpressionValue:IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(mbTrans, 0)), 2)];
  OrgGeogebraCommonKernelArithmeticExpressionNode *newY = [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(mbTrans, 1)), 0), OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY(), IOSObjectArray_Get(fVars_, 0)) plusWithOrgGeogebraCommonKernelArithmeticExpressionValue:new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(mbTrans, 1)), 1), OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY(), IOSObjectArray_Get(fVars_, 1))])) plusWithOrgGeogebraCommonKernelArithmeticExpressionValue:IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(mbTrans, 1)), 2)];
  expression_ = [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(expression_)) replaceWithOrgGeogebraCommonKernelArithmeticExpressionValue:IOSObjectArray_Get(fVars_, 1) withOrgGeogebraCommonKernelArithmeticExpressionValue:[((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(newY)) divideWithOrgGeogebraCommonKernelArithmeticExpressionValue:newZ]])) wrap];
...
- (id<OrgGeogebraCommonKernelArithmeticExpressionValue>)traverseWithOrgGeogebraCommonKernelArithmeticTraversing:(id<OrgGeogebraCommonKernelArithmeticTraversing>)t {
  ...
  expression_ = [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(expression_)) traverseWithOrgGeogebraCommonKernelArithmeticTraversing:t])) wrap];
  return self;
}
...
- (OrgGeogebraCommonKernelArithmeticFunctionNVar *)getDerivativeNoCASWithOrgGeogebraCommonKernelArithmeticFunctionVariable:(OrgGeogebraCommonKernelArithmeticFunctionVariable *)fv
  ...
  return new_OrgGeogebraCommonKernelArithmeticFunctionNVar_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionVariableArray_(expDeriv, fVars_);
}
...
- (void)fillVariablesWithOrgGeogebraCommonKernelArithmeticFunctionVariableArray:(IOSObjectArray *)oldVars {
  ...
  IOSObjectArray *newVars = [IOSObjectArray newArrayWithLength:length type:OrgGeogebraCommonKernelArithmeticFunctionVariable_class_()];
  JavaUtilTreeSet *usedNames = new_JavaUtilTreeSet_init();
  for (jint i = 0; i < fVars_->size_; i++) {
    (void) IOSObjectArray_Set(newVars, i, IOSObjectArray_Get(fVars_, i));
  ...
  for (jint i = 0; i < oldVars->size_ && pos < length; i++) {
    if (![usedNames containsWithId:[((OrgGeogebraCommonKernelArithmeticFunctionVariable *) nil_chk(IOSObjectArray_Get(oldVars, i))) toStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]]) {
      (void) IOSObjectArray_Set(newVars, pos, IOSObjectArray_Get(oldVars, i));
      pos++;
    }
  }
  fVars_ = newVars;
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonKernelArithmeticFunctionNVar class]) {
    OrgGeogebraCommonKernelArithmeticFunctionNVar_undecided_ = new_JavaUtilArrayList_init();
...
void OrgGeogebraCommonKernelArithmeticFunctionNVar_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_(OrgGeogebraCommonKernelArithmeticFunctionNVar *self, OrgGeogebraCommonKernelArithmeticExpressionNode *expression) {
  ...
  self->kernel_ = [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(expression)) getKernel];
...
void OrgGeogebraCommonKernelArithmeticFunctionNVar_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionVariableArray_(OrgGeogebraCommonKernelArithmeticFunctionNVar *self, OrgGeogebraCommonKernelArithmeticExpressionNode *exp, IOSObjectArray *fVars) {
  ...
  self->isBooleanFunction__ = NO;
  self->isConstantFunction__ = NO;
  self->kernel_ = [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(exp)) getKernel];
...
void OrgGeogebraCommonKernelArithmeticFunctionNVar_initWithOrgGeogebraCommonKernelArithmeticFunctionNVar_withOrgGeogebraCommonKernelKernel_(OrgGeogebraCommonKernelArithmeticFunctionNVar *self, OrgGeogebraCommonKernelArithmeticFunctionNVar *f, OrgGeogebraCommonKernelKernel *kernel) {
  ...
  self->isBooleanFunction__ = NO;
  self->isConstantFunction__ = NO;
  self->expression_ = [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(((OrgGeogebraCommonKernelArithmeticFunctionNVar *) nil_chk(f))->expression_)) getCopyWithOrgGeogebraCommonKernelKernel:kernel];
...
jboolean OrgGeogebraCommonKernelArithmeticFunctionNVar_initTypeWithOrgGeogebraCommonKernelArithmeticExpressionValue_(OrgGeogebraCommonKernelArithmeticFunctionNVar *self, id<OrgGeogebraCommonKernelArithmeticExpressionValue> ev) {
  if ([OrgGeogebraCommonKernelArithmeticBooleanValue_class_() isInstance:ev]) {
    ...
    self->expression_ = OrgGeogebraCommonKernelArithmeticFunctionNVar_getExpression(nil_chk(((OrgGeogebraCommonKernelArithmeticFunctionNVar *) check_class_cast(ev, [OrgGeogebraCommonKernelArithmeticFunctionNVar class]))));
    self->fVars_ = [((OrgGeogebraCommonKernelArithmeticFunctionNVar *) nil_chk(((OrgGeogebraCommonKernelArithmeticFunctionNVar *) check_class_cast(ev, [OrgGeogebraCommonKernelArithmeticFunctionNVar class])))) getFunctionVariables];
  }
  else if ([ev isKindOfClass:[OrgGeogebraCommonKernelGeosGeoFunction class]]) {
    self->expression_ = [((OrgGeogebraCommonKernelGeosGeoFunction *) nil_chk(((OrgGeogebraCommonKernelGeosGeoFunction *) check_class_cast(ev, [OrgGeogebraCommonKernelGeosGeoFunction class])))) getFunctionExpression];
    self->fVars_ = [((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk([((OrgGeogebraCommonKernelGeosGeoFunction *) nil_chk(((OrgGeogebraCommonKernelGeosGeoFunction *) check_class_cast(ev, [OrgGeogebraCommonKernelGeosGeoFunction class])))) getFunction])) getFunctionVariables];
  }
  else {
    return NO;
  }
...
OrgGeogebraCommonUtilMaxSizeHashMap *OrgGeogebraCommonKernelArithmeticFunctionNVar_getCasEvalMap(OrgGeogebraCommonKernelArithmeticFunctionNVar *self) {
  if (self->casEvalMap_ == nil) {
    self->casEvalMap_ = new_OrgGeogebraCommonUtilMaxSizeHashMap_initWithInt_(OrgGeogebraCommonKernelArithmeticFunctionNVar_MAX_CAS_EVAL_MAP_SIZE);
  }
...
jboolean OrgGeogebraCommonKernelArithmeticFunctionNVar_initIneqsWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionalNVar_withOrgGeogebraCommonKernelArithmeticIneqTree_withBoolean_(OrgGeogebraCommonKernelArithmeticFunctionNVar *self, OrgGeogebraCommonKernelArithmeticExpressionNode *fe, id<OrgGeogebraCommonKernelArithmeticFunctionalNVar> functional, OrgGeogebraCommonKernelArithmeticIneqTree *tree, jboolean negate) {
  ...
  if ([((OrgGeogebraCommonPluginOperationEnum *) nil_chk(op)) isEqual:OrgGeogebraCommonPluginOperationEnum_get_GREATER()] || [op isEqual:OrgGeogebraCommonPluginOperationEnum_get_GREATER_EQUAL()] || [op isEqual:OrgGeogebraCommonPluginOperationEnum_get_LESS()] || [op isEqual:OrgGeogebraCommonPluginOperationEnum_get_LESS_EQUAL()]) {
    ...
    [tree setLeftWithOrgGeogebraCommonKernelArithmeticIneqTree:new_OrgGeogebraCommonKernelArithmeticIneqTree_init()];
    [tree setRightWithOrgGeogebraCommonKernelArithmeticIneqTree:new_OrgGeogebraCommonKernelArithmeticIneqTree_init()];
    ...
    for (jint i = 0; i < ((IOSObjectArray *) nil_chk(subVars))->size_; i++) (void) [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(subExpr)) replaceWithOrgGeogebraCommonKernelArithmeticExpressionValue:IOSObjectArray_Get(subVars, i) withOrgGeogebraCommonKernelArithmeticExpressionValue:[((OrgGeogebraCommonKernelArithmeticMyList *) nil_chk(((OrgGeogebraCommonKernelArithmeticMyList *) check_class_cast([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(rightTree)) getLeft], [OrgGeogebraCommonKernelArithmeticMyList class])))) getListElementWithInt:i]];
