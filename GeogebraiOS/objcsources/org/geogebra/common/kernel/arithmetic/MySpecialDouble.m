...
- (id<OrgGeogebraCommonKernelArithmeticExpressionValue>)deepCopyWithOrgGeogebraCommonKernelKernel:(OrgGeogebraCommonKernelKernel *)kernel1 {
  ...
  OrgGeogebraCommonKernelArithmeticMySpecialDouble *ret = new_OrgGeogebraCommonKernelArithmeticMySpecialDouble_initWithOrgGeogebraCommonKernelArithmeticMySpecialDouble_(self);
  ret->kernel_ = kernel1;
  return ret;
}
...
void OrgGeogebraCommonKernelArithmeticMySpecialDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_withNSString_(OrgGeogebraCommonKernelArithmeticMySpecialDouble *self, OrgGeogebraCommonKernelKernel *kernel, jdouble val, NSString *str) {
  (void) OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self, kernel, val);
  self->scientificNotation_ = NO;
  self->originalString_ = OrgGeogebraCommonUtilStringUtil_cannonicNumberWithNSString_(str);
  self->strToString_ = self->originalString_;
  if (self->strToString_ == nil) self->strToString_ = @"0";
  ...
  if (self->keepOriginalString_) {
    JavaMathBigDecimal *bd = new_JavaMathBigDecimal_initWithNSString_(self->strToString_);
    jdouble absVal = JavaLangMath_absWithDouble_(val);
    if (absVal >= 10E-3 && absVal < 10E7) {
      bd = [bd stripTrailingZeros];
      self->strToString_ = [((JavaMathBigDecimal *) nil_chk(bd)) toPlainString];
    }
    else {
      self->strToString_ = OrgGeogebraCommonKernelArithmeticMyDouble_toStringWithJavaMathBigDecimal_(bd);
...
void OrgGeogebraCommonKernelArithmeticMySpecialDouble_initWithOrgGeogebraCommonKernelArithmeticMySpecialDouble_(OrgGeogebraCommonKernelArithmeticMySpecialDouble *self, OrgGeogebraCommonKernelArithmeticMySpecialDouble *sd) {
  (void) OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelArithmeticMyDouble_(self, sd);
  self->scientificNotation_ = NO;
  self->originalString_ = ((OrgGeogebraCommonKernelArithmeticMySpecialDouble *) nil_chk(sd))->originalString_;
  self->strToString_ = sd->strToString_;
...
OrgGeogebraCommonKernelArithmeticMySpecialDouble *OrgGeogebraCommonKernelArithmeticMySpecialDouble_getEulerConstantWithOrgGeogebraCommonKernelKernel_(OrgGeogebraCommonKernelKernel *kernel) {
  ...
  if (OrgGeogebraCommonKernelArithmeticMySpecialDouble_eulerConstant_ == nil) {
    OrgGeogebraCommonKernelArithmeticMySpecialDouble_eulerConstant_ = new_OrgGeogebraCommonKernelArithmeticMySpecialDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_withNSString_(kernel, JavaLangMath_E, OrgGeogebraCommonUtilUnicode_get_EULER_STRING_());
  }
