...
void OrgGeogebraCommonKernelArithmeticSymbolicPolyFunction_initWithInt_(OrgGeogebraCommonKernelArithmeticSymbolicPolyFunction *self, jint degree) {
  ...
  OrgGeogebraCommonKernelArithmeticSymbolicPolyFunction_setAndConsume_symbCoeffs_(self, [IOSObjectArray newArrayWithLength:degree + 1 type:OrgGeogebraCommonKernelArithmeticExpressionNode_class_()]);
}
...
void OrgGeogebraCommonKernelArithmeticSymbolicPolyFunction_initWithOrgGeogebraCommonKernelArithmeticExpressionNodeArray_(OrgGeogebraCommonKernelArithmeticSymbolicPolyFunction *self, IOSObjectArray *coeff) {
  OrgGeogebraCommonKernelArithmeticPolyFunction_initWithInt_(self, ((IOSObjectArray *) nil_chk(coeff))->size_ - 1);
  OrgGeogebraCommonKernelArithmeticSymbolicPolyFunction_set_symbCoeffs_(self, coeff);
}
