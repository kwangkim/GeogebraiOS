...
void OrgGeogebraCommonKernelArithmeticMyNumberPair_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonKernelArithmeticExpressionValue_(OrgGeogebraCommonKernelArithmeticMyNumberPair *self, OrgGeogebraCommonKernelKernel *kernel, id<OrgGeogebraCommonKernelArithmeticExpressionValue> en, id<OrgGeogebraCommonKernelArithmeticExpressionValue> en2) {
  (void) OrgGeogebraCommonKernelArithmeticMyVecNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self, kernel, en, en2);
}
...
NSString *OrgGeogebraCommonKernelArithmeticMyNumberPair_toStringWithOrgGeogebraCommonKernelStringTemplate_(OrgGeogebraCommonKernelArithmeticMyNumberPair *self, OrgGeogebraCommonKernelStringTemplate *tpl) {
  ...
  (void) [sb appendWithNSString:[((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(self->x_)) toStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
  (void) [sb appendWithNSString:@", "];
  (void) [sb appendWithNSString:[((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(self->y_)) toStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
...
NSString *OrgGeogebraCommonKernelArithmeticMyNumberPair_toValueStringWithOrgGeogebraCommonKernelStringTemplate_(OrgGeogebraCommonKernelArithmeticMyNumberPair *self, OrgGeogebraCommonKernelStringTemplate *tpl) {
  JavaLangStringBuilder *sb = new_JavaLangStringBuilder_init();
  (void) [sb appendWithNSString:[((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(self->x_)) toValueStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
  (void) [sb appendWithNSString:@", "];
  (void) [sb appendWithNSString:[((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(self->y_)) toValueStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
  return [sb description];
}
