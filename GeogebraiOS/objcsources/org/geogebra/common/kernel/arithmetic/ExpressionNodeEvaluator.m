...
- (id<OrgGeogebraCommonKernelArithmeticExpressionValue>)handleXcoordWithOrgGeogebraCommonKernelArithmeticExpressionValue:(id<OrgGeogebraCommonKernelArithmeticExpressionValue>)arg
  ...
  if ([OrgGeogebraCommonKernelArithmeticVectorValue_class_() isInstance:arg]) {
    ...
    return [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, IOSDoubleArray_Get(nil_chk([((id<OrgGeogebraCommonKernelArithmetic3DVector3DValue>) nil_chk(((id<OrgGeogebraCommonKernelArithmetic3DVector3DValue>) check_protocol_cast(arg, @protocol(OrgGeogebraCommonKernelArithmetic3DVector3DValue))))) getPointAsDouble]), 0)) autorelease];
  }
  else if ([arg isKindOfClass:[OrgGeogebraCommonKernelGeosGeoLine class]]) {
    return [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, ((OrgGeogebraCommonKernelGeosGeoLine *) nil_chk(((OrgGeogebraCommonKernelGeosGeoLine *) check_class_cast(arg, [OrgGeogebraCommonKernelGeosGeoLine class]))))->x_) autorelease];
  }
...
- (id<OrgGeogebraCommonKernelArithmeticExpressionValue>)handleYcoordWithOrgGeogebraCommonKernelArithmeticExpressionValue:(id<OrgGeogebraCommonKernelArithmeticExpressionValue>)arg
  ...
  if ([OrgGeogebraCommonKernelArithmeticVectorValue_class_() isInstance:arg]) {
    ...
    return [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, IOSDoubleArray_Get(nil_chk([((id<OrgGeogebraCommonKernelArithmetic3DVector3DValue>) nil_chk(((id<OrgGeogebraCommonKernelArithmetic3DVector3DValue>) check_protocol_cast(arg, @protocol(OrgGeogebraCommonKernelArithmetic3DVector3DValue))))) getPointAsDouble]), 1)) autorelease];
  }
  else if ([arg isKindOfClass:[OrgGeogebraCommonKernelGeosGeoLine class]]) {
    return [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, ((OrgGeogebraCommonKernelGeosGeoLine *) nil_chk(((OrgGeogebraCommonKernelGeosGeoLine *) check_class_cast(arg, [OrgGeogebraCommonKernelGeosGeoLine class]))))->y_) autorelease];
  }
...
- (id<OrgGeogebraCommonKernelArithmeticExpressionValue>)innerProductWithOrgGeogebraCommonKernelArithmeticVectorNDValue:(id<OrgGeogebraCommonKernelArithmeticVectorNDValue>)ev1
                                                                    withOrgGeogebraCommonKernelArithmeticVectorNDValue:(id<OrgGeogebraCommonKernelArithmeticVectorNDValue>)ev2
                                                                                     withOrgGeogebraCommonKernelKernel:(OrgGeogebraCommonKernelKernel *)kernel {
  OrgGeogebraCommonKernelArithmeticMyDouble *num = [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_(kernel) autorelease];
...
- (id<OrgGeogebraCommonKernelArithmeticExpressionValue>)handlePlusWithOrgGeogebraCommonKernelArithmeticExpressionValue:(id<OrgGeogebraCommonKernelArithmeticExpressionValue>)lt
  ...
  if ([OrgGeogebraCommonKernelArithmeticNumberValue_class_() isInstance:lt] && [OrgGeogebraCommonKernelArithmeticNumberValue_class_() isInstance:rt]) {
    ...
    @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSStringArray_(l10n_, str) autorelease];
  }
}
...
- (id<OrgGeogebraCommonKernelArithmeticExpressionValue>)handleDivideWithOrgGeogebraCommonKernelArithmeticExpressionValue:(id<OrgGeogebraCommonKernelArithmeticExpressionValue>)lt
  ...
  if ([OrgGeogebraCommonKernelArithmeticNumberValue_class_() isInstance:rt]) {
    if ([OrgGeogebraCommonKernelArithmeticNumberValue_class_() isInstance:lt]) {
      ...
      str = [IOSObjectArray arrayWithObjects:(id[]){ @"IllegalDivision", [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(lt)) toStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelArithmeticExpressionNodeEvaluator_errorTemplate_], @"/", [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(rt)) toStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelArithmeticExpressionNodeEvaluator_errorTemplate_] } count:4 type:NSString_class_()];
      @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSStringArray_(l10n_, str) autorelease];
    }
  }
  else if ([OrgGeogebraCommonKernelArithmeticVectorValue_class_() isInstance:lt] && [OrgGeogebraCommonKernelArithmeticVectorValue_class_() isInstance:rt]) {
...
- (id<OrgGeogebraCommonKernelArithmeticExpressionValue>)handleMinusWithOrgGeogebraCommonKernelArithmeticExpressionValue:(id<OrgGeogebraCommonKernelArithmeticExpressionValue>)lt
  ...
  if ([OrgGeogebraCommonKernelArithmeticNumberValue_class_() isInstance:lt] && [OrgGeogebraCommonKernelArithmeticNumberValue_class_() isInstance:rt]) {
    ...
    str = [IOSObjectArray arrayWithObjects:(id[]){ @"IllegalSubtraction", [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(lt)) toStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelArithmeticExpressionNodeEvaluator_errorTemplate_], @"-", [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(rt)) toStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelArithmeticExpressionNodeEvaluator_errorTemplate_] } count:4 type:NSString_class_()];
...
- (id<OrgGeogebraCommonKernelArithmeticExpressionValue>)handlePowerWithOrgGeogebraCommonKernelArithmeticExpressionValue:(id<OrgGeogebraCommonKernelArithmeticExpressionValue>)lt
  ...
  if ([OrgGeogebraCommonKernelArithmeticNumberValue_class_() isInstance:lt] && [OrgGeogebraCommonKernelArithmeticNumberValue_class_() isInstance:rt]) {
    ...
    str = [IOSObjectArray arrayWithObjects:(id[]){ @"IllegalExponent", [lt toStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelArithmeticExpressionNodeEvaluator_errorTemplate_], @"^", [rt toStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelArithmeticExpressionNodeEvaluator_errorTemplate_] } count:4 type:NSString_class_()];
    @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSStringArray_(l10n_, str) autorelease];
  }
}
...
- (id<OrgGeogebraCommonKernelArithmeticExpressionValue>)handleFunctionWithOrgGeogebraCommonKernelArithmeticExpressionValue:(id<OrgGeogebraCommonKernelArithmeticExpressionValue>)lt
    ...
    if ([OrgGeogebraCommonKernelArithmeticEvaluatable_class_() isInstance:lt]) {
      ...
      if ([lt isKindOfClass:[OrgGeogebraCommonKernelGeosGeoFunction class]]) {
        ...
        if ([((OrgGeogebraCommonKernelArithmeticFunctionNVar *) nil_chk(fun)) isBooleanFunction]) {
          return [new_OrgGeogebraCommonKernelArithmeticMyBoolean_initWithOrgGeogebraCommonKernelKernel_withBoolean_(kernel_, [fun evaluateBooleanWithOrgGeogebraCommonKernelGeosGeoPoint:pt]) autorelease];
        }
        return [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, [fun evaluateWithOrgGeogebraCommonKernelGeosGeoPoint:pt]) autorelease];
      }
      else if ([OrgGeogebraCommonKernelGeosGeoFunctionable_class_() isInstance:lt]) {
        return [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, [((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk([((OrgGeogebraCommonKernelGeosGeoFunction *) nil_chk([((id<OrgGeogebraCommonKernelGeosGeoFunctionable>) nil_chk(((id<OrgGeogebraCommonKernelGeosGeoFunctionable>) check_protocol_cast(lt, @protocol(OrgGeogebraCommonKernelGeosGeoFunctionable))))) getGeoFunction])) getFunction])) evaluateWithOrgGeogebraCommonKernelGeosGeoPoint:pt]) autorelease];
      }
      else {
  ...
  str = [IOSObjectArray arrayWithObjects:(id[]){ @"IllegalArgument", [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(rt)) toStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelArithmeticExpressionNodeEvaluator_errorTemplate_] } count:2 type:NSString_class_()];
  @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSStringArray_(l10n_, str) autorelease];
}
...
- (id<OrgGeogebraCommonKernelArithmeticExpressionValue>)handleFunctionNVarWithOrgGeogebraCommonKernelArithmeticExpressionValue:(id<OrgGeogebraCommonKernelArithmeticExpressionValue>)lt
    ...
    if ([((OrgGeogebraCommonKernelArithmeticFunctionNVar *) nil_chk(funN)) getVarNumber] == [((id<OrgGeogebraCommonKernelArithmeticListValue>) nil_chk(list)) size]) {
      ...
      if (args != nil) {
        if ([funN isBooleanFunction]) {
          return [new_OrgGeogebraCommonKernelArithmeticMyBoolean_initWithOrgGeogebraCommonKernelKernel_withBoolean_(kernel_, [funN evaluateBooleanWithDoubleArray:args]) autorelease];
        }
        return [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, [funN evaluateWithDoubleArray:args]) autorelease];
      }
      return lt;
    }
    else if ([list size] == 1) {
      ...
      if (([funN getVarNumber] == 2) && ([ev isKindOfClass:[OrgGeogebraCommonKernelGeosGeoPoint class]])) {
        ...
        if ([funN isBooleanFunction]) {
          return [new_OrgGeogebraCommonKernelArithmeticMyBoolean_initWithOrgGeogebraCommonKernelKernel_withBoolean_(kernel_, [funN evaluateBooleanWithOrgGeogebraCommonKernelGeosGeoPoint:pt]) autorelease];
        }
        return [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, [funN evaluateWithOrgGeogebraCommonKernelGeosGeoPoint:pt]) autorelease];
      }
        ...
        IOSDoubleArray *vals = [IOSDoubleArray arrayWithDoubles:(jdouble[]){ [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk([((OrgGeogebraCommonKernelArithmeticMyVecNode *) nil_chk(pt)) getX])) evaluateDouble], [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk([pt getY])) evaluateDouble] } count:2];
        if ([funN isBooleanFunction]) {
          return [new_OrgGeogebraCommonKernelArithmeticMyBoolean_initWithOrgGeogebraCommonKernelKernel_withBoolean_(kernel_, [funN evaluateBooleanWithDoubleArray:vals]) autorelease];
        }
        return [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, [funN evaluateWithDoubleArray:vals]) autorelease];
      }
  ...
  IOSObjectArray *str3 = [IOSObjectArray arrayWithObjects:(id[]){ @"IllegalArgument", [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(rt)) toStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelArithmeticExpressionNodeEvaluator_errorTemplate_] } count:2 type:NSString_class_()];
  @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSStringArray_(l10n_, str3) autorelease];
}
...
- (id<OrgGeogebraCommonKernelArithmeticExpressionValue>)illegalBooleanWithOrgGeogebraCommonKernelArithmeticExpressionValue:(id<OrgGeogebraCommonKernelArithmeticExpressionValue>)arg
  ...
  IOSObjectArray *str = [IOSObjectArray arrayWithObjects:(id[]){ @"IllegalBoolean", opname, [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(arg)) toStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelArithmeticExpressionNodeEvaluator_errorTemplate_] } count:3 type:NSString_class_()];
  @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSStringArray_(l10n_, str) autorelease];
}
...
- (id<OrgGeogebraCommonKernelArithmeticExpressionValue>)illegalArgumentWithOrgGeogebraCommonKernelArithmeticExpressionValue:(id<OrgGeogebraCommonKernelArithmeticExpressionValue>)arg {
  IOSObjectArray *str = [IOSObjectArray arrayWithObjects:(id[]){ @"IllegalArgument", [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(arg)) toStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelArithmeticExpressionNodeEvaluator_errorTemplate_] } count:2 type:NSString_class_()];
  @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSStringArray_(l10n_, str) autorelease];
}
...
- (id<OrgGeogebraCommonKernelArithmeticExpressionValue>)illegalComparisonWithOrgGeogebraCommonKernelArithmeticExpressionValue:(id<OrgGeogebraCommonKernelArithmeticExpressionValue>)lt
                                                                         withOrgGeogebraCommonKernelArithmeticExpressionValue:(id<OrgGeogebraCommonKernelArithmeticExpressionValue>)rt
                                                                                                                 withNSString:(NSString *)opname {
  IOSObjectArray *str = [IOSObjectArray arrayWithObjects:(id[]){ @"IllegalComparison", [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(lt)) toStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelArithmeticExpressionNodeEvaluator_errorTemplate_], opname, [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(rt)) toStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelArithmeticExpressionNodeEvaluator_errorTemplate_] } count:4 type:NSString_class_()];
  @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSStringArray_(l10n_, str) autorelease];
}
...
- (id<OrgGeogebraCommonKernelArithmeticExpressionValue>)illegalListOpWithOrgGeogebraCommonKernelArithmeticExpressionValue:(id<OrgGeogebraCommonKernelArithmeticExpressionValue>)lt
                                                                     withOrgGeogebraCommonKernelArithmeticExpressionValue:(id<OrgGeogebraCommonKernelArithmeticExpressionValue>)rt
                                                                                                             withNSString:(NSString *)opname {
  IOSObjectArray *str = [IOSObjectArray arrayWithObjects:(id[]){ @"IllegalListOperation", [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(lt)) toStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelArithmeticExpressionNodeEvaluator_errorTemplate_], opname, [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(rt)) toStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelArithmeticExpressionNodeEvaluator_errorTemplate_] } count:4 type:NSString_class_()];
  @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSStringArray_(l10n_, str) autorelease];
}
...
- (id<OrgGeogebraCommonKernelArithmeticExpressionValue>)polynomialOrDieWithOrgGeogebraCommonKernelArithmeticExpressionValue:(id<OrgGeogebraCommonKernelArithmeticExpressionValue>)lt
  ...
  IOSObjectArray *strings = [IOSObjectArray arrayWithObjects:(id[]){ @"IllegalArgument", prefix, [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(lt)) toStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelArithmeticExpressionNodeEvaluator_errorTemplate_], suffix } count:4 type:NSString_class_()];
  @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSStringArray_(l10n_, strings) autorelease];
}
...
- (id<OrgGeogebraCommonKernelArithmeticExpressionValue>)vectorProductWithOrgGeogebraCommonKernelArithmeticVectorNDValue:(id<OrgGeogebraCommonKernelArithmeticVectorNDValue>)v1
  ...
  OrgGeogebraCommonKernelArithmeticMyDouble *num = [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_(kernel_) autorelease];
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonKernelArithmeticExpressionNodeEvaluator class]) {
    JreStrongAssign(&OrgGeogebraCommonKernelArithmeticExpressionNodeEvaluator_errorTemplate_, nil, OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_());
...
void OrgGeogebraCommonKernelArithmeticExpressionNodeEvaluator_initWithOrgGeogebraCommonMainLocalization_withOrgGeogebraCommonKernelKernel_(OrgGeogebraCommonKernelArithmeticExpressionNodeEvaluator *self, OrgGeogebraCommonMainLocalization *l10n, OrgGeogebraCommonKernelKernel *kernel) {
  NSObject_init(self);
  OrgGeogebraCommonKernelArithmeticExpressionNodeEvaluator_set_l10n_(self, l10n);
  OrgGeogebraCommonKernelArithmeticExpressionNodeEvaluator_set_kernel_(self, kernel);
}
...
OrgGeogebraCommonKernelArithmeticMyBoolean *OrgGeogebraCommonKernelArithmeticExpressionNodeEvaluator_evalEqualsWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonKernelArithmeticExpressionValue_(OrgGeogebraCommonKernelKernel *kernel, id<OrgGeogebraCommonKernelArithmeticExpressionValue> lt, id<OrgGeogebraCommonKernelArithmeticExpressionValue> rt) {
  ...
  if ([OrgGeogebraCommonKernelArithmeticBooleanValue_class_() isInstance:lt] && [OrgGeogebraCommonKernelArithmeticBooleanValue_class_() isInstance:rt]) {
    ...
    if ((strL == nil) || (strR == nil)) {
      return [new_OrgGeogebraCommonKernelArithmeticMyBoolean_initWithOrgGeogebraCommonKernelKernel_withBoolean_(kernel, NO) autorelease];
    }
    return [new_OrgGeogebraCommonKernelArithmeticMyBoolean_initWithOrgGeogebraCommonKernelKernel_withBoolean_(kernel, [((NSString *) nil_chk(strL)) isEqual:strR]) autorelease];
  }
    ...
    return [new_OrgGeogebraCommonKernelArithmeticMyBoolean_initWithOrgGeogebraCommonKernelKernel_withBoolean_(kernel, YES) autorelease];
  }
    ...
    return [new_OrgGeogebraCommonKernelArithmeticMyBoolean_initWithOrgGeogebraCommonKernelKernel_withBoolean_(kernel, [geo1 isEqualWithOrgGeogebraCommonKernelGeosGeoElement:geo2]) autorelease];
  }
  else if ([OrgGeogebraCommonKernelArithmeticVectorValue_class_() isInstance:lt] && [OrgGeogebraCommonKernelArithmeticVectorValue_class_() isInstance:rt]) {
    ...
    return [new_OrgGeogebraCommonKernelArithmeticMyBoolean_initWithOrgGeogebraCommonKernelKernel_withBoolean_(kernel, [((OrgGeogebraCommonKernelGeosGeoVec2D *) nil_chk([vec1 getVector])) isEqualWithOrgGeogebraCommonKernelGeosGeoVec2D:[((id<OrgGeogebraCommonKernelArithmeticVectorValue>) nil_chk(vec2)) getVector]]) autorelease];
  }
