...
- (OrgGeogebraCommonKernelArithmeticFunction *)deepCopyWithOrgGeogebraCommonKernelKernel:(OrgGeogebraCommonKernelKernel *)kernel1 {
  return [new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticFunction_withOrgGeogebraCommonKernelKernel_(self, kernel1) autorelease];
}
...
- (void)setExpressionWithOrgGeogebraCommonKernelArithmeticExpressionNode:(OrgGeogebraCommonKernelArithmeticExpressionNode *)exp
  ...
  [super setExpressionWithOrgGeogebraCommonKernelArithmeticExpressionNode:exp withOrgGeogebraCommonKernelArithmeticFunctionVariableArray:[IOSObjectArray arrayWithObjects:(id[]){ var } count:1 type:OrgGeogebraCommonKernelArithmeticFunctionVariable_class_()]];
  OrgGeogebraCommonKernelArithmeticFunction_set_derivative__(self, nil);
}
...
- (jboolean)initFunction {
  if (fVars_ == nil) {
    OrgGeogebraCommonKernelArithmeticFunctionNVar_setAndConsume_fVars_(self, [IOSObjectArray newArrayWithObjects:(id[]){ [new_OrgGeogebraCommonKernelArithmeticFunctionVariable_initWithOrgGeogebraCommonKernelKernel_(kernel_) autorelease] } count:1 type:OrgGeogebraCommonKernelArithmeticFunctionVariable_class_()]);
  }
...
- (void)translateWithDouble:(jdouble)vx
  ...
  if (!OrgGeogebraCommonKernelKernel_isZeroWithDouble_(vx)) {
    if (isLeaf && left == IOSObjectArray_Get(nil_chk(fVars_), 0)) {
      OrgGeogebraCommonKernelArithmeticFunctionNVar_set_expression_(self, OrgGeogebraCommonKernelArithmeticFunction_shiftXnodeWithDouble_(self, vx));
    }
    else {
...
- (JavaUtilLinkedList *)getSymbolicPolynomialFactorsWithBoolean:(jboolean)rootFindingSimplification
  ...
  if (factorParentExp_ != expression_) {
    OrgGeogebraCommonKernelArithmeticFunction_set_factorParentExp_(self, expression_);
    if (symbolicPolyFactorList_ == nil) OrgGeogebraCommonKernelArithmeticFunction_setAndConsume_symbolicPolyFactorList_(self, new_JavaUtilLinkedList_init());
...
- (OrgGeogebraCommonKernelArithmeticPolyFunction *)expandToPolyFunctionWithOrgGeogebraCommonKernelArithmeticExpressionValue:(id<OrgGeogebraCommonKernelArithmeticExpressionValue>)ev
  ...
  if ([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(ev)) isExpressionNode]) {
    ...
    node = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, ev) autorelease];
  }
  ...
  if (symbolic) {
    OrgGeogebraCommonKernelArithmeticSymbolicPolyFunction *symbPolyFun = [new_OrgGeogebraCommonKernelArithmeticSymbolicPolyFunction_initWithInt_(degree) autorelease];
    IOSObjectArray *symbCoeffs = [symbPolyFun getSymbolicCoeffs];
    for (jint i = 0; i < strCoeffs->size_; i++) {
      IOSObjectArray_Set(nil_chk(symbCoeffs), degree - i, OrgGeogebraCommonKernelArithmeticFunction_evaluateToExpressionNodeWithNSString_(self, IOSObjectArray_Get(strCoeffs, i)));
  ...
  @try {
    OrgGeogebraCommonKernelArithmeticPolyFunction *polyFun = [new_OrgGeogebraCommonKernelArithmeticPolyFunction_initWithInt_(degree) autorelease];
    for (jint i = 0; i < strCoeffs->size_; i++) {
...
- (OrgGeogebraCommonKernelGeosGeoFunction *)getGeoDerivativeWithInt:(jint)n {
  if (geoDeriv_ == nil) OrgGeogebraCommonKernelArithmeticFunction_setAndConsume_geoDeriv_(self, new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) getConstruction]));
  OrgGeogebraCommonKernelArithmeticFunction *deriv = OrgGeogebraCommonKernelArithmeticFunction_getDerivativeWithInt_withBoolean_(self, n, NO);
...
- (id<OrgGeogebraCommonKernelRootsRealRootDerivFunction>)getRealRootDerivFunction {
  ...
  return [new_OrgGeogebraCommonKernelArithmeticFunction_DerivFunction_initWithOrgGeogebraCommonKernelArithmeticFunction_withOrgGeogebraCommonKernelArithmeticFunction_withOrgGeogebraCommonKernelArithmeticFunction_(self, self, deriv) autorelease];
}
...
- (OrgGeogebraCommonKernelGeosGeoFunction *)getGeoFunction {
  OrgGeogebraCommonKernelGeosGeoFunction *gf = [new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) getConstruction]) autorelease];
...
- (IOSDoubleArray *)evaluateDerivFuncWithDouble:(jdouble)x {
  ...
  *IOSDoubleArray_GetRef(ret, 0) = [self evaluateWithDouble:x];
  ...
  if (derivative__ == nil) {
    OrgGeogebraCommonKernelArithmeticFunction_set_derivative__(self, OrgGeogebraCommonKernelArithmeticFunction_getDerivativeWithInt_withBoolean_withBoolean_(self, 1, NO, YES));
  }
...
void OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_(OrgGeogebraCommonKernelArithmeticFunction *self, OrgGeogebraCommonKernelArithmeticExpressionNode *expression) {
  ...
  OrgGeogebraCommonKernelArithmeticFunction_setAndConsume_zeroExpr_(self, new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self->kernel_, [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, 0) autorelease]));
}
...
void OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionVariable_(OrgGeogebraCommonKernelArithmeticFunction *self, OrgGeogebraCommonKernelArithmeticExpressionNode *exp, OrgGeogebraCommonKernelArithmeticFunctionVariable *fVar) {
  OrgGeogebraCommonKernelArithmeticFunctionNVar_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionVariableArray_(self, exp, [IOSObjectArray arrayWithObjects:(id[]){ fVar } count:1 type:OrgGeogebraCommonKernelArithmeticFunctionVariable_class_()]);
  OrgGeogebraCommonKernelArithmeticFunction_setAndConsume_zeroExpr_(self, new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self->kernel_, [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, 0) autorelease]));
}
...
void OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelKernel_(OrgGeogebraCommonKernelArithmeticFunction *self, OrgGeogebraCommonKernelKernel *kernel) {
  ...
  OrgGeogebraCommonKernelArithmeticFunction_setAndConsume_zeroExpr_(self, new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self->kernel_, [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, 0) autorelease]));
  OrgGeogebraCommonKernelArithmeticFunctionNVar_setAndConsume_fVars_(self, [IOSObjectArray newArrayWithLength:1 type:OrgGeogebraCommonKernelArithmeticFunctionVariable_class_()]);
}
...
void OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticFunction_withOrgGeogebraCommonKernelKernel_(OrgGeogebraCommonKernelArithmeticFunction *self, OrgGeogebraCommonKernelArithmeticFunction *f, OrgGeogebraCommonKernelKernel *kernel) {
  OrgGeogebraCommonKernelArithmeticFunctionNVar_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_(self, [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk(f))->expression_)) getCopyWithOrgGeogebraCommonKernelKernel:kernel]);
  OrgGeogebraCommonKernelArithmeticFunction_setAndConsume_zeroExpr_(self, new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self->kernel_, [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, 0) autorelease]));
...
OrgGeogebraCommonKernelArithmeticExpressionNode *OrgGeogebraCommonKernelArithmeticFunction_shiftXnodeWithDouble_(OrgGeogebraCommonKernelArithmeticFunction *self, jdouble xShift) {
  ...
  OrgGeogebraCommonKernelArithmeticExpressionNode *node;
  if (vx > 0) {
    node = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self->kernel_, IOSObjectArray_Get(nil_chk(self->fVars_), 0), OrgGeogebraCommonPluginOperationEnum_get_MINUS(), [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, vx) autorelease]) autorelease];
  }
  else {
    node = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self->kernel_, IOSObjectArray_Get(nil_chk(self->fVars_), 0), OrgGeogebraCommonPluginOperationEnum_get_PLUS(), [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, -vx) autorelease]) autorelease];
  }
  return node;
}
...
void OrgGeogebraCommonKernelArithmeticFunction_translateYWithDouble_(OrgGeogebraCommonKernelArithmeticFunction *self, jdouble vy) {
  if ([[((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(self->expression_)) getRight] isKindOfClass:[OrgGeogebraCommonKernelArithmeticMyDouble class]]) {
    ...
    switch ([[self->expression_ getOperation] ordinal]) {
      ...
      if (OrgGeogebraCommonKernelKernel_isZeroWithDouble_(temp)) {
        OrgGeogebraCommonKernelArithmeticFunctionNVar_set_expression_(self, [self->expression_ getLeftTree]);
      }
      else if (temp < 0) {
      ...
      temp = OrgGeogebraCommonKernelKernel_checkDecimalFractionWithDouble_([((OrgGeogebraCommonKernelArithmeticMyDouble *) nil_chk(num)) getDouble] - vy);
      if (OrgGeogebraCommonKernelKernel_isZeroWithDouble_(temp)) {
        OrgGeogebraCommonKernelArithmeticFunctionNVar_set_expression_(self, [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(self->expression_)) getLeftTree]);
      }
      else if (temp < 0) {
...
void OrgGeogebraCommonKernelArithmeticFunction_addNumberWithDouble_(OrgGeogebraCommonKernelArithmeticFunction *self, jdouble n) {
  if (n > 0) {
    OrgGeogebraCommonKernelArithmeticFunctionNVar_setAndConsume_expression_(self, new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self->kernel_, self->expression_, OrgGeogebraCommonPluginOperationEnum_get_PLUS(), [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, n) autorelease]));
  }
  else {
    OrgGeogebraCommonKernelArithmeticFunctionNVar_setAndConsume_expression_(self, new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self->kernel_, self->expression_, OrgGeogebraCommonPluginOperationEnum_get_MINUS(), [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, -n) autorelease]));
  }
}
...
JavaUtilLinkedList *OrgGeogebraCommonKernelArithmeticFunction_getNumericPolynomialFactorsWithBoolean_(OrgGeogebraCommonKernelArithmeticFunction *self, jboolean rootFindingSimplification) {
  if (self->numericPolyFactorList_ == nil) OrgGeogebraCommonKernelArithmeticFunction_setAndConsume_numericPolyFactorList_(self, new_JavaUtilLinkedList_init());
...
OrgGeogebraCommonKernelArithmeticPolyFunction *OrgGeogebraCommonKernelArithmeticFunction_expandToPolyFunctionNoCasWithOrgGeogebraCommonKernelArithmeticExpressionValue_withBoolean_(OrgGeogebraCommonKernelArithmeticFunction *self, id<OrgGeogebraCommonKernelArithmeticExpressionValue> ev, jboolean symbolic) {
  ...
  OrgGeogebraCommonKernelArithmeticFunctionVariable *xVar = [new_OrgGeogebraCommonKernelArithmeticFunctionVariable_initWithOrgGeogebraCommonKernelKernel_withNSString_(self->kernel_, @"x") autorelease];
  ...
  if (!symbolic) {
    ...
    polyFun = [new_OrgGeogebraCommonKernelArithmeticPolyFunction_initWithDoubleArray_(coeffValues) autorelease];
  }
  else {
    IOSObjectArray *coeffExpr = [IOSObjectArray arrayWithLength:terms type:OrgGeogebraCommonKernelArithmeticExpressionNode_class_()];
    for (jint i = 0; i < ((IOSObjectArray *) nil_chk(coeff))->size_; i++) {
      IOSObjectArray_Set(coeffExpr, i, IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(coeff, i)), 0) == nil ? self->zeroExpr_ : [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self->kernel_, IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(coeff, i)), 0)) autorelease]);
    }
    polyFun = [new_OrgGeogebraCommonKernelArithmeticSymbolicPolyFunction_initWithOrgGeogebraCommonKernelArithmeticExpressionNodeArray_(coeffExpr) autorelease];
  }
  return polyFun;
}
...
OrgGeogebraCommonKernelArithmeticFunction *OrgGeogebraCommonKernelArithmeticFunction_getDerivativeWithInt_withBoolean_withBoolean_(OrgGeogebraCommonKernelArithmeticFunction *self, jint n, jboolean keepFractions, jboolean fast) {
  ...
  if (polyDeriv != nil) {
    jboolean factor = [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([self getExpression])) inspectWithOrgGeogebraCommonKernelArithmeticInspecting:[new_OrgGeogebraCommonKernelArithmeticFunction_$1_init() autorelease]];
    if (factor) {
...
void OrgGeogebraCommonKernelArithmeticFunction_differenceWithOrgGeogebraCommonKernelArithmeticFunction_withOrgGeogebraCommonKernelArithmeticFunction_withOrgGeogebraCommonKernelArithmeticFunction_(OrgGeogebraCommonKernelArithmeticFunction *a, OrgGeogebraCommonKernelArithmeticFunction *b, OrgGeogebraCommonKernelArithmeticFunction *c) {
  ...
  [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(right)) replaceWithOrgGeogebraCommonKernelArithmeticExpressionValue:IOSObjectArray_Get(nil_chk(b->fVars_), 0) withOrgGeogebraCommonKernelArithmeticExpressionValue:IOSObjectArray_Get(a->fVars_, 0)];
...
void OrgGeogebraCommonKernelArithmeticFunction_differenceWithOrgGeogebraCommonKernelArithmeticFunction_withOrgGeogebraCommonKernelGeosGeoLine_withOrgGeogebraCommonKernelArithmeticFunction_(OrgGeogebraCommonKernelArithmeticFunction *f, OrgGeogebraCommonKernelGeosGeoLine *line, OrgGeogebraCommonKernelArithmeticFunction *c) {
  ...
  IOSObjectArray_Set(nil_chk(c->fVars_), 0, IOSObjectArray_Get(((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk(f))->fVars_, 0));
}
...
void OrgGeogebraCommonKernelArithmeticFunction_DerivFunction_initWithOrgGeogebraCommonKernelArithmeticFunction_withOrgGeogebraCommonKernelArithmeticFunction_withOrgGeogebraCommonKernelArithmeticFunction_(OrgGeogebraCommonKernelArithmeticFunction_DerivFunction *self, OrgGeogebraCommonKernelArithmeticFunction *outer$, OrgGeogebraCommonKernelArithmeticFunction *fun, OrgGeogebraCommonKernelArithmeticFunction *derivative) {
  NSObject_init(self);
  OrgGeogebraCommonKernelArithmeticFunction_DerivFunction_setAndConsume_ret_(self, [IOSDoubleArray newArrayWithLength:2]);
  OrgGeogebraCommonKernelArithmeticFunction_DerivFunction_set_fun_(self, fun);
  OrgGeogebraCommonKernelArithmeticFunction_DerivFunction_set_derivative_(self, derivative);
}
