...
- (void)appendWithNSString:(NSString *)str {
  (void) [((JavaLangStringBuilder *) nil_chk(sb_)) appendWithNSString:str];
}

- (void)insertWithInt:(jint)pos
         withNSString:(NSString *)str {
  (void) [((JavaLangStringBuilder *) nil_chk(sb_)) insertWithInt:pos withNSString:str];
}

- (NSString *)toStringWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  JavaLangStringBuilder *temp = new_JavaLangStringBuilder_init();
  (void) [temp appendWithNSString:@"\""];
  (void) [temp appendWithJavaLangCharSequence:sb_];
  (void) [temp appendWithNSString:@"\""];
...
- (NSString *)toOutputValueStringWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  JavaLangStringBuffer *sb2 = new_JavaLangStringBuffer_initWithInt_([((JavaLangStringBuilder *) nil_chk(sb_)) length] + 2);
  (void) [sb2 appendWithChar:'"'];
  (void) [sb2 appendWithJavaLangCharSequence:sb_];
  (void) [sb2 appendWithChar:'"'];
...
- (OrgGeogebraCommonKernelArithmeticMyStringBuffer *)getText {
  return new_OrgGeogebraCommonKernelArithmeticMyStringBuffer_initWithOrgGeogebraCommonKernelKernel_withNSString_(kernel_, [((JavaLangStringBuilder *) nil_chk(sb_)) description]);
}
...
void OrgGeogebraCommonKernelArithmeticMyStringBuffer_initWithOrgGeogebraCommonKernelKernel_withNSString_(OrgGeogebraCommonKernelArithmeticMyStringBuffer *self, OrgGeogebraCommonKernelKernel *kernel, NSString *str) {
  ...
  self->sb_ = new_JavaLangStringBuilder_initWithNSString_(str);
  self->kernel_ = kernel;
}
