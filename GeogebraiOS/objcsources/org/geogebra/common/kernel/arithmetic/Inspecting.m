...
+ (void)initialize {
  if (self == [OrgGeogebraCommonKernelArithmeticInspecting class]) {
    JreStrongAssignAndConsume(&OrgGeogebraCommonKernelArithmeticInspecting_dynamicGeosFinder_, nil, new_OrgGeogebraCommonKernelArithmeticInspecting_$1_init());
    JreStrongAssignAndConsume(&OrgGeogebraCommonKernelArithmeticInspecting_textFinder_, nil, new_OrgGeogebraCommonKernelArithmeticInspecting_$2_init());
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonKernelArithmeticInspecting_UnplottableChecker class]) {
    JreStrongAssignAndConsume(&OrgGeogebraCommonKernelArithmeticInspecting_UnplottableChecker_checker_, nil, new_OrgGeogebraCommonKernelArithmeticInspecting_UnplottableChecker_init());
