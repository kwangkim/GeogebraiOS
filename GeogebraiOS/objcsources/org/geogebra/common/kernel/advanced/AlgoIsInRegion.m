...
- (void)setInputOutput {
  ...
  IOSObjectArray_Set(input_, 0, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(pi_, [OrgGeogebraCommonKernelGeosGeoElement class]));
  IOSObjectArray_Set(input_, 1, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(region_, [OrgGeogebraCommonKernelGeosGeoElement class]));
...
void OrgGeogebraCommonKernelAdvancedAlgoIsInRegion_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelRegion_(OrgGeogebraCommonKernelAdvancedAlgoIsInRegion *self, OrgGeogebraCommonKernelConstruction *c, NSString *label, id<OrgGeogebraCommonKernelKernelNDGeoPointND> pi, id<OrgGeogebraCommonKernelRegion> region) {
  ...
  OrgGeogebraCommonKernelAdvancedAlgoIsInRegion_set_pi_(self, pi);
  OrgGeogebraCommonKernelAdvancedAlgoIsInRegion_set_region_(self, region);
  OrgGeogebraCommonKernelAdvancedAlgoIsInRegion_setAndConsume_result_(self, new_OrgGeogebraCommonKernelGeosGeoBoolean_initWithOrgGeogebraCommonKernelConstruction_(self->cons_));
  [self setInputOutput];
  [self compute];
