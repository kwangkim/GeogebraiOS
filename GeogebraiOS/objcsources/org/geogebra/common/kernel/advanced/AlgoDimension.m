...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/advanced/AlgoDimension.java
//
...
void OrgGeogebraCommonKernelAdvancedAlgoDimension_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoList_(OrgGeogebraCommonKernelAdvancedAlgoDimension *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelGeosGeoList *geoList) {
  ...
  OrgGeogebraCommonKernelAdvancedAlgoDimension_set_list_(self, geoList);
  OrgGeogebraCommonKernelAdvancedAlgoDimension_setAndConsume_firstDimension_(self, new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(cons));
  self->matrix_ = [((OrgGeogebraCommonKernelGeosGeoList *) nil_chk(self->list_)) isMatrix];
  if (self->matrix_) {
    OrgGeogebraCommonKernelAdvancedAlgoDimension_setAndConsume_matrixDimension_(self, new_OrgGeogebraCommonKernelGeosGeoList_initWithOrgGeogebraCommonKernelConstruction_(cons));
    OrgGeogebraCommonKernelAdvancedAlgoDimension_setAndConsume_secondDimension_(self, new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(cons));
...
void OrgGeogebraCommonKernelAdvancedAlgoDimension_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoElement_(OrgGeogebraCommonKernelAdvancedAlgoDimension *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelGeosGeoElement *geoList) {
  OrgGeogebraCommonKernelAlgosAlgoElement_initWithOrgGeogebraCommonKernelConstruction_(self, cons);
  OrgGeogebraCommonKernelAdvancedAlgoDimension_set_point_(self, geoList);
  OrgGeogebraCommonKernelAdvancedAlgoDimension_setAndConsume_firstDimension_(self, new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(cons));
  self->matrix_ = NO;
  [self setInputOutput];
  [self compute];
