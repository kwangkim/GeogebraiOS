...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/kernel/advanced/CmdAreParallel.java
//
...
@implementation OrgGeogebraCommonKernelAdvancedCmdAreParallel

- (instancetype)initWithOrgGeogebraCommonKernelKernel:(OrgGeogebraCommonKernelKernel *)kernel {
  OrgGeogebraCommonKernelAdvancedCmdAreParallel_initWithOrgGeogebraCommonKernelKernel_(self, kernel);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithOrgGeogebraCommonKernelKernel:", "CmdAreParallel", NULL, 0x1, NULL, NULL },
  ...
  static const J2ObjcClassInfo _OrgGeogebraCommonKernelAdvancedCmdAreParallel = { 2, "CmdAreParallel", "org.geogebra.common.kernel.advanced", NULL, 0x1, 2, methods, 0, NULL, 0, NULL, 0, NULL, NULL, NULL };
  return &_OrgGeogebraCommonKernelAdvancedCmdAreParallel;
}

@end

void OrgGeogebraCommonKernelAdvancedCmdAreParallel_initWithOrgGeogebraCommonKernelKernel_(OrgGeogebraCommonKernelAdvancedCmdAreParallel *self, OrgGeogebraCommonKernelKernel *kernel) {
  (void) OrgGeogebraCommonKernelCommandsCommandProcessor_initWithOrgGeogebraCommonKernelKernel_(self, kernel);
}

OrgGeogebraCommonKernelAdvancedCmdAreParallel *new_OrgGeogebraCommonKernelAdvancedCmdAreParallel_initWithOrgGeogebraCommonKernelKernel_(OrgGeogebraCommonKernelKernel *kernel) {
  OrgGeogebraCommonKernelAdvancedCmdAreParallel *self = [OrgGeogebraCommonKernelAdvancedCmdAreParallel alloc];
  OrgGeogebraCommonKernelAdvancedCmdAreParallel_initWithOrgGeogebraCommonKernelKernel_(self, kernel);
  return self;
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgGeogebraCommonKernelAdvancedCmdAreParallel)
