...
void OrgGeogebraCommonKernelAdvancedAlgoVerticalText_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoText_(OrgGeogebraCommonKernelAdvancedAlgoVerticalText *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelGeosGeoText *args) {
  OrgGeogebraCommonKernelAdvancedAlgoVerticalText_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoText_withOrgGeogebraCommonKernelGeosGeoPoint_(self, cons, args, nil);
...
void OrgGeogebraCommonKernelAdvancedAlgoVerticalText_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoText_withOrgGeogebraCommonKernelGeosGeoPoint_(OrgGeogebraCommonKernelAdvancedAlgoVerticalText *self, OrgGeogebraCommonKernelConstruction *cons, OrgGeogebraCommonKernelGeosGeoText *args, OrgGeogebraCommonKernelGeosGeoPoint *p) {
  ...
  OrgGeogebraCommonKernelAdvancedAlgoVerticalText_setAndConsume_sb_(self, new_JavaLangStringBuilder_init());
  OrgGeogebraCommonKernelAdvancedAlgoVerticalText_set_args_(self, args);
  OrgGeogebraCommonKernelAdvancedAlgoVerticalText_set_startPoint_(self, p);
  OrgGeogebraCommonKernelAdvancedAlgoVerticalText_setAndConsume_text_(self, new_OrgGeogebraCommonKernelGeosGeoText_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self->text_ setIsTextCommandWithBoolean:YES];
  if (self->startPoint_ != nil) {
    OrgGeogebraCommonKernelAdvancedAlgoVerticalText_set_startPointCopy_(self, (OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast([self->startPoint_ copyInternalWithOrgGeogebraCommonKernelConstruction:cons], [OrgGeogebraCommonKernelGeosGeoPoint class]));
    @try {
