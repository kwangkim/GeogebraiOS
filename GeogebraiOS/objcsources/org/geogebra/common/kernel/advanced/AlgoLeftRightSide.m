...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/advanced/AlgoLeftRightSide.java
//
...
- (void)setInputOutput {
  ...
  OrgGeogebraCommonKernelAlgosAlgoElement_setAndConsume_input_(self, [IOSObjectArray newArrayWithObjects:(id[]){ equation_ } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()]);
...
void OrgGeogebraCommonKernelAdvancedAlgoLeftRightSide_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoElement_withBoolean_(OrgGeogebraCommonKernelAdvancedAlgoLeftRightSide *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelGeosGeoElement *equation, jboolean left) {
  ...
  OrgGeogebraCommonKernelAdvancedAlgoLeftRightSide_set_equation_(self, equation);
  self->left_ = left;
  OrgGeogebraCommonKernelAdvancedAlgoLeftRightSide_setAndConsume_fv_(self, [IOSObjectArray newArrayWithObjects:(id[]){ [new_OrgGeogebraCommonKernelArithmeticFunctionVariable_initWithOrgGeogebraCommonKernelKernel_withNSString_(self->kernel_, @"x") autorelease], [new_OrgGeogebraCommonKernelArithmeticFunctionVariable_initWithOrgGeogebraCommonKernelKernel_withNSString_(self->kernel_, @"y") autorelease] } count:2 type:OrgGeogebraCommonKernelArithmeticFunctionVariable_class_()]);
  OrgGeogebraCommonKernelArithmeticFunctionNVar *f = [new_OrgGeogebraCommonKernelArithmeticFunctionNVar_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionVariableArray_([new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self->kernel_, IOSObjectArray_Get(self->fv_, 0)) autorelease], self->fv_) autorelease];
  OrgGeogebraCommonKernelAdvancedAlgoLeftRightSide_setAndConsume_side_(self, new_OrgGeogebraCommonKernelGeosGeoFunctionNVar_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticFunctionNVar_(cons, f));
  [self setInputOutput];
  [self compute];
