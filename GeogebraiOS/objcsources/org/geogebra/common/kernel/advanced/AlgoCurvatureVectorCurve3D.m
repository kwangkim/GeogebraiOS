...
void OrgGeogebraCommonKernelAdvancedAlgoCurvatureVectorCurve3D_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_withOrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D_(OrgGeogebraCommonKernelAdvancedAlgoCurvatureVectorCurve3D *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D *arg, OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D *arg2) {
  OrgGeogebraCommonKernelAdvancedAlgoCurvatureVectorCurve3D_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D_(self, cons, arg, arg2);
  if (label != nil) {
...
void OrgGeogebraCommonKernelAdvancedAlgoCurvatureVectorCurve3D_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D_(OrgGeogebraCommonKernelAdvancedAlgoCurvatureVectorCurve3D *self, OrgGeogebraCommonKernelConstruction *cons, id<OrgGeogebraCommonKernelKernelNDGeoPointND> A, OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D *f) {
  ...
  OrgGeogebraCommonKernelAdvancedAlgoCurvatureVectorCurve3D_setAndConsume_f1eval_(self, [IOSDoubleArray newArrayWithLength:3]);
  OrgGeogebraCommonKernelAdvancedAlgoCurvatureVectorCurve3D_setAndConsume_f2eval_(self, [IOSDoubleArray newArrayWithLength:3]);
  OrgGeogebraCommonKernelAdvancedAlgoCurvatureVectorCurve3D_set_A_(self, A);
  OrgGeogebraCommonKernelAdvancedAlgoCurvatureVectorCurve3D_set_f_(self, f);
  OrgGeogebraCommonKernelAdvancedAlgoCurvatureVectorCurve3D_setAndConsume_v_(self, new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoVector3D_initWithOrgGeogebraCommonKernelConstruction_(cons));
  @try {
...
void OrgGeogebraCommonKernelAdvancedAlgoCurvatureVectorCurve3D_cas(OrgGeogebraCommonKernelAdvancedAlgoCurvatureVectorCurve3D *self) {
  OrgGeogebraCommonKernelAdvancedAlgoCurvatureVectorCurve3D_setAndConsume_algoCAS_(self, new_OrgGeogebraCommonKernelCasAlgoDerivative_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosCasEvaluableFunction_withBoolean_(self->cons_, self->f_, YES));
  ...
  OrgGeogebraCommonKernelAdvancedAlgoCurvatureVectorCurve3D_set_f1_(self, (OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D *) check_class_cast([self->algoCAS_ getResult], [OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D class]));
  OrgGeogebraCommonKernelAdvancedAlgoCurvatureVectorCurve3D_setAndConsume_algoCAS2_(self, new_OrgGeogebraCommonKernelCasAlgoDerivative_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosCasEvaluableFunction_withBoolean_(self->cons_, self->f1_, YES));
  [self->cons_ removeFromConstructionListWithOrgGeogebraCommonKernelAlgosConstructionElement:self->algoCAS2_];
  OrgGeogebraCommonKernelAdvancedAlgoCurvatureVectorCurve3D_set_f2_(self, (OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D *) check_class_cast([self->algoCAS2_ getResult], [OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D class]));
}
