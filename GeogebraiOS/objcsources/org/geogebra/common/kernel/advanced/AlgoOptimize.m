...
- (void)setInputOutput {
  ...
  (void) IOSObjectArray_Set(input_, 0, dep_);
  (void) IOSObjectArray_Set(input_, 1, indep_);
...
void OrgGeogebraCommonKernelAdvancedAlgoOptimize_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelAdvancedAlgoOptimize_OptimizationTypeEnum_(OrgGeogebraCommonKernelAdvancedAlgoOptimize *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, id<OrgGeogebraCommonKernelArithmeticNumberValue> dep, OrgGeogebraCommonKernelGeosGeoNumeric *indep, OrgGeogebraCommonKernelAdvancedAlgoOptimize_OptimizationTypeEnum *type) {
  ...
  self->i_am_not_a_real_function_ = nil;
  self->dep_ = nil;
  self->indep_ = nil;
  self->result_ = nil;
  self->type_ = OrgGeogebraCommonKernelAdvancedAlgoOptimize_OptimizationTypeEnum_get_MINIMIZE();
  self->isrunning_ = NO;
  self->optCons_ = cons;
  self->dep_ = [((id<OrgGeogebraCommonKernelArithmeticNumberValue>) nil_chk(dep)) toGeoElement];
  self->indep_ = indep;
  self->type_ = type;
  self->extrFinder_ = new_OrgGeogebraCommonKernelOptimizationExtremumFinder_init();
  self->i_am_not_a_real_function_ = new_OrgGeogebraCommonKernelOptimizationRealRootFunctionVariable_initWithOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelGeosGeoNumeric_(dep, indep);
