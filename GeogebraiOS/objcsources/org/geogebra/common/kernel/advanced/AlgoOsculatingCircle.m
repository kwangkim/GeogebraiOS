...
void OrgGeogebraCommonKernelAdvancedAlgoOsculatingCircle_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoFunction_(OrgGeogebraCommonKernelAdvancedAlgoOsculatingCircle *self, OrgGeogebraCommonKernelConstruction *cons, OrgGeogebraCommonKernelGeosGeoPoint *A, OrgGeogebraCommonKernelGeosGeoFunction *f) {
  ...
  OrgGeogebraCommonKernelAdvancedAlgoOsculatingCircle_set_A_(self, A);
  OrgGeogebraCommonKernelAdvancedAlgoOsculatingCircle_set_f_(self, f);
  OrgGeogebraCommonKernelAdvancedAlgoOsculatingCircle_setAndConsume_R_(self, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons));
  OrgGeogebraCommonKernelAdvancedAlgoOsculatingCircle_setAndConsume_circle_(self, new_OrgGeogebraCommonKernelGeosGeoConic_initWithOrgGeogebraCommonKernelConstruction_(cons));
  OrgGeogebraCommonKernelAdvancedAlgoOsculatingCircle_setAndConsume_algo_(self, new_OrgGeogebraCommonKernelAdvancedAlgoCurvature_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelGeosGeoFunction_(cons, A, f));
  OrgGeogebraCommonKernelAdvancedAlgoOsculatingCircle_setAndConsume_cv_(self, new_OrgGeogebraCommonKernelAdvancedAlgoCurvatureVector_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoFunction_(cons, A, f));
  OrgGeogebraCommonKernelAdvancedAlgoOsculatingCircle_set_curv_(self, [self->algo_ getResult]);
  OrgGeogebraCommonKernelAdvancedAlgoOsculatingCircle_set_v_(self, [self->cv_ getVector]);
