...
- (OrgGeogebraCommonKernelAlgosAlgoTransformation *)getTransformAlgoWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  OrgGeogebraCommonKernelAdvancedAlgoApplyMatrix *algo = [new_OrgGeogebraCommonKernelAdvancedAlgoApplyMatrix_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoList_(cons_, geo, matrix_) autorelease];
  return algo;
}
...
- (jboolean)changesOrientation {
  OrgGeogebraCommonKernelAlgosAlgoTransformation *at = [self getTransformAlgoWithOrgGeogebraCommonKernelGeosGeoElement:[new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease]];
...
void OrgGeogebraCommonKernelAdvancedTransformApplyMatrix_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoList_(OrgGeogebraCommonKernelAdvancedTransformApplyMatrix *self, OrgGeogebraCommonKernelConstruction *cons, OrgGeogebraCommonKernelGeosGeoList *matrix) {
  ...
  OrgGeogebraCommonKernelAdvancedTransformApplyMatrix_set_matrix_(self, matrix);
