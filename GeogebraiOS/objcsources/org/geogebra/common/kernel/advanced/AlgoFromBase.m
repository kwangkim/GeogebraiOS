...
- (void)setInputOutput {
  OrgGeogebraCommonKernelAlgosAlgoElement_setAndConsume_input_(self, [IOSObjectArray newArrayWithObjects:(id[]){ number_, [((id<OrgGeogebraCommonKernelGeosGeoNumberValue>) nil_chk(base_)) toGeoElement] } count:2 type:OrgGeogebraCommonKernelGeosGeoElement_class_()]);
...
void OrgGeogebraCommonKernelAdvancedAlgoFromBase_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoText_withOrgGeogebraCommonKernelGeosGeoNumberValue_(OrgGeogebraCommonKernelAdvancedAlgoFromBase *self, OrgGeogebraCommonKernelConstruction *c, NSString *label, OrgGeogebraCommonKernelGeosGeoText *number, id<OrgGeogebraCommonKernelGeosGeoNumberValue> base) {
  ...
  OrgGeogebraCommonKernelAdvancedAlgoFromBase_set_base_(self, base);
  OrgGeogebraCommonKernelAdvancedAlgoFromBase_set_number_(self, number);
  OrgGeogebraCommonKernelAdvancedAlgoFromBase_setAndConsume_result_(self, new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(self->cons_));
  [self setInputOutput];
  [self compute];
