...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/advanced/AlgoDivision.java
//
...
- (void)setInputOutput {
  ...
  OrgGeogebraCommonKernelAlgosAlgoElement_setAndConsume_input_(self, [IOSObjectArray newArrayWithObjects:(id[]){ [((id<OrgGeogebraCommonKernelGeosGeoNumberValue>) nil_chk(a_)) toGeoElement], [((id<OrgGeogebraCommonKernelGeosGeoNumberValue>) nil_chk(b_)) toGeoElement] } count:2 type:OrgGeogebraCommonKernelGeosGeoElement_class_()]);
...
void OrgGeogebraCommonKernelAdvancedAlgoDivision_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoNumberValue_withOrgGeogebraCommonKernelGeosGeoNumberValue_(OrgGeogebraCommonKernelAdvancedAlgoDivision *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, id<OrgGeogebraCommonKernelGeosGeoNumberValue> dividend, id<OrgGeogebraCommonKernelGeosGeoNumberValue> divisor) {
  ...
  OrgGeogebraCommonKernelAdvancedAlgoDivision_set_a_(self, dividend);
  OrgGeogebraCommonKernelAdvancedAlgoDivision_set_b_(self, divisor);
  OrgGeogebraCommonKernelAdvancedAlgoDivision_setAndConsume_num_(self, new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(cons));
  OrgGeogebraCommonKernelAdvancedAlgoDivision_setAndConsume_mod_(self, new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(cons));
  OrgGeogebraCommonKernelAdvancedAlgoDivision_setAndConsume_result_(self, new_OrgGeogebraCommonKernelGeosGeoList_initWithOrgGeogebraCommonKernelConstruction_(cons));
