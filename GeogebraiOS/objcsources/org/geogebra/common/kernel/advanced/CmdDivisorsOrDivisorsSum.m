...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/advanced/CmdDivisorsOrDivisorsSum.java
//
...
- (OrgGeogebraCommonKernelGeosGeoElement *)getResultWithOrgGeogebraCommonKernelGeosGeoNumberValue:(id<OrgGeogebraCommonKernelGeosGeoNumberValue>)num
  ...
  OrgGeogebraCommonKernelAdvancedAlgoDivisorsSum *algo = [new_OrgGeogebraCommonKernelAdvancedAlgoDivisorsSum_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticNumberValue_withBoolean_(cons_, label, num, sum_) autorelease];
