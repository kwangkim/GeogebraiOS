...
- (void)setInputOutput {
  ...
  (void) IOSObjectArray_Set(input_, 0, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(param1_, [OrgGeogebraCommonKernelGeosGeoElement class]));
  (void) IOSObjectArray_Set(input_, 1, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(param2_, [OrgGeogebraCommonKernelGeosGeoElement class]));
  (void) IOSObjectArray_Set(input_, 2, surface_);
...
void OrgGeogebraCommonKernelAdvancedAlgoCurvatureSurfaceParametric_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoNumberValue_withOrgGeogebraCommonKernelGeosGeoNumberValue_withOrgGeogebraCommonGeogebra3DKernel3DGeosGeoSurfaceCartesian3D_(OrgGeogebraCommonKernelAdvancedAlgoCurvatureSurfaceParametric *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, id<OrgGeogebraCommonKernelGeosGeoNumberValue> param1, id<OrgGeogebraCommonKernelGeosGeoNumberValue> param2, OrgGeogebraCommonGeogebra3DKernel3DGeosGeoSurfaceCartesian3D *f) {
  (void) OrgGeogebraCommonKernelAdvancedAlgoCurvatureSurfaceParametric_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoNumberValue_withOrgGeogebraCommonKernelGeosGeoNumberValue_withOrgGeogebraCommonGeogebra3DKernel3DGeosGeoSurfaceCartesian3D_(self, cons, param1, param2, f);
  if (label != nil) {
...
void OrgGeogebraCommonKernelAdvancedAlgoCurvatureSurfaceParametric_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoNumberValue_withOrgGeogebraCommonKernelGeosGeoNumberValue_withOrgGeogebraCommonGeogebra3DKernel3DGeosGeoSurfaceCartesian3D_(OrgGeogebraCommonKernelAdvancedAlgoCurvatureSurfaceParametric *self, OrgGeogebraCommonKernelConstruction *cons, id<OrgGeogebraCommonKernelGeosGeoNumberValue> param1, id<OrgGeogebraCommonKernelGeosGeoNumberValue> param2, OrgGeogebraCommonGeogebra3DKernel3DGeosGeoSurfaceCartesian3D *surface) {
  ...
  self->matrix1_ = new_OrgApacheCommonsMathLinearArray2DRowRealMatrix_initWithInt_withInt_(3, 3);
  self->matrix2_ = new_OrgApacheCommonsMathLinearArray2DRowRealMatrix_initWithInt_withInt_(3, 3);
  self->param1_ = param1;
  self->param2_ = param2;
  ...
  self->e_ = new_OrgGeogebraCommonKernelGeosGeoFunctionNVar_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticFunctionNVar_(cons, IOSObjectArray_Get(nil_chk(functions), 0));
  self->f_ = new_OrgGeogebraCommonKernelGeosGeoFunctionNVar_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticFunctionNVar_(cons, IOSObjectArray_Get(functions, 1));
  self->g_ = new_OrgGeogebraCommonKernelGeosGeoFunctionNVar_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticFunctionNVar_(cons, IOSObjectArray_Get(functions, 2));
  OrgGeogebraCommonKernelGeosGeoNumeric *u = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(cons);
  ...
  OrgGeogebraCommonKernelGeosGeoNumeric *v = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(cons);
  ...
  self->algoCASeu_ = new_OrgGeogebraCommonKernelCasAlgoDerivative_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosCasEvaluableFunction_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelArithmeticNumberValue_withBoolean_(cons, self->e_, u, one, NO);
  ...
  self->eu_ = (OrgGeogebraCommonKernelGeosGeoFunctionNVar *) check_class_cast([self->algoCASeu_ getResult], [OrgGeogebraCommonKernelGeosGeoFunctionNVar class]);
  self->algoCASfu_ = new_OrgGeogebraCommonKernelCasAlgoDerivative_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosCasEvaluableFunction_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelArithmeticNumberValue_withBoolean_(cons, self->f_, u, one, NO);
  [cons removeFromConstructionListWithOrgGeogebraCommonKernelAlgosConstructionElement:self->algoCASfu_];
  self->fu_ = (OrgGeogebraCommonKernelGeosGeoFunctionNVar *) check_class_cast([self->algoCASfu_ getResult], [OrgGeogebraCommonKernelGeosGeoFunctionNVar class]);
  self->algoCASgu_ = new_OrgGeogebraCommonKernelCasAlgoDerivative_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosCasEvaluableFunction_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelArithmeticNumberValue_withBoolean_(cons, self->g_, u, one, NO);
  [cons removeFromConstructionListWithOrgGeogebraCommonKernelAlgosConstructionElement:self->algoCASgu_];
  self->gu_ = (OrgGeogebraCommonKernelGeosGeoFunctionNVar *) check_class_cast([self->algoCASgu_ getResult], [OrgGeogebraCommonKernelGeosGeoFunctionNVar class]);
  self->algoCASev_ = new_OrgGeogebraCommonKernelCasAlgoDerivative_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosCasEvaluableFunction_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelArithmeticNumberValue_withBoolean_(cons, self->e_, v, one, NO);
  [cons removeFromConstructionListWithOrgGeogebraCommonKernelAlgosConstructionElement:self->algoCASev_];
  self->ev_ = (OrgGeogebraCommonKernelGeosGeoFunctionNVar *) check_class_cast([self->algoCASev_ getResult], [OrgGeogebraCommonKernelGeosGeoFunctionNVar class]);
  self->algoCASfv_ = new_OrgGeogebraCommonKernelCasAlgoDerivative_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosCasEvaluableFunction_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelArithmeticNumberValue_withBoolean_(cons, self->f_, v, one, NO);
  [cons removeFromConstructionListWithOrgGeogebraCommonKernelAlgosConstructionElement:self->algoCASfv_];
  self->fv_ = (OrgGeogebraCommonKernelGeosGeoFunctionNVar *) check_class_cast([self->algoCASfv_ getResult], [OrgGeogebraCommonKernelGeosGeoFunctionNVar class]);
  self->algoCASgv_ = new_OrgGeogebraCommonKernelCasAlgoDerivative_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosCasEvaluableFunction_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelArithmeticNumberValue_withBoolean_(cons, self->g_, v, one, NO);
  [cons removeFromConstructionListWithOrgGeogebraCommonKernelAlgosConstructionElement:self->algoCASgv_];
  self->gv_ = (OrgGeogebraCommonKernelGeosGeoFunctionNVar *) check_class_cast([self->algoCASgv_ getResult], [OrgGeogebraCommonKernelGeosGeoFunctionNVar class]);
  self->algoCASevv_ = new_OrgGeogebraCommonKernelCasAlgoDerivative_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosCasEvaluableFunction_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelArithmeticNumberValue_withBoolean_(cons, self->ev_, v, one, NO);
  [cons removeFromConstructionListWithOrgGeogebraCommonKernelAlgosConstructionElement:self->algoCASevv_];
  self->evv_ = (OrgGeogebraCommonKernelGeosGeoFunctionNVar *) check_class_cast([self->algoCASevv_ getResult], [OrgGeogebraCommonKernelGeosGeoFunctionNVar class]);
  self->algoCASfuv_ = new_OrgGeogebraCommonKernelCasAlgoDerivative_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosCasEvaluableFunction_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelArithmeticNumberValue_withBoolean_(cons, self->fu_, v, one, NO);
  [cons removeFromConstructionListWithOrgGeogebraCommonKernelAlgosConstructionElement:self->algoCASfuv_];
  self->fuv_ = (OrgGeogebraCommonKernelGeosGeoFunctionNVar *) check_class_cast([self->algoCASfuv_ getResult], [OrgGeogebraCommonKernelGeosGeoFunctionNVar class]);
  self->algoCASguu_ = new_OrgGeogebraCommonKernelCasAlgoDerivative_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosCasEvaluableFunction_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelArithmeticNumberValue_withBoolean_(cons, self->gu_, u, one, NO);
  [cons removeFromConstructionListWithOrgGeogebraCommonKernelAlgosConstructionElement:self->algoCASguu_];
  self->guu_ = (OrgGeogebraCommonKernelGeosGeoFunctionNVar *) check_class_cast([self->algoCASguu_ getResult], [OrgGeogebraCommonKernelGeosGeoFunctionNVar class]);
  [self setInputOutput];
  OrgGeogebraCommonKernelAdvancedAlgoCurvatureSurfaceParametric_compute(self);
}
...
void OrgGeogebraCommonKernelAdvancedAlgoCurvatureSurfaceParametric_compute(OrgGeogebraCommonKernelAdvancedAlgoCurvatureSurfaceParametric *self) {
  ...
  IOSObjectArray *m1 = [IOSObjectArray newArrayWithObjects:(id[]){ [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ -evvEval / 2 + fuvEval - guuEval / 2, euEval / 2, fuEval - evEval / 2 } count:3], [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ fvEval - guEval / 2, eEval, fEval } count:3], [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ gvEval / 2, fEval, gEval } count:3] } count:3 type:IOSClass_doubleArray(1)];
  IOSObjectArray *m2 = [IOSObjectArray newArrayWithObjects:(id[]){ [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 0, evEval / 2, guEval / 2 } count:3], [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ evEval / 2, eEval, fEval } count:3], [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ guEval / 2, fEval, gEval } count:3] } count:3 type:IOSClass_doubleArray(1)];
