...
- (OrgGeogebraCommonKernelAlgosAlgoAxesQuadricND *)axesConicWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)cons1
  ...
  return [new_OrgGeogebraCommonKernelAlgosAlgoAxes_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelGeosGeoConic_(cons1, labels, (OrgGeogebraCommonKernelGeosGeoConic *) check_class_cast(c, [OrgGeogebraCommonKernelGeosGeoConic class])) autorelease];
}
