...
- (IOSObjectArray *)processWithOrgGeogebraCommonKernelArithmeticCommand:(OrgGeogebraCommonKernelArithmeticCommand *)c {
  jint n = [((OrgGeogebraCommonKernelArithmeticCommand *) nil_chk(c)) getArgumentNumber];
  {
    ...
    switch (n) {
      ...
      argE = [c getArguments];
      arg = [IOSObjectArray arrayWithLength:2 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
      [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(IOSObjectArray_Get(nil_chk(argE), 1))) resolveVariables];
      IOSObjectArray_Set(arg, 1, IOSObjectArray_Get(nil_chk([self resArgWithOrgGeogebraCommonKernelArithmeticExpressionNode:IOSObjectArray_Get(argE, 1)]), 0));
      ...
      @try {
        ...
        IOSObjectArray_Set(arg, 0, IOSObjectArray_Get(nil_chk([self resArgWithOrgGeogebraCommonKernelArithmeticExpressionNode:IOSObjectArray_Get(argE, 0)]), 0));
      }
      @catch (JavaLangThrowable *t) {
      }
      if (!([IOSObjectArray_Get(arg, 0) isKindOfClass:[OrgGeogebraCommonKernelGeosGeoText class]])) {
        IOSObjectArray_SetAndConsume(arg, 0, new_OrgGeogebraCommonKernelGeosGeoText_initWithOrgGeogebraCommonKernelConstruction_withNSString_([((OrgGeogebraCommonKernelKernel *) nil_chk(kernelA_)) getConstruction], str));
      }
      ...
      ret = [IOSObjectArray arrayWithObjects:(id[]){ [fromBase getResult] } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
      return ret;
      default:
