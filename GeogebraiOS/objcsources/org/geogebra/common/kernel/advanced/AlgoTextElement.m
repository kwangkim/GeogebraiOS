...
void OrgGeogebraCommonKernelAdvancedAlgoTextElement_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoText_withOrgGeogebraCommonKernelArithmeticNumberValue_(OrgGeogebraCommonKernelAdvancedAlgoTextElement *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelGeosGeoText *text, id<OrgGeogebraCommonKernelArithmeticNumberValue> num) {
  ...
  OrgGeogebraCommonKernelAdvancedAlgoTextElement_set_num_(self, nil);
  OrgGeogebraCommonKernelAdvancedAlgoTextElement_set_text_(self, text);
  OrgGeogebraCommonKernelAdvancedAlgoTextElement_set_num_(self, num);
  OrgGeogebraCommonKernelAdvancedAlgoTextElement_set_numGeo_(self, [((id<OrgGeogebraCommonKernelArithmeticNumberValue>) nil_chk(num)) toGeoElement]);
  OrgGeogebraCommonKernelAdvancedAlgoTextElement_setAndConsume_textOut_(self, new_OrgGeogebraCommonKernelGeosGeoText_initWithOrgGeogebraCommonKernelConstruction_(cons));
