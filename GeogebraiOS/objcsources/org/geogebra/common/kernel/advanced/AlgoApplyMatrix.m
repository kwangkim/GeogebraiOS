...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/javasources/org/geogebra/common/kernel/advanced/AlgoApplyMatrix.java
//
...
- (void)setTransformedObjectWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)g
  ...
  OrgGeogebraCommonKernelAdvancedAlgoApplyMatrix_set_inGeo_(self, g);
  OrgGeogebraCommonKernelAdvancedAlgoApplyMatrix_set_outGeo_(self, g2);
  if (!([out_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoList class]]) && ([OrgGeogebraCommonKernelMatrixTransformable_class_() isInstance:outGeo_])) {
    OrgGeogebraCommonKernelAdvancedAlgoApplyMatrix_set_out_(self, (id<OrgGeogebraCommonKernelMatrixTransformable>) check_protocol_cast(outGeo_, @protocol(OrgGeogebraCommonKernelMatrixTransformable)));
  }
}
...
void OrgGeogebraCommonKernelAdvancedAlgoApplyMatrix_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoList_(OrgGeogebraCommonKernelAdvancedAlgoApplyMatrix *self, OrgGeogebraCommonKernelConstruction *cons, OrgGeogebraCommonKernelGeosGeoElement *inArg, OrgGeogebraCommonKernelGeosGeoList *matrix) {
  ...
  OrgGeogebraCommonKernelAdvancedAlgoApplyMatrix_set_matrix_(self, matrix);
  OrgGeogebraCommonKernelAdvancedAlgoApplyMatrix_set_inGeo_(self, [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(inArg)) toGeoElement]);
  if (([OrgGeogebraCommonKernelGeosGeoPoly_class_() isInstance:self->inGeo_]) || [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(self->inGeo_)) isLimitedPath]) {
    OrgGeogebraCommonKernelAdvancedAlgoApplyMatrix_set_outGeo_(self, [inArg copyInternalWithOrgGeogebraCommonKernelConstruction:cons]);
    OrgGeogebraCommonKernelAdvancedAlgoApplyMatrix_set_out_(self, (id<OrgGeogebraCommonKernelMatrixTransformable>) check_protocol_cast(self->outGeo_, @protocol(OrgGeogebraCommonKernelMatrixTransformable)));
  }
  else if ([self->inGeo_ isGeoList]) {
    OrgGeogebraCommonKernelAdvancedAlgoApplyMatrix_setAndConsume_outGeo_(self, new_OrgGeogebraCommonKernelGeosGeoList_initWithOrgGeogebraCommonKernelConstruction_(cons));
  }
  else if ([self->inGeo_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoFunction class]]) {
    OrgGeogebraCommonKernelAdvancedAlgoApplyMatrix_setAndConsume_out_(self, new_OrgGeogebraCommonKernelGeosGeoCurveCartesian_initWithOrgGeogebraCommonKernelConstruction_(cons));
    OrgGeogebraCommonKernelAdvancedAlgoApplyMatrix_set_outGeo_(self, [self->out_ toGeoElement]);
  }
  else {
    OrgGeogebraCommonKernelAdvancedAlgoApplyMatrix_set_out_(self, (id<OrgGeogebraCommonKernelMatrixTransformable>) check_protocol_cast([self->inGeo_ copy__], @protocol(OrgGeogebraCommonKernelMatrixTransformable)));
    OrgGeogebraCommonKernelAdvancedAlgoApplyMatrix_set_outGeo_(self, [((id<OrgGeogebraCommonKernelMatrixTransformable>) nil_chk(self->out_)) toGeoElement]);
  }
  [self setInputOutput];
  OrgGeogebraCommonKernelAdvancedAlgoApplyMatrix_compute(self);
