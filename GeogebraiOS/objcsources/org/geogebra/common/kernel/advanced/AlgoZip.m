...
- (void)setInputOutput {
  OrgGeogebraCommonKernelAlgosAlgoElement_setAndConsume_input_(self, [IOSObjectArray newArrayWithLength:1 + listCount_ + varCount_ type:OrgGeogebraCommonKernelGeosGeoElement_class_()]);
...
- (IOSObjectArray *)getInputForUpdateSetPropagation {
  IOSObjectArray *realInput = [IOSObjectArray arrayWithLength:listCount_ + 1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
...
void OrgGeogebraCommonKernelAdvancedAlgoZip_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoElementArray_withOrgGeogebraCommonKernelGeosGeoListArray_(OrgGeogebraCommonKernelAdvancedAlgoZip *self, OrgGeogebraCommonKernelConstruction *cons, OrgGeogebraCommonKernelGeosGeoElement *expression, IOSObjectArray *vars, IOSObjectArray *over) {
  ...
  OrgGeogebraCommonKernelAdvancedAlgoZip_set_expression_(self, expression);
  OrgGeogebraCommonKernelAdvancedAlgoZip_set_vars_(self, vars);
  OrgGeogebraCommonKernelAdvancedAlgoZip_set_over_(self, over);
  self->listCount_ = ((IOSObjectArray *) nil_chk(over))->size_;
  self->varCount_ = ((IOSObjectArray *) nil_chk(vars))->size_;
  OrgGeogebraCommonKernelAdvancedAlgoZip_set_expressionParentAlgo_(self, [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(expression)) getParentAlgorithm]);
  self->expIsFunctionOrCurve_ = [OrgGeogebraCommonKernelGeosCasEvaluableFunction_class_() isInstance:expression];
  OrgGeogebraCommonKernelAdvancedAlgoZip_setAndConsume_list_(self, new_OrgGeogebraCommonKernelGeosGeoList_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  OrgGeogebraCommonKernelAdvancedAlgoZip_compute(self);
}
