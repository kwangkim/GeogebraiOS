...
- (void)setInputOutput {
  ...
  input_ = [IOSObjectArray newArrayWithObjects:(id[]){ inputList_ } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
  [self setDependencies];
}

- (void)compute {
  OrgGeogebraCommonUtilGgbMat *matrix = new_OrgGeogebraCommonUtilGgbMat_initWithOrgGeogebraCommonKernelGeosGeoList_(inputList_);
...
void OrgGeogebraCommonKernelAdvancedAlgoMatrixRank_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoList_(OrgGeogebraCommonKernelAdvancedAlgoMatrixRank *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelGeosGeoList *matrix) {
  ...
  self->inputList_ = matrix;
  self->rank_ = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(cons);
  [self setInputOutput];
  [self compute];
