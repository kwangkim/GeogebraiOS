...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/advanced/CmdImplicitPoly.java
//
    ...
    switch (n) {
      ...
      if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(IOSObjectArray_Get(nil_chk(arg), 0))) isGeoList]) {
        ...
        if (((IOSObjectArray *) nil_chk(fvars))->size_ != 2) {
          @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSString_([((OrgGeogebraCommonMainApp *) nil_chk(app_)) getLocalization], @"InvalidEquation") autorelease];
        }
      ...
      if (list != nil) {
        IOSObjectArray *ret = [IOSObjectArray arrayWithObjects:(id[]){ OrgGeogebraCommonKernelAdvancedCmdImplicitPoly_doCommandWithNSString_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelArithmeticCommand_(self, [c getLabel], list, c) } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
        return ret;
      }
      @throw [self argErrWithOrgGeogebraCommonMainApp:app_ withNSString:[c getName] withOrgGeogebraCommonKernelArithmeticExpressionValue:IOSObjectArray_Get(arg, 0)];
    }
...
OrgGeogebraCommonKernelGeosGeoElement *OrgGeogebraCommonKernelAdvancedCmdImplicitPoly_doCommandWithNSString_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelArithmeticCommand_(OrgGeogebraCommonKernelAdvancedCmdImplicitPoly *self, NSString *a, OrgGeogebraCommonKernelGeosGeoList *b, OrgGeogebraCommonKernelArithmeticCommand *c) {
  OrgGeogebraCommonKernelImplicitAlgoImplicitPolyThroughPoints *algo = [new_OrgGeogebraCommonKernelImplicitAlgoImplicitPolyThroughPoints_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoList_(self->cons_, a, b) autorelease];
