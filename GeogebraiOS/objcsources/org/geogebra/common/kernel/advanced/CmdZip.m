...
- (IOSObjectArray *)processWithOrgGeogebraCommonKernelArithmeticCommand:(OrgGeogebraCommonKernelArithmeticCommand *)c {
  ...
  IOSObjectArray *vars = [IOSObjectArray arrayWithLength:n / 2 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
  IOSObjectArray *over = [IOSObjectArray arrayWithLength:(n - 1) / 2 type:OrgGeogebraCommonKernelGeosGeoList_class_()];
