...
- (void)setInputOutput {
  OrgGeogebraCommonKernelAlgosAlgoElement_setAndConsume_input_(self, [IOSObjectArray newArrayWithLength:precision_ == nil ? 1 : 2 type:OrgGeogebraCommonKernelGeosGeoElement_class_()]);
  IOSObjectArray_Set(input_, 0, num_);
  if (precision_ != nil) {
    IOSObjectArray_Set(input_, 1, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(precision_, [OrgGeogebraCommonKernelGeosGeoElement class]));
  }
...
void OrgGeogebraCommonKernelAdvancedAlgoScientificText_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoNumeric_withOrgGeogebraCommonKernelGeosGeoNumeric_(OrgGeogebraCommonKernelAdvancedAlgoScientificText *self, OrgGeogebraCommonKernelConstruction *cons, OrgGeogebraCommonKernelGeosGeoNumeric *num, OrgGeogebraCommonKernelGeosGeoNumeric *precision) {
  ...
  OrgGeogebraCommonKernelAdvancedAlgoScientificText_setAndConsume_sb_(self, new_JavaLangStringBuilder_init());
  OrgGeogebraCommonKernelAdvancedAlgoScientificText_set_num_(self, num);
  OrgGeogebraCommonKernelAdvancedAlgoScientificText_set_precision_(self, precision);
  OrgGeogebraCommonKernelAdvancedAlgoScientificText_setAndConsume_text_(self, new_OrgGeogebraCommonKernelGeosGeoText_initWithOrgGeogebraCommonKernelConstruction_(cons));
