...
- (void)insertPointPairWithInt:(jint)indexD
  ...
  OrgGeogebraCommonKernelPointPair *newPair = new_OrgGeogebraCommonKernelPointPair_initWithInt_withBoolean_withInt_withBoolean_withDouble_(indexD, isPalive, indexQ, isQonPath, distance);
  ...
  newPair->next_ = ((OrgGeogebraCommonKernelPointPair *) nil_chk(currentPair))->next_;
  currentPair->next_ = newPair;
  size__++;
}
...
- (void)removeAllPairsWithOrgGeogebraCommonKernelPointPair:(OrgGeogebraCommonKernelPointPair *)pair {
  ...
  while (currentPair != nil) {
    if (((OrgGeogebraCommonKernelPointPair *) nil_chk(currentPair))->indexP_ == pair->indexP_ || currentPair->indexQ_ == pair->indexQ_) {
      ((OrgGeogebraCommonKernelPointPair *) nil_chk(prevPair))->next_ = currentPair->next_;
      currentPair = currentPair->next_;
      size__--;
    }
    else {
