...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/kernel/locusequ/elements/EquationGenericConicPart.java
//
...
- (OrgGeogebraCommonKernelLocusequEquationList *)orAllExpressionsWithOrgGeogebraCommonKernelLocusequEquationList:(OrgGeogebraCommonKernelLocusequEquationList *)originalList {
  OrgGeogebraCommonKernelLocusequEquationList *result = new_OrgGeogebraCommonKernelLocusequEquationList_initWithInt_(1);
  IOSObjectArray *eqs = [IOSObjectArray newArrayWithLength:[((OrgGeogebraCommonKernelLocusequEquationList *) nil_chk(originalList)) size] type:OrgGeogebraCommonKernelLocusequArithEquationExpression_class_()];
  for (jint i = 0; i < [originalList size]; i++) {
    (void) IOSObjectArray_Set(eqs, i, [((OrgGeogebraCommonKernelLocusequArithEquation *) nil_chk([originalList getWithInt:i])) getExpression]);
  }
