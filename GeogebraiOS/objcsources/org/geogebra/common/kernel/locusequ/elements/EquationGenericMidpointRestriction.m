...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/locusequ/elements/EquationGenericMidpointRestriction.java
//
...
- (void)setEndsWithOrgGeogebraCommonKernelGeosGeoPoint:(OrgGeogebraCommonKernelGeosGeoPoint *)first
  ...
  OrgGeogebraCommonKernelLocusequElementsEquationGenericMidpointRestriction_set_firstEnd_(self, first);
  OrgGeogebraCommonKernelLocusequElementsEquationGenericMidpointRestriction_set_secondEnd_(self, second);
}

- (void)setMidpointWithOrgGeogebraCommonKernelGeosGeoPoint:(OrgGeogebraCommonKernelGeosGeoPoint *)midpoint {
  OrgGeogebraCommonKernelLocusequElementsEquationGenericMidpointRestriction_set_midpoint_(self, midpoint);
}
...
- (OrgGeogebraCommonKernelLocusequEquationList *)forPointImplWithOrgGeogebraCommonKernelLocusequEquationPoint:(OrgGeogebraCommonKernelLocusequEquationPoint *)p {
  ...
  OrgGeogebraCommonKernelLocusequEquationList *res = [new_OrgGeogebraCommonKernelLocusequEquationList_initWithInt_(2) autorelease];
