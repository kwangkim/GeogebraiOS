...
- (OrgGeogebraCommonKernelLocusequEquationElement *)getFirstConic {
  if (self->firstConic_ == nil) {
    OrgGeogebraCommonKernelLocusequElementsEquationIntersectConicsRestriction_set_firstConic_(self, [((OrgGeogebraCommonKernelLocusequEquationScope *) nil_chk([self getScope])) getElementWithOrgGeogebraCommonKernelGeosGeoElement:[((OrgGeogebraCommonKernelAlgosAlgoIntersectConics *) nil_chk([self getAlgo])) getA]]);
  }
...
- (OrgGeogebraCommonKernelLocusequEquationElement *)getSecondConic {
  if (self->secondConic_ == nil) {
    OrgGeogebraCommonKernelLocusequElementsEquationIntersectConicsRestriction_set_secondConic_(self, [((OrgGeogebraCommonKernelLocusequEquationScope *) nil_chk([self getScope])) getElementWithOrgGeogebraCommonKernelGeosGeoElement:[((OrgGeogebraCommonKernelAlgosAlgoIntersectConics *) nil_chk([self getAlgo])) getB]]);
  }
  return secondConic_;
}
