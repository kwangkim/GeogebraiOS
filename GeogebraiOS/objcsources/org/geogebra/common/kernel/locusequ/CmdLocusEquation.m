...
- (IOSObjectArray *)processWithOrgGeogebraCommonKernelArithmeticCommand:(OrgGeogebraCommonKernelArithmeticCommand *)c {
  ...
  return [IOSObjectArray arrayWithObjects:(id[]){ OrgGeogebraCommonKernelLocusequCmdLocusEquation_LocusEquationWithNSString_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_(self, [c getLabel], locusPoint, movingPoint) } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
}
...
OrgGeogebraCommonKernelImplicitGeoImplicitPoly *OrgGeogebraCommonKernelLocusequCmdLocusEquation_LocusEquationWithNSString_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_(OrgGeogebraCommonKernelLocusequCmdLocusEquation *self, NSString *label, OrgGeogebraCommonKernelGeosGeoPoint *locusPoint, OrgGeogebraCommonKernelGeosGeoPoint *movingPoint) {
  ...
  OrgGeogebraCommonKernelLocusequAlgoLocusEquation *algo = [new_OrgGeogebraCommonKernelLocusequAlgoLocusEquation_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_(self->cons_, locusPoint, movingPoint) autorelease];
