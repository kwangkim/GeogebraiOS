...
+ (void)initialize {
  if (self == [OrgGeogebraCommonKernelLocusequEquationList class]) {
    JreStrongAssignAndConsume(&OrgGeogebraCommonKernelLocusequEquationList_emptyList_, nil, new_OrgGeogebraCommonKernelLocusequEquationList_EmptyEquationList_init());
...
void OrgGeogebraCommonKernelLocusequEquationList_EmptyEquationList_init(OrgGeogebraCommonKernelLocusequEquationList_EmptyEquationList *self) {
  OrgGeogebraCommonKernelLocusequEquationList_initWithInt_(self, 0);
}
