...
- (void)setInputOutput {
  ...
  efficientInput_AlgoLocusEquation_ = [IOSObjectArray newArrayWithLength:[inSet size] type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
  efficientInput_AlgoLocusEquation_ = [inSet toArrayWithNSObjectArray:efficientInput_AlgoLocusEquation_];
  standardInput_ = [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
  (void) IOSObjectArray_Set(standardInput_, 0, self->locusPoint_);
...
- (void)compute {
  ...
  old_system_ = system;
  if (system != nil) {
    OrgGeogebraCommonKernelLocusequEquationTranslator *trans = new_OrgGeogebraCommonKernelLocusequCASTranslator_initWithOrgGeogebraCommonKernelKernel_([((OrgGeogebraCommonKernelConstruction *) nil_chk(cons_)) getKernel]);
    @try {
...
void OrgGeogebraCommonKernelLocusequAlgoLocusEquation_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_(OrgGeogebraCommonKernelLocusequAlgoLocusEquation *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelGeosGeoPoint *locusPoint, OrgGeogebraCommonKernelGeosGeoPoint *movingPoint) {
  (void) OrgGeogebraCommonKernelLocusequAlgoLocusEquation_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_(self, cons, locusPoint, movingPoint);
...
OrgGeogebraCommonKernelLocusequEquationSystem *OrgGeogebraCommonKernelLocusequAlgoLocusEquation_getOriginalIdeal(OrgGeogebraCommonKernelLocusequAlgoLocusEquation *self) {
  OrgGeogebraCommonKernelLocusequEquationScope *scope = new_OrgGeogebraCommonKernelLocusequEquationScope_initWithOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_(self->locusPoint_, self->movingPoint_);
  ...
  if (constructionIsFeasible) {
    ...
    return new_OrgGeogebraCommonKernelLocusequEquationSystem_initWithOrgGeogebraCommonKernelLocusequEquationList_withOrgGeogebraCommonKernelLocusequEquationScope_(restrictions, scope);
  }
  return nil;
}
