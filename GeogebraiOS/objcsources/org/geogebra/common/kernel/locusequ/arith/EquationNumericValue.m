...
+ (void)initialize {
  if (self == [OrgGeogebraCommonKernelLocusequArithEquationNumericValue class]) {
    JreStrongAssignAndConsume(&OrgGeogebraCommonKernelLocusequArithEquationNumericValue_ZERO_, nil, new_OrgGeogebraCommonKernelLocusequArithEquationNumericValue_initWithDouble_(0));
    JreStrongAssignAndConsume(&OrgGeogebraCommonKernelLocusequArithEquationNumericValue_ONE_, nil, new_OrgGeogebraCommonKernelLocusequArithEquationNumericValue_initWithDouble_(1));
    JreStrongAssignAndConsume(&OrgGeogebraCommonKernelLocusequArithEquationNumericValue_TWO_, nil, new_OrgGeogebraCommonKernelLocusequArithEquationNumericValue_initWithDouble_(2));
...
OrgGeogebraCommonKernelLocusequArithEquationNumericValue *OrgGeogebraCommonKernelLocusequArithEquationNumericValue_fromWithDouble_(jdouble value) {
  ...
  if (value == 0) {
    ...
    return [new_OrgGeogebraCommonKernelLocusequArithEquationNumericValue_initWithDouble_(value) autorelease];
  }
}
