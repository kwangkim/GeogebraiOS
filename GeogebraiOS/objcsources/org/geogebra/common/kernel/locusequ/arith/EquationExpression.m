...
- (OrgGeogebraCommonKernelLocusequArithEquationExpression *)getOpposite {
  if (self->opposite_ == nil) {
    self->opposite_ = new_OrgGeogebraCommonKernelLocusequArithEquationOppositeOperator_initWithOrgGeogebraCommonKernelLocusequArithEquationExpression_(self);
  }
...
- (OrgGeogebraCommonKernelLocusequArithEquationExpression *)getInverse {
  if (self->inverse_ == nil) {
    self->inverse_ = new_OrgGeogebraCommonKernelLocusequArithEquationInverseOperator_initWithOrgGeogebraCommonKernelLocusequArithEquationExpression_(self);
  }
...
- (jboolean)containsSymbolicValues {
  if (self->containsSymbolicValues__ == nil) {
    self->containsSymbolicValues__ = JavaLangBoolean_valueOfWithBoolean_([self containsSymbolicValuesImpl]);
  }
...
void OrgGeogebraCommonKernelLocusequArithEquationExpression_init(OrgGeogebraCommonKernelLocusequArithEquationExpression *self) {
  ...
  self->opposite_ = nil;
  self->inverse_ = nil;
  self->containsSymbolicValues__ = nil;
}
