...
- (OrgGeogebraCommonKernelLocusequEquationAuxiliarSymbolicPoint *)getNewAuxiliarPoint {
  OrgGeogebraCommonKernelLocusequEquationAuxiliarSymbolicPoint *p = [new_OrgGeogebraCommonKernelLocusequEquationAuxiliarSymbolicPoint_initWithInt_(self->auxPointIndex_) autorelease];
...
void OrgGeogebraCommonKernelLocusequEquationScope_init(OrgGeogebraCommonKernelLocusequEquationScope *self) {
  NSObject_init(self);
  OrgGeogebraCommonKernelLocusequEquationScope_setAndConsume_pointMap_(self, new_OrgGeogebraCommonKernelLocusequEquationPointMap_initWithOrgGeogebraCommonKernelLocusequEquationScope_(self));
  OrgGeogebraCommonKernelLocusequEquationScope_setAndConsume_elementsMap_(self, new_OrgGeogebraCommonKernelLocusequEquationElementMap_initWithOrgGeogebraCommonKernelLocusequEquationScope_(self));
  OrgGeogebraCommonKernelLocusequEquationScope_initAuxiliarPoints(self);
}
...
void OrgGeogebraCommonKernelLocusequEquationScope_initWithOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_(OrgGeogebraCommonKernelLocusequEquationScope *self, OrgGeogebraCommonKernelGeosGeoPoint *locusPoint, OrgGeogebraCommonKernelGeosGeoPoint *movingPoint) {
  NSObject_init(self);
  OrgGeogebraCommonKernelLocusequEquationScope_setAndConsume_pointMap_(self, new_OrgGeogebraCommonKernelLocusequEquationPointMap_initWithOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelLocusequEquationScope_(locusPoint, movingPoint, self));
  OrgGeogebraCommonKernelLocusequEquationScope_setAndConsume_elementsMap_(self, new_OrgGeogebraCommonKernelLocusequEquationElementMap_initWithOrgGeogebraCommonKernelLocusequEquationScope_(self));
  OrgGeogebraCommonKernelLocusequEquationScope_initAuxiliarPoints(self);
}
...
void OrgGeogebraCommonKernelLocusequEquationScope_initWithOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoPoint_(OrgGeogebraCommonKernelLocusequEquationScope *self, OrgGeogebraCommonKernelGeosGeoElement *path, OrgGeogebraCommonKernelGeosGeoPoint *movingPoint) {
  NSObject_init(self);
  OrgGeogebraCommonKernelLocusequEquationScope_setAndConsume_pointMap_(self, new_OrgGeogebraCommonKernelLocusequEquationPointMap_initWithOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelLocusequEquationScope_(path, movingPoint, self));
  OrgGeogebraCommonKernelLocusequEquationScope_setAndConsume_elementsMap_(self, new_OrgGeogebraCommonKernelLocusequEquationElementMap_initWithOrgGeogebraCommonKernelLocusequEquationScope_(self));
  OrgGeogebraCommonKernelLocusequEquationScope_initAuxiliarPoints(self);
}
...
void OrgGeogebraCommonKernelLocusequEquationScope_initAuxiliarPoints(OrgGeogebraCommonKernelLocusequEquationScope *self) {
  OrgGeogebraCommonKernelLocusequEquationScope_setAndConsume_auxiliarPoints_(self, new_JavaUtilHashSet_init());
