...
- (NSString *)getVarsToEliminate {
  JavaLangStringBuilder *varsString = new_JavaLangStringBuilder_initWithInt_([((id<JavaUtilSet>) nil_chk(varsToEliminate_)) size]);
  IOSObjectArray *vars = [varsToEliminate_ toArrayWithNSObjectArray:[IOSObjectArray newArrayWithLength:[varsToEliminate_ size] type:NSString_class_()]];
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(vars))->size_; i++) {
    (void) [varsString appendWithNSString:IOSObjectArray_Get(vars, i)];
    if (i < vars->size_ - 1) {
      (void) [varsString appendWithNSString:@","];
    }
  }
...
- (NSString *)getVars {
  return [((JavaLangStringBuilder *) nil_chk([new_JavaLangStringBuilder_initWithNSString_(@"x,y,") appendWithNSString:[self getVarsToEliminate]])) description];
}
...
- (id<JavaUtilCollection>)translateWithOrgGeogebraCommonKernelLocusequEquationSystem:(OrgGeogebraCommonKernelLocusequEquationSystem *)system {
  ...
  id<JavaUtilList> restrictions = new_JavaUtilArrayList_initWithInt_([((OrgGeogebraCommonKernelLocusequEquationList *) nil_chk([((OrgGeogebraCommonKernelLocusequEquationSystem *) nil_chk([self getSystem])) getEquations])) size]);
...
- (JavaLangStringBuilder *)absWithId:(JavaLangStringBuilder *)value {
  return [((JavaLangStringBuilder *) nil_chk([new_JavaLangStringBuilder_initWithNSString_(@"abs(") appendWithJavaLangCharSequence:value])) appendWithNSString:@")"];
}

- (JavaLangStringBuilder *)sumWithId:(JavaLangStringBuilder *)a
                              withId:(JavaLangStringBuilder *)b {
  return [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([new_JavaLangStringBuilder_initWithNSString_(@"(") appendWithJavaLangCharSequence:a])) appendWithNSString:@"+"])) appendWithJavaLangCharSequence:b])) appendWithNSString:@")"];
}
...
- (JavaLangStringBuilder *)divWithId:(JavaLangStringBuilder *)num
  ...
  return [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([new_JavaLangStringBuilder_initWithNSString_(@"(") appendWithJavaLangCharSequence:num])) appendWithNSString:@"/"])) appendWithJavaLangCharSequence:denom])) appendWithNSString:@")"];
}

- (JavaLangStringBuilder *)expWithId:(JavaLangStringBuilder *)base
                            withLong:(jlong)exp {
  return [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([new_JavaLangStringBuilder_initWithNSString_(@"(") appendWithJavaLangCharSequence:base])) appendWithNSString:@"**"])) appendWithLong:exp])) appendWithNSString:@")"];
}

- (JavaLangStringBuilder *)inverseWithId:(JavaLangStringBuilder *)value {
  return [self divWithId:new_JavaLangStringBuilder_initWithNSString_(@"1") withId:value];
}

- (JavaLangStringBuilder *)numberWithDouble:(jdouble)number {
  OrgGeogebraCommonKernelArithmeticMyDouble *md = new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, number);
  return [((JavaLangStringBuilder *) nil_chk([new_JavaLangStringBuilder_initWithNSString_(@"(") appendWithNSString:[md toStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]])) appendWithNSString:@")"];
}

- (JavaLangStringBuilder *)auxiliarSymbolicWithInt:(jint)id_ {
  JavaLangStringBuilder *var = [new_JavaLangStringBuilder_initWithNSString_(@"y") appendWithInt:id_];
  [((id<JavaUtilSet>) nil_chk(self->varsToEliminate_)) addWithId:[((JavaLangStringBuilder *) nil_chk(var)) description]];
  return [((JavaLangStringBuilder *) nil_chk([new_JavaLangStringBuilder_initWithNSString_(@"(") appendWithJavaLangCharSequence:var])) appendWithNSString:@")"];
}

- (JavaLangStringBuilder *)specialSymbolicWithInt:(jint)id_ {
  return [((JavaLangStringBuilder *) nil_chk([new_JavaLangStringBuilder_initWithNSString_(@"(") appendWithNSString:(id_ == 1) ? @"x" : @"y"])) appendWithNSString:@")"];
}

- (JavaLangStringBuilder *)symbolicWithInt:(jint)id_ {
  JavaLangStringBuilder *var = [new_JavaLangStringBuilder_initWithNSString_(@"x") appendWithInt:id_];
  [((id<JavaUtilSet>) nil_chk(self->varsToEliminate_)) addWithId:[((JavaLangStringBuilder *) nil_chk(var)) description]];
  return [((JavaLangStringBuilder *) nil_chk([new_JavaLangStringBuilder_initWithNSString_(@"(") appendWithJavaLangCharSequence:var])) appendWithNSString:@")"];
}

- (JavaLangStringBuilder *)oppositeWithId:(JavaLangStringBuilder *)value {
  return [((JavaLangStringBuilder *) nil_chk([new_JavaLangStringBuilder_initWithNSString_(@"(-") appendWithJavaLangCharSequence:value])) appendWithNSString:@")"];
}

- (JavaLangStringBuilder *)sqrtWithId:(JavaLangStringBuilder *)value {
  return [((JavaLangStringBuilder *) nil_chk([new_JavaLangStringBuilder_initWithNSString_(@"(sqrt(") appendWithJavaLangCharSequence:value])) appendWithNSString:@"))"];
}
...
- (IOSObjectArray *)eliminateWithJavaUtilCollection:(id<JavaUtilCollection>)translatedRestrictions {
  ...
  if (OrgGeogebraCommonMainApp_get_singularWS_() != nil && [OrgGeogebraCommonMainApp_get_singularWS_() isAvailable] && [OrgGeogebraCommonMainApp_get_singularWS_() isFast]) {
    ...
    @catch (JavaLangThrowable *e) {
      @throw new_OrgGeogebraCommonKernelCASException_initWithNSString_(@"Error in SingularWS computation");
    }
...
void OrgGeogebraCommonKernelLocusequCASTranslator_initWithOrgGeogebraCommonKernelKernel_(OrgGeogebraCommonKernelLocusequCASTranslator *self, OrgGeogebraCommonKernelKernel *kernel) {
  (void) OrgGeogebraCommonKernelLocusequEquationTranslator_init(self);
  self->kernel_ = kernel;
  self->varsToEliminate_ = new_JavaUtilHashSet_init();
}
...
NSString *OrgGeogebraCommonKernelLocusequCASTranslator_constructRestrictionsWithJavaUtilCollection_(id<JavaUtilCollection> restrictions) {
  OrgGeogebraCommonKernelLocusequCASTranslator_initialize();
  JavaLangStringBuilder *equations = new_JavaLangStringBuilder_init();
  IOSObjectArray *rs = [restrictions toArrayWithNSObjectArray:[IOSObjectArray newArrayWithLength:[((id<JavaUtilCollection>) nil_chk(restrictions)) size] type:JavaLangStringBuilder_class_()]];
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(rs))->size_; i++) {
    (void) [equations appendWithJavaLangCharSequence:IOSObjectArray_Get(rs, i)];
    if (i < rs->size_ - 1) {
      (void) [equations appendWithNSString:@" , "];
    }
  }
...
NSString *OrgGeogebraCommonKernelLocusequCASTranslator_convertFloatsToRationalsWithNSString_(NSString *input) {
  OrgGeogebraCommonKernelLocusequCASTranslator_initialize();
  JavaLangStringBuffer *output = new_JavaLangStringBuffer_init();
  ...
  for (ComGoogleGwtRegexpSharedMatchResult *mr = [((ComGoogleGwtRegexpSharedRegExp *) nil_chk(re)) execWithNSString:input]; mr != nil; mr = [re execWithNSString:input]) {
    ...
    if (from <= [mr getIndex] - 1) (void) [output appendWithNSString:[((NSString *) nil_chk(input)) substring:from endIndex:[mr getIndex]]];
    (void) [output appendWithNSString:OrgGeogebraCommonKernelStringTemplate_convertScientificNotationGiacWithNSString_(number)];
    from = [mr getIndex] + ((jint) [((NSString *) nil_chk(number)) length]);
  }
  (void) [output appendWithNSString:[input substring:from endIndex:((jint) [((NSString *) nil_chk(input)) length])]];
