...
- (void)setAssignmentTypeWithOrgGeogebraCommonKernelArithmeticAssignmentTypeEnum:(OrgGeogebraCommonKernelArithmeticAssignmentTypeEnum *)assignmentType {
  OrgGeogebraCommonKernelGeosGeoCasCell_set_assignmentType_(self, assignmentType);
}
    ...
    if (outputVE_ != nil) {
      ...
      if (nativeOutput_ || !([outputVE_ isKindOfClass:[OrgGeogebraCommonKernelArithmeticExpressionNode class]])) {
        ...
        if (OrgGeogebraCommonKernelGeosGeoCasCell_isAssignmentVariableDefined(self)) {
          [sb appendWithNSString:[self getAssignmentLHSWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_latexTemplate_()]];
          if ([geo isKindOfClass:[OrgGeogebraCommonKernelGeosGeoFunction class]]) {
            [sb appendWithChar:'('];
            [sb appendWithNSString:[((OrgGeogebraCommonKernelGeosGeoFunction *) nil_chk(((OrgGeogebraCommonKernelGeosGeoFunction *) check_class_cast(geo, [OrgGeogebraCommonKernelGeosGeoFunction class])))) getVarStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_latexTemplate_()]];
            [sb appendWithChar:')'];
          }
        ...
        if (!([geo isKindOfClass:[OrgGeogebraCommonKernelGeosGeoLocus class]])) {
          [sb appendWithNSString:[((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(geo)) toValueStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_latexTemplate_()]];
        }
        else {
          [sb appendWithNSString:[((OrgGeogebraCommonKernelAlgosAlgoElement *) nil_chk(((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(geo))->algoParent_)) getCommandDescriptionWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_latexTemplate_()]];
        }
      }
      [sb appendWithNSString:@"}"];
      OrgGeogebraCommonKernelGeosGeoCasCell_set_latex_(self, [sb description]);
    }
  }
  return latex_;
}
...
- (void)setUseAsTextWithBoolean:(jboolean)val {
  useAsText_ = val;
  if (!val) {
    OrgGeogebraCommonKernelGeosGeoCasCell_set_input_(self, [((OrgGeogebraCommonKernelGeosGeoText *) nil_chk(self->commentText_)) getTextString]);
  }
  else {
...
- (void)setGeoTextWithOrgGeogebraCommonKernelGeosGeoText:(OrgGeogebraCommonKernelGeosGeoText *)gt {
  if (gt != nil) {
    OrgGeogebraCommonKernelGeosGeoCasCell_set_commentText_(self, gt);
  }
}
...
- (jboolean)setInputWithNSString:(NSString *)inValue
  ...
  OrgGeogebraCommonKernelGeosGeoCasCell_set_input_(self, inNotNull);
  OrgGeogebraCommonKernelGeosGeoCasCell_set_prefix_(self, @"");
  OrgGeogebraCommonKernelGeosGeoCasCell_set_evalVE_(self, [self getInputVE]);
  OrgGeogebraCommonKernelGeosGeoCasCell_set_postfix_(self, @"");
  OrgGeogebraCommonKernelGeosGeoCasCell_setEvalCommandWithNSString_(self, @"");
  OrgGeogebraCommonKernelGeosGeoCasCell_set_evalComment_(self, @"");
...
- (void)updateInputStringWithRowReferencesWithBoolean:(jboolean)force {
  ...
  OrgGeogebraCommonKernelGeosGeoCasCell_set_input_(self, [((OrgGeogebraCommonKernelArithmeticValidExpression *) nil_chk([self getInputVE])) toAssignmentStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_noLocalDefault_() withOrgGeogebraCommonKernelArithmeticAssignmentTypeEnum:[self getAssignmentType]]);
  ...
  if (suppressOutput__) {
    OrgGeogebraCommonKernelGeosGeoCasCell_set_input_(self, JreStrcat("$C", input_, ';'));
    OrgGeogebraCommonKernelGeosGeoCasCell_set_localizedInput_(self, JreStrcat("$C", localizedInput_, ';'));
  }
}
...
- (void)setProcessingInformationWithNSString:(NSString *)prefix
  ...
  OrgGeogebraCommonKernelGeosGeoCasCell_set_evalVE_(self, OrgGeogebraCommonKernelGeosGeoCasCell_parseGeoGebraCASInputAndResolveDummyVarsWithNSString_(self, eval));
  ...
  if (evalVE_ != nil) {
    OrgGeogebraCommonKernelGeosGeoCasCell_set_evalVE_(self, OrgGeogebraCommonKernelGeosGeoCasCell_resolveInputReferencesWithOrgGeogebraCommonKernelArithmeticValidExpression_withJavaUtilTreeSet_(self, evalVE_, inGeos_));
    ...
    OrgGeogebraCommonKernelGeosGeoCasCell_set_prefix_(self, prefix1);
    OrgGeogebraCommonKernelGeosGeoCasCell_set_postfix_(self, postfix1);
  }
  else {
    OrgGeogebraCommonKernelGeosGeoCasCell_set_evalVE_(self, [self getInputVE]);
    OrgGeogebraCommonKernelGeosGeoCasCell_set_prefix_(self, @"");
...
- (JavaUtilTreeSet *)getGeoElementVariables {
  if (inGeos_ == nil) {
    OrgGeogebraCommonKernelGeosGeoCasCell_set_inGeos_(self, OrgGeogebraCommonKernelGeosGeoCasCell_updateInputGeoElementsWithJavaUtilTreeSet_(self, invars_));
  }
  return inGeos_;
}
...
- (void)setEvalCommentWithNSString:(NSString *)comment {
  if (comment != nil) {
    OrgGeogebraCommonKernelGeosGeoCasCell_set_evalComment_(self, comment);
  }
}

- (void)setOutputWithNSString:(NSString *)output
                  withBoolean:(jboolean)prependLabel {
  OrgGeogebraCommonKernelGeosGeoCasCell_set_error_(self, nil);
  ...
  if (nativeOutput_) {
    ...
    if (isFunctionDeclaration && prependLabel) {
      OrgGeogebraCommonKernelGeosGeoCasCell_set_outputVE_(self, (OrgGeogebraCommonKernelArithmeticValidExpression *) check_class_cast([((OrgGeogebraCommonKernelArithmeticValidExpression *) nil_chk(OrgGeogebraCommonKernelGeosGeoCasCell_parseGeoGebraCASInputAndResolveDummyVarsWithNSString_(self, res))) traverseWithOrgGeogebraCommonKernelArithmeticTraversing:OrgGeogebraCommonKernelArithmeticTraversing_FunctionCreator_getCreator()], [OrgGeogebraCommonKernelArithmeticValidExpression class]));
      JavaLangStringBuilder *sb = [new_JavaLangStringBuilder_init() autorelease];
      [sb appendWithNSString:[((OrgGeogebraCommonKernelArithmeticValidExpression *) nil_chk([self getInputVE])) getLabelForAssignment]];
      switch ([[self getAssignmentType] ordinal]) {
        case OrgGeogebraCommonKernelArithmeticAssignmentType_DEFAULT:
        [sb appendWithNSString:[((OrgGeogebraCommonKernelArithmeticValidExpression *) nil_chk([self getInputVE])) getAssignmentOperator]];
        break;
        case OrgGeogebraCommonKernelArithmeticAssignmentType_DELAYED:
        [sb appendWithNSString:[((OrgGeogebraCommonKernelArithmeticValidExpression *) nil_chk([self getInputVE])) getDelayedAssignmentOperator]];
        break;
        case OrgGeogebraCommonKernelArithmeticAssignmentType_NONE:
        break;
      }
      [sb appendWithNSString:OrgGeogebraCommonKernelGeosGeoCasCell_includesNumericCommand(self) ? [((OrgGeogebraCommonKernelArithmeticValidExpression *) nil_chk(outputVE_)) toStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_numericDefault_()] : [((OrgGeogebraCommonKernelArithmeticValidExpression *) nil_chk(outputVE_)) toStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]];
      res = [sb description];
    }
    ...
    OrgGeogebraCommonKernelGeosGeoCasCell_set_outputVE_(self, parsed == nil ? nil : (OrgGeogebraCommonKernelArithmeticValidExpression *) check_class_cast([parsed traverseWithOrgGeogebraCommonKernelArithmeticTraversing:OrgGeogebraCommonKernelArithmeticTraversing_GgbVectRemover_getInstance()], [OrgGeogebraCommonKernelArithmeticValidExpression class]));
    if (outputVE_ != nil) {
      ...
      [outputVE_ traverseWithOrgGeogebraCommonKernelArithmeticTraversing:cr];
      if (inputVE_ != nil) {
        if ([inputVE_ isTopLevelCommand] && [@"Vector" isEqual:[((OrgGeogebraCommonKernelArithmeticCommand *) nil_chk([inputVE_ getTopLevelCommand])) getName]]) {
          ...
          OrgGeogebraCommonKernelGeosGeoCasCell_set_outputVE_(self, wrapped);
        }
      }
    }
    else {
...
- (void)setErrorWithNSString:(NSString *)error {
  OrgGeogebraCommonKernelGeosGeoCasCell_set_error_(self, error);
  OrgGeogebraCommonKernelGeosGeoCasCell_clearStrings(self);
  OrgGeogebraCommonKernelGeosGeoCasCell_set_outputVE_(self, nil);
}
...
- (void)getXMLtagsWithJavaLangStringBuilder:(JavaLangStringBuilder *)sb {
  ...
  if (useAsText_) {
    ...
    [sb appendWithInt:[((OrgGeogebraCommonAwtGColor *) nil_chk([self getFontColor])) getRed]];
    [sb appendWithNSString:@"\" "];
    [sb appendWithNSString:@" b=\""];
    [sb appendWithInt:[((OrgGeogebraCommonAwtGColor *) nil_chk([self getFontColor])) getBlue]];
    [sb appendWithNSString:@"\" "];
    [sb appendWithNSString:@" g=\""];
    [sb appendWithInt:[((OrgGeogebraCommonAwtGColor *) nil_chk([self getFontColor])) getGreen]];
    [sb appendWithNSString:@"\" "];
    [sb appendWithNSString:@"/>\n"];
    [sb appendWithNSString:@"\t\t"];
    [sb appendWithNSString:@"</useAsText>\n"];
...
- (OrgGeogebraCommonKernelGeosGeoElement *)copy__ {
  OrgGeogebraCommonKernelGeosGeoCasCell *casCell = [new_OrgGeogebraCommonKernelGeosGeoCasCell_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
...
- (NSString *)getLabelWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  ...
  switch ([[((OrgGeogebraCommonKernelStringTemplate *) nil_chk(tpl)) getStringType] ordinal]) {
    ...
    [sb appendWithNSString:@" ("];
    [sb appendWithNSString:outputVE_ == nil ? @"?" : [outputVE_ toStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
    [sb appendWithNSString:@") "];
    break;
    default:
    if (row_ >= 0) {
      if ([tpl hasTypeWithOrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_LATEX()]) {
        ...
        [sb appendWithNSString:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_get_CAS_ROW_REFERENCE_PREFIX_()];
      }
...
- (void)doRemove {
  if (assignmentVar_ != nil) {
    [((OrgGeogebraCommonKernelConstruction *) nil_chk(cons_)) removeCasCellLabelWithNSString:assignmentVar_];
    OrgGeogebraCommonKernelGeosGeoCasCell_set_assignmentVar_(self, nil);
  }
  [super doRemove];
...
- (IOSObjectArray *)getFunctionVariables {
  ...
  return [IOSObjectArray arrayWithLength:0 type:OrgGeogebraCommonKernelArithmeticFunctionVariable_class_()];
}
...
- (jboolean)plot {
  ...
  OrgGeogebraCommonKernelGeosGeoCasCell_set_assignmentVar_(self, OrgGeogebraCommonKernelGeosGeoCasCell_getPlotVar(self));
  ...
  if (twinGeo_ != nil && [twinGeo_ getLabelSimple] != nil && [twinGeo_ isEuclidianShowable]) {
    ...
    if ([((NSString *) nil_chk(input_)) hasPrefix:@"Numeric["]) {
      remover = OrgGeogebraCommonKernelArithmeticTraversing_CommandRemover_getRemoverWithNSStringArray_([IOSObjectArray arrayWithObjects:(id[]){ @"KeepInput", @"Evaluate" } count:2 type:NSString_class_()]);
    }
    else {
      remover = OrgGeogebraCommonKernelArithmeticTraversing_CommandRemover_getRemoverWithNSStringArray_([IOSObjectArray arrayWithObjects:(id[]){ @"KeepInput", @"Evaluate", @"Numeric" } count:3 type:NSString_class_()]);
    }
    [((OrgGeogebraCommonKernelArithmeticValidExpression *) nil_chk(ex)) traverseWithOrgGeogebraCommonKernelArithmeticTraversing:remover];
    ...
    if ([twinGeo_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoFunction class]]) {
      [ex traverseWithOrgGeogebraCommonKernelArithmeticTraversing:OrgGeogebraCommonKernelArithmeticTraversing_FunctionCreator_getCreator()];
    }
    [self setAssignmentTypeWithOrgGeogebraCommonKernelArithmeticAssignmentTypeEnum:OrgGeogebraCommonKernelArithmeticAssignmentTypeEnum_get_DEFAULT()];
    ...
    OrgGeogebraCommonKernelGeosGeoCasCell_set_assignmentVar_(self, oldAssignmentVar);
    [self setAssignmentTypeWithOrgGeogebraCommonKernelArithmeticAssignmentTypeEnum:oldOVEAssignmentType];
    self->firstComputeOutput_ = YES;
    OrgGeogebraCommonKernelGeosGeoCasCell_set_evalComment_(self, oldEvalComment);
    OrgGeogebraCommonKernelGeosGeoCasCell_set_evalVE_(self, oldEvalVE);
...
- (NSString *)getTooltipTextWithBoolean:(jboolean)colored
  ...
  if (tooltip_ == nil && outputVE_ != nil) {
    OrgGeogebraCommonKernelGeosGeoCasCell_set_tooltip_(self, [self getOutputWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]);
    OrgGeogebraCommonKernelGeosGeoCasCell_set_tooltip_(self, [((NSString *) nil_chk(tooltip_)) replace:@"gGbSuM(" withSequence:@"\u03a3("]);
    OrgGeogebraCommonKernelGeosGeoCasCell_set_tooltip_(self, [((NSString *) nil_chk(tooltip_)) replace:@"gGbInTeGrAl(" withSequence:@"\u222b("]);
    if (((jint) [((NSString *) nil_chk(tooltip_)) length]) > SCREEN_WIDTH_ && [tooltip_ indexOf:'{'] > -1) {
      ...
      OrgGeogebraCommonKernelGeosGeoCasCell_set_tooltip_(self, [sb description]);
    }
    OrgGeogebraCommonKernelGeosGeoCasCell_set_tooltip_(self, OrgGeogebraCommonKernelGeosGeoElement_indicesToHTMLWithNSString_withBoolean_(tooltip_, YES));
  }
  return tooltip_;
}
...
- (NSString *)getCommandAndComment {
  ...
  if (pointList_) {
    [evalCmdLocal appendWithNSString:[((OrgGeogebraCommonMainLocalization *) nil_chk([self getLoc])) getCommandWithNSString:@"PointList"]];
  }
    ...
    [evalCmdLocal appendWithNSString:[((OrgGeogebraCommonMainLocalization *) nil_chk([self getLoc])) getCommandWithNSString:evalCmd_]];
  }
...
- (void)adjustPointListWithBoolean:(jboolean)onlySolutions {
  if ([((OrgGeogebraCommonKernelArithmeticValidExpression *) nil_chk(evalVE_)) isTopLevelCommand] && ([((NSString *) nil_chk(OrgGeogebraCommonKernelGeosGeoCasCell_getPlotVar(self))) isEqual:assignmentVar_])) {
    ...
    if (!OrgGeogebraCommonKernelGeosGeoCasCell_inequalityInEvalVE(self) && (([((NSString *) nil_chk(cmd)) isEqual:@"Solutions"] || [cmd isEqual:@"CSolutions"] || [cmd isEqual:@"NSolutions"]) || (!onlySolutions && ([cmd isEqual:@"Solve"] || [cmd isEqual:@"CSolve"] || [cmd isEqual:@"NSolve"] || [cmd isEqual:@"Root"] || [cmd isEqual:@"ComplexRoot"])))) {
      if (!pointList_) {
        OrgGeogebraCommonKernelGeosGeoCasCell_set_inputVE_(self, evalVE_);
      }
      pointList_ = YES;
    }
  }
...
void OrgGeogebraCommonKernelGeosGeoCasCell_initWithOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonKernelGeosGeoCasCell *self, OrgGeogebraCommonKernelConstruction *c) {
  ...
  OrgGeogebraCommonKernelGeosGeoCasCell_set_assignmentType_(self, OrgGeogebraCommonKernelArithmeticAssignmentTypeEnum_get_NONE());
  self->suppressOutput__ = NO;
  self->row_ = -1;
  self->ignoreSetAssignment_ = NO;
  OrgGeogebraCommonKernelGeosGeoCasCell_setAndConsume_arbconst_(self, new_OrgGeogebraCommonKernelArithmeticMyArbitraryConstant_initWithOrgGeogebraCommonKernelAlgosConstructionElement_(self));
  self->SCREEN_WIDTH_ = 80;
  OrgGeogebraCommonKernelGeosGeoCasCell_set_input_(self, @"");
  OrgGeogebraCommonKernelGeosGeoCasCell_set_localizedInput_(self, @"");
  OrgGeogebraCommonKernelGeosGeoCasCell_setInputVEWithOrgGeogebraCommonKernelArithmeticValidExpression_(self, nil);
  OrgGeogebraCommonKernelGeosGeoCasCell_set_outputVE_(self, nil);
  OrgGeogebraCommonKernelGeosGeoCasCell_set_prefix_(self, @"");
  OrgGeogebraCommonKernelGeosGeoCasCell_set_evalVE_(self, nil);
  OrgGeogebraCommonKernelGeosGeoCasCell_set_postfix_(self, @"");
  OrgGeogebraCommonKernelGeosGeoCasCell_set_evalCmd_(self, @"");
  OrgGeogebraCommonKernelGeosGeoCasCell_set_evalComment_(self, @"");
  self->useAsText_ = NO;
  OrgGeogebraCommonKernelGeosGeoCasCell_setAndConsume_commentText_(self, new_OrgGeogebraCommonKernelGeosGeoText_initWithOrgGeogebraCommonKernelConstruction_withNSString_(c, @""));
  OrgGeogebraCommonKernelGeosGeoCasCell_set_twinGeo_(self, nil);
}
...
void OrgGeogebraCommonKernelGeosGeoCasCell_updateLocalizedInputWithOrgGeogebraCommonKernelStringTemplate_withNSString_(OrgGeogebraCommonKernelGeosGeoCasCell *self, OrgGeogebraCommonKernelStringTemplate *tpl, NSString *input1) {
  OrgGeogebraCommonKernelGeosGeoCasCell_set_currentLanguage_(self, [((OrgGeogebraCommonMainLocalization *) nil_chk([self getLoc])) getLanguage]);
  OrgGeogebraCommonKernelGeosGeoCasCell_set_localizedInput_(self, OrgGeogebraCommonKernelGeosGeoCasCell_localizeInputWithNSString_withOrgGeogebraCommonKernelStringTemplate_(self, input1, tpl));
}
...
void OrgGeogebraCommonKernelGeosGeoCasCell_updateInputVariablesWithOrgGeogebraCommonKernelArithmeticValidExpression_(OrgGeogebraCommonKernelGeosGeoCasCell *self, OrgGeogebraCommonKernelArithmeticValidExpression *ve) {
  ...
  OrgGeogebraCommonKernelGeosGeoCasCell_setAndConsume_commands_(self, new_JavaUtilHashSet_init());
  [((OrgGeogebraCommonKernelArithmeticValidExpression *) nil_chk(ve)) traverseWithOrgGeogebraCommonKernelArithmeticTraversing:OrgGeogebraCommonKernelArithmeticTraversing_CommandCollector_getCollectorWithJavaUtilSet_(self->commands_)];
  if ([self->commands_ isEmpty]) {
    OrgGeogebraCommonKernelGeosGeoCasCell_set_commands_(self, nil);
  }
  else {
  ...
  OrgGeogebraCommonKernelGeosGeoCasCell_set_inGeos_(self, OrgGeogebraCommonKernelGeosGeoCasCell_updateInputGeoElementsWithJavaUtilTreeSet_(self, self->invars_));
...
void OrgGeogebraCommonKernelGeosGeoCasCell_internalizeInput(OrgGeogebraCommonKernelGeosGeoCasCell *self) {
  OrgGeogebraCommonKernelGeosGeoCasCell_set_input_(self, OrgGeogebraCommonPluginScriptGgbScript_localizedScript2ScriptWithOrgGeogebraCommonMainApp_withNSString_([((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) getApplication], self->input_));
}
...
void OrgGeogebraCommonKernelGeosGeoCasCell_setAssignmentVarWithNSString_(OrgGeogebraCommonKernelGeosGeoCasCell *self, NSString *var) {
  ...
  if (var == nil) {
    OrgGeogebraCommonKernelGeosGeoCasCell_set_assignmentVar_(self, var);
  }
...
void OrgGeogebraCommonKernelGeosGeoCasCell_changeAssignmentVarWithNSString_withNSString_(OrgGeogebraCommonKernelGeosGeoCasCell *self, NSString *oldLabel, NSString *newLabel) {
  ...
  if (oldLabel != nil) {
    OrgGeogebraCommonKernelGeosGeoCasCell_set_input_(self, [((NSString *) nil_chk(self->input_)) replaceFirst:oldLabel withReplacement:newLabel]);
    OrgGeogebraCommonKernelGeosGeoCasCell_set_localizedInput_(self, [((NSString *) nil_chk(self->localizedInput_)) replaceFirst:oldLabel withReplacement:newLabel]);
  }
  OrgGeogebraCommonKernelGeosGeoCasCell_set_assignmentVar_(self, newLabel);
}

JavaUtilTreeSet *OrgGeogebraCommonKernelGeosGeoCasCell_getInVars(OrgGeogebraCommonKernelGeosGeoCasCell *self) {
  if (self->invars_ == nil) OrgGeogebraCommonKernelGeosGeoCasCell_setAndConsume_invars_(self, new_JavaUtilTreeSet_init());
  return self->invars_;
}

JavaUtilTreeSet *OrgGeogebraCommonKernelGeosGeoCasCell_getFunctionVars(OrgGeogebraCommonKernelGeosGeoCasCell *self) {
  if (self->functionvars_ == nil) OrgGeogebraCommonKernelGeosGeoCasCell_setAndConsume_functionvars_(self, new_JavaUtilTreeSet_init());
...
void OrgGeogebraCommonKernelGeosGeoCasCell_clearInVars(OrgGeogebraCommonKernelGeosGeoCasCell *self) {
  OrgGeogebraCommonKernelGeosGeoCasCell_set_invars_(self, nil);
  OrgGeogebraCommonKernelGeosGeoCasCell_set_functionvars_(self, nil);
...
OrgGeogebraCommonKernelArithmeticValidExpression *OrgGeogebraCommonKernelGeosGeoCasCell_resolveInputReferencesWithOrgGeogebraCommonKernelArithmeticValidExpression_withJavaUtilTreeSet_(OrgGeogebraCommonKernelGeosGeoCasCell *self, OrgGeogebraCommonKernelArithmeticValidExpression *ve, JavaUtilTreeSet *inputGeos) {
  ...
  if ([((OrgGeogebraCommonKernelArithmeticValidExpression *) nil_chk(ve)) isTopLevelCommand] && [((id<JavaUtilIterator>) nil_chk([((JavaUtilTreeSet *) nil_chk(OrgGeogebraCommonKernelGeosGeoCasCell_getFunctionVars(self))) iterator])) hasNext]) {
    ...
    if ([ve isKindOfClass:[OrgGeogebraCommonKernelArithmeticExpressionNode class]]) {
      ...
      node = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self->kernel_, ve) autorelease];
    }
  ...
  if (inputGeos != nil) {
    for (OrgGeogebraCommonKernelGeosGeoElement * __strong inGeo in inputGeos) {
      ...
      [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(node)) traverseWithOrgGeogebraCommonKernelArithmeticTraversing:ge];
      if (![((OrgGeogebraCommonKernelArithmeticTraversing_GeoDummyReplacer *) nil_chk(ge)) didReplacement]) {
        ...
        [node traverseWithOrgGeogebraCommonKernelArithmeticTraversing:ge];
      }
    }
  }
...
void OrgGeogebraCommonKernelGeosGeoCasCell_resolveGeoElementReferencesWithOrgGeogebraCommonKernelArithmeticValidExpression_(OrgGeogebraCommonKernelGeosGeoCasCell *self, OrgGeogebraCommonKernelArithmeticValidExpression *outVE) {
  ...
  for (NSString * __strong varLabel in nil_chk(self->invars_)) {
    ...
    if (geo != nil) {
      ...
      [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((OrgGeogebraCommonKernelArithmeticFunctionNVar *) nil_chk(fun)) getExpression])) traverseWithOrgGeogebraCommonKernelArithmeticTraversing:ge];
    }
  }
}
...
void OrgGeogebraCommonKernelGeosGeoCasCell_setEvalCommandWithNSString_(OrgGeogebraCommonKernelGeosGeoCasCell *self, NSString *cmd) {
  ...
  OrgGeogebraCommonKernelGeosGeoCasCell_set_evalCmd_(self, cmd);
...
void OrgGeogebraCommonKernelGeosGeoCasCell_createTwinGeoWithBoolean_(OrgGeogebraCommonKernelGeosGeoCasCell *self, jboolean allowFunction) {
  ...
  [((OrgGeogebraCommonKernelArithmeticValidExpression *) nil_chk(self->outputVE_)) traverseWithOrgGeogebraCommonKernelArithmeticTraversing:repl];
  OrgGeogebraCommonKernelGeosGeoCasCell_setEquationMode(self);
...
void OrgGeogebraCommonKernelGeosGeoCasCell_setEquationMode(OrgGeogebraCommonKernelGeosGeoCasCell *self) {
  if (self->inputVE_ != nil && [[self->inputVE_ unwrap] isKindOfClass:[OrgGeogebraCommonKernelArithmeticEquation class]] && [self->inputVE_ inspectWithOrgGeogebraCommonKernelArithmeticInspecting:[new_OrgGeogebraCommonKernelGeosGeoCasCell_$1_init() autorelease]]) {
...
void OrgGeogebraCommonKernelGeosGeoCasCell_simpleUpdateTwinGeoWithBoolean_(OrgGeogebraCommonKernelGeosGeoCasCell *self, jboolean allowFunction) {
  ...
  [((OrgGeogebraCommonKernelArithmeticValidExpression *) nil_chk(self->outputVE_)) traverseWithOrgGeogebraCommonKernelArithmeticTraversing:repl];
  OrgGeogebraCommonKernelGeosGeoCasCell_setEquationMode(self);
  OrgGeogebraCommonKernelGeosGeoCasCell_set_lastOutputEvaluationGeo_(self, OrgGeogebraCommonKernelGeosGeoCasCell_silentEvalInGeoGebraWithOrgGeogebraCommonKernelArithmeticValidExpression_withBoolean_(self, self->outputVE_, allowFunction));
  if (self->lastOutputEvaluationGeo_ != nil && !OrgGeogebraCommonKernelGeosGeoCasCell_dependsOnDummyWithOrgGeogebraCommonKernelGeosGeoElement_(self->lastOutputEvaluationGeo_)) {
    @try {
      if (OrgGeogebraCommonKernelGeosTestEnum_canSetWithOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoElement_(self->twinGeo_, self->lastOutputEvaluationGeo_)) {
        ...
        OrgGeogebraCommonKernelGeosGeoCasCell_set_twinGeo_(self, self->lastOutputEvaluationGeo_);
...
OrgGeogebraCommonKernelGeosGeoElement *OrgGeogebraCommonKernelGeosGeoCasCell_silentEvalInGeoGebraWithOrgGeogebraCommonKernelArithmeticValidExpression_withBoolean_(OrgGeogebraCommonKernelGeosGeoCasCell *self, OrgGeogebraCommonKernelArithmeticValidExpression *ve, jboolean allowFunction) {
  ...
  OrgGeogebraCommonKernelArithmeticFunctionVariable *fvX = [new_OrgGeogebraCommonKernelArithmeticFunctionVariable_initWithOrgGeogebraCommonKernelKernel_withNSString_(self->kernel_, @"x") autorelease];
  ...
  [((OrgGeogebraCommonKernelArithmeticValidExpression *) nil_chk(ve)) traverseWithOrgGeogebraCommonKernelArithmeticTraversing:variableReplacer];
  OrgGeogebraCommonKernelArithmeticFunctionVariable *fvY = [new_OrgGeogebraCommonKernelArithmeticFunctionVariable_initWithOrgGeogebraCommonKernelKernel_withNSString_(self->kernel_, @"y") autorelease];
  ...
  [ve traverseWithOrgGeogebraCommonKernelArithmeticTraversing:variableReplacer];
  if ([((OrgGeogebraCommonMainApp *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) getApplication])) is3D]) {
    OrgGeogebraCommonKernelArithmeticFunctionVariable *fvZ = [new_OrgGeogebraCommonKernelArithmeticFunctionVariable_initWithOrgGeogebraCommonKernelKernel_withNSString_(self->kernel_, @"z") autorelease];
...
void OrgGeogebraCommonKernelGeosGeoCasCell_computeOutputWithBoolean_withBoolean_(OrgGeogebraCommonKernelGeosGeoCasCell *self, jboolean doTwinGeoUpdate, jboolean allowFunction) {
  ...
  if (self->inputVE_ != nil && [self getAssignmentType] == OrgGeogebraCommonKernelArithmeticAssignmentTypeEnum_get_DELAYED()) {
    ...
    @try {
      if (self->evalVE_ == nil) {
        @throw [new_OrgGeogebraCommonKernelCASException_initWithNSString_(@"Invalid input (evalVE is null)") autorelease];
      }
      jboolean isSubstitute = [self isSubstitute];
      OrgGeogebraCommonKernelGeosGeoCasCell_set_evalVE_(self, OrgGeogebraCommonKernelGeosGeoCasCell_wrapEvaluateWithOrgGeogebraCommonKernelArithmeticValidExpression_withBoolean_(self, self->evalVE_, isSubstitute && ![self isKeepInputUsed]));
      if (OrgGeogebraCommonKernelGeosGeoCasCell_isAssignmentVariableDefined(self)) {
        [self adjustPointListWithBoolean:YES];
      }
      OrgGeogebraCommonKernelGeosGeoCasCell_set_expandedEvalVE_(self, self->pointList_ ? OrgGeogebraCommonKernelGeosGeoCasCell_wrapPointListWithOrgGeogebraCommonKernelArithmeticValidExpression_(self, self->evalVE_) : self->evalVE_);
      if (!([self->expandedEvalVE_ isTopLevelCommand]) || ![((NSString *) nil_chk([((OrgGeogebraCommonKernelArithmeticCommand *) nil_chk([self->expandedEvalVE_ getTopLevelCommand])) getName])) isEqual:@"Delete"]) {
        ...
        OrgGeogebraCommonKernelGeosGeoCasCell_set_expandedEvalVE_(self, (OrgGeogebraCommonKernelArithmeticValidExpression *) check_class_cast([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([self->expandedEvalVE_ wrap])) getCopyWithOrgGeogebraCommonKernelKernel:self->kernel_])) traverseWithOrgGeogebraCommonKernelArithmeticTraversing:fex], [OrgGeogebraCommonKernelArithmeticValidExpression class]));
        OrgGeogebraCommonKernelGeosGeoCasCell_set_expandedEvalVE_(self, OrgGeogebraCommonKernelGeosGeoCasCell_processSolveCommandWithOrgGeogebraCommonKernelArithmeticValidExpression_(self, self->expandedEvalVE_));
      }
    ...
    @catch (JavaLangException *e) {
      OrgGeogebraCommonMainApp_errorWithNSString_(JreStrcat("$@$@", @"GeoCasCell.computeOutput(), CAS eval: ", self->evalVE_, @"\n\t ", e));
      success = NO;
      ce = [new_OrgGeogebraCommonKernelCASException_initWithJavaLangThrowable_(e) autorelease];
    }
  }
  else {
    ...
    @try {
      ...
      if (geos != nil) {
        if (geos->size_ == 0 && [self->evalVE_ isTopLevelCommand] && [@"Delete" isEqual:[((OrgGeogebraCommonKernelArithmeticCommand *) nil_chk([self->evalVE_ getTopLevelCommand])) getName]]) {
          geos = [IOSObjectArray arrayWithObjects:(id[]){ [new_OrgGeogebraCommonKernelGeosGeoBoolean_initWithOrgGeogebraCommonKernelConstruction_withBoolean_(self->cons_, YES) autorelease] } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
        }
        success = YES;
        ...
        OrgGeogebraCommonKernelGeosGeoCasCell_setAndConsume_outputVE_(self, new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self->kernel_, IOSObjectArray_Get(geos, 0)));
...
OrgGeogebraCommonKernelArithmeticValidExpression *OrgGeogebraCommonKernelGeosGeoCasCell_wrapPointListWithOrgGeogebraCommonKernelArithmeticValidExpression_(OrgGeogebraCommonKernelGeosGeoCasCell *self, OrgGeogebraCommonKernelArithmeticValidExpression *arg) {
  OrgGeogebraCommonKernelArithmeticCommand *c = [new_OrgGeogebraCommonKernelArithmeticCommand_initWithOrgGeogebraCommonKernelKernel_withNSString_withBoolean_(self->kernel_, @"PointList", NO) autorelease];
...
OrgGeogebraCommonKernelArithmeticValidExpression *OrgGeogebraCommonKernelGeosGeoCasCell_wrapEvaluateWithOrgGeogebraCommonKernelArithmeticValidExpression_withBoolean_(OrgGeogebraCommonKernelGeosGeoCasCell *self, OrgGeogebraCommonKernelArithmeticValidExpression *arg, jboolean forceWrapping) {
  ...
  OrgGeogebraCommonKernelArithmeticCommand *c = [new_OrgGeogebraCommonKernelArithmeticCommand_initWithOrgGeogebraCommonKernelKernel_withNSString_withBoolean_(self->kernel_, @"Evaluate", NO) autorelease];
...
OrgGeogebraCommonKernelArithmeticValidExpression *OrgGeogebraCommonKernelGeosGeoCasCell_processSolveCommandWithOrgGeogebraCommonKernelArithmeticValidExpression_(OrgGeogebraCommonKernelGeosGeoCasCell *self, OrgGeogebraCommonKernelArithmeticValidExpression *ve) {
  ...
  id<JavaUtilSet> set = [new_JavaUtilTreeSet_initWithJavaUtilComparator_([new_OrgGeogebraCommonKernelGeosGeoCasCell_$2_init() autorelease]) autorelease];
  [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([cmd getArgumentWithInt:0])) traverseWithOrgGeogebraCommonKernelArithmeticTraversing:OrgGeogebraCommonKernelArithmeticTraversing_DummyVariableCollector_getCollectorWithJavaUtilSet_(set)];
  ...
  OrgGeogebraCommonKernelArithmeticMyList *variables = [new_OrgGeogebraCommonKernelArithmeticMyList_initWithOrgGeogebraCommonKernelKernel_withInt_(self->kernel_, n) autorelease];
  jint i = 0;
  id<JavaUtilIterator> ite = [set iterator];
  if (n == 1) {
    if ([((id<JavaUtilIterator>) nil_chk(ite)) hasNext]) {
      [cmd addArgumentWithOrgGeogebraCommonKernelArithmeticExpressionNode:[((OrgGeogebraCommonKernelGeosGeoDummyVariable *) [new_OrgGeogebraCommonKernelGeosGeoDummyVariable_initWithOrgGeogebraCommonKernelConstruction_withNSString_(self->cons_, [ite next]) autorelease]) wrap]];
    }
  }
  else {
    while (i < n && [((id<JavaUtilIterator>) nil_chk(ite)) hasNext]) {
      [variables addListElementWithOrgGeogebraCommonKernelArithmeticExpressionValue:[new_OrgGeogebraCommonKernelGeosGeoDummyVariable_initWithOrgGeogebraCommonKernelConstruction_withNSString_(self->cons_, [((id<JavaUtilIterator>) nil_chk(ite)) next]) autorelease]];
      i++;
    }
    if ([variables size] > 0) {
...
void OrgGeogebraCommonKernelGeosGeoCasCell_finalizeComputationWithBoolean_withNSString_withOrgGeogebraCommonKernelCASException_withBoolean_withBoolean_(OrgGeogebraCommonKernelGeosGeoCasCell *self, jboolean success, NSString *result, OrgGeogebraCommonKernelCASException *ce, jboolean doTwinGeoUpdate, jboolean allowFunction) {
  ...
  if (self->outputVE_ != nil && (!doTwinGeoUpdate || self->twinGeo_ == nil) && ![((OrgGeogebraCommonKernelArithmeticAssignmentTypeEnum *) nil_chk([self getAssignmentType])) isEqual:OrgGeogebraCommonKernelArithmeticAssignmentTypeEnum_get_DELAYED()]) {
    OrgGeogebraCommonKernelArithmeticTraversing_ArbconstReplacer *repl = OrgGeogebraCommonKernelArithmeticTraversing_ArbconstReplacer_getReplacerWithOrgGeogebraCommonKernelArithmeticMyArbitraryConstant_(self->arbconst_);
    [((OrgGeogebraCommonKernelArithmeticMyArbitraryConstant *) nil_chk(self->arbconst_)) reset];
    [self->outputVE_ traverseWithOrgGeogebraCommonKernelArithmeticTraversing:repl];
  }
...
void OrgGeogebraCommonKernelGeosGeoCasCell_setTwinGeoWithOrgGeogebraCommonKernelGeosGeoElement_(OrgGeogebraCommonKernelGeosGeoCasCell *self, OrgGeogebraCommonKernelGeosGeoElement *newTwinGeo) {
  ...
  OrgGeogebraCommonKernelGeosGeoCasCell_set_twinGeo_(self, newTwinGeo);
  if (self->twinGeo_ == nil) {
    return;
  }
...
void OrgGeogebraCommonKernelGeosGeoCasCell_setInputVEWithOrgGeogebraCommonKernelArithmeticValidExpression_(OrgGeogebraCommonKernelGeosGeoCasCell *self, OrgGeogebraCommonKernelArithmeticValidExpression *inputVE) {
  OrgGeogebraCommonKernelGeosGeoCasCell_set_inputVE_(self, inputVE);
}
...
void OrgGeogebraCommonKernelGeosGeoCasCell_clearStrings(OrgGeogebraCommonKernelGeosGeoCasCell *self) {
  OrgGeogebraCommonKernelGeosGeoCasCell_set_tooltip_(self, nil);
  OrgGeogebraCommonKernelGeosGeoCasCell_set_latex_(self, nil);
}
