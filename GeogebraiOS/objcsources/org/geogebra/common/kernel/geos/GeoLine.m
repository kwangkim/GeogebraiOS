...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/kernel/geos/GeoLine.java
//
...
- (OrgGeogebraCommonKernelGeosGeoLine *)copy__ {
  return new_OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelGeosGeoLine_(self);
}
...
- (OrgGeogebraCommonKernelPathParameter *)getTempPathParameter {
  if (tempPP_ == nil) tempPP_ = new_OrgGeogebraCommonKernelPathParameter_init();
  return tempPP_;
}
...
- (void)setWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  ...
  parameter_ = ((OrgGeogebraCommonKernelGeosGeoLine *) nil_chk(l))->parameter_;
...
- (void)setToParametricWithNSString:(NSString *)parameter {
  ...
  if (parameter != nil && ((jint) [parameter length]) > 0) self->parameter_ = parameter;
}
...
- (NSString *)toStringWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  ...
  (void) [sbToStr appendWithNSString:label_];
  (void) [sbToStr appendWithNSString:@": "];
  (void) [sbToStr appendWithNSString:[((JavaLangStringBuilder *) nil_chk(OrgGeogebraCommonKernelGeosGeoLine_buildValueStringWithOrgGeogebraCommonKernelStringTemplate_(self, tpl))) description]];
...
- (void)getXMLtagsWithJavaLangStringBuilder:(JavaLangStringBuilder *)sb {
  ...
  switch (toStringMode_) {
    ...
    (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"\t<eqnStyle style=\"parametric\" parameter=\""];
    (void) [sb appendWithNSString:parameter_];
    (void) [sb appendWithNSString:@"\"/>\n"];
    break;
    case OrgGeogebraCommonKernelGeosGeoLine_EQUATION_EXPLICIT:
    (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"\t<eqnStyle style=\"explicit\"/>\n"];
    break;
    case OrgGeogebraCommonKernelGeosGeoLine_EQUATION_IMPLICIT_NON_CANONICAL:
    break;
    default:
    (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"\t<eqnStyle style=\"implicit\"/>\n"];
  }
}
...
- (id<OrgGeogebraCommonKernelPathMover>)createPathMover {
  return new_OrgGeogebraCommonKernelGeosGeoLine_PathMoverLine_initWithOrgGeogebraCommonKernelGeosGeoLine_(self);
}
...
- (OrgGeogebraCommonKernelGeosGeoFunction *)getGeoFunction {
  ...
  OrgGeogebraCommonKernelArithmeticFunction *fun = new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionVariable_(temp, fv);
  if ([self isLabelSet] || ![self isIndependent]) {
    ...
    ret = new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_(cons_);
...
- (OrgGeogebraCommonKernelMatrixCoords *)getDirectionInD3 {
  if (OrgGeogebraCommonKernelGeosGeoLine_getEndPoint(self) == nil) {
    return new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_(-y_, x_, 0, 0);
  }
...
- (void)addPointOnLineWithOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)p {
  if (pointsOnLine_ == nil) {
    pointsOnLine_ = new_JavaUtilArrayList_init();
  }
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonKernelGeosGeoLine class]) {
    OrgGeogebraCommonKernelGeosGeoLine_vars_ = [IOSObjectArray newArrayWithObjects:(id[]){ @"x", @"y" } count:2 type:NSString_class_()];
    OrgGeogebraCommonKernelGeosGeoLine_sbToStringLHS_ = new_JavaLangStringBuilder_initWithNSString_(@"\u221e");
...
void OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelConstruction_withNSString_withDouble_withDouble_withDouble_(OrgGeogebraCommonKernelGeosGeoLine *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, jdouble a, jdouble b, jdouble c) {
  (void) OrgGeogebraCommonKernelGeosGeoVec3D_initWithOrgGeogebraCommonKernelConstruction_withDouble_withDouble_withDouble_(self, cons, a, b, c);
  self->showUndefinedInAlgebraView__ = NO;
  self->parameter_ = @"\u03bb";
  self->sbBuildValueString_ = new_JavaLangStringBuilder_initWithInt_(50);
  [self setConstructionDefaults];
...
void OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelGeosGeoLine_(OrgGeogebraCommonKernelGeosGeoLine *self, OrgGeogebraCommonKernelGeosGeoLine *line) {
  (void) OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelConstruction_(self, ((OrgGeogebraCommonKernelGeosGeoLine *) nil_chk(line))->cons_);
...
void OrgGeogebraCommonKernelGeosGeoLine_setStandardStartPoint(OrgGeogebraCommonKernelGeosGeoLine *self) {
  if (self->startPoint_ == nil) {
    self->startPoint_ = new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(self->cons_);
...
JavaLangStringBuilder *OrgGeogebraCommonKernelGeosGeoLine_getSbToString(OrgGeogebraCommonKernelGeosGeoLine *self) {
  if (self->sbToString_GeoLine_ == nil) self->sbToString_GeoLine_ = new_JavaLangStringBuilder_initWithInt_(50);
...
JavaLangStringBuilder *OrgGeogebraCommonKernelGeosGeoLine_buildValueStringWithOrgGeogebraCommonKernelStringTemplate_(OrgGeogebraCommonKernelGeosGeoLine *self, OrgGeogebraCommonKernelStringTemplate *tpl) {
  if ([((OrgGeogebraCommonKernelStringTemplate *) nil_chk(tpl)) hasTypeWithOrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_GIAC()]) {
    ...
    (void) [sb appendWithNSString:@"("];
    (void) [sb appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) formatWithDouble:self->x_ withOrgGeogebraCommonKernelStringTemplate:tpl]];
    (void) [sb appendWithNSString:@")*"];
    (void) [sb appendWithNSString:[tpl printVariableNameWithNSString:@"x"]];
    (void) [sb appendWithNSString:@"+("];
    (void) [sb appendWithNSString:[self->kernel_ formatWithDouble:self->y_ withOrgGeogebraCommonKernelStringTemplate:tpl]];
    (void) [sb appendWithNSString:@")*"];
    (void) [sb appendWithNSString:[tpl printVariableNameWithNSString:@"y"]];
    (void) [sb appendWithChar:'='];
    (void) [sb appendWithNSString:[self->kernel_ formatWithDouble:-self->z_ withOrgGeogebraCommonKernelStringTemplate:tpl]];
    return sb;
  }
  IOSDoubleArray *P = [IOSDoubleArray newArrayWithLength:2];
  IOSDoubleArray *g = [IOSDoubleArray newArrayWithLength:3];
  jchar op = '=';
  if (![self isDefined]) {
    return new_JavaLangStringBuilder_initWithNSString_((self->toStringMode_ == OrgGeogebraCommonKernelGeosGeoLine_PARAMETRIC) ? @"X = (?, ?)" : @"y = ?");
  }
  {
    ...
    switch (self->toStringMode_) {
      ...
      *IOSDoubleArray_GetRef(g, 2) = self->z_;
      ...
      (void) [sbBuildValueStr appendWithNSString:@"X = ("];
      (void) [sbBuildValueStr appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) formatWithDouble:IOSDoubleArray_Get(P, 0) withOrgGeogebraCommonKernelStringTemplate:tpl]];
      (void) [sbBuildValueStr appendWithNSString:@", "];
      (void) [sbBuildValueStr appendWithNSString:[self->kernel_ formatWithDouble:IOSDoubleArray_Get(P, 1) withOrgGeogebraCommonKernelStringTemplate:tpl]];
      (void) [sbBuildValueStr appendWithNSString:@") + "];
      (void) [sbBuildValueStr appendWithNSString:self->parameter_];
      (void) [sbBuildValueStr appendWithNSString:@" ("];
      (void) [sbBuildValueStr appendWithNSString:[self->kernel_ formatWithDouble:self->y_ withOrgGeogebraCommonKernelStringTemplate:tpl]];
      (void) [sbBuildValueStr appendWithNSString:@", "];
      (void) [sbBuildValueStr appendWithNSString:[self->kernel_ formatWithDouble:-self->x_ withOrgGeogebraCommonKernelStringTemplate:tpl]];
      (void) [sbBuildValueStr appendWithNSString:@")"];
...
JavaLangStringBuilder *OrgGeogebraCommonKernelGeosGeoLine_getSbBuildValueString(OrgGeogebraCommonKernelGeosGeoLine *self) {
  if (self->sbBuildValueString_ == nil) self->sbBuildValueString_ = new_JavaLangStringBuilder_initWithInt_(50);
...
OrgGeogebraCommonKernelMatrixCoords *OrgGeogebraCommonKernelGeosGeoLine_getStartCoordsInDWithInt_(OrgGeogebraCommonKernelGeosGeoLine *self, jint dimension) {
  ...
  if (self->startPoint_ != nil && [self->startPoint_ isFinite]) {
    ...
    startCoords = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(dimension + 1);
    if (JavaLangMath_absWithDouble_(self->x_) > JavaLangMath_absWithDouble_(self->y_)) {
...
OrgGeogebraCommonKernelMatrixCoords *OrgGeogebraCommonKernelGeosGeoLine_getDirectionInDWithInt_(OrgGeogebraCommonKernelGeosGeoLine *self, jint dimension) {
  OrgGeogebraCommonKernelMatrixCoords *direction = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(dimension + 1);
...
void OrgGeogebraCommonKernelGeosGeoLine_PathMoverLine_initWithOrgGeogebraCommonKernelGeosGeoLine_(OrgGeogebraCommonKernelGeosGeoLine_PathMoverLine *self, OrgGeogebraCommonKernelGeosGeoLine *outer$) {
  self->this$0_ = outer$;
  (void) OrgGeogebraCommonKernelPathMoverGeneric_initWithOrgGeogebraCommonKernelPath_(self, outer$);
}
