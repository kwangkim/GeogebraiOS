...
- (NSString *)toStringWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  ...
  (void) [sbToString_ appendWithNSString:[self getCommandDescriptionWithOrgGeogebraCommonKernelStringTemplate:tpl]];
...
- (id<OrgGeogebraCommonKernelPathMover>)createPathMover {
  return new_OrgGeogebraCommonKernelPathMoverLocus_initWithOrgGeogebraCommonKernelGeosGeoLocusND_(self);
}
...
void OrgGeogebraCommonKernelGeosGeoLocusND_initWithOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonKernelGeosGeoLocusND *self, OrgGeogebraCommonKernelConstruction *c) {
  ...
  self->myPointList_ = new_JavaUtilArrayList_initWithInt_(500);
}
