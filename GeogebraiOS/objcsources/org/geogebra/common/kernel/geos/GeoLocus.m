...
- (OrgGeogebraCommonKernelGeosGeoLocus *)newGeoLocus {
  return new_OrgGeogebraCommonKernelGeosGeoLocus_initWithOrgGeogebraCommonKernelConstruction_(cons_);
}

- (void)insertPointWithDouble:(jdouble)x
                   withDouble:(jdouble)y
                  withBoolean:(jboolean)lineTo {
  [((JavaUtilArrayList *) nil_chk(myPointList_)) addWithId:new_OrgGeogebraCommonKernelMyPoint_initWithDouble_withDouble_withBoolean_(x, y, lineTo)];
}
...
- (id<OrgGeogebraCommonKernelKernelNDGeoSegmentND>)newGeoSegment {
  OrgGeogebraCommonKernelGeosGeoSegment *segment = new_OrgGeogebraCommonKernelGeosGeoSegment_initWithOrgGeogebraCommonKernelConstruction_(cons_);
  OrgGeogebraCommonKernelGeosGeoPoint *p1 = new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons_);
  OrgGeogebraCommonKernelGeosGeoPoint *p2 = new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons_);
...
- (void)setChangingPointWithOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)P {
  changingPoint_ = [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk([((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(P)) getCoordsInD2])) getInhomCoordsInSameDimension];
}
