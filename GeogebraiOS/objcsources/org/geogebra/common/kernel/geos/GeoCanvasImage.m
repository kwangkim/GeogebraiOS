...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/geos/GeoCanvasImage.java
//
...
- (OrgGeogebraCommonKernelGeosGeoElement *)copy__ {
  return [new_OrgGeogebraCommonKernelGeosGeoCanvasImage_initWithOrgGeogebraCommonKernelGeosGeoCanvasImage_(self) autorelease];
}
...
void OrgGeogebraCommonKernelGeosGeoCanvasImage_initWithOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonKernelGeosGeoCanvasImage *self, OrgGeogebraCommonKernelConstruction *c) {
  OrgGeogebraCommonKernelGeosGeoCanvasImage_initWithOrgGeogebraCommonKernelConstruction_withInt_withInt_(self, c, 200, 100);
}
...
void OrgGeogebraCommonKernelGeosGeoCanvasImage_initWithOrgGeogebraCommonKernelConstruction_withInt_withInt_(OrgGeogebraCommonKernelGeosGeoCanvasImage *self, OrgGeogebraCommonKernelConstruction *c, jint width, jint height) {
  ...
  OrgGeogebraCommonKernelGeosGeoCanvasImage_set_bufferedImage_(self, nil);
  ...
  OrgGeogebraCommonKernelGeosGeoCanvasImage_createImageWithOrgGeogebraCommonAwtGBasicStroke_withOrgGeogebraCommonAwtGColor_withOrgGeogebraCommonAwtGColor_withFloat_withInt_withInt_(self, objStroke, [self getAlgebraColor], [self getBackgroundColor], self->alphaValue_, self->pixelWidth_, self->pixelHeight_);
}
...
void OrgGeogebraCommonKernelGeosGeoCanvasImage_initWithOrgGeogebraCommonKernelGeosGeoCanvasImage_(OrgGeogebraCommonKernelGeosGeoCanvasImage *self, OrgGeogebraCommonKernelGeosGeoCanvasImage *img) {
  OrgGeogebraCommonKernelGeosGeoCanvasImage_initWithOrgGeogebraCommonKernelConstruction_(self, ((OrgGeogebraCommonKernelGeosGeoCanvasImage *) nil_chk(img))->cons_);
...
id<OrgGeogebraCommonAwtGGraphics2D> OrgGeogebraCommonKernelGeosGeoCanvasImage_createImageWithOrgGeogebraCommonAwtGBasicStroke_withOrgGeogebraCommonAwtGColor_withOrgGeogebraCommonAwtGColor_withFloat_withInt_withInt_(OrgGeogebraCommonKernelGeosGeoCanvasImage *self, id<OrgGeogebraCommonAwtGBasicStroke> objStroke, OrgGeogebraCommonAwtGColor *color, OrgGeogebraCommonAwtGColor *bgColor1, jfloat backgroundTransparency, jint xInt, jint yInt) {
  OrgGeogebraCommonKernelGeosGeoCanvasImage_set_bufferedImage_(self, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newMyImageWithInt:xInt withInt:yInt withInt:OrgGeogebraCommonAwtGBufferedImage_TYPE_INT_ARGB]);
  OrgGeogebraCommonKernelGeosGeoCanvasImage_set_g_(self, [((id<OrgGeogebraCommonAwtMyImage>) nil_chk(self->bufferedImage_)) createGraphics]);
