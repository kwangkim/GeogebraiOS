...
- (OrgGeogebraCommonKernelGeosGeoElement *)copy__ {
  return new_OrgGeogebraCommonKernelGeosGeoFunctionNVar_initWithOrgGeogebraCommonKernelGeosGeoFunctionNVar_(self);
}
...
- (void)setWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  ...
  fun_ = new_OrgGeogebraCommonKernelArithmeticFunctionNVar_initWithOrgGeogebraCommonKernelArithmeticFunctionNVar_withOrgGeogebraCommonKernelKernel_([((id<OrgGeogebraCommonKernelArithmeticFunctionalNVar>) nil_chk(geoFun)) getFunction], kernel_);
  ...
  isInequality__ = JavaLangBoolean_valueOfWithBoolean_([fun_ initIneqsWithOrgGeogebraCommonKernelArithmeticExpressionNode:OrgGeogebraCommonKernelGeosGeoFunctionNVar_getFunctionExpression(self) withOrgGeogebraCommonKernelArithmeticFunctionalNVar:self]);
}
...
- (void)setDerivatives {
  ...
  fun1_ = [IOSObjectArray newArrayWithLength:((IOSObjectArray *) nil_chk(vars))->size_ type:OrgGeogebraCommonKernelArithmeticFunctionNVar_class_()];
  if (OrgGeogebraCommonKernelGeosGeoFunctionNVar_functionExpander_ == nil) {
    OrgGeogebraCommonKernelGeosGeoFunctionNVar_functionExpander_ = new_OrgGeogebraCommonKernelArithmeticTraversing_FunctionExpander_init();
  }
...
- (OrgGeogebraCommonKernelMatrixCoords *)evaluatePointWithDoubleArray:(IOSDoubleArray *)vals {
  ...
  return new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_(IOSDoubleArray_Get(nil_chk(vals), 0), IOSDoubleArray_Get(vals, 1), [((OrgGeogebraCommonKernelArithmeticFunctionNVar *) nil_chk(fun_)) evaluateWithDoubleArray:vals]);
}
...
- (jdouble)evaluateWithDouble:(jdouble)x
  ...
  if (fun_ == nil) return JavaLangDouble_NaN;
  return [((OrgGeogebraCommonKernelArithmeticFunctionNVar *) nil_chk(fun_)) evaluateWithDoubleArray:[IOSDoubleArray newArrayWithDoubles:(jdouble[]){ x, y, z } count:3]];
}
...
withOrgGeogebraCommonKernelArithmeticMyArbitraryConstant:(OrgGeogebraCommonKernelArithmeticMyArbitraryConstant *)arbconst {
  ...
  if ([((OrgGeogebraCommonKernelGeosGeoFunctionNVar *) nil_chk(ff)) isDefined]) {
    fun_ = [((OrgGeogebraCommonKernelArithmeticFunctionNVar *) nil_chk(ff->fun_)) evalCasCommandWithNSString:ggbCasCmd withBoolean:symbolic withOrgGeogebraCommonKernelArithmeticMyArbitraryConstant:arbconst];
    OrgGeogebraCommonKernelGeosGeoFunctionNVar_checkDefined(self);
  }
  else {
    isDefined__ = NO;
...
withJavaLangStringBuilder:(JavaLangStringBuilder *)sb {
  ...
  (void) [sb appendWithNSString:@" type=\"functionNVar\""];
  (void) [sb appendWithNSString:@" label=\""];
  (void) [sb appendWithNSString:label_];
...
- (void)resetIneqs {
  isInequality__ = JavaLangBoolean_valueOfWithBoolean_([((OrgGeogebraCommonKernelArithmeticFunctionNVar *) nil_chk(fun_)) initIneqsWithOrgGeogebraCommonKernelArithmeticExpressionNode:OrgGeogebraCommonKernelGeosGeoFunctionNVar_getFunctionExpression(self) withOrgGeogebraCommonKernelArithmeticFunctionalNVar:self]);
}
...
- (void)update {
  if (fun_ != nil && [fun_ isBooleanFunction]) {
    isInequality__ = JavaLangBoolean_valueOfWithBoolean_([fun_ updateIneqs]);
  }
  [super update];
}
...
- (jboolean)isInRegionWithDouble:(jdouble)x0
  ...
  return [((OrgGeogebraCommonKernelArithmeticFunctionNVar *) nil_chk(fun_)) evaluateBooleanWithDoubleArray:[IOSDoubleArray newArrayWithDoubles:(jdouble[]){ x0, y0 } count:2]];
}
...
- (void)mirrorWithOrgGeogebraCommonKernelKernelNDGeoLineND:(id<OrgGeogebraCommonKernelKernelNDGeoLineND>)g1 {
  ...
  OrgGeogebraCommonKernelGeosGeoFunctionNVar_mirrorWithOrgGeogebraCommonKernelArithmeticNumberValue_(self, new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, 2.0 * JavaLangMath_atan2WithDouble_withDouble_(-[g getX], [g getY])));
...
void OrgGeogebraCommonKernelGeosGeoFunctionNVar_initWithOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonKernelGeosGeoFunctionNVar *self, OrgGeogebraCommonKernelConstruction *c) {
  ...
  self->der1_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_(1, 0, 0);
  self->der2_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_(0, 1, 0);
...
void OrgGeogebraCommonKernelGeosGeoFunctionNVar_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticFunctionNVar_(OrgGeogebraCommonKernelGeosGeoFunctionNVar *self, OrgGeogebraCommonKernelConstruction *c, OrgGeogebraCommonKernelArithmeticFunctionNVar *f) {
  (void) OrgGeogebraCommonKernelGeosGeoFunctionNVar_initWithOrgGeogebraCommonKernelConstruction_withBoolean_(self, c, NO);
  [self setFunctionWithOrgGeogebraCommonKernelArithmeticFunctionNVar:f];
  if (self->fun_ != nil) self->isInequality__ = JavaLangBoolean_valueOfWithBoolean_([self->fun_ initIneqsWithOrgGeogebraCommonKernelArithmeticExpressionNode:OrgGeogebraCommonKernelGeosGeoFunctionNVar_getFunctionExpression(self) withOrgGeogebraCommonKernelArithmeticFunctionalNVar:self]);
  [self setConstructionDefaults];
}
...
void OrgGeogebraCommonKernelGeosGeoFunctionNVar_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticFunctionNVar_(OrgGeogebraCommonKernelGeosGeoFunctionNVar *self, OrgGeogebraCommonKernelConstruction *c, NSString *label, OrgGeogebraCommonKernelArithmeticFunctionNVar *f) {
  (void) OrgGeogebraCommonKernelGeosGeoFunctionNVar_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticFunctionNVar_(self, c, f);
...
void OrgGeogebraCommonKernelGeosGeoFunctionNVar_initWithOrgGeogebraCommonKernelGeosGeoFunctionNVar_(OrgGeogebraCommonKernelGeosGeoFunctionNVar *self, OrgGeogebraCommonKernelGeosGeoFunctionNVar *f) {
  (void) OrgGeogebraCommonKernelGeosGeoFunctionNVar_initWithOrgGeogebraCommonKernelConstruction_(self, ((OrgGeogebraCommonKernelGeosGeoFunctionNVar *) nil_chk(f))->cons_);
...
NSString *OrgGeogebraCommonKernelGeosGeoFunctionNVar_toXMLStringWithOrgGeogebraCommonKernelStringTemplate_(OrgGeogebraCommonKernelGeosGeoFunctionNVar *self, OrgGeogebraCommonKernelStringTemplate *tpl) {
  ...
  (void) [self->sbToString_ appendWithNSString:self->label_];
  (void) [self->sbToString_ appendWithNSString:@"("];
  (void) [self->sbToString_ appendWithNSString:[self getVarStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
  (void) [self->sbToString_ appendWithNSString:@") = "];
  (void) [self->sbToString_ appendWithNSString:[self toValueStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
