...
- (OrgGeogebraCommonKernelGeosGeoElement *)copy__ {
  return new_OrgGeogebraCommonKernelGeosGeoButton_initWithOrgGeogebraCommonKernelConstruction_withInt_withInt_(cons_, labelOffsetX_, labelOffsetY_);
}
...
- (void)getXMLtagsWithJavaLangStringBuilder:(JavaLangStringBuilder *)sb {
  ...
  if ([self isFixedSize]) {
    (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:JreStrcat("$I$I$", @"\t<dimensions width=\"", width_, @"\" height=\"", height_, @"\" />\n")];
  }
}
...
void OrgGeogebraCommonKernelGeosGeoButton_initWithOrgGeogebraCommonKernelConstruction_withInt_withInt_(OrgGeogebraCommonKernelGeosGeoButton *self, OrgGeogebraCommonKernelConstruction *cons, jint labelOffsetX, jint labelOffsetY) {
  (void) OrgGeogebraCommonKernelGeosGeoButton_initWithOrgGeogebraCommonKernelConstruction_(self, cons);
...
OrgGeogebraCommonKernelGeosGeoButton *OrgGeogebraCommonKernelGeosGeoButton_getNewButtonWithOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonKernelConstruction *cons) {
  ...
  return new_OrgGeogebraCommonKernelGeosGeoButton_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons, OrgGeogebraCommonKernelConstructionDefaults_DEFAULT_BUTTON_SIZE);
}
