...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/kernel/geos/GeoNumeric.java
//
...
- (OrgGeogebraCommonKernelGeosGeoNumeric *)copy__ {
  return new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons_, value_);
}
    ...
    if (visible) {
      ...
      if (!OrgGeogebraCommonKernelGeosGeoNumeric_isIntervalMinActive(self) && !([intervalMin_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoNumeric class]])) {
        if (!OrgGeogebraCommonKernelGeosGeoNumeric_isIntervalMaxActive(self) && !([intervalMax_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoNumeric class]])) {
          ...
          [self setIntervalMinWithOrgGeogebraCommonKernelArithmeticNumberValue:new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, min)];
          [self setIntervalMaxWithOrgGeogebraCommonKernelArithmeticNumberValue:new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, max)];
        }
        else {
          jdouble min = JavaLangMath_minWithDouble_withDouble_(OrgGeogebraCommonKernelGeosGeoNumeric_getIntervalMin(nil_chk(num)), JavaLangMath_floorWithDouble_(value_));
          [self setIntervalMinWithOrgGeogebraCommonKernelArithmeticNumberValue:new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, min)];
...
- (NSString *)getLaTeXdescription {
  if (strLaTeXneedsUpdate_) {
    if (!OrgGeogebraCommonKernelGeosGeoNumeric_isDefined(self)) {
      strLaTeX_ = [((OrgGeogebraCommonMainLocalization *) nil_chk([self getLoc])) getPlainWithNSString:@"Undefined"];
    }
    else if (OrgGeogebraCommonKernelGeosGeoNumeric_isInfinite(self)) {
      if (value_ >= 0) strLaTeX_ = @"\\infty";
      else strLaTeX_ = @"-\\infty";
    }
    else {
...
- (NSString *)toStringWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  if (sbToString_ == nil) {
    sbToString_ = new_JavaLangStringBuilder_initWithInt_(50);
  }
...
- (NSString *)toStringMinimal {
  ...
  [((JavaLangStringBuilder *) nil_chk(sbToString_)) setLengthWithInt:0];
  (void) [sbToString_ appendWithNSString:[self toValueStringMinimal]];
  return [sbToString_ description];
}
...
- (OrgGeogebraCommonKernelArithmeticMyDouble *)getNumber {
  return new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, value_);
}
...
- (void)getXMLtagsWithJavaLangStringBuilder:(JavaLangStringBuilder *)sb {
  ...
  (void) [sb appendWithDouble:value_];
  ...
  if (isDrawable__ || [self isSliderable]) {
    ...
    if (slopeTriangleSize_ > 1) {
      (void) [sb appendWithNSString:@"\t<slopeTriangleSize val=\""];
      (void) [sb appendWithInt:slopeTriangleSize_];
      (void) [sb appendWithNSString:@"\"/>\n"];
    }
  }
...
- (void)getXMLsliderTagWithJavaLangStringBuilder:(JavaLangStringBuilder *)sb {
  ...
  (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"\t<slider"];
  if (OrgGeogebraCommonKernelGeosGeoNumeric_isIntervalMinActive(self) || [intervalMin_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoNumeric class]]) {
    (void) [sb appendWithNSString:@" min=\""];
  ...
  if (OrgGeogebraCommonKernelGeosGeoNumeric_isIntervalMaxActive(self) || [intervalMax_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoNumeric class]]) {
    (void) [sb appendWithNSString:@" max=\""];
  ...
  if (hasAbsoluteScreenLocation_) {
    (void) [sb appendWithNSString:@" absoluteScreenLocation=\"true\""];
  }
  (void) [sb appendWithNSString:@" width=\""];
  (void) [sb appendWithDouble:sliderWidth_];
  (void) [sb appendWithNSString:@"\" x=\""];
  (void) [sb appendWithDouble:sliderX_];
  (void) [sb appendWithNSString:@"\" y=\""];
  (void) [sb appendWithDouble:sliderY_];
  (void) [sb appendWithNSString:@"\" fixed=\""];
  (void) [sb appendWithBoolean:sliderFixed_];
  (void) [sb appendWithNSString:@"\" horizontal=\""];
  (void) [sb appendWithBoolean:sliderHorizontal_];
  (void) [sb appendWithNSString:@"\"/>\n"];
}
...
- (OrgGeogebraCommonKernelGeosGeoFunction *)getGeoFunction {
  OrgGeogebraCommonKernelArithmeticExpressionNode *en = new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, self);
...
- (void)registerMinMaxListenerWithOrgGeogebraCommonKernelGeosGeoNumeric:(OrgGeogebraCommonKernelGeosGeoNumeric *)geo {
  if (minMaxListeners_ == nil) minMaxListeners_ = new_JavaUtilArrayList_init();
...
- (void)setIntervalMinWithDouble:(jdouble)value {
  [self setIntervalMinWithOrgGeogebraCommonKernelArithmeticNumberValue:new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, value)];
}

- (void)setIntervalMaxWithDouble:(jdouble)value {
  [self setIntervalMaxWithOrgGeogebraCommonKernelArithmeticNumberValue:new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, value)];
}
...
- (void)addEVSizeListenerWithOrgGeogebraCommonEuclidianEuclidianViewInterfaceSlim:(id<OrgGeogebraCommonEuclidianEuclidianViewInterfaceSlim>)ev {
  if (evListeners_ == nil) evListeners_ = new_JavaUtilArrayList_init();
...
- (void)moveDependenciesWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)oldGeo {
  ...
  if (num->evListeners_ != nil) {
    ...
    num->evListeners_ = nil;
  }
  if (num->minMaxListeners_ != nil) {
    minMaxListeners_ = num->minMaxListeners_;
...
void OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonKernelGeosGeoNumeric *self, OrgGeogebraCommonKernelConstruction *c) {
  (void) OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withBoolean_(self, c, YES);
}
...
void OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withNSString_withDouble_(OrgGeogebraCommonKernelGeosGeoNumeric *self, OrgGeogebraCommonKernelConstruction *c, NSString *label, jdouble x) {
  (void) OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(self, c, x);
...
id<JavaUtilComparator> OrgGeogebraCommonKernelGeosGeoNumeric_getComparator() {
  ...
  if (OrgGeogebraCommonKernelGeosGeoNumeric_comparator_ == nil) {
    OrgGeogebraCommonKernelGeosGeoNumeric_comparator_ = new_OrgGeogebraCommonKernelGeosGeoNumeric_$1_init();
  }
