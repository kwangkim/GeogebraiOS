...
- (OrgGeogebraCommonKernelGeosGeoElement *)copy__ {
  return new_OrgGeogebraCommonKernelGeosGeoTransferFunction_initWithOrgGeogebraCommonKernelGeosGeoTransferFunction_(self);
}
...
- (void)setWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  ...
  originalFunction_ = [((OrgGeogebraCommonKernelGeosGeoTransferFunction *) nil_chk(gcf)) getFunction];
  omegaStart_ = OrgGeogebraCommonKernelGeosGeoTransferFunction_getOmega(gcf);
  coordsList_ = [gcf getCoordsList];
}
...
- (OrgGeogebraCommonKernelMatrixCoords *)evaluateWithOrgGeogebraCommonUtilComplex:(OrgGeogebraCommonUtilComplex *)z {
  @try {
    if (OrgGeogebraCommonKernelKernel_isEqualWithDouble_withDouble_withDouble_([((OrgGeogebraCommonUtilComplex *) nil_chk(z)) getRe], 0, OrgGeogebraCommonKernelKernel_MIN_PRECISION)) {
      return (new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_([((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk(originalFunction_)) evaluateWithDouble:0], 0, 1));
    }
    exp_ = [((id<OrgGeogebraCommonKernelParserParserInterface>) nil_chk(parser_)) parseExpressionWithNSString:[z description]];
    currentFunction_ = new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticFunction_withOrgGeogebraCommonKernelKernel_(originalFunction_, kernel_);
    t_ = OrgGeogebraCommonKernelArithmeticTraversing_VariableReplacer_getReplacerWithNSString_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonKernelKernel_([currentFunction_ getVarStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()], exp_, kernel_);
    (void) [currentFunction_ traverseWithOrgGeogebraCommonKernelArithmeticTraversing:t_];
    v_ = (OrgGeogebraCommonKernelGeosGeoVec2D *) check_class_cast([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk([currentFunction_ evaluateComplex])) getExpression])) evaluateWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()], [OrgGeogebraCommonKernelGeosGeoVec2D class]);
    return new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_([((OrgGeogebraCommonKernelGeosGeoVec2D *) nil_chk(v_)) getX], [v_ getY]);
  }
...
- (OrgGeogebraCommonKernelMatrixCoords *)evaluateWithDouble:(jdouble)x {
  @try {
    ...
    OrgGeogebraCommonKernelGeosGeoVec2D *xi = new_OrgGeogebraCommonKernelGeosGeoVec2D_initWithOrgGeogebraCommonKernelKernel_withDouble_withDouble_(kernel_, 0, x);
    ...
    (void) [currentFunction_ traverseWithOrgGeogebraCommonKernelArithmeticTraversing:t_];
    v_ = (OrgGeogebraCommonKernelGeosGeoVec2D *) check_class_cast([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk([currentFunction_ evaluateComplex])) getExpression])) evaluateWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()], [OrgGeogebraCommonKernelGeosGeoVec2D class]);
    return new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_([((OrgGeogebraCommonKernelGeosGeoVec2D *) nil_chk(v_)) getX], [v_ getY], 1);
  }
...
withOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  if (isDefined__) {
    ...
    if ([((OrgGeogebraCommonMainApp *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) getApplication])) isHTML5Applet]) {
      (void) [sb appendWithNSString:[((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk(originalFunction_)) toLaTeXStringWithBoolean:symbolic withOrgGeogebraCommonKernelStringTemplate:tpl]];
      (void) [sb appendWithNSString:@" , "];
      (void) [sb appendWithNSString:[kernel_ formatWithDouble:-omegaStart_ withOrgGeogebraCommonKernelStringTemplate:tpl]];
      (void) [sb appendWithNSString:@" \\le "];
      (void) [sb appendWithChar:OrgGeogebraCommonUtilUnicode_omega];
      (void) [sb appendWithNSString:@" \\le "];
      (void) [sb appendWithNSString:[kernel_ formatWithDouble:omegaStart_ withOrgGeogebraCommonKernelStringTemplate:tpl]];
    }
    else {
      (void) [sb appendWithNSString:@"\\left."];
      (void) [sb appendWithNSString:JreStrcat("$$", label_, @":  ")];
      (void) [sb appendWithNSString:[((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk(originalFunction_)) toLaTeXStringWithBoolean:symbolic withOrgGeogebraCommonKernelStringTemplate:tpl]];
...
void OrgGeogebraCommonKernelGeosGeoTransferFunction_initWithOrgGeogebraCommonKernelGeosGeoTransferFunction_(OrgGeogebraCommonKernelGeosGeoTransferFunction *self, OrgGeogebraCommonKernelGeosGeoTransferFunction *gcf) {
  (void) OrgGeogebraCommonKernelGeosGeoElement_initWithOrgGeogebraCommonKernelConstruction_(self, ((OrgGeogebraCommonKernelGeosGeoTransferFunction *) nil_chk(gcf))->cons_);
  self->isDefined__ = YES;
  self->omegaStart_ = 50;
  self->coordsList_ = new_JavaUtilArrayList_init();
  self->step_ = 1.001;
...
void OrgGeogebraCommonKernelGeosGeoTransferFunction_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelGeosGeoList_withInt_(OrgGeogebraCommonKernelGeosGeoTransferFunction *self, OrgGeogebraCommonKernelConstruction *c, NSString *label, OrgGeogebraCommonKernelGeosGeoList *num, OrgGeogebraCommonKernelGeosGeoList *den, jint omega) {
  ...
  if ([((OrgGeogebraCommonPluginGeoClassEnum *) nil_chk([((OrgGeogebraCommonKernelGeosGeoList *) nil_chk(num)) getElementType])) isEqual:OrgGeogebraCommonPluginGeoClassEnum_get_NUMERIC()] && [((OrgGeogebraCommonPluginGeoClassEnum *) nil_chk([((OrgGeogebraCommonKernelGeosGeoList *) nil_chk(den)) getElementType])) isEqual:OrgGeogebraCommonPluginGeoClassEnum_get_NUMERIC()]) {
    ...
    OrgGeogebraCommonKernelGeosGeoFunction *f = new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticFunction_(c, strFunc);
    self->geoFunction_ = new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelGeosGeoFunction_(f);
    self->originalFunction_ = [self->geoFunction_ getFunction];
    self->parser_ = [((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) getParser];
...
void OrgGeogebraCommonKernelGeosGeoTransferFunction_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelGeosGeoList_(OrgGeogebraCommonKernelGeosGeoTransferFunction *self, OrgGeogebraCommonKernelConstruction *c, NSString *label, OrgGeogebraCommonKernelGeosGeoList *num, OrgGeogebraCommonKernelGeosGeoList *den) {
  (void) OrgGeogebraCommonKernelGeosGeoTransferFunction_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelGeosGeoList_withInt_(self, c, label, num, den, 10);
}
...
OrgGeogebraCommonKernelArithmeticFunction *OrgGeogebraCommonKernelGeosGeoTransferFunction_createFunctionWithOrgGeogebraCommonKernelGeosGeoList_withOrgGeogebraCommonKernelGeosGeoList_(OrgGeogebraCommonKernelGeosGeoTransferFunction *self, OrgGeogebraCommonKernelGeosGeoList *num, OrgGeogebraCommonKernelGeosGeoList *den) {
  OrgGeogebraCommonKernelArithmeticFunctionVariable *s = new_OrgGeogebraCommonKernelArithmeticFunctionVariable_initWithOrgGeogebraCommonKernelKernel_withNSString_(self->kernel_, @"s");
