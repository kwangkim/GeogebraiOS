...
- (OrgGeogebraCommonKernelGeosGeoElement *)copy__ {
  return new_OrgGeogebraCommonKernelGeosGeoCurveCartesian_initWithOrgGeogebraCommonKernelGeosGeoCurveCartesian_(self);
}
...
- (void)setWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  ...
  [self setFunWithInt:0 withOrgGeogebraCommonKernelArithmeticFunction:new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticFunction_withOrgGeogebraCommonKernelKernel_(IOSObjectArray_Get(nil_chk(((OrgGeogebraCommonKernelGeosGeoCurveCartesian *) nil_chk(geoCurve))->fun_), 0), self->kernel_)];
  [self setFunWithInt:1 withOrgGeogebraCommonKernelArithmeticFunction:new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticFunction_withOrgGeogebraCommonKernelKernel_(IOSObjectArray_Get(geoCurve->fun_, 1), self->kernel_)];
...
- (void)mirrorWithOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)P {
  [self dilateWithOrgGeogebraCommonKernelArithmeticNumberValue:new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, -1.0) withOrgGeogebraCommonKernelMatrixCoords:P];
}
...
- (void)mirrorWithOrgGeogebraCommonKernelKernelNDGeoLineND:(id<OrgGeogebraCommonKernelKernelNDGeoLineND>)g1 {
  ...
  OrgGeogebraCommonKernelGeosGeoCurveCartesian_mirrorWithOrgGeogebraCommonKernelArithmeticNumberValue_(self, new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, 2.0 * JavaLangMath_atan2WithDouble_withDouble_(-[g getX], [g getY])));
  OrgGeogebraCommonKernelGeosGeoCurveCartesian_translateWithDouble_withDouble_(self, -qx, -qy);
}
...
- (JavaUtilArrayList *)getPointsOnCurveWithInt:(jint)n
  ...
  for (jdouble i = 0, v = startInterval; i < n; i++, v += step) {
    ...
    *IOSDoubleArray_GetRef(point, 1) = [((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk([self getFunWithInt:1])) evaluateWithDouble:v];
    [pointList addWithId:new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withDouble_withDouble_withDouble_(self->cons_, IOSDoubleArray_Get(point, 0), IOSDoubleArray_Get(point, 1), 1)];
  }
  return pointList;
}
...
- (void)matrixTransformWithDouble:(jdouble)a
  ...
  OrgGeogebraCommonKernelArithmeticMyDouble *ma = new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, a);
  OrgGeogebraCommonKernelArithmeticMyDouble *mb = new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, b);
  OrgGeogebraCommonKernelArithmeticMyDouble *mc = new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, c);
  OrgGeogebraCommonKernelArithmeticMyDouble *md = new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, d);
  OrgGeogebraCommonKernelArithmeticExpressionNode *exprX = [((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk(([((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk([self getFunWithInt:0])) deepCopyWithOrgGeogebraCommonKernelKernel:self->kernel_]))) getExpression];
  OrgGeogebraCommonKernelArithmeticExpressionNode *exprY = [((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk(([((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk([self getFunWithInt:1])) deepCopyWithOrgGeogebraCommonKernelKernel:self->kernel_]))) getExpression];
...
- (NSString *)toStringWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  ...
  if ([self isLabelSet]) {
    (void) [sbToString appendWithNSString:self->label_];
...
- (NSString *)toValueStringWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  if (self->isDefined__) {
    ...
    if ([((OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum *) nil_chk([((OrgGeogebraCommonKernelStringTemplate *) nil_chk(tpl)) getStringType])) isEqual:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_GIAC()]) {
      (void) [sbTemp appendWithNSString:@"equation(plotparam(["];
      (void) [sbTemp appendWithNSString:[((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk([self getFunWithInt:0])) toValueStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
      (void) [sbTemp appendWithChar:','];
      (void) [sbTemp appendWithNSString:[((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk([self getFunWithInt:1])) toValueStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
      (void) [sbTemp appendWithNSString:@"],"];
      (void) [sbTemp appendWithNSString:[((OrgGeogebraCommonKernelArithmeticFunctionVariable *) nil_chk([((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk([self getFunWithInt:0])) getFunctionVariable])) toStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_giacTemplate_()]];
      (void) [sbTemp appendWithChar:','];
      (void) [sbTemp appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) formatWithDouble:[self getMinParameter] withOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_giacTemplate_()]];
      (void) [sbTemp appendWithChar:','];
      (void) [sbTemp appendWithNSString:[self->kernel_ formatWithDouble:[self getMaxParameter] withOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_giacTemplate_()]];
      (void) [sbTemp appendWithNSString:@"))"];
    }
    else {
      (void) [sbTemp appendWithChar:'('];
...
- (NSString *)toSymbolicStringWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  if (self->isDefined__) {
    ...
    (void) [sbTemp appendWithChar:'('];
    (void) [sbTemp appendWithNSString:[((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk([self getFunWithInt:0])) toStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
    (void) [sbTemp appendWithNSString:@", "];
    (void) [sbTemp appendWithNSString:[((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk([self getFunWithInt:1])) toStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
    (void) [sbTemp appendWithChar:')'];
    return [sbTemp description];
  }
  return [((OrgGeogebraCommonMainLocalization *) nil_chk([self getLoc])) getPlainWithNSString:@"Undefined"];
...
- (jdouble)getClosestParameterWithOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)P
  ...
  if (self->distFun_ == nil) self->distFun_ = new_OrgGeogebraCommonKernelParametricCurveDistanceFunction_initWithOrgGeogebraCommonKernelGeosParametricCurve_(self);
...
- (jdouble)evaluateCurvatureWithDouble:(jdouble)t {
  ...
  IOSDoubleArray *f2eval = [IOSDoubleArray newArrayWithLength:2];
...
- (void)mirrorWithOrgGeogebraCommonKernelGeosGeoConic:(OrgGeogebraCommonKernelGeosGeoConic *)c {
  if ([((OrgGeogebraCommonKernelGeosGeoConic *) nil_chk(c)) getType] == OrgGeogebraCommonKernelKernelNDGeoConicNDConstants_CONIC_CIRCLE) {
    ...
    OrgGeogebraCommonKernelArithmeticExpressionNode *exprX = [((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk(([((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk([self getFunWithInt:0])) deepCopyWithOrgGeogebraCommonKernelKernel:self->kernel_]))) getExpression];
    OrgGeogebraCommonKernelArithmeticExpressionNode *exprY = [((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk(([((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk([self getFunWithInt:1])) deepCopyWithOrgGeogebraCommonKernelKernel:self->kernel_]))) getExpression];
    OrgGeogebraCommonKernelArithmeticMyDouble *d2 = new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, 2);
    OrgGeogebraCommonKernelArithmeticExpressionNode *sf = new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self->kernel_, new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, r * r), OrgGeogebraCommonPluginOperationEnum_get_DIVIDE(), [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(exprX)) powerWithOrgGeogebraCommonKernelArithmeticExpressionValue:d2])) plusWithOrgGeogebraCommonKernelArithmeticExpressionValue:[((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(exprY)) powerWithOrgGeogebraCommonKernelArithmeticExpressionValue:d2]]);
...
- (void)matrixTransformWithDouble:(jdouble)a00
  ...
  OrgGeogebraCommonKernelArithmeticMyDouble *ma00 = new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, a00);
  OrgGeogebraCommonKernelArithmeticMyDouble *ma01 = new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, a01);
  OrgGeogebraCommonKernelArithmeticMyDouble *ma02 = new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, a02);
  OrgGeogebraCommonKernelArithmeticMyDouble *ma10 = new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, a10);
  OrgGeogebraCommonKernelArithmeticMyDouble *ma11 = new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, a11);
  OrgGeogebraCommonKernelArithmeticMyDouble *ma12 = new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, a12);
  OrgGeogebraCommonKernelArithmeticMyDouble *ma20 = new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, a20);
  OrgGeogebraCommonKernelArithmeticMyDouble *ma21 = new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, a21);
  OrgGeogebraCommonKernelArithmeticMyDouble *ma22 = new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, a22);
  OrgGeogebraCommonKernelArithmeticExpressionNode *exprX = [((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk(([((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk([self getFunWithInt:0])) deepCopyWithOrgGeogebraCommonKernelKernel:self->kernel_]))) getExpression];
  OrgGeogebraCommonKernelArithmeticExpressionNode *exprY = [((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk(([((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk([self getFunWithInt:1])) deepCopyWithOrgGeogebraCommonKernelKernel:self->kernel_]))) getExpression];
...
- (void)setFromPolyLineWithOrgGeogebraCommonKernelKernelNDGeoPointNDArray:(IOSObjectArray *)points
  ...
  for (jint i = 1; i < limit; i++) {
    ...
    cumulative += coef;
    cumulativeY += coefY;
    enx = [enx plusWithOrgGeogebraCommonKernelArithmeticExpressionValue:[greater multiplyWithOrgGeogebraCommonKernelArithmeticExpressionValue:new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, coef)]];
    eny = [eny plusWithOrgGeogebraCommonKernelArithmeticExpressionValue:[greater multiplyWithOrgGeogebraCommonKernelArithmeticExpressionValue:new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, coefY)]];
  }
  enx = [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(enx)) plusWithOrgGeogebraCommonKernelArithmeticExpressionValue:new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self->kernel_, fv, OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY(), new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, cumulative))];
  eny = [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(eny)) plusWithOrgGeogebraCommonKernelArithmeticExpressionValue:new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self->kernel_, fv, OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY(), new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, cumulativeY))];
  enx = [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(enx)) plusWithOrgGeogebraCommonKernelArithmeticExpressionValue:new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, -sum)];
  eny = [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(eny)) plusWithOrgGeogebraCommonKernelArithmeticExpressionValue:new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, -sumY)];
  OrgGeogebraCommonKernelArithmeticFunction *xFun = new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionVariable_(enx, fv);
  OrgGeogebraCommonKernelArithmeticFunction *yFun = new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionVariable_(eny, fv);
...
- (OrgGeogebraCommonKernelKernelNDGeoCurveCartesianND *)newGeoCurveCartesianWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)cons {
  return new_OrgGeogebraCommonKernelGeosGeoCurveCartesian_initWithOrgGeogebraCommonKernelConstruction_(cons);
}
...
void OrgGeogebraCommonKernelGeosGeoCurveCartesian_initWithOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonKernelGeosGeoCurveCartesian *self, OrgGeogebraCommonKernelConstruction *c) {
  (void) OrgGeogebraCommonKernelKernelNDGeoCurveCartesianND_initWithOrgGeogebraCommonKernelConstruction_withInt_(self, c, 2);
  self->trace_ = NO;
}
...
void OrgGeogebraCommonKernelGeosGeoCurveCartesian_initWithOrgGeogebraCommonKernelGeosGeoCurveCartesian_(OrgGeogebraCommonKernelGeosGeoCurveCartesian *self, OrgGeogebraCommonKernelGeosGeoCurveCartesian *f) {
  (void) OrgGeogebraCommonKernelKernelNDGeoCurveCartesianND_initWithOrgGeogebraCommonKernelConstruction_withInt_(self, ((OrgGeogebraCommonKernelGeosGeoCurveCartesian *) nil_chk(f))->cons_, 2);
  self->trace_ = NO;
