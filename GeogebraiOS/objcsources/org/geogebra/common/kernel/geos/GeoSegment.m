...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/geos/GeoSegment.java
//
...
- (NSString *)toStringWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  ...
  [sbToString_GeoSegment_ appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) formatWithDouble:length_ withOrgGeogebraCommonKernelStringTemplate:tpl]];
...
- (IOSObjectArray *)createTransformedObjectWithOrgGeogebraCommonKernelTransform:(OrgGeogebraCommonKernelTransform *)t
  ...
  if (keepTypeOnGeometricTransform_ && [((OrgGeogebraCommonKernelTransform *) nil_chk(t)) isAffine]) {
    ...
    IOSObjectArray *geos = [IOSObjectArray arrayWithObjects:(id[]){ IOSObjectArray_Get(nil_chk([t transformWithOrgGeogebraCommonKernelGeosGeoElement:self withNSString:transformedLabel]), 0) } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    return geos;
  }
  else {
...
- (OrgGeogebraCommonKernelMatrixCoords *)getLabelPosition {
  return [new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_([self getPointXWithDouble:0.5], [self getPointYWithDouble:0.5], 0, 1) autorelease];
}
...
- (void)setFromMetaWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)poly {
  OrgGeogebraCommonKernelGeosGeoSegment_set_meta_(self, poly);
}
...
- (OrgGeogebraCommonKernelGeosGeoElement *)copyFreeSegment {
  ...
  OrgGeogebraCommonKernelAlgosAlgoJoinPointsSegment *algo = [new_OrgGeogebraCommonKernelAlgosAlgoJoinPointsSegment_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_(cons_, nil, startPoint1, endPoint1) autorelease];
...
void OrgGeogebraCommonKernelGeosGeoSegment_initWithOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonKernelGeosGeoSegment *self, OrgGeogebraCommonKernelConstruction *c) {
  ...
  OrgGeogebraCommonKernelGeosGeoSegment_setAndConsume_sbToString_GeoSegment_(self, new_JavaLangStringBuilder_initWithInt_(30));
  OrgGeogebraCommonKernelGeosGeoSegment_set_meta_(self, nil);
