...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/geos/GeoText.java
//
...
- (OrgGeogebraCommonKernelGeosGeoElement *)copy__ {
  return [new_OrgGeogebraCommonKernelGeosGeoText_initWithOrgGeogebraCommonKernelGeosGeoText_(self) autorelease];
}
...
- (void)setWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  ...
  if (cons_ != geo->cons_ && [self isAlgoMacroOutput]) {
    ...
    OrgGeogebraCommonKernelGeosGeoText_set_str_(self, gt->str_);
  ...
  isLaTeXorMathML_ = gt->isLaTeXorMathML_;
  isMathML__ = gt->isMathML__;
  OrgGeogebraCommonKernelGeosGeoText_set_boundingBox_(self, [gt getBoundingBox]);
  @try {
...
- (void)initStartPointWithOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)p
                                                            withInt:(jint)number {
  OrgGeogebraCommonKernelGeosGeoText_set_startPoint_(self, p);
}
...
- (void)setStartPointWithOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)p {
  ...
  if (p == nil) {
    if (startPoint_ != nil) OrgGeogebraCommonKernelGeosGeoText_set_startPoint_(self, [startPoint_ copy__]);
    else OrgGeogebraCommonKernelGeosGeoText_set_startPoint_(self, nil);
    labelOffsetX_ = 0;
    labelOffsetY_ = 0;
  }
  else {
...
- (void)setUndefined {
  OrgGeogebraCommonKernelGeosGeoText_set_str_(self, nil);
}
...
- (NSString *)toOutputValueStringWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl1 {
  ...
  if ([((OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum *) nil_chk(printForm)) isEqual:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_LATEX()]) [sbToString_ appendWithNSString:@"\\text{``"];
  else [sbToString_ appendWithChar:'"'];
  if (str_ != nil) [sbToString_ appendWithNSString:str_];
  if ([printForm isEqual:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_LATEX()]) [sbToString_ appendWithNSString:@"''}"];
  else [sbToString_ appendWithChar:'"'];
...
- (void)addTextDescendantWithOrgGeogebraCommonKernelGeosGeoText:(OrgGeogebraCommonKernelGeosGeoText *)text {
  ...
  OrgGeogebraCommonKernelGeosGeoText_set_linkedText_(self, text);
}
...
- (OrgGeogebraCommonKernelArithmeticMyStringBuffer *)getText {
  if (str_ != nil) return [new_OrgGeogebraCommonKernelArithmeticMyStringBuffer_initWithOrgGeogebraCommonKernelKernel_withNSString_(kernel_, str_) autorelease];
  return [new_OrgGeogebraCommonKernelArithmeticMyStringBuffer_initWithOrgGeogebraCommonKernelKernel_withNSString_(kernel_, @"") autorelease];
}
...
- (void)getXMLtagsWithJavaLangStringBuilder:(JavaLangStringBuilder *)sb {
  ...
  [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:OrgGeogebraCommonKernelGeosGeoText_getXMLlocation(self)];
...
- (void)setAbsoluteScreenLocActiveWithBoolean:(jboolean)flag {
  ...
  if (flag) {
    if (startPoint_ != nil) {
      ...
      OrgGeogebraCommonKernelGeosGeoText_set_startPoint_(self, nil);
    }
  }
  else {
    labelOffsetX_ = 0;
...
- (void)setBoundingBoxWithDouble:(jdouble)x
  ...
  if (firstTime) {
    OrgGeogebraCommonKernelGeosGeoText_set_boundingBox_(self, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newRectangle2D]);
  }
...
- (void)setZero {
  OrgGeogebraCommonKernelGeosGeoText_set_str_(self, @"");
}
...
- (void)setSpreadsheetTraceableWithOrgGeogebraCommonKernelArithmeticExpressionNode:(OrgGeogebraCommonKernelArithmeticExpressionNode *)leftTree
  ...
  OrgGeogebraCommonKernelGeosGeoText_set_spreadsheetTraceableLeftTree_(self, leftTree);
  OrgGeogebraCommonKernelGeosGeoText_set_spreadsheetTraceableValue_(self, value);
}

- (void)initSpreadsheetTraceableCase {
  OrgGeogebraCommonKernelGeosGeoText_set_spreadsheetTraceableCase_(self, OrgGeogebraCommonKernelGeosGeoText_SpreadsheetTraceableCaseEnum_get_SPREADSHEET_TRACEABLE_NOT_TESTED());
}
    ...
    switch ([spreadsheetTraceableCase_ ordinal]) {
      ...
      if (algo != nil && ([algo isKindOfClass:[OrgGeogebraCommonKernelAlgosAlgoDependentText class]])) {
        ...
        if (spreadsheetTraceableLeftTree_ != nil) {
          OrgGeogebraCommonKernelGeosGeoText_set_spreadsheetTraceableCase_(self, OrgGeogebraCommonKernelGeosGeoText_SpreadsheetTraceableCaseEnum_get_SPREADSHEET_TRACEABLE_TRUE());
          if (spreadsheetTraceableValue_ == nil) OrgGeogebraCommonKernelGeosGeoText_set_traceModes_(self, OrgGeogebraCommonKernelGeosGeoElement_TraceModesEnumEnum_get_ONLY_COPY());
          else OrgGeogebraCommonKernelGeosGeoText_set_traceModes_(self, OrgGeogebraCommonKernelGeosGeoElement_TraceModesEnumEnum_get_ONE_VALUE_OR_COPY());
          return YES;
        }
      }
      OrgGeogebraCommonKernelGeosGeoText_set_spreadsheetTraceableCase_(self, OrgGeogebraCommonKernelGeosGeoText_SpreadsheetTraceableCaseEnum_get_SPREADSHEET_TRACEABLE_TRUE());
      OrgGeogebraCommonKernelGeosGeoText_set_traceModes_(self, OrgGeogebraCommonKernelGeosGeoElement_TraceModesEnumEnum_get_ONLY_COPY());
      return YES;
      default:
      return NO;
    }
...
- (void)addToSpreadsheetTraceListWithJavaUtilArrayList:(JavaUtilArrayList *)spreadsheetTraceList {
  OrgGeogebraCommonKernelGeosGeoNumeric *numeric = [new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons_, [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(spreadsheetTraceableValue_)) evaluateDouble]) autorelease];
...
void OrgGeogebraCommonKernelGeosGeoText_initWithOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonKernelGeosGeoText *self, OrgGeogebraCommonKernelConstruction *c) {
  ...
  OrgGeogebraCommonKernelGeosGeoText_setAndConsume_sbToString_(self, new_JavaLangStringBuilder_initWithInt_(80));
  self->isTextCommand__ = NO;
  self->alwaysFixed_ = NO;
  OrgGeogebraCommonKernelGeosGeoText_set_tpl_(self, OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_());
  OrgGeogebraCommonKernelGeosGeoText_set_spreadsheetTraceableCase_(self, OrgGeogebraCommonKernelGeosGeoText_SpreadsheetTraceableCaseEnum_get_SPREADSHEET_TRACEABLE_NOT_TESTED());
...
void OrgGeogebraCommonKernelGeosGeoText_initWithOrgGeogebraCommonKernelGeosGeoText_(OrgGeogebraCommonKernelGeosGeoText *self, OrgGeogebraCommonKernelGeosGeoText *text) {
  OrgGeogebraCommonKernelGeosGeoText_initWithOrgGeogebraCommonKernelConstruction_(self, ((OrgGeogebraCommonKernelGeosGeoText *) nil_chk(text))->cons_);
...
void OrgGeogebraCommonKernelGeosGeoText_setTextStringWithNSString_(OrgGeogebraCommonKernelGeosGeoText *self, NSString *text2) {
  ...
  if (self->isLaTeXorMathML_) {
    OrgGeogebraCommonKernelGeosGeoText_set_str_(self, OrgGeogebraCommonUtilStringUtil_toLaTeXStringWithNSString_withBoolean_(text, NO));
  }
  else {
    OrgGeogebraCommonKernelGeosGeoText_set_str_(self, [((NSString *) nil_chk(text)) replaceAll:@"\\\\\\\\n" withReplacement:@"\n"]);
  }
}
...
id<JavaUtilComparator> OrgGeogebraCommonKernelGeosGeoText_getComparator() {
  ...
  if (OrgGeogebraCommonKernelGeosGeoText_comparator_ == nil) {
    JreStrongAssignAndConsume(&OrgGeogebraCommonKernelGeosGeoText_comparator_, nil, new_OrgGeogebraCommonKernelGeosGeoText_$1_init());
  }
...
void OrgGeogebraCommonKernelGeosGeoText_updateTemplate(OrgGeogebraCommonKernelGeosGeoText *self) {
  ...
  if ([self useSignificantFigures] && self->printFigures_ > -1) {
    OrgGeogebraCommonKernelGeosGeoText_set_tpl_(self, OrgGeogebraCommonKernelStringTemplate_printFiguresWithOrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_withInt_withBoolean_(type, self->printFigures_, NO));
  }
  else if (!self->useSignificantFigures__ && self->printDecimals_ > -1) {
    OrgGeogebraCommonKernelGeosGeoText_set_tpl_(self, OrgGeogebraCommonKernelStringTemplate_printDecimalsWithOrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_withInt_withBoolean_(type, self->printDecimals_, NO));
  }
  else {
    OrgGeogebraCommonKernelGeosGeoText_set_tpl_(self, OrgGeogebraCommonKernelStringTemplate_getWithOrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_(type));
  }
}
