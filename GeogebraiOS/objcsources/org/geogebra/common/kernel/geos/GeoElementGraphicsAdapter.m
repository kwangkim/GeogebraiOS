...
- (void)setImageOnlyWithOrgGeogebraCommonAwtMyImage:(id<OrgGeogebraCommonAwtMyImage>)ba {
  OrgGeogebraCommonKernelGeosGeoElementGraphicsAdapter_set_image_(self, ba);
}

- (void)setImageFileNameOnlyWithNSString:(NSString *)fn {
  OrgGeogebraCommonKernelGeosGeoElementGraphicsAdapter_set_imageFileName_(self, fn);
}
...
- (void)setFillImageWithNSString:(NSString *)filename {
  ...
  OrgGeogebraCommonKernelGeosGeoElementGraphicsAdapter_set_image_(self, nil);
}
...
void OrgGeogebraCommonKernelGeosGeoElementGraphicsAdapter_init(OrgGeogebraCommonKernelGeosGeoElementGraphicsAdapter *self) {
  NSObject_init(self);
  OrgGeogebraCommonKernelGeosGeoElementGraphicsAdapter_set_imageFileName_(self, @"");
}
