...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/geos/GeoVector.java
//
...
- (OrgGeogebraCommonKernelGeosGeoElement *)copy__ {
  return [new_OrgGeogebraCommonKernelGeosGeoVector_initWithOrgGeogebraCommonKernelGeosGeoVector_(self) autorelease];
}
...
- (void)initStartPointWithOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)p
                                                            withInt:(jint)number {
  OrgGeogebraCommonKernelGeosGeoVector_set_startPoint_(self, p);
}
...
- (void)setStartPointWithOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)p {
  ...
  if (waitingForStartPoint_) {
    ...
    OrgGeogebraCommonKernelGeosGeoVector_set_waitingPointSet_(self, nil);
  }
}
...
- (OrgGeogebraCommonKernelGeosGeoVec2D *)getVector {
  OrgGeogebraCommonKernelGeosGeoVec2D *ret = [new_OrgGeogebraCommonKernelGeosGeoVec2D_initWithOrgGeogebraCommonKernelKernel_withDouble_withDouble_(kernel_, x_, y_) autorelease];
...
- (void)pointChangedWithOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)P {
  if (startPoint_ == nil && waitingForStartPoint_) {
    if (waitingPointSet_ == nil) OrgGeogebraCommonKernelGeosGeoVector_setAndConsume_waitingPointSet_(self, new_JavaUtilHashSet_init());
...
withOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  if (sb_ == nil) OrgGeogebraCommonKernelGeosGeoVector_setAndConsume_sb_(self, new_JavaLangStringBuilder_init());
...
- (void)addToSpreadsheetTraceListWithJavaUtilArrayList:(JavaUtilArrayList *)spreadsheetTraceList {
  OrgGeogebraCommonKernelGeosGeoNumeric *xx = [new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons_, [((OrgGeogebraCommonKernelGeosGeoVec2D *) nil_chk(OrgGeogebraCommonKernelGeosGeoVector_getInhomVec(self))) getX]) autorelease];
  [((JavaUtilArrayList *) nil_chk(spreadsheetTraceList)) addWithId:xx];
  OrgGeogebraCommonKernelGeosGeoNumeric *yy = [new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons_, [((OrgGeogebraCommonKernelGeosGeoVec2D *) nil_chk(OrgGeogebraCommonKernelGeosGeoVector_getInhomVec(self))) getY]) autorelease];
...
void OrgGeogebraCommonKernelGeosGeoVector_initWithOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonKernelGeosGeoVector *self, OrgGeogebraCommonKernelConstruction *c) {
  ...
  OrgGeogebraCommonKernelGeosGeoVector_setAndConsume_sbToString_GeoVector_(self, new_JavaLangStringBuilder_initWithInt_(50));
  OrgGeogebraCommonKernelGeosGeoVector_setAndConsume_sbBuildValueString_(self, new_JavaLangStringBuilder_initWithInt_(50));
...
void OrgGeogebraCommonKernelGeosGeoVector_initWithOrgGeogebraCommonKernelGeosGeoVector_(OrgGeogebraCommonKernelGeosGeoVector *self, OrgGeogebraCommonKernelGeosGeoVector *vector) {
  OrgGeogebraCommonKernelGeosGeoVector_initWithOrgGeogebraCommonKernelConstruction_(self, ((OrgGeogebraCommonKernelGeosGeoVector *) nil_chk(vector))->cons_);
...
OrgGeogebraCommonKernelGeosGeoVec2D *OrgGeogebraCommonKernelGeosGeoVector_getInhomVec(OrgGeogebraCommonKernelGeosGeoVector *self) {
  return [new_OrgGeogebraCommonKernelGeosGeoVec2D_initWithOrgGeogebraCommonKernelKernel_withDouble_withDouble_(self->kernel_, self->x_, self->y_) autorelease];
}
...
JavaLangStringBuilder *OrgGeogebraCommonKernelGeosGeoVector_buildValueStringWithOrgGeogebraCommonKernelStringTemplate_(OrgGeogebraCommonKernelGeosGeoVector *self, OrgGeogebraCommonKernelStringTemplate *tpl) {
  ...
  switch ([[((OrgGeogebraCommonKernelStringTemplate *) nil_chk(tpl)) getStringType] ordinal]) {
    ...
    [self->sbBuildValueString_ appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) formatWithDouble:[((OrgGeogebraCommonKernelGeosGeoVec2D *) nil_chk(OrgGeogebraCommonKernelGeosGeoVector_getInhomVec(self))) getX] withOrgGeogebraCommonKernelStringTemplate:tpl]];
    [self->sbBuildValueString_ appendWithChar:','];
    [self->sbBuildValueString_ appendWithNSString:[self->kernel_ formatWithDouble:[((OrgGeogebraCommonKernelGeosGeoVec2D *) nil_chk(OrgGeogebraCommonKernelGeosGeoVector_getInhomVec(self))) getY] withOrgGeogebraCommonKernelStringTemplate:tpl]];
  ...
  switch (self->toStringMode_) {
    case OrgGeogebraCommonKernelKernel_COORD_POLAR:
    [self->sbBuildValueString_ appendWithNSString:@"("];
    [self->sbBuildValueString_ appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) formatWithDouble:OrgGeogebraCommonUtilMyMath_lengthWithDouble_withDouble_(self->x_, self->y_) withOrgGeogebraCommonKernelStringTemplate:tpl]];
    [self->sbBuildValueString_ appendWithNSString:@"; "];
    [self->sbBuildValueString_ appendWithJavaLangCharSequence:[self->kernel_ formatAngleWithDouble:JavaLangMath_atan2WithDouble_withDouble_(self->y_, self->x_) withOrgGeogebraCommonKernelStringTemplate:tpl withBoolean:NO]];
    [self->sbBuildValueString_ appendWithNSString:@")"];
    break;
    case OrgGeogebraCommonKernelKernel_COORD_COMPLEX:
    [self->sbBuildValueString_ appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) formatWithDouble:self->x_ withOrgGeogebraCommonKernelStringTemplate:tpl]];
    [self->sbBuildValueString_ appendWithNSString:@" "];
    ...
    [self->sbBuildValueString_ appendWithNSString:OrgGeogebraCommonUtilUnicode_get_IMAGINARY_()];
    break;
    case OrgGeogebraCommonKernelKernel_COORD_CARTESIAN_3D:
    ...
    [self->sbBuildValueString_ appendWithNSString:[self->kernel_ formatWithDouble:self->y_ withOrgGeogebraCommonKernelStringTemplate:tpl]];
    [self->sbBuildValueString_ appendWithNSString:@")"];
    break;
  }
  return self->sbBuildValueString_;
...
void OrgGeogebraCommonKernelGeosGeoVector_initPathSegment(OrgGeogebraCommonKernelGeosGeoVector *self) {
  if (self->startPoint_ != nil && ![self->startPoint_ isGeoElement3D]) {
    OrgGeogebraCommonKernelGeosGeoVector_set_pathStartPoint_(self, (OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast(self->startPoint_, [OrgGeogebraCommonKernelGeosGeoPoint class]));
  }
  else {
    OrgGeogebraCommonKernelGeosGeoVector_setAndConsume_pathStartPoint_(self, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(self->cons_));
    [self->pathStartPoint_ setCoordsWithDouble:0 withDouble:0 withDouble:1];
  }
  OrgGeogebraCommonKernelGeosGeoVector_setAndConsume_pathEndPoint_(self, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(self->cons_));
  OrgGeogebraCommonKernelGeosGeoVector_setAndConsume_pathSegment_(self, new_OrgGeogebraCommonKernelGeosGeoSegment_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_(self->cons_, self->pathStartPoint_, self->pathEndPoint_));
}
...
void OrgGeogebraCommonKernelGeosGeoVector_buildLatexValueStringCoordCartesian3DWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelStringTemplate_withDouble_withDouble_withDouble_withJavaLangStringBuilder_withOrgGeogebraCommonKernelKernelNDGeoVectorND_withBoolean_(OrgGeogebraCommonKernelKernel *kernel, OrgGeogebraCommonKernelStringTemplate *tpl, jdouble x, jdouble y, jdouble z, JavaLangStringBuilder *sb, id<OrgGeogebraCommonKernelKernelNDGeoVectorND> vector, jboolean symbolic) {
  ...
  if (symbolic && [OrgGeogebraCommonKernelAlgosDependentAlgo_class_() isInstance:[((id<OrgGeogebraCommonKernelKernelNDGeoVectorND>) nil_chk(vector)) getParentAlgorithm]]) {
    ...
    IOSObjectArray_Set(inputs, 0, [((OrgGeogebraCommonKernelKernel *) nil_chk(kernel)) formatWithDouble:x withOrgGeogebraCommonKernelStringTemplate:tpl]);
    IOSObjectArray_Set(inputs, 1, [kernel formatWithDouble:y withOrgGeogebraCommonKernelStringTemplate:tpl]);
    IOSObjectArray_Set(inputs, 2, [kernel formatWithDouble:z withOrgGeogebraCommonKernelStringTemplate:tpl]);
  }
...
NSString *OrgGeogebraCommonKernelGeosGeoVector_buildLatexStringWithOrgGeogebraCommonKernelKernel_withJavaLangStringBuilder_withBoolean_withOrgGeogebraCommonKernelStringTemplate_withInt_withDouble_withDouble_withOrgGeogebraCommonKernelKernelNDGeoVectorND_(OrgGeogebraCommonKernelKernel *kernel, JavaLangStringBuilder *sb, jboolean symbolic, OrgGeogebraCommonKernelStringTemplate *tpl, jint toStringMode, jdouble x, jdouble y, id<OrgGeogebraCommonKernelKernelNDGeoVectorND> vector) {
  OrgGeogebraCommonKernelGeosGeoVector_initialize();
  {
    ...
    switch (toStringMode) {
      ...
      [sb appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(kernel)) formatWithDouble:OrgGeogebraCommonUtilMyMath_lengthWithDouble_withDouble_(x, y) withOrgGeogebraCommonKernelStringTemplate:tpl]];
      [sb appendWithNSString:@"; "];
      [sb appendWithJavaLangCharSequence:[kernel formatAngleWithDouble:JavaLangMath_atan2WithDouble_withDouble_(y, x) withOrgGeogebraCommonKernelStringTemplate:tpl withBoolean:NO]];
      [sb appendWithNSString:@")"];
      break;
      case OrgGeogebraCommonKernelKernel_COORD_COMPLEX:
      [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(kernel)) formatWithDouble:x withOrgGeogebraCommonKernelStringTemplate:tpl]];
      [sb appendWithNSString:@" "];
      [kernel formatSignedWithDouble:y withJavaLangStringBuilder:sb withOrgGeogebraCommonKernelStringTemplate:tpl];
      [sb appendWithNSString:OrgGeogebraCommonUtilUnicode_get_IMAGINARY_()];
      break;
      case OrgGeogebraCommonKernelKernel_COORD_CARTESIAN_3D:
      ...
      if (symbolic && [[((id<OrgGeogebraCommonKernelKernelNDGeoVectorND>) nil_chk(vector)) getParentAlgorithm] isKindOfClass:[OrgGeogebraCommonKernelAlgosAlgoDependentVector class]]) {
        ...
        if ([ev isKindOfClass:[OrgGeogebraCommonKernelArithmeticMyVecNode class]]) {
          ...
          IOSObjectArray_Set(inputs, 0, [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk([((OrgGeogebraCommonKernelArithmeticMyVecNode *) nil_chk(vn)) getX])) toStringWithOrgGeogebraCommonKernelStringTemplate:tpl]);
          IOSObjectArray_Set(inputs, 1, [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk([vn getY])) toStringWithOrgGeogebraCommonKernelStringTemplate:tpl]);
        }
        else {
