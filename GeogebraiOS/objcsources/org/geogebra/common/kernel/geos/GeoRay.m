...
- (IOSObjectArray *)createTransformedObjectWithOrgGeogebraCommonKernelTransform:(OrgGeogebraCommonKernelTransform *)t
  ...
  if ([parent isKindOfClass:[OrgGeogebraCommonKernelAlgosAlgoJoinPointsRay class]]) {
    ...
    IOSObjectArray *points = [IOSObjectArray arrayWithObjects:(id[]){ [algo getP], [algo getQ] } count:2 type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()];
    ...
    IOSObjectArray *geos = [IOSObjectArray arrayWithObjects:(id[]){ arc, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(IOSObjectArray_Get(points, 0), [OrgGeogebraCommonKernelGeosGeoElement class]), (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(IOSObjectArray_Get(points, 1), [OrgGeogebraCommonKernelGeosGeoElement class]) } count:3 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    return geos;
  }
  else if ([parent isKindOfClass:[OrgGeogebraCommonKernelAlgosAlgoRayPointVector class]]) {
    IOSObjectArray *points = [IOSObjectArray arrayWithObjects:(id[]){ [self getStartPoint] } count:1 type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()];
    points = [((OrgGeogebraCommonKernelTransform *) nil_chk(t)) transformPointsWithOrgGeogebraCommonKernelKernelNDGeoPointNDArray:points];
    ...
    OrgGeogebraCommonKernelAlgosAlgoDirection *ad = [new_OrgGeogebraCommonKernelAlgosAlgoDirection_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoLine_(cons_, self) autorelease];
    ...
    if ([t isAffine]) {
      ...
      [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(ray)) setVisualStyleForTransformationsWithOrgGeogebraCommonKernelGeosGeoElement:self];
      IOSObjectArray *geos = [IOSObjectArray arrayWithObjects:(id[]){ ray, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(IOSObjectArray_Get(points, 0), [OrgGeogebraCommonKernelGeosGeoElement class]) } count:2 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
      return geos;
    }
    OrgGeogebraCommonKernelAlgosAlgoTranslate *at = [new_OrgGeogebraCommonKernelAlgosAlgoTranslate_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoElement_(cons_, [self getStartPoint], direction) autorelease];
    ...
    OrgGeogebraCommonKernelGeosGeoPoint *inf = [new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
    [inf setCoordsWithDouble:JavaLangDouble_POSITIVE_INFINITY withDouble:JavaLangDouble_POSITIVE_INFINITY withDouble:1];
    IOSObjectArray *points2 = [IOSObjectArray arrayWithObjects:(id[]){ thirdPoint, inf } count:2 type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()];
    points2 = [t transformPointsWithOrgGeogebraCommonKernelKernelNDGeoPointNDArray:points2];
    [cons_ setSuppressLabelCreationWithBoolean:oldSuppressLabelCreation];
    OrgGeogebraCommonKernelAlgosAlgoConicPartCircumcircle *ae = [new_OrgGeogebraCommonKernelAlgosAlgoConicPartCircumcircle_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_withInt_(cons_, OrgGeogebraCommonKernelTransform_transformedGeoLabelWithOrgGeogebraCommonKernelGeosGeoElement_(self), (OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast(IOSObjectArray_Get(nil_chk(points), 0), [OrgGeogebraCommonKernelGeosGeoPoint class]), (OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast(IOSObjectArray_Get(nil_chk(points2), 0), [OrgGeogebraCommonKernelGeosGeoPoint class]), (OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast(IOSObjectArray_Get(points2, 1), [OrgGeogebraCommonKernelGeosGeoPoint class]), OrgGeogebraCommonKernelKernelNDGeoConicNDConstants_CONIC_PART_ARC) autorelease];
    OrgGeogebraCommonKernelGeosGeoElement *arc = [ae getConicPart];
    [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(arc)) setVisualStyleForTransformationsWithOrgGeogebraCommonKernelGeosGeoElement:self];
    IOSObjectArray *geos = [IOSObjectArray arrayWithObjects:(id[]){ arc, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(IOSObjectArray_Get(points, 0), [OrgGeogebraCommonKernelGeosGeoElement class]) } count:2 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    return geos;
  }
  else {
    ...
    IOSObjectArray *ret = [IOSObjectArray arrayWithObjects:(id[]){ transformedLine } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    return ret;
  }
}
...
- (OrgGeogebraCommonKernelGeosGeoElement *)copyFreeRay {
  ...
  OrgGeogebraCommonKernelGeosGeoVector *directionVec = [new_OrgGeogebraCommonKernelGeosGeoVector_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
  [directionVec setCoordsWithDoubleArray:direction];
  OrgGeogebraCommonKernelAlgosAlgoRayPointVector *algo = [new_OrgGeogebraCommonKernelAlgosAlgoRayPointVector_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoVector_(cons_, nil, startPoint1, directionVec) autorelease];
  return [algo getRay];
}
