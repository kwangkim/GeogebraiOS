...
- (void)setSpreadsheetCellWithOrgGeogebraCommonMainApp:(OrgGeogebraCommonMainApp *)app
  ...
  if (OrgGeogebraCommonKernelGeosGeoElementSpreadsheet_sb_ == nil) JreStrongAssignAndConsume(&OrgGeogebraCommonKernelGeosGeoElementSpreadsheet_sb_, nil, new_JavaLangStringBuilder_init());
  else [OrgGeogebraCommonKernelGeosGeoElementSpreadsheet_sb_ setLengthWithInt:0];
  [((JavaLangStringBuilder *) nil_chk(OrgGeogebraCommonKernelGeosGeoElementSpreadsheet_sb_)) appendWithNSString:cellName];
  if ([OrgGeogebraCommonKernelArithmeticFunctionalNVar_class_() isInstance:cellGeo]) {
    [OrgGeogebraCommonKernelGeosGeoElementSpreadsheet_sb_ appendWithNSString:@"("];
    [OrgGeogebraCommonKernelGeosGeoElementSpreadsheet_sb_ appendWithNSString:[((id<OrgGeogebraCommonKernelArithmeticFunctionalNVar>) nil_chk(((id<OrgGeogebraCommonKernelArithmeticFunctionalNVar>) check_protocol_cast(cellGeo, @protocol(OrgGeogebraCommonKernelArithmeticFunctionalNVar))))) getVarStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]];
    [OrgGeogebraCommonKernelGeosGeoElementSpreadsheet_sb_ appendWithNSString:@")"];
  }
  ...
  if ([((NSString *) nil_chk(label)) indexOf:'='] == -1) [OrgGeogebraCommonKernelGeosGeoElementSpreadsheet_sb_ appendWithChar:'='];
  else [OrgGeogebraCommonKernelGeosGeoElementSpreadsheet_sb_ appendWithChar:':'];
  [OrgGeogebraCommonKernelGeosGeoElementSpreadsheet_sb_ appendWithNSString:label];
  if ([OrgGeogebraCommonKernelArithmeticFunctionalNVar_class_() isInstance:cellGeo] && [cellGeo isLabelSet]) {
    [OrgGeogebraCommonKernelGeosGeoElementSpreadsheet_sb_ appendWithNSString:@"("];
    [OrgGeogebraCommonKernelGeosGeoElementSpreadsheet_sb_ appendWithNSString:[((id<OrgGeogebraCommonKernelArithmeticFunctionalNVar>) check_protocol_cast(cellGeo, @protocol(OrgGeogebraCommonKernelArithmeticFunctionalNVar))) getVarStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]];
    [OrgGeogebraCommonKernelGeosGeoElementSpreadsheet_sb_ appendWithNSString:@")"];
  }
  [((OrgGeogebraCommonKernelCommandsAlgebraProcessor *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk([((OrgGeogebraCommonMainApp *) nil_chk(app)) getKernel])) getAlgebraProcessor])) processAlgebraCommandWithNSString:[OrgGeogebraCommonKernelGeosGeoElementSpreadsheet_sb_ description] withBoolean:NO];
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonKernelGeosGeoElementSpreadsheet class]) {
    JreStrongAssign(&OrgGeogebraCommonKernelGeosGeoElementSpreadsheet_spreadsheetPattern_, nil, ComGoogleGwtRegexpSharedRegExp_compileWithNSString_(@"^(\\$?)([A-Z]+)(\\$?)([1-9][0-9]*)$"));
...
OrgGeogebraCommonAwtGPoint *OrgGeogebraCommonKernelGeosGeoElementSpreadsheet_spreadsheetIndicesWithNSString_(NSString *cellName) {
  ...
  return [new_OrgGeogebraCommonAwtGPoint_initWithInt_withInt_(OrgGeogebraCommonKernelGeosGeoElementSpreadsheet_getSpreadsheetColumnWithComGoogleGwtRegexpSharedMatchResult_(matcher), OrgGeogebraCommonKernelGeosGeoElementSpreadsheet_getSpreadsheetRowWithComGoogleGwtRegexpSharedMatchResult_(matcher)) autorelease];
}
