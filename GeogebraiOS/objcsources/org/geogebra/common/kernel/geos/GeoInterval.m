...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/kernel/geos/GeoInterval.java
//
...
- (OrgGeogebraCommonKernelGeosGeoElement *)copy__ {
  return [new_OrgGeogebraCommonKernelGeosGeoInterval_initWithOrgGeogebraCommonKernelGeosGeoInterval_(self) autorelease];
}
...
- (void)setWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  ...
  OrgGeogebraCommonKernelGeosGeoFunction_setAndConsume_fun_(self, new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticFunction_withOrgGeogebraCommonKernelKernel_(geoFun->fun_, kernel_));
...
- (NSString *)toStringWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  if (sbToString2_ == nil) OrgGeogebraCommonKernelGeosGeoInterval_setAndConsume_sbToString2_(self, new_JavaLangStringBuilder_init());
  ...
  [((JavaLangStringBuilder *) nil_chk(sbToString2_)) appendWithNSString:[self toSymbolicStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
  ...
  if ([((OrgGeogebraCommonPluginOperationEnum *) nil_chk([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(en)) getOperation])) isEqual:OrgGeogebraCommonPluginOperationEnum_get_AND()] || [((OrgGeogebraCommonPluginOperationEnum *) nil_chk([en getOperation])) isEqual:OrgGeogebraCommonPluginOperationEnum_get_AND_INTERVAL()]) {
    ...
    if ([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(left)) isExpressionNode] && [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(right)) isExpressionNode]) {
      ...
      if (!JavaLangDouble_isNaNWithDouble_(IOSDoubleArray_Get(nil_chk(leftRightBoundsField_), 1)) && !JavaLangDouble_isNaNWithDouble_(IOSDoubleArray_Get(leftRightBoundsField_, 0)) && IOSDoubleArray_Get(leftRightBoundsField_, 0) <= IOSDoubleArray_Get(leftRightBoundsField_, 1)) {
        ...
        [sbToString_ appendWithNSString:symbolic ? IOSObjectArray_Get(nil_chk(leftRightStrField_), 0) : [((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) formatWithDouble:IOSDoubleArray_Get(leftRightBoundsField_, 0) withOrgGeogebraCommonKernelStringTemplate:tpl]];
        ...
        [sbToString_ appendWithChar:' '];
        [sbToString_ appendWithNSString:symbolic ? IOSObjectArray_Get(nil_chk(leftRightStrField_), 1) : [((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) formatWithDouble:IOSDoubleArray_Get(leftRightBoundsField_, 1) withOrgGeogebraCommonKernelStringTemplate:tpl]];
...
void OrgGeogebraCommonKernelGeosGeoInterval_initWithOrgGeogebraCommonKernelGeosGeoInterval_(OrgGeogebraCommonKernelGeosGeoInterval *self, OrgGeogebraCommonKernelGeosGeoInterval *geoInterval) {
  OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_(self, ((OrgGeogebraCommonKernelGeosGeoInterval *) nil_chk(geoInterval))->cons_);
...
void OrgGeogebraCommonKernelGeosGeoInterval_initWithOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonKernelGeosGeoInterval *self, OrgGeogebraCommonKernelConstruction *cons) {
  OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_(self, cons);
}
...
void OrgGeogebraCommonKernelGeosGeoInterval_updateBoundaries(OrgGeogebraCommonKernelGeosGeoInterval *self) {
  if (self->leftRightBoundsField_ == nil) {
    OrgGeogebraCommonKernelGeosGeoInterval_setAndConsume_leftRightBoundsField_(self, [IOSDoubleArray newArrayWithLength:2]);
  ...
  if (self->leftRightStrField_ == nil) {
    OrgGeogebraCommonKernelGeosGeoInterval_setAndConsume_leftRightStrField_(self, [IOSObjectArray newArrayWithLength:2 type:NSString_class_()]);
  }
  if (self->leftRightInequalityField_ == nil) {
    OrgGeogebraCommonKernelGeosGeoInterval_setAndConsume_leftRightInequalityField_(self, [IOSCharArray newArrayWithLength:2]);
  }
...
jdouble OrgGeogebraCommonKernelGeosGeoInterval_setLeftBoundWithOrgGeogebraCommonKernelArithmeticExpressionValue_withNSStringArray_(id<OrgGeogebraCommonKernelArithmeticExpressionValue> nv, IOSObjectArray *leftRightStr) {
  ...
  if ([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(nv)) isGeoElement]) {
    IOSObjectArray_Set(nil_chk(leftRightStr), 0, [((OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(nv, [OrgGeogebraCommonKernelGeosGeoElement class])) getLabelWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]);
  }
  else {
    IOSObjectArray_Set(nil_chk(leftRightStr), 0, [nv toStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]);
  }
...
jdouble OrgGeogebraCommonKernelGeosGeoInterval_setRightBoundWithOrgGeogebraCommonKernelArithmeticExpressionValue_withNSStringArray_(id<OrgGeogebraCommonKernelArithmeticExpressionValue> nv, IOSObjectArray *leftRightStr) {
  OrgGeogebraCommonKernelGeosGeoInterval_initialize();
  if ([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(nv)) isGeoElement]) {
    IOSObjectArray_Set(nil_chk(leftRightStr), 1, [((OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(nv, [OrgGeogebraCommonKernelGeosGeoElement class])) getLabelWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]);
  }
  else {
    IOSObjectArray_Set(nil_chk(leftRightStr), 1, [nv toStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]);
  }
  return [nv evaluateDouble];
}
