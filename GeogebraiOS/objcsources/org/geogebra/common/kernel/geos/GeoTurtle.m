...
- (OrgGeogebraCommonKernelGeosGeoPoint *)copy__ {
  return new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons_);
}
...
- (OrgGeogebraCommonKernelGeosGeoElement *)copyInternalWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)cons1 {
  OrgGeogebraCommonKernelGeosGeoTurtle *ret = new_OrgGeogebraCommonKernelGeosGeoTurtle_initWithOrgGeogebraCommonKernelConstruction_withNSString_(cons1, nil);
...
- (IOSDoubleArray *)getAngleRotators {
  IOSDoubleArray *ar = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ self->cosAngle_, self->sinAngle_ } count:2];
  return ar;
}
...
- (void)forwardWithDouble:(jdouble)distance {
  [self addCommandWithOrgGeogebraCommonKernelGeosGeoTurtle_Command:new_OrgGeogebraCommonKernelGeosGeoTurtle_CmdForward_initWithOrgGeogebraCommonKernelGeosGeoTurtle_withDouble_(self, distance)];
}

- (void)setPositionWithDouble:(jdouble)x
                   withDouble:(jdouble)y {
  [self addCommandWithOrgGeogebraCommonKernelGeosGeoTurtle_Command:new_OrgGeogebraCommonKernelGeosGeoTurtle_CmdSetPosition_initWithOrgGeogebraCommonKernelGeosGeoTurtle_withDouble_withDouble_(self, x, y)];
}
...
- (void)setCoordsWithDouble:(jdouble)x
  ...
  [self addCommandWithOrgGeogebraCommonKernelGeosGeoTurtle_Command:new_OrgGeogebraCommonKernelGeosGeoTurtle_CmdSetCoords_initWithOrgGeogebraCommonKernelGeosGeoTurtle_withDouble_withDouble_(self, x, y)];
  [self setPenDownWithBoolean:currPenDown];
}

- (void)turnWithDouble:(jdouble)turnAngleChange {
  [self addCommandWithOrgGeogebraCommonKernelGeosGeoTurtle_Command:new_OrgGeogebraCommonKernelGeosGeoTurtle_CmdTurn_initWithOrgGeogebraCommonKernelGeosGeoTurtle_withDouble_(self, turnAngleChange)];
}

- (void)setPenDownWithBoolean:(jboolean)penDown {
  [self addCommandWithOrgGeogebraCommonKernelGeosGeoTurtle_Command:new_OrgGeogebraCommonKernelGeosGeoTurtle_CmdSetPen_initWithOrgGeogebraCommonKernelGeosGeoTurtle_withBoolean_(self, penDown)];
}
...
- (void)setPenColorWithOrgGeogebraCommonAwtGColor:(OrgGeogebraCommonAwtGColor *)penColor {
  [self addCommandWithOrgGeogebraCommonKernelGeosGeoTurtle_Command:new_OrgGeogebraCommonKernelGeosGeoTurtle_CmdSetColor_initWithOrgGeogebraCommonKernelGeosGeoTurtle_withOrgGeogebraCommonAwtGColor_(self, penColor)];
}

- (void)setPenThicknessWithInt:(jint)thickness {
  [self addCommandWithOrgGeogebraCommonKernelGeosGeoTurtle_Command:new_OrgGeogebraCommonKernelGeosGeoTurtle_CmdSetThickness_initWithOrgGeogebraCommonKernelGeosGeoTurtle_withInt_(self, thickness)];
}
...
- (void)getXMLtagsWithJavaLangStringBuilder:(JavaLangStringBuilder *)sb {
  ...
  if ([self getFillImage] != nil) {
    (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"\t<file name=\""];
    (void) [sb appendWithNSString:OrgGeogebraCommonUtilStringUtil_encodeXMLWithNSString_([((OrgGeogebraCommonKernelGeosGeoElementGraphicsAdapter *) nil_chk([self getGraphicsAdapter])) getImageFileName])];
...
void OrgGeogebraCommonKernelGeosGeoTurtle_initWithOrgGeogebraCommonKernelConstruction_withNSString_(OrgGeogebraCommonKernelGeosGeoTurtle *self, OrgGeogebraCommonKernelConstruction *c, NSString *label) {
  (void) OrgGeogebraCommonKernelGeosGeoTurtle_initWithOrgGeogebraCommonKernelConstruction_(self, c);
...
void OrgGeogebraCommonKernelGeosGeoTurtle_initWithOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonKernelGeosGeoTurtle *self, OrgGeogebraCommonKernelConstruction *c) {
  (void) OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(self, c);
  self->defined_ = YES;
  self->startPoint_ = new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withDouble_withDouble_withDouble_(self->cons_, 0.0, 0.0, 1.0);
  self->position_ = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 0.0, 0.0, 1.0 } count:3];
  self->penColor_ = OrgGeogebraCommonAwtGColor_get_BLACK_();
  ...
  self->cmdList_ = new_JavaUtilArrayList_init();
  [self setObjColorWithOrgGeogebraCommonAwtGColor:OrgGeogebraCommonAwtGColor_get_GRAY_()];
  self->turtleImageList_ = new_JavaUtilArrayList_init();
...
- (void)perform {
  ...
  *IOSDoubleArray_GetRef(this$0_->position_, 1) += length_ * this$0_->sinAngle_;
  destination_ = new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withDouble_withDouble_withDouble_(this$0_->cons_, IOSDoubleArray_Get(this$0_->position_, 0), IOSDoubleArray_Get(this$0_->position_, 1), 1.0);
...
void OrgGeogebraCommonKernelGeosGeoTurtle_CmdSetPosition_initWithOrgGeogebraCommonKernelGeosGeoTurtle_withDouble_withDouble_(OrgGeogebraCommonKernelGeosGeoTurtle_CmdSetPosition *self, OrgGeogebraCommonKernelGeosGeoTurtle *outer$, jdouble x, jdouble y) {
  (void) OrgGeogebraCommonKernelGeosGeoTurtle_CmdSetCoords_initWithOrgGeogebraCommonKernelGeosGeoTurtle_withDouble_withDouble_(self, outer$, x, y);
