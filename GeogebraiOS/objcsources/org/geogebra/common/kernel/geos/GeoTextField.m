...
- (void)setLinkedGeoWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  OrgGeogebraCommonKernelGeosGeoTextField_set_linkedGeo_(self, geo);
  OrgGeogebraCommonKernelGeosGeoTextField_set_text_(self, [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(geo)) getValueForInputBar]);
  if (((jint) [((NSString *) nil_chk(text_)) length]) > 0 && [text_ charAtWithInt:0] == '"') {
    OrgGeogebraCommonKernelGeosGeoTextField_set_text_(self, [text_ substring:1]);
  }
  if (((jint) [((NSString *) nil_chk(text_)) length]) > 0 && [text_ charAtWithInt:((jint) [text_ length]) - 1] == '"') {
    OrgGeogebraCommonKernelGeosGeoTextField_set_text_(self, [text_ substring:0 endIndex:((jint) [text_ length]) - 1]);
  }
}
...
- (void)setTextWithNSString:(NSString *)newText {
  OrgGeogebraCommonKernelGeosGeoTextField_set_text_(self, newText);
}
...
- (OrgGeogebraCommonKernelGeosGeoElement *)copy__ {
  return [new_OrgGeogebraCommonKernelGeosGeoTextField_initWithOrgGeogebraCommonKernelConstruction_withInt_withInt_(cons_, labelOffsetX_, labelOffsetY_) autorelease];
}
...
- (void)updateLinkedGeoWithNSString:(NSString *)inputText {
  ...
  @try {
    OrgGeogebraCommonKernelGeosGeoTextField_set_linkedGeo_(self, [((OrgGeogebraCommonKernelCommandsAlgebraProcessor *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) getAlgebraProcessor])) changeGeoElementNoExceptionHandlingWithOrgGeogebraCommonKernelGeosGeoElement:linkedGeo_ withNSString:defineText withBoolean:[linkedGeo_ isIndependent] withBoolean:YES]);
  }
...
- (id<OrgGeogebraCommonGuiInputfieldAutoCompleteTextField>)getTextFieldWithInt:(jint)viewID
  ...
  if (textField_ == nil) {
    OrgGeogebraCommonKernelGeosGeoTextField_set_textField_(self, [((OrgGeogebraCommonFactoriesSwingFactory *) nil_chk([((OrgGeogebraCommonMainApp *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) getApplication])) getSwingFactory])) newAutoCompleteTextFieldWithInt:[self getLength] withOrgGeogebraCommonMainApp:[kernel_ getApplication] withOrgGeogebraCommonEuclidianDrawable:drawTextField]);
  ...
  if (textField2_ == nil) {
    OrgGeogebraCommonKernelGeosGeoTextField_set_textField2_(self, [((OrgGeogebraCommonFactoriesSwingFactory *) nil_chk([((OrgGeogebraCommonMainApp *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) getApplication])) getSwingFactory])) newAutoCompleteTextFieldWithInt:[self getLength] withOrgGeogebraCommonMainApp:[kernel_ getApplication] withOrgGeogebraCommonEuclidianDrawable:drawTextField]);
    if ([linkedGeo_ isKindOfClass:[OrgGeogebraCommonKernelGeosGeoText class]]) {
...
- (void)setBackgroundColorWithOrgGeogebraCommonAwtGColor:(OrgGeogebraCommonAwtGColor *)bgCol {
  ...
  OrgGeogebraCommonKernelGeosGeoElement_set_bgColor_(self, [((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newColorWithInt:red withInt:green withInt:blue]);
}
...
void OrgGeogebraCommonKernelGeosGeoTextField_initWithOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonKernelGeosGeoTextField *self, OrgGeogebraCommonKernelConstruction *c) {
  ...
  OrgGeogebraCommonKernelGeosGeoTextField_set_linkedGeo_(self, nil);
  OrgGeogebraCommonKernelGeosGeoTextField_set_text_(self, nil);
  self->printDecimals_ = -1;
  self->printFigures_ = -1;
  self->useSignificantFigures__ = NO;
  OrgGeogebraCommonKernelGeosGeoTextField_set_tpl_(self, OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_());
...
void OrgGeogebraCommonKernelGeosGeoTextField_initWithOrgGeogebraCommonKernelConstruction_withInt_withInt_(OrgGeogebraCommonKernelGeosGeoTextField *self, OrgGeogebraCommonKernelConstruction *cons, jint labelOffsetX, jint labelOffsetY) {
  OrgGeogebraCommonKernelGeosGeoTextField_initWithOrgGeogebraCommonKernelConstruction_(self, cons);
...
void OrgGeogebraCommonKernelGeosGeoTextField_updateTemplate(OrgGeogebraCommonKernelGeosGeoTextField *self) {
  if ([self useSignificantFigures] && self->printFigures_ > -1) {
    OrgGeogebraCommonKernelGeosGeoTextField_set_tpl_(self, OrgGeogebraCommonKernelStringTemplate_printFiguresWithOrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_withInt_withBoolean_(OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_GEOGEBRA(), self->printFigures_, NO));
  }
  else if (!self->useSignificantFigures__ && self->printDecimals_ > -1) {
    OrgGeogebraCommonKernelGeosGeoTextField_set_tpl_(self, OrgGeogebraCommonKernelStringTemplate_printDecimalsWithOrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_withInt_withBoolean_(OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_GEOGEBRA(), self->printDecimals_, NO));
  }
  else {
    OrgGeogebraCommonKernelGeosGeoTextField_set_tpl_(self, OrgGeogebraCommonKernelStringTemplate_getWithOrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_(OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_GEOGEBRA()));
  }
}
