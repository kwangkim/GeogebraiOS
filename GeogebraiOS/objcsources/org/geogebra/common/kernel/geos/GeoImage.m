...
- (OrgGeogebraCommonKernelGeosGeoElement *)copy__ {
  return new_OrgGeogebraCommonKernelGeosGeoImage_initWithOrgGeogebraCommonKernelGeosGeoImage_(self);
}
  ...
  if (hasAbsoluteScreenLocation_) {
    ...
    for (jint i = 0; i < ((IOSObjectArray *) nil_chk(corners_))->size_; i++) {
      if (IOSObjectArray_Get(img->corners_, i) == nil) {
        (void) IOSObjectArray_Set(corners_, i, nil);
      }
      else {
        OrgGeogebraCommonKernelGeosGeoImage_initTempPoints(self);
        ...
        (void) IOSObjectArray_Set(corners_, i, IOSObjectArray_Get(tempPoints_, i));
      }
    }
  }
...
- (void)initStartPointWithOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)p
                                                            withInt:(jint)number {
  (void) IOSObjectArray_Set(nil_chk(corners_), number, (OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast(p, [OrgGeogebraCommonKernelGeosGeoPoint class]));
}
...
- (void)setCornerWithOrgGeogebraCommonKernelGeosGeoPoint:(OrgGeogebraCommonKernelGeosGeoPoint *)p
  ...
  if (p == nil) {
    ...
    if (number == 0 && IOSObjectArray_Get(corners_, 0) != nil) {
      OrgGeogebraCommonKernelGeosGeoPoint *temp = new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons_);
      [temp setCoordsWithOrgGeogebraCommonKernelGeosGeoVec3D:IOSObjectArray_Get(corners_, 0)];
      (void) IOSObjectArray_Set(corners_, 0, temp);
    }
    else (void) IOSObjectArray_Set(corners_, number, nil);
  }
  else {
    ...
    if (IOSObjectArray_Get(corners_, number) != nil) [((OrgGeogebraCommonKernelLocateableList *) nil_chk([((OrgGeogebraCommonKernelGeosGeoPoint *) nil_chk(IOSObjectArray_Get(corners_, number))) getLocateableList])) unregisterLocateableWithOrgGeogebraCommonKernelLocateable:self];
    (void) IOSObjectArray_Set(corners_, number, p);
...
- (void)getXMLtagsWithJavaLangStringBuilder:(JavaLangStringBuilder *)sb {
  ...
  (void) [sb appendWithNSString:@"\t<inBackground val=\""];
  (void) [sb appendWithBoolean:inBackground_];
  (void) [sb appendWithNSString:@"\"/>\n"];
  if (!OrgGeogebraCommonKernelGeosGeoImage_isInterpolate(self)) (void) [sb appendWithNSString:@"\t<interpolate val=\"false\"/>\n"];
  if (hasAbsoluteScreenLocation_) {
    (void) [sb appendWithNSString:OrgGeogebraCommonKernelGeosGeoImage_getXMLabsScreenLoc(self)];
  }
  else {
    for (jint i = 0; i < ((IOSObjectArray *) nil_chk(corners_))->size_; i++) {
      if (IOSObjectArray_Get(corners_, i) != nil) {
        (void) [sb appendWithNSString:OrgGeogebraCommonKernelGeosGeoImage_getCornerPointXMLWithInt_(self, i)];
      }
    }
  }
...
- (void)setAbsoluteScreenLocActiveWithBoolean:(jboolean)flag {
  ...
  if (flag) {
    ...
    (void) IOSObjectArray_Set(nil_chk(corners_), 1, nil);
    (void) IOSObjectArray_Set(corners_, 2, nil);
  }
}
...
- (void)calculateCornerPointWithOrgGeogebraCommonKernelGeosGeoPoint:(OrgGeogebraCommonKernelGeosGeoPoint *)result
  ...
  if (IOSObjectArray_Get(nil_chk(corners_), 0) == nil) OrgGeogebraCommonKernelGeosGeoImage_initTempPoints(self);
  {
    ...
    switch (n) {
      ...
      break;
      case 3:
      b = [IOSDoubleArray newArrayWithLength:2];
      d = [IOSDoubleArray newArrayWithLength:2];
...
- (void)matrixTransformWithDouble:(jdouble)a
  ...
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(corners_))->size_; i++) {
    ...
    if (IOSObjectArray_Get(corners_, i) == nil) (void) IOSObjectArray_Set(corners_, i, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons_));
...
void OrgGeogebraCommonKernelGeosGeoImage_initWithOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonKernelGeosGeoImage *self, OrgGeogebraCommonKernelConstruction *c) {
  ...
  self->tempCoords_ = [IOSDoubleArray newArrayWithLength:2];
  self->al_ = nil;
  [self setConstructionDefaults];
  [self setAlphaValueWithFloat:1.0f];
  [self setAuxiliaryObjectWithBoolean:YES];
  self->corners_ = [IOSObjectArray newArrayWithLength:3 type:OrgGeogebraCommonKernelGeosGeoPoint_class_()];
...
void OrgGeogebraCommonKernelGeosGeoImage_initWithOrgGeogebraCommonKernelGeosGeoImage_(OrgGeogebraCommonKernelGeosGeoImage *self, OrgGeogebraCommonKernelGeosGeoImage *img) {
  (void) OrgGeogebraCommonKernelGeosGeoImage_initWithOrgGeogebraCommonKernelConstruction_(self, ((OrgGeogebraCommonKernelGeosGeoImage *) nil_chk(img))->cons_);
...
void OrgGeogebraCommonKernelGeosGeoImage_initTempPoints(OrgGeogebraCommonKernelGeosGeoImage *self) {
  if (self->tempPoints_ == nil) {
    self->tempPoints_ = [IOSObjectArray newArrayWithLength:3 type:OrgGeogebraCommonKernelGeosGeoPoint_class_()];
    for (jint i = 0; i < self->tempPoints_->size_; i++) {
      (void) IOSObjectArray_Set(self->tempPoints_, i, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(self->cons_));
    }
  }
  if (IOSObjectArray_Get(nil_chk(self->corners_), 0) == nil) (void) IOSObjectArray_Set(self->corners_, 0, IOSObjectArray_Get(nil_chk(self->tempPoints_), 0));
}
...
NSString *OrgGeogebraCommonKernelGeosGeoImage_getXMLabsScreenLoc(OrgGeogebraCommonKernelGeosGeoImage *self) {
  ...
  (void) [sb appendWithNSString:@"\t<absoluteScreenLocation x=\""];
  (void) [sb appendWithInt:self->screenX_];
  (void) [sb appendWithNSString:@"\" y=\""];
  (void) [sb appendWithInt:self->screenY_];
  (void) [sb appendWithNSString:@"\"/>"];
...
NSString *OrgGeogebraCommonKernelGeosGeoImage_getCornerPointXMLWithInt_(OrgGeogebraCommonKernelGeosGeoImage *self, jint number) {
  JavaLangStringBuilder *sb = new_JavaLangStringBuilder_init();
  (void) [sb appendWithNSString:@"\t<startPoint number=\""];
  (void) [sb appendWithInt:number];
  (void) [sb appendWithNSString:@"\""];
  if ([((OrgGeogebraCommonKernelGeosGeoPoint *) nil_chk(IOSObjectArray_Get(nil_chk(self->corners_), number))) isAbsoluteStartPoint]) {
    (void) [sb appendWithNSString:JreStrcat("$DC", @" x=\"", ((OrgGeogebraCommonKernelGeosGeoPoint *) nil_chk(IOSObjectArray_Get(self->corners_, number)))->x_, '"')];
    (void) [sb appendWithNSString:JreStrcat("$DC", @" y=\"", ((OrgGeogebraCommonKernelGeosGeoPoint *) nil_chk(IOSObjectArray_Get(self->corners_, number)))->y_, '"')];
    (void) [sb appendWithNSString:JreStrcat("$DC", @" z=\"", ((OrgGeogebraCommonKernelGeosGeoPoint *) nil_chk(IOSObjectArray_Get(self->corners_, number)))->z_, '"')];
  }
  else {
