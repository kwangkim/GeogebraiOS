...
- (void)setWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  ...
  userInput_ = ((OrgGeogebraCommonKernelGeosGeoUserInputElement *) nil_chk(((OrgGeogebraCommonKernelGeosGeoUserInputElement *) check_class_cast(geo, [OrgGeogebraCommonKernelGeosGeoUserInputElement class]))))->userInput_;
}

- (void)getXMLtagsWithJavaLangStringBuilder:(JavaLangStringBuilder *)sb {
  [super getXMLtagsWithJavaLangStringBuilder:sb];
  (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"\t<userinput show=\""];
  (void) [sb appendWithBoolean:inputForm_];
  if ([self isIndependent]) {
    (void) [sb appendWithNSString:@"\" value=\""];
    (void) [sb appendWithId:userInput_];
  }
  (void) [sb appendWithNSString:@"\" valid=\""];
  (void) [sb appendWithBoolean:validInputForm_];
