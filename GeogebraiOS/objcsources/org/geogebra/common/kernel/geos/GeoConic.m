...
- (OrgGeogebraCommonKernelGeosGeoElement *)copy__ {
  return [new_OrgGeogebraCommonKernelGeosGeoConic_initWithOrgGeogebraCommonKernelGeosGeoConic_(self) autorelease];
}
...
- (JavaUtilArrayList *)getPointsOnConicWithInt:(jint)n {
  OrgGeogebraCommonKernelGeosGeoCurveCartesian *curve = [new_OrgGeogebraCommonKernelGeosGeoCurveCartesian_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
...
- (void)mirrorWithOrgGeogebraCommonKernelGeosGeoConic:(OrgGeogebraCommonKernelGeosGeoConic *)mirror {
  ...
  if ([mirror isCircle] && (type_ == OrgGeogebraCommonKernelKernelNDGeoConicNDConstants_CONIC_SINGLE_POINT || type_ == OrgGeogebraCommonKernelKernelNDGeoConicNDConstants_CONIC_CIRCLE)) {
    ...
    OrgGeogebraCommonKernelGeosGeoPoint *tmp = [new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withNSString_withDouble_withDouble_withDouble_(cons_, nil, centerX, centerY, 1.0) autorelease];
    ...
    if ([mirror getType] == OrgGeogebraCommonKernelKernelNDGeoConicNDConstants_CONIC_CIRCLE) {
      ...
      if (!OrgGeogebraCommonKernelKernel_isZeroWithDouble_(dist2)) {
        ...
        OrgGeogebraCommonKernelGeosGeoPoint *m = [new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
...
- (OrgGeogebraCommonKernelMatrixCoords *)getDirection3DWithInt:(jint)i {
  return [new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_(((OrgGeogebraCommonKernelGeosGeoLine *) nil_chk(IOSObjectArray_Get(nil_chk(lines_), i)))->y_, -((OrgGeogebraCommonKernelGeosGeoLine *) nil_chk(IOSObjectArray_Get(lines_, i)))->x_, 0, 0) autorelease];
}

- (OrgGeogebraCommonKernelMatrixCoords *)getOrigin3DWithInt:(jint)i {
  return [new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_(((OrgGeogebraCommonKernelGeosGeoPoint *) nil_chk(IOSObjectArray_Get(nil_chk(startPoints_), i)))->x_, ((OrgGeogebraCommonKernelGeosGeoPoint *) nil_chk(IOSObjectArray_Get(startPoints_, i)))->y_, 0, 1) autorelease];
}
...
- (OrgGeogebraCommonKernelMatrixCoordSys *)getCoordSys {
  if (coordSys_ == nil) {
    OrgGeogebraCommonKernelGeosGeoConic_set_coordSys_(self, OrgGeogebraCommonKernelMatrixCoordSys_get_Identity3D_());
  }
  return coordSys_;
}
...
void OrgGeogebraCommonKernelGeosGeoConic_initWithOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonKernelGeosGeoConic *self, OrgGeogebraCommonKernelConstruction *c) {
  OrgGeogebraCommonKernelKernelNDGeoConicND_initWithOrgGeogebraCommonKernelConstruction_withInt_(self, c, 2);
}
...
void OrgGeogebraCommonKernelGeosGeoConic_initWithOrgGeogebraCommonKernelGeosGeoConic_(OrgGeogebraCommonKernelGeosGeoConic *self, OrgGeogebraCommonKernelGeosGeoConic *conic) {
  OrgGeogebraCommonKernelGeosGeoConic_initWithOrgGeogebraCommonKernelConstruction_(self, ((OrgGeogebraCommonKernelGeosGeoConic *) nil_chk(conic))->cons_);
