...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/kernel/geos/GeoConicPart.java
//
...
- (OrgGeogebraCommonKernelGeosGeoElement *)copyInternalWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)construction {
  OrgGeogebraCommonKernelGeosGeoConicPart *ret = new_OrgGeogebraCommonKernelGeosGeoConicPart_initWithOrgGeogebraCommonKernelConstruction_withInt_(construction, ((OrgGeogebraCommonKernelKernelNDGeoConicPartParameters *) nil_chk(parameters_))->conic_part_type_);
...
- (NSString *)toStringWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  ...
  (void) [sbToString_ appendWithNSString:OrgGeogebraCommonKernelGeosGeoConicPart_toValueStringWithOrgGeogebraCommonKernelStringTemplate_(self, tpl)];
...
- (OrgGeogebraCommonKernelArithmeticMyDouble *)getNumber {
  return new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, OrgGeogebraCommonKernelGeosGeoConicPart_getValue(self));
}
...
- (IOSObjectArray *)createTransformedObjectWithOrgGeogebraCommonKernelTransform:(OrgGeogebraCommonKernelTransform *)t
  ...
  if (((OrgGeogebraCommonKernelKernelNDGeoConicPartParameters *) nil_chk(parameters_))->keepTypeOnGeometricTransform_) {
    algoParent_ = [self getParentAlgorithm];
  }
  ...
  if ([algoParent_ isKindOfClass:[OrgGeogebraCommonKernelAlgosAlgoConicPartCircle class]]) {
    ...
    IOSObjectArray *points = [IOSObjectArray newArrayWithObjects:(id[]){ [((OrgGeogebraCommonKernelAlgosAlgoConicPartCircle *) nil_chk(algo)) getCenter], [algo getStartPoint], [algo getEndPoint] } count:3 type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()];
    ...
    IOSObjectArray *geos = [IOSObjectArray newArrayWithObjects:(id[]){ res, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(IOSObjectArray_Get(points, 1), [OrgGeogebraCommonKernelGeosGeoElement class]), (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(IOSObjectArray_Get(points, 2), [OrgGeogebraCommonKernelGeosGeoElement class]), (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(IOSObjectArray_Get(points, 0), [OrgGeogebraCommonKernelGeosGeoElement class]) } count:4 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    return geos;
  }
    ...
    IOSObjectArray *geos = [IOSObjectArray newArrayWithObjects:(id[]){ ret } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    return geos;
  }
    ...
    IOSObjectArray *points = [IOSObjectArray newArrayWithObjects:(id[]){ [((OrgGeogebraCommonKernelAlgosAlgoConicPartConicPoints *) nil_chk(algo)) getStartPoint], [algo getEndPoint] } count:2 type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()];
    points = [((OrgGeogebraCommonKernelTransform *) nil_chk(t)) transformPointsWithOrgGeogebraCommonKernelKernelNDGeoPointNDArray:points];
    ...
    if ([t isKindOfClass:[OrgGeogebraCommonKernelTransformMirror class]] && [t changesOrientation]) {
      ...
      [((OrgGeogebraCommonKernelGeosGeoConicPart *) nil_chk(conicPart)) setVisualStyleForTransformationsWithOrgGeogebraCommonKernelGeosGeoElement:self];
      IOSObjectArray *geos = [IOSObjectArray newArrayWithObjects:(id[]){ conicPart, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(IOSObjectArray_Get(nil_chk(points), 0), [OrgGeogebraCommonKernelGeosGeoElement class]), (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(IOSObjectArray_Get(points, 1), [OrgGeogebraCommonKernelGeosGeoElement class]) } count:3 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
      return geos;
    }
    ...
    IOSObjectArray *geos = [IOSObjectArray newArrayWithObjects:(id[]){ semCirc, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(IOSObjectArray_Get(nil_chk(points), 0), [OrgGeogebraCommonKernelGeosGeoElement class]), (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(IOSObjectArray_Get(points, 1), [OrgGeogebraCommonKernelGeosGeoElement class]) } count:3 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    return geos;
  }
  else {
    ...
    IOSObjectArray *ret = [IOSObjectArray newArrayWithObjects:(id[]){ transformedConic } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    return ret;
  }
}

- (OrgGeogebraCommonKernelGeosGeoElement *)copy__ {
  return new_OrgGeogebraCommonKernelGeosGeoConicPart_initWithOrgGeogebraCommonKernelGeosGeoConicPart_(self);
}
...
void OrgGeogebraCommonKernelGeosGeoConicPart_initWithOrgGeogebraCommonKernelGeosGeoConicPart_(OrgGeogebraCommonKernelGeosGeoConicPart *self, OrgGeogebraCommonKernelGeosGeoConicPart *conic) {
  (void) OrgGeogebraCommonKernelGeosGeoConicPart_initWithOrgGeogebraCommonKernelConstruction_withInt_(self, ((OrgGeogebraCommonKernelGeosGeoConicPart *) nil_chk(conic))->cons_, OrgGeogebraCommonKernelGeosGeoConicPart_getConicPartType(conic));
