...
@interface OrgGeogebraCommonKernelGeosGeoConicPart () {
 @public
...
J2OBJC_FIELD_SETTER(OrgGeogebraCommonKernelGeosGeoConicPart, parameters_, OrgGeogebraCommonKernelKernelNDGeoConicPartParameters *)
J2OBJC_FIELD_SETTER(OrgGeogebraCommonKernelGeosGeoConicPart, sbToString_, JavaLangStringBuilder *)
J2OBJC_FIELD_SETTER(OrgGeogebraCommonKernelGeosGeoConicPart, tempPP_, OrgGeogebraCommonKernelPathParameter *)
J2OBJC_FIELD_SETTER(OrgGeogebraCommonKernelGeosGeoConicPart, tmpCoords_, OrgGeogebraCommonKernelMatrixCoords *)
J2OBJC_FIELD_SETTER(OrgGeogebraCommonKernelGeosGeoConicPart, tmpParameters_, IOSDoubleArray *)

__attribute__((unused)) static jint OrgGeogebraCommonKernelGeosGeoConicPart_getConicPartType(OrgGeogebraCommonKernelGeosGeoConicPart *self);

__attribute__((unused)) static jdouble OrgGeogebraCommonKernelGeosGeoConicPart_getValue(OrgGeogebraCommonKernelGeosGeoConicPart *self);

__attribute__((unused)) static NSString *OrgGeogebraCommonKernelGeosGeoConicPart_toValueStringWithOrgGeogebraCommonKernelStringTemplate_(OrgGeogebraCommonKernelGeosGeoConicPart *self, OrgGeogebraCommonKernelStringTemplate *tpl);

__attribute__((unused)) static OrgGeogebraCommonKernelPathParameter *OrgGeogebraCommonKernelGeosGeoConicPart_getTempPathParameter(OrgGeogebraCommonKernelGeosGeoConicPart *self);

@implementation OrgGeogebraCommonKernelGeosGeoConicPart

- (instancetype)initWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)c
                                                    withInt:(jint)type {
  OrgGeogebraCommonKernelGeosGeoConicPart_initWithOrgGeogebraCommonKernelConstruction_withInt_(self, c, type);
  return self;
}

- (instancetype)initWithOrgGeogebraCommonKernelGeosGeoConicPart:(OrgGeogebraCommonKernelGeosGeoConicPart *)conic {
  OrgGeogebraCommonKernelGeosGeoConicPart_initWithOrgGeogebraCommonKernelGeosGeoConicPart_(self, conic);
  return self;
}
...
- (OrgGeogebraCommonKernelGeosGeoElement *)copyInternalWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)construction {
  OrgGeogebraCommonKernelGeosGeoConicPart *ret = [new_OrgGeogebraCommonKernelGeosGeoConicPart_initWithOrgGeogebraCommonKernelConstruction_withInt_(construction, ((OrgGeogebraCommonKernelKernelNDGeoConicPartParameters *) nil_chk(parameters_))->conic_part_type_) autorelease];
...
- (void)setWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  ...
  OrgGeogebraCommonKernelGeosGeoConicPart *cp = (OrgGeogebraCommonKernelGeosGeoConicPart *) check_class_cast(geo, [OrgGeogebraCommonKernelGeosGeoConicPart class]);
  [((OrgGeogebraCommonKernelKernelNDGeoConicPartParameters *) nil_chk(parameters_)) setWithOrgGeogebraCommonKernelKernelNDGeoConicPartParameters:cp->parameters_];
}
...
- (jint)getConicPartType {
  return OrgGeogebraCommonKernelGeosGeoConicPart_getConicPartType(self);
}
...
- (jboolean)isEqualWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  ...
  OrgGeogebraCommonKernelGeosGeoConicPart *other = (OrgGeogebraCommonKernelGeosGeoConicPart *) check_class_cast(geo, [OrgGeogebraCommonKernelGeosGeoConicPart class]);
...
- (jdouble)getValue {
  return OrgGeogebraCommonKernelGeosGeoConicPart_getValue(self);
}
...
- (NSString *)toStringWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  ...
  [sbToString_ appendWithNSString:OrgGeogebraCommonKernelGeosGeoConicPart_toValueStringWithOrgGeogebraCommonKernelStringTemplate_(self, tpl)];
  return [sbToString_ description];
}

- (NSString *)toValueStringWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  return OrgGeogebraCommonKernelGeosGeoConicPart_toValueStringWithOrgGeogebraCommonKernelStringTemplate_(self, tpl);
}
...
- (jboolean)isOnPathWithOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)PI
  ...
  OrgGeogebraCommonKernelPathParameter *tempParam = OrgGeogebraCommonKernelGeosGeoConicPart_getTempPathParameter(self);
...
- (OrgGeogebraCommonKernelPathParameter *)getTempPathParameter {
  return OrgGeogebraCommonKernelGeosGeoConicPart_getTempPathParameter(self);
}
...
- (OrgGeogebraCommonKernelArithmeticMyDouble *)getNumber {
  return [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, OrgGeogebraCommonKernelGeosGeoConicPart_getValue(self)) autorelease];
}
...
- (IOSObjectArray *)createTransformedObjectWithOrgGeogebraCommonKernelTransform:(OrgGeogebraCommonKernelTransform *)t
  ...
  if (((OrgGeogebraCommonKernelKernelNDGeoConicPartParameters *) nil_chk(parameters_))->keepTypeOnGeometricTransform_) {
    OrgGeogebraCommonKernelGeosGeoElement_set_algoParent_(self, [self getParentAlgorithm]);
  }
  jint conic_part_type = parameters_->conic_part_type_;
  if ([algoParent_ isKindOfClass:[OrgGeogebraCommonKernelAlgosAlgoConicPartCircle class]]) {
    OrgGeogebraCommonKernelAlgosAlgoConicPartCircle *algo = (OrgGeogebraCommonKernelAlgosAlgoConicPartCircle *) check_class_cast(algoParent_, [OrgGeogebraCommonKernelAlgosAlgoConicPartCircle class]);
    IOSObjectArray *points = [IOSObjectArray arrayWithObjects:(id[]){ [((OrgGeogebraCommonKernelAlgosAlgoConicPartCircle *) nil_chk(algo)) getCenter], [algo getStartPoint], [algo getEndPoint] } count:3 type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()];
    OrgGeogebraCommonKernelAlgosAlgoCircleTwoPoints *algoCircle = [new_OrgGeogebraCommonKernelAlgosAlgoCircleTwoPoints_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_(cons_, (OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast(IOSObjectArray_Get(points, 0), [OrgGeogebraCommonKernelGeosGeoPoint class]), (OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast(IOSObjectArray_Get(points, 1), [OrgGeogebraCommonKernelGeosGeoPoint class])) autorelease];
    ...
    OrgGeogebraCommonKernelGeosGeoConic *circle = [algoCircle getCircle];
    ...
    OrgGeogebraCommonKernelKernelNDGeoConicND *transformedCircle = [t getTransformedConicWithOrgGeogebraCommonKernelKernelNDGeoConicND:circle];
    [cons_ removeFromConstructionListWithOrgGeogebraCommonKernelAlgosConstructionElement:[((OrgGeogebraCommonKernelKernelNDGeoConicND *) nil_chk(transformedCircle)) getParentAlgorithm]];
    OrgGeogebraCommonKernelAlgosAlgoConicPartConicPoints *algoResult = [new_OrgGeogebraCommonKernelAlgosAlgoConicPartConicPoints_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelKernelNDGeoConicND_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_withInt_(cons_, transformedLabel, transformedCircle, (OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast(IOSObjectArray_Get(nil_chk(points), 1), [OrgGeogebraCommonKernelGeosGeoPoint class]), (OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast(IOSObjectArray_Get(points, 2), [OrgGeogebraCommonKernelGeosGeoPoint class]), conic_part_type) autorelease];
    OrgGeogebraCommonKernelGeosGeoConicPart *conicPart = [algoResult getConicPart];
    [((OrgGeogebraCommonKernelGeosGeoConicPart *) nil_chk(conicPart)) setVisualStyleForTransformationsWithOrgGeogebraCommonKernelGeosGeoElement:self];
    IOSObjectArray *geos = [IOSObjectArray arrayWithObjects:(id[]){ conicPart, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(IOSObjectArray_Get(points, 0), [OrgGeogebraCommonKernelGeosGeoElement class]), (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(IOSObjectArray_Get(points, 2), [OrgGeogebraCommonKernelGeosGeoElement class]), (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(IOSObjectArray_Get(points, 1), [OrgGeogebraCommonKernelGeosGeoElement class]) } count:4 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    return geos;
  }
  else if ([algoParent_ isKindOfClass:[OrgGeogebraCommonKernelAlgosAlgoConicPartCircumcircle class]]) {
    IOSObjectArray *points = [IOSObjectArray arrayWithObjects:(id[]){ (OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast(IOSObjectArray_Get(nil_chk(((OrgGeogebraCommonKernelAlgosAlgoElement *) nil_chk(algoParent_))->input_), 0), [OrgGeogebraCommonKernelGeosGeoPoint class]), (OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast(IOSObjectArray_Get(algoParent_->input_, 1), [OrgGeogebraCommonKernelGeosGeoPoint class]), (OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast(IOSObjectArray_Get(algoParent_->input_, 2), [OrgGeogebraCommonKernelGeosGeoPoint class]) } count:3 type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()];
    points = [((OrgGeogebraCommonKernelTransform *) nil_chk(t)) transformPointsWithOrgGeogebraCommonKernelKernelNDGeoPointNDArray:points];
    OrgGeogebraCommonKernelAlgosAlgoConicPartCircumcircle *algo = [new_OrgGeogebraCommonKernelAlgosAlgoConicPartCircumcircle_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_withOrgGeogebraCommonKernelGeosGeoPoint_withInt_(cons_, transformedLabel, (OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast(IOSObjectArray_Get(nil_chk(points), 0), [OrgGeogebraCommonKernelGeosGeoPoint class]), (OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast(IOSObjectArray_Get(points, 1), [OrgGeogebraCommonKernelGeosGeoPoint class]), (OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast(IOSObjectArray_Get(points, 2), [OrgGeogebraCommonKernelGeosGeoPoint class]), conic_part_type) autorelease];
    OrgGeogebraCommonKernelGeosGeoConicPart *res = [algo getConicPart];
    [((OrgGeogebraCommonKernelGeosGeoConicPart *) nil_chk(res)) setLabelWithNSString:transformedLabel];
    [res setVisualStyleForTransformationsWithOrgGeogebraCommonKernelGeosGeoElement:self];
    IOSObjectArray *geos = [IOSObjectArray arrayWithObjects:(id[]){ res, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(IOSObjectArray_Get(points, 1), [OrgGeogebraCommonKernelGeosGeoElement class]), (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(IOSObjectArray_Get(points, 2), [OrgGeogebraCommonKernelGeosGeoElement class]), (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(IOSObjectArray_Get(points, 0), [OrgGeogebraCommonKernelGeosGeoElement class]) } count:4 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    return geos;
  }
  else if ([algoParent_ isKindOfClass:[OrgGeogebraCommonKernelAlgosAlgoConicPartConicParameters class]]) {
    OrgGeogebraCommonKernelAlgosAlgoConicPartConicParameters *algo = (OrgGeogebraCommonKernelAlgosAlgoConicPartConicParameters *) check_class_cast(algoParent_, [OrgGeogebraCommonKernelAlgosAlgoConicPartConicParameters class]);
    OrgGeogebraCommonKernelKernelNDGeoConicND *transformedConic = [((OrgGeogebraCommonKernelTransform *) nil_chk(t)) getTransformedConicWithOrgGeogebraCommonKernelKernelNDGeoConicND:((OrgGeogebraCommonKernelAlgosAlgoConicPartConicParameters *) nil_chk(algo))->conic_];
    [((OrgGeogebraCommonKernelConstruction *) nil_chk(cons_)) removeFromConstructionListWithOrgGeogebraCommonKernelAlgosConstructionElement:[((OrgGeogebraCommonKernelKernelNDGeoConicND *) nil_chk(transformedConic)) getParentAlgorithm]];
    ...
    OrgGeogebraCommonKernelGeosGeoElement *ret = [algo getConicPart];
    [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(ret)) setVisualStyleForTransformationsWithOrgGeogebraCommonKernelGeosGeoElement:self];
    IOSObjectArray *geos = [IOSObjectArray arrayWithObjects:(id[]){ ret } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    return geos;
  }
  else if ([algoParent_ isKindOfClass:[OrgGeogebraCommonKernelAlgosAlgoConicPartConicPoints class]]) {
    OrgGeogebraCommonKernelAlgosAlgoConicPartConicPoints *algo = (OrgGeogebraCommonKernelAlgosAlgoConicPartConicPoints *) check_class_cast(algoParent_, [OrgGeogebraCommonKernelAlgosAlgoConicPartConicPoints class]);
    IOSObjectArray *points = [IOSObjectArray arrayWithObjects:(id[]){ [((OrgGeogebraCommonKernelAlgosAlgoConicPartConicPoints *) nil_chk(algo)) getStartPoint], [algo getEndPoint] } count:2 type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()];
    points = [((OrgGeogebraCommonKernelTransform *) nil_chk(t)) transformPointsWithOrgGeogebraCommonKernelKernelNDGeoPointNDArray:points];
    OrgGeogebraCommonKernelKernelNDGeoConicND *orgConic = [algo getConic];
    OrgGeogebraCommonKernelKernelNDGeoConicND *transformedConic = [t getTransformedConicWithOrgGeogebraCommonKernelKernelNDGeoConicND:orgConic];
    [((OrgGeogebraCommonKernelConstruction *) nil_chk(cons_)) removeFromConstructionListWithOrgGeogebraCommonKernelAlgosConstructionElement:[((OrgGeogebraCommonKernelKernelNDGeoConicND *) nil_chk(transformedConic)) getParentAlgorithm]];
    algo = [new_OrgGeogebraCommonKernelAlgosAlgoConicPartConicPoints_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelKernelNDGeoConicND_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_withInt_(cons_, transformedLabel, transformedConic, (OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast(IOSObjectArray_Get(nil_chk(points), 0), [OrgGeogebraCommonKernelGeosGeoPoint class]), (OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast(IOSObjectArray_Get(points, 1), [OrgGeogebraCommonKernelGeosGeoPoint class]), conic_part_type) autorelease];
    OrgGeogebraCommonKernelGeosGeoConicPart *conicPart = [algo getConicPart];
    [((OrgGeogebraCommonKernelGeosGeoConicPart *) nil_chk(conicPart)) setVisualStyleForTransformationsWithOrgGeogebraCommonKernelGeosGeoElement:self];
    IOSObjectArray *geos = [IOSObjectArray arrayWithObjects:(id[]){ conicPart, (OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast(IOSObjectArray_Get(points, 0), [OrgGeogebraCommonKernelGeosGeoPoint class]), (OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast(IOSObjectArray_Get(points, 1), [OrgGeogebraCommonKernelGeosGeoPoint class]) } count:3 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    return geos;
  }
  else if ([algoParent_ isKindOfClass:[OrgGeogebraCommonKernelAlgosAlgoSemicircle class]]) {
    OrgGeogebraCommonKernelAlgosAlgoElement *algo = algoParent_;
    IOSObjectArray *points = [IOSObjectArray arrayWithObjects:(id[]){ [((OrgGeogebraCommonKernelAlgosAlgoSemicircle *) nil_chk(((OrgGeogebraCommonKernelAlgosAlgoSemicircle *) check_class_cast(algo, [OrgGeogebraCommonKernelAlgosAlgoSemicircle class])))) getA], [((OrgGeogebraCommonKernelAlgosAlgoSemicircle *) nil_chk(((OrgGeogebraCommonKernelAlgosAlgoSemicircle *) check_class_cast(algo, [OrgGeogebraCommonKernelAlgosAlgoSemicircle class])))) getB] } count:2 type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()];
    points = [((OrgGeogebraCommonKernelTransform *) nil_chk(t)) transformPointsWithOrgGeogebraCommonKernelKernelNDGeoPointNDArray:points];
    OrgGeogebraCommonKernelGeosGeoConic *semCirc;
    if ([t isKindOfClass:[OrgGeogebraCommonKernelTransformMirror class]] && [t changesOrientation]) {
      semCirc = [((OrgGeogebraCommonKernelAlgosAlgoDispatcher *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) getAlgoDispatcher])) SemicircleWithNSString:transformedLabel withOrgGeogebraCommonKernelGeosGeoPoint:(OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast(IOSObjectArray_Get(nil_chk(points), 1), [OrgGeogebraCommonKernelGeosGeoPoint class]) withOrgGeogebraCommonKernelGeosGeoPoint:(OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast(IOSObjectArray_Get(points, 0), [OrgGeogebraCommonKernelGeosGeoPoint class])];
    }
    else if ([t isSimilar]) {
      semCirc = [((OrgGeogebraCommonKernelAlgosAlgoDispatcher *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) getAlgoDispatcher])) SemicircleWithNSString:transformedLabel withOrgGeogebraCommonKernelGeosGeoPoint:(OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast(IOSObjectArray_Get(nil_chk(points), 0), [OrgGeogebraCommonKernelGeosGeoPoint class]) withOrgGeogebraCommonKernelGeosGeoPoint:(OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast(IOSObjectArray_Get(points, 1), [OrgGeogebraCommonKernelGeosGeoPoint class])];
    }
    else {
      OrgGeogebraCommonKernelGeosGeoConic *orgConic = [((OrgGeogebraCommonKernelAlgosAlgoSemicircle *) nil_chk(((OrgGeogebraCommonKernelAlgosAlgoSemicircle *) check_class_cast(algo, [OrgGeogebraCommonKernelAlgosAlgoSemicircle class])))) getConic];
      OrgGeogebraCommonKernelKernelNDGeoConicND *transformedConic = [t getTransformedConicWithOrgGeogebraCommonKernelKernelNDGeoConicND:orgConic];
      [((OrgGeogebraCommonKernelConstruction *) nil_chk((cons_))) removeFromConstructionListWithOrgGeogebraCommonKernelAlgosConstructionElement:[((OrgGeogebraCommonKernelKernelNDGeoConicND *) nil_chk(transformedConic)) getParentAlgorithm]];
      if ([t changesOrientation]) {
        algo = [new_OrgGeogebraCommonKernelAlgosAlgoConicPartConicPoints_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelKernelNDGeoConicND_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_withInt_(cons_, transformedLabel, transformedConic, (OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast(IOSObjectArray_Get(nil_chk(points), 0), [OrgGeogebraCommonKernelGeosGeoPoint class]), (OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast(IOSObjectArray_Get(points, 1), [OrgGeogebraCommonKernelGeosGeoPoint class]), conic_part_type) autorelease];
      }
      else algo = [new_OrgGeogebraCommonKernelAlgosAlgoConicPartConicPoints_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelKernelNDGeoConicND_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_withInt_(cons_, transformedLabel, transformedConic, (OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast(IOSObjectArray_Get(nil_chk(points), 1), [OrgGeogebraCommonKernelGeosGeoPoint class]), (OrgGeogebraCommonKernelGeosGeoPoint *) check_class_cast(IOSObjectArray_Get(points, 0), [OrgGeogebraCommonKernelGeosGeoPoint class]), conic_part_type) autorelease];
      OrgGeogebraCommonKernelGeosGeoConicPart *conicPart = [((OrgGeogebraCommonKernelAlgosAlgoConicPartConicPoints *) nil_chk(((OrgGeogebraCommonKernelAlgosAlgoConicPartConicPoints *) check_class_cast(algo, [OrgGeogebraCommonKernelAlgosAlgoConicPartConicPoints class])))) getConicPart];
      [((OrgGeogebraCommonKernelGeosGeoConicPart *) nil_chk(conicPart)) setVisualStyleForTransformationsWithOrgGeogebraCommonKernelGeosGeoElement:self];
      IOSObjectArray *geos = [IOSObjectArray arrayWithObjects:(id[]){ conicPart, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(IOSObjectArray_Get(nil_chk(points), 0), [OrgGeogebraCommonKernelGeosGeoElement class]), (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(IOSObjectArray_Get(points, 1), [OrgGeogebraCommonKernelGeosGeoElement class]) } count:3 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
      return geos;
    }
    [((OrgGeogebraCommonKernelGeosGeoConic *) nil_chk(semCirc)) setVisualStyleForTransformationsWithOrgGeogebraCommonKernelGeosGeoElement:self];
    IOSObjectArray *geos = [IOSObjectArray arrayWithObjects:(id[]){ semCirc, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(IOSObjectArray_Get(nil_chk(points), 0), [OrgGeogebraCommonKernelGeosGeoElement class]), (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(IOSObjectArray_Get(points, 1), [OrgGeogebraCommonKernelGeosGeoElement class]) } count:3 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    return geos;
  }
  else {
    OrgGeogebraCommonKernelKernelNDGeoConicND *transformedConic = [((OrgGeogebraCommonKernelTransform *) nil_chk(t)) getTransformedConicWithOrgGeogebraCommonKernelKernelNDGeoConicND:self];
    [((OrgGeogebraCommonKernelKernelNDGeoConicND *) nil_chk(transformedConic)) setLabelWithNSString:transformedLabel];
    IOSObjectArray *ret = [IOSObjectArray arrayWithObjects:(id[]){ transformedConic } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    return ret;
  }
}

- (OrgGeogebraCommonKernelGeosGeoElement *)copy__ {
  return [new_OrgGeogebraCommonKernelGeosGeoConicPart_initWithOrgGeogebraCommonKernelGeosGeoConicPart_(self) autorelease];
}
...
- (void)moveBackToRegionWithOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)pi
  ...
  OrgGeogebraCommonKernelMatrixCoordNearest *nearestPoint = [new_OrgGeogebraCommonKernelMatrixCoordNearest_initWithOrgGeogebraCommonKernelMatrixCoords_(coords) autorelease];
  OrgGeogebraCommonKernelMatrixCoords *midPoint = [self getMidpoint2D];
  if (OrgGeogebraCommonKernelGeosGeoConicPart_getConicPartType(self) == OrgGeogebraCommonKernelKernelNDGeoConicNDConstants_CONIC_PART_SECTOR) [nearestPoint checkWithOrgGeogebraCommonKernelMatrixCoords:midPoint];
  OrgGeogebraCommonKernelMatrixCoords *ev0 = [new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(3) autorelease];
  [ev0 setWithOrgGeogebraCommonKernelMatrixCoords:[self getEigenvecWithInt:0]];
  OrgGeogebraCommonKernelMatrixCoords *ev1 = [new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(3) autorelease];
  ...
  if (OrgGeogebraCommonKernelGeosGeoConicPart_getConicPartType(self) == OrgGeogebraCommonKernelKernelNDGeoConicNDConstants_CONIC_PART_SECTOR) {
...
- (OrgGeogebraCommonKernelGeosGeoPoint *)getPointParamWithDouble:(jdouble)param {
  OrgGeogebraCommonKernelGeosGeoPoint *ret = [new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
...
- (OrgGeogebraCommonKernelMatrixCoords *)getOrigin3DWithInt:(jint)i {
  return [((OrgGeogebraCommonKernelGeosGeoLine *) nil_chk(IOSObjectArray_Get(nil_chk(lines_), i))) getStartInhomCoords];
}

- (OrgGeogebraCommonKernelMatrixCoords *)getSegmentEnd3D {
  return [((OrgGeogebraCommonKernelGeosGeoLine *) nil_chk(IOSObjectArray_Get(nil_chk(lines_), 0))) getEndInhomCoords];
}
...
- (void)fromLineWithOrgGeogebraCommonKernelGeosGeoLine:(OrgGeogebraCommonKernelGeosGeoLine *)line {
  [super fromLineWithOrgGeogebraCommonKernelGeosGeoLine:line];
  ((OrgGeogebraCommonKernelKernelNDGeoConicPartParameters *) nil_chk(parameters_))->value_ = 0;
  parameters_->value_defined_ = YES;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithOrgGeogebraCommonKernelConstruction:withInt:", "GeoConicPart", NULL, 0x1, NULL, NULL },
    { "initWithOrgGeogebraCommonKernelGeosGeoConicPart:", "GeoConicPart", NULL, 0x1, NULL, NULL },
  ...
  static const J2ObjcClassInfo _OrgGeogebraCommonKernelGeosGeoConicPart = { 2, "GeoConicPart", "org.geogebra.common.kernel.geos", NULL, 0x1, 54, methods, 5, fields, 0, NULL, 0, NULL, NULL, NULL };
  return &_OrgGeogebraCommonKernelGeosGeoConicPart;
}

@end

void OrgGeogebraCommonKernelGeosGeoConicPart_initWithOrgGeogebraCommonKernelConstruction_withInt_(OrgGeogebraCommonKernelGeosGeoConicPart *self, OrgGeogebraCommonKernelConstruction *c, jint type) {
  OrgGeogebraCommonKernelGeosGeoConic_initWithOrgGeogebraCommonKernelConstruction_(self, c);
  OrgGeogebraCommonKernelGeosGeoConicPart_setAndConsume_sbToString_(self, new_JavaLangStringBuilder_initWithInt_(50));
  OrgGeogebraCommonKernelGeosGeoConicPart_setAndConsume_tmpCoords_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(3));
  OrgGeogebraCommonKernelGeosGeoConicPart_setAndConsume_tmpParameters_(self, [IOSDoubleArray newArrayWithLength:2]);
  OrgGeogebraCommonKernelGeosGeoConicPart_setAndConsume_parameters_(self, new_OrgGeogebraCommonKernelKernelNDGeoConicPartParameters_initWithOrgGeogebraCommonKernelKernelNDGeoConicND_withInt_(self, type));
  [self setConstructionDefaults];
}

OrgGeogebraCommonKernelGeosGeoConicPart *new_OrgGeogebraCommonKernelGeosGeoConicPart_initWithOrgGeogebraCommonKernelConstruction_withInt_(OrgGeogebraCommonKernelConstruction *c, jint type) {
  OrgGeogebraCommonKernelGeosGeoConicPart *self = [OrgGeogebraCommonKernelGeosGeoConicPart alloc];
  OrgGeogebraCommonKernelGeosGeoConicPart_initWithOrgGeogebraCommonKernelConstruction_withInt_(self, c, type);
  return self;
}

void OrgGeogebraCommonKernelGeosGeoConicPart_initWithOrgGeogebraCommonKernelGeosGeoConicPart_(OrgGeogebraCommonKernelGeosGeoConicPart *self, OrgGeogebraCommonKernelGeosGeoConicPart *conic) {
  OrgGeogebraCommonKernelGeosGeoConicPart_initWithOrgGeogebraCommonKernelConstruction_withInt_(self, ((OrgGeogebraCommonKernelGeosGeoConicPart *) nil_chk(conic))->cons_, OrgGeogebraCommonKernelGeosGeoConicPart_getConicPartType(conic));
  [self setWithOrgGeogebraCommonKernelGeosGeoElement:conic];
}

OrgGeogebraCommonKernelGeosGeoConicPart *new_OrgGeogebraCommonKernelGeosGeoConicPart_initWithOrgGeogebraCommonKernelGeosGeoConicPart_(OrgGeogebraCommonKernelGeosGeoConicPart *conic) {
  OrgGeogebraCommonKernelGeosGeoConicPart *self = [OrgGeogebraCommonKernelGeosGeoConicPart alloc];
  OrgGeogebraCommonKernelGeosGeoConicPart_initWithOrgGeogebraCommonKernelGeosGeoConicPart_(self, conic);
  return self;
}

jint OrgGeogebraCommonKernelGeosGeoConicPart_getConicPartType(OrgGeogebraCommonKernelGeosGeoConicPart *self) {
...
jdouble OrgGeogebraCommonKernelGeosGeoConicPart_getValue(OrgGeogebraCommonKernelGeosGeoConicPart *self) {
  return [((OrgGeogebraCommonKernelKernelNDGeoConicPartParameters *) nil_chk(self->parameters_)) getValue];
}

NSString *OrgGeogebraCommonKernelGeosGeoConicPart_toValueStringWithOrgGeogebraCommonKernelStringTemplate_(OrgGeogebraCommonKernelGeosGeoConicPart *self, OrgGeogebraCommonKernelStringTemplate *tpl) {
...
OrgGeogebraCommonKernelPathParameter *OrgGeogebraCommonKernelGeosGeoConicPart_getTempPathParameter(OrgGeogebraCommonKernelGeosGeoConicPart *self) {
  if (self->tempPP_ == nil) OrgGeogebraCommonKernelGeosGeoConicPart_setAndConsume_tempPP_(self, new_OrgGeogebraCommonKernelPathParameter_init());
  return self->tempPP_;
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgGeogebraCommonKernelGeosGeoConicPart)
