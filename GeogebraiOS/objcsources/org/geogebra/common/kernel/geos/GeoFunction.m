...
- (OrgGeogebraCommonKernelGeosGeoElement *)copy__ {
  return new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelGeosGeoFunction_(self);
}
...
- (void)setWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  ...
  [self setFunctionWithOrgGeogebraCommonKernelArithmeticFunction:new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticFunction_withOrgGeogebraCommonKernelKernel_(geoFun, kernel_)];
...
- (void)setFunctionWithOrgGeogebraCommonKernelArithmeticFunction:(OrgGeogebraCommonKernelArithmeticFunction *)f {
  fun_ = f;
  self->includesNonContinuousIntegralFun_ = nil;
...
- (void)setDerivativeWithOrgGeogebraCommonKernelGeosCasEvaluableFunction:(id<OrgGeogebraCommonKernelGeosCasEvaluableFunction>)fd
  ...
  if ([((OrgGeogebraCommonKernelGeosGeoFunction *) nil_chk(f)) isDefined]) {
    fun_ = [((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk(f->fun_)) getDerivativeWithInt:n withBoolean:fast];
...
withOrgGeogebraCommonKernelArithmeticMyArbitraryConstant:(OrgGeogebraCommonKernelArithmeticMyArbitraryConstant *)arbconst {
  ...
  if ([((OrgGeogebraCommonKernelGeosGeoFunction *) nil_chk(ff)) isDefined]) {
    fun_ = (OrgGeogebraCommonKernelArithmeticFunction *) check_class_cast([((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk(ff->fun_)) evalCasCommandWithNSString:ggbCasCmd withBoolean:symbolic withOrgGeogebraCommonKernelArithmeticMyArbitraryConstant:arbconst], [OrgGeogebraCommonKernelArithmeticFunction class]);
    OrgGeogebraCommonKernelGeosGeoFunction_checkDefined(self);
  }
  else {
    isDefined__ = NO;
...
- (OrgGeogebraCommonKernelGeosGeoFunction *)getGeoDerivativeWithInt:(jint)order {
  if (derivGeoFun_ == nil) {
    derivGeoFun_ = new_OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_(cons_);
  }
...
- (jboolean)includesDivisionByVar {
  if (includesDivisionByVarFun_ != fun_) {
    includesDivisionByVarFun_ = fun_;
...
- (jboolean)includesNonContinuousIntegral {
  if (includesNonContinuousIntegralFun_ != fun_) {
    includesNonContinuousIntegralFun_ = fun_;
...
- (jboolean)isFillable {
  if (fun_ != nil && isInequality__ == nil && [self isBooleanFunction]) (void) [self getIneqs];
...
- (NSString *)toStringWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  ...
  (void) [sbToString_ appendWithNSString:[self toValueStringWithOrgGeogebraCommonKernelStringTemplate:tpl]];
...
withJavaLangStringBuilder:(JavaLangStringBuilder *)sbxml {
  ...
  (void) [((JavaLangStringBuilder *) nil_chk(sbxml)) appendWithNSString:@"<element"];
  (void) [sbxml appendWithNSString:@" type=\"function\""];
  (void) [sbxml appendWithNSString:@" label=\""];
  (void) [sbxml appendWithNSString:label_];
  if ([self getDefaultGeoType] >= 0) {
    (void) [sbxml appendWithNSString:@"\" default=\""];
    (void) [sbxml appendWithInt:[self getDefaultGeoType]];
  }
  (void) [sbxml appendWithNSString:@"\">\n"];
  ...
  (void) [sbxml appendWithNSString:@"</element>\n"];
}
...
- (void)getXMLtagsWithJavaLangStringBuilder:(JavaLangStringBuilder *)sbxml {
  ...
  if ([self showOnAxis]) {
    (void) [((JavaLangStringBuilder *) nil_chk(sbxml)) appendWithNSString:@"<showOnAxis val=\"true\" />"];
  }
}
...
- (NSString *)getAssignmentLHSWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  [((JavaLangStringBuilder *) nil_chk(sbToString_)) setLengthWithInt:0];
  (void) [sbToString_ appendWithNSString:[((OrgGeogebraCommonKernelStringTemplate *) nil_chk(tpl)) printVariableNameWithNSString:label_]];
...
- (id<OrgGeogebraCommonKernelRootsRealRootFunction>)getRealRootFunctionX {
  return new_OrgGeogebraCommonKernelGeosGeoFunction_$4_init();
}
...
- (OrgGeogebraCommonKernelGeosGeoVec2D *)evaluateCurveWithDouble:(jdouble)t {
  return new_OrgGeogebraCommonKernelGeosGeoVec2D_initWithOrgGeogebraCommonKernelKernel_withDouble_withDouble_(kernel_, t, [self evaluateWithDouble:t]);
}
...
- (NSString *)getLimitWithDouble:(jdouble)x
  ...
  if (OrgGeogebraCommonKernelGeosGeoFunction_sb_ == nil) {
    OrgGeogebraCommonKernelGeosGeoFunction_sb_ = new_JavaLangStringBuilder_init();
  }
  else {
  ...
  (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:@"Numeric(Limit"];
  if (direction == -1) {
    (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:@"Above"];
  }
  else if (direction == 1) {
    (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:@"Below"];
  }
  (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithChar:'('];
  (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:IOSObjectArray_Get(nil_chk(funVarStr), 0)];
  (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithChar:','];
  (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:IOSObjectArray_Get(funVarStr, 1)];
  (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithChar:','];
  (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:OrgGeogebraCommonKernelArithmeticMyDouble_toStringWithDouble_(x)];
  (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:@"),"];
  (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:@"50)"];
...
- (void)getDiagonalAsymptoteStaticWithOrgGeogebraCommonKernelGeosGeoFunction:(OrgGeogebraCommonKernelGeosGeoFunction *)f
  ...
  @try {
    ...
    if (OrgGeogebraCommonKernelGeosGeoFunction_sb_ == nil) OrgGeogebraCommonKernelGeosGeoFunction_sb_ = new_JavaLangStringBuilder_init();
    else [OrgGeogebraCommonKernelGeosGeoFunction_sb_ setLengthWithInt:0];
    NSString *gradientStrMinus = @"";
    NSString *interceptStrMinus = @"";
    [((JavaLangStringBuilder *) nil_chk(OrgGeogebraCommonKernelGeosGeoFunction_sb_)) setLengthWithInt:0];
    (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:@"Limit("];
    (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:IOSObjectArray_Get(nil_chk(derivVarStr), 0)];
    (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithChar:','];
    (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:IOSObjectArray_Get(derivVarStr, 1)];
    (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithChar:','];
    if (!positiveInfinity_) (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithChar:'-'];
    (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithChar:OrgGeogebraCommonUtilUnicode_INFINITY];
    (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithChar:')'];
    ...
    if (!OrgGeogebraCommonKernelGeosGeoFunction_CASErrorWithNSString_withBoolean_(gradientStrMinus, NO) && !OrgGeogebraCommonKernelKernel_isZeroWithDouble_(grad)) {
      ...
      (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:IOSObjectArray_Get(nil_chk(funVarStr), 0)];
      (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:@" - "];
      (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:gradientStrMinus];
      (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:@" * "];
      (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:IOSObjectArray_Get(derivVarStr, 1)];
      (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithChar:','];
      (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:IOSObjectArray_Get(derivVarStr, 1)];
      ...
      if (!OrgGeogebraCommonKernelGeosGeoFunction_CASErrorWithNSString_withBoolean_(interceptStrMinus, NO)) {
        [OrgGeogebraCommonKernelGeosGeoFunction_sb_ setLengthWithInt:0];
        (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:@"y = "];
        (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:gradientStrMinus];
        (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:@" * x +"];
        (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:interceptStrMinus];
        if (![((NSString *) nil_chk([((JavaLangStringBuilder *) nil_chk(SB)) description])) hasSuffix:[OrgGeogebraCommonKernelGeosGeoFunction_sb_ description]]) {
          ...
          (void) [SB appendWithJavaLangCharSequence:OrgGeogebraCommonKernelGeosGeoFunction_sb_];
        }
      }
    }
  }
...
- (void)getHorizontalAsymptoteStaticWithOrgGeogebraCommonKernelGeosGeoFunction:(OrgGeogebraCommonKernelGeosGeoFunction *)f
  ...
  (void) [((JavaLangStringBuilder *) nil_chk(OrgGeogebraCommonKernelGeosGeoFunction_sb_)) appendWithNSString:@"Limit("];
  (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:IOSObjectArray_Get(nil_chk(funVarStr), 0)];
  (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithChar:','];
  (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:IOSObjectArray_Get(funVarStr, 1)];
  (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithChar:','];
...
- (void)getVerticalAsymptotesStaticWithOrgGeogebraCommonKernelGeosGeoFunction:(OrgGeogebraCommonKernelGeosGeoFunction *)f
  ...
  (void) [((JavaLangStringBuilder *) nil_chk(OrgGeogebraCommonKernelGeosGeoFunction_sb_)) appendWithNSString:@"Solve("];
  (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:@"Simplify("];
  (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:@"1/("];
  (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:IOSObjectArray_Get(nil_chk(funVarStr), 0)];
  (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithChar:')'];
  (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:@")=0"];
  (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:@","];
  (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:IOSObjectArray_Get(funVarStr, 1)];
  (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:@")"];
  @try {
    ...
    if (!OrgGeogebraCommonKernelGeosGeoFunction_CASErrorWithNSString_withBoolean_(verticalAsymptotes, NO) && ((jint) [((NSString *) nil_chk(verticalAsymptotes)) length]) > 2) {
      ...
      for (jint i = 0; i < ((IOSObjectArray *) nil_chk(verticalAsymptotesArray))->size_; i++) {
        ...
        if (!repeat && isInRange) {
          [OrgGeogebraCommonKernelGeosGeoFunction_sb_ setLengthWithInt:0];
          (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:@"Numeric(Limit("];
          (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:IOSObjectArray_Get(funVarStr, 0)];
          (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithChar:','];
          (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:IOSObjectArray_Get(funVarStr, 1)];
          (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:@","];
          (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:IOSObjectArray_Get(verticalAsymptotesArray, i)];
          (void) [OrgGeogebraCommonKernelGeosGeoFunction_sb_ appendWithNSString:@"))"];
          @try {
            ...
            if ([((NSString *) nil_chk(limit)) isEqual:@"?"] || !OrgGeogebraCommonKernelGeosGeoFunction_CASErrorWithNSString_withBoolean_(limit, YES)) {
              if ([((JavaLangStringBuilder *) nil_chk(verticalSB)) length] > 1) (void) [verticalSB appendWithChar:','];
              (void) [verticalSB appendWithNSString:@"x="];
              (void) [verticalSB appendWithNSString:IOSObjectArray_Get(verticalAsymptotesArray, i)];
            }
          }
          @catch (JavaLangThrowable *e) {
            [((JavaLangThrowable *) nil_chk(e)) printStackTrace];
...
- (void)toGeoCurveCartesianWithOrgGeogebraCommonKernelGeosGeoCurveCartesian:(OrgGeogebraCommonKernelGeosGeoCurveCartesian *)curve {
  OrgGeogebraCommonKernelArithmeticFunctionVariable *t = new_OrgGeogebraCommonKernelArithmeticFunctionVariable_initWithOrgGeogebraCommonKernelKernel_withNSString_(kernel_, @"t");
  ...
  [((OrgGeogebraCommonKernelGeosGeoCurveCartesian *) nil_chk(curve)) setFunctionYWithOrgGeogebraCommonKernelArithmeticFunction:new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionVariable_(yExp, t)];
...
- (void)mirrorWithOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)P {
  [self dilateWithOrgGeogebraCommonKernelArithmeticNumberValue:new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, -1.0) withOrgGeogebraCommonKernelMatrixCoords:P];
}
...
- (void)resetIneqs {
  isInequality__ = JavaLangBoolean_valueOfWithBoolean_([((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk(fun_)) initIneqsWithOrgGeogebraCommonKernelArithmeticExpressionNode:OrgGeogebraCommonKernelGeosGeoFunction_getFunctionExpression(self) withOrgGeogebraCommonKernelArithmeticFunctionalNVar:self]);
}

- (OrgGeogebraCommonKernelArithmeticIneqTree *)getIneqs {
  if ([((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk(fun_)) getIneqs] == nil) {
    isInequality__ = JavaLangBoolean_valueOfWithBoolean_([fun_ initIneqsWithOrgGeogebraCommonKernelArithmeticExpressionNode:[fun_ getExpression] withOrgGeogebraCommonKernelArithmeticFunctionalNVar:self]);
  }
...
withOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  JavaLangStringBuilder *sbLaTeX = new_JavaLangStringBuilder_init();
  ...
  if ([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(expr)) getOperation] == OrgGeogebraCommonPluginOperationEnum_get_IF() && ![((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk([expr getRight])) wrap])) isConditional]) {
    if (substituteNumbers) {
      (void) [sbLaTeX appendWithNSString:[((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk([expr getRight])) toValueStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_latexTemplate_()]];
      (void) [sbLaTeX appendWithNSString:@" \\;\\;\\;\\; \\left("];
      (void) [sbLaTeX appendWithNSString:[((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk([expr getLeft])) toValueStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_latexTemplate_()]];
    }
    else {
      (void) [sbLaTeX appendWithNSString:[((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk([expr getRight])) toStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_latexTemplate_()]];
      (void) [sbLaTeX appendWithNSString:@" \\;\\;\\;\\; \\left("];
      (void) [sbLaTeX appendWithNSString:[((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk([expr getLeft])) toStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_latexTemplate_()]];
    }
    (void) [sbLaTeX appendWithNSString:@" \\right)"];
  }
  else {
    JavaUtilArrayList *cases = new_JavaUtilArrayList_init();
    JavaUtilArrayList *conditions = new_JavaUtilArrayList_init();
    jboolean complete = OrgGeogebraCommonKernelGeosGeoFunction_collectCasesWithOrgGeogebraCommonKernelArithmeticExpressionNode_withJavaUtilArrayList_withJavaUtilArrayList_withOrgGeogebraCommonKernelGeosGeoFunction_Bounds_(self, expr, cases, conditions, new_OrgGeogebraCommonKernelGeosGeoFunction_Bounds_initWithOrgGeogebraCommonKernelGeosGeoFunction_(self));
    if ([((OrgGeogebraCommonMainApp *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) getApplication])) isLatexMathQuillStyleWithOrgGeogebraCommonKernelStringTemplate:tpl]) {
      (void) [sbLaTeX appendWithNSString:@"\\piecewise{ \\pwtable{ "];
      for (jint i = 0; i < [cases size]; i++) {
        (void) [sbLaTeX appendWithNSString:@"\\ggbtr{ \\ggbtdL{ "];
        (void) [sbLaTeX appendWithNSString:[((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([cases getWithInt:i])) toLaTeXStringWithBoolean:!substituteNumbers withOrgGeogebraCommonKernelStringTemplate:tpl]];
        (void) [sbLaTeX appendWithNSString:@"} \\ggbtdL{ : \\space "];
        if (i == [cases size] - 1 && complete) {
          (void) [sbLaTeX appendWithNSString:@"\\textotherwise{"];
          (void) [sbLaTeX appendWithNSString:[((OrgGeogebraCommonMainLocalization *) nil_chk([self getLoc])) getPlainWithNSString:@"otherwise"]];
          (void) [sbLaTeX appendWithNSString:@"}"];
        }
        else {
          (void) [sbLaTeX appendWithNSString:[((OrgGeogebraCommonKernelGeosGeoFunction_Bounds *) nil_chk([conditions getWithInt:i])) toLaTeXStringWithBoolean:!substituteNumbers withNSString:[self getVarStringWithOrgGeogebraCommonKernelStringTemplate:tpl] withOrgGeogebraCommonKernelStringTemplate:tpl]];
        }
        (void) [sbLaTeX appendWithNSString:@" } } "];
      }
      (void) [sbLaTeX appendWithNSString:@" } } "];
      ...
      (void) [sbLaTeX appendWithNSString:@"\\left\\{\\begin{array}{ll} "];
      for (jint i = 0; i < [cases size]; i++) {
        (void) [sbLaTeX appendWithNSString:[((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([cases getWithInt:i])) toLaTeXStringWithBoolean:!substituteNumbers withOrgGeogebraCommonKernelStringTemplate:tpl]];
        (void) [sbLaTeX appendWithNSString:@"& : "];
        if (i == [cases size] - 1 && complete) {
          (void) [sbLaTeX appendWithNSString:@"\\text{"];
          (void) [sbLaTeX appendWithNSString:[((OrgGeogebraCommonMainLocalization *) nil_chk([self getLoc])) getPlainWithNSString:@"otherwise"]];
          (void) [sbLaTeX appendWithNSString:@"}"];
        }
        else {
          (void) [sbLaTeX appendWithNSString:[((OrgGeogebraCommonKernelGeosGeoFunction_Bounds *) nil_chk([conditions getWithInt:i])) toLaTeXStringWithBoolean:!substituteNumbers withNSString:[self getVarStringWithOrgGeogebraCommonKernelStringTemplate:tpl] withOrgGeogebraCommonKernelStringTemplate:tpl]];
          if (i != [cases size] - 1) (void) [sbLaTeX appendWithNSString:@"\\\\ "];
        }
      }
      (void) [sbLaTeX appendWithNSString:@" \\end{array}\\right. "];
    }
  }
...
- (NSString *)conditionalMathMLWithBoolean:(jboolean)substituteNumbers
 withOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  JavaLangStringBuilder *sbMathml = new_JavaLangStringBuilder_init();
  OrgGeogebraCommonKernelArithmeticExpressionNode *expr = OrgGeogebraCommonKernelGeosGeoFunction_getFunctionExpression(self);
  if ([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(expr)) getOperation] == OrgGeogebraCommonPluginOperationEnum_get_IF() && ![((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk([expr getRight])) wrap])) isConditional]) {
    (void) [sbMathml appendWithNSString:@"<piecewise><piece>"];
    if (substituteNumbers) {
      (void) [sbMathml appendWithNSString:[((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk([expr getRight])) toValueStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_latexTemplate_()]];
      (void) [sbMathml appendWithNSString:[((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk([expr getLeft])) toValueStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_latexTemplate_()]];
    }
    else {
      (void) [sbMathml appendWithNSString:[((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk([expr getRight])) toStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_latexTemplate_()]];
      (void) [sbMathml appendWithNSString:[((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk([expr getLeft])) toStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_latexTemplate_()]];
    }
    (void) [sbMathml appendWithNSString:@"</piece></piecewise>"];
  }
  else {
    (void) [sbMathml appendWithNSString:@"<piecewise>"];
    JavaUtilArrayList *cases = new_JavaUtilArrayList_init();
    JavaUtilArrayList *conditions = new_JavaUtilArrayList_init();
    jboolean complete = OrgGeogebraCommonKernelGeosGeoFunction_collectCasesWithOrgGeogebraCommonKernelArithmeticExpressionNode_withJavaUtilArrayList_withJavaUtilArrayList_withOrgGeogebraCommonKernelGeosGeoFunction_Bounds_(self, expr, cases, conditions, new_OrgGeogebraCommonKernelGeosGeoFunction_Bounds_initWithOrgGeogebraCommonKernelGeosGeoFunction_(self));
    for (jint i = 0; i < [cases size]; i++) {
      if (i == [cases size] - 1 && complete) {
        (void) [sbMathml appendWithNSString:@"<otherwise>"];
        (void) [sbMathml appendWithNSString:[((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([cases getWithInt:i])) toLaTeXStringWithBoolean:!substituteNumbers withOrgGeogebraCommonKernelStringTemplate:tpl]];
        (void) [sbMathml appendWithNSString:@"</otherwise>"];
      }
      else {
        (void) [sbMathml appendWithNSString:@"<piece>"];
        (void) [sbMathml appendWithNSString:[((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([cases getWithInt:i])) toLaTeXStringWithBoolean:!substituteNumbers withOrgGeogebraCommonKernelStringTemplate:tpl]];
        (void) [sbMathml appendWithNSString:[((OrgGeogebraCommonKernelGeosGeoFunction_Bounds *) nil_chk([conditions getWithInt:i])) toLaTeXStringWithBoolean:!substituteNumbers withNSString:[self getVarStringWithOrgGeogebraCommonKernelStringTemplate:tpl] withOrgGeogebraCommonKernelStringTemplate:tpl]];
        (void) [sbMathml appendWithNSString:@"</piece>"];
      }
    }
    (void) [sbMathml appendWithNSString:@"</piecewise>"];
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonKernelGeosGeoFunction class]) {
    OrgGeogebraCommonKernelGeosGeoFunction_dummy1_ = [IOSObjectArray newArrayWithObjects:(id[]){ @"", @"" } count:2 type:NSString_class_()];
    OrgGeogebraCommonKernelGeosGeoFunction_dummy2_ = [IOSCharArray newArrayWithChars:(jchar[]){ ' ', ' ' } count:2];
...
void OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticFunction_(OrgGeogebraCommonKernelGeosGeoFunction *self, OrgGeogebraCommonKernelConstruction *c, NSString *label, OrgGeogebraCommonKernelArithmeticFunction *f) {
  (void) OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticFunction_(self, c, f);
  [self setLabelWithNSString:label];
  if ([self isLabelSet] && ![self isBooleanFunction] && [self isFunctionOfY]) {
    [self remove];
    @throw new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSString_([self getLoc], @"InvalidFunction");
  }
}
...
void OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelImplicitGeoImplicitPoly_withOrgGeogebraCommonKernelGeosGeoFunction_withOrgGeogebraCommonKernelGeosGeoFunction_(OrgGeogebraCommonKernelGeosGeoFunction *self, OrgGeogebraCommonKernelConstruction *c, OrgGeogebraCommonKernelImplicitGeoImplicitPoly *iPoly, OrgGeogebraCommonKernelGeosGeoFunction *f, OrgGeogebraCommonKernelGeosGeoFunction *g) {
  (void) OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_(self, c);
  self->iPoly_ = iPoly;
  self->geoFunctionType_ = OrgGeogebraCommonKernelGeosGeoFunction_FUNCTION_COMPOSITE_IPOLY_FUNCS_;
  self->substituteFunctions_ = [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonKernelGeosGeoFunction_class_()];
  (void) IOSObjectArray_Set(self->substituteFunctions_, 0, f);
  (void) IOSObjectArray_Set(self->substituteFunctions_, 1, g);
  if (f == nil && g != nil) {
    OrgGeogebraCommonKernelGeosGeoFunction_setIntervalWithDouble_withDouble_(self, g->intervalMin_, g->intervalMax_);
    self->fun_ = new_OrgGeogebraCommonKernelGeosGeoFunction_$1_initWithOrgGeogebraCommonKernelGeosGeoFunction_withOrgGeogebraCommonKernelKernel_(self, [((OrgGeogebraCommonKernelConstruction *) nil_chk(c)) getKernel]);
    ...
    self->fun_ = new_OrgGeogebraCommonKernelGeosGeoFunction_$2_initWithOrgGeogebraCommonKernelGeosGeoFunction_withOrgGeogebraCommonKernelKernel_(self, [((OrgGeogebraCommonKernelConstruction *) nil_chk(c)) getKernel]);
    [self->fun_ setExpressionWithOrgGeogebraCommonKernelArithmeticExpressionNode:new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self->kernel_, new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(c, 0))];
  }
  else if (f != nil && g != nil) {
    ...
    self->fun_ = new_OrgGeogebraCommonKernelGeosGeoFunction_$3_initWithOrgGeogebraCommonKernelGeosGeoFunction_withOrgGeogebraCommonKernelKernel_(self, [((OrgGeogebraCommonKernelConstruction *) nil_chk(c)) getKernel]);
    [self->fun_ setExpressionWithOrgGeogebraCommonKernelArithmeticExpressionNode:new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self->kernel_, new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(c, 0))];
  }
}
...
void OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelGeosGeoFunction_(OrgGeogebraCommonKernelGeosGeoFunction *self, OrgGeogebraCommonKernelGeosGeoFunction *f) {
  (void) OrgGeogebraCommonKernelGeosGeoFunction_initWithOrgGeogebraCommonKernelConstruction_(self, ((OrgGeogebraCommonKernelGeosGeoFunction *) nil_chk(f))->cons_);
...
void OrgGeogebraCommonKernelGeosGeoFunction_initStringBuilderWithJavaLangStringBuilder_withOrgGeogebraCommonKernelStringTemplate_withNSString_withNSString_withBoolean_withBoolean_(JavaLangStringBuilder *stringBuilder, OrgGeogebraCommonKernelStringTemplate *tpl, NSString *label, NSString *var, jboolean isLabelSet, jboolean isBooleanFunction) {
  ...
  if (isLabelSet) {
    (void) [stringBuilder appendWithNSString:label];
    if (isBooleanFunction && ![((OrgGeogebraCommonKernelStringTemplate *) nil_chk(tpl)) hasTypeWithOrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_GEOGEBRA_XML()]) (void) [stringBuilder appendWithNSString:@": "];
    else {
      (void) [stringBuilder appendWithNSString:@"("];
      (void) [stringBuilder appendWithNSString:var];
      (void) [stringBuilder appendWithNSString:@") = "];
    }
  }
}
      ...
      if ([((OrgGeogebraCommonPluginOperationEnum *) nil_chk([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(exp)) getOperation])) isEqual:OrgGeogebraCommonPluginOperationEnum_get_IF()]) {
        ...
        if ([((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk(inequality)) isExpressionNode]) {
          ...
          switch ([op ordinal]) {
            case OrgGeogebraCommonPluginOperation_AND_INTERVAL:
            if (self->bounds_ == nil) {
              self->bounds_ = [IOSDoubleArray newArrayWithLength:2];
            }
...
id<OrgGeogebraCommonKernelRootsRealRootFunction> OrgGeogebraCommonKernelGeosGeoFunction_getRealRootFunctionY(OrgGeogebraCommonKernelGeosGeoFunction *self) {
  return new_OrgGeogebraCommonKernelGeosGeoFunction_$5_initWithOrgGeogebraCommonKernelGeosGeoFunction_(self);
}
...
OrgGeogebraCommonKernelGeosGeoFunction *OrgGeogebraCommonKernelGeosGeoFunction_addWithOrgGeogebraCommonKernelGeosGeoFunction_withOrgGeogebraCommonKernelGeosGeoFunction_withOrgGeogebraCommonKernelGeosGeoFunction_(OrgGeogebraCommonKernelGeosGeoFunction *resultFun, OrgGeogebraCommonKernelGeosGeoFunction *fun1, OrgGeogebraCommonKernelGeosGeoFunction *fun2) {
  ...
  OrgGeogebraCommonKernelArithmeticFunctionVariable *x = new_OrgGeogebraCommonKernelArithmeticFunctionVariable_initWithOrgGeogebraCommonKernelKernel_(kernel);
...
OrgGeogebraCommonKernelArithmeticFunctionNVar *OrgGeogebraCommonKernelGeosGeoFunction_operationSymbWithOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticFunctionalNVar_withOrgGeogebraCommonKernelArithmeticFunctionalNVar_(OrgGeogebraCommonPluginOperationEnum *op, id<OrgGeogebraCommonKernelArithmeticFunctionalNVar> lt, id<OrgGeogebraCommonKernelArithmeticFunctionalNVar> rt) {
  ...
  JavaUtilTreeSet *varNames = new_JavaUtilTreeSet_init();
...
OrgGeogebraCommonKernelArithmeticFunctionNVar *OrgGeogebraCommonKernelGeosGeoFunction_fromExprWithOrgGeogebraCommonKernelArithmeticExpressionNode_withJavaUtilHashMap_withJavaUtilTreeSet_(OrgGeogebraCommonKernelArithmeticExpressionNode *sum, JavaUtilHashMap *varmap, JavaUtilTreeSet *varNames) {
  ...
  if (size > 1) {
    IOSObjectArray *varArray = [IOSObjectArray newArrayWithLength:size type:OrgGeogebraCommonKernelArithmeticFunctionVariable_class_()];
    jint i = 0;
    for (NSString * __strong name in nil_chk(varNames)) {
      (void) IOSObjectArray_Set(varArray, i, [varmap getWithId:name]);
      i++;
    }
    OrgGeogebraCommonKernelArithmeticFunctionNVar *f = new_OrgGeogebraCommonKernelArithmeticFunctionNVar_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionVariableArray_(sum, varArray);
    return f;
  }
  id<JavaUtilIterator> var = [((id<JavaUtilCollection>) nil_chk([varmap values])) iterator];
  return new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionVariable_(sum, [((id<JavaUtilIterator>) nil_chk(var)) next]);
}
...
OrgGeogebraCommonKernelArithmeticExpressionNode *OrgGeogebraCommonKernelGeosGeoFunction_toExprWithOrgGeogebraCommonKernelArithmeticFunctionalNVar_withJavaUtilHashMap_withOrgGeogebraCommonKernelKernel_(id<OrgGeogebraCommonKernelArithmeticFunctionalNVar> lt, JavaUtilHashMap *varMap, OrgGeogebraCommonKernelKernel *kernel) {
  ...
  if ([lt isKindOfClass:[OrgGeogebraCommonKernelGeosGeoFunctionNVar class]]) {
    OrgGeogebraCommonKernelArithmeticMyList *varList = new_OrgGeogebraCommonKernelArithmeticMyList_initWithOrgGeogebraCommonKernelKernel_(kernel);
...
OrgGeogebraCommonKernelArithmeticFunctionNVar *OrgGeogebraCommonKernelGeosGeoFunction_applyNumberSymbWithOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticFunctionalNVar_withOrgGeogebraCommonKernelArithmeticExpressionValue_withBoolean_(OrgGeogebraCommonPluginOperationEnum *op, id<OrgGeogebraCommonKernelArithmeticFunctionalNVar> fun1, id<OrgGeogebraCommonKernelArithmeticExpressionValue> ev, jboolean right) {
  ...
  if (right) {
    sum = new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel, myExpr, op, nv);
  }
  else {
    sum = new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel, nv, op, myExpr);
  }
  OrgGeogebraCommonKernelArithmeticFunctionNVar *f = OrgGeogebraCommonKernelGeosGeoFunction_fromExprWithOrgGeogebraCommonKernelArithmeticExpressionNode_withJavaUtilHashMap_withJavaUtilTreeSet_(sum, varmap, varNames);
  [((OrgGeogebraCommonKernelArithmeticFunctionNVar *) nil_chk(f)) initFunction];
  return f;
...
OrgGeogebraCommonKernelGeosGeoFunction *OrgGeogebraCommonKernelGeosGeoFunction_multWithOrgGeogebraCommonKernelGeosGeoFunction_withDouble_withOrgGeogebraCommonKernelGeosGeoFunction_(OrgGeogebraCommonKernelGeosGeoFunction *resultFun, jdouble number, OrgGeogebraCommonKernelGeosGeoFunction *fun) {
  ...
  OrgGeogebraCommonKernelArithmeticMyDouble *num = new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel, number);
  ...
  OrgGeogebraCommonKernelArithmeticFunctionVariable *x = new_OrgGeogebraCommonKernelArithmeticFunctionVariable_initWithOrgGeogebraCommonKernelKernel_(kernel);
  OrgGeogebraCommonKernelArithmeticExpressionNode *left = new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel, num);
  ...
  OrgGeogebraCommonKernelArithmeticFunction *f = new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionVariable_(product, x);
  [((OrgGeogebraCommonKernelGeosGeoFunction *) nil_chk(resultFun)) setFunctionWithOrgGeogebraCommonKernelArithmeticFunction:f];
  [resultFun setDefinedWithBoolean:YES];
  return resultFun;
}
...
IOSObjectArray *OrgGeogebraCommonKernelGeosGeoFunction_getTempVarCASStringWithBoolean_(OrgGeogebraCommonKernelGeosGeoFunction *self, jboolean symbolic) {
  ...
  IOSObjectArray *ret = [IOSObjectArray newArrayWithObjects:(id[]){ [self getCASStringWithOrgGeogebraCommonKernelStringTemplate:tpl withBoolean:symbolic], [self getVarStringWithOrgGeogebraCommonKernelStringTemplate:tpl] } count:2 type:NSString_class_()];
  return ret;
}
...
- (OrgGeogebraCommonKernelGeosGeoFunction_Bounds *)addRestrictionWithOrgGeogebraCommonKernelArithmeticExpressionNode:(OrgGeogebraCommonKernelArithmeticExpressionNode *)e {
  ...
  OrgGeogebraCommonKernelGeosGeoFunction_Bounds *b = new_OrgGeogebraCommonKernelGeosGeoFunction_Bounds_initWithOrgGeogebraCommonKernelGeosGeoFunction_(this$0_);
  b->lower_ = lower_;
  b->upper_ = upper_;
  b->lowerSharp_ = lowerSharp_;
  b->upperSharp_ = upperSharp_;
  b->condition_ = condition_;
  ...
  if (simple && [lt isKindOfClass:[OrgGeogebraCommonKernelArithmeticFunctionVariable class]] && [OrgGeogebraCommonKernelArithmeticNumberValue_class_() isInstance:rt] && !([rt isKindOfClass:[OrgGeogebraCommonKernelArithmeticFunctionVariable class]])) {
    ...
    if ([e getOperation] == OrgGeogebraCommonPluginOperationEnum_get_GREATER() && (lower_ == nil || [lower_ doubleValue] <= d)) {
      b->lower_ = JavaLangDouble_valueOfWithDouble_(d);
      b->lowerSharp_ = YES;
    }
      ...
      b->upper_ = JavaLangDouble_valueOfWithDouble_(d);
      b->upperSharp_ = YES;
    }
    ...
    if (condition_ == nil) b->condition_ = e;
    else b->condition_ = [condition_ and__WithOrgGeogebraCommonKernelArithmeticExpressionValue:e];
  }
  if (b->upper_ != nil && b->lower_ != nil && (b->condition_ != nil) && OrgGeogebraCommonKernelKernel_isEqualWithDouble_withDouble_([b->upper_ doubleValue], [b->lower_ doubleValue])) {
    ...
    if ([OrgGeogebraCommonKernelArithmeticBooleanValue_class_() isInstance:v] && [((id<OrgGeogebraCommonKernelArithmeticBooleanValue>) nil_chk(((id<OrgGeogebraCommonKernelArithmeticBooleanValue>) check_protocol_cast(v, @protocol(OrgGeogebraCommonKernelArithmeticBooleanValue))))) getBoolean]) b->condition_ = nil;
  }
  if (b->condition_ != nil && [b->condition_ getOperation] == OrgGeogebraCommonPluginOperationEnum_get_NOT_EQUAL()) {
    if ([[b->condition_ getLeft] isKindOfClass:[OrgGeogebraCommonKernelArithmeticFunctionVariable class]] && [[b->condition_ getRight] isKindOfClass:[OrgGeogebraCommonKernelArithmeticMyDouble class]]) {
      ...
      if ((b->lower_ != nil && d < [b->lower_ doubleValue]) || (b->upper_ != nil && d > [b->upper_ doubleValue])) b->condition_ = nil;
    }
...
withOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  ...
  if ([((OrgGeogebraCommonKernelStringTemplate *) nil_chk(tpl)) hasTypeWithOrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_StringTypeEnum_get_LATEX()]) {
    if (upper_ == nil && lower_ != nil) {
      (void) [ret appendWithNSString:varString];
      (void) [ret appendWithNSString:@" "];
      (void) [ret appendWithId:lowerSharp_ ? @">" : JavaLangCharacter_valueOfWithChar_(OrgGeogebraCommonUtilUnicode_GREATER_EQUAL)];
      (void) [ret appendWithNSString:@" "];
      (void) [ret appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(this$0_->kernel_)) formatWithDouble:[lower_ doubleValue] withOrgGeogebraCommonKernelStringTemplate:tpl]];
    }
    else if (lower_ == nil && upper_ != nil) {
      (void) [ret appendWithNSString:varString];
      (void) [ret appendWithNSString:@" "];
      (void) [ret appendWithId:upperSharp_ ? @"<" : JavaLangCharacter_valueOfWithChar_(OrgGeogebraCommonUtilUnicode_LESS_EQUAL)];
      (void) [ret appendWithNSString:@" "];
      (void) [ret appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(this$0_->kernel_)) formatWithDouble:[upper_ doubleValue] withOrgGeogebraCommonKernelStringTemplate:tpl]];
    }
    else if (lower_ != nil && upper_ != nil) {
      if (OrgGeogebraCommonKernelKernel_isEqualWithDouble_withDouble_([lower_ doubleValue], [upper_ doubleValue]) && !lowerSharp_ && !upperSharp_) {
        ...
        (void) [ret appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(this$0_->kernel_)) formatWithDouble:[lower_ doubleValue] withOrgGeogebraCommonKernelStringTemplate:tpl]];
        (void) [ret appendWithNSString:@" "];
        (void) [ret appendWithId:lowerSharp_ ? @"<" : JavaLangCharacter_valueOfWithChar_(OrgGeogebraCommonUtilUnicode_LESS_EQUAL)];
        (void) [ret appendWithNSString:@" "];
        (void) [ret appendWithNSString:varString];
        (void) [ret appendWithNSString:@" "];
        (void) [ret appendWithId:upperSharp_ ? @"<" : JavaLangCharacter_valueOfWithChar_(OrgGeogebraCommonUtilUnicode_LESS_EQUAL)];
        (void) [ret appendWithNSString:@" "];
        (void) [ret appendWithNSString:[this$0_->kernel_ formatWithDouble:[upper_ doubleValue] withOrgGeogebraCommonKernelStringTemplate:tpl]];
      }
    }
    ...
    if (condition_ != nil) {
      (void) [ret insertWithInt:0 withNSString:@"("];
      (void) [ret appendWithNSString:@")\\wedge \\left("];
      (void) [ret appendWithNSString:[condition_ toLaTeXStringWithBoolean:symbolic withOrgGeogebraCommonKernelStringTemplate:tpl]];
      (void) [ret appendWithNSString:@"\\right)"];
    }
  }
  else {
    if (upper_ == nil && lower_ != nil) {
      (void) [ret appendWithNSString:@"<apply>"];
      (void) [ret appendWithNSString:lowerSharp_ ? @"<gt/>" : @"<geq/>"];
      (void) [ret appendWithNSString:@"<ci>"];
      (void) [ret appendWithNSString:varString];
      (void) [ret appendWithNSString:@"</ci><cn>"];
      (void) [ret appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(this$0_->kernel_)) formatWithDouble:[lower_ doubleValue] withOrgGeogebraCommonKernelStringTemplate:tpl]];
      (void) [ret appendWithNSString:@"</cn></apply>"];
    }
    else if (lower_ == nil && upper_ != nil) {
      (void) [ret appendWithNSString:@"<apply>"];
      (void) [ret appendWithNSString:upperSharp_ ? @"<lt/>" : @"<leq/>"];
      (void) [ret appendWithNSString:@"<ci>"];
      (void) [ret appendWithNSString:varString];
      (void) [ret appendWithNSString:@"</ci><cn>"];
      (void) [ret appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(this$0_->kernel_)) formatWithDouble:[upper_ doubleValue] withOrgGeogebraCommonKernelStringTemplate:tpl]];
      ...
      if (OrgGeogebraCommonKernelKernel_isEqualWithDouble_withDouble_([lower_ doubleValue], [upper_ doubleValue]) && !lowerSharp_ && !upperSharp_) {
        (void) [ret appendWithNSString:@"<apply>"];
        (void) [ret appendWithNSString:@"<eq/>"];
        (void) [ret appendWithNSString:@"<ci>"];
        (void) [ret appendWithNSString:varString];
        (void) [ret appendWithNSString:@"</ci><cn>"];
        (void) [ret appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(this$0_->kernel_)) formatWithDouble:[lower_ doubleValue] withOrgGeogebraCommonKernelStringTemplate:tpl]];
        ...
        if (lowerSharp_ == upperSharp_) {
          (void) [ret appendWithNSString:@"<apply>"];
          (void) [ret appendWithNSString:lowerSharp_ ? @"<lt/>" : @"<leq/>"];
          (void) [ret appendWithNSString:@"<cn>"];
          (void) [ret appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(this$0_->kernel_)) formatWithDouble:[lower_ doubleValue] withOrgGeogebraCommonKernelStringTemplate:tpl]];
          (void) [ret appendWithNSString:@"</cn>"];
          (void) [ret appendWithNSString:@"<ci>"];
          (void) [ret appendWithNSString:varString];
          ...
          (void) [ret appendWithNSString:@"<apply>"];
          (void) [ret appendWithNSString:@"<and/>"];
          (void) [ret appendWithNSString:@"<apply>"];
          (void) [ret appendWithNSString:lowerSharp_ ? @"<lt/>" : @"<leq/>"];
          (void) [ret appendWithNSString:@"<cn>"];
          (void) [ret appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(this$0_->kernel_)) formatWithDouble:[lower_ doubleValue] withOrgGeogebraCommonKernelStringTemplate:tpl]];
    ...
    if (condition_ != nil) {
      (void) [ret insertWithInt:0 withNSString:@"<apply><and/>"];
      (void) [ret appendWithNSString:[condition_ toLaTeXStringWithBoolean:symbolic withOrgGeogebraCommonKernelStringTemplate:tpl]];
      (void) [ret appendWithNSString:@"</apply>"];
    }
  }
...
void OrgGeogebraCommonKernelGeosGeoFunction_$1_initWithOrgGeogebraCommonKernelGeosGeoFunction_withOrgGeogebraCommonKernelKernel_(OrgGeogebraCommonKernelGeosGeoFunction_$1 *self, OrgGeogebraCommonKernelGeosGeoFunction *outer$, OrgGeogebraCommonKernelKernel *arg$0) {
  self->this$0_ = outer$;
  (void) OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelKernel_(self, arg$0);
}
