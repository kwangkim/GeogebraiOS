...
- (IOSObjectArray *)processWithOrgGeogebraCommonKernelArithmeticCommand:(OrgGeogebraCommonKernelArithmeticCommand *)c {
  ...
  IOSObjectArray *arg;
  {
    ...
    switch (n) {
      ...
      tb = nil;
      tc = nil;
      arg = [IOSObjectArray newArrayWithLength:4 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
      for (jint i = 0; i < 3; i++) (void) IOSObjectArray_Set(arg, i, OrgGeogebraCommonKernelBarycentricCmdTriangleCurve_resArgWithOrgGeogebraCommonKernelArithmeticCommand_withInt_(self, c, i));
      ta = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(cons_);
      tb = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(cons_);
      tc = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(cons_);
