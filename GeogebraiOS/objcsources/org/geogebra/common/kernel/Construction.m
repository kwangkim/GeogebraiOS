...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/kernel/Construction.java
//
...
- (void)newConstructionDefaults {
  consDefaults_ = new_OrgGeogebraCommonKernelConstructionDefaults_initWithOrgGeogebraCommonKernelConstruction_(self);
}
...
- (OrgGeogebraCommonKernelGeosGeoPoint *)getOrigin {
  if (origin_ == nil) {
    origin_ = new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(self);
...
- (void)initAxis {
  xAxis_ = new_OrgGeogebraCommonKernelGeosGeoAxis_initWithOrgGeogebraCommonKernelConstruction_withInt_(self, OrgGeogebraCommonKernelKernelNDGeoAxisND_X_AXIS);
  yAxis_ = new_OrgGeogebraCommonKernelGeosGeoAxis_initWithOrgGeogebraCommonKernelConstruction_withInt_(self, OrgGeogebraCommonKernelKernelNDGeoAxisND_Y_AXIS);
}
...
- (void)updateLocalAxesNames {
  (void) [((JavaUtilHashMap *) nil_chk(geoTable_)) removeWithId:xAxisLocalName_];
  (void) [geoTable_ removeWithId:yAxisLocalName_];
  OrgGeogebraCommonMainApp *app = [((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) getApplication];
  xAxisLocalName_ = [((OrgGeogebraCommonMainApp *) nil_chk(app)) getPlainWithNSString:@"xAxis"];
  yAxisLocalName_ = [app getPlainWithNSString:@"yAxis"];
  (void) [geoTable_ putWithId:xAxisLocalName_ withId:xAxis_];
  (void) [geoTable_ putWithId:yAxisLocalName_ withId:yAxis_];
}
...
- (void)setWorksheetTextWithNSString:(NSString *)text
                             withInt:(jint)i {
  (void) IOSObjectArray_Set(nil_chk(worksheetText_), i, text);
}
...
withOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  if (localVariableTable_ == nil) localVariableTable_ = new_JavaUtilHashMap_init();
  (void) [((JavaUtilHashMap *) nil_chk(localVariableTable_)) putWithId:varname withId:geo];
...
- (jboolean)moveInConstructionListWithInt:(jint)fromIndex
  ...
  if (change) {
    ...
    (void) [ceList_ removeWithInt:fromIndex];
...
- (jboolean)notifyEuclidianViewCEWithBoolean:(jboolean)onlyCorner5 {
  ...
  for (jint i = 0; i < size; i++) {
    ...
    if (needsUpdateCascade) {
      if (updateSet == nil) updateSet = new_OrgGeogebraCommonKernelAlgosAlgorithmSet_init();
...
- (void)addRandomGeoWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)num {
  if (randomElements_ == nil) randomElements_ = new_JavaUtilTreeSet_init();
...
- (void)updateConstruction {
  ...
  @try {
    ...
    JavaUtilArrayList *tempList = new_JavaUtilArrayList_initWithJavaUtilCollection_(algoList_);
    for (jint i = 0; i < size; ++i) {
...
- (void)getConstructionRegressionOutWithJavaLangStringBuilder:(JavaLangStringBuilder *)sb {
  ...
  @try {
    ...
    for (jint i = 0; i < size; ++i) {
      ce = [ceList_ getWithInt:i];
      (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:JreStrcat("$$", [((OrgGeogebraCommonKernelAlgosConstructionElement *) nil_chk(ce)) getNameDescription], @" = ")];
      if ([ce isKindOfClass:[OrgGeogebraCommonKernelGeosGeoElement class]]) {
        ...
        (void) [sb appendWithNSString:[((OrgGeogebraCommonKernelAlgosAlgoElement *) check_class_cast(ce, [OrgGeogebraCommonKernelAlgosAlgoElement class])) getCommandDescriptionWithOrgGeogebraCommonKernelStringTemplate:tpl]];
        (void) [sb appendWithNSString:@" == "];
        (void) [sb appendWithNSString:[((OrgGeogebraCommonKernelAlgosAlgoElement *) check_class_cast(ce, [OrgGeogebraCommonKernelAlgosAlgoElement class])) getAlgebraDescriptionRegrOutWithOrgGeogebraCommonKernelStringTemplate:tpl]];
      }
      (void) [sb appendWithNSString:@"\n"];
    }
  }
  @catch (JavaLangException *e) {
    (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:[((JavaLangException *) nil_chk(e)) getMessage]];
  }
}
...
- (void)startCollectingRedefineCalls {
  ...
  if (redefineMap_ == nil) redefineMap_ = new_JavaUtilHashMap_init();
...
- (void)replaceWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)oldGeo
  ...
  if ([((NSString *) nil_chk([oldGeo getCommandDescriptionWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_maxPrecision_()])) isEqual:[((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(newGeo)) getCommandDescriptionWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_maxPrecision_()]] && [oldGeo getParentAlgorithm] != nil) {
    JavaUtilArrayList *ae = new_JavaUtilArrayList_init();
  ...
  if (collectRedefineCalls_) {
    (void) [((JavaUtilHashMap *) nil_chk(redefineMap_)) putWithId:oldGeo withId:newGeo];
    return;
  }
  OrgGeogebraCommonMainApp *app = [((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) getApplication];
...
- (JavaLangStringBuilder *)doReplaceInXMLWithJavaLangStringBuilder:(JavaLangStringBuilder *)consXML
  ...
  if (pos < 0) {
    ...
    @throw new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSString_([((OrgGeogebraCommonMainApp *) nil_chk([self getApplication])) getLocalization], @"ReplaceFailed");
  }
  jint inputEndPos = -1;
  ...
  if (pos >= inputEndPos) {
    (void) [consXML replaceWithInt:pos withInt:pos + ((jint) [((NSString *) nil_chk(oldXML)) length]) withNSString:newXML];
  }
  else {
    (void) [consXML insertWithInt:inputEndPos withNSString:newXML];
    (void) [consXML replaceWithInt:pos withInt:pos + ((jint) [((NSString *) nil_chk(oldXML)) length]) withNSString:@""];
  }
  return consXML;
}
...
- (void)putLabelWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  ...
  (void) [((JavaUtilHashMap *) nil_chk(geoTable_)) putWithId:[((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(geo)) getLabelSimple] withId:geo];
...
- (void)removeLabelWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  (void) [((JavaUtilHashMap *) nil_chk(geoTable_)) removeWithId:[((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(geo)) getLabelSimple]];
...
- (void)putCasCellLabelWithOrgGeogebraCommonKernelGeosGeoCasCell:(OrgGeogebraCommonKernelGeosGeoCasCell *)geoCasCell
  ...
  if (label == nil) return;
  if (geoCasCellTable_ == nil) geoCasCellTable_ = new_JavaUtilHashMap_init();
  (void) [((JavaUtilHashMap *) nil_chk(geoCasCellTable_)) putWithId:label withId:geoCasCell];
}

- (void)removeCasCellLabelWithNSString:(NSString *)variable {
  if (geoCasCellTable_ != nil) {
    (void) [geoCasCellTable_ removeWithId:variable];
  }
}
...
- (jboolean)updateConstructionOrderWithOrgGeogebraCommonKernelGeosGeoCasCell:(OrgGeogebraCommonKernelGeosGeoCasCell *)casCell {
  JavaUtilTreeSet *allPred = new_JavaUtilTreeSet_init();
...
- (OrgGeogebraCommonKernelGeosGeoElement *)createSpreadsheetGeoElementWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)neighbourCell
  ...
  if (neighbourCell != nil) {
    ...
    result = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(self);
  }
...
- (NSString *)getIndexLabelWithNSString:(NSString *)prefix
  ...
  JavaLangStringBuilder *sbIndexLabel = new_JavaLangStringBuilder_init();
  jint n = startIndex;
  do {
    [sbIndexLabel setLengthWithInt:0];
    (void) [sbIndexLabel appendWithNSString:pref];
    if (n < 10) {
      (void) [sbIndexLabel appendWithChar:'_'];
      (void) [sbIndexLabel appendWithInt:n];
    }
    else {
      (void) [sbIndexLabel appendWithNSString:@"_{"];
      (void) [sbIndexLabel appendWithInt:n];
      (void) [sbIndexLabel appendWithChar:'}'];
    }
    n++;
  }
...
- (OrgGeogebraCommonKernelGeosGeoElement *)autoCreateGeoElementWithNSString:(NSString *)labelNew {
  ...
  if (length == 3 && [label charAtWithInt:2] == '\'') {
    ...
    if ([label isEqual:@"O"]) {
      createdGeo = new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withDouble_withDouble_withDouble_(self, 0.0, 0.0, 1.0);
      label = @"O";
      auxilliary = YES;
      fix = YES;
    }
...
- (void)initGeoTables {
  ...
  geoCasCellTable_ = nil;
  localVariableTable_ = nil;
  [((id<JavaUtilMap>) nil_chk(constsM_)) clear];
  [((id<JavaUtilMap>) nil_chk(complexNumbersM_)) clear];
  [((id<JavaUtilMap>) nil_chk(intsM_)) clear];
  (void) [geoTable_ putWithId:@"xAxis" withId:xAxis_];
  (void) [geoTable_ putWithId:@"yAxis" withId:yAxis_];
...
- (JavaUtilTreeSet *)getGeoSetNameDescriptionOrder {
  JavaUtilTreeSet *sortedSet = new_JavaUtilTreeSet_initWithJavaUtilComparator_(new_OrgGeogebraCommonKernelNameDescriptionComparator_init());
...
- (void)addUsedMacroWithOrgGeogebraCommonKernelMacro:(OrgGeogebraCommonKernelMacro *)macro {
  if (usedMacros_ == nil) usedMacros_ = new_JavaUtilArrayList_init();
...
- (void)clearConstruction {
  ...
  author_ = nil;
  date_ = nil;
  (void) IOSObjectArray_Set(nil_chk(worksheetText_), 0, nil);
  (void) IOSObjectArray_Set(worksheetText_, 1, nil);
  usedMacros_ = nil;
...
- (OrgGeogebraCommonIoMyXMLio *)getXMLio {
  if (xmlio_ == nil) xmlio_ = [((OrgGeogebraCommonMainApp *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) getApplication])) createXMLioWithOrgGeogebraCommonKernelConstruction:self];
  return xmlio_;
}
...
- (void)setOutputGeoWithNSString:(NSString *)type {
  ...
  self->outputGeo_ = [((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) createGeoElementWithOrgGeogebraCommonKernelConstruction:self withNSString:type];
}

- (OrgGeogebraCommonKernelGeosGeoElement *)getOutputGeo {
  return outputGeo_ == nil ? new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_(self) : outputGeo_;
}
...
- (void)setAlgoSetCurrentlyUpdatedWithOrgGeogebraCommonKernelAlgosAlgorithmSet:(OrgGeogebraCommonKernelAlgosAlgorithmSet *)algoSetCurrentlyUpdated {
  self->algoSetCurrentlyUpdated_ = algoSetCurrentlyUpdated;
}
...
- (id<JavaUtilSet>)getAllGeoLabels {
  return new_JavaUtilHashSet_initWithJavaUtilCollection_([((JavaUtilHashMap *) nil_chk(geoTable_)) keySet]);
}

- (id<JavaUtilSet>)getAllLabels {
  id<JavaUtilSet> ret = new_JavaUtilHashSet_initWithJavaUtilCollection_([self getAllGeoLabels]);
  if (geoCasCellTable_ != nil) {
...
- (void)updateConstructionLaTeX {
  ...
  [((OrgGeogebraCommonMainApp *) nil_chk([self->kernel_ getApplication])) setBlockUpdateScriptsWithBoolean:YES];
  if (latexGeos_ != nil) {
    OrgGeogebraCommonKernelGeosGeoElement_updateCascadeWithJavaUtilArrayList_withJavaUtilTreeSet_withBoolean_(latexGeos_, new_JavaUtilTreeSet_init(), YES);
  }
  self->latexGeos_ = nil;
  [((OrgGeogebraCommonMainApp *) nil_chk([self->kernel_ getApplication])) setBlockUpdateScriptsWithBoolean:oldFlag];
}
...
- (void)registerCorner5WithOrgGeogebraCommonKernelEuclidianViewCE:(id<OrgGeogebraCommonKernelEuclidianViewCE>)algo {
  if (self->corner5Algos_ == nil) {
    self->corner5Algos_ = new_JavaUtilArrayList_init();
  }
  [((JavaUtilArrayList *) nil_chk(self->corner5Algos_)) addWithId:algo];
}

- (IOSObjectArray *)getRegisteredFunctionVariables {
  IOSObjectArray *varNames = [IOSObjectArray newArrayWithLength:[((JavaUtilTreeSet *) nil_chk(self->registredFV_)) size] type:NSString_class_()];
  id<JavaUtilIterator> it = [self->registredFV_ iterator];
  jint i = 0;
  while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
    (void) IOSObjectArray_Set(varNames, i++, [it next]);
  }
  return varNames;
}
...
- (void)addLaTeXGeoWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  if (latexGeos_ == nil) {
    latexGeos_ = new_JavaUtilArrayList_init();
  }
...
void OrgGeogebraCommonKernelConstruction_initWithOrgGeogebraCommonKernelKernel_(OrgGeogebraCommonKernelConstruction *self, OrgGeogebraCommonKernelKernel *k) {
  (void) OrgGeogebraCommonKernelConstruction_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelConstruction_(self, k, nil);
}
...
void OrgGeogebraCommonKernelConstruction_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonKernelConstruction *self, OrgGeogebraCommonKernelKernel *k, OrgGeogebraCommonKernelConstruction *parentConstruction) {
  ...
  self->constsM_ = new_JavaUtilTreeMap_init();
  self->intsM_ = new_JavaUtilTreeMap_init();
  self->complexNumbersM_ = new_JavaUtilTreeMap_init();
  self->usedGeos_ = new_JavaUtilTreeSet_init();
  self->worksheetText_ = [IOSObjectArray newArrayWithLength:2 type:NSString_class_()];
  self->supressLabelCreation_ = NO;
  self->collectRedefineCalls_ = NO;
  self->undoEnabled_ = YES;
  self->isRemovingGeoToReplaceIt__ = NO;
  self->registredFV_ = new_JavaUtilTreeSet_init();
  self->casDummies_ = new_JavaUtilTreeSet_init();
  self->allowUnboundedAngles_ = YES;
  self->casAlgos_ = new_JavaUtilArrayList_init();
  self->kernel_ = k;
  self->ceList_ = new_JavaUtilArrayList_init();
  self->algoList_ = new_JavaUtilArrayList_init();
  self->step_ = -1;
  self->geoSetConsOrder_ = new_JavaUtilTreeSet_init();
  self->geoSetWithCasCells_ = new_JavaUtilTreeSet_init();
  self->geoSetLabelOrder_ = new_JavaUtilTreeSet_initWithJavaUtilComparator_(new_OrgGeogebraCommonKernelConstruction_LabelComparator_initWithOrgGeogebraCommonKernelConstruction_(self));
  self->geoSetsTypeMap_ = new_JavaUtilHashMap_init();
  self->euclidianViewCE_ = new_JavaUtilArrayList_init();
  if (parentConstruction != nil) self->consDefaults_ = OrgGeogebraCommonKernelConstruction_getConstructionDefaults(parentConstruction);
  else [self newConstructionDefaults];
  [self initAxis];
  self->geoTable_ = new_JavaUtilHashMap_initWithInt_(200);
  [self initGeoTables];
}
...
jboolean OrgGeogebraCommonKernelConstruction_updateAllConstructionProtocolAlgorithms(OrgGeogebraCommonKernelConstruction *self) {
  ...
  for (jint i = 0; i < size; ++i) {
    ...
    if ([((OrgGeogebraCommonKernelAlgosAlgoElement *) nil_chk(algo)) wantsConstructionProtocolUpdate]) {
      if (updateAlgos == nil) updateAlgos = new_JavaUtilArrayList_init();
...
JavaUtilTreeSet *OrgGeogebraCommonKernelConstruction_createTypeSetWithOrgGeogebraCommonPluginGeoClassEnum_(OrgGeogebraCommonKernelConstruction *self, OrgGeogebraCommonPluginGeoClassEnum *type) {
  JavaUtilTreeSet *typeSet = new_JavaUtilTreeSet_initWithJavaUtilComparator_(new_OrgGeogebraCommonKernelConstruction_LabelComparator_initWithOrgGeogebraCommonKernelConstruction_(self));
  (void) [((JavaUtilHashMap *) nil_chk(self->geoSetsTypeMap_)) putWithId:type withId:typeSet];
  return typeSet;
}
...
OrgGeogebraCommonKernelGeosGeoElement *OrgGeogebraCommonKernelConstruction_distanceOrProductWithNSString_withNSString_(OrgGeogebraCommonKernelConstruction *self, NSString *string, NSString *string2) {
  ...
  if (geo1 != nil && [geo1 isGeoPoint]) {
    ...
    if (geo2 != nil && [OrgGeogebraCommonKernelArithmeticNumberValue_class_() isInstance:geo2]) {
      ...
      OrgGeogebraCommonKernelAlgosAlgoDependentNumber *algo = new_OrgGeogebraCommonKernelAlgosAlgoDependentNumber_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticExpressionNode_withBoolean_(self, nil, node, NO);
...
void OrgGeogebraCommonKernelConstruction_buildConstructionWithJavaLangStringBuilder_(OrgGeogebraCommonKernelConstruction *self, JavaLangStringBuilder *consXML) {
  @try {
    if (self->undoManager_ == nil) self->undoManager_ = [((OrgGeogebraCommonMainApp *) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) getApplication])) getUndoManagerWithOrgGeogebraCommonKernelConstruction:self];
