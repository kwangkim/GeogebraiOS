...
void OrgGeogebraCommonKernelParametricCurveDistanceFunction_initWithOrgGeogebraCommonKernelGeosParametricCurve_(OrgGeogebraCommonKernelParametricCurveDistanceFunction *self, id<OrgGeogebraCommonKernelGeosParametricCurve> curve) {
  NSObject_init(self);
  OrgGeogebraCommonKernelParametricCurveDistanceFunction_set_funX_(self, [((id<OrgGeogebraCommonKernelGeosParametricCurve>) nil_chk(curve)) getRealRootFunctionX]);
  OrgGeogebraCommonKernelParametricCurveDistanceFunction_set_funY_(self, [curve getRealRootFunctionY]);
}
