...
void OrgGeogebraCommonKernelRelation_showRelationWithOrgGeogebraCommonMainApp_withOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoElement_(OrgGeogebraCommonMainApp *app, OrgGeogebraCommonKernelGeosGeoElement *ra, OrgGeogebraCommonKernelGeosGeoElement *rb) {
  ...
  @try {
    (void) [((id<OrgGeogebraCommonKernelCASGenericInterface>) nil_chk([((OrgGeogebraCommonCasGeoGebraCAS *) nil_chk(cas)) getCurrentCAS])) evaluateRawWithNSString:@"1"];
  }
  ...
  id<JavaUtilSortedSet> relInfosAll = OrgGeogebraCommonKernelRelationNumerical_sortAlphabeticallyWithJavaUtilSet_([new_OrgGeogebraCommonKernelRelationNumerical_initWithOrgGeogebraCommonKernelKernel_([app getKernel]) relationWithOrgGeogebraCommonKernelGeosGeoElement:ra withOrgGeogebraCommonKernelGeosGeoElement:rb]);
  id<JavaUtilIterator> it = [((id<JavaUtilSortedSet>) nil_chk(relInfosAll)) iterator];
  jint rels = [relInfosAll size];
  IOSObjectArray *relInfos = [IOSObjectArray newArrayWithLength:rels type:NSString_class_()];
  IOSObjectArray *relAlgos = [IOSObjectArray newArrayWithLength:rels type:OrgGeogebraCommonKernelRelationNumerical_Report_RelationCommandEnum_class_()];
  IOSObjectArray *relBools = [IOSObjectArray newArrayWithLength:rels type:JavaLangBoolean_class_()];
  jint i = 0;
  while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
    OrgGeogebraCommonKernelRelationNumerical_Report *r = [it next];
    (void) IOSObjectArray_Set(relInfos, i, ((OrgGeogebraCommonKernelRelationNumerical_Report *) nil_chk(r))->stringResult_);
    (void) IOSObjectArray_Set(relAlgos, i, r->symbolicCheck_);
    (void) IOSObjectArray_Set(relBools, i, r->boolResult_);
    i++;
  }
  IOSObjectArray *rr = [IOSObjectArray newArrayWithLength:rels type:OrgGeogebraCommonJavaxSwingRelationPane_RelationRow_class_()];
  for (i = 0; i < rels; i++) {
    (void) IOSObjectArray_Set(rr, i, new_OrgGeogebraCommonJavaxSwingRelationPane_RelationRow_init());
    NSString *relInfo = [((NSString *) nil_chk(IOSObjectArray_Get(relInfos, i))) replace:@"\n" withSequence:@"<br>"];
    ((OrgGeogebraCommonJavaxSwingRelationPane_RelationRow *) nil_chk(IOSObjectArray_Get(rr, i)))->info_ = JreStrcat("$$$$$", @"<html>", relInfo, @"<br>", [app getPlainWithNSString:@"CheckedNumerically"], @"</html>");
    OrgGeogebraCommonKernelRelationNumerical_Report_RelationCommandEnum *relAlgo = IOSObjectArray_Get(relAlgos, i);
    id<OrgGeogebraCommonGuiUtilRelationMore> rm = new_OrgGeogebraCommonKernelRelation_$1_initWithOrgGeogebraCommonMainApp_withOrgGeogebraCommonKernelRelationNumerical_Report_RelationCommandEnum_withOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoElement_withNSString_(app, relAlgo, ra, rb, relInfo);
    if (IOSObjectArray_Get(relBools, i) != nil && [((JavaLangBoolean *) nil_chk(IOSObjectArray_Get(relBools, i))) booleanValue] && IOSObjectArray_Get(relAlgos, i) != nil) {
      ((OrgGeogebraCommonJavaxSwingRelationPane_RelationRow *) nil_chk(IOSObjectArray_Get(rr, i)))->callback_ = rm;
    }
  }
...
JavaLangBoolean *OrgGeogebraCommonKernelRelation_checkGenerallyWithOrgGeogebraCommonKernelRelationNumerical_Report_RelationCommandEnum_withOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoElement_(OrgGeogebraCommonKernelRelationNumerical_Report_RelationCommandEnum *command, OrgGeogebraCommonKernelGeosGeoElement *g1, OrgGeogebraCommonKernelGeosGeoElement *g2) {
  ...
  OrgGeogebraCommonKernelGeosGeoElement *root = new_OrgGeogebraCommonKernelGeosGeoBoolean_initWithOrgGeogebraCommonKernelConstruction_(cons);
  ...
  @try {
    switch ([command ordinal]) {
      ...
      ae = new_OrgGeogebraCommonKernelProverAlgoAreEqual_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoElement_(cons, nil, g1, g2);
      break;
      case OrgGeogebraCommonKernelRelationNumerical_Report_RelationCommand_AreParallel:
      ae = new_OrgGeogebraCommonKernelProverAlgoAreParallel_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoElement_(cons, nil, g1, g2);
      break;
      case OrgGeogebraCommonKernelRelationNumerical_Report_RelationCommand_ArePerpendicular:
      ae = new_OrgGeogebraCommonKernelProverAlgoArePerpendicular_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoElement_(cons, nil, g1, g2);
      break;
  ...
  OrgGeogebraCommonKernelProverAlgoProve *ap = new_OrgGeogebraCommonKernelProverAlgoProve_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoElement_(cons, nil, root);
  [ap compute];
...
IOSObjectArray *OrgGeogebraCommonKernelRelation_getNDGConditionsWithOrgGeogebraCommonKernelRelationNumerical_Report_RelationCommandEnum_withOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoElement_(OrgGeogebraCommonKernelRelationNumerical_Report_RelationCommandEnum *command, OrgGeogebraCommonKernelGeosGeoElement *g1, OrgGeogebraCommonKernelGeosGeoElement *g2) {
  ...
  @catch (JavaLangException *ex) {
    ret = [IOSObjectArray newArrayWithLength:1 type:NSString_class_()];
  ...
  [root setParentAlgorithmWithOrgGeogebraCommonKernelAlgosAlgoElement:ae];
  OrgGeogebraCommonKernelProverAlgoProveDetails *ap = new_OrgGeogebraCommonKernelProverAlgoProveDetails_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoElement_withBoolean_(cons, nil, root, YES);
  [ap compute];
  IOSObjectArray *o = [ap getOutput];
  ...
  if ([((OrgGeogebraCommonKernelGeosGeoList *) nil_chk(list)) size] >= 2) {
    ...
    ret = [IOSObjectArray newArrayWithLength:condsSize + 1 type:NSString_class_()];
    for (jint i = 0; i < condsSize; ++i) {
      NSString *cond = [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk([conds getWithInt:i])) description];
      (void) IOSObjectArray_Set(ret, i + 1, [cond substring:1 endIndex:((jint) [((NSString *) nil_chk(cond)) length]) - 1]);
    }
  }
  else {
    ret = [IOSObjectArray newArrayWithLength:1 type:NSString_class_()];
  ...
  if ([list size] != 0) {
    ...
    if (ans == nil) {
      (void) IOSObjectArray_Set(nil_chk(ret), 0, @"");
    }
    else if ([ans booleanValue]) {
      (void) IOSObjectArray_Set(nil_chk(ret), 0, @"1");
    }
    else {
      (void) IOSObjectArray_Set(nil_chk(ret), 0, @"0");
    }
  }
  else {
    (void) IOSObjectArray_Set(nil_chk(ret), 0, @"");
...
- (void)actionWithOrgGeogebraCommonJavaxSwingRelationPane:(id<OrgGeogebraCommonJavaxSwingRelationPane>)table
                                                  withInt:(jint)row {
  OrgGeogebraCommonJavaxSwingRelationPane_RelationRow *rel = new_OrgGeogebraCommonJavaxSwingRelationPane_RelationRow_init();
  ...
  if (result != nil && ![result booleanValue]) {
    rel->info_ = JreStrcat("$$", rel->info_, JreStrcat("$$$$", val$relInfo_, @"<br><b>", [val$app_ getPlainWithNSString:@"ButNotGenerallyTrue"], @"</b>"));
    ...
    if (((IOSObjectArray *) nil_chk(ndgResult))->size_ == 1) {
      rel->info_ = JreStrcat("$$", rel->info_, JreStrcat("$$", val$relInfo_, @"<br><b>"));
      if ([@"" isEqual:IOSObjectArray_Get(ndgResult, 0)]) {
        if (result != nil && [result booleanValue]) {
          rel->info_ = JreStrcat("$$", rel->info_, [val$app_ getPlainWithNSString:@"GenerallyTrue"]);
        }
        else {
          rel->info_ = JreStrcat("$$", rel->info_, [val$app_ getPlainWithNSString:@"PossiblyGenerallyTrue"]);
        }
      }
      else if ([@"1" isEqual:IOSObjectArray_Get(ndgResult, 0)]) {
        rel->info_ = JreStrcat("$$", rel->info_, [val$app_ getPlainWithNSString:@"AlwaysTrue"]);
      }
      else {
        OrgGeogebraCommonMainApp_errorWithNSString_(@"Internal error in prover: Prove==true <-> ProveDetails==false");
        rel->info_ = JreStrcat("$$", rel->info_, [val$app_ getPlainWithNSString:@"ButNotGenerallyTrue"]);
      }
      rel->info_ = JreStrcat("$$", rel->info_, @"</b>");
    }
    else {
      jint ndgs = ndgResult->size_;
      if ((ndgs == 2) && ([@"..." isEqual:IOSObjectArray_Get(ndgResult, 1)])) {
        rel->info_ = JreStrcat("$$", rel->info_, [loc getPlainWithNSString:@"UnderCertainConditionsA" withNSString:JreStrcat("$$C$$", @"<ul><li ", liStyle, '>', val$relInfo_, @"</ul>")]);
      }
      else {
        NSString *conds = @"<ul>";
        ...
        rel->info_ = JreStrcat("$$", rel->info_, [loc getPlainWithNSString:@"GenerallyTrueAcondB" withNSString:JreStrcat("$$C$$", @"<ul><li ", liStyle, '>', val$relInfo_, @"</ul>") withNSString:conds]);
      }
    }
  }
  rel->info_ = JreStrcat("$$", rel->info_, @"</html>");
  rel->callback_ = nil;
...
void OrgGeogebraCommonKernelRelation_$1_initWithOrgGeogebraCommonMainApp_withOrgGeogebraCommonKernelRelationNumerical_Report_RelationCommandEnum_withOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoElement_withNSString_(OrgGeogebraCommonKernelRelation_$1 *self, OrgGeogebraCommonMainApp *capture$0, OrgGeogebraCommonKernelRelationNumerical_Report_RelationCommandEnum *capture$1, OrgGeogebraCommonKernelGeosGeoElement *capture$2, OrgGeogebraCommonKernelGeosGeoElement *capture$3, NSString *capture$4) {
  self->val$app_ = capture$0;
  self->val$relAlgo_ = capture$1;
  self->val$ra_ = capture$2;
  self->val$rb_ = capture$3;
  self->val$relInfo_ = capture$4;
  (void) NSObject_init(self);
}
