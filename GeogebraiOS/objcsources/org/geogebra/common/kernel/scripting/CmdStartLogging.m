...
- (IOSObjectArray *)performWithOrgGeogebraCommonKernelArithmeticCommand:(OrgGeogebraCommonKernelArithmeticCommand *)c {
  ...
  if (!success) {
    @throw [new_OrgGeogebraCommonMainMyError_initWithOrgGeogebraCommonMainLocalization_withNSString_(loc_, [((OrgGeogebraCommonMainLocalization *) nil_chk(loc_)) getErrorWithNSString:@"NoLogging"]) autorelease];
  }
  return arg;
}
