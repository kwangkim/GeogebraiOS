...
- (IOSObjectArray *)performWithOrgGeogebraCommonKernelArithmeticCommand:(OrgGeogebraCommonKernelArithmeticCommand *)c {
  ...
  if (n == 2) {
    ...
    arg = [IOSObjectArray arrayWithLength:((IOSObjectArray *) nil_chk(args))->size_ type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(IOSObjectArray_Get(args, 0))) resolveVariables];
    IOSObjectArray_Set(arg, 0, IOSObjectArray_Get(nil_chk([self resArgWithOrgGeogebraCommonKernelArithmeticExpressionNode:IOSObjectArray_Get(args, 0)]), 0));
    @try {
      [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(IOSObjectArray_Get(args, 1))) resolveVariables];
      IOSObjectArray_Set(arg, 1, IOSObjectArray_Get(nil_chk([self resArgWithOrgGeogebraCommonKernelArithmeticExpressionNode:IOSObjectArray_Get(args, 1)]), 0));
    }
    @catch (JavaLangError *e) {
      IOSObjectArray_SetAndConsume(arg, 1, new_OrgGeogebraCommonKernelGeosGeoText_initWithOrgGeogebraCommonKernelConstruction_withNSString_(cons_, [((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(IOSObjectArray_Get(args, 1))) toStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]));
    }
