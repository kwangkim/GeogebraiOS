...
- (void)createTurtle {
  turtle_ = new_OrgGeogebraCommonKernelGeosGeoTurtle_initWithOrgGeogebraCommonKernelConstruction_(self->cons_);
}
...
- (NSString *)toStringWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  ...
  (void) [((JavaLangStringBuilder *) nil_chk(sb_)) appendWithNSString:[((OrgGeogebraCommonMainLocalization *) nil_chk([self getLoc])) getPlainWithNSString:@"Turtle"]];
