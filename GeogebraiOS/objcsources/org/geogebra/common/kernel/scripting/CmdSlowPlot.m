...
- (IOSObjectArray *)processWithOrgGeogebraCommonKernelArithmeticCommand:(OrgGeogebraCommonKernelArithmeticCommand *)c {
  ...
  switch (n) {
    ...
    if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(IOSObjectArray_Get(nil_chk(arg), 0))) isGeoFunctionable]) {
      OrgGeogebraCommonKernelGeosGeoNumeric *var = [new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons_, 0.0) autorelease];
      ...
      [sb appendWithNSString:[((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(IOSObjectArray_Get(arg, 0))) getLabelWithOrgGeogebraCommonKernelStringTemplate:tpl]];
      [sb appendWithNSString:@",x(Corner[1]), x(Corner[1]) (1-"];
      [sb appendWithNSString:[var getLabelWithOrgGeogebraCommonKernelStringTemplate:tpl]];
