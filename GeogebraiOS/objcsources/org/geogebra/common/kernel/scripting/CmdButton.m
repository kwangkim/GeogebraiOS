  ...
  IOSObjectArray *arg;
  {
    ...
    switch (n) {
      ...
      if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(IOSObjectArray_Get(nil_chk(arg), 0))) isGeoText]) {
        ...
        OrgGeogebraCommonKernelGeosGeoButton *gb = new_OrgGeogebraCommonKernelGeosGeoButton_initWithOrgGeogebraCommonKernelConstruction_(cons_);
      ...
      case 0:
      gb = new_OrgGeogebraCommonKernelGeosGeoButton_initWithOrgGeogebraCommonKernelConstruction_(cons_);
      [gb setLabelVisibleWithBoolean:YES];
      [gb setLabelWithNSString:[c getLabel]];
      [gb updateRepaint];
      return [IOSObjectArray newArrayWithObjects:(id[]){ gb } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
