...
- (void)createDefaultGeoElements {
  ...
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoConic3D *intersectionCurve = [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoConic3D_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
  ...
  [((JavaUtilHashMap *) nil_chk(defaultGeoElements_)) putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonGeogebra3DKernel3DConstructionDefaults3D_DEFAULT_INTERSECTION_CURVE) withId:intersectionCurve];
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoAxis3D *axis = [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoAxis3D_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
  ...
  [defaultGeoElements_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonGeogebra3DKernel3DConstructionDefaults3D_DEFAULT_AXIS3D) withId:axis];
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D *curve = [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
  ...
  [defaultGeoElements_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonGeogebra3DKernel3DConstructionDefaults3D_DEFAULT_CURVECARTESIAN3D) withId:curve];
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D *plane = [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
  ...
  [defaultGeoElements_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonGeogebra3DKernel3DConstructionDefaults3D_DEFAULT_PLANE3D) withId:plane];
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron *polyhedron = [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
  ...
  [defaultGeoElements_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonGeogebra3DKernel3DConstructionDefaults3D_DEFAULT_POLYHEDRON) withId:polyhedron];
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedronNet *polyhedronNet = [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedronNet_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
  ...
  [defaultGeoElements_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonGeogebra3DKernel3DConstructionDefaults3D_DEFAULT_NET) withId:polyhedronNet];
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3D *quadric = [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3D_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
  ...
  [defaultGeoElements_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonGeogebra3DKernel3DConstructionDefaults3D_DEFAULT_QUADRIC) withId:quadric];
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoSurfaceCartesian3D *surface = [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoSurfaceCartesian3D_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
  ...
  [defaultGeoElements_ putWithId:JavaLangInteger_valueOfWithInt_(OrgGeogebraCommonGeogebra3DKernel3DConstructionDefaults3D_DEFAULT_SURFACECARTESIAN3D) withId:surface];
}
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonGeogebra3DKernel3DConstructionDefaults3D class]) {
    JreStrongAssign(&OrgGeogebraCommonGeogebra3DKernel3DConstructionDefaults3D_colCurveCartesian3D_, nil, OrgGeogebraCommonKernelConstructionDefaults_get_colConic_());
    JreStrongAssign(&OrgGeogebraCommonGeogebra3DKernel3DConstructionDefaults3D_colPlane3D_, nil, OrgGeogebraCommonAwtGColor_get_DARK_CYAN_());
    JreStrongAssign(&OrgGeogebraCommonGeogebra3DKernel3DConstructionDefaults3D_colPolyhedron_, nil, OrgGeogebraCommonKernelConstructionDefaults_get_colPolygon_());
    JreStrongAssign(&OrgGeogebraCommonGeogebra3DKernel3DConstructionDefaults3D_colIntersectionCurve_, nil, OrgGeogebraCommonAwtGColor_get_ORANGE_());
    JreStrongAssign(&OrgGeogebraCommonGeogebra3DKernel3DConstructionDefaults3D_colXAXIS_, nil, OrgGeogebraCommonAwtGColor_get_RED_());
    JreStrongAssign(&OrgGeogebraCommonGeogebra3DKernel3DConstructionDefaults3D_colYAXIS_, nil, OrgGeogebraCommonAwtGColor_get_GREEN_());
    JreStrongAssign(&OrgGeogebraCommonGeogebra3DKernel3DConstructionDefaults3D_colZAXIS_, nil, OrgGeogebraCommonAwtGColor_get_BLUE_());
...
void OrgGeogebraCommonGeogebra3DKernel3DConstructionDefaults3D_initWithOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonGeogebra3DKernel3DConstructionDefaults3D *self, OrgGeogebraCommonKernelConstruction *cons) {
  OrgGeogebraCommonKernelConstructionDefaults_initWithOrgGeogebraCommonKernelConstruction_(self, cons);
}
