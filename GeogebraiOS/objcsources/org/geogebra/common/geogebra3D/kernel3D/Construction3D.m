...
- (void)initAxis {
  [super initAxis];
  OrgGeogebraCommonGeogebra3DKernel3DConstruction3D_setAndConsume_zAxis3D_(self, new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoAxis3D_initWithOrgGeogebraCommonKernelConstruction_withInt_(self, OrgGeogebraCommonKernelKernelNDGeoAxisND_Z_AXIS_3D));
  OrgGeogebraCommonGeogebra3DKernel3DConstruction3D_setAndConsume_xOyPlane_(self, new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3DConstant_initWithOrgGeogebraCommonKernelConstruction_withInt_(self, OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3DConstant_XOY_PLANE));
  OrgGeogebraCommonGeogebra3DKernel3DConstruction3D_setAndConsume_space_(self, new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoSpace_initWithOrgGeogebraCommonKernelConstruction_(self));
  OrgGeogebraCommonGeogebra3DKernel3DConstruction3D_setAndConsume_clippingCube_(self, new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoClippingCube3D_initWithOrgGeogebraCommonKernelConstruction_(self));
}
...
- (void)newConstructionDefaults {
  OrgGeogebraCommonKernelConstruction_setAndConsume_consDefaults_(self, new_OrgGeogebraCommonGeogebra3DKernel3DConstructionDefaults3D_initWithOrgGeogebraCommonKernelConstruction_(self));
}
...
- (void)updateLocalAxesNames {
  ...
  OrgGeogebraCommonGeogebra3DKernel3DConstruction3D_set_zAxis3DLocalName_(self, [((OrgGeogebraCommonMainApp *) nil_chk(app)) getPlainWithNSString:@"zAxis"]);
  OrgGeogebraCommonGeogebra3DKernel3DConstruction3D_set_xOyPlaneLocalName_(self, [app getPlainWithNSString:@"xOyPlane"]);
  OrgGeogebraCommonGeogebra3DKernel3DConstruction3D_set_spaceLocalName_(self, [app getPlainWithNSString:@"space"]);
  [geoTable_ putWithId:zAxis3DLocalName_ withId:zAxis3D_];
  [geoTable_ putWithId:xOyPlaneLocalName_ withId:xOyPlane_];
  [geoTable_ putWithId:spaceLocalName_ withId:space_];
}
...
void OrgGeogebraCommonGeogebra3DKernel3DConstruction3D_initWithOrgGeogebraCommonGeogebra3DKernel3DKernel3D_(OrgGeogebraCommonGeogebra3DKernel3DConstruction3D *self, OrgGeogebraCommonGeogebra3DKernel3DKernel3D *kernel3D) {
  OrgGeogebraCommonKernelConstruction_initWithOrgGeogebraCommonKernelKernel_(self, kernel3D);
}
