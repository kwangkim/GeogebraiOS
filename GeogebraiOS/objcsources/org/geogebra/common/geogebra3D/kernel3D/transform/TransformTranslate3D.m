...
- (OrgGeogebraCommonKernelAlgosAlgoTransformation *)getTransformAlgoWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoTranslate3D *algo = new_OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoTranslate3D_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoElement_(cons_, geo, transVec_);
  return algo;
}
...
void OrgGeogebraCommonGeogebra3DKernel3DTransformTransformTranslate3D_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoVectorND_(OrgGeogebraCommonGeogebra3DKernel3DTransformTransformTranslate3D *self, OrgGeogebraCommonKernelConstruction *cons, id<OrgGeogebraCommonKernelKernelNDGeoVectorND> transVec) {
  (void) OrgGeogebraCommonGeogebra3DKernel3DTransformTransform3D_init(self);
  self->transVec_ = (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(transVec, [OrgGeogebraCommonKernelGeosGeoElement class]);
  self->cons_ = cons;
}
