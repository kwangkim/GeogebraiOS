...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/geogebra3D/kernel3D/commands/AlgebraProcessor3D.java
//
...
- (IOSObjectArray *)processPointVector3DWithOrgGeogebraCommonKernelArithmeticExpressionNode:(OrgGeogebraCommonKernelArithmeticExpressionNode *)n
  ...
  if (isIndependent) {
    ...
    if (isVector) IOSObjectArray_Set(ret, 0, [((id<OrgGeogebraCommonKernelManager3DInterface>) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) getManager3D])) Vector3DWithNSString:label withDouble:x withDouble:y withDouble:z]);
    else IOSObjectArray_Set(ret, 0, [((id<OrgGeogebraCommonKernelManager3DInterface>) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) getManager3D])) Point3DWithNSString:label withDouble:x withDouble:y withDouble:z withBoolean:NO]);
  }
  else {
    if (isVector) IOSObjectArray_Set(ret, 0, [((id<OrgGeogebraCommonKernelManager3DInterface>) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) getManager3D])) DependentVector3DWithNSString:label withOrgGeogebraCommonKernelArithmeticExpressionNode:n]);
    else IOSObjectArray_Set(ret, 0, [((id<OrgGeogebraCommonKernelManager3DInterface>) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) getManager3D])) DependentPoint3DWithNSString:label withOrgGeogebraCommonKernelArithmeticExpressionNode:n]);
  }
...
- (IOSObjectArray *)processParametricFunctionWithOrgGeogebraCommonKernelArithmeticExpressionNode:(OrgGeogebraCommonKernelArithmeticExpressionNode *)exp
  ...
  if ([OrgGeogebraCommonKernelArithmetic3DVector3DValue_class_() isInstance:ev]) {
    ...
    IOSObjectArray *coefX = [IOSObjectArray arrayWithLength:5 type:OrgGeogebraCommonKernelArithmeticExpressionValue_class_()];
    IOSObjectArray *coefY = [IOSObjectArray arrayWithLength:5 type:OrgGeogebraCommonKernelArithmeticExpressionValue_class_()];
    IOSObjectArray *coefZ = [IOSObjectArray arrayWithLength:5 type:OrgGeogebraCommonKernelArithmeticExpressionValue_class_()];
    for (jint i = 0; i < coefX->size_; i++) {
      IOSObjectArray_SetAndConsume(coefX, i, new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, 0));
      IOSObjectArray_SetAndConsume(coefY, i, new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, 0));
      IOSObjectArray_SetAndConsume(coefZ, i, new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, 0));
    }
    jint degX = [self getPolyCoeffsWithOrgGeogebraCommonKernelArithmeticExpressionNode:cx withOrgGeogebraCommonKernelArithmeticExpressionValueArray:coefX withOrgGeogebraCommonKernelArithmeticExpressionNode:[new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, 1) autorelease] withOrgGeogebraCommonKernelGeosGeoNumeric:loc];
    ...
    if ((degX >= 0 && degY >= 0 && degZ >= 0) && (degX < 2 && degY < 2 && degZ < 2)) {
      OrgGeogebraCommonGeogebra3DKernel3DGeosGeoLine3D *line = [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoLine3D_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
      ...
      return [IOSObjectArray arrayWithObjects:(id[]){ line } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    }
    ...
    OrgGeogebraCommonKernelAlgosAlgoDependentNumber *nz = [new_OrgGeogebraCommonKernelAlgosAlgoDependentNumber_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticExpressionNode_withBoolean_(cons_, cz, NO) autorelease];
...
void OrgGeogebraCommonGeogebra3DKernel3DCommandsAlgebraProcessor3D_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelCommandsCommandDispatcher_(OrgGeogebraCommonGeogebra3DKernel3DCommandsAlgebraProcessor3D *self, OrgGeogebraCommonKernelKernel *kernel, OrgGeogebraCommonKernelCommandsCommandDispatcher *cd) {
  OrgGeogebraCommonKernelCommandsAlgebraProcessor_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelCommandsCommandDispatcher_(self, kernel, cd);
}
...
IOSObjectArray *OrgGeogebraCommonGeogebra3DKernel3DCommandsAlgebraProcessor3D_processQuadricWithOrgGeogebraCommonKernelArithmeticEquation_(OrgGeogebraCommonGeogebra3DKernel3DCommandsAlgebraProcessor3D *self, OrgGeogebraCommonKernelArithmeticEquation *equ) {
  ...
  if (isIndependent) {
    ...
    quadric = [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3D_initWithOrgGeogebraCommonKernelConstruction_withNSString_withDoubleArray_(self->cons_, label, coeffs) autorelease];
  }
  else {
