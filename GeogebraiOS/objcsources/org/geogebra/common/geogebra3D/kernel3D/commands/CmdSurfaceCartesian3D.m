...
- (IOSObjectArray *)processWithOrgGeogebraCommonKernelArithmeticCommand:(OrgGeogebraCommonKernelArithmeticCommand *)c {
  ...
  IOSBooleanArray *ok = [IOSBooleanArray arrayWithLength:n];
  {
    ...
    switch (n) {
      case 9:
      arg = [self resArgsLocalNumVarWithOrgGeogebraCommonKernelArithmeticCommand:c withIntArray:[IOSIntArray arrayWithInts:(jint[]){ 3, 6 } count:2] withIntArray:[IOSIntArray arrayWithInts:(jint[]){ 4, 7 } count:2]];
