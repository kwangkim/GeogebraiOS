...
- (OrgGeogebraCommonKernelGeosGeoElement *)ConicWithNSString:(NSString *)label
  ...
  IOSObjectArray *points = [IOSObjectArray newArrayWithLength:5 type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()];
  jboolean is3D = NO;
  for (jint i = 0; i < 5; i++) {
    (void) IOSObjectArray_Set(points, i, (id<OrgGeogebraCommonKernelKernelNDGeoPointND>) check_protocol_cast(IOSObjectArray_Get(nil_chk(arg), i), @protocol(OrgGeogebraCommonKernelKernelNDGeoPointND)));
...
void OrgGeogebraCommonGeogebra3DKernel3DCommandsCmdConic3D_initWithOrgGeogebraCommonKernelKernel_(OrgGeogebraCommonGeogebra3DKernel3DCommandsCmdConic3D *self, OrgGeogebraCommonKernelKernel *kernel) {
  (void) OrgGeogebraCommonKernelCommandsCmdConic_initWithOrgGeogebraCommonKernelKernel_(self, kernel);
}
