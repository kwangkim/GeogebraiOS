...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/geogebra3D/kernel3D/commands/CmdAngle3D.java
//
...
- (IOSObjectArray *)anglePointOrVectorWithNSString:(NSString *)label
  ...
  if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(v)) isGeoElement3D]) {
    ...
    IOSObjectArray *ret = [IOSObjectArray arrayWithObjects:(id[]){ [((OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAngleElement3D *) nil_chk(algo)) getAngle] } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    return ret;
  }
