...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/geogebra3D/kernel3D/commands/CmdVertex3D.java
//
...
- (OrgGeogebraCommonKernelAlgosAlgoVertexPolygon *)newAlgoVertexPolygonWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)cons
  ...
  if ([((id<OrgGeogebraCommonKernelGeosGeoPoly>) nil_chk(p)) isGeoElement3D]) {
    return [new_OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoVertexPolygon3D_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoPoly_withOrgGeogebraCommonKernelArithmeticNumberValue_(cons, label, p, v) autorelease];
  }
...
- (OrgGeogebraCommonKernelAlgosAlgoVertexConic *)newAlgoVertexConicWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)cons
  ...
  if ([((OrgGeogebraCommonKernelKernelNDGeoConicND *) nil_chk(conic)) isGeoElement3D]) {
    return [new_OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoVertexConic3D_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelKernelNDGeoConicND_(cons, labels, conic) autorelease];
  }
