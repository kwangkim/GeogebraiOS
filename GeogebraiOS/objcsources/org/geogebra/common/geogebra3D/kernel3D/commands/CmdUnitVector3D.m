...
- (IOSObjectArray *)processNotLineNotVectorWithOrgGeogebraCommonKernelArithmeticCommand:(OrgGeogebraCommonKernelArithmeticCommand *)c
  ...
  if ([OrgGeogebraCommonKernelKernelNDGeoDirectionND_class_() isInstance:arg]) {
    ...
    IOSObjectArray *ret = [IOSObjectArray newArrayWithObjects:(id[]){ (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast([algo getVector], [OrgGeogebraCommonKernelGeosGeoElement class]) } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    return ret;
  }
...
- (OrgGeogebraCommonKernelAlgosAlgoUnitVector *)algoWithNSString:(NSString *)label
  ...
  if ([((id<OrgGeogebraCommonKernelKernelNDGeoLineND>) nil_chk(line)) isGeoElement3D]) {
    return new_OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoUnitVector3D_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelKernelNDGeoDirectionND_(cons_, label, line);
  }
...
- (OrgGeogebraCommonKernelAlgosAlgoUnitVector *)algoWithNSString:(NSString *)label
  ...
  if ([((id<OrgGeogebraCommonKernelKernelNDGeoVectorND>) nil_chk(v)) isGeoElement3D]) {
    return new_OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoUnitVector3D_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelKernelNDGeoDirectionND_(cons_, label, v);
  }
...
void OrgGeogebraCommonGeogebra3DKernel3DCommandsCmdUnitVector3D_initWithOrgGeogebraCommonKernelKernel_(OrgGeogebraCommonGeogebra3DKernel3DCommandsCmdUnitVector3D *self, OrgGeogebraCommonKernelKernel *kernel) {
  (void) OrgGeogebraCommonKernelAlgosCmdUnitVector_initWithOrgGeogebraCommonKernelKernel_(self, kernel);
}
