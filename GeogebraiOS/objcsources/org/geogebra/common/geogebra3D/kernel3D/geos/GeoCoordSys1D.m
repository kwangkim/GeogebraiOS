...
- (void)setLineThroughWithDouble:(jdouble)pointX
  ...
  [self setCoordWithOrgGeogebraCommonKernelMatrixCoords:new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_(pointX, pointY, 0, 1) withOrgGeogebraCommonKernelMatrixCoords:[self getDirectionInD3]];
}
...
- (OrgGeogebraCommonKernelMatrixCoords *)getPointInDWithInt:(jint)dimension
  ...
  switch (dimension) {
    ...
    return v;
    case 2:
    return new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_([((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(v)) getX], [v getY], [v getW]);
    default:
    return nil;
  }
}
...
- (void)rotateWithOrgGeogebraCommonKernelArithmeticNumberValue:(id<OrgGeogebraCommonKernelArithmeticNumberValue>)phiValue {
  ...
  jdouble y = [o getY];
  jdouble w = [o getW];
  OrgGeogebraCommonKernelMatrixCoords *oRot = new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_(x * cos - y * sin, x * sin + y * cos, z, w);
  jdouble vx = [v getX];
  jdouble vy = [v getY];
  jdouble vw = [v getW];
  OrgGeogebraCommonKernelMatrixCoords *vRot = new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_(vx * cos - vy * sin, vx * sin + vy * cos, vz, vw);
...
- (void)rotateWithOrgGeogebraCommonKernelArithmeticNumberValue:(id<OrgGeogebraCommonKernelArithmeticNumberValue>)phiValue
  ...
  jdouble qy = w * [Q getY];
  OrgGeogebraCommonKernelMatrixCoords *oRot = new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_((x - qx) * cos + (qy - y) * sin + qx, (x - qx) * sin + (y - qy) * cos + qy, z, w);
  jdouble vx = [v getX];
  jdouble vy = [v getY];
  jdouble vw = [v getW];
  OrgGeogebraCommonKernelMatrixCoords *vRot = new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_(vx * cos - vy * sin, vx * sin + vy * cos, vz, vw);
...
- (void)mirrorWithOrgGeogebraCommonKernelKernelNDGeoCoordSys2D:(id<OrgGeogebraCommonKernelKernelNDGeoCoordSys2D>)plane {
  ...
  (void) [point mulInsideWithDouble:-1];
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCoordSys1D_initWithOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCoordSys1D *self, OrgGeogebraCommonKernelConstruction *c) {
  (void) OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCoordSys1D_initWithOrgGeogebraCommonKernelConstruction_withBoolean_(self, c, NO);
}
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCoordSys1D_initWithOrgGeogebraCommonKernelConstruction_withBoolean_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCoordSys1D *self, OrgGeogebraCommonKernelConstruction *c, jboolean isIntersection) {
  ...
  self->coordsys_ = new_OrgGeogebraCommonKernelMatrixCoordSys_initWithInt_(1);
}
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCoordSys1D_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCoordSys1D *self, OrgGeogebraCommonKernelConstruction *c, id<OrgGeogebraCommonKernelKernelNDGeoPointND> O, id<OrgGeogebraCommonKernelKernelNDGeoPointND> I) {
  (void) OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCoordSys1D_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_withBoolean_(self, c, O, I, NO);
}
