...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/javasources/org/geogebra/common/geogebra3D/kernel3D/geos/GeoPolyLine3D.java
//
...
- (OrgGeogebraCommonKernelGeosGeoElement *)copyInternalWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)cons {
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyLine3D *ret = [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyLine3D_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_(cons, nil) autorelease];
  OrgGeogebraCommonKernelGeosGeoPolyLine_set_points_(ret, OrgGeogebraCommonKernelGeosGeoElement_copyPointsNDWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_(cons, points_));
...
- (id<OrgGeogebraCommonKernelKernelNDGeoPointND>)createNewPoint {
  return [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
}
...
- (void)calcIsPlanar {
  ...
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyLine3D_set_normal_(self, nil);
  index1_ = index2_ = 0;
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyLine3D_set_direction1_(self, OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyLine3D_set_direction2_(self, OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyLine3D_set_direction3_(self, nil)));
  ...
  for (index2_ = index1_ + 1; index2_ < [self getNumPoints]; index2_++) {
    OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyLine3D_set_direction2_(self, [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk([((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(IOSObjectArray_Get(nil_chk(points_), index2_))) getInhomCoordsInD3])) subWithOrgGeogebraCommonKernelMatrixCoords:[((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(IOSObjectArray_Get(points_, index1_))) getInhomCoordsInD3]]);
    OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyLine3D_set_normal_(self, [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(direction1_)) crossProductWithOrgGeogebraCommonKernelMatrixCoords:direction2_]);
    if (![((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(normal_)) equalsForKernelWithOrgGeogebraCommonKernelMatrixCoords:[new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_(0, 0, 0) autorelease] withDouble:OrgGeogebraCommonKernelKernel_STANDARD_PRECISION]) {
      break;
    }
    else {
      OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyLine3D_set_direction2_(self, nil);
      OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyLine3D_set_normal_(self, nil);
    }
  }
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyLine3D_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyLine3D *self, OrgGeogebraCommonKernelConstruction *c, IOSObjectArray *points) {
  OrgGeogebraCommonKernelGeosGeoPolyLine_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_(self, c, points);
  self->defined_GeoPolyLine3D_ = NO;
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyLine3D_set_direction1_(self, nil);
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyLine3D_set_direction2_(self, nil);
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyLine3D_set_direction3_(self, nil);
  self->isPlanar__ = NO;
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyLine3D_set_normal_(self, nil);
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyLine3D_setAndConsume_seg_GeoPolyLine3D_(self, new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoSegment3D_initWithOrgGeogebraCommonKernelConstruction_(self->cons_));
}
