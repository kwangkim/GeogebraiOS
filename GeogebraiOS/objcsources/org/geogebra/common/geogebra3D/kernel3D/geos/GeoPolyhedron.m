...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/geogebra3D/kernel3D/geos/GeoPolyhedron.java
//
...
- (void)startNewFace {
  currentFace_ = new_OrgGeogebraCommonKernelConstructionElementCycle_init();
}
...
- (void)endCurrentFace {
  ...
  (void) [((JavaUtilTreeMap *) nil_chk(polygonsIndex_)) putWithId:currentFace_ withId:new_JavaLangInteger_initWithInt_(polygonsIndexMax_)];
...
- (void)updateFacesDeprecated {
  ...
  for (OrgGeogebraCommonKernelConstructionElementCycle * __strong currentFace in nil_chk([((JavaUtilTreeMap *) nil_chk(polygonsIndex_)) keySet])) {
    ...
    IOSObjectArray *p = [IOSObjectArray newArrayWithLength:[((OrgGeogebraCommonKernelConstructionElementCycle *) nil_chk(currentFace)) size] type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()];
    IOSObjectArray *s = [IOSObjectArray newArrayWithLength:[currentFace size] type:OrgGeogebraCommonKernelKernelNDGeoSegmentND_class_()];
    ...
    jint j = 0;
    (void) IOSObjectArray_Set(p, j, endPoint);
    ...
    for (; [it2 hasNext]; ) {
      ...
      (void) IOSObjectArray_Set(s, j, [self createSegmentWithOrgGeogebraCommonKernelKernelNDGeoPointND:startPoint withOrgGeogebraCommonKernelKernelNDGeoPointND:endPoint]);
      j++;
      (void) IOSObjectArray_Set(p, j, endPoint);
    }
    (void) IOSObjectArray_Set(s, j, [self createSegmentWithOrgGeogebraCommonKernelKernelNDGeoPointND:endPoint withOrgGeogebraCommonKernelKernelNDGeoPointND:firstPoint]);
...
- (OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolygon3D *)createPolygonWithInt:(jint)index {
  currentFace_ = [((JavaUtilArrayList *) nil_chk(polygonsDescriptions_)) getWithInt:index];
  IOSObjectArray *p = [IOSObjectArray newArrayWithLength:[((OrgGeogebraCommonKernelConstructionElementCycle *) nil_chk(currentFace_)) size] type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()];
  IOSObjectArray *s = [IOSObjectArray newArrayWithLength:[currentFace_ size] type:OrgGeogebraCommonKernelKernelNDGeoSegmentND_class_()];
  ...
  (void) IOSObjectArray_Set(p, 0, endPoint);
  id<OrgGeogebraCommonKernelKernelNDGeoPointND> firstPoint = endPoint;
  jint j;
  for (j = 1; j < [currentFace_ size]; j++) {
    ...
    (void) IOSObjectArray_Set(s, j - 1, [self createSegmentWithOrgGeogebraCommonKernelKernelNDGeoPointND:startPoint withOrgGeogebraCommonKernelKernelNDGeoPointND:endPoint]);
    (void) IOSObjectArray_Set(p, j, endPoint);
  }
  (void) IOSObjectArray_Set(s, j - 1, [self createSegmentWithOrgGeogebraCommonKernelKernelNDGeoPointND:endPoint withOrgGeogebraCommonKernelKernelNDGeoPointND:firstPoint]);
...
- (void)createFaces {
  for (jint index = 0; index < [((JavaUtilArrayList *) nil_chk(polygonsDescriptions_)) size]; index++) {
    (void) [self createPolygonWithInt:index];
  }
}
...
- (OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolygon3D *)createPolygonWithOrgGeogebraCommonKernelKernelNDGeoPointNDArray:(IOSObjectArray *)points
                                                                                                                 withInt:(jint)index {
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolygon3D *algo = new_OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolygon3D_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_withBoolean_withOrgGeogebraCommonKernelGeosGeoElement_(cons_, points, NO, self);
  ...
  (void) [((JavaUtilTreeMap *) nil_chk(polygons_)) putWithId:JavaLangInteger_valueOfWithInt_(index) withId:polygon];
  return polygon;
}
...
- (void)storeSegmentWithOrgGeogebraCommonGeogebra3DKernel3DGeosGeoSegment3D:(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoSegment3D *)segment
                        withOrgGeogebraCommonKernelConstructionElementCycle:(OrgGeogebraCommonKernelConstructionElementCycle *)key {
  JavaLangLong *index = new_JavaLangLong_initWithLong_(segmentsIndexMax_);
  (void) [((JavaUtilTreeMap *) nil_chk(segmentsIndex_)) putWithId:key withId:index];
  (void) [((JavaUtilTreeMap *) nil_chk(segments_)) putWithId:index withId:segment];
  segmentsIndexMax_++;
}
...
- (void)addSegmentLinkedWithOrgGeogebraCommonKernelKernelNDGeoSegmentND:(id<OrgGeogebraCommonKernelKernelNDGeoSegmentND>)segment {
  ...
  (void) [((JavaUtilTreeMap *) nil_chk(segmentsLinked_)) putWithId:key withId:segment];
}
...
- (void)defaultLabelsWithNSStringArray:(IOSObjectArray *)labels {
  ...
  if (labels == nil || labels->size_ == 0) labels = [IOSObjectArray newArrayWithLength:1 type:NSString_class_()];
...
- (void)initLabelsWithNSStringArray:(IOSObjectArray *)labels {
  ...
  if (labels == nil || labels->size_ == 0) {
    labels = [IOSObjectArray newArrayWithLength:1 type:NSString_class_()];
  }
  [self setLabelWithNSString:IOSObjectArray_Get(nil_chk(labels), 0)];
  jint index = 1;
...
- (IOSObjectArray *)getSegments {
  IOSObjectArray *ret = [IOSObjectArray newArrayWithLength:[((JavaUtilTreeMap *) nil_chk(segments_)) size] type:OrgGeogebraCommonKernelKernelNDGeoSegmentND_class_()];
  jint i = 0;
  for (OrgGeogebraCommonGeogebra3DKernel3DGeosGeoSegment3D * __strong segment in nil_chk([segments_ values])) {
    (void) IOSObjectArray_Set(ret, i, segment);
    i++;
  }
  return ret;
}
...
- (IOSObjectArray *)getSegments3D {
  IOSObjectArray *ret = [IOSObjectArray newArrayWithLength:[((JavaUtilTreeMap *) nil_chk(segments_)) size] type:OrgGeogebraCommonGeogebra3DKernel3DGeosGeoSegment3D_class_()];
  jint i = 0;
  for (OrgGeogebraCommonGeogebra3DKernel3DGeosGeoSegment3D * __strong segment in nil_chk([segments_ values])) {
    (void) IOSObjectArray_Set(ret, i, segment);
    i++;
...
- (IOSObjectArray *)getFaces {
  IOSObjectArray *polygonsArray = [IOSObjectArray newArrayWithLength:[((JavaUtilArrayList *) nil_chk(polygonsLinked_)) size] + [((JavaUtilTreeMap *) nil_chk(polygons_)) size] type:OrgGeogebraCommonKernelGeosGeoPolygon_class_()];
  jint index = 0;
  for (OrgGeogebraCommonKernelGeosGeoPolygon * __strong polygon in polygonsLinked_) {
    (void) IOSObjectArray_Set(polygonsArray, index, polygon);
    index++;
  }
...
- (IOSObjectArray *)getFaces3D {
  IOSObjectArray *polygonsArray = [IOSObjectArray newArrayWithLength:[((JavaUtilTreeMap *) nil_chk(polygons_)) size] type:OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolygon3D_class_()];
  jint index = 0;
  for (OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolygon3D * __strong polygon in nil_chk([polygons_ values])) {
    (void) IOSObjectArray_Set(polygonsArray, index, polygon);
    index++;
...
- (OrgGeogebraCommonKernelGeosGeoElement *)copy__ {
  return new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron_initWithOrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron_(self);
}
...
- (NSString *)toStringWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  ...
  (void) [sbToString_GeoPolyhedron_ appendWithNSString:label_];
  (void) [sbToString_GeoPolyhedron_ appendWithNSString:@" = "];
  (void) [sbToString_GeoPolyhedron_ appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) formatWithDouble:[self getVolume] withOrgGeogebraCommonKernelStringTemplate:tpl]];
...
- (NSString *)toStringMinimalWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  [((JavaLangStringBuilder *) nil_chk(sbToString_GeoPolyhedron_)) setLengthWithInt:0];
  (void) [sbToString_GeoPolyhedron_ appendWithNSString:[self regrFormatWithDouble:[self getVolume]]];
  return [sbToString_GeoPolyhedron_ description];
}
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron_initWithOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron *self, OrgGeogebraCommonKernelConstruction *c) {
  ...
  self->sbToString_GeoPolyhedron_ = new_JavaLangStringBuilder_initWithInt_(50);
  self->volume_ = JavaLangDouble_NaN;
  self->area_ = JavaLangDouble_NaN;
  [self setConstructionDefaults];
  self->polygonsIndex_ = new_JavaUtilTreeMap_init();
  self->polygonsDescriptions_ = new_JavaUtilArrayList_init();
  self->polygons_ = new_JavaUtilTreeMap_init();
  self->segmentsIndex_ = new_JavaUtilTreeMap_init();
  self->segments_ = new_JavaUtilTreeMap_init();
  self->segmentsLinked_ = new_JavaUtilTreeMap_init();
  self->polygonsLinked_ = new_JavaUtilArrayList_init();
  self->pointsCreated_ = new_JavaUtilArrayList_init();
}
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron_initWithOrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron *self, OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron *polyhedron) {
  (void) OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron_initWithOrgGeogebraCommonKernelConstruction_(self, [((OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron *) nil_chk(polyhedron)) getConstruction]);
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron_defaultPolygonsLabels(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron *self) {
  for (OrgGeogebraCommonKernelConstructionElementCycle * __strong key in nil_chk([((JavaUtilTreeMap *) nil_chk(self->polygonsIndex_)) keySet])) {
    ...
    IOSObjectArray *points = [IOSObjectArray newArrayWithLength:[((OrgGeogebraCommonKernelConstructionElementCycle *) nil_chk(key)) size] type:NSString_class_()];
    ...
    for (id<JavaUtilIterator> it = [key iterator]; [((id<JavaUtilIterator>) nil_chk(it)) hasNext] && (labelUsability < 2); ) {
      ...
      if (labelUsability < 2) {
        (void) IOSObjectArray_Set(points, i, [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(p)) getLabelWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]);
    ...
    if (labelUsability < 2) {
      ...
      (void) [self->sb_ appendWithNSString:[((OrgGeogebraCommonMainLocalization *) nil_chk([self getLoc])) getPlainWithNSString:@"Name.face"]];
      ...
      if ([((NSString *) nil_chk(IOSObjectArray_Get(points, indexSecondPointPlus))) compareToIgnoreCase:IOSObjectArray_Get(points, indexSecondPointMinus)] < 0) {
        for (jint j = indexFirstPointName; j < points->size_; j++) (void) [self->sb_ appendWithNSString:IOSObjectArray_Get(points, j)];
        for (jint j = 0; j < indexFirstPointName; j++) (void) [self->sb_ appendWithNSString:IOSObjectArray_Get(points, j)];
      }
      else {
        for (jint j = indexFirstPointName; j >= 0; j--) (void) [self->sb_ appendWithNSString:IOSObjectArray_Get(points, j)];
        for (jint j = points->size_ - 1; j > indexFirstPointName; j--) (void) [self->sb_ appendWithNSString:IOSObjectArray_Get(points, j)];
      }
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron_defaultSegmentLabels(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron *self) {
  for (OrgGeogebraCommonKernelConstructionElementCycle * __strong key in nil_chk([((JavaUtilTreeMap *) nil_chk(self->segmentsIndex_)) keySet])) {
    jint labelUsability = 0;
    NSString *label = nil;
    IOSObjectArray *points = [IOSObjectArray newArrayWithLength:2 type:NSString_class_()];
    jint i = 0;
    ...
    if (labelUsability < 2) {
      [((JavaLangStringBuffer *) nil_chk(self->sb_)) setLengthWithInt:0];
      (void) [self->sb_ appendWithNSString:[((OrgGeogebraCommonMainLocalization *) nil_chk([self getLoc])) getPlainWithNSString:@"Name.edge"]];
      if ([((NSString *) nil_chk(IOSObjectArray_Get(points, 0))) compareToIgnoreCase:IOSObjectArray_Get(points, 1)] < 0) {
        (void) [self->sb_ appendWithNSString:IOSObjectArray_Get(points, 0)];
        (void) [self->sb_ appendWithNSString:IOSObjectArray_Get(points, 1)];
      }
      else {
        (void) [self->sb_ appendWithNSString:IOSObjectArray_Get(points, 1)];
        (void) [self->sb_ appendWithNSString:IOSObjectArray_Get(points, 0)];
...
jboolean OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron_setPolygonWithInt_withOrgGeogebraCommonKernelGeosGeoPolygon_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron *self, jint index, OrgGeogebraCommonKernelGeosGeoPolygon *p) {
  ...
  if (poly == nil) {
    poly = new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolygon3D_initWithOrgGeogebraCommonKernelConstruction_([self getConstruction]);
    (void) [self->polygons_ putWithId:JavaLangInteger_valueOfWithInt_(index) withId:poly];
  }
...
jboolean OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron_setSegmentWithLong_withOrgGeogebraCommonKernelKernelNDGeoSegmentND_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron *self, jlong index, id<OrgGeogebraCommonKernelKernelNDGeoSegmentND> s) {
  ...
  if (seg == nil) {
    seg = new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoSegment3D_initWithOrgGeogebraCommonKernelConstruction_([self getConstruction]);
    (void) [self->segments_ putWithId:JavaLangLong_valueOfWithLong_(index) withId:seg];
  }
