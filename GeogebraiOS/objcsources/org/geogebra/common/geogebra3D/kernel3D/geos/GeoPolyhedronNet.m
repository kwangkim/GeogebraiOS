...
- (NSString *)toStringWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  ...
  (void) [sbToString_GeoPolyhedronNet_ appendWithNSString:label_];
  (void) [sbToString_GeoPolyhedronNet_ appendWithNSString:@" = "];
  (void) [sbToString_GeoPolyhedronNet_ appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) formatWithDouble:[self getArea] withOrgGeogebraCommonKernelStringTemplate:tpl]];
...
- (NSString *)toStringMinimalWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  [((JavaLangStringBuilder *) nil_chk(sbToString_GeoPolyhedronNet_)) setLengthWithInt:0];
  (void) [sbToString_GeoPolyhedronNet_ appendWithNSString:[self regrFormatWithDouble:[self getArea]]];
  return [sbToString_GeoPolyhedronNet_ description];
}
...
- (void)createFaces {
  ...
  if (segments_ != nil) {
    oldSegments_ = [self getSegments3D];
  }
  else {
    oldSegments_ = nil;
  }
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedronNet_initWithOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedronNet *self, OrgGeogebraCommonKernelConstruction *c) {
  (void) OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron_initWithOrgGeogebraCommonKernelConstruction_(self, c);
  self->sbToString_GeoPolyhedronNet_ = new_JavaLangStringBuilder_initWithInt_(50);
}
