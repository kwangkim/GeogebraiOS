...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/geogebra3D/kernel3D/geos/GeoLine3D.java
//
...
- (NSString *)toStringWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  ...
  (void) [sbToString appendWithJavaLangCharSequence:OrgGeogebraCommonGeogebra3DKernel3DGeosGeoLine3D_buildValueStringWithOrgGeogebraCommonKernelStringTemplate_(self, tpl)];
...
- (void)getCoordsXMLWithJavaLangStringBuilder:(JavaLangStringBuilder *)sb {
  ...
  (void) [sb appendWithNSString:@" ox=\""];
  (void) [sb appendWithDouble:[((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(o)) getX]];
  (void) [sb appendWithNSString:@"\" oy=\""];
  (void) [sb appendWithDouble:[o getY]];
  (void) [sb appendWithNSString:@"\" oz=\""];
  (void) [sb appendWithDouble:[o getZ]];
  (void) [sb appendWithNSString:@"\" ow=\""];
  (void) [sb appendWithDouble:[o getW]];
  (void) [sb appendWithNSString:@"\" vx=\""];
  (void) [sb appendWithDouble:[((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(v)) getX]];
  (void) [sb appendWithNSString:@"\" vy=\""];
  (void) [sb appendWithDouble:[v getY]];
  (void) [sb appendWithNSString:@"\" vz=\""];
  (void) [sb appendWithDouble:[v getZ]];
  (void) [sb appendWithNSString:@"\" vw=\""];
  (void) [sb appendWithDouble:[v getW]];
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoLine3D_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoLine3D *self, OrgGeogebraCommonKernelConstruction *c, id<OrgGeogebraCommonKernelKernelNDGeoPointND> O, id<OrgGeogebraCommonKernelKernelNDGeoPointND> I) {
  (void) OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCoordSys1D_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_(self, c, O, I);
  self->parameter_ = JreStrcat("C", OrgGeogebraCommonUtilUnicode_lambda);
}
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoLine3D_initWithOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoLine3D *self, OrgGeogebraCommonKernelConstruction *c) {
  (void) OrgGeogebraCommonGeogebra3DKernel3DGeosGeoLine3D_initWithOrgGeogebraCommonKernelConstruction_withBoolean_(self, c, NO);
}
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoLine3D_initWithOrgGeogebraCommonKernelConstruction_withBoolean_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoLine3D *self, OrgGeogebraCommonKernelConstruction *c, jboolean isIntersection) {
  (void) OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCoordSys1D_initWithOrgGeogebraCommonKernelConstruction_withBoolean_(self, c, isIntersection);
  self->parameter_ = JreStrcat("C", OrgGeogebraCommonUtilUnicode_lambda);
}
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoLine3D_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelMatrixCoords_withOrgGeogebraCommonKernelMatrixCoords_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoLine3D *self, OrgGeogebraCommonKernelConstruction *c, OrgGeogebraCommonKernelMatrixCoords *o, OrgGeogebraCommonKernelMatrixCoords *v) {
  (void) OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCoordSys1D_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelMatrixCoords_withOrgGeogebraCommonKernelMatrixCoords_(self, c, o, v);
  self->parameter_ = JreStrcat("C", OrgGeogebraCommonUtilUnicode_lambda);
}
...
JavaLangStringBuilder *OrgGeogebraCommonGeogebra3DKernel3DGeosGeoLine3D_buildValueStringWithOrgGeogebraCommonKernelStringTemplate_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoLine3D *self, OrgGeogebraCommonKernelStringTemplate *tpl) {
  ...
  [((JavaLangStringBuilder *) nil_chk(sbToString)) setLengthWithInt:0];
  if (![self isDefined]) {
    (void) [sbToString appendWithNSString:@"X = (?, ?, ?)"];
    return sbToString;
  }
  ...
  if ([algo isKindOfClass:[OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoLinePoint class]]) {
    ...
    if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(IOSObjectArray_Get(nil_chk(geos), 0))) isGeoPoint] && [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(IOSObjectArray_Get(geos, 1))) isGeoVector]) {
      ...
      (void) [sbToString appendWithNSString:@"X = ("];
      (void) [sbToString appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) formatWithDouble:[((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(coords1)) getX] withOrgGeogebraCommonKernelStringTemplate:tpl]];
      (void) [sbToString appendWithNSString:@", "];
      (void) [sbToString appendWithNSString:[self->kernel_ formatWithDouble:[coords1 getY] withOrgGeogebraCommonKernelStringTemplate:tpl]];
      (void) [sbToString appendWithNSString:@", "];
      (void) [sbToString appendWithNSString:[self->kernel_ formatWithDouble:[coords1 getZ] withOrgGeogebraCommonKernelStringTemplate:tpl]];
      (void) [sbToString appendWithNSString:@") + "];
      (void) [sbToString appendWithNSString:self->parameter_];
      (void) [sbToString appendWithNSString:@" ("];
      (void) [sbToString appendWithNSString:[self->kernel_ formatWithDouble:[((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(coords2)) getX] withOrgGeogebraCommonKernelStringTemplate:tpl]];
      (void) [sbToString appendWithNSString:@", "];
      (void) [sbToString appendWithNSString:[self->kernel_ formatWithDouble:[coords2 getY] withOrgGeogebraCommonKernelStringTemplate:tpl]];
      (void) [sbToString appendWithNSString:@", "];
      (void) [sbToString appendWithNSString:[self->kernel_ formatWithDouble:[coords2 getZ] withOrgGeogebraCommonKernelStringTemplate:tpl]];
      (void) [sbToString appendWithNSString:@")"];
      return sbToString;
    }
  }
  ...
  (void) [sbToString appendWithNSString:@"X = ("];
  (void) [sbToString appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) formatWithDouble:[((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(O)) getWithInt:1] withOrgGeogebraCommonKernelStringTemplate:tpl]];
  (void) [sbToString appendWithNSString:@", "];
  (void) [sbToString appendWithNSString:[self->kernel_ formatWithDouble:[O getWithInt:2] withOrgGeogebraCommonKernelStringTemplate:tpl]];
  (void) [sbToString appendWithNSString:@", "];
  (void) [sbToString appendWithNSString:[self->kernel_ formatWithDouble:[O getWithInt:3] withOrgGeogebraCommonKernelStringTemplate:tpl]];
  (void) [sbToString appendWithNSString:@") + "];
  (void) [sbToString appendWithNSString:self->parameter_];
  (void) [sbToString appendWithNSString:@" ("];
  (void) [sbToString appendWithNSString:[self->kernel_ formatWithDouble:[((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(V)) getWithInt:1] withOrgGeogebraCommonKernelStringTemplate:tpl]];
  (void) [sbToString appendWithNSString:@", "];
  (void) [sbToString appendWithNSString:[self->kernel_ formatWithDouble:[V getWithInt:2] withOrgGeogebraCommonKernelStringTemplate:tpl]];
  (void) [sbToString appendWithNSString:@", "];
  (void) [sbToString appendWithNSString:[self->kernel_ formatWithDouble:[V getWithInt:3] withOrgGeogebraCommonKernelStringTemplate:tpl]];
  (void) [sbToString appendWithNSString:@")"];
  return sbToString;
}
