...
- (OrgGeogebraCommonKernelGeosGeoElement *)copy__ {
  return new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3DLimited_initWithOrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3DLimited_(self);
}
...
- (void)setWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  if ([geo isKindOfClass:[OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3DLimited class]]) {
    ...
    origin_ = [side_ getMidpoint3D];
    direction_ = [side_ getEigenvec3DWithInt:2];
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3DLimited_initWithOrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3DLimited_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3DLimited *self, OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3DLimited *quadric) {
  (void) OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3DLimited_initWithOrgGeogebraCommonKernelConstruction_(self, [((OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3DLimited *) nil_chk(quadric)) getConstruction]);
  self->bottom_ = new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoConic3D_initWithOrgGeogebraCommonKernelConstruction_([quadric getConstruction]);
  self->top_ = new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoConic3D_initWithOrgGeogebraCommonKernelConstruction_([quadric getConstruction]);
  self->side_ = new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3DPart_initWithOrgGeogebraCommonKernelConstruction_([quadric getConstruction]);
