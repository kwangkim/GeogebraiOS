...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/geogebra3D/kernel3D/geos/GeoLocus3D.java
//
...
- (OrgGeogebraCommonGeogebra3DKernel3DGeosGeoLocus3D *)newGeoLocus {
  return [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoLocus3D_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
}
...
- (void)insertPointWithDouble:(jdouble)x
  ...
  [((JavaUtilArrayList *) nil_chk(myPointList_)) addWithId:[new_OrgGeogebraCommonGeogebra3DKernel3DMyPoint3D_initWithDouble_withDouble_withDouble_withBoolean_(x, y, z, lineTo) autorelease]];
}
...
- (id<OrgGeogebraCommonKernelKernelNDGeoSegmentND>)newGeoSegment {
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoSegment3D *segment = [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoSegment3D_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
  return segment;
}

- (void)setChangingPointWithOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)P {
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoLocus3D_set_changingPoint_(self, P);
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoLocus3D_set_changingCoords_(self, [((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(P)) getInhomCoordsInD3]);
}
