...
- (id<OrgGeogebraCommonKernelArithmeticExpressionValue>)deepCopyWithOrgGeogebraCommonKernelKernel:(OrgGeogebraCommonKernelKernel *)kernel1 {
  return [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeo3DVec_initWithOrgGeogebraCommonGeogebra3DKernel3DGeosGeo3DVec_(self) autorelease];
}
...
- (IOSDoubleArray *)getPointAsDouble {
  return [IOSDoubleArray arrayWithDoubles:(jdouble[]){ OrgGeogebraCommonGeogebra3DKernel3DGeosGeo3DVec_getX(self), OrgGeogebraCommonGeogebra3DKernel3DGeosGeo3DVec_getY(self), OrgGeogebraCommonGeogebra3DKernel3DGeosGeo3DVec_getZ(self) } count:3];
}
...
- (OrgGeogebraCommonGeogebra3DKernel3DGeosGeo3DVec *)round {
  return [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeo3DVec_initWithOrgGeogebraCommonKernelKernel_withDouble_withDouble_withDouble_(kernel_, JavaLangMath_roundWithDouble_(x_), JavaLangMath_roundWithDouble_(y_), JavaLangMath_roundWithDouble_(z_)) autorelease];
}

- (OrgGeogebraCommonGeogebra3DKernel3DGeosGeo3DVec *)floor {
  return [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeo3DVec_initWithOrgGeogebraCommonKernelKernel_withDouble_withDouble_withDouble_(kernel_, JavaLangMath_floorWithDouble_(x_), JavaLangMath_floorWithDouble_(y_), JavaLangMath_floorWithDouble_(z_)) autorelease];
}

- (OrgGeogebraCommonGeogebra3DKernel3DGeosGeo3DVec *)ceil {
  return [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeo3DVec_initWithOrgGeogebraCommonKernelKernel_withDouble_withDouble_withDouble_(kernel_, JavaLangMath_ceilWithDouble_(x_), JavaLangMath_ceilWithDouble_(y_), JavaLangMath_ceilWithDouble_(z_)) autorelease];
}
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeo3DVec_initWithOrgGeogebraCommonKernelKernel_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeo3DVec *self, OrgGeogebraCommonKernelKernel *kernel) {
  ...
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeo3DVec_setAndConsume_sbToString_(self, new_JavaLangStringBuilder_initWithInt_(50));
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeo3DVec_set_kernel_(self, kernel);
}
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeo3DVec_initWithOrgGeogebraCommonGeogebra3DKernel3DGeosGeo3DVec_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeo3DVec *self, OrgGeogebraCommonGeogebra3DKernel3DGeosGeo3DVec *v) {
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeo3DVec_initWithOrgGeogebraCommonKernelKernel_(self, ((OrgGeogebraCommonGeogebra3DKernel3DGeosGeo3DVec *) nil_chk(v))->kernel_);
  self->x_ = v->x_;
  self->y_ = v->y_;
  self->z_ = v->z_;
  self->mode_ = v->mode_;
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeo3DVec_complexMultiplyWithOrgGeogebraCommonKernelKernelNDGeoVecInterface_withOrgGeogebraCommonKernelKernelNDGeoVecInterface_withOrgGeogebraCommonKernelGeosGeoVec2D_(id<OrgGeogebraCommonKernelKernelNDGeoVecInterface> a, id<OrgGeogebraCommonKernelKernelNDGeoVecInterface> b, OrgGeogebraCommonKernelGeosGeoVec2D *c) {
  ...
  out = [out multiplyWithId:[new_OrgApacheCommonsMathComplexComplex_initWithDouble_withDouble_([((id<OrgGeogebraCommonKernelKernelNDGeoVecInterface>) nil_chk(b)) getX], [b getY]) autorelease]];
