...
- (void)setConeWithOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)origin
  ...
  (void) IOSObjectArray_Set(nil_chk(eigenvecND_), 2, direction);
  IOSObjectArray *ee = [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(direction)) completeOrthonormal];
  (void) IOSObjectArray_Set(eigenvecND_, 0, IOSObjectArray_Get(nil_chk(ee), 0));
  (void) IOSObjectArray_Set(eigenvecND_, 1, IOSObjectArray_Get(ee, 1));
...
- (OrgGeogebraCommonKernelGeosGeoElement *)copy__ {
  return new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3D_initWithOrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3D_(self);
}
...
- (JavaLangStringBuilder *)buildValueStringWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  JavaLangStringBuilder *sbToValueString = new_JavaLangStringBuilder_init();
  {
    ...
    switch (type_) {
      ...
      case OrgGeogebraCommonKernelKernelNDGeoQuadricNDConstants_QUADRIC_CYLINDER:
      default:
      coeffs = [IOSDoubleArray newArrayWithLength:10];
...
withOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)point {
  {
    ...
    switch (type_) {
      case OrgGeogebraCommonKernelKernelNDGeoQuadricNDConstants_QUADRIC_SPHERE:
      (void) [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(point)) setMulPointWithOrgGeogebraCommonKernelMatrixCoordMatrix:eigenMatrix_ withDouble:JavaLangMath_cosWithDouble_(u) * JavaLangMath_cosWithDouble_(v) withDouble:JavaLangMath_sinWithDouble_(u) * JavaLangMath_cosWithDouble_(v) withDouble:JavaLangMath_sinWithDouble_(v)];
      break;
      case OrgGeogebraCommonKernelKernelNDGeoQuadricNDConstants_QUADRIC_CONE:
      v2 = JavaLangMath_absWithDouble_(v);
      (void) [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(point)) setMulPointWithOrgGeogebraCommonKernelMatrixCoordMatrix:eigenMatrix_ withDouble:JavaLangMath_cosWithDouble_(u) * v2 withDouble:JavaLangMath_sinWithDouble_(u) * v2 withDouble:v];
      break;
      case OrgGeogebraCommonKernelKernelNDGeoQuadricNDConstants_QUADRIC_CYLINDER:
      (void) [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(point)) setMulPointWithOrgGeogebraCommonKernelMatrixCoordMatrix:eigenMatrix_ withDouble:JavaLangMath_cosWithDouble_(u) withDouble:JavaLangMath_sinWithDouble_(u) withDouble:v];
      break;
...
- (OrgGeogebraCommonKernelMatrixCoords *)evaluateNormalWithDouble:(jdouble)u
  ...
  OrgGeogebraCommonKernelMatrixCoords *n;
  {
    ...
    switch (type_) {
      case OrgGeogebraCommonKernelKernelNDGeoQuadricNDConstants_QUADRIC_SPHERE:
      return new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_(JavaLangMath_cosWithDouble_(u) * JavaLangMath_cosWithDouble_(v), JavaLangMath_sinWithDouble_(u) * JavaLangMath_cosWithDouble_(v), JavaLangMath_sinWithDouble_(v), 0);
      case OrgGeogebraCommonKernelKernelNDGeoQuadricNDConstants_QUADRIC_CONE:
...
- (IOSObjectArray *)getNormalProjectionWithOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)coords {
  ...
  return [IOSObjectArray newArrayWithObjects:(id[]){ [self getPointWithDouble:IOSDoubleArray_Get(nil_chk(tmpDouble2_), 0) withDouble:IOSDoubleArray_Get(tmpDouble2_, 1)], new_OrgGeogebraCommonKernelMatrixCoords_initWithDoubleArray_(tmpDouble2_) } count:2 type:OrgGeogebraCommonKernelMatrixCoords_class_()];
}
...
- (IOSObjectArray *)getProjectionWithOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)oldCoords
  ...
  if (tmpMatrix4x2_ == nil) {
    tmpMatrix4x2_ = new_OrgGeogebraCommonKernelMatrixCoordMatrix_initWithInt_withInt_(4, 2);
  }
  ...
  if (tmpMatrix2x4_ == nil) {
    tmpMatrix2x4_ = new_OrgGeogebraCommonKernelMatrixCoordMatrix_initWithInt_withInt_(2, 4);
  }
...
- (void)getProjectionsWithOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)oldCoords
  ...
  if (Delta >= 0) {
    jdouble t1 = (-b - JavaLangMath_sqrtWithDouble_(Delta)) / a;
    jdouble t2 = (-b + JavaLangMath_sqrtWithDouble_(Delta)) / a;
    (void) [tmpCoords_ setAddWithOrgGeogebraCommonKernelMatrixCoords:willingCoords withOrgGeogebraCommonKernelMatrixCoords:[((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(tmpCoords_)) setMulWithOrgGeogebraCommonKernelMatrixCoords:willingDirection withDouble:t1]];
    ...
    (void) [tmpCoords_ setAddWithOrgGeogebraCommonKernelMatrixCoords:willingCoords withOrgGeogebraCommonKernelMatrixCoords:[tmpCoords_ setMulWithOrgGeogebraCommonKernelMatrixCoords:willingDirection withDouble:t2]];
    [self getNormalProjectionParametersWithOrgGeogebraCommonKernelMatrixCoords:tmpCoords_ withDoubleArray:tmpDouble2_];
    [self checkParametersWithDoubleArray:tmpDouble2_];
...
- (void)mirrorWithOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)point {
  ...
  for (jint i = 0; i < 3; i++) {
    (void) [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(IOSObjectArray_Get(nil_chk(eigenvecND_), i))) mulInsideWithDouble:-1];
  }
  [self setMatrixFromEigen];
}
...
- (void)dilateWithOrgGeogebraCommonKernelArithmeticNumberValue:(id<OrgGeogebraCommonKernelArithmeticNumberValue>)rval
  ...
  OrgGeogebraCommonKernelMatrixCoords *mp = [self getMidpoint3D];
  (void) [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(mp)) mulInsideWithDouble:r];
...
- (void)getXMLtagsMatrixWithJavaLangStringBuilder:(JavaLangStringBuilder *)sb {
  (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"\t<matrix"];
  for (jint i = 0; i < 10; i++) (void) [sb appendWithNSString:JreStrcat("$I$DC", @" A", i, @"=\"", IOSDoubleArray_Get(nil_chk(matrix_), i), '"')];
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3D class]) {
    OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3D_vars3D_ = [IOSObjectArray newArrayWithObjects:(id[]){ @"x\u00b2", @"y\u00b2", @"z\u00b2", @"x y", @"x z", @"y z", @"x", @"y", @"z" } count:9 type:NSString_class_()];
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3D_initWithOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3D *self, OrgGeogebraCommonKernelConstruction *c) {
  (void) OrgGeogebraCommonKernelKernelNDGeoQuadricND_initWithOrgGeogebraCommonKernelConstruction_withInt_(self, c, 3);
  self->eigenMatrix_ = OrgGeogebraCommonKernelMatrixCoordMatrix4x4_Identity();
  self->volume_ = JavaLangDouble_NaN;
  self->tmpDouble2_ = [IOSDoubleArray newArrayWithLength:2];
  self->tmpDouble2bis_ = [IOSDoubleArray newArrayWithLength:2];
  self->tmpCoords_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4);
  self->eigenvecND_ = [IOSObjectArray newArrayWithLength:3 type:OrgGeogebraCommonKernelMatrixCoords_class_()];
  for (jint i = 0; i < 3; i++) {
    (void) IOSObjectArray_Set(self->eigenvecND_, i, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4));
    [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(IOSObjectArray_Get(self->eigenvecND_, i))) setWithInt:i + 1 withDouble:1];
  }
  self->diagonal_ = [IOSDoubleArray newArrayWithLength:4];
}
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3D_classifyMidpointQuadricWithBoolean_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3D *self, jboolean degenerate) {
  ...
  IOSDoubleArray *coords = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ x, y, z, 1 } count:4];
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3D_initWithOrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3D_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3D *self, OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3D *quadric) {
  (void) OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3D_initWithOrgGeogebraCommonKernelConstruction_(self, [((OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3D *) nil_chk(quadric)) getConstruction]);
...
OrgGeogebraCommonKernelMatrixCoords *OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3D_getDirectionToCenterWithOrgGeogebraCommonKernelMatrixCoords_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3D *self, OrgGeogebraCommonKernelMatrixCoords *p) {
  {
    ...
    switch ([self getType]) {
      ...
      eigenDir = new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_([((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(eigenCoords)) getX], [eigenCoords getY], 0, 0);
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3D_rotateWithOrgGeogebraCommonKernelMatrixCoordMatrix4x4_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3D *self, OrgGeogebraCommonKernelMatrixCoordMatrix4x4 *tm) {
  self->eigenMatrix_ = [((OrgGeogebraCommonKernelMatrixCoordMatrix4x4 *) nil_chk(tm)) mulWithOrgGeogebraCommonKernelMatrixCoordMatrix4x4:self->eigenMatrix_];
  ...
  for (jint i = 0; i < 3; i++) {
    (void) IOSObjectArray_Set(nil_chk(self->eigenvecND_), i, [tm mulWithOrgGeogebraCommonKernelMatrixCoords:IOSObjectArray_Get(self->eigenvecND_, i)]);
  }
