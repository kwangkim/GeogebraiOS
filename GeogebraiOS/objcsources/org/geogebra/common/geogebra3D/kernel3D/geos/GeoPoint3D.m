...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/geogebra3D/kernel3D/geos/GeoPoint3D.java
//
...
- (void)setPathWithOrgGeogebraCommonKernelPath:(id<OrgGeogebraCommonKernelPath>)path {
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_set_path_(self, path);
}
...
- (void)setRegionWithOrgGeogebraCommonKernelRegion:(id<OrgGeogebraCommonKernelRegion>)region {
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_set_region_(self, region);
}
...
- (OrgGeogebraCommonKernelMatrixCoords *)getInhomCoordsInD2 {
  if (inhom2D_ == nil) {
    OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_setAndConsume_inhom2D_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(2));
  }
...
- (OrgGeogebraCommonKernelMatrixCoords *)getCoordsInD2WithOrgGeogebraCommonKernelMatrixCoordSys:(OrgGeogebraCommonKernelMatrixCoordSys *)coordSys {
  ...
  if (tmpCoords1_ == nil) {
    OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_set_tmpCoords1_(self, OrgGeogebraCommonKernelMatrixCoords_createInhomCoorsInD3());
  }
  if ([self hasWillingCoords]) coords = [self getWillingCoords];
  else coords = [self getCoords];
  if (tmpMatrix4x4_ == nil) {
    OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_setAndConsume_tmpMatrix4x4_(self, new_OrgGeogebraCommonKernelMatrixCoordMatrix4x4_init());
  }
  if (coordSys == nil) {
  ...
  if (tmpCoordsLength3_ == nil) {
    OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_setAndConsume_tmpCoordsLength3_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(3));
  }
...
withOrgGeogebraCommonKernelMatrixCoordSys:(OrgGeogebraCommonKernelMatrixCoordSys *)coordsys {
  ...
  else [self setCoordsWithOrgGeogebraCommonKernelMatrixCoords:[new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_([self getX2D], [self getY2D], 0, 1) autorelease] withBoolean:doPathOrRegion];
}
...
- (void)setWillingCoordsWithOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)willingCoords {
  if (self->willingCoords_ == nil) {
    OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_set_willingCoords_(self, OrgGeogebraCommonKernelMatrixCoords_createInhomCoorsInD3());
  }
...
- (void)setWillingDirectionWithOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)willingDirection {
  if (self->willingDirection_ == nil) {
    OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_setAndConsume_willingDirection_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4));
  }
...
- (OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D *)copy__ {
  return [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_initWithOrgGeogebraCommonKernelKernelNDGeoPointND_(self) autorelease];
}
...
- (void)setUndefined {
  [self setCoordsWithOrgGeogebraCommonKernelMatrixCoords:[new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_(JavaLangDouble_NaN, JavaLangDouble_NaN, JavaLangDouble_NaN, JavaLangDouble_NaN) autorelease] withBoolean:NO];
...
- (NSString *)getStartPointXML {
  ...
  if (OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_isAbsoluteStartPoint(self)) {
    [sb appendWithNSString:JreStrcat("$DC", @" x=\"", [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk([self getCoords])) getWithInt:1], '"')];
    [sb appendWithNSString:JreStrcat("$DC", @" y=\"", [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk([self getCoords])) getWithInt:2], '"')];
    [sb appendWithNSString:JreStrcat("$DC", @" z=\"", [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk([self getCoords])) getWithInt:3], '"')];
    [sb appendWithNSString:JreStrcat("$DC", @" w=\"", [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk([self getCoords])) getWithInt:4], '"')];
  }
  else {
...
- (OrgGeogebraCommonKernelLocateableList *)getLocateableList {
  if (locateableList_ == nil) OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_setAndConsume_locateableList_(self, new_OrgGeogebraCommonKernelLocateableList_initWithOrgGeogebraCommonKernelKernelNDGeoPointND_(self));
...
- (void)setLocateableListWithOrgGeogebraCommonKernelLocateableList:(OrgGeogebraCommonKernelLocateableList *)locateableList {
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_set_locateableList_(self, locateableList);
}
...
- (OrgGeogebraCommonGeogebra3DKernel3DGeosGeo3DVec *)getVector {
  return [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeo3DVec_initWithOrgGeogebraCommonKernelKernel_withDouble_withDouble_withDouble_(kernel_, [self getX], [self getY], [self getZ]) autorelease];
}
...
- (void)setMoveNormalDirectionWithOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)d {
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_set_moveNormalDirection_(self, [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(d)) copyVector]);
}
...
- (void)addToSpreadsheetTraceListWithJavaUtilArrayList:(JavaUtilArrayList *)spreadsheetTraceList {
  OrgGeogebraCommonKernelGeosGeoNumeric *xx = [new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons_, [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(inhom_)) getX]) autorelease];
  [((JavaUtilArrayList *) nil_chk(spreadsheetTraceList)) addWithId:xx];
  OrgGeogebraCommonKernelGeosGeoNumeric *yy = [new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons_, [inhom_ getY]) autorelease];
  [spreadsheetTraceList addWithId:yy];
  OrgGeogebraCommonKernelGeosGeoNumeric *zz = [new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons_, [inhom_ getZ]) autorelease];
...
withOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)vn {
  ...
  if (tmpCoords2_ == nil) {
    OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_setAndConsume_tmpCoords2_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4));
  }
  [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(tmpCoords2_)) setSubWithOrgGeogebraCommonKernelMatrixCoords:point withOrgGeogebraCommonKernelMatrixCoords:tmpCoords1_];
  jdouble cos = JavaLangMath_cosWithDouble_(phi);
  jdouble sin = JavaLangMath_sinWithDouble_(phi);
  jdouble l = [vn calcNorm];
  if (tmpCoords3_ == nil) {
    OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_setAndConsume_tmpCoords3_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4));
  }
...
- (jdouble)distanceToPathWithOrgGeogebraCommonKernelPathOrPoint:(id<OrgGeogebraCommonKernelPathOrPoint>)path {
  ...
  if (tmpWillingCoords_ == nil) {
    OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_set_tmpWillingCoords_(self, OrgGeogebraCommonKernelMatrixCoords_createInhomCoorsInD3());
  }
  if (tmpWillingDirection_ == nil) {
    OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_setAndConsume_tmpWillingDirection_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4));
  }
...
- (void)setDrawingMatrixWithOrgGeogebraCommonKernelMatrixCoordMatrix4x4:(OrgGeogebraCommonKernelMatrixCoordMatrix4x4 *)a_drawingMatrix {
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_set_m_drawingMatrix_(self, a_drawingMatrix);
}
...
- (void)setIncidenceListWithJavaUtilArrayList:(JavaUtilArrayList *)list {
  if (list == nil) OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_setAndConsume_incidenceList_(self, new_JavaUtilArrayList_init());
  else OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_setAndConsume_incidenceList_(self, new_JavaUtilArrayList_initWithJavaUtilCollection_(list));
}

- (void)createIncidenceList {
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_setAndConsume_incidenceList_(self, new_JavaUtilArrayList_init());
  [incidenceList_ addWithId:self];
}

- (void)createNonIncidenceList {
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_setAndConsume_nonIncidenceList_(self, new_JavaUtilArrayList_init());
}
...
- (jboolean)addIncidenceWithProbabilisticCheckingWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  ...
  if (([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(geo)) isGeoPoint] && [self isEqualWithOrgGeogebraCommonKernelGeosGeoElement:geo]) || ([geo isPath] && [((id<OrgGeogebraCommonKernelPath>) check_protocol_cast(geo, @protocol(OrgGeogebraCommonKernelPath))) isOnPathWithOrgGeogebraCommonKernelKernelNDGeoPointND:self withDouble:OrgGeogebraCommonKernelKernel_STANDARD_PRECISION])) {
    ...
    for (jint i = 0; i < 5; ++i) {
      ...
      OrgGeogebraCommonKernelGeosGeoElement_updateCascadeUntilWithJavaUtilArrayList_withJavaUtilTreeSet_withOrgGeogebraCommonKernelAlgosAlgoElement_(predList, [new_JavaUtilTreeSet_init() autorelease], [geo getParentAlgorithm]);
      if ([geo isGeoPoint]) {
...
- (void)translateWithOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)v0 {
  ...
  [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(tmpCoords2_)) setMulWithOrgGeogebraCommonKernelMatrixCoords:v0 withDouble:[((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(v_)) getW]];
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_initWithOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D *self, OrgGeogebraCommonKernelConstruction *c) {
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoVec4D_initWithOrgGeogebraCommonKernelConstruction_withInt_(self, c, 4);
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_set_willingCoords_(self, nil);
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_set_willingDirection_(self, nil);
  self->x2D_ = 0;
  self->y2D_ = 0;
  self->z2D_ = 0;
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_set_inhom_(self, OrgGeogebraCommonKernelMatrixCoords_createInhomCoorsInD3());
  ...
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_set_m_drawingMatrix_(self, nil);
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelMatrixCoords_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D *self, OrgGeogebraCommonKernelConstruction *c, NSString *label, OrgGeogebraCommonKernelMatrixCoords *v) {
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_initWithOrgGeogebraCommonKernelConstruction_withNSString_withDouble_withDouble_withDouble_withDouble_(self, c, label, [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(v)) getWithInt:1], [v getWithInt:2], [v getWithInt:3], [v getWithInt:4]);
}
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_setCoordsWithDouble_withDouble_withDouble_withDouble_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D *self, jdouble x, jdouble y, jdouble z, jdouble w) {
  [self setWillingCoordsUndefined];
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_setCoordsWithOrgGeogebraCommonKernelMatrixCoords_(self, [new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_(x, y, z, w) autorelease]);
}
...
OrgGeogebraCommonKernelPathParameter *OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_getPathParameter(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D *self) {
  if (self->pp_ == nil) OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_setAndConsume_pp_(self, new_OrgGeogebraCommonKernelPathParameter_initWithDouble_(0));
  return self->pp_;
}
...
OrgGeogebraCommonKernelRegionParameters *OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_getRegionParameters(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D *self) {
  if (self->regionParameters_ == nil) OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_setAndConsume_regionParameters_(self, new_OrgGeogebraCommonKernelRegionParameters_init());
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_initWithOrgGeogebraCommonKernelKernelNDGeoPointND_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D *self, id<OrgGeogebraCommonKernelKernelNDGeoPointND> point) {
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoVec4D_initWithOrgGeogebraCommonKernelConstruction_(self, [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(((OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(point, [OrgGeogebraCommonKernelGeosGeoElement class])))) getConstruction]);
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_set_willingCoords_(self, nil);
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_set_willingDirection_(self, nil);
  self->x2D_ = 0;
  self->y2D_ = 0;
...
JavaUtilTreeSet *OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_getTempSet() {
  ...
  if (OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_tempSet_ == nil) {
    JreStrongAssignAndConsume(&OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_tempSet_, nil, new_JavaUtilTreeSet_init());
  }
