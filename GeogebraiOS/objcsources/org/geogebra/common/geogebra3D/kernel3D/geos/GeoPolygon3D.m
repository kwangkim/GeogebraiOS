...
- (void)setPoints2DWithOrgGeogebraCommonKernelGeosGeoPointArray:(IOSObjectArray *)points {
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolygon3D_set_points2D_(self, points);
}
...
- (void)setCoordSysWithOrgGeogebraCommonKernelMatrixCoordSys:(OrgGeogebraCommonKernelMatrixCoordSys *)cs {
  ...
  [self setDefined];
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolygon3D_set_coordSys_(self, cs);
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolygon3D_setAndConsume_points2D_(self, [IOSObjectArray newArrayWithLength:((IOSObjectArray *) nil_chk(points_))->size_ type:OrgGeogebraCommonKernelGeosGeoPoint_class_()]);
  for (jint i = 0; i < points_->size_; i++) {
    IOSObjectArray_SetAndConsume(points2D_, i, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withBoolean_([self getConstruction], YES));
  }
  if (coordSys_ == nil) {
    OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolygon3D_setAndConsume_coordSys_(self, new_OrgGeogebraCommonKernelMatrixCoordSys_initWithInt_(2));
    [self updateCoordSys];
  }
}
...
- (void)setPoints3DLength {
  if (points3DArray_ == nil) {
    OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolygon3D_setAndConsume_points3DArray_(self, new_JavaUtilArrayList_init());
  }
  for (jint i = [((JavaUtilArrayList *) nil_chk(points3DArray_)) size]; i < ((IOSObjectArray *) nil_chk(points2D_))->size_; i++) {
    OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D *point = [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
    [points3DArray_ addWithId:point];
    [point setCanBeRemovedAsInputWithBoolean:NO];
  }
  OrgGeogebraCommonKernelGeosGeoPolygon_setAndConsume_points_(self, [IOSObjectArray newArrayWithLength:points2D_->size_ type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()]);
...
- (jboolean)checkPointsAreOnCoordSys {
  OrgGeogebraCommonKernelMatrixCoords *tmpCoords = [new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4) autorelease];
...
- (void)setOrthoNormalRegionCS {
  [self updateRegionCSWithOrgGeogebraCommonKernelGeosGeoPoint:[new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withDouble_withDouble_withDouble_(cons_, 0, 0, 1) autorelease] withOrgGeogebraCommonKernelGeosGeoPoint:[new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withDouble_withDouble_withDouble_(cons_, 1, 0, 1) autorelease] withOrgGeogebraCommonKernelGeosGeoPoint:[new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_withDouble_withDouble_withDouble_(cons_, 0, 1, 1) autorelease]];
}
...
- (void)pathChangedWithOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)PI {
  ...
  if (segments_ == nil) {
    seg = [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoSegment3D_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
...
- (void)pointChangedWithOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)PI {
  ...
  if (segments_ == nil) {
    segment = [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoSegment3D_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
  }
...
- (OrgGeogebraCommonKernelGeosGeoPolygon *)newGeoPolygonWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)cons {
  return [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolygon3D_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_(cons, nil) autorelease];
}
...
- (void)setEuclidianViewForPlaneWithOrgGeogebraCommonEuclidianEuclidianViewCompanion:(OrgGeogebraCommonEuclidianEuclidianViewCompanion *)view {
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolygon3D_set_euclidianViewForPlane_(self, (OrgGeogebraCommonGeogebra3DEuclidianForPlaneEuclidianViewForPlaneCompanion *) check_class_cast(view, [OrgGeogebraCommonGeogebra3DEuclidianForPlaneEuclidianViewForPlaneCompanion class]));
}
...
- (void)matrixTransformWithDouble:(jdouble)a00
  ...
  if (tmpMatrix4x4_ == nil) {
    OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolygon3D_set_tmpMatrix4x4_(self, OrgGeogebraCommonKernelMatrixCoordMatrix4x4_Identity());
  }
  else {
...
- (void)calcCentroidWithOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)p {
  if (tmp3_GeoPolygon3D_ == nil) {
    OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolygon3D_setAndConsume_tmp3_GeoPolygon3D_(self, [IOSDoubleArray newArrayWithLength:3]);
  }
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolygon3D_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_withOrgGeogebraCommonKernelMatrixCoordSys_withBoolean_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolygon3D *self, OrgGeogebraCommonKernelConstruction *c, IOSObjectArray *points, OrgGeogebraCommonKernelMatrixCoordSys *cs2D, jboolean createSegments) {
  OrgGeogebraCommonKernelGeosGeoPolygon_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_withOrgGeogebraCommonKernelMatrixCoordSys_withBoolean_(self, c, points, cs2D, createSegments);
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolygon3D_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolygon3D *self, OrgGeogebraCommonKernelConstruction *c, IOSObjectArray *points) {
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolygon3D_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_withOrgGeogebraCommonKernelMatrixCoordSys_withBoolean_(self, c, points, nil, YES);
}
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolygon3D_initWithOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolygon3D *self, OrgGeogebraCommonKernelConstruction *cons) {
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolygon3D_initWithOrgGeogebraCommonKernelConstruction_withBoolean_(self, cons, NO);
}
