...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/geogebra3D/kernel3D/geos/GeoConicPart3D.java
//
...
- (OrgGeogebraCommonKernelGeosGeoElement *)copyInternalWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)construction {
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoConicPart3D *ret = [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoConicPart3D_initWithOrgGeogebraCommonKernelConstruction_withInt_(construction, ((OrgGeogebraCommonKernelKernelNDGeoConicPartParameters *) nil_chk(parameters_))->conic_part_type_) autorelease];
...
- (NSString *)toStringWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  ...
  [sbToString_ appendWithNSString:OrgGeogebraCommonGeogebra3DKernel3DGeosGeoConicPart3D_toValueStringWithOrgGeogebraCommonKernelStringTemplate_(self, tpl)];
...
- (OrgGeogebraCommonKernelArithmeticMyDouble *)getNumber {
  return [new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, OrgGeogebraCommonGeogebra3DKernel3DGeosGeoConicPart3D_getValue(self)) autorelease];
}
...
- (OrgGeogebraCommonKernelGeosGeoElement *)copy__ {
  return [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoConicPart3D_initWithOrgGeogebraCommonKernelKernelNDGeoConicPartND_(self) autorelease];
}
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoConicPart3D_initWithOrgGeogebraCommonKernelConstruction_withInt_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoConicPart3D *self, OrgGeogebraCommonKernelConstruction *c, jint type) {
  ...
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoConicPart3D_setAndConsume_sbToString_(self, new_JavaLangStringBuilder_initWithInt_(50));
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoConicPart3D_setAndConsume_tmpCoords_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(3));
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoConicPart3D_setAndConsume_tmpParameters_(self, [IOSDoubleArray newArrayWithLength:2]);
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoConicPart3D_setAndConsume_parameters_(self, new_OrgGeogebraCommonKernelKernelNDGeoConicPartParameters_initWithOrgGeogebraCommonKernelKernelNDGeoConicND_withInt_(self, type));
...
OrgGeogebraCommonKernelPathParameter *OrgGeogebraCommonGeogebra3DKernel3DGeosGeoConicPart3D_getTempPathParameter(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoConicPart3D *self) {
  if (self->tempPP_ == nil) OrgGeogebraCommonGeogebra3DKernel3DGeosGeoConicPart3D_setAndConsume_tempPP_(self, new_OrgGeogebraCommonKernelPathParameter_init());
  return self->tempPP_;
}
