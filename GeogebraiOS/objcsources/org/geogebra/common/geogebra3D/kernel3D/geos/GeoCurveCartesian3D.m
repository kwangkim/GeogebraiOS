...
- (OrgGeogebraCommonKernelMatrixCoords *)evaluateTangentWithDouble:(jdouble)t {
  ...
  OrgGeogebraCommonKernelMatrixCoords *v = [new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(3) autorelease];
...
- (OrgGeogebraCommonKernelMatrixCoords *)evaluateCurve3DWithDouble:(jdouble)t {
  return [new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_([((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk(IOSObjectArray_Get(nil_chk(fun_), 0))) evaluateWithDouble:t], [((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk(IOSObjectArray_Get(fun_, 1))) evaluateWithDouble:t], [((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk(IOSObjectArray_Get(fun_, 2))) evaluateWithDouble:t], 1) autorelease];
}

- (OrgGeogebraCommonKernelMatrixCoords3D *)evaluateTangent3DWithDouble:(jdouble)t {
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D_updateDerivatives(self);
  return [((OrgGeogebraCommonKernelMatrixCoords3D *) [new_OrgGeogebraCommonKernelMatrixCoords3D_initWithDouble_withDouble_withDouble_withDouble_([((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk(IOSObjectArray_Get(nil_chk(funD1_), 0))) evaluateWithDouble:t], [((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk(IOSObjectArray_Get(funD1_, 1))) evaluateWithDouble:t], [((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk(IOSObjectArray_Get(funD1_, 2))) evaluateWithDouble:t], 1) autorelease]) normalize];
}

- (jdouble)evaluateCurvatureWithDouble:(jdouble)t {
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D_updateDerivatives(self);
  OrgGeogebraCommonKernelMatrixCoords *D1 = [new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(3) autorelease];
  OrgGeogebraCommonKernelMatrixCoords *D2 = [new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(3) autorelease];
...
- (OrgGeogebraCommonKernelGeosGeoElement *)copy__ {
  return [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D_initWithOrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D_(self) autorelease];
}
...
- (void)setWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  ...
  for (jint i = 0; i < 2; i++) {
    IOSObjectArray_SetAndConsume(nil_chk(fun_), i, new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticFunction_withOrgGeogebraCommonKernelKernel_([((OrgGeogebraCommonKernelKernelNDGeoCurveCartesianND *) nil_chk(geoCurve)) getFunWithInt:i], kernel_));
  }
  if ([((OrgGeogebraCommonKernelKernelNDGeoCurveCartesianND *) nil_chk(geoCurve)) isGeoElement3D]) {
    IOSObjectArray_SetAndConsume(nil_chk(fun_), 2, new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticFunction_withOrgGeogebraCommonKernelKernel_([geoCurve getFunWithInt:2], kernel_));
  }
  else {
    IOSObjectArray_SetAndConsume(nil_chk(fun_), 2, new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionVariable_([new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, 0) autorelease], [new_OrgGeogebraCommonKernelArithmeticFunctionVariable_initWithOrgGeogebraCommonKernelKernel_withNSString_(kernel_, @"t") autorelease]));
  }
...
- (void)rotateWithOrgGeogebraCommonKernelArithmeticNumberValue:(id<OrgGeogebraCommonKernelArithmeticNumberValue>)r
  ...
  if (tmpMatrix4x4_ == nil) {
    OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D_setAndConsume_tmpMatrix4x4_(self, new_OrgGeogebraCommonKernelMatrixCoordMatrix4x4_init());
  }
...
- (jdouble)getClosestParameterWithOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)P
  ...
  if (distFun_ == nil) OrgGeogebraCommonKernelKernelNDGeoCurveCartesianND_setAndConsume_distFun_(self, new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D_CurveCartesian3DDistanceFunction_initWithOrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D_withOrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D_(self, self));
...
- (OrgGeogebraCommonKernelKernelNDGeoCurveCartesianND *)newGeoCurveCartesianWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)cons {
  return [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D_initWithOrgGeogebraCommonKernelConstruction_(cons) autorelease];
}
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D_initWithOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D *self, OrgGeogebraCommonKernelConstruction *c) {
  OrgGeogebraCommonKernelKernelNDGeoCurveCartesianND_initWithOrgGeogebraCommonKernelConstruction_withInt_(self, c, 3);
}
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D_initWithOrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D *self, OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D *curve) {
  OrgGeogebraCommonKernelKernelNDGeoCurveCartesianND_initWithOrgGeogebraCommonKernelConstruction_withInt_(self, ((OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D *) nil_chk(curve))->cons_, 3);
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D_updateDerivatives(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D *self) {
  jint dim = 3;
  OrgGeogebraCommonKernelKernelNDGeoCurveCartesianND_setAndConsume_funD1_(self, [IOSObjectArray newArrayWithLength:dim type:OrgGeogebraCommonKernelArithmeticFunction_class_()]);
  OrgGeogebraCommonKernelKernelNDGeoCurveCartesianND_setAndConsume_funD2_(self, [IOSObjectArray newArrayWithLength:dim type:OrgGeogebraCommonKernelArithmeticFunction_class_()]);
  for (jint i = 0; i < dim; i++) {
    IOSObjectArray_Set(self->funD1_, i, [((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk([self getFunWithInt:i])) getDerivativeWithInt:1 withBoolean:YES]);
    IOSObjectArray_Set(self->funD2_, i, [((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk([self getFunWithInt:i])) getDerivativeWithInt:2 withBoolean:YES]);
  }
}
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D_transformWithOrgGeogebraCommonKernelMatrixCoordMatrix4x4_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D *self, OrgGeogebraCommonKernelMatrixCoordMatrix4x4 *m) {
  IOSObjectArray *expr = [IOSObjectArray arrayWithLength:3 type:OrgGeogebraCommonKernelArithmeticExpressionNode_class_()];
  for (jint i = 0; i < 3; i++) {
    IOSObjectArray_Set(expr, i, [((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk(([((OrgGeogebraCommonKernelArithmeticFunction *) nil_chk(IOSObjectArray_Get(nil_chk(self->fun_), i))) deepCopyWithOrgGeogebraCommonKernelKernel:self->kernel_]))) getExpression]);
  }
  for (jint row = 0; row < 3; row++) {
    IOSObjectArray *coeff = [IOSObjectArray arrayWithLength:4 type:OrgGeogebraCommonKernelArithmeticMyDouble_class_()];
    for (jint i = 0; i < 4; i++) {
      IOSObjectArray_SetAndConsume(coeff, i, new_OrgGeogebraCommonKernelArithmeticMyDouble_initWithOrgGeogebraCommonKernelKernel_withDouble_(self->kernel_, [((OrgGeogebraCommonKernelMatrixCoordMatrix4x4 *) nil_chk(m)) getWithInt:row + 1 withInt:i + 1]));
    }
    OrgGeogebraCommonKernelArithmeticExpressionNode *trans = [new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(self->kernel_, IOSObjectArray_Get(coeff, 3)) autorelease];
    for (jint i = 0; i < 3; i++) {
...
- (void)setDistantPointWithOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)p {
  if ([((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(p)) isGeoElement3D]) {
    ...
    if ([p3D hasWillingCoords]) {
      OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D_CurveCartesian3DDistanceFunction_set_distCoords_(self, [p3D getWillingCoords]);
    }
    else {
      OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D_CurveCartesian3DDistanceFunction_set_distCoords_(self, [p3D getInhomCoordsInD3]);
    }
    OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D_CurveCartesian3DDistanceFunction_set_distDirection_(self, [p3D getWillingDirection]);
  }
  else {
    OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D_CurveCartesian3DDistanceFunction_set_distCoords_(self, [p getInhomCoordsInD3]);
    OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D_CurveCartesian3DDistanceFunction_set_distDirection_(self, nil);
  }
}
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D_CurveCartesian3DDistanceFunction_initWithOrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D_withOrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D_CurveCartesian3DDistanceFunction *self, OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D *outer$, OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D *curve) {
  NSObject_init(self);
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D_CurveCartesian3DDistanceFunction_set_curve_(self, curve);
}
