...
- (void)setCoordsWithDoubleArray:(IOSDoubleArray *)vals {
  ...
  if (matrix_ == nil) matrix_ = new_OrgGeogebraCommonKernelMatrixCoordMatrix_initWithInt_withInt_(4, 2);
...
- (void)updateStartPointPosition {
  ...
  labelPosition_ = [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk([((OrgGeogebraCommonKernelMatrixCoordMatrix *) nil_chk(matrix_)) getOrigin])) addWithOrgGeogebraCommonKernelMatrixCoords:[((OrgGeogebraCommonKernelMatrixCoords *) nil_chk([matrix_ getVx])) mulWithDouble:0.5]];
}
...
- (OrgGeogebraCommonKernelGeosGeoElement *)copy__ {
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoVector3D *ret = new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoVector3D_initWithOrgGeogebraCommonKernelConstruction_([self getConstruction]);
...
- (NSString *)toStringWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  ...
  (void) [sbToString_GeoVector3D_ appendWithNSString:label_];
  switch ([((OrgGeogebraCommonKernelStringTemplate *) nil_chk(tpl)) getCoordStyleWithInt:[((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) getCoordStyle]]) {
    ...
    (void) [sbToString_GeoVector3D_ appendWithNSString:@": "];
    case OrgGeogebraCommonKernelKernel_COORD_STYLE_AUSTRIAN:
    break;
    default:
    (void) [sbToString_GeoVector3D_ appendWithNSString:@" = "];
  }
  (void) [sbToString_GeoVector3D_ appendWithJavaLangCharSequence:OrgGeogebraCommonGeogebra3DKernel3DGeosGeoVector3D_buildValueStringWithOrgGeogebraCommonKernelStringTemplate_(self, tpl)];
...
- (void)getXMLtagsWithJavaLangStringBuilder:(JavaLangStringBuilder *)sb {
  ...
  if (startPoint_ != nil) {
    (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:[startPoint_ getStartPointXML]];
  }
}
...
- (OrgGeogebraCommonGeogebra3DKernel3DGeosGeo3DVec *)getVector {
  return new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeo3DVec_initWithOrgGeogebraCommonKernelKernel_withDouble_withDouble_withDouble_(kernel_, [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(v_)) getX], [v_ getY], [v_ getZ]);
}

- (IOSDoubleArray *)getPointAsDouble {
  IOSDoubleArray *ret = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(v_)) getX], [v_ getY], [v_ getZ] } count:3];
  return ret;
}
...
- (void)addToSpreadsheetTraceListWithJavaUtilArrayList:(JavaUtilArrayList *)spreadsheetTraceList {
  OrgGeogebraCommonKernelGeosGeoNumeric *xx = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons_, [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(v_)) getX]);
  [((JavaUtilArrayList *) nil_chk(spreadsheetTraceList)) addWithId:xx];
  OrgGeogebraCommonKernelGeosGeoNumeric *yy = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons_, [v_ getY]);
  [spreadsheetTraceList addWithId:yy];
  OrgGeogebraCommonKernelGeosGeoNumeric *zz = new_OrgGeogebraCommonKernelGeosGeoNumeric_initWithOrgGeogebraCommonKernelConstruction_withDouble_(cons_, [v_ getZ]);
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoVector3D_initWithOrgGeogebraCommonKernelConstruction_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoVector3D *self, OrgGeogebraCommonKernelConstruction *c) {
  (void) OrgGeogebraCommonGeogebra3DKernel3DGeosGeoVec4D_initWithOrgGeogebraCommonKernelConstruction_(self, c);
  self->labelPosition_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_(0, 0, 0, 0);
  self->sbToString_GeoVector3D_ = new_JavaLangStringBuilder_initWithInt_(50);
  self->sbBuildValueString_GeoVector3D_ = new_JavaLangStringBuilder_initWithInt_(50);
  self->matrix_ = new_OrgGeogebraCommonKernelMatrixCoordMatrix_initWithInt_withInt_(4, 2);
  [self setCartesian3D];
}
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoVector3D_initWithOrgGeogebraCommonKernelConstruction_withDouble_withDouble_withDouble_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoVector3D *self, OrgGeogebraCommonKernelConstruction *c, jdouble x, jdouble y, jdouble z) {
  (void) OrgGeogebraCommonGeogebra3DKernel3DGeosGeoVec4D_initWithOrgGeogebraCommonKernelConstruction_withDouble_withDouble_withDouble_withDouble_(self, c, x, y, z, 0);
  self->labelPosition_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_(0, 0, 0, 0);
  self->sbToString_GeoVector3D_ = new_JavaLangStringBuilder_initWithInt_(50);
  self->sbBuildValueString_GeoVector3D_ = new_JavaLangStringBuilder_initWithInt_(50);
  self->matrix_ = new_OrgGeogebraCommonKernelMatrixCoordMatrix_initWithInt_withInt_(4, 2);
...
JavaLangStringBuilder *OrgGeogebraCommonGeogebra3DKernel3DGeosGeoVector3D_buildValueStringWithOrgGeogebraCommonKernelStringTemplate_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoVector3D *self, OrgGeogebraCommonKernelStringTemplate *tpl) {
  ...
  switch ([[((OrgGeogebraCommonKernelStringTemplate *) nil_chk(tpl)) getStringType] ordinal]) {
    ...
    (void) [self->sbBuildValueString_GeoVector3D_ appendWithNSString:@"ggbvect["];
    (void) [self->sbBuildValueString_GeoVector3D_ appendWithNSString:[((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) formatWithDouble:[self getX] withOrgGeogebraCommonKernelStringTemplate:tpl]];
    (void) [self->sbBuildValueString_GeoVector3D_ appendWithChar:','];
    (void) [self->sbBuildValueString_GeoVector3D_ appendWithNSString:[self->kernel_ formatWithDouble:[self getY] withOrgGeogebraCommonKernelStringTemplate:tpl]];
    (void) [self->sbBuildValueString_GeoVector3D_ appendWithChar:','];
    (void) [self->sbBuildValueString_GeoVector3D_ appendWithNSString:[self->kernel_ formatWithDouble:[self getZ] withOrgGeogebraCommonKernelStringTemplate:tpl]];
    (void) [self->sbBuildValueString_GeoVector3D_ appendWithNSString:@"]"];
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoVector3D_setCoordSepWithOrgGeogebraCommonKernelStringTemplate_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoVector3D *self, OrgGeogebraCommonKernelStringTemplate *tpl) {
  switch ([((OrgGeogebraCommonKernelStringTemplate *) nil_chk(tpl)) getCoordStyleWithInt:[((OrgGeogebraCommonKernelKernel *) nil_chk(self->kernel_)) getCoordStyle]]) {
    case OrgGeogebraCommonKernelKernel_COORD_STYLE_AUSTRIAN:
    (void) [((JavaLangStringBuilder *) nil_chk(self->sbBuildValueString_GeoVector3D_)) appendWithNSString:@" | "];
    break;
    default:
    (void) [((JavaLangStringBuilder *) nil_chk(self->sbBuildValueString_GeoVector3D_)) appendWithNSString:@", "];
  }
