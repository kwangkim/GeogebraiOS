...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/geogebra3D/kernel3D/geos/GeoPlane3D.java
//
...
- (OrgGeogebraCommonKernelMatrixCoordMatrix *)getParametricMatrix {
  ...
  if (parametricMatrix_ == nil) {
    parametricMatrix_ = new_OrgGeogebraCommonKernelMatrixCoordMatrix_initWithInt_withInt_(4, 3);
  }
...
- (OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D *)copy__ {
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D *p = new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D_initWithOrgGeogebraCommonKernelConstruction_(cons_);
...
- (NSString *)toStringWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  ...
  (void) [sbToString appendWithJavaLangCharSequence:OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D_buildValueStringWithOrgGeogebraCommonKernelStringTemplate_(self, tpl)];
...
- (void)getXMLtagsWithJavaLangStringBuilder:(JavaLangStringBuilder *)sb {
  ...
  (void) [sb appendWithDouble:[((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(equation)) getX]];
  (void) [sb appendWithNSString:@"\""];
  (void) [sb appendWithNSString:@" y=\""];
  (void) [sb appendWithDouble:[equation getY]];
  (void) [sb appendWithNSString:@"\""];
  (void) [sb appendWithNSString:@" z=\""];
  (void) [sb appendWithDouble:[equation getZ]];
  (void) [sb appendWithNSString:@"\""];
  (void) [sb appendWithNSString:@" w=\""];
  (void) [sb appendWithDouble:[equation getW]];
  (void) [sb appendWithNSString:@"\""];
  (void) [sb appendWithNSString:@"/>\n"];
  (void) [sb appendWithNSString:@"\t<fading val=\""];
  (void) [sb appendWithFloat:[self getFading]];
  (void) [sb appendWithNSString:@"\"/>\n"];
}
...
- (jdouble)distanceWithSignWithOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)P {
  if (tmpCoords1_ == nil) {
    tmpCoords1_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(3);
  }
  if (tmpCoords2_ == nil) {
    tmpCoords2_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(3);
  }
  (void) [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(tmpCoords1_)) setSubWithOrgGeogebraCommonKernelMatrixCoords:[((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(P)) getInhomCoordsInD3] withOrgGeogebraCommonKernelMatrixCoords:[((OrgGeogebraCommonKernelMatrixCoordSys *) nil_chk([self getCoordSys])) getOrigin]];
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D class]) {
    OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D_Labels_ = [IOSCharArray newArrayWithChars:(jchar[]){ 'p', 'q', 'r' } count:3];
    OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D_VAR_STRING_ = [IOSObjectArray newArrayWithObjects:(id[]){ @"x", @"y", @"z" } count:3 type:NSString_class_()];
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D_initWithOrgGeogebraCommonKernelConstruction_withNSString_withDouble_withDouble_withDouble_withDouble_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, jdouble a, jdouble b, jdouble c, jdouble d) {
  (void) OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D_initWithOrgGeogebraCommonKernelConstruction_(self, cons);
...
void OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D_setEquationWithDouble_withDouble_withDouble_withDouble_withBoolean_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D *self, jdouble a, jdouble b, jdouble c, jdouble d, jboolean makeCoordSys) {
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D_setEquationWithDoubleArray_withBoolean_(self, [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ a, b, c, d } count:4], makeCoordSys);
}
...
JavaLangStringBuilder *OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D_buildValueStringWithOrgGeogebraCommonKernelStringTemplate_(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D *self, OrgGeogebraCommonKernelStringTemplate *tpl) {
  ...
  if ([((OrgGeogebraCommonKernelStringTemplate *) nil_chk(tpl)) hasCASType]) {
    JavaLangStringBuilder *sbTemp = new_JavaLangStringBuilder_init();
    (void) [sbTemp appendWithNSString:@"plane("];
    (void) [sbTemp appendWithJavaLangCharSequence:ret];
