...
- (id<OrgGeogebraCommonKernelManager3DInterface>)newManager3DWithOrgGeogebraCommonKernelKernel:(OrgGeogebraCommonKernelKernel *)kernel {
  return new_OrgGeogebraCommonGeogebra3DKernel3DAlgosManager3D_initWithOrgGeogebraCommonKernelKernel_(kernel);
}
...
- (void)newConstruction {
  cons_ = new_OrgGeogebraCommonGeogebra3DKernel3DConstruction3D_initWithOrgGeogebraCommonGeogebra3DKernel3DKernel3D_(self);
}
...
- (OrgGeogebraCommonIoMyXMLHandler *)newMyXMLHandlerWithOrgGeogebraCommonKernelKernel:(OrgGeogebraCommonKernelKernel *)kernel
  ...
  return new_OrgGeogebraCommonGeogebra3DIoMyXMLHandler3D_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelConstruction_(kernel, construction);
}
...
- (OrgGeogebraCommonKernelArithmeticExpressionNodeEvaluator *)newExpressionNodeEvaluatorWithOrgGeogebraCommonKernelKernel:(OrgGeogebraCommonKernelKernel *)kernel {
  return new_OrgGeogebraCommonGeogebra3DKernel3DArithmeticExpressionNodeEvaluator3D_initWithOrgGeogebraCommonMainLocalization_withOrgGeogebraCommonKernelKernel_([((OrgGeogebraCommonMainApp *) nil_chk(app_)) getLocalization], kernel);
}
...
- (OrgGeogebraCommonKernelCommandsAlgebraProcessor *)newAlgebraProcessorWithOrgGeogebraCommonKernelKernel:(OrgGeogebraCommonKernelKernel *)kernel {
  OrgGeogebraCommonKernelCommandsCommandDispatcher *cd = new_OrgGeogebraCommonGeogebra3DKernel3DCommandsCommandDispatcher3D_initWithOrgGeogebraCommonKernelKernel_(kernel);
  return new_OrgGeogebraCommonGeogebra3DKernel3DCommandsAlgebraProcessor3D_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelCommandsCommandDispatcher_(kernel, cd);
}
...
- (OrgGeogebraCommonKernelGeosGeoElement *)createGeoElementWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)cons1
  ...
  switch ([((NSString *) nil_chk(type)) charAtWithInt:0]) {
    case 'a':
    if ([type isEqual:@"axis3d"]) return new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoAxis3D_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    else if ([type isEqual:@"angle3d"]) return new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoAngle3D_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    case 'c':
    if ([type isEqual:@"conic3d"]) return new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoConic3D_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    else if ([type isEqual:@"curvecartesian3d"]) return new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    case 'l':
    if ([type isEqual:@"line3d"]) return new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoLine3D_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    case 'p':
    ...
    else if ([type isEqual:@"polygon3d"]) return new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolygon3D_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_(cons1, nil);
    else if ([type isEqual:@"plane3d"]) return new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    else if ([type isEqual:@"polyline3d"]) return new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyLine3D_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_(cons1, nil);
    else if ([type isEqual:@"polyhedron"]) return new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    case 'q':
    if ([type isEqual:@"quadric3d"] || [type isEqual:@"quadric"]) {
      return new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3D_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    }
    else if ([type isEqual:@"quadric3dpart"]) return new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3DPart_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    else if ([type isEqual:@"quadric3dlimited"]) return new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3DLimited_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    case 'r':
    if ([type isEqual:@"ray3d"]) return new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoRay3D_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    case 's':
    if ([type isEqual:@"segment3d"]) return new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoSegment3D_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    if ([type isEqual:@"surfacecartesian3d"]) return new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoSurfaceCartesian3D_initWithOrgGeogebraCommonKernelConstruction_(cons1);
    case 'v':
    if ([type isEqual:@"vector3d"]) return new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoVector3D_initWithOrgGeogebraCommonKernelConstruction_(cons1);
  }
...
- (OrgGeogebraCommonKernelGeosGeoElement *)copy3DWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  {
    ...
    switch ([[((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(geo)) getGeoClassType] ordinal]) {
      ...
      return new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_initWithOrgGeogebraCommonKernelKernelNDGeoPointND_((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) check_protocol_cast(geo, @protocol(OrgGeogebraCommonKernelKernelNDGeoPointND)));
      case OrgGeogebraCommonPluginGeoClass_VECTOR:
      v = new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoVector3D_initWithOrgGeogebraCommonKernelConstruction_([geo getConstruction]);
      [v setWithOrgGeogebraCommonKernelGeosGeoElement:geo];
      return v;
      case OrgGeogebraCommonPluginGeoClass_LINE:
      ret = new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoLine3D_initWithOrgGeogebraCommonKernelConstruction_([geo getConstruction]);
      [ret setWithOrgGeogebraCommonKernelGeosGeoElement:geo];
      return ret;
      case OrgGeogebraCommonPluginGeoClass_SEGMENT:
      ret = new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoSegment3D_initWithOrgGeogebraCommonKernelConstruction_([geo getConstruction]);
      [ret setWithOrgGeogebraCommonKernelGeosGeoElement:geo];
      return ret;
      case OrgGeogebraCommonPluginGeoClass_RAY:
      ret = new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoRay3D_initWithOrgGeogebraCommonKernelConstruction_([geo getConstruction]);
      [ret setWithOrgGeogebraCommonKernelGeosGeoElement:geo];
      return ret;
      case OrgGeogebraCommonPluginGeoClass_POLYGON:
      ret = new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolygon3D_initWithOrgGeogebraCommonKernelConstruction_([geo getConstruction]);
      [ret setWithOrgGeogebraCommonKernelGeosGeoElement:geo];
      return ret;
      case OrgGeogebraCommonPluginGeoClass_CONIC:
      return new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoConic3D_initWithOrgGeogebraCommonKernelKernelNDGeoConicND_((OrgGeogebraCommonKernelKernelNDGeoConicND *) check_class_cast(geo, [OrgGeogebraCommonKernelKernelNDGeoConicND class]));
      case OrgGeogebraCommonPluginGeoClass_CONICPART:
      return new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoConicPart3D_initWithOrgGeogebraCommonKernelKernelNDGeoConicPartND_((id<OrgGeogebraCommonKernelKernelNDGeoConicPartND>) check_protocol_cast(geo, @protocol(OrgGeogebraCommonKernelKernelNDGeoConicPartND)));
      default:
...
- (OrgGeogebraCommonKernelGeosGeoElement *)copyInternal3DWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)cons
                                                       withOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  {
    ...
    switch ([[((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(geo)) getGeoClassType] ordinal]) {
      case OrgGeogebraCommonPluginGeoClass_POLYGON:
      poly = new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolygon3D_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_(cons, nil);
...
- (OrgGeogebraCommonKernelAlgosAlgoDispatcher *)newAlgoDispatcherWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)cons1 {
  return new_OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoDispatcher3D_initWithOrgGeogebraCommonKernelConstruction_(cons1);
}
...
- (void)setEuclidianView3DBoundsWithInt:(jint)view
  ...
  if (3 > ((IOSDoubleArray *) nil_chk(self->xmin_))->size_) {
    self->xmin_ = [self prolongWithDoubleArray:self->xmin_ withInt:3];
    self->xmax_ = [self prolongWithDoubleArray:self->xmin_ withInt:3];
    self->ymin_ = [self prolongWithDoubleArray:self->ymin_ withInt:3];
    self->ymax_ = [self prolongWithDoubleArray:self->ymax_ withInt:3];
    self->xscale_ = [self prolongWithDoubleArray:self->xscale_ withInt:3];
    self->yscale_ = [self prolongWithDoubleArray:self->yscale_ withInt:3];
  }
...
- (void)RigidPolygonAddEndOfCommandWithJavaLangStringBuilder:(JavaLangStringBuilder *)sb
  ...
  if (is3D) {
    (void) [((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@"],xOyPlane]"];
  }
  else {
...
- (OrgGeogebraCommonKernelGeosGeoElement *)wrapInVectorWithOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)pt {
  if ([pt isKindOfClass:[OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D class]]) {
    OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoVectorPoint3D *algo = new_OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoVectorPoint3D_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointND_(cons_, pt);
...
void OrgGeogebraCommonGeogebra3DKernel3DKernel3D_initWithOrgGeogebraCommonMainApp_(OrgGeogebraCommonGeogebra3DKernel3DKernel3D *self, OrgGeogebraCommonMainApp *app) {
  (void) OrgGeogebraCommonKernelKernel_initWithOrgGeogebraCommonMainApp_(self, app);
}
