...
- (void)createPolyhedronWithOrgGeogebraCommonKernelKernelNDGeoPointNDArray:(IOSObjectArray *)bottomPoints {
  ...
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronPoints_setAndConsume_points_(self, [IOSObjectArray newArrayWithLength:bottomPointsLength_ + 1 type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()]);
...
- (void)updateOutputWithInt:(jint)newBottomPointsLength {
  ...
  if (newBottomPointsLength > nOld) {
    ...
    IOSObjectArray *p = [IOSObjectArray arrayWithLength:3 type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()];
    ...
    IOSObjectArray *s = [IOSObjectArray arrayWithLength:3 type:OrgGeogebraCommonKernelKernelNDGeoSegmentND_class_()];
...
- (void)initCoords {
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronPointsPyramid_setAndConsume_bottomCenter_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4));
}
...
- (void)updateOutputPoints {
  ...
  OrgGeogebraCommonKernelMatrixCoords *bottomCenter1 = [new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4) autorelease];
  ...
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronPointsPyramid_set_bottomCenter_(self, [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(bottomCenter1)) mulWithDouble:(jdouble) 1 / (bottomPoints->size_)]);
  if (height_ != nil) {
