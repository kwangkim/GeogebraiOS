...
- (void)createMaxDistances {
  ...
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoLocus3D_setAndConsume_maxZdist_(self, [IOSDoubleArray newArrayWithLength:3]);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoLocus3D_setAndConsume_farZmin_(self, [IOSDoubleArray newArrayWithLength:3]);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoLocus3D_setAndConsume_farZmax_(self, [IOSDoubleArray newArrayWithLength:3]);
}
...
- (void)createStartPosWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)cons {
  OrgGeogebraCommonKernelAlgosAlgoLocusND_setAndConsume_QstartPos_(self, new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_initWithOrgGeogebraCommonKernelConstruction_(cons));
  if ([((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(movingPoint_)) isGeoElement3D]) {
    OrgGeogebraCommonKernelAlgosAlgoLocusND_setAndConsume_PstartPos_(self, new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_initWithOrgGeogebraCommonKernelConstruction_(cons));
  }
  else {
...
- (OrgGeogebraCommonGeogebra3DKernel3DGeosGeoLocus3D *)newGeoLocusWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)cons {
  return [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoLocus3D_initWithOrgGeogebraCommonKernelConstruction_(cons) autorelease];
}
...
- (IOSObjectArray *)createQCopyCache {
  return [IOSObjectArray arrayWithLength:((IOSDoubleArray *) nil_chk(paramCache_))->size_ type:OrgGeogebraCommonGeogebra3DKernel3DMyPoint3D_class_()];
}
...
- (OrgGeogebraCommonGeogebra3DKernel3DMyPoint3D *)newCache {
  return [new_OrgGeogebraCommonGeogebra3DKernel3DMyPoint3D_init() autorelease];
}
