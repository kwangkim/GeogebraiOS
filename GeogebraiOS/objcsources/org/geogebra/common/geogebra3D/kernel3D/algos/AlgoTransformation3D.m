...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/geogebra3D/kernel3D/algos/AlgoTransformation3D.java
//
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoTransformation3D_toGeoCurveCartesianWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelGeosGeoFunction_withOrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D_(OrgGeogebraCommonKernelKernel *kernel, OrgGeogebraCommonKernelGeosGeoFunction *geoFun, OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D *curve) {
  ...
  OrgGeogebraCommonKernelArithmeticFunctionVariable *t = [new_OrgGeogebraCommonKernelArithmeticFunctionVariable_initWithOrgGeogebraCommonKernelKernel_withNSString_(kernel, @"t") autorelease];
  ...
  IOSObjectArray *fun = [IOSObjectArray arrayWithLength:3 type:OrgGeogebraCommonKernelArithmeticFunction_class_()];
  IOSObjectArray_SetAndConsume(fun, 0, new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionVariable_([new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel, t) autorelease], t));
  IOSObjectArray_SetAndConsume(fun, 1, new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionVariable_(yExp, t));
  IOSObjectArray_SetAndConsume(fun, 2, new_OrgGeogebraCommonKernelArithmeticFunction_initWithOrgGeogebraCommonKernelArithmeticExpressionNode_withOrgGeogebraCommonKernelArithmeticFunctionVariable_([new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel, 0) autorelease], t));
