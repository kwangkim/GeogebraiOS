...
- (id<OrgGeogebraCommonKernelKernelNDGeoPointND>)newGeoPointWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)cons {
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolarPoint3D_setAndConsume_polar2D_(self, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons));
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolarPoint3D_setAndConsume_polarCoords_(self, [IOSDoubleArray newArrayWithLength:3]);
...
- (void)compute {
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolarPoint3D_set_equation2D_(self, [((id<OrgGeogebraCommonKernelKernelNDGeoLineND>) nil_chk(line_)) getCartesianEquationVectorWithOrgGeogebraCommonKernelMatrixCoordMatrix:[((OrgGeogebraCommonKernelMatrixCoordSys *) nil_chk([((OrgGeogebraCommonKernelKernelNDGeoConicND *) nil_chk(c_)) getCoordSys])) getMatrixOrthonormal]]);
  if (equation2D_ == nil) {
