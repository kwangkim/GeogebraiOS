...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/geogebra3D/kernel3D/algos/AlgoJoinPoints3D.java
//
...
- (void)setInputOutput {
  if (poly_ == nil) {
    [self setInputOutputWithOrgGeogebraCommonKernelGeosGeoElementArray:[IOSObjectArray arrayWithObjects:(id[]){ (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(P_, [OrgGeogebraCommonKernelGeosGeoElement class]), (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(Q_, [OrgGeogebraCommonKernelGeosGeoElement class]) } count:2 type:OrgGeogebraCommonKernelGeosGeoElement_class_()] withOrgGeogebraCommonKernelGeosGeoElementArray:[IOSObjectArray arrayWithObjects:(id[]){ cs_ } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()]];
  }
  else {
    [self setInputOutputWithOrgGeogebraCommonKernelGeosGeoElementArray:[IOSObjectArray arrayWithObjects:(id[]){ (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(P_, [OrgGeogebraCommonKernelGeosGeoElement class]), (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(Q_, [OrgGeogebraCommonKernelGeosGeoElement class]), poly_ } count:3 type:OrgGeogebraCommonKernelGeosGeoElement_class_()] withOrgGeogebraCommonKernelGeosGeoElementArray:[IOSObjectArray arrayWithObjects:(id[]){ (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(P_, [OrgGeogebraCommonKernelGeosGeoElement class]), (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(Q_, [OrgGeogebraCommonKernelGeosGeoElement class]) } count:2 type:OrgGeogebraCommonKernelGeosGeoElement_class_()] withOrgGeogebraCommonKernelGeosGeoElementArray:[IOSObjectArray arrayWithObjects:(id[]){ cs_ } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()]];
  }
}
...
- (void)modifyInputPointsWithOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)A
  ...
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoJoinPoints3D_set_P_(self, A);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoJoinPoints3D_set_Q_(self, B);
  [((OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCoordSys1D *) nil_chk(cs_)) setCoordWithOrgGeogebraCommonKernelKernelNDGeoPointND:P_ withOrgGeogebraCommonKernelKernelNDGeoPointND:Q_];
  [self setInputOutput];
  [self compute];
}
...
- (void)modifyInputPolyAndPointsWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)p
  ...
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(input_))->size_; i++) [((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(IOSObjectArray_Get(input_, i))) removeAlgorithmWithOrgGeogebraCommonKernelAlgosAlgoElement:self];
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoJoinPoints3D_set_poly_(self, p);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoJoinPoints3D_set_P_(self, A);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoJoinPoints3D_set_Q_(self, B);
  [((OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCoordSys1D *) nil_chk(cs_)) setCoordWithOrgGeogebraCommonKernelKernelNDGeoPointND:P_ withOrgGeogebraCommonKernelKernelNDGeoPointND:Q_];
  [self setInputOutput];
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoJoinPoints3D_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonPluginGeoClassEnum_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoJoinPoints3D *self, OrgGeogebraCommonKernelConstruction *cons, id<OrgGeogebraCommonKernelKernelNDGeoPointND> P, id<OrgGeogebraCommonKernelKernelNDGeoPointND> Q, OrgGeogebraCommonKernelGeosGeoElement *poly, OrgGeogebraCommonPluginGeoClassEnum *geoClassType) {
  ...
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoJoinPoints3D_set_P_(self, P);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoJoinPoints3D_set_Q_(self, Q);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoJoinPoints3D_set_poly_(self, poly);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoJoinPoints3D_set_geoClassType_(self, geoClassType);
  switch ([geoClassType ordinal]) {
    case OrgGeogebraCommonPluginGeoClass_SEGMENT3D:
    OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoJoinPoints3D_setAndConsume_cs_(self, new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoSegment3D_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_(cons, P, Q));
    if (poly != nil) {
    ...
    break;
    case OrgGeogebraCommonPluginGeoClass_LINE3D:
    OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoJoinPoints3D_setAndConsume_cs_(self, new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoLine3D_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_(cons, P, Q));
    break;
    case OrgGeogebraCommonPluginGeoClass_RAY3D:
    OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoJoinPoints3D_setAndConsume_cs_(self, new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoRay3D_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_(cons, P, Q));
    break;
    default:
    OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoJoinPoints3D_set_cs_(self, nil);
  }
  [self setInputOutput];
  [self compute];
}
