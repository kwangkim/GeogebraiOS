...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/geogebra3D/kernel3D/algos/AlgoIntersectPlaneQuadricPart.java
//
...
- (void)end {
  if ([[((OrgGeogebraCommonKernelKernelNDGeoQuadricND *) nil_chk(quadric_)) getParentAlgorithm] isKindOfClass:[OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoQuadricSide class]]) {
    ...
    OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectPlaneQuadricPart_set_bottom_(self, [((OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3DLimited *) nil_chk(parent)) getBottom]);
    OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectPlaneQuadricPart_set_top_(self, [parent getTop]);
  }
  else {
    jboolean oldSilentMode = [((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) isSilentMode];
    [kernel_ setSilentModeWithBoolean:YES];
    OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectPlaneQuadricPart_setAndConsume_algoEnds_(self, new_OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoQuadricEnds_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoQuadricND_(cons_, quadric_));
    OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectPlaneQuadricPart_set_bottom_(self, [algoEnds_ getSection1]);
    OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectPlaneQuadricPart_set_top_(self, [algoEnds_ getSection2]);
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectPlaneQuadricPart_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D_withOrgGeogebraCommonKernelKernelNDGeoQuadricND_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectPlaneQuadricPart *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D *plane, OrgGeogebraCommonKernelKernelNDGeoQuadricND *quadric) {
  ...
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectPlaneQuadricPart_set_algoEnds_(self, nil);
}
