...
- (void)createEnds {
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoQuadricEnds *algo2 = new_OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoQuadricEnds_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoQuadricND_(cons_, [self getQuadric]);
  ...
  bottom_ = [algo2 getSection1];
  top_ = [algo2 getSection2];
}
