...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/geogebra3D/kernel3D/algos/AlgoTangentCurve3D.java
//
...
- (void)initialize__WithOrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D:(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D *)f1 {
  ...
  if ([[((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(P_)) getParentAlgorithm] isKindOfClass:[OrgGeogebraCommonKernelAlgosAlgoPointOnPath class]]) {
    ...
    if ([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk(en)) getOperation] == OrgGeogebraCommonPluginOperationEnum_get_VEC_FUNCTION() && [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk([en getLeft])) unwrap] == f_) {
      ...
      pointOnCurveSpecialParam_ = [((id<OrgGeogebraCommonKernelArithmeticExpressionValue>) nil_chk([en getRight])) unwrap];
    }
  }
  if (pointOnCurve_ || pointOnCurveSpecial_) {
    ...
    T_ = new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_initWithOrgGeogebraCommonKernelConstruction_(cons_);
  }
  ...
  algo_ = new_OrgGeogebraCommonKernelCasAlgoDerivative_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosCasEvaluableFunction_withBoolean_(cons_, f_, YES);
  self->df_ = (OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D *) check_class_cast([algo_ getResult], [OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D class]);
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoTangentCurve3D_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoTangentCurve3D *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, id<OrgGeogebraCommonKernelKernelNDGeoPointND> P, OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCurveCartesian3D *f) {
  (void) OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoLinePoint_initWithOrgGeogebraCommonKernelConstruction_(self, cons);
  self->direction_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_(0, 0, 0, 1);
  self->feval_ = [IOSDoubleArray newArrayWithLength:3];
  self->dfeval_ = [IOSDoubleArray newArrayWithLength:3];
  self->tangent_ = new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoLine3D_initWithOrgGeogebraCommonKernelConstruction_(cons);
  self->P_ = P;
