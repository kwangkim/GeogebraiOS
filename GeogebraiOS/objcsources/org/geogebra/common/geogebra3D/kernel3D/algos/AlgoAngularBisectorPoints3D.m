...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/geogebra3D/kernel3D/algos/AlgoAngularBisectorPoints3D.java
//
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAngularBisectorPoints3D_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoDirectionND_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAngularBisectorPoints3D *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, id<OrgGeogebraCommonKernelKernelNDGeoPointND> A, id<OrgGeogebraCommonKernelKernelNDGeoPointND> B, id<OrgGeogebraCommonKernelKernelNDGeoPointND> C, id<OrgGeogebraCommonKernelKernelNDGeoDirectionND> orientation) {
  ...
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAngularBisectorPoints3D_set_A_(self, A);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAngularBisectorPoints3D_set_B_(self, B);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAngularBisectorPoints3D_set_C_(self, C);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAngularBisectorPoints3D_setAndConsume_bisector_(self, new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoLine3D_initWithOrgGeogebraCommonKernelConstruction_(cons));
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAngularBisectorPoints3D_compute(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAngularBisectorPoints3D *self) {
  ...
  if (infiniteB) {
    ...
    [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(v1)) normalize];
