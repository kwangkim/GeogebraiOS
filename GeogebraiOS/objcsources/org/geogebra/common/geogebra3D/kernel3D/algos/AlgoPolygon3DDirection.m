...
- (IOSObjectArray *)createEfficientInput {
  ...
  if (geoList_ != nil) {
    efficientInput = [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    (void) IOSObjectArray_Set(efficientInput, 0, geoList_);
    (void) IOSObjectArray_Set(efficientInput, 1, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(direction_, [OrgGeogebraCommonKernelGeosGeoElement class]));
  }
  else {
    efficientInput = [IOSObjectArray newArrayWithLength:((IOSObjectArray *) nil_chk(points_))->size_ + 1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    ...
    (void) IOSObjectArray_Set(efficientInput, points_->size_, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(direction_, [OrgGeogebraCommonKernelGeosGeoElement class]));
  }
