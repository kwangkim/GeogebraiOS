...
- (OrgGeogebraCommonKernelAlgosAlgoCircleThreePoints *)getAlgo {
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoConicPartCircumcircle3D_setAndConsume_algo_(self, new_OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoCircle3DThreePoints_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_(cons_, A_, B_, C_));
  return algo_;
}
