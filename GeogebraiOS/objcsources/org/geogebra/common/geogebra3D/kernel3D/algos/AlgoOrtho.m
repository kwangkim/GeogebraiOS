...
- (void)setSpecificInputOutput {
  [self setInputOutputWithOrgGeogebraCommonKernelGeosGeoElementArray:[IOSObjectArray arrayWithObjects:(id[]){ (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(point_, [OrgGeogebraCommonKernelGeosGeoElement class]), inputOrtho_ } count:2 type:OrgGeogebraCommonKernelGeosGeoElement_class_()] withOrgGeogebraCommonKernelGeosGeoElementArray:[IOSObjectArray arrayWithObjects:(id[]){ line_ } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()]];
}
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoOrtho_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelGeosGeoElement_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoOrtho *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, id<OrgGeogebraCommonKernelKernelNDGeoPointND> point, OrgGeogebraCommonKernelGeosGeoElement *ortho) {
  ...
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoOrtho_set_point_(self, point);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoOrtho_set_inputOrtho_(self, ortho);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoOrtho_setAndConsume_line_(self, new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoLine3D_initWithOrgGeogebraCommonKernelConstruction_(cons));
