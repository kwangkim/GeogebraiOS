...
- (void)createOutputSegments {
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronPoints_set_outputSegmentsBottom_(self, [self createOutputSegmentsHandler]);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronPoints_set_outputSegmentsSide_(self, [self createOutputSegmentsHandler]);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronPoints_set_outputSegmentsTop_(self, [self createOutputSegmentsHandler]);
}

- (void)createOutputPolygons {
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronPoints_set_outputPolygonsBottom_(self, [self createOutputPolygonsHandler]);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronPoints_set_outputPolygonsSide_(self, [self createOutputPolygonsHandler]);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronPoints_set_outputPolygonsTop_(self, [self createOutputPolygonsHandler]);
}
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronPoints_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronPoints *self, OrgGeogebraCommonKernelConstruction *c, IOSObjectArray *labels, IOSObjectArray *points) {
  ...
  [self initCoords];
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronPoints_setAndConsume_bottomPoints_(self, [IOSObjectArray newArrayWithLength:((IOSObjectArray *) nil_chk(points))->size_ - 1 type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()]);
  ...
  self->shift_ = 1;
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronPoints_createPolyhedron(self);
  OrgGeogebraCommonKernelAlgosAlgoElement_setAndConsume_input_(self, [IOSObjectArray newArrayWithLength:points->size_ type:OrgGeogebraCommonKernelGeosGeoElement_class_()]);
  for (jint i = 0; i < points->size_; i++) IOSObjectArray_Set(self->input_, i, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(IOSObjectArray_Get(points, i), [OrgGeogebraCommonKernelGeosGeoElement class]));
  [self addAlgoToInput];
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronPoints_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelGeosGeoPolygon_withOrgGeogebraCommonKernelKernelNDGeoPointND_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronPoints *self, OrgGeogebraCommonKernelConstruction *c, IOSObjectArray *labels, OrgGeogebraCommonKernelGeosGeoPolygon *polygon, id<OrgGeogebraCommonKernelKernelNDGeoPointND> point) {
  ...
  self->bottomPointsLength_ = -1;
  [self initCoords];
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronPoints_set_bottom_(self, polygon);
  ...
  IOSObjectArray_Set(self->input_, 1, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(self->topPoint_, [OrgGeogebraCommonKernelGeosGeoElement class]));
  [self addAlgoToInput];
  [self updateOutputPoints];
  [self createFaces];
  [self setOutput];
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronPoints_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelGeosGeoPolygon_withOrgGeogebraCommonKernelArithmeticNumberValue_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronPoints *self, OrgGeogebraCommonKernelConstruction *c, IOSObjectArray *labels, OrgGeogebraCommonKernelGeosGeoPolygon *polygon, id<OrgGeogebraCommonKernelArithmeticNumberValue> height) {
  ...
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronPoints_set_bottom_(self, polygon);
  self->bottomAsInput_ = YES;
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronPoints_set_height_(self, height);
  self->shift_ = 0;
  ...
  OrgGeogebraCommonKernelAlgosAlgoElement_setAndConsume_input_(self, [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonKernelGeosGeoElement_class_()]);
  IOSObjectArray_Set(self->input_, 0, self->bottom_);
  IOSObjectArray_Set(self->input_, 1, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(height, [OrgGeogebraCommonKernelGeosGeoElement class]));
  [self addAlgoToInput];
  [self updateOutputPoints];
  [self createFaces];
  [self setOutput];
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronPoints_setTopPointWithOrgGeogebraCommonKernelKernelNDGeoPointND_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronPoints *self, id<OrgGeogebraCommonKernelKernelNDGeoPointND> p) {
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronPoints_set_topPoint_(self, p);
}
