...
- (NSString *)toStringWithOrgGeogebraCommonKernelStringTemplate:(OrgGeogebraCommonKernelStringTemplate *)tpl {
  ...
  if (lhs0z_ == nil) {
    ...
    OrgGeogebraCommonKernelArithmeticFunctionVariable *z = new_OrgGeogebraCommonKernelArithmeticFunctionVariable_initWithOrgGeogebraCommonKernelKernel_withNSString_(kernel_, @"z");
    lhs0z_ = new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, lhs, OrgGeogebraCommonPluginOperationEnum_get_PLUS(), new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonKernelArithmeticExpressionValue_withOrgGeogebraCommonPluginOperationEnum_withOrgGeogebraCommonKernelArithmeticExpressionValue_(kernel_, new_OrgGeogebraCommonKernelArithmeticExpressionNode_initWithOrgGeogebraCommonKernelKernel_withDouble_(kernel_, 0), OrgGeogebraCommonPluginOperationEnum_get_MULTIPLY(), z));
  }
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoDependentPlane3D_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticEquation_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoDependentPlane3D *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelArithmeticEquation *equ) {
  (void) OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoElement3D_initWithOrgGeogebraCommonKernelConstruction_withBoolean_(self, cons, NO);
  self->ev_ = [IOSObjectArray newArrayWithLength:4 type:OrgGeogebraCommonKernelArithmeticExpressionValue_class_()];
  self->lhs0z_ = nil;
  self->equation_ = equ;
  ...
  (void) IOSObjectArray_Set(self->ev_, 2, [lhs getCoefficientWithNSString:@"z"]);
  (void) IOSObjectArray_Set(self->ev_, 3, [lhs getConstantCoefficient]);
  for (jint i = 0; i < 4; i++) {
  ...
  self->p_ = new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D_initWithOrgGeogebraCommonKernelConstruction_(cons);
  [self setInputOutput];
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoDependentPlane3D_compute(self);
