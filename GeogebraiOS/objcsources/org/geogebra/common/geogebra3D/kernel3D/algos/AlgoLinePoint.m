...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoLinePoint_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelGeosGeoElement_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoLinePoint *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, id<OrgGeogebraCommonKernelKernelNDGeoPointND> point, OrgGeogebraCommonKernelGeosGeoElement *inputParallel) {
  ...
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoLinePoint_set_point_(self, point);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoLinePoint_set_inputParallel_(self, inputParallel);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoLinePoint_set_line_(self, [self createLineWithOrgGeogebraCommonKernelConstruction:cons]);
  [self setInputOutputWithOrgGeogebraCommonKernelGeosGeoElementArray:[IOSObjectArray arrayWithObjects:(id[]){ (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(point, [OrgGeogebraCommonKernelGeosGeoElement class]), inputParallel } count:2 type:OrgGeogebraCommonKernelGeosGeoElement_class_()] withOrgGeogebraCommonKernelGeosGeoElementArray:[IOSObjectArray arrayWithObjects:(id[]){ self->line_ } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()]];
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoLinePoint_compute(self);
