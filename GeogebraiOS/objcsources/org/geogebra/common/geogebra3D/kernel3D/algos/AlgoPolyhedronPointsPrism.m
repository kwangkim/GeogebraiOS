...
- (void)createPolyhedronWithOrgGeogebraCommonKernelKernelNDGeoPointNDArray:(IOSObjectArray *)bottomPoints {
  ...
  points_ = [IOSObjectArray newArrayWithLength:bottomPointsLength_ * 2 type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()];
  ...
  for (jint i = 0; i < bottomPointsLength_ - 1; i++) {
    ...
    (void) IOSObjectArray_Set(points_, bottomPointsLength_ + 1 + i, point);
  }
...
- (void)updateOutputWithInt:(jint)newBottomPointsLength {
  ...
  if (newBottomPointsLength > nOld) {
    ...
    IOSObjectArray *p = [IOSObjectArray newArrayWithLength:newBottomPointsLength type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()];
    (void) IOSObjectArray_Set(p, 0, [self getTopPoint]);
    for (jint i = 0; i < newBottomPointsLength - 1; i++) (void) IOSObjectArray_Set(p, 1 + i, [self getTopPointWithInt:i + 1]);
    ...
    [polygon setSegmentsWithOrgGeogebraCommonKernelKernelNDGeoSegmentNDArray:[outputSegmentsTop_ getOutputWithOrgGeogebraCommonKernelGeosGeoElementArray:[IOSObjectArray newArrayWithLength:newBottomPointsLength type:OrgGeogebraCommonGeogebra3DKernel3DGeosGeoSegment3D_class_()]]];
    [polygon calcArea];
    ...
    p = [IOSObjectArray newArrayWithLength:4 type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()];
    ...
    (void) IOSObjectArray_Set(p, 3, [self getTopPointWithInt:newBottomPointsLength - 1]);
    ...
    (void) IOSObjectArray_Set(s, 1, [((OrgGeogebraCommonKernelAlgosAlgoElement_OutputHandler *) nil_chk(outputSegmentsSide_)) getElementWithInt:0]);
    (void) IOSObjectArray_Set(s, 2, [outputSegmentsTop_ getElementWithInt:newBottomPointsLength - 1]);
    (void) IOSObjectArray_Set(s, 3, [outputSegmentsSide_ getElementWithInt:newBottomPointsLength - 1]);
...
- (void)updateOutputPoints {
  if (height_ == nil) uptranslation_ = [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk([((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk([self getTopPoint])) getInhomCoordsInD3])) subWithOrgGeogebraCommonKernelMatrixCoords:[((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(IOSObjectArray_Get(nil_chk([self getBottomPoints]), 0))) getInhomCoordsInD3]];
  else uptranslation_ = [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk([((OrgGeogebraCommonKernelMatrixCoords *) nil_chk([((OrgGeogebraCommonKernelGeosGeoPolygon *) nil_chk(bottom_)) getMainDirection])) normalized])) mulWithDouble:[height_ getDouble]];
  IOSObjectArray *bottomPoints = [self getBottomPoints];
  if (bottomPoints != nil) {
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronPointsPrism_updateTopWithInt_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronPointsPrism *self, jint n) {
  OrgGeogebraCommonKernelGeosGeoPolygon *polygon = [self getTopFace];
  IOSObjectArray *p = [IOSObjectArray newArrayWithLength:n type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()];
  (void) IOSObjectArray_Set(p, 0, [self getTopPoint]);
  for (jint i = 0; i < n - 1; i++) (void) IOSObjectArray_Set(p, 1 + i, [self getTopPointWithInt:i + 1]);
  [((OrgGeogebraCommonKernelGeosGeoPolygon *) nil_chk(polygon)) modifyInputPointsWithOrgGeogebraCommonKernelKernelNDGeoPointNDArray:p];
  [polygon setSegmentsWithOrgGeogebraCommonKernelKernelNDGeoSegmentNDArray:[((OrgGeogebraCommonKernelAlgosAlgoElement_OutputHandler *) nil_chk(self->outputSegmentsTop_)) getOutputWithOrgGeogebraCommonKernelGeosGeoElementArray:[IOSObjectArray newArrayWithLength:n type:OrgGeogebraCommonGeogebra3DKernel3DGeosGeoSegment3D_class_()]]];
  [polygon calcArea];
}
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronPointsPrism_updateSideWithInt_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_withOrgGeogebraCommonKernelKernelNDGeoSegmentNDArray_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronPointsPrism *self, jint index, IOSObjectArray *bottomPoints, IOSObjectArray *bottomSegments) {
  ...
  IOSObjectArray *p = [IOSObjectArray newArrayWithLength:4 type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()];
  ...
  (void) IOSObjectArray_Set(p, 2, [self getTopPointWithInt:index]);
  (void) IOSObjectArray_Set(p, 3, [self getTopPointWithInt:index - 1]);
  [((OrgGeogebraCommonKernelGeosGeoPolygon *) nil_chk(polygon)) modifyInputPointsWithOrgGeogebraCommonKernelKernelNDGeoPointNDArray:p];
  IOSObjectArray *s = [IOSObjectArray newArrayWithLength:4 type:OrgGeogebraCommonKernelKernelNDGeoSegmentND_class_()];
  ...
  (void) IOSObjectArray_Set(s, 2, [self->outputSegmentsTop_ getElementWithInt:index - 1]);
  (void) IOSObjectArray_Set(s, 3, [self->outputSegmentsSide_ getElementWithInt:index - 1]);
  [polygon setSegmentsWithOrgGeogebraCommonKernelKernelNDGeoSegmentNDArray:s];
  [polygon calcArea];
}
