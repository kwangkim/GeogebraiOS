...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/geogebra3D/kernel3D/algos/AlgoConicPartCircle3D.java
//
...
- (void)initCoords {
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoConicPartCircle3D_setAndConsume_p2d_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4));
}
...
- (void)setInputWithInt:(jint)n {
  OrgGeogebraCommonKernelAlgosAlgoElement_setAndConsume_input_(self, [IOSObjectArray newArrayWithLength:n type:OrgGeogebraCommonKernelGeosGeoElement_class_()]);
  IOSObjectArray_Set(input_, 0, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(center_, [OrgGeogebraCommonKernelGeosGeoElement class]));
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoConicPartCircle3D_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoDirectionND_withInt_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoConicPartCircle3D *self, OrgGeogebraCommonKernelConstruction *cons, id<OrgGeogebraCommonKernelKernelNDGeoPointND> center, id<OrgGeogebraCommonKernelKernelNDGeoPointND> startPoint, id<OrgGeogebraCommonKernelKernelNDGeoPointND> endPoint, id<OrgGeogebraCommonKernelKernelNDGeoDirectionND> orientation, jint type) {
  ...
  OrgGeogebraCommonKernelAlgosAlgoConicPart_set_conic_(self, [algo getCircle]);
  [self setOrientationWithOrgGeogebraCommonKernelKernelNDGeoDirectionND:orientation];
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoConicPartCircle3D_setAndConsume_paramP_(self, new_OrgGeogebraCommonKernelPathParameter_init());
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoConicPartCircle3D_setAndConsume_paramQ_(self, new_OrgGeogebraCommonKernelPathParameter_init());
  OrgGeogebraCommonKernelAlgosAlgoConicPart_setAndConsume_conicPart_(self, new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoConicPart3D_initWithOrgGeogebraCommonKernelConstruction_withInt_(cons, type));
