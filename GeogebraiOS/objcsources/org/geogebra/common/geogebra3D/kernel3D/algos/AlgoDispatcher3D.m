...
- (id<OrgGeogebraCommonKernelKernelNDGeoVectorND>)createVectorWithNSString:(NSString *)label
  ...
  if ([((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(P)) isGeoElement3D]) {
    OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoVectorPoint3D *algo = [new_OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoVectorPoint3D_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelKernelNDGeoPointND_(cons_, label, P) autorelease];
...
- (OrgGeogebraCommonKernelAlgosAlgoVertexPolygon *)newAlgoVertexPolygonWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)cons1
  ...
  if ([((id<OrgGeogebraCommonKernelGeosGeoPoly>) nil_chk(p)) isGeoElement3D]) {
    return [new_OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoVertexPolygon3D_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelGeosGeoPoly_(cons1, labels, p) autorelease];
  }
...
- (id<OrgGeogebraCommonKernelKernelNDGeoVectorND>)Vector3D {
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoVector3D *v = [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoVector3D_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
...
IOSObjectArray *OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoDispatcher3D_SegmentFixedSphereWithNSString_withNSString_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelArithmeticNumberValue_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoDispatcher3D *self, NSString *pointLabel, NSString *segmentLabel, id<OrgGeogebraCommonKernelKernelNDGeoPointND> A, id<OrgGeogebraCommonKernelArithmeticNumberValue> n) {
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoSpherePointRadius *algoSphere = [new_OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoSpherePointRadius_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelArithmeticNumberValue_(self->cons_, A, n) autorelease];
  ...
  if (self->tmpCoords_ == nil) {
    OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoDispatcher3D_set_tmpCoords_(self, OrgGeogebraCommonKernelMatrixCoords_createInhomCoorsInD3());
  }
  else {
