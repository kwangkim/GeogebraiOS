...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/geogebra3D/kernel3D/algos/AlgoPolyhedronNetPrism.java
//
...
withOrgGeogebraCommonKernelMatrixCoordsArray:(IOSObjectArray *)points {
  if (pp1_ == nil) {
    OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetPrism_setAndConsume_pp1_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4));
  }
  ...
  IOSObjectArray *bottomSegsDirections = [IOSObjectArray arrayWithLength:sz type:OrgGeogebraCommonKernelMatrixCoords_class_()];
  ...
  IOSObjectArray_Set(bottomSegsDirections, sz - 1, [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk([((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(p2)) subWithOrgGeogebraCommonKernelMatrixCoords:p1])) normalized]);
  for (jint i = 0; i < sz - 1; i++) {
    p1 = p2;
    p2 = IOSObjectArray_Get(points, i + 1);
    IOSObjectArray_Set(bottomSegsDirections, i, [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk([((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(p2)) subWithOrgGeogebraCommonKernelMatrixCoords:p1])) normalized]);
  }
...
- (void)updateTopWithInt:(jint)newBottomPointsLength {
  ...
  IOSObjectArray_Set(points, 0, [((OrgGeogebraCommonKernelAlgosAlgoElement_OutputHandler *) nil_chk(outputPointsSide_)) getElementWithInt:0]);
  IOSObjectArray_Set(points, 1, [outputPointsSide_ getElementWithInt:1]);
  for (jint i = 2; i < newBottomPointsLength; i++) {
    IOSObjectArray_Set(points, i, [((OrgGeogebraCommonKernelAlgosAlgoElement_OutputHandler *) nil_chk(outputPointsTop_)) getElementWithInt:i - 2]);
  }
  IOSObjectArray_Set(segments, 0, [((OrgGeogebraCommonKernelAlgosAlgoElement_OutputHandler *) nil_chk(outputSegmentsSide_)) getElementWithInt:0]);
  for (jint i = 1; i < newBottomPointsLength; i++) {
    IOSObjectArray_Set(segments, i, [((OrgGeogebraCommonKernelAlgosAlgoElement_OutputHandler *) nil_chk(outputSegmentsTop_)) getElementWithInt:i - 1]);
  }
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetPrism_updateSideWithInt_withInt_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetPrism *self, jint index, jint newBottomPointsLength) {
  ...
  IOSObjectArray *points = [IOSObjectArray arrayWithLength:4 type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()];
