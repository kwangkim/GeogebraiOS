...
- (void)compute {
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAngleElement3D_set_v2_(self, [self getVectorCoords]);
  ...
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAngleElement3D_set_vn_(self, OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAnglePoints3D_forceNormalVectorWithOrgGeogebraCommonKernelMatrixCoords_withOrgGeogebraCommonKernelMatrixCoords_(OrgGeogebraCommonKernelMatrixCoords_get_VX_(), v2_));
  [self setOrigin];
}
