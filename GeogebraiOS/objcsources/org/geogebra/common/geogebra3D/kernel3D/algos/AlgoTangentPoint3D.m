...
- (void)setPolar {
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoTangentPoint3D_setAndConsume_polarCoords_(self, [IOSDoubleArray newArrayWithLength:3]);
  ...
  OrgGeogebraCommonKernelAlgosAlgoTangentPointND_setAndConsume_algoIntersect_(self, new_OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectLineIncludedConic3D_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoLine_withOrgGeogebraCommonKernelKernelNDGeoConicND_(cons_, polar_, c_));
...
- (void)setTangentFromPolarWithInt:(jint)i {
  if (i == 0) {
    ...
    OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoTangentPoint3D_set_polarDirection_(self, [((OrgGeogebraCommonKernelMatrixCoordSys *) nil_chk([((OrgGeogebraCommonKernelKernelNDGeoConicND *) nil_chk(c_)) getCoordSys])) getVectorWithDouble:-IOSDoubleArray_Get(nil_chk(polarCoords_), 1) withDouble:IOSDoubleArray_Get(polarCoords_, 0)]);
    if (OrgGeogebraCommonKernelKernel_isZeroWithDouble_(IOSDoubleArray_Get(polarCoords_, 0))) {
      OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoTangentPoint3D_set_polarOrigin_(self, [((OrgGeogebraCommonKernelMatrixCoordSys *) nil_chk([c_ getCoordSys])) getPointWithDouble:0 withDouble:-IOSDoubleArray_Get(polarCoords_, 2) / IOSDoubleArray_Get(polarCoords_, 1)]);
    }
    else {
      OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoTangentPoint3D_set_polarOrigin_(self, [((OrgGeogebraCommonKernelMatrixCoordSys *) nil_chk([c_ getCoordSys])) getPointWithDouble:-IOSDoubleArray_Get(polarCoords_, 2) / IOSDoubleArray_Get(polarCoords_, 0) withDouble:0]);
    }
  }
...
- (void)setTangents {
  OrgGeogebraCommonKernelAlgosAlgoTangentPointND_setAndConsume_tangents_(self, [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonGeogebra3DKernel3DGeosGeoLine3D_class_()]);
...
- (jboolean)checkUndefined {
  ...
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoTangentPoint3D_set_coords2D_(self, IOSObjectArray_Get(nil_chk([((OrgGeogebraCommonKernelMatrixCoordSys *) nil_chk([((OrgGeogebraCommonKernelKernelNDGeoConicND *) nil_chk(c_)) getCoordSys])) getNormalProjectionWithOrgGeogebraCommonKernelMatrixCoords:[((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(P_)) getInhomCoordsInD3]]), 1));
