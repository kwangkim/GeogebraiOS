...
- (OrgGeogebraCommonGeogebra3DKernel3DGeosGeoConic3D *)newConicWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)cons {
  return [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoConicSection_initWithOrgGeogebraCommonKernelConstruction_withBoolean_(cons, YES) autorelease];
}

- (void)end {
  jboolean oldSilentMode = [((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) isSilentMode];
  [kernel_ setSilentModeWithBoolean:YES];
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectPlaneQuadricLimited_setAndConsume_algoBottom_(self, new_OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectPlaneConic_initWithOrgGeogebraCommonKernelConstruction_(cons_));
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectPlaneQuadricLimited_setAndConsume_algoTop_(self, new_OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectPlaneConic_initWithOrgGeogebraCommonKernelConstruction_(cons_));
  [kernel_ setSilentModeWithBoolean:oldSilentMode];
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectPlaneQuadricLimited_setAndConsume_bottomP_(self, [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_class_()]);
  for (jint i = 0; i < 2; i++) {
    IOSObjectArray_SetAndConsume(bottomP_, i, new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_initWithOrgGeogebraCommonKernelConstruction_(cons_));
  }
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectPlaneQuadricLimited_setAndConsume_topP_(self, [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_class_()]);
  for (jint i = 0; i < 2; i++) {
    IOSObjectArray_SetAndConsume(topP_, i, new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_initWithOrgGeogebraCommonKernelConstruction_(cons_));
  }
  [super end];
}
    ...
    if (JavaLangDouble_isNaNWithDouble_(IOSDoubleArray_Get(topParameters, 0))) {
      if (!JavaLangDouble_isNaNWithDouble_(IOSDoubleArray_Get(bottomParameters, 0))) {
        if (OrgGeogebraCommonKernelKernel_isEqualWithDouble_withDouble_(IOSDoubleArray_Get(bottomParameters, 0), IOSDoubleArray_Get(bottomParameters, 1))) {
          ...
          OrgGeogebraCommonKernelPathParameter *pp = [new_OrgGeogebraCommonKernelPathParameter_initWithDouble_(midParameter) autorelease];
...
jboolean OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectPlaneQuadricLimited_planeOutsideAxis(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectPlaneQuadricLimited *self) {
  if (self->tmpCoords_ == nil) {
    OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectPlaneQuadricLimited_setAndConsume_tmpCoords_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4));
  }
...
IOSDoubleArray *OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectPlaneQuadricLimited_setPartPointsWithOrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectPlaneConic_withOrgGeogebraCommonKernelKernelNDGeoConicND_withOrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3DArray_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectPlaneQuadricLimited *self, OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectPlaneConic *algo, OrgGeogebraCommonKernelKernelNDGeoConicND *c, IOSObjectArray *points) {
  ...
  if ([((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(c0)) equalsForKernelWithOrgGeogebraCommonKernelMatrixCoords:c1] && [self->conic_ getType] == OrgGeogebraCommonKernelKernelNDGeoConicNDConstants_CONIC_INTERSECTING_LINES) {
    OrgGeogebraCommonKernelPathParameter *pp = [new_OrgGeogebraCommonKernelPathParameter_init() autorelease];
