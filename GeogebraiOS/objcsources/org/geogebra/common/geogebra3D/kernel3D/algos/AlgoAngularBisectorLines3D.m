...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/geogebra3D/kernel3D/algos/AlgoAngularBisectorLines3D.java
//
...
- (void)setInputOutput {
  ...
  IOSObjectArray_Set(input_, 1, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(h_, [OrgGeogebraCommonKernelGeosGeoElement class]));
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAngularBisectorLines3D_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelKernelNDGeoLineND_withOrgGeogebraCommonKernelKernelNDGeoLineND_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAngularBisectorLines3D *self, OrgGeogebraCommonKernelConstruction *cons, id<OrgGeogebraCommonKernelKernelNDGeoLineND> g, id<OrgGeogebraCommonKernelKernelNDGeoLineND> h) {
  ...
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAngularBisectorLines3D_set_g_(self, g);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAngularBisectorLines3D_set_h_(self, h);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAngularBisectorLines3D_setAndConsume_bisector_(self, [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonGeogebra3DKernel3DGeosGeoLine3D_class_()]);
  IOSObjectArray_SetAndConsume(self->bisector_, 0, new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoLine3D_initWithOrgGeogebraCommonKernelConstruction_(cons));
  IOSObjectArray_SetAndConsume(self->bisector_, 1, new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoLine3D_initWithOrgGeogebraCommonKernelConstruction_(cons));
  [self setInputOutput];
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAngularBisectorLines3D_setAndConsume_wv_(self, [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonKernelGeosGeoVector_class_()]);
  ...
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAngularBisectorLines3D_setAndConsume_B_(self, new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_initWithOrgGeogebraCommonKernelConstruction_(cons));
