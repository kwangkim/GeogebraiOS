...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/javasources/org/geogebra/common/geogebra3D/kernel3D/algos/AlgoPolyhedronNetPyramid.java
//
...
withOrgGeogebraCommonKernelMatrixCoordsArray:(IOSObjectArray *)points {
  if (p1_ == nil) {
    OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetPyramid_setAndConsume_p1_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4));
  }
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetPyramid_updateSideWithInt_withInt_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetPyramid *self, jint index, jint newBottomPointsLength) {
  ...
  IOSObjectArray *points = [IOSObjectArray arrayWithLength:3 type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()];
