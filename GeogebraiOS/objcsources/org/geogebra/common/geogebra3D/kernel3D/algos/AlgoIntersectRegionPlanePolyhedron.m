...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/geogebra3D/kernel3D/algos/AlgoIntersectRegionPlanePolyhedron.java
//
...
- (void)setSecondInputWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_set_polyhedron_(self, (OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron *) check_class_cast(geo, [OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron class]));
}
...
- (void)setNewCoords {
  if (newCoordsList_ == nil) OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_setAndConsume_newCoordsList_(self, new_JavaUtilTreeMap_init());
  else [newCoordsList_ clear];
  if (parentToPolygons_ == nil) OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_setAndConsume_parentToPolygons_(self, new_JavaUtilTreeMap_init());
  else [parentToPolygons_ clear];
  if (polyhedronVertices_ == nil) OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_setAndConsume_polyhedronVertices_(self, new_JavaUtilTreeSet_initWithJavaUtilComparator_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_COORDS_COMPARATOR_));
  ...
  for (OrgGeogebraCommonKernelGeosGeoPolygon * __strong polygon in nil_chk([((OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron *) nil_chk(polyhedron_)) getPolygons])) {
    OrgGeogebraCommonKernelAlgosAlgoIntersectPathLinePolygon_set_p_(self, polygon);
...
- (void)compute {
  if (verticesList_ == nil) OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_setAndConsume_verticesList_(self, new_OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_VerticesList_initWithOrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_(self));
  else [verticesList_ clear];
  if (checkVerticesList_ == nil) OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_setAndConsume_checkVerticesList_(self, new_JavaUtilTreeSet_init());
  else [checkVerticesList_ clear];
  if (polyhedronFaces_ == nil) OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_setAndConsume_polyhedronFaces_(self, new_JavaUtilArrayList_init());
  ...
  if ([((JavaUtilTreeMap *) nil_chk(newCoordsList_)) size] == 0 && [((JavaUtilArrayList *) nil_chk(polyhedronFaces_)) size] == 0) {
    ...
    while ([newCoordsList_ size] != 0) {
      OrgGeogebraCommonKernelAlgosAlgoIntersectPathLinePolygon_set_p_(self, [newCoordsList_ firstKey]);
    ...
    IOSObjectArray *points = [IOSObjectArray arrayWithLength:verticesList_->cumulateSize_ type:OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_class_()];
    ...
    for (JavaUtilArrayList * __strong vertices in verticesList_) {
      ...
      IOSObjectArray *polyPoints = [IOSObjectArray arrayWithLength:length type:OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_class_()];
      IOSObjectArray *polySegments = [IOSObjectArray arrayWithLength:length type:OrgGeogebraCommonGeogebra3DKernel3DGeosGeoSegment3D_class_()];
      for (jint i = 0; i < length; i++) {
...
- (void)getCmdOutputXMLWithJavaLangStringBuilder:(JavaLangStringBuilder *)sb
  ...
  [sb appendWithInt:[((OrgGeogebraCommonKernelAlgosAlgoElement_OutputHandler *) nil_chk(outputPolygons_)) size]];
  [sb appendWithNSString:@","];
  [sb appendWithInt:[((OrgGeogebraCommonKernelAlgosAlgoElement_OutputHandler *) nil_chk(outputPoints_)) size]];
  [sb appendWithNSString:@","];
  [sb appendWithInt:[((OrgGeogebraCommonKernelAlgosAlgoElement_OutputHandler *) nil_chk(outputSegments_AlgoIntersectRegionPlanePolyhedron_)) size]];
  [sb appendWithNSString:@"\""];
  [sb appendWithNSString:@"/>\n"];
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron class]) {
    JreStrongAssignAndConsume(&OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_COORDS_COMPARATOR_, nil, new_OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_$1_init());
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D_withOrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron *self, OrgGeogebraCommonKernelConstruction *c, OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D *plane, OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron *p) {
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D_withOrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron_withBoolean_(self, c, plane, p, NO);
}
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D_withOrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron_withIntArray_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron *self, OrgGeogebraCommonKernelConstruction *c, IOSObjectArray *labels, OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D *plane, OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron *p, IOSIntArray *outputSizes) {
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D_withOrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron_withBoolean_(self, c, plane, p, YES);
  if (labels == nil) {
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_setNewCoordsList(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron *self) {
  ...
  if ([((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(self->d1_)) isZero] && !(OrgGeogebraCommonKernelKernel_isZeroWithDouble_([((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(self->o1_)) getW]))) {
    ...
    OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_Vertices *vertices = [new_OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_Vertices_initWithOrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_(self) autorelease];
    {
    ...
    if (self->newCoords_AlgoIntersectRegionPlanePolyhedron_ == nil) OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_setAndConsume_newCoords_AlgoIntersectRegionPlanePolyhedron_(self, new_JavaUtilTreeSet_init());
    ...
    if ([((JavaUtilTreeSet *) nil_chk(self->newCoords_AlgoIntersectRegionPlanePolyhedron_)) size] > 1) {
      OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_set_segmentCoords_(self, OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_getSegmentsCoords(self));
...
OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_CoordsWithParent *OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_nextVertexWithOrgGeogebraCommonKernelGeosGeoPolygon_withOrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_CoordsWithParent_withOrgGeogebraCommonKernelKernelNDGeoElementND_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron *self, OrgGeogebraCommonKernelGeosGeoPolygon *p2, OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_CoordsWithParent *startPoint, id<OrgGeogebraCommonKernelKernelNDGeoElementND> oldPoint) {
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_set_segmentCoords_(self, [((JavaUtilTreeMap *) nil_chk(self->newCoordsList_)) getWithId:p2]);
  ...
  if (notFound) {
    ...
    OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_set_removeSegmentCoordsPolygon_(self, p2);
  }
  return b;
}
...
OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_CoordsWithParent *OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_nextVertexWithOrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_CoordsWithParent_withOrgGeogebraCommonKernelKernelNDGeoElementND_withOrgGeogebraCommonKernelKernelNDGeoElementND_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron *self, OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_CoordsWithParent *startPoint, id<OrgGeogebraCommonKernelKernelNDGeoElementND> oldParent, id<OrgGeogebraCommonKernelKernelNDGeoElementND> firstParent) {
    ...
    if (p2 != self->p_ && [self->newCoordsList_ containsKeyWithId:p2]) {
      ...
      if (b != nil) {
        if (b->parent_ == firstParent) {
          ...
          OrgGeogebraCommonKernelAlgosAlgoIntersectPathLinePolygon_set_p_(self, p2);
          OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_removeSegmentCoords(self);
          return b;
        }
      }
  ...
  if (bFirstPoint != nil) {
    ...
    OrgGeogebraCommonKernelAlgosAlgoIntersectPathLinePolygon_set_p_(self, pFirstPoint);
    return bFirstPoint;
  }
  return nil;
}
...
OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_Vertices *OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_addVertices(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron *self) {
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_Vertices *vertices = [new_OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_Vertices_initWithOrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_(self) autorelease];
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_set_segmentCoords_(self, [((JavaUtilTreeMap *) nil_chk(self->newCoordsList_)) getWithId:self->p_]);
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_addPolyhedronVerticesToOutputWithInt_withInt_withInt_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron *self, jint indexPolygon, jint indexPoint, jint indexSegment) {
  for (OrgGeogebraCommonKernelMatrixCoords * __strong coords in nil_chk(self->polyhedronVertices_)) {
    ...
    [((OrgGeogebraCommonKernelGeosGeoPolygon *) nil_chk(outputPoly)) setPointsWithOrgGeogebraCommonKernelKernelNDGeoPointNDArray:[IOSObjectArray arrayWithObjects:(id[]){ point, point } count:2 type:OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_class_()] withOrgGeogebraCommonKernelMatrixCoordSys:nil withBoolean:NO];
    [outputPoly setSegmentsWithOrgGeogebraCommonKernelKernelNDGeoSegmentNDArray:[IOSObjectArray arrayWithObjects:(id[]){ seg, seg } count:2 type:OrgGeogebraCommonGeogebra3DKernel3DGeosGeoSegment3D_class_()]];
    [outputPoly calcArea];
    indexPolygon++;
    indexPoint++;
    indexSegment++;
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_createOutput(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron *self) {
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_setAndConsume_outputPolygons_(self, new_OrgGeogebraCommonKernelAlgosAlgoElement_OutputHandler_initWithOrgGeogebraCommonKernelAlgosAlgoElement_withOrgGeogebraCommonKernelAlgosAlgoElement_elementFactory_(self, [new_OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_$2_initWithOrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_(self) autorelease]));
  [self->outputPolygons_ adjustOutputSizeWithInt:1 withBoolean:NO];
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_setAndConsume_outputPoints_(self, new_OrgGeogebraCommonKernelAlgosAlgoElement_OutputHandler_initWithOrgGeogebraCommonKernelAlgosAlgoElement_withOrgGeogebraCommonKernelAlgosAlgoElement_elementFactory_(self, [new_OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_$3_initWithOrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_(self) autorelease]));
  [self->outputPoints_ adjustOutputSizeWithInt:1 withBoolean:NO];
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_setAndConsume_outputSegments_AlgoIntersectRegionPlanePolyhedron_(self, new_OrgGeogebraCommonKernelAlgosAlgoElement_OutputHandler_initWithOrgGeogebraCommonKernelAlgosAlgoElement_withOrgGeogebraCommonKernelAlgosAlgoElement_elementFactory_(self, [new_OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_$4_initWithOrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_(self) autorelease]));
}
...
- (jint)compareToWithId:(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_CoordsWithParent *)o {
  check_class_cast(o, [OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_CoordsWithParent class]);
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_CoordsWithParent_initWithOrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_withJavaLangDouble_withOrgGeogebraCommonKernelMatrixCoords_withOrgGeogebraCommonKernelKernelNDGeoElementND_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_CoordsWithParent *self, OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron *outer$, JavaLangDouble *parameter, OrgGeogebraCommonKernelMatrixCoords *v, id<OrgGeogebraCommonKernelKernelNDGeoElementND> parent) {
  ...
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_CoordsWithParent_set_parent_(self, parent);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_CoordsWithParent_set_parameter_(self, parameter);
}
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_Segment_initWithOrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_withOrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_CoordsWithParent_withOrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_CoordsWithParent_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_Segment *self, OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron *outer$, OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_CoordsWithParent *p1, OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_CoordsWithParent *p2) {
  NSObject_init(self);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_Segment_set_p1_(self, p1);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_Segment_set_p2_(self, p2);
}
...
- (jint)compareToWithId:(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_Vertices *)o {
  check_class_cast(o, [OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_Vertices class]);
...
- (OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolygon3D *)newElement {
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolygon3D *p = [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolygon3D_initWithOrgGeogebraCommonKernelConstruction_withBoolean_(this$0_->cons_, YES) autorelease];
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_$2_initWithOrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_$2 *self, OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron *outer$) {
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_$2_set_this$0_(self, outer$);
  NSObject_init(self);
}
...
- (OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D *)newElement {
  OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D *newPoint = [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_initWithOrgGeogebraCommonKernelConstruction_(this$0_->cons_) autorelease];
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_$3_initWithOrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_$3 *self, OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron *outer$) {
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_$3_set_this$0_(self, outer$);
  NSObject_init(self);
}
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_$4_initWithOrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_$4 *self, OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron *outer$) {
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectRegionPlanePolyhedron_$4_set_this$0_(self, outer$);
  NSObject_init(self);
}
