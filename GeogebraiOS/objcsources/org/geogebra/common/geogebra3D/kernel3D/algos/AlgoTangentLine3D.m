...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/geogebra3D/kernel3D/algos/AlgoTangentLine3D.java
//
...
- (void)initDiameterAndDirection {
  ...
  OrgGeogebraCommonKernelAlgosAlgoTangentLineND_setAndConsume_algoIntersect_(self, new_OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoIntersectLineIncludedConic3D_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelGeosGeoLine_withOrgGeogebraCommonKernelKernelNDGeoConicND_(cons_, diameter_, c_));
...
- (void)setTangents {
  OrgGeogebraCommonKernelAlgosAlgoTangentLineND_setAndConsume_tangents_(self, [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonGeogebra3DKernel3DGeosGeoLine3D_class_()]);
...
- (jboolean)checkUndefined {
  ...
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoTangentLine3D_set_direction3D_(self, [((id<OrgGeogebraCommonKernelKernelNDGeoLineND>) nil_chk(g_)) getDirectionInD3]);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoTangentLine3D_set_direction_(self, IOSObjectArray_Get(nil_chk([((OrgGeogebraCommonKernelMatrixCoordSys *) nil_chk([((OrgGeogebraCommonKernelKernelNDGeoConicND *) nil_chk(c_)) getCoordSys])) getNormalProjectionWithOrgGeogebraCommonKernelMatrixCoords:direction3D_]), 1));
