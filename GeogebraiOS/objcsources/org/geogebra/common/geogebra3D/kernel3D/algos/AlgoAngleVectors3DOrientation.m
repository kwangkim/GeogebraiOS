...
- (void)setInputWithOrgGeogebraCommonKernelKernelNDGeoVectorND:(id<OrgGeogebraCommonKernelKernelNDGeoVectorND>)v
  ...
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAngleVectors3DOrientation_set_orientation_(self, orientation);
}
...
- (void)setInputOutput {
  ...
  IOSObjectArray_Set(input_, 0, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast([self getv], [OrgGeogebraCommonKernelGeosGeoElement class]));
  IOSObjectArray_Set(input_, 1, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast([self getw], [OrgGeogebraCommonKernelGeosGeoElement class]));
