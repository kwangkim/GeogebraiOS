...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/geogebra3D/kernel3D/algos/AlgoSurfaceCartesian3D.java
//
...
- (OrgGeogebraCommonKernelKernelNDGeoSurfaceCartesianND *)createCurveWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)cons
  ...
  return [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoSurfaceCartesian3D_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelArithmeticFunctionNVarArray_(cons, fun) autorelease];
}
...
- (void)setInputOutput {
  OrgGeogebraCommonKernelAlgosAlgoElement_setAndConsume_input_(self, [IOSObjectArray newArrayWithLength:((IOSObjectArray *) nil_chk(coords_))->size_ + 3 * ((IOSObjectArray *) nil_chk(localVar_))->size_ type:OrgGeogebraCommonKernelGeosGeoElement_class_()]);
  for (jint i = 0; i < coords_->size_; i++) IOSObjectArray_Set(input_, i, [((id<OrgGeogebraCommonKernelArithmeticNumberValue>) nil_chk(IOSObjectArray_Get(coords_, i))) toGeoElement]);
  for (jint i = 0; i < localVar_->size_; i++) {
    IOSObjectArray_Set(input_, coords_->size_ + 3 * i, IOSObjectArray_Get(localVar_, i));
    IOSObjectArray_Set(input_, coords_->size_ + 3 * i + 1, [((id<OrgGeogebraCommonKernelArithmeticNumberValue>) nil_chk(IOSObjectArray_Get(nil_chk(from_), i))) toGeoElement]);
    IOSObjectArray_Set(input_, coords_->size_ + 3 * i + 2, [((id<OrgGeogebraCommonKernelArithmeticNumberValue>) nil_chk(IOSObjectArray_Get(nil_chk(to_), i))) toGeoElement]);
  }
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoSurfaceCartesian3D_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticNumberValueArray_withOrgGeogebraCommonKernelGeosGeoNumericArray_withOrgGeogebraCommonKernelArithmeticNumberValueArray_withOrgGeogebraCommonKernelArithmeticNumberValueArray_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoSurfaceCartesian3D *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, IOSObjectArray *coords, IOSObjectArray *localVar, IOSObjectArray *from, IOSObjectArray *to) {
  ...
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoSurfaceCartesian3D_set_coords_(self, coords);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoSurfaceCartesian3D_set_from_(self, from);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoSurfaceCartesian3D_set_to_(self, to);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoSurfaceCartesian3D_set_localVar_(self, localVar);
  ...
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoSurfaceCartesian3D_set_surface_(self, [self createCurveWithOrgGeogebraCommonKernelConstruction:cons withOrgGeogebraCommonKernelArithmeticFunctionNVarArray:fun]);
  [self setInputOutput];
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoSurfaceCartesian3D_compute(self);
