...
- (IOSObjectArray *)getTransformedOutputWithOrgGeogebraCommonKernelTransform:(OrgGeogebraCommonKernelTransform *)t {
  ...
  for (jint i = 0; i < output->size_; i++) {
    IOSObjectArray_Set(labels, i, OrgGeogebraCommonKernelTransform_transformedGeoLabelWithOrgGeogebraCommonKernelGeosGeoElement_(IOSObjectArray_Get(output, i)));
  }
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoQuadricLimitedPointPointRadius_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelKernelNDGeoPointND_withOrgGeogebraCommonKernelArithmeticNumberValue_withInt_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoQuadricLimitedPointPointRadius *self, OrgGeogebraCommonKernelConstruction *c, IOSObjectArray *labels, id<OrgGeogebraCommonKernelKernelNDGeoPointND> origin, id<OrgGeogebraCommonKernelKernelNDGeoPointND> secondPoint, id<OrgGeogebraCommonKernelArithmeticNumberValue> r, jint type) {
  ...
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoQuadricLimitedPointPointRadius_set_origin_(self, origin);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoQuadricLimitedPointPointRadius_set_secondPoint_(self, secondPoint);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoQuadricLimitedPointPointRadius_set_radius_(self, r);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoQuadricLimitedPointPointRadius_setAndConsume_quadric_(self, new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3DLimited_initWithOrgGeogebraCommonKernelConstruction_(c));
  [self->quadric_ setTypeWithInt:type];
  OrgGeogebraCommonKernelAlgosAlgoElement_setAndConsume_input_(self, [IOSObjectArray newArrayWithObjects:(id[]){ (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(origin, [OrgGeogebraCommonKernelGeosGeoElement class]), (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(secondPoint, [OrgGeogebraCommonKernelGeosGeoElement class]), (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(r, [OrgGeogebraCommonKernelGeosGeoElement class]) } count:3 type:OrgGeogebraCommonKernelGeosGeoElement_class_()]);
  ...
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoQuadricLimitedPointPointRadius_set_side_(self, (OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3DPart *) check_class_cast([algo getQuadric], [OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3DPart class]));
