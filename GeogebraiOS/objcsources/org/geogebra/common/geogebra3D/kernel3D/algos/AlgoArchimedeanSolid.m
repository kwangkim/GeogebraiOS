...
- (void)setInput {
  ...
  (void) IOSObjectArray_Set(input_, 2, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(v_, [OrgGeogebraCommonKernelGeosGeoElement class]));
}
...
- (void)createPolyhedron {
  ...
  (void) IOSObjectArray_Set(points, 0, [self getA]);
  (void) IOSObjectArray_Set(points, 1, [self getB]);
