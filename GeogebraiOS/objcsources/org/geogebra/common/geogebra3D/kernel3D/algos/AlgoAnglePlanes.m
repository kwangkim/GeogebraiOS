...
- (void)initCoords {
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAnglePlanes_setAndConsume_o_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4));
}
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAnglePlanes_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D_withOrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAnglePlanes *self, OrgGeogebraCommonKernelConstruction *cons, OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D *p, OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D *q) {
  ...
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAnglePlanes_set_p_(self, p);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAnglePlanes_set_q_(self, q);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAnglePlanes_set_angle_(self, OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAnglePlanes_newGeoAngleWithOrgGeogebraCommonKernelConstruction_(self, cons));
  [self setInputOutput];
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAnglePlanes_compute(self);
}
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAnglePlanes_initWithOrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D_withOrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAnglePlanes *self, OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D *p, OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D *q) {
  OrgGeogebraCommonKernelAlgosAlgoAngle_initWithOrgGeogebraCommonKernelConstruction_withBoolean_(self, [((OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D *) nil_chk(p)) getConstruction], NO);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAnglePlanes_set_p_(self, p);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAnglePlanes_set_q_(self, q);
}
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAnglePlanes_compute(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAnglePlanes *self) {
  ...
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAnglePlanes_set_vn_(self, [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk([((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(vn1)) crossProduct4WithOrgGeogebraCommonKernelMatrixCoords:vn2])) normalize]);
  if ([((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(self->vn_)) isZero]) {
    ...
    OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAnglePlanes_set_o_(self, OrgGeogebraCommonKernelMatrixCoords_get_UNDEFINED_());
    return;
  }
  ...
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAnglePlanes_set_v2_(self, [vn1 crossProduct4WithOrgGeogebraCommonKernelMatrixCoords:self->vn_]);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAnglePlanes_set_v1_(self, [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(vn2)) crossProduct4WithOrgGeogebraCommonKernelMatrixCoords:self->vn_]);
