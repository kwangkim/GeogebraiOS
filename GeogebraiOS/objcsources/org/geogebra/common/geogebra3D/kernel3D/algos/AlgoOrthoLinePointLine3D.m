...
- (void)setSpecificInputOutput {
  [self setInputOutputWithOrgGeogebraCommonKernelGeosGeoElementArray:[IOSObjectArray newArrayWithObjects:(id[]){ (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(point_, [OrgGeogebraCommonKernelGeosGeoElement class]), inputOrtho_, [((OrgGeogebraCommonGeogebra3DKernel3DConstruction3D *) nil_chk(((OrgGeogebraCommonGeogebra3DKernel3DConstruction3D *) check_class_cast(cons_, [OrgGeogebraCommonGeogebra3DKernel3DConstruction3D class])))) getSpace] } count:3 type:OrgGeogebraCommonKernelGeosGeoElement_class_()] withOrgGeogebraCommonKernelGeosGeoElementArray:[IOSObjectArray newArrayWithObjects:(id[]){ line_ } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()]];
}
