...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/geogebra3D/kernel3D/algos/AlgoCircle3DThreePoints.java
//
...
- (void)setPointsWithOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)A
                 withOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)B
                 withOrgGeogebraCommonKernelKernelNDGeoPointND:(id<OrgGeogebraCommonKernelKernelNDGeoPointND>)C {
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoCircle3DThreePoints_setAndConsume_points_(self, [IOSObjectArray newArrayWithLength:3 type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()]);
  IOSObjectArray_Set(points_, 0, A);
  IOSObjectArray_Set(points_, 1, B);
  IOSObjectArray_Set(points_, 2, C);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoCircle3DThreePoints_setAndConsume_coordSys_(self, new_OrgGeogebraCommonKernelMatrixCoordSys_initWithInt_(2));
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoCircle3DThreePoints_setAndConsume_points2D_(self, [IOSObjectArray newArrayWithLength:3 type:OrgGeogebraCommonKernelGeosGeoPoint_class_()]);
  for (jint i = 0; i < 3; i++) IOSObjectArray_SetAndConsume(points2D_, i, new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_([self getConstruction]));
...
- (void)createCircle {
  OrgGeogebraCommonKernelAlgosAlgoCircleThreePoints_setAndConsume_circle_(self, new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoConic3D_initWithOrgGeogebraCommonKernelConstruction_withOrgGeogebraCommonKernelMatrixCoordSys_(cons_, coordSys_));
}
...
- (void)setInput {
  ...
  for (jint i = 0; i < 3; i++) IOSObjectArray_Set(input_, i, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(IOSObjectArray_Get(nil_chk(points_), i), [OrgGeogebraCommonKernelGeosGeoElement class]));
}
