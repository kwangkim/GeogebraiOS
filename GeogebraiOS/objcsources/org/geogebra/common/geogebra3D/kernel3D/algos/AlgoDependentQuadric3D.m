...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoDependentQuadric3D_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelArithmeticEquation_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoDependentQuadric3D *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelArithmeticEquation *equ) {
  ...
  self->ev_ = [IOSObjectArray newArrayWithLength:10 type:OrgGeogebraCommonKernelArithmeticExpressionValue_class_()];
  self->equation_ = equ;
  ...
  (void) IOSObjectArray_Set(self->ev_, 1, [lhs getCoefficientWithNSString:@"yy"]);
  (void) IOSObjectArray_Set(self->ev_, 2, [lhs getCoefficientWithNSString:@"zz"]);
  (void) IOSObjectArray_Set(self->ev_, 3, [lhs getConstantCoefficient]);
  (void) IOSObjectArray_Set(self->ev_, 4, [lhs getCoefficientWithNSString:@"xy"]);
  (void) IOSObjectArray_Set(self->ev_, 5, [lhs getCoefficientWithNSString:@"xz"]);
  (void) IOSObjectArray_Set(self->ev_, 6, [lhs getCoefficientWithNSString:@"yz"]);
  (void) IOSObjectArray_Set(self->ev_, 7, [lhs getCoefficientWithNSString:@"x"]);
  (void) IOSObjectArray_Set(self->ev_, 8, [lhs getCoefficientWithNSString:@"y"]);
  (void) IOSObjectArray_Set(self->ev_, 9, [lhs getCoefficientWithNSString:@"z"]);
  self->coeffs_ = [IOSDoubleArray newArrayWithLength:10];
  for (jint i = 0; i < 10; i++) {
  ...
  self->quadric_ = new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3D_initWithOrgGeogebraCommonKernelConstruction_(cons);
  [self setInputOutput];
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoDependentQuadric3D_compute(self);
