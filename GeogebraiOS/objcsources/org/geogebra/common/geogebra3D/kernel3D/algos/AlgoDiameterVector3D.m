...
- (void)createOutputWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)cons {
  OrgGeogebraCommonKernelAlgosAlgoDiameterVectorND_setAndConsume_diameter_(self, new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoLine3D_initWithOrgGeogebraCommonKernelConstruction_(cons));
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoDiameterVector3D_setAndConsume_diameter2D_(self, new_OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelConstruction_(cons));
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoDiameterVector3D_setAndConsume_diameterCoords_(self, [IOSDoubleArray newArrayWithLength:3]);
}

- (void)compute {
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoDiameterVector3D_set_direction_(self, IOSObjectArray_Get(nil_chk([((OrgGeogebraCommonKernelMatrixCoordSys *) nil_chk([((OrgGeogebraCommonKernelKernelNDGeoConicND *) nil_chk(c_)) getCoordSys])) getNormalProjectionWithOrgGeogebraCommonKernelMatrixCoords:[((id<OrgGeogebraCommonKernelKernelNDGeoVectorND>) nil_chk(v_)) getCoordsInD3]]), 1));
  ...
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoDiameterVector3D_set_diameterDirection_(self, [((OrgGeogebraCommonKernelMatrixCoordSys *) nil_chk([c_ getCoordSys])) getVectorWithDouble:-IOSDoubleArray_Get(nil_chk(diameterCoords_), 1) withDouble:IOSDoubleArray_Get(diameterCoords_, 0)]);
  if (OrgGeogebraCommonKernelKernel_isZeroWithDouble_(IOSDoubleArray_Get(diameterCoords_, 0))) {
    OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoDiameterVector3D_set_diameterOrigin_(self, [((OrgGeogebraCommonKernelMatrixCoordSys *) nil_chk([c_ getCoordSys])) getPointWithDouble:0 withDouble:-IOSDoubleArray_Get(diameterCoords_, 2) / IOSDoubleArray_Get(diameterCoords_, 1)]);
  }
  else {
    OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoDiameterVector3D_set_diameterOrigin_(self, [((OrgGeogebraCommonKernelMatrixCoordSys *) nil_chk([c_ getCoordSys])) getPointWithDouble:-IOSDoubleArray_Get(diameterCoords_, 2) / IOSDoubleArray_Get(diameterCoords_, 0) withDouble:0]);
  }
