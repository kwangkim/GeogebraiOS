...
- (void)compute {
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoOrthoLineLine_set_origin1_(self, [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk([((id<OrgGeogebraCommonKernelKernelNDGeoLineND>) nil_chk(line1_)) getPointInDWithInt:3 withDouble:0])) getInhomCoordsInSameDimension]);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoOrthoLineLine_set_direction1_(self, [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk([line1_ getPointInDWithInt:3 withDouble:1])) subWithOrgGeogebraCommonKernelMatrixCoords:origin1_]);
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoOrthoLineLine_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelKernelNDGeoLineND_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoOrthoLineLine *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, id<OrgGeogebraCommonKernelKernelNDGeoLineND> line1) {
  ...
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoOrthoLineLine_set_line1_(self, line1);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoOrthoLineLine_setAndConsume_line_(self, new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoLine3D_initWithOrgGeogebraCommonKernelConstruction_(cons));
}
