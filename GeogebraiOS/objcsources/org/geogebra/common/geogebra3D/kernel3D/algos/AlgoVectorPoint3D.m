...
- (void)setCoords {
  ...
  [((id<OrgGeogebraCommonKernelKernelNDGeoVectorND>) nil_chk([self getVector])) setCoordsWithDoubleArray:[IOSDoubleArray arrayWithDoubles:(jdouble[]){ [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(coords)) getX], [coords getY], [coords getZ], 0 } count:4]];
}
