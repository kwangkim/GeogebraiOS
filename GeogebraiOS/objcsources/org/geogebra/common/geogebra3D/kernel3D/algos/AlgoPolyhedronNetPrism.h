...
#ifndef _OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetPrism_H_
#define _OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetPrism_H_
...
@interface OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetPrism : OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNet
...
J2OBJC_EMPTY_STATIC_INIT(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetPrism)
...
FOUNDATION_EXPORT OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetPrism *new_OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetPrism_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron_withOrgGeogebraCommonKernelArithmeticNumberValue_(OrgGeogebraCommonKernelConstruction *c, IOSObjectArray *labels, OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron *p, id<OrgGeogebraCommonKernelArithmeticNumberValue> v) NS_RETURNS_RETAINED;

J2OBJC_TYPE_LITERAL_HEADER(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetPrism)

#endif // _OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetPrism_H_
