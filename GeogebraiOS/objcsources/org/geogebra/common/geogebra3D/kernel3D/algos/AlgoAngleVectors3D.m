...
- (void)compute {
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAngleVectors3D_set_v1_(self, [((id<OrgGeogebraCommonKernelKernelNDGeoVectorND>) nil_chk([self getv])) getCoordsInD3]);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAngleVectors3D_set_v2_(self, [((id<OrgGeogebraCommonKernelKernelNDGeoVectorND>) nil_chk([self getw])) getCoordsInD3]);
  ...
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAngleVectors3D_set_vn_(self, OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAnglePoints3D_forceNormalVectorWithOrgGeogebraCommonKernelMatrixCoords_withOrgGeogebraCommonKernelMatrixCoords_(v1_, v2_));
  ...
  if (OrgGeogebraCommonKernelAlgosAlgoAngle_centerIsNotDrawableWithOrgGeogebraCommonKernelKernelNDGeoPointND_(start)) {
    OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAngleVectors3D_set_o_(self, OrgGeogebraCommonKernelMatrixCoords_get_UNDEFINED_());
  }
  else {
    OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAngleVectors3D_set_o_(self, [((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(start)) getInhomCoordsInD3]);
  }
}
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAngleVectors3D_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelKernelNDGeoVectorND_withOrgGeogebraCommonKernelKernelNDGeoVectorND_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAngleVectors3D *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, id<OrgGeogebraCommonKernelKernelNDGeoVectorND> v, id<OrgGeogebraCommonKernelKernelNDGeoVectorND> w) {
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoAngleVectors3D_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelKernelNDGeoVectorND_withOrgGeogebraCommonKernelKernelNDGeoVectorND_withOrgGeogebraCommonKernelKernelNDGeoDirectionND_(self, cons, label, v, w, nil);
}
