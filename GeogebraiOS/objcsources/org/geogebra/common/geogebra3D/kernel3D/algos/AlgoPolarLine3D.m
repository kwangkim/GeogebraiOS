...
- (id<OrgGeogebraCommonKernelKernelNDGeoLineND>)newGeoLineWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)cons {
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolarLine3D_setAndConsume_polar2D_(self, new_OrgGeogebraCommonKernelGeosGeoLine_initWithOrgGeogebraCommonKernelConstruction_(cons));
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolarLine3D_setAndConsume_polarCoords_(self, [IOSDoubleArray newArrayWithLength:3]);
...
- (void)compute {
  ...
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolarLine3D_set_polarDirection_(self, [((OrgGeogebraCommonKernelMatrixCoordSys *) nil_chk([c_ getCoordSys])) getVectorWithDouble:-IOSDoubleArray_Get(nil_chk(polarCoords_), 1) withDouble:IOSDoubleArray_Get(polarCoords_, 0)]);
  if (OrgGeogebraCommonKernelKernel_isZeroWithDouble_(IOSDoubleArray_Get(polarCoords_, 0))) {
    OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolarLine3D_set_polarOrigin_(self, [((OrgGeogebraCommonKernelMatrixCoordSys *) nil_chk([c_ getCoordSys])) getPointWithDouble:0 withDouble:-IOSDoubleArray_Get(polarCoords_, 2) / IOSDoubleArray_Get(polarCoords_, 1)]);
  }
  else {
    OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolarLine3D_set_polarOrigin_(self, [((OrgGeogebraCommonKernelMatrixCoordSys *) nil_chk([c_ getCoordSys])) getPointWithDouble:-IOSDoubleArray_Get(polarCoords_, 2) / IOSDoubleArray_Get(polarCoords_, 0) withDouble:0]);
  }
