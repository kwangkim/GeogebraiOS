...
- (void)createVertexWithOrgGeogebraCommonKernelConstruction:(OrgGeogebraCommonKernelConstruction *)cons {
  vertex_ = [IOSObjectArray newArrayWithLength:4 type:OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_class_()];
  for (jint i = 0; i < vertex_->size_; i++) {
    (void) IOSObjectArray_Set(vertex_, i, new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_initWithOrgGeogebraCommonKernelConstruction_(cons));
  }
}
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoVertexConic3D_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelKernelNDGeoConicND_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoVertexConic3D *self, OrgGeogebraCommonKernelConstruction *cons, IOSObjectArray *labels, OrgGeogebraCommonKernelKernelNDGeoConicND *c) {
  (void) OrgGeogebraCommonKernelAlgosAlgoVertexConic_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelKernelNDGeoConicND_(self, cons, labels, c);
}
