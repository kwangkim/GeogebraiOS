...
- (void)compute {
  ...
  (void) OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetConvex_rotateFaceWithInt_withDouble_(self, iBottom_, f);
}
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetConvex_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron_withOrgGeogebraCommonKernelArithmeticNumberValue_withOrgGeogebraCommonKernelGeosGeoPolygon_withOrgGeogebraCommonKernelKernelNDGeoSegmentNDArray_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetConvex *self, OrgGeogebraCommonKernelConstruction *c, IOSObjectArray *labels, OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron *p, id<OrgGeogebraCommonKernelArithmeticNumberValue> v, OrgGeogebraCommonKernelGeosGeoPolygon *bottomFace, IOSObjectArray *pivotSegments) {
  ...
  self->netMap_ = new_JavaUtilArrayList_init();
  self->polygonInfo_ = new_JavaUtilArrayList_init();
  self->polygonChildSegsList_ = new_JavaUtilArrayList_init();
  self->segmentList_ = new_JavaUtilArrayList_init();
  self->segmentInfoList_ = new_JavaUtilArrayList_init();
  self->netComplete_ = YES;
  self->projCoord_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4);
  self->p_ = p;
  self->v_ = v;
  self->bottomFace_ = bottomFace;
  self->userCutSegments_ = pivotSegments;
  jint pivotSegmentsLength = 0;
  if (pivotSegments != nil) {
    pivotSegmentsLength = pivotSegments->size_;
  }
  if (bottomFace == nil) {
    self->input_ = [IOSObjectArray newArrayWithLength:2 + pivotSegmentsLength type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    (void) IOSObjectArray_Set(self->input_, 0, p);
    (void) IOSObjectArray_Set(self->input_, 1, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(v, [OrgGeogebraCommonKernelGeosGeoElement class]));
    for (jint i = 0; i < pivotSegmentsLength; i++) {
      (void) IOSObjectArray_Set(self->input_, 2 + i, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(IOSObjectArray_Get(nil_chk(pivotSegments), i), [OrgGeogebraCommonKernelGeosGeoElement class]));
    }
  }
  else {
    self->input_ = [IOSObjectArray newArrayWithLength:3 + pivotSegmentsLength type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    (void) IOSObjectArray_Set(self->input_, 0, p);
    (void) IOSObjectArray_Set(self->input_, 1, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(v, [OrgGeogebraCommonKernelGeosGeoElement class]));
    (void) IOSObjectArray_Set(self->input_, 2, bottomFace);
    for (jint i = 0; i < pivotSegmentsLength; i++) {
      (void) IOSObjectArray_Set(self->input_, 3 + i, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(IOSObjectArray_Get(nil_chk(pivotSegments), i), [OrgGeogebraCommonKernelGeosGeoElement class]));
    }
  }
  ...
  self->outputNet_ = new_OrgGeogebraCommonKernelAlgosAlgoElement_OutputHandler_initWithOrgGeogebraCommonKernelAlgosAlgoElement_withOrgGeogebraCommonKernelAlgosAlgoElement_elementFactory_(self, new_OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetConvex_$1_initWithOrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetConvex_(self));
  [self->outputNet_ adjustOutputSizeWithInt:1];
  self->outputPointsNet_ = OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetConvex_createOutputPoints(self);
  self->outputPolygons_ = OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetConvex_createOutputPolygons(self);
  self->outputSegments_ = OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetConvex_createOutputSegments(self);
  OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetConvex_netFacesCompute(self);
  if (self->iBottom_ != -1) {
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetConvex_setSegmentsToFacesLinkWithOrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetConvex *self, OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron *p) {
  ...
  for (jint iP = 0; iP < ((IOSObjectArray *) nil_chk(polygonList))->size_; iP++) {
    JavaUtilArrayList *segsList = new_JavaUtilArrayList_init();
    ...
    }
    {
      ...
      while (b__ < e__) {
        ...
        if (!found) {
          ...
          OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetConvex_SegmentInfo *newSegParent = new_OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetConvex_SegmentInfo_initWithOrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetConvex_(self);
...
jboolean OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetConvex_makeNetMapWithOrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetConvex *self, OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron *p) {
  ...
  IOSObjectArray *polygonList = [((OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron *) nil_chk(p)) getFaces];
  for (jint iP = 0; iP < ((IOSObjectArray *) nil_chk(polygonList))->size_; iP++) {
    JavaUtilArrayList *linkedPolygonList = new_JavaUtilArrayList_init();
    [self->netMap_ addWithId:linkedPolygonList];
    OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetConvex_PolygonInfoElement *infoElt = new_OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetConvex_PolygonInfoElement_initWithOrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetConvex_(self);
...
JavaUtilArrayList *OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetConvex_rotateFaceWithInt_withDouble_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetConvex *self, jint iFace, jdouble f) {
  JavaUtilArrayList *pointsToRotate = new_JavaUtilArrayList_init();
...
OrgGeogebraCommonKernelAlgosAlgoElement_OutputHandler *OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetConvex_createOutputPolygons(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetConvex *self) {
  return new_OrgGeogebraCommonKernelAlgosAlgoElement_OutputHandler_initWithOrgGeogebraCommonKernelAlgosAlgoElement_withOrgGeogebraCommonKernelAlgosAlgoElement_elementFactory_(self, new_OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetConvex_$4_initWithOrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetConvex_(self));
}
...
void OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetConvex_PolygonInfoElement_initWithOrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetConvex_(OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetConvex_PolygonInfoElement *self, OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronNetConvex *outer$) {
  (void) NSObject_init(self);
  self->pointIndex_ = new_JavaUtilArrayList_init();
}
