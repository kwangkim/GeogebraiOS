...
- (void)startEuclidianView3DElementWithNSString:(NSString *)eName
                      withJavaUtilLinkedHashMap:(JavaUtilLinkedHashMap *)attrs {
  if (evSet_ == nil) OrgGeogebraCommonIoMyXMLHandler_set_evSet_(self, [((OrgGeogebraCommonMainSettingsSettings *) nil_chk([((OrgGeogebraCommonMainApp *) nil_chk(app_)) getSettings])) getEuclidianWithInt:3]);
...
- (id<OrgGeogebraCommonKernelKernelNDGeoPointND>)handleAbsoluteStartPointWithJavaUtilLinkedHashMap:(JavaUtilLinkedHashMap *)attrs {
  ...
  if (wStr != nil) {
    ...
    p = [new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
    [p setCoordsWithDouble:x withDouble:y withDouble:z withDouble:w];
  }
  else {
    p = [new_OrgGeogebraCommonKernelGeosGeoPoint_initWithOrgGeogebraCommonKernelConstruction_(cons_) autorelease];
...
- (void)startEuclidianViewElementCheckViewIdWithNSString:(NSString *)eName
  ...
  if ([@"viewId" isEqual:eName]) {
    ...
    OrgGeogebraCommonIoMyXMLHandler_set_evSet_(self, [((OrgGeogebraCommonMainSettingsSettings *) nil_chk([((OrgGeogebraCommonMainApp *) nil_chk(app_)) getSettings])) getEuclidianForPlaneWithNSString:plane]);
    if (evSet_ == nil) {
      OrgGeogebraCommonIoMyXMLHandler_setAndConsume_evSet_(self, new_OrgGeogebraCommonGeogebra3DMainSettingsEuclidianSettingsForPlane_initWithOrgGeogebraCommonMainSettingsEuclidianSettings_(nil));
