...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/geogebra3D/euclidian3D/draw/DrawConicPart3D.java
//
...
- (void)updateLinesWithOrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterBrush:(OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterBrush *)brush {
  if ([((id<OrgGeogebraCommonKernelKernelNDGeoConicPartND>) nil_chk(((id<OrgGeogebraCommonKernelKernelNDGeoConicPartND>) check_protocol_cast(conic_, @protocol(OrgGeogebraCommonKernelKernelNDGeoConicPartND))))) positiveOrientation]) {
    ...
    OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawConic3D_set_d_(self, [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk([((id<OrgGeogebraCommonKernelKernelNDGeoConicPartND>) check_protocol_cast(conic_, @protocol(OrgGeogebraCommonKernelKernelNDGeoConicPartND))) getSegmentEnd3D])) subWithOrgGeogebraCommonKernelMatrixCoords:m_]);
...
void OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawConicPart3D_initWithOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D_withOrgGeogebraCommonKernelKernelNDGeoConicPartND_(OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawConicPart3D *self, OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D *view3d, id<OrgGeogebraCommonKernelKernelNDGeoConicPartND> conic) {
  OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawConic3D_initWithOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D_withOrgGeogebraCommonKernelKernelNDGeoConicND_(self, view3d, (OrgGeogebraCommonKernelKernelNDGeoConicND *) check_class_cast(conic, [OrgGeogebraCommonKernelKernelNDGeoConicND class]));
}
