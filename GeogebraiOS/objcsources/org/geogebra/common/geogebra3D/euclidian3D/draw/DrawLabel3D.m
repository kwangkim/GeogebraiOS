...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/geogebra3D/euclidian3D/draw/DrawLabel3D.java
//
...
withOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)v
                 withFloat:(jfloat)xOffset
                 withFloat:(jfloat)yOffset {
  OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawLabel3D_set_origin_(self, v);
  ...
  OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawLabel3D_setAndConsume_color_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_((jdouble) [((OrgGeogebraCommonAwtGColor *) nil_chk(color)) getRed] / 255, (jdouble) [color getGreen] / 255, (jdouble) [color getBlue] / 255, 1));
  if (backgroundColor != nil) OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawLabel3D_setAndConsume_backgroundColor_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_((jdouble) [backgroundColor getRed] / 255, (jdouble) [backgroundColor getGreen] / 255, (jdouble) [backgroundColor getBlue] / 255, 1));
  else OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawLabel3D_set_backgroundColor_(self, nil);
  ...
  if (waitForReset__ || ![text isEqual:self->text_] || ![((OrgGeogebraCommonAwtGFont *) nil_chk(font0)) isEqual:self->fontOriginal_]) {
    OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawLabel3D_set_text_(self, text);
    OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawLabel3D_set_fontOriginal_(self, font0);
    jint style = [((OrgGeogebraCommonAwtGFont *) nil_chk(fontOriginal_)) getStyle];
    jint size = [fontOriginal_ getSize];
    OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawLabel3D_set_font_(self, [fontOriginal_ deriveFontWithInt:style withFloat:(jfloat) (size * [self getFontScale])]);
...
- (id<OrgGeogebraCommonAwtGBufferedImage>)draw {
  ...
  if (OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawLabel3D_isLatexWithNSString_(text_) && ((jint) [((NSString *) nil_chk(text_)) length]) > 1) {
    ...
    [((OrgGeogebraCommonEuclidianDrawEquation *) nil_chk([((OrgGeogebraCommonMainApp *) nil_chk(app)) getDrawEquation])) drawEquationWithOrgGeogebraCommonMainApp:[((OrgGeogebraCommonKernelKernel *) nil_chk([geo getKernel])) getApplication] withOrgGeogebraCommonKernelGeosGeoElement:geo withOrgGeogebraCommonAwtGGraphics2D:g2d withInt:0 withInt:-offsetY withNSString:[text_ substring:1 endIndex:((jint) [text_ length]) - 1] withOrgGeogebraCommonAwtGFont:[((id<OrgGeogebraCommonAwtGGraphics2D>) nil_chk(g2d)) getFont] withBoolean:serif withOrgGeogebraCommonAwtGColor:[g2d getColor] withOrgGeogebraCommonAwtGColor:[g2d getBackground] withBoolean:YES withBoolean:NO];
    return bimg;
  }
  bimg = [self createBufferedImage];
  g2d = [self createGraphics2DWithOrgGeogebraCommonAwtGBufferedImage:bimg];
  if (hasIndex_) {
    OrgGeogebraCommonEuclidianEuclidianStatic_drawIndexedStringWithOrgGeogebraCommonMainApp_withOrgGeogebraCommonAwtGGraphics2D_withNSString_withFloat_withFloat_withBoolean_withBoolean_([((OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D *) nil_chk(view_)) getApplication], g2d, text_, 0, 0, NO, NO);
  }
  else {
...
- (void)updateDrawPosition {
  ...
  [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(v_)) setMulWithOrgGeogebraCommonKernelMatrixCoordMatrix:[((OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D *) nil_chk(view_)) getToScreenMatrix] withOrgGeogebraCommonKernelMatrixCoords:origin_];
...
void OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawLabel3D_initWithOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D_withOrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawable3D_(OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawLabel3D *self, OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D *view, OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawable3D *drawable) {
  ...
  OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawLabel3D_set_tempGraphics_(self, [((id<OrgGeogebraCommonAwtGBufferedImage>) nil_chk([((OrgGeogebraCommonFactoriesAwtFactory *) nil_chk(OrgGeogebraCommonFactoriesAwtFactory_get_prototype_())) newBufferedImageWithInt:1 withInt:1 withInt:OrgGeogebraCommonAwtGBufferedImage_TYPE_INT_ARGB])) createGraphics]);
  self->hasIndex_ = NO;
  OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawLabel3D_setAndConsume_v_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(3));
  self->textIndex_ = -1;
  self->pickingIndex_ = -1;
  self->backgroundIndex_ = -1;
  OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawLabel3D_set_view_(self, view);
  OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawLabel3D_set_drawable_(self, drawable);
}
