...
- (jboolean)updateForItSelf {
  ...
  (void) OrgGeogebraCommonEuclidianPlotCurvePlotter_drawWithOrgGeogebraCommonEuclidianPlotPathPlotter_withJavaUtilArrayList_(brush, [((OrgGeogebraCommonKernelGeosGeoLocusND *) nil_chk(((OrgGeogebraCommonKernelGeosGeoLocusND *) check_class_cast([self getGeoElement], [OrgGeogebraCommonKernelGeosGeoLocusND class])))) getPoints]);
...
void OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawLocus3D_initWithOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D_withOrgGeogebraCommonKernelGeosGeoLocusND_(OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawLocus3D *self, OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D *a_view3d, OrgGeogebraCommonKernelGeosGeoLocusND *locus) {
  (void) OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawable3DCurves_initWithOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D_withOrgGeogebraCommonKernelGeosGeoElement_(self, a_view3d, locus);
}
