    ...
    if (show90degrees) {
      {
        ...
        switch ([((OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D *) nil_chk([self getView3D])) getRightAngleStyle]) {
          ...
          if (tmpCoords2_ == nil) {
            OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawAngle3D_setAndConsume_tmpCoords2_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4));
          }
...
void OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawAngle3D_initWithOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D_withOrgGeogebraCommonKernelGeosGeoAngle_(OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawAngle3D *self, OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D *view3d, OrgGeogebraCommonKernelGeosGeoAngle *geo) {
  OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawable3DCurves_initWithOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D_withOrgGeogebraCommonKernelGeosGeoElement_(self, view3d, geo);
  OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawAngle3D_setAndConsume_labelCenter_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4));
  OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawAngle3D_setAndConsume_vn2_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4));
  OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawAngle3D_set_drawCoords_(self, nil);
  OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawAngle3D_setAndConsume_tmpCoords_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4));
  OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawAngle3D_setAndConsume_vn_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4));
}
...
void OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawAngle3D_initCoords(OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawAngle3D *self) {
  ...
  OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawAngle3D_setAndConsume_drawCoords_(self, [IOSObjectArray newArrayWithObjects:(id[]){ [new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4) autorelease], [new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4) autorelease], [new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4) autorelease] } count:3 type:OrgGeogebraCommonKernelMatrixCoords_class_()]);
}
