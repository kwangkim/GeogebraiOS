...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/geogebra3D/euclidian3D/draw/DrawAxis3D.java
//
  ...
  if ([((OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D *) nil_chk([self getView3D])) getShowAxisNumbersWithInt:axisIndex]) {
    ...
    for (jint i = iMin; i <= iMax; i++) {
      ...
      if (label != nil) {
        ...
        label = [new_OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawLabel3D_initWithOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D_withOrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawable3D_([self getView3D], self) autorelease];
...
void OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawAxis3D_initWithOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D_withOrgGeogebraCommonKernelKernelNDGeoAxisND_(OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawAxis3D *self, OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D *view3D, id<OrgGeogebraCommonKernelKernelNDGeoAxisND> axis3D) {
  OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawLine3D_initWithOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D_withOrgGeogebraCommonKernelKernelNDGeoLineND_(self, view3D, axis3D);
  self->outsideBox_ = NO;
  ...
  OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawAxis3D_setAndConsume_labels_(self, new_JavaUtilTreeMap_init());
}
