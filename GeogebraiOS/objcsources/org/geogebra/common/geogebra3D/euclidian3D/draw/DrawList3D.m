...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/geogebra3D/euclidian3D/draw/DrawList3D.java
//
...
- (jboolean)updateForItSelf {
  ...
  for (jint i = [drawables_ size] - 1; i >= drawablePos; i--) {
    ...
    (void) [drawables_ removeWithInt:i];
  }
...
void OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawList3D_initWithOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D_withOrgGeogebraCommonKernelGeosGeoList_(OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawList3D *self, OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D *view3D, OrgGeogebraCommonKernelGeosGeoList *geo) {
  ...
  self->drawables_ = new_OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawList3DArray_initWithOrgGeogebraCommonEuclidianEuclidianViewInterfaceCommon_withOrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawList3D_(view3D, self);
  self->geoList_ = geo;
  self->drawable3DLists_ = new_OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawable3DListsForDrawList3D_initWithOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D_(view3D);
