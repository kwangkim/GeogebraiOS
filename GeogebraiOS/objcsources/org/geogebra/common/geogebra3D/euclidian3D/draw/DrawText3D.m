...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/geogebra3D/euclidian3D/draw/DrawText3D.java
//
...
- (OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawLabel3D *)newDrawLabel3DWithOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D:(OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D *)view3D {
  return new_OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawLabel3DForText_initWithOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D_withOrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawable3D_(view3D, self);
}
...
- (OrgGeogebraCommonKernelMatrixCoords *)getLabelPosition {
  OrgGeogebraCommonKernelGeosGeoText *text = (OrgGeogebraCommonKernelGeosGeoText *) check_class_cast([self getGeoElement], [OrgGeogebraCommonKernelGeosGeoText class]);
  if ([((OrgGeogebraCommonKernelGeosGeoText *) nil_chk(text)) isAbsoluteScreenLocActive]) return new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_([text getAbsoluteScreenLocX], [text getAbsoluteScreenLocY], 0, 1);
  id<OrgGeogebraCommonKernelKernelNDGeoPointND> loc = [text getStartPoint];
  if (loc == nil) return new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_(0, 0, 0, 1);
...
void OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawText3D_initWithOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D_withOrgGeogebraCommonKernelGeosGeoText_(OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawText3D *self, OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D *a_view3d, OrgGeogebraCommonKernelGeosGeoText *text) {
  (void) OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawable3DCurves_initWithOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D_withOrgGeogebraCommonKernelGeosGeoElement_(self, a_view3d, text);
