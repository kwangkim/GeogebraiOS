...
- (void)setPointWithOrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D:(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D *)point0 {
  self->point_ = point0;
  p1_ = [((OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D *) nil_chk(point_)) getCoords];
  p2_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4);
...
- (void)drawOutlineWithOrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer:(OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer *)renderer {
  [((OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer *) nil_chk(renderer)) setColorWithOrgGeogebraCommonKernelMatrixCoords:new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_(0, 0, 0, 1)];
...
void OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawPointDecorations_initWithOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D_(OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawPointDecorations *self, OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D *aView3d) {
  (void) OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawCoordSys1D_initWithOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D_(self, aView3d);
  [self setDrawMinMaxWithDouble:0 withDouble:1];
  self->p1_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4);
  [self->p1_ setWWithDouble:1];
  self->p2_ = [self->p1_ copyVector];
  self->planeMatrix_ = OrgGeogebraCommonKernelMatrixCoordMatrix4x4_Identity();
