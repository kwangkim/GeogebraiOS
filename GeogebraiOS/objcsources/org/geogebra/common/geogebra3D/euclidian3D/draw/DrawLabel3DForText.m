...
- (id<OrgGeogebraCommonAwtGBufferedImage>)draw {
  ...
  if ([((OrgGeogebraCommonKernelGeosGeoText *) nil_chk(geo_)) isLaTeX]) {
    OrgGeogebraCommonEuclidianEuclidianStatic_drawMultilineLaTeXWithOrgGeogebraCommonMainApp_withOrgGeogebraCommonAwtGGraphics2D_withOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonAwtGGraphics2D_withOrgGeogebraCommonAwtGFont_withOrgGeogebraCommonAwtGColor_withOrgGeogebraCommonAwtGColor_withNSString_withInt_withInt_withBoolean_([((OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D *) nil_chk(view_)) getApplication], tempGraphics_, geo_, g2d, font_, OrgGeogebraCommonAwtGColor_get_BLACK_(), OrgGeogebraCommonAwtGColor_get_WHITE_(), text_, 0, 0, NO);
  }
  else {
    OrgGeogebraCommonEuclidianEuclidianStatic_drawMultiLineTextWithOrgGeogebraCommonMainApp_withNSString_withInt_withInt_withOrgGeogebraCommonAwtGGraphics2D_withBoolean_withOrgGeogebraCommonAwtGFont_([((OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D *) nil_chk(view_)) getApplication], text_, 0, 0, g2d, NO, [((id<OrgGeogebraCommonAwtGGraphics2D>) nil_chk(g2d)) getFont]);
  }
  return bimg;
}

- (void)setGeoWithOrgGeogebraCommonKernelGeosGeoText:(OrgGeogebraCommonKernelGeosGeoText *)geo {
  OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawLabel3DForText_set_geo_(self, geo);
}
