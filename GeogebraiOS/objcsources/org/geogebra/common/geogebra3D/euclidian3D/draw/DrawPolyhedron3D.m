...
- (void)updatePreview {
  ...
  if ([((JavaUtilArrayList *) nil_chk(selectedPolygons_)) size] == 1) {
    ...
    switch (previewMode_) {
      ...
      previewAlgo_ = new_OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronPointsPyramid_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelGeosGeoPolygon_withOrgGeogebraCommonKernelKernelNDGeoPointND_(cons, nil, [selectedPolygons_ getWithInt:0], [((OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D *) nil_chk([self getView3D])) getCursor3D]);
      break;
      case OrgGeogebraCommonEuclidianEuclidianConstants_MODE_PRISM:
      previewAlgo_ = new_OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronPointsPrism_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelGeosGeoPolygon_withOrgGeogebraCommonKernelKernelNDGeoPointND_(cons, nil, [selectedPolygons_ getWithInt:0], [((OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D *) nil_chk([self getView3D])) getCursor3D]);
      break;
    }
...
- (void)previewBasisIsFinished {
  previewBasisIsFinished__ = YES;
  [((OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawPolygon3D *) nil_chk(drawPolygon3D_)) disposePreview];
  IOSObjectArray *points = [IOSObjectArray newArrayWithLength:[((JavaUtilArrayList *) nil_chk(selectedPoints_)) size] + 1 type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()];
  for (jint i = 0; i < [selectedPoints_ size]; i++) {
    (void) IOSObjectArray_Set(points, i, [selectedPoints_ getWithInt:i]);
  }
  (void) IOSObjectArray_Set(points, [selectedPoints_ size], [((OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D *) nil_chk([self getView3D])) getCursor3D]);
  OrgGeogebraCommonKernelConstruction *cons = [((OrgGeogebraCommonGeogebra3DKernel3DKernel3D *) nil_chk([((OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D *) nil_chk([self getView3D])) getKernel])) getConstruction];
  switch (previewMode_) {
    case OrgGeogebraCommonEuclidianEuclidianConstants_MODE_PYRAMID:
    previewAlgo_ = new_OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronPointsPyramid_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_(cons, nil, points);
    break;
    case OrgGeogebraCommonEuclidianEuclidianConstants_MODE_PRISM:
    previewAlgo_ = new_OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronPointsPrism_initWithOrgGeogebraCommonKernelConstruction_withNSStringArray_withOrgGeogebraCommonKernelKernelNDGeoPointNDArray_(cons, nil, points);
    break;
  }
  [((OrgGeogebraCommonGeogebra3DKernel3DAlgosAlgoPolyhedronPoints *) nil_chk(previewAlgo_)) removeOutputFromAlgebraView];
  [previewAlgo_ removeOutputFromPicking];
...
void OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawPolyhedron3D_initWithOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D_withOrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron_(OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawPolyhedron3D *self, OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D *a_view3D, OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron *poly) {
  (void) OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawable3DSurfaces_initWithOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D_withOrgGeogebraCommonKernelGeosGeoElement_(self, a_view3D, poly);
  self->isPreview_ = NO;
...
void OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawPolyhedron3D_initWithOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D_withJavaUtilArrayList_withJavaUtilArrayList_withInt_(OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawPolyhedron3D *self, OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D *a_view3D, JavaUtilArrayList *selectedPoints, JavaUtilArrayList *selectedPolygons, jint mode) {
  ...
  self->pt_ = new_OrgGeogebraCommonKernelDiscretePolygonTriangulation_init();
  self->previewBasisIsFinished__ = NO;
  self->drawPolygon3D_ = new_OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawPolygon3D_initWithOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D_withJavaUtilArrayList_(a_view3D, selectedPoints);
  self->selectedPoints_ = selectedPoints;
  self->selectedPolygons_ = selectedPolygons;
  self->isPreview_ = YES;
