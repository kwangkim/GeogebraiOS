...
- (IOSObjectArray *)calcPoints {
  ...
  if ([geo getStartPoint] == nil) {
    p1 = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4);
    [p1 setWWithDouble:1];
  }
  ...
  return [IOSObjectArray newArrayWithObjects:(id[]){ p1, p2 } count:2 type:OrgGeogebraCommonKernelMatrixCoords_class_()];
}
...
void OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawVector3D_initWithOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D_withOrgGeogebraCommonKernelKernelNDGeoVectorND_(OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawVector3D *self, OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D *view3D, id<OrgGeogebraCommonKernelKernelNDGeoVectorND> vector) {
  (void) OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawJoinPoints_initWithOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D_withOrgGeogebraCommonKernelGeosGeoElement_(self, view3D, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(vector, [OrgGeogebraCommonKernelGeosGeoElement class]));
