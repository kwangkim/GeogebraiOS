...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/geogebra3D/euclidian3D/draw/DrawPolygon3D.java
//
...
- (void)updatePreview {
  ...
  for (; [i hasNext]; ) {
    ...
    point = (id<OrgGeogebraCommonKernelKernelNDGeoPointND>) check_protocol_cast([i next], @protocol(OrgGeogebraCommonKernelKernelNDGeoPointND));
    [sp addWithId:point];
    OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawSegment3D *s = [new_OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawSegment3D_initWithOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D_withJavaUtilArrayList_([self getView3D], sp) autorelease];
  ...
  IOSObjectArray *points = [IOSObjectArray arrayWithLength:[selectedPoints_ size] + 1 type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()];
  index = 0;
  for (id<JavaUtilIterator> p = [selectedPoints_ iterator]; [((id<JavaUtilIterator>) nil_chk(p)) hasNext]; ) {
    IOSObjectArray_Set(points, index, (id<OrgGeogebraCommonKernelKernelNDGeoPointND>) check_protocol_cast([p next], @protocol(OrgGeogebraCommonKernelKernelNDGeoPointND)));
    index++;
  }
  IOSObjectArray_Set(points, index, [((OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D *) nil_chk([self getView3D])) getCursor3D]);
...
- (jboolean)hitWithOrgGeogebraCommonGeogebra3DEuclidian3DHitting:(OrgGeogebraCommonGeogebra3DEuclidian3DHitting *)hitting {
  ...
  if (globalCoords_ == nil) {
    OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawPolygon3D_setAndConsume_globalCoords_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4));
    OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawPolygon3D_setAndConsume_inPlaneCoords_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4));
  }
  if ([((OrgGeogebraCommonGeogebra3DEuclidian3DHitting *) nil_chk(hitting)) isSphere]) {
    ...
    if (hittingPointForOutline_ == nil) {
      OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawPolygon3D_setAndConsume_hittingPointForOutline_(self, new_OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_initWithOrgGeogebraCommonKernelConstruction_([poly getConstruction]));
    ...
    if (project_ == nil) {
      OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawPolygon3D_set_project_(self, OrgGeogebraCommonKernelMatrixCoords_createInhomCoorsInD3());
    }
...
void OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawPolygon3D_initWithOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D_withOrgGeogebraCommonKernelGeosGeoPolygon_(OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawPolygon3D *self, OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D *a_view3D, OrgGeogebraCommonKernelGeosGeoPolygon *polygon) {
  OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawable3DSurfaces_initWithOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D_withOrgGeogebraCommonKernelGeosGeoElement_(self, a_view3D, polygon);
  OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawPolygon3D_setAndConsume_vertices_(self, [IOSObjectArray newArrayWithLength:0 type:OrgGeogebraCommonKernelMatrixCoords_class_()]);
  OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawPolygon3D_setAndConsume_pt_(self, new_OrgGeogebraCommonKernelDiscretePolygonTriangulation_init());
  OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawPolygon3D_setAndConsume_boundsMin_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(3));
  OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawPolygon3D_setAndConsume_boundsMax_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(3));
  self->isPreview_ = NO;
  OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawPolygon3D_setAndConsume_parameters_(self, [IOSDoubleArray newArrayWithLength:2]);
...
void OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawPolygon3D_updateVerticesWithOrgGeogebraCommonKernelGeosGeoPolygon_withInt_(OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawPolygon3D *self, OrgGeogebraCommonKernelGeosGeoPolygon *polygon, jint pointLength) {
  if (((IOSObjectArray *) nil_chk(self->vertices_))->size_ < pointLength) {
    OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawPolygon3D_setAndConsume_vertices_(self, [IOSObjectArray newArrayWithLength:pointLength type:OrgGeogebraCommonKernelMatrixCoords_class_()]);
...
void OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawPolygon3D_initWithOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D_withJavaUtilArrayList_(OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawPolygon3D *self, OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D *a_view3D, JavaUtilArrayList *selectedPoints) {
  ...
  OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawPolygon3D_set_selectedPoints_(self, selectedPoints);
  OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawPolygon3D_setAndConsume_segments_(self, new_JavaUtilArrayList_init());
  OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawPolygon3D_setAndConsume_segmentsPoints_(self, new_JavaUtilArrayList_init());
  [self setPickingTypeWithOrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_PickingTypeEnum:OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_PickingTypeEnum_get_SURFACE()];
  self->isPreview_ = YES;
  [self updatePreview];
}
