...
void OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3DCompanion_initWithOrgGeogebraCommonEuclidianEuclidianController_(OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3DCompanion *self, OrgGeogebraCommonEuclidianEuclidianController *ec) {
  ...
  OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3DCompanion_setAndConsume_tmpCoords1_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4));
  OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3DCompanion_setAndConsume_tmpCoords2_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4));
  OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3DCompanion_set_captureCoords_(self, OrgGeogebraCommonKernelMatrixCoords_createInhomCoorsInD3());
}
