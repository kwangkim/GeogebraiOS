...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/geogebra3D/euclidian3D/EuclidianController3D.java
//
...
- (OrgGeogebraCommonEuclidianEuclidianControllerCompanion *)newCompanion {
  return new_OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3DCompanion_initWithOrgGeogebraCommonEuclidianEuclidianController_(self);
}

- (void)setView3DWithOrgGeogebraCommonEuclidianEuclidianView:(OrgGeogebraCommonEuclidianEuclidianView *)view {
  self->view3D_ = (OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D *) check_class_cast(view, [OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D class]);
}
...
- (void)setMovedGeoPointWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo {
  ...
  xMinMax_ = OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D_getMinMaxWithDouble_withDouble_withDouble_(self, [view3D_ getXmin] + size, [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(coords)) getX], [view3D_ getXmax] - size);
  yMinMax_ = OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D_getMinMaxWithDouble_withDouble_withDouble_(self, [view3D_ getYmin] + size, [coords getY], [view3D_ getYmax] - size);
  zMinMax_ = OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D_getMinMaxWithDouble_withDouble_withDouble_(self, [view3D_ getZmin] + size, [coords getZ], [view3D_ getZmax] - size);
...
- (OrgGeogebraCommonKernelMatrixCoordMatrix4x4 *)getCurrentPlane {
  if (currentPlane_ == nil) {
    currentPlane_ = OrgGeogebraCommonKernelMatrixCoordMatrix4x4_Identity();
  }
...
- (void)movePointOnCurrentPlaneWithOrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D:(OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D *)point
  ...
  if (useOldMouse) {
    ...
    positionOld_ = [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk([((OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D *) nil_chk(point)) getCoords])) copyVector];
...
- (void)addOffsetForTranslationWithOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)o {
  if (moveMode__ == OrgGeogebraCommonEuclidianEuclidianController_MOVE_POINT_WITH_OFFSET) {
    (void) [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(o)) setAddWithOrgGeogebraCommonKernelMatrixCoords:o withOrgGeogebraCommonKernelMatrixCoords:translationVec3D_];
  }
}
    ...
    switch ([view3D_ getCursor3DType]) {
      ...
      if (onPathPossible) {
        ...
        if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk([((id<OrgGeogebraCommonKernelPath>) nil_chk(path)) toGeoElement])) isGeoElement3D] || ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk([path toGeoElement])) isGeoList] && [((OrgGeogebraCommonKernelGeosGeoList *) nil_chk(((OrgGeogebraCommonKernelGeosGeoList *) check_class_cast([path toGeoElement], [OrgGeogebraCommonKernelGeosGeoList class])))) containsGeoElement3D])) {
          ...
          pointCreated_ = [self createNewPoint2DWithNSString:nil withBoolean:NO withOrgGeogebraCommonKernelPath:path withDouble:[((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(coords)) getX] withDouble:[coords getY] withBoolean:NO withBoolean:NO];
      ...
      if (inRegionPossible) {
        ...
        if (region == [((OrgGeogebraCommonKernelKernel *) nil_chk([self getKernel])) getXOYPlane]) {
          ...
          OrgGeogebraCommonKernelMatrixCoords *coords = [point getCoordsInD2];
          pointCreated_ = [self createNewPoint2DWithNSString:nil withBoolean:NO withOrgGeogebraCommonKernelRegion:region withDouble:[((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(coords)) getX] withDouble:[coords getY] withBoolean:NO withBoolean:NO];
          return pointCreated_;
        }
      }
      else {
      ...
      if (intersectPossible) {
        ...
        pointCreated_ = intersectionPoint;
      ...
      default:
      pointCreated_ = [super getNewPointWithOrgGeogebraCommonEuclidianHits:hits withBoolean:onPathPossible withBoolean:inRegionPossible withBoolean:intersectPossible withBoolean:NO];
      return pointCreated_;
    }
  }
...
- (IOSObjectArray *)getSelectedPoints3D {
  IOSObjectArray *ret = [IOSObjectArray newArrayWithLength:[((JavaUtilArrayList *) nil_chk(selectedPoints_)) size] type:OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPoint3D_class_()];
  [self getSelectedPointsNDWithOrgGeogebraCommonKernelKernelNDGeoPointNDArray:ret];
  return ret;
}

- (IOSObjectArray *)getSelectedLines3D {
  IOSObjectArray *lines = [IOSObjectArray newArrayWithLength:[((JavaUtilArrayList *) nil_chk(selectedLines_)) size] type:OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCoordSys1D_class_()];
...
- (void)circleOrSphereWithOrgGeogebraCommonKernelArithmeticNumberValue:(id<OrgGeogebraCommonKernelArithmeticNumberValue>)num {
  ...
  (void) [((id<OrgGeogebraCommonKernelManager3DInterface>) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk([self getKernel])) getManager3D])) SphereWithNSString:nil withOrgGeogebraCommonKernelKernelNDGeoPointND:IOSObjectArray_Get(nil_chk(points), 0) withOrgGeogebraCommonKernelArithmeticNumberValue:num];
}
...
- (OrgGeogebraCommonGeogebra3DEuclidian3DTextDispatcher3D *)getTextDispatcher {
  if (textDispatcher_EuclidianController3D_ == nil) {
    textDispatcher_EuclidianController3D_ = new_OrgGeogebraCommonGeogebra3DEuclidian3DTextDispatcher3D_initWithOrgGeogebraCommonKernelKernel_withOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D_(kernel_, view3D_);
  }
...
- (IOSObjectArray *)switchModeForThreePointsWithInt:(jint)mode {
  {
    ...
    switch (mode) {
      ...
      ret = [IOSObjectArray newArrayWithObjects:(id[]){ ret0 } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
      return ret;
      default:
...
- (IOSObjectArray *)switchModeForCircleOrSphere2WithInt:(jint)mode {
  {
    ...
    switch (mode) {
      case OrgGeogebraCommonEuclidianEuclidianConstants_MODE_SPHERE_TWO_POINTS:
      points = [self getSelectedPointsND];
      ret = [IOSObjectArray newArrayWithObjects:(id[]){ nil } count:1 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
...
- (void)switchModeForMousePressedWithOrgGeogebraCommonEuclidianEventAbstractEvent:(OrgGeogebraCommonEuclidianEventAbstractEvent *)e {
  ...
  OrgGeogebraCommonEuclidianEventPointerEventTypeEnum *type = [((OrgGeogebraCommonEuclidianEventAbstractEvent *) nil_chk(e)) getType];
  {
    ...
    switch (mode_) {
      ...
      (void) OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D_extrusionOrConifyWithOrgGeogebraCommonEuclidianHits_(self, hits);
...
- (IOSObjectArray *)intersectWithOrgGeogebraCommonEuclidianHits:(OrgGeogebraCommonEuclidianHits *)hits {
  ...
  if (goodHits_ == nil) goodHits_ = new_OrgGeogebraCommonGeogebra3DEuclidian3DHits3D_init();
  ...
  if ([self selGeos] == 0) {
    ...
    if (OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D_selCS2D(self) == 1 || OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D_selQuadric(self) == 1) {
      (void) [hits getHitsWithOrgGeogebraCommonKernelGeosTestEnumArray:[IOSObjectArray newArrayWithObjects:(id[]){ OrgGeogebraCommonKernelGeosTestEnum_get_GEOCOORDSYS2D(), OrgGeogebraCommonKernelGeosTestEnum_get_GEOQUADRIC3D() } count:2 type:OrgGeogebraCommonKernelGeosTestEnum_class_()] withBoolean:YES withOrgGeogebraCommonEuclidianHits:goodHits_];
    }
    else {
      (void) [hits getHitsWithOrgGeogebraCommonKernelGeosTestEnumArray:[IOSObjectArray newArrayWithObjects:(id[]){ OrgGeogebraCommonKernelGeosTestEnum_get_GEOLINEND(), OrgGeogebraCommonKernelGeosTestEnum_get_GEOCOORDSYS2D(), OrgGeogebraCommonKernelGeosTestEnum_get_GEOQUADRICND() } count:3 type:OrgGeogebraCommonKernelGeosTestEnum_class_()] withBoolean:NO withOrgGeogebraCommonEuclidianHits:goodHits_];
    }
  ...
  if ([self selLines] >= 2) {
    ...
    if ([self selConics] >= 1) {
      ...
      IOSObjectArray *ret = [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
      ...
      for (jint i = 0; i < 2; i++) (void) IOSObjectArray_Set(ret, i, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(IOSObjectArray_Get(nil_chk(points), i), [OrgGeogebraCommonKernelGeosGeoElement class]));
      return ret;
    }
    ...
    IOSObjectArray *ret = [IOSObjectArray newArrayWithLength:4 type:OrgGeogebraCommonKernelGeosGeoElement_class_()];
    ...
    for (jint i = 0; i < ((IOSObjectArray *) nil_chk(points))->size_; i++) {
      ...
      (void) IOSObjectArray_Set(ret, i, (OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(IOSObjectArray_Get(points, i), [OrgGeogebraCommonKernelGeosGeoElement class]));
    }
    return ret;
  }
...
- (void)updatePastePreviewPosition {
  ...
  if (translationVec3D_ == nil) {
    translationVec3D_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(3);
  }
...
- (IOSObjectArray *)getSelectedCS1D {
  IOSObjectArray *lines = [IOSObjectArray newArrayWithLength:[((JavaUtilArrayList *) nil_chk(selectedCS1D_)) size] type:OrgGeogebraCommonGeogebra3DKernel3DGeosGeoCoordSys1D_class_()];
  jint i = 0;
  id<JavaUtilIterator> it = [selectedCS1D_ iterator];
  while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
    (void) IOSObjectArray_Set(lines, i, [it next]);
    i++;
  }
...
- (void)updateTranslationVectorWithOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)point {
  translationVec3D_ = [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(point)) subWithOrgGeogebraCommonKernelMatrixCoords:startPoint3D_];
}
...
- (void)setTranslateStartWithOrgGeogebraCommonKernelGeosGeoElement:(OrgGeogebraCommonKernelGeosGeoElement *)geo
  ...
  if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(geo)) isGeoPlane]) {
    translateDirection_ = [geo getMainDirection];
  }
  else {
    translateDirection_ = nil;
  }
}
...
- (void)moveVector {
  ...
  if (P == nil) {
    (void) [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(tmpCoords_)) setSubWithOrgGeogebraCommonKernelMatrixCoords:tmpCoords_ withOrgGeogebraCommonKernelMatrixCoords:startPoint3D_];
  }
  else {
    (void) [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(tmpCoords_)) setSubWithOrgGeogebraCommonKernelMatrixCoords:tmpCoords_ withOrgGeogebraCommonKernelMatrixCoords:[P getInhomCoordsInD3]];
  }
  (void) [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(tmpCoords_)) setAddWithOrgGeogebraCommonKernelMatrixCoords:tmpCoords_ withOrgGeogebraCommonKernelMatrixCoords:translationVec3D_];
    ...
    if ([algo isKindOfClass:[OrgGeogebraCommonKernelAlgosAlgoTranslate class]]) {
      ...
      if ([OrgGeogebraCommonKernelKernelNDGeoVectorND_class_() isInstance:in]) {
        if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(in)) isIndependent]) {
          movedGeoVector_ = (id<OrgGeogebraCommonKernelKernelNDGeoVectorND>) check_protocol_cast(IOSObjectArray_Get(input, 1), @protocol(OrgGeogebraCommonKernelKernelNDGeoVectorND));
...
- (IOSObjectArray *)getSelectedPolygons3D {
  IOSObjectArray *ret = [IOSObjectArray newArrayWithLength:[((JavaUtilArrayList *) nil_chk(selectedPolygons3D_)) size] type:OrgGeogebraCommonKernelGeosGeoPolygon_class_()];
  for (jint i = 0; i < [selectedPolygons3D_ size]; i++) {
    (void) IOSObjectArray_Set(ret, i, [selectedPolygons3D_ getWithInt:i]);
  }
...
- (OrgGeogebraCommonKernelGeosGeoAngle *)createAngle3D {
  ...
  if (OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D_selPlanes(self) == 1 && [self selLines] == 1) {
    IOSObjectArray *lines = [self getSelectedLinesND];
    IOSObjectArray *planes = OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D_getSelectedPlanes(self);
    (void) [((id<OrgGeogebraCommonKernelManager3DInterface>) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk(kernel_)) getManager3D])) Angle3DWithNSString:nil withOrgGeogebraCommonKernelKernelNDGeoLineND:IOSObjectArray_Get(nil_chk(lines), 0) withOrgGeogebraCommonKernelKernelNDGeoPlaneND:IOSObjectArray_Get(nil_chk(planes), 0)];
  }
  return nil;
}
...
void OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D_initWithOrgGeogebraCommonMainApp_(OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D *self, OrgGeogebraCommonMainApp *app) {
  (void) OrgGeogebraCommonEuclidianEuclidianController_initWithOrgGeogebraCommonMainApp_(self, app);
  self->currentPlane_ = nil;
  self->mouseLocOld_ = new_OrgGeogebraCommonAwtGPoint_init();
  self->positionOld_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4);
  self->freePointJustCreated_ = NO;
  self->viewRotationOccured_ = NO;
  self->intersectionCurveList_ = new_JavaUtilArrayList_init();
  self->selectedCS2D_ = new_JavaUtilArrayList_init();
  self->selectedPolygons3D_ = new_JavaUtilArrayList_init();
  self->selectedPlane_ = new_JavaUtilArrayList_init();
  self->tmpCoords_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4);
  self->dialogOccurred_ = NO;
  self->pyramidBasis_ = nil;
  self->polygonForPyramidBasis_ = NO;
  self->pointMoveMode_ = OrgGeogebraCommonKernelKernelNDGeoPointND_MOVE_MODE_XY;
  self->mouseMoved_ = NO;
  self->mouseEvent_ = nil;
  self->selectedCS1D_ = new_JavaUtilArrayList_init();
  self->selectedQuadric_ = new_JavaUtilArrayList_init();
  self->selectedQuadricLimited_ = new_JavaUtilArrayList_init();
  self->selectedPolyhedron_ = new_JavaUtilArrayList_init();
  self->startPoint3D_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_(0, 0, 0, 1);
  self->startPoint3DxOy_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_(0, 0, 0, 1);
  self->translationVec3D_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4);
  self->xMinMax_ = [IOSDoubleArray newArrayWithLength:2];
  self->yMinMax_ = [IOSDoubleArray newArrayWithLength:2];
  self->zMinMax_ = [IOSDoubleArray newArrayWithLength:2];
}
...
IOSDoubleArray *OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D_getMinMaxWithDouble_withDouble_withDouble_(OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D *self, jdouble min, jdouble val, jdouble max) {
  ...
  return [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ min, max } count:2];
}
...
IOSObjectArray *OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D_planeContainingWithOrgGeogebraCommonEuclidianHits_(OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D *self, OrgGeogebraCommonEuclidianHits *hits0) {
  OrgGeogebraCommonEuclidianHits *hits = [((OrgGeogebraCommonEuclidianHits *) nil_chk(hits0)) keepFirstsWithOrgGeogebraCommonKernelGeosTestEnumArray:[IOSObjectArray newArrayWithObjects:(id[]){ OrgGeogebraCommonKernelGeosTestEnum_get_GEOPOINTND(), OrgGeogebraCommonKernelGeosTestEnum_get_GEOLINEND(), OrgGeogebraCommonKernelGeosTestEnum_get_GEOCOORDSYS2DNOTPLANE() } count:3 type:OrgGeogebraCommonKernelGeosTestEnum_class_()]];
  if ([((OrgGeogebraCommonEuclidianHits *) nil_chk(hits)) isEmpty]) return nil;
...
IOSObjectArray *OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D_pyramidOrPrismWithOrgGeogebraCommonEuclidianHits_(OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D *self, OrgGeogebraCommonEuclidianHits *hits) {
  ...
  if (self->pyramidBasis_ == nil) {
    if ([self selPolygons] == 0) {
      if ([self selPoints] > 2) {
        ...
        if (finished) {
          ...
          self->pyramidBasis_ = [self getSelectedPointsND];
          OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D_cancelSwitchPointMoveModeIfNeeded(self);
          return nil;
        }
      }
    ...
    [self addSelectedPointWithOrgGeogebraCommonEuclidianHits:hits withInt:1 withBoolean:NO];
    if ([self selPoints] == 1) {
      IOSObjectArray *points = [IOSObjectArray newArrayWithLength:self->pyramidBasis_->size_ + 1 type:OrgGeogebraCommonKernelKernelNDGeoPointND_class_()];
      for (jint i = 0; i < self->pyramidBasis_->size_; i++) (void) IOSObjectArray_Set(points, i, IOSObjectArray_Get(self->pyramidBasis_, i));
      (void) IOSObjectArray_Set(points, self->pyramidBasis_->size_, IOSObjectArray_Get(nil_chk([self getSelectedPointsND]), 0));
      [((OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D *) nil_chk(self->view3D_)) disposePreview];
      switch (self->mode_) {
        case OrgGeogebraCommonEuclidianEuclidianConstants_MODE_PYRAMID:
        self->pyramidBasis_ = nil;
...
IOSObjectArray *OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D_intersectionCurveWithOrgGeogebraCommonEuclidianHits_(OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D *self, OrgGeogebraCommonEuclidianHits *hits) {
  ...
  if (OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D_selPlanes(self) == 1) {
    if (OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D_selQuadric(self) >= 1) {
      ...
      IOSObjectArray *ret = [((id<OrgGeogebraCommonKernelManager3DInterface>) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk([self getKernel])) getManager3D])) IntersectPathWithNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ nil } count:1 type:NSString_class_()] withOrgGeogebraCommonKernelKernelNDGeoPlaneND:plane withOrgGeogebraCommonKernelGeosGeoElement:poly];
      if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(IOSObjectArray_Get(nil_chk(ret), 0))) isDefined]) {
        (void) [((id<OrgGeogebraCommonKernelManager3DInterface>) nil_chk([((OrgGeogebraCommonKernelKernel *) nil_chk([self getKernel])) getManager3D])) IntersectionPointWithNSStringArray:[IOSObjectArray newArrayWithObjects:(id[]){ nil } count:1 type:NSString_class_()] withOrgGeogebraCommonKernelKernelNDGeoPlaneND:plane withOrgGeogebraCommonKernelGeosGeoElement:poly];
        return ret;
      }
      return nil;
    }
...
jboolean OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D_createIntersectionCurvePlanePolygonWithOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoPolygon_(OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D *self, OrgGeogebraCommonKernelGeosGeoElement *A, OrgGeogebraCommonKernelGeosGeoPolygon *B) {
  if ([((OrgGeogebraCommonKernelGeosGeoPolygon *) nil_chk(B)) getMetasLength] == 1) {
    ...
    OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawIntersectionCurve3D *drawPolygons = new_OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawIntersectionCurve3D_initWithOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D_withOrgGeogebraCommonKernelGeosGeoElement_(self->view3D_, IOSObjectArray_Get(nil_chk(ret), 0));
  ...
  OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawIntersectionCurve3D *drawSegments = new_OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawIntersectionCurve3D_initWithOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D_withOrgGeogebraCommonKernelGeosGeoElement_(self->view3D_, IOSObjectArray_Get(nil_chk(ret), 0));
  {
...
jboolean OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D_createIntersectionCurvePlaneQuadricWithOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelGeosGeoElement_(OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D *self, OrgGeogebraCommonKernelGeosGeoElement *A, OrgGeogebraCommonKernelGeosGeoElement *B) {
  ...
  if ([B isKindOfClass:[OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3DPart class]]) {
    ...
    if (quad != nil) {
      ...
      d = new_OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawConic3D_initWithOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D_withOrgGeogebraCommonKernelKernelNDGeoConicND_(self->view3D_, (OrgGeogebraCommonKernelKernelNDGeoConicND *) check_class_cast(ret, [OrgGeogebraCommonKernelKernelNDGeoConicND class]));
    }
  }
  else {
...
void OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D_decideIntersectionWithOrgGeogebraCommonEuclidianHits_(OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D *self, OrgGeogebraCommonEuclidianHits *hits) {
  ...
  for (OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D_IntersectionCurve * __strong intersectionCurve in nil_chk(self->intersectionCurveList_)) {
    ...
    if ([((OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawable3D *) nil_chk(d)) getZPickNear] > zNear) {
      self->resultedGeo_ = [d getGeoElement];
      self->resultedIntersectionCurve_ = intersectionCurve;
  ...
  if (self->goodHits_ == nil) self->goodHits_ = new_OrgGeogebraCommonGeogebra3DEuclidian3DHits3D_init();
...
IOSObjectArray *OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D_getSelectedCS2D(OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D *self) {
  IOSObjectArray *planes = [IOSObjectArray newArrayWithLength:[((JavaUtilArrayList *) nil_chk(self->selectedCS2D_)) size] type:OrgGeogebraCommonKernelKernelNDGeoCoordSys2D_class_()];
  jint i = 0;
  id<JavaUtilIterator> it = [self->selectedCS2D_ iterator];
  while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
    (void) IOSObjectArray_Set(planes, i, [it next]);
    i++;
  }
...
IOSObjectArray *OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D_getSelectedPlanes(OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D *self) {
  IOSObjectArray *planes = [IOSObjectArray newArrayWithLength:[((JavaUtilArrayList *) nil_chk(self->selectedPlane_)) size] type:OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPlane3D_class_()];
  jint i = 0;
...
IOSObjectArray *OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D_getSelectedQuadric(OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D *self) {
  IOSObjectArray *quads = [IOSObjectArray newArrayWithLength:[((JavaUtilArrayList *) nil_chk(self->selectedQuadric_)) size] type:OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3D_class_()];
  jint i = 0;
  id<JavaUtilIterator> it = [self->selectedQuadric_ iterator];
  while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
    (void) IOSObjectArray_Set(quads, i, [it next]);
    i++;
  }
...
IOSObjectArray *OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D_getSelectedQuadricLimited(OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D *self) {
  IOSObjectArray *quads = [IOSObjectArray newArrayWithLength:[((JavaUtilArrayList *) nil_chk(self->selectedQuadricLimited_)) size] type:OrgGeogebraCommonGeogebra3DKernel3DGeosGeoQuadric3DLimited_class_()];
  jint i = 0;
...
IOSObjectArray *OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D_getSelectedPolyhedron(OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D *self) {
  IOSObjectArray *polyh = [IOSObjectArray newArrayWithLength:[((JavaUtilArrayList *) nil_chk(self->selectedPolyhedron_)) size] type:OrgGeogebraCommonGeogebra3DKernel3DGeosGeoPolyhedron_class_()];
  jint i = 0;
  id<JavaUtilIterator> it = [self->selectedPolyhedron_ iterator];
  while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
    (void) IOSObjectArray_Set(polyh, i, [it next]);
    i++;
  }
...
void OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D_setTranslateFromPointStartWithOrgGeogebraCommonKernelGeosGeoElement_withOrgGeogebraCommonKernelKernelNDGeoPointND_(OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianController3D *self, OrgGeogebraCommonKernelGeosGeoElement *geo, id<OrgGeogebraCommonKernelKernelNDGeoPointND> point) {
  ...
  (void) [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(self->translationVec3D_)) setSubWithOrgGeogebraCommonKernelMatrixCoords:[((id<OrgGeogebraCommonKernelKernelNDGeoPointND>) nil_chk(point)) getInhomCoordsInD3] withOrgGeogebraCommonKernelMatrixCoords:self->startPoint3D_];
  if ([((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(geo)) isGeoPlane]) {
    self->translateDirection_ = [geo getMainDirection];
