...
- (OrgGeogebraCommonGeogebra3DEuclidian3DPlotsDynamicMeshElement2 *)getChildWithInt:(jint)i {
  if (i >= ((OrgGeogebraCommonGeogebra3DEuclidian3DPlotsDynamicMesh2 *) nil_chk(mesh_))->nChildren_) @throw [new_JavaLangIndexOutOfBoundsException_init() autorelease];
...
- (void)updateCullInfo {
  ...
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsDynamicMeshElement2_set_cullInfo_(self, OrgGeogebraCommonGeogebra3DEuclidian3DPlotsDynamicMeshElement2_getCullInfo(self));
...
void OrgGeogebraCommonGeogebra3DEuclidian3DPlotsDynamicMeshElement2_initWithOrgGeogebraCommonGeogebra3DEuclidian3DPlotsDynamicMesh2_withInt_withBoolean_withInt_(OrgGeogebraCommonGeogebra3DEuclidian3DPlotsDynamicMeshElement2 *self, OrgGeogebraCommonGeogebra3DEuclidian3DPlotsDynamicMesh2 *mesh, jint level, jboolean ignoreFlag, jint version_) {
  ...
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsDynamicMeshElement2_set_mesh_(self, mesh);
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsDynamicMeshElement2_setAndConsume_children_(self, [IOSObjectArray newArrayWithLength:((OrgGeogebraCommonGeogebra3DEuclidian3DPlotsDynamicMesh2 *) nil_chk(mesh))->nChildren_ type:OrgGeogebraCommonGeogebra3DEuclidian3DPlotsDynamicMeshElement2_class_()]);
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsDynamicMeshElement2_setAndConsume_parents_(self, [IOSObjectArray newArrayWithLength:mesh->nParents_ type:OrgGeogebraCommonGeogebra3DEuclidian3DPlotsDynamicMeshElement2_class_()]);
}
