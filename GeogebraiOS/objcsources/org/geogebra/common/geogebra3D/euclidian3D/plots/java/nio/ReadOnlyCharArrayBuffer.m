...
- (OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioCharBuffer *)slice {
  return new_OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioReadOnlyCharArrayBuffer_initWithInt_withCharArray_withInt_([self remaining], backingArray_, offset_ + position__);
}
