...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/geogebra3D/euclidian3D/plots/Collision.java
//
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonGeogebra3DEuclidian3DPlotsCollision class]) {
    OrgGeogebraCommonGeogebra3DEuclidian3DPlotsCollision_AAB_NORMALS_ = [IOSObjectArray newArrayWithObjects:(id[]){ [IOSFloatArray newArrayWithFloats:(jfloat[]){ -1, 0, 0 } count:3], [IOSFloatArray newArrayWithFloats:(jfloat[]){ 1, 0, 0 } count:3], [IOSFloatArray newArrayWithFloats:(jfloat[]){ 0, -1, 0 } count:3], [IOSFloatArray newArrayWithFloats:(jfloat[]){ 0, 1, 0 } count:3], [IOSFloatArray newArrayWithFloats:(jfloat[]){ 0, 0, -1 } count:3], [IOSFloatArray newArrayWithFloats:(jfloat[]){ 0, 0, 1 } count:3] } count:6 type:IOSClass_floatArray(1)];
...
IOSFloatArray *OrgGeogebraCommonGeogebra3DEuclidian3DPlotsCollision_triangleBoundingBoxWithFloatArray_(IOSFloatArray *tri) {
  ...
  IOSFloatArray *bb = [IOSFloatArray newArrayWithLength:6];
  for (jint i = 0; i < 3; i++) {
...
IOSObjectArray *OrgGeogebraCommonGeogebra3DEuclidian3DPlotsCollision_triTriIntersectionWithOrgGeogebraCommonKernelMatrixCoordsArray_withOrgGeogebraCommonKernelMatrixCoordsArray_(IOSObjectArray *t1, IOSObjectArray *t2) {
  ...
  return [IOSObjectArray newArrayWithObjects:(id[]){ [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(O)) addWithOrgGeogebraCommonKernelMatrixCoords:[D mulWithDouble:tf1]], [O addWithOrgGeogebraCommonKernelMatrixCoords:[D mulWithDouble:tf2]] } count:2 type:OrgGeogebraCommonKernelMatrixCoords_class_()];
}
...
IOSFloatArray *OrgGeogebraCommonGeogebra3DEuclidian3DPlotsCollision_subWithFloatArray_withFloatArray_(IOSFloatArray *v1, IOSFloatArray *v2) {
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsCollision_initialize();
  return [IOSFloatArray newArrayWithFloats:(jfloat[]){ IOSFloatArray_Get(nil_chk(v1), 0) - IOSFloatArray_Get(nil_chk(v2), 0), IOSFloatArray_Get(v1, 1) - IOSFloatArray_Get(v2, 1), IOSFloatArray_Get(v1, 2) - IOSFloatArray_Get(v2, 2) } count:3];
}
...
IOSFloatArray *OrgGeogebraCommonGeogebra3DEuclidian3DPlotsCollision_multWithFloatArray_withFloat_(IOSFloatArray *v, jfloat factor) {
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsCollision_initialize();
  return [IOSFloatArray newArrayWithFloats:(jfloat[]){ IOSFloatArray_Get(nil_chk(v), 0) * factor, IOSFloatArray_Get(v, 1) * factor, IOSFloatArray_Get(v, 2) * factor } count:3];
}
...
IOSFloatArray *OrgGeogebraCommonGeogebra3DEuclidian3DPlotsCollision_triTriIntersectWithFloatArray_withFloatArray_withJavaLangBoolean_withJavaLangBoolean_(IOSFloatArray *t0, IOSFloatArray *t1, JavaLangBoolean *coplanar, JavaLangBoolean *intersect) {
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsCollision_initialize();
  IOSFloatArray *v0 = [IOSFloatArray newArrayWithFloats:(jfloat[]){ IOSFloatArray_Get(nil_chk(t0), 0), IOSFloatArray_Get(t0, 1), IOSFloatArray_Get(t0, 2) } count:3];
  IOSFloatArray *v1 = [IOSFloatArray newArrayWithFloats:(jfloat[]){ IOSFloatArray_Get(t0, 3), IOSFloatArray_Get(t0, 4), IOSFloatArray_Get(t0, 5) } count:3];
  IOSFloatArray *v2 = [IOSFloatArray newArrayWithFloats:(jfloat[]){ IOSFloatArray_Get(t0, 6), IOSFloatArray_Get(t0, 7), IOSFloatArray_Get(t0, 8) } count:3];
  IOSFloatArray *u0 = [IOSFloatArray newArrayWithFloats:(jfloat[]){ IOSFloatArray_Get(nil_chk(t1), 0), IOSFloatArray_Get(t1, 1), IOSFloatArray_Get(t1, 2) } count:3];
  IOSFloatArray *u1 = [IOSFloatArray newArrayWithFloats:(jfloat[]){ IOSFloatArray_Get(t1, 3), IOSFloatArray_Get(t1, 4), IOSFloatArray_Get(t1, 5) } count:3];
  IOSFloatArray *u2 = [IOSFloatArray newArrayWithFloats:(jfloat[]){ IOSFloatArray_Get(t1, 6), IOSFloatArray_Get(t1, 7), IOSFloatArray_Get(t1, 8) } count:3];
  ...
  IOSFloatArray *isectpointA1 = [IOSFloatArray newArrayWithLength:3];
  IOSFloatArray *isectpointA2 = [IOSFloatArray newArrayWithLength:3];
  ...
  IOSFloatArray *isectpointB1 = [IOSFloatArray newArrayWithLength:3];
  IOSFloatArray *isectpointB2 = [IOSFloatArray newArrayWithLength:3];
  ...
  return [IOSFloatArray newArrayWithFloats:(jfloat[]){ IOSFloatArray_Get(nil_chk(isectpt1), 0), IOSFloatArray_Get(isectpt1, 1), IOSFloatArray_Get(isectpt1, 2), IOSFloatArray_Get(nil_chk(isectpt2), 0), IOSFloatArray_Get(isectpt2, 1), IOSFloatArray_Get(isectpt2, 2) } count:6];
}
...
jboolean OrgGeogebraCommonGeogebra3DEuclidian3DPlotsCollision_coplanarTriTriWithFloatArray_withFloatArray_withFloatArray_withFloatArray_withFloatArray_withFloatArray_withFloatArray_(IOSFloatArray *n, IOSFloatArray *t0, IOSFloatArray *t1, IOSFloatArray *t2, IOSFloatArray *u0, IOSFloatArray *u1, IOSFloatArray *u2) {
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsCollision_initialize();
  IOSFloatArray *a = [IOSFloatArray newArrayWithLength:3];
  jshort i0, i1;
...
IOSFloatArray *OrgGeogebraCommonGeogebra3DEuclidian3DPlotsCollision_isect2WithFloatArray_withFloatArray_withFloatArray_withFloat_withFloat_withFloat_withFloat_withFloat_withFloat_withFloatArray_withFloatArray_(IOSFloatArray *vt0, IOSFloatArray *vt1, IOSFloatArray *vt2, jfloat vv0, jfloat vv1, jfloat vv2, jfloat d0, jfloat d1, jfloat d2, IOSFloatArray *isectpoint0, IOSFloatArray *isectpoint1) {
  ...
  return [IOSFloatArray newArrayWithFloats:(jfloat[]){ isect0, isect1 } count:2];
}
...
jint OrgGeogebraCommonGeogebra3DEuclidian3DPlotsCollision_rayTriIntersectWithFloatArray_withFloatArray_withFloatArray_withJavaLangFloat_withFloatArray_(IOSFloatArray *p0, IOSFloatArray *p1, IOSFloatArray *t, JavaLangFloat *param, IOSFloatArray *intersection) {
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsCollision_initialize();
  IOSFloatArray *v0 = [IOSFloatArray newArrayWithFloats:(jfloat[]){ IOSFloatArray_Get(nil_chk(t), 0), IOSFloatArray_Get(t, 1), IOSFloatArray_Get(t, 2) } count:3];
  IOSFloatArray *v1 = [IOSFloatArray newArrayWithFloats:(jfloat[]){ IOSFloatArray_Get(t, 3), IOSFloatArray_Get(t, 4), IOSFloatArray_Get(t, 5) } count:3];
  IOSFloatArray *v2 = [IOSFloatArray newArrayWithFloats:(jfloat[]){ IOSFloatArray_Get(t, 6), IOSFloatArray_Get(t, 7), IOSFloatArray_Get(t, 8) } count:3];
...
jboolean OrgGeogebraCommonGeogebra3DEuclidian3DPlotsCollision_rayBoxIntersectWithFloatArray_withFloatArray_withFloatArray_withFloatArray_withFloatArray_(IOSFloatArray *box, IOSFloatArray *origin, IOSFloatArray *t, IOSFloatArray *entry_, IOSFloatArray *exit) {
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsCollision_initialize();
  IOSFloatArray *params = [IOSFloatArray newArrayWithLength:6];
  IOSBooleanArray *intersect = [IOSBooleanArray newArrayWithLength:6];
  IOSObjectArray *pts = [IOSObjectArray newArrayWithLength:2 type:IOSClass_floatArray(1)];
  IOSFloatArray *p = [IOSFloatArray newArrayWithLength:2];
  IOSObjectArray *pp = [IOSObjectArray newArrayWithObjects:(id[]){ [IOSFloatArray newArrayWithFloats:(jfloat[]){ IOSFloatArray_Get(nil_chk(box), 0), IOSFloatArray_Get(box, 2), IOSFloatArray_Get(box, 4) } count:3], [IOSFloatArray newArrayWithFloats:(jfloat[]){ IOSFloatArray_Get(box, 1), IOSFloatArray_Get(box, 2), IOSFloatArray_Get(box, 4) } count:3], [IOSFloatArray newArrayWithFloats:(jfloat[]){ IOSFloatArray_Get(box, 0), IOSFloatArray_Get(box, 2), IOSFloatArray_Get(box, 4) } count:3], [IOSFloatArray newArrayWithFloats:(jfloat[]){ IOSFloatArray_Get(box, 0), IOSFloatArray_Get(box, 3), IOSFloatArray_Get(box, 4) } count:3], [IOSFloatArray newArrayWithFloats:(jfloat[]){ IOSFloatArray_Get(box, 0), IOSFloatArray_Get(box, 2), IOSFloatArray_Get(box, 4) } count:3], [IOSFloatArray newArrayWithFloats:(jfloat[]){ IOSFloatArray_Get(box, 0), IOSFloatArray_Get(box, 2), IOSFloatArray_Get(box, 5) } count:3] } count:6 type:IOSClass_floatArray(1)];
  for (jint i = 0; i < 6; i++) {
  ...
  for (jint i = 0; i < 6; i++) {
    if (IOSBooleanArray_Get(intersect, i)) {
      ...
      if (OrgGeogebraCommonGeogebra3DEuclidian3DPlotsCollision_pointBoxIntersectWithFloatArray_withFloatArray_(IOSObjectArray_Get(pts, i), box)) {
        (void) IOSObjectArray_Set(pts, j++, in);
...
jboolean OrgGeogebraCommonGeogebra3DEuclidian3DPlotsCollision_segmentTriIntersectWithFloatArray_withFloatArray_withFloatArray_withFloatArray_(IOSFloatArray *p0, IOSFloatArray *p1, IOSFloatArray *t, IOSFloatArray *intersection) {
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsCollision_initialize();
  JavaLangFloat *param = new_JavaLangFloat_initWithFloat_(-1);
