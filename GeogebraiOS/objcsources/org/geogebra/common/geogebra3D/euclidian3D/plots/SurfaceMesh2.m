...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/geogebra3D/euclidian3D/plots/SurfaceMesh2.java
//
...
- (void)calcMainVertexWithDouble:(jdouble)u
  ...
  if (v2def != v3def) {
    ...
    OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_set_alt_(self, hi);
    f = lo;
    OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_setAndConsume_ancestorDiff_(self, [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ IOSDoubleArray_Get(a1->params_, 0) - IOSDoubleArray_Get(a0->params_, 0), IOSDoubleArray_Get(a1->params_, 1) - IOSDoubleArray_Get(a0->params_, 1) } count:2]);
    *IOSDoubleArray_GetRef(params_, 0) = ui;
    *IOSDoubleArray_GetRef(params_, 1) = vi;
    OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_setAndConsume_originalParams_(self, [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ u, v } count:2]);
  }
  else {
    jfloat d = 1e-6f;
  ...
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_set_vertex_(self, f);
}
...
- (void)createChildWithInt:(jint)i {
  ...
  if (i == 1 || i == 3) IOSObjectArray_SetAndConsume(nil_chk(children_), i, new_OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_initWithOrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceMesh2_withOrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_withInt_withOrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_withInt_withOrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_withOrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_withInt_withInt_((OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceMesh2 *) check_class_cast(mesh_, [OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceMesh2 class]), otherParent, otherIndex, self, i, a0, a1, level_ + 1, lastVersion_));
  else IOSObjectArray_SetAndConsume(nil_chk(children_), i, new_OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_initWithOrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceMesh2_withOrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_withInt_withOrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_withInt_withOrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_withOrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_withInt_withInt_((OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceMesh2 *) check_class_cast(mesh_, [OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceMesh2 class]), self, i, otherParent, otherIndex, a0, a1, level_ + 1, lastVersion_));
...
- (jboolean)recalculateWithInt:(jint)currentVersion
  ...
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_set_normal_(self, OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_approxNormalWithDouble_withDouble_(self, IOSDoubleArray_Get(params_, 0), IOSDoubleArray_Get(params_, 1)));
  [self setBoundingBox];
  [self setArea];
  [self generateError];
  return YES;
...
- (void)setBoundingBox {
  ...
  IOSDoubleArray *xs = [IOSDoubleArray arrayWithDoubles:(jdouble[]){ [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(v2)) getX], [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(v3)) getX], [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(v4)) getX], [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(v5)) getX] } count:4];
  ...
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsDynamicMeshElement2_setAndConsume_boundingBox_(self, [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ x0, x1, y0, y1, z0, z1 } count:6]);
}
...
void OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_initWithOrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceMesh2_withInt_withDouble_withDouble_withBoolean_withInt_(OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2 *self, OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceMesh2 *mesh, jint level, jdouble pa1, jdouble pa2, jboolean isClipped, jint version_) {
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsDynamicMeshElement2_initWithOrgGeogebraCommonGeogebra3DEuclidian3DPlotsDynamicMesh2_withInt_withBoolean_withInt_(self, mesh, level, isClipped, version_);
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_setAndConsume_errors_(self, [IOSDoubleArray newArrayWithLength:2]);
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_setAndConsume_triangles_(self, [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonGeogebra3DEuclidian3DPlotsTriListElem_class_()]);
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_setAndConsume_params_(self, [IOSDoubleArray newArrayWithLength:2]);
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_set_alt_(self, nil);
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_setAndConsume_ancestors_(self, [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_class_()]);
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_setAndConsume_indices_(self, [IOSIntArray newArrayWithLength:2]);
  *IOSDoubleArray_GetRef(self->params_, 0) = pa1;
  *IOSDoubleArray_GetRef(self->params_, 1) = pa2;
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_set_vertex_(self, OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_calcVertexWithDouble_withDouble_(self, pa1, pa2));
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_set_normal_(self, OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_approxNormalWithDouble_withDouble_(self, pa1, pa2));
}
...
void OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_initWithOrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceMesh2_withOrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_withInt_withOrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_withInt_withOrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_withOrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_withInt_withInt_(OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2 *self, OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceMesh2 *mesh, OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2 *parent0, jint index0, OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2 *parent1, jint index1, OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2 *ancestor0, OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2 *ancestor1, jint level, jint version_) {
  ...
  *IOSDoubleArray_GetRef(self->params_, 1) = (IOSDoubleArray_Get(ancestor0->params_, 1) + IOSDoubleArray_Get(ancestor1->params_, 1)) * 0.5;
  ...
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_set_normal_(self, OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_approxNormalWithDouble_withDouble_(self, IOSDoubleArray_Get(self->params_, 0), IOSDoubleArray_Get(self->params_, 1)));
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_init__(self);
}
...
- (void)setCullingBoxWithDoubleArray:(IOSDoubleArray *)bb {
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsDynamicMesh2_set_cullingBox_(self, bb);
...
- (OrgGeogebraCommonGeogebra3DEuclidian3DPlotsOctree *)getObjectOctree {
  if (octree_ == nil) {
    OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceMesh2_setAndConsume_octree_(self, new_OrgGeogebraCommonGeogebra3DEuclidian3DPlotsTriangleOctree_init());
    ...
    for (jint i = 0; i < n; i++) {
      [((OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioFloatBuffer *) nil_chk(buf)) getWithFloatArray:temp];
      @try {
...
void OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceMesh2_initMeshWithDouble_withDouble_withDouble_withDouble_(OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceMesh2 *self, jdouble xMin, jdouble xMax, jdouble yMin, jdouble yMax) {
  ...
  IOSObjectArray *base0 = [IOSObjectArray arrayWithDimensions:2 lengths:(jint[]){ 4, 4 } type:OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_class_()];
  IOSObjectArray *base1 = [IOSObjectArray arrayWithDimensions:2 lengths:(jint[]){ 4, 4 } type:OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_class_()];
  jdouble dx = (xMax - xMin);
  jdouble dy = (yMax - yMin);
  for (jint i = 0; i < 4; i++) for (jint j = 0; j < 4; j++) {
    x = xMin + (i - 0.5) * dx;
    y = yMin + (j - 0.5) * dy;
    IOSObjectArray_SetAndConsume(nil_chk(IOSObjectArray_Get(base0, j)), i, new_OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_initWithOrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceMesh2_withInt_withDouble_withDouble_withBoolean_withInt_(self, 0, x, y, !(i == 1 && j == 1), self->currentVersion_));
    x = xMin + (i - 1) * dx;
    y = yMin + (j - 1) * dy;
    IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(base1, j)), i, t = [new_OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_initWithOrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceMesh2_withInt_withDouble_withDouble_withBoolean_withInt_(self, ((i ^ j) & 1) != 0 ? -1 : -2, x, y, NO, self->currentVersion_) autorelease]);
  ...
  for (jint i = 0; i < 4; i++) for (jint j = 0; j < 4; j++) {
    ...
    jx = (RShift32(2 * j, 1)) % 4;
    IOSObjectArray_Set(nil_chk(((OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2 *) nil_chk(t))->parents_), 0, IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(base1, jx)), ix));
    ix = (RShift32((2 * i + 1 + di), 1)) % 4;
  ...
  for (jint i = 0; i < 4; i++) for (jint j = 0; j < 4; j++) {
    ...
    IOSObjectArray_Set(nil_chk(((OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2 *) nil_chk(t))->ancestors_), 1, IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(base1, (j + 3) % 4)), i));
  ...
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceMesh2_set_root_(self, IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(base0, 1)), 1));
...
- (void)addWithOrgGeogebraCommonGeogebra3DEuclidian3DPlotsDynamicMeshElement2:(OrgGeogebraCommonGeogebra3DEuclidian3DPlotsDynamicMeshElement2 *)e
  ...
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsTriListElem *lm = ignore ? [new_OrgGeogebraCommonGeogebra3DEuclidian3DPlotsTriListElem_initWithChar_(flags) autorelease] : [self addWithFloatArray:v withFloatArray:n];
  [lm setOwnerWithId:s];
...
void OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceTriList2_initWithInt_withInt_(OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceTriList2 *self, jint capacity, jint marigin) {
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsTriList_initWithInt_withInt_withInt_withBoolean_(self, capacity, marigin, 9, YES);
}
...
void OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceTriList2_calcFloatsWithOrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_withInt_withFloatArray_withFloatArray_(OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceTriList2 *self, OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2 *d, jint j, IOSFloatArray *v, IOSFloatArray *n) {
  IOSObjectArray *t = [IOSObjectArray arrayWithLength:3 type:OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2_class_()];
  IOSObjectArray_Set(t, 1, (OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2 *) check_class_cast([((OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2 *) nil_chk(d)) getParentWithInt:j], [OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceDiamond2 class]));
  if (j == 0) {
