...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/geogebra3D/euclidian3D/plots/java/nio/CharSequenceAdapter.java
//
...
- (OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioCharBuffer *)slice {
  return [new_OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioCharSequenceAdapter_initWithJavaLangCharSequence_([((id<JavaLangCharSequence>) nil_chk(sequence_)) subSequenceFrom:position__ to:limit__]) autorelease];
}
...
OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioCharSequenceAdapter *OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioCharSequenceAdapter_copy__WithOrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioCharSequenceAdapter_(OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioCharSequenceAdapter *other) {
  ...
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioCharSequenceAdapter *buf = [new_OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioCharSequenceAdapter_initWithJavaLangCharSequence_(((OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioCharSequenceAdapter *) nil_chk(other))->sequence_) autorelease];
...
void OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioCharSequenceAdapter_initWithJavaLangCharSequence_(OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioCharSequenceAdapter *self, id<JavaLangCharSequence> chseq) {
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioCharBuffer_initWithInt_(self, [((id<JavaLangCharSequence>) nil_chk(chseq)) length]);
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioCharSequenceAdapter_set_sequence_(self, chseq);
}
