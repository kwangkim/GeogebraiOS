...
- (OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioIntBuffer *)slice {
  return [new_OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioReadOnlyIntArrayBuffer_initWithInt_withIntArray_withInt_([self remaining], backingArray_, offset_ + position__) autorelease];
}
