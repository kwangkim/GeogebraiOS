...
- (jboolean)addWithOrgGeogebraCommonGeogebra3DEuclidian3DPlotsDynamicMeshElement2:(OrgGeogebraCommonGeogebra3DEuclidian3DPlotsDynamicMeshElement2 *)obj {
  ...
  obj->bucket_prev_ = IOSObjectArray_Get(nil_chk(backs_), bucketIndex);
  if (IOSObjectArray_Get(backs_, bucketIndex) != nil) ((OrgGeogebraCommonGeogebra3DEuclidian3DPlotsDynamicMeshElement2 *) nil_chk(IOSObjectArray_Get(backs_, bucketIndex)))->bucket_next_ = obj;
  (void) IOSObjectArray_Set(backs_, bucketIndex, obj);
  if (IOSObjectArray_Get(nil_chk(buckets_), bucketIndex) == nil) (void) IOSObjectArray_Set(buckets_, bucketIndex, obj);
  if (bucketIndex > maxBucket_) maxBucket_ = bucketIndex;
  obj->bucket_index_ = bucketIndex;
  count_++;
  obj->bucket_owner_ = self;
  return YES;
}
...
- (jboolean)removeWithOrgGeogebraCommonGeogebra3DEuclidian3DPlotsDynamicMeshElement2:(OrgGeogebraCommonGeogebra3DEuclidian3DPlotsDynamicMeshElement2 *)elem {
  ...
  if (elem->bucket_next_ != nil) elem->bucket_next_->bucket_prev_ = elem->bucket_prev_;
  if (elem->bucket_prev_ != nil) elem->bucket_prev_->bucket_next_ = elem->bucket_next_;
  if (IOSObjectArray_Get(nil_chk(buckets_), bi) == elem) (void) IOSObjectArray_Set(buckets_, bi, elem->bucket_next_);
  if (IOSObjectArray_Get(nil_chk(backs_), bi) == elem) (void) IOSObjectArray_Set(backs_, bi, elem->bucket_prev_);
  while (maxBucket_ > 0 && IOSObjectArray_Get(buckets_, maxBucket_) == nil) maxBucket_--;
  elem->bucket_next_ = elem->bucket_prev_ = nil;
  elem->bucket_owner_ = nil;
  count_--;
  return YES;
}
...
void OrgGeogebraCommonGeogebra3DEuclidian3DPlotsFastBucketPQ_initWithOrgGeogebraCommonGeogebra3DEuclidian3DPlotsBucketAssigner_withBoolean_(OrgGeogebraCommonGeogebra3DEuclidian3DPlotsFastBucketPQ *self, id<OrgGeogebraCommonGeogebra3DEuclidian3DPlotsBucketAssigner> ba, jboolean reverse) {
  (void) OrgGeogebraCommonGeogebra3DEuclidian3DPlotsFastBucketPQ_initWithInt_withOrgGeogebraCommonGeogebra3DEuclidian3DPlotsBucketAssigner_withBoolean_(self, OrgGeogebraCommonGeogebra3DEuclidian3DPlotsFastBucketPQ_DEFAULT_BUCKET_AMT, ba, reverse);
}
...
void OrgGeogebraCommonGeogebra3DEuclidian3DPlotsFastBucketPQ_initWithInt_withOrgGeogebraCommonGeogebra3DEuclidian3DPlotsBucketAssigner_withBoolean_(OrgGeogebraCommonGeogebra3DEuclidian3DPlotsFastBucketPQ *self, jint bucketAmt, id<OrgGeogebraCommonGeogebra3DEuclidian3DPlotsBucketAssigner> ba, jboolean reverse) {
  ...
  self->buckets_ = [IOSObjectArray newArrayWithLength:bucketAmt type:OrgGeogebraCommonGeogebra3DEuclidian3DPlotsDynamicMeshElement2_class_()];
  self->backs_ = [IOSObjectArray newArrayWithLength:bucketAmt type:OrgGeogebraCommonGeogebra3DEuclidian3DPlotsDynamicMeshElement2_class_()];
...
jboolean OrgGeogebraCommonGeogebra3DEuclidian3DPlotsFastBucketPQ_addToZeroBucketWithOrgGeogebraCommonGeogebra3DEuclidian3DPlotsDynamicMeshElement2_(OrgGeogebraCommonGeogebra3DEuclidian3DPlotsFastBucketPQ *self, OrgGeogebraCommonGeogebra3DEuclidian3DPlotsDynamicMeshElement2 *obj) {
  if (nil == obj) @throw new_JavaLangNullPointerException_init();
  if (((OrgGeogebraCommonGeogebra3DEuclidian3DPlotsDynamicMeshElement2 *) nil_chk(obj))->bucket_owner_ != nil) return NO;
  jint bucketIndex = 0;
  obj->bucket_prev_ = IOSObjectArray_Get(nil_chk(self->backs_), bucketIndex);
  if (IOSObjectArray_Get(self->backs_, bucketIndex) != nil) ((OrgGeogebraCommonGeogebra3DEuclidian3DPlotsDynamicMeshElement2 *) nil_chk(IOSObjectArray_Get(self->backs_, bucketIndex)))->bucket_next_ = obj;
  (void) IOSObjectArray_Set(self->backs_, bucketIndex, obj);
  if (IOSObjectArray_Get(nil_chk(self->buckets_), bucketIndex) == nil) (void) IOSObjectArray_Set(self->buckets_, bucketIndex, obj);
