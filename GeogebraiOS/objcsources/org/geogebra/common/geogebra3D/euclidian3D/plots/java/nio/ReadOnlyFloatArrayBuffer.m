...
- (OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioFloatBuffer *)slice {
  return [new_OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioReadOnlyFloatArrayBuffer_initWithInt_withFloatArray_withInt_([self remaining], backingArray_, offset_ + position__) autorelease];
}
