...
- (OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioShortBuffer *)slice {
  return [new_OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioReadWriteShortArrayBuffer_initWithInt_withShortArray_withInt_([self remaining], backingArray_, offset_ + position__) autorelease];
}
