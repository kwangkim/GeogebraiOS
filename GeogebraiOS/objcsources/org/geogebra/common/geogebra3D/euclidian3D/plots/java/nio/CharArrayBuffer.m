...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/common/geogebra3D/euclidian3D/plots/java/nio/CharArrayBuffer.java
//
...
- (id<JavaLangCharSequence>)subSequenceFrom:(jint)start
  ...
  [((OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioCharBuffer *) nil_chk(result)) limitWithInt:position__ + end];
...
void OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioCharArrayBuffer_initWithCharArray_(OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioCharArrayBuffer *self, IOSCharArray *array) {
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioCharArrayBuffer_initWithInt_withCharArray_withInt_(self, ((IOSCharArray *) nil_chk(array))->size_, array, 0);
}
...
void OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioCharArrayBuffer_initWithInt_(OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioCharArrayBuffer *self, jint capacity) {
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioCharArrayBuffer_initWithInt_withCharArray_withInt_(self, capacity, [IOSCharArray arrayWithLength:capacity], 0);
}
...
void OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioCharArrayBuffer_initWithInt_withCharArray_withInt_(OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioCharArrayBuffer *self, jint capacity, IOSCharArray *backingArray, jint offset) {
  ...
  OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioCharArrayBuffer_set_backingArray_(self, backingArray);
  self->offset_ = offset;
}
