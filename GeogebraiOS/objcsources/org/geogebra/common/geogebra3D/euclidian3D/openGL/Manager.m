...
- (OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterBrush *)newPlotterBrush {
  return new_OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterBrush_initWithOrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManager_(self);
}
...
- (void)setCylinderWithOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)p1
  ...
  clockU_ = IOSObjectArray_Get(nil_chk(vn), 0);
  clockV_ = IOSObjectArray_Get(vn, 1);
}

- (void)translateCylinderWithOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)v {
  cylinderStart_ = [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(cylinderStart_)) addWithOrgGeogebraCommonKernelMatrixCoords:v];
  cylinderEnd_ = [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(cylinderEnd_)) addWithOrgGeogebraCommonKernelMatrixCoords:v];
}
...
void OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManager_initWithOrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_withOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D_(OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManager *self, OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer *renderer, OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D *view3D) {
  ...
  self->clockU_ = nil;
  self->clockV_ = nil;
  self->cylinderStart_ = nil;
  self->cylinderEnd_ = nil;
  [self setRendererWithOrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer:renderer];
  [self initGeometriesList];
  self->brush_ = [self newPlotterBrush];
  self->surface_ = new_OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterSurface_initWithOrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManager_(self);
  self->text_ = new_OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterText_initWithOrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManager_(self);
  self->cursor_ = new_OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterCursor_initWithOrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManager_(self);
  self->viewInFrontOf_ = new_OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterViewInFrontOf_initWithOrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManager_(self);
  self->mouseCursor_ = new_OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterMouseCursor_initWithOrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManager_(self);
  self->completingCursor_ = new_OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterCompletingCursor_initWithOrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManager_(self);
  self->view3D_ = view3D;
}
