...
- (void)setDrawable3DListsWithOrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawable3DListsForView:(OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawable3DListsForView *)dl {
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_set_drawable3DLists_(self, dl);
}
...
- (void)setMatrixWithOrgGeogebraCommonKernelMatrixCoordMatrix4x4:(OrgGeogebraCommonKernelMatrixCoordMatrix4x4 *)a_matrix {
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_set_m_drawingMatrix_(self, a_matrix);
}
...
- (void)setMouseLocWithOrgGeogebraCommonAwtGPoint:(OrgGeogebraCommonAwtGPoint *)p
  ...
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_set_mouse_(self, p);
...
- (IOSDoubleArray *)getIntervalInFrustumWithDoubleArray:(IOSDoubleArray *)minmax
  ...
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_updateIntervalInFrustumWithDoubleArray_withDouble_withDouble_(minmax, left, right);
  jdouble top = ([self getTop] - [o getWithInt:2]) / [v getWithInt:2];
  jdouble bottom = ([self getBottom] - [o getWithInt:2]) / [v getWithInt:2];
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_updateIntervalInFrustumWithDoubleArray_withDouble_withDouble_(minmax, top, bottom);
  ...
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_updateIntervalInFrustumWithDoubleArray_withDouble_withDouble_(minmax, front, back);
  return minmax;
}
...
- (void)updateProjectionObliqueValues {
  ...
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_setAndConsume_obliqueOrthoDirection_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_(obliqueX_, obliqueY_, -1, 0));
}
...
- (void)exportToClipboard {
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_set_exportType_(self, OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_ExportTypeEnum_get_CLIPBOARD());
...
- (void)uploadToGeoGebraTube {
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_set_exportType_(self, OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_ExportTypeEnum_get_UPLOAD_TO_GEOGEBRATUBE());
...
- (void)init__ {
  [self initShaders];
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_set_geometryManager_(self, [self createManager]);
...
- (void)dealloc {
  ...
  RELEASE_(mouse_);
  RELEASE_(eyeToScreenDistance_);
  RELEASE_(perspNear_);
  RELEASE_(perspLeft_);
  RELEASE_(perspRight_);
  RELEASE_(perspBottom_);
  RELEASE_(perspTop_);
  RELEASE_(perspFar_);
  RELEASE_(perspDistratio_);
  RELEASE_(perspFocus_);
  RELEASE_(perspEye_);
  RELEASE_(glassesEyeX_);
  RELEASE_(glassesEyeX1_);
  RELEASE_(glassesEyeY_);
  RELEASE_(glassesEyeY1_);
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer class]) {
    ...
    JreStrongAssignAndConsume(&OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_LIGHT_POSITION_W_, nil, [IOSFloatArray newArrayWithFloats:(jfloat[]){ OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_SQRT2_DIV2_, 0.0f, OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_SQRT2_DIV2_ } count:3]);
    JreStrongAssignAndConsume(&OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_LIGHT_POSITION_D_, nil, [IOSFloatArray newArrayWithFloats:(jfloat[]){ OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_SQRT2_DIV2_, 0.0f, OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_SQRT2_DIV2_, 0.0f } count:4]);
...
void OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_initWithOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D_(OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer *self, OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D *view) {
  ...
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_setAndConsume_dilationValues_(self, [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 1, 1.3 } count:2]);
  ...
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_setAndConsume_eyeToScreenDistance_(self, [IOSDoubleArray newArrayWithLength:2]);
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_setAndConsume_perspNear_(self, [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_PERSP_NEAR_MIN, OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_PERSP_NEAR_MIN } count:2]);
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_setAndConsume_perspLeft_(self, [IOSDoubleArray newArrayWithLength:2]);
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_setAndConsume_perspRight_(self, [IOSDoubleArray newArrayWithLength:2]);
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_setAndConsume_perspBottom_(self, [IOSDoubleArray newArrayWithLength:2]);
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_setAndConsume_perspTop_(self, [IOSDoubleArray newArrayWithLength:2]);
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_setAndConsume_perspFar_(self, [IOSDoubleArray newArrayWithLength:2]);
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_setAndConsume_perspDistratio_(self, [IOSDoubleArray newArrayWithLength:2]);
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_setAndConsume_perspFocus_(self, [IOSDoubleArray newArrayWithLength:2]);
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_setAndConsume_glassesEyeX_(self, [IOSDoubleArray newArrayWithLength:2]);
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_setAndConsume_glassesEyeX1_(self, [IOSDoubleArray newArrayWithLength:2]);
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_setAndConsume_glassesEyeY_(self, [IOSDoubleArray newArrayWithLength:2]);
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_setAndConsume_glassesEyeY1_(self, [IOSDoubleArray newArrayWithLength:2]);
  self->eye_ = OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_EYE_LEFT;
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_set_exportType_(self, OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_ExportTypeEnum_get_NONE());
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_set_view3D_(self, view);
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_setAndConsume_textures_(self, new_OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLTextures_initWithOrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_withOrgGeogebraCommonUtilImageManager_(self, [((OrgGeogebraCommonMainApp *) nil_chk([((OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D *) nil_chk(self->view3D_)) getApplication])) getImageManager]));
}
...
IOSObjectArray *OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer_createDrawableListForPickingWithInt_(jint bufSize) {
  ...
  return [IOSObjectArray arrayWithLength:bufSize type:OrgGeogebraCommonGeogebra3DEuclidian3DDrawDrawable3D_class_()];
}
