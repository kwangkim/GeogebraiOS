...
- (void)initGeometriesList {
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManagerShaders_setAndConsume_geometriesSetList_(self, new_JavaUtilTreeMap_init());
  geometriesSetMaxIndex_ = -1;
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManagerShaders_setAndConsume_indicesRemoved_(self, new_JavaUtilStack_init());
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManagerShaders_setAndConsume_vertices__(self, new_JavaUtilArrayList_init());
  verticesSize_ = 0;
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManagerShaders_setAndConsume_normals_(self, new_JavaUtilArrayList_init());
  normalsSize_ = 0;
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManagerShaders_setAndConsume_textures_(self, new_JavaUtilArrayList_init());
  texturesSize_ = 0;
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManagerShaders_setAndConsume_colors_(self, new_JavaUtilArrayList_init());
  colorsSize_ = 0;
}
...
- (void)setRendererWithOrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer:(OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLRenderer *)renderer {
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManagerShaders_set_renderer_(self, renderer);
}
...
- (jint)startNewListWithInt:(jint)old {
  currentOld_ = old;
  if (currentOld_ >= 0) {
    OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManagerShaders_set_currentGeometriesSet_(self, [((JavaUtilTreeMap *) nil_chk(geometriesSetList_)) getWithId:JavaLangInteger_valueOfWithInt_(old)]);
  }
  else {
    OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManagerShaders_set_currentGeometriesSet_(self, nil);
  }
  ...
  if (currentGeometriesSet_ == nil) {
    ...
    OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManagerShaders_set_currentGeometriesSet_(self, [self newGeometriesSet]);
...
- (OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManagerShaders_GeometriesSet *)newGeometriesSet {
  return [new_OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManagerShaders_GeometriesSet_initWithOrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManagerShaders_(self) autorelease];
}
...
- (void)drawWithInt:(jint)index {
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManagerShaders_set_currentGeometriesSet_(self, [((JavaUtilTreeMap *) nil_chk(geometriesSetList_)) getWithId:JavaLangInteger_valueOfWithInt_(index)]);
  if (currentGeometriesSet_ != nil) {
...
- (void)setTypeWithOrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManager_TypeEnum:(OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManager_TypeEnum *)type {
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManagerShaders_Geometry_set_type_(self, type);
...
void OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManagerShaders_Geometry_initWithOrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManagerShaders_withOrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManager_TypeEnum_(OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManagerShaders_Geometry *self, OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManagerShaders *outer$, OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManager_TypeEnum *type) {
  NSObject_init(self);
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManagerShaders_Geometry_set_type_(self, type);
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManagerShaders_Geometry_set_v_(self, [((OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLGLFactory *) nil_chk(OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLGLFactory_get_prototype_())) newBuffer]);
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManagerShaders_Geometry_set_n_(self, [OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLGLFactory_get_prototype_() newBuffer]);
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManagerShaders_Geometry_set_t_(self, [OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLGLFactory_get_prototype_() newBuffer]);
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManagerShaders_Geometry_set_c_(self, [OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLGLFactory_get_prototype_() newBuffer]);
}
...
- (void)startGeometryWithOrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManager_TypeEnum:(OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManager_TypeEnum *)type {
  if (currentGeometryIndex_ < [self size]) {
    OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManagerShaders_GeometriesSet_set_currentGeometry_(self, [self getWithInt:currentGeometryIndex_]);
  }
  else {
    OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManagerShaders_GeometriesSet_set_currentGeometry_(self, [self newGeometryWithOrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManager_TypeEnum:type]);
...
- (OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManagerShaders_Geometry *)newGeometryWithOrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManager_TypeEnum:(OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManager_TypeEnum *)type {
  return [new_OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManagerShaders_Geometry_initWithOrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManagerShaders_withOrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManager_TypeEnum_(this$0_, type) autorelease];
}
...
void OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManagerShaders_GeometriesSet_initWithOrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManagerShaders_(OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManagerShaders_GeometriesSet *self, OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManagerShaders *outer$) {
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManagerShaders_GeometriesSet_set_this$0_(self, outer$);
