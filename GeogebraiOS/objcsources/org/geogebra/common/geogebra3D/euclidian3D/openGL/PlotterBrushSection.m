...
- (void)setWithOrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterBrushSection:(OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterBrushSection *)s
  ...
  [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(self->center_)) setWithOrgGeogebraCommonKernelMatrixCoords:point];
  self->thickness_ = thickness;
  [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(direction_)) setSubWithOrgGeogebraCommonKernelMatrixCoords:center_ withOrgGeogebraCommonKernelMatrixCoords:((OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterBrushSection *) nil_chk(s))->center_];
  if ([center_ equalsForKernelWithOrgGeogebraCommonKernelMatrixCoords:s->center_ withDouble:OrgGeogebraCommonKernelKernel_STANDARD_PRECISION]) {
    if (self->thickness_ < s->thickness_) {
      ...
      [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(normal_)) setMulWithOrgGeogebraCommonKernelMatrixCoords:s->direction_ withDouble:-1];
    }
...
withOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)pos {
  ...
  if ([((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(normal_)) isDefined]) {
    ...
    [vn setAddWithOrgGeogebraCommonKernelMatrixCoords:[vn setMulWithOrgGeogebraCommonKernelMatrixCoords:vn withDouble:normalDevN_] withOrgGeogebraCommonKernelMatrixCoords:[tmpCoords_ setMulWithOrgGeogebraCommonKernelMatrixCoords:direction_ withDouble:normalDevD_]];
  }
}
...
- (void)setWithOrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterBrushSection:(OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterBrushSection *)s
  ...
  [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(self->center_)) setWithOrgGeogebraCommonKernelMatrixCoords:point];
  self->thickness_ = thickness;
  [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(self->direction_)) setSubWithOrgGeogebraCommonKernelMatrixCoords:center_ withOrgGeogebraCommonKernelMatrixCoords:[((OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterBrushSection *) nil_chk(s)) getCenter]];
  [direction_ calcNorm];
...
void OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterBrushSection_init(OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterBrushSection *self) {
  NSObject_init(self);
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterBrushSection_set_normal_(self, nil);
  self->normalDevD_ = 0;
  self->normalDevN_ = 1;
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterBrushSection_setAndConsume_tmpCoords_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(3));
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterBrushSection_set_center_(self, OrgGeogebraCommonKernelMatrixCoords_createInhomCoorsInD3());
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterBrushSection_setAndConsume_clockU_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4));
  [self->clockU_ setUndefined];
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterBrushSection_setAndConsume_clockV_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4));
  [self->clockV_ setUndefined];
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterBrushSection_setAndConsume_direction_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4));
  [self->direction_ setUndefined];
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterBrushSection_setAndConsume_normal_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4));
