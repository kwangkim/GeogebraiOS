...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/geogebra3D/euclidian3D/openGL/PlotterSurface.java
//
...
- (void)drawSphereWithOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)center
  ...
  if (((IOSObjectArray *) nil_chk(coordsArray_))->size_ <= longitudeLength) {
    coordsArray_ = [IOSObjectArray newArrayWithLength:longitudeLength + 1 type:OrgGeogebraCommonKernelMatrixCoords_class_()];
    for (jint ui = 0; ui <= longitudeLength; ui++) {
      (void) IOSObjectArray_Set(coordsArray_, ui, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4));
    }
  }
  OrgGeogebraCommonKernelMatrixCoords *n1 = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4), *n2 = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4), *n1b = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4), *n2b = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4);
  IOSDoubleArray *cosSinV = [IOSDoubleArray newArrayWithLength:2];
...
- (void)drawWithOrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceMesh2:(OrgGeogebraCommonGeogebra3DEuclidian3DPlotsSurfaceMesh2 *)tree {
  ...
  IOSFloatArray *f = [IOSFloatArray newArrayWithLength:9];
  IOSFloatArray *n = [IOSFloatArray newArrayWithLength:9];
  (void) [((OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioFloatBuffer *) nil_chk(b1)) rewind];
  (void) [((OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioFloatBuffer *) nil_chk(b2)) rewind];
  for (jint i = 0; i < cnt; i++) {
    (void) [b1 getWithFloatArray:f];
    (void) [b2 getWithFloatArray:n];
...
- (void)parallelogramWithOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)center
  ...
  [manager_ setDummyTexture];
  [manager_ normalWithOrgGeogebraCommonKernelMatrixCoords:[((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(v1)) crossProductWithOrgGeogebraCommonKernelMatrixCoords:v2]];
  (void) [tmpCoords_ setAddWithOrgGeogebraCommonKernelMatrixCoords:center withOrgGeogebraCommonKernelMatrixCoords:[((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(tmpCoords_)) setMulWithOrgGeogebraCommonKernelMatrixCoords:v1 withDouble:l1]];
  (void) [tmpCoords2_ setAddWithOrgGeogebraCommonKernelMatrixCoords:tmpCoords_ withOrgGeogebraCommonKernelMatrixCoords:[((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(tmpCoords2_)) setMulWithOrgGeogebraCommonKernelMatrixCoords:v2 withDouble:l2]];
  (void) [tmpCoords3_ setAddWithOrgGeogebraCommonKernelMatrixCoords:center withOrgGeogebraCommonKernelMatrixCoords:[((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(tmpCoords3_)) setMulWithOrgGeogebraCommonKernelMatrixCoords:v2 withDouble:l2]];
...
- (OrgGeogebraCommonKernelMatrixCoords *)coneWithOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)center
  ...
  (void) [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(tmpCoords_)) setMulWithOrgGeogebraCommonKernelMatrixCoords:vz withDouble:radius];
  for (jint i = 0; i <= longitude; i++) {
    u = (jfloat) JavaLangMath_cosWithDouble_(start + i * da);
    v = (jfloat) JavaLangMath_sinWithDouble_(start + i * da);
    (void) [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(m_)) setAddWithOrgGeogebraCommonKernelMatrixCoords:[((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(tmpCoords2_)) setMulWithOrgGeogebraCommonKernelMatrixCoords:vx withDouble:u] withOrgGeogebraCommonKernelMatrixCoords:[((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(tmpCoords3_)) setMulWithOrgGeogebraCommonKernelMatrixCoords:vy withDouble:v]];
    (void) [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(n_)) setAddWithOrgGeogebraCommonKernelMatrixCoords:m_ withOrgGeogebraCommonKernelMatrixCoords:tmpCoords_];
    (void) [n_ normalize];
    if (fading < 1) {
...
- (void)coneWithOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)center
  ...
  (void) [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(tmpCoords_)) setMulWithOrgGeogebraCommonKernelMatrixCoords:vz withDouble:radius * sgn];
...
- (OrgGeogebraCommonKernelMatrixCoords *)calcNormalWithFloat:(jfloat)x
                                                   withFloat:(jfloat)y
                                                   withFloat:(jfloat)z {
  IOSDoubleArray *n = [IOSDoubleArray newArrayWithLength:3];
  OrgGeogebraCommonKernelMatrixCoords *v0 = new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_(x, y, z, 0);
...
- (void)drawTriangleWithOrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioFloatBuffer:(OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioFloatBuffer *)d {
  ...
  [manager_ textureWithDouble:uT withDouble:vT];
  IOSFloatArray *f = [IOSFloatArray newArrayWithLength:9];
  (void) [((OrgGeogebraCommonGeogebra3DEuclidian3DPlotsJavaNioFloatBuffer *) nil_chk(d)) getWithFloatArray:f];
  [manager_ vertexWithDouble:IOSFloatArray_Get(f, 0) withDouble:IOSFloatArray_Get(f, 1) withDouble:IOSFloatArray_Get(f, 2)];
  [manager_ vertexWithDouble:IOSFloatArray_Get(f, 3) withDouble:IOSFloatArray_Get(f, 4) withDouble:IOSFloatArray_Get(f, 5)];
  [manager_ vertexWithDouble:IOSFloatArray_Get(f, 6) withDouble:IOSFloatArray_Get(f, 7) withDouble:IOSFloatArray_Get(f, 8)];
  [manager_ endGeometry];
...
void OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterSurface_initWithOrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManager_(OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterSurface *self, OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManager *manager) {
  ...
  self->coordsArray_ = [IOSObjectArray newArrayWithLength:0 type:OrgGeogebraCommonKernelMatrixCoords_class_()];
  self->m_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4);
  ...
  self->center1_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4);
  self->center2_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4);
  self->n_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4);
  self->coords1_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4);
  self->normal2_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4);
