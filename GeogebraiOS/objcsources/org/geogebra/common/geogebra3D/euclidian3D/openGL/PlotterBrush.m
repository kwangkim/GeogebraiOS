...
- (void)arcWithOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)center
  ...
  OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterBrush_setTextureXWithFloat_withFloat_(self, 0, 0);
  (void) [vn1_ setAddWithOrgGeogebraCommonKernelMatrixCoords:[((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(tmpCoords_)) setMulWithOrgGeogebraCommonKernelMatrixCoords:v1 withDouble:u] withOrgGeogebraCommonKernelMatrixCoords:[((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(vn1_)) setMulWithOrgGeogebraCommonKernelMatrixCoords:v2 withDouble:v]];
  (void) [tmpCoords_ setAddWithOrgGeogebraCommonKernelMatrixCoords:center withOrgGeogebraCommonKernelMatrixCoords:[tmpCoords_ setMulWithOrgGeogebraCommonKernelMatrixCoords:vn1_ withDouble:radius]];
  ...
  for (jint i = 1; i <= longitude; i++) {
    ...
    (void) [vn1_ setAddWithOrgGeogebraCommonKernelMatrixCoords:[tmpCoords_ setMulWithOrgGeogebraCommonKernelMatrixCoords:v1 withDouble:u] withOrgGeogebraCommonKernelMatrixCoords:[vn1_ setMulWithOrgGeogebraCommonKernelMatrixCoords:v2 withDouble:v]];
    (void) [tmpCoords_ setAddWithOrgGeogebraCommonKernelMatrixCoords:center withOrgGeogebraCommonKernelMatrixCoords:[tmpCoords_ setMulWithOrgGeogebraCommonKernelMatrixCoords:vn1_ withDouble:radius]];
...
- (void)arcEllipseWithOrgGeogebraCommonKernelMatrixCoords:(OrgGeogebraCommonKernelMatrixCoords *)center
  ...
  (void) [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(f1_)) setMulWithOrgGeogebraCommonKernelMatrixCoords:v1 withDouble:f];
  (void) [((OrgGeogebraCommonKernelMatrixCoords *) nil_chk(f2_)) setMulWithOrgGeogebraCommonKernelMatrixCoords:v1 withDouble:-f];
...
- (void)drawToWithDoubleArray:(IOSDoubleArray *)pos
  ...
  OrgGeogebraCommonKernelMatrixCoords *p = new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_(0, 0, 0, 1);
...
+ (void)initialize {
  if (self == [OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterBrush class]) {
    ...
    {
      OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterBrush_COSINUS_ = [IOSDoubleArray newArrayWithLength:OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterBrush_LATITUDES + 1];
      OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterBrush_SINUS_ = [IOSDoubleArray newArrayWithLength:OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterBrush_LATITUDES + 1];
      for (jint i = 0; i <= OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterBrush_LATITUDES; i++) {
...
void OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterBrush_initWithOrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManager_(OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterBrush *self, OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLManager *manager) {
  ...
  self->start__ = new_OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterBrushSection_init();
  self->end__ = new_OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterBrushSection_init();
  self->justStarted_ = NO;
  self->notStarted_ = NO;
  self->textureX_ = [IOSFloatArray newArrayWithLength:2];
  ...
  self->ticks_ = OrgGeogebraCommonGeogebra3DEuclidian3DOpenGLPlotterBrush_TicksEnum_get_NONE();
  self->drawNormal_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(3);
  self->drawPos_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(3);
  self->m_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(3);
  self->vn1_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(3);
  self->tmpCoords_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(3);
  self->tmpCoords2_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(3);
  self->tmpCoords3_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(3);
  self->tmpCoords4_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(3);
  self->f1_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4);
  self->f2_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4);
  self->vn2_ = new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(3);
