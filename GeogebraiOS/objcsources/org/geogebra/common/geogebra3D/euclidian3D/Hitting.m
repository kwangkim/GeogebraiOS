...
- (void)setHitsWithOrgGeogebraCommonAwtGPoint:(OrgGeogebraCommonAwtGPoint *)mouseLoc
  ...
  OrgGeogebraCommonGeogebra3DEuclidian3DHitting_set_origin_(self, [view_ getHittingOriginWithOrgGeogebraCommonAwtGPoint:mouseLoc]);
  OrgGeogebraCommonGeogebra3DEuclidian3DHitting_set_direction_(self, [view_ getHittingDirection]);
...
void OrgGeogebraCommonGeogebra3DEuclidian3DHitting_initWithOrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D_(OrgGeogebraCommonGeogebra3DEuclidian3DHitting *self, OrgGeogebraCommonGeogebra3DEuclidian3DEuclidianView3D *view) {
  NSObject_init(self);
  OrgGeogebraCommonGeogebra3DEuclidian3DHitting_set_view_(self, view);
  OrgGeogebraCommonGeogebra3DEuclidian3DHitting_setAndConsume_pos_(self, new_OrgGeogebraCommonAwtGPoint_init());
}
