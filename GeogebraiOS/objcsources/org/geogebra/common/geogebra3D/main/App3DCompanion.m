...
- (OrgGeogebraCommonKernelKernel *)newKernel {
  return new_OrgGeogebraCommonGeogebra3DKernel3DKernel3D_initWithOrgGeogebraCommonMainApp_(app_);
}
...
- (OrgGeogebraCommonGeogebra3DEuclidianForPlaneEuclidianViewForPlaneCompanion *)createEuclidianViewForPlaneWithOrgGeogebraCommonKernelKernelNDViewCreator:(id<OrgGeogebraCommonKernelKernelNDViewCreator>)plane
  ...
  if (evSettings == nil) {
    evSettings = new_OrgGeogebraCommonGeogebra3DMainSettingsEuclidianSettingsForPlane_initWithOrgGeogebraCommonMainSettingsEuclidianSettings_([((OrgGeogebraCommonEuclidianEuclidianView *) nil_chk([app_ getEuclidianView1])) getSettings]);
  ...
  euclidianViewForPlaneCompanion_ = [self createEuclidianViewForPlaneWithOrgGeogebraCommonKernelKernelNDViewCreator:plane withOrgGeogebraCommonMainSettingsEuclidianSettings:evSettings withBoolean:panelSettings];
  ...
  if (euclidianViewForPlaneCompanionList_ == nil) euclidianViewForPlaneCompanionList_ = new_JavaUtilArrayList_init();
...
- (OrgGeogebraCommonMainSettingsSettings *)newSettings {
  return new_OrgGeogebraCommonMainSettingsSettings_initWithInt_(3);
}
...
void OrgGeogebraCommonGeogebra3DMainApp3DCompanion_initWithOrgGeogebraCommonMainApp_(OrgGeogebraCommonGeogebra3DMainApp3DCompanion *self, OrgGeogebraCommonMainApp *app) {
  (void) OrgGeogebraCommonMainAppCompanion_initWithOrgGeogebraCommonMainApp_(self, app);
}
