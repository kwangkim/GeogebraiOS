...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/common/geogebra3D/archimedean/support/AbstractArchimedeanSolid.java
//
...
- (void)calcVerticesInABv {
  ...
  OrgGeogebraCommonKernelMatrixCoordMatrix4x4 *matrix = new_OrgGeogebraCommonKernelMatrixCoordMatrix4x4_init();
  ...
  verticesInABv_ = [IOSObjectArray newArrayWithLength:count type:OrgGeogebraCommonKernelMatrixCoords_class_()];
  for (jint i = 0; i < count; i++) (void) IOSObjectArray_Set(verticesInABv_, i, [((OrgGeogebraCommonKernelMatrixCoordMatrix *) nil_chk(mInv)) mulWithOrgGeogebraCommonKernelMatrixCoords:IOSObjectArray_Get(vertices_, i)]);
}
...
- (NSString *)description {
  ...
  (void) [sb appendWithNSString:JreStrcat("I$", ((IOSObjectArray *) nil_chk(vertices_))->size_, @" Vertices:")];
  for (jint i = 0; i < vertices_->size_; ++i) {
    OrgGeogebraCommonGeogebra3DArchimedeanSupportPoint *p = IOSObjectArray_Get(vertices_, i);
    (void) [sb appendWithNSString:JreStrcat("$I$@", @"\n\t", i, @": ", p)];
  }
...
void OrgGeogebraCommonGeogebra3DArchimedeanSupportAbstractArchimedeanSolid_initWithIntArray_withInt_withBoolean_(OrgGeogebraCommonGeogebra3DArchimedeanSupportAbstractArchimedeanSolid *self, IOSIntArray *polyTypes, jint numPolys, jboolean untwist) {
  ...
  OrgGeogebraCommonGeogebra3DArchimedeanComQuantimegroupSolutionsArchimedeanGeomSurface *surface = [new_OrgGeogebraCommonGeogebra3DArchimedeanComQuantimegroupSolutionsArchimedeanGeomArchiBuilder_initWithIntArray_withInt_withBoolean_(polyTypes, numPolys, untwist) createSurface];
  ...
  IOSIntArray *inverseIndexOrder = [IOSIntArray newArrayWithLength:((IOSObjectArray *) nil_chk(indexOrder))->size_];
  ...
  id<JavaUtilList> pointList = new_JavaUtilArrayList_init();
  {
    ...
    while (b__ < e__) {
      ...
      [pointList addWithId:new_OrgGeogebraCommonGeogebra3DArchimedeanSupportPoint_initWithDouble_withDouble_withDouble_(((OrgGeogebraCommonGeogebra3DArchimedeanComQuantimegroupSolutionsArchimedeanUtilsOrderedTriple *) nil_chk(ot))->x_, ot->y_, ot->z_)];
    }
  }
  [self setVerticesWithOrgGeogebraCommonGeogebra3DArchimedeanSupportPointArray:[pointList toArrayWithNSObjectArray:[IOSObjectArray newArrayWithLength:0 type:OrgGeogebraCommonGeogebra3DArchimedeanSupportPoint_class_()]]];
  [self calcVerticesInABv];
  id<JavaUtilList> faceList = new_JavaUtilArrayList_init();
  for (id<JavaUtilIterator> it = [surface rootFacetsIterator]; [((id<JavaUtilIterator>) nil_chk(it)) hasNext]; ) {
    ...
    IOSIntArray *sortedVertexIndices = [IOSIntArray newArrayWithLength:((IOSIntArray *) nil_chk(vertexIndices))->size_];
    ...
    [faceList addWithId:new_OrgGeogebraCommonGeogebra3DArchimedeanSupportAbstractArchimedeanSolid_Face_initWithOrgGeogebraCommonGeogebra3DArchimedeanSupportAbstractArchimedeanSolid_withIntArray_(self, sortedVertexIndices)];
  }
  [self setFacesWithOrgGeogebraCommonGeogebra3DArchimedeanSupportAbstractArchimedeanSolid_FaceArray:[faceList toArrayWithNSObjectArray:[IOSObjectArray newArrayWithLength:0 type:OrgGeogebraCommonGeogebra3DArchimedeanSupportAbstractArchimedeanSolid_Face_class_()]]];
}
...
- (NSString *)description {
  ...
  for (jint i = 0; i < ((IOSIntArray *) nil_chk(vertexIndices_))->size_; ++i) {
    ...
    (void) [sb appendWithNSString:NSString_valueOfInt_(IOSIntArray_Get(vertexIndices_, i))];
  }
  (void) [sb appendWithNSString:@")"];
  return [sb description];
}
...
void OrgGeogebraCommonGeogebra3DArchimedeanSupportAbstractArchimedeanSolid_Face_initWithOrgGeogebraCommonGeogebra3DArchimedeanSupportAbstractArchimedeanSolid_withIntArray_(OrgGeogebraCommonGeogebra3DArchimedeanSupportAbstractArchimedeanSolid_Face *self, OrgGeogebraCommonGeogebra3DArchimedeanSupportAbstractArchimedeanSolid *outer$, IOSIntArray *vertexIndices) {
  (void) NSObject_init(self);
  self->vertexIndices_ = vertexIndices;
}
...
- (jint)compareWithId:(JavaLangInteger *)o1
  ...
  if (OrgGeogebraCommonGeogebra3DArchimedeanComQuantimegroupSolutionsArchimedeanUtilsOrderedTriple_isApproxWithDouble_withDouble_withDouble_(zDiff, 0, 1e-8)) {
    OrgGeogebraCommonGeogebra3DArchimedeanComQuantimegroupSolutionsArchimedeanUtilsOrderedTriple *projectedOt1 = new_OrgGeogebraCommonGeogebra3DArchimedeanComQuantimegroupSolutionsArchimedeanUtilsOrderedTriple_initWithDouble_withDouble_withDouble_(ot1->x_, ot1->y_, 0);
    OrgGeogebraCommonGeogebra3DArchimedeanComQuantimegroupSolutionsArchimedeanUtilsOrderedTriple *projectedOt2 = new_OrgGeogebraCommonGeogebra3DArchimedeanComQuantimegroupSolutionsArchimedeanUtilsOrderedTriple_initWithDouble_withDouble_withDouble_(ot2->x_, ot2->y_, 0);
...
void OrgGeogebraCommonGeogebra3DArchimedeanSupportAbstractArchimedeanSolid_$1_initWithOrgGeogebraCommonGeogebra3DArchimedeanComQuantimegroupSolutionsArchimedeanUtilsObjectList_withOrgGeogebraCommonGeogebra3DArchimedeanComQuantimegroupSolutionsArchimedeanUtilsOrderedTriple_(OrgGeogebraCommonGeogebra3DArchimedeanSupportAbstractArchimedeanSolid_$1 *self, OrgGeogebraCommonGeogebra3DArchimedeanComQuantimegroupSolutionsArchimedeanUtilsObjectList *capture$0, OrgGeogebraCommonGeogebra3DArchimedeanComQuantimegroupSolutionsArchimedeanUtilsOrderedTriple *capture$1) {
  self->val$vertices_ = capture$0;
  self->val$zeroAngleVector_ = capture$1;
  (void) NSObject_init(self);
}
