...
- (void)setPlaneWithOrgGeogebraCommonKernelKernelNDViewCreator:(id<OrgGeogebraCommonKernelKernelNDViewCreator>)plane {
  OrgGeogebraCommonGeogebra3DEuclidianForPlaneEuclidianViewForPlaneCompanion_set_plane_(self, plane);
}
...
- (void)updateCenterAndOrientationRegardingView {
  ...
  OrgGeogebraCommonKernelMatrixCoords *c = [new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_(-[((id<OrgGeogebraCommonEuclidian3DEuclidianView3DInterface>) nil_chk(view3D)) getXZero], -[view3D getYZero], -[view3D getZZero], 1) autorelease];
...
- (void)updateMatrix {
  if (![((id<OrgGeogebraCommonKernelKernelNDViewCreator>) nil_chk(plane_)) isDefined]) {
    OrgGeogebraCommonGeogebra3DEuclidianForPlaneEuclidianViewForPlaneCompanion_set_planeMatrix_(self, OrgGeogebraCommonKernelMatrixCoordMatrix4x4_get_IDENTITY_());
    OrgGeogebraCommonGeogebra3DEuclidianForPlaneEuclidianViewForPlaneCompanion_set_transformedMatrix_(self, OrgGeogebraCommonKernelMatrixCoordMatrix4x4_get_IDENTITY_());
    OrgGeogebraCommonGeogebra3DEuclidianForPlaneEuclidianViewForPlaneCompanion_set_inverseTransformedMatrix_(self, OrgGeogebraCommonKernelMatrixCoordMatrix4x4_get_IDENTITY_());
    return;
  }
  if (transform_ == nil) OrgGeogebraCommonGeogebra3DEuclidianForPlaneEuclidianViewForPlaneCompanion_set_transform_(self, OrgGeogebraCommonKernelMatrixCoordMatrix4x4_get_IDENTITY_());
  OrgGeogebraCommonGeogebra3DEuclidianForPlaneEuclidianViewForPlaneCompanion_set_planeMatrix_(self, [((OrgGeogebraCommonKernelMatrixCoordSys *) nil_chk([plane_ getCoordSys])) getDrawingMatrix]);
  OrgGeogebraCommonGeogebra3DEuclidianForPlaneEuclidianViewForPlaneCompanion_set_transformedMatrix_(self, [((OrgGeogebraCommonKernelMatrixCoordMatrix4x4 *) nil_chk(planeMatrix_)) mulWithOrgGeogebraCommonKernelMatrixCoordMatrix4x4:transform_]);
  OrgGeogebraCommonGeogebra3DEuclidianForPlaneEuclidianViewForPlaneCompanion_set_inverseTransformedMatrix_(self, [((OrgGeogebraCommonKernelMatrixCoordMatrix4x4 *) nil_chk(transformedMatrix_)) inverse]);
}
...
- (void)setTransformRegardingView {
  ...
  if (p <= 0) {
    OrgGeogebraCommonGeogebra3DEuclidianForPlaneEuclidianViewForPlaneCompanion_set_transform_(self, OrgGeogebraCommonKernelMatrixCoordMatrix4x4_get_IDENTITY_());
    transformMirror_ = 1;
  }
  else {
    OrgGeogebraCommonGeogebra3DEuclidianForPlaneEuclidianViewForPlaneCompanion_set_transform_(self, OrgGeogebraCommonKernelMatrixCoordMatrix4x4_get_MIRROR_Y_());
    transformMirror_ = -1;
  }
  ...
  if (JavaLangMath_absWithDouble_(vXy) > JavaLangMath_absWithDouble_(vXx) && JavaLangMath_absWithDouble_(vYx) > JavaLangMath_absWithDouble_(vYy)) {
    if (vYx * transformMirror_ >= 0) {
      OrgGeogebraCommonGeogebra3DEuclidianForPlaneEuclidianViewForPlaneCompanion_set_transform_(self, [((OrgGeogebraCommonKernelMatrixCoordMatrix4x4 *) nil_chk(OrgGeogebraCommonKernelMatrixCoordMatrix4x4_get_ROTATION_OZ_90_())) mulWithOrgGeogebraCommonKernelMatrixCoordMatrix4x4:transform_]);
      transformRotate_ = 90;
    }
    else {
      OrgGeogebraCommonGeogebra3DEuclidianForPlaneEuclidianViewForPlaneCompanion_set_transform_(self, [((OrgGeogebraCommonKernelMatrixCoordMatrix4x4 *) nil_chk(OrgGeogebraCommonKernelMatrixCoordMatrix4x4_get_ROTATION_OZ_M90_())) mulWithOrgGeogebraCommonKernelMatrixCoordMatrix4x4:transform_]);
      transformRotate_ = -90;
    }
  }
  else if (vXx * transformMirror_ < 0) {
    OrgGeogebraCommonGeogebra3DEuclidianForPlaneEuclidianViewForPlaneCompanion_set_transform_(self, [((OrgGeogebraCommonKernelMatrixCoordMatrix4x4 *) nil_chk(OrgGeogebraCommonKernelMatrixCoordMatrix4x4_get_MIRROR_O_())) mulWithOrgGeogebraCommonKernelMatrixCoordMatrix4x4:transform_]);
...
- (void)setTransform {
  if (transformMirror_ == 1) OrgGeogebraCommonGeogebra3DEuclidianForPlaneEuclidianViewForPlaneCompanion_set_transform_(self, OrgGeogebraCommonKernelMatrixCoordMatrix4x4_get_IDENTITY_());
  else OrgGeogebraCommonGeogebra3DEuclidianForPlaneEuclidianViewForPlaneCompanion_set_transform_(self, OrgGeogebraCommonKernelMatrixCoordMatrix4x4_get_MIRROR_Y_());
  if (transformRotate_ == 90) OrgGeogebraCommonGeogebra3DEuclidianForPlaneEuclidianViewForPlaneCompanion_set_transform_(self, [((OrgGeogebraCommonKernelMatrixCoordMatrix4x4 *) nil_chk(OrgGeogebraCommonKernelMatrixCoordMatrix4x4_get_ROTATION_OZ_90_())) mulWithOrgGeogebraCommonKernelMatrixCoordMatrix4x4:transform_]);
  else if (transformRotate_ == -90) OrgGeogebraCommonGeogebra3DEuclidianForPlaneEuclidianViewForPlaneCompanion_set_transform_(self, [((OrgGeogebraCommonKernelMatrixCoordMatrix4x4 *) nil_chk(OrgGeogebraCommonKernelMatrixCoordMatrix4x4_get_ROTATION_OZ_M90_())) mulWithOrgGeogebraCommonKernelMatrixCoordMatrix4x4:transform_]);
  else if (transformRotate_ == 180) OrgGeogebraCommonGeogebra3DEuclidianForPlaneEuclidianViewForPlaneCompanion_set_transform_(self, [((OrgGeogebraCommonKernelMatrixCoordMatrix4x4 *) nil_chk(OrgGeogebraCommonKernelMatrixCoordMatrix4x4_get_MIRROR_O_())) mulWithOrgGeogebraCommonKernelMatrixCoordMatrix4x4:transform_]);
}
...
- (OrgGeogebraCommonEuclidianDrawDrawAngle *)newDrawAngleWithOrgGeogebraCommonKernelGeosGeoAngle:(OrgGeogebraCommonKernelGeosGeoAngle *)geo {
  return [new_OrgGeogebraCommonGeogebra3DEuclidianFor3DDrawAngleFor3D_initWithOrgGeogebraCommonEuclidianEuclidianView_withOrgGeogebraCommonKernelGeosGeoAngle_(view_, geo) autorelease];
}
...
- (OrgGeogebraCommonKernelMatrixCoords *)getCoordsFromViewWithDouble:(jdouble)x
  ...
  return [self getCoordsFromViewWithOrgGeogebraCommonKernelMatrixCoords:[new_OrgGeogebraCommonKernelMatrixCoords_initWithDouble_withDouble_withDouble_withDouble_(x, y, 0, 1) autorelease]];
}
...
- (void)getXMLidWithJavaLangStringBuilder:(JavaLangStringBuilder *)sbxml {
  ...
  [sbxml appendWithNSString:[((OrgGeogebraCommonKernelGeosGeoElement *) nil_chk(((OrgGeogebraCommonKernelGeosGeoElement *) check_class_cast(plane_, [OrgGeogebraCommonKernelGeosGeoElement class])))) getLabelSimple]];
  [sbxml appendWithNSString:@"\""];
  [sbxml appendWithNSString:@"/>\n"];
}
...
- (void)setDockPanelWithOrgGeogebraCommonGuiLayoutDockPanel:(id<OrgGeogebraCommonGuiLayoutDockPanel>)panel {
  OrgGeogebraCommonGeogebra3DEuclidianForPlaneEuclidianViewForPlaneCompanion_set_panel_(self, panel);
...
void OrgGeogebraCommonGeogebra3DEuclidianForPlaneEuclidianViewForPlaneCompanion_initWithOrgGeogebraCommonEuclidianEuclidianView_(OrgGeogebraCommonGeogebra3DEuclidianForPlaneEuclidianViewForPlaneCompanion *self, OrgGeogebraCommonEuclidianEuclidianView *view) {
  ...
  OrgGeogebraCommonGeogebra3DEuclidianForPlaneEuclidianViewForPlaneCompanion_setAndConsume_tmpCoords_(self, new_OrgGeogebraCommonKernelMatrixCoords_initWithInt_(4));
}
