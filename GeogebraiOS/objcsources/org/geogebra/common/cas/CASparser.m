...
- (OrgGeogebraCommonKernelArithmeticValidExpression *)parseGeoGebraCASInputWithNSString:(NSString *)exp
  ...
  @try {
    return [((OrgGeogebraCommonKernelParserParser *) nil_chk(parser_)) parseGeoGebraCASWithNSString:exp];
  }
  @catch (OrgGeogebraCommonKernelParserParseException *e) {
    c = [new_OrgGeogebraCommonKernelCASException_initWithJavaLangThrowable_(e) autorelease];
...
- (OrgGeogebraCommonKernelArithmeticValidExpression *)parseGeoGebraCASInputAndResolveDummyVarsWithNSString:(NSString *)inValue
  ...
  @try {
    ...
    if ([ve isKindOfClass:[OrgGeogebraCommonKernelArithmeticFunction class]]) {
      [((OrgGeogebraCommonKernelArithmeticValidExpression *) nil_chk(ve)) traverseWithOrgGeogebraCommonKernelArithmeticTraversing:OrgGeogebraCommonKernelArithmeticTraversing_FunctionCreator_getCreator()];
    }
    return ve;
  }
  @catch (JavaLangThrowable *e) {
    ...
    @throw [new_OrgGeogebraCommonKernelCASException_initWithJavaLangThrowable_(e) autorelease];
  }
}
...
- (id<OrgGeogebraCommonKernelArithmeticExpressionValue>)resolveVariablesForCASWithOrgGeogebraCommonKernelArithmeticExpressionValue:(id<OrgGeogebraCommonKernelArithmeticExpressionValue>)ev
  ...
  @synchronized(self) {
    ...
    [ev traverseWithOrgGeogebraCommonKernelArithmeticTraversing:c];
    ...
    if (c == prefixStart && i + prefixLen < ((jint) [str length])) {
      ...
      if (prefixFound) {
        ...
        if (code > 0 && code < 65536) {
          ...
          [insertSpecial appendWithNSString:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_get_UNICODE_PREFIX_()];
          i += prefixLen;
        }
      }
      else {
...
- (id<JavaUtilMap>)getTranslationRessourceBundle {
  @synchronized(self) {
    if (rbCasTranslations_ == nil) {
      OrgGeogebraCommonCasCASparser_set_rbCasTranslations_(self, OrgGeogebraCommonCasGiacGgb2giac_getMap());
    }
...
void OrgGeogebraCommonCasCASparser_initWithOrgGeogebraCommonKernelParserParser_withOrgGeogebraCommonKernelParserCashandlersParserFunctions_(OrgGeogebraCommonCasCASparser *self, OrgGeogebraCommonKernelParserParser *parser, OrgGeogebraCommonKernelParserCashandlersParserFunctions *pf) {
  NSObject_init(self);
  OrgGeogebraCommonCasCASparser_set_parser_(self, parser);
  OrgGeogebraCommonCasCASparser_set_parserFunctions_(self, pf);
}
...
void OrgGeogebraCommonCasCASparser_appendcodeWithJavaLangStringBuilder_withInt_(JavaLangStringBuilder *replaceIndices, jint code) {
  ...
  [((JavaLangStringBuilder *) nil_chk(replaceIndices)) appendWithNSString:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_get_UNICODE_PREFIX_()];
  [replaceIndices appendWithInt:code];
  [replaceIndices appendWithNSString:OrgGeogebraCommonKernelArithmeticExpressionNodeConstants_get_UNICODE_DELIMITER_()];
}
