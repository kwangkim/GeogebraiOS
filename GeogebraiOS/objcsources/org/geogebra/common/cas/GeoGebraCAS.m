...
- (void)setCurrentCAS {
  @synchronized(self) {
    @try {
      cas_ = OrgGeogebraCommonCasGeoGebraCAS_getGiac(self);
...
withOrgGeogebraCommonKernelArithmeticMyArbitraryConstant:(OrgGeogebraCommonKernelArithmeticMyArbitraryConstant *)arbconst
  ...
  @try {
    ...
    if (ret == nil) @throw new_OrgGeogebraCommonKernelCASException_initWithJavaLangThrowable_(new_JavaLangException_initWithNSString_([((OrgGeogebraCommonMainLocalization *) nil_chk([((OrgGeogebraCommonMainApp *) nil_chk(app_)) getLocalization])) getErrorWithNSString:@"CAS.GeneralErrorMessage"]));
    return ret;
  }
...
- (IOSObjectArray *)getPolynomialCoeffsWithNSString:(NSString *)polyExpr
  ...
  (void) [getPolynomialCoeffsSB_ appendWithNSString:polyExpr];
  (void) [getPolynomialCoeffsSB_ appendWithChar:','];
  (void) [getPolynomialCoeffsSB_ appendWithNSString:variable];
  ...
  (void) [sbPolyCoeffs_ appendWithNSString:@"when(is\\_polynomial("];
  (void) [sbPolyCoeffs_ appendWithNSString:polyExpr];
  (void) [sbPolyCoeffs_ appendWithChar:','];
  (void) [sbPolyCoeffs_ appendWithNSString:variable];
  (void) [sbPolyCoeffs_ appendWithNSString:@"),"];
  (void) [sbPolyCoeffs_ appendWithNSString:@"coeff("];
  (void) [sbPolyCoeffs_ appendWithNSString:[getPolynomialCoeffsSB_ description]];
  (void) [sbPolyCoeffs_ appendWithNSString:@"),{})"];
  @try {
    ...
    (void) [getPolynomialCoeffsCache_ putWithId:[getPolynomialCoeffsSB_ description] withId:result];
    return result;
  }
...
- (jboolean)isCommandAvailableWithOrgGeogebraCommonKernelArithmeticCommand:(OrgGeogebraCommonKernelArithmeticCommand *)cmd {
  JavaLangStringBuilder *sbCASCommand = new_JavaLangStringBuilder_init();
  (void) [sbCASCommand appendWithNSString:[((OrgGeogebraCommonKernelArithmeticCommand *) nil_chk(cmd)) getName]];
  (void) [sbCASCommand appendWithNSString:@"."];
  (void) [sbCASCommand appendWithInt:[cmd getArgumentNumber]];
  ...
  (void) [sbCASCommand appendWithNSString:[cmd getName]];
  (void) [sbCASCommand appendWithNSString:@".N"];
...
- (id<JavaUtilSet>)getAvailableCommandNames {
  id<JavaUtilSet> cmdSet = new_JavaUtilHashSet_init();
...
void OrgGeogebraCommonCasGeoGebraCAS_initWithOrgGeogebraCommonKernelKernel_(OrgGeogebraCommonCasGeoGebraCAS *self, OrgGeogebraCommonKernelKernel *kernel) {
  ...
  self->getPolynomialCoeffsCache_ = new_OrgGeogebraCommonUtilMaxSizeHashMap_initWithInt_(OrgGeogebraCommonKernelKernel_get_GEOGEBRA_CAS_CACHE_SIZE_());
  self->getPolynomialCoeffsSB_ = new_JavaLangStringBuilder_init();
  self->sbPolyCoeffs_ = new_JavaLangStringBuilder_init();
  self->app_ = [((OrgGeogebraCommonKernelKernel *) nil_chk(kernel)) getApplication];
  self->casParser_ = new_OrgGeogebraCommonCasCASparser_initWithOrgGeogebraCommonKernelParserParser_withOrgGeogebraCommonKernelParserCashandlersParserFunctions_([kernel getParser], [((OrgGeogebraCommonMainApp *) nil_chk([kernel getApplication])) getParserFunctions]);
}
...
id<OrgGeogebraCommonKernelCASGenericInterface> OrgGeogebraCommonCasGeoGebraCAS_getGiac(OrgGeogebraCommonCasGeoGebraCAS *self) {
  @synchronized(self) {
    if (self->cas_ == nil) {
      self->cas_ = [((OrgGeogebraCommonFactoriesCASFactory *) nil_chk([((OrgGeogebraCommonMainApp *) nil_chk(self->app_)) getCASFactory])) newGiacWithOrgGeogebraCommonCasCASparser:self->casParser_ withOrgGeogebraCommonCasCasParserTools:new_OrgGeogebraCommonCasCasParserToolsImpl_initWithChar_('e') withOrgGeogebraCommonKernelKernel:[self->app_ getKernel]];
    }
    return self->cas_;
  }
}
...
NSString *OrgGeogebraCommonCasGeoGebraCAS_getCASCommandWithNSString_withJavaUtilArrayList_withBoolean_withOrgGeogebraCommonKernelStringTemplate_withBoolean_(OrgGeogebraCommonCasGeoGebraCAS *self, NSString *name, JavaUtilArrayList *args, jboolean symbolic, OrgGeogebraCommonKernelStringTemplate *tpl, jboolean allowOutsourcing) {
  @synchronized(self) {
    JavaLangStringBuilder *sbCASCommand = new_JavaLangStringBuilder_initWithInt_(80);
    [sbCASCommand setLengthWithInt:0];
    (void) [sbCASCommand appendWithNSString:name];
    (void) [sbCASCommand appendWithNSString:@".N"];
      ...
      for (jint i = 0; i < ((jint) [translation length]); i++) {
        ...
        if (ch == '%') {
          if ([((JavaUtilArrayList *) nil_chk(args)) size] == 1) {
            ...
            (void) [sbCASCommand appendWithNSString:str];
          }
          else {
            ...
            for (jint j = 0; j < [args size]; j++) {
              ...
              (void) [sbCASCommand appendWithNSString:OrgGeogebraCommonCasGeoGebraCAS_toStringWithOrgGeogebraCommonKernelArithmeticExpressionValue_withBoolean_withOrgGeogebraCommonKernelStringTemplate_(ev, symbolic, tpl)];
              (void) [sbCASCommand appendWithChar:','];
            }
          ...
          (void) [sbCASCommand appendWithChar:ch];
        }
      }
      return [sbCASCommand description];
    }
    [sbCASCommand setLengthWithInt:[sbCASCommand length] - 1];
    (void) [sbCASCommand appendWithInt:[((JavaUtilArrayList *) nil_chk(args)) size]];
    ...
    if (translation == nil) {
      ...
      if (((jint) [((NSString *) nil_chk(name)) length]) == 1) {
        ...
        if (ch == 'x' || ch == 'y' || ch == 'z') {
          if ([((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([args getWithInt:0])) evaluatesToList]) {
            (void) [sbCASCommand appendWithNSString:OrgGeogebraCommonCasGeoGebraCAS_toStringWithOrgGeogebraCommonKernelArithmeticExpressionValue_withBoolean_withOrgGeogebraCommonKernelStringTemplate_([args getWithInt:0], symbolic, tpl)];
            (void) [sbCASCommand appendWithChar:'['];
            switch (ch) {
              case 'x':
              default:
              (void) [sbCASCommand appendWithChar:'0'];
              break;
              case 'y':
              (void) [sbCASCommand appendWithChar:'1'];
              break;
              case 'z':
              (void) [sbCASCommand appendWithChar:'2'];
              break;
            }
            (void) [sbCASCommand appendWithChar:']'];
            return [sbCASCommand description];
            ...
            (void) [sbCASCommand appendWithChar:ch];
            (void) [sbCASCommand appendWithNSString:@"coord("];
          }
          else {
            (void) [sbCASCommand appendWithChar:'('];
            (void) [sbCASCommand appendWithNSString:[((OrgGeogebraCommonKernelStringTemplate *) nil_chk(tpl)) printVariableNameWithNSString:JreStrcat("C", ch)]];
            (void) [sbCASCommand appendWithNSString:@")*("];
          }
          handled = YES;
        }
        ...
        if (c != nil) {
          ...
          for (jint i = 0; i < [args size]; i++) {
            ...
            (void) [sb appendWithNSString:[((OrgGeogebraCommonKernelArithmeticExpressionNode *) nil_chk([args getWithInt:i])) toOutputValueStringWithOrgGeogebraCommonKernelStringTemplate:OrgGeogebraCommonKernelStringTemplate_get_defaultTemplate_()]];
          }
          (void) [sb appendWithChar:']'];
      ...
      if (!handled) {
        (void) [sbCASCommand appendWithNSString:[((OrgGeogebraCommonKernelStringTemplate *) nil_chk(tpl)) printVariableNameWithNSString:name]];
        (void) [sbCASCommand appendWithChar:'('];
      }
      for (jint i = 0; i < [args size]; i++) {
      ...
      for (jint i = 0; i < ((jint) [translation length]); i++) {
        ...
        if (ch == '%') {
          ...
          if (pos >= 0 && pos < [args size]) {
            ...
            (void) [sbCASCommand appendWithChar:ch];
            (void) [sbCASCommand appendWithChar:[translation charAtWithInt:i]];
          }
        }
        else if (ch == '@') {
          i++;
          ...
          if (pos >= 0 && pos < [args size]) {
            id<OrgGeogebraCommonKernelArithmeticExpressionValue> ev = [args getWithInt:pos];
            if ([((NSString *) nil_chk(OrgGeogebraCommonCasGeoGebraCAS_toStringWithOrgGeogebraCommonKernelArithmeticExpressionValue_withBoolean_withOrgGeogebraCommonKernelStringTemplate_(ev, symbolic, tpl))) matches:@"[^(),]*"]) (void) [sbCASCommand appendWithNSString:OrgGeogebraCommonCasGeoGebraCAS_toStringWithOrgGeogebraCommonKernelArithmeticExpressionValue_withBoolean_withOrgGeogebraCommonKernelStringTemplate_(ev, symbolic, tpl)];
            else (void) [sbCASCommand appendWithNSString:@"x"];
          }
          else {
            (void) [sbCASCommand appendWithChar:ch];
            (void) [sbCASCommand appendWithChar:[translation charAtWithInt:i]];
