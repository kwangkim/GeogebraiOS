...
+ (void)initialize {
  if (self == [OrgGeogebraCommonCasGiacGgb2giac class]) {
    OrgGeogebraCommonCasGiacGgb2giac_commandMap_ = new_JavaUtilTreeMap_init();
...
void OrgGeogebraCommonCasGiacGgb2giac_pWithNSString_withNSString_(NSString *signature, NSString *casSyntax) {
  ...
  (void) [((id<JavaUtilMap>) nil_chk(OrgGeogebraCommonCasGiacGgb2giac_commandMap_)) putWithId:signature withId:[((NSString *) nil_chk(casSyntax)) replace:@"_" withSequence:@"\\_"]];
}
