...
void OrgGeogebraCommonCasAlgoAsymptoteFunction_initWithOrgGeogebraCommonKernelConstruction_withNSString_withOrgGeogebraCommonKernelGeosGeoFunction_(OrgGeogebraCommonCasAlgoAsymptoteFunction *self, OrgGeogebraCommonKernelConstruction *cons, NSString *label, OrgGeogebraCommonKernelGeosGeoFunction *f) {
  ...
  OrgGeogebraCommonCasAlgoAsymptoteFunction_setAndConsume_sb_(self, new_JavaLangStringBuilder_init());
  OrgGeogebraCommonCasAlgoAsymptoteFunction_set_f_(self, f);
  OrgGeogebraCommonCasAlgoAsymptoteFunction_setAndConsume_g_(self, new_OrgGeogebraCommonKernelGeosGeoList_initWithOrgGeogebraCommonKernelConstruction_(cons));
