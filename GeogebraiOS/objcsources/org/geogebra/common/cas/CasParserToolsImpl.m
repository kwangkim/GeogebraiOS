...
void OrgGeogebraCommonCasCasParserToolsImpl_initWithChar_(OrgGeogebraCommonCasCasParserToolsImpl *self, jchar foreignExpChar) {
  NSObject_init(self);
  OrgGeogebraCommonCasCasParserToolsImpl_set_pattern_(self, ComGoogleGwtRegexpSharedRegExp_compileWithNSString_withNSString_(JreStrcat("$C", @"((^|\\W)[0-9]+)", foreignExpChar), @"g"));
}
