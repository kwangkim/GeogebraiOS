...
void iOSXmlParser_parseDirtyWithOrgGeogebraCommonIoDocHandler_withNSString_(id<OrgGeogebraCommonIoDocHandler> docHandler, NSString *xml) {
  ...
  @try {
    [new_OrgGeogebraCommonIoQDParser_init() parseWithOrgGeogebraCommonIoDocHandler:docHandler withJavaIoReader:new_JavaIoStringReader_initWithNSString_(xml)];
  }
  @catch (JavaLangException *e2) {
    @throw new_ConstructionException_initWithJavaLangException_(e2);
  }
}
