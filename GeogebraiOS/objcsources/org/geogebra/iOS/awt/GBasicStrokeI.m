...
- (id<OrgGeogebraCommonAwtGShape>)createStrokedShapeWithOrgGeogebraCommonAwtGShape:(id<OrgGeogebraCommonAwtGShape>)s {
  ...
  GBasicStrokeI_setAndConsume_dst_(self, new_GBasicStrokeI_BufferedPath_init());
  GBasicStrokeI_setAndConsume_lp_(self, new_GBasicStrokeI_BufferedPath_init());
  GBasicStrokeI_setAndConsume_rp_(self, new_GBasicStrokeI_BufferedPath_init());
  if (dash_ == nil) {
...
- (void)createSolidShapeWithOrgGeogebraCommonAwtGPathIterator:(id<OrgGeogebraCommonAwtGPathIterator>)pathIterator {
  ...
  GBasicStrokeI_set_dst_(self, lp_);
}
...
- (void)createDashedShapeWithOrgGeogebraCommonAwtGPathIterator:(id<OrgGeogebraCommonAwtGPathIterator>)pathIterator {
  ...
  while (![((id<OrgGeogebraCommonAwtGPathIterator>) nil_chk(pathIterator)) isDone]) {
    switch ([pathIterator currentSegmentWithDoubleArray:coords]) {
      ...
      GBasicStrokeI_setAndConsume_dasher_(self, new_GBasicStrokeI_Dasher_initWithGBasicStrokeI_withFloatArray_withFloat_(self, dash_, dashPhase_));
      [((GBasicStrokeI_BufferedPath *) nil_chk(lp_)) clean];
      [((GBasicStrokeI_BufferedPath *) nil_chk(rp_)) clean];
      GBasicStrokeI_set_sp_(self, nil);
      isFirst_ = YES;
      isMove_ = YES;
      isClosed = NO;
      mx_ = cx_ = IOSDoubleArray_Get(coords, 0);
...
- (void)addCubicWithDouble:(jdouble)x1
  ...
  if (onLine) {
    ...
    IOSDoubleArray *roots = [IOSDoubleArray arrayWithLength:3];
    jint rc = 0;
    if (d == 0.0) {
...
- (void)addDashLineWithDouble:(jdouble)x1
  ...
  jdouble mx = -y21 * w;
  jdouble my = x21 * w;
  [((GBasicStrokeI_Dasher *) nil_chk(dasher_)) init__WithGBasicStrokeI_DashIterator:[new_GBasicStrokeI_DashIterator_Line_initWithDouble_(l21) autorelease]];
  while (![dasher_ eof]) {
    ...
    if ([dasher_ isOpen]) {
      ...
      if (dasher_->close_) {
        ...
        if (isFirst_) {
          ...
          fmx_ = smx_;
          fmy_ = smy_;
          GBasicStrokeI_set_sp_(self, lp_);
          GBasicStrokeI_setAndConsume_lp_(self, new_GBasicStrokeI_BufferedPath_init());
        }
        else {
          [self addCapWithGBasicStrokeI_BufferedPath:lp_ withDouble:smx_ withDouble:smy_ withDouble:lp_->xMove_ withDouble:lp_->yMove_];
...
- (void)addDashQuadWithDouble:(jdouble)x1
  ...
  px1 = py1 = dx1 = dy1 = 0.0;
  jdouble prev = 0.0;
  [((GBasicStrokeI_Dasher *) nil_chk(dasher_)) init__WithGBasicStrokeI_DashIterator:[new_GBasicStrokeI_DashIterator_Quad_initWithDouble_withDouble_withDouble_withDouble_withDouble_withDouble_(x1, y1, x2, y2, x3, y3) autorelease]];
  while (![dasher_ eof]) {
    jdouble t = [dasher_ getValue];
    jdouble dx = t * ax + bx;
    jdouble dy = t * ay + by;
...
- (void)addDashCubicWithDouble:(jdouble)x1
  ...
  jdouble py1 = 0.0;
  jdouble prev = 0.0;
  [((GBasicStrokeI_Dasher *) nil_chk(dasher_)) init__WithGBasicStrokeI_DashIterator:[new_GBasicStrokeI_DashIterator_Cubic_initWithDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_(x1, y1, x2, y2, x3, y3, x4, y4) autorelease]];
  while (![dasher_ eof]) {
    jdouble t = [dasher_ getValue];
...
void GBasicStrokeI_init(GBasicStrokeI *self) {
  GBasicStrokeI_initWithFloat_withInt_withInt_withFloat_withFloatArray_withFloat_(self, 1.0f, GBasicStrokeI_CAP_SQUARE, GBasicStrokeI_JOIN_MITER, 10.0f, nil, 0.0f);
}
...
void GBasicStrokeI_initWithFloat_withInt_withInt_withFloat_withFloatArray_withFloat_(GBasicStrokeI *self, jfloat width, jint cap, jint join, jfloat miterLimit, IOSFloatArray *dash, jfloat dashPhase) {
  ...
  GBasicStrokeI_set_dasharray_(self, nil);
  if (width < 0.0f) {
    @throw [new_JavaLangIllegalArgumentException_initWithNSString_((@"Negative width awt.133")) autorelease];
  }
  if (cap != GBasicStrokeI_CAP_BUTT && cap != GBasicStrokeI_CAP_ROUND && cap != GBasicStrokeI_CAP_SQUARE) {
    @throw [new_JavaLangIllegalArgumentException_initWithNSString_((@"Illegal cap awt.134")) autorelease];
  }
  if (join != GBasicStrokeI_JOIN_MITER && join != GBasicStrokeI_JOIN_ROUND && join != GBasicStrokeI_JOIN_BEVEL) {
    @throw [new_JavaLangIllegalArgumentException_initWithNSString_((@"Illegal join awt.135")) autorelease];
  }
  if (join == GBasicStrokeI_JOIN_MITER && miterLimit < 1.0f) {
    @throw [new_JavaLangIllegalArgumentException_initWithNSString_((@"miterLimit less than 1.0f awt.136")) autorelease];
  }
  if (dash != nil) {
    if (dashPhase < 0.0f) {
      @throw [new_JavaLangIllegalArgumentException_initWithNSString_((@"Negative dashPhase awt.137")) autorelease];
    }
    if (dash->size_ == 0) {
      @throw [new_JavaLangIllegalArgumentException_initWithNSString_((@"Zero dash length awt.138")) autorelease];
    }
    {
      for (jint i = 0; i < dash->size_; i++) {
        if (IOSFloatArray_Get(dash, i) < 0.0) {
          @throw [new_JavaLangIllegalArgumentException_initWithNSString_((@"Negative dash[{0}] awt.139")) autorelease];
        }
        if (IOSFloatArray_Get(dash, i) > 0.0) {
          goto break_ZERO;
        }
      }
      @throw [new_JavaLangIllegalArgumentException_initWithNSString_((@"All dash lengths zero awt.13A")) autorelease];
    }
    break_ZERO: ;
  }
  self->width_ = width;
  ...
  GBasicStrokeI_set_dash_(self, dash);
...
void GBasicStrokeI_initWithFloat_withInt_withInt_withFloat_(GBasicStrokeI *self, jfloat width, jint cap, jint join, jfloat miterLimit) {
  GBasicStrokeI_initWithFloat_withInt_withInt_withFloat_withFloatArray_withFloat_(self, width, cap, join, miterLimit, nil, 0.0f);
}
...
void GBasicStrokeI_initWithFloat_withInt_withInt_(GBasicStrokeI *self, jfloat width, jint cap, jint join) {
  GBasicStrokeI_initWithFloat_withInt_withInt_withFloat_withFloatArray_withFloat_(self, width, cap, join, 10.0f, nil, 0.0f);
}
...
void GBasicStrokeI_initWithFloat_(GBasicStrokeI *self, jfloat width) {
  GBasicStrokeI_initWithFloat_withInt_withInt_withFloat_withFloatArray_withFloat_(self, width, GBasicStrokeI_CAP_SQUARE, GBasicStrokeI_JOIN_MITER, 10.0f, nil, 0.0f);
}
...
void GBasicStrokeI_initWithOrgGeogebraCommonAwtGBasicStroke_(GBasicStrokeI *self, id<OrgGeogebraCommonAwtGBasicStroke> objStroke) {
  ...
  GBasicStrokeI_set_dasharray_(self, [((GBasicStrokeI *) nil_chk(((GBasicStrokeI *) check_class_cast(objStroke, [GBasicStrokeI class])))) getDashArray]);
}
...
- (void)init__WithGBasicStrokeI_DashIterator:(GBasicStrokeI_DashIterator *)iter {
  GBasicStrokeI_Dasher_set_iter_(self, iter);
  close_ = YES;
}
...
void GBasicStrokeI_Dasher_initWithGBasicStrokeI_withFloatArray_withFloat_(GBasicStrokeI_Dasher *self, GBasicStrokeI *outer$, IOSFloatArray *dash, jfloat phase) {
  NSObject_init(self);
  GBasicStrokeI_Dasher_set_dash_(self, dash);
  self->phase_ = phase;
  self->index_ = 0;
  self->pos_ = phase;
  self->visible_ = YES;
...
void GBasicStrokeI_DashIterator_Quad_initWithDouble_withDouble_withDouble_withDouble_withDouble_withDouble_(GBasicStrokeI_DashIterator_Quad *self, jdouble x1, jdouble y1, jdouble x2, jdouble y2, jdouble x3, jdouble y3) {
  ...
  jdouble vy = y1;
  self->valSize_ = n;
  GBasicStrokeI_DashIterator_Quad_setAndConsume_values_(self, [IOSDoubleArray newArrayWithLength:self->valSize_]);
  jdouble pvx = vx;
  jdouble pvy = vy;
  self->length_ = 0.0;
  for (jint i = 0; i < n; i++) {
...
void GBasicStrokeI_DashIterator_Cubic_initWithDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_(GBasicStrokeI_DashIterator_Cubic *self, jdouble x1, jdouble y1, jdouble x2, jdouble y2, jdouble x3, jdouble y3, jdouble x4, jdouble y4) {
  ...
  jdouble vy = y1;
  self->valSize_ = n;
  GBasicStrokeI_DashIterator_Cubic_setAndConsume_values_(self, [IOSDoubleArray newArrayWithLength:self->valSize_]);
  jdouble pvx = vx;
  jdouble pvy = vy;
  self->length_ = 0.0;
  for (jint i = 0; i < n; i++) {
...
- (void)checkBufWithInt:(jint)typeCount
  ...
  if (typeSize_ + typeCount > ((IOSByteArray *) nil_chk(types_))->size_) {
    IOSByteArray *tmp = [IOSByteArray arrayWithLength:typeSize_ + JavaLangMath_maxWithInt_withInt_(GBasicStrokeI_BufferedPath_bufCapacity, typeCount)];
    JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(types_, 0, tmp, 0, typeSize_);
    GBasicStrokeI_BufferedPath_set_types_(self, tmp);
  }
  if (pointSize_ + pointCount > ((IOSFloatArray *) nil_chk(points_))->size_) {
    IOSFloatArray *tmp = [IOSFloatArray arrayWithLength:pointSize_ + JavaLangMath_maxWithInt_withInt_(GBasicStrokeI_BufferedPath_bufCapacity * 2, pointCount)];
    JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(points_, 0, tmp, 0, pointSize_);
    GBasicStrokeI_BufferedPath_set_points_(self, tmp);
  }
}
...
- (id<OrgGeogebraCommonAwtGGeneralPath>)createGeneralPath {
  OrgGeogebraGgbjdkJavaAwtGeomGeneralPath *p = [new_OrgGeogebraGgbjdkJavaAwtGeomGeneralPath_init() autorelease];
  jint j = 0;
...
+ (void)initialize {
  if (self == [GBasicStrokeI_BufferedPath class]) {
    JreStrongAssignAndConsume(&GBasicStrokeI_BufferedPath_pointShift_, nil, [IOSIntArray newArrayWithInts:(jint[]){ 2, 2, 4, 6, 0 } count:5]);
...
void GBasicStrokeI_BufferedPath_init(GBasicStrokeI_BufferedPath *self) {
  NSObject_init(self);
  GBasicStrokeI_BufferedPath_setAndConsume_types_(self, [IOSByteArray newArrayWithLength:GBasicStrokeI_BufferedPath_bufCapacity]);
  GBasicStrokeI_BufferedPath_setAndConsume_points_(self, [IOSFloatArray newArrayWithLength:GBasicStrokeI_BufferedPath_bufCapacity * 2]);
}
