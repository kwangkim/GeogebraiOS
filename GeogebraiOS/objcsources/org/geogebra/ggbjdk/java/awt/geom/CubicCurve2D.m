...
- (jboolean)containsWithDouble:(jdouble)x
  ...
  IOSDoubleArray *res = [IOSDoubleArray newArrayWithLength:4];
...
- (id<OrgGeogebraGgbjdkJavaAwtGeomPathIterator>)getPathIteratorWithOrgGeogebraCommonAwtGAffineTransform:(id<OrgGeogebraCommonAwtGAffineTransform>)at {
  return new_OrgGeogebraGgbjdkJavaAwtGeomCubicIterator_initWithOrgGeogebraGgbjdkJavaAwtGeomCubicCurve2D_withOrgGeogebraCommonAwtGAffineTransform_(self, at);
}
...
- (jboolean)intersectsWithDouble:(jdouble)x
  ...
  jint num = OrgGeogebraGgbjdkJavaAwtGeomCubicCurve2D_solveCubicWithDoubleArray_withDoubleArray_(eqn, res);
  num = OrgGeogebraGgbjdkJavaAwtGeomCubicCurve2D_evalCubicWithDoubleArray_withInt_withBoolean_withBoolean_withDoubleArray_withDouble_withDouble_withDouble_withDouble_(res, num, YES, YES, nil, y1, ctrly1, ctrly2, y2);
  IOSIntArray *tags = [IOSIntArray newArrayWithLength:num + 1];
...
jint OrgGeogebraGgbjdkJavaAwtGeomCubicCurve2D_solveCubicWithDoubleArray_withDoubleArray_(IOSDoubleArray *eqn, IOSDoubleArray *res) {
  ...
  if (R2 < Q3) {
    ...
    if (res == eqn) {
      eqn = [IOSDoubleArray newArrayWithLength:4];
...
- (OrgGeogebraGgbjdkJavaAwtGeomRectangle2D *)getBounds2D {
  ...
  return new_OrgGeogebraGgbjdkJavaAwtGeomRectangle2D_Double_initWithDouble_withDouble_withDouble_withDouble_(left, top, right - left, bottom - top);
}

- (OrgGeogebraGgbjdkJavaAwtGeomPoint2D *)getCtrlP1 {
  return new_OrgGeogebraGgbjdkJavaAwtGeomPoint2D_Double_initWithDouble_withDouble_(ctrlx1_, ctrly1_);
}

- (OrgGeogebraGgbjdkJavaAwtGeomPoint2D *)getCtrlP2 {
  return new_OrgGeogebraGgbjdkJavaAwtGeomPoint2D_Double_initWithDouble_withDouble_(ctrlx2_, ctrly2_);
}
...
void OrgGeogebraGgbjdkJavaAwtGeomCubicCurve2D_Double_init(OrgGeogebraGgbjdkJavaAwtGeomCubicCurve2D_Double *self) {
  (void) OrgGeogebraGgbjdkJavaAwtGeomCubicCurve2D_init(self);
}
...
- (OrgGeogebraGgbjdkJavaAwtGeomRectangle2D *)getBounds2D {
  ...
  return new_OrgGeogebraGgbjdkJavaAwtGeomRectangle2D_Float_initWithFloat_withFloat_withFloat_withFloat_(left, top, right - left, bottom - top);
}

- (OrgGeogebraGgbjdkJavaAwtGeomPoint2D *)getCtrlP1 {
  return new_OrgGeogebraGgbjdkJavaAwtGeomPoint2D_Float_initWithFloat_withFloat_(ctrlx1_, ctrly1_);
}

- (OrgGeogebraGgbjdkJavaAwtGeomPoint2D *)getCtrlP2 {
  return new_OrgGeogebraGgbjdkJavaAwtGeomPoint2D_Float_initWithFloat_withFloat_(ctrlx2_, ctrly2_);
}
