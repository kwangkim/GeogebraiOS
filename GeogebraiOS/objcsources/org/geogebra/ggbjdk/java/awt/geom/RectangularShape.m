...
- (id<OrgGeogebraCommonAwtGRectangle>)getBounds {
  ...
  return [new_OrgGeogebraGgbjdkJavaAwtGeomRectangle_initWithInt_withInt_withInt_withInt_(J2ObjCFpToInt(x1), J2ObjCFpToInt(y1), J2ObjCFpToInt((x2 - x1)), J2ObjCFpToInt((y2 - y1))) autorelease];
}
...
- (OrgGeogebraGgbjdkJavaAwtGeomRectangle2D *)getFrame {
  return [new_OrgGeogebraGgbjdkJavaAwtGeomRectangle2D_Double_initWithDouble_withDouble_withDouble_withDouble_([self getX], [self getY], [self getWidth], [self getHeight]) autorelease];
}
