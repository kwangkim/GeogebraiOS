...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/ggbjdk/java/awt/geom/GeneralPath.java
//
...
- (id)clone {
  OrgGeogebraGgbjdkJavaAwtGeomGeneralPath *clone = new_OrgGeogebraGgbjdkJavaAwtGeomGeneralPath_initWithOrgGeogebraGgbjdkJavaAwtGeomShape_(self);
  return clone;
}
...
- (OrgGeogebraGgbjdkJavaAwtGeomRectangle2D *)getBounds2D {
  ...
  return new_OrgGeogebraGgbjdkJavaAwtGeomRectangle2D_Float_initWithFloat_withFloat_withFloat_withFloat_(x1, y1, x2 - x1, y2 - y1);
}
...
- (OrgGeogebraGgbjdkJavaAwtGeomPoint2D *)getCurrentPoint {
  ...
  return new_OrgGeogebraGgbjdkJavaAwtGeomPoint2D_Float_initWithFloat_withFloat_(IOSFloatArray_Get(nil_chk(pointCoords_), index - 2), IOSFloatArray_Get(pointCoords_, index - 1));
}
...
- (id<OrgGeogebraGgbjdkJavaAwtGeomPathIterator>)getPathIteratorWithOrgGeogebraCommonAwtGAffineTransform:(id<OrgGeogebraCommonAwtGAffineTransform>)at {
  return new_OrgGeogebraGgbjdkJavaAwtGeomGeneralPathIterator_initWithOrgGeogebraGgbjdkJavaAwtGeomGeneralPath_withOrgGeogebraCommonAwtGAffineTransform_(self, at);
}
...
- (void)setWindingRuleWithInt:(jint)rule {
  if (rule != OrgGeogebraGgbjdkJavaAwtGeomGeneralPath_WIND_EVEN_ODD && rule != OrgGeogebraGgbjdkJavaAwtGeomGeneralPath_WIND_NON_ZERO) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"winding rule must be WIND_EVEN_ODD or WIND_NON_ZERO");
  }
  windingRule_ = rule;
}
...
void OrgGeogebraGgbjdkJavaAwtGeomGeneralPath_init(OrgGeogebraGgbjdkJavaAwtGeomGeneralPath *self) {
  (void) OrgGeogebraGgbjdkJavaAwtGeomGeneralPath_initWithInt_withInt_withInt_(self, OrgGeogebraGgbjdkJavaAwtGeomGeneralPath_WIND_NON_ZERO, OrgGeogebraGgbjdkJavaAwtGeomGeneralPath_INIT_SIZE, OrgGeogebraGgbjdkJavaAwtGeomGeneralPath_INIT_SIZE);
}
...
void OrgGeogebraGgbjdkJavaAwtGeomGeneralPath_initWithInt_(OrgGeogebraGgbjdkJavaAwtGeomGeneralPath *self, jint rule) {
  (void) OrgGeogebraGgbjdkJavaAwtGeomGeneralPath_initWithInt_withInt_withInt_(self, rule, OrgGeogebraGgbjdkJavaAwtGeomGeneralPath_INIT_SIZE, OrgGeogebraGgbjdkJavaAwtGeomGeneralPath_INIT_SIZE);
}
...
void OrgGeogebraGgbjdkJavaAwtGeomGeneralPath_initWithInt_withInt_(OrgGeogebraGgbjdkJavaAwtGeomGeneralPath *self, jint rule, jint initialCapacity) {
  (void) OrgGeogebraGgbjdkJavaAwtGeomGeneralPath_initWithInt_withInt_withInt_(self, rule, initialCapacity, initialCapacity);
}
...
void OrgGeogebraGgbjdkJavaAwtGeomGeneralPath_initWithInt_withByteArray_withInt_withFloatArray_withInt_(OrgGeogebraGgbjdkJavaAwtGeomGeneralPath *self, jint windingRule, IOSByteArray *pointTypes, jint numTypes, IOSFloatArray *pointCoords, jint numCoords) {
  ...
  self->pointTypes_ = pointTypes;
  self->numTypes_ = numTypes;
  self->pointCoords_ = pointCoords;
...
void OrgGeogebraGgbjdkJavaAwtGeomGeneralPath_initWithInt_withInt_withInt_(OrgGeogebraGgbjdkJavaAwtGeomGeneralPath *self, jint rule, jint initialTypes, jint initialCoords) {
  ...
  self->pointTypes_ = [IOSByteArray newArrayWithLength:initialTypes];
  self->pointCoords_ = [IOSFloatArray newArrayWithLength:initialCoords * 2];
}
...
void OrgGeogebraGgbjdkJavaAwtGeomGeneralPath_needRoomWithInt_withInt_withBoolean_(OrgGeogebraGgbjdkJavaAwtGeomGeneralPath *self, jint newTypes, jint newCoords, jboolean needMove) {
  if (needMove && self->numTypes_ == 0) {
    @throw new_OrgGeogebraGgbjdkJavaAwtGeomIllegalPathStateException_initWithNSString_(@"missing initial moveto in path definition");
  }
