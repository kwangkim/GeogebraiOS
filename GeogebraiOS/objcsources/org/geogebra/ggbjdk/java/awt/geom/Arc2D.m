...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/ggbjdk/java/awt/geom/Arc2D.java
//
...
- (OrgGeogebraGgbjdkJavaAwtGeomPoint2D *)getEndPoint {
  ...
  return [new_OrgGeogebraGgbjdkJavaAwtGeomPoint2D_Double_initWithDouble_withDouble_(x, y) autorelease];
}
...
- (id<OrgGeogebraGgbjdkJavaAwtGeomPathIterator>)getPathIteratorWithOrgGeogebraCommonAwtGAffineTransform:(id<OrgGeogebraCommonAwtGAffineTransform>)at {
  return [new_OrgGeogebraGgbjdkJavaAwtGeomArcIterator_initWithOrgGeogebraGgbjdkJavaAwtGeomArc2D_withOrgGeogebraCommonAwtGAffineTransform_(self, at) autorelease];
}
...
- (void)setArcTypeWithInt:(jint)type {
  if (type < OrgGeogebraGgbjdkJavaAwtGeomArc2D_OPEN || type > OrgGeogebraGgbjdkJavaAwtGeomArc2D_PIE) {
    @throw [new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$I", @"invalid type for Arc: ", type)) autorelease];
  }
  self->type_ = type;
}
...
jboolean OrgGeogebraGgbjdkJavaAwtGeomArc2D_containsWithDouble_withDouble_withDouble_withDouble_withOrgGeogebraCommonAwtGRectangle2D_(OrgGeogebraGgbjdkJavaAwtGeomArc2D *self, jdouble x, jdouble y, jdouble w, jdouble h, id<OrgGeogebraCommonAwtGRectangle2D> origrect) {
  ...
  if (origrect == nil) {
    origrect = [new_OrgGeogebraGgbjdkJavaAwtGeomRectangle2D_Double_initWithDouble_withDouble_withDouble_withDouble_(x, y, w, h) autorelease];
  }
...
- (OrgGeogebraGgbjdkJavaAwtGeomRectangle2D *)makeBoundsWithDouble:(jdouble)x
                                                       ...
                                                       withDouble:(jdouble)w
                                                       withDouble:(jdouble)h {
  return [new_OrgGeogebraGgbjdkJavaAwtGeomRectangle2D_Double_initWithDouble_withDouble_withDouble_withDouble_(x, y, w, h) autorelease];
}
...
void OrgGeogebraGgbjdkJavaAwtGeomArc2D_Double_init(OrgGeogebraGgbjdkJavaAwtGeomArc2D_Double *self) {
  OrgGeogebraGgbjdkJavaAwtGeomArc2D_initWithInt_(self, OrgGeogebraGgbjdkJavaAwtGeomArc2D_OPEN);
}
...
- (OrgGeogebraGgbjdkJavaAwtGeomRectangle2D *)makeBoundsWithDouble:(jdouble)x
                                                       ...
                                                       withDouble:(jdouble)w
                                                       withDouble:(jdouble)h {
  return [new_OrgGeogebraGgbjdkJavaAwtGeomRectangle2D_Float_initWithFloat_withFloat_withFloat_withFloat_((jfloat) x, (jfloat) y, (jfloat) w, (jfloat) h) autorelease];
}
