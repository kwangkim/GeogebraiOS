...
- (OrgGeogebraGgbjdkJavaAwtGeomRectangle *)getBounds {
  return new_OrgGeogebraGgbjdkJavaAwtGeomRectangle_initWithInt_withInt_withInt_withInt_(x_, y_, width_, height_);
}
...
- (OrgGeogebraGgbjdkJavaAwtGeomPoint *)getLocation {
  return new_OrgGeogebraGgbjdkJavaAwtGeomPoint_initWithInt_withInt_(x_, y_);
}
...
- (OrgGeogebraGgbjdkJavaAwtGeomDimension *)getSize {
  return new_OrgGeogebraGgbjdkJavaAwtGeomDimension_initWithInt_withInt_(width_, height_);
}
...
- (OrgGeogebraGgbjdkJavaAwtGeomRectangle *)intersectionWithOrgGeogebraGgbjdkJavaAwtGeomRectangle:(OrgGeogebraGgbjdkJavaAwtGeomRectangle *)r {
  ...
  return new_OrgGeogebraGgbjdkJavaAwtGeomRectangle_initWithInt_withInt_withInt_withInt_(tx1, ty1, (jint) tx2, (jint) ty2);
}
...
- (OrgGeogebraGgbjdkJavaAwtGeomRectangle *)union__WithOrgGeogebraCommonAwtGRectangle:(id<OrgGeogebraCommonAwtGRectangle>)r {
  ...
  return new_OrgGeogebraGgbjdkJavaAwtGeomRectangle_initWithInt_withInt_withInt_withInt_(x1, y1, x2 - x1, y2 - y1);
}
...
void OrgGeogebraGgbjdkJavaAwtGeomRectangle_init(OrgGeogebraGgbjdkJavaAwtGeomRectangle *self) {
  (void) OrgGeogebraGgbjdkJavaAwtGeomRectangle_initWithInt_withInt_withInt_withInt_(self, 0, 0, 0, 0);
}
...
void OrgGeogebraGgbjdkJavaAwtGeomRectangle_initWithOrgGeogebraCommonAwtGRectangle_(OrgGeogebraGgbjdkJavaAwtGeomRectangle *self, id<OrgGeogebraCommonAwtGRectangle> r) {
  (void) OrgGeogebraGgbjdkJavaAwtGeomRectangle_initWithInt_withInt_withInt_withInt_(self, J2ObjCFpToInt([((id<OrgGeogebraCommonAwtGRectangle>) nil_chk(r)) getX]), J2ObjCFpToInt([r getY]), J2ObjCFpToInt([r getWidth]), J2ObjCFpToInt([r getHeight]));
}
...
void OrgGeogebraGgbjdkJavaAwtGeomRectangle_initWithInt_withInt_(OrgGeogebraGgbjdkJavaAwtGeomRectangle *self, jint width, jint height) {
  (void) OrgGeogebraGgbjdkJavaAwtGeomRectangle_initWithInt_withInt_withInt_withInt_(self, 0, 0, width, height);
}
...
void OrgGeogebraGgbjdkJavaAwtGeomRectangle_initWithOrgGeogebraGgbjdkJavaAwtGeomPoint_withOrgGeogebraGgbjdkJavaAwtGeomDimension_(OrgGeogebraGgbjdkJavaAwtGeomRectangle *self, OrgGeogebraGgbjdkJavaAwtGeomPoint *p, OrgGeogebraGgbjdkJavaAwtGeomDimension *d) {
  (void) OrgGeogebraGgbjdkJavaAwtGeomRectangle_initWithInt_withInt_withInt_withInt_(self, ((OrgGeogebraGgbjdkJavaAwtGeomPoint *) nil_chk(p))->x_, p->y_, ((OrgGeogebraGgbjdkJavaAwtGeomDimension *) nil_chk(d))->width_, d->height_);
}
...
void OrgGeogebraGgbjdkJavaAwtGeomRectangle_initWithOrgGeogebraGgbjdkJavaAwtGeomPoint_(OrgGeogebraGgbjdkJavaAwtGeomRectangle *self, OrgGeogebraGgbjdkJavaAwtGeomPoint *p) {
  (void) OrgGeogebraGgbjdkJavaAwtGeomRectangle_initWithInt_withInt_withInt_withInt_(self, ((OrgGeogebraGgbjdkJavaAwtGeomPoint *) nil_chk(p))->x_, p->y_, 0, 0);
}
...
void OrgGeogebraGgbjdkJavaAwtGeomRectangle_initWithOrgGeogebraGgbjdkJavaAwtGeomDimension_(OrgGeogebraGgbjdkJavaAwtGeomRectangle *self, OrgGeogebraGgbjdkJavaAwtGeomDimension *d) {
  (void) OrgGeogebraGgbjdkJavaAwtGeomRectangle_initWithInt_withInt_withInt_withInt_(self, 0, 0, ((OrgGeogebraGgbjdkJavaAwtGeomDimension *) nil_chk(d))->width_, d->height_);
}
