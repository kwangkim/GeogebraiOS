...
- (void)addWithOrgGeogebraCommonAwtGArea:(id<OrgGeogebraCommonAwtGArea>)rhs {
  curves_ = [new_OrgGeogebraGgbjdkSunAwtGeomAreaOp_AddOp_init() calculateWithJavaUtilVector:self->curves_ withJavaUtilVector:((OrgGeogebraGgbjdkJavaAwtGeomArea *) nil_chk(((OrgGeogebraGgbjdkJavaAwtGeomArea *) check_class_cast(rhs, [OrgGeogebraGgbjdkJavaAwtGeomArea class]))))->curves_];
...
- (void)subtractWithOrgGeogebraCommonAwtGArea:(id<OrgGeogebraCommonAwtGArea>)rhs {
  curves_ = [new_OrgGeogebraGgbjdkSunAwtGeomAreaOp_SubOp_init() calculateWithJavaUtilVector:self->curves_ withJavaUtilVector:((OrgGeogebraGgbjdkJavaAwtGeomArea *) nil_chk(((OrgGeogebraGgbjdkJavaAwtGeomArea *) check_class_cast(rhs, [OrgGeogebraGgbjdkJavaAwtGeomArea class]))))->curves_];
  OrgGeogebraGgbjdkJavaAwtGeomArea_invalidateBounds(self);
}

- (void)intersectWithOrgGeogebraCommonAwtGArea:(id<OrgGeogebraCommonAwtGArea>)rhs {
  curves_ = [new_OrgGeogebraGgbjdkSunAwtGeomAreaOp_IntOp_init() calculateWithJavaUtilVector:self->curves_ withJavaUtilVector:((OrgGeogebraGgbjdkJavaAwtGeomArea *) nil_chk(((OrgGeogebraGgbjdkJavaAwtGeomArea *) check_class_cast(rhs, [OrgGeogebraGgbjdkJavaAwtGeomArea class]))))->curves_];
  OrgGeogebraGgbjdkJavaAwtGeomArea_invalidateBounds(self);
}

- (void)exclusiveOrWithOrgGeogebraCommonAwtGArea:(id<OrgGeogebraCommonAwtGArea>)rhs {
  curves_ = [new_OrgGeogebraGgbjdkSunAwtGeomAreaOp_XorOp_init() calculateWithJavaUtilVector:self->curves_ withJavaUtilVector:((OrgGeogebraGgbjdkJavaAwtGeomArea *) nil_chk(((OrgGeogebraGgbjdkJavaAwtGeomArea *) check_class_cast(rhs, [OrgGeogebraGgbjdkJavaAwtGeomArea class]))))->curves_];
  OrgGeogebraGgbjdkJavaAwtGeomArea_invalidateBounds(self);
}

- (void)reset {
  curves_ = new_JavaUtilVector_init();
  OrgGeogebraGgbjdkJavaAwtGeomArea_invalidateBounds(self);
}
...
- (jboolean)isSingular {
  ...
  (void) [((id<JavaUtilEnumeration>) nil_chk(enum_)) nextElement];
...
- (id)clone {
  return new_OrgGeogebraGgbjdkJavaAwtGeomArea_initWithOrgGeogebraCommonAwtGShape_(self);
}
...
- (jboolean)equalsWithOrgGeogebraGgbjdkJavaAwtGeomArea:(OrgGeogebraGgbjdkJavaAwtGeomArea *)other {
  ...
  JavaUtilVector *c = [new_OrgGeogebraGgbjdkSunAwtGeomAreaOp_XorOp_init() calculateWithJavaUtilVector:self->curves_ withJavaUtilVector:((OrgGeogebraGgbjdkJavaAwtGeomArea *) nil_chk(other))->curves_];
...
- (void)transformWithOrgGeogebraGgbjdkJavaAwtGeomAffineTransform:(OrgGeogebraGgbjdkJavaAwtGeomAffineTransform *)t {
  curves_ = new_OrgGeogebraGgbjdkJavaAwtGeomArea_initWithOrgGeogebraCommonAwtGShape_([((OrgGeogebraGgbjdkJavaAwtGeomAffineTransform *) nil_chk(t)) createTransformedShapeWithOrgGeogebraCommonAwtGShape:self])->curves_;
  OrgGeogebraGgbjdkJavaAwtGeomArea_invalidateBounds(self);
}
...
- (OrgGeogebraGgbjdkJavaAwtGeomArea *)createTransformedAreaWithOrgGeogebraGgbjdkJavaAwtGeomAffineTransform:(OrgGeogebraGgbjdkJavaAwtGeomAffineTransform *)t {
  return new_OrgGeogebraGgbjdkJavaAwtGeomArea_initWithOrgGeogebraCommonAwtGShape_([((OrgGeogebraGgbjdkJavaAwtGeomAffineTransform *) nil_chk(t)) createTransformedShapeWithOrgGeogebraCommonAwtGShape:self]);
}
...
- (id<OrgGeogebraGgbjdkJavaAwtGeomPathIterator>)getPathIteratorWithOrgGeogebraCommonAwtGAffineTransform:(id<OrgGeogebraCommonAwtGAffineTransform>)at {
  return new_OrgGeogebraGgbjdkJavaAwtGeomAreaIterator_initWithJavaUtilVector_withOrgGeogebraCommonAwtGAffineTransform_(curves_, at);
}
...
+ (void)initialize {
  if (self == [OrgGeogebraGgbjdkJavaAwtGeomArea class]) {
    OrgGeogebraGgbjdkJavaAwtGeomArea_EmptyCurves_ = new_JavaUtilVector_init();
...
void OrgGeogebraGgbjdkJavaAwtGeomArea_init(OrgGeogebraGgbjdkJavaAwtGeomArea *self) {
  ...
  self->curves_ = OrgGeogebraGgbjdkJavaAwtGeomArea_EmptyCurves_;
}
...
void OrgGeogebraGgbjdkJavaAwtGeomArea_initWithOrgGeogebraCommonAwtGShape_(OrgGeogebraGgbjdkJavaAwtGeomArea *self, id<OrgGeogebraCommonAwtGShape> s) {
  ...
  if ([s isKindOfClass:[OrgGeogebraGgbjdkJavaAwtGeomArea class]]) {
    self->curves_ = ((OrgGeogebraGgbjdkJavaAwtGeomArea *) nil_chk(((OrgGeogebraGgbjdkJavaAwtGeomArea *) check_class_cast(s, [OrgGeogebraGgbjdkJavaAwtGeomArea class]))))->curves_;
    return;
  }
  self->curves_ = new_JavaUtilVector_init();
  ...
  IOSDoubleArray *coords = [IOSDoubleArray newArrayWithLength:23];
  ...
  if (windingRule == OrgGeogebraGgbjdkJavaAwtGeomPathIterator_WIND_EVEN_ODD) {
    operator_ = new_OrgGeogebraGgbjdkSunAwtGeomAreaOp_EOWindOp_init();
  }
  else {
    operator_ = new_OrgGeogebraGgbjdkSunAwtGeomAreaOp_NZWindOp_init();
  }
  self->curves_ = [((OrgGeogebraGgbjdkSunAwtGeomAreaOp *) nil_chk(operator_)) calculateWithJavaUtilVector:self->curves_ withJavaUtilVector:OrgGeogebraGgbjdkJavaAwtGeomArea_EmptyCurves_];
}
...
OrgGeogebraGgbjdkJavaAwtGeomRectangle2D *OrgGeogebraGgbjdkJavaAwtGeomArea_getCachedBounds(OrgGeogebraGgbjdkJavaAwtGeomArea *self) {
  ...
  OrgGeogebraGgbjdkJavaAwtGeomRectangle2D *r = new_OrgGeogebraGgbjdkJavaAwtGeomRectangle2D_Double_init();
