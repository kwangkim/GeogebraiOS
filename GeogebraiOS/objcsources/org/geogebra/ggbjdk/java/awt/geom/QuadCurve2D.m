...
- (id<OrgGeogebraGgbjdkJavaAwtGeomPathIterator>)getPathIteratorWithOrgGeogebraCommonAwtGAffineTransform:(id<OrgGeogebraCommonAwtGAffineTransform>)at {
  return new_OrgGeogebraGgbjdkJavaAwtGeomQuadIterator_initWithOrgGeogebraGgbjdkJavaAwtGeomQuadCurve2D_withOrgGeogebraCommonAwtGAffineTransform_(self, at);
}
...
- (OrgGeogebraGgbjdkJavaAwtGeomPoint2D *)getCtrlPt {
  return new_OrgGeogebraGgbjdkJavaAwtGeomPoint2D_Float_initWithFloat_withFloat_(ctrlx_, ctrly_);
}
...
void OrgGeogebraGgbjdkJavaAwtGeomQuadCurve2D_Float_init(OrgGeogebraGgbjdkJavaAwtGeomQuadCurve2D_Float *self) {
  (void) OrgGeogebraGgbjdkJavaAwtGeomQuadCurve2D_init(self);
}
...
- (OrgGeogebraGgbjdkJavaAwtGeomPoint2D *)getCtrlPt {
  return new_OrgGeogebraGgbjdkJavaAwtGeomPoint2D_Double_initWithDouble_withDouble_(ctrlx_, ctrly_);
}
