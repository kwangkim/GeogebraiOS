...
+ (void)initialize {
  if (self == [OrgGeogebraGgbjdkJavaAwtGeomGeneralPathIterator class]) {
    OrgGeogebraGgbjdkJavaAwtGeomGeneralPathIterator_curvesize_ = [IOSIntArray newArrayWithInts:(jint[]){ 2, 2, 4, 6, 0 } count:5];
...
void OrgGeogebraGgbjdkJavaAwtGeomGeneralPathIterator_initWithOrgGeogebraGgbjdkJavaAwtGeomGeneralPath_(OrgGeogebraGgbjdkJavaAwtGeomGeneralPathIterator *self, OrgGeogebraGgbjdkJavaAwtGeomGeneralPath *path) {
  (void) OrgGeogebraGgbjdkJavaAwtGeomGeneralPathIterator_initWithOrgGeogebraGgbjdkJavaAwtGeomGeneralPath_withOrgGeogebraCommonAwtGAffineTransform_(self, path, nil);
}
