...
- (id<OrgGeogebraGgbjdkJavaAwtGeomPathIterator>)getPathIteratorWithOrgGeogebraCommonAwtGAffineTransform:(id<OrgGeogebraCommonAwtGAffineTransform>)at {
  return [new_OrgGeogebraGgbjdkJavaAwtGeomLineIterator_initWithOrgGeogebraGgbjdkJavaAwtGeomLine2D_withOrgGeogebraCommonAwtGAffineTransform_(self, at) autorelease];
}
...
- (jboolean)intersectsWithDouble:(jdouble)x
                      ...
                      withDouble:(jdouble)w
                      withDouble:(jdouble)h {
  return [self intersectsWithOrgGeogebraCommonAwtGRectangle2D:[new_OrgGeogebraGgbjdkJavaAwtGeomRectangle2D_Double_initWithDouble_withDouble_withDouble_withDouble_(x, y, w, h) autorelease]];
}
...
- (OrgGeogebraGgbjdkJavaAwtGeomRectangle2D *)getBounds2D {
  ...
  return [new_OrgGeogebraGgbjdkJavaAwtGeomRectangle2D_Float_initWithFloat_withFloat_withFloat_withFloat_(x, y, w, h) autorelease];
}
