...
- (void)calculateBoundsWithIntArray:(IOSIntArray *)xpoints
  ...
  bounds_ = new_OrgGeogebraGgbjdkJavaAwtGeomRectangle_initWithInt_withInt_withInt_withInt_(boundsMinX, boundsMinY, boundsMaxX - boundsMinX, boundsMaxY - boundsMinY);
}
...
- (void)addPointWithInt:(jint)x
  ...
  if (npoints_ >= ((IOSIntArray *) nil_chk(xpoints_))->size_ || npoints_ >= ((IOSIntArray *) nil_chk(ypoints_))->size_) {
    ...
    xpoints_ = OrgGeogebraGgbjdkJavaAwtGeomPolygon_copyOfWithIntArray_withInt_(self, xpoints_, newLength);
    ypoints_ = OrgGeogebraGgbjdkJavaAwtGeomPolygon_copyOfWithIntArray_withInt_(self, ypoints_, newLength);
  }
...
- (id<OrgGeogebraGgbjdkJavaAwtGeomPathIterator>)getPathIteratorWithOrgGeogebraCommonAwtGAffineTransform:(id<OrgGeogebraCommonAwtGAffineTransform>)at {
  return new_OrgGeogebraGgbjdkJavaAwtGeomPolygon_PolygonPathIterator_initWithOrgGeogebraGgbjdkJavaAwtGeomPolygon_withOrgGeogebraGgbjdkJavaAwtGeomPolygon_withOrgGeogebraCommonAwtGAffineTransform_(self, self, at);
}
...
void OrgGeogebraGgbjdkJavaAwtGeomPolygon_init(OrgGeogebraGgbjdkJavaAwtGeomPolygon *self) {
  ...
  self->xpoints_ = [IOSIntArray newArrayWithLength:OrgGeogebraGgbjdkJavaAwtGeomPolygon_MIN_LENGTH];
  self->ypoints_ = [IOSIntArray newArrayWithLength:OrgGeogebraGgbjdkJavaAwtGeomPolygon_MIN_LENGTH];
}
...
void OrgGeogebraGgbjdkJavaAwtGeomPolygon_initWithIntArray_withIntArray_withInt_(OrgGeogebraGgbjdkJavaAwtGeomPolygon *self, IOSIntArray *xpoints, IOSIntArray *ypoints, jint npoints) {
  ...
  if (npoints > ((IOSIntArray *) nil_chk(xpoints))->size_ || npoints > ((IOSIntArray *) nil_chk(ypoints))->size_) {
    @throw new_JavaLangIndexOutOfBoundsException_initWithNSString_(@"npoints > xpoints.length || npoints > ypoints.length");
  }
  if (npoints < 0) {
    @throw new_JavaLangNegativeArraySizeException_initWithNSString_(@"npoints < 0");
  }
  self->npoints_ = npoints;
  self->xpoints_ = OrgGeogebraGgbjdkJavaAwtGeomPolygon_copyOfWithIntArray_withInt_(self, xpoints, npoints);
  self->ypoints_ = OrgGeogebraGgbjdkJavaAwtGeomPolygon_copyOfWithIntArray_withInt_(self, ypoints, npoints);
}
...
OrgGeogebraGgbjdkSunAwtGeomCrossings *OrgGeogebraGgbjdkJavaAwtGeomPolygon_getCrossingsWithDouble_withDouble_withDouble_withDouble_(OrgGeogebraGgbjdkJavaAwtGeomPolygon *self, jdouble xlo, jdouble ylo, jdouble xhi, jdouble yhi) {
  OrgGeogebraGgbjdkSunAwtGeomCrossings *cross = new_OrgGeogebraGgbjdkSunAwtGeomCrossings_EvenOdd_initWithDouble_withDouble_withDouble_withDouble_(xlo, ylo, xhi, yhi);
