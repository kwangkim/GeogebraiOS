...
- (jdouble)nextVerticalWithDouble:(jdouble)t0
  ...
  IOSDoubleArray *eqn = [IOSDoubleArray arrayWithDoubles:(jdouble[]){ xcoeff1_, 2 * xcoeff2_, 3 * xcoeff3_ } count:3];
...
- (OrgGeogebraGgbjdkSunAwtGeomCurve *)getSubCurveWithDouble:(jdouble)ystart
  ...
  IOSDoubleArray *eqn = [IOSDoubleArray arrayWithLength:14];
  jdouble t0, t1;
...
void OrgGeogebraGgbjdkSunAwtGeomOrder3_addInstanceWithJavaUtilVector_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withInt_(JavaUtilVector *curves, jdouble x0, jdouble y0, jdouble cx0, jdouble cy0, jdouble cx1, jdouble cy1, jdouble x1, jdouble y1, jint direction) {
  OrgGeogebraGgbjdkSunAwtGeomOrder3_initialize();
  if (y0 > y1) {
    [((JavaUtilVector *) nil_chk(curves)) addWithId:[new_OrgGeogebraGgbjdkSunAwtGeomOrder3_initWithDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withInt_(x1, y1, cx1, cy1, cx0, cy0, x0, y0, -direction) autorelease]];
  }
  else if (y1 > y0) {
    [((JavaUtilVector *) nil_chk(curves)) addWithId:[new_OrgGeogebraGgbjdkSunAwtGeomOrder3_initWithDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withInt_(x0, y0, cx0, cy0, cx1, cy1, x1, y1, direction) autorelease]];
  }
}
