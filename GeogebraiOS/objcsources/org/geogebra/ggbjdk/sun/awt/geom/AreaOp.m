...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/geogebra/ggbjdk/sun/awt/geom/AreaOp.java
//
...
- (JavaUtilVector *)calculateWithJavaUtilVector:(JavaUtilVector *)left
  ...
  JavaUtilVector *edges = [new_JavaUtilVector_init() autorelease];
...
+ (void)initialize {
  if (self == [OrgGeogebraGgbjdkSunAwtGeomAreaOp class]) {
    JreStrongAssignAndConsume(&OrgGeogebraGgbjdkSunAwtGeomAreaOp_YXTopComparator_, nil, new_OrgGeogebraGgbjdkSunAwtGeomAreaOp_$1_init());
    JreStrongAssignAndConsume(&OrgGeogebraGgbjdkSunAwtGeomAreaOp_EmptyLinkList_, nil, [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraGgbjdkSunAwtGeomCurveLink_class_()]);
    JreStrongAssignAndConsume(&OrgGeogebraGgbjdkSunAwtGeomAreaOp_EmptyChainList_, nil, [IOSObjectArray newArrayWithLength:2 type:OrgGeogebraGgbjdkSunAwtGeomChainEnd_class_()]);
...
void OrgGeogebraGgbjdkSunAwtGeomAreaOp_addEdgesWithJavaUtilVector_withJavaUtilVector_withInt_(JavaUtilVector *edges, JavaUtilVector *curves, jint curvetag) {
  ...
  while ([((id<JavaUtilEnumeration>) nil_chk(enum_)) hasMoreElements]) {
    ...
    if ([((OrgGeogebraGgbjdkSunAwtGeomCurve *) nil_chk(c)) getOrder] > 0) {
      [((JavaUtilVector *) nil_chk(edges)) addWithId:[new_OrgGeogebraGgbjdkSunAwtGeomEdge_initWithOrgGeogebraGgbjdkSunAwtGeomCurve_withInt_(c, curvetag) autorelease]];
    }
  }
}
...
JavaUtilVector *OrgGeogebraGgbjdkSunAwtGeomAreaOp_pruneEdgesWithJavaUtilVector_(OrgGeogebraGgbjdkSunAwtGeomAreaOp *self, JavaUtilVector *edges) {
  ...
  IOSObjectArray *edgelist = (IOSObjectArray *) check_class_cast([edges toArrayWithNSObjectArray:[IOSObjectArray arrayWithLength:numedges type:OrgGeogebraGgbjdkSunAwtGeomEdge_class_()]], [IOSObjectArray class]);
  ...
  jint cur = 0;
  jint next = 0;
  IOSDoubleArray *yrange = [IOSDoubleArray arrayWithLength:2];
  JavaUtilVector *subcurves = [new_JavaUtilVector_init() autorelease];
  JavaUtilVector *chains = [new_JavaUtilVector_init() autorelease];
  JavaUtilVector *links = [new_JavaUtilVector_init() autorelease];
  while (left < numedges) {
    ...
    for (cur = next = right - 1; cur >= left; cur--) {
      ...
      if ([((OrgGeogebraGgbjdkSunAwtGeomCurve *) nil_chk([((OrgGeogebraGgbjdkSunAwtGeomEdge *) nil_chk(e)) getCurve])) getYBot] > y) {
        if (next > cur) {
          IOSObjectArray_Set(edgelist, next, e);
        }
        next--;
      }
    }
    ...
    *IOSDoubleArray_GetRef(yrange, 1) = [((OrgGeogebraGgbjdkSunAwtGeomCurve *) nil_chk([((OrgGeogebraGgbjdkSunAwtGeomEdge *) nil_chk(IOSObjectArray_Get(nil_chk(edgelist), left))) getCurve])) getYBot];
    ...
    for (cur = left; cur < right; cur++) {
      ...
      for (next = cur; next > left; next--) {
        ...
        if (IOSDoubleArray_Get(yrange, 1) <= IOSDoubleArray_Get(yrange, 0)) {
          @throw [new_OrgGeogebraGgbjdkSunAwtGeomInternalError_initWithNSString_(JreStrcat("$D$D", @"backstepping to ", IOSDoubleArray_Get(yrange, 1), @" from ", IOSDoubleArray_Get(yrange, 0))) autorelease];
        }
        if (ordering >= 0) {
          if (ordering == 0) {
        ...
        IOSObjectArray_Set(edgelist, next, prevedge);
      }
      IOSObjectArray_Set(edgelist, next, e);
    }
    [self newRow];
    ...
    for (cur = left; cur < right; cur++) {
      ...
      if (etag != OrgGeogebraGgbjdkSunAwtGeomAreaOp_ETAG_IGNORE) {
        ...
        [links addWithId:[new_OrgGeogebraGgbjdkSunAwtGeomCurveLink_initWithOrgGeogebraGgbjdkSunAwtGeomCurve_withDouble_withDouble_withInt_([e getCurve], ystart, yend, etag) autorelease]];
      }
    }
  ...
  OrgGeogebraGgbjdkSunAwtGeomAreaOp_finalizeSubCurvesWithJavaUtilVector_withJavaUtilVector_(subcurves, chains);
  JavaUtilVector *ret = [new_JavaUtilVector_init() autorelease];
...
void OrgGeogebraGgbjdkSunAwtGeomAreaOp_finalizeSubCurvesWithJavaUtilVector_withJavaUtilVector_(JavaUtilVector *subcurves, JavaUtilVector *chains) {
  ...
  if ((numchains & 1) != 0) {
    @throw [new_OrgGeogebraGgbjdkSunAwtGeomInternalError_initWithNSString_(@"Odd number of chains!") autorelease];
  }
  IOSObjectArray *endlist = [IOSObjectArray arrayWithLength:numchains type:OrgGeogebraGgbjdkSunAwtGeomChainEnd_class_()];
  [chains toArrayWithNSObjectArray:endlist];
...
void OrgGeogebraGgbjdkSunAwtGeomAreaOp_resolveLinksWithJavaUtilVector_withJavaUtilVector_withJavaUtilVector_(JavaUtilVector *subcurves, JavaUtilVector *chains, JavaUtilVector *links) {
  ...
  if (numlinks == 0) {
    ...
    if ((numlinks & 1) != 0) {
      @throw [new_OrgGeogebraGgbjdkSunAwtGeomInternalError_initWithNSString_(@"Odd number of new curves!") autorelease];
    }
    linklist = [IOSObjectArray arrayWithLength:numlinks + 2 type:OrgGeogebraGgbjdkSunAwtGeomCurveLink_class_()];
    [links toArrayWithNSObjectArray:linklist];
  }
  jint numchains = [((JavaUtilVector *) nil_chk(chains)) size];
  ...
  if (numchains == 0) {
    ...
    endlist = [IOSObjectArray arrayWithLength:numchains + 2 type:OrgGeogebraGgbjdkSunAwtGeomChainEnd_class_()];
    [chains toArrayWithNSObjectArray:endlist];
  }
  jint curchain = 0;
  jint curlink = 0;
  ...
  while (chain != nil || link != nil) {
    ...
    if (connectlinks) {
      OrgGeogebraGgbjdkSunAwtGeomChainEnd *openend = [new_OrgGeogebraGgbjdkSunAwtGeomChainEnd_initWithOrgGeogebraGgbjdkSunAwtGeomCurveLink_withOrgGeogebraGgbjdkSunAwtGeomChainEnd_(link, nil) autorelease];
      OrgGeogebraGgbjdkSunAwtGeomChainEnd *closeend = [new_OrgGeogebraGgbjdkSunAwtGeomChainEnd_initWithOrgGeogebraGgbjdkSunAwtGeomCurveLink_withOrgGeogebraGgbjdkSunAwtGeomChainEnd_(nextlink, openend) autorelease];
