...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/ggbjdk/sun/awt/geom/Order2.java
//
...
- (OrgGeogebraGgbjdkSunAwtGeomCurve *)getSubCurveWithDouble:(jdouble)ystart
  ...
  IOSDoubleArray *eqn = [IOSDoubleArray newArrayWithLength:10];
  ...
  *IOSDoubleArray_GetRef(eqn, 5) = y1_;
  ...
  return new_OrgGeogebraGgbjdkSunAwtGeomOrder2_initWithDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withInt_(IOSDoubleArray_Get(eqn, i + 0), ystart, IOSDoubleArray_Get(eqn, i + 2), IOSDoubleArray_Get(eqn, i + 3), IOSDoubleArray_Get(eqn, i + 4), yend, dir);
}

- (OrgGeogebraGgbjdkSunAwtGeomCurve *)getReversedCurve {
  return new_OrgGeogebraGgbjdkSunAwtGeomOrder2_initWithDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withInt_(x0_, y0_, cx0_, cy0_, x1_, y1_, -direction_);
}
...
void OrgGeogebraGgbjdkSunAwtGeomOrder2_addInstanceWithJavaUtilVector_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withInt_(JavaUtilVector *curves, jdouble x0, jdouble y0, jdouble cx0, jdouble cy0, jdouble x1, jdouble y1, jint direction) {
  OrgGeogebraGgbjdkSunAwtGeomOrder2_initialize();
  if (y0 > y1) {
    [((JavaUtilVector *) nil_chk(curves)) addWithId:new_OrgGeogebraGgbjdkSunAwtGeomOrder2_initWithDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withInt_(x1, y1, cx0, cy0, x0, y0, -direction)];
  }
  else if (y1 > y0) {
    [((JavaUtilVector *) nil_chk(curves)) addWithId:new_OrgGeogebraGgbjdkSunAwtGeomOrder2_initWithDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withInt_(x0, y0, cx0, cy0, x1, y1, direction)];
  }
}
