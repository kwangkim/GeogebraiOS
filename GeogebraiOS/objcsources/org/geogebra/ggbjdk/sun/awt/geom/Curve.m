...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/geogebra/ggbjdk/sun/awt/geom/Curve.java
//
...
- (jint)compareToWithOrgGeogebraGgbjdkSunAwtGeomCurve:(OrgGeogebraGgbjdkSunAwtGeomCurve *)that
  ...
  if (y1 <= IOSDoubleArray_Get(yrange, 0)) {
    ...
    @throw new_OrgGeogebraGgbjdkSunAwtGeomInternalError_initWithNSString_(JreStrcat("$D$D", @"backstepping from ", IOSDoubleArray_Get(yrange, 0), @" to ", y1));
  }
...
- (jboolean)findIntersectWithOrgGeogebraGgbjdkSunAwtGeomCurve:(OrgGeogebraGgbjdkSunAwtGeomCurve *)that
  ...
  if (s1 - s0 > OrgGeogebraGgbjdkSunAwtGeomCurve_TMIN) {
    ...
    if (s == s0 || s == s1) {
      ...
      @throw new_OrgGeogebraGgbjdkSunAwtGeomInternalError_initWithNSString_(@"no s progress!");
    }
    if (t1 - t0 > OrgGeogebraGgbjdkSunAwtGeomCurve_TMIN) {
      ...
      if (t == t0 || t == t1) {
        ...
        @throw new_OrgGeogebraGgbjdkSunAwtGeomInternalError_initWithNSString_(@"no t progress!");
      }
      if (ys >= yt0 && yt >= ys0) {
...
void OrgGeogebraGgbjdkSunAwtGeomCurve_insertMoveWithJavaUtilVector_withDouble_withDouble_(JavaUtilVector *curves, jdouble x, jdouble y) {
  ...
  [((JavaUtilVector *) nil_chk(curves)) addWithId:new_OrgGeogebraGgbjdkSunAwtGeomOrder0_initWithDouble_withDouble_(x, y)];
}
...
void OrgGeogebraGgbjdkSunAwtGeomCurve_insertLineWithJavaUtilVector_withDouble_withDouble_withDouble_withDouble_(JavaUtilVector *curves, jdouble x0, jdouble y0, jdouble x1, jdouble y1) {
  OrgGeogebraGgbjdkSunAwtGeomCurve_initialize();
  if (y0 < y1) {
    [((JavaUtilVector *) nil_chk(curves)) addWithId:new_OrgGeogebraGgbjdkSunAwtGeomOrder1_initWithDouble_withDouble_withDouble_withDouble_withInt_(x0, y0, x1, y1, OrgGeogebraGgbjdkSunAwtGeomCurve_INCREASING)];
  }
  else if (y0 > y1) {
    [((JavaUtilVector *) nil_chk(curves)) addWithId:new_OrgGeogebraGgbjdkSunAwtGeomOrder1_initWithDouble_withDouble_withDouble_withDouble_withInt_(x1, y1, x0, y0, OrgGeogebraGgbjdkSunAwtGeomCurve_DECREASING)];
  }
  else {
  }
}
...
jlong OrgGeogebraGgbjdkSunAwtGeomCurve_signeddiffbitsWithDouble_withDouble_(jdouble y1, jdouble y2) {
  OrgGeogebraGgbjdkSunAwtGeomCurve_initialize();
  @throw new_OrgGeogebraGgbjdkSunAwtGeomNotImplementedException_initWithNSString_(@"not possible in GWT");
}
