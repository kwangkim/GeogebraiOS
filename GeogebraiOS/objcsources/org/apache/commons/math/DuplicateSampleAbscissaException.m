...
void OrgApacheCommonsMathDuplicateSampleAbscissaException_initWithDouble_withInt_withInt_(OrgApacheCommonsMathDuplicateSampleAbscissaException *self, jdouble abscissa, jint i1, jint i2) {
  (void) OrgApacheCommonsMathMathException_initWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(self, OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_DUPLICATED_ABSCISSA(), [IOSObjectArray newArrayWithObjects:(id[]){ JavaLangDouble_valueOfWithDouble_(abscissa), JavaLangInteger_valueOfWithInt_(i1), JavaLangInteger_valueOfWithInt_(i2) } count:3 type:NSObject_class_()]);
}
