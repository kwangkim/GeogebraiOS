...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/apache/commons/math/analysis/interpolation/SmoothingBicubicSplineInterpolator.java
//
...
- (id<OrgApacheCommonsMathAnalysisBivariateRealFunction>)interpolateWithDoubleArray:(IOSDoubleArray *)xval
  ...
  if (xval->size_ != ((IOSObjectArray *) nil_chk(zval))->size_) {
    @throw new_OrgApacheCommonsMathDimensionMismatchException_initWithInt_withInt_(xval->size_, zval->size_);
  }
  ...
  IOSObjectArray *zX = [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ yLen, xLen }];
  for (jint i = 0; i < xLen; i++) {
    if (((IOSDoubleArray *) nil_chk(IOSObjectArray_Get(zval, i)))->size_ != yLen) {
      @throw new_OrgApacheCommonsMathDimensionMismatchException_initWithInt_withInt_(((IOSDoubleArray *) nil_chk(IOSObjectArray_Get(zval, i)))->size_, yLen);
    }
  ...
  for (jint j = 0; j < yLen; j++) {
    (void) IOSObjectArray_Set(ySplineX, j, [spInterpolator interpolateWithDoubleArray:xval withDoubleArray:IOSObjectArray_Get(zX, j)]);
  }
  IOSObjectArray *zY_1 = [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ xLen, yLen }];
  for (jint j = 0; j < yLen; j++) {
  ...
  for (jint i = 0; i < xLen; i++) {
    (void) IOSObjectArray_Set(xSplineY, i, [spInterpolator interpolateWithDoubleArray:yval withDoubleArray:IOSObjectArray_Get(zY_1, i)]);
  }
  IOSObjectArray *zY_2 = [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ xLen, yLen }];
  for (jint i = 0; i < xLen; i++) {
  ...
  IOSObjectArray *dZdX = [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ xLen, yLen }];
  for (jint j = 0; j < yLen; j++) {
  ...
  IOSObjectArray *dZdY = [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ xLen, yLen }];
  for (jint i = 0; i < xLen; i++) {
  ...
  IOSObjectArray *dZdXdY = [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ xLen, yLen }];
  for (jint i = 0; i < xLen; i++) {
  ...
  return new_OrgApacheCommonsMathAnalysisInterpolationBicubicSplineInterpolatingFunction_initWithDoubleArray_withDoubleArray_withDoubleArray2_withDoubleArray2_withDoubleArray2_withDoubleArray2_(xval, yval, zY_2, dZdX, dZdY, dZdXdY);
}
