...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/apache/commons/math/analysis/interpolation/TricubicSplineInterpolator.java
//
...
- (OrgApacheCommonsMathAnalysisInterpolationTricubicSplineInterpolatingFunction *)interpolateWithDoubleArray:(IOSDoubleArray *)xval
  ...
  if (xval->size_ != ((IOSObjectArray *) nil_chk(fval))->size_) {
    @throw new_OrgApacheCommonsMathExceptionDimensionMismatchException_initWithInt_withInt_(xval->size_, fval->size_);
  }
  ...
  IOSObjectArray *fvalXY = [IOSDoubleArray newArrayWithDimensions:3 lengths:(jint[]){ zLen, xLen, yLen }];
  IOSObjectArray *fvalZX = [IOSDoubleArray newArrayWithDimensions:3 lengths:(jint[]){ yLen, zLen, xLen }];
  for (jint i = 0; i < xLen; i++) {
    if (((IOSObjectArray *) nil_chk(IOSObjectArray_Get(fval, i)))->size_ != yLen) {
      @throw new_OrgApacheCommonsMathExceptionDimensionMismatchException_initWithInt_withInt_(((IOSObjectArray *) nil_chk(IOSObjectArray_Get(fval, i)))->size_, yLen);
    }
    for (jint j = 0; j < yLen; j++) {
      if (((IOSDoubleArray *) nil_chk(IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(fval, i)), j)))->size_ != zLen) {
        @throw new_OrgApacheCommonsMathExceptionDimensionMismatchException_initWithInt_withInt_(((IOSDoubleArray *) nil_chk(IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(fval, i)), j)))->size_, zLen);
      }
  ...
  OrgApacheCommonsMathAnalysisInterpolationBicubicSplineInterpolator *bsi = new_OrgApacheCommonsMathAnalysisInterpolationBicubicSplineInterpolator_init();
  IOSObjectArray *xSplineYZ = [IOSObjectArray newArrayWithLength:xLen type:OrgApacheCommonsMathAnalysisInterpolationBicubicSplineInterpolatingFunction_class_()];
  for (jint i = 0; i < xLen; i++) {
    (void) IOSObjectArray_Set(xSplineYZ, i, [bsi interpolateWithDoubleArray:yval withDoubleArray:zval withDoubleArray2:IOSObjectArray_Get(fval, i)]);
  }
  IOSObjectArray *ySplineZX = [IOSObjectArray newArrayWithLength:yLen type:OrgApacheCommonsMathAnalysisInterpolationBicubicSplineInterpolatingFunction_class_()];
  for (jint j = 0; j < yLen; j++) {
    (void) IOSObjectArray_Set(ySplineZX, j, [bsi interpolateWithDoubleArray:zval withDoubleArray:xval withDoubleArray2:IOSObjectArray_Get(fvalZX, j)]);
  }
  IOSObjectArray *zSplineXY = [IOSObjectArray newArrayWithLength:zLen type:OrgApacheCommonsMathAnalysisInterpolationBicubicSplineInterpolatingFunction_class_()];
  for (jint k = 0; k < zLen; k++) {
    (void) IOSObjectArray_Set(zSplineXY, k, [bsi interpolateWithDoubleArray:xval withDoubleArray:yval withDoubleArray2:IOSObjectArray_Get(fvalXY, k)]);
  }
  IOSObjectArray *dFdX = [IOSDoubleArray newArrayWithDimensions:3 lengths:(jint[]){ xLen, yLen, zLen }];
  IOSObjectArray *dFdY = [IOSDoubleArray newArrayWithDimensions:3 lengths:(jint[]){ xLen, yLen, zLen }];
  IOSObjectArray *d2FdXdY = [IOSDoubleArray newArrayWithDimensions:3 lengths:(jint[]){ xLen, yLen, zLen }];
  for (jint k = 0; k < zLen; k++) {
  ...
  IOSObjectArray *dFdZ = [IOSDoubleArray newArrayWithDimensions:3 lengths:(jint[]){ xLen, yLen, zLen }];
  IOSObjectArray *d2FdYdZ = [IOSDoubleArray newArrayWithDimensions:3 lengths:(jint[]){ xLen, yLen, zLen }];
  for (jint i = 0; i < xLen; i++) {
  ...
  IOSObjectArray *d2FdZdX = [IOSDoubleArray newArrayWithDimensions:3 lengths:(jint[]){ xLen, yLen, zLen }];
  for (jint j = 0; j < yLen; j++) {
  ...
  IOSObjectArray *d3FdXdYdZ = [IOSDoubleArray newArrayWithDimensions:3 lengths:(jint[]){ xLen, yLen, zLen }];
  for (jint i = 0; i < xLen; i++) {
