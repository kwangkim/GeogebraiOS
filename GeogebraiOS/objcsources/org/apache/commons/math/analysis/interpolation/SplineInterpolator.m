...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/apache/commons/math/analysis/interpolation/SplineInterpolator.java
//
...
- (OrgApacheCommonsMathAnalysisPolynomialsPolynomialSplineFunction *)interpolateWithDoubleArray:(IOSDoubleArray *)x
  ...
  *IOSDoubleArray_GetRef(z, 0) = 0.0;
  ...
  IOSDoubleArray *b = [IOSDoubleArray newArrayWithLength:n];
  ...
  *IOSDoubleArray_GetRef(c, n) = 0.0;
  ...
  IOSObjectArray *polynomials = [IOSObjectArray newArrayWithLength:n type:OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction_class_()];
  IOSDoubleArray *coefficients = [IOSDoubleArray newArrayWithLength:4];
  for (jint i = 0; i < n; i++) {
    ...
    *IOSDoubleArray_GetRef(coefficients, 3) = IOSDoubleArray_Get(d, i);
    (void) IOSObjectArray_Set(polynomials, i, new_OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction_initWithDoubleArray_(coefficients));
  }
  return new_OrgApacheCommonsMathAnalysisPolynomialsPolynomialSplineFunction_initWithDoubleArray_withOrgApacheCommonsMathAnalysisPolynomialsPolynomialFunctionArray_(x, polynomials);
}
