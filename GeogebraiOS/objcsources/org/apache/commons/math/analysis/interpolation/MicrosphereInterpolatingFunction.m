...
- (jdouble)valueWithDoubleArray:(IOSDoubleArray *)point {
  id<OrgApacheCommonsMathLinearRealVector> p = [new_OrgApacheCommonsMathLinearArrayRealVector_initWithDoubleArray_(point) autorelease];
...
void OrgApacheCommonsMathAnalysisInterpolationMicrosphereInterpolatingFunction_initWithDoubleArray2_withDoubleArray_withInt_withInt_withOrgApacheCommonsMathRandomUnitSphereRandomVectorGenerator_(OrgApacheCommonsMathAnalysisInterpolationMicrosphereInterpolatingFunction *self, IOSObjectArray *xval, IOSDoubleArray *yval, jint brightnessExponent, jint microsphereElements, OrgApacheCommonsMathRandomUnitSphereRandomVectorGenerator *rand) {
  ...
  if (xval->size_ != ((IOSDoubleArray *) nil_chk(yval))->size_) {
    @throw [new_OrgApacheCommonsMathDimensionMismatchException_initWithInt_withInt_(xval->size_, yval->size_) autorelease];
  }
  self->dimension_ = ((IOSDoubleArray *) nil_chk(IOSObjectArray_Get(xval, 0)))->size_;
  self->brightnessExponent_ = brightnessExponent;
  OrgApacheCommonsMathAnalysisInterpolationMicrosphereInterpolatingFunction_setAndConsume_samples_(self, new_JavaUtilHashMap_initWithInt_(yval->size_));
  for (jint i = 0; i < xval->size_; ++i) {
    ...
    if (((IOSDoubleArray *) nil_chk(xvalI))->size_ != self->dimension_) {
      @throw [new_OrgApacheCommonsMathDimensionMismatchException_initWithInt_withInt_(xvalI->size_, self->dimension_) autorelease];
    }
    [self->samples_ putWithId:[new_OrgApacheCommonsMathLinearArrayRealVector_initWithDoubleArray_(xvalI) autorelease] withId:JavaLangDouble_valueOfWithDouble_(IOSDoubleArray_Get(yval, i))];
  }
  OrgApacheCommonsMathAnalysisInterpolationMicrosphereInterpolatingFunction_setAndConsume_microsphere_(self, new_JavaUtilArrayList_initWithInt_(microsphereElements));
  for (jint i = 0; i < microsphereElements; i++) {
    [self->microsphere_ addWithId:[new_OrgApacheCommonsMathAnalysisInterpolationMicrosphereInterpolatingFunction_MicrosphereSurfaceElement_initWithDoubleArray_([((OrgApacheCommonsMathRandomUnitSphereRandomVectorGenerator *) nil_chk(rand)) nextVector]) autorelease]];
  }
}
...
- (void)reset {
  ...
  OrgApacheCommonsMathAnalysisInterpolationMicrosphereInterpolatingFunction_MicrosphereSurfaceElement_set_brightestSample_(self, nil);
}
...
- (void)storeWithDouble:(jdouble)illuminationFromSample
  ...
  if (illuminationFromSample > self->brightestIllumination_) {
    ...
    OrgApacheCommonsMathAnalysisInterpolationMicrosphereInterpolatingFunction_MicrosphereSurfaceElement_set_brightestSample_(self, sample);
  }
}
...
void OrgApacheCommonsMathAnalysisInterpolationMicrosphereInterpolatingFunction_MicrosphereSurfaceElement_initWithDoubleArray_(OrgApacheCommonsMathAnalysisInterpolationMicrosphereInterpolatingFunction_MicrosphereSurfaceElement *self, IOSDoubleArray *n) {
  NSObject_init(self);
  OrgApacheCommonsMathAnalysisInterpolationMicrosphereInterpolatingFunction_MicrosphereSurfaceElement_setAndConsume_normal__(self, new_OrgApacheCommonsMathLinearArrayRealVector_initWithDoubleArray_(n));
}
