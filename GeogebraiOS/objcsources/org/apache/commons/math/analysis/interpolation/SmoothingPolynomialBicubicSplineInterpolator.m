...
- (OrgApacheCommonsMathAnalysisInterpolationBicubicSplineInterpolatingFunction *)interpolateWithDoubleArray:(IOSDoubleArray *)xval
  ...
  for (jint i = 0; i < xLen; i++) {
    if (((IOSDoubleArray *) nil_chk(IOSObjectArray_Get(fval, i)))->size_ != yLen) {
      @throw new_OrgApacheCommonsMathExceptionDimensionMismatchException_initWithInt_withInt_(((IOSDoubleArray *) nil_chk(IOSObjectArray_Get(fval, i)))->size_, yLen);
    }
  }
  ...
  IOSObjectArray *yPolyX = [IOSObjectArray newArrayWithLength:yLen type:OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction_class_()];
  for (jint j = 0; j < yLen; j++) {
    ...
    (void) IOSObjectArray_Set(yPolyX, j, [xFitter_ fit]);
  }
  IOSObjectArray *fval_1 = [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ xLen, yLen }];
  for (jint j = 0; j < yLen; j++) {
  ...
  IOSObjectArray *xPolyY = [IOSObjectArray newArrayWithLength:xLen type:OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction_class_()];
  for (jint i = 0; i < xLen; i++) {
    ...
    (void) IOSObjectArray_Set(xPolyY, i, [yFitter_ fit]);
  }
  IOSObjectArray *fval_2 = [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ xLen, yLen }];
  for (jint i = 0; i < xLen; i++) {
...
void OrgApacheCommonsMathAnalysisInterpolationSmoothingPolynomialBicubicSplineInterpolator_init(OrgApacheCommonsMathAnalysisInterpolationSmoothingPolynomialBicubicSplineInterpolator *self) {
  (void) OrgApacheCommonsMathAnalysisInterpolationSmoothingPolynomialBicubicSplineInterpolator_initWithInt_(self, 3);
}
...
void OrgApacheCommonsMathAnalysisInterpolationSmoothingPolynomialBicubicSplineInterpolator_initWithInt_(OrgApacheCommonsMathAnalysisInterpolationSmoothingPolynomialBicubicSplineInterpolator *self, jint degree) {
  (void) OrgApacheCommonsMathAnalysisInterpolationSmoothingPolynomialBicubicSplineInterpolator_initWithInt_withInt_(self, degree, degree);
}
...
void OrgApacheCommonsMathAnalysisInterpolationSmoothingPolynomialBicubicSplineInterpolator_initWithInt_withInt_(OrgApacheCommonsMathAnalysisInterpolationSmoothingPolynomialBicubicSplineInterpolator *self, jint xDegree, jint yDegree) {
  (void) OrgApacheCommonsMathAnalysisInterpolationBicubicSplineInterpolator_init(self);
  self->xFitter_ = new_OrgApacheCommonsMathOptimizationFittingPolynomialFitter_initWithInt_withOrgApacheCommonsMathOptimizationDifferentiableMultivariateVectorialOptimizer_(xDegree, new_OrgApacheCommonsMathOptimizationGeneralGaussNewtonOptimizer_initWithBoolean_(NO));
  self->yFitter_ = new_OrgApacheCommonsMathOptimizationFittingPolynomialFitter_initWithInt_withOrgApacheCommonsMathOptimizationDifferentiableMultivariateVectorialOptimizer_(yDegree, new_OrgApacheCommonsMathOptimizationGeneralGaussNewtonOptimizer_initWithBoolean_(NO));
}
