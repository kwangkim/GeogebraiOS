...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/apache/commons/math/analysis/integration/LegendreGaussIntegrator.java
//
...
+ (void)initialize {
  if (self == [OrgApacheCommonsMathAnalysisIntegrationLegendreGaussIntegrator class]) {
    OrgApacheCommonsMathAnalysisIntegrationLegendreGaussIntegrator_ABSCISSAS_2_ = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ -1.0 / OrgApacheCommonsMathUtilFastMath_sqrtWithDouble_(3.0), 1.0 / OrgApacheCommonsMathUtilFastMath_sqrtWithDouble_(3.0) } count:2];
    OrgApacheCommonsMathAnalysisIntegrationLegendreGaussIntegrator_WEIGHTS_2_ = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 1.0, 1.0 } count:2];
    OrgApacheCommonsMathAnalysisIntegrationLegendreGaussIntegrator_ABSCISSAS_3_ = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ -OrgApacheCommonsMathUtilFastMath_sqrtWithDouble_(0.6), 0.0, OrgApacheCommonsMathUtilFastMath_sqrtWithDouble_(0.6) } count:3];
    OrgApacheCommonsMathAnalysisIntegrationLegendreGaussIntegrator_WEIGHTS_3_ = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 5.0 / 9.0, 8.0 / 9.0, 5.0 / 9.0 } count:3];
    OrgApacheCommonsMathAnalysisIntegrationLegendreGaussIntegrator_ABSCISSAS_4_ = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ -OrgApacheCommonsMathUtilFastMath_sqrtWithDouble_((15.0 + 2.0 * OrgApacheCommonsMathUtilFastMath_sqrtWithDouble_(30.0)) / 35.0), -OrgApacheCommonsMathUtilFastMath_sqrtWithDouble_((15.0 - 2.0 * OrgApacheCommonsMathUtilFastMath_sqrtWithDouble_(30.0)) / 35.0), OrgApacheCommonsMathUtilFastMath_sqrtWithDouble_((15.0 - 2.0 * OrgApacheCommonsMathUtilFastMath_sqrtWithDouble_(30.0)) / 35.0), OrgApacheCommonsMathUtilFastMath_sqrtWithDouble_((15.0 + 2.0 * OrgApacheCommonsMathUtilFastMath_sqrtWithDouble_(30.0)) / 35.0) } count:4];
    OrgApacheCommonsMathAnalysisIntegrationLegendreGaussIntegrator_WEIGHTS_4_ = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ (90.0 - 5.0 * OrgApacheCommonsMathUtilFastMath_sqrtWithDouble_(30.0)) / 180.0, (90.0 + 5.0 * OrgApacheCommonsMathUtilFastMath_sqrtWithDouble_(30.0)) / 180.0, (90.0 + 5.0 * OrgApacheCommonsMathUtilFastMath_sqrtWithDouble_(30.0)) / 180.0, (90.0 - 5.0 * OrgApacheCommonsMathUtilFastMath_sqrtWithDouble_(30.0)) / 180.0 } count:4];
    OrgApacheCommonsMathAnalysisIntegrationLegendreGaussIntegrator_ABSCISSAS_5_ = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ -OrgApacheCommonsMathUtilFastMath_sqrtWithDouble_((35.0 + 2.0 * OrgApacheCommonsMathUtilFastMath_sqrtWithDouble_(70.0)) / 63.0), -OrgApacheCommonsMathUtilFastMath_sqrtWithDouble_((35.0 - 2.0 * OrgApacheCommonsMathUtilFastMath_sqrtWithDouble_(70.0)) / 63.0), 0.0, OrgApacheCommonsMathUtilFastMath_sqrtWithDouble_((35.0 - 2.0 * OrgApacheCommonsMathUtilFastMath_sqrtWithDouble_(70.0)) / 63.0), OrgApacheCommonsMathUtilFastMath_sqrtWithDouble_((35.0 + 2.0 * OrgApacheCommonsMathUtilFastMath_sqrtWithDouble_(70.0)) / 63.0) } count:5];
    OrgApacheCommonsMathAnalysisIntegrationLegendreGaussIntegrator_WEIGHTS_5_ = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ (322.0 - 13.0 * OrgApacheCommonsMathUtilFastMath_sqrtWithDouble_(70.0)) / 900.0, (322.0 + 13.0 * OrgApacheCommonsMathUtilFastMath_sqrtWithDouble_(70.0)) / 900.0, 128.0 / 225.0, (322.0 + 13.0 * OrgApacheCommonsMathUtilFastMath_sqrtWithDouble_(70.0)) / 900.0, (322.0 - 13.0 * OrgApacheCommonsMathUtilFastMath_sqrtWithDouble_(70.0)) / 900.0 } count:5];
...
void OrgApacheCommonsMathAnalysisIntegrationLegendreGaussIntegrator_initWithInt_withInt_(OrgApacheCommonsMathAnalysisIntegrationLegendreGaussIntegrator *self, jint n, jint defaultMaximalIterationCount) {
  (void) OrgApacheCommonsMathAnalysisIntegrationUnivariateRealIntegratorImpl_initWithInt_(self, defaultMaximalIterationCount);
  switch (n) {
    case 2:
    self->abscissas_ = OrgApacheCommonsMathAnalysisIntegrationLegendreGaussIntegrator_ABSCISSAS_2_;
    self->weights_ = OrgApacheCommonsMathAnalysisIntegrationLegendreGaussIntegrator_WEIGHTS_2_;
    break;
    case 3:
    self->abscissas_ = OrgApacheCommonsMathAnalysisIntegrationLegendreGaussIntegrator_ABSCISSAS_3_;
    self->weights_ = OrgApacheCommonsMathAnalysisIntegrationLegendreGaussIntegrator_WEIGHTS_3_;
    break;
    case 4:
    self->abscissas_ = OrgApacheCommonsMathAnalysisIntegrationLegendreGaussIntegrator_ABSCISSAS_4_;
    self->weights_ = OrgApacheCommonsMathAnalysisIntegrationLegendreGaussIntegrator_WEIGHTS_4_;
    break;
    case 5:
    self->abscissas_ = OrgApacheCommonsMathAnalysisIntegrationLegendreGaussIntegrator_ABSCISSAS_5_;
    self->weights_ = OrgApacheCommonsMathAnalysisIntegrationLegendreGaussIntegrator_WEIGHTS_5_;
    break;
    default:
