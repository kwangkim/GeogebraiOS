...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/apache/commons/math/analysis/polynomials/PolynomialFunction.java
//
...
- (OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction *)addWithOrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction:(OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction *)p {
  ...
  IOSDoubleArray *newCoefficients = [IOSDoubleArray newArrayWithLength:highLength];
  ...
  return new_OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction_initWithDoubleArray_(newCoefficients);
}
...
- (OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction *)negate {
  IOSDoubleArray *newCoefficients = [IOSDoubleArray newArrayWithLength:((IOSDoubleArray *) nil_chk(coefficients_))->size_];
...
- (OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction *)multiplyWithOrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction:(OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction *)p {
  IOSDoubleArray *newCoefficients = [IOSDoubleArray newArrayWithLength:((IOSDoubleArray *) nil_chk(coefficients_))->size_ + ((OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction *) nil_chk(p))->coefficients_->size_ - 1];
...
- (OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction *)polynomialDerivative {
  return new_OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction_initWithDoubleArray_(OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction_differentiateWithDoubleArray_(coefficients_));
}
...
- (NSString *)description {
  ...
  if (IOSDoubleArray_Get(nil_chk(coefficients_), 0) == 0.0) {
    ...
    (void) [s appendWithNSString:JavaLangDouble_toStringWithDouble_(IOSDoubleArray_Get(coefficients_, 0))];
  }
  for (jint i = 1; i < coefficients_->size_; ++i) {
    if (IOSDoubleArray_Get(coefficients_, i) != 0) {
      ...
      if ((absAi - 1) != 0) {
        (void) [s appendWithNSString:JavaLangDouble_toStringWithDouble_(absAi)];
        (void) [s appendWithChar:' '];
      }
      (void) [s appendWithNSString:@"x"];
      if (i > 1) {
        (void) [s appendWithChar:'^'];
        (void) [s appendWithNSString:JavaLangInteger_toStringWithInt_(i)];
      }
    }
  }
...
void OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction_initWithDoubleArray_(OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction *self, IOSDoubleArray *c) {
  ...
  if (n == 0) {
    @throw new_OrgApacheCommonsMathExceptionNoDataException_initWithOrgApacheCommonsMathExceptionUtilLocalizable_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_EMPTY_POLYNOMIALS_COEFFICIENTS_ARRAY());
  }
  while ((n > 1) && (IOSDoubleArray_Get(c, n - 1) == 0)) {
    --n;
  }
  self->coefficients_ = [IOSDoubleArray newArrayWithLength:n];
...
IOSDoubleArray *OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction_differentiateWithDoubleArray_(IOSDoubleArray *coefficients) {
  ...
  if (n == 1) {
    return [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 0 } count:1];
  }
  IOSDoubleArray *result = [IOSDoubleArray newArrayWithLength:n - 1];
