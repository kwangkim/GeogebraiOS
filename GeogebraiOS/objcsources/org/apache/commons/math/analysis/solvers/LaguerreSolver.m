...
- (OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction *)getPolynomialFunction {
  return new_OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction_initWithDoubleArray_([((OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction *) nil_chk(p_)) getCoefficients]);
}
...
- (jdouble)solveWithOrgApacheCommonsMathAnalysisUnivariateRealFunction:(id<OrgApacheCommonsMathAnalysisUnivariateRealFunction>)f
  ...
  if (!([f isKindOfClass:[OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction class]])) {
    @throw OrgApacheCommonsMathMathRuntimeException_createIllegalArgumentExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_FUNCTION_NOT_POLYNOMIAL(), [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
  }
  if ([((id<OrgApacheCommonsMathAnalysisUnivariateRealFunction>) nil_chk(f)) valueWithDouble:min] == 0.0) {
    return min;
  }
  ...
  IOSObjectArray *c = [IOSObjectArray newArrayWithLength:((IOSDoubleArray *) nil_chk(coefficients))->size_ type:OrgApacheCommonsMathComplexComplex_class_()];
  for (jint i = 0; i < coefficients->size_; i++) {
    (void) IOSObjectArray_Set(c, i, new_OrgApacheCommonsMathComplexComplex_initWithDouble_withDouble_(IOSDoubleArray_Get(coefficients, i), 0.0));
  }
  OrgApacheCommonsMathComplexComplex *initial = new_OrgApacheCommonsMathComplexComplex_initWithDouble_withDouble_(0.5 * (min + max), 0.0);
  ...
  @throw new_OrgApacheCommonsMathConvergenceException_init();
}
...
- (IOSObjectArray *)solveAllWithDoubleArray:(IOSDoubleArray *)coefficients
                                 withDouble:(jdouble)initial {
  IOSObjectArray *c = [IOSObjectArray newArrayWithLength:((IOSDoubleArray *) nil_chk(coefficients))->size_ type:OrgApacheCommonsMathComplexComplex_class_()];
  OrgApacheCommonsMathComplexComplex *z = new_OrgApacheCommonsMathComplexComplex_initWithDouble_withDouble_(initial, 0.0);
...
- (IOSObjectArray *)solveAllWithOrgApacheCommonsMathComplexComplexArray:(IOSObjectArray *)coefficients
  ...
  IOSObjectArray *c = [IOSObjectArray newArrayWithLength:n + 1 type:OrgApacheCommonsMathComplexComplex_class_()];
  for (jint i = 0; i <= n; i++) {
    (void) IOSObjectArray_Set(c, i, IOSObjectArray_Get(coefficients, i));
  }
  IOSObjectArray *root = [IOSObjectArray newArrayWithLength:n type:OrgApacheCommonsMathComplexComplex_class_()];
  for (jint i = 0; i < n; i++) {
    IOSObjectArray *subarray = [IOSObjectArray newArrayWithLength:n - i + 1 type:OrgApacheCommonsMathComplexComplex_class_()];
    JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(c, 0, subarray, 0, subarray->size_);
    (void) IOSObjectArray_Set(root, i, [self solveWithOrgApacheCommonsMathComplexComplexArray:subarray withOrgApacheCommonsMathComplexComplex:initial]);
    ...
    for (jint j = n - i - 1; j >= 0; j--) {
      ...
      (void) IOSObjectArray_Set(c, j, newc);
...
- (OrgApacheCommonsMathComplexComplex *)solveWithOrgApacheCommonsMathComplexComplexArray:(IOSObjectArray *)coefficients
  ...
  OrgApacheCommonsMathComplexComplex *N = new_OrgApacheCommonsMathComplexComplex_initWithDouble_withDouble_(n, 0.0);
  OrgApacheCommonsMathComplexComplex *N1 = new_OrgApacheCommonsMathComplexComplex_initWithDouble_withDouble_(n - 1, 0.0);
  jint i = 1;
  ...
  OrgApacheCommonsMathComplexComplex *oldz = new_OrgApacheCommonsMathComplexComplex_initWithDouble_withDouble_(JavaLangDouble_POSITIVE_INFINITY, JavaLangDouble_POSITIVE_INFINITY);
  while (i <= maximalIterationCount_) {
    ...
    d2v = [((OrgApacheCommonsMathComplexComplex *) nil_chk(d2v)) multiplyWithId:new_OrgApacheCommonsMathComplexComplex_initWithDouble_withDouble_(2.0, 0.0)];
    jdouble tolerance = OrgApacheCommonsMathUtilFastMath_maxWithDouble_withDouble_(relativeAccuracy_ * [((OrgApacheCommonsMathComplexComplex *) nil_chk(z)) abs], absoluteAccuracy_);
    ...
    if ([denominator isEqual:new_OrgApacheCommonsMathComplexComplex_initWithDouble_withDouble_(0.0, 0.0)]) {
      z = [z addWithId:new_OrgApacheCommonsMathComplexComplex_initWithDouble_withDouble_(absoluteAccuracy_, absoluteAccuracy_)];
      oldz = new_OrgApacheCommonsMathComplexComplex_initWithDouble_withDouble_(JavaLangDouble_POSITIVE_INFINITY, JavaLangDouble_POSITIVE_INFINITY);
    }
    else {
      oldz = z;
...
void OrgApacheCommonsMathAnalysisSolversLaguerreSolver_initWithOrgApacheCommonsMathAnalysisUnivariateRealFunction_(OrgApacheCommonsMathAnalysisSolversLaguerreSolver *self, id<OrgApacheCommonsMathAnalysisUnivariateRealFunction> f) {
  ...
  if ([f isKindOfClass:[OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction class]]) {
    self->p_ = (OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction *) check_class_cast(f, [OrgApacheCommonsMathAnalysisPolynomialsPolynomialFunction class]);
  }
  else {
    @throw OrgApacheCommonsMathMathRuntimeException_createIllegalArgumentExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_FUNCTION_NOT_POLYNOMIAL(), [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
  }
