...
- (JavaLangStringBuffer *)formatWithOrgApacheCommonsMathFractionBigFraction:(OrgApacheCommonsMathFractionBigFraction *)fraction
  ...
  if (![((JavaMathBigInteger *) nil_chk(JavaMathBigInteger_get_ZERO_())) isEqual:whole]) {
    (void) [((JavaTextNumberFormat *) nil_chk([self getWholeFormat])) formatWithId:whole withJavaLangStringBuffer:toAppendTo withJavaTextFieldPosition:pos];
  ...
  (void) [((JavaTextNumberFormat *) nil_chk([self getNumeratorFormat])) formatWithId:num withJavaLangStringBuffer:toAppendTo withJavaTextFieldPosition:pos];
  (void) [((JavaLangStringBuffer *) nil_chk(toAppendTo)) appendWithNSString:@" / "];
  (void) [((JavaTextNumberFormat *) nil_chk([self getDenominatorFormat])) formatWithId:den withJavaLangStringBuffer:toAppendTo withJavaTextFieldPosition:pos];
  return toAppendTo;
}
...
void OrgApacheCommonsMathFractionProperBigFractionFormat_init(OrgApacheCommonsMathFractionProperBigFractionFormat *self) {
  (void) OrgApacheCommonsMathFractionProperBigFractionFormat_initWithJavaTextNumberFormat_(self, OrgApacheCommonsMathFractionAbstractFormat_getDefaultNumberFormat());
}
...
void OrgApacheCommonsMathFractionProperBigFractionFormat_initWithJavaTextNumberFormat_withJavaTextNumberFormat_withJavaTextNumberFormat_(OrgApacheCommonsMathFractionProperBigFractionFormat *self, JavaTextNumberFormat *wholeFormat, JavaTextNumberFormat *numeratorFormat, JavaTextNumberFormat *denominatorFormat) {
  (void) OrgApacheCommonsMathFractionBigFractionFormat_initWithJavaTextNumberFormat_withJavaTextNumberFormat_(self, numeratorFormat, denominatorFormat);
