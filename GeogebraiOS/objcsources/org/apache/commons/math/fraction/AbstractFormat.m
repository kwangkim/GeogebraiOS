...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/apache/commons/math/fraction/AbstractFormat.java
//
...
- (void)setDenominatorFormatWithJavaTextNumberFormat:(JavaTextNumberFormat *)format {
  if (format == nil) {
    @throw new_OrgApacheCommonsMathExceptionNullArgumentException_initWithOrgApacheCommonsMathExceptionUtilLocalizable_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_DENOMINATOR_FORMAT());
  }
  self->denominatorFormat_ = format;
}

- (void)setNumeratorFormatWithJavaTextNumberFormat:(JavaTextNumberFormat *)format {
  if (format == nil) {
    @throw new_OrgApacheCommonsMathExceptionNullArgumentException_initWithOrgApacheCommonsMathExceptionUtilLocalizable_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_NUMERATOR_FORMAT());
  }
  self->numeratorFormat_ = format;
}
...
void OrgApacheCommonsMathFractionAbstractFormat_init(OrgApacheCommonsMathFractionAbstractFormat *self) {
  (void) OrgApacheCommonsMathFractionAbstractFormat_initWithJavaTextNumberFormat_(self, OrgApacheCommonsMathFractionAbstractFormat_getDefaultNumberFormat());
}
...
void OrgApacheCommonsMathFractionAbstractFormat_initWithJavaTextNumberFormat_(OrgApacheCommonsMathFractionAbstractFormat *self, JavaTextNumberFormat *format) {
  (void) OrgApacheCommonsMathFractionAbstractFormat_initWithJavaTextNumberFormat_withJavaTextNumberFormat_(self, format, (JavaTextNumberFormat *) check_class_cast([((JavaTextNumberFormat *) nil_chk(format)) clone], [JavaTextNumberFormat class]));
}
...
void OrgApacheCommonsMathFractionAbstractFormat_initWithJavaTextNumberFormat_withJavaTextNumberFormat_(OrgApacheCommonsMathFractionAbstractFormat *self, JavaTextNumberFormat *numeratorFormat, JavaTextNumberFormat *denominatorFormat) {
  (void) JavaTextNumberFormat_init(self);
  self->numeratorFormat_ = numeratorFormat;
  self->denominatorFormat_ = denominatorFormat;
}
