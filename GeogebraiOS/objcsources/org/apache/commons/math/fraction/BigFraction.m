...
- (OrgApacheCommonsMathFractionBigFraction *)addWithJavaMathBigInteger:(JavaMathBigInteger *)bg {
  return new_OrgApacheCommonsMathFractionBigFraction_initWithJavaMathBigInteger_withJavaMathBigInteger_([((JavaMathBigInteger *) nil_chk(numerator_)) addWithJavaMathBigInteger:[((JavaMathBigInteger *) nil_chk(denominator_)) multiplyWithJavaMathBigInteger:bg]], denominator_);
}
...
- (OrgApacheCommonsMathFractionBigFraction *)addWithId:(OrgApacheCommonsMathFractionBigFraction *)fraction {
  if (fraction == nil) {
    @throw new_JavaLangNullPointerException_initWithNSString_([((OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum *) nil_chk(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_FRACTION())) getSourceString]);
  }
...
- (JavaMathBigDecimal *)bigDecimalValue {
  return [new_JavaMathBigDecimal_initWithJavaMathBigInteger_(numerator_) divideWithJavaMathBigDecimal:new_JavaMathBigDecimal_initWithJavaMathBigInteger_(denominator_)];
}

- (JavaMathBigDecimal *)bigDecimalValueWithInt:(jint)roundingMode {
  return [new_JavaMathBigDecimal_initWithJavaMathBigInteger_(numerator_) divideWithJavaMathBigDecimal:new_JavaMathBigDecimal_initWithJavaMathBigInteger_(denominator_) withInt:roundingMode];
}

- (JavaMathBigDecimal *)bigDecimalValueWithInt:(jint)scale_
                                       withInt:(jint)roundingMode {
  return [new_JavaMathBigDecimal_initWithJavaMathBigInteger_(numerator_) divideWithJavaMathBigDecimal:new_JavaMathBigDecimal_initWithJavaMathBigInteger_(denominator_) withInt:scale_ withInt:roundingMode];
}

- (jint)compareToWithId:(OrgApacheCommonsMathFractionBigFraction *)object {
  (void) check_class_cast(object, [OrgApacheCommonsMathFractionBigFraction class]);
...
- (OrgApacheCommonsMathFractionBigFraction *)divideWithJavaMathBigInteger:(JavaMathBigInteger *)bg {
  if ([((JavaMathBigInteger *) nil_chk(JavaMathBigInteger_get_ZERO_())) isEqual:bg]) {
    @throw OrgApacheCommonsMathMathRuntimeException_createArithmeticExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_ZERO_DENOMINATOR(), [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
  }
  return new_OrgApacheCommonsMathFractionBigFraction_initWithJavaMathBigInteger_withJavaMathBigInteger_(numerator_, [((JavaMathBigInteger *) nil_chk(denominator_)) multiplyWithJavaMathBigInteger:bg]);
}
...
- (OrgApacheCommonsMathFractionBigFraction *)multiplyWithJavaMathBigInteger:(JavaMathBigInteger *)bg {
  ...
  return new_OrgApacheCommonsMathFractionBigFraction_initWithJavaMathBigInteger_withJavaMathBigInteger_([((JavaMathBigInteger *) nil_chk(bg)) multiplyWithJavaMathBigInteger:numerator_], denominator_);
}
...
- (OrgApacheCommonsMathFractionBigFraction *)powWithInt:(jint)exponent {
  if (exponent < 0) {
    return new_OrgApacheCommonsMathFractionBigFraction_initWithJavaMathBigInteger_withJavaMathBigInteger_([((JavaMathBigInteger *) nil_chk(denominator_)) powWithInt:-exponent], [((JavaMathBigInteger *) nil_chk(numerator_)) powWithInt:-exponent]);
  }
  return new_OrgApacheCommonsMathFractionBigFraction_initWithJavaMathBigInteger_withJavaMathBigInteger_([((JavaMathBigInteger *) nil_chk(numerator_)) powWithInt:exponent], [((JavaMathBigInteger *) nil_chk(denominator_)) powWithInt:exponent]);
}

- (OrgApacheCommonsMathFractionBigFraction *)powWithLong:(jlong)exponent {
  if (exponent < 0) {
    return new_OrgApacheCommonsMathFractionBigFraction_initWithJavaMathBigInteger_withJavaMathBigInteger_(OrgApacheCommonsMathUtilMathUtils_powWithJavaMathBigInteger_withLong_(denominator_, -exponent), OrgApacheCommonsMathUtilMathUtils_powWithJavaMathBigInteger_withLong_(numerator_, -exponent));
  }
  return new_OrgApacheCommonsMathFractionBigFraction_initWithJavaMathBigInteger_withJavaMathBigInteger_(OrgApacheCommonsMathUtilMathUtils_powWithJavaMathBigInteger_withLong_(numerator_, exponent), OrgApacheCommonsMathUtilMathUtils_powWithJavaMathBigInteger_withLong_(denominator_, exponent));
}
...
- (OrgApacheCommonsMathFractionBigFraction *)reciprocal {
  return new_OrgApacheCommonsMathFractionBigFraction_initWithJavaMathBigInteger_withJavaMathBigInteger_(denominator_, numerator_);
}
...
- (OrgApacheCommonsMathFractionBigFraction *)reduce {
  ...
  return new_OrgApacheCommonsMathFractionBigFraction_initWithJavaMathBigInteger_withJavaMathBigInteger_([numerator_ divideWithJavaMathBigInteger:gcd], [((JavaMathBigInteger *) nil_chk(denominator_)) divideWithJavaMathBigInteger:gcd]);
}
...
- (OrgApacheCommonsMathFractionBigFraction *)subtractWithJavaMathBigInteger:(JavaMathBigInteger *)bg {
  ...
  return new_OrgApacheCommonsMathFractionBigFraction_initWithJavaMathBigInteger_withJavaMathBigInteger_([((JavaMathBigInteger *) nil_chk(numerator_)) subtractWithJavaMathBigInteger:[((JavaMathBigInteger *) nil_chk(denominator_)) multiplyWithJavaMathBigInteger:bg]], denominator_);
}
...
+ (void)initialize {
  if (self == [OrgApacheCommonsMathFractionBigFraction class]) {
    OrgApacheCommonsMathFractionBigFraction_TWO_ = new_OrgApacheCommonsMathFractionBigFraction_initWithInt_(2);
    OrgApacheCommonsMathFractionBigFraction_ONE_ = new_OrgApacheCommonsMathFractionBigFraction_initWithInt_(1);
    OrgApacheCommonsMathFractionBigFraction_ZERO_ = new_OrgApacheCommonsMathFractionBigFraction_initWithInt_(0);
    OrgApacheCommonsMathFractionBigFraction_MINUS_ONE_ = new_OrgApacheCommonsMathFractionBigFraction_initWithInt_(-1);
    OrgApacheCommonsMathFractionBigFraction_FOUR_FIFTHS_ = new_OrgApacheCommonsMathFractionBigFraction_initWithInt_withInt_(4, 5);
    OrgApacheCommonsMathFractionBigFraction_ONE_FIFTH_ = new_OrgApacheCommonsMathFractionBigFraction_initWithInt_withInt_(1, 5);
    OrgApacheCommonsMathFractionBigFraction_ONE_HALF_ = new_OrgApacheCommonsMathFractionBigFraction_initWithInt_withInt_(1, 2);
    OrgApacheCommonsMathFractionBigFraction_ONE_QUARTER_ = new_OrgApacheCommonsMathFractionBigFraction_initWithInt_withInt_(1, 4);
    OrgApacheCommonsMathFractionBigFraction_ONE_THIRD_ = new_OrgApacheCommonsMathFractionBigFraction_initWithInt_withInt_(1, 3);
    OrgApacheCommonsMathFractionBigFraction_THREE_FIFTHS_ = new_OrgApacheCommonsMathFractionBigFraction_initWithInt_withInt_(3, 5);
    OrgApacheCommonsMathFractionBigFraction_THREE_QUARTERS_ = new_OrgApacheCommonsMathFractionBigFraction_initWithInt_withInt_(3, 4);
    OrgApacheCommonsMathFractionBigFraction_TWO_FIFTHS_ = new_OrgApacheCommonsMathFractionBigFraction_initWithInt_withInt_(2, 5);
    OrgApacheCommonsMathFractionBigFraction_TWO_QUARTERS_ = new_OrgApacheCommonsMathFractionBigFraction_initWithInt_withInt_(2, 4);
    OrgApacheCommonsMathFractionBigFraction_TWO_THIRDS_ = new_OrgApacheCommonsMathFractionBigFraction_initWithInt_withInt_(2, 3);
    OrgApacheCommonsMathFractionBigFraction_ONE_HUNDRED_DOUBLE_ = JavaMathBigInteger_valueOfWithLong_(100);
...
void OrgApacheCommonsMathFractionBigFraction_initWithJavaMathBigInteger_(OrgApacheCommonsMathFractionBigFraction *self, JavaMathBigInteger *num) {
  (void) OrgApacheCommonsMathFractionBigFraction_initWithJavaMathBigInteger_withJavaMathBigInteger_(self, num, JavaMathBigInteger_get_ONE_());
}
...
void OrgApacheCommonsMathFractionBigFraction_initWithJavaMathBigInteger_withJavaMathBigInteger_(OrgApacheCommonsMathFractionBigFraction *self, JavaMathBigInteger *num, JavaMathBigInteger *den) {
  ...
  if (num == nil) {
    @throw new_JavaLangNullPointerException_initWithNSString_([((OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum *) nil_chk(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_NUMERATOR())) getSourceString]);
  }
  if (den == nil) {
    @throw new_JavaLangNullPointerException_initWithNSString_([((OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum *) nil_chk(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_DENOMINATOR())) getSourceString]);
  }
  if ([((JavaMathBigInteger *) nil_chk(JavaMathBigInteger_get_ZERO_())) isEqual:den]) {
    @throw OrgApacheCommonsMathMathRuntimeException_createArithmeticExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_ZERO_DENOMINATOR(), [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
  }
  if ([JavaMathBigInteger_get_ZERO_() isEqual:num]) {
    self->numerator_ = JavaMathBigInteger_get_ZERO_();
    self->denominator_ = JavaMathBigInteger_get_ONE_();
  }
  else {
...
void OrgApacheCommonsMathFractionBigFraction_initWithDouble_(OrgApacheCommonsMathFractionBigFraction *self, jdouble value) {
  ...
  if (JavaLangDouble_isNaNWithDouble_(value)) {
    @throw OrgApacheCommonsMathMathRuntimeException_createIllegalArgumentExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_NAN_VALUE_CONVERSION(), [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
  }
  if (JavaLangDouble_isInfiniteWithDouble_(value)) {
    @throw OrgApacheCommonsMathMathRuntimeException_createIllegalArgumentExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_INFINITE_VALUE_CONVERSION(), [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
  }
  ...
  if (k < 0) {
    self->numerator_ = JavaMathBigInteger_valueOfWithLong_(m);
    self->denominator_ = [((JavaMathBigInteger *) nil_chk(JavaMathBigInteger_get_ZERO_())) flipBitWithInt:-k];
  }
  else {
    self->numerator_ = [((JavaMathBigInteger *) nil_chk(JavaMathBigInteger_valueOfWithLong_(m))) multiplyWithJavaMathBigInteger:[((JavaMathBigInteger *) nil_chk(JavaMathBigInteger_get_ZERO_())) flipBitWithInt:k]];
    self->denominator_ = JavaMathBigInteger_get_ONE_();
  }
}
...
void OrgApacheCommonsMathFractionBigFraction_initWithDouble_withDouble_withInt_(OrgApacheCommonsMathFractionBigFraction *self, jdouble value, jdouble epsilon, jint maxIterations) {
  (void) OrgApacheCommonsMathFractionBigFraction_initWithDouble_withDouble_withInt_withInt_(self, value, epsilon, JavaLangInteger_MAX_VALUE, maxIterations);
}
...
void OrgApacheCommonsMathFractionBigFraction_initWithDouble_withDouble_withInt_withInt_(OrgApacheCommonsMathFractionBigFraction *self, jdouble value, jdouble epsilon, jint maxDenominator, jint maxIterations) {
  ...
  if (OrgApacheCommonsMathUtilFastMath_absWithDouble_(a0 - value) < epsilon) {
    self->numerator_ = JavaMathBigInteger_valueOfWithLong_(a0);
    self->denominator_ = JavaMathBigInteger_get_ONE_();
    return;
  }
  jlong p0 = 1;
  ...
  if (q2 < maxDenominator) {
    self->numerator_ = JavaMathBigInteger_valueOfWithLong_(p2);
    self->denominator_ = JavaMathBigInteger_valueOfWithLong_(q2);
  }
  else {
    self->numerator_ = JavaMathBigInteger_valueOfWithLong_(p1);
    self->denominator_ = JavaMathBigInteger_valueOfWithLong_(q1);
  }
}
...
void OrgApacheCommonsMathFractionBigFraction_initWithDouble_withInt_(OrgApacheCommonsMathFractionBigFraction *self, jdouble value, jint maxDenominator) {
  (void) OrgApacheCommonsMathFractionBigFraction_initWithDouble_withDouble_withInt_withInt_(self, value, 0, maxDenominator, 100);
}
...
void OrgApacheCommonsMathFractionBigFraction_initWithInt_(OrgApacheCommonsMathFractionBigFraction *self, jint num) {
  (void) OrgApacheCommonsMathFractionBigFraction_initWithJavaMathBigInteger_withJavaMathBigInteger_(self, JavaMathBigInteger_valueOfWithLong_(num), JavaMathBigInteger_get_ONE_());
}
...
void OrgApacheCommonsMathFractionBigFraction_initWithInt_withInt_(OrgApacheCommonsMathFractionBigFraction *self, jint num, jint den) {
  (void) OrgApacheCommonsMathFractionBigFraction_initWithJavaMathBigInteger_withJavaMathBigInteger_(self, JavaMathBigInteger_valueOfWithLong_(num), JavaMathBigInteger_valueOfWithLong_(den));
}
...
OrgApacheCommonsMathFractionBigFraction *OrgApacheCommonsMathFractionBigFraction_getReducedFractionWithInt_withInt_(jint numerator, jint denominator) {
  ...
  return new_OrgApacheCommonsMathFractionBigFraction_initWithInt_withInt_(numerator, denominator);
}
