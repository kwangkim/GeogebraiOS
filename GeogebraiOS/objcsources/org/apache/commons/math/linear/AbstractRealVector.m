...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/apache/commons/math/linear/AbstractRealVector.java
//
...
- (void)checkVectorDimensionsWithInt:(jint)n {
  ...
  if (d != n) {
    @throw new_OrgApacheCommonsMathExceptionDimensionMismatchException_initWithInt_withInt_(d, n);
  }
}
...
- (id<OrgApacheCommonsMathLinearRealVector>)addWithDoubleArray:(IOSDoubleArray *)v {
  ...
  return new_OrgApacheCommonsMathLinearArrayRealVector_initWithDoubleArray_withBoolean_(result, NO);
}
...
- (jdouble)dotProductWithDoubleArray:(IOSDoubleArray *)v {
  return [self dotProductWithOrgApacheCommonsMathLinearRealVector:new_OrgApacheCommonsMathLinearArrayRealVector_initWithDoubleArray_withBoolean_(v, NO)];
}
...
- (id<OrgApacheCommonsMathLinearRealVector>)ebeDivideWithDoubleArray:(IOSDoubleArray *)v {
  return [self ebeDivideWithOrgApacheCommonsMathLinearRealVector:new_OrgApacheCommonsMathLinearArrayRealVector_initWithDoubleArray_withBoolean_(v, NO)];
}

- (id<OrgApacheCommonsMathLinearRealVector>)ebeMultiplyWithDoubleArray:(IOSDoubleArray *)v {
  return [self ebeMultiplyWithOrgApacheCommonsMathLinearRealVector:new_OrgApacheCommonsMathLinearArrayRealVector_initWithDoubleArray_withBoolean_(v, NO)];
}
...
- (jdouble)getDistanceWithDoubleArray:(IOSDoubleArray *)v {
  return [self getDistanceWithOrgApacheCommonsMathLinearRealVector:new_OrgApacheCommonsMathLinearArrayRealVector_initWithDoubleArray_withBoolean_(v, NO)];
}
...
- (id<OrgApacheCommonsMathLinearRealMatrix>)outerProductWithOrgApacheCommonsMathLinearRealVector:(id<OrgApacheCommonsMathLinearRealVector>)v {
  ...
  if ([OrgApacheCommonsMathLinearSparseRealVector_class_() isInstance:v] || [OrgApacheCommonsMathLinearSparseRealVector_class_() isInstance:self]) {
    product = new_OrgApacheCommonsMathLinearOpenMapRealMatrix_initWithInt_withInt_([self getDimension], [((id<OrgApacheCommonsMathLinearRealVector>) nil_chk(v)) getDimension]);
  }
  else {
    product = new_OrgApacheCommonsMathLinearArray2DRowRealMatrix_initWithInt_withInt_([self getDimension], [((id<OrgApacheCommonsMathLinearRealVector>) nil_chk(v)) getDimension]);
  }
...
- (id<OrgApacheCommonsMathLinearRealMatrix>)outerProductWithDoubleArray:(IOSDoubleArray *)v {
  return [self outerProductWithOrgApacheCommonsMathLinearRealVector:new_OrgApacheCommonsMathLinearArrayRealVector_initWithDoubleArray_withBoolean_(v, NO)];
}

- (id<OrgApacheCommonsMathLinearRealVector>)projectionWithDoubleArray:(IOSDoubleArray *)v {
  return [self projectionWithOrgApacheCommonsMathLinearRealVector:new_OrgApacheCommonsMathLinearArrayRealVector_initWithDoubleArray_withBoolean_(v, NO)];
}
...
- (IOSDoubleArray *)toArray {
  ...
  IOSDoubleArray *values = [IOSDoubleArray newArrayWithLength:dim];
...
- (void)unitize {
  (void) [self mapDivideToSelfWithDouble:[self getNorm]];
}

- (id<JavaUtilIterator>)sparseIterator {
  return new_OrgApacheCommonsMathLinearAbstractRealVector_SparseEntryIterator_initWithOrgApacheCommonsMathLinearAbstractRealVector_(self);
}

- (id<JavaUtilIterator>)iterator {
  jint dim = [self getDimension];
  return new_OrgApacheCommonsMathLinearAbstractRealVector_$1_initWithOrgApacheCommonsMathLinearAbstractRealVector_withInt_(self, dim);
}
...
- (void)remove {
  @throw new_OrgApacheCommonsMathExceptionMathUnsupportedOperationException_initWithNSObjectArray_([IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
}
...
void OrgApacheCommonsMathLinearAbstractRealVector_SparseEntryIterator_initWithOrgApacheCommonsMathLinearAbstractRealVector_(OrgApacheCommonsMathLinearAbstractRealVector_SparseEntryIterator *self, OrgApacheCommonsMathLinearAbstractRealVector *outer$) {
  ...
  self->current_ = new_OrgApacheCommonsMathLinearAbstractRealVector_EntryImpl_initWithOrgApacheCommonsMathLinearAbstractRealVector_(outer$);
  self->next__ = new_OrgApacheCommonsMathLinearAbstractRealVector_EntryImpl_initWithOrgApacheCommonsMathLinearAbstractRealVector_(outer$);
...
void OrgApacheCommonsMathLinearAbstractRealVector_$1_initWithOrgApacheCommonsMathLinearAbstractRealVector_withInt_(OrgApacheCommonsMathLinearAbstractRealVector_$1 *self, OrgApacheCommonsMathLinearAbstractRealVector *outer$, jint capture$0) {
  ...
  (void) NSObject_init(self);
  self->i_ = 0;
  self->e_ = new_OrgApacheCommonsMathLinearAbstractRealVector_EntryImpl_initWithOrgApacheCommonsMathLinearAbstractRealVector_(outer$);
}
