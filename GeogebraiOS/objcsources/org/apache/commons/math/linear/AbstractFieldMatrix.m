...
- (IOSObjectArray *)getData {
  ...
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(data))->size_; ++i) {
    ...
    for (jint j = 0; j < ((IOSObjectArray *) nil_chk(dataI))->size_; ++j) {
      (void) IOSObjectArray_Set(dataI, j, [self getEntryWithInt:i withInt:j]);
    }
  }
  return data;
}
...
withOrgApacheCommonsMathFieldElementArray2:(IOSObjectArray *)destination {
  ...
  (void) [self walkInOptimizedOrderWithOrgApacheCommonsMathLinearFieldMatrixPreservingVisitor:new_OrgApacheCommonsMathLinearAbstractFieldMatrix_$2_initWithOrgApacheCommonsMathFieldElementArray2_withOrgApacheCommonsMathFieldElement_(destination, [((id<OrgApacheCommonsMathField>) nil_chk(field_)) getZero]) withInt:startRow withInt:endRow withInt:startColumn withInt:endColumn];
}
...
withOrgApacheCommonsMathFieldElementArray2:(IOSObjectArray *)destination {
  ...
  for (jint i = 0; i < selectedRows->size_; i++) {
    ...
    for (jint j = 0; j < ((IOSIntArray *) nil_chk(selectedColumns))->size_; j++) {
      (void) IOSObjectArray_Set(nil_chk(destinationI), j, [self getEntryWithInt:IOSIntArray_Get(selectedRows, i) withInt:IOSIntArray_Get(selectedColumns, j)]);
    }
  }
}
...
- (id<OrgApacheCommonsMathLinearFieldVector>)getRowVectorWithInt:(jint)row {
  return new_OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathFieldElementArray_withBoolean_([self getRowWithInt:row], NO);
}
...
- (id<OrgApacheCommonsMathLinearFieldVector>)getColumnVectorWithInt:(jint)column {
  return new_OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathFieldElementArray_withBoolean_([self getColumnWithInt:column], NO);
}
...
- (IOSObjectArray *)getRowWithInt:(jint)row {
  ...
  for (jint i = 0; i < nCols; ++i) {
    (void) IOSObjectArray_Set(nil_chk(out), i, [self getEntryWithInt:row withInt:i]);
  }
  return out;
}
...
- (IOSObjectArray *)getColumnWithInt:(jint)column {
  ...
  for (jint i = 0; i < nRows; ++i) {
    (void) IOSObjectArray_Set(nil_chk(out), i, [self getEntryWithInt:i withInt:column]);
  }
  return out;
}
...
- (id<OrgApacheCommonsMathLinearFieldMatrix>)transpose {
  ...
  (void) [self walkInOptimizedOrderWithOrgApacheCommonsMathLinearFieldMatrixPreservingVisitor:new_OrgApacheCommonsMathLinearAbstractFieldMatrix_$3_initWithOrgApacheCommonsMathLinearFieldMatrix_withOrgApacheCommonsMathFieldElement_(out, [((id<OrgApacheCommonsMathField>) nil_chk(field_)) getZero])];
  return out;
}
...
- (id<OrgApacheCommonsMathLinearFieldVector>)operateWithOrgApacheCommonsMathLinearFieldVector:(id<OrgApacheCommonsMathLinearFieldVector>)v {
  ...
  @catch (JavaLangClassCastException *cce) {
    ...
    return new_OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathFieldElementArray_withBoolean_(out, NO);
  }
}
...
- (id<OrgApacheCommonsMathLinearFieldVector>)preMultiplyWithOrgApacheCommonsMathLinearFieldVector:(id<OrgApacheCommonsMathLinearFieldVector>)v {
  @try {
    return new_OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathFieldElementArray_withBoolean_([self preMultiplyWithOrgApacheCommonsMathFieldElementArray:[((OrgApacheCommonsMathLinearArrayFieldVector *) nil_chk(((OrgApacheCommonsMathLinearArrayFieldVector *) check_class_cast(v, [OrgApacheCommonsMathLinearArrayFieldVector class])))) getDataRef]], NO);
  }
  @catch (JavaLangClassCastException *cce) {
    jint nRows = [self getRowDimension];
    jint nCols = [self getColumnDimension];
...
- (NSString *)description {
  ...
  for (jint i = 0; i < nRows; ++i) {
    ...
    for (jint j = 0; j < nCols; ++j) {
      ...
      (void) [res appendWithId:[self getEntryWithInt:i withInt:j]];
    }
    (void) [res appendWithNSString:@"}"];
  }
  (void) [res appendWithNSString:@"}"];
...
IOSObjectArray *OrgApacheCommonsMathLinearAbstractFieldMatrix_buildArrayWithOrgApacheCommonsMathField_withInt_withInt_(id<OrgApacheCommonsMathField> field, jint rows, jint columns) {
  ...
  IOSObjectArray *array = (IOSObjectArray *) check_class_cast(JavaLangReflectArray_newInstanceWithIOSClass_withIntArray_([((id<OrgApacheCommonsMathFieldElement>) nil_chk([((id<OrgApacheCommonsMathField>) nil_chk(field)) getZero])) getClass], [IOSIntArray newArrayWithInts:(jint[]){ rows, columns } count:2]), [IOSObjectArray class]);
...
void OrgApacheCommonsMathLinearAbstractFieldMatrix_$1_initWithOrgApacheCommonsMathLinearAbstractFieldMatrix_withIntArray_withIntArray_withOrgApacheCommonsMathFieldElement_(OrgApacheCommonsMathLinearAbstractFieldMatrix_$1 *self, OrgApacheCommonsMathLinearAbstractFieldMatrix *outer$, IOSIntArray *capture$0, IOSIntArray *capture$1, id<OrgApacheCommonsMathFieldElement> arg$0) {
  ...
  (void) OrgApacheCommonsMathLinearDefaultFieldMatrixChangingVisitor_initWithOrgApacheCommonsMathFieldElement_(self, arg$0);
}
...
- (void)visitWithInt:(jint)row
             withInt:(jint)column
withOrgApacheCommonsMathFieldElement:(id<OrgApacheCommonsMathFieldElement>)value {
  (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(nil_chk(val$destination_), row - startRow1_)), column - startColumn1_, value);
}
...
void OrgApacheCommonsMathLinearAbstractFieldMatrix_$2_initWithOrgApacheCommonsMathFieldElementArray2_withOrgApacheCommonsMathFieldElement_(OrgApacheCommonsMathLinearAbstractFieldMatrix_$2 *self, IOSObjectArray *capture$0, id<OrgApacheCommonsMathFieldElement> arg$0) {
  ...
  (void) OrgApacheCommonsMathLinearDefaultFieldMatrixPreservingVisitor_initWithOrgApacheCommonsMathFieldElement_(self, arg$0);
}
