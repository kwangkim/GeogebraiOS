...
id<OrgApacheCommonsMathLinearRealMatrix> OrgApacheCommonsMathLinearMatrixUtils_createRealMatrixWithInt_withInt_(jint rows, jint columns) {
  ...
  return (rows * columns <= 4096) ? new_OrgApacheCommonsMathLinearArray2DRowRealMatrix_initWithInt_withInt_(rows, columns) : new_OrgApacheCommonsMathLinearBlockRealMatrix_initWithInt_withInt_(rows, columns);
}
...
id<OrgApacheCommonsMathLinearFieldMatrix> OrgApacheCommonsMathLinearMatrixUtils_createFieldMatrixWithOrgApacheCommonsMathField_withInt_withInt_(id<OrgApacheCommonsMathField> field, jint rows, jint columns) {
  OrgApacheCommonsMathLinearMatrixUtils_initialize();
  return (rows * columns <= 4096) ? new_OrgApacheCommonsMathLinearArray2DRowFieldMatrix_initWithOrgApacheCommonsMathField_withInt_withInt_(field, rows, columns) : new_OrgApacheCommonsMathLinearBlockFieldMatrix_initWithOrgApacheCommonsMathField_withInt_withInt_(field, rows, columns);
}
...
id<OrgApacheCommonsMathLinearRealMatrix> OrgApacheCommonsMathLinearMatrixUtils_createRealMatrixWithDoubleArray2_(IOSObjectArray *data) {
  OrgApacheCommonsMathLinearMatrixUtils_initialize();
  return (((IOSObjectArray *) nil_chk(data))->size_ * ((IOSDoubleArray *) nil_chk(IOSObjectArray_Get(data, 0)))->size_ <= 4096) ? new_OrgApacheCommonsMathLinearArray2DRowRealMatrix_initWithDoubleArray2_(data) : new_OrgApacheCommonsMathLinearBlockRealMatrix_initWithDoubleArray2_(data);
}
...
id<OrgApacheCommonsMathLinearFieldMatrix> OrgApacheCommonsMathLinearMatrixUtils_createFieldIdentityMatrixWithOrgApacheCommonsMathField_withInt_(id<OrgApacheCommonsMathField> field, jint dimension) {
  ...
  IOSObjectArray *d = (IOSObjectArray *) check_class_cast(JavaLangReflectArray_newInstanceWithIOSClass_withIntArray_([((id<OrgApacheCommonsMathFieldElement>) nil_chk(zero)) getClass], [IOSIntArray newArrayWithInts:(jint[]){ dimension, dimension } count:2]), [IOSObjectArray class]);
  for (jint row = 0; row < dimension; row++) {
    ...
    (void) IOSObjectArray_Set(nil_chk(dRow), row, one);
  }
  return new_OrgApacheCommonsMathLinearArray2DRowFieldMatrix_initWithOrgApacheCommonsMathFieldElementArray2_withBoolean_(d, NO);
}
...
id<OrgApacheCommonsMathLinearBigMatrix> OrgApacheCommonsMathLinearMatrixUtils_createBigIdentityMatrixWithInt_(jint dimension) {
  OrgApacheCommonsMathLinearMatrixUtils_initialize();
  IOSObjectArray *d = [IOSObjectArray newArrayWithDimensions:2 lengths:(jint[]){ dimension, dimension } type:JavaMathBigDecimal_class_()];
  for (jint row = 0; row < dimension; row++) {
    ...
    (void) IOSObjectArray_Set(nil_chk(dRow), row, OrgApacheCommonsMathLinearBigMatrixImpl_get_ONE_());
  }
  return new_OrgApacheCommonsMathLinearBigMatrixImpl_initWithJavaMathBigDecimalArray2_withBoolean_(d, NO);
}
...
id<OrgApacheCommonsMathLinearBigMatrix> OrgApacheCommonsMathLinearMatrixUtils_createBigMatrixWithDoubleArray2_(IOSObjectArray *data) {
  OrgApacheCommonsMathLinearMatrixUtils_initialize();
  return new_OrgApacheCommonsMathLinearBigMatrixImpl_initWithDoubleArray2_(data);
}
...
id<OrgApacheCommonsMathLinearBigMatrix> OrgApacheCommonsMathLinearMatrixUtils_createBigMatrixWithJavaMathBigDecimalArray2_(IOSObjectArray *data) {
  OrgApacheCommonsMathLinearMatrixUtils_initialize();
  return new_OrgApacheCommonsMathLinearBigMatrixImpl_initWithJavaMathBigDecimalArray2_(data);
}
...
id<OrgApacheCommonsMathLinearBigMatrix> OrgApacheCommonsMathLinearMatrixUtils_createBigMatrixWithJavaMathBigDecimalArray2_withBoolean_(IOSObjectArray *data, jboolean copyArray) {
  OrgApacheCommonsMathLinearMatrixUtils_initialize();
  return new_OrgApacheCommonsMathLinearBigMatrixImpl_initWithJavaMathBigDecimalArray2_withBoolean_(data, copyArray);
}
...
id<OrgApacheCommonsMathLinearBigMatrix> OrgApacheCommonsMathLinearMatrixUtils_createBigMatrixWithNSStringArray2_(IOSObjectArray *data) {
  OrgApacheCommonsMathLinearMatrixUtils_initialize();
  return new_OrgApacheCommonsMathLinearBigMatrixImpl_initWithNSStringArray2_(data);
}
...
id<OrgApacheCommonsMathLinearRealVector> OrgApacheCommonsMathLinearMatrixUtils_createRealVectorWithDoubleArray_(IOSDoubleArray *data) {
  OrgApacheCommonsMathLinearMatrixUtils_initialize();
  return new_OrgApacheCommonsMathLinearArrayRealVector_initWithDoubleArray_withBoolean_(data, YES);
}
...
id<OrgApacheCommonsMathLinearFieldVector> OrgApacheCommonsMathLinearMatrixUtils_createFieldVectorWithOrgApacheCommonsMathFieldElementArray_(IOSObjectArray *data) {
  OrgApacheCommonsMathLinearMatrixUtils_initialize();
  return new_OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathFieldElementArray_withBoolean_(data, YES);
}
...
id<OrgApacheCommonsMathLinearBigMatrix> OrgApacheCommonsMathLinearMatrixUtils_createRowBigMatrixWithDoubleArray_(IOSDoubleArray *rowData) {
  OrgApacheCommonsMathLinearMatrixUtils_initialize();
  jint nCols = ((IOSDoubleArray *) nil_chk(rowData))->size_;
  IOSObjectArray *data = [IOSObjectArray newArrayWithDimensions:2 lengths:(jint[]){ 1, nCols } type:JavaMathBigDecimal_class_()];
  for (jint i = 0; i < nCols; ++i) {
    (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(data, 0)), i, new_JavaMathBigDecimal_initWithDouble_(IOSDoubleArray_Get(rowData, i)));
  }
  return new_OrgApacheCommonsMathLinearBigMatrixImpl_initWithJavaMathBigDecimalArray2_withBoolean_(data, NO);
}
...
id<OrgApacheCommonsMathLinearBigMatrix> OrgApacheCommonsMathLinearMatrixUtils_createRowBigMatrixWithNSStringArray_(IOSObjectArray *rowData) {
  ...
  IOSObjectArray *data = [IOSObjectArray newArrayWithDimensions:2 lengths:(jint[]){ 1, nCols } type:JavaMathBigDecimal_class_()];
  for (jint i = 0; i < nCols; ++i) {
    (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(data, 0)), i, new_JavaMathBigDecimal_initWithNSString_(IOSObjectArray_Get(rowData, i)));
  }
  return new_OrgApacheCommonsMathLinearBigMatrixImpl_initWithJavaMathBigDecimalArray2_withBoolean_(data, NO);
}
...
id<OrgApacheCommonsMathLinearBigMatrix> OrgApacheCommonsMathLinearMatrixUtils_createColumnBigMatrixWithDoubleArray_(IOSDoubleArray *columnData) {
  OrgApacheCommonsMathLinearMatrixUtils_initialize();
  jint nRows = ((IOSDoubleArray *) nil_chk(columnData))->size_;
  IOSObjectArray *data = [IOSObjectArray newArrayWithDimensions:2 lengths:(jint[]){ nRows, 1 } type:JavaMathBigDecimal_class_()];
  for (jint row = 0; row < nRows; row++) {
    (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(data, row)), 0, new_JavaMathBigDecimal_initWithDouble_(IOSDoubleArray_Get(columnData, row)));
  }
  return new_OrgApacheCommonsMathLinearBigMatrixImpl_initWithJavaMathBigDecimalArray2_withBoolean_(data, NO);
}
...
id<OrgApacheCommonsMathLinearBigMatrix> OrgApacheCommonsMathLinearMatrixUtils_createColumnBigMatrixWithJavaMathBigDecimalArray_(IOSObjectArray *columnData) {
  ...
  IOSObjectArray *data = [IOSObjectArray newArrayWithDimensions:2 lengths:(jint[]){ nRows, 1 } type:JavaMathBigDecimal_class_()];
  for (jint row = 0; row < nRows; row++) {
    (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(data, row)), 0, IOSObjectArray_Get(columnData, row));
  }
  return new_OrgApacheCommonsMathLinearBigMatrixImpl_initWithJavaMathBigDecimalArray2_withBoolean_(data, NO);
}
...
id<OrgApacheCommonsMathLinearBigMatrix> OrgApacheCommonsMathLinearMatrixUtils_createColumnBigMatrixWithNSStringArray_(IOSObjectArray *columnData) {
  ...
  IOSObjectArray *data = [IOSObjectArray newArrayWithDimensions:2 lengths:(jint[]){ nRows, 1 } type:JavaMathBigDecimal_class_()];
  for (jint row = 0; row < nRows; row++) {
    (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(data, row)), 0, new_JavaMathBigDecimal_initWithNSString_(IOSObjectArray_Get(columnData, row)));
  }
  return new_OrgApacheCommonsMathLinearBigMatrixImpl_initWithJavaMathBigDecimalArray2_withBoolean_(data, NO);
}
...
OrgApacheCommonsMathLinearArray2DRowRealMatrix *OrgApacheCommonsMathLinearMatrixUtils_fractionMatrixToRealMatrixWithOrgApacheCommonsMathLinearFieldMatrix_(id<OrgApacheCommonsMathLinearFieldMatrix> m) {
  OrgApacheCommonsMathLinearMatrixUtils_initialize();
  OrgApacheCommonsMathLinearMatrixUtils_FractionMatrixConverter *converter = new_OrgApacheCommonsMathLinearMatrixUtils_FractionMatrixConverter_init();
  (void) [((id<OrgApacheCommonsMathLinearFieldMatrix>) nil_chk(m)) walkInOptimizedOrderWithOrgApacheCommonsMathLinearFieldMatrixPreservingVisitor:converter];
...
OrgApacheCommonsMathLinearArray2DRowRealMatrix *OrgApacheCommonsMathLinearMatrixUtils_bigFractionMatrixToRealMatrixWithOrgApacheCommonsMathLinearFieldMatrix_(id<OrgApacheCommonsMathLinearFieldMatrix> m) {
  OrgApacheCommonsMathLinearMatrixUtils_initialize();
  OrgApacheCommonsMathLinearMatrixUtils_BigFractionMatrixConverter *converter = new_OrgApacheCommonsMathLinearMatrixUtils_BigFractionMatrixConverter_init();
  (void) [((id<OrgApacheCommonsMathLinearFieldMatrix>) nil_chk(m)) walkInOptimizedOrderWithOrgApacheCommonsMathLinearFieldMatrixPreservingVisitor:converter];
  return [converter getConvertedMatrix];
}
...
void OrgApacheCommonsMathLinearMatrixUtils_deserializeRealVectorWithId_withNSString_withJavaIoObjectInputStream_(id instance, NSString *fieldName, JavaIoObjectInputStream *ois) {
  ...
  @try {
    ...
    IOSDoubleArray *data = [IOSDoubleArray newArrayWithLength:n];
    for (jint i = 0; i < n; ++i) {
      *IOSDoubleArray_GetRef(data, i) = [ois readDouble];
    }
    id<OrgApacheCommonsMathLinearRealVector> vector = new_OrgApacheCommonsMathLinearArrayRealVector_initWithDoubleArray_withBoolean_(data, NO);
  ...
  @catch (JavaLangNoSuchFieldException *nsfe) {
    JavaIoIOException *ioe = new_JavaIoIOException_init();
    (void) [ioe initCauseWithJavaLangThrowable:nsfe];
    @throw ioe;
  }
  @catch (JavaLangIllegalAccessException *iae) {
    JavaIoIOException *ioe = new_JavaIoIOException_init();
    (void) [ioe initCauseWithJavaLangThrowable:iae];
    @throw ioe;
  }
}
...
void OrgApacheCommonsMathLinearMatrixUtils_deserializeRealMatrixWithId_withNSString_withJavaIoObjectInputStream_(id instance, NSString *fieldName, JavaIoObjectInputStream *ois) {
  ...
  @try {
    jint n = [((JavaIoObjectInputStream *) nil_chk(ois)) readInt];
    jint m = [ois readInt];
    IOSObjectArray *data = [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ n, m }];
    for (jint i = 0; i < n; ++i) {
    ...
    id<OrgApacheCommonsMathLinearRealMatrix> matrix = new_OrgApacheCommonsMathLinearArray2DRowRealMatrix_initWithDoubleArray2_withBoolean_(data, NO);
    JavaLangReflectField *f = [[nil_chk(instance) getClass] getDeclaredField:fieldName];
    [((JavaLangReflectField *) nil_chk(f)) setAccessibleWithBoolean:YES];
...
- (void)startWithInt:(jint)rows
             ...
             withInt:(jint)startColumn
             withInt:(jint)endColumn {
  data_ = [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ rows, columns }];
}
...
- (OrgApacheCommonsMathLinearArray2DRowRealMatrix *)getConvertedMatrix {
  return new_OrgApacheCommonsMathLinearArray2DRowRealMatrix_initWithDoubleArray2_withBoolean_(data_, NO);
}
...
void OrgApacheCommonsMathLinearMatrixUtils_FractionMatrixConverter_init(OrgApacheCommonsMathLinearMatrixUtils_FractionMatrixConverter *self) {
  (void) OrgApacheCommonsMathLinearDefaultFieldMatrixPreservingVisitor_initWithOrgApacheCommonsMathFieldElement_(self, OrgApacheCommonsMathFractionFraction_get_ZERO_());
}
...
void OrgApacheCommonsMathLinearMatrixUtils_BigFractionMatrixConverter_init(OrgApacheCommonsMathLinearMatrixUtils_BigFractionMatrixConverter *self) {
  (void) OrgApacheCommonsMathLinearDefaultFieldMatrixPreservingVisitor_initWithOrgApacheCommonsMathFieldElement_(self, OrgApacheCommonsMathFractionBigFraction_get_ZERO_());
}
