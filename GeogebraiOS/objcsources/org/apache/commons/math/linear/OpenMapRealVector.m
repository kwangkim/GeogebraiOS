...
- (OrgApacheCommonsMathLinearOpenMapRealVector *)appendWithOrgApacheCommonsMathLinearOpenMapRealVector:(OrgApacheCommonsMathLinearOpenMapRealVector *)v {
  OrgApacheCommonsMathLinearOpenMapRealVector *res = new_OrgApacheCommonsMathLinearOpenMapRealVector_initWithOrgApacheCommonsMathLinearOpenMapRealVector_withInt_(self, [((OrgApacheCommonsMathLinearOpenMapRealVector *) nil_chk(v)) getDimension]);
...
- (OrgApacheCommonsMathLinearOpenMapRealVector *)appendWithDouble:(jdouble)d {
  OrgApacheCommonsMathLinearOpenMapRealVector *res = new_OrgApacheCommonsMathLinearOpenMapRealVector_initWithOrgApacheCommonsMathLinearOpenMapRealVector_withInt_(self, 1);
...
- (OrgApacheCommonsMathLinearOpenMapRealVector *)appendWithDoubleArray:(IOSDoubleArray *)a {
  OrgApacheCommonsMathLinearOpenMapRealVector *res = new_OrgApacheCommonsMathLinearOpenMapRealVector_initWithOrgApacheCommonsMathLinearOpenMapRealVector_withInt_(self, ((IOSDoubleArray *) nil_chk(a))->size_);
...
- (OrgApacheCommonsMathLinearOpenMapRealVector *)copy__ {
  return new_OrgApacheCommonsMathLinearOpenMapRealVector_initWithOrgApacheCommonsMathLinearOpenMapRealVector_(self);
}
...
- (OrgApacheCommonsMathLinearOpenMapRealVector *)ebeDivideWithOrgApacheCommonsMathLinearRealVector:(id<OrgApacheCommonsMathLinearRealVector>)v {
  [self checkVectorDimensionsWithInt:[((id<OrgApacheCommonsMathLinearRealVector>) nil_chk(v)) getDimension]];
  OrgApacheCommonsMathLinearOpenMapRealVector *res = new_OrgApacheCommonsMathLinearOpenMapRealVector_initWithOrgApacheCommonsMathLinearOpenMapRealVector_(self);
...
- (OrgApacheCommonsMathLinearOpenMapRealVector *)getSubVectorWithInt:(jint)index
  ...
  OrgApacheCommonsMathLinearOpenMapRealVector *res = new_OrgApacheCommonsMathLinearOpenMapRealVector_initWithInt_(n);
  jint end = index + n;
...
- (IOSDoubleArray *)getData {
  IOSDoubleArray *res = [IOSDoubleArray newArrayWithLength:virtualSize_];
  OrgApacheCommonsMathUtilOpenIntToDoubleHashMap_Iterator *iter = [((OrgApacheCommonsMathUtilOpenIntToDoubleHashMap *) nil_chk(entries_)) iterator];
  while ([((OrgApacheCommonsMathUtilOpenIntToDoubleHashMap_Iterator *) nil_chk(iter)) hasNext]) {
    [iter advance];
...
- (id<OrgApacheCommonsMathLinearRealMatrix>)outerProductWithDoubleArray:(IOSDoubleArray *)v {
  [self checkVectorDimensionsWithInt:((IOSDoubleArray *) nil_chk(v))->size_];
  id<OrgApacheCommonsMathLinearRealMatrix> res = new_OrgApacheCommonsMathLinearOpenMapRealMatrix_initWithInt_withInt_(virtualSize_, virtualSize_);
  OrgApacheCommonsMathUtilOpenIntToDoubleHashMap_Iterator *iter = [((OrgApacheCommonsMathUtilOpenIntToDoubleHashMap *) nil_chk(entries_)) iterator];
  while ([((OrgApacheCommonsMathUtilOpenIntToDoubleHashMap_Iterator *) nil_chk(iter)) hasNext]) {
    [iter advance];
    jint row = [iter key];
...
- (OrgApacheCommonsMathLinearOpenMapRealVector *)projectionWithDoubleArray:(IOSDoubleArray *)v {
  [self checkVectorDimensionsWithInt:((IOSDoubleArray *) nil_chk(v))->size_];
  return (OrgApacheCommonsMathLinearOpenMapRealVector *) check_class_cast([self projectionWithOrgApacheCommonsMathLinearRealVector:new_OrgApacheCommonsMathLinearOpenMapRealVector_initWithDoubleArray_(v)], [OrgApacheCommonsMathLinearOpenMapRealVector class]);
}
...
- (void)unitize {
  ...
  if ([self isDefaultValueWithDouble:norm]) {
    @throw OrgApacheCommonsMathMathRuntimeException_createArithmeticExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_CANNOT_NORMALIZE_A_ZERO_NORM_VECTOR(), [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
  }
  OrgApacheCommonsMathUtilOpenIntToDoubleHashMap_Iterator *iter = [((OrgApacheCommonsMathUtilOpenIntToDoubleHashMap *) nil_chk(entries_)) iterator];
  while ([((OrgApacheCommonsMathUtilOpenIntToDoubleHashMap_Iterator *) nil_chk(iter)) hasNext]) {
    [iter advance];
...
- (id<JavaUtilIterator>)sparseIterator {
  return new_OrgApacheCommonsMathLinearOpenMapRealVector_OpenMapSparseIterator_initWithOrgApacheCommonsMathLinearOpenMapRealVector_(self);
}
...
void OrgApacheCommonsMathLinearOpenMapRealVector_init(OrgApacheCommonsMathLinearOpenMapRealVector *self) {
  (void) OrgApacheCommonsMathLinearOpenMapRealVector_initWithInt_withDouble_(self, 0, OrgApacheCommonsMathLinearOpenMapRealVector_DEFAULT_ZERO_TOLERANCE);
}
...
void OrgApacheCommonsMathLinearOpenMapRealVector_initWithInt_(OrgApacheCommonsMathLinearOpenMapRealVector *self, jint dimension) {
  (void) OrgApacheCommonsMathLinearOpenMapRealVector_initWithInt_withDouble_(self, dimension, OrgApacheCommonsMathLinearOpenMapRealVector_DEFAULT_ZERO_TOLERANCE);
}
...
void OrgApacheCommonsMathLinearOpenMapRealVector_initWithInt_withDouble_(OrgApacheCommonsMathLinearOpenMapRealVector *self, jint dimension, jdouble epsilon) {
  (void) OrgApacheCommonsMathLinearAbstractRealVector_init(self);
...
void OrgApacheCommonsMathLinearOpenMapRealVector_initWithOrgApacheCommonsMathLinearOpenMapRealVector_withInt_(OrgApacheCommonsMathLinearOpenMapRealVector *self, OrgApacheCommonsMathLinearOpenMapRealVector *v, jint resize) {
  ...
  self->entries_ = new_OrgApacheCommonsMathUtilOpenIntToDoubleHashMap_initWithOrgApacheCommonsMathUtilOpenIntToDoubleHashMap_(v->entries_);
...
void OrgApacheCommonsMathLinearOpenMapRealVector_initWithInt_withInt_(OrgApacheCommonsMathLinearOpenMapRealVector *self, jint dimension, jint expectedSize) {
  (void) OrgApacheCommonsMathLinearOpenMapRealVector_initWithInt_withInt_withDouble_(self, dimension, expectedSize, OrgApacheCommonsMathLinearOpenMapRealVector_DEFAULT_ZERO_TOLERANCE);
}
...
void OrgApacheCommonsMathLinearOpenMapRealVector_initWithInt_withInt_withDouble_(OrgApacheCommonsMathLinearOpenMapRealVector *self, jint dimension, jint expectedSize, jdouble epsilon) {
  (void) OrgApacheCommonsMathLinearAbstractRealVector_init(self);
  self->virtualSize_ = dimension;
  self->entries_ = new_OrgApacheCommonsMathUtilOpenIntToDoubleHashMap_initWithInt_withDouble_(expectedSize, 0.0);
  self->epsilon_ = epsilon;
}
...
void OrgApacheCommonsMathLinearOpenMapRealVector_initWithDoubleArray_(OrgApacheCommonsMathLinearOpenMapRealVector *self, IOSDoubleArray *values) {
  (void) OrgApacheCommonsMathLinearOpenMapRealVector_initWithDoubleArray_withDouble_(self, values, OrgApacheCommonsMathLinearOpenMapRealVector_DEFAULT_ZERO_TOLERANCE);
}
...
void OrgApacheCommonsMathLinearOpenMapRealVector_initWithJavaLangDoubleArray_(OrgApacheCommonsMathLinearOpenMapRealVector *self, IOSObjectArray *values) {
  (void) OrgApacheCommonsMathLinearOpenMapRealVector_initWithJavaLangDoubleArray_withDouble_(self, values, OrgApacheCommonsMathLinearOpenMapRealVector_DEFAULT_ZERO_TOLERANCE);
}
...
void OrgApacheCommonsMathLinearOpenMapRealVector_initWithOrgApacheCommonsMathLinearOpenMapRealVector_(OrgApacheCommonsMathLinearOpenMapRealVector *self, OrgApacheCommonsMathLinearOpenMapRealVector *v) {
  ...
  self->entries_ = new_OrgApacheCommonsMathUtilOpenIntToDoubleHashMap_initWithOrgApacheCommonsMathUtilOpenIntToDoubleHashMap_(OrgApacheCommonsMathLinearOpenMapRealVector_getEntries(v));
  self->epsilon_ = v->epsilon_;
}
...
void OrgApacheCommonsMathLinearOpenMapRealVector_OpenMapEntry_initWithOrgApacheCommonsMathLinearOpenMapRealVector_withOrgApacheCommonsMathUtilOpenIntToDoubleHashMap_Iterator_(OrgApacheCommonsMathLinearOpenMapRealVector_OpenMapEntry *self, OrgApacheCommonsMathLinearOpenMapRealVector *outer$, OrgApacheCommonsMathUtilOpenIntToDoubleHashMap_Iterator *iter) {
  self->this$0_ = outer$;
  (void) OrgApacheCommonsMathLinearRealVector_Entry_init(self);
  self->iter_ = iter;
}
...
- (void)remove {
  @throw new_JavaLangUnsupportedOperationException_initWithNSString_(@"Not supported");
}
...
void OrgApacheCommonsMathLinearOpenMapRealVector_OpenMapSparseIterator_initWithOrgApacheCommonsMathLinearOpenMapRealVector_(OrgApacheCommonsMathLinearOpenMapRealVector_OpenMapSparseIterator *self, OrgApacheCommonsMathLinearOpenMapRealVector *outer$) {
  ...
  self->iter_ = [((OrgApacheCommonsMathUtilOpenIntToDoubleHashMap *) nil_chk(outer$->entries_)) iterator];
  self->current_ = new_OrgApacheCommonsMathLinearOpenMapRealVector_OpenMapEntry_initWithOrgApacheCommonsMathLinearOpenMapRealVector_withOrgApacheCommonsMathUtilOpenIntToDoubleHashMap_Iterator_(outer$, self->iter_);
}
