...
withOrgApacheCommonsMathFieldElement:(id<OrgApacheCommonsMathFieldElement>)increment {
  ...
  if ([((id<OrgApacheCommonsMathFieldElement>) nil_chk([((id<OrgApacheCommonsMathField>) nil_chk([self getField])) getZero])) isEqual:value]) {
    ...
    [entries_ putWithInt:key withOrgApacheCommonsMathFieldElement:value];
  }
}

- (id<OrgApacheCommonsMathLinearFieldMatrix>)copy__ {
  return [new_OrgApacheCommonsMathLinearSparseFieldMatrix_initWithOrgApacheCommonsMathLinearSparseFieldMatrix_(self) autorelease];
}

- (id<OrgApacheCommonsMathLinearFieldMatrix>)createMatrixWithInt:(jint)rowDimension
                                                         withInt:(jint)columnDimension {
  return [new_OrgApacheCommonsMathLinearSparseFieldMatrix_initWithOrgApacheCommonsMathField_withInt_withInt_([self getField], rowDimension, columnDimension) autorelease];
}
...
withOrgApacheCommonsMathFieldElement:(id<OrgApacheCommonsMathFieldElement>)value {
  ...
  [self checkColumnIndexWithInt:column];
  if ([((id<OrgApacheCommonsMathFieldElement>) nil_chk([((id<OrgApacheCommonsMathField>) nil_chk([self getField])) getZero])) isEqual:value]) {
    [((OrgApacheCommonsMathUtilOpenIntToFieldHashMap *) nil_chk(entries_)) removeWithInt:OrgApacheCommonsMathLinearSparseFieldMatrix_computeKeyWithInt_withInt_(self, row, column)];
  }
  else {
    [((OrgApacheCommonsMathUtilOpenIntToFieldHashMap *) nil_chk(entries_)) putWithInt:OrgApacheCommonsMathLinearSparseFieldMatrix_computeKeyWithInt_withInt_(self, row, column) withOrgApacheCommonsMathFieldElement:value];
  }
}
...
void OrgApacheCommonsMathLinearSparseFieldMatrix_initWithOrgApacheCommonsMathField_(OrgApacheCommonsMathLinearSparseFieldMatrix *self, id<OrgApacheCommonsMathField> field) {
  ...
  self->rows_ = 0;
  self->columns_ = 0;
  OrgApacheCommonsMathLinearSparseFieldMatrix_setAndConsume_entries_(self, new_OrgApacheCommonsMathUtilOpenIntToFieldHashMap_initWithOrgApacheCommonsMathField_(field));
}
...
void OrgApacheCommonsMathLinearSparseFieldMatrix_initWithOrgApacheCommonsMathLinearSparseFieldMatrix_(OrgApacheCommonsMathLinearSparseFieldMatrix *self, OrgApacheCommonsMathLinearSparseFieldMatrix *other) {
  OrgApacheCommonsMathLinearAbstractFieldMatrix_initWithOrgApacheCommonsMathField_withInt_withInt_(self, [((OrgApacheCommonsMathLinearSparseFieldMatrix *) nil_chk(other)) getField], [other getRowDimension], [other getColumnDimension]);
  self->rows_ = [other getRowDimension];
  self->columns_ = [other getColumnDimension];
  OrgApacheCommonsMathLinearSparseFieldMatrix_setAndConsume_entries_(self, new_OrgApacheCommonsMathUtilOpenIntToFieldHashMap_initWithOrgApacheCommonsMathUtilOpenIntToFieldHashMap_(other->entries_));
}
...
void OrgApacheCommonsMathLinearSparseFieldMatrix_initWithOrgApacheCommonsMathLinearFieldMatrix_(OrgApacheCommonsMathLinearSparseFieldMatrix *self, id<OrgApacheCommonsMathLinearFieldMatrix> other) {
  OrgApacheCommonsMathLinearAbstractFieldMatrix_initWithOrgApacheCommonsMathField_withInt_withInt_(self, [((id<OrgApacheCommonsMathLinearFieldMatrix>) nil_chk(other)) getField], [other getRowDimension], [other getColumnDimension]);
  self->rows_ = [other getRowDimension];
  self->columns_ = [other getColumnDimension];
  OrgApacheCommonsMathLinearSparseFieldMatrix_setAndConsume_entries_(self, new_OrgApacheCommonsMathUtilOpenIntToFieldHashMap_initWithOrgApacheCommonsMathField_([self getField]));
