...
- (id<OrgApacheCommonsMathLinearRealMatrix>)createMatrixWithInt:(jint)rowDimension
                                                        withInt:(jint)columnDimension {
  return new_OrgApacheCommonsMathLinearRealMatrixImpl_initWithInt_withInt_(rowDimension, columnDimension);
}

- (id<OrgApacheCommonsMathLinearRealMatrix>)copy__ {
  return new_OrgApacheCommonsMathLinearRealMatrixImpl_initWithDoubleArray2_withBoolean_(OrgApacheCommonsMathLinearRealMatrixImpl_copyOut(self), NO);
}
...
- (OrgApacheCommonsMathLinearRealMatrixImpl *)addWithOrgApacheCommonsMathLinearRealMatrixImpl:(OrgApacheCommonsMathLinearRealMatrixImpl *)m {
  ...
  return new_OrgApacheCommonsMathLinearRealMatrixImpl_initWithDoubleArray2_withBoolean_(outData, NO);
}
