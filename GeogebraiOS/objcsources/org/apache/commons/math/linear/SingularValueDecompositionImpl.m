...
- (id<OrgApacheCommonsMathLinearRealMatrix>)getUT {
  if (cachedUt_ == nil) {
    cachedUt_ = [((id<OrgApacheCommonsMathLinearRealMatrix>) nil_chk([self getU])) transpose];
  }
  return cachedUt_;
}
...
- (id<OrgApacheCommonsMathLinearRealMatrix>)getS {
  if (cachedS_ == nil) {
    cachedS_ = OrgApacheCommonsMathLinearMatrixUtils_createRealDiagonalMatrixWithDoubleArray_(singularValues_);
  }
  return cachedS_;
}
...
- (id<OrgApacheCommonsMathLinearRealMatrix>)getVT {
  if (cachedVt_ == nil) {
    cachedVt_ = [((id<OrgApacheCommonsMathLinearRealMatrix>) nil_chk([self getV])) transpose];
  }
  return cachedVt_;
}
...
- (id<OrgApacheCommonsMathLinearRealMatrix>)getCovarianceWithDouble:(jdouble)minSingularValue {
  ...
  if (dimension == 0) {
    @throw OrgApacheCommonsMathMathRuntimeException_createIllegalArgumentExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_TOO_LARGE_CUTOFF_SINGULAR_VALUE(), [IOSObjectArray newArrayWithObjects:(id[]){ JavaLangDouble_valueOfWithDouble_(minSingularValue), JavaLangDouble_valueOfWithDouble_(IOSDoubleArray_Get(singularValues_, 0)) } count:2 type:NSObject_class_()]);
  }
  IOSObjectArray *data = [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ dimension, p }];
  [((id<OrgApacheCommonsMathLinearRealMatrix>) nil_chk([self getVT])) walkInOptimizedOrderWithOrgApacheCommonsMathLinearRealMatrixPreservingVisitor:new_OrgApacheCommonsMathLinearSingularValueDecompositionImpl_$1_initWithOrgApacheCommonsMathLinearSingularValueDecompositionImpl_withDoubleArray2_(self, data) withInt:0 withInt:dimension - 1 withInt:0 withInt:p - 1];
  id<OrgApacheCommonsMathLinearRealMatrix> jv = new_OrgApacheCommonsMathLinearArray2DRowRealMatrix_initWithDoubleArray2_withBoolean_(data, NO);
...
- (id<OrgApacheCommonsMathLinearDecompositionSolver>)getSolver {
  return new_OrgApacheCommonsMathLinearSingularValueDecompositionImpl_Solver_initWithDoubleArray_withOrgApacheCommonsMathLinearRealMatrix_withOrgApacheCommonsMathLinearRealMatrix_withBoolean_(singularValues_, [self getUT], [self getV], [self getRank] == JavaLangMath_maxWithInt_withInt_(m_, n_));
}
...
void OrgApacheCommonsMathLinearSingularValueDecompositionImpl_initWithOrgApacheCommonsMathLinearRealMatrix_(OrgApacheCommonsMathLinearSingularValueDecompositionImpl *self, id<OrgApacheCommonsMathLinearRealMatrix> matrix) {
  ...
  IOSObjectArray *matATA = [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ self->n_, self->n_ }];
  ...
  IOSObjectArray *matAAT = [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ self->m_, self->m_ }];
  ...
  if (self->m_ >= self->n_) {
    p = self->n_;
    self->eigenDecomposition_ = new_OrgApacheCommonsMathLinearEigenDecompositionImpl_initWithOrgApacheCommonsMathLinearRealMatrix_withDouble_(new_OrgApacheCommonsMathLinearArray2DRowRealMatrix_initWithDoubleArray2_(matATA), 1.0);
    self->singularValues_ = [self->eigenDecomposition_ getRealEigenvalues];
    self->cachedV_ = [self->eigenDecomposition_ getV];
    self->eigenDecomposition_ = new_OrgApacheCommonsMathLinearEigenDecompositionImpl_initWithOrgApacheCommonsMathLinearRealMatrix_withDouble_(new_OrgApacheCommonsMathLinearArray2DRowRealMatrix_initWithDoubleArray2_(matAAT), 1.0);
    self->cachedU_ = [((id<OrgApacheCommonsMathLinearRealMatrix>) nil_chk([self->eigenDecomposition_ getV])) getSubMatrixWithInt:0 withInt:self->m_ - 1 withInt:0 withInt:p - 1];
  }
  else {
    p = self->m_;
    self->eigenDecomposition_ = new_OrgApacheCommonsMathLinearEigenDecompositionImpl_initWithOrgApacheCommonsMathLinearRealMatrix_withDouble_(new_OrgApacheCommonsMathLinearArray2DRowRealMatrix_initWithDoubleArray2_(matAAT), 1.0);
    self->singularValues_ = [self->eigenDecomposition_ getRealEigenvalues];
    self->cachedU_ = [self->eigenDecomposition_ getV];
    self->eigenDecomposition_ = new_OrgApacheCommonsMathLinearEigenDecompositionImpl_initWithOrgApacheCommonsMathLinearRealMatrix_withDouble_(new_OrgApacheCommonsMathLinearArray2DRowRealMatrix_initWithDoubleArray2_(matATA), 1.0);
    self->cachedV_ = [((id<OrgApacheCommonsMathLinearRealMatrix>) nil_chk([self->eigenDecomposition_ getV])) getSubMatrixWithInt:0 withInt:self->n_ - 1 withInt:0 withInt:p - 1];
  }
  for (jint i = 0; i < p; i++) {
...
void OrgApacheCommonsMathLinearSingularValueDecompositionImpl_Solver_initWithDoubleArray_withOrgApacheCommonsMathLinearRealMatrix_withOrgApacheCommonsMathLinearRealMatrix_withBoolean_(OrgApacheCommonsMathLinearSingularValueDecompositionImpl_Solver *self, IOSDoubleArray *singularValues, id<OrgApacheCommonsMathLinearRealMatrix> uT, id<OrgApacheCommonsMathLinearRealMatrix> v, jboolean nonSingular) {
  ...
  self->pseudoInverse_ = [((id<OrgApacheCommonsMathLinearRealMatrix>) nil_chk(v)) multiplyWithOrgApacheCommonsMathLinearRealMatrix:new_OrgApacheCommonsMathLinearArray2DRowRealMatrix_initWithDoubleArray2_withBoolean_(suT, NO)];
