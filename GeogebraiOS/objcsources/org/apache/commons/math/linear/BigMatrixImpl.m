...
- (id<OrgApacheCommonsMathLinearBigMatrix>)copy__ {
  return new_OrgApacheCommonsMathLinearBigMatrixImpl_initWithJavaMathBigDecimalArray2_withBoolean_(OrgApacheCommonsMathLinearBigMatrixImpl_copyOut(self), NO);
}
...
- (id<OrgApacheCommonsMathLinearBigMatrix>)addWithOrgApacheCommonsMathLinearBigMatrix:(id<OrgApacheCommonsMathLinearBigMatrix>)m {
  ...
  @catch (JavaLangClassCastException *cce) {
    ...
    IOSObjectArray *outData = [IOSObjectArray newArrayWithDimensions:2 lengths:(jint[]){ rowCount, columnCount } type:JavaMathBigDecimal_class_()];
    for (jint row = 0; row < rowCount; row++) {
      ...
      for (jint col = 0; col < columnCount; col++) {
        (void) IOSObjectArray_Set(nil_chk(outDataRow), col, [((JavaMathBigDecimal *) nil_chk(IOSObjectArray_Get(nil_chk(dataRow), col))) addWithJavaMathBigDecimal:[((id<OrgApacheCommonsMathLinearBigMatrix>) nil_chk(m)) getEntryWithInt:row withInt:col]]);
      }
    }
    return new_OrgApacheCommonsMathLinearBigMatrixImpl_initWithJavaMathBigDecimalArray2_withBoolean_(outData, NO);
  }
}
...
- (OrgApacheCommonsMathLinearBigMatrixImpl *)addWithOrgApacheCommonsMathLinearBigMatrixImpl:(OrgApacheCommonsMathLinearBigMatrixImpl *)m {
  ...
  for (jint row = 0; row < rowCount; row++) {
    ...
    IOSObjectArray *outDataRow = IOSObjectArray_Get(outData, row);
    for (jint col = 0; col < columnCount; col++) {
      (void) IOSObjectArray_Set(nil_chk(outDataRow), col, [((JavaMathBigDecimal *) nil_chk(IOSObjectArray_Get(nil_chk(dataRow), col))) addWithJavaMathBigDecimal:IOSObjectArray_Get(nil_chk(mRow), col)]);
    }
  }
  return new_OrgApacheCommonsMathLinearBigMatrixImpl_initWithJavaMathBigDecimalArray2_withBoolean_(outData, NO);
}
...
- (id<OrgApacheCommonsMathLinearBigMatrix>)subtractWithOrgApacheCommonsMathLinearBigMatrix:(id<OrgApacheCommonsMathLinearBigMatrix>)m {
  ...
  @catch (JavaLangClassCastException *cce) {
    ...
    for (jint row = 0; row < rowCount; row++) {
      ...
      IOSObjectArray *outDataRow = IOSObjectArray_Get(outData, row);
      for (jint col = 0; col < columnCount; col++) {
        (void) IOSObjectArray_Set(nil_chk(outDataRow), col, [((JavaMathBigDecimal *) nil_chk(IOSObjectArray_Get(nil_chk(dataRow), col))) subtractWithJavaMathBigDecimal:[self getEntryWithInt:row withInt:col]]);
      }
    }
    return new_OrgApacheCommonsMathLinearBigMatrixImpl_initWithJavaMathBigDecimalArray2_withBoolean_(outData, NO);
  }
...
- (OrgApacheCommonsMathLinearBigMatrixImpl *)subtractWithOrgApacheCommonsMathLinearBigMatrixImpl:(OrgApacheCommonsMathLinearBigMatrixImpl *)m {
  ...
  for (jint row = 0; row < rowCount; row++) {
    ...
    IOSObjectArray *outDataRow = IOSObjectArray_Get(outData, row);
    for (jint col = 0; col < columnCount; col++) {
      (void) IOSObjectArray_Set(nil_chk(outDataRow), col, [((JavaMathBigDecimal *) nil_chk(IOSObjectArray_Get(nil_chk(dataRow), col))) subtractWithJavaMathBigDecimal:IOSObjectArray_Get(nil_chk(mRow), col)]);
    }
  }
  return new_OrgApacheCommonsMathLinearBigMatrixImpl_initWithJavaMathBigDecimalArray2_withBoolean_(outData, NO);
}
...
- (id<OrgApacheCommonsMathLinearBigMatrix>)scalarAddWithJavaMathBigDecimal:(JavaMathBigDecimal *)d {
  ...
  for (jint row = 0; row < rowCount; row++) {
    ...
    IOSObjectArray *outDataRow = IOSObjectArray_Get(outData, row);
    for (jint col = 0; col < columnCount; col++) {
      (void) IOSObjectArray_Set(nil_chk(outDataRow), col, [((JavaMathBigDecimal *) nil_chk(IOSObjectArray_Get(nil_chk(dataRow), col))) addWithJavaMathBigDecimal:d]);
    }
  }
  return new_OrgApacheCommonsMathLinearBigMatrixImpl_initWithJavaMathBigDecimalArray2_withBoolean_(outData, NO);
}
...
- (id<OrgApacheCommonsMathLinearBigMatrix>)scalarMultiplyWithJavaMathBigDecimal:(JavaMathBigDecimal *)d {
  ...
  for (jint row = 0; row < rowCount; row++) {
    ...
    IOSObjectArray *outDataRow = IOSObjectArray_Get(outData, row);
    for (jint col = 0; col < columnCount; col++) {
      (void) IOSObjectArray_Set(nil_chk(outDataRow), col, [((JavaMathBigDecimal *) nil_chk(IOSObjectArray_Get(nil_chk(dataRow), col))) multiplyWithJavaMathBigDecimal:d]);
    }
  }
  return new_OrgApacheCommonsMathLinearBigMatrixImpl_initWithJavaMathBigDecimalArray2_withBoolean_(outData, NO);
}
...
- (id<OrgApacheCommonsMathLinearBigMatrix>)multiplyWithOrgApacheCommonsMathLinearBigMatrix:(id<OrgApacheCommonsMathLinearBigMatrix>)m {
  ...
  @catch (JavaLangClassCastException *cce) {
    ...
    IOSObjectArray *outData = [IOSObjectArray newArrayWithDimensions:2 lengths:(jint[]){ nRows, nCols } type:JavaMathBigDecimal_class_()];
...
- (IOSObjectArray *)getDataAsDoubleArray {
  ...
  IOSObjectArray *d = [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ nRows, nCols }];
...
- (id<OrgApacheCommonsMathLinearBigMatrix>)getSubMatrixWithInt:(jint)startRow
  ...
  if (startColumn > endColumn) {
    @throw new_OrgApacheCommonsMathLinearMatrixIndexException_initWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_INITIAL_COLUMN_AFTER_FINAL_COLUMN(), [IOSObjectArray newArrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(startColumn), JavaLangInteger_valueOfWithInt_(endColumn) } count:2 type:NSObject_class_()]);
  }
  IOSObjectArray *subMatrixData = [IOSObjectArray newArrayWithDimensions:2 lengths:(jint[]){ endRow - startRow + 1, endColumn - startColumn + 1 } type:JavaMathBigDecimal_class_()];
  ...
  return new_OrgApacheCommonsMathLinearBigMatrixImpl_initWithJavaMathBigDecimalArray2_withBoolean_(subMatrixData, NO);
}
...
- (id<OrgApacheCommonsMathLinearBigMatrix>)getSubMatrixWithIntArray:(IOSIntArray *)selectedRows
  ...
  if (((IOSIntArray *) nil_chk(selectedRows))->size_ * ((IOSIntArray *) nil_chk(selectedColumns))->size_ == 0) {
    if (selectedRows->size_ == 0) {
      @throw new_OrgApacheCommonsMathLinearMatrixIndexException_initWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_EMPTY_SELECTED_ROW_INDEX_ARRAY(), [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
    }
    @throw new_OrgApacheCommonsMathLinearMatrixIndexException_initWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_EMPTY_SELECTED_COLUMN_INDEX_ARRAY(), [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
  }
  IOSObjectArray *subMatrixData = [IOSObjectArray newArrayWithDimensions:2 lengths:(jint[]){ selectedRows->size_, selectedColumns->size_ } type:JavaMathBigDecimal_class_()];
  @try {
    for (jint i = 0; i < selectedRows->size_; i++) {
      ...
      for (jint j = 0; j < selectedColumns->size_; j++) {
        (void) IOSObjectArray_Set(nil_chk(subI), j, IOSObjectArray_Get(nil_chk(dataSelectedI), IOSIntArray_Get(selectedColumns, j)));
      }
    }
  }
...
- (void)setSubMatrixWithJavaMathBigDecimalArray2:(IOSObjectArray *)subMatrix
  ...
  if (data_ == nil) {
    ...
    data_ = [IOSObjectArray newArrayWithDimensions:2 lengths:(jint[]){ nRows, nCols } type:JavaMathBigDecimal_class_()];
...
- (id<OrgApacheCommonsMathLinearBigMatrix>)getRowMatrixWithInt:(jint)row {
  OrgApacheCommonsMathLinearMatrixUtils_checkRowIndexWithOrgApacheCommonsMathLinearAnyMatrix_withInt_(self, row);
  jint ncols = [self getColumnDimension];
  IOSObjectArray *out = [IOSObjectArray newArrayWithDimensions:2 lengths:(jint[]){ 1, ncols } type:JavaMathBigDecimal_class_()];
  ...
  return new_OrgApacheCommonsMathLinearBigMatrixImpl_initWithJavaMathBigDecimalArray2_withBoolean_(out, NO);
}

- (id<OrgApacheCommonsMathLinearBigMatrix>)getColumnMatrixWithInt:(jint)column {
  OrgApacheCommonsMathLinearMatrixUtils_checkColumnIndexWithOrgApacheCommonsMathLinearAnyMatrix_withInt_(self, column);
  jint nRows = [self getRowDimension];
  IOSObjectArray *out = [IOSObjectArray newArrayWithDimensions:2 lengths:(jint[]){ nRows, 1 } type:JavaMathBigDecimal_class_()];
  for (jint row = 0; row < nRows; row++) {
    (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(out, row)), 0, IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(nil_chk(data_), row)), column));
  }
  return new_OrgApacheCommonsMathLinearBigMatrixImpl_initWithJavaMathBigDecimalArray2_withBoolean_(out, NO);
}
...
- (IOSObjectArray *)getRowWithInt:(jint)row {
  OrgApacheCommonsMathLinearMatrixUtils_checkRowIndexWithOrgApacheCommonsMathLinearAnyMatrix_withInt_(self, row);
  jint ncols = [self getColumnDimension];
  IOSObjectArray *out = [IOSObjectArray newArrayWithLength:ncols type:JavaMathBigDecimal_class_()];
...
- (IOSObjectArray *)getColumnWithInt:(jint)col {
  ...
  jint nRows = [self getRowDimension];
  IOSObjectArray *out = [IOSObjectArray newArrayWithLength:nRows type:JavaMathBigDecimal_class_()];
  for (jint i = 0; i < nRows; i++) {
    (void) IOSObjectArray_Set(out, i, IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(nil_chk(data_), i)), col));
  }
  return out;
}
...
- (id<OrgApacheCommonsMathLinearBigMatrix>)transpose {
  jint nRows = [self getRowDimension];
  jint nCols = [self getColumnDimension];
  IOSObjectArray *outData = [IOSObjectArray newArrayWithDimensions:2 lengths:(jint[]){ nCols, nRows } type:JavaMathBigDecimal_class_()];
  for (jint row = 0; row < nRows; row++) {
    IOSObjectArray *dataRow = IOSObjectArray_Get(nil_chk(data_), row);
    for (jint col = 0; col < nCols; col++) {
      (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(outData, col)), row, IOSObjectArray_Get(nil_chk(dataRow), col));
    }
  }
  return new_OrgApacheCommonsMathLinearBigMatrixImpl_initWithJavaMathBigDecimalArray2_withBoolean_(outData, NO);
}
...
- (JavaMathBigDecimal *)getDeterminant {
  if (![self isSquare]) {
    @throw new_OrgApacheCommonsMathLinearNonSquareMatrixException_initWithInt_withInt_([self getRowDimension], [self getColumnDimension]);
  }
  if ([self isSingular]) {
...
- (IOSObjectArray *)operateWithJavaMathBigDecimalArray:(IOSObjectArray *)v {
  ...
  for (jint row = 0; row < nRows; row++) {
    ...
    (void) IOSObjectArray_Set(out, row, sum);
  }
  return out;
}

- (IOSObjectArray *)operateWithDoubleArray:(IOSDoubleArray *)v {
  IOSObjectArray *bd = [IOSObjectArray newArrayWithLength:((IOSDoubleArray *) nil_chk(v))->size_ type:JavaMathBigDecimal_class_()];
  for (jint i = 0; i < bd->size_; i++) {
    (void) IOSObjectArray_Set(bd, i, new_JavaMathBigDecimal_initWithDouble_(IOSDoubleArray_Get(v, i)));
  }
...
- (IOSObjectArray *)preMultiplyWithJavaMathBigDecimalArray:(IOSObjectArray *)v {
  ...
  for (jint col = 0; col < nCols; col++) {
    ...
    (void) IOSObjectArray_Set(out, col, sum);
  }
  return out;
}
...
- (IOSObjectArray *)solveWithJavaMathBigDecimalArray:(IOSObjectArray *)b {
  ...
  id<OrgApacheCommonsMathLinearBigMatrix> bMatrix = new_OrgApacheCommonsMathLinearBigMatrixImpl_initWithJavaMathBigDecimalArray_(b);
  ...
  IOSObjectArray *out = [IOSObjectArray newArrayWithLength:nRows type:JavaMathBigDecimal_class_()];
  for (jint row = 0; row < nRows; row++) {
    (void) IOSObjectArray_Set(out, row, IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(nil_chk(solution), row)), 0));
  }
  return out;
}

- (IOSObjectArray *)solveWithDoubleArray:(IOSDoubleArray *)b {
  IOSObjectArray *bd = [IOSObjectArray newArrayWithLength:((IOSDoubleArray *) nil_chk(b))->size_ type:JavaMathBigDecimal_class_()];
  for (jint i = 0; i < bd->size_; i++) {
    (void) IOSObjectArray_Set(bd, i, new_JavaMathBigDecimal_initWithDouble_(IOSDoubleArray_Get(b, i)));
  }
...
- (id<OrgApacheCommonsMathLinearBigMatrix>)solveWithOrgApacheCommonsMathLinearBigMatrix:(id<OrgApacheCommonsMathLinearBigMatrix>)b {
  ...
  IOSObjectArray *bp = [IOSObjectArray newArrayWithDimensions:2 lengths:(jint[]){ nRowB, nColB } type:JavaMathBigDecimal_class_()];
  for (jint row = 0; row < nRowB; row++) {
    IOSObjectArray *bpRow = IOSObjectArray_Get(bp, row);
    for (jint col = 0; col < nColB; col++) {
      (void) IOSObjectArray_Set(nil_chk(bpRow), col, [b getEntryWithInt:IOSIntArray_Get(nil_chk(permutation_), row) withInt:col]);
    }
  }
  for (jint col = 0; col < nCol; col++) {
    for (jint i = col + 1; i < nCol; i++) {
      ...
      for (jint j = 0; j < nColB; j++) {
        (void) IOSObjectArray_Set(nil_chk(bpI), j, [((JavaMathBigDecimal *) nil_chk(IOSObjectArray_Get(bpI, j))) subtractWithJavaMathBigDecimal:[((JavaMathBigDecimal *) nil_chk(IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(bp, col)), j))) multiplyWithJavaMathBigDecimal:IOSObjectArray_Get(nil_chk(luI), col)]]);
      }
    }
  }
  for (jint col = nCol - 1; col >= 0; col--) {
    ...
    for (jint j = 0; j < nColB; j++) {
      (void) IOSObjectArray_Set(nil_chk(bpCol), j, [((JavaMathBigDecimal *) nil_chk(IOSObjectArray_Get(bpCol, j))) divideWithJavaMathBigDecimal:luDiag withInt:scale__ withInt:roundingMode_]);
    }
  ...
  return new_OrgApacheCommonsMathLinearBigMatrixImpl_initWithJavaMathBigDecimalArray2_withBoolean_(bp, NO);
}
...
- (void)luDecompose {
  ...
  lu_ = [self getData];
  permutation_ = [IOSIntArray newArrayWithLength:nRows];
  for (jint row = 0; row < nRows; row++) {
  ...
  for (jint col = 0; col < nCols; col++) {
    ...
    for (jint row = 0; row < col; row++) {
      ...
      (void) IOSObjectArray_Set(luRow, col, sum);
    }
    jint max = col;
    ...
    if (max != col) {
      ...
      for (jint i = 0; i < nCols; i++) {
        ...
        (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(lu_, max)), i, IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(lu_, col)), i));
        (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(lu_, col)), i, tmp);
      }
    ...
    for (jint row = col + 1; row < nRows; row++) {
      ...
      (void) IOSObjectArray_Set(nil_chk(luRow), col, [((JavaMathBigDecimal *) nil_chk(IOSObjectArray_Get(luRow, col))) divideWithJavaMathBigDecimal:luDiag withInt:scale__ withInt:roundingMode_]);
    }
  }
}
...
- (NSString *)description {
  ...
  (void) [res appendWithNSString:@"BigMatrixImpl{"];
  if (data_ != nil) {
    for (jint i = 0; i < data_->size_; i++) {
      ...
      for (jint j = 0; j < ((IOSObjectArray *) nil_chk(IOSObjectArray_Get(data_, 0)))->size_; j++) {
        ...
        (void) [res appendWithId:IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(data_, i)), j)];
      }
      (void) [res appendWithNSString:@"}"];
    }
  }
...
- (id<OrgApacheCommonsMathLinearBigMatrix>)getLUMatrix {
  ...
  return new_OrgApacheCommonsMathLinearBigMatrixImpl_initWithJavaMathBigDecimalArray2_(lu_);
}

- (IOSIntArray *)getPermutation {
  IOSIntArray *out = [IOSIntArray newArrayWithLength:((IOSIntArray *) nil_chk(permutation_))->size_];
...
+ (void)initialize {
  if (self == [OrgApacheCommonsMathLinearBigMatrixImpl class]) {
    OrgApacheCommonsMathLinearBigMatrixImpl_ZERO_ = new_JavaMathBigDecimal_initWithInt_(0);
    OrgApacheCommonsMathLinearBigMatrixImpl_ONE_ = new_JavaMathBigDecimal_initWithInt_(1);
    OrgApacheCommonsMathLinearBigMatrixImpl_TOO_SMALL_ = new_JavaMathBigDecimal_initWithDouble_(10E-12);
...
void OrgApacheCommonsMathLinearBigMatrixImpl_initWithInt_withInt_(OrgApacheCommonsMathLinearBigMatrixImpl *self, jint rowDimension, jint columnDimension) {
  ...
  self->data_ = [IOSObjectArray newArrayWithDimensions:2 lengths:(jint[]){ rowDimension, columnDimension } type:JavaMathBigDecimal_class_()];
  self->lu_ = nil;
}
...
void OrgApacheCommonsMathLinearBigMatrixImpl_initWithJavaMathBigDecimalArray_(OrgApacheCommonsMathLinearBigMatrixImpl *self, IOSObjectArray *v) {
  ...
  self->data_ = [IOSObjectArray newArrayWithDimensions:2 lengths:(jint[]){ nRows, 1 } type:JavaMathBigDecimal_class_()];
  for (jint row = 0; row < nRows; row++) {
    (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(self->data_, row)), 0, IOSObjectArray_Get(v, row));
  }
}
...
IOSObjectArray *OrgApacheCommonsMathLinearBigMatrixImpl_copyOut(OrgApacheCommonsMathLinearBigMatrixImpl *self) {
  jint nRows = [self getRowDimension];
  IOSObjectArray *out = [IOSObjectArray newArrayWithDimensions:2 lengths:(jint[]){ nRows, [self getColumnDimension] } type:JavaMathBigDecimal_class_()];
  for (jint i = 0; i < nRows; i++) {
...
void OrgApacheCommonsMathLinearBigMatrixImpl_copyInWithDoubleArray2_(OrgApacheCommonsMathLinearBigMatrixImpl *self, IOSObjectArray *inArg) {
  ...
  self->data_ = [IOSObjectArray newArrayWithDimensions:2 lengths:(jint[]){ nRows, nCols } type:JavaMathBigDecimal_class_()];
  for (jint i = 0; i < nRows; i++) {
    IOSObjectArray *dataI = IOSObjectArray_Get(self->data_, i);
    IOSDoubleArray *inI = IOSObjectArray_Get(inArg, i);
    for (jint j = 0; j < nCols; j++) {
      (void) IOSObjectArray_Set(nil_chk(dataI), j, new_JavaMathBigDecimal_initWithDouble_(IOSDoubleArray_Get(nil_chk(inI), j)));
    }
  }
  self->lu_ = nil;
}
...
void OrgApacheCommonsMathLinearBigMatrixImpl_copyInWithNSStringArray2_(OrgApacheCommonsMathLinearBigMatrixImpl *self, IOSObjectArray *inArg) {
  ...
  for (jint i = 0; i < nRows; i++) {
    ...
    for (jint j = 0; j < nCols; j++) {
      (void) IOSObjectArray_Set(nil_chk(dataI), j, new_JavaMathBigDecimal_initWithNSString_(IOSObjectArray_Get(nil_chk(inI), j)));
    }
  }
  self->lu_ = nil;
}
