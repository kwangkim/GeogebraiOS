...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/apache/commons/math/linear/SparseFieldVector.java
//
...
- (id<OrgApacheCommonsMathLinearFieldVector>)addWithOrgApacheCommonsMathFieldElementArray:(IOSObjectArray *)v {
  ...
  OrgApacheCommonsMathLinearSparseFieldVector *res = new_OrgApacheCommonsMathLinearSparseFieldVector_initWithOrgApacheCommonsMathField_withInt_(field_, [self getDimension]);
...
- (id<OrgApacheCommonsMathLinearFieldVector>)appendWithOrgApacheCommonsMathLinearSparseFieldVector:(OrgApacheCommonsMathLinearSparseFieldVector *)v {
  OrgApacheCommonsMathLinearSparseFieldVector *res = new_OrgApacheCommonsMathLinearSparseFieldVector_initWithOrgApacheCommonsMathLinearSparseFieldVector_withInt_(self, [((OrgApacheCommonsMathLinearSparseFieldVector *) nil_chk(v)) getDimension]);
...
- (id<OrgApacheCommonsMathLinearFieldVector>)appendWithOrgApacheCommonsMathFieldElement:(id<OrgApacheCommonsMathFieldElement>)d {
  id<OrgApacheCommonsMathLinearFieldVector> res = new_OrgApacheCommonsMathLinearSparseFieldVector_initWithOrgApacheCommonsMathLinearSparseFieldVector_withInt_(self, 1);
...
- (id<OrgApacheCommonsMathLinearFieldVector>)appendWithOrgApacheCommonsMathFieldElementArray:(IOSObjectArray *)a {
  id<OrgApacheCommonsMathLinearFieldVector> res = new_OrgApacheCommonsMathLinearSparseFieldVector_initWithOrgApacheCommonsMathLinearSparseFieldVector_withInt_(self, ((IOSObjectArray *) nil_chk(a))->size_);
...
- (id<OrgApacheCommonsMathLinearFieldVector>)copy__ {
  return new_OrgApacheCommonsMathLinearSparseFieldVector_initWithOrgApacheCommonsMathLinearSparseFieldVector_(self);
}
...
- (id<OrgApacheCommonsMathLinearFieldVector>)ebeDivideWithOrgApacheCommonsMathLinearFieldVector:(id<OrgApacheCommonsMathLinearFieldVector>)v {
  [self checkVectorDimensionsWithInt:[((id<OrgApacheCommonsMathLinearFieldVector>) nil_chk(v)) getDimension]];
  OrgApacheCommonsMathLinearSparseFieldVector *res = new_OrgApacheCommonsMathLinearSparseFieldVector_initWithOrgApacheCommonsMathLinearSparseFieldVector_(self);
...
- (IOSObjectArray *)getData {
  ...
  while ([((OrgApacheCommonsMathUtilOpenIntToFieldHashMap_Iterator *) nil_chk(iter)) hasNext]) {
    [iter advance];
    (void) IOSObjectArray_Set(nil_chk(res), [iter key], [iter value]);
  }
  return res;
}
...
- (id<OrgApacheCommonsMathLinearFieldVector>)getSubVectorWithInt:(jint)index
  ...
  OrgApacheCommonsMathLinearSparseFieldVector *res = new_OrgApacheCommonsMathLinearSparseFieldVector_initWithOrgApacheCommonsMathField_withInt_(field_, n);
  jint end = index + n;
  OrgApacheCommonsMathUtilOpenIntToFieldHashMap_Iterator *iter = [((OrgApacheCommonsMathUtilOpenIntToFieldHashMap *) nil_chk(entries_)) iterator];
  while ([((OrgApacheCommonsMathUtilOpenIntToFieldHashMap_Iterator *) nil_chk(iter)) hasNext]) {
    [iter advance];
...
- (id<OrgApacheCommonsMathLinearFieldVector>)mapDivideToSelfWithOrgApacheCommonsMathFieldElement:(id<OrgApacheCommonsMathFieldElement>)d {
  ...
  while ([((OrgApacheCommonsMathUtilOpenIntToFieldHashMap_Iterator *) nil_chk(iter)) hasNext]) {
    [iter advance];
    (void) [entries_ putWithInt:[iter key] withOrgApacheCommonsMathFieldElement:[((id<OrgApacheCommonsMathFieldElement>) nil_chk([iter value])) divideWithId:d]];
  }
  return self;
}
...
- (id<OrgApacheCommonsMathLinearFieldVector>)mapMultiplyToSelfWithOrgApacheCommonsMathFieldElement:(id<OrgApacheCommonsMathFieldElement>)d {
  ...
  while ([((OrgApacheCommonsMathUtilOpenIntToFieldHashMap_Iterator *) nil_chk(iter)) hasNext]) {
    [iter advance];
    (void) [entries_ putWithInt:[iter key] withOrgApacheCommonsMathFieldElement:[((id<OrgApacheCommonsMathFieldElement>) nil_chk([iter value])) multiplyWithId:d]];
  }
  return self;
}
...
- (id<OrgApacheCommonsMathLinearFieldMatrix>)outerProductWithOrgApacheCommonsMathLinearSparseFieldVector:(OrgApacheCommonsMathLinearSparseFieldVector *)v {
  [self checkVectorDimensionsWithInt:[((OrgApacheCommonsMathLinearSparseFieldVector *) nil_chk(v)) getDimension]];
  OrgApacheCommonsMathLinearSparseFieldMatrix *res = new_OrgApacheCommonsMathLinearSparseFieldMatrix_initWithOrgApacheCommonsMathField_withInt_withInt_(field_, virtualSize_, virtualSize_);
  OrgApacheCommonsMathUtilOpenIntToFieldHashMap_Iterator *iter = [((OrgApacheCommonsMathUtilOpenIntToFieldHashMap *) nil_chk(entries_)) iterator];
  while ([((OrgApacheCommonsMathUtilOpenIntToFieldHashMap_Iterator *) nil_chk(iter)) hasNext]) {
    [iter advance];
...
- (id<OrgApacheCommonsMathLinearFieldMatrix>)outerProductWithOrgApacheCommonsMathFieldElementArray:(IOSObjectArray *)v {
  [self checkVectorDimensionsWithInt:((IOSObjectArray *) nil_chk(v))->size_];
  id<OrgApacheCommonsMathLinearFieldMatrix> res = new_OrgApacheCommonsMathLinearSparseFieldMatrix_initWithOrgApacheCommonsMathField_withInt_withInt_(field_, virtualSize_, virtualSize_);
  OrgApacheCommonsMathUtilOpenIntToFieldHashMap_Iterator *iter = [((OrgApacheCommonsMathUtilOpenIntToFieldHashMap *) nil_chk(entries_)) iterator];
  while ([((OrgApacheCommonsMathUtilOpenIntToFieldHashMap_Iterator *) nil_chk(iter)) hasNext]) {
    [iter advance];
    jint row = [iter key];
...
- (id<OrgApacheCommonsMathLinearFieldVector>)projectionWithOrgApacheCommonsMathFieldElementArray:(IOSObjectArray *)v {
  [self checkVectorDimensionsWithInt:((IOSObjectArray *) nil_chk(v))->size_];
  return [self projectionWithOrgApacheCommonsMathLinearFieldVector:new_OrgApacheCommonsMathLinearSparseFieldVector_initWithOrgApacheCommonsMathField_withOrgApacheCommonsMathFieldElementArray_(field_, v)];
}
...
withOrgApacheCommonsMathFieldElement:(id<OrgApacheCommonsMathFieldElement>)value {
  OrgApacheCommonsMathLinearSparseFieldVector_checkIndexWithInt_(self, index);
  (void) [((OrgApacheCommonsMathUtilOpenIntToFieldHashMap *) nil_chk(entries_)) putWithInt:index withOrgApacheCommonsMathFieldElement:value];
}
...
void OrgApacheCommonsMathLinearSparseFieldVector_initWithOrgApacheCommonsMathField_(OrgApacheCommonsMathLinearSparseFieldVector *self, id<OrgApacheCommonsMathField> field) {
  (void) OrgApacheCommonsMathLinearSparseFieldVector_initWithOrgApacheCommonsMathField_withInt_(self, field, 0);
}
...
void OrgApacheCommonsMathLinearSparseFieldVector_initWithOrgApacheCommonsMathLinearSparseFieldVector_withInt_(OrgApacheCommonsMathLinearSparseFieldVector *self, OrgApacheCommonsMathLinearSparseFieldVector *v, jint resize) {
  (void) NSObject_init(self);
  self->field_ = ((OrgApacheCommonsMathLinearSparseFieldVector *) nil_chk(v))->field_;
  self->virtualSize_ = [v getDimension] + resize;
  self->entries_ = new_OrgApacheCommonsMathUtilOpenIntToFieldHashMap_initWithOrgApacheCommonsMathUtilOpenIntToFieldHashMap_(v->entries_);
}
...
void OrgApacheCommonsMathLinearSparseFieldVector_initWithOrgApacheCommonsMathField_withInt_withInt_(OrgApacheCommonsMathLinearSparseFieldVector *self, id<OrgApacheCommonsMathField> field, jint dimension, jint expectedSize) {
  ...
  self->field_ = field;
  self->virtualSize_ = dimension;
  self->entries_ = new_OrgApacheCommonsMathUtilOpenIntToFieldHashMap_initWithOrgApacheCommonsMathField_withInt_(field, expectedSize);
}
...
void OrgApacheCommonsMathLinearSparseFieldVector_initWithOrgApacheCommonsMathField_withOrgApacheCommonsMathFieldElementArray_(OrgApacheCommonsMathLinearSparseFieldVector *self, id<OrgApacheCommonsMathField> field, IOSObjectArray *values) {
  ...
  for (jint key = 0; key < values->size_; key++) {
    ...
    (void) [self->entries_ putWithInt:key withOrgApacheCommonsMathFieldElement:value];
  }
}
...
void OrgApacheCommonsMathLinearSparseFieldVector_initWithOrgApacheCommonsMathLinearSparseFieldVector_(OrgApacheCommonsMathLinearSparseFieldVector *self, OrgApacheCommonsMathLinearSparseFieldVector *v) {
  ...
  self->entries_ = new_OrgApacheCommonsMathUtilOpenIntToFieldHashMap_initWithOrgApacheCommonsMathUtilOpenIntToFieldHashMap_(OrgApacheCommonsMathLinearSparseFieldVector_getEntries(v));
}
