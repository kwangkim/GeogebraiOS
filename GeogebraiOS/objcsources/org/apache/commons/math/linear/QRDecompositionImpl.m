...
- (id<OrgApacheCommonsMathLinearRealMatrix>)getR {
  if (cachedR_ == nil) {
    ...
    cachedR_ = OrgApacheCommonsMathLinearMatrixUtils_createRealMatrixWithInt_withInt_(m, n);
...
- (id<OrgApacheCommonsMathLinearRealMatrix>)getQ {
  if (cachedQ_ == nil) {
    cachedQ_ = [((id<OrgApacheCommonsMathLinearRealMatrix>) nil_chk([self getQT])) transpose];
  }
  return cachedQ_;
}
...
- (id<OrgApacheCommonsMathLinearRealMatrix>)getQT {
  if (cachedQT_ == nil) {
    jint n = ((IOSObjectArray *) nil_chk(qrt_))->size_;
    jint m = ((IOSDoubleArray *) nil_chk(IOSObjectArray_Get(qrt_, 0)))->size_;
    cachedQT_ = OrgApacheCommonsMathLinearMatrixUtils_createRealMatrixWithInt_withInt_(m, m);
...
- (id<OrgApacheCommonsMathLinearRealMatrix>)getH {
  if (cachedH_ == nil) {
    jint n = ((IOSObjectArray *) nil_chk(qrt_))->size_;
    jint m = ((IOSDoubleArray *) nil_chk(IOSObjectArray_Get(qrt_, 0)))->size_;
    cachedH_ = OrgApacheCommonsMathLinearMatrixUtils_createRealMatrixWithInt_withInt_(m, n);
    for (jint i = 0; i < m; ++i) {
...
- (id<OrgApacheCommonsMathLinearDecompositionSolver>)getSolver {
  return new_OrgApacheCommonsMathLinearQRDecompositionImpl_Solver_initWithDoubleArray2_withDoubleArray_(qrt_, rDiag_);
}
...
void OrgApacheCommonsMathLinearQRDecompositionImpl_initWithOrgApacheCommonsMathLinearRealMatrix_(OrgApacheCommonsMathLinearQRDecompositionImpl *self, id<OrgApacheCommonsMathLinearRealMatrix> matrix) {
  ...
  self->qrt_ = [((id<OrgApacheCommonsMathLinearRealMatrix>) nil_chk([matrix transpose])) getData];
  self->rDiag_ = [IOSDoubleArray newArrayWithLength:OrgApacheCommonsMathUtilFastMath_minWithInt_withInt_(m, n)];
  self->cachedQ_ = nil;
  self->cachedQT_ = nil;
  self->cachedR_ = nil;
  self->cachedH_ = nil;
...
- (id<OrgApacheCommonsMathLinearRealVector>)solveWithOrgApacheCommonsMathLinearRealVector:(id<OrgApacheCommonsMathLinearRealVector>)b {
  ...
  @catch (JavaLangClassCastException *cce) {
    return new_OrgApacheCommonsMathLinearArrayRealVector_initWithDoubleArray_withBoolean_([self solveWithDoubleArray:[((id<OrgApacheCommonsMathLinearRealVector>) nil_chk(b)) getData]], NO);
  }
}
...
- (id<OrgApacheCommonsMathLinearRealMatrix>)solveWithOrgApacheCommonsMathLinearRealMatrix:(id<OrgApacheCommonsMathLinearRealMatrix>)b {
  ...
  IOSObjectArray *y = [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ [b getRowDimension], blockSize }];
  IOSDoubleArray *alpha = [IOSDoubleArray newArrayWithLength:blockSize];
  ...
  return new_OrgApacheCommonsMathLinearBlockRealMatrix_initWithInt_withInt_withDoubleArray2_withBoolean_(n, columns, xBlocks, NO);
}
