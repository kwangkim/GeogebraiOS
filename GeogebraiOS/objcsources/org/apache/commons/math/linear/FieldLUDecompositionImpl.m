...
- (id<OrgApacheCommonsMathLinearFieldMatrix>)getL {
  if ((cachedL_ == nil) && !singular_) {
    ...
    cachedL_ = new_OrgApacheCommonsMathLinearArray2DRowFieldMatrix_initWithOrgApacheCommonsMathField_withInt_withInt_(field_, m, m);
    for (jint i = 0; i < m; ++i) {
...
- (id<OrgApacheCommonsMathLinearFieldMatrix>)getU {
  if ((cachedU_ == nil) && !singular_) {
    jint m = ((IOSIntArray *) nil_chk(pivot_))->size_;
    cachedU_ = new_OrgApacheCommonsMathLinearArray2DRowFieldMatrix_initWithOrgApacheCommonsMathField_withInt_withInt_(field_, m, m);
    for (jint i = 0; i < m; ++i) {
      IOSObjectArray *luI = IOSObjectArray_Get(nil_chk(lu_), i);
      for (jint j = i; j < m; ++j) {
...
- (id<OrgApacheCommonsMathLinearFieldMatrix>)getP {
  if ((cachedP_ == nil) && !singular_) {
    jint m = ((IOSIntArray *) nil_chk(pivot_))->size_;
    cachedP_ = new_OrgApacheCommonsMathLinearArray2DRowFieldMatrix_initWithOrgApacheCommonsMathField_withInt_withInt_(field_, m, m);
    for (jint i = 0; i < m; ++i) {
...
- (id<OrgApacheCommonsMathLinearFieldDecompositionSolver>)getSolver {
  return new_OrgApacheCommonsMathLinearFieldLUDecompositionImpl_Solver_initWithOrgApacheCommonsMathField_withOrgApacheCommonsMathFieldElementArray2_withIntArray_withBoolean_(field_, lu_, pivot_, singular_);
}
  ...
  for (jint col = 0; col < m; col++) {
    ...
    if (nonZero != col) {
      ...
      for (jint i = 0; i < m; i++) {
        ...
        (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(self->lu_, nonZero)), i, IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(self->lu_, col)), i));
        (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(self->lu_, col)), i, tmp);
      }
    ...
    for (jint row = col + 1; row < m; row++) {
      ...
      (void) IOSObjectArray_Set(nil_chk(luRow), col, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(luRow, col))) divideWithId:luDiag]);
    }
  }
}
...
- (IOSObjectArray *)solveWithOrgApacheCommonsMathFieldElementArray:(IOSObjectArray *)b {
  ...
  for (jint row = 0; row < m; row++) {
    (void) IOSObjectArray_Set(nil_chk(bp), row, IOSObjectArray_Get(b, IOSIntArray_Get(pivot_, row)));
  }
  for (jint col = 0; col < m; col++) {
    id<OrgApacheCommonsMathFieldElement> bpCol = IOSObjectArray_Get(nil_chk(bp), col);
    for (jint i = col + 1; i < m; i++) {
      (void) IOSObjectArray_Set(bp, i, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(bp, i))) subtractWithId:[((id<OrgApacheCommonsMathFieldElement>) nil_chk(bpCol)) multiplyWithId:IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(nil_chk(lu_), i)), col)]]);
    }
  }
  for (jint col = m - 1; col >= 0; col--) {
    (void) IOSObjectArray_Set(nil_chk(bp), col, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(bp, col))) divideWithId:IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(nil_chk(lu_), col)), col)]);
    id<OrgApacheCommonsMathFieldElement> bpCol = IOSObjectArray_Get(bp, col);
    for (jint i = 0; i < col; i++) {
      (void) IOSObjectArray_Set(bp, i, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(bp, i))) subtractWithId:[((id<OrgApacheCommonsMathFieldElement>) nil_chk(bpCol)) multiplyWithId:IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(lu_, i)), col)]]);
    }
  }
  return bp;
}
...
- (id<OrgApacheCommonsMathLinearFieldVector>)solveWithOrgApacheCommonsMathLinearFieldVector:(id<OrgApacheCommonsMathLinearFieldVector>)b {
  ...
  @catch (JavaLangClassCastException *cce) {
    ...
    IOSObjectArray *bp = (IOSObjectArray *) check_class_cast(JavaLangReflectArray_newInstanceWithIOSClass_withInt_([((id<OrgApacheCommonsMathFieldElement>) nil_chk([((id<OrgApacheCommonsMathField>) nil_chk(field_)) getZero])) getClass], m), [IOSObjectArray class]);
    for (jint row = 0; row < m; row++) {
      (void) IOSObjectArray_Set(nil_chk(bp), row, [b getEntryWithInt:IOSIntArray_Get(pivot_, row)]);
    }
    for (jint col = 0; col < m; col++) {
      id<OrgApacheCommonsMathFieldElement> bpCol = IOSObjectArray_Get(nil_chk(bp), col);
      for (jint i = col + 1; i < m; i++) {
    ...
    return new_OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathFieldElementArray_withBoolean_(bp, NO);
  }
}

- (OrgApacheCommonsMathLinearArrayFieldVector *)solveWithOrgApacheCommonsMathLinearArrayFieldVector:(OrgApacheCommonsMathLinearArrayFieldVector *)b {
  return new_OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathFieldElementArray_withBoolean_([self solveWithOrgApacheCommonsMathFieldElementArray:[((OrgApacheCommonsMathLinearArrayFieldVector *) nil_chk(b)) getDataRef]], NO);
}
...
- (id<OrgApacheCommonsMathLinearFieldMatrix>)solveWithOrgApacheCommonsMathLinearFieldMatrix:(id<OrgApacheCommonsMathLinearFieldMatrix>)b {
  ...
  IOSObjectArray *bp = (IOSObjectArray *) check_class_cast(JavaLangReflectArray_newInstanceWithIOSClass_withIntArray_([((id<OrgApacheCommonsMathFieldElement>) nil_chk([((id<OrgApacheCommonsMathField>) nil_chk(field_)) getZero])) getClass], [IOSIntArray newArrayWithInts:(jint[]){ m, nColB } count:2]), [IOSObjectArray class]);
  for (jint row = 0; row < m; row++) {
    IOSObjectArray *bpRow = IOSObjectArray_Get(nil_chk(bp), row);
    jint pRow = IOSIntArray_Get(pivot_, row);
    for (jint col = 0; col < nColB; col++) {
      (void) IOSObjectArray_Set(nil_chk(bpRow), col, [b getEntryWithInt:pRow withInt:col]);
    }
  }
  for (jint col = 0; col < m; col++) {
    ...
    for (jint i = col + 1; i < m; i++) {
      ...
      for (jint j = 0; j < nColB; j++) {
        (void) IOSObjectArray_Set(nil_chk(bpI), j, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(bpI, j))) subtractWithId:[((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(nil_chk(bpCol), j))) multiplyWithId:luICol]]);
      }
    }
  }
  for (jint col = m - 1; col >= 0; col--) {
    ...
    for (jint j = 0; j < nColB; j++) {
      (void) IOSObjectArray_Set(nil_chk(bpCol), j, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(bpCol, j))) divideWithId:luDiag]);
    }
    for (jint i = 0; i < col; i++) {
      IOSObjectArray *bpI = IOSObjectArray_Get(bp, i);
  ...
  return new_OrgApacheCommonsMathLinearArray2DRowFieldMatrix_initWithOrgApacheCommonsMathFieldElementArray2_withBoolean_(bp, NO);
}

- (id<OrgApacheCommonsMathLinearFieldMatrix>)getInverse {
  jint m = ((IOSIntArray *) nil_chk(pivot_))->size_;
  id<OrgApacheCommonsMathFieldElement> one = [((id<OrgApacheCommonsMathField>) nil_chk(field_)) getOne];
  id<OrgApacheCommonsMathLinearFieldMatrix> identity = new_OrgApacheCommonsMathLinearArray2DRowFieldMatrix_initWithOrgApacheCommonsMathField_withInt_withInt_(field_, m, m);
  for (jint i = 0; i < m; ++i) {
