...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/apache/commons/math/linear/BlockFieldMatrix.java
//
...
- (id<OrgApacheCommonsMathLinearFieldMatrix>)createMatrixWithInt:(jint)rowDimension
  ...
  return new_OrgApacheCommonsMathLinearBlockFieldMatrix_initWithOrgApacheCommonsMathField_withInt_withInt_([self getField], rowDimension, columnDimension);
}

- (id<OrgApacheCommonsMathLinearFieldMatrix>)copy__ {
  OrgApacheCommonsMathLinearBlockFieldMatrix *copied = new_OrgApacheCommonsMathLinearBlockFieldMatrix_initWithOrgApacheCommonsMathField_withInt_withInt_([self getField], rows_, columns_);
...
- (id<OrgApacheCommonsMathLinearFieldMatrix>)addWithOrgApacheCommonsMathLinearFieldMatrix:(id<OrgApacheCommonsMathLinearFieldMatrix>)m {
  ...
  @catch (JavaLangClassCastException *cce) {
    ...
    OrgApacheCommonsMathLinearBlockFieldMatrix *out = new_OrgApacheCommonsMathLinearBlockFieldMatrix_initWithOrgApacheCommonsMathField_withInt_withInt_([self getField], rows_, columns_);
    jint blockIndex = 0;
      ...
      for (jint jBlock = 0; jBlock < out->blockColumns_; ++jBlock) {
        ...
        for (jint p = pStart; p < pEnd; ++p) {
          for (jint q = qStart; q < qEnd; ++q) {
            (void) IOSObjectArray_Set(nil_chk(outBlock), k, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(nil_chk(tBlock), k))) addWithId:[((id<OrgApacheCommonsMathLinearFieldMatrix>) nil_chk(m)) getEntryWithInt:p withInt:q]]);
            ++k;
          }
        }
        ++blockIndex;
...
- (OrgApacheCommonsMathLinearBlockFieldMatrix *)addWithOrgApacheCommonsMathLinearBlockFieldMatrix:(OrgApacheCommonsMathLinearBlockFieldMatrix *)m {
  ...
  for (jint blockIndex = 0; blockIndex < ((IOSObjectArray *) nil_chk(out->blocks_))->size_; ++blockIndex) {
    ...
    for (jint k = 0; k < ((IOSObjectArray *) nil_chk(outBlock))->size_; ++k) {
      (void) IOSObjectArray_Set(outBlock, k, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(nil_chk(tBlock), k))) addWithId:IOSObjectArray_Get(nil_chk(mBlock), k)]);
    }
  }
  return out;
}
  ...
  @catch (JavaLangClassCastException *cce) {
    ...
    for (jint iBlock = 0; iBlock < out->blockRows_; ++iBlock) {
      for (jint jBlock = 0; jBlock < out->blockColumns_; ++jBlock) {
        ...
        for (jint p = pStart; p < pEnd; ++p) {
          for (jint q = qStart; q < qEnd; ++q) {
            (void) IOSObjectArray_Set(nil_chk(outBlock), k, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(nil_chk(tBlock), k))) subtractWithId:[((id<OrgApacheCommonsMathLinearFieldMatrix>) nil_chk(m)) getEntryWithInt:p withInt:q]]);
            ++k;
          }
        }
        ++blockIndex;
...
- (OrgApacheCommonsMathLinearBlockFieldMatrix *)subtractWithOrgApacheCommonsMathLinearBlockFieldMatrix:(OrgApacheCommonsMathLinearBlockFieldMatrix *)m {
  ...
  for (jint blockIndex = 0; blockIndex < ((IOSObjectArray *) nil_chk(out->blocks_))->size_; ++blockIndex) {
    ...
    IOSObjectArray *mBlock = IOSObjectArray_Get(((OrgApacheCommonsMathLinearBlockFieldMatrix *) nil_chk(m))->blocks_, blockIndex);
    for (jint k = 0; k < ((IOSObjectArray *) nil_chk(outBlock))->size_; ++k) {
      (void) IOSObjectArray_Set(outBlock, k, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(nil_chk(tBlock), k))) subtractWithId:IOSObjectArray_Get(nil_chk(mBlock), k)]);
    }
  }
  return out;
}
...
- (id<OrgApacheCommonsMathLinearFieldMatrix>)scalarAddWithOrgApacheCommonsMathFieldElement:(id<OrgApacheCommonsMathFieldElement>)d {
  ...
  for (jint blockIndex = 0; blockIndex < ((IOSObjectArray *) nil_chk(out->blocks_))->size_; ++blockIndex) {
    ...
    IOSObjectArray *tBlock = IOSObjectArray_Get(blocks_, blockIndex);
    for (jint k = 0; k < ((IOSObjectArray *) nil_chk(outBlock))->size_; ++k) {
      (void) IOSObjectArray_Set(outBlock, k, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(nil_chk(tBlock), k))) addWithId:d]);
    }
  }
  return out;
}
...
- (id<OrgApacheCommonsMathLinearFieldMatrix>)scalarMultiplyWithOrgApacheCommonsMathFieldElement:(id<OrgApacheCommonsMathFieldElement>)d {
  ...
  for (jint blockIndex = 0; blockIndex < ((IOSObjectArray *) nil_chk(out->blocks_))->size_; ++blockIndex) {
    ...
    IOSObjectArray *tBlock = IOSObjectArray_Get(blocks_, blockIndex);
    for (jint k = 0; k < ((IOSObjectArray *) nil_chk(outBlock))->size_; ++k) {
      (void) IOSObjectArray_Set(outBlock, k, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(nil_chk(tBlock), k))) multiplyWithId:d]);
    }
  }
  return out;
}
...
- (id<OrgApacheCommonsMathLinearFieldMatrix>)multiplyWithOrgApacheCommonsMathLinearFieldMatrix:(id<OrgApacheCommonsMathLinearFieldMatrix>)m {
  ...
  @catch (JavaLangClassCastException *cce) {
    ...
    OrgApacheCommonsMathLinearBlockFieldMatrix *out = new_OrgApacheCommonsMathLinearBlockFieldMatrix_initWithOrgApacheCommonsMathField_withInt_withInt_([self getField], rows_, [((id<OrgApacheCommonsMathLinearFieldMatrix>) nil_chk(m)) getColumnDimension]);
        ...
        for (jint kBlock = 0; kBlock < blockColumns_; ++kBlock) {
          ...
          for (jint p = pStart; p < pEnd; ++p) {
            ...
            for (jint q = qStart; q < qEnd; ++q) {
              ...
              (void) IOSObjectArray_Set(nil_chk(outBlock), k, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(outBlock, k))) addWithId:sum]);
              ++k;
            }
          }
        }
...
- (OrgApacheCommonsMathLinearBlockFieldMatrix *)multiplyWithOrgApacheCommonsMathLinearBlockFieldMatrix:(OrgApacheCommonsMathLinearBlockFieldMatrix *)m {
  [self checkMultiplicationCompatibleWithOrgApacheCommonsMathLinearFieldMatrix:m];
  OrgApacheCommonsMathLinearBlockFieldMatrix *out = new_OrgApacheCommonsMathLinearBlockFieldMatrix_initWithOrgApacheCommonsMathField_withInt_withInt_([self getField], rows_, ((OrgApacheCommonsMathLinearBlockFieldMatrix *) nil_chk(m))->columns_);
  id<OrgApacheCommonsMathFieldElement> zero = [((id<OrgApacheCommonsMathField>) nil_chk([self getField])) getZero];
  jint blockIndex = 0;
  for (jint iBlock = 0; iBlock < out->blockRows_; ++iBlock) {
    jint pStart = iBlock * OrgApacheCommonsMathLinearBlockFieldMatrix_BLOCK_SIZE;
...
- (id<OrgApacheCommonsMathLinearFieldMatrix>)getSubMatrixWithInt:(jint)startRow
  ...
  OrgApacheCommonsMathLinearBlockFieldMatrix *out = new_OrgApacheCommonsMathLinearBlockFieldMatrix_initWithOrgApacheCommonsMathField_withInt_withInt_([self getField], endRow - startRow + 1, endColumn - startColumn + 1);
...
- (id<OrgApacheCommonsMathLinearFieldMatrix>)getRowMatrixWithInt:(jint)row {
  ...
  OrgApacheCommonsMathLinearBlockFieldMatrix *out = new_OrgApacheCommonsMathLinearBlockFieldMatrix_initWithOrgApacheCommonsMathField_withInt_withInt_([self getField], 1, columns_);
...
- (id<OrgApacheCommonsMathLinearFieldMatrix>)getColumnMatrixWithInt:(jint)column {
  ...
  OrgApacheCommonsMathLinearBlockFieldMatrix *out = new_OrgApacheCommonsMathLinearBlockFieldMatrix_initWithOrgApacheCommonsMathField_withInt_withInt_([self getField], rows_, 1);
  ...
  for (jint iBlock = 0; iBlock < blockRows_; ++iBlock) {
    ...
    for (jint i = 0; i < iHeight; ++i) {
      ...
      (void) IOSObjectArray_Set(nil_chk(outBlock), outIndex++, IOSObjectArray_Get(nil_chk(block), i * jWidth + jColumn));
    }
  }
  return out;
}
...
withOrgApacheCommonsMathLinearBlockFieldMatrix:(OrgApacheCommonsMathLinearBlockFieldMatrix *)matrix {
  ...
  for (jint iBlock = 0; iBlock < blockRows_; ++iBlock) {
    ...
    for (jint i = 0; i < iHeight; ++i) {
      ...
      (void) IOSObjectArray_Set(nil_chk(block), i * jWidth + jColumn, IOSObjectArray_Get(nil_chk(mBlock), mIndex++));
    }
  }
}
...
- (id<OrgApacheCommonsMathLinearFieldVector>)getRowVectorWithInt:(jint)row {
  ...
  return new_OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathFieldElementArray_withBoolean_(outData, NO);
}
...
- (id<OrgApacheCommonsMathLinearFieldVector>)getColumnVectorWithInt:(jint)column {
  ...
  for (jint iBlock = 0; iBlock < blockRows_; ++iBlock) {
    ...
    IOSObjectArray *block = IOSObjectArray_Get(nil_chk(blocks_), iBlock * blockColumns_ + jBlock);
    for (jint i = 0; i < iHeight; ++i) {
      (void) IOSObjectArray_Set(nil_chk(outData), outIndex++, IOSObjectArray_Get(nil_chk(block), i * jWidth + jColumn));
    }
  }
  return new_OrgApacheCommonsMathLinearArrayFieldVector_initWithOrgApacheCommonsMathFieldElementArray_withBoolean_(outData, NO);
}
...
- (IOSObjectArray *)getColumnWithInt:(jint)column {
  ...
  for (jint iBlock = 0; iBlock < blockRows_; ++iBlock) {
    ...
    IOSObjectArray *block = IOSObjectArray_Get(nil_chk(blocks_), iBlock * blockColumns_ + jBlock);
    for (jint i = 0; i < iHeight; ++i) {
      (void) IOSObjectArray_Set(nil_chk(out), outIndex++, IOSObjectArray_Get(nil_chk(block), i * jWidth + jColumn));
    }
  }
  return out;
}
...
withOrgApacheCommonsMathFieldElementArray:(IOSObjectArray *)array {
  ...
  for (jint iBlock = 0; iBlock < blockRows_; ++iBlock) {
    ...
    IOSObjectArray *block = IOSObjectArray_Get(nil_chk(blocks_), iBlock * blockColumns_ + jBlock);
    for (jint i = 0; i < iHeight; ++i) {
      (void) IOSObjectArray_Set(nil_chk(block), i * jWidth + jColumn, IOSObjectArray_Get(array, outIndex++));
    }
  }
}
...
withOrgApacheCommonsMathFieldElement:(id<OrgApacheCommonsMathFieldElement>)value {
  @try {
    ...
    jint jBlock = column / OrgApacheCommonsMathLinearBlockFieldMatrix_BLOCK_SIZE;
    jint k = (row - iBlock * OrgApacheCommonsMathLinearBlockFieldMatrix_BLOCK_SIZE) * OrgApacheCommonsMathLinearBlockFieldMatrix_blockWidthWithInt_(self, jBlock) + (column - jBlock * OrgApacheCommonsMathLinearBlockFieldMatrix_BLOCK_SIZE);
    (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(nil_chk(blocks_), iBlock * blockColumns_ + jBlock)), k, value);
  }
  @catch (JavaLangArrayIndexOutOfBoundsException *e) {
    @throw new_OrgApacheCommonsMathLinearMatrixIndexException_initWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_NO_SUCH_MATRIX_ENTRY(), [IOSObjectArray newArrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(row), JavaLangInteger_valueOfWithInt_(column), JavaLangInteger_valueOfWithInt_([self getRowDimension]), JavaLangInteger_valueOfWithInt_([self getColumnDimension]) } count:4 type:NSObject_class_()]);
  }
...
withOrgApacheCommonsMathFieldElement:(id<OrgApacheCommonsMathFieldElement>)increment {
  @try {
    ...
    (void) IOSObjectArray_Set(nil_chk(blockIJ), k, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(blockIJ, k))) addWithId:increment]);
  }
  @catch (JavaLangArrayIndexOutOfBoundsException *e) {
    @throw new_OrgApacheCommonsMathLinearMatrixIndexException_initWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_NO_SUCH_MATRIX_ENTRY(), [IOSObjectArray newArrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(row), JavaLangInteger_valueOfWithInt_(column), JavaLangInteger_valueOfWithInt_([self getRowDimension]), JavaLangInteger_valueOfWithInt_([self getColumnDimension]) } count:4 type:NSObject_class_()]);
  }
...
withOrgApacheCommonsMathFieldElement:(id<OrgApacheCommonsMathFieldElement>)factor {
  @try {
    ...
    jint k = (row - iBlock * OrgApacheCommonsMathLinearBlockFieldMatrix_BLOCK_SIZE) * OrgApacheCommonsMathLinearBlockFieldMatrix_blockWidthWithInt_(self, jBlock) + (column - jBlock * OrgApacheCommonsMathLinearBlockFieldMatrix_BLOCK_SIZE);
    IOSObjectArray *blockIJ = IOSObjectArray_Get(nil_chk(blocks_), iBlock * blockColumns_ + jBlock);
    (void) IOSObjectArray_Set(nil_chk(blockIJ), k, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(blockIJ, k))) multiplyWithId:factor]);
  }
  @catch (JavaLangArrayIndexOutOfBoundsException *e) {
    @throw new_OrgApacheCommonsMathLinearMatrixIndexException_initWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_NO_SUCH_MATRIX_ENTRY(), [IOSObjectArray newArrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(row), JavaLangInteger_valueOfWithInt_(column), JavaLangInteger_valueOfWithInt_([self getRowDimension]), JavaLangInteger_valueOfWithInt_([self getColumnDimension]) } count:4 type:NSObject_class_()]);
  }
...
- (id<OrgApacheCommonsMathLinearFieldMatrix>)transpose {
  jint nRows = [self getRowDimension];
  jint nCols = [self getColumnDimension];
  OrgApacheCommonsMathLinearBlockFieldMatrix *out = new_OrgApacheCommonsMathLinearBlockFieldMatrix_initWithOrgApacheCommonsMathField_withInt_withInt_([self getField], nCols, nRows);
  jint blockIndex = 0;
  for (jint iBlock = 0; iBlock < blockColumns_; ++iBlock) {
    for (jint jBlock = 0; jBlock < blockRows_; ++jBlock) {
      ...
      for (jint p = pStart; p < pEnd; ++p) {
        ...
        jint l = p - pStart;
        for (jint q = qStart; q < qEnd; ++q) {
          (void) IOSObjectArray_Set(nil_chk(outBlock), k, IOSObjectArray_Get(nil_chk(tBlock), l));
          ++k;
          l += lInc;
        }
      }
  ...
  for (jint iBlock = 0; iBlock < blockRows_; ++iBlock) {
    ...
    for (jint jBlock = 0; jBlock < blockColumns_; ++jBlock) {
      ...
      for (jint p = pStart; p < pEnd; ++p) {
        ...
        (void) IOSObjectArray_Set(nil_chk(out), p, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(out, p))) addWithId:sum]);
      }
    }
  }
  return out;
  ...
  for (jint jBlock = 0; jBlock < blockColumns_; ++jBlock) {
    ...
    for (jint iBlock = 0; iBlock < blockRows_; ++iBlock) {
      ...
      for (jint q = qStart; q < qEnd; ++q) {
        ...
        (void) IOSObjectArray_Set(nil_chk(out), q, [((id<OrgApacheCommonsMathFieldElement>) nil_chk(IOSObjectArray_Get(out, q))) addWithId:sum]);
      }
    }
  }
  return out;
  ...
  for (jint iBlock = 0; iBlock < blockRows_; ++iBlock) {
    ...
    for (jint p = pStart; p < pEnd; ++p) {
      for (jint jBlock = 0; jBlock < blockColumns_; ++jBlock) {
        ...
        for (jint q = qStart; q < qEnd; ++q) {
          (void) IOSObjectArray_Set(nil_chk(block), k, [visitor visitWithInt:p withInt:q withOrgApacheCommonsMathFieldElement:IOSObjectArray_Get(block, k)]);
          ++k;
        }
      }
    }
...
void OrgApacheCommonsMathLinearBlockFieldMatrix_initWithOrgApacheCommonsMathField_withInt_withInt_(OrgApacheCommonsMathLinearBlockFieldMatrix *self, id<OrgApacheCommonsMathField> field, jint rows, jint columns) {
  (void) OrgApacheCommonsMathLinearAbstractFieldMatrix_initWithOrgApacheCommonsMathField_withInt_withInt_(self, field, rows, columns);
  self->rows_ = rows;
  ...
  self->blocks_ = OrgApacheCommonsMathLinearBlockFieldMatrix_createBlocksLayoutWithOrgApacheCommonsMathField_withInt_withInt_(field, rows, columns);
}
...
void OrgApacheCommonsMathLinearBlockFieldMatrix_initWithOrgApacheCommonsMathFieldElementArray2_(OrgApacheCommonsMathLinearBlockFieldMatrix *self, IOSObjectArray *rawData) {
  (void) OrgApacheCommonsMathLinearBlockFieldMatrix_initWithInt_withInt_withOrgApacheCommonsMathFieldElementArray2_withBoolean_(self, ((IOSObjectArray *) nil_chk(rawData))->size_, ((IOSObjectArray *) nil_chk(IOSObjectArray_Get(rawData, 0)))->size_, OrgApacheCommonsMathLinearBlockFieldMatrix_toBlocksLayoutWithOrgApacheCommonsMathFieldElementArray2_(rawData), NO);
}
...
void OrgApacheCommonsMathLinearBlockFieldMatrix_initWithInt_withInt_withOrgApacheCommonsMathFieldElementArray2_withBoolean_(OrgApacheCommonsMathLinearBlockFieldMatrix *self, jint rows, jint columns, IOSObjectArray *blockData, jboolean copyArray) {
  (void) OrgApacheCommonsMathLinearAbstractFieldMatrix_initWithOrgApacheCommonsMathField_withInt_withInt_(self, OrgApacheCommonsMathLinearAbstractFieldMatrix_extractFieldWithOrgApacheCommonsMathFieldElementArray2_(blockData), rows, columns);
  self->rows_ = rows;
  self->columns_ = columns;
  self->blockRows_ = (rows + OrgApacheCommonsMathLinearBlockFieldMatrix_BLOCK_SIZE - 1) / OrgApacheCommonsMathLinearBlockFieldMatrix_BLOCK_SIZE;
  self->blockColumns_ = (columns + OrgApacheCommonsMathLinearBlockFieldMatrix_BLOCK_SIZE - 1) / OrgApacheCommonsMathLinearBlockFieldMatrix_BLOCK_SIZE;
  if (copyArray) {
    self->blocks_ = OrgApacheCommonsMathLinearAbstractFieldMatrix_buildArrayWithOrgApacheCommonsMathField_withInt_withInt_([self getField], self->blockRows_ * self->blockColumns_, -1);
  }
  else {
    self->blocks_ = blockData;
  }
  jint index = 0;
  for (jint iBlock = 0; iBlock < self->blockRows_; ++iBlock) {
    ...
    for (jint jBlock = 0; jBlock < self->blockColumns_; ++jBlock, ++index) {
      ...
      if (copyArray) {
        (void) IOSObjectArray_Set(nil_chk(self->blocks_), index, [((IOSObjectArray *) nil_chk(IOSObjectArray_Get(blockData, index))) clone]);
      }
    }
  }
}
...
IOSObjectArray *OrgApacheCommonsMathLinearBlockFieldMatrix_toBlocksLayoutWithOrgApacheCommonsMathFieldElementArray2_(IOSObjectArray *rawData) {
  ...
  for (jint iBlock = 0; iBlock < blockRows; ++iBlock) {
    ...
    for (jint jBlock = 0; jBlock < blockColumns; ++jBlock) {
      ...
      (void) IOSObjectArray_Set(nil_chk(blocks), blockIndex, block);
      jint index = 0;
      for (jint p = pStart; p < pEnd; ++p) {
...
IOSObjectArray *OrgApacheCommonsMathLinearBlockFieldMatrix_createBlocksLayoutWithOrgApacheCommonsMathField_withInt_withInt_(id<OrgApacheCommonsMathField> field, jint rows, jint columns) {
  ...
  for (jint iBlock = 0; iBlock < blockRows; ++iBlock) {
    ...
    for (jint jBlock = 0; jBlock < blockColumns; ++jBlock) {
      ...
      jint qEnd = OrgApacheCommonsMathUtilFastMath_minWithInt_withInt_(qStart + OrgApacheCommonsMathLinearBlockFieldMatrix_BLOCK_SIZE, columns);
      jint jWidth = qEnd - qStart;
      (void) IOSObjectArray_Set(nil_chk(blocks), blockIndex, OrgApacheCommonsMathLinearAbstractFieldMatrix_buildArrayWithOrgApacheCommonsMathField_withInt_(field, iHeight * jWidth));
      ++blockIndex;
    }
  }
  return blocks;
