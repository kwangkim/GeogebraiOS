...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/apache/commons/math/linear/Array2DRowRealMatrix.java
//
...
- (id<OrgApacheCommonsMathLinearRealMatrix>)createMatrixWithInt:(jint)rowDimension
                                                        withInt:(jint)columnDimension {
  return new_OrgApacheCommonsMathLinearArray2DRowRealMatrix_initWithInt_withInt_(rowDimension, columnDimension);
}

- (id<OrgApacheCommonsMathLinearRealMatrix>)copy__ {
  return new_OrgApacheCommonsMathLinearArray2DRowRealMatrix_initWithDoubleArray2_withBoolean_(OrgApacheCommonsMathLinearArray2DRowRealMatrix_copyOut(self), NO);
}
...
- (OrgApacheCommonsMathLinearArray2DRowRealMatrix *)addWithOrgApacheCommonsMathLinearArray2DRowRealMatrix:(OrgApacheCommonsMathLinearArray2DRowRealMatrix *)m {
  ...
  IOSObjectArray *outData = [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ rowCount, columnCount }];
  ...
  return new_OrgApacheCommonsMathLinearArray2DRowRealMatrix_initWithDoubleArray2_withBoolean_(outData, NO);
}
...
- (OrgApacheCommonsMathLinearArray2DRowRealMatrix *)multiplyWithOrgApacheCommonsMathLinearArray2DRowRealMatrix:(OrgApacheCommonsMathLinearArray2DRowRealMatrix *)m {
  ...
  IOSObjectArray *outData = [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ nRows, nCols }];
...
- (void)setSubMatrixWithDoubleArray2:(IOSObjectArray *)subMatrix
  ...
  if (data_ == nil) {
    ...
    data_ = [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ subMatrix->size_, nCols }];
...
void OrgApacheCommonsMathLinearArray2DRowRealMatrix_initWithInt_withInt_(OrgApacheCommonsMathLinearArray2DRowRealMatrix *self, jint rowDimension, jint columnDimension) {
  ...
  self->data_ = [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ rowDimension, columnDimension }];
}
...
void OrgApacheCommonsMathLinearArray2DRowRealMatrix_initWithDoubleArray_(OrgApacheCommonsMathLinearArray2DRowRealMatrix *self, IOSDoubleArray *v) {
  ...
  self->data_ = [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ nRows, 1 }];
  for (jint row = 0; row < nRows; row++) {
...
IOSObjectArray *OrgApacheCommonsMathLinearArray2DRowRealMatrix_copyOut(OrgApacheCommonsMathLinearArray2DRowRealMatrix *self) {
  jint nRows = [self getRowDimension];
  IOSObjectArray *out = [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ nRows, [self getColumnDimension] }];
  for (jint i = 0; i < nRows; i++) {
