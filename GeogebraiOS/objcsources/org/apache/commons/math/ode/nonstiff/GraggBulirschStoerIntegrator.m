...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/apache/commons/math/ode/nonstiff/GraggBulirschStoerIntegrator.java
//
...
- (jdouble)integrateWithOrgApacheCommonsMathOdeFirstOrderDifferentialEquations:(id<OrgApacheCommonsMathOdeFirstOrderDifferentialEquations>)equations
  ...
  IOSDoubleArray *yDot0 = [IOSDoubleArray newArrayWithLength:((IOSDoubleArray *) nil_chk(y0))->size_];
  IOSDoubleArray *y1 = [IOSDoubleArray newArrayWithLength:y0->size_];
  IOSDoubleArray *yTmp = [IOSDoubleArray newArrayWithLength:y0->size_];
  IOSDoubleArray *yTmpDot = [IOSDoubleArray newArrayWithLength:y0->size_];
  IOSObjectArray *diagonal = [IOSObjectArray newArrayWithLength:((IOSIntArray *) nil_chk(sequence_))->size_ - 1 type:IOSClass_doubleArray(1)];
  IOSObjectArray *y1Diag = [IOSObjectArray newArrayWithLength:sequence_->size_ - 1 type:IOSClass_doubleArray(1)];
  for (jint k = 0; k < sequence_->size_ - 1; ++k) {
    (void) IOSObjectArray_SetAndConsume(diagonal, k, [IOSDoubleArray newArrayWithLength:y0->size_]);
    (void) IOSObjectArray_SetAndConsume(y1Diag, k, [IOSDoubleArray newArrayWithLength:y0->size_]);
  }
  IOSObjectArray *fk = [IOSObjectArray newArrayWithLength:sequence_->size_ type:IOSClass_doubleArray(2)];
  for (jint k = 0; k < sequence_->size_; ++k) {
    (void) IOSObjectArray_SetAndConsume(fk, k, [IOSObjectArray newArrayWithLength:IOSIntArray_Get(sequence_, k) + 1 type:IOSClass_doubleArray(1)]);
    (void) IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(fk, k)), 0, yDot0);
    for (jint l = 0; l < IOSIntArray_Get(sequence_, k); ++l) {
      (void) IOSObjectArray_SetAndConsume(nil_chk(IOSObjectArray_Get(fk, k)), l + 1, [IOSDoubleArray newArrayWithLength:y0->size_]);
    }
  }
  if (y != y0) {
    JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(y0, 0, y, 0, y0->size_);
  }
  IOSDoubleArray *yDot1 = [IOSDoubleArray newArrayWithLength:y0->size_];
  IOSObjectArray *yMidDots = nil;
  jboolean denseOutput = [self requiresDenseOutput];
  if (denseOutput) {
    yMidDots = [IOSObjectArray newArrayWithLength:1 + 2 * sequence_->size_ type:IOSClass_doubleArray(1)];
    for (jint j = 0; j < yMidDots->size_; ++j) {
      (void) IOSObjectArray_SetAndConsume(yMidDots, j, [IOSDoubleArray newArrayWithLength:y0->size_]);
    }
  }
  else {
    yMidDots = [IOSObjectArray newArrayWithLength:1 type:IOSClass_doubleArray(1)];
    (void) IOSObjectArray_SetAndConsume(yMidDots, 0, [IOSDoubleArray newArrayWithLength:y0->size_]);
  }
  IOSDoubleArray *scale_ = [IOSDoubleArray newArrayWithLength:mainSetDimension_];
  ...
  if (denseOutput) {
    interpolator = new_OrgApacheCommonsMathOdeNonstiffGraggBulirschStoerStepInterpolator_initWithDoubleArray_withDoubleArray_withDoubleArray_withDoubleArray_withDoubleArray2_withBoolean_(y, yDot0, y1, yDot1, yMidDots, forward);
  }
  else {
    interpolator = new_OrgApacheCommonsMathOdeSamplingDummyStepInterpolator_initWithDoubleArray_withDoubleArray_withBoolean_(y, yDot1, forward);
  }
...
void OrgApacheCommonsMathOdeNonstiffGraggBulirschStoerIntegrator_initWithDouble_withDouble_withDouble_withDouble_(OrgApacheCommonsMathOdeNonstiffGraggBulirschStoerIntegrator *self, jdouble minStep, jdouble maxStep, jdouble scalAbsoluteTolerance, jdouble scalRelativeTolerance) {
  (void) OrgApacheCommonsMathOdeNonstiffAdaptiveStepsizeIntegrator_initWithNSString_withDouble_withDouble_withDouble_withDouble_(self, OrgApacheCommonsMathOdeNonstiffGraggBulirschStoerIntegrator_METHOD_NAME_, minStep, maxStep, scalAbsoluteTolerance, scalRelativeTolerance);
...
void OrgApacheCommonsMathOdeNonstiffGraggBulirschStoerIntegrator_initWithDouble_withDouble_withDoubleArray_withDoubleArray_(OrgApacheCommonsMathOdeNonstiffGraggBulirschStoerIntegrator *self, jdouble minStep, jdouble maxStep, IOSDoubleArray *vecAbsoluteTolerance, IOSDoubleArray *vecRelativeTolerance) {
  (void) OrgApacheCommonsMathOdeNonstiffAdaptiveStepsizeIntegrator_initWithNSString_withDouble_withDouble_withDoubleArray_withDoubleArray_(self, OrgApacheCommonsMathOdeNonstiffGraggBulirschStoerIntegrator_METHOD_NAME_, minStep, maxStep, vecAbsoluteTolerance, vecRelativeTolerance);
  [self setStabilityCheckWithBoolean:YES withInt:-1 withInt:-1 withDouble:-1];
  [self setStepsizeControlWithDouble:-1 withDouble:-1 withDouble:-1 withDouble:-1];
  [self setOrderControlWithInt:-1 withDouble:-1 withDouble:-1];
  [self setInterpolationControlWithBoolean:YES withInt:-1];
...
void OrgApacheCommonsMathOdeNonstiffGraggBulirschStoerIntegrator_initializeArrays(OrgApacheCommonsMathOdeNonstiffGraggBulirschStoerIntegrator *self) {
  ...
  if ((self->sequence_ == nil) || (self->sequence_->size_ != size)) {
    self->sequence_ = [IOSIntArray newArrayWithLength:size];
    self->costPerStep_ = [IOSIntArray newArrayWithLength:size];
    self->coeff_ = [IOSObjectArray newArrayWithLength:size type:IOSClass_doubleArray(1)];
    self->costPerTimeUnit_ = [IOSDoubleArray newArrayWithLength:size];
    self->optimalStep_ = [IOSDoubleArray newArrayWithLength:size];
  }
  ...
  *IOSIntArray_GetRef(nil_chk(self->costPerStep_), 0) = IOSIntArray_Get(nil_chk(self->sequence_), 0) + 1;
  ...
  for (jint k = 0; k < size; ++k) {
    (void) IOSObjectArray_Set(nil_chk(self->coeff_), k, (k > 0) ? [IOSDoubleArray newArrayWithLength:k] : nil);
    for (jint l = 0; l < k; ++l) {
