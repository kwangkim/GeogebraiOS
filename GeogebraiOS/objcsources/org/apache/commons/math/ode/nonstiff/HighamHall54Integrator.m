...
+ (void)initialize {
  if (self == [OrgApacheCommonsMathOdeNonstiffHighamHall54Integrator class]) {
    OrgApacheCommonsMathOdeNonstiffHighamHall54Integrator_STATIC_C_ = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 2.0 / 9.0, 1.0 / 3.0, 1.0 / 2.0, 3.0 / 5.0, 1.0, 1.0 } count:6];
    OrgApacheCommonsMathOdeNonstiffHighamHall54Integrator_STATIC_A_ = [IOSObjectArray newArrayWithObjects:(id[]){ [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 2.0 / 9.0 } count:1], [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 1.0 / 12.0, 1.0 / 4.0 } count:2], [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 1.0 / 8.0, 0.0, 3.0 / 8.0 } count:3], [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 91.0 / 500.0, -27.0 / 100.0, 78.0 / 125.0, 8.0 / 125.0 } count:4], [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ -11.0 / 20.0, 27.0 / 20.0, 12.0 / 5.0, -36.0 / 5.0, 5.0 } count:5], [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 1.0 / 12.0, 0.0, 27.0 / 32.0, -4.0 / 3.0, 125.0 / 96.0, 5.0 / 48.0 } count:6] } count:6 type:IOSClass_doubleArray(1)];
    OrgApacheCommonsMathOdeNonstiffHighamHall54Integrator_STATIC_B_ = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 1.0 / 12.0, 0.0, 27.0 / 32.0, -4.0 / 3.0, 125.0 / 96.0, 5.0 / 48.0, 0.0 } count:7];
    OrgApacheCommonsMathOdeNonstiffHighamHall54Integrator_STATIC_E_ = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ -1.0 / 20.0, 0.0, 81.0 / 160.0, -6.0 / 5.0, 25.0 / 32.0, 1.0 / 16.0, -1.0 / 10.0 } count:7];
