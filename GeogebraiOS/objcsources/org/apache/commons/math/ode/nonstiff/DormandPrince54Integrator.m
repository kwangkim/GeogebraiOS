...
+ (void)initialize {
  if (self == [OrgApacheCommonsMathOdeNonstiffDormandPrince54Integrator class]) {
    OrgApacheCommonsMathOdeNonstiffDormandPrince54Integrator_STATIC_C_ = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 1.0 / 5.0, 3.0 / 10.0, 4.0 / 5.0, 8.0 / 9.0, 1.0, 1.0 } count:6];
    OrgApacheCommonsMathOdeNonstiffDormandPrince54Integrator_STATIC_A_ = [IOSObjectArray newArrayWithObjects:(id[]){ [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 1.0 / 5.0 } count:1], [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 3.0 / 40.0, 9.0 / 40.0 } count:2], [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 44.0 / 45.0, -56.0 / 15.0, 32.0 / 9.0 } count:3], [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 19372.0 / 6561.0, -25360.0 / 2187.0, 64448.0 / 6561.0, -212.0 / 729.0 } count:4], [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 9017.0 / 3168.0, -355.0 / 33.0, 46732.0 / 5247.0, 49.0 / 176.0, -5103.0 / 18656.0 } count:5], [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 35.0 / 384.0, 0.0, 500.0 / 1113.0, 125.0 / 192.0, -2187.0 / 6784.0, 11.0 / 84.0 } count:6] } count:6 type:IOSClass_doubleArray(1)];
    OrgApacheCommonsMathOdeNonstiffDormandPrince54Integrator_STATIC_B_ = [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 35.0 / 384.0, 0.0, 500.0 / 1113.0, 125.0 / 192.0, -2187.0 / 6784.0, 11.0 / 84.0, 0.0 } count:7];
