...
- (id<OrgApacheCommonsMathOdeSamplingStepInterpolator>)doCopy {
  return new_OrgApacheCommonsMathOdeNonstiffDormandPrince54StepInterpolator_initWithOrgApacheCommonsMathOdeNonstiffDormandPrince54StepInterpolator_(self);
}
...
- (void)computeInterpolatedStateAndDerivativesWithDouble:(jdouble)theta
  ...
  if (!vectorsInitialized_) {
    if (v1_ == nil) {
      v1_ = [IOSDoubleArray newArrayWithLength:((IOSDoubleArray *) nil_chk(interpolatedState_))->size_];
      v2_ = [IOSDoubleArray newArrayWithLength:interpolatedState_->size_];
      v3_ = [IOSDoubleArray newArrayWithLength:interpolatedState_->size_];
      v4_ = [IOSDoubleArray newArrayWithLength:interpolatedState_->size_];
    }
...
void OrgApacheCommonsMathOdeNonstiffDormandPrince54StepInterpolator_initWithOrgApacheCommonsMathOdeNonstiffDormandPrince54StepInterpolator_(OrgApacheCommonsMathOdeNonstiffDormandPrince54StepInterpolator *self, OrgApacheCommonsMathOdeNonstiffDormandPrince54StepInterpolator *interpolator) {
  ...
  if (((OrgApacheCommonsMathOdeNonstiffDormandPrince54StepInterpolator *) nil_chk(interpolator))->v1_ == nil) {
    ...
    self->v1_ = [interpolator->v1_ clone];
    self->v2_ = [((IOSDoubleArray *) nil_chk(interpolator->v2_)) clone];
    self->v3_ = [((IOSDoubleArray *) nil_chk(interpolator->v3_)) clone];
    self->v4_ = [((IOSDoubleArray *) nil_chk(interpolator->v4_)) clone];
