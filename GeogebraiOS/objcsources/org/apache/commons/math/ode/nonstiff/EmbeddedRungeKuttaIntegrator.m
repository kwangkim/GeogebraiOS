...
- (jdouble)integrateWithOrgApacheCommonsMathOdeFirstOrderDifferentialEquations:(id<OrgApacheCommonsMathOdeFirstOrderDifferentialEquations>)equations
  ...
  IOSObjectArray *yDotK = [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ stages, ((IOSDoubleArray *) nil_chk(y0))->size_ }];
  IOSDoubleArray *yTmp = [IOSDoubleArray newArrayWithLength:y0->size_];
  IOSDoubleArray *yDotTmp = [IOSDoubleArray newArrayWithLength:y0->size_];
  ...
  if ([self requiresDenseOutput]) {
    ...
    interpolator = new_OrgApacheCommonsMathOdeSamplingDummyStepInterpolator_initWithDoubleArray_withDoubleArray_withBoolean_(yTmp, IOSObjectArray_Get(yDotK, stages - 1), forward);
  }
