...
- (void)addEventHandlerWithOrgApacheCommonsMathOdeEventsEventHandler:(id<OrgApacheCommonsMathOdeEventsEventHandler>)handler
  ...
  [((id<JavaUtilList>) nil_chk(states_)) addWithId:new_OrgApacheCommonsMathOdeEventsEventState_initWithOrgApacheCommonsMathOdeEventsEventHandler_withDouble_withDouble_withInt_(handler, maxCheckInterval, convergence, maxIterationCount)];
}
