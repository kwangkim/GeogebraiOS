...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/apache/commons/math/util/MathUtils.java
//
...
+ (void)initialize {
  if (self == [OrgApacheCommonsMathUtilMathUtils class]) {
    OrgApacheCommonsMathUtilMathUtils_FACTORIALS_ = [IOSLongArray newArrayWithLongs:(jlong[]){ 1l, 1l, 2l, 6l, 24l, 120l, 720l, 5040l, 40320l, 362880l, 3628800l, 39916800l, 479001600l, 6227020800l, 87178291200l, 1307674368000l, 20922789888000l, 355687428096000l, 6402373705728000l, 121645100408832000l, 2432902008176640000l } count:21];
    ...
    if (a < 0) {
      if (b < 0) {
        if (JavaLangLong_MIN_VALUE - b <= a) {
          ...
          @throw OrgApacheCommonsMathMathRuntimeException_createArithmeticExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(pattern, [IOSObjectArray newArrayWithObjects:(id[]){ JavaLangLong_valueOfWithLong_(a), JavaLangLong_valueOfWithLong_(b) } count:2 type:NSObject_class_()]);
        }
      }
      else {
        ret = a + b;
...
jlong OrgApacheCommonsMathUtilMathUtils_factorialWithInt_(jint n) {
  ...
  if (n > 20) {
    @throw new_JavaLangArithmeticException_initWithNSString_(@"factorial value is too large to fit in a long");
  }
...
jint OrgApacheCommonsMathUtilMathUtils_hash__WithDouble_(jdouble value) {
  OrgApacheCommonsMathUtilMathUtils_initialize();
  return ((jint) [new_JavaLangDouble_initWithDouble_(value) hash]);
}
...
jint OrgApacheCommonsMathUtilMathUtils_mulAndCheckWithInt_withInt_(jint x, jint y) {
  ...
  if (m < JavaLangInteger_MIN_VALUE || m > JavaLangInteger_MAX_VALUE) {
    @throw new_JavaLangArithmeticException_initWithNSString_(@"overflow: mul");
  }
  return (jint) m;
}
    ...
    if (a < 0) {
      if (b < 0) {
        if (a >= JavaLangLong_MAX_VALUE / b) {
          ...
          @throw new_JavaLangArithmeticException_initWithNSString_(msg);
        }
      }
      else if (b > 0) {
        if (JavaLangLong_MIN_VALUE / b <= a) {
...
IOSDoubleArray *OrgApacheCommonsMathUtilMathUtils_normalizeArrayWithDoubleArray_withDouble_(IOSDoubleArray *values, jdouble normalizedSum) {
  ...
  if (JavaLangDouble_isInfiniteWithDouble_(normalizedSum)) {
    @throw OrgApacheCommonsMathMathRuntimeException_createIllegalArgumentExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_NORMALIZE_INFINITE(), [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
  }
  if (JavaLangDouble_isNaNWithDouble_(normalizedSum)) {
    @throw OrgApacheCommonsMathMathRuntimeException_createIllegalArgumentExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_NORMALIZE_NAN(), [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
  }
  jdouble sum = 0.0;
  ...
  for (jint i = 0; i < len; i++) {
    if (JavaLangDouble_isInfiniteWithDouble_(IOSDoubleArray_Get(values, i))) {
      @throw OrgApacheCommonsMathMathRuntimeException_createArithmeticExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_INFINITE_ARRAY_ELEMENT(), [IOSObjectArray newArrayWithObjects:(id[]){ JavaLangDouble_valueOfWithDouble_(IOSDoubleArray_Get(values, i)), JavaLangInteger_valueOfWithInt_(i) } count:2 type:NSObject_class_()]);
    }
  ...
  if (sum == 0) {
    @throw OrgApacheCommonsMathMathRuntimeException_createArithmeticExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_ARRAY_SUMS_TO_ZERO(), [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
  }
  for (jint i = 0; i < len; i++) {
    if (JavaLangDouble_isNaNWithDouble_(IOSDoubleArray_Get(values, i))) {
...
jdouble OrgApacheCommonsMathUtilMathUtils_roundWithDouble_withInt_withInt_(jdouble x, jint scale_, jint roundingMethod) {
  OrgApacheCommonsMathUtilMathUtils_initialize();
  @try {
    return [((JavaMathBigDecimal *) nil_chk(([new_JavaMathBigDecimal_initWithNSString_(JavaLangDouble_toStringWithDouble_(x)) setScaleWithInt:scale_ withInt:roundingMethod]))) doubleValue];
  }
...
jdouble OrgApacheCommonsMathUtilMathUtils_roundUnscaledWithDouble_withDouble_withInt_(jdouble unscaled, jdouble sign, jint roundingMethod) {
  ...
  switch (roundingMethod) {
    ...
    if (unscaled != OrgApacheCommonsMathUtilFastMath_floorWithDouble_(unscaled)) {
      @throw new_JavaLangArithmeticException_initWithNSString_(@"Inexact result from rounding");
    }
    break;
...
JavaMathBigInteger *OrgApacheCommonsMathUtilMathUtils_powWithJavaMathBigInteger_withInt_(JavaMathBigInteger *k, jint e) {
  OrgApacheCommonsMathUtilMathUtils_initialize();
  if (e < 0) {
    @throw OrgApacheCommonsMathMathRuntimeException_createIllegalArgumentExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_POWER_NEGATIVE_PARAMETERS(), [IOSObjectArray newArrayWithObjects:(id[]){ k, JavaLangInteger_valueOfWithInt_(e) } count:2 type:NSObject_class_()]);
  }
...
JavaMathBigInteger *OrgApacheCommonsMathUtilMathUtils_powWithJavaMathBigInteger_withLong_(JavaMathBigInteger *k, jlong e) {
  OrgApacheCommonsMathUtilMathUtils_initialize();
  if (e < 0) {
    @throw OrgApacheCommonsMathMathRuntimeException_createIllegalArgumentExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_POWER_NEGATIVE_PARAMETERS(), [IOSObjectArray newArrayWithObjects:(id[]){ k, JavaLangLong_valueOfWithLong_(e) } count:2 type:NSObject_class_()]);
  }
...
JavaMathBigInteger *OrgApacheCommonsMathUtilMathUtils_powWithJavaMathBigInteger_withJavaMathBigInteger_(JavaMathBigInteger *k, JavaMathBigInteger *e) {
  ...
  if ([((JavaMathBigInteger *) nil_chk(e)) compareToWithId:JavaMathBigInteger_get_ZERO_()] < 0) {
    @throw OrgApacheCommonsMathMathRuntimeException_createIllegalArgumentExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_POWER_NEGATIVE_PARAMETERS(), [IOSObjectArray newArrayWithObjects:(id[]){ k, e } count:2 type:NSObject_class_()]);
  }
  JavaMathBigInteger *result = JavaMathBigInteger_get_ONE_();
  JavaMathBigInteger *k2p = k;
...
void OrgApacheCommonsMathUtilMathUtils_checkOrderWithDoubleArray_withOrgApacheCommonsMathUtilMathUtils_OrderDirectionEnum_withBoolean_(IOSDoubleArray *val, OrgApacheCommonsMathUtilMathUtils_OrderDirectionEnum *dir, jboolean strict) {
  ...
  for (jint i = 1; i < max; i++) {
    ...
    if (!ok) {
      @throw new_OrgApacheCommonsMathExceptionNonMonotonousSequenceException_initWithNSNumber_withNSNumber_withInt_withOrgApacheCommonsMathUtilMathUtils_OrderDirectionEnum_withBoolean_(JavaLangDouble_valueOfWithDouble_(IOSDoubleArray_Get(val, i)), JavaLangDouble_valueOfWithDouble_(previous), i, dir, strict);
    }
