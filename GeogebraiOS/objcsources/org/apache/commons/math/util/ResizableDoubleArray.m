...
- (void)addElementsWithDoubleArray:(IOSDoubleArray *)values {
  @synchronized(self) {
    IOSDoubleArray *tempArray = [IOSDoubleArray newArrayWithLength:numElements_ + ((IOSDoubleArray *) nil_chk(values))->size_ + 1];
...
- (void)clear {
  @synchronized(self) {
    numElements_ = 0;
    startIndex_ = 0;
    internalArray_ = [IOSDoubleArray newArrayWithLength:initialCapacity_];
  }
}

- (void)contract {
  @synchronized(self) {
    IOSDoubleArray *tempArray = [IOSDoubleArray newArrayWithLength:numElements_ + 1];
    JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(internalArray_, startIndex_, tempArray, 0, numElements_);
    internalArray_ = tempArray;
    startIndex_ = 0;
  }
...
- (void)expand {
  @synchronized(self) {
    ...
    IOSDoubleArray *tempArray = [IOSDoubleArray newArrayWithLength:newSize];
...
- (IOSDoubleArray *)getElements {
  @synchronized(self) {
    IOSDoubleArray *elementArray = [IOSDoubleArray newArrayWithLength:numElements_];
...
- (void)setElementWithInt:(jint)index
  ...
  @synchronized(self) {
    if (index < 0) {
      @throw OrgApacheCommonsMathMathRuntimeException_createArrayIndexOutOfBoundsExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_CANNOT_SET_AT_NEGATIVE_INDEX(), [IOSObjectArray newArrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(index) } count:1 type:NSObject_class_()]);
    }
...
- (OrgApacheCommonsMathUtilResizableDoubleArray *)copy__ {
  @synchronized(self) {
    OrgApacheCommonsMathUtilResizableDoubleArray *result = new_OrgApacheCommonsMathUtilResizableDoubleArray_init();
...
- (NSUInteger)hash {
  @synchronized(self) {
    IOSIntArray *hashData = [IOSIntArray newArrayWithLength:7];
    *IOSIntArray_GetRef(hashData, 0) = ((jint) [new_JavaLangFloat_initWithFloat_(expansionFactor_) hash]);
    *IOSIntArray_GetRef(hashData, 1) = ((jint) [new_JavaLangFloat_initWithFloat_(contractionCriteria_) hash]);
...
void OrgApacheCommonsMathUtilResizableDoubleArray_init(OrgApacheCommonsMathUtilResizableDoubleArray *self) {
  ...
  self->numElements_ = 0;
  self->startIndex_ = 0;
  self->internalArray_ = [IOSDoubleArray newArrayWithLength:self->initialCapacity_];
}
...
void OrgApacheCommonsMathUtilResizableDoubleArray_initWithDoubleArray_(OrgApacheCommonsMathUtilResizableDoubleArray *self, IOSDoubleArray *initialArray) {
  ...
  if (initialArray == nil) {
    ...
    self->internalArray_ = [IOSDoubleArray newArrayWithLength:initialArray->size_];
...
void OrgApacheCommonsMathUtilResizableDoubleArray_initWithInt_withFloat_(OrgApacheCommonsMathUtilResizableDoubleArray *self, jint initialCapacity, jfloat expansionFactor) {
  ...
  self->expansionFactor_ = expansionFactor;
  [self setInitialCapacityWithInt:initialCapacity];
  self->internalArray_ = [IOSDoubleArray newArrayWithLength:initialCapacity];
...
void OrgApacheCommonsMathUtilResizableDoubleArray_expandToWithInt_(OrgApacheCommonsMathUtilResizableDoubleArray *self, jint size) {
  @synchronized(self) {
    IOSDoubleArray *tempArray = [IOSDoubleArray newArrayWithLength:size];
...
void OrgApacheCommonsMathUtilResizableDoubleArray_copy__WithOrgApacheCommonsMathUtilResizableDoubleArray_withOrgApacheCommonsMathUtilResizableDoubleArray_(OrgApacheCommonsMathUtilResizableDoubleArray *source, OrgApacheCommonsMathUtilResizableDoubleArray *dest) {
  ...
  @synchronized(source) {
    @synchronized(dest) {
      ...
      dest->internalArray_ = [IOSDoubleArray newArrayWithLength:((IOSDoubleArray *) nil_chk(source->internalArray_))->size_];
