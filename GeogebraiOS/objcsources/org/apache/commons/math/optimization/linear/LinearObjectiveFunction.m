...
void OrgApacheCommonsMathOptimizationLinearLinearObjectiveFunction_initWithDoubleArray_withDouble_(OrgApacheCommonsMathOptimizationLinearLinearObjectiveFunction *self, IOSDoubleArray *coefficients, jdouble constantTerm) {
  (void) OrgApacheCommonsMathOptimizationLinearLinearObjectiveFunction_initWithOrgApacheCommonsMathLinearRealVector_withDouble_(self, new_OrgApacheCommonsMathLinearArrayRealVector_initWithDoubleArray_(coefficients), constantTerm);
}
