...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/apache/commons/math/optimization/linear/SimplexTableau.java
//
...
- (id<OrgApacheCommonsMathLinearRealMatrix>)createTableauWithBoolean:(jboolean)maximize {
  ...
  OrgApacheCommonsMathLinearArray2DRowRealMatrix *matrix = new_OrgApacheCommonsMathLinearArray2DRowRealMatrix_initWithInt_withInt_(height, width);
  if (OrgApacheCommonsMathOptimizationLinearSimplexTableau_getNumObjectiveFunctions(self) == 2) {
...
- (id<JavaUtilList>)normalizeConstraintsWithJavaUtilCollection:(id<JavaUtilCollection>)originalConstraints {
  id<JavaUtilList> normalized = new_JavaUtilArrayList_init();
...
- (void)dropPhase1Objective {
  ...
  id<JavaUtilList> columnsToDrop = new_JavaUtilArrayList_init();
  ...
  IOSObjectArray *matrix = [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ OrgApacheCommonsMathOptimizationLinearSimplexTableau_getHeight(self) - 1, OrgApacheCommonsMathOptimizationLinearSimplexTableau_getWidth(self) - [columnsToDrop size] }];
  ...
  for (jint i = [columnsToDrop size] - 1; i >= 0; i--) {
    (void) [((id<JavaUtilList>) nil_chk(columnLabels_)) removeWithInt:[((JavaLangInteger *) nil_chk([columnsToDrop getWithInt:i])) intValue]];
  }
  self->tableau_ = new_OrgApacheCommonsMathLinearArray2DRowRealMatrix_initWithDoubleArray2_(matrix);
...
- (OrgApacheCommonsMathOptimizationRealPointValuePair *)getSolution {
  ...
  id<JavaUtilSet> basicRows = new_JavaUtilHashSet_init();
  IOSDoubleArray *coefficients = [IOSDoubleArray newArrayWithLength:OrgApacheCommonsMathOptimizationLinearSimplexTableau_getOriginalNumDecisionVariables(self)];
  ...
  return new_OrgApacheCommonsMathOptimizationRealPointValuePair_initWithDoubleArray_withDouble_(coefficients, [((OrgApacheCommonsMathOptimizationLinearLinearObjectiveFunction *) nil_chk(f_)) getValueWithDoubleArray:coefficients]);
}
...
void OrgApacheCommonsMathOptimizationLinearSimplexTableau_initWithOrgApacheCommonsMathOptimizationLinearLinearObjectiveFunction_withJavaUtilCollection_withOrgApacheCommonsMathOptimizationGoalTypeEnum_withBoolean_withDouble_(OrgApacheCommonsMathOptimizationLinearSimplexTableau *self, OrgApacheCommonsMathOptimizationLinearLinearObjectiveFunction *f, id<JavaUtilCollection> constraints, OrgApacheCommonsMathOptimizationGoalTypeEnum *goalType, jboolean restrictToNonNegative, jdouble epsilon) {
  ...
  self->columnLabels_ = new_JavaUtilArrayList_init();
  self->f_ = f;
  self->constraints_ = [self normalizeConstraintsWithJavaUtilCollection:constraints];
  ...
  self->tableau_ = [self createTableauWithBoolean:goalType == OrgApacheCommonsMathOptimizationGoalTypeEnum_get_MAXIMIZE()];
