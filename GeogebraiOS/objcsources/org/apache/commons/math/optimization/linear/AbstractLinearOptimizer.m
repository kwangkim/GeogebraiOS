...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/apache/commons/math/optimization/linear/AbstractLinearOptimizer.java
//
...
- (OrgApacheCommonsMathOptimizationRealPointValuePair *)optimizeWithOrgApacheCommonsMathOptimizationLinearLinearObjectiveFunction:(OrgApacheCommonsMathOptimizationLinearLinearObjectiveFunction *)f
  ...
  self->function_ = f;
  self->linearConstraints_ = constraints;
  self->goal_ = goalType;
