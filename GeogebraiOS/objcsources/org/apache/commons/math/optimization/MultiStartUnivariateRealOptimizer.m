...
- (jdouble)optimizeWithOrgApacheCommonsMathAnalysisUnivariateRealFunction:(id<OrgApacheCommonsMathAnalysisUnivariateRealFunction>)f
  ...
  OrgApacheCommonsMathOptimizationMultiStartUnivariateRealOptimizer_setAndConsume_optima_(self, [IOSDoubleArray newArrayWithLength:starts_]);
  OrgApacheCommonsMathOptimizationMultiStartUnivariateRealOptimizer_setAndConsume_optimaValues_(self, [IOSDoubleArray newArrayWithLength:starts_]);
  totalIterations_ = 0;
  totalEvaluations_ = 0;
...
void OrgApacheCommonsMathOptimizationMultiStartUnivariateRealOptimizer_initWithOrgApacheCommonsMathOptimizationUnivariateRealOptimizer_withInt_withOrgApacheCommonsMathRandomRandomGenerator_(OrgApacheCommonsMathOptimizationMultiStartUnivariateRealOptimizer *self, id<OrgApacheCommonsMathOptimizationUnivariateRealOptimizer> optimizer, jint starts, id<OrgApacheCommonsMathRandomRandomGenerator> generator) {
  NSObject_init(self);
  OrgApacheCommonsMathOptimizationMultiStartUnivariateRealOptimizer_set_optimizer_(self, optimizer);
  self->totalIterations_ = 0;
  self->starts_ = starts;
  OrgApacheCommonsMathOptimizationMultiStartUnivariateRealOptimizer_set_generator_(self, generator);
  OrgApacheCommonsMathOptimizationMultiStartUnivariateRealOptimizer_set_optima_(self, nil);
