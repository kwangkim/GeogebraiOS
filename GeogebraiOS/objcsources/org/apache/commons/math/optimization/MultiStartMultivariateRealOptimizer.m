...
- (OrgApacheCommonsMathOptimizationRealPointValuePair *)optimizeWithOrgApacheCommonsMathAnalysisMultivariateRealFunction:(id<OrgApacheCommonsMathAnalysisMultivariateRealFunction>)f
  ...
  for (jint i = 0; i < starts_; ++i) {
    @try {
      ...
      (void) IOSObjectArray_Set(optima_, i, [optimizer_ optimizeWithOrgApacheCommonsMathAnalysisMultivariateRealFunction:f withOrgApacheCommonsMathOptimizationGoalTypeEnum:goalType withDoubleArray:(i == 0) ? startPoint : [((id<OrgApacheCommonsMathRandomRandomVectorGenerator>) nil_chk(generator_)) nextVector]]);
    }
  ...
  JavaUtilArrays_sortWithNSObjectArray_withJavaUtilComparator_(optima_, new_OrgApacheCommonsMathOptimizationMultiStartMultivariateRealOptimizer_$1_initWithOrgApacheCommonsMathOptimizationGoalTypeEnum_(goalType));
