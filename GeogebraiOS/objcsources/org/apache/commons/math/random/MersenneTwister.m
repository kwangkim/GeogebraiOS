...
+ (void)initialize {
  if (self == [OrgApacheCommonsMathRandomMersenneTwister class]) {
    OrgApacheCommonsMathRandomMersenneTwister_MAG01_ = [IOSIntArray newArrayWithInts:(jint[]){ (jint) 0x0, (jint) 0x9908b0df } count:2];
...
void OrgApacheCommonsMathRandomMersenneTwister_init(OrgApacheCommonsMathRandomMersenneTwister *self) {
  ...
  self->mt_ = [IOSIntArray newArrayWithLength:OrgApacheCommonsMathRandomMersenneTwister_N];
  [self setSeedWithLong:JavaLangSystem_currentTimeMillis()];
}
