...
- (void)setSeedWithInt:(jint)seed {
  [self setSeedWithIntArray:[IOSIntArray newArrayWithInts:(jint[]){ seed } count:1]];
}
...
- (void)setSeedWithLong:(jlong)seed {
  [self setSeedWithIntArray:[IOSIntArray newArrayWithInts:(jint[]){ (jint) (URShift64(seed, 32)), (jint) (seed & (jlong) 0xffffffffl) } count:2]];
}
...
void OrgApacheCommonsMathRandomAbstractWell_initWithInt_withInt_withInt_withInt_(OrgApacheCommonsMathRandomAbstractWell *self, jint k, jint m1, jint m2, jint m3) {
  (void) OrgApacheCommonsMathRandomAbstractWell_initWithInt_withInt_withInt_withInt_withLong_(self, k, m1, m2, m3, JavaLangSystem_currentTimeMillis());
}
...
void OrgApacheCommonsMathRandomAbstractWell_initWithInt_withInt_withInt_withInt_withInt_(OrgApacheCommonsMathRandomAbstractWell *self, jint k, jint m1, jint m2, jint m3, jint seed) {
  (void) OrgApacheCommonsMathRandomAbstractWell_initWithInt_withInt_withInt_withInt_withIntArray_(self, k, m1, m2, m3, [IOSIntArray newArrayWithInts:(jint[]){ seed } count:1]);
}
...
void OrgApacheCommonsMathRandomAbstractWell_initWithInt_withInt_withInt_withInt_withIntArray_(OrgApacheCommonsMathRandomAbstractWell *self, jint k, jint m1, jint m2, jint m3, IOSIntArray *seed) {
  (void) OrgApacheCommonsMathRandomBitsStreamGenerator_init(self);
  jint w = 32;
  jint r = (k + w - 1) / w;
  self->v_ = [IOSIntArray newArrayWithLength:r];
  self->index_ = 0;
  self->iRm1_ = [IOSIntArray newArrayWithLength:r];
  self->iRm2_ = [IOSIntArray newArrayWithLength:r];
  self->i1_ = [IOSIntArray newArrayWithLength:r];
  self->i2_ = [IOSIntArray newArrayWithLength:r];
  self->i3_ = [IOSIntArray newArrayWithLength:r];
  for (jint j = 0; j < r; ++j) {
...
void OrgApacheCommonsMathRandomAbstractWell_initWithInt_withInt_withInt_withInt_withLong_(OrgApacheCommonsMathRandomAbstractWell *self, jint k, jint m1, jint m2, jint m3, jlong seed) {
  (void) OrgApacheCommonsMathRandomAbstractWell_initWithInt_withInt_withInt_withInt_withIntArray_(self, k, m1, m2, m3, [IOSIntArray newArrayWithInts:(jint[]){ (jint) (URShift64(seed, 32)), (jint) (seed & (jlong) 0xffffffffl) } count:2]);
}
