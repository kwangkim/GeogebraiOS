...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/apache/commons/math/special/Gamma.java
//
...
+ (void)initialize {
  if (self == [OrgApacheCommonsMathSpecialGamma class]) {
    JreStrongAssignAndConsume(&OrgApacheCommonsMathSpecialGamma_LANCZOS_, nil, [IOSDoubleArray newArrayWithDoubles:(jdouble[]){ 0.99999999999999709182, 57.156235665862923517, -59.597960355475491248, 14.136097974741747174, -0.49191381609762019978, .33994649984811888699e-4, .46523628927048575665e-4, -.98374475304879564677e-4, .15808870322491248884e-3, -.21026444172410488319e-3, .21743961811521264320e-3, -.16431810653676389022e-3, .84418223983852743293e-4, -.26190838401581408670e-4, .36899182659531622704e-5 } count:15]);
...
jdouble OrgApacheCommonsMathSpecialGamma_regularizedGammaPWithDouble_withDouble_withDouble_withInt_(jdouble a, jdouble x, jdouble epsilon, jint maxIterations) {
  ...
  if (JavaLangDouble_isNaNWithDouble_(a) || JavaLangDouble_isNaNWithDouble_(x) || (a <= 0.0) || (x < 0.0)) {
    ...
    if (n >= maxIterations) {
      @throw [new_OrgApacheCommonsMathMaxIterationsExceededException_initWithInt_(maxIterations) autorelease];
    }
...
jdouble OrgApacheCommonsMathSpecialGamma_regularizedGammaQWithDouble_withDouble_withDouble_withInt_(jdouble a, jdouble x, jdouble epsilon, jint maxIterations) {
  ...
  if (JavaLangDouble_isNaNWithDouble_(a) || JavaLangDouble_isNaNWithDouble_(x) || (a <= 0.0) || (x < 0.0)) {
    ...
    OrgApacheCommonsMathUtilContinuedFraction *cf = [new_OrgApacheCommonsMathSpecialGamma_$1_initWithDouble_(a) autorelease];
