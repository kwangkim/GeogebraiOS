...
- (OrgApacheCommonsMathDfpDfp *)newInstance {
  return new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_([self getField]);
}

- (OrgApacheCommonsMathDfpDfp *)newInstanceWithByte:(jbyte)x {
  return new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withByte_([self getField], x);
}

- (OrgApacheCommonsMathDfpDfp *)newInstanceWithInt:(jint)x {
  return new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withInt_([self getField], x);
}

- (OrgApacheCommonsMathDfpDfp *)newInstanceWithLong:(jlong)x {
  return new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withLong_([self getField], x);
}

- (OrgApacheCommonsMathDfpDfp *)newInstanceWithDouble:(jdouble)x {
  return new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withDouble_([self getField], x);
}
...
- (OrgApacheCommonsMathDfpDfp *)newInstanceWithNSString:(NSString *)s {
  return new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withNSString_(field_, s);
}
...
- (jint)alignWithInt:(jint)e {
  ...
  if (adiff > (((IOSIntArray *) nil_chk(mant_))->size_ + 1)) {
    ...
    (void) [self dotrapWithInt:OrgApacheCommonsMathDfpDfpField_FLAG_INEXACT withNSString:OrgApacheCommonsMathDfpDfp_ALIGN_TRAP_ withOrgApacheCommonsMathDfpDfp:self withOrgApacheCommonsMathDfpDfp:self];
    return 0;
  }
...
- (jboolean)lessThanWithOrgApacheCommonsMathDfpDfp:(OrgApacheCommonsMathDfpDfp *)x {
  if ([((OrgApacheCommonsMathDfpDfpField *) nil_chk(field_)) getRadixDigits] != [((OrgApacheCommonsMathDfpDfp *) nil_chk(x))->field_ getRadixDigits]) {
    ...
    OrgApacheCommonsMathDfpDfp *result = [self newInstanceWithOrgApacheCommonsMathDfpDfp:[self getZero]];
    ((OrgApacheCommonsMathDfpDfp *) nil_chk(result))->nans_ = OrgApacheCommonsMathDfpDfp_QNAN;
    (void) [self dotrapWithInt:OrgApacheCommonsMathDfpDfpField_FLAG_INVALID withNSString:OrgApacheCommonsMathDfpDfp_LESS_THAN_TRAP_ withOrgApacheCommonsMathDfpDfp:x withOrgApacheCommonsMathDfpDfp:result];
    return NO;
  }
  if ([self isNaN] || [x isNaN]) {
    [field_ setIEEEFlagsBitsWithInt:OrgApacheCommonsMathDfpDfpField_FLAG_INVALID];
    (void) [self dotrapWithInt:OrgApacheCommonsMathDfpDfpField_FLAG_INVALID withNSString:OrgApacheCommonsMathDfpDfp_LESS_THAN_TRAP_ withOrgApacheCommonsMathDfpDfp:x withOrgApacheCommonsMathDfpDfp:[self newInstanceWithOrgApacheCommonsMathDfpDfp:[self getZero]]];
    return NO;
  }
...
- (jboolean)greaterThanWithOrgApacheCommonsMathDfpDfp:(OrgApacheCommonsMathDfpDfp *)x {
  if ([((OrgApacheCommonsMathDfpDfpField *) nil_chk(field_)) getRadixDigits] != [((OrgApacheCommonsMathDfpDfp *) nil_chk(x))->field_ getRadixDigits]) {
    ...
    OrgApacheCommonsMathDfpDfp *result = [self newInstanceWithOrgApacheCommonsMathDfpDfp:[self getZero]];
    ((OrgApacheCommonsMathDfpDfp *) nil_chk(result))->nans_ = OrgApacheCommonsMathDfpDfp_QNAN;
    (void) [self dotrapWithInt:OrgApacheCommonsMathDfpDfpField_FLAG_INVALID withNSString:OrgApacheCommonsMathDfpDfp_GREATER_THAN_TRAP_ withOrgApacheCommonsMathDfpDfp:x withOrgApacheCommonsMathDfpDfp:result];
    return NO;
  }
  if ([self isNaN] || [x isNaN]) {
    [field_ setIEEEFlagsBitsWithInt:OrgApacheCommonsMathDfpDfpField_FLAG_INVALID];
    (void) [self dotrapWithInt:OrgApacheCommonsMathDfpDfpField_FLAG_INVALID withNSString:OrgApacheCommonsMathDfpDfp_GREATER_THAN_TRAP_ withOrgApacheCommonsMathDfpDfp:x withOrgApacheCommonsMathDfpDfp:[self newInstanceWithOrgApacheCommonsMathDfpDfp:[self getZero]]];
    return NO;
  }
  return OrgApacheCommonsMathDfpDfp_compareWithOrgApacheCommonsMathDfpDfp_withOrgApacheCommonsMathDfpDfp_(self, x) > 0;
}
...
- (OrgApacheCommonsMathDfpDfp *)multiplyWithId:(OrgApacheCommonsMathDfpDfp *)x {
  ...
  IOSIntArray *product = [IOSIntArray newArrayWithLength:((IOSIntArray *) nil_chk(mant_))->size_ * 2];
  for (jint i = 0; i < mant_->size_; i++) {
    jint rh = 0;
...
- (OrgApacheCommonsMathDfpDfp *)divideWithId:(OrgApacheCommonsMathDfpDfp *)divisor {
  ...
  dividend = [IOSIntArray newArrayWithLength:mant_->size_ + 1];
  quotient = [IOSIntArray newArrayWithLength:mant_->size_ + 2];
  remainder = [IOSIntArray newArrayWithLength:mant_->size_ + 1];
...
- (NSString *)dfp2sci {
  IOSCharArray *rawdigits = [IOSCharArray newArrayWithLength:((IOSIntArray *) nil_chk(mant_))->size_ * 4];
  IOSCharArray *outputbuffer = [IOSCharArray newArrayWithLength:mant_->size_ * 4 + 20];
  jint p;
  jint q;
  jint e;
  jint ae;
...
- (NSString *)dfp2string {
  IOSCharArray *buffer = [IOSCharArray newArrayWithLength:((IOSIntArray *) nil_chk(mant_))->size_ * 4 + 20];
  jint p = 1;
  jint q;
  jint e = exp_;
...
- (IOSDoubleArray *)toSplitDouble {
  IOSDoubleArray *split = [IOSDoubleArray newArrayWithLength:2];
...
void OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_(OrgApacheCommonsMathDfpDfp *self, OrgApacheCommonsMathDfpDfpField *field) {
  ...
  self->mant_ = [IOSIntArray newArrayWithLength:[((OrgApacheCommonsMathDfpDfpField *) nil_chk(field)) getRadixDigits]];
  self->sign_ = 1;
  self->exp_ = 0;
...
void OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withByte_(OrgApacheCommonsMathDfpDfp *self, OrgApacheCommonsMathDfpDfpField *field, jbyte x) {
  (void) OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withLong_(self, field, (jlong) x);
}
...
void OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withDouble_(OrgApacheCommonsMathDfpDfp *self, OrgApacheCommonsMathDfpDfpField *field, jdouble x) {
  ...
  OrgApacheCommonsMathDfpDfp *xdfp = new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withLong_(field, mantissa);
  xdfp = [((OrgApacheCommonsMathDfpDfp *) nil_chk([xdfp divideWithId:new_OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withLong_(field, 4503599627370496l)])) addWithId:[field getOne]];
...
void OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfp_(OrgApacheCommonsMathDfpDfp *self, OrgApacheCommonsMathDfpDfp *d) {
  (void) NSObject_init(self);
  self->mant_ = [((IOSIntArray *) nil_chk(((OrgApacheCommonsMathDfpDfp *) nil_chk(d))->mant_)) clone];
  self->sign_ = d->sign_;
  self->exp_ = d->exp_;
  self->nans_ = d->nans_;
  self->field_ = d->field_;
}
...
void OrgApacheCommonsMathDfpDfp_initWithOrgApacheCommonsMathDfpDfpField_withNSString_(OrgApacheCommonsMathDfpDfp *self, OrgApacheCommonsMathDfpDfpField *field, NSString *s) {
  ...
  jint rsize = 4;
  jint offset = 4;
  IOSCharArray *striped = [IOSCharArray newArrayWithLength:[self getRadixDigits] * rsize + offset * 2];
