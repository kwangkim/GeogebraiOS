...
- (OrgApacheCommonsMathGeometryRotation *)revert {
  return new_OrgApacheCommonsMathGeometryRotation_initWithDouble_withDouble_withDouble_withDouble_withBoolean_(-q0_, q1_, q2_, q3_, NO);
}
...
- (OrgApacheCommonsMathGeometryVector3D *)getAxis {
  ...
  if (squaredSine == 0) {
    return new_OrgApacheCommonsMathGeometryVector3D_initWithDouble_withDouble_withDouble_(1, 0, 0);
  }
  else if (q0_ < 0) {
    jdouble inverse = 1 / OrgApacheCommonsMathUtilFastMath_sqrtWithDouble_(squaredSine);
    return new_OrgApacheCommonsMathGeometryVector3D_initWithDouble_withDouble_withDouble_(q1_ * inverse, q2_ * inverse, q3_ * inverse);
  }
  jdouble inverse = -1 / OrgApacheCommonsMathUtilFastMath_sqrtWithDouble_(squaredSine);
  return new_OrgApacheCommonsMathGeometryVector3D_initWithDouble_withDouble_withDouble_(q1_ * inverse, q2_ * inverse, q3_ * inverse);
}
...
- (IOSDoubleArray *)getAnglesWithOrgApacheCommonsMathGeometryRotationOrder:(OrgApacheCommonsMathGeometryRotationOrder *)order {
  if (order == OrgApacheCommonsMathGeometryRotationOrder_get_XYZ_()) {
    ...
    OrgApacheCommonsMathGeometryVector3D *v2 = [self applyInverseToWithOrgApacheCommonsMathGeometryVector3D:OrgApacheCommonsMathGeometryVector3D_get_PLUS_I_()];
    if (([((OrgApacheCommonsMathGeometryVector3D *) nil_chk(v2)) getX] < -0.9999999999) || ([v2 getX] > 0.9999999999)) {
      @throw new_OrgApacheCommonsMathGeometryCardanEulerSingularityException_initWithBoolean_(NO);
    }
...
- (IOSObjectArray *)getMatrix {
  ...
  IOSObjectArray *m = [IOSObjectArray newArrayWithLength:3 type:IOSClass_doubleArray(1)];
  (void) IOSObjectArray_SetAndConsume(m, 0, [IOSDoubleArray newArrayWithLength:3]);
  (void) IOSObjectArray_SetAndConsume(m, 1, [IOSDoubleArray newArrayWithLength:3]);
  (void) IOSObjectArray_SetAndConsume(m, 2, [IOSDoubleArray newArrayWithLength:3]);
...
- (OrgApacheCommonsMathGeometryVector3D *)applyToWithOrgApacheCommonsMathGeometryVector3D:(OrgApacheCommonsMathGeometryVector3D *)u {
  ...
  return new_OrgApacheCommonsMathGeometryVector3D_initWithDouble_withDouble_withDouble_(2 * (q0_ * (x * q0_ - (q2_ * z - q3_ * y)) + s * q1_) - x, 2 * (q0_ * (y * q0_ - (q3_ * x - q1_ * z)) + s * q2_) - y, 2 * (q0_ * (z * q0_ - (q1_ * y - q2_ * x)) + s * q3_) - z);
}
...
- (OrgApacheCommonsMathGeometryVector3D *)applyInverseToWithOrgApacheCommonsMathGeometryVector3D:(OrgApacheCommonsMathGeometryVector3D *)u {
  ...
  jdouble s = q1_ * x + q2_ * y + q3_ * z;
  jdouble m0 = -q0_;
  return new_OrgApacheCommonsMathGeometryVector3D_initWithDouble_withDouble_withDouble_(2 * (m0 * (x * m0 - (q2_ * z - q3_ * y)) + s * q1_) - x, 2 * (m0 * (y * m0 - (q3_ * x - q1_ * z)) + s * q2_) - y, 2 * (m0 * (z * m0 - (q1_ * y - q2_ * x)) + s * q3_) - z);
}
...
+ (void)initialize {
  if (self == [OrgApacheCommonsMathGeometryRotation class]) {
    OrgApacheCommonsMathGeometryRotation_IDENTITY_ = new_OrgApacheCommonsMathGeometryRotation_initWithDouble_withDouble_withDouble_withDouble_withBoolean_(1.0, 0.0, 0.0, 0.0, NO);
...
void OrgApacheCommonsMathGeometryRotation_initWithOrgApacheCommonsMathGeometryVector3D_withDouble_(OrgApacheCommonsMathGeometryRotation *self, OrgApacheCommonsMathGeometryVector3D *axis, jdouble angle) {
  ...
  if (norm == 0) {
    @throw OrgApacheCommonsMathMathRuntimeException_createArithmeticExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_ZERO_NORM_FOR_ROTATION_AXIS(), [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
  }
...
void OrgApacheCommonsMathGeometryRotation_initWithDoubleArray2_withDouble_(OrgApacheCommonsMathGeometryRotation *self, IOSObjectArray *m, jdouble threshold) {
  ...
  if (det < 0.0) {
    @throw new_OrgApacheCommonsMathGeometryNotARotationMatrixException_initWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_CLOSEST_ORTHOGONAL_MATRIX_HAS_NEGATIVE_DETERMINANT(), [IOSObjectArray newArrayWithObjects:(id[]){ JavaLangDouble_valueOfWithDouble_(det) } count:1 type:NSObject_class_()]);
  }
...
void OrgApacheCommonsMathGeometryRotation_initWithOrgApacheCommonsMathGeometryVector3D_withOrgApacheCommonsMathGeometryVector3D_withOrgApacheCommonsMathGeometryVector3D_withOrgApacheCommonsMathGeometryVector3D_(OrgApacheCommonsMathGeometryRotation *self, OrgApacheCommonsMathGeometryVector3D *u1, OrgApacheCommonsMathGeometryVector3D *u2, OrgApacheCommonsMathGeometryVector3D *v1, OrgApacheCommonsMathGeometryVector3D *v2) {
  ...
  if ((u1u1 == 0) || (u2u2 == 0) || (v1v1 == 0) || (v2v2 == 0)) {
    @throw OrgApacheCommonsMathMathRuntimeException_createIllegalArgumentExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_ZERO_NORM_FOR_ROTATION_DEFINING_VECTOR(), [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
  }
  ...
  v1 = new_OrgApacheCommonsMathGeometryVector3D_initWithDouble_withDouble_withDouble_(v1x, v1y, v1z);
  ...
  v2 = new_OrgApacheCommonsMathGeometryVector3D_initWithDouble_withDouble_withDouble_(v2x, v2y, v2z);
  ...
  OrgApacheCommonsMathGeometryVector3D *k = new_OrgApacheCommonsMathGeometryVector3D_initWithDouble_withDouble_withDouble_(dy1 * dz2 - dz1 * dy2, dz1 * dx2 - dx1 * dz2, dx1 * dy2 - dy1 * dx2);
  ...
  if (c == 0) {
    ...
    jdouble dy3 = v3y - u3y;
    jdouble dz3 = v3z - u3z;
    k = new_OrgApacheCommonsMathGeometryVector3D_initWithDouble_withDouble_withDouble_(dy1 * dz3 - dz1 * dy3, dz1 * dx3 - dx1 * dz3, dx1 * dy3 - dy1 * dx3);
    c = [k getX] * (u1y * u3z - u1z * u3y) + [k getY] * (u1z * u3x - u1x * u3z) + [k getZ] * (u1x * u3y - u1y * u3x);
    if (c == 0) {
      k = new_OrgApacheCommonsMathGeometryVector3D_initWithDouble_withDouble_withDouble_(dy2 * dz3 - dz2 * dy3, dz2 * dx3 - dx2 * dz3, dx2 * dy3 - dy2 * dx3);
  ...
  self->q2_ = inv * [k getY];
  self->q3_ = inv * [k getZ];
  k = new_OrgApacheCommonsMathGeometryVector3D_initWithDouble_withDouble_withDouble_([uRef getY] * self->q3_ - [uRef getZ] * self->q2_, [uRef getZ] * self->q1_ - [uRef getX] * self->q3_, [uRef getX] * self->q2_ - [uRef getY] * self->q1_);
...
void OrgApacheCommonsMathGeometryRotation_initWithOrgApacheCommonsMathGeometryRotationOrder_withDouble_withDouble_withDouble_(OrgApacheCommonsMathGeometryRotation *self, OrgApacheCommonsMathGeometryRotationOrder *order, jdouble alpha1, jdouble alpha2, jdouble alpha3) {
  (void) NSObject_init(self);
  OrgApacheCommonsMathGeometryRotation *r1 = new_OrgApacheCommonsMathGeometryRotation_initWithOrgApacheCommonsMathGeometryVector3D_withDouble_([((OrgApacheCommonsMathGeometryRotationOrder *) nil_chk(order)) getA1], alpha1);
  OrgApacheCommonsMathGeometryRotation *r2 = new_OrgApacheCommonsMathGeometryRotation_initWithOrgApacheCommonsMathGeometryVector3D_withDouble_([order getA2], alpha2);
  OrgApacheCommonsMathGeometryRotation *r3 = new_OrgApacheCommonsMathGeometryRotation_initWithOrgApacheCommonsMathGeometryVector3D_withDouble_([order getA3], alpha3);
...
IOSObjectArray *OrgApacheCommonsMathGeometryRotation_orthogonalizeMatrixWithDoubleArray2_withDouble_(OrgApacheCommonsMathGeometryRotation *self, IOSObjectArray *m, jdouble threshold) {
  ...
  jdouble fn = 0;
  jdouble fn1;
  IOSObjectArray *o = [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ 3, 3 }];
