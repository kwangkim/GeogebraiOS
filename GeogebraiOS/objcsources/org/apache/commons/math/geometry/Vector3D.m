...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/apache/commons/math/geometry/Vector3D.java
//
...
- (OrgApacheCommonsMathGeometryVector3D *)addWithOrgApacheCommonsMathGeometryVector3D:(OrgApacheCommonsMathGeometryVector3D *)v {
  return new_OrgApacheCommonsMathGeometryVector3D_initWithDouble_withDouble_withDouble_(x_ + ((OrgApacheCommonsMathGeometryVector3D *) nil_chk(v))->x_, y_ + v->y_, z_ + v->z_);
}
...
- (OrgApacheCommonsMathGeometryVector3D *)addWithDouble:(jdouble)factor
  ...
  return new_OrgApacheCommonsMathGeometryVector3D_initWithDouble_withDouble_withDouble_(x_ + factor * ((OrgApacheCommonsMathGeometryVector3D *) nil_chk(v))->x_, y_ + factor * v->y_, z_ + factor * v->z_);
}
...
- (OrgApacheCommonsMathGeometryVector3D *)orthogonal {
  ...
  if (threshold == 0) {
    @throw OrgApacheCommonsMathMathRuntimeException_createArithmeticExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_ZERO_NORM(), [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
  }
  if ((x_ >= -threshold) && (x_ <= threshold)) {
    jdouble inverse = 1 / OrgApacheCommonsMathUtilFastMath_sqrtWithDouble_(y_ * y_ + z_ * z_);
    return new_OrgApacheCommonsMathGeometryVector3D_initWithDouble_withDouble_withDouble_(0, inverse * z_, -inverse * y_);
  }
  else if ((y_ >= -threshold) && (y_ <= threshold)) {
    jdouble inverse = 1 / OrgApacheCommonsMathUtilFastMath_sqrtWithDouble_(x_ * x_ + z_ * z_);
    return new_OrgApacheCommonsMathGeometryVector3D_initWithDouble_withDouble_withDouble_(-inverse * z_, 0, inverse * x_);
  }
  jdouble inverse = 1 / OrgApacheCommonsMathUtilFastMath_sqrtWithDouble_(x_ * x_ + y_ * y_);
  return new_OrgApacheCommonsMathGeometryVector3D_initWithDouble_withDouble_withDouble_(inverse * y_, -inverse * x_, 0);
}
...
- (OrgApacheCommonsMathGeometryVector3D *)negate {
  return new_OrgApacheCommonsMathGeometryVector3D_initWithDouble_withDouble_withDouble_(-x_, -y_, -z_);
}

- (OrgApacheCommonsMathGeometryVector3D *)scalarMultiplyWithDouble:(jdouble)a {
  return new_OrgApacheCommonsMathGeometryVector3D_initWithDouble_withDouble_withDouble_(a * x_, a * y_, a * z_);
}
...
+ (void)initialize {
  if (self == [OrgApacheCommonsMathGeometryVector3D class]) {
    OrgApacheCommonsMathGeometryVector3D_ZERO_ = new_OrgApacheCommonsMathGeometryVector3D_initWithDouble_withDouble_withDouble_(0, 0, 0);
    OrgApacheCommonsMathGeometryVector3D_PLUS_I_ = new_OrgApacheCommonsMathGeometryVector3D_initWithDouble_withDouble_withDouble_(1, 0, 0);
    OrgApacheCommonsMathGeometryVector3D_MINUS_I_ = new_OrgApacheCommonsMathGeometryVector3D_initWithDouble_withDouble_withDouble_(-1, 0, 0);
    OrgApacheCommonsMathGeometryVector3D_PLUS_J_ = new_OrgApacheCommonsMathGeometryVector3D_initWithDouble_withDouble_withDouble_(0, 1, 0);
    OrgApacheCommonsMathGeometryVector3D_MINUS_J_ = new_OrgApacheCommonsMathGeometryVector3D_initWithDouble_withDouble_withDouble_(0, -1, 0);
    OrgApacheCommonsMathGeometryVector3D_PLUS_K_ = new_OrgApacheCommonsMathGeometryVector3D_initWithDouble_withDouble_withDouble_(0, 0, 1);
    OrgApacheCommonsMathGeometryVector3D_MINUS_K_ = new_OrgApacheCommonsMathGeometryVector3D_initWithDouble_withDouble_withDouble_(0, 0, -1);
    OrgApacheCommonsMathGeometryVector3D_NaN_ = new_OrgApacheCommonsMathGeometryVector3D_initWithDouble_withDouble_withDouble_(JavaLangDouble_NaN, JavaLangDouble_NaN, JavaLangDouble_NaN);
    OrgApacheCommonsMathGeometryVector3D_POSITIVE_INFINITY_ = new_OrgApacheCommonsMathGeometryVector3D_initWithDouble_withDouble_withDouble_(JavaLangDouble_POSITIVE_INFINITY, JavaLangDouble_POSITIVE_INFINITY, JavaLangDouble_POSITIVE_INFINITY);
    OrgApacheCommonsMathGeometryVector3D_NEGATIVE_INFINITY_ = new_OrgApacheCommonsMathGeometryVector3D_initWithDouble_withDouble_withDouble_(JavaLangDouble_NEGATIVE_INFINITY, JavaLangDouble_NEGATIVE_INFINITY, JavaLangDouble_NEGATIVE_INFINITY);
    OrgApacheCommonsMathGeometryVector3D_DEFAULT_FORMAT_ = OrgApacheCommonsMathGeometryVector3DFormat_getInstance();
...
OrgApacheCommonsMathGeometryVector3D *OrgApacheCommonsMathGeometryVector3D_crossProductWithOrgApacheCommonsMathGeometryVector3D_withOrgApacheCommonsMathGeometryVector3D_(OrgApacheCommonsMathGeometryVector3D *v1, OrgApacheCommonsMathGeometryVector3D *v2) {
  OrgApacheCommonsMathGeometryVector3D_initialize();
  return new_OrgApacheCommonsMathGeometryVector3D_initWithDouble_withDouble_withDouble_(((OrgApacheCommonsMathGeometryVector3D *) nil_chk(v1))->y_ * ((OrgApacheCommonsMathGeometryVector3D *) nil_chk(v2))->z_ - v1->z_ * v2->y_, v1->z_ * v2->x_ - v1->x_ * v2->z_, v1->x_ * v2->y_ - v1->y_ * v2->x_);
}
