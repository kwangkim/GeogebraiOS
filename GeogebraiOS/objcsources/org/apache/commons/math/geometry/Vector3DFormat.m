...
- (JavaLangStringBuffer *)formatWithOrgApacheCommonsMathGeometryVector3D:(OrgApacheCommonsMathGeometryVector3D *)vector
  ...
  (void) [self formatDoubleWithDouble:[((OrgApacheCommonsMathGeometryVector3D *) nil_chk(vector)) getX] withJavaTextNumberFormat:format__ withJavaLangStringBuffer:toAppendTo withJavaTextFieldPosition:pos];
  (void) [toAppendTo appendWithNSString:separator_];
  (void) [self formatDoubleWithDouble:[vector getY] withJavaTextNumberFormat:format__ withJavaLangStringBuffer:toAppendTo withJavaTextFieldPosition:pos];
  (void) [toAppendTo appendWithNSString:separator_];
  (void) [self formatDoubleWithDouble:[vector getZ] withJavaTextNumberFormat:format__ withJavaLangStringBuffer:toAppendTo withJavaTextFieldPosition:pos];
...
- (OrgApacheCommonsMathGeometryVector3D *)parseWithNSString:(NSString *)source
  ...
  return new_OrgApacheCommonsMathGeometryVector3D_initWithDouble_withDouble_withDouble_([((NSNumber *) nil_chk(x)) doubleValue], [((NSNumber *) nil_chk(y)) doubleValue], [((NSNumber *) nil_chk(z)) doubleValue]);
}
...
void OrgApacheCommonsMathGeometryVector3DFormat_initWithNSString_withNSString_withNSString_(OrgApacheCommonsMathGeometryVector3DFormat *self, NSString *prefix, NSString *suffix, NSString *separator) {
  (void) OrgApacheCommonsMathGeometryVector3DFormat_initWithNSString_withNSString_withNSString_withJavaTextNumberFormat_(self, prefix, suffix, separator, OrgApacheCommonsMathUtilCompositeFormat_getDefaultNumberFormat());
}
...
OrgApacheCommonsMathGeometryVector3DFormat *OrgApacheCommonsMathGeometryVector3DFormat_getInstanceWithJavaUtilLocale_(JavaUtilLocale *locale) {
  OrgApacheCommonsMathGeometryVector3DFormat_initialize();
  return new_OrgApacheCommonsMathGeometryVector3DFormat_initWithJavaTextNumberFormat_(OrgApacheCommonsMathUtilCompositeFormat_getDefaultNumberFormatWithJavaUtilLocale_(locale));
}
