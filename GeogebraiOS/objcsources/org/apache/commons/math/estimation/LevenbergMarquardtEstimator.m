...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/apache/commons/math/estimation/LevenbergMarquardtEstimator.java
//
...
- (void)estimateWithOrgApacheCommonsMathEstimationEstimationProblem:(id<OrgApacheCommonsMathEstimationEstimationProblem>)problem {
  ...
  OrgApacheCommonsMathEstimationLevenbergMarquardtEstimator_setAndConsume_diagR_(self, [IOSDoubleArray newArrayWithLength:cols_]);
  OrgApacheCommonsMathEstimationLevenbergMarquardtEstimator_setAndConsume_jacNorm_(self, [IOSDoubleArray newArrayWithLength:cols_]);
  OrgApacheCommonsMathEstimationLevenbergMarquardtEstimator_setAndConsume_beta_(self, [IOSDoubleArray newArrayWithLength:cols_]);
  OrgApacheCommonsMathEstimationLevenbergMarquardtEstimator_setAndConsume_permutation_(self, [IOSIntArray newArrayWithLength:cols_]);
  OrgApacheCommonsMathEstimationLevenbergMarquardtEstimator_setAndConsume_lmDir_(self, [IOSDoubleArray newArrayWithLength:cols_]);
  jdouble delta = 0;
  jdouble xNorm = 0;
  ...
  while (YES) {
    ...
    for (jdouble ratio = 0; ratio < 1.0e-4; ) {
      ...
      OrgApacheCommonsMathEstimationAbstractEstimator_set_residuals_(self, oldRes);
      oldRes = tmpVec;
      ...
      if ((OrgApacheCommonsMathUtilFastMath_absWithDouble_(actRed) <= 2.2204e-16) && (preRed <= 2.2204e-16) && (ratio <= 2.0)) {
        @throw [new_OrgApacheCommonsMathEstimationEstimationException_initWithNSString_withNSObjectArray_(@"cost relative tolerance is too small ({0}), no further reduction in the sum of squares is possible", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangDouble_valueOfWithDouble_(costRelativeTolerance_) } count:1 type:NSObject_class_()]) autorelease];
      }
      else if (delta <= 2.2204e-16 * xNorm) {
        @throw [new_OrgApacheCommonsMathEstimationEstimationException_initWithNSString_withNSObjectArray_(@"parameters relative tolerance is too small ({0}), no further improvement in the approximate solution is possible", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangDouble_valueOfWithDouble_(parRelativeTolerance_) } count:1 type:NSObject_class_()]) autorelease];
      }
      else if (maxCosine <= 2.2204e-16) {
        @throw [new_OrgApacheCommonsMathEstimationEstimationException_initWithNSString_withNSObjectArray_(@"orthogonality tolerance is too small ({0}), solution is orthogonal to the jacobian", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangDouble_valueOfWithDouble_(orthoTolerance_) } count:1 type:NSObject_class_()]) autorelease];
      }
    }
  }
}
