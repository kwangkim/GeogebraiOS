...
- (void)estimateWithOrgApacheCommonsMathEstimationEstimationProblem:(id<OrgApacheCommonsMathEstimationEstimationProblem>)problem {
  ...
  IOSDoubleArray *grad = [IOSDoubleArray newArrayWithLength:((IOSObjectArray *) nil_chk(parameters_))->size_];
  OrgApacheCommonsMathLinearArrayRealVector *bDecrement = new_OrgApacheCommonsMathLinearArrayRealVector_initWithInt_(parameters_->size_);
  ...
  do {
    ...
    id<OrgApacheCommonsMathLinearRealVector> b = new_OrgApacheCommonsMathLinearArrayRealVector_initWithInt_(parameters_->size_);
    ...
    @try {
      id<OrgApacheCommonsMathLinearRealVector> dX = [((id<OrgApacheCommonsMathLinearDecompositionSolver>) nil_chk([new_OrgApacheCommonsMathLinearLUDecompositionImpl_initWithOrgApacheCommonsMathLinearRealMatrix_(a) getSolver])) solveWithOrgApacheCommonsMathLinearRealVector:b];
    ...
    @catch (OrgApacheCommonsMathLinearInvalidMatrixException *e) {
      @throw new_OrgApacheCommonsMathEstimationEstimationException_initWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_UNABLE_TO_SOLVE_SINGULAR_PROBLEM(), [IOSObjectArray newArrayWithLength:0 type:NSObject_class_()]);
    }
    previous = cost_;
