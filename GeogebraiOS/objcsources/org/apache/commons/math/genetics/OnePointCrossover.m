...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/apache/commons/math/genetics/OnePointCrossover.java
//
...
- (OrgApacheCommonsMathGeneticsChromosomePair *)crossoverWithOrgApacheCommonsMathGeneticsChromosome:(OrgApacheCommonsMathGeneticsChromosome *)first
  ...
  if (!([first isKindOfClass:[OrgApacheCommonsMathGeneticsAbstractListChromosome class]] && [second isKindOfClass:[OrgApacheCommonsMathGeneticsAbstractListChromosome class]])) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"One point crossover works on FixedLengthChromosomes only.");
  }
...
OrgApacheCommonsMathGeneticsChromosomePair *OrgApacheCommonsMathGeneticsOnePointCrossover_crossoverWithOrgApacheCommonsMathGeneticsAbstractListChromosome_withOrgApacheCommonsMathGeneticsAbstractListChromosome_(OrgApacheCommonsMathGeneticsOnePointCrossover *self, OrgApacheCommonsMathGeneticsAbstractListChromosome *first, OrgApacheCommonsMathGeneticsAbstractListChromosome *second) {
  ...
  if (length != [((OrgApacheCommonsMathGeneticsAbstractListChromosome *) nil_chk(second)) getLength]) @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"Both chromosomes must have same lengths.");
  id<JavaUtilList> parent1Rep = [first getRepresentation];
  id<JavaUtilList> parent2Rep = [second getRepresentation];
  JavaUtilArrayList *child1Rep = new_JavaUtilArrayList_initWithInt_([first getLength]);
  JavaUtilArrayList *child2Rep = new_JavaUtilArrayList_initWithInt_([second getLength]);
  ...
  return new_OrgApacheCommonsMathGeneticsChromosomePair_initWithOrgApacheCommonsMathGeneticsChromosome_withOrgApacheCommonsMathGeneticsChromosome_([first newFixedLengthChromosomeWithJavaUtilList:child1Rep], [second newFixedLengthChromosomeWithJavaUtilList:child2Rep]);
}
