...
- (id<OrgApacheCommonsMathLinearRealMatrix>)getCorrelationStandardErrors {
  ...
  IOSObjectArray *out = [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ nVars, nVars }];
  ...
  return new_OrgApacheCommonsMathLinearBlockRealMatrix_initWithDoubleArray2_(out);
}

- (id<OrgApacheCommonsMathLinearRealMatrix>)getCorrelationPValues {
  id<OrgApacheCommonsMathDistributionTDistribution> tDistribution = new_OrgApacheCommonsMathDistributionTDistributionImpl_initWithDouble_(nObs_ - 2);
  jint nVars = [((id<OrgApacheCommonsMathLinearRealMatrix>) nil_chk(correlationMatrix_)) getColumnDimension];
  IOSObjectArray *out = [IOSDoubleArray newArrayWithDimensions:2 lengths:(jint[]){ nVars, nVars }];
  for (jint i = 0; i < nVars; i++) {
    for (jint j = 0; j < nVars; j++) {
...
- (id<OrgApacheCommonsMathLinearRealMatrix>)computeCorrelationMatrixWithOrgApacheCommonsMathLinearRealMatrix:(id<OrgApacheCommonsMathLinearRealMatrix>)matrix {
  ...
  id<OrgApacheCommonsMathLinearRealMatrix> outMatrix = new_OrgApacheCommonsMathLinearBlockRealMatrix_initWithInt_withInt_(nVars, nVars);
  for (jint i = 0; i < nVars; i++) {
    for (jint j = 0; j < i; j++) {
...
- (id<OrgApacheCommonsMathLinearRealMatrix>)computeCorrelationMatrixWithDoubleArray2:(IOSObjectArray *)data {
  return [self computeCorrelationMatrixWithOrgApacheCommonsMathLinearRealMatrix:new_OrgApacheCommonsMathLinearBlockRealMatrix_initWithDoubleArray2_(data)];
}

- (jdouble)correlationWithDoubleArray:(IOSDoubleArray *)xArray
                      withDoubleArray:(IOSDoubleArray *)yArray {
  OrgApacheCommonsMathStatRegressionSimpleRegression *regression = new_OrgApacheCommonsMathStatRegressionSimpleRegression_init();
  if (((IOSDoubleArray *) nil_chk(xArray))->size_ != ((IOSDoubleArray *) nil_chk(yArray))->size_) {
    @throw new_OrgApacheCommonsMathExceptionDimensionMismatchException_initWithInt_withInt_(xArray->size_, yArray->size_);
  }
...
void OrgApacheCommonsMathStatCorrelationPearsonsCorrelation_initWithDoubleArray2_(OrgApacheCommonsMathStatCorrelationPearsonsCorrelation *self, IOSObjectArray *data) {
  (void) OrgApacheCommonsMathStatCorrelationPearsonsCorrelation_initWithOrgApacheCommonsMathLinearRealMatrix_(self, new_OrgApacheCommonsMathLinearBlockRealMatrix_initWithDoubleArray2_(data));
}
...
void OrgApacheCommonsMathStatCorrelationPearsonsCorrelation_initWithOrgApacheCommonsMathLinearRealMatrix_(OrgApacheCommonsMathStatCorrelationPearsonsCorrelation *self, id<OrgApacheCommonsMathLinearRealMatrix> matrix) {
  ...
  self->correlationMatrix_ = [self computeCorrelationMatrixWithOrgApacheCommonsMathLinearRealMatrix:matrix];
}
...
void OrgApacheCommonsMathStatCorrelationPearsonsCorrelation_initWithOrgApacheCommonsMathStatCorrelationCovariance_(OrgApacheCommonsMathStatCorrelationPearsonsCorrelation *self, OrgApacheCommonsMathStatCorrelationCovariance *covariance) {
  ...
  if (covarianceMatrix == nil) {
    @throw new_OrgApacheCommonsMathExceptionNullArgumentException_initWithOrgApacheCommonsMathExceptionUtilLocalizable_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_COVARIANCE_MATRIX());
  }
  self->nObs_ = [covariance getN];
  self->correlationMatrix_ = [self covarianceToCorrelationWithOrgApacheCommonsMathLinearRealMatrix:covarianceMatrix];
}
