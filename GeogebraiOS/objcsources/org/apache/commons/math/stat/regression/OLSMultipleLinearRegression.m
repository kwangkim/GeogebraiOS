...
- (void)newSampleDataWithDoubleArray:(IOSDoubleArray *)data
  ...
  qr_ = new_OrgApacheCommonsMathLinearQRDecompositionImpl_initWithOrgApacheCommonsMathLinearRealMatrix_(X_);
}
...
- (id<OrgApacheCommonsMathLinearRealMatrix>)calculateHat {
  ...
  OrgApacheCommonsMathLinearArray2DRowRealMatrix *augI = new_OrgApacheCommonsMathLinearArray2DRowRealMatrix_initWithInt_withInt_(n, n);
...
- (jdouble)calculateTotalSumOfSquares {
  if ([self isNoIntercept]) {
    ...
    return [new_OrgApacheCommonsMathStatDescriptiveMomentSecondMoment_init() evaluateWithDoubleArray:[((id<OrgApacheCommonsMathLinearRealVector>) nil_chk(Y_)) getData]];
  }
}
...
- (id<OrgApacheCommonsMathLinearRealMatrix>)calculateBetaVariance {
  ...
  id<OrgApacheCommonsMathLinearRealMatrix> Rinv = [((id<OrgApacheCommonsMathLinearDecompositionSolver>) nil_chk([new_OrgApacheCommonsMathLinearLUDecompositionImpl_initWithOrgApacheCommonsMathLinearRealMatrix_(Raug) getSolver])) getInverse];
