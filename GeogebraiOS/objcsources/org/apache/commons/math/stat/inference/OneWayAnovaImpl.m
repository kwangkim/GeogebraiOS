...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/apache/commons/math/stat/inference/OneWayAnovaImpl.java
//
...
- (jdouble)anovaPValueWithJavaUtilCollection:(id<JavaUtilCollection>)categoryData {
  OrgApacheCommonsMathStatInferenceOneWayAnovaImpl_AnovaStats *a = OrgApacheCommonsMathStatInferenceOneWayAnovaImpl_anovaStatsWithJavaUtilCollection_(self, categoryData);
  id<OrgApacheCommonsMathDistributionFDistribution> fdist = new_OrgApacheCommonsMathDistributionFDistributionImpl_initWithDouble_withDouble_(((OrgApacheCommonsMathStatInferenceOneWayAnovaImpl_AnovaStats *) nil_chk(a))->dfbg_, a->dfwg_);
...
- (jboolean)anovaTestWithJavaUtilCollection:(id<JavaUtilCollection>)categoryData
  ...
  if ((alpha <= 0) || (alpha > 0.5)) {
    @throw OrgApacheCommonsMathMathRuntimeException_createIllegalArgumentExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_OUT_OF_BOUND_SIGNIFICANCE_LEVEL(), [IOSObjectArray newArrayWithObjects:(id[]){ JavaLangDouble_valueOfWithDouble_(alpha), JavaLangInteger_valueOfWithInt_(0), JavaLangDouble_valueOfWithDouble_(0.5) } count:3 type:NSObject_class_()]);
  }
...
OrgApacheCommonsMathStatInferenceOneWayAnovaImpl_AnovaStats *OrgApacheCommonsMathStatInferenceOneWayAnovaImpl_anovaStatsWithJavaUtilCollection_(OrgApacheCommonsMathStatInferenceOneWayAnovaImpl *self, id<JavaUtilCollection> categoryData) {
  ...
  for (IOSDoubleArray * __strong array in categoryData) {
    if (((IOSDoubleArray *) nil_chk(array))->size_ <= 1) {
      @throw OrgApacheCommonsMathMathRuntimeException_createIllegalArgumentExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_TWO_OR_MORE_VALUES_IN_CATEGORY_REQUIRED(), [IOSObjectArray newArrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(array->size_) } count:1 type:NSObject_class_()]);
    }
  }
  jint dfwg = 0;
  jdouble sswg = 0;
  ...
  jdouble F = msbg / mswg;
  return new_OrgApacheCommonsMathStatInferenceOneWayAnovaImpl_AnovaStats_initWithInt_withInt_withDouble_(dfbg, dfwg, F);
}
