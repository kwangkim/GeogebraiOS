...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/apache/commons/math/stat/descriptive/StatisticalSummaryValues.java
//
...
- (NSString *)description {
  ...
  NSString *endl = @"\n";
  (void) [((JavaLangStringBuilder *) nil_chk([outBuffer appendWithNSString:@"StatisticalSummaryValues:"])) appendWithNSString:endl];
  ...
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([outBuffer appendWithNSString:@"sum: "])) appendWithDouble:[self getSum]])) appendWithNSString:endl];
