...
void OrgApacheCommonsMathDistributionBetaDistributionImpl_initWithDouble_withDouble_(OrgApacheCommonsMathDistributionBetaDistributionImpl *self, jdouble alpha, jdouble beta) {
  (void) OrgApacheCommonsMathDistributionBetaDistributionImpl_initWithDouble_withDouble_withDouble_(self, alpha, beta, OrgApacheCommonsMathDistributionBetaDistributionImpl_DEFAULT_INVERSE_ABSOLUTE_ACCURACY);
}
