...
void OrgApacheCommonsMathDistributionNormalDistributionImpl_initWithDouble_withDouble_(OrgApacheCommonsMathDistributionNormalDistributionImpl *self, jdouble mean, jdouble sd) {
  (void) OrgApacheCommonsMathDistributionNormalDistributionImpl_initWithDouble_withDouble_withDouble_(self, mean, sd, OrgApacheCommonsMathDistributionNormalDistributionImpl_DEFAULT_INVERSE_ABSOLUTE_ACCURACY);
}
...
void OrgApacheCommonsMathDistributionNormalDistributionImpl_init(OrgApacheCommonsMathDistributionNormalDistributionImpl *self) {
  (void) OrgApacheCommonsMathDistributionNormalDistributionImpl_initWithDouble_withDouble_(self, 0.0, 1.0);
}
