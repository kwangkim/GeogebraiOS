...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/apache/commons/math/distribution/ZipfDistributionImpl.java
//
...
void OrgApacheCommonsMathDistributionZipfDistributionImpl_setExponentInternalWithDouble_(OrgApacheCommonsMathDistributionZipfDistributionImpl *self, jdouble s) {
  if (s <= 0.0) {
    @throw OrgApacheCommonsMathMathRuntimeException_createIllegalArgumentExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_NOT_POSITIVE_EXPONENT(), [IOSObjectArray newArrayWithObjects:(id[]){ JavaLangDouble_valueOfWithDouble_(s) } count:1 type:NSObject_class_()]);
  }
  self->exponent_ = s;
}
