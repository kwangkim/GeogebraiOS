...
IOSIntArray *OrgApacheCommonsMathDistributionHypergeometricDistributionImpl_getDomainWithInt_withInt_withInt_(OrgApacheCommonsMathDistributionHypergeometricDistributionImpl *self, jint n, jint m, jint k) {
  return [IOSIntArray newArrayWithInts:(jint[]){ OrgApacheCommonsMathDistributionHypergeometricDistributionImpl_getLowerDomainWithInt_withInt_withInt_(self, n, m, k), OrgApacheCommonsMathDistributionHypergeometricDistributionImpl_getUpperDomainWithInt_withInt_(self, m, k) } count:2];
}
...
void OrgApacheCommonsMathDistributionHypergeometricDistributionImpl_setNumberOfSuccessesInternalWithInt_(OrgApacheCommonsMathDistributionHypergeometricDistributionImpl *self, jint num) {
  if (num < 0) {
    @throw OrgApacheCommonsMathMathRuntimeException_createIllegalArgumentExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_NEGATIVE_NUMBER_OF_SUCCESSES(), [IOSObjectArray newArrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(num) } count:1 type:NSObject_class_()]);
  }
...
void OrgApacheCommonsMathDistributionHypergeometricDistributionImpl_setPopulationSizeInternalWithInt_(OrgApacheCommonsMathDistributionHypergeometricDistributionImpl *self, jint size) {
  if (size <= 0) {
    @throw OrgApacheCommonsMathMathRuntimeException_createIllegalArgumentExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_NOT_POSITIVE_POPULATION_SIZE(), [IOSObjectArray newArrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(size) } count:1 type:NSObject_class_()]);
  }
