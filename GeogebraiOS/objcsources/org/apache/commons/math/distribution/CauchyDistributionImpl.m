...
void OrgApacheCommonsMathDistributionCauchyDistributionImpl_init(OrgApacheCommonsMathDistributionCauchyDistributionImpl *self) {
  (void) OrgApacheCommonsMathDistributionCauchyDistributionImpl_initWithDouble_withDouble_(self, 0.0, 1.0);
}
...
void OrgApacheCommonsMathDistributionCauchyDistributionImpl_initWithDouble_withDouble_(OrgApacheCommonsMathDistributionCauchyDistributionImpl *self, jdouble median, jdouble s) {
  (void) OrgApacheCommonsMathDistributionCauchyDistributionImpl_initWithDouble_withDouble_withDouble_(self, median, s, OrgApacheCommonsMathDistributionCauchyDistributionImpl_DEFAULT_INVERSE_ABSOLUTE_ACCURACY);
}
...
void OrgApacheCommonsMathDistributionCauchyDistributionImpl_setScaleInternalWithDouble_(OrgApacheCommonsMathDistributionCauchyDistributionImpl *self, jdouble s) {
  if (s <= 0.0) {
    @throw OrgApacheCommonsMathMathRuntimeException_createIllegalArgumentExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_NOT_POSITIVE_SCALE(), [IOSObjectArray newArrayWithObjects:(id[]){ JavaLangDouble_valueOfWithDouble_(s) } count:1 type:NSObject_class_()]);
  }
  self->scale__ = s;
}
