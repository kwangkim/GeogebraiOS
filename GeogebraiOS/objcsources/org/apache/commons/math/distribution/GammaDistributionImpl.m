...
void OrgApacheCommonsMathDistributionGammaDistributionImpl_initWithDouble_withDouble_(OrgApacheCommonsMathDistributionGammaDistributionImpl *self, jdouble alpha, jdouble beta) {
  (void) OrgApacheCommonsMathDistributionGammaDistributionImpl_initWithDouble_withDouble_withDouble_(self, alpha, beta, OrgApacheCommonsMathDistributionGammaDistributionImpl_DEFAULT_INVERSE_ABSOLUTE_ACCURACY);
}
...
void OrgApacheCommonsMathDistributionGammaDistributionImpl_setAlphaInternalWithDouble_(OrgApacheCommonsMathDistributionGammaDistributionImpl *self, jdouble newAlpha) {
  if (newAlpha <= 0.0) {
    @throw OrgApacheCommonsMathMathRuntimeException_createIllegalArgumentExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_NOT_POSITIVE_ALPHA(), [IOSObjectArray newArrayWithObjects:(id[]){ JavaLangDouble_valueOfWithDouble_(newAlpha) } count:1 type:NSObject_class_()]);
  }
...
void OrgApacheCommonsMathDistributionGammaDistributionImpl_setBetaInternalWithDouble_(OrgApacheCommonsMathDistributionGammaDistributionImpl *self, jdouble newBeta) {
  if (newBeta <= 0.0) {
    @throw OrgApacheCommonsMathMathRuntimeException_createIllegalArgumentExceptionWithOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_NOT_POSITIVE_BETA(), [IOSObjectArray newArrayWithObjects:(id[]){ JavaLangDouble_valueOfWithDouble_(newBeta) } count:1 type:NSObject_class_()]);
  }
  self->beta_ = newBeta;
}
