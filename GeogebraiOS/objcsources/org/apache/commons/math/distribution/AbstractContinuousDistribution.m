...
- (jdouble)inverseCumulativeProbabilityWithDouble:(jdouble)p {
  ...
  id<OrgApacheCommonsMathAnalysisUnivariateRealFunction> rootFindingFunction = new_OrgApacheCommonsMathDistributionAbstractContinuousDistribution_$1_initWithOrgApacheCommonsMathDistributionAbstractContinuousDistribution_withDouble_(self, p);
  ...
  @catch (OrgApacheCommonsMathConvergenceException *ex) {
    ...
    @throw new_OrgApacheCommonsMathMathException_initWithJavaLangThrowable_(ex);
  }
...
- (IOSDoubleArray *)sampleWithInt:(jint)sampleSize {
  ...
  IOSDoubleArray *out = [IOSDoubleArray newArrayWithLength:sampleSize];
...
- (jdouble)valueWithDouble:(jdouble)x {
  ...
  @catch (OrgApacheCommonsMathMathException *ex) {
    @throw new_OrgApacheCommonsMathFunctionEvaluationException_initWithDouble_withOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(x, [((OrgApacheCommonsMathMathException *) nil_chk(ex)) getSpecificPattern], [IOSObjectArray newArrayWithObjects:(id[]){ [ex getGeneralPattern], [ex getArguments] } count:2 type:NSObject_class_()]);
  }
  if (JavaLangDouble_isNaNWithDouble_(ret)) {
    @throw new_OrgApacheCommonsMathFunctionEvaluationException_initWithDouble_withOrgApacheCommonsMathExceptionUtilLocalizable_withNSObjectArray_(x, OrgApacheCommonsMathExceptionUtilLocalizedFormatsEnum_get_CUMULATIVE_PROBABILITY_RETURNED_NAN(), [IOSObjectArray newArrayWithObjects:(id[]){ JavaLangDouble_valueOfWithDouble_(x), JavaLangDouble_valueOfWithDouble_(val$p_) } count:2 type:NSObject_class_()]);
  }
  return ret;
}
