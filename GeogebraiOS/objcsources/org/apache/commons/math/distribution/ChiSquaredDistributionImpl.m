...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/apache/commons/math/distribution/ChiSquaredDistributionImpl.java
//
...
void OrgApacheCommonsMathDistributionChiSquaredDistributionImpl_initWithDouble_(OrgApacheCommonsMathDistributionChiSquaredDistributionImpl *self, jdouble df) {
  (void) OrgApacheCommonsMathDistributionChiSquaredDistributionImpl_initWithDouble_withOrgApacheCommonsMathDistributionGammaDistribution_(self, df, new_OrgApacheCommonsMathDistributionGammaDistributionImpl_initWithDouble_withDouble_(df / 2.0, 2.0));
}
...
void OrgApacheCommonsMathDistributionChiSquaredDistributionImpl_initWithDouble_withDouble_(OrgApacheCommonsMathDistributionChiSquaredDistributionImpl *self, jdouble df, jdouble inverseCumAccuracy) {
  (void) OrgApacheCommonsMathDistributionAbstractContinuousDistribution_init(self);
  self->gamma_ = new_OrgApacheCommonsMathDistributionGammaDistributionImpl_initWithDouble_withDouble_(df / 2.0, 2.0);
  OrgApacheCommonsMathDistributionChiSquaredDistributionImpl_setDegreesOfFreedomInternalWithDouble_(self, df);
