...
+ (void)initialize {
  if (self == [OrgApacheCommonsCollections15ComparatorsBooleanComparator class]) {
    OrgApacheCommonsCollections15ComparatorsBooleanComparator_TRUE_FIRST_ = new_OrgApacheCommonsCollections15ComparatorsBooleanComparator_initWithBoolean_(YES);
    OrgApacheCommonsCollections15ComparatorsBooleanComparator_FALSE_FIRST_ = new_OrgApacheCommonsCollections15ComparatorsBooleanComparator_initWithBoolean_(NO);
...
void OrgApacheCommonsCollections15ComparatorsBooleanComparator_init(OrgApacheCommonsCollections15ComparatorsBooleanComparator *self) {
  (void) OrgApacheCommonsCollections15ComparatorsBooleanComparator_initWithBoolean_(self, NO);
}
