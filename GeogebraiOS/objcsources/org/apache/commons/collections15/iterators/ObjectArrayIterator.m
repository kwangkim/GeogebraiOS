...
- (void)remove {
  @throw new_JavaLangUnsupportedOperationException_initWithNSString_(@"remove() method is not supported for an ObjectArrayIterator");
}
...
- (void)setArrayWithNSObjectArray:(IOSObjectArray *)array {
  if (self->array_ != nil) {
    @throw new_JavaLangIllegalStateException_initWithNSString_(@"The array to iterate over has already been set");
  }
  self->array_ = array;
  self->startIndex_ = 0;
...
void OrgApacheCommonsCollections15IteratorsObjectArrayIterator_initWithNSObjectArray_(OrgApacheCommonsCollections15IteratorsObjectArrayIterator *self, IOSObjectArray *array) {
  (void) OrgApacheCommonsCollections15IteratorsObjectArrayIterator_initWithNSObjectArray_withInt_withInt_(self, array, 0, ((IOSObjectArray *) nil_chk(array))->size_);
}
...
void OrgApacheCommonsCollections15IteratorsObjectArrayIterator_initWithNSObjectArray_withInt_(OrgApacheCommonsCollections15IteratorsObjectArrayIterator *self, IOSObjectArray *array, jint start) {
  (void) OrgApacheCommonsCollections15IteratorsObjectArrayIterator_initWithNSObjectArray_withInt_withInt_(self, array, start, ((IOSObjectArray *) nil_chk(array))->size_);
}
...
void OrgApacheCommonsCollections15IteratorsObjectArrayIterator_initWithNSObjectArray_withInt_withInt_(OrgApacheCommonsCollections15IteratorsObjectArrayIterator *self, IOSObjectArray *array, jint start, jint end) {
  ...
  self->index_ = 0;
  if (start < 0) {
    @throw new_JavaLangArrayIndexOutOfBoundsException_initWithNSString_(@"Start index must not be less than zero");
  }
  if (end > ((IOSObjectArray *) nil_chk(array))->size_) {
    @throw new_JavaLangArrayIndexOutOfBoundsException_initWithNSString_(@"End index must not be greater than the array length");
  }
  if (start > array->size_) {
    @throw new_JavaLangArrayIndexOutOfBoundsException_initWithNSString_(@"Start index must not be greater than the array length");
  }
  if (end < start) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"End index must not be less than start index");
  }
  self->array_ = array;
