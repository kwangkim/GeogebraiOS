...
- (void)addWithId:(id)o {
  @throw new_JavaLangUnsupportedOperationException_initWithNSString_(OrgApacheCommonsCollections15IteratorsListIteratorWrapper_UNSUPPORTED_OPERATION_MESSAGE_);
}
