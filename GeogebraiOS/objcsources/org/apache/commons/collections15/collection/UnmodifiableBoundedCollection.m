...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/apache/commons/collections15/collection/UnmodifiableBoundedCollection.java
//
...
id<OrgApacheCommonsCollections15BoundedCollection> OrgApacheCommonsCollections15CollectionUnmodifiableBoundedCollection_decorateWithOrgApacheCommonsCollections15BoundedCollection_(id<OrgApacheCommonsCollections15BoundedCollection> coll) {
  ...
  return [new_OrgApacheCommonsCollections15CollectionUnmodifiableBoundedCollection_initWithOrgApacheCommonsCollections15BoundedCollection_(coll) autorelease];
}
...
id<OrgApacheCommonsCollections15BoundedCollection> OrgApacheCommonsCollections15CollectionUnmodifiableBoundedCollection_decorateUsingWithJavaUtilCollection_(id<JavaUtilCollection> coll) {
  OrgApacheCommonsCollections15CollectionUnmodifiableBoundedCollection_initialize();
  if (coll == nil) {
    @throw [new_JavaLangIllegalArgumentException_initWithNSString_(@"The collection must not be null") autorelease];
  }
  ...
  if ([OrgApacheCommonsCollections15BoundedCollection_class_() isInstance:coll] == NO) {
    @throw [new_JavaLangIllegalArgumentException_initWithNSString_(@"The collection is not a bounded collection") autorelease];
  }
  return [new_OrgApacheCommonsCollections15CollectionUnmodifiableBoundedCollection_initWithOrgApacheCommonsCollections15BoundedCollection_((id<OrgApacheCommonsCollections15BoundedCollection>) check_protocol_cast(coll, @protocol(OrgApacheCommonsCollections15BoundedCollection))) autorelease];
}
