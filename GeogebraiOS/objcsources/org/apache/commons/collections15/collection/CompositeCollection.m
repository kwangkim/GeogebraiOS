...
- (id<JavaUtilIterator>)iterator {
  ...
  OrgApacheCommonsCollections15IteratorsIteratorChain *chain = new_OrgApacheCommonsCollections15IteratorsIteratorChain_init();
...
- (IOSObjectArray *)toArray {
  IOSObjectArray *result = (IOSObjectArray *) check_class_cast([IOSObjectArray newArrayWithLength:[self size] type:NSObject_class_()], [IOSObjectArray class]);
  jint i = 0;
  for (id<JavaUtilIterator> it = [self iterator]; [((id<JavaUtilIterator>) nil_chk(it)) hasNext]; i++) {
    (void) IOSObjectArray_Set(result, i, [it next]);
  }
  return result;
}
...
- (IOSObjectArray *)toArrayWithNSObjectArray:(IOSObjectArray *)array {
  ...
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(self->all_))->size_; ++i) {
    for (id<JavaUtilIterator> it = [((id<JavaUtilCollection>) nil_chk(IOSObjectArray_Get(self->all_, i))) iterator]; [((id<JavaUtilIterator>) nil_chk(it)) hasNext]; ) {
      (void) IOSObjectArray_Set(nil_chk(result), offset++, (id) [it next]);
    }
  }
  if (((IOSObjectArray *) nil_chk(result))->size_ > size) {
    (void) IOSObjectArray_Set(result, size, nil);
  }
  return result;
}
...
- (jboolean)addWithId:(id)obj {
  if (self->mutator_ == nil) {
    @throw new_JavaLangUnsupportedOperationException_initWithNSString_(@"add() is not supported on CompositeCollection without a CollectionMutator strategy");
  }
...
- (jboolean)removeWithId:(id)obj {
  if (self->mutator_ == nil) {
    @throw new_JavaLangUnsupportedOperationException_initWithNSString_(@"remove() is not supported on CompositeCollection without a CollectionMutator strategy");
  }
...
- (jboolean)addAllWithJavaUtilCollection:(id<JavaUtilCollection>)coll {
  if (self->mutator_ == nil) {
    @throw new_JavaLangUnsupportedOperationException_initWithNSString_(@"addAll() is not supported on CompositeCollection without a CollectionMutator strategy");
  }
...
- (void)addCompositedWithJavaUtilCollectionArray:(IOSObjectArray *)comps {
  JavaUtilArrayList *list = new_JavaUtilArrayList_initWithJavaUtilCollection_(JavaUtilArrays_asListWithNSObjectArray_(self->all_));
  [list addAllWithJavaUtilCollection:JavaUtilArrays_asListWithNSObjectArray_(comps)];
  all_ = (IOSObjectArray *) check_class_cast([list toArrayWithNSObjectArray:[IOSObjectArray newArrayWithLength:[list size] type:JavaUtilCollection_class_()]], [IOSObjectArray class]);
}

- (void)addCompositedWithJavaUtilCollection:(id<JavaUtilCollection>)c {
  [self addCompositedWithJavaUtilCollectionArray:[IOSObjectArray newArrayWithObjects:(id[]){ c } count:1 type:JavaUtilCollection_class_()]];
}

- (void)addCompositedWithJavaUtilCollection:(id<JavaUtilCollection>)c
                     withJavaUtilCollection:(id<JavaUtilCollection>)d {
  [self addCompositedWithJavaUtilCollectionArray:[IOSObjectArray newArrayWithObjects:(id[]){ c, d } count:2 type:JavaUtilCollection_class_()]];
}

- (void)removeCompositedWithJavaUtilCollection:(id<JavaUtilCollection>)coll {
  JavaUtilArrayList *list = new_JavaUtilArrayList_initWithInt_(((IOSObjectArray *) nil_chk(self->all_))->size_);
  [list addAllWithJavaUtilCollection:JavaUtilArrays_asListWithNSObjectArray_(self->all_)];
  [list removeWithId:coll];
  self->all_ = (IOSObjectArray *) check_class_cast([list toArrayWithNSObjectArray:[IOSObjectArray newArrayWithLength:[list size] type:JavaUtilCollection_class_()]], [IOSObjectArray class]);
}

- (id<JavaUtilCollection>)toCollection {
  return new_JavaUtilArrayList_initWithJavaUtilCollection_(self);
}
...
void OrgApacheCommonsCollections15CollectionCompositeCollection_init(OrgApacheCommonsCollections15CollectionCompositeCollection *self) {
  ...
  self->all_ = [IOSObjectArray newArrayWithLength:0 type:JavaUtilCollection_class_()];
}
...
void OrgApacheCommonsCollections15CollectionCompositeCollection_initWithJavaUtilCollection_(OrgApacheCommonsCollections15CollectionCompositeCollection *self, id<JavaUtilCollection> coll) {
  (void) OrgApacheCommonsCollections15CollectionCompositeCollection_init(self);
