...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/apache/commons/collections15/CollectionUtils.java
//
...
+ (void)initialize {
  if (self == [OrgApacheCommonsCollections15CollectionUtils class]) {
    OrgApacheCommonsCollections15CollectionUtils_INTEGER_ONE_ = new_JavaLangInteger_initWithInt_(1);
    OrgApacheCommonsCollections15CollectionUtils_EMPTY_COLLECTION_ = OrgApacheCommonsCollections15CollectionUnmodifiableCollection_decorateWithJavaUtilCollection_(new_JavaUtilArrayList_init());
...
id<JavaUtilCollection> OrgApacheCommonsCollections15CollectionUtils_union__WithJavaUtilCollection_withJavaUtilCollection_(id<JavaUtilCollection> a, id<JavaUtilCollection> b) {
  ...
  id<JavaUtilSet> elts = new_JavaUtilHashSet_initWithJavaUtilCollection_(a);
...
id<JavaUtilCollection> OrgApacheCommonsCollections15CollectionUtils_subtractWithJavaUtilCollection_withJavaLangIterable_(id<JavaUtilCollection> a, id<JavaLangIterable> b) {
  OrgApacheCommonsCollections15CollectionUtils_initialize();
  JavaUtilArrayList *list = new_JavaUtilArrayList_initWithJavaUtilCollection_(a);
...
void OrgApacheCommonsCollections15CollectionUtils_mainWithNSStringArray_(IOSObjectArray *args) {
  ...
  [l1 addWithId:@"Test"];
  id<JavaUtilList> l2 = new_JavaUtilArrayList_init();
...
id<JavaUtilMap> OrgApacheCommonsCollections15CollectionUtils_getCardinalityMapWithJavaLangIterable_(id<JavaLangIterable> iterable) {
  OrgApacheCommonsCollections15CollectionUtils_initialize();
  id<JavaUtilMap> count = new_JavaUtilHashMap_init();
  for (id<JavaUtilIterator> it = [((id<JavaLangIterable>) nil_chk(iterable)) iterator]; [((id<JavaUtilIterator>) nil_chk(it)) hasNext]; ) {
    ...
    if (c == nil) {
      (void) [count putWithId:obj withId:OrgApacheCommonsCollections15CollectionUtils_INTEGER_ONE_];
    }
    else {
      (void) [count putWithId:obj withId:new_JavaLangInteger_initWithInt_([c intValue] + 1)];
    }
  }
  return count;
}
...
id<JavaUtilCollection> OrgApacheCommonsCollections15CollectionUtils_selectWithJavaUtilCollection_withOrgApacheCommonsCollections15Predicate_(id<JavaUtilCollection> inputCollection, id<OrgApacheCommonsCollections15Predicate> predicate) {
  OrgApacheCommonsCollections15CollectionUtils_initialize();
  return ((JavaUtilArrayList *) OrgApacheCommonsCollections15CollectionUtils_selectWithJavaLangIterable_withOrgApacheCommonsCollections15Predicate_withJavaUtilCollection_(inputCollection, predicate, new_JavaUtilArrayList_initWithInt_([((id<JavaUtilCollection>) nil_chk(inputCollection)) size])));
}
...
id<JavaUtilCollection> OrgApacheCommonsCollections15CollectionUtils_selectRejectedWithJavaUtilCollection_withOrgApacheCommonsCollections15Predicate_(id<JavaUtilCollection> inputCollection, id<OrgApacheCommonsCollections15Predicate> predicate) {
  OrgApacheCommonsCollections15CollectionUtils_initialize();
  JavaUtilArrayList *answer = new_JavaUtilArrayList_initWithInt_([((id<JavaUtilCollection>) nil_chk(inputCollection)) size]);
...
id<JavaUtilCollection> OrgApacheCommonsCollections15CollectionUtils_collectWithJavaUtilCollection_withOrgApacheCommonsCollections15Transformer_(id<JavaUtilCollection> inputCollection, id<OrgApacheCommonsCollections15Transformer> transformer) {
  OrgApacheCommonsCollections15CollectionUtils_initialize();
  JavaUtilArrayList *answer = new_JavaUtilArrayList_initWithInt_([((id<JavaUtilCollection>) nil_chk(inputCollection)) size]);
  (void) OrgApacheCommonsCollections15CollectionUtils_collectWithJavaLangIterable_withOrgApacheCommonsCollections15Transformer_withJavaUtilCollection_(inputCollection, transformer, answer);
  return answer;
}
...
id<JavaUtilCollection> OrgApacheCommonsCollections15CollectionUtils_collectWithJavaUtilIterator_withOrgApacheCommonsCollections15Transformer_(id<JavaUtilIterator> inputIterator, id<OrgApacheCommonsCollections15Transformer> transformer) {
  OrgApacheCommonsCollections15CollectionUtils_initialize();
  JavaUtilArrayList *answer = new_JavaUtilArrayList_init();
  (void) OrgApacheCommonsCollections15CollectionUtils_collectWithJavaUtilIterator_withOrgApacheCommonsCollections15Transformer_withJavaUtilCollection_(inputIterator, transformer, answer);
  return answer;
}
...
id OrgApacheCommonsCollections15CollectionUtils_indexWithId_withInt_(id obj, jint idx) {
  OrgApacheCommonsCollections15CollectionUtils_initialize();
  return OrgApacheCommonsCollections15CollectionUtils_indexWithId_withId_(obj, new_JavaLangInteger_initWithInt_(idx));
}
...
id OrgApacheCommonsCollections15CollectionUtils_getWithId_withInt_(id object, jint index) {
  OrgApacheCommonsCollections15CollectionUtils_initialize();
  if (index < 0) {
    @throw new_JavaLangIndexOutOfBoundsException_initWithNSString_(JreStrcat("$I", @"Index cannot be negative: ", index));
  }
  if ([JavaUtilMap_class_() isInstance:object]) {
    ...
    @throw new_JavaLangIndexOutOfBoundsException_initWithNSString_(JreStrcat("$I", @"Entry does not exist: ", index));
  }
    ...
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"Unsupported object type: null");
  }
  else {
    @try {
    ...
    @catch (JavaLangIllegalArgumentException *ex) {
      @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$", @"Unsupported object type: ", [[object getClass] getName]));
    }
  }
}
...
void OrgApacheCommonsCollections15CollectionUtils_reverseArrayWithNSObjectArray_(IOSObjectArray *array) {
  ...
  while (j > i) {
    ...
    (void) IOSObjectArray_Set(array, j, IOSObjectArray_Get(array, i));
    (void) IOSObjectArray_Set(array, i, tmp);
    j--;
    i++;
  }
}
