...
- (void)moveToMRUWithOrgApacheCommonsCollections15MapAbstractLinkedMap_LinkEntry:(OrgApacheCommonsCollections15MapAbstractLinkedMap_LinkEntry *)entry_ {
  if (((OrgApacheCommonsCollections15MapAbstractLinkedMap_LinkEntry *) nil_chk(entry_))->after_ != header_) {
    modCount_++;
    ((OrgApacheCommonsCollections15MapAbstractLinkedMap_LinkEntry *) nil_chk(entry_->before_))->after_ = entry_->after_;
    ((OrgApacheCommonsCollections15MapAbstractLinkedMap_LinkEntry *) nil_chk(entry_->after_))->before_ = entry_->before_;
    entry_->after_ = header_;
    entry_->before_ = ((OrgApacheCommonsCollections15MapAbstractLinkedMap_LinkEntry *) nil_chk(header_))->before_;
    header_->before_->after_ = entry_;
    header_->before_ = entry_;
  }
}
...
void OrgApacheCommonsCollections15MapLRUMap_init(OrgApacheCommonsCollections15MapLRUMap *self) {
  (void) OrgApacheCommonsCollections15MapLRUMap_initWithInt_withFloat_withBoolean_(self, OrgApacheCommonsCollections15MapLRUMap_DEFAULT_MAX_SIZE, OrgApacheCommonsCollections15MapAbstractHashedMap_DEFAULT_LOAD_FACTOR, NO);
}
...
void OrgApacheCommonsCollections15MapLRUMap_initWithInt_(OrgApacheCommonsCollections15MapLRUMap *self, jint maxSize) {
  (void) OrgApacheCommonsCollections15MapLRUMap_initWithInt_withFloat_(self, maxSize, OrgApacheCommonsCollections15MapAbstractHashedMap_DEFAULT_LOAD_FACTOR);
}
...
void OrgApacheCommonsCollections15MapLRUMap_initWithInt_withBoolean_(OrgApacheCommonsCollections15MapLRUMap *self, jint maxSize, jboolean scanUntilRemovable) {
  (void) OrgApacheCommonsCollections15MapLRUMap_initWithInt_withFloat_withBoolean_(self, maxSize, OrgApacheCommonsCollections15MapAbstractHashedMap_DEFAULT_LOAD_FACTOR, scanUntilRemovable);
}
...
void OrgApacheCommonsCollections15MapLRUMap_initWithInt_withFloat_(OrgApacheCommonsCollections15MapLRUMap *self, jint maxSize, jfloat loadFactor) {
  (void) OrgApacheCommonsCollections15MapLRUMap_initWithInt_withFloat_withBoolean_(self, maxSize, loadFactor, NO);
}
...
void OrgApacheCommonsCollections15MapLRUMap_initWithInt_withFloat_withBoolean_(OrgApacheCommonsCollections15MapLRUMap *self, jint maxSize, jfloat loadFactor, jboolean scanUntilRemovable) {
  (void) OrgApacheCommonsCollections15MapAbstractLinkedMap_initWithInt_withFloat_(self, (maxSize < 1 ? OrgApacheCommonsCollections15MapAbstractHashedMap_DEFAULT_CAPACITY : maxSize), loadFactor);
  if (maxSize < 1) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"LRUMap max size must be greater than 0");
  }
...
void OrgApacheCommonsCollections15MapLRUMap_initWithJavaUtilMap_(OrgApacheCommonsCollections15MapLRUMap *self, id<JavaUtilMap> map) {
  (void) OrgApacheCommonsCollections15MapLRUMap_initWithJavaUtilMap_withBoolean_(self, map, NO);
}
...
void OrgApacheCommonsCollections15MapLRUMap_initWithJavaUtilMap_withBoolean_(OrgApacheCommonsCollections15MapLRUMap *self, id<JavaUtilMap> map, jboolean scanUntilRemovable) {
  (void) OrgApacheCommonsCollections15MapLRUMap_initWithInt_withFloat_withBoolean_(self, [((id<JavaUtilMap>) nil_chk(map)) size], OrgApacheCommonsCollections15MapAbstractHashedMap_DEFAULT_LOAD_FACTOR, scanUntilRemovable);
