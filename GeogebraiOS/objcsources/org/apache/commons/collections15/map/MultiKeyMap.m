...
- (id)putWithId:(id)key1
         withId:(id)key2
         withId:(id)value {
  return [self putMultiKeyWithId:value withNSObjectArray:[IOSObjectArray newArrayWithObjects:(id[]){ key1, key2 } count:2 type:NSObject_class_()]];
}
...
- (id)putWithId:(id)key1
         ...
         withId:(id)key3
         withId:(id)value {
  return [self putMultiKeyWithId:value withNSObjectArray:[IOSObjectArray newArrayWithObjects:(id[]){ key1, key2, key3 } count:3 type:NSObject_class_()]];
}
...
- (id)putWithId:(id)key1
         ...
         withId:(id)key4
         withId:(id)value {
  return [self putMultiKeyWithId:value withNSObjectArray:[IOSObjectArray newArrayWithObjects:(id[]){ key1, key2, key3, key4 } count:4 type:NSObject_class_()]];
}
...
- (id)putWithId:(id)key1
         ...
         withId:(id)key5
         withId:(id)value {
  return [self putMultiKeyWithId:value withNSObjectArray:[IOSObjectArray newArrayWithObjects:(id[]){ key1, key2, key3, key4, key5 } count:5 type:NSObject_class_()]];
}
...
- (id)putMultiKeyWithId:(id)value
  ...
  [map_ addMappingWithInt:index withInt:hashCode withId:new_OrgApacheCommonsCollections15KeyvalueMultiKey_initWithNSObjectArray_(keys) withId:value];
  return nil;
}
...
- (void)checkKeyWithId:(id)key {
  if (key == nil) {
    @throw new_JavaLangNullPointerException_initWithNSString_(@"Key must not be null");
  }
}

- (id)clone {
  return new_OrgApacheCommonsCollections15MapMultiKeyMap_initWithOrgApacheCommonsCollections15MapAbstractHashedMap_((OrgApacheCommonsCollections15MapAbstractHashedMap *) check_class_cast([((OrgApacheCommonsCollections15MapAbstractHashedMap *) nil_chk(map_)) clone], [OrgApacheCommonsCollections15MapAbstractHashedMap class]));
}
...
OrgApacheCommonsCollections15MapMultiKeyMap *OrgApacheCommonsCollections15MapMultiKeyMap_decorateWithOrgApacheCommonsCollections15MapAbstractHashedMap_(OrgApacheCommonsCollections15MapAbstractHashedMap *map) {
  ...
  if ([((OrgApacheCommonsCollections15MapAbstractHashedMap *) nil_chk(map)) size] > 0) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"Map must be empty");
  }
  return new_OrgApacheCommonsCollections15MapMultiKeyMap_initWithOrgApacheCommonsCollections15MapAbstractHashedMap_(map);
}

void OrgApacheCommonsCollections15MapMultiKeyMap_init(OrgApacheCommonsCollections15MapMultiKeyMap *self) {
  (void) NSObject_init(self);
  self->map_ = new_OrgApacheCommonsCollections15MapHashedMap_init();
}
