  ...
  if (self == [OrgApacheCommonsCollections15FunctorException class]) {
    {
      jboolean flag = NO;
      @try {
        (void) [JavaLangThrowable_class_() getDeclaredMethod:@"getCause" parameterTypes:[IOSObjectArray newArrayWithLength:0 type:IOSClass_class_()]];
        flag = YES;
      }
...
void OrgApacheCommonsCollections15FunctorException_initWithJavaLangThrowable_(OrgApacheCommonsCollections15FunctorException *self, JavaLangThrowable *rootCause) {
  (void) JavaLangRuntimeException_initWithNSString_(self, (rootCause == nil ? nil : [rootCause getMessage]));
  self->rootCause_ = rootCause;
}
