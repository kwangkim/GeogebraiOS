...
id<JavaUtilList> OrgApacheCommonsCollections15EnumerationUtils_toListWithJavaUtilEnumeration_(id<JavaUtilEnumeration> enumeration) {
  ...
  return OrgApacheCommonsCollections15IteratorUtils_toListWithJavaUtilIterator_(new_OrgApacheCommonsCollections15IteratorsEnumerationIterator_initWithJavaUtilEnumeration_(enumeration));
}
