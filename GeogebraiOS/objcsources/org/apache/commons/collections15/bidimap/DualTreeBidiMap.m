...
- (id<OrgApacheCommonsCollections15BidiMap>)createBidiMapWithJavaUtilMap:(id<JavaUtilMap>)normalMap
  ...
  return new_OrgApacheCommonsCollections15BidimapDualTreeBidiMap_initWithJavaUtilMap_withJavaUtilMap_withOrgApacheCommonsCollections15BidiMap_(normalMap, reverseMap, inverseMap);
}
...
- (id<OrgApacheCommonsCollections15OrderedMapIterator>)orderedMapIterator {
  return new_OrgApacheCommonsCollections15BidimapDualTreeBidiMap_BidiOrderedMapIterator_initWithOrgApacheCommonsCollections15BidimapAbstractDualBidiMap_(self);
}
...
- (id<JavaUtilSortedMap>)headMapWithId:(id)toKey {
  ...
  return new_OrgApacheCommonsCollections15BidimapDualTreeBidiMap_ViewMap_initWithOrgApacheCommonsCollections15BidimapDualTreeBidiMap_withJavaUtilSortedMap_(self, sub);
}
...
- (void)readObjectWithJavaIoObjectInputStream:(JavaIoObjectInputStream *)inArg {
  ...
  forwardMap_ = new_JavaUtilTreeMap_initWithJavaUtilComparator_(comparator__);
  inverseMap_ = new_JavaUtilTreeMap_init();
...
void OrgApacheCommonsCollections15BidimapDualTreeBidiMap_init(OrgApacheCommonsCollections15BidimapDualTreeBidiMap *self) {
  (void) OrgApacheCommonsCollections15BidimapAbstractDualBidiMap_initWithJavaUtilMap_withJavaUtilMap_(self, new_JavaUtilTreeMap_init(), new_JavaUtilTreeMap_init());
  self->comparator__ = nil;
}
...
OrgApacheCommonsCollections15BidimapDualTreeBidiMap *OrgApacheCommonsCollections15BidimapDualTreeBidiMap_createTwoWayBidiMapWithJavaUtilComparator_(id<JavaUtilComparator> comparator) {
  ...
  return new_OrgApacheCommonsCollections15BidimapDualTreeBidiMap_initWithJavaUtilComparator_withJavaUtilComparator_(comparator, comparator);
}
...
void OrgApacheCommonsCollections15BidimapDualTreeBidiMap_initWithJavaUtilComparator_withJavaUtilComparator_(OrgApacheCommonsCollections15BidimapDualTreeBidiMap *self, id<JavaUtilComparator> comparator, id<JavaUtilComparator> inverseComparator) {
  (void) OrgApacheCommonsCollections15BidimapAbstractDualBidiMap_initWithJavaUtilMap_withJavaUtilMap_(self, new_JavaUtilTreeMap_initWithJavaUtilComparator_(comparator), new_JavaUtilTreeMap_initWithJavaUtilComparator_(inverseComparator));
...
void OrgApacheCommonsCollections15BidimapDualTreeBidiMap_initWithJavaUtilMap_withJavaUtilMap_withOrgApacheCommonsCollections15BidiMap_(OrgApacheCommonsCollections15BidimapDualTreeBidiMap *self, id<JavaUtilMap> normalMap, id<JavaUtilMap> reverseMap, id<OrgApacheCommonsCollections15BidiMap> inverseBidiMap) {
  ...
  self->comparator__ = [((id<JavaUtilSortedMap>) nil_chk(((id<JavaUtilSortedMap>) check_protocol_cast(normalMap, @protocol(JavaUtilSortedMap))))) comparator];
}
...
- (id<JavaUtilSortedMap>)headMapWithId:(id)toKey {
  return new_OrgApacheCommonsCollections15BidimapDualTreeBidiMap_ViewMap_initWithOrgApacheCommonsCollections15BidimapDualTreeBidiMap_withJavaUtilSortedMap_(bidi_, [super headMapWithId:toKey]);
}

- (id<JavaUtilSortedMap>)tailMapWithId:(id)fromKey {
  return new_OrgApacheCommonsCollections15BidimapDualTreeBidiMap_ViewMap_initWithOrgApacheCommonsCollections15BidimapDualTreeBidiMap_withJavaUtilSortedMap_(bidi_, [super tailMapWithId:fromKey]);
}

- (id<JavaUtilSortedMap>)subMapWithId:(id)fromKey
                               withId:(id)toKey {
  return new_OrgApacheCommonsCollections15BidimapDualTreeBidiMap_ViewMap_initWithOrgApacheCommonsCollections15BidimapDualTreeBidiMap_withJavaUtilSortedMap_(bidi_, [super subMapWithId:fromKey withId:toKey]);
}
...
void OrgApacheCommonsCollections15BidimapDualTreeBidiMap_ViewMap_initWithOrgApacheCommonsCollections15BidimapDualTreeBidiMap_withJavaUtilSortedMap_(OrgApacheCommonsCollections15BidimapDualTreeBidiMap_ViewMap *self, OrgApacheCommonsCollections15BidimapDualTreeBidiMap *bidi, id<JavaUtilSortedMap> sm) {
  (void) OrgApacheCommonsCollections15MapAbstractSortedMapDecorator_initWithJavaUtilSortedMap_(self, (id<JavaUtilSortedMap>) check_protocol_cast([bidi createBidiMapWithJavaUtilMap:sm withJavaUtilMap:((OrgApacheCommonsCollections15BidimapDualTreeBidiMap *) nil_chk(bidi))->inverseMap_ withOrgApacheCommonsCollections15BidiMap:bidi->inverseBidiMap__], @protocol(JavaUtilSortedMap)));
  self->bidi_ = (OrgApacheCommonsCollections15BidimapDualTreeBidiMap *) check_class_cast(self->map_, [OrgApacheCommonsCollections15BidimapDualTreeBidiMap class]);
}
...
- (void)remove {
  ...
  (void) [((OrgApacheCommonsCollections15BidimapAbstractDualBidiMap *) nil_chk(parent_)) removeWithId:[((id<JavaUtilMap_Entry>) nil_chk(last_)) getKey]];
  last_ = nil;
}
...
- (void)reset {
  iterator_ = [new_JavaUtilArrayList_initWithJavaUtilCollection_([((OrgApacheCommonsCollections15BidimapAbstractDualBidiMap *) nil_chk(parent_)) entrySet]) listIterator];
  last_ = nil;
}
...
void OrgApacheCommonsCollections15BidimapDualTreeBidiMap_BidiOrderedMapIterator_initWithOrgApacheCommonsCollections15BidimapAbstractDualBidiMap_(OrgApacheCommonsCollections15BidimapDualTreeBidiMap_BidiOrderedMapIterator *self, OrgApacheCommonsCollections15BidimapAbstractDualBidiMap *parent) {
  ...
  self->last_ = nil;
  self->parent_ = parent;
  self->iterator_ = [new_JavaUtilArrayList_initWithJavaUtilCollection_([((OrgApacheCommonsCollections15BidimapAbstractDualBidiMap *) nil_chk(parent)) entrySet]) listIterator];
}
