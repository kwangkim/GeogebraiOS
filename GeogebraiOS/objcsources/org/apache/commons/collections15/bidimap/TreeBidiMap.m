...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/org/apache/commons/collections15/bidimap/TreeBidiMap.java
//
...
- (void)putAllWithJavaUtilMap:(id<JavaUtilMap>)map {
  ...
  while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
    ...
    (void) [self putWithId:(id<JavaLangComparable>) check_protocol_cast([((id<JavaUtilMap_Entry>) nil_chk(entry_)) getKey], @protocol(JavaLangComparable)) withId:(id<JavaLangComparable>) check_protocol_cast([entry_ getValue], @protocol(JavaLangComparable))];
  }
}
...
- (void)clear {
  ...
  nodeCount_ = 0;
  (void) IOSObjectArray_Set(nil_chk(rootNode_), OrgApacheCommonsCollections15BidimapTreeBidiMap_KEY, nil);
  (void) IOSObjectArray_Set(rootNode_, OrgApacheCommonsCollections15BidimapTreeBidiMap_VALUE, nil);
}
...
- (id<JavaUtilSet>)keySet {
  if (keySet__ == nil) {
    keySet__ = new_OrgApacheCommonsCollections15BidimapTreeBidiMap_View_initWithOrgApacheCommonsCollections15BidimapTreeBidiMap_withInt_withInt_(self, OrgApacheCommonsCollections15BidimapTreeBidiMap_KEY, OrgApacheCommonsCollections15BidimapTreeBidiMap_KEY);
  }
  return keySet__;
}
...
- (id<JavaUtilSet>)values {
  if (valuesSet_ == nil) {
    valuesSet_ = new_OrgApacheCommonsCollections15BidimapTreeBidiMap_View_initWithOrgApacheCommonsCollections15BidimapTreeBidiMap_withInt_withInt_(self, OrgApacheCommonsCollections15BidimapTreeBidiMap_KEY, OrgApacheCommonsCollections15BidimapTreeBidiMap_VALUE);
  }
  return valuesSet_;
}
...
- (id<JavaUtilSet>)entrySet {
  if (entrySet__ == nil) {
    return new_OrgApacheCommonsCollections15BidimapTreeBidiMap_EntryView_initWithOrgApacheCommonsCollections15BidimapTreeBidiMap_withInt_withInt_(self, OrgApacheCommonsCollections15BidimapTreeBidiMap_KEY, OrgApacheCommonsCollections15BidimapTreeBidiMap_MAPENTRY);
  }
  return entrySet__;
}
...
- (id<OrgApacheCommonsCollections15MapIterator>)mapIterator {
  ...
  return new_OrgApacheCommonsCollections15BidimapTreeBidiMap_ViewMapIterator_initWithOrgApacheCommonsCollections15BidimapTreeBidiMap_withInt_(self, OrgApacheCommonsCollections15BidimapTreeBidiMap_KEY);
}
...
- (id<OrgApacheCommonsCollections15OrderedBidiMap>)inverseOrderedBidiMap {
  if (inverse_ == nil) {
    inverse_ = new_OrgApacheCommonsCollections15BidimapTreeBidiMap_Inverse_initWithOrgApacheCommonsCollections15BidimapTreeBidiMap_(self);
  }
  return inverse_;
}
...
+ (void)initialize {
  if (self == [OrgApacheCommonsCollections15BidimapTreeBidiMap class]) {
    OrgApacheCommonsCollections15BidimapTreeBidiMap_dataName_ = [IOSObjectArray newArrayWithObjects:(id[]){ @"key", @"value" } count:2 type:NSString_class_()];
...
void OrgApacheCommonsCollections15BidimapTreeBidiMap_init(OrgApacheCommonsCollections15BidimapTreeBidiMap *self) {
  ...
  self->rootNode_ = [IOSObjectArray newArrayWithLength:2 type:OrgApacheCommonsCollections15BidimapTreeBidiMap_Node_class_()];
  self->nodeCount_ = 0;
...
void OrgApacheCommonsCollections15BidimapTreeBidiMap_doPutWithJavaLangComparable_withJavaLangComparable_(OrgApacheCommonsCollections15BidimapTreeBidiMap *self, id<JavaLangComparable> key, id<JavaLangComparable> value) {
  (void) OrgApacheCommonsCollections15BidimapTreeBidiMap_doRemoveByKeyWithJavaLangComparable_(self, key);
  (void) OrgApacheCommonsCollections15BidimapTreeBidiMap_doRemoveByValueWithJavaLangComparable_(self, value);
  ...
  if (node == nil) {
    OrgApacheCommonsCollections15BidimapTreeBidiMap_Node *root = new_OrgApacheCommonsCollections15BidimapTreeBidiMap_Node_initWithJavaLangComparable_withJavaLangComparable_(key, value);
    (void) IOSObjectArray_Set(self->rootNode_, OrgApacheCommonsCollections15BidimapTreeBidiMap_KEY, root);
    (void) IOSObjectArray_Set(self->rootNode_, OrgApacheCommonsCollections15BidimapTreeBidiMap_VALUE, root);
    OrgApacheCommonsCollections15BidimapTreeBidiMap_grow(self);
  }
  else {
    while (YES) {
      ...
      if (cmp == 0) {
        @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$@$", @"Cannot store a duplicate key (\"", key, @"\") in this Map"));
      }
      else if (cmp < 0) {
        if (OrgApacheCommonsCollections15BidimapTreeBidiMap_Node_getLeftWithInt_(node, OrgApacheCommonsCollections15BidimapTreeBidiMap_KEY) != nil) {
          ...
          OrgApacheCommonsCollections15BidimapTreeBidiMap_Node *newNode = new_OrgApacheCommonsCollections15BidimapTreeBidiMap_Node_initWithJavaLangComparable_withJavaLangComparable_(key, value);
          OrgApacheCommonsCollections15BidimapTreeBidiMap_insertValueWithOrgApacheCommonsCollections15BidimapTreeBidiMap_Node_(self, newNode);
...
void OrgApacheCommonsCollections15BidimapTreeBidiMap_rotateLeftWithOrgApacheCommonsCollections15BidimapTreeBidiMap_Node_withInt_(OrgApacheCommonsCollections15BidimapTreeBidiMap *self, OrgApacheCommonsCollections15BidimapTreeBidiMap_Node *node, jint index) {
  ...
  if (OrgApacheCommonsCollections15BidimapTreeBidiMap_Node_getParentWithInt_(node, index) == nil) {
    (void) IOSObjectArray_Set(nil_chk(self->rootNode_), index, rightChild);
  }
...
void OrgApacheCommonsCollections15BidimapTreeBidiMap_rotateRightWithOrgApacheCommonsCollections15BidimapTreeBidiMap_Node_withInt_(OrgApacheCommonsCollections15BidimapTreeBidiMap *self, OrgApacheCommonsCollections15BidimapTreeBidiMap_Node *node, jint index) {
  ...
  if (OrgApacheCommonsCollections15BidimapTreeBidiMap_Node_getParentWithInt_(node, index) == nil) {
    (void) IOSObjectArray_Set(nil_chk(self->rootNode_), index, leftChild);
  }
  ...
  for (jint index = OrgApacheCommonsCollections15BidimapTreeBidiMap_FIRST_INDEX; index < OrgApacheCommonsCollections15BidimapTreeBidiMap_NUMBER_OF_INDICES; index++) {
    ...
    if (replacement != nil) {
      ...
      if (OrgApacheCommonsCollections15BidimapTreeBidiMap_Node_getParentWithInt_(deletedNode, index) == nil) {
        (void) IOSObjectArray_Set(nil_chk(self->rootNode_), index, replacement);
      }
      ...
      if (OrgApacheCommonsCollections15BidimapTreeBidiMap_Node_getParentWithInt_(deletedNode, index) == nil) {
        (void) IOSObjectArray_Set(nil_chk(self->rootNode_), index, nil);
      }
      else {
        if (OrgApacheCommonsCollections15BidimapTreeBidiMap_isBlackWithOrgApacheCommonsCollections15BidimapTreeBidiMap_Node_withInt_(deletedNode, index)) {
...
void OrgApacheCommonsCollections15BidimapTreeBidiMap_swapPositionWithOrgApacheCommonsCollections15BidimapTreeBidiMap_Node_withOrgApacheCommonsCollections15BidimapTreeBidiMap_Node_withInt_(OrgApacheCommonsCollections15BidimapTreeBidiMap *self, OrgApacheCommonsCollections15BidimapTreeBidiMap_Node *x, OrgApacheCommonsCollections15BidimapTreeBidiMap_Node *y, jint index) {
  ...
  if (IOSObjectArray_Get(nil_chk(self->rootNode_), index) == x) {
    (void) IOSObjectArray_Set(self->rootNode_, index, y);
  }
  else if (IOSObjectArray_Get(self->rootNode_, index) == y) {
    (void) IOSObjectArray_Set(self->rootNode_, index, x);
  }
}
...
void OrgApacheCommonsCollections15BidimapTreeBidiMap_checkNonNullComparableWithId_(id o) {
  OrgApacheCommonsCollections15BidimapTreeBidiMap_initialize();
  if (o == nil) {
    @throw new_JavaLangNullPointerException_initWithNSString_(@"Cannot be null");
  }
  if (!([JavaLangComparable_class_() isInstance:o])) {
    @throw new_JavaLangClassCastException_initWithNSString_(@"Must be Comparable");
  }
}
...
void OrgApacheCommonsCollections15BidimapTreeBidiMap_insertValueWithOrgApacheCommonsCollections15BidimapTreeBidiMap_Node_(OrgApacheCommonsCollections15BidimapTreeBidiMap *self, OrgApacheCommonsCollections15BidimapTreeBidiMap_Node *newNode) {
  ...
  while (YES) {
    ...
    if (cmp == 0) {
      @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$@$", @"Cannot store a duplicate value (\"", OrgApacheCommonsCollections15BidimapTreeBidiMap_Node_getDataWithInt_(newNode, OrgApacheCommonsCollections15BidimapTreeBidiMap_VALUE), @"\") in this Map"));
    }
    else if (cmp < 0) {
...
jboolean OrgApacheCommonsCollections15BidimapTreeBidiMap_doEqualsWithId_withInt_(OrgApacheCommonsCollections15BidimapTreeBidiMap *self, id obj, jint type) {
  ...
  if (self->nodeCount_ > 0) {
    @try {
      for (id<OrgApacheCommonsCollections15MapIterator> it = new_OrgApacheCommonsCollections15BidimapTreeBidiMap_ViewMapIterator_initWithOrgApacheCommonsCollections15BidimapTreeBidiMap_withInt_(self, type); [it hasNext]; ) {
        id key = [it next];
...
NSString *OrgApacheCommonsCollections15BidimapTreeBidiMap_doToStringWithInt_(OrgApacheCommonsCollections15BidimapTreeBidiMap *self, jint type) {
  ...
  JavaLangStringBuffer *buf = new_JavaLangStringBuffer_initWithInt_(self->nodeCount_ * 32);
  (void) [buf appendWithChar:'{'];
  id<OrgApacheCommonsCollections15MapIterator> it = new_OrgApacheCommonsCollections15BidimapTreeBidiMap_ViewMapIterator_initWithOrgApacheCommonsCollections15BidimapTreeBidiMap_withInt_(self, type);
...
- (id<JavaUtilIterator>)iterator {
  return new_OrgApacheCommonsCollections15BidimapTreeBidiMap_ViewIterator_initWithOrgApacheCommonsCollections15BidimapTreeBidiMap_withInt_withInt_(main_, orderType_, dataType_);
}
...
- (id)next {
  ...
  lastReturnedNode_ = nextNode_;
  previousNode_ = nextNode_;
  nextNode_ = OrgApacheCommonsCollections15BidimapTreeBidiMap_nextGreaterWithOrgApacheCommonsCollections15BidimapTreeBidiMap_Node_withInt_(main_, nextNode_, orderType_);
...
- (id)previous {
  ...
  nextNode_ = lastReturnedNode_;
  if (nextNode_ == nil) {
    nextNode_ = OrgApacheCommonsCollections15BidimapTreeBidiMap_nextGreaterWithOrgApacheCommonsCollections15BidimapTreeBidiMap_Node_withInt_(main_, previousNode_, orderType_);
  }
  lastReturnedNode_ = previousNode_;
  previousNode_ = OrgApacheCommonsCollections15BidimapTreeBidiMap_nextSmallerWithOrgApacheCommonsCollections15BidimapTreeBidiMap_Node_withInt_(main_, previousNode_, orderType_);
  return [self doGetData];
}
...
- (id)doGetData {
  switch (dataType_) {
    ...
    return new_OrgApacheCommonsCollections15KeyvalueUnmodifiableMapEntry_initWithId_withId_([((OrgApacheCommonsCollections15BidimapTreeBidiMap_Node *) nil_chk(lastReturnedNode_)) getValue], [lastReturnedNode_ getKey]);
  }
  return nil;
}
...
- (void)remove {
  ...
  lastReturnedNode_ = nil;
  if (nextNode_ == nil) {
    previousNode_ = OrgApacheCommonsCollections15BidimapTreeBidiMap_greatestNodeWithOrgApacheCommonsCollections15BidimapTreeBidiMap_Node_withInt_(IOSObjectArray_Get(nil_chk(main_->rootNode_), orderType_), orderType_);
  }
  else {
    previousNode_ = OrgApacheCommonsCollections15BidimapTreeBidiMap_nextSmallerWithOrgApacheCommonsCollections15BidimapTreeBidiMap_Node_withInt_(main_, nextNode_, orderType_);
  }
}
...
void OrgApacheCommonsCollections15BidimapTreeBidiMap_ViewIterator_initWithOrgApacheCommonsCollections15BidimapTreeBidiMap_withInt_withInt_(OrgApacheCommonsCollections15BidimapTreeBidiMap_ViewIterator *self, OrgApacheCommonsCollections15BidimapTreeBidiMap *main, jint orderType, jint dataType) {
  ...
  self->nextNode_ = OrgApacheCommonsCollections15BidimapTreeBidiMap_leastNodeWithOrgApacheCommonsCollections15BidimapTreeBidiMap_Node_withInt_(IOSObjectArray_Get(nil_chk(main->rootNode_), orderType), orderType);
  self->lastReturnedNode_ = nil;
  self->previousNode_ = nil;
}
...
void OrgApacheCommonsCollections15BidimapTreeBidiMap_ViewMapIterator_initWithOrgApacheCommonsCollections15BidimapTreeBidiMap_withInt_(OrgApacheCommonsCollections15BidimapTreeBidiMap_ViewMapIterator *self, OrgApacheCommonsCollections15BidimapTreeBidiMap *main, jint orderType) {
  (void) OrgApacheCommonsCollections15BidimapTreeBidiMap_ViewIterator_initWithOrgApacheCommonsCollections15BidimapTreeBidiMap_withInt_withInt_(self, main, orderType, orderType);
...
void OrgApacheCommonsCollections15BidimapTreeBidiMap_EntryView_initWithOrgApacheCommonsCollections15BidimapTreeBidiMap_withInt_withInt_(OrgApacheCommonsCollections15BidimapTreeBidiMap_EntryView *self, OrgApacheCommonsCollections15BidimapTreeBidiMap *main, jint orderType, jint dataType) {
  (void) OrgApacheCommonsCollections15BidimapTreeBidiMap_View_initWithOrgApacheCommonsCollections15BidimapTreeBidiMap_withInt_withInt_(self, main, orderType, dataType);
...
- (id)setValueWithId:(id<JavaLangComparable>)ignored {
  @throw new_JavaLangUnsupportedOperationException_initWithNSString_(@"Map.Entry.setValue is not supported");
}
...
void OrgApacheCommonsCollections15BidimapTreeBidiMap_Node_initWithJavaLangComparable_withJavaLangComparable_(OrgApacheCommonsCollections15BidimapTreeBidiMap_Node *self, id<JavaLangComparable> key, id<JavaLangComparable> value) {
  ...
  self->key_ = key;
  self->value_ = value;
  self->leftNode_ = [IOSObjectArray newArrayWithLength:2 type:OrgApacheCommonsCollections15BidimapTreeBidiMap_Node_class_()];
  self->rightNode_ = [IOSObjectArray newArrayWithLength:2 type:OrgApacheCommonsCollections15BidimapTreeBidiMap_Node_class_()];
  self->parentNode_ = [IOSObjectArray newArrayWithLength:2 type:OrgApacheCommonsCollections15BidimapTreeBidiMap_Node_class_()];
  self->blackColor_ = [IOSBooleanArray newArrayWithBooleans:(jboolean[]){ YES, YES } count:2];
...
void OrgApacheCommonsCollections15BidimapTreeBidiMap_Node_setLeftWithOrgApacheCommonsCollections15BidimapTreeBidiMap_Node_withInt_(OrgApacheCommonsCollections15BidimapTreeBidiMap_Node *self, OrgApacheCommonsCollections15BidimapTreeBidiMap_Node *node, jint index) {
  (void) IOSObjectArray_Set(nil_chk(self->leftNode_), index, node);
}
...
void OrgApacheCommonsCollections15BidimapTreeBidiMap_Node_setRightWithOrgApacheCommonsCollections15BidimapTreeBidiMap_Node_withInt_(OrgApacheCommonsCollections15BidimapTreeBidiMap_Node *self, OrgApacheCommonsCollections15BidimapTreeBidiMap_Node *node, jint index) {
  (void) IOSObjectArray_Set(nil_chk(self->rightNode_), index, node);
}
...
void OrgApacheCommonsCollections15BidimapTreeBidiMap_Node_setParentWithOrgApacheCommonsCollections15BidimapTreeBidiMap_Node_withInt_(OrgApacheCommonsCollections15BidimapTreeBidiMap_Node *self, OrgApacheCommonsCollections15BidimapTreeBidiMap_Node *node, jint index) {
  (void) IOSObjectArray_Set(nil_chk(self->parentNode_), index, node);
}
...
- (id<JavaUtilSet>)keySet {
  if (keySet__ == nil) {
    keySet__ = new_OrgApacheCommonsCollections15BidimapTreeBidiMap_View_initWithOrgApacheCommonsCollections15BidimapTreeBidiMap_withInt_withInt_(main_, OrgApacheCommonsCollections15BidimapTreeBidiMap_VALUE, OrgApacheCommonsCollections15BidimapTreeBidiMap_VALUE);
  }
  return keySet__;
}
...
- (id<JavaUtilSet>)values {
  if (valuesSet_ == nil) {
    valuesSet_ = new_OrgApacheCommonsCollections15BidimapTreeBidiMap_View_initWithOrgApacheCommonsCollections15BidimapTreeBidiMap_withInt_withInt_(main_, OrgApacheCommonsCollections15BidimapTreeBidiMap_VALUE, OrgApacheCommonsCollections15BidimapTreeBidiMap_KEY);
  }
  return valuesSet_;
}
...
- (id<JavaUtilSet>)entrySet {
  if (entrySet__ == nil) {
    return new_OrgApacheCommonsCollections15BidimapTreeBidiMap_EntryView_initWithOrgApacheCommonsCollections15BidimapTreeBidiMap_withInt_withInt_(main_, OrgApacheCommonsCollections15BidimapTreeBidiMap_VALUE, OrgApacheCommonsCollections15BidimapTreeBidiMap_INVERSEMAPENTRY);
  }
  return entrySet__;
}
...
- (id<OrgApacheCommonsCollections15MapIterator>)mapIterator {
  ...
  return new_OrgApacheCommonsCollections15BidimapTreeBidiMap_ViewMapIterator_initWithOrgApacheCommonsCollections15BidimapTreeBidiMap_withInt_(main_, OrgApacheCommonsCollections15BidimapTreeBidiMap_VALUE);
}
