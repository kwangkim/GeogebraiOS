...
- (id)putWithId:(id)key
  ...
  if ([((id<JavaUtilMap>) nil_chk(forwardMap_)) containsKeyWithId:key]) {
    (void) [((id<JavaUtilMap>) nil_chk(inverseMap_)) removeWithId:[forwardMap_ getWithId:key]];
  }
  if ([((id<JavaUtilMap>) nil_chk(inverseMap_)) containsKeyWithId:value]) {
    (void) [forwardMap_ removeWithId:[inverseMap_ getWithId:value]];
  }
  id obj = [forwardMap_ putWithId:key withId:value];
  (void) [inverseMap_ putWithId:value withId:key];
  return obj;
}
...
- (id)removeWithId:(id)key {
  ...
  if ([((id<JavaUtilMap>) nil_chk(forwardMap_)) containsKeyWithId:key]) {
    ...
    (void) [((id<JavaUtilMap>) nil_chk(inverseMap_)) removeWithId:value];
  }
  return value;
}
...
- (id<OrgApacheCommonsCollections15MapIterator>)mapIterator {
  return new_OrgApacheCommonsCollections15BidimapAbstractDualBidiMap_BidiMapIterator_initWithOrgApacheCommonsCollections15BidimapAbstractDualBidiMap_(self);
}
...
- (id)removeValueWithId:(id)value {
  ...
  if ([((id<JavaUtilMap>) nil_chk(inverseMap_)) containsKeyWithId:value]) {
    ...
    (void) [((id<JavaUtilMap>) nil_chk(forwardMap_)) removeWithId:key];
  }
  return key;
}
...
- (id<OrgApacheCommonsCollections15BidiMap>)inverseBidiMap {
  if (inverseBidiMap__ == nil) {
    inverseBidiMap__ = [self createBidiMapWithJavaUtilMap:inverseMap_ withJavaUtilMap:forwardMap_ withOrgApacheCommonsCollections15BidiMap:self];
  }
...
- (id<JavaUtilSet>)keySet {
  if (keySet__ == nil) {
    keySet__ = new_OrgApacheCommonsCollections15BidimapAbstractDualBidiMap_KeySet_initWithOrgApacheCommonsCollections15BidimapAbstractDualBidiMap_(self);
  }
  return keySet__;
}

- (id<JavaUtilIterator>)createKeySetIteratorWithJavaUtilIterator:(id<JavaUtilIterator>)iterator {
  return new_OrgApacheCommonsCollections15BidimapAbstractDualBidiMap_KeySetIterator_initWithJavaUtilIterator_withOrgApacheCommonsCollections15BidimapAbstractDualBidiMap_(iterator, self);
}

- (id<JavaUtilSet>)values {
  if (values__ == nil) {
    values__ = new_OrgApacheCommonsCollections15BidimapAbstractDualBidiMap_Values_initWithOrgApacheCommonsCollections15BidimapAbstractDualBidiMap_(self);
  }
  return values__;
}

- (id<JavaUtilIterator>)createValuesIteratorWithJavaUtilIterator:(id<JavaUtilIterator>)iterator {
  return new_OrgApacheCommonsCollections15BidimapAbstractDualBidiMap_ValuesIterator_initWithJavaUtilIterator_withOrgApacheCommonsCollections15BidimapAbstractDualBidiMap_(iterator, self);
}

- (id<JavaUtilSet>)entrySet {
  if (entrySet__ == nil) {
    entrySet__ = new_OrgApacheCommonsCollections15BidimapAbstractDualBidiMap_EntrySet_initWithOrgApacheCommonsCollections15BidimapAbstractDualBidiMap_(self);
  }
  return entrySet__;
}

- (id<JavaUtilIterator>)createEntrySetIteratorWithJavaUtilIterator:(id<JavaUtilIterator>)iterator {
  return new_OrgApacheCommonsCollections15BidimapAbstractDualBidiMap_EntrySetIterator_initWithJavaUtilIterator_withOrgApacheCommonsCollections15BidimapAbstractDualBidiMap_(iterator, self);
}
...
void OrgApacheCommonsCollections15BidimapAbstractDualBidiMap_init(OrgApacheCommonsCollections15BidimapAbstractDualBidiMap *self) {
  ...
  self->inverseBidiMap__ = nil;
  self->keySet__ = nil;
  self->values__ = nil;
  self->entrySet__ = nil;
  self->forwardMap_ = [self createMap];
  self->inverseMap_ = [self createMap];
}
...
void OrgApacheCommonsCollections15BidimapAbstractDualBidiMap_initWithJavaUtilMap_withJavaUtilMap_(OrgApacheCommonsCollections15BidimapAbstractDualBidiMap *self, id<JavaUtilMap> normalMap, id<JavaUtilMap> reverseMap) {
  ...
  self->values__ = nil;
  self->entrySet__ = nil;
  self->forwardMap_ = normalMap;
  self->inverseMap_ = reverseMap;
}
...
void OrgApacheCommonsCollections15BidimapAbstractDualBidiMap_initWithJavaUtilMap_withJavaUtilMap_withOrgApacheCommonsCollections15BidiMap_(OrgApacheCommonsCollections15BidimapAbstractDualBidiMap *self, id<JavaUtilMap> normalMap, id<JavaUtilMap> reverseMap, id<OrgApacheCommonsCollections15BidiMap> inverseBidiMap) {
  ...
  self->forwardMap_ = normalMap;
  self->inverseMap_ = reverseMap;
  self->inverseBidiMap__ = inverseBidiMap;
}
...
void OrgApacheCommonsCollections15BidimapAbstractDualBidiMap_View_initWithJavaUtilCollection_withOrgApacheCommonsCollections15BidimapAbstractDualBidiMap_(OrgApacheCommonsCollections15BidimapAbstractDualBidiMap_View *self, id<JavaUtilCollection> coll, OrgApacheCommonsCollections15BidimapAbstractDualBidiMap *parent) {
  (void) OrgApacheCommonsCollections15CollectionAbstractCollectionDecorator_initWithJavaUtilCollection_(self, coll);
  self->parent_ = parent;
}
...
- (jboolean)removeWithId:(id)key {
  if ([((id<JavaUtilMap>) nil_chk(((OrgApacheCommonsCollections15BidimapAbstractDualBidiMap *) nil_chk(parent_))->forwardMap_)) containsKeyWithId:key]) {
    ...
    (void) [((id<JavaUtilMap>) nil_chk(parent_->inverseMap_)) removeWithId:value];
    return YES;
  }
  return NO;
}
...
void OrgApacheCommonsCollections15BidimapAbstractDualBidiMap_KeySet_initWithOrgApacheCommonsCollections15BidimapAbstractDualBidiMap_(OrgApacheCommonsCollections15BidimapAbstractDualBidiMap_KeySet *self, OrgApacheCommonsCollections15BidimapAbstractDualBidiMap *parent) {
  (void) OrgApacheCommonsCollections15BidimapAbstractDualBidiMap_View_initWithJavaUtilCollection_withOrgApacheCommonsCollections15BidimapAbstractDualBidiMap_(self, [((id<JavaUtilMap>) nil_chk(((OrgApacheCommonsCollections15BidimapAbstractDualBidiMap *) nil_chk(parent))->forwardMap_)) keySet], parent);
}
...
- (jboolean)removeWithId:(id)value {
  if ([((id<JavaUtilMap>) nil_chk(((OrgApacheCommonsCollections15BidimapAbstractDualBidiMap *) nil_chk(parent_))->inverseMap_)) containsKeyWithId:value]) {
    ...
    (void) [((id<JavaUtilMap>) nil_chk(parent_->forwardMap_)) removeWithId:key];
    return YES;
  }
  return NO;
}
...
void OrgApacheCommonsCollections15BidimapAbstractDualBidiMap_Values_initWithOrgApacheCommonsCollections15BidimapAbstractDualBidiMap_(OrgApacheCommonsCollections15BidimapAbstractDualBidiMap_Values *self, OrgApacheCommonsCollections15BidimapAbstractDualBidiMap *parent) {
  (void) OrgApacheCommonsCollections15BidimapAbstractDualBidiMap_View_initWithJavaUtilCollection_withOrgApacheCommonsCollections15BidimapAbstractDualBidiMap_(self, [((id<JavaUtilMap>) nil_chk(((OrgApacheCommonsCollections15BidimapAbstractDualBidiMap *) nil_chk(parent))->forwardMap_)) values], parent);
}
...
- (void)remove {
  ...
  [super remove];
  (void) [((id<JavaUtilMap>) nil_chk(((OrgApacheCommonsCollections15BidimapAbstractDualBidiMap *) nil_chk(parent_))->inverseMap_)) removeWithId:lastValue_];
  lastValue_ = nil;
  canRemove_ = NO;
}
...
- (jboolean)removeWithId:(id)obj {
  ...
  if ([((OrgApacheCommonsCollections15BidimapAbstractDualBidiMap *) nil_chk(parent_)) containsKeyWithId:key]) {
    ...
    if (value == nil ? [entry_ getValue] == nil : [value isEqual:[entry_ getValue]]) {
      (void) [parent_->forwardMap_ removeWithId:key];
      (void) [((id<JavaUtilMap>) nil_chk(parent_->inverseMap_)) removeWithId:value];
      return YES;
    }
  }
...
void OrgApacheCommonsCollections15BidimapAbstractDualBidiMap_EntrySet_initWithOrgApacheCommonsCollections15BidimapAbstractDualBidiMap_(OrgApacheCommonsCollections15BidimapAbstractDualBidiMap_EntrySet *self, OrgApacheCommonsCollections15BidimapAbstractDualBidiMap *parent) {
  (void) OrgApacheCommonsCollections15BidimapAbstractDualBidiMap_View_initWithJavaUtilCollection_withOrgApacheCommonsCollections15BidimapAbstractDualBidiMap_(self, [((id<JavaUtilMap>) nil_chk(((OrgApacheCommonsCollections15BidimapAbstractDualBidiMap *) nil_chk(parent))->forwardMap_)) entrySet], parent);
}
...
- (id<JavaUtilMap_Entry>)next {
  last_ = new_OrgApacheCommonsCollections15BidimapAbstractDualBidiMap_MapEntry_initWithJavaUtilMap_Entry_withOrgApacheCommonsCollections15BidimapAbstractDualBidiMap_([super next], parent_);
  canRemove_ = YES;
  return last_;
}
...
- (void)remove {
  ...
  [super remove];
  (void) [((id<JavaUtilMap>) nil_chk(((OrgApacheCommonsCollections15BidimapAbstractDualBidiMap *) nil_chk(parent_))->inverseMap_)) removeWithId:value];
  last_ = nil;
  canRemove_ = NO;
}
...
- (id)setValueWithId:(id)value {
  ...
  if ([((id<JavaUtilMap>) nil_chk(((OrgApacheCommonsCollections15BidimapAbstractDualBidiMap *) nil_chk(parent_))->inverseMap_)) containsKeyWithId:value] && [parent_->inverseMap_ getWithId:value] != key) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"Cannot use setValue() when the object being set is already in the map");
  }
  (void) [parent_ putWithId:key withId:value];
...
- (void)reset {
  iterator_ = [((id<JavaUtilSet>) nil_chk([((id<JavaUtilMap>) nil_chk(((OrgApacheCommonsCollections15BidimapAbstractDualBidiMap *) nil_chk(parent_))->forwardMap_)) entrySet])) iterator];
  last_ = nil;
  canRemove_ = NO;
}
...
void OrgApacheCommonsCollections15BidimapAbstractDualBidiMap_BidiMapIterator_initWithOrgApacheCommonsCollections15BidimapAbstractDualBidiMap_(OrgApacheCommonsCollections15BidimapAbstractDualBidiMap_BidiMapIterator *self, OrgApacheCommonsCollections15BidimapAbstractDualBidiMap *parent) {
  ...
  self->canRemove_ = NO;
  self->parent_ = parent;
  self->iterator_ = [((id<JavaUtilSet>) nil_chk([((id<JavaUtilMap>) nil_chk(((OrgApacheCommonsCollections15BidimapAbstractDualBidiMap *) nil_chk(parent))->forwardMap_)) entrySet])) iterator];
}
