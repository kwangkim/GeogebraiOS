...
- (id)getWithInt:(jint)index {
  ...
  if (index < size) {
    ...
    if (object == nil) {
      ...
      (void) [((id<JavaUtilList>) nil_chk([self getList])) setWithInt:index withId:object];
      return object;
    }
    else {
      return object;
...
- (id<JavaUtilList>)subListWithInt:(jint)fromIndex
  ...
  return new_OrgApacheCommonsCollections15ListLazyList_initWithJavaUtilList_withOrgApacheCommonsCollections15Factory_(sub, factory_);
}
...
id<JavaUtilList> OrgApacheCommonsCollections15ListLazyList_decorateWithJavaUtilList_withOrgApacheCommonsCollections15Factory_(id<JavaUtilList> list, id<OrgApacheCommonsCollections15Factory> factory) {
  ...
  return new_OrgApacheCommonsCollections15ListLazyList_initWithJavaUtilList_withOrgApacheCommonsCollections15Factory_(list, factory);
}
