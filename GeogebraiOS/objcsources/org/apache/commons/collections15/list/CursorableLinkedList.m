...
- (void)init__ {
  [super init__];
  OrgApacheCommonsCollections15ListCursorableLinkedList_setAndConsume_cursors_(self, new_JavaUtilArrayList_init());
}
...
- (OrgApacheCommonsCollections15ListCursorableLinkedList_Cursor *)cursorWithInt:(jint)fromIndex {
  OrgApacheCommonsCollections15ListCursorableLinkedList_Cursor *cursor = [new_OrgApacheCommonsCollections15ListCursorableLinkedList_Cursor_initWithOrgApacheCommonsCollections15ListCursorableLinkedList_withInt_(self, fromIndex) autorelease];
...
- (void)registerCursorWithOrgApacheCommonsCollections15ListCursorableLinkedList_Cursor:(OrgApacheCommonsCollections15ListCursorableLinkedList_Cursor *)cursor {
  ...
  [cursors_ addWithId:[new_JavaLangRefWeakReference_initWithId_(cursor) autorelease]];
}
...
- (void)addWithId:(id)obj {
  [super addWithId:obj];
  OrgApacheCommonsCollections15ListAbstractLinkedList_LinkedListIterator_set_next__(self, ((OrgApacheCommonsCollections15ListAbstractLinkedList_Node *) nil_chk(next__))->next_);
}
...
- (void)nodeRemovedWithOrgApacheCommonsCollections15ListAbstractLinkedList_Node:(OrgApacheCommonsCollections15ListAbstractLinkedList_Node *)node {
  if (node == next__) {
    OrgApacheCommonsCollections15ListAbstractLinkedList_LinkedListIterator_set_next__(self, ((OrgApacheCommonsCollections15ListAbstractLinkedList_Node *) nil_chk(node))->next_);
  }
...
- (void)nodeInsertedWithOrgApacheCommonsCollections15ListAbstractLinkedList_Node:(OrgApacheCommonsCollections15ListAbstractLinkedList_Node *)node {
  if (((OrgApacheCommonsCollections15ListAbstractLinkedList_Node *) nil_chk(node))->previous_ == current_) {
    OrgApacheCommonsCollections15ListAbstractLinkedList_LinkedListIterator_set_next__(self, node);
  }
...
- (void)checkModCount {
  if (!valid_) {
    @throw [new_JavaUtilConcurrentModificationException_initWithNSString_(@"Cursor closed") autorelease];
  }
}
...
void OrgApacheCommonsCollections15ListCursorableLinkedList_Cursor_initWithOrgApacheCommonsCollections15ListCursorableLinkedList_withInt_(OrgApacheCommonsCollections15ListCursorableLinkedList_Cursor *self, OrgApacheCommonsCollections15ListCursorableLinkedList *parent, jint index) {
  OrgApacheCommonsCollections15ListAbstractLinkedList_LinkedListIterator_initWithOrgApacheCommonsCollections15ListAbstractLinkedList_withInt_(self, parent, index);
  self->valid_ = YES;
