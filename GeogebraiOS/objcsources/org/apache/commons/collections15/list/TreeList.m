...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/org/apache/commons/collections15/list/TreeList.java
//
...
- (id<JavaUtilListIterator>)listIteratorWithInt:(jint)fromIndex {
  ...
  return [new_OrgApacheCommonsCollections15ListTreeList_TreeListIterator_initWithOrgApacheCommonsCollections15ListTreeList_withInt_(self, fromIndex) autorelease];
}
...
- (IOSObjectArray *)toArray {
  IOSObjectArray *array = [IOSObjectArray arrayWithLength:[self size] type:NSObject_class_()];
  if (root_ != nil) {
...
- (void)addWithInt:(jint)index
  ...
  if (root_ == nil) {
    OrgApacheCommonsCollections15ListTreeList_setAndConsume_root_(self, new_OrgApacheCommonsCollections15ListTreeList_AVLNode_initWithInt_withId_withOrgApacheCommonsCollections15ListTreeList_AVLNode_withOrgApacheCommonsCollections15ListTreeList_AVLNode_(index, obj, nil, nil));
  }
  else {
    OrgApacheCommonsCollections15ListTreeList_set_root_(self, [root_ insertWithInt:index withId:obj]);
  }
  size__++;
}
...
- (id)removeWithInt:(jint)index {
  ...
  OrgApacheCommonsCollections15ListTreeList_set_root_(self, [((OrgApacheCommonsCollections15ListTreeList_AVLNode *) nil_chk(root_)) removeWithInt:index]);
  size__--;
  return result;
}
...
- (void)clear {
  modCount_++;
  OrgApacheCommonsCollections15ListTreeList_set_root_(self, nil);
  size__ = 0;
}
...
void OrgApacheCommonsCollections15ListTreeList_checkIntervalWithInt_withInt_withInt_(OrgApacheCommonsCollections15ListTreeList *self, jint index, jint startIndex, jint endIndex) {
  if (index < startIndex || index > endIndex) {
    @throw [new_JavaLangIndexOutOfBoundsException_initWithNSString_(JreStrcat("$I$I", @"Invalid index:", index, @", size=", [self size])) autorelease];
  }
}
...
- (void)setValueWithId:(id)obj {
  OrgApacheCommonsCollections15ListTreeList_AVLNode_set_value_(self, obj);
}
...
- (void)toArrayWithNSObjectArray:(IOSObjectArray *)array
                         withInt:(jint)index {
  IOSObjectArray_Set(nil_chk(array), index, value_);
  if (OrgApacheCommonsCollections15ListTreeList_AVLNode_getLeftSubTree(self) != nil) {
...
void OrgApacheCommonsCollections15ListTreeList_AVLNode_initWithInt_withId_withOrgApacheCommonsCollections15ListTreeList_AVLNode_withOrgApacheCommonsCollections15ListTreeList_AVLNode_(OrgApacheCommonsCollections15ListTreeList_AVLNode *self, jint relativePosition, id obj, OrgApacheCommonsCollections15ListTreeList_AVLNode *rightFollower, OrgApacheCommonsCollections15ListTreeList_AVLNode *leftFollower) {
  ...
  OrgApacheCommonsCollections15ListTreeList_AVLNode_set_right_(self, rightFollower);
  OrgApacheCommonsCollections15ListTreeList_AVLNode_set_left_(self, leftFollower);
}
...
OrgApacheCommonsCollections15ListTreeList_AVLNode *OrgApacheCommonsCollections15ListTreeList_AVLNode_removeSelf(OrgApacheCommonsCollections15ListTreeList_AVLNode *self) {
  ...
  if (OrgApacheCommonsCollections15ListTreeList_AVLNode_heightRightMinusLeft(self) > 0) {
    ...
    OrgApacheCommonsCollections15ListTreeList_AVLNode_set_value_(self, ((OrgApacheCommonsCollections15ListTreeList_AVLNode *) nil_chk(rightMin))->value_);
    if (self->leftIsPrevious_) {
      OrgApacheCommonsCollections15ListTreeList_AVLNode_set_left_(self, rightMin->left_);
    }
    OrgApacheCommonsCollections15ListTreeList_AVLNode_set_right_(self, OrgApacheCommonsCollections15ListTreeList_AVLNode_removeMin(self->right_));
    if (self->relativePosition_ < 0) {
      self->relativePosition_++;
    }
  }
    ...
    OrgApacheCommonsCollections15ListTreeList_AVLNode_set_value_(self, ((OrgApacheCommonsCollections15ListTreeList_AVLNode *) nil_chk(leftMax))->value_);
    if (self->rightIsNext_) {
      OrgApacheCommonsCollections15ListTreeList_AVLNode_set_right_(self, leftMax->right_);
    }
    OrgApacheCommonsCollections15ListTreeList_AVLNode_set_left_(self, OrgApacheCommonsCollections15ListTreeList_AVLNode_removeMax(self->left_));
    if (self->relativePosition_ > 0) {
      self->relativePosition_--;
    }
  }
...
OrgApacheCommonsCollections15ListTreeList_AVLNode *OrgApacheCommonsCollections15ListTreeList_AVLNode_balance(OrgApacheCommonsCollections15ListTreeList_AVLNode *self) {
  switch (OrgApacheCommonsCollections15ListTreeList_AVLNode_heightRightMinusLeft(self)) {
    ...
    return OrgApacheCommonsCollections15ListTreeList_AVLNode_rotateLeft(self);
    default:
    @throw [new_JavaLangRuntimeException_initWithNSString_(@"tree inconsistent!") autorelease];
  }
}
...
void OrgApacheCommonsCollections15ListTreeList_AVLNode_setLeftWithOrgApacheCommonsCollections15ListTreeList_AVLNode_withOrgApacheCommonsCollections15ListTreeList_AVLNode_(OrgApacheCommonsCollections15ListTreeList_AVLNode *self, OrgApacheCommonsCollections15ListTreeList_AVLNode *node, OrgApacheCommonsCollections15ListTreeList_AVLNode *previous) {
  ...
  OrgApacheCommonsCollections15ListTreeList_AVLNode_set_left_(self, (self->leftIsPrevious_ ? previous : node));
  OrgApacheCommonsCollections15ListTreeList_AVLNode_recalcHeight(self);
}

void OrgApacheCommonsCollections15ListTreeList_AVLNode_setRightWithOrgApacheCommonsCollections15ListTreeList_AVLNode_withOrgApacheCommonsCollections15ListTreeList_AVLNode_(OrgApacheCommonsCollections15ListTreeList_AVLNode *self, OrgApacheCommonsCollections15ListTreeList_AVLNode *node, OrgApacheCommonsCollections15ListTreeList_AVLNode *next) {
  self->rightIsNext_ = (node == nil);
  OrgApacheCommonsCollections15ListTreeList_AVLNode_set_right_(self, (self->rightIsNext_ ? next : node));
  OrgApacheCommonsCollections15ListTreeList_AVLNode_recalcHeight(self);
}
...
- (id)next {
  ...
  if (next__ == nil) {
    OrgApacheCommonsCollections15ListTreeList_TreeListIterator_set_next__(self, [((OrgApacheCommonsCollections15ListTreeList_AVLNode *) nil_chk(((OrgApacheCommonsCollections15ListTreeList *) nil_chk(parent_))->root_)) getWithInt:nextIndex__]);
  }
  id value = [((OrgApacheCommonsCollections15ListTreeList_AVLNode *) nil_chk(next__)) getValue];
  OrgApacheCommonsCollections15ListTreeList_TreeListIterator_set_current_(self, next__);
  currentIndex_ = nextIndex__++;
  OrgApacheCommonsCollections15ListTreeList_TreeListIterator_set_next__(self, [next__ next]);
  return value;
}
...
- (id)previous {
  ...
  if (next__ == nil) {
    OrgApacheCommonsCollections15ListTreeList_TreeListIterator_set_next__(self, [((OrgApacheCommonsCollections15ListTreeList_AVLNode *) nil_chk(((OrgApacheCommonsCollections15ListTreeList *) nil_chk(parent_))->root_)) getWithInt:nextIndex__ - 1]);
  }
  else {
    OrgApacheCommonsCollections15ListTreeList_TreeListIterator_set_next__(self, [next__ previous]);
  }
  id value = [((OrgApacheCommonsCollections15ListTreeList_AVLNode *) nil_chk(next__)) getValue];
  OrgApacheCommonsCollections15ListTreeList_TreeListIterator_set_current_(self, next__);
  currentIndex_ = --nextIndex__;
...
- (void)remove {
  ...
  [((OrgApacheCommonsCollections15ListTreeList *) nil_chk(parent_)) removeWithInt:currentIndex_];
  OrgApacheCommonsCollections15ListTreeList_TreeListIterator_set_current_(self, nil);
  currentIndex_ = -1;
  nextIndex__--;
  expectedModCount_++;
}
...
void OrgApacheCommonsCollections15ListTreeList_TreeListIterator_initWithOrgApacheCommonsCollections15ListTreeList_withInt_(OrgApacheCommonsCollections15ListTreeList_TreeListIterator *self, OrgApacheCommonsCollections15ListTreeList *parent, jint fromIndex) {
  NSObject_init(self);
  OrgApacheCommonsCollections15ListTreeList_TreeListIterator_set_parent_(self, parent);
  self->expectedModCount_ = ((OrgApacheCommonsCollections15ListTreeList *) nil_chk(parent))->modCount_;
  OrgApacheCommonsCollections15ListTreeList_TreeListIterator_set_next__(self, (parent->root_ == nil ? nil : [parent->root_ getWithInt:fromIndex]));
