...
- (id)clone {
  ...
  if (fast_) {
    results = new_OrgApacheCommonsCollections15ListFastArrayList_initWithJavaUtilCollection_(list_);
  }
  else {
    @synchronized(list_) {
      results = new_OrgApacheCommonsCollections15ListFastArrayList_initWithJavaUtilCollection_(list_);
...
- (id<JavaUtilIterator>)iterator {
  if (fast_) {
    return new_OrgApacheCommonsCollections15ListFastArrayList_ListIter_initWithOrgApacheCommonsCollections15ListFastArrayList_withInt_(self, 0);
  }
  else {
...
- (id<JavaUtilListIterator>)listIteratorWithInt:(jint)index {
  if (fast_) {
    return new_OrgApacheCommonsCollections15ListFastArrayList_ListIter_initWithOrgApacheCommonsCollections15ListFastArrayList_withInt_(self, index);
  }
  else {
...
- (id<JavaUtilList>)subListWithInt:(jint)fromIndex
  ...
  if (fast_) {
    return new_OrgApacheCommonsCollections15ListFastArrayList_SubList_initWithOrgApacheCommonsCollections15ListFastArrayList_withInt_withInt_(self, fromIndex, toIndex);
  }
  else {
...
- (NSString *)description {
  JavaLangStringBuffer *sb = new_JavaLangStringBuffer_initWithNSString_(@"FastArrayList[");
  (void) [sb appendWithNSString:[((JavaUtilArrayList *) nil_chk(list_)) description]];
...
- (id<JavaUtilIterator>)iterator {
  return new_OrgApacheCommonsCollections15ListFastArrayList_SubList_SubListIter_initWithOrgApacheCommonsCollections15ListFastArrayList_SubList_withInt_(self, 0);
}
...
- (id<JavaUtilListIterator>)listIteratorWithInt:(jint)i {
  return new_OrgApacheCommonsCollections15ListFastArrayList_SubList_SubListIter_initWithOrgApacheCommonsCollections15ListFastArrayList_SubList_withInt_(self, i);
}
...
- (id<JavaUtilList>)subListWithInt:(jint)f
  ...
  return new_OrgApacheCommonsCollections15ListFastArrayList_SubList_initWithOrgApacheCommonsCollections15ListFastArrayList_withInt_withInt_(this$0_, first_ + f, f + l);
}
...
- (void)remove {
  ...
  (void) [((id<JavaUtilList>) nil_chk([self get])) removeWithInt:lastReturnedIndex_];
  this$0_->last_--;
  expected1_ = this$0_->this$0_->list_;
  iter_ = [((id<JavaUtilList>) nil_chk([self get])) listIteratorWithInt:[self previousIndex]];
...
- (void)setWithId:(id)o {
  ...
  (void) [((id<JavaUtilList>) nil_chk([self get])) setWithInt:lastReturnedIndex_ withId:o];
  expected1_ = this$0_->this$0_->list_;
  iter_ = [((id<JavaUtilList>) nil_chk([self get])) listIteratorWithInt:[self previousIndex] + 1];
}
...
- (void)addWithId:(id)o {
  ...
  this$0_->last_++;
  iter_ = [((id<JavaUtilList>) nil_chk([self get])) listIteratorWithInt:i + 1];
  lastReturnedIndex_ = 1;
}
...
void OrgApacheCommonsCollections15ListFastArrayList_SubList_SubListIter_initWithOrgApacheCommonsCollections15ListFastArrayList_SubList_withInt_(OrgApacheCommonsCollections15ListFastArrayList_SubList_SubListIter *self, OrgApacheCommonsCollections15ListFastArrayList_SubList *outer$, jint i) {
  ...
  self->expected1_ = outer$->this$0_->list_;
  self->iter_ = [((id<JavaUtilList>) nil_chk(OrgApacheCommonsCollections15ListFastArrayList_SubList_getWithJavaUtilList_(outer$, self->expected1_))) listIteratorWithInt:i];
}
...
void OrgApacheCommonsCollections15ListFastArrayList_ListIter_initWithOrgApacheCommonsCollections15ListFastArrayList_withInt_(OrgApacheCommonsCollections15ListFastArrayList_ListIter *self, OrgApacheCommonsCollections15ListFastArrayList *outer$, jint i) {
  ...
  self->lastReturnedIndex_ = -1;
  self->expected_ = outer$->list_;
  self->iter_ = [((id<JavaUtilList>) nil_chk([self get])) listIteratorWithInt:i];
}
