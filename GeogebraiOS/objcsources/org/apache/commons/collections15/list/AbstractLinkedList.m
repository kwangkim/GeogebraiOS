...
- (id<JavaUtilListIterator>)listIterator {
  return new_OrgApacheCommonsCollections15ListAbstractLinkedList_LinkedListIterator_initWithOrgApacheCommonsCollections15ListAbstractLinkedList_withInt_(self, 0);
}

- (id<JavaUtilListIterator>)listIteratorWithInt:(jint)fromIndex {
  return new_OrgApacheCommonsCollections15ListAbstractLinkedList_LinkedListIterator_initWithOrgApacheCommonsCollections15ListAbstractLinkedList_withInt_(self, fromIndex);
}
...
- (IOSObjectArray *)toArray {
  return [self toArrayWithNSObjectArray:[IOSObjectArray newArrayWithLength:size__ type:NSObject_class_()]];
}
...
- (IOSObjectArray *)toArrayWithNSObjectArray:(IOSObjectArray *)array {
  ...
  for (OrgApacheCommonsCollections15ListAbstractLinkedList_Node *node = ((OrgApacheCommonsCollections15ListAbstractLinkedList_Node *) nil_chk(header_))->next_; node != header_; node = node->next_, i++) {
    (void) IOSObjectArray_Set(nil_chk(array), i, (id) [((OrgApacheCommonsCollections15ListAbstractLinkedList_Node *) nil_chk(node)) getValue]);
  }
  if (((IOSObjectArray *) nil_chk(array))->size_ > size__) {
    (void) IOSObjectArray_Set(array, size__, nil);
  }
  return array;
}
...
- (id<JavaUtilList>)subListWithInt:(jint)fromIndexInclusive
  ...
  return new_OrgApacheCommonsCollections15ListAbstractLinkedList_LinkedSubList_initWithOrgApacheCommonsCollections15ListAbstractLinkedList_withInt_withInt_(self, fromIndexInclusive, toIndexExclusive);
}
...
- (NSString *)description {
  ...
  JavaLangStringBuffer *buf = new_JavaLangStringBuffer_initWithInt_(16 * [self size]);
  (void) [buf appendWithNSString:@"["];
  id<JavaUtilIterator> it = [self iterator];
  jboolean hasNext = [((id<JavaUtilIterator>) nil_chk(it)) hasNext];
  while (hasNext) {
    id value = [it next];
    (void) [buf appendWithId:value == self ? @"(this Collection)" : value];
    hasNext = [it hasNext];
    if (hasNext) {
      (void) [buf appendWithNSString:@", "];
    }
...
- (OrgApacheCommonsCollections15ListAbstractLinkedList_Node *)createHeaderNode {
  return new_OrgApacheCommonsCollections15ListAbstractLinkedList_Node_init();
}

- (OrgApacheCommonsCollections15ListAbstractLinkedList_Node *)createNodeWithId:(id)value {
  return new_OrgApacheCommonsCollections15ListAbstractLinkedList_Node_initWithId_(value);
}
...
- (void)addNodeWithOrgApacheCommonsCollections15ListAbstractLinkedList_Node:(OrgApacheCommonsCollections15ListAbstractLinkedList_Node *)nodeToInsert
  ...
  ((OrgApacheCommonsCollections15ListAbstractLinkedList_Node *) nil_chk(nodeToInsert))->next_ = insertBeforeNode;
  nodeToInsert->previous_ = ((OrgApacheCommonsCollections15ListAbstractLinkedList_Node *) nil_chk(insertBeforeNode))->previous_;
  ((OrgApacheCommonsCollections15ListAbstractLinkedList_Node *) nil_chk(insertBeforeNode->previous_))->next_ = nodeToInsert;
  insertBeforeNode->previous_ = nodeToInsert;
  size__++;
  modCount_++;
}
...
- (void)removeNodeWithOrgApacheCommonsCollections15ListAbstractLinkedList_Node:(OrgApacheCommonsCollections15ListAbstractLinkedList_Node *)node {
  ((OrgApacheCommonsCollections15ListAbstractLinkedList_Node *) nil_chk(((OrgApacheCommonsCollections15ListAbstractLinkedList_Node *) nil_chk(node))->previous_))->next_ = node->next_;
  ((OrgApacheCommonsCollections15ListAbstractLinkedList_Node *) nil_chk(node->next_))->previous_ = node->previous_;
  size__--;
  modCount_++;
}

- (void)removeAllNodes {
  ((OrgApacheCommonsCollections15ListAbstractLinkedList_Node *) nil_chk(header_))->next_ = header_;
...
- (OrgApacheCommonsCollections15ListAbstractLinkedList_Node *)getNodeWithInt:(jint)index
  ...
  if (index < 0) {
    @throw new_JavaLangIndexOutOfBoundsException_initWithNSString_(JreStrcat("$I$", @"Couldn't get the node: index (", index, @") less than zero."));
  }
  if (!endMarkerAllowed && index == size__) {
    @throw new_JavaLangIndexOutOfBoundsException_initWithNSString_(JreStrcat("$I$", @"Couldn't get the node: index (", index, @") is the size of the list."));
  }
  if (index > size__) {
    @throw new_JavaLangIndexOutOfBoundsException_initWithNSString_(JreStrcat("$I$I$", @"Couldn't get the node: index (", index, @") greater than the size of the list (", size__, @")."));
  }
...
- (id<JavaUtilListIterator>)createSubListListIteratorWithOrgApacheCommonsCollections15ListAbstractLinkedList_LinkedSubList:(OrgApacheCommonsCollections15ListAbstractLinkedList_LinkedSubList *)subList
  ...
  return new_OrgApacheCommonsCollections15ListAbstractLinkedList_LinkedSubListIterator_initWithOrgApacheCommonsCollections15ListAbstractLinkedList_LinkedSubList_withInt_(subList, fromIndex);
}
...
- (id)previous {
  ...
  next__ = ((OrgApacheCommonsCollections15ListAbstractLinkedList_Node *) nil_chk(next__))->previous_;
  id value = [((OrgApacheCommonsCollections15ListAbstractLinkedList_Node *) nil_chk(next__)) getValue];
  current_ = next__;
  nextIndex__--;
  return value;
...
void OrgApacheCommonsCollections15ListAbstractLinkedList_LinkedListIterator_initWithOrgApacheCommonsCollections15ListAbstractLinkedList_withInt_(OrgApacheCommonsCollections15ListAbstractLinkedList_LinkedListIterator *self, OrgApacheCommonsCollections15ListAbstractLinkedList *parent, jint fromIndex) {
  ...
  self->next__ = [parent getNodeWithInt:fromIndex withBoolean:YES];
...
void OrgApacheCommonsCollections15ListAbstractLinkedList_LinkedSubListIterator_initWithOrgApacheCommonsCollections15ListAbstractLinkedList_LinkedSubList_withInt_(OrgApacheCommonsCollections15ListAbstractLinkedList_LinkedSubListIterator *self, OrgApacheCommonsCollections15ListAbstractLinkedList_LinkedSubList *sub, jint startIndex) {
  (void) OrgApacheCommonsCollections15ListAbstractLinkedList_LinkedListIterator_initWithOrgApacheCommonsCollections15ListAbstractLinkedList_withInt_(self, ((OrgApacheCommonsCollections15ListAbstractLinkedList_LinkedSubList *) nil_chk(sub))->parent_, startIndex + sub->offset_);
  self->sub_ = sub;
}
...
- (id<JavaUtilList>)subListWithInt:(jint)fromIndexInclusive
                           withInt:(jint)toIndexExclusive {
  return new_OrgApacheCommonsCollections15ListAbstractLinkedList_LinkedSubList_initWithOrgApacheCommonsCollections15ListAbstractLinkedList_withInt_withInt_(parent_, fromIndexInclusive + offset_, toIndexExclusive + offset_);
}

- (void)rangeCheckWithInt:(jint)index
                  withInt:(jint)beyond {
  if (index < 0 || index >= beyond) {
    @throw new_JavaLangIndexOutOfBoundsException_initWithNSString_(JreStrcat("$I$IC", @"Index '", index, @"' out of bounds for size '", size__, '\''));
  }
}
...
void OrgApacheCommonsCollections15ListAbstractLinkedList_LinkedSubList_initWithOrgApacheCommonsCollections15ListAbstractLinkedList_withInt_withInt_(OrgApacheCommonsCollections15ListAbstractLinkedList_LinkedSubList *self, OrgApacheCommonsCollections15ListAbstractLinkedList *parent, jint fromIndex, jint toIndex) {
  ...
  if (fromIndex < 0) {
    @throw new_JavaLangIndexOutOfBoundsException_initWithNSString_(JreStrcat("$I", @"fromIndex = ", fromIndex));
  }
  if (toIndex > [((OrgApacheCommonsCollections15ListAbstractLinkedList *) nil_chk(parent)) size]) {
    @throw new_JavaLangIndexOutOfBoundsException_initWithNSString_(JreStrcat("$I", @"toIndex = ", toIndex));
  }
  if (fromIndex > toIndex) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$I$IC", @"fromIndex(", fromIndex, @") > toIndex(", toIndex, ')'));
  }
  self->parent_ = parent;
