...
void ComVividsolutionsJtsUtilAssert_isTrueWithBoolean_withNSString_(jboolean assertion, NSString *message) {
  ...
  if (!assertion) {
    if (message == nil) {
      @throw new_ComVividsolutionsJtsUtilAssertionFailedException_init();
    }
    else {
      @throw new_ComVividsolutionsJtsUtilAssertionFailedException_initWithNSString_(message);
    }
  }
}
...
void ComVividsolutionsJtsUtilAssert_equalsWithId_withId_withNSString_(id expectedValue, id actualValue, NSString *message) {
  ...
  if (![nil_chk(actualValue) isEqual:expectedValue]) {
    @throw new_ComVividsolutionsJtsUtilAssertionFailedException_initWithNSString_(JreStrcat("$@$@$", @"Expected ", expectedValue, @" but encountered ", actualValue, (message != nil ? JreStrcat("$$", @": ", message) : @"")));
  }
}
...
void ComVividsolutionsJtsUtilAssert_shouldNeverReachHereWithNSString_(NSString *message) {
  ComVividsolutionsJtsUtilAssert_initialize();
  @throw new_ComVividsolutionsJtsUtilAssertionFailedException_initWithNSString_(JreStrcat("$$", @"Should never reach here", (message != nil ? JreStrcat("$$", @": ", message) : @"")));
}
