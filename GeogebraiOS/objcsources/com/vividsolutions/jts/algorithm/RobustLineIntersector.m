...
- (jint)computeIntersectWithComVividsolutionsJtsGeomCoordinate:(ComVividsolutionsJtsGeomCoordinate *)p1
  ...
  if (Pq1 == 0 || Pq2 == 0 || Qp1 == 0 || Qp2 == 0) {
    ...
    if ([((ComVividsolutionsJtsGeomCoordinate *) nil_chk(p1)) equals2DWithComVividsolutionsJtsGeomCoordinate:q1] || [p1 equals2DWithComVividsolutionsJtsGeomCoordinate:q2]) {
      (void) IOSObjectArray_Set(nil_chk(intPt_), 0, p1);
    }
      ...
      (void) IOSObjectArray_Set(nil_chk(intPt_), 0, p2);
    }
    else if (Pq1 == 0) {
      (void) IOSObjectArray_Set(nil_chk(intPt_), 0, new_ComVividsolutionsJtsGeomCoordinate_initWithComVividsolutionsJtsGeomCoordinate_(q1));
    }
    else if (Pq2 == 0) {
      (void) IOSObjectArray_Set(nil_chk(intPt_), 0, new_ComVividsolutionsJtsGeomCoordinate_initWithComVividsolutionsJtsGeomCoordinate_(q2));
    }
    else if (Qp1 == 0) {
      (void) IOSObjectArray_Set(nil_chk(intPt_), 0, new_ComVividsolutionsJtsGeomCoordinate_initWithComVividsolutionsJtsGeomCoordinate_(p1));
    }
    else if (Qp2 == 0) {
      (void) IOSObjectArray_Set(nil_chk(intPt_), 0, new_ComVividsolutionsJtsGeomCoordinate_initWithComVividsolutionsJtsGeomCoordinate_(p2));
    }
  }
  else {
    isProper__ = YES;
    (void) IOSObjectArray_Set(nil_chk(intPt_), 0, ComVividsolutionsJtsAlgorithmRobustLineIntersector_intersectionWithComVividsolutionsJtsGeomCoordinate_withComVividsolutionsJtsGeomCoordinate_withComVividsolutionsJtsGeomCoordinate_withComVividsolutionsJtsGeomCoordinate_(self, p1, p2, q1, q2));
  }
...
jint ComVividsolutionsJtsAlgorithmRobustLineIntersector_computeCollinearIntersectionWithComVividsolutionsJtsGeomCoordinate_withComVividsolutionsJtsGeomCoordinate_withComVividsolutionsJtsGeomCoordinate_withComVividsolutionsJtsGeomCoordinate_(ComVividsolutionsJtsAlgorithmRobustLineIntersector *self, ComVividsolutionsJtsGeomCoordinate *p1, ComVividsolutionsJtsGeomCoordinate *p2, ComVividsolutionsJtsGeomCoordinate *q1, ComVividsolutionsJtsGeomCoordinate *q2) {
  ...
  if (p1q1p2 && p1q2p2) {
    (void) IOSObjectArray_Set(nil_chk(self->intPt_), 0, q1);
    (void) IOSObjectArray_Set(self->intPt_, 1, q2);
    return ComVividsolutionsJtsAlgorithmLineIntersector_COLLINEAR;
  }
  if (q1p1q2 && q1p2q2) {
    (void) IOSObjectArray_Set(nil_chk(self->intPt_), 0, p1);
    (void) IOSObjectArray_Set(self->intPt_, 1, p2);
    return ComVividsolutionsJtsAlgorithmLineIntersector_COLLINEAR;
  }
  if (p1q1p2 && q1p1q2) {
    (void) IOSObjectArray_Set(nil_chk(self->intPt_), 0, q1);
    (void) IOSObjectArray_Set(self->intPt_, 1, p1);
  ...
  if (p1q2p2 && q1p1q2) {
    (void) IOSObjectArray_Set(nil_chk(self->intPt_), 0, q2);
    (void) IOSObjectArray_Set(self->intPt_, 1, p1);
...
ComVividsolutionsJtsGeomCoordinate *ComVividsolutionsJtsAlgorithmRobustLineIntersector_intersectionWithNormalizationWithComVividsolutionsJtsGeomCoordinate_withComVividsolutionsJtsGeomCoordinate_withComVividsolutionsJtsGeomCoordinate_withComVividsolutionsJtsGeomCoordinate_(ComVividsolutionsJtsAlgorithmRobustLineIntersector *self, ComVividsolutionsJtsGeomCoordinate *p1, ComVividsolutionsJtsGeomCoordinate *p2, ComVividsolutionsJtsGeomCoordinate *q1, ComVividsolutionsJtsGeomCoordinate *q2) {
  ComVividsolutionsJtsGeomCoordinate *n1 = new_ComVividsolutionsJtsGeomCoordinate_initWithComVividsolutionsJtsGeomCoordinate_(p1);
  ComVividsolutionsJtsGeomCoordinate *n2 = new_ComVividsolutionsJtsGeomCoordinate_initWithComVividsolutionsJtsGeomCoordinate_(p2);
  ComVividsolutionsJtsGeomCoordinate *n3 = new_ComVividsolutionsJtsGeomCoordinate_initWithComVividsolutionsJtsGeomCoordinate_(q1);
  ComVividsolutionsJtsGeomCoordinate *n4 = new_ComVividsolutionsJtsGeomCoordinate_initWithComVividsolutionsJtsGeomCoordinate_(q2);
  ComVividsolutionsJtsGeomCoordinate *normPt = new_ComVividsolutionsJtsGeomCoordinate_init();
...
jboolean ComVividsolutionsJtsAlgorithmRobustLineIntersector_isInSegmentEnvelopesWithComVividsolutionsJtsGeomCoordinate_(ComVividsolutionsJtsAlgorithmRobustLineIntersector *self, ComVividsolutionsJtsGeomCoordinate *intPt) {
  ComVividsolutionsJtsGeomEnvelope *env0 = new_ComVividsolutionsJtsGeomEnvelope_initWithComVividsolutionsJtsGeomCoordinate_withComVividsolutionsJtsGeomCoordinate_(IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(nil_chk(self->inputLines_), 0)), 0), IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(self->inputLines_, 0)), 1));
  ComVividsolutionsJtsGeomEnvelope *env1 = new_ComVividsolutionsJtsGeomEnvelope_initWithComVividsolutionsJtsGeomCoordinate_withComVividsolutionsJtsGeomCoordinate_(IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(self->inputLines_, 1)), 0), IOSObjectArray_Get(nil_chk(IOSObjectArray_Get(self->inputLines_, 1)), 1));
