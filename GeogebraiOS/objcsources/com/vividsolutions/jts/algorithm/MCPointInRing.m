...
- (jboolean)isInsideWithComVividsolutionsJtsGeomCoordinate:(ComVividsolutionsJtsGeomCoordinate *)pt {
  crossings_ = 0;
  ComVividsolutionsJtsGeomEnvelope *rayEnv = new_ComVividsolutionsJtsGeomEnvelope_initWithDouble_withDouble_withDouble_withDouble_(JavaLangDouble_NEGATIVE_INFINITY, JavaLangDouble_POSITIVE_INFINITY, ((ComVividsolutionsJtsGeomCoordinate *) nil_chk(pt))->y_, pt->y_);
  ...
  ComVividsolutionsJtsAlgorithmMCPointInRing_MCSelecter *mcSelecter = new_ComVividsolutionsJtsAlgorithmMCPointInRing_MCSelecter_initWithComVividsolutionsJtsAlgorithmMCPointInRing_withComVividsolutionsJtsGeomCoordinate_(self, pt);
...
void ComVividsolutionsJtsAlgorithmMCPointInRing_initWithComVividsolutionsJtsGeomLinearRing_(ComVividsolutionsJtsAlgorithmMCPointInRing *self, ComVividsolutionsJtsGeomLinearRing *ring) {
  ...
  self->crossings_ = 0;
  self->interval_ = new_ComVividsolutionsJtsIndexBintreeInterval_init();
  self->ring_ = ring;
  ComVividsolutionsJtsAlgorithmMCPointInRing_buildIndex(self);
}
...
void ComVividsolutionsJtsAlgorithmMCPointInRing_buildIndex(ComVividsolutionsJtsAlgorithmMCPointInRing *self) {
  self->tree_ = new_ComVividsolutionsJtsIndexBintreeBintree_init();
