...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/com/vividsolutions/jts/algorithm/BoundaryNodeRule.java
//
...
+ (void)initialize {
  if (self == [ComVividsolutionsJtsAlgorithmBoundaryNodeRule class]) {
    ComVividsolutionsJtsAlgorithmBoundaryNodeRule_MOD2_BOUNDARY_RULE_ = new_ComVividsolutionsJtsAlgorithmBoundaryNodeRule_Mod2BoundaryNodeRule_init();
    ComVividsolutionsJtsAlgorithmBoundaryNodeRule_ENDPOINT_BOUNDARY_RULE_ = new_ComVividsolutionsJtsAlgorithmBoundaryNodeRule_EndPointBoundaryNodeRule_init();
    ComVividsolutionsJtsAlgorithmBoundaryNodeRule_MULTIVALENT_ENDPOINT_BOUNDARY_RULE_ = new_ComVividsolutionsJtsAlgorithmBoundaryNodeRule_MultiValentEndPointBoundaryNodeRule_init();
    ComVividsolutionsJtsAlgorithmBoundaryNodeRule_MONOVALENT_ENDPOINT_BOUNDARY_RULE_ = new_ComVividsolutionsJtsAlgorithmBoundaryNodeRule_MonoValentEndPointBoundaryNodeRule_init();
    ComVividsolutionsJtsAlgorithmBoundaryNodeRule_OGC_SFS_BOUNDARY_RULE_ = ComVividsolutionsJtsAlgorithmBoundaryNodeRule_MOD2_BOUNDARY_RULE_;
