...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/com/vividsolutions/jts/geomgraph/PlanarGraph.java
//
...
- (void)addEdgesWithJavaUtilList:(id<JavaUtilList>)edgesToAdd {
  for (id<JavaUtilIterator> it = [((id<JavaUtilList>) nil_chk(edgesToAdd)) iterator]; [((id<JavaUtilIterator>) nil_chk(it)) hasNext]; ) {
    ...
    [((id<JavaUtilList>) nil_chk(edges_)) addWithId:e];
    ComVividsolutionsJtsGeomgraphDirectedEdge *de1 = new_ComVividsolutionsJtsGeomgraphDirectedEdge_initWithComVividsolutionsJtsGeomgraphEdge_withBoolean_(e, YES);
    ComVividsolutionsJtsGeomgraphDirectedEdge *de2 = new_ComVividsolutionsJtsGeomgraphDirectedEdge_initWithComVividsolutionsJtsGeomgraphEdge_withBoolean_(e, NO);
...
void ComVividsolutionsJtsGeomgraphPlanarGraph_initWithComVividsolutionsJtsGeomgraphNodeFactory_(ComVividsolutionsJtsGeomgraphPlanarGraph *self, ComVividsolutionsJtsGeomgraphNodeFactory *nodeFact) {
  ...
  self->edgeEndList_ = new_JavaUtilArrayList_init();
  self->nodes_ = new_ComVividsolutionsJtsGeomgraphNodeMap_initWithComVividsolutionsJtsGeomgraphNodeFactory_(nodeFact);
}
...
void ComVividsolutionsJtsGeomgraphPlanarGraph_init(ComVividsolutionsJtsGeomgraphPlanarGraph *self) {
  ...
  self->edges_ = new_JavaUtilArrayList_init();
  self->edgeEndList_ = new_JavaUtilArrayList_init();
  self->nodes_ = new_ComVividsolutionsJtsGeomgraphNodeMap_initWithComVividsolutionsJtsGeomgraphNodeFactory_(new_ComVividsolutionsJtsGeomgraphNodeFactory_init());
}
