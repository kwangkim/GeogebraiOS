...
- (ComVividsolutionsJtsGeomgraphIndexMonotoneChainEdge *)getMonotoneChainEdge {
  if (mce_ == nil) mce_ = new_ComVividsolutionsJtsGeomgraphIndexMonotoneChainEdge_initWithComVividsolutionsJtsGeomgraphEdge_(self);
  return mce_;
}
...
- (ComVividsolutionsJtsGeomgraphEdge *)getCollapsedEdge {
  IOSObjectArray *newPts = [IOSObjectArray newArrayWithLength:2 type:ComVividsolutionsJtsGeomCoordinate_class_()];
  (void) IOSObjectArray_Set(newPts, 0, IOSObjectArray_Get(nil_chk(pts_), 0));
  (void) IOSObjectArray_Set(newPts, 1, IOSObjectArray_Get(pts_, 1));
  ComVividsolutionsJtsGeomgraphEdge *newe = new_ComVividsolutionsJtsGeomgraphEdge_initWithComVividsolutionsJtsGeomCoordinateArray_withComVividsolutionsJtsGeomgraphLabel_(newPts, ComVividsolutionsJtsGeomgraphLabel_toLineLabelWithComVividsolutionsJtsGeomgraphLabel_(label_));
  return newe;
}
...
- (void)addIntersectionWithComVividsolutionsJtsAlgorithmLineIntersector:(ComVividsolutionsJtsAlgorithmLineIntersector *)li
  ...
  ComVividsolutionsJtsGeomCoordinate *intPt = new_ComVividsolutionsJtsGeomCoordinate_initWithComVividsolutionsJtsGeomCoordinate_([((ComVividsolutionsJtsAlgorithmLineIntersector *) nil_chk(li)) getIntersectionWithInt:intIndex]);
...
void ComVividsolutionsJtsGeomgraphEdge_initWithComVividsolutionsJtsGeomCoordinateArray_withComVividsolutionsJtsGeomgraphLabel_(ComVividsolutionsJtsGeomgraphEdge *self, IOSObjectArray *pts, ComVividsolutionsJtsGeomgraphLabel *label) {
  (void) ComVividsolutionsJtsGeomgraphGraphComponent_init(self);
  self->eiList_ = new_ComVividsolutionsJtsGeomgraphEdgeIntersectionList_initWithComVividsolutionsJtsGeomgraphEdge_(self);
  self->isIsolated__ = YES;
  self->depth_ = new_ComVividsolutionsJtsGeomgraphDepth_init();
  self->depthDelta_ = 0;
  self->pts_ = pts;
  self->label_ = label;
}
...
void ComVividsolutionsJtsGeomgraphEdge_initWithComVividsolutionsJtsGeomCoordinateArray_(ComVividsolutionsJtsGeomgraphEdge *self, IOSObjectArray *pts) {
  (void) ComVividsolutionsJtsGeomgraphEdge_initWithComVividsolutionsJtsGeomCoordinateArray_withComVividsolutionsJtsGeomgraphLabel_(self, pts, nil);
}
