...
- (ComVividsolutionsJtsGeomgraphEdgeIntersection *)addWithComVividsolutionsJtsGeomCoordinate:(ComVividsolutionsJtsGeomCoordinate *)intPt
  ...
  ComVividsolutionsJtsGeomgraphEdgeIntersection *eiNew = new_ComVividsolutionsJtsGeomgraphEdgeIntersection_initWithComVividsolutionsJtsGeomCoordinate_withInt_withDouble_(intPt, segmentIndex, dist);
...
- (void)addEndpoints {
  ...
  (void) [self addWithComVividsolutionsJtsGeomCoordinate:IOSObjectArray_Get(edge_->pts_, 0) withInt:0 withDouble:0.0];
  (void) [self addWithComVividsolutionsJtsGeomCoordinate:IOSObjectArray_Get(edge_->pts_, maxSegIndex) withInt:maxSegIndex withDouble:0.0];
}
...
- (ComVividsolutionsJtsGeomgraphEdge *)createSplitEdgeWithComVividsolutionsJtsGeomgraphEdgeIntersection:(ComVividsolutionsJtsGeomgraphEdgeIntersection *)ei0
  ...
  for (jint i = ei0->segmentIndex_ + 1; i <= ei1->segmentIndex_; i++) {
    (void) IOSObjectArray_Set(pts, ipt++, IOSObjectArray_Get(edge_->pts_, i));
  }
  if (useIntPt1) (void) IOSObjectArray_Set(pts, ipt, ei1->coord_);
  return new_ComVividsolutionsJtsGeomgraphEdge_initWithComVividsolutionsJtsGeomCoordinateArray_withComVividsolutionsJtsGeomgraphLabel_(pts, new_ComVividsolutionsJtsGeomgraphLabel_initWithComVividsolutionsJtsGeomgraphLabel_(edge_->label_));
}
