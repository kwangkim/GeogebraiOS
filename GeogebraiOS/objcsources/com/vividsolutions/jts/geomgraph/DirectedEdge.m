...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/com/vividsolutions/jts/geomgraph/DirectedEdge.java
//
...
- (void)setEdgeRingWithComVividsolutionsJtsGeomgraphEdgeRing:(ComVividsolutionsJtsGeomgraphEdgeRing *)edgeRing {
  ComVividsolutionsJtsGeomgraphDirectedEdge_set_edgeRing_(self, edgeRing);
}
...
- (void)setMinEdgeRingWithComVividsolutionsJtsGeomgraphEdgeRing:(ComVividsolutionsJtsGeomgraphEdgeRing *)minEdgeRing {
  ComVividsolutionsJtsGeomgraphDirectedEdge_set_minEdgeRing_(self, minEdgeRing);
}
...
- (void)setDepthWithInt:(jint)position
  ...
  if (IOSIntArray_Get(nil_chk(depth_), position) != -999) {
    if (IOSIntArray_Get(depth_, position) != depthVal) @throw [new_ComVividsolutionsJtsGeomTopologyException_initWithNSString_withComVividsolutionsJtsGeomCoordinate_(@"assigned depths do not match", [self getCoordinate]) autorelease];
  }
...
- (void)setSymWithComVividsolutionsJtsGeomgraphDirectedEdge:(ComVividsolutionsJtsGeomgraphDirectedEdge *)de {
  ComVividsolutionsJtsGeomgraphDirectedEdge_set_sym_(self, de);
}
...
- (void)setNextWithComVividsolutionsJtsGeomgraphDirectedEdge:(ComVividsolutionsJtsGeomgraphDirectedEdge *)next {
  ComVividsolutionsJtsGeomgraphDirectedEdge_set_next_(self, next);
}
...
- (void)setNextMinWithComVividsolutionsJtsGeomgraphDirectedEdge:(ComVividsolutionsJtsGeomgraphDirectedEdge *)nextMin {
  ComVividsolutionsJtsGeomgraphDirectedEdge_set_nextMin_(self, nextMin);
}
...
void ComVividsolutionsJtsGeomgraphDirectedEdge_initWithComVividsolutionsJtsGeomgraphEdge_withBoolean_(ComVividsolutionsJtsGeomgraphDirectedEdge *self, ComVividsolutionsJtsGeomgraphEdge *edge, jboolean isForward) {
  ...
  self->isVisited__ = NO;
  ComVividsolutionsJtsGeomgraphDirectedEdge_setAndConsume_depth_(self, [IOSIntArray newArrayWithInts:(jint[]){ 0, -999, -999 } count:3]);
...
void ComVividsolutionsJtsGeomgraphDirectedEdge_computeDirectedLabel(ComVividsolutionsJtsGeomgraphDirectedEdge *self) {
  ComVividsolutionsJtsGeomgraphEdgeEnd_setAndConsume_label_(self, new_ComVividsolutionsJtsGeomgraphLabel_initWithComVividsolutionsJtsGeomgraphLabel_([((ComVividsolutionsJtsGeomgraphEdge *) nil_chk(self->edge_)) getLabel]));
