...
void ComVividsolutionsJtsGeomgraphIndexMonotoneChainEdge_initWithComVividsolutionsJtsGeomgraphEdge_(ComVividsolutionsJtsGeomgraphIndexMonotoneChainEdge *self, ComVividsolutionsJtsGeomgraphEdge *e) {
  ...
  self->env1_ = new_ComVividsolutionsJtsGeomEnvelope_init();
  self->env2_ = new_ComVividsolutionsJtsGeomEnvelope_init();
  self->e_ = e;
  self->pts_ = [((ComVividsolutionsJtsGeomgraphEdge *) nil_chk(e)) getCoordinates];
  ComVividsolutionsJtsGeomgraphIndexMonotoneChainIndexer *mcb = new_ComVividsolutionsJtsGeomgraphIndexMonotoneChainIndexer_init();
  self->startIndex_ = [mcb getChainStartIndicesWithComVividsolutionsJtsGeomCoordinateArray:self->pts_];
}
