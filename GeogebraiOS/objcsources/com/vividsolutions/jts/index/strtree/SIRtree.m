...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/com/vividsolutions/jts/index/strtree/SIRtree.java
//
...
- (ComVividsolutionsJtsIndexStrtreeAbstractNode *)createNodeWithInt:(jint)level {
  return new_ComVividsolutionsJtsIndexStrtreeSIRtree_$3_initWithInt_(level);
}

- (void)insertWithDouble:(jdouble)x1
              withDouble:(jdouble)x2
                  withId:(id)item {
  [super insertWithId:new_ComVividsolutionsJtsIndexStrtreeInterval_initWithDouble_withDouble_(JavaLangMath_minWithDouble_withDouble_(x1, x2), JavaLangMath_maxWithDouble_withDouble_(x1, x2)) withId:item];
}
...
- (id<JavaUtilList>)queryWithDouble:(jdouble)x1
                         withDouble:(jdouble)x2 {
  return [super queryWithId:new_ComVividsolutionsJtsIndexStrtreeInterval_initWithDouble_withDouble_(JavaLangMath_minWithDouble_withDouble_(x1, x2), JavaLangMath_maxWithDouble_withDouble_(x1, x2))];
}
...
void ComVividsolutionsJtsIndexStrtreeSIRtree_init(ComVividsolutionsJtsIndexStrtreeSIRtree *self) {
  (void) ComVividsolutionsJtsIndexStrtreeSIRtree_initWithInt_(self, 10);
}
...
void ComVividsolutionsJtsIndexStrtreeSIRtree_initWithInt_(ComVividsolutionsJtsIndexStrtreeSIRtree *self, jint nodeCapacity) {
  ...
  self->comparator_ = new_ComVividsolutionsJtsIndexStrtreeSIRtree_$1_initWithComVividsolutionsJtsIndexStrtreeSIRtree_(self);
  self->intersectsOp_ = new_ComVividsolutionsJtsIndexStrtreeSIRtree_$2_init();
}
...
- (id)computeBounds {
  ...
  for (id<JavaUtilIterator> i = [((id<JavaUtilList>) nil_chk([self getChildBoundables])) iterator]; [((id<JavaUtilIterator>) nil_chk(i)) hasNext]; ) {
    ...
    if (bounds == nil) {
      bounds = new_ComVividsolutionsJtsIndexStrtreeInterval_initWithComVividsolutionsJtsIndexStrtreeInterval_((ComVividsolutionsJtsIndexStrtreeInterval *) check_class_cast([((id<ComVividsolutionsJtsIndexStrtreeBoundable>) nil_chk(childBoundable)) getBounds], [ComVividsolutionsJtsIndexStrtreeInterval class]));
    }
    else {
      (void) [bounds expandToIncludeWithComVividsolutionsJtsIndexStrtreeInterval:(ComVividsolutionsJtsIndexStrtreeInterval *) check_class_cast([((id<ComVividsolutionsJtsIndexStrtreeBoundable>) nil_chk(childBoundable)) getBounds], [ComVividsolutionsJtsIndexStrtreeInterval class])];
    }
  }
  return bounds;
}
