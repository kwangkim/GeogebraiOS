...
- (id<JavaUtilIterator>)iterator {
  id<JavaUtilList> foundItems = new_JavaUtilArrayList_init();
  (void) [((ComVividsolutionsJtsIndexBintreeRoot *) nil_chk(root_)) addAllItemsWithJavaUtilList:foundItems];
  return [foundItems iterator];
}

- (id<JavaUtilList>)queryWithDouble:(jdouble)x {
  return [self queryWithComVividsolutionsJtsIndexBintreeInterval:new_ComVividsolutionsJtsIndexBintreeInterval_initWithDouble_withDouble_(x, x)];
}
...
- (void)queryWithComVividsolutionsJtsIndexBintreeInterval:(ComVividsolutionsJtsIndexBintreeInterval *)interval
  ...
  (void) [((ComVividsolutionsJtsIndexBintreeRoot *) nil_chk(root_)) addAllItemsFromOverlappingWithComVividsolutionsJtsIndexBintreeInterval:interval withJavaUtilCollection:foundItems];
}
...
ComVividsolutionsJtsIndexBintreeInterval *ComVividsolutionsJtsIndexBintreeBintree_ensureExtentWithComVividsolutionsJtsIndexBintreeInterval_withDouble_(ComVividsolutionsJtsIndexBintreeInterval *itemInterval, jdouble minExtent) {
  ...
  return new_ComVividsolutionsJtsIndexBintreeInterval_initWithDouble_withDouble_(min, max);
}

void ComVividsolutionsJtsIndexBintreeBintree_init(ComVividsolutionsJtsIndexBintreeBintree *self) {
  (void) NSObject_init(self);
  self->minExtent_ = 1.0;
  self->root_ = new_ComVividsolutionsJtsIndexBintreeRoot_init();
}
