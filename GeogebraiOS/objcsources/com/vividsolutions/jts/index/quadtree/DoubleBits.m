...
jdouble ComVividsolutionsJtsIndexQuadtreeDoubleBits_powerOf2WithInt_(jint exp) {
  ...
  if (exp > 1023 || exp < -1022) @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"Exponent out of bounds");
...
jint ComVividsolutionsJtsIndexQuadtreeDoubleBits_exponentWithDouble_(jdouble d) {
  ComVividsolutionsJtsIndexQuadtreeDoubleBits_initialize();
  ComVividsolutionsJtsIndexQuadtreeDoubleBits *db = new_ComVividsolutionsJtsIndexQuadtreeDoubleBits_initWithDouble_(d);
...
jdouble ComVividsolutionsJtsIndexQuadtreeDoubleBits_maximumCommonMantissaWithDouble_withDouble_(jdouble d1, jdouble d2) {
  ...
  ComVividsolutionsJtsIndexQuadtreeDoubleBits *db1 = new_ComVividsolutionsJtsIndexQuadtreeDoubleBits_initWithDouble_(d1);
  ComVividsolutionsJtsIndexQuadtreeDoubleBits *db2 = new_ComVividsolutionsJtsIndexQuadtreeDoubleBits_initWithDouble_(d2);
