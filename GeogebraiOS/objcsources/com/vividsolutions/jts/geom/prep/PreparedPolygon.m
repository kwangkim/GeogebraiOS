...
- (id<ComVividsolutionsJtsAlgorithmLocatePointOnGeometryLocator>)getPointLocator {
  if (pia_ == nil) pia_ = new_ComVividsolutionsJtsAlgorithmLocateIndexedPointInAreaLocator_initWithComVividsolutionsJtsGeomGeometry_([self getGeometry]);
  return pia_;
}
...
void ComVividsolutionsJtsGeomPrepPreparedPolygon_initWithComVividsolutionsJtsGeomPolygonal_(ComVividsolutionsJtsGeomPrepPreparedPolygon *self, id<ComVividsolutionsJtsGeomPolygonal> poly) {
  (void) ComVividsolutionsJtsGeomPrepBasicPreparedGeometry_initWithComVividsolutionsJtsGeomGeometry_(self, (ComVividsolutionsJtsGeomGeometry *) check_class_cast(poly, [ComVividsolutionsJtsGeomGeometry class]));
