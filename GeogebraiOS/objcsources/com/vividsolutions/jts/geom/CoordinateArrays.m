...
+ (void)initialize {
  if (self == [ComVividsolutionsJtsGeomCoordinateArrays class]) {
    ComVividsolutionsJtsGeomCoordinateArrays_coordArrayType_ = [IOSObjectArray newArrayWithLength:0 type:ComVividsolutionsJtsGeomCoordinate_class_()];
...
IOSObjectArray *ComVividsolutionsJtsGeomCoordinateArrays_copyDeepWithComVividsolutionsJtsGeomCoordinateArray_(IOSObjectArray *coordinates) {
  ComVividsolutionsJtsGeomCoordinateArrays_initialize();
  IOSObjectArray *copy_ = [IOSObjectArray newArrayWithLength:((IOSObjectArray *) nil_chk(coordinates))->size_ type:ComVividsolutionsJtsGeomCoordinate_class_()];
  for (jint i = 0; i < coordinates->size_; i++) {
    (void) IOSObjectArray_Set(copy_, i, new_ComVividsolutionsJtsGeomCoordinate_initWithComVividsolutionsJtsGeomCoordinate_(IOSObjectArray_Get(coordinates, i)));
  }
  return copy_;
}
...
IOSObjectArray *ComVividsolutionsJtsGeomCoordinateArrays_atLeastNCoordinatesOrNothingWithInt_withComVividsolutionsJtsGeomCoordinateArray_(jint n, IOSObjectArray *c) {
  ComVividsolutionsJtsGeomCoordinateArrays_initialize();
  return ((IOSObjectArray *) nil_chk(c))->size_ >= n ? c : [IOSObjectArray newArrayWithObjects:(id[]){  } count:0 type:ComVividsolutionsJtsGeomCoordinate_class_()];
}
...
IOSObjectArray *ComVividsolutionsJtsGeomCoordinateArrays_removeRepeatedPointsWithComVividsolutionsJtsGeomCoordinateArray_(IOSObjectArray *coord) {
  ...
  ComVividsolutionsJtsGeomCoordinateList *coordList = new_ComVividsolutionsJtsGeomCoordinateList_initWithComVividsolutionsJtsGeomCoordinateArray_withBoolean_(coord, NO);
...
void ComVividsolutionsJtsGeomCoordinateArrays_reverseWithComVividsolutionsJtsGeomCoordinateArray_(IOSObjectArray *coord) {
  ...
  for (jint i = 0; i <= mid; i++) {
    ...
    (void) IOSObjectArray_Set(coord, i, IOSObjectArray_Get(coord, last - i));
    (void) IOSObjectArray_Set(coord, last - i, tmp);
  }
}
...
void ComVividsolutionsJtsGeomCoordinateArrays_scrollWithComVividsolutionsJtsGeomCoordinateArray_withComVividsolutionsJtsGeomCoordinate_(IOSObjectArray *coordinates, ComVividsolutionsJtsGeomCoordinate *firstCoordinate) {
  ...
  if (i < 0) return;
  IOSObjectArray *newCoordinates = [IOSObjectArray newArrayWithLength:((IOSObjectArray *) nil_chk(coordinates))->size_ type:ComVividsolutionsJtsGeomCoordinate_class_()];
...
IOSObjectArray *ComVividsolutionsJtsGeomCoordinateArrays_extractWithComVividsolutionsJtsGeomCoordinateArray_withInt_withInt_(IOSObjectArray *pts, jint start, jint end) {
  ...
  IOSObjectArray *extractPts = [IOSObjectArray newArrayWithLength:len type:ComVividsolutionsJtsGeomCoordinate_class_()];
  jint iPts = 0;
  for (jint i = start; i <= end; i++) {
    (void) IOSObjectArray_Set(extractPts, iPts++, IOSObjectArray_Get(nil_chk(pts), i));
  }
  return extractPts;
}
