...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/com/vividsolutions/jts/geom/impl/CoordinateArraySequence.java
//
...
- (id)clone {
  ...
  return new_ComVividsolutionsJtsGeomImplCoordinateArraySequence_initWithComVividsolutionsJtsGeomCoordinateArray_(cloneCoordinates);
}
...
- (void)setOrdinateWithInt:(jint)index
  ...
  switch (ordinateIndex) {
    ...
    break;
    default:
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"invalid ordinateIndex");
  }
}
...
void ComVividsolutionsJtsGeomImplCoordinateArraySequence_initWithComVividsolutionsJtsGeomCoordinateArray_(ComVividsolutionsJtsGeomImplCoordinateArraySequence *self, IOSObjectArray *coordinates) {
  ...
  if (coordinates == nil) self->coordinates_ = [IOSObjectArray newArrayWithLength:0 type:ComVividsolutionsJtsGeomCoordinate_class_()];
}
...
void ComVividsolutionsJtsGeomImplCoordinateArraySequence_initWithComVividsolutionsJtsGeomCoordinateSequence_(ComVividsolutionsJtsGeomImplCoordinateArraySequence *self, id<ComVividsolutionsJtsGeomCoordinateSequence> coordSeq) {
  (void) NSObject_init(self);
  if (coordSeq != nil) self->coordinates_ = [IOSObjectArray newArrayWithLength:[coordSeq size] type:ComVividsolutionsJtsGeomCoordinate_class_()];
  else self->coordinates_ = [IOSObjectArray newArrayWithLength:0 type:ComVividsolutionsJtsGeomCoordinate_class_()];
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(self->coordinates_))->size_; i++) {
    (void) IOSObjectArray_Set(self->coordinates_, i, [((id<ComVividsolutionsJtsGeomCoordinateSequence>) nil_chk(coordSeq)) getCoordinateCopyWithInt:i]);
  }
}
