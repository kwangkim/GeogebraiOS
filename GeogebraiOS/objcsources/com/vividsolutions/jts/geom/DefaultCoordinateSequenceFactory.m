...
- (id<ComVividsolutionsJtsGeomCoordinateSequence>)createWithComVividsolutionsJtsGeomCoordinateArray:(IOSObjectArray *)coordinates {
  return new_ComVividsolutionsJtsGeomDefaultCoordinateSequence_initWithComVividsolutionsJtsGeomCoordinateArray_(coordinates);
}
...
- (id<ComVividsolutionsJtsGeomCoordinateSequence>)createWithComVividsolutionsJtsGeomCoordinateSequence:(id<ComVividsolutionsJtsGeomCoordinateSequence>)coordSeq {
  return new_ComVividsolutionsJtsGeomDefaultCoordinateSequence_initWithComVividsolutionsJtsGeomCoordinateSequence_(coordSeq);
}

- (id<ComVividsolutionsJtsGeomCoordinateSequence>)createWithInt:(jint)size
                                                        withInt:(jint)dimension {
  return new_ComVividsolutionsJtsGeomDefaultCoordinateSequence_initWithInt_(size);
}

+ (void)initialize {
  if (self == [ComVividsolutionsJtsGeomDefaultCoordinateSequenceFactory class]) {
    ComVividsolutionsJtsGeomDefaultCoordinateSequenceFactory_instanceObject_ = new_ComVividsolutionsJtsGeomDefaultCoordinateSequenceFactory_init();
