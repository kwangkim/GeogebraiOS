...
- (ComVividsolutionsJtsGeomEnvelope *)computeEnvelopeInternal {
  ...
  return [((id<ComVividsolutionsJtsGeomCoordinateSequence>) nil_chk(points_)) expandEnvelopeWithComVividsolutionsJtsGeomEnvelope:new_ComVividsolutionsJtsGeomEnvelope_init()];
}
...
- (id)clone {
  ...
  ((ComVividsolutionsJtsGeomLineString *) nil_chk(ls))->points_ = (id<ComVividsolutionsJtsGeomCoordinateSequence>) check_protocol_cast([((id<ComVividsolutionsJtsGeomCoordinateSequence>) nil_chk(points_)) clone], @protocol(ComVividsolutionsJtsGeomCoordinateSequence));
  return ls;
}
...
void ComVividsolutionsJtsGeomLineString_init__WithComVividsolutionsJtsGeomCoordinateSequence_(ComVividsolutionsJtsGeomLineString *self, id<ComVividsolutionsJtsGeomCoordinateSequence> points) {
  if (points == nil) {
    points = [((id<ComVividsolutionsJtsGeomCoordinateSequenceFactory>) nil_chk([((ComVividsolutionsJtsGeomGeometryFactory *) nil_chk([self getFactory])) getCoordinateSequenceFactory])) createWithComVividsolutionsJtsGeomCoordinateArray:[IOSObjectArray newArrayWithObjects:(id[]){  } count:0 type:ComVividsolutionsJtsGeomCoordinate_class_()]];
  }
  if ([((id<ComVividsolutionsJtsGeomCoordinateSequence>) nil_chk(points)) size] == 1) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$I$", @"Invalid number of points in LineString (found ", [points size], @" - must be 0 or >= 2)"));
  }
  self->points_ = points;
}
