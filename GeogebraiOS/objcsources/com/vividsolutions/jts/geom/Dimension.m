...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/com/vividsolutions/jts/geom/Dimension.java
//
...
jchar ComVividsolutionsJtsGeomDimension_toDimensionSymbolWithInt_(jint dimensionValue) {
  ...
  @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$I", @"Unknown dimension value: ", dimensionValue));
}
...
jint ComVividsolutionsJtsGeomDimension_toDimensionValueWithChar_(jchar dimensionSymbol) {
  ...
  @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$C", @"Unknown dimension symbol: ", dimensionSymbol));
}
