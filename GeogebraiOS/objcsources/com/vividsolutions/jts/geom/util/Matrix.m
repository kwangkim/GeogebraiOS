...
IOSDoubleArray *ComVividsolutionsJtsGeomUtilMatrix_solveWithDoubleArray2_withDoubleArray_(IOSObjectArray *a, IOSDoubleArray *b) {
  ...
  if (((IOSObjectArray *) nil_chk(a))->size_ != n || ((IOSDoubleArray *) nil_chk(IOSObjectArray_Get(a, 0)))->size_ != n) @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"Matrix A is incorrectly sized");
  for (jint i = 0; i < n; i++) {
  ...
  IOSDoubleArray *solution = [IOSDoubleArray newArrayWithLength:n];
