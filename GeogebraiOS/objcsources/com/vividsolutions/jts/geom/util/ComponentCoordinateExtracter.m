...
id<JavaUtilList> ComVividsolutionsJtsGeomUtilComponentCoordinateExtracter_getCoordinatesWithComVividsolutionsJtsGeomGeometry_(ComVividsolutionsJtsGeomGeometry *geom) {
  ...
  id<JavaUtilList> coords = new_JavaUtilArrayList_init();
  [((ComVividsolutionsJtsGeomGeometry *) nil_chk(geom)) applyWithComVividsolutionsJtsGeomGeometryComponentFilter:new_ComVividsolutionsJtsGeomUtilComponentCoordinateExtracter_initWithJavaUtilList_(coords)];
  return coords;
}
