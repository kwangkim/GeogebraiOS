...
void ComVividsolutionsJtsGeomTopologyException_initWithNSString_withComVividsolutionsJtsGeomCoordinate_(ComVividsolutionsJtsGeomTopologyException *self, NSString *msg, ComVividsolutionsJtsGeomCoordinate *pt) {
  (void) JavaLangRuntimeException_initWithNSString_(self, ComVividsolutionsJtsGeomTopologyException_msgWithCoordWithNSString_withComVividsolutionsJtsGeomCoordinate_(msg, pt));
  self->pt_ = nil;
  self->pt_ = new_ComVividsolutionsJtsGeomCoordinate_initWithComVividsolutionsJtsGeomCoordinate_(pt);
}
