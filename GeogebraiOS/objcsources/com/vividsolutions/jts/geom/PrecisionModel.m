...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/com/vividsolutions/jts/geom/PrecisionModel.java
//
...
- (ComVividsolutionsJtsGeomCoordinate *)toInternalWithComVividsolutionsJtsGeomCoordinate:(ComVividsolutionsJtsGeomCoordinate *)external {
  ComVividsolutionsJtsGeomCoordinate *internal = new_ComVividsolutionsJtsGeomCoordinate_initWithComVividsolutionsJtsGeomCoordinate_(external);
...
- (ComVividsolutionsJtsGeomCoordinate *)toExternalWithComVividsolutionsJtsGeomCoordinate:(ComVividsolutionsJtsGeomCoordinate *)internal {
  ComVividsolutionsJtsGeomCoordinate *external = new_ComVividsolutionsJtsGeomCoordinate_initWithComVividsolutionsJtsGeomCoordinate_(internal);
  return external;
}
...
- (jint)compareToWithId:(id)o {
  ...
  return [(new_JavaLangInteger_initWithInt_(sigDigits)) compareToWithId:new_JavaLangInteger_initWithInt_(otherSigDigits)];
}

+ (void)initialize {
  if (self == [ComVividsolutionsJtsGeomPrecisionModel class]) {
    ComVividsolutionsJtsGeomPrecisionModel_FIXED_ = new_ComVividsolutionsJtsGeomPrecisionModel_Type_initWithNSString_(@"FIXED");
    ComVividsolutionsJtsGeomPrecisionModel_FLOATING_ = new_ComVividsolutionsJtsGeomPrecisionModel_Type_initWithNSString_(@"FLOATING");
    ComVividsolutionsJtsGeomPrecisionModel_FLOATING_SINGLE_ = new_ComVividsolutionsJtsGeomPrecisionModel_Type_initWithNSString_(@"FLOATING SINGLE");
...
void ComVividsolutionsJtsGeomPrecisionModel_init(ComVividsolutionsJtsGeomPrecisionModel *self) {
  ...
  self->modelType_ = ComVividsolutionsJtsGeomPrecisionModel_FLOATING_;
}
...
void ComVividsolutionsJtsGeomPrecisionModel_initWithDouble_withDouble_withDouble_(ComVividsolutionsJtsGeomPrecisionModel *self, jdouble scale_, jdouble offsetX, jdouble offsetY) {
  (void) NSObject_init(self);
  self->modelType_ = ComVividsolutionsJtsGeomPrecisionModel_FIXED_;
  ComVividsolutionsJtsGeomPrecisionModel_setScaleWithDouble_(self, scale_);
}
...
void ComVividsolutionsJtsGeomPrecisionModel_initWithComVividsolutionsJtsGeomPrecisionModel_(ComVividsolutionsJtsGeomPrecisionModel *self, ComVividsolutionsJtsGeomPrecisionModel *pm) {
  (void) NSObject_init(self);
  self->modelType_ = ((ComVividsolutionsJtsGeomPrecisionModel *) nil_chk(pm))->modelType_;
...
+ (void)initialize {
  if (self == [ComVividsolutionsJtsGeomPrecisionModel_Type class]) {
    ComVividsolutionsJtsGeomPrecisionModel_Type_nameToTypeMap_ = new_JavaUtilHashMap_init();
...
void ComVividsolutionsJtsGeomPrecisionModel_Type_initWithNSString_(ComVividsolutionsJtsGeomPrecisionModel_Type *self, NSString *name) {
  (void) NSObject_init(self);
  self->name_ = name;
  (void) [((id<JavaUtilMap>) nil_chk(ComVividsolutionsJtsGeomPrecisionModel_Type_nameToTypeMap_)) putWithId:name withId:self];
}
