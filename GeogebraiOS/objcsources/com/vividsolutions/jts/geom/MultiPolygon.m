...
- (ComVividsolutionsJtsGeomGeometry *)getBoundary {
  ...
  JavaUtilArrayList *allRings = new_JavaUtilArrayList_init();
  ...
  IOSObjectArray *allRingsArray = [IOSObjectArray newArrayWithLength:[allRings size] type:ComVividsolutionsJtsGeomLineString_class_()];
...
- (ComVividsolutionsJtsGeomGeometry *)reverse {
  ...
  IOSObjectArray *revGeoms = [IOSObjectArray newArrayWithLength:n type:ComVividsolutionsJtsGeomPolygon_class_()];
  for (jint i = 0; i < geometries_->size_; i++) {
    (void) IOSObjectArray_Set(revGeoms, i, (ComVividsolutionsJtsGeomPolygon *) check_class_cast([((ComVividsolutionsJtsGeomGeometry *) nil_chk(IOSObjectArray_Get(geometries_, i))) reverse], [ComVividsolutionsJtsGeomPolygon class]));
  }
...
void ComVividsolutionsJtsGeomMultiPolygon_initWithComVividsolutionsJtsGeomPolygonArray_withComVividsolutionsJtsGeomPrecisionModel_withInt_(ComVividsolutionsJtsGeomMultiPolygon *self, IOSObjectArray *polygons, ComVividsolutionsJtsGeomPrecisionModel *precisionModel, jint SRID) {
  (void) ComVividsolutionsJtsGeomMultiPolygon_initWithComVividsolutionsJtsGeomPolygonArray_withComVividsolutionsJtsGeomGeometryFactory_(self, polygons, new_ComVividsolutionsJtsGeomGeometryFactory_initWithComVividsolutionsJtsGeomPrecisionModel_withInt_(precisionModel, SRID));
}
...
void ComVividsolutionsJtsGeomMultiPolygon_initWithComVividsolutionsJtsGeomPolygonArray_withComVividsolutionsJtsGeomGeometryFactory_(ComVividsolutionsJtsGeomMultiPolygon *self, IOSObjectArray *polygons, ComVividsolutionsJtsGeomGeometryFactory *factory) {
  (void) ComVividsolutionsJtsGeomGeometryCollection_initWithComVividsolutionsJtsGeomGeometryArray_withComVividsolutionsJtsGeomGeometryFactory_(self, polygons, factory);
}
