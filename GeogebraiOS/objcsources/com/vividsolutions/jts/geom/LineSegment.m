...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/com/vividsolutions/jts/geom/LineSegment.java
//
...
- (ComVividsolutionsJtsGeomCoordinate *)midPoint {
  return new_ComVividsolutionsJtsGeomCoordinate_initWithDouble_withDouble_((((ComVividsolutionsJtsGeomCoordinate *) nil_chk(p0_))->x_ + ((ComVividsolutionsJtsGeomCoordinate *) nil_chk(p1_))->x_) / 2, (p0_->y_ + p1_->y_) / 2);
}
...
- (ComVividsolutionsJtsGeomCoordinate *)pointAlongWithDouble:(jdouble)segmentLengthFraction {
  ComVividsolutionsJtsGeomCoordinate *coord = new_ComVividsolutionsJtsGeomCoordinate_init();
...
- (ComVividsolutionsJtsGeomCoordinate *)pointAlongOffsetWithDouble:(jdouble)segmentLengthFraction
  ...
  ComVividsolutionsJtsGeomCoordinate *coord = new_ComVividsolutionsJtsGeomCoordinate_initWithDouble_withDouble_(offsetx, offsety);
  return coord;
}
...
- (ComVividsolutionsJtsGeomCoordinate *)projectWithComVividsolutionsJtsGeomCoordinate:(ComVividsolutionsJtsGeomCoordinate *)p {
  if ([((ComVividsolutionsJtsGeomCoordinate *) nil_chk(p)) isEqual:p0_] || [p isEqual:p1_]) return new_ComVividsolutionsJtsGeomCoordinate_initWithComVividsolutionsJtsGeomCoordinate_(p);
...
- (ComVividsolutionsJtsGeomLineSegment *)projectWithComVividsolutionsJtsGeomLineSegment:(ComVividsolutionsJtsGeomLineSegment *)seg {
  ...
  return new_ComVividsolutionsJtsGeomLineSegment_initWithComVividsolutionsJtsGeomCoordinate_withComVividsolutionsJtsGeomCoordinate_(newp0, newp1);
}
...
- (IOSObjectArray *)closestPointsWithComVividsolutionsJtsGeomLineSegment:(ComVividsolutionsJtsGeomLineSegment *)line {
  ...
  if (intPt != nil) {
    return [IOSObjectArray newArrayWithObjects:(id[]){ intPt, intPt } count:2 type:ComVividsolutionsJtsGeomCoordinate_class_()];
  }
  IOSObjectArray *closestPt = [IOSObjectArray newArrayWithLength:2 type:ComVividsolutionsJtsGeomCoordinate_class_()];
  ...
  (void) IOSObjectArray_Set(closestPt, 0, close00);
  (void) IOSObjectArray_Set(closestPt, 1, line->p0_);
  ...
  if (dist < minDistance) {
    minDistance = dist;
    (void) IOSObjectArray_Set(closestPt, 0, close01);
    (void) IOSObjectArray_Set(closestPt, 1, line->p1_);
  }
  ...
  if (dist < minDistance) {
    minDistance = dist;
    (void) IOSObjectArray_Set(closestPt, 0, p0_);
    (void) IOSObjectArray_Set(closestPt, 1, close10);
  }
  ...
  if (dist < minDistance) {
    minDistance = dist;
    (void) IOSObjectArray_Set(closestPt, 0, p1_);
    (void) IOSObjectArray_Set(closestPt, 1, close11);
  }
  return closestPt;
}
...
- (ComVividsolutionsJtsGeomLineString *)toGeometryWithComVividsolutionsJtsGeomGeometryFactory:(ComVividsolutionsJtsGeomGeometryFactory *)geomFactory {
  return [((ComVividsolutionsJtsGeomGeometryFactory *) nil_chk(geomFactory)) createLineStringWithComVividsolutionsJtsGeomCoordinateArray:[IOSObjectArray newArrayWithObjects:(id[]){ p0_, p1_ } count:2 type:ComVividsolutionsJtsGeomCoordinate_class_()]];
}
...
void ComVividsolutionsJtsGeomLineSegment_initWithDouble_withDouble_withDouble_withDouble_(ComVividsolutionsJtsGeomLineSegment *self, jdouble x0, jdouble y0, jdouble x1, jdouble y1) {
  (void) ComVividsolutionsJtsGeomLineSegment_initWithComVividsolutionsJtsGeomCoordinate_withComVividsolutionsJtsGeomCoordinate_(self, new_ComVividsolutionsJtsGeomCoordinate_initWithDouble_withDouble_(x0, y0), new_ComVividsolutionsJtsGeomCoordinate_initWithDouble_withDouble_(x1, y1));
}
...
void ComVividsolutionsJtsGeomLineSegment_initWithComVividsolutionsJtsGeomLineSegment_(ComVividsolutionsJtsGeomLineSegment *self, ComVividsolutionsJtsGeomLineSegment *ls) {
  (void) ComVividsolutionsJtsGeomLineSegment_initWithComVividsolutionsJtsGeomCoordinate_withComVividsolutionsJtsGeomCoordinate_(self, ((ComVividsolutionsJtsGeomLineSegment *) nil_chk(ls))->p0_, ls->p1_);
}
...
void ComVividsolutionsJtsGeomLineSegment_init(ComVividsolutionsJtsGeomLineSegment *self) {
  (void) ComVividsolutionsJtsGeomLineSegment_initWithComVividsolutionsJtsGeomCoordinate_withComVividsolutionsJtsGeomCoordinate_(self, new_ComVividsolutionsJtsGeomCoordinate_init(), new_ComVividsolutionsJtsGeomCoordinate_init());
}
