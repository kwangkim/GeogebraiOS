...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/com/vividsolutions/jts/precision/SimpleGeometryPrecisionReducer.java
//
...
- (ComVividsolutionsJtsGeomGeometry *)reduceWithComVividsolutionsJtsGeomGeometry:(ComVividsolutionsJtsGeomGeometry *)geom {
  ...
  if (changePrecisionModel_) {
    ComVividsolutionsJtsGeomGeometryFactory *newFactory = new_ComVividsolutionsJtsGeomGeometryFactory_initWithComVividsolutionsJtsGeomPrecisionModel_withInt_(newPrecisionModel_, [((ComVividsolutionsJtsGeomGeometryFactory *) nil_chk([((ComVividsolutionsJtsGeomGeometry *) nil_chk(geom)) getFactory])) getSRID]);
    geomEdit = new_ComVividsolutionsJtsGeomUtilGeometryEditor_initWithComVividsolutionsJtsGeomGeometryFactory_(newFactory);
  }
  else geomEdit = new_ComVividsolutionsJtsGeomUtilGeometryEditor_init();
...
ComVividsolutionsJtsGeomGeometry *ComVividsolutionsJtsPrecisionSimpleGeometryPrecisionReducer_reduceWithComVividsolutionsJtsGeomGeometry_withComVividsolutionsJtsGeomPrecisionModel_(ComVividsolutionsJtsGeomGeometry *g, ComVividsolutionsJtsGeomPrecisionModel *precModel) {
  ...
  ComVividsolutionsJtsPrecisionSimpleGeometryPrecisionReducer *reducer = new_ComVividsolutionsJtsPrecisionSimpleGeometryPrecisionReducer_initWithComVividsolutionsJtsGeomPrecisionModel_(precModel);
...
- (IOSObjectArray *)editWithComVividsolutionsJtsGeomCoordinateArray:(IOSObjectArray *)coordinates
  ...
  IOSObjectArray *reducedCoords = [IOSObjectArray newArrayWithLength:coordinates->size_ type:ComVividsolutionsJtsGeomCoordinate_class_()];
  for (jint i = 0; i < coordinates->size_; i++) {
    ComVividsolutionsJtsGeomCoordinate *coord = new_ComVividsolutionsJtsGeomCoordinate_initWithComVividsolutionsJtsGeomCoordinate_(IOSObjectArray_Get(coordinates, i));
    ...
    (void) IOSObjectArray_Set(reducedCoords, i, coord);
  }
  ComVividsolutionsJtsGeomCoordinateList *noRepeatedCoordList = new_ComVividsolutionsJtsGeomCoordinateList_initWithComVividsolutionsJtsGeomCoordinateArray_withBoolean_(reducedCoords, NO);
