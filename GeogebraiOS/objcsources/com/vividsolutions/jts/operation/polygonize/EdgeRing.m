...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/com/vividsolutions/jts/operation/polygonize/EdgeRing.java
//
...
- (void)addHoleWithComVividsolutionsJtsGeomLinearRing:(ComVividsolutionsJtsGeomLinearRing *)hole {
  if (holes_ == nil) ComVividsolutionsJtsOperationPolygonizeEdgeRing_setAndConsume_holes_(self, new_JavaUtilArrayList_init());
...
- (ComVividsolutionsJtsGeomPolygon *)getPolygon {
  ...
  if (holes_ != nil) {
    holeLR = [IOSObjectArray arrayWithLength:[holes_ size] type:ComVividsolutionsJtsGeomLinearRing_class_()];
    for (jint i = 0; i < [holes_ size]; i++) {
      IOSObjectArray_Set(holeLR, i, (ComVividsolutionsJtsGeomLinearRing *) check_class_cast([holes_ getWithInt:i], [ComVividsolutionsJtsGeomLinearRing class]));
    }
  }
...
- (jboolean)isValid {
  ComVividsolutionsJtsOperationPolygonizeEdgeRing_getCoordinates(self);
...
- (ComVividsolutionsJtsGeomLinearRing *)getRing {
  ...
  @try {
    ComVividsolutionsJtsOperationPolygonizeEdgeRing_set_ring_(self, [((ComVividsolutionsJtsGeomGeometryFactory *) nil_chk(factory_)) createLinearRingWithComVividsolutionsJtsGeomCoordinateArray:ringPts_]);
  }
...
void ComVividsolutionsJtsOperationPolygonizeEdgeRing_initWithComVividsolutionsJtsGeomGeometryFactory_(ComVividsolutionsJtsOperationPolygonizeEdgeRing *self, ComVividsolutionsJtsGeomGeometryFactory *factory) {
  NSObject_init(self);
  ComVividsolutionsJtsOperationPolygonizeEdgeRing_setAndConsume_deList_(self, new_JavaUtilArrayList_init());
  ComVividsolutionsJtsOperationPolygonizeEdgeRing_set_ring_(self, nil);
  ComVividsolutionsJtsOperationPolygonizeEdgeRing_set_ringPts_(self, nil);
  ComVividsolutionsJtsOperationPolygonizeEdgeRing_set_factory_(self, factory);
}
...
IOSObjectArray *ComVividsolutionsJtsOperationPolygonizeEdgeRing_getCoordinates(ComVividsolutionsJtsOperationPolygonizeEdgeRing *self) {
  if (self->ringPts_ == nil) {
    ...
    ComVividsolutionsJtsOperationPolygonizeEdgeRing_set_ringPts_(self, [coordList toCoordinateArray]);
  }
