...
ComVividsolutionsJtsGeomGeometry *ComVividsolutionsJtsOperationUnionUnaryUnionOp_union__WithJavaUtilCollection_(id<JavaUtilCollection> geoms) {
  ...
  ComVividsolutionsJtsOperationUnionUnaryUnionOp *op = new_ComVividsolutionsJtsOperationUnionUnaryUnionOp_initWithJavaUtilCollection_(geoms);
  return [op union__];
}
...
ComVividsolutionsJtsGeomGeometry *ComVividsolutionsJtsOperationUnionUnaryUnionOp_union__WithJavaUtilCollection_withComVividsolutionsJtsGeomGeometryFactory_(id<JavaUtilCollection> geoms, ComVividsolutionsJtsGeomGeometryFactory *geomFact) {
  ComVividsolutionsJtsOperationUnionUnaryUnionOp_initialize();
  ComVividsolutionsJtsOperationUnionUnaryUnionOp *op = new_ComVividsolutionsJtsOperationUnionUnaryUnionOp_initWithJavaUtilCollection_withComVividsolutionsJtsGeomGeometryFactory_(geoms, geomFact);
  return [op union__];
}
...
ComVividsolutionsJtsGeomGeometry *ComVividsolutionsJtsOperationUnionUnaryUnionOp_union__WithComVividsolutionsJtsGeomGeometry_(ComVividsolutionsJtsGeomGeometry *geom) {
  ComVividsolutionsJtsOperationUnionUnaryUnionOp_initialize();
  ComVividsolutionsJtsOperationUnionUnaryUnionOp *op = new_ComVividsolutionsJtsOperationUnionUnaryUnionOp_initWithComVividsolutionsJtsGeomGeometry_(geom);
  return [op union__];
}
...
void ComVividsolutionsJtsOperationUnionUnaryUnionOp_initWithJavaUtilCollection_withComVividsolutionsJtsGeomGeometryFactory_(ComVividsolutionsJtsOperationUnionUnaryUnionOp *self, id<JavaUtilCollection> geoms, ComVividsolutionsJtsGeomGeometryFactory *geomFact) {
  ...
  self->polygons_ = new_JavaUtilArrayList_init();
...
void ComVividsolutionsJtsOperationUnionUnaryUnionOp_extractWithComVividsolutionsJtsGeomGeometry_(ComVividsolutionsJtsOperationUnionUnaryUnionOp *self, ComVividsolutionsJtsGeomGeometry *geom) {
  if (self->geomFact_ == nil) self->geomFact_ = [((ComVividsolutionsJtsGeomGeometry *) nil_chk(geom)) getFactory];
  (void) ComVividsolutionsJtsGeomUtilGeometryExtracter_extractWithComVividsolutionsJtsGeomGeometry_withIOSClass_withJavaUtilList_(geom, ComVividsolutionsJtsGeomPolygon_class_(), self->polygons_);
  (void) ComVividsolutionsJtsGeomUtilGeometryExtracter_extractWithComVividsolutionsJtsGeomGeometry_withIOSClass_withJavaUtilList_(geom, ComVividsolutionsJtsGeomLineString_class_(), self->lines_);
  (void) ComVividsolutionsJtsGeomUtilGeometryExtracter_extractWithComVividsolutionsJtsGeomGeometry_withIOSClass_withJavaUtilList_(geom, ComVividsolutionsJtsGeomPoint_class_(), self->points_);
}
