...
jboolean ComVividsolutionsJtsOperationOverlayValidateOverlayResultValidator_isValidWithComVividsolutionsJtsGeomGeometry_withComVividsolutionsJtsGeomGeometry_withInt_withComVividsolutionsJtsGeomGeometry_(ComVividsolutionsJtsGeomGeometry *a, ComVividsolutionsJtsGeomGeometry *b, jint overlayOp, ComVividsolutionsJtsGeomGeometry *result) {
  ...
  ComVividsolutionsJtsOperationOverlayValidateOverlayResultValidator *validator = new_ComVividsolutionsJtsOperationOverlayValidateOverlayResultValidator_initWithComVividsolutionsJtsGeomGeometry_withComVividsolutionsJtsGeomGeometry_withComVividsolutionsJtsGeomGeometry_(a, b, result);
...
void ComVividsolutionsJtsOperationOverlayValidateOverlayResultValidator_initWithComVividsolutionsJtsGeomGeometry_withComVividsolutionsJtsGeomGeometry_withComVividsolutionsJtsGeomGeometry_(ComVividsolutionsJtsOperationOverlayValidateOverlayResultValidator *self, ComVividsolutionsJtsGeomGeometry *a, ComVividsolutionsJtsGeomGeometry *b, ComVividsolutionsJtsGeomGeometry *result) {
  ...
  self->location_ = [IOSIntArray newArrayWithLength:3];
  self->invalidLocation_ = nil;
  self->boundaryDistanceTolerance_ = ComVividsolutionsJtsOperationOverlayValidateOverlayResultValidator_TOLERANCE;
  self->testCoords_ = new_JavaUtilArrayList_init();
  ...
  self->geom_ = [IOSObjectArray newArrayWithObjects:(id[]){ a, b, result } count:3 type:ComVividsolutionsJtsGeomGeometry_class_()];
  self->locFinder_ = [IOSObjectArray newArrayWithObjects:(id[]){ new_ComVividsolutionsJtsOperationOverlayValidateFuzzyPointLocator_initWithComVividsolutionsJtsGeomGeometry_withDouble_(IOSObjectArray_Get(self->geom_, 0), self->boundaryDistanceTolerance_), new_ComVividsolutionsJtsOperationOverlayValidateFuzzyPointLocator_initWithComVividsolutionsJtsGeomGeometry_withDouble_(IOSObjectArray_Get(self->geom_, 1), self->boundaryDistanceTolerance_), new_ComVividsolutionsJtsOperationOverlayValidateFuzzyPointLocator_initWithComVividsolutionsJtsGeomGeometry_withDouble_(IOSObjectArray_Get(self->geom_, 2), self->boundaryDistanceTolerance_) } count:3 type:ComVividsolutionsJtsOperationOverlayValidateFuzzyPointLocator_class_()];
}
...
void ComVividsolutionsJtsOperationOverlayValidateOverlayResultValidator_addTestPtsWithComVividsolutionsJtsGeomGeometry_(ComVividsolutionsJtsOperationOverlayValidateOverlayResultValidator *self, ComVividsolutionsJtsGeomGeometry *g) {
  ComVividsolutionsJtsOperationOverlayValidateOffsetPointGenerator *ptGen = new_ComVividsolutionsJtsOperationOverlayValidateOffsetPointGenerator_initWithComVividsolutionsJtsGeomGeometry_withDouble_(g, 5 * self->boundaryDistanceTolerance_);
