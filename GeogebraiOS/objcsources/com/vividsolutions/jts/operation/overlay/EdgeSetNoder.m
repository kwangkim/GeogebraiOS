...
- (id<JavaUtilList>)getNodedEdges {
  ComVividsolutionsJtsGeomgraphIndexEdgeSetIntersector *esi = new_ComVividsolutionsJtsGeomgraphIndexSimpleMCSweepLineIntersector_init();
  ComVividsolutionsJtsGeomgraphIndexSegmentIntersector *si = new_ComVividsolutionsJtsGeomgraphIndexSegmentIntersector_initWithComVividsolutionsJtsAlgorithmLineIntersector_withBoolean_withBoolean_(li_, YES, NO);
...
void ComVividsolutionsJtsOperationOverlayEdgeSetNoder_initWithComVividsolutionsJtsAlgorithmLineIntersector_(ComVividsolutionsJtsOperationOverlayEdgeSetNoder *self, ComVividsolutionsJtsAlgorithmLineIntersector *li) {
  ...
  self->inputEdges_ = new_JavaUtilArrayList_init();
  self->li_ = li;
}
