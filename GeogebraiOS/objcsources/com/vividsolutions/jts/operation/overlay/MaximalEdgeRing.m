...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/com/vividsolutions/jts/operation/overlay/MaximalEdgeRing.java
//
...
- (id<JavaUtilList>)buildMinimalRings {
  id<JavaUtilList> minEdgeRings = new_JavaUtilArrayList_init();
  ComVividsolutionsJtsGeomgraphDirectedEdge *de = startDe_;
  do {
    if ([((ComVividsolutionsJtsGeomgraphDirectedEdge *) nil_chk(de)) getMinEdgeRing] == nil) {
      ComVividsolutionsJtsGeomgraphEdgeRing *minEr = new_ComVividsolutionsJtsOperationOverlayMinimalEdgeRing_initWithComVividsolutionsJtsGeomgraphDirectedEdge_withComVividsolutionsJtsGeomGeometryFactory_(de, geometryFactory_);
