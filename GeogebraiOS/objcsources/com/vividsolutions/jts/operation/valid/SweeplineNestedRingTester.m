...
- (jboolean)isNonNested {
  ...
  ComVividsolutionsJtsOperationValidSweeplineNestedRingTester_OverlapAction *action = new_ComVividsolutionsJtsOperationValidSweeplineNestedRingTester_OverlapAction_initWithComVividsolutionsJtsOperationValidSweeplineNestedRingTester_(self);
...
void ComVividsolutionsJtsOperationValidSweeplineNestedRingTester_buildIndex(ComVividsolutionsJtsOperationValidSweeplineNestedRingTester *self) {
  self->sweepLine_ = new_ComVividsolutionsJtsIndexSweeplineSweepLineIndex_init();
  for (jint i = 0; i < [((id<JavaUtilList>) nil_chk(self->rings_)) size]; i++) {
    ...
    ComVividsolutionsJtsIndexSweeplineSweepLineInterval *sweepInt = new_ComVividsolutionsJtsIndexSweeplineSweepLineInterval_initWithDouble_withDouble_withId_([((ComVividsolutionsJtsGeomEnvelope *) nil_chk(env)) getMinX], [env getMaxX], ring);
