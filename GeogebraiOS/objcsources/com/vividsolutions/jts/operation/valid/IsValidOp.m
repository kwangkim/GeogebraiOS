...
void ComVividsolutionsJtsOperationValidIsValidOp_initWithComVividsolutionsJtsGeomGeometry_(ComVividsolutionsJtsOperationValidIsValidOp *self, ComVividsolutionsJtsGeomGeometry *parentGeometry) {
  ...
  self->isChecked_ = NO;
  self->parentGeometry_ = parentGeometry;
}
...
void ComVividsolutionsJtsOperationValidIsValidOp_checkValidWithComVividsolutionsJtsGeomGeometry_(ComVividsolutionsJtsOperationValidIsValidOp *self, ComVividsolutionsJtsGeomGeometry *g) {
  ...
  else @throw new_JavaLangUnsupportedOperationException_initWithNSString_([[g getClass] getName]);
}
...
void ComVividsolutionsJtsOperationValidIsValidOp_checkValidWithComVividsolutionsJtsGeomLineString_(ComVividsolutionsJtsOperationValidIsValidOp *self, ComVividsolutionsJtsGeomLineString *g) {
  ...
  ComVividsolutionsJtsGeomgraphGeometryGraph *graph = new_ComVividsolutionsJtsGeomgraphGeometryGraph_initWithInt_withComVividsolutionsJtsGeomGeometry_(0, g);
  ComVividsolutionsJtsOperationValidIsValidOp_checkTooFewPointsWithComVividsolutionsJtsGeomgraphGeometryGraph_(self, graph);
}
...
void ComVividsolutionsJtsOperationValidIsValidOp_checkValidWithComVividsolutionsJtsGeomLinearRing_(ComVividsolutionsJtsOperationValidIsValidOp *self, ComVividsolutionsJtsGeomLinearRing *g) {
  ...
  (void) [graph computeSelfNodesWithComVividsolutionsJtsAlgorithmLineIntersector:li withBoolean:YES];
  ComVividsolutionsJtsOperationValidIsValidOp_checkNoSelfIntersectingRingsWithComVividsolutionsJtsGeomgraphGeometryGraph_(self, graph);
}
...
void ComVividsolutionsJtsOperationValidIsValidOp_checkInvalidCoordinatesWithComVividsolutionsJtsGeomCoordinateArray_(ComVividsolutionsJtsOperationValidIsValidOp *self, IOSObjectArray *coords) {
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(coords))->size_; i++) {
    if (!ComVividsolutionsJtsOperationValidIsValidOp_isValidWithComVividsolutionsJtsGeomCoordinate_(IOSObjectArray_Get(coords, i))) {
      self->validErr_ = new_ComVividsolutionsJtsOperationValidTopologyValidationError_initWithInt_withComVividsolutionsJtsGeomCoordinate_(ComVividsolutionsJtsOperationValidTopologyValidationError_INVALID_COORDINATE, IOSObjectArray_Get(coords, i));
      return;
    }
  }
}
...
void ComVividsolutionsJtsOperationValidIsValidOp_checkClosedRingWithComVividsolutionsJtsGeomLinearRing_(ComVividsolutionsJtsOperationValidIsValidOp *self, ComVividsolutionsJtsGeomLinearRing *ring) {
  if (![((ComVividsolutionsJtsGeomLinearRing *) nil_chk(ring)) isClosed]) self->validErr_ = new_ComVividsolutionsJtsOperationValidTopologyValidationError_initWithInt_withComVividsolutionsJtsGeomCoordinate_(ComVividsolutionsJtsOperationValidTopologyValidationError_RING_NOT_CLOSED, [ring getCoordinateNWithInt:0]);
}
...
void ComVividsolutionsJtsOperationValidIsValidOp_checkTooFewPointsWithComVividsolutionsJtsGeomgraphGeometryGraph_(ComVividsolutionsJtsOperationValidIsValidOp *self, ComVividsolutionsJtsGeomgraphGeometryGraph *graph) {
  if ([((ComVividsolutionsJtsGeomgraphGeometryGraph *) nil_chk(graph)) hasTooFewPoints]) {
    self->validErr_ = new_ComVividsolutionsJtsOperationValidTopologyValidationError_initWithInt_withComVividsolutionsJtsGeomCoordinate_(ComVividsolutionsJtsOperationValidTopologyValidationError_TOO_FEW_POINTS, [graph getInvalidPoint]);
    return;
  }
}
...
void ComVividsolutionsJtsOperationValidIsValidOp_checkConsistentAreaWithComVividsolutionsJtsGeomgraphGeometryGraph_(ComVividsolutionsJtsOperationValidIsValidOp *self, ComVividsolutionsJtsGeomgraphGeometryGraph *graph) {
  ComVividsolutionsJtsOperationValidConsistentAreaTester *cat = new_ComVividsolutionsJtsOperationValidConsistentAreaTester_initWithComVividsolutionsJtsGeomgraphGeometryGraph_(graph);
  jboolean isValidArea = [cat isNodeConsistentArea];
  if (!isValidArea) {
    self->validErr_ = new_ComVividsolutionsJtsOperationValidTopologyValidationError_initWithInt_withComVividsolutionsJtsGeomCoordinate_(ComVividsolutionsJtsOperationValidTopologyValidationError_SELF_INTERSECTION, [cat getInvalidPoint]);
    return;
  }
  if ([cat hasDuplicateRings]) {
    self->validErr_ = new_ComVividsolutionsJtsOperationValidTopologyValidationError_initWithInt_withComVividsolutionsJtsGeomCoordinate_(ComVividsolutionsJtsOperationValidTopologyValidationError_DUPLICATE_RINGS, [cat getInvalidPoint]);
  }
}
...
void ComVividsolutionsJtsOperationValidIsValidOp_checkNoSelfIntersectingRingWithComVividsolutionsJtsGeomgraphEdgeIntersectionList_(ComVividsolutionsJtsOperationValidIsValidOp *self, ComVividsolutionsJtsGeomgraphEdgeIntersectionList *eiList) {
  id<JavaUtilSet> nodeSet = new_JavaUtilTreeSet_init();
  ...
  for (id<JavaUtilIterator> i = [((ComVividsolutionsJtsGeomgraphEdgeIntersectionList *) nil_chk(eiList)) iterator]; [((id<JavaUtilIterator>) nil_chk(i)) hasNext]; ) {
    ...
    if ([nodeSet containsWithId:((ComVividsolutionsJtsGeomgraphEdgeIntersection *) nil_chk(ei))->coord_]) {
      self->validErr_ = new_ComVividsolutionsJtsOperationValidTopologyValidationError_initWithInt_withComVividsolutionsJtsGeomCoordinate_(ComVividsolutionsJtsOperationValidTopologyValidationError_RING_SELF_INTERSECTION, ei->coord_);
      return;
    }
    else {
...
void ComVividsolutionsJtsOperationValidIsValidOp_checkHolesInShellWithComVividsolutionsJtsGeomPolygon_withComVividsolutionsJtsGeomgraphGeometryGraph_(ComVividsolutionsJtsOperationValidIsValidOp *self, ComVividsolutionsJtsGeomPolygon *p, ComVividsolutionsJtsGeomgraphGeometryGraph *graph) {
  ...
  id<ComVividsolutionsJtsAlgorithmPointInRing> pir = new_ComVividsolutionsJtsAlgorithmMCPointInRing_initWithComVividsolutionsJtsGeomLinearRing_(shell);
  for (jint i = 0; i < [p getNumInteriorRing]; i++) {
    ...
    if (outside) {
      self->validErr_ = new_ComVividsolutionsJtsOperationValidTopologyValidationError_initWithInt_withComVividsolutionsJtsGeomCoordinate_(ComVividsolutionsJtsOperationValidTopologyValidationError_HOLE_OUTSIDE_SHELL, holePt);
      return;
    }
  }
}
...
void ComVividsolutionsJtsOperationValidIsValidOp_checkHolesNotNestedWithComVividsolutionsJtsGeomPolygon_withComVividsolutionsJtsGeomgraphGeometryGraph_(ComVividsolutionsJtsOperationValidIsValidOp *self, ComVividsolutionsJtsGeomPolygon *p, ComVividsolutionsJtsGeomgraphGeometryGraph *graph) {
  ComVividsolutionsJtsOperationValidIndexedNestedRingTester *nestedTester = new_ComVividsolutionsJtsOperationValidIndexedNestedRingTester_initWithComVividsolutionsJtsGeomgraphGeometryGraph_(graph);
  ...
  if (!isNonNested) {
    self->validErr_ = new_ComVividsolutionsJtsOperationValidTopologyValidationError_initWithInt_withComVividsolutionsJtsGeomCoordinate_(ComVividsolutionsJtsOperationValidTopologyValidationError_NESTED_HOLES, [nestedTester getNestedPoint]);
  }
}
...
void ComVividsolutionsJtsOperationValidIsValidOp_checkShellNotNestedWithComVividsolutionsJtsGeomLinearRing_withComVividsolutionsJtsGeomPolygon_withComVividsolutionsJtsGeomgraphGeometryGraph_(ComVividsolutionsJtsOperationValidIsValidOp *self, ComVividsolutionsJtsGeomLinearRing *shell, ComVividsolutionsJtsGeomPolygon *p, ComVividsolutionsJtsGeomgraphGeometryGraph *graph) {
  ...
  if ([p getNumInteriorRing] <= 0) {
    self->validErr_ = new_ComVividsolutionsJtsOperationValidTopologyValidationError_initWithInt_withComVividsolutionsJtsGeomCoordinate_(ComVividsolutionsJtsOperationValidTopologyValidationError_NESTED_SHELLS, shellPt);
    return;
  }
  ...
  self->validErr_ = new_ComVividsolutionsJtsOperationValidTopologyValidationError_initWithInt_withComVividsolutionsJtsGeomCoordinate_(ComVividsolutionsJtsOperationValidTopologyValidationError_NESTED_SHELLS, badNestedPt);
}
...
void ComVividsolutionsJtsOperationValidIsValidOp_checkConnectedInteriorsWithComVividsolutionsJtsGeomgraphGeometryGraph_(ComVividsolutionsJtsOperationValidIsValidOp *self, ComVividsolutionsJtsGeomgraphGeometryGraph *graph) {
  ComVividsolutionsJtsOperationValidConnectedInteriorTester *cit = new_ComVividsolutionsJtsOperationValidConnectedInteriorTester_initWithComVividsolutionsJtsGeomgraphGeometryGraph_(graph);
  if (![cit isInteriorsConnected]) self->validErr_ = new_ComVividsolutionsJtsOperationValidTopologyValidationError_initWithInt_withComVividsolutionsJtsGeomCoordinate_(ComVividsolutionsJtsOperationValidTopologyValidationError_DISCONNECTED_INTERIOR, [cit getCoordinate]);
}
