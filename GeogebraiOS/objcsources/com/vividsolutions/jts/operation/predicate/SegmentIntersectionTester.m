...
void ComVividsolutionsJtsOperationPredicateSegmentIntersectionTester_init(ComVividsolutionsJtsOperationPredicateSegmentIntersectionTester *self) {
  ...
  self->pt00_ = new_ComVividsolutionsJtsGeomCoordinate_init();
  self->pt01_ = new_ComVividsolutionsJtsGeomCoordinate_init();
  self->pt10_ = new_ComVividsolutionsJtsGeomCoordinate_init();
  self->pt11_ = new_ComVividsolutionsJtsGeomCoordinate_init();
}
