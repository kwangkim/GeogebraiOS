...
jdouble ComVividsolutionsJtsOperationDistanceDistanceOp_distanceWithComVividsolutionsJtsGeomGeometry_withComVividsolutionsJtsGeomGeometry_(ComVividsolutionsJtsGeomGeometry *g0, ComVividsolutionsJtsGeomGeometry *g1) {
  ...
  ComVividsolutionsJtsOperationDistanceDistanceOp *distOp = new_ComVividsolutionsJtsOperationDistanceDistanceOp_initWithComVividsolutionsJtsGeomGeometry_withComVividsolutionsJtsGeomGeometry_(g0, g1);
...
jboolean ComVividsolutionsJtsOperationDistanceDistanceOp_isWithinDistanceWithComVividsolutionsJtsGeomGeometry_withComVividsolutionsJtsGeomGeometry_withDouble_(ComVividsolutionsJtsGeomGeometry *g0, ComVividsolutionsJtsGeomGeometry *g1, jdouble distance) {
  ComVividsolutionsJtsOperationDistanceDistanceOp_initialize();
  ComVividsolutionsJtsOperationDistanceDistanceOp *distOp = new_ComVividsolutionsJtsOperationDistanceDistanceOp_initWithComVividsolutionsJtsGeomGeometry_withComVividsolutionsJtsGeomGeometry_withDouble_(g0, g1, distance);
...
void ComVividsolutionsJtsOperationDistanceDistanceOp_initWithComVividsolutionsJtsGeomGeometry_withComVividsolutionsJtsGeomGeometry_(ComVividsolutionsJtsOperationDistanceDistanceOp *self, ComVividsolutionsJtsGeomGeometry *g0, ComVividsolutionsJtsGeomGeometry *g1) {
  (void) ComVividsolutionsJtsOperationDistanceDistanceOp_initWithComVividsolutionsJtsGeomGeometry_withComVividsolutionsJtsGeomGeometry_withDouble_(self, g0, g1, 0.0);
}
...
void ComVividsolutionsJtsOperationDistanceDistanceOp_initWithComVividsolutionsJtsGeomGeometry_withComVividsolutionsJtsGeomGeometry_withDouble_(ComVividsolutionsJtsOperationDistanceDistanceOp *self, ComVividsolutionsJtsGeomGeometry *g0, ComVividsolutionsJtsGeomGeometry *g1, jdouble terminateDistance) {
  ...
  (void) IOSObjectArray_Set(self->geom_, 0, g0);
  (void) IOSObjectArray_Set(self->geom_, 1, g1);
...
void ComVividsolutionsJtsOperationDistanceDistanceOp_updateMinDistanceWithComVividsolutionsJtsOperationDistanceGeometryLocationArray_withBoolean_(ComVividsolutionsJtsOperationDistanceDistanceOp *self, IOSObjectArray *locGeom, jboolean flip) {
  ...
  if (flip) {
    (void) IOSObjectArray_Set(nil_chk(self->minDistanceLocation_), 0, IOSObjectArray_Get(locGeom, 1));
    (void) IOSObjectArray_Set(self->minDistanceLocation_, 1, IOSObjectArray_Get(locGeom, 0));
  }
  else {
    (void) IOSObjectArray_Set(nil_chk(self->minDistanceLocation_), 0, IOSObjectArray_Get(locGeom, 0));
    (void) IOSObjectArray_Set(self->minDistanceLocation_, 1, IOSObjectArray_Get(locGeom, 1));
  }
}
...
void ComVividsolutionsJtsOperationDistanceDistanceOp_computeMinDistance(ComVividsolutionsJtsOperationDistanceDistanceOp *self) {
  ...
  self->minDistanceLocation_ = [IOSObjectArray newArrayWithLength:2 type:ComVividsolutionsJtsOperationDistanceGeometryLocation_class_()];
  ComVividsolutionsJtsOperationDistanceDistanceOp_computeContainmentDistance(self);
...
void ComVividsolutionsJtsOperationDistanceDistanceOp_computeContainmentDistance(ComVividsolutionsJtsOperationDistanceDistanceOp *self) {
  IOSObjectArray *locPtPoly = [IOSObjectArray newArrayWithLength:2 type:ComVividsolutionsJtsOperationDistanceGeometryLocation_class_()];
  ...
  if ([((id<JavaUtilList>) nil_chk(polys1)) size] > 0) {
    ...
    if (self->minDistance_ <= self->terminateDistance_) {
      (void) IOSObjectArray_Set(nil_chk(self->minDistanceLocation_), 0, IOSObjectArray_Get(locPtPoly, 0));
      (void) IOSObjectArray_Set(self->minDistanceLocation_, 1, IOSObjectArray_Get(locPtPoly, 1));
      return;
    }
  }
  ...
  if ([((id<JavaUtilList>) nil_chk(polys0)) size] > 0) {
    ...
    if (self->minDistance_ <= self->terminateDistance_) {
      (void) IOSObjectArray_Set(nil_chk(self->minDistanceLocation_), 0, IOSObjectArray_Get(locPtPoly, 1));
      (void) IOSObjectArray_Set(self->minDistanceLocation_, 1, IOSObjectArray_Get(locPtPoly, 0));
      return;
    }
  }
}
...
void ComVividsolutionsJtsOperationDistanceDistanceOp_computeInsideWithComVividsolutionsJtsOperationDistanceGeometryLocation_withComVividsolutionsJtsGeomPolygon_withComVividsolutionsJtsOperationDistanceGeometryLocationArray_(ComVividsolutionsJtsOperationDistanceDistanceOp *self, ComVividsolutionsJtsOperationDistanceGeometryLocation *ptLoc, ComVividsolutionsJtsGeomPolygon *poly, IOSObjectArray *locPtPoly) {
  ...
  if (ComVividsolutionsJtsGeomLocation_EXTERIOR != [((ComVividsolutionsJtsAlgorithmPointLocator *) nil_chk(self->ptLocator_)) locateWithComVividsolutionsJtsGeomCoordinate:pt withComVividsolutionsJtsGeomGeometry:poly]) {
    ...
    (void) IOSObjectArray_Set(nil_chk(locPtPoly), 0, ptLoc);
    ComVividsolutionsJtsOperationDistanceGeometryLocation *locPoly = new_ComVividsolutionsJtsOperationDistanceGeometryLocation_initWithComVividsolutionsJtsGeomGeometry_withComVividsolutionsJtsGeomCoordinate_(poly, pt);
    (void) IOSObjectArray_Set(locPtPoly, 1, locPoly);
    return;
  }
}
...
void ComVividsolutionsJtsOperationDistanceDistanceOp_computeFacetDistance(ComVividsolutionsJtsOperationDistanceDistanceOp *self) {
  IOSObjectArray *locGeom = [IOSObjectArray newArrayWithLength:2 type:ComVividsolutionsJtsOperationDistanceGeometryLocation_class_()];
  ...
  if (self->minDistance_ <= self->terminateDistance_) return;
  (void) IOSObjectArray_Set(locGeom, 0, nil);
  (void) IOSObjectArray_Set(locGeom, 1, nil);
  ...
  for (jint i = 0; i < [((id<JavaUtilList>) nil_chk(points0)) size]; i++) {
    ...
    for (jint j = 0; j < [((id<JavaUtilList>) nil_chk(points1)) size]; j++) {
      ...
      if (dist < self->minDistance_) {
        ...
        (void) IOSObjectArray_Set(nil_chk(locGeom), 0, new_ComVividsolutionsJtsOperationDistanceGeometryLocation_initWithComVividsolutionsJtsGeomGeometry_withInt_withComVividsolutionsJtsGeomCoordinate_(pt0, 0, [pt0 getCoordinate]));
        (void) IOSObjectArray_Set(locGeom, 1, new_ComVividsolutionsJtsOperationDistanceGeometryLocation_initWithComVividsolutionsJtsGeomGeometry_withInt_withComVividsolutionsJtsGeomCoordinate_(pt1, 0, [pt1 getCoordinate]));
      }
      if (self->minDistance_ <= self->terminateDistance_) return;
    }
  }
...
void ComVividsolutionsJtsOperationDistanceDistanceOp_computeMinDistanceWithComVividsolutionsJtsGeomLineString_withComVividsolutionsJtsGeomLineString_withComVividsolutionsJtsOperationDistanceGeometryLocationArray_(ComVividsolutionsJtsOperationDistanceDistanceOp *self, ComVividsolutionsJtsGeomLineString *line0, ComVividsolutionsJtsGeomLineString *line1, IOSObjectArray *locGeom) {
  ...
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(coord0))->size_ - 1; i++) {
    for (jint j = 0; j < ((IOSObjectArray *) nil_chk(coord1))->size_ - 1; j++) {
      ...
      if (dist < self->minDistance_) {
        self->minDistance_ = dist;
        ComVividsolutionsJtsGeomLineSegment *seg0 = new_ComVividsolutionsJtsGeomLineSegment_initWithComVividsolutionsJtsGeomCoordinate_withComVividsolutionsJtsGeomCoordinate_(IOSObjectArray_Get(coord0, i), IOSObjectArray_Get(coord0, i + 1));
        ComVividsolutionsJtsGeomLineSegment *seg1 = new_ComVividsolutionsJtsGeomLineSegment_initWithComVividsolutionsJtsGeomCoordinate_withComVividsolutionsJtsGeomCoordinate_(IOSObjectArray_Get(coord1, j), IOSObjectArray_Get(coord1, j + 1));
        IOSObjectArray *closestPt = [seg0 closestPointsWithComVividsolutionsJtsGeomLineSegment:seg1];
        (void) IOSObjectArray_Set(nil_chk(locGeom), 0, new_ComVividsolutionsJtsOperationDistanceGeometryLocation_initWithComVividsolutionsJtsGeomGeometry_withInt_withComVividsolutionsJtsGeomCoordinate_(line0, i, IOSObjectArray_Get(nil_chk(closestPt), 0)));
        (void) IOSObjectArray_Set(locGeom, 1, new_ComVividsolutionsJtsOperationDistanceGeometryLocation_initWithComVividsolutionsJtsGeomGeometry_withInt_withComVividsolutionsJtsGeomCoordinate_(line1, j, IOSObjectArray_Get(closestPt, 1)));
      }
      if (self->minDistance_ <= self->terminateDistance_) return;
    }
  }
...
void ComVividsolutionsJtsOperationDistanceDistanceOp_computeMinDistanceWithComVividsolutionsJtsGeomLineString_withComVividsolutionsJtsGeomPoint_withComVividsolutionsJtsOperationDistanceGeometryLocationArray_(ComVividsolutionsJtsOperationDistanceDistanceOp *self, ComVividsolutionsJtsGeomLineString *line, ComVividsolutionsJtsGeomPoint *pt, IOSObjectArray *locGeom) {
  ...
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(coord0))->size_ - 1; i++) {
    ...
    if (dist < self->minDistance_) {
      self->minDistance_ = dist;
      ComVividsolutionsJtsGeomLineSegment *seg = new_ComVividsolutionsJtsGeomLineSegment_initWithComVividsolutionsJtsGeomCoordinate_withComVividsolutionsJtsGeomCoordinate_(IOSObjectArray_Get(coord0, i), IOSObjectArray_Get(coord0, i + 1));
      ComVividsolutionsJtsGeomCoordinate *segClosestPoint = [seg closestPointWithComVividsolutionsJtsGeomCoordinate:coord];
      (void) IOSObjectArray_Set(nil_chk(locGeom), 0, new_ComVividsolutionsJtsOperationDistanceGeometryLocation_initWithComVividsolutionsJtsGeomGeometry_withInt_withComVividsolutionsJtsGeomCoordinate_(line, i, segClosestPoint));
      (void) IOSObjectArray_Set(locGeom, 1, new_ComVividsolutionsJtsOperationDistanceGeometryLocation_initWithComVividsolutionsJtsGeomGeometry_withInt_withComVividsolutionsJtsGeomCoordinate_(pt, 0, coord));
    }
    if (self->minDistance_ <= self->terminateDistance_) return;
  }
}
