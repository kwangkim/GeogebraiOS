...
id<JavaUtilList> ComVividsolutionsJtsOperationDistanceConnectedElementLocationFilter_getLocationsWithComVividsolutionsJtsGeomGeometry_(ComVividsolutionsJtsGeomGeometry *geom) {
  ...
  id<JavaUtilList> locations = new_JavaUtilArrayList_init();
  [((ComVividsolutionsJtsGeomGeometry *) nil_chk(geom)) applyWithComVividsolutionsJtsGeomGeometryFilter:new_ComVividsolutionsJtsOperationDistanceConnectedElementLocationFilter_initWithJavaUtilList_(locations)];
  return locations;
}
