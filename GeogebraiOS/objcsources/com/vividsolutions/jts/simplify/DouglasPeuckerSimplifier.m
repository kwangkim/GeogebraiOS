...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/com/vividsolutions/jts/simplify/DouglasPeuckerSimplifier.java
//
...
- (ComVividsolutionsJtsGeomGeometry *)getResultGeometry {
  return [(new_ComVividsolutionsJtsSimplifyDouglasPeuckerSimplifier_DPTransformer_initWithComVividsolutionsJtsSimplifyDouglasPeuckerSimplifier_withBoolean_(self, isEnsureValidTopology_)) transformWithComVividsolutionsJtsGeomGeometry:inputGeom_];
}
...
ComVividsolutionsJtsGeomGeometry *ComVividsolutionsJtsSimplifyDouglasPeuckerSimplifier_simplifyWithComVividsolutionsJtsGeomGeometry_withDouble_(ComVividsolutionsJtsGeomGeometry *geom, jdouble distanceTolerance) {
  ...
  ComVividsolutionsJtsSimplifyDouglasPeuckerSimplifier *tss = new_ComVividsolutionsJtsSimplifyDouglasPeuckerSimplifier_initWithComVividsolutionsJtsGeomGeometry_(geom);
