...
- (void)setDistanceToleranceWithDouble:(jdouble)distanceTolerance {
  if (distanceTolerance < 0.0) @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"Tolerance must be non-negative");
...
- (ComVividsolutionsJtsGeomGeometry *)getResultGeometry {
  linestringMap_ = new_JavaUtilHashMap_init();
  [((ComVividsolutionsJtsGeomGeometry *) nil_chk(inputGeom_)) applyWithComVividsolutionsJtsGeomGeometryComponentFilter:new_ComVividsolutionsJtsSimplifyTopologyPreservingSimplifier_LineStringMapBuilderFilter_initWithComVividsolutionsJtsSimplifyTopologyPreservingSimplifier_(self)];
  ...
  ComVividsolutionsJtsGeomGeometry *result = [(new_ComVividsolutionsJtsSimplifyTopologyPreservingSimplifier_LineStringTransformer_initWithComVividsolutionsJtsSimplifyTopologyPreservingSimplifier_(self)) transformWithComVividsolutionsJtsGeomGeometry:inputGeom_];
  return result;
}
...
ComVividsolutionsJtsGeomGeometry *ComVividsolutionsJtsSimplifyTopologyPreservingSimplifier_simplifyWithComVividsolutionsJtsGeomGeometry_withDouble_(ComVividsolutionsJtsGeomGeometry *geom, jdouble distanceTolerance) {
  ...
  ComVividsolutionsJtsSimplifyTopologyPreservingSimplifier *tss = new_ComVividsolutionsJtsSimplifyTopologyPreservingSimplifier_initWithComVividsolutionsJtsGeomGeometry_(geom);
...
void ComVividsolutionsJtsSimplifyTopologyPreservingSimplifier_initWithComVividsolutionsJtsGeomGeometry_(ComVividsolutionsJtsSimplifyTopologyPreservingSimplifier *self, ComVividsolutionsJtsGeomGeometry *inputGeom) {
  ...
  self->lineSimplifier_ = new_ComVividsolutionsJtsSimplifyTaggedLinesSimplifier_init();
...
- (void)filterWithComVividsolutionsJtsGeomGeometry:(ComVividsolutionsJtsGeomGeometry *)geom {
  if ([geom isKindOfClass:[ComVividsolutionsJtsGeomLinearRing class]]) {
    ComVividsolutionsJtsSimplifyTaggedLineString *taggedLine = new_ComVividsolutionsJtsSimplifyTaggedLineString_initWithComVividsolutionsJtsGeomLineString_withInt_((ComVividsolutionsJtsGeomLineString *) check_class_cast(geom, [ComVividsolutionsJtsGeomLineString class]), 4);
    (void) [((id<JavaUtilMap>) nil_chk(this$0_->linestringMap_)) putWithId:geom withId:taggedLine];
  }
  else if ([geom isKindOfClass:[ComVividsolutionsJtsGeomLineString class]]) {
    ComVividsolutionsJtsSimplifyTaggedLineString *taggedLine = new_ComVividsolutionsJtsSimplifyTaggedLineString_initWithComVividsolutionsJtsGeomLineString_withInt_((ComVividsolutionsJtsGeomLineString *) check_class_cast(geom, [ComVividsolutionsJtsGeomLineString class]), 2);
    (void) [((id<JavaUtilMap>) nil_chk(this$0_->linestringMap_)) putWithId:geom withId:taggedLine];
  }
}
