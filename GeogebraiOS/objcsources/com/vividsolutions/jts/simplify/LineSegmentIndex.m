...
- (void)addWithComVividsolutionsJtsGeomLineSegment:(ComVividsolutionsJtsGeomLineSegment *)seg {
  [((ComVividsolutionsJtsIndexQuadtreeQuadtree *) nil_chk(index_)) insertWithComVividsolutionsJtsGeomEnvelope:new_ComVividsolutionsJtsGeomEnvelope_initWithComVividsolutionsJtsGeomCoordinate_withComVividsolutionsJtsGeomCoordinate_(((ComVividsolutionsJtsGeomLineSegment *) nil_chk(seg))->p0_, seg->p1_) withId:seg];
}

- (void)removeWithComVividsolutionsJtsGeomLineSegment:(ComVividsolutionsJtsGeomLineSegment *)seg {
  [((ComVividsolutionsJtsIndexQuadtreeQuadtree *) nil_chk(index_)) removeWithComVividsolutionsJtsGeomEnvelope:new_ComVividsolutionsJtsGeomEnvelope_initWithComVividsolutionsJtsGeomCoordinate_withComVividsolutionsJtsGeomCoordinate_(((ComVividsolutionsJtsGeomLineSegment *) nil_chk(seg))->p0_, seg->p1_) withId:seg];
}

- (id<JavaUtilList>)queryWithComVividsolutionsJtsGeomLineSegment:(ComVividsolutionsJtsGeomLineSegment *)querySeg {
  ComVividsolutionsJtsGeomEnvelope *env = new_ComVividsolutionsJtsGeomEnvelope_initWithComVividsolutionsJtsGeomCoordinate_withComVividsolutionsJtsGeomCoordinate_(((ComVividsolutionsJtsGeomLineSegment *) nil_chk(querySeg))->p0_, querySeg->p1_);
  ComVividsolutionsJtsSimplifyLineSegmentVisitor *visitor = new_ComVividsolutionsJtsSimplifyLineSegmentVisitor_initWithComVividsolutionsJtsGeomLineSegment_(querySeg);
...
void ComVividsolutionsJtsSimplifyLineSegmentIndex_init(ComVividsolutionsJtsSimplifyLineSegmentIndex *self) {
  ...
  self->index_ = new_ComVividsolutionsJtsIndexQuadtreeQuadtree_init();
}
