...
- (void)addWithComVividsolutionsJtsPlanargraphNode:(ComVividsolutionsJtsPlanargraphNode *)node {
  (void) [((ComVividsolutionsJtsPlanargraphNodeMap *) nil_chk(nodeMap_)) addWithComVividsolutionsJtsPlanargraphNode:node];
}
...
- (void)removeWithComVividsolutionsJtsPlanargraphNode:(ComVividsolutionsJtsPlanargraphNode *)node {
  ...
  (void) [((ComVividsolutionsJtsPlanargraphNodeMap *) nil_chk(nodeMap_)) removeWithComVividsolutionsJtsGeomCoordinate:[node getCoordinate]];
  [node remove];
}

- (id<JavaUtilList>)findNodesOfDegreeWithInt:(jint)degree {
  id<JavaUtilList> nodesFound = new_JavaUtilArrayList_init();
...
void ComVividsolutionsJtsPlanargraphPlanarGraph_init(ComVividsolutionsJtsPlanargraphPlanarGraph *self) {
  ...
  self->dirEdges_ = new_JavaUtilHashSet_init();
