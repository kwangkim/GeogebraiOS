...
- (jboolean)intersectsWithJavaUtilCollection:(id<JavaUtilCollection>)segStrings {
  ComVividsolutionsJtsNodingSegmentIntersectionDetector *intFinder = new_ComVividsolutionsJtsNodingSegmentIntersectionDetector_initWithComVividsolutionsJtsAlgorithmLineIntersector_(ComVividsolutionsJtsNodingFastSegmentSetIntersectionFinder_li_);
...
+ (void)initialize {
  if (self == [ComVividsolutionsJtsNodingFastSegmentSetIntersectionFinder class]) {
    ComVividsolutionsJtsNodingFastSegmentSetIntersectionFinder_li_ = new_ComVividsolutionsJtsAlgorithmRobustLineIntersector_init();
...
void ComVividsolutionsJtsNodingFastSegmentSetIntersectionFinder_init__WithJavaUtilCollection_(ComVividsolutionsJtsNodingFastSegmentSetIntersectionFinder *self, id<JavaUtilCollection> baseSegStrings) {
  self->segSetMutInt_ = new_ComVividsolutionsJtsNodingMCIndexSegmentSetMutualIntersector_init();
