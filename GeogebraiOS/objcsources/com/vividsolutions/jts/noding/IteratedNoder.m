...
//  source: /Users/jacky/GSoC/GeoGebraiOSARC/GeoGebraiOSARC/javasources/com/vividsolutions/jts/noding/IteratedNoder.java
//
...
- (void)computeNodesWithJavaUtilCollection:(id<JavaUtilCollection>)segStrings {
  IOSIntArray *numInteriorIntersections = [IOSIntArray newArrayWithLength:1];
  nodedSegStrings_ = segStrings;
  ...
  do {
    ...
    if (lastNodesCreated > 0 && nodesCreated >= lastNodesCreated && nodingIterationCount > maxIter_) {
      @throw new_ComVividsolutionsJtsGeomTopologyException_initWithNSString_(JreStrcat("$I$", @"Iterated noding failed to converge after ", nodingIterationCount, @" iterations"));
    }
...
void ComVividsolutionsJtsNodingIteratedNoder_nodeWithJavaUtilCollection_withIntArray_(ComVividsolutionsJtsNodingIteratedNoder *self, id<JavaUtilCollection> segStrings, IOSIntArray *numInteriorIntersections) {
  ComVividsolutionsJtsNodingIntersectionAdder *si = new_ComVividsolutionsJtsNodingIntersectionAdder_initWithComVividsolutionsJtsAlgorithmLineIntersector_(self->li_);
  ...
  self->nodedSegStrings_ = [noder getNodedSubstrings];
