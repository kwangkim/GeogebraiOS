...
- (void)setDesiredPrecisionWithDouble:(jdouble)prec {
  if (prec <= 0) @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$D", @"Non-positive precision: ", prec));
  desiredPrecision_ = prec;
}

- (void)setMaximumIterationsWithInt:(jint)maxIter {
  if (maxIter < 1) @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$I", @"Non-positive maximum iteration: ", maxIter));
