...
//  source: /Users/jacky/GSoC/GeogebraiOS/GeogebraiOS/sources/edu/uci/ics/jung/algorithms/util/WeightedChoice.java
//
...
void EduUciIcsJungAlgorithmsUtilWeightedChoice_initWithJavaUtilMap_(EduUciIcsJungAlgorithmsUtilWeightedChoice *self, id<JavaUtilMap> item_weights) {
  EduUciIcsJungAlgorithmsUtilWeightedChoice_initWithJavaUtilMap_withJavaUtilRandom_withDouble_(self, item_weights, [new_JavaUtilRandom_init() autorelease], EduUciIcsJungAlgorithmsUtilWeightedChoice_DEFAULT_THRESHOLD);
}
...
void EduUciIcsJungAlgorithmsUtilWeightedChoice_initWithJavaUtilMap_withDouble_(EduUciIcsJungAlgorithmsUtilWeightedChoice *self, id<JavaUtilMap> item_weights, jdouble threshold) {
  EduUciIcsJungAlgorithmsUtilWeightedChoice_initWithJavaUtilMap_withJavaUtilRandom_withDouble_(self, item_weights, [new_JavaUtilRandom_init() autorelease], threshold);
}
...
void EduUciIcsJungAlgorithmsUtilWeightedChoice_initWithJavaUtilMap_withJavaUtilRandom_(EduUciIcsJungAlgorithmsUtilWeightedChoice *self, id<JavaUtilMap> item_weights, JavaUtilRandom *random) {
  EduUciIcsJungAlgorithmsUtilWeightedChoice_initWithJavaUtilMap_withJavaUtilRandom_withDouble_(self, item_weights, random, EduUciIcsJungAlgorithmsUtilWeightedChoice_DEFAULT_THRESHOLD);
}
...
void EduUciIcsJungAlgorithmsUtilWeightedChoice_initWithJavaUtilMap_withJavaUtilRandom_withDouble_(EduUciIcsJungAlgorithmsUtilWeightedChoice *self, id<JavaUtilMap> item_weights, JavaUtilRandom *random, jdouble threshold) {
  NSObject_init(self);
  if ([((id<JavaUtilMap>) nil_chk(item_weights)) isEmpty]) @throw [new_JavaLangIllegalArgumentException_initWithNSString_(@"Item weights must be non-empty") autorelease];
  jint item_count = [item_weights size];
  EduUciIcsJungAlgorithmsUtilWeightedChoice_setAndConsume_item_pairs_(self, new_JavaUtilArrayList_initWithInt_(item_count));
  jdouble sum = 0;
  for (id<JavaUtilMap_Entry> __strong entry_ in nil_chk([item_weights entrySet])) {
    ...
    if (value <= 0) @throw [new_JavaLangIllegalArgumentException_initWithNSString_(@"Weights must be > 0") autorelease];
    sum += value;
  }
  jdouble bucket_weight = 1.0 / [item_weights size];
  id<JavaUtilQueue> light_weights = [new_JavaUtilLinkedList_init() autorelease];
  id<JavaUtilQueue> heavy_weights = [new_JavaUtilLinkedList_init() autorelease];
  for (id<JavaUtilMap_Entry> __strong entry_ in nil_chk([item_weights entrySet])) {
  ...
  while (![heavy_weights isEmpty] || ![light_weights isEmpty]) {
    ...
    [self->item_pairs_ addWithId:[new_EduUciIcsJungAlgorithmsUtilWeightedChoice_ItemPair_initWithEduUciIcsJungAlgorithmsUtilWeightedChoice_withId_withId_withDouble_(self, light, heavy, light_weight) autorelease]];
  }
  EduUciIcsJungAlgorithmsUtilWeightedChoice_set_random_(self, random);
}
...
void EduUciIcsJungAlgorithmsUtilWeightedChoice_enqueueItemWithId_withDouble_withDouble_withJavaUtilQueue_withJavaUtilQueue_(EduUciIcsJungAlgorithmsUtilWeightedChoice *self, id key, jdouble value, jdouble threshold, id<JavaUtilQueue> light_weights, id<JavaUtilQueue> heavy_weights) {
  if (value < threshold) [((id<JavaUtilQueue>) nil_chk(light_weights)) offerWithId:[new_EduUciIcsJungAlgorithmsUtilWeightedChoice_ItemPair_initWithEduUciIcsJungAlgorithmsUtilWeightedChoice_withId_withId_withDouble_(self, key, nil, value) autorelease]];
  else [((id<JavaUtilQueue>) nil_chk(heavy_weights)) offerWithId:[new_EduUciIcsJungAlgorithmsUtilWeightedChoice_ItemPair_initWithEduUciIcsJungAlgorithmsUtilWeightedChoice_withId_withId_withDouble_(self, nil, key, value) autorelease]];
}
...
void EduUciIcsJungAlgorithmsUtilWeightedChoice_ItemPair_initWithEduUciIcsJungAlgorithmsUtilWeightedChoice_withId_withId_withDouble_(EduUciIcsJungAlgorithmsUtilWeightedChoice_ItemPair *self, EduUciIcsJungAlgorithmsUtilWeightedChoice *outer$, id light, id heavy, jdouble weight) {
  NSObject_init(self);
  EduUciIcsJungAlgorithmsUtilWeightedChoice_ItemPair_set_light_(self, light);
  EduUciIcsJungAlgorithmsUtilWeightedChoice_ItemPair_set_heavy_(self, heavy);
  self->weight_ = weight;
}
