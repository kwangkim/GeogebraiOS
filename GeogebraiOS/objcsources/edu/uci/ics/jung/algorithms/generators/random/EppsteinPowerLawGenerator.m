...
- (id<EduUciIcsJungGraphGraph>)initializeGraph {
  ...
  id<JavaUtilList> vertices = new_JavaUtilArrayList_initWithJavaUtilCollection_([((id<EduUciIcsJungGraphGraph>) nil_chk(graph)) getVertices]);
...
- (id<EduUciIcsJungGraphGraph>)create {
  ...
  for (jint rIdx = 0; rIdx < mNumIterations_; rIdx++) {
    ...
    while (degree == 0);
    id<JavaUtilList> edges = new_JavaUtilArrayList_initWithJavaUtilCollection_([graph getIncidentEdgesWithId:v]);
