...
- (JavaUtilLinkedHashMap *)singleSourceShortestPathWithId:(id)source
  ...
  id<JavaUtilSet> to_get = new_JavaUtilHashSet_init();
  if (targets != nil) {
    ...
    for (id __strong e in nil_chk([self getEdgesToCheckWithId:v])) {
      for (id __strong w in nil_chk([((id<EduUciIcsJungGraphHypergraph>) nil_chk(g_)) getIncidentVerticesWithId:e])) {
        if (![sd->distances_ containsKeyWithId:w]) {
          ...
          if (edge_weight < 0) @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"Edges weights must be non-negative");
...
- (EduUciIcsJungAlgorithmsShortestpathDijkstraDistance_SourceData *)getSourceDataWithId:(id)source {
  ...
  if (sd == nil) sd = new_EduUciIcsJungAlgorithmsShortestpathDijkstraDistance_SourceData_initWithEduUciIcsJungAlgorithmsShortestpathDijkstraDistance_withId_(self, source);
  return sd;
}
...
- (NSNumber *)getDistanceWithId:(id)source
                         withId:(id)target {
  if ([((id<EduUciIcsJungGraphHypergraph>) nil_chk(g_)) containsVertexWithId:target] == NO) @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$@$@", @"Specified target vertex ", target, @" is not part of graph ", g_));
  if ([g_ containsVertexWithId:source] == NO) @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$@$@", @"Specified source vertex ", source, @" is not part of graph ", g_));
...
- (id<JavaUtilMap>)getDistanceMapWithId:(id)source
                 withJavaUtilCollection:(id<JavaUtilCollection>)targets {
  if ([((id<EduUciIcsJungGraphHypergraph>) nil_chk(g_)) containsVertexWithId:source] == NO) @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$@$@", @"Specified source vertex ", source, @" is not part of graph ", g_));
  if ([((id<JavaUtilCollection>) nil_chk(targets)) size] > max_targets_) @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$I", @"size of target set exceeds maximum number of targets allowed: ", self->max_targets_));
...
- (JavaUtilLinkedHashMap *)getDistanceMapWithId:(id)source
  ...
  if ([((id<JavaUtilCollection>) nil_chk([((id<EduUciIcsJungGraphHypergraph>) nil_chk(g_)) getVertices])) containsWithId:source] == NO) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$@$@", @"Specified source vertex ", source, @" is not part of graph ", g_));
  }
  ...
  if (numDests > max_targets_) @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$I", @"numDests must be <= the maximum number of targets allowed: ", self->max_targets_));
...
- (void)reset {
  sourceMap_ = new_JavaUtilHashMap_init();
}
...
- (void)resetWithId:(id)source {
  (void) [((id<JavaUtilMap>) nil_chk(sourceMap_)) putWithId:source withId:nil];
}
...
void EduUciIcsJungAlgorithmsShortestpathDijkstraDistance_initWithEduUciIcsJungGraphHypergraph_withOrgApacheCommonsCollections15Transformer_withBoolean_(EduUciIcsJungAlgorithmsShortestpathDijkstraDistance *self, id<EduUciIcsJungGraphHypergraph> g, id<OrgApacheCommonsCollections15Transformer> nev, jboolean cached) {
  ...
  self->g_ = g;
  self->nev_ = nev;
  self->sourceMap_ = new_JavaUtilHashMap_init();
  self->cached_ = cached;
...
void EduUciIcsJungAlgorithmsShortestpathDijkstraDistance_initWithEduUciIcsJungGraphHypergraph_withOrgApacheCommonsCollections15Transformer_(EduUciIcsJungAlgorithmsShortestpathDijkstraDistance *self, id<EduUciIcsJungGraphHypergraph> g, id<OrgApacheCommonsCollections15Transformer> nev) {
  (void) EduUciIcsJungAlgorithmsShortestpathDijkstraDistance_initWithEduUciIcsJungGraphHypergraph_withOrgApacheCommonsCollections15Transformer_withBoolean_(self, g, nev, YES);
}
...
void EduUciIcsJungAlgorithmsShortestpathDijkstraDistance_initWithEduUciIcsJungGraphGraph_(EduUciIcsJungAlgorithmsShortestpathDijkstraDistance *self, id<EduUciIcsJungGraphGraph> g) {
  (void) EduUciIcsJungAlgorithmsShortestpathDijkstraDistance_initWithEduUciIcsJungGraphHypergraph_withOrgApacheCommonsCollections15Transformer_withBoolean_(self, g, new_OrgApacheCommonsCollections15FunctorsConstantTransformer_initWithId_(JavaLangInteger_valueOfWithInt_(1)), YES);
}
...
void EduUciIcsJungAlgorithmsShortestpathDijkstraDistance_initWithEduUciIcsJungGraphGraph_withBoolean_(EduUciIcsJungAlgorithmsShortestpathDijkstraDistance *self, id<EduUciIcsJungGraphGraph> g, jboolean cached) {
  (void) EduUciIcsJungAlgorithmsShortestpathDijkstraDistance_initWithEduUciIcsJungGraphHypergraph_withOrgApacheCommonsCollections15Transformer_withBoolean_(self, g, new_OrgApacheCommonsCollections15FunctorsConstantTransformer_initWithId_(JavaLangInteger_valueOfWithInt_(1)), cached);
}
...
- (id<JavaUtilMap_Entry>)getNextVertex {
  ...
  (void) [((JavaUtilLinkedHashMap *) nil_chk(distances_)) putWithId:v withId:dist];
  return new_EduUciIcsJungAlgorithmsUtilBasicMapEntry_initWithId_withId_(v, dist);
}

- (void)updateWithId:(id)dest
              withId:(id)tentative_edge
          withDouble:(jdouble)new_dist {
  (void) [((id<JavaUtilMap>) nil_chk(estimatedDistances_)) putWithId:dest withId:JavaLangDouble_valueOfWithDouble_(new_dist)];
...
- (void)createRecordWithId:(id)w
                    withId:(id)e
                withDouble:(jdouble)new_dist {
  (void) [((id<JavaUtilMap>) nil_chk(estimatedDistances_)) putWithId:w withId:JavaLangDouble_valueOfWithDouble_(new_dist)];
...
- (void)restoreVertexWithId:(id)v
  ...
  (void) [((id<JavaUtilMap>) nil_chk(estimatedDistances_)) putWithId:v withId:JavaLangDouble_valueOfWithDouble_(dist)];
  [((EduUciIcsJungAlgorithmsUtilMapBinaryHeap *) nil_chk(unknownVertices_)) addWithId:v];
  (void) [((JavaUtilLinkedHashMap *) nil_chk(distances_)) removeWithId:v];
}
...
void EduUciIcsJungAlgorithmsShortestpathDijkstraDistance_SourceData_initWithEduUciIcsJungAlgorithmsShortestpathDijkstraDistance_withId_(EduUciIcsJungAlgorithmsShortestpathDijkstraDistance_SourceData *self, EduUciIcsJungAlgorithmsShortestpathDijkstraDistance *outer$, id source) {
  ...
  self->distances_ = new_JavaUtilLinkedHashMap_init();
  self->estimatedDistances_ = new_JavaUtilHashMap_init();
  self->unknownVertices_ = new_EduUciIcsJungAlgorithmsUtilMapBinaryHeap_initWithJavaUtilComparator_(new_EduUciIcsJungAlgorithmsShortestpathDijkstraDistance_VertexComparator_initWithJavaUtilMap_(self->estimatedDistances_));
  (void) [((id<JavaUtilMap>) nil_chk(outer$->sourceMap_)) putWithId:source withId:self];
  (void) [self->estimatedDistances_ putWithId:source withId:new_JavaLangDouble_initWithDouble_(0)];
