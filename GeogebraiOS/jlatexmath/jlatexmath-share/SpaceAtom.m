...
//  source: /Users/jacky/GSoC/JLaTeXMathiOS/JLaTeXMathiOS/javasource/org/scilab/forge/jlatexmath/SpaceAtom.java
//
...
- (OrgScilabForgeJlatexmathBox *)createBoxWithOrgScilabForgeJlatexmathTeXEnvironment:(OrgScilabForgeJlatexmathTeXEnvironment *)env {
  if (blankSpace_) {
    if (blankType_ == 0) return [new_OrgScilabForgeJlatexmathStrutBox_initWithFloat_withFloat_withFloat_withFloat_([((OrgScilabForgeJlatexmathTeXEnvironment *) nil_chk(env)) getSpace], 0, 0, 0) autorelease];
    else {
...
+ (void)initialize {
  if (self == [OrgScilabForgeJlatexmathSpaceAtom class]) {
    JreStrongAssignAndConsume(&OrgScilabForgeJlatexmathSpaceAtom_units_, nil, new_JavaUtilHashMap_init());
    {
      [OrgScilabForgeJlatexmathSpaceAtom_units_ putWithId:@"em" withId:JavaLangInteger_valueOfWithInt_(OrgScilabForgeJlatexmathTeXConstants_UNIT_EM)];
      [OrgScilabForgeJlatexmathSpaceAtom_units_ putWithId:@"ex" withId:JavaLangInteger_valueOfWithInt_(OrgScilabForgeJlatexmathTeXConstants_UNIT_EX)];
      [OrgScilabForgeJlatexmathSpaceAtom_units_ putWithId:@"px" withId:JavaLangInteger_valueOfWithInt_(OrgScilabForgeJlatexmathTeXConstants_UNIT_PIXEL)];
      [OrgScilabForgeJlatexmathSpaceAtom_units_ putWithId:@"pix" withId:JavaLangInteger_valueOfWithInt_(OrgScilabForgeJlatexmathTeXConstants_UNIT_PIXEL)];
      [OrgScilabForgeJlatexmathSpaceAtom_units_ putWithId:@"pixel" withId:JavaLangInteger_valueOfWithInt_(OrgScilabForgeJlatexmathTeXConstants_UNIT_PIXEL)];
      [OrgScilabForgeJlatexmathSpaceAtom_units_ putWithId:@"pt" withId:JavaLangInteger_valueOfWithInt_(OrgScilabForgeJlatexmathTeXConstants_UNIT_PT)];
      [OrgScilabForgeJlatexmathSpaceAtom_units_ putWithId:@"bp" withId:JavaLangInteger_valueOfWithInt_(OrgScilabForgeJlatexmathTeXConstants_UNIT_POINT)];
      [OrgScilabForgeJlatexmathSpaceAtom_units_ putWithId:@"pica" withId:JavaLangInteger_valueOfWithInt_(OrgScilabForgeJlatexmathTeXConstants_UNIT_PICA)];
      [OrgScilabForgeJlatexmathSpaceAtom_units_ putWithId:@"pc" withId:JavaLangInteger_valueOfWithInt_(OrgScilabForgeJlatexmathTeXConstants_UNIT_PICA)];
      [OrgScilabForgeJlatexmathSpaceAtom_units_ putWithId:@"mu" withId:JavaLangInteger_valueOfWithInt_(OrgScilabForgeJlatexmathTeXConstants_UNIT_MU)];
      [OrgScilabForgeJlatexmathSpaceAtom_units_ putWithId:@"cm" withId:JavaLangInteger_valueOfWithInt_(OrgScilabForgeJlatexmathTeXConstants_UNIT_CM)];
      [OrgScilabForgeJlatexmathSpaceAtom_units_ putWithId:@"mm" withId:JavaLangInteger_valueOfWithInt_(OrgScilabForgeJlatexmathTeXConstants_UNIT_MM)];
      [OrgScilabForgeJlatexmathSpaceAtom_units_ putWithId:@"in" withId:JavaLangInteger_valueOfWithInt_(OrgScilabForgeJlatexmathTeXConstants_UNIT_IN)];
      [OrgScilabForgeJlatexmathSpaceAtom_units_ putWithId:@"sp" withId:JavaLangInteger_valueOfWithInt_(OrgScilabForgeJlatexmathTeXConstants_UNIT_SP)];
      [OrgScilabForgeJlatexmathSpaceAtom_units_ putWithId:@"dd" withId:JavaLangInteger_valueOfWithInt_(OrgScilabForgeJlatexmathTeXConstants_UNIT_DD)];
      [OrgScilabForgeJlatexmathSpaceAtom_units_ putWithId:@"cc" withId:JavaLangInteger_valueOfWithInt_(OrgScilabForgeJlatexmathTeXConstants_UNIT_CC)];
    }
    JreStrongAssignAndConsume(&OrgScilabForgeJlatexmathSpaceAtom_unitConversions_, nil, [IOSObjectArray newArrayWithObjects:(id[]){ [new_OrgScilabForgeJlatexmathSpaceAtom_$1_init() autorelease], [new_OrgScilabForgeJlatexmathSpaceAtom_$2_init() autorelease], [new_OrgScilabForgeJlatexmathSpaceAtom_$3_init() autorelease], [new_OrgScilabForgeJlatexmathSpaceAtom_$4_init() autorelease], [new_OrgScilabForgeJlatexmathSpaceAtom_$5_init() autorelease], [new_OrgScilabForgeJlatexmathSpaceAtom_$6_init() autorelease], [new_OrgScilabForgeJlatexmathSpaceAtom_$7_init() autorelease], [new_OrgScilabForgeJlatexmathSpaceAtom_$8_init() autorelease], [new_OrgScilabForgeJlatexmathSpaceAtom_$9_init() autorelease], [new_OrgScilabForgeJlatexmathSpaceAtom_$10_init() autorelease], [new_OrgScilabForgeJlatexmathSpaceAtom_$11_init() autorelease], [new_OrgScilabForgeJlatexmathSpaceAtom_$12_init() autorelease], [new_OrgScilabForgeJlatexmathSpaceAtom_$13_init() autorelease] } count:13 type:OrgScilabForgeJlatexmathSpaceAtom_UnitConversion_class_()]);
...
void OrgScilabForgeJlatexmathSpaceAtom_checkUnitWithInt_(jint unit) {
  ...
  if (unit < 0 || unit >= ((IOSObjectArray *) nil_chk(OrgScilabForgeJlatexmathSpaceAtom_unitConversions_))->size_) @throw [new_OrgScilabForgeJlatexmathExceptionInvalidUnitException_init() autorelease];
}
...
IOSFloatArray *OrgScilabForgeJlatexmathSpaceAtom_getLengthWithNSString_(NSString *lgth) {
  OrgScilabForgeJlatexmathSpaceAtom_initialize();
  if (lgth == nil) {
    return [IOSFloatArray arrayWithFloats:(jfloat[]){ OrgScilabForgeJlatexmathTeXConstants_UNIT_PIXEL, 0.0f } count:2];
  }
  jint i = 0;
  ...
  @catch (JavaLangNumberFormatException *e) {
    return [IOSFloatArray arrayWithFloats:(jfloat[]){ JavaLangFloat_NaN } count:1];
  }
  jint unit;
  ...
  return [IOSFloatArray arrayWithFloats:(jfloat[]){ (jfloat) unit, f } count:2];
}
