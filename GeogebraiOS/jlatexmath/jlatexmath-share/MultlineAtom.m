...
//  source: /Users/jacky/GSoC/JLaTeXMathiOS/JLaTeXMathiOS/javasource/org/scilab/forge/jlatexmath/MultlineAtom.java
//
...
- (OrgScilabForgeJlatexmathBox *)createBoxWithOrgScilabForgeJlatexmathTeXEnvironment:(OrgScilabForgeJlatexmathTeXEnvironment *)env {
  ...
  if (tw == JavaLangFloat_POSITIVE_INFINITY || type_MultlineAtom_ == OrgScilabForgeJlatexmathMultlineAtom_GATHERED) {
    return [((OrgScilabForgeJlatexmathMatrixAtom *) [new_OrgScilabForgeJlatexmathMatrixAtom_initWithBoolean_withOrgScilabForgeJlatexmathArrayOfAtoms_withNSString_(isPartial_, column_, @"") autorelease]) createBoxWithOrgScilabForgeJlatexmathTeXEnvironment:env];
  }
  ...
  [vb addWithOrgScilabForgeJlatexmathBox:[new_OrgScilabForgeJlatexmathHorizontalBox_initWithOrgScilabForgeJlatexmathBox_withFloat_withInt_([at createBoxWithOrgScilabForgeJlatexmathTeXEnvironment:env], tw, alignment) autorelease]];
...
+ (void)initialize {
  if (self == [OrgScilabForgeJlatexmathMultlineAtom class]) {
    JreStrongAssignAndConsume(&OrgScilabForgeJlatexmathMultlineAtom_vsep_in_, nil, new_OrgScilabForgeJlatexmathSpaceAtom_initWithInt_withFloat_withFloat_withFloat_(OrgScilabForgeJlatexmathTeXConstants_UNIT_EX, 0.0f, 1.0f, 0.0f));
...
void OrgScilabForgeJlatexmathMultlineAtom_initWithBoolean_withOrgScilabForgeJlatexmathArrayOfAtoms_withInt_(OrgScilabForgeJlatexmathMultlineAtom *self, jboolean isPartial, OrgScilabForgeJlatexmathArrayOfAtoms *column, jint type) {
  ...
  OrgScilabForgeJlatexmathMultlineAtom_set_column_(self, column);
...
void OrgScilabForgeJlatexmathMultlineAtom_initWithOrgScilabForgeJlatexmathArrayOfAtoms_withInt_(OrgScilabForgeJlatexmathMultlineAtom *self, OrgScilabForgeJlatexmathArrayOfAtoms *column, jint type) {
  OrgScilabForgeJlatexmathMultlineAtom_initWithBoolean_withOrgScilabForgeJlatexmathArrayOfAtoms_withInt_(self, NO, column, type);
}
