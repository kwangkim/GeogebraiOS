...
//  source: /Users/jacky/GSoC/JLaTeXMathiOS/JLaTeXMathiOS/javasource/org/scilab/forge/jlatexmath/exception/SymbolNotFoundException.java
//
...
void OrgScilabForgeJlatexmathExceptionSymbolNotFoundException_initWithNSString_(OrgScilabForgeJlatexmathExceptionSymbolNotFoundException *self, NSString *name) {
  OrgScilabForgeJlatexmathExceptionJMathTeXException_initWithNSString_(self, JreStrcat("$$$$$", @"There's no symbol with the name '", name, @"' defined in '", OrgScilabForgeJlatexmathDefaultTeXFontParser_get_RESOURCE_NAME_(), @"'!"));
}
