...
//  source: /Users/jacky/GSoC/JLaTeXMathiOS/JLaTeXMathiOS/javasource/org/scilab/forge/jlatexmath/ReflectAtom.java
//
...
- (OrgScilabForgeJlatexmathBox *)createBoxWithOrgScilabForgeJlatexmathTeXEnvironment:(OrgScilabForgeJlatexmathTeXEnvironment *)env {
  return [new_OrgScilabForgeJlatexmathReflectBox_initWithOrgScilabForgeJlatexmathBox_([((OrgScilabForgeJlatexmathAtom *) nil_chk(base_)) createBoxWithOrgScilabForgeJlatexmathTeXEnvironment:env]) autorelease];
}
...
void OrgScilabForgeJlatexmathReflectAtom_initWithOrgScilabForgeJlatexmathAtom_(OrgScilabForgeJlatexmathReflectAtom *self, OrgScilabForgeJlatexmathAtom *base) {
  ...
  OrgScilabForgeJlatexmathReflectAtom_set_base_(self, base);
}
