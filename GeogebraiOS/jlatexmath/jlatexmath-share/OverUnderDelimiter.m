...
//  source: /Users/jacky/GSoC/JLaTeXMathiOS/JLaTeXMathiOS/javasource/org/scilab/forge/jlatexmath/OverUnderDelimiter.java
//
...
- (void)addScriptWithOrgScilabForgeJlatexmathAtom:(OrgScilabForgeJlatexmathAtom *)script {
  OrgScilabForgeJlatexmathOverUnderDelimiter_set_script_(self, script);
}
...
- (OrgScilabForgeJlatexmathBox *)createBoxWithOrgScilabForgeJlatexmathTeXEnvironment:(OrgScilabForgeJlatexmathTeXEnvironment *)env {
  ...
  if (max - [b getWidth] > OrgScilabForgeJlatexmathTeXFormula_PREC) {
    b = [new_OrgScilabForgeJlatexmathHorizontalBox_initWithOrgScilabForgeJlatexmathBox_withFloat_withInt_(b, max, OrgScilabForgeJlatexmathTeXConstants_ALIGN_CENTER) autorelease];
  }
  del = [new_OrgScilabForgeJlatexmathVerticalBox_initWithOrgScilabForgeJlatexmathBox_withFloat_withInt_(del, max, OrgScilabForgeJlatexmathTeXConstants_ALIGN_CENTER) autorelease];
  if (scriptBox != nil && max - [scriptBox getWidth] > OrgScilabForgeJlatexmathTeXFormula_PREC) {
    scriptBox = [new_OrgScilabForgeJlatexmathHorizontalBox_initWithOrgScilabForgeJlatexmathBox_withFloat_withInt_(scriptBox, max, OrgScilabForgeJlatexmathTeXConstants_ALIGN_CENTER) autorelease];
  }
  return [new_OrgScilabForgeJlatexmathOverUnderBox_initWithOrgScilabForgeJlatexmathBox_withOrgScilabForgeJlatexmathBox_withOrgScilabForgeJlatexmathBox_withFloat_withBoolean_(b, del, scriptBox, [((OrgScilabForgeJlatexmathBox *) nil_chk([((OrgScilabForgeJlatexmathSpaceAtom *) nil_chk(kern_)) createBoxWithOrgScilabForgeJlatexmathTeXEnvironment:env])) getHeight], over_) autorelease];
}
...
void OrgScilabForgeJlatexmathOverUnderDelimiter_initWithOrgScilabForgeJlatexmathAtom_withOrgScilabForgeJlatexmathAtom_withOrgScilabForgeJlatexmathSymbolAtom_withInt_withFloat_withBoolean_(OrgScilabForgeJlatexmathOverUnderDelimiter *self, OrgScilabForgeJlatexmathAtom *base, OrgScilabForgeJlatexmathAtom *script, OrgScilabForgeJlatexmathSymbolAtom *s, jint kernUnit, jfloat kern, jboolean over) {
  ...
  OrgScilabForgeJlatexmathOverUnderDelimiter_set_base_(self, base);
  OrgScilabForgeJlatexmathOverUnderDelimiter_set_script_(self, script);
  OrgScilabForgeJlatexmathOverUnderDelimiter_set_symbol_(self, s);
  OrgScilabForgeJlatexmathOverUnderDelimiter_setAndConsume_kern_(self, new_OrgScilabForgeJlatexmathSpaceAtom_initWithInt_withFloat_withFloat_withFloat_(kernUnit, 0, kern, 0));
  self->over_ = over;
}
