...
//  source: /Users/jacky/GSoC/JLaTeXMathiOS/JLaTeXMathiOS/javasource/org/scilab/forge/jlatexmath/ColorUtil.java
//
...
+ (void)initialize {
  if (self == [OrgScilabForgeJlatexmathColorUtil class]) {
    JreStrongAssign(&OrgScilabForgeJlatexmathColorUtil_GRAPHICS_FACTORY_, nil, [((OrgScilabForgeJlatexmathPlatformFactoryProvider *) nil_chk(OrgScilabForgeJlatexmathPlatformFactoryProvider_get_INSTANCE_())) getGraphicsFactory]);
    JreStrongAssign(&OrgScilabForgeJlatexmathColorUtil_RED_, nil, [((OrgScilabForgeJlatexmathPlatformGraphicsGraphicsFactory *) nil_chk(OrgScilabForgeJlatexmathColorUtil_GRAPHICS_FACTORY_)) createColorWithInt:255 withInt:0 withInt:0]);
    JreStrongAssign(&OrgScilabForgeJlatexmathColorUtil_BLACK_, nil, [OrgScilabForgeJlatexmathColorUtil_GRAPHICS_FACTORY_ createColorWithInt:0 withInt:0 withInt:0]);
    JreStrongAssign(&OrgScilabForgeJlatexmathColorUtil_WHITE_, nil, [OrgScilabForgeJlatexmathColorUtil_GRAPHICS_FACTORY_ createColorWithInt:255 withInt:255 withInt:255]);
    JreStrongAssign(&OrgScilabForgeJlatexmathColorUtil_BLUE_, nil, [OrgScilabForgeJlatexmathColorUtil_GRAPHICS_FACTORY_ createColorWithInt:0 withInt:0 withInt:255]);
    JreStrongAssign(&OrgScilabForgeJlatexmathColorUtil_GREEN_, nil, [OrgScilabForgeJlatexmathColorUtil_GRAPHICS_FACTORY_ createColorWithInt:0 withInt:255 withInt:0]);
    JreStrongAssign(&OrgScilabForgeJlatexmathColorUtil_CYAN_, nil, [OrgScilabForgeJlatexmathColorUtil_GRAPHICS_FACTORY_ createColorWithInt:0 withInt:255 withInt:255]);
    JreStrongAssign(&OrgScilabForgeJlatexmathColorUtil_MAGENTA_, nil, [OrgScilabForgeJlatexmathColorUtil_GRAPHICS_FACTORY_ createColorWithInt:255 withInt:0 withInt:255]);
    JreStrongAssign(&OrgScilabForgeJlatexmathColorUtil_YELLOW_, nil, [OrgScilabForgeJlatexmathColorUtil_GRAPHICS_FACTORY_ createColorWithInt:255 withInt:255 withInt:0]);
    JreStrongAssignAndConsume(&OrgScilabForgeJlatexmathColorUtil_COLOR_CONSTANTS_, nil, new_JavaUtilHashMap_init());
    {
      [OrgScilabForgeJlatexmathColorUtil_COLOR_CONSTANTS_ putWithId:@"RED" withId:OrgScilabForgeJlatexmathColorUtil_RED_];
      [OrgScilabForgeJlatexmathColorUtil_COLOR_CONSTANTS_ putWithId:@"BLACK" withId:OrgScilabForgeJlatexmathColorUtil_BLACK_];
      [OrgScilabForgeJlatexmathColorUtil_COLOR_CONSTANTS_ putWithId:@"WHITE" withId:OrgScilabForgeJlatexmathColorUtil_WHITE_];
      [OrgScilabForgeJlatexmathColorUtil_COLOR_CONSTANTS_ putWithId:@"BLUE" withId:OrgScilabForgeJlatexmathColorUtil_BLUE_];
      [OrgScilabForgeJlatexmathColorUtil_COLOR_CONSTANTS_ putWithId:@"GREEN" withId:OrgScilabForgeJlatexmathColorUtil_GREEN_];
      [OrgScilabForgeJlatexmathColorUtil_COLOR_CONSTANTS_ putWithId:@"CYAN" withId:OrgScilabForgeJlatexmathColorUtil_CYAN_];
      [OrgScilabForgeJlatexmathColorUtil_COLOR_CONSTANTS_ putWithId:@"MAGENTA" withId:OrgScilabForgeJlatexmathColorUtil_MAGENTA_];
      [OrgScilabForgeJlatexmathColorUtil_COLOR_CONSTANTS_ putWithId:@"YELLOW" withId:OrgScilabForgeJlatexmathColorUtil_YELLOW_];
    }
    JreStrongAssignAndConsume(&OrgScilabForgeJlatexmathColorUtil_sb_, nil, new_JavaLangStringBuilder_initWithNSString_(@"#"));
