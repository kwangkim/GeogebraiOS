...
//  source: /Users/jacky/GSoC/JLaTeXMathiOS/JLaTeXMathiOS/javasource/org/scilab/forge/jlatexmath/exception/SymbolMappingNotFoundException.java
//
...
void OrgScilabForgeJlatexmathExceptionSymbolMappingNotFoundException_initWithNSString_(OrgScilabForgeJlatexmathExceptionSymbolMappingNotFoundException *self, NSString *symbolName) {
  OrgScilabForgeJlatexmathExceptionJMathTeXException_initWithNSString_(self, JreStrcat("$$$$$$$", @"No mapping found for the symbol '", symbolName, @"'! Insert a <", OrgScilabForgeJlatexmathDefaultTeXFontParser_get_SYMBOL_MAPPING_EL_(), @">-element in '", OrgScilabForgeJlatexmathDefaultTeXFontParser_get_RESOURCE_NAME_(), @"'."));
}
