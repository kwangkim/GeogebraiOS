...
//  source: /Users/jacky/GSoC/JLaTeXMathiOS/JLaTeXMathiOS/javasource/org/scilab/forge/jlatexmath/platform/Resource.java
//
...
void OrgScilabForgeJlatexmathPlatformResource_init(OrgScilabForgeJlatexmathPlatformResource *self) {
  NSObject_init(self);
  OrgScilabForgeJlatexmathPlatformResource_set_resourceLoader_(self, [((id<OrgScilabForgeJlatexmathPlatformResourcesResourceLoaderFactory>) nil_chk([((OrgScilabForgeJlatexmathPlatformFactoryProvider *) nil_chk(OrgScilabForgeJlatexmathPlatformFactoryProvider_get_INSTANCE_())) createResourceLoaderFactory])) createResourceLoader]);
}
