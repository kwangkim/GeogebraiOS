...
//  source: /Users/jacky/GSoC/JLaTeXMathiOS/JLaTeXMathiOS/javasource/org/scilab/forge/jlatexmath/VRowAtom.java
//
...
- (void)setRaiseWithInt:(jint)unit
              withFloat:(jfloat)r {
  OrgScilabForgeJlatexmathVRowAtom_setAndConsume_raise_(self, new_OrgScilabForgeJlatexmathSpaceAtom_initWithInt_withFloat_withFloat_withFloat_(unit, r, 0, 0));
}
...
- (OrgScilabForgeJlatexmathBox *)createBoxWithOrgScilabForgeJlatexmathTeXEnvironment:(OrgScilabForgeJlatexmathTeXEnvironment *)env {
  ...
  OrgScilabForgeJlatexmathBox *interline = [new_OrgScilabForgeJlatexmathStrutBox_initWithFloat_withFloat_withFloat_withFloat_(0, [((OrgScilabForgeJlatexmathTeXEnvironment *) nil_chk(env)) getInterline], 0, 0) autorelease];
...
void OrgScilabForgeJlatexmathVRowAtom_init(OrgScilabForgeJlatexmathVRowAtom *self) {
  ...
  OrgScilabForgeJlatexmathVRowAtom_setAndConsume_elements_(self, new_JavaUtilLinkedList_init());
  OrgScilabForgeJlatexmathVRowAtom_setAndConsume_raise_(self, new_OrgScilabForgeJlatexmathSpaceAtom_initWithInt_withFloat_withFloat_withFloat_(OrgScilabForgeJlatexmathTeXConstants_UNIT_EX, 0, 0, 0));
