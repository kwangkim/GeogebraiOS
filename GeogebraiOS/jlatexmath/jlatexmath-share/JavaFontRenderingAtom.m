...
//  source: /Users/jacky/GSoC/JLaTeXMathiOS/JLaTeXMathiOS/javasource/org/scilab/forge/jlatexmath/JavaFontRenderingAtom.java
//
...
- (OrgScilabForgeJlatexmathBox *)createBoxWithOrgScilabForgeJlatexmathTeXEnvironment:(OrgScilabForgeJlatexmathTeXEnvironment *)env {
  if (fontInfos_ == nil) {
    return [new_OrgScilabForgeJlatexmathJavaFontRenderingBox_initWithNSString_withInt_withFloat_(str_, type_JavaFontRenderingAtom_, OrgScilabForgeJlatexmathDefaultTeXFont_getSizeFactorWithInt_([((OrgScilabForgeJlatexmathTeXEnvironment *) nil_chk(env)) getStyle])) autorelease];
  }
  else {
    ...
    return [new_OrgScilabForgeJlatexmathJavaFontRenderingBox_initWithNSString_withInt_withFloat_withOrgScilabForgeJlatexmathPlatformFontFont_withBoolean_(str_, type, OrgScilabForgeJlatexmathDefaultTeXFont_getSizeFactorWithInt_([env getStyle]), font, kerning) autorelease];
  }
}
...
void OrgScilabForgeJlatexmathJavaFontRenderingAtom_initWithNSString_withInt_(OrgScilabForgeJlatexmathJavaFontRenderingAtom *self, NSString *str, jint type) {
  ...
  OrgScilabForgeJlatexmathJavaFontRenderingAtom_set_str_(self, str);
...
void OrgScilabForgeJlatexmathJavaFontRenderingAtom_initWithNSString_withOrgScilabForgeJlatexmathTeXFormula_FontInfos_(OrgScilabForgeJlatexmathJavaFontRenderingAtom *self, NSString *str, OrgScilabForgeJlatexmathTeXFormula_FontInfos *fontInfos) {
  OrgScilabForgeJlatexmathJavaFontRenderingAtom_initWithNSString_withInt_(self, str, 0);
  OrgScilabForgeJlatexmathJavaFontRenderingAtom_set_fontInfos_(self, fontInfos);
}
