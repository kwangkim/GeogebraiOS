...
+ (void)initialize {
  if (self == [OrgScilabForgeJlatexmathNewCommandMacro class]) {
    JreStrongAssignAndConsume(&OrgScilabForgeJlatexmathNewCommandMacro_macrocode_, nil, new_JavaUtilHashMap_init());
    JreStrongAssignAndConsume(&OrgScilabForgeJlatexmathNewCommandMacro_macroreplacement_, nil, new_JavaUtilHashMap_init());
...
void OrgScilabForgeJlatexmathNewCommandMacro_addNewCommandWithNSString_withNSString_withInt_(NSString *name, NSString *code, jint nbargs) {
  ...
  [((JavaUtilHashMap *) nil_chk(OrgScilabForgeJlatexmathNewCommandMacro_macrocode_)) putWithId:name withId:code];
  [((JavaUtilHashMap *) nil_chk(OrgScilabForgeJlatexmathMacroInfo_get_Commands_())) putWithId:name withId:[new_OrgScilabForgeJlatexmathMacroInfo_initWithOrgScilabForgeJlatexmathMacro_withInt_([new_OrgScilabForgeJlatexmathNewCommandMacro_init() autorelease], nbargs) autorelease]];
}
...
void OrgScilabForgeJlatexmathNewCommandMacro_addNewCommandWithNSString_withNSString_withInt_withNSString_(NSString *name, NSString *code, jint nbargs, NSString *def) {
  OrgScilabForgeJlatexmathNewCommandMacro_initialize();
  if ([((JavaUtilHashMap *) nil_chk(OrgScilabForgeJlatexmathNewCommandMacro_macrocode_)) getWithId:name] != nil) @throw [new_OrgScilabForgeJlatexmathExceptionParseException_initWithNSString_(JreStrcat("$$$", @"Command ", name, @" already exists ! Use renewcommand instead ...")) autorelease];
  [OrgScilabForgeJlatexmathNewCommandMacro_macrocode_ putWithId:name withId:code];
  [((JavaUtilHashMap *) nil_chk(OrgScilabForgeJlatexmathNewCommandMacro_macroreplacement_)) putWithId:name withId:def];
  [((JavaUtilHashMap *) nil_chk(OrgScilabForgeJlatexmathMacroInfo_get_Commands_())) putWithId:name withId:[new_OrgScilabForgeJlatexmathMacroInfo_initWithOrgScilabForgeJlatexmathMacro_withInt_withInt_([new_OrgScilabForgeJlatexmathNewCommandMacro_init() autorelease], nbargs, 1) autorelease]];
}
...
void OrgScilabForgeJlatexmathNewCommandMacro_addReNewCommandWithNSString_withNSString_withInt_(NSString *name, NSString *code, jint nbargs) {
  OrgScilabForgeJlatexmathNewCommandMacro_initialize();
  if ([((JavaUtilHashMap *) nil_chk(OrgScilabForgeJlatexmathNewCommandMacro_macrocode_)) getWithId:name] == nil) @throw [new_OrgScilabForgeJlatexmathExceptionParseException_initWithNSString_(JreStrcat("$$$", @"Command ", name, @" is not defined ! Use newcommand instead ...")) autorelease];
  [OrgScilabForgeJlatexmathNewCommandMacro_macrocode_ putWithId:name withId:code];
  [((JavaUtilHashMap *) nil_chk(OrgScilabForgeJlatexmathMacroInfo_get_Commands_())) putWithId:name withId:[new_OrgScilabForgeJlatexmathMacroInfo_initWithOrgScilabForgeJlatexmathMacro_withInt_([new_OrgScilabForgeJlatexmathNewCommandMacro_init() autorelease], nbargs) autorelease]];
}
