...
//  source: /Users/jacky/GSoC/JLaTeXMathiOS/JLaTeXMathiOS/javasource/org/scilab/forge/jlatexmath/NewEnvironmentMacro.java
//
...
void OrgScilabForgeJlatexmathNewEnvironmentMacro_addReNewEnvironmentWithNSString_withNSString_withNSString_withInt_(NSString *name, NSString *begdef, NSString *enddef, jint nbArgs) {
  OrgScilabForgeJlatexmathNewEnvironmentMacro_initialize();
  if ([((JavaUtilHashMap *) nil_chk(OrgScilabForgeJlatexmathNewCommandMacro_get_macrocode_())) getWithId:JreStrcat("$$", name, @"@env")] == nil) @throw [new_OrgScilabForgeJlatexmathExceptionParseException_initWithNSString_(JreStrcat("$$$", @"Environment ", name, @"is not defined ! Use newenvironment instead ...")) autorelease];
