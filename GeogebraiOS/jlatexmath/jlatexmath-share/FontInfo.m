...
//  source: /Users/jacky/GSoC/JLaTeXMathiOS/JLaTeXMathiOS/javasource/org/scilab/forge/jlatexmath/FontInfo.java
//
...
- (void)addKernWithChar:(jchar)left
              ...
              withFloat:(jfloat)k {
  [((id<JavaUtilMap>) nil_chk(kern_)) putWithId:[new_OrgScilabForgeJlatexmathFontInfo_CharCouple_initWithOrgScilabForgeJlatexmathFontInfo_withChar_withChar_(self, left, right) autorelease] withId:[new_JavaLangFloat_initWithFloat_(k) autorelease]];
}

- (void)addLigatureWithChar:(jchar)left
                   withChar:(jchar)right
                   withChar:(jchar)ligChar {
  [((id<JavaUtilMap>) nil_chk(lig_)) putWithId:[new_OrgScilabForgeJlatexmathFontInfo_CharCouple_initWithOrgScilabForgeJlatexmathFontInfo_withChar_withChar_(self, left, right) autorelease] withId:[new_JavaLangCharacter_initWithChar_(ligChar) autorelease]];
}
...
- (jfloat)getKernWithChar:(jchar)left
  ...
  id obj = [((id<JavaUtilMap>) nil_chk(kern_)) getWithId:[new_OrgScilabForgeJlatexmathFontInfo_CharCouple_initWithOrgScilabForgeJlatexmathFontInfo_withChar_withChar_(self, left, right) autorelease]];
  if (obj == nil) return 0;
...
- (OrgScilabForgeJlatexmathCharFont *)getLigatureWithChar:(jchar)left
                                                 withChar:(jchar)right {
  id obj = [((id<JavaUtilMap>) nil_chk(lig_)) getWithId:[new_OrgScilabForgeJlatexmathFontInfo_CharCouple_initWithOrgScilabForgeJlatexmathFontInfo_withChar_withChar_(self, left, right) autorelease]];
  if (obj == nil) return nil;
  else return [new_OrgScilabForgeJlatexmathCharFont_initWithChar_withInt_([((JavaLangCharacter *) check_class_cast(obj, [JavaLangCharacter class])) charValue], fontId_) autorelease];
}
...
- (void)setExtensionWithChar:(jchar)ch
  ...
  if (unicode_ == nil) IOSObjectArray_Set(nil_chk(extensions_), ch, ext);
  else if (![unicode_ containsKeyWithId:JavaLangCharacter_valueOfWithChar_(ch)]) {
    jchar s = (jchar) [unicode_ size];
    [unicode_ putWithId:JavaLangCharacter_valueOfWithChar_(ch) withId:JavaLangCharacter_valueOfWithChar_(s)];
    IOSObjectArray_Set(nil_chk(extensions_), s, ext);
  }
  else IOSObjectArray_Set(nil_chk(extensions_), [((JavaLangCharacter *) nil_chk([unicode_ getWithId:JavaLangCharacter_valueOfWithChar_(ch)])) charValue], ext);
}

- (void)setMetricsWithChar:(jchar)c
            withFloatArray:(IOSFloatArray *)arr {
  if (unicode_ == nil) IOSObjectArray_Set(nil_chk(metrics_), c, arr);
  else if (![unicode_ containsKeyWithId:JavaLangCharacter_valueOfWithChar_(c)]) {
    jchar s = (jchar) [unicode_ size];
    [unicode_ putWithId:JavaLangCharacter_valueOfWithChar_(c) withId:JavaLangCharacter_valueOfWithChar_(s)];
    IOSObjectArray_Set(nil_chk(metrics_), s, arr);
  }
  else IOSObjectArray_Set(nil_chk(metrics_), [((JavaLangCharacter *) nil_chk([unicode_ getWithId:JavaLangCharacter_valueOfWithChar_(c)])) charValue], arr);
}

- (void)setNextLargerWithChar:(jchar)ch
                     withChar:(jchar)larger
                      withInt:(jint)fontLarger {
  if (unicode_ == nil) IOSObjectArray_SetAndConsume(nil_chk(nextLarger_), ch, new_OrgScilabForgeJlatexmathCharFont_initWithChar_withInt_(larger, fontLarger));
  else if (![unicode_ containsKeyWithId:JavaLangCharacter_valueOfWithChar_(ch)]) {
    jchar s = (jchar) [unicode_ size];
    [unicode_ putWithId:JavaLangCharacter_valueOfWithChar_(ch) withId:JavaLangCharacter_valueOfWithChar_(s)];
    IOSObjectArray_SetAndConsume(nil_chk(nextLarger_), s, new_OrgScilabForgeJlatexmathCharFont_initWithChar_withInt_(larger, fontLarger));
  }
  else IOSObjectArray_SetAndConsume(nil_chk(nextLarger_), [((JavaLangCharacter *) nil_chk([unicode_ getWithId:JavaLangCharacter_valueOfWithChar_(ch)])) charValue], new_OrgScilabForgeJlatexmathCharFont_initWithChar_withInt_(larger, fontLarger));
}
...
- (id<OrgScilabForgeJlatexmathPlatformFontFont>)getFont {
  if (font_ == nil) {
    if (base_ == nil) {
      OrgScilabForgeJlatexmathFontInfo_set_font_(self, OrgScilabForgeJlatexmathDefaultTeXFontParser_createFontWithNSString_(path_));
    }
    else {
      OrgScilabForgeJlatexmathFontInfo_set_font_(self, OrgScilabForgeJlatexmathDefaultTeXFontParser_createFontWithId_withNSString_(base_, path_));
    }
  }
  return font_;
}
...
- (void)dealloc {
  ...
  RELEASE_(kern_);
  RELEASE_(metrics_);
  RELEASE_(nextLarger_);
  RELEASE_(extensions_);
  RELEASE_(unicode_);
  RELEASE_(boldVersion_);
  RELEASE_(romanVersion_);
  RELEASE_(ssVersion_);
  RELEASE_(ttVersion_);
  RELEASE_(itVersion_);
  [super dealloc];
...
+ (void)initialize {
  if (self == [OrgScilabForgeJlatexmathFontInfo class]) {
    JreStrongAssignAndConsume(&OrgScilabForgeJlatexmathFontInfo_fonts_, nil, new_JavaUtilHashMap_init());
...
void OrgScilabForgeJlatexmathFontInfo_initWithInt_withId_withNSString_withNSString_withInt_withFloat_withFloat_withFloat_withNSString_withNSString_withNSString_withNSString_withNSString_(OrgScilabForgeJlatexmathFontInfo *self, jint fontId, id base, NSString *path, NSString *fontName, jint unicode, jfloat xHeight, jfloat space, jfloat quad, NSString *boldVersion, NSString *romanVersion, NSString *ssVersion, NSString *ttVersion, NSString *itVersion) {
  NSObject_init(self);
  OrgScilabForgeJlatexmathFontInfo_setAndConsume_lig_(self, new_JavaUtilHashMap_init());
  OrgScilabForgeJlatexmathFontInfo_setAndConsume_kern_(self, new_JavaUtilHashMap_init());
  OrgScilabForgeJlatexmathFontInfo_set_unicode_(self, nil);
  self->skewChar_ = (jchar) -1;
  self->fontId_ = fontId;
  OrgScilabForgeJlatexmathFontInfo_set_base_(self, base);
  OrgScilabForgeJlatexmathFontInfo_set_path_(self, path);
  OrgScilabForgeJlatexmathFontInfo_set_fontName_(self, fontName);
  self->xHeight_ = xHeight;
  self->space_ = space;
  self->quad_ = quad;
  OrgScilabForgeJlatexmathFontInfo_set_boldVersion_(self, boldVersion);
  OrgScilabForgeJlatexmathFontInfo_set_romanVersion_(self, romanVersion);
  OrgScilabForgeJlatexmathFontInfo_set_ssVersion_(self, ssVersion);
  OrgScilabForgeJlatexmathFontInfo_set_ttVersion_(self, ttVersion);
  OrgScilabForgeJlatexmathFontInfo_set_itVersion_(self, itVersion);
  jint num = OrgScilabForgeJlatexmathFontInfo_NUMBER_OF_CHAR_CODES;
  if (unicode != 0) {
    OrgScilabForgeJlatexmathFontInfo_setAndConsume_unicode_(self, new_JavaUtilHashMap_initWithInt_(unicode));
    num = unicode;
  }
  OrgScilabForgeJlatexmathFontInfo_setAndConsume_metrics_(self, [IOSObjectArray newArrayWithLength:num type:IOSClass_floatArray(1)]);
  OrgScilabForgeJlatexmathFontInfo_setAndConsume_nextLarger_(self, [IOSObjectArray newArrayWithLength:num type:OrgScilabForgeJlatexmathCharFont_class_()]);
  OrgScilabForgeJlatexmathFontInfo_setAndConsume_extensions_(self, [IOSObjectArray newArrayWithLength:num type:IOSClass_intArray(1)]);
  [((id<JavaUtilMap>) nil_chk(OrgScilabForgeJlatexmathFontInfo_fonts_)) putWithId:JavaLangInteger_valueOfWithInt_(fontId) withId:self];
}
