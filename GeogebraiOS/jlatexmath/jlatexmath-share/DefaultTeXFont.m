...
//  source: /Users/jacky/GSoC/JLaTeXMathiOS/JLaTeXMathiOS/javasource/org/scilab/forge/jlatexmath/DefaultTeXFont.java
//
...
- (id<OrgScilabForgeJlatexmathTeXFont>)copy__ {
  return [new_OrgScilabForgeJlatexmathDefaultTeXFont_initWithFloat_withFloat_withBoolean_withBoolean_withBoolean_withBoolean_withBoolean_(size_, factor_, isBold_, isRoman_, isSs_, isTt_, isIt_) autorelease];
}

- (id<OrgScilabForgeJlatexmathTeXFont>)deriveFontWithFloat:(jfloat)size {
  return [new_OrgScilabForgeJlatexmathDefaultTeXFont_initWithFloat_withFloat_withBoolean_withBoolean_withBoolean_withBoolean_withBoolean_(size, factor_, isBold_, isRoman_, isSs_, isTt_, isIt_) autorelease];
}

- (id<OrgScilabForgeJlatexmathTeXFont>)scaleFontWithFloat:(jfloat)factor {
  return [new_OrgScilabForgeJlatexmathDefaultTeXFont_initWithFloat_withFloat_withBoolean_withBoolean_withBoolean_withBoolean_withBoolean_(size_, factor, isBold_, isRoman_, isSs_, isTt_, isIt_) autorelease];
}
...
- (OrgScilabForgeJlatexmathChar *)getCharWithChar:(jchar)c
  ...
  if (mapping == nil) @throw [new_OrgScilabForgeJlatexmathExceptionTextStyleMappingNotFoundException_initWithNSString_(textStyle) autorelease];
...
- (OrgScilabForgeJlatexmathChar *)getCharWithOrgScilabForgeJlatexmathCharFont:(OrgScilabForgeJlatexmathCharFont *)cf
  ...
  if (isBold_ && ((OrgScilabForgeJlatexmathCharFont *) nil_chk(cf))->fontId_ == cf->boldFontId_) {
    ...
    cf = [new_OrgScilabForgeJlatexmathCharFont_initWithChar_withInt_withInt_(cf->c_, id_, style) autorelease];
  }
  if (isRoman_) {
    id_ = [((OrgScilabForgeJlatexmathFontInfo *) nil_chk(info)) getRomanId];
    info = IOSObjectArray_Get(OrgScilabForgeJlatexmathDefaultTeXFont_fontInfo_, id_);
    cf = [new_OrgScilabForgeJlatexmathCharFont_initWithChar_withInt_withInt_(((OrgScilabForgeJlatexmathCharFont *) nil_chk(cf))->c_, id_, style) autorelease];
  }
  if (isSs_) {
...
- (OrgScilabForgeJlatexmathChar *)getCharWithNSString:(NSString *)symbolName
  ...
  if (obj == nil) {
    @throw [new_OrgScilabForgeJlatexmathExceptionSymbolMappingNotFoundException_initWithNSString_(symbolName) autorelease];
  }
  else {
...
- (jfloat)getSkewWithOrgScilabForgeJlatexmathCharFont:(OrgScilabForgeJlatexmathCharFont *)cf
  ...
  if (skew == -1) return 0;
  else return [self getKernWithOrgScilabForgeJlatexmathCharFont:cf withOrgScilabForgeJlatexmathCharFont:[new_OrgScilabForgeJlatexmathCharFont_initWithChar_withInt_(skew, cf->fontId_) autorelease] withInt:style];
}
...
+ (void)initialize {
  if (self == [OrgScilabForgeJlatexmathDefaultTeXFont class]) {
    JreStrongAssignAndConsume(&OrgScilabForgeJlatexmathDefaultTeXFont_fontInfo_, nil, [IOSObjectArray newArrayWithLength:0 type:OrgScilabForgeJlatexmathFontInfo_class_()]);
    JreStrongAssignAndConsume(&OrgScilabForgeJlatexmathDefaultTeXFont_loadedAlphabets_, nil, new_JavaUtilArrayList_init());
    JreStrongAssignAndConsume(&OrgScilabForgeJlatexmathDefaultTeXFont_registeredAlphabets_, nil, new_JavaUtilHashMap_init());
    {
      OrgScilabForgeJlatexmathDefaultTeXFontParser *parser = [new_OrgScilabForgeJlatexmathDefaultTeXFontParser_init() autorelease];
      ...
      JreStrongAssign(&OrgScilabForgeJlatexmathDefaultTeXFont_fontInfo_, nil, [parser parseFontDescriptionsWithOrgScilabForgeJlatexmathFontInfoArray:OrgScilabForgeJlatexmathDefaultTeXFont_fontInfo_]);
      JreStrongAssign(&OrgScilabForgeJlatexmathDefaultTeXFont_parameters_, nil, [parser parseParameters]);
      JreStrongAssign(&OrgScilabForgeJlatexmathDefaultTeXFont_textStyleMappings_, nil, [parser parseTextStyleMappings]);
      JreStrongAssign(&OrgScilabForgeJlatexmathDefaultTeXFont_defaultTextStyleMappings_, nil, [parser parseDefaultTextStyleMappings]);
      JreStrongAssign(&OrgScilabForgeJlatexmathDefaultTeXFont_symbolMappings_, nil, [parser parseSymbolMappings]);
      JreStrongAssign(&OrgScilabForgeJlatexmathDefaultTeXFont_generalSettings_, nil, [parser parseGeneralSettings]);
      [((id<JavaUtilMap>) nil_chk(OrgScilabForgeJlatexmathDefaultTeXFont_generalSettings_)) putWithId:@"textfactor" withId:JavaLangInteger_valueOfWithInt_(1)];
...
void OrgScilabForgeJlatexmathDefaultTeXFont_initWithFloat_withBoolean_withBoolean_withBoolean_withBoolean_withBoolean_(OrgScilabForgeJlatexmathDefaultTeXFont *self, jfloat pointSize, jboolean b, jboolean rm, jboolean ss, jboolean tt, jboolean it) {
  OrgScilabForgeJlatexmathDefaultTeXFont_initWithFloat_withFloat_withBoolean_withBoolean_withBoolean_withBoolean_withBoolean_(self, pointSize, 1, b, rm, ss, tt, it);
}
...
void OrgScilabForgeJlatexmathDefaultTeXFont_addTeXFontDescriptionWithId_withNSString_(id inArg, NSString *name) {
  OrgScilabForgeJlatexmathDefaultTeXFont_initialize();
  OrgScilabForgeJlatexmathDefaultTeXFontParser *dtfp = [new_OrgScilabForgeJlatexmathDefaultTeXFontParser_initWithId_withNSString_(inArg, name) autorelease];
  JreStrongAssign(&OrgScilabForgeJlatexmathDefaultTeXFont_fontInfo_, nil, [dtfp parseFontDescriptionsWithOrgScilabForgeJlatexmathFontInfoArray:OrgScilabForgeJlatexmathDefaultTeXFont_fontInfo_]);
...
void OrgScilabForgeJlatexmathDefaultTeXFont_addTeXFontDescriptionWithId_withId_withNSString_(id base, id inArg, NSString *name) {
  OrgScilabForgeJlatexmathDefaultTeXFont_initialize();
  OrgScilabForgeJlatexmathDefaultTeXFontParser *dtfp = [new_OrgScilabForgeJlatexmathDefaultTeXFontParser_initWithId_withId_withNSString_(base, inArg, name) autorelease];
  JreStrongAssign(&OrgScilabForgeJlatexmathDefaultTeXFont_fontInfo_, nil, [dtfp parseFontDescriptionsWithOrgScilabForgeJlatexmathFontInfoArray:OrgScilabForgeJlatexmathDefaultTeXFont_fontInfo_]);
  [dtfp parseExtraPath];
  [((id<JavaUtilMap>) nil_chk(OrgScilabForgeJlatexmathDefaultTeXFont_textStyleMappings_)) putAllWithJavaUtilMap:[dtfp parseTextStyleMappings]];
  [((id<JavaUtilMap>) nil_chk(OrgScilabForgeJlatexmathDefaultTeXFont_symbolMappings_)) putAllWithJavaUtilMap:[dtfp parseSymbolMappings]];
...
void OrgScilabForgeJlatexmathDefaultTeXFont_addAlphabetWithId_withOrgScilabForgeJlatexmathCharacterCharacter_UnicodeBlockArray_withNSString_(id base, IOSObjectArray *alphabet, NSString *language) {
  ...
  if (!b) {
    *OrgScilabForgeJlatexmathTeXParser_getRef_isLoading_() = YES;
    OrgScilabForgeJlatexmathDefaultTeXFont_addTeXFontDescriptionWithId_withId_withNSString_(base, [((OrgScilabForgeJlatexmathPlatformResource *) [new_OrgScilabForgeJlatexmathPlatformResource_init() autorelease]) loadResourceWithId:base withNSString:language], language);
...
void OrgScilabForgeJlatexmathDefaultTeXFont_registerAlphabetWithOrgScilabForgeJlatexmathAlphabetRegistration_(id<OrgScilabForgeJlatexmathAlphabetRegistration> reg) {
  ...
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(blocks))->size_; i++) {
    [((id<JavaUtilMap>) nil_chk(OrgScilabForgeJlatexmathDefaultTeXFont_registeredAlphabets_)) putWithId:IOSObjectArray_Get(blocks, i) withId:reg];
  }
}
...
OrgScilabForgeJlatexmathChar *OrgScilabForgeJlatexmathDefaultTeXFont_getCharWithChar_withOrgScilabForgeJlatexmathCharFontArray_withInt_(OrgScilabForgeJlatexmathDefaultTeXFont *self, jchar c, IOSObjectArray *cf, jint style) {
  ...
  else return [self getCharWithOrgScilabForgeJlatexmathCharFont:[new_OrgScilabForgeJlatexmathCharFont_initWithChar_withInt_((jchar) (((OrgScilabForgeJlatexmathCharFont *) nil_chk(IOSObjectArray_Get(cf, kind)))->c_ + offset), ((OrgScilabForgeJlatexmathCharFont *) nil_chk(IOSObjectArray_Get(cf, kind)))->fontId_) autorelease] withInt:style];
}
...
void OrgScilabForgeJlatexmathDefaultTeXFont_setMathSizesWithFloat_withFloat_withFloat_withFloat_(jfloat ds, jfloat ts, jfloat ss, jfloat sss) {
  ...
  if (OrgScilabForgeJlatexmathDefaultTeXFont_magnificationEnable_) {
    [((id<JavaUtilMap>) nil_chk(OrgScilabForgeJlatexmathDefaultTeXFont_generalSettings_)) putWithId:@"scriptfactor" withId:JavaLangFloat_valueOfWithFloat_(JavaLangMath_absWithFloat_(ss / ds))];
    [OrgScilabForgeJlatexmathDefaultTeXFont_generalSettings_ putWithId:@"scriptscriptfactor" withId:JavaLangFloat_valueOfWithFloat_(JavaLangMath_absWithFloat_(sss / ds))];
    [OrgScilabForgeJlatexmathDefaultTeXFont_generalSettings_ putWithId:@"textfactor" withId:JavaLangFloat_valueOfWithFloat_(JavaLangMath_absWithFloat_(ts / ds))];
