...
//  source: /Users/jacky/GSoC/JLaTeXMathiOS/JLaTeXMathiOS/javasource/org/scilab/forge/jlatexmath/TeXParser.java
//
...
- (void)resetWithNSString:(NSString *)latex {
  OrgScilabForgeJlatexmathTeXParser_setAndConsume_parseString_(self, new_JavaLangStringBuffer_initWithNSString_(latex));
  len_ = [parseString_ length];
  OrgScilabForgeJlatexmathTeXFormula_set_root_(nil_chk(formula_), nil);
  pos_ = 0;
  spos_ = 0;
  line_ = 0;
  col_ = 0;
...
- (OrgScilabForgeJlatexmathAtom *)getLastAtom {
  ...
  OrgScilabForgeJlatexmathTeXFormula_set_root_(formula_, nil);
  return at;
}
...
- (void)addAtomWithOrgScilabForgeJlatexmathAtom:(OrgScilabForgeJlatexmathAtom *)at {
  [((OrgScilabForgeJlatexmathTeXFormula *) nil_chk(formula_)) addWithOrgScilabForgeJlatexmathAtom:at];
}
...
- (void)addRow {
  if (!arrayMode_) @throw [new_OrgScilabForgeJlatexmathExceptionParseException_initWithNSString_(@"You can add a row only in array mode !") autorelease];
...
- (void)parse {
      ...
      ch = [((JavaLangStringBuffer *) nil_chk(parseString_)) charAtWithInt:pos_];
      {
        ...
        switch (ch) {
          ...
          if (!ignoreWhiteSpace_) {
            [((OrgScilabForgeJlatexmathTeXFormula *) nil_chk(formula_)) addWithOrgScilabForgeJlatexmathAtom:[new_OrgScilabForgeJlatexmathSpaceAtom_init() autorelease]];
            [formula_ addWithOrgScilabForgeJlatexmathAtom:[new_OrgScilabForgeJlatexmathBreakMarkAtom_init() autorelease]];
            while (pos_ < len_) {
          ...
          if (!ignoreWhiteSpace_) {
            ...
            [((OrgScilabForgeJlatexmathTeXFormula *) nil_chk(formula_)) addWithOrgScilabForgeJlatexmathAtom:[new_OrgScilabForgeJlatexmathMathAtom_initWithOrgScilabForgeJlatexmathAtom_withInt_(((OrgScilabForgeJlatexmathTeXFormula *) [new_OrgScilabForgeJlatexmathTeXFormula_initWithOrgScilabForgeJlatexmathTeXParser_withNSString_withBoolean_(self, [self getDollarGroupWithChar:OrgScilabForgeJlatexmathTeXParser_DOLLAR], NO) autorelease])->root_, style) autorelease]];
            if (doubleDollar) {
              if ([parseString_ charAtWithInt:pos_] == OrgScilabForgeJlatexmathTeXParser_DOLLAR) {
                pos_++;
              }
          ...
          [((OrgScilabForgeJlatexmathTeXFormula *) nil_chk(formula_)) addWithOrgScilabForgeJlatexmathAtom:atom];
          break;
          case OrgScilabForgeJlatexmathTeXParser_R_GROUP:
          group_--;
          pos_++;
          if (group_ == -1) @throw [new_OrgScilabForgeJlatexmathExceptionParseException_initWithNSString_(JreStrcat("$C$C$", @"Found a closing '", OrgScilabForgeJlatexmathTeXParser_R_GROUP, @"' without an opening '", OrgScilabForgeJlatexmathTeXParser_L_GROUP, @"'!")) autorelease];
          return;
          case OrgScilabForgeJlatexmathTeXParser_SUPER_SCRIPT:
          [((OrgScilabForgeJlatexmathTeXFormula *) nil_chk(formula_)) addWithOrgScilabForgeJlatexmathAtom:OrgScilabForgeJlatexmathTeXParser_getScriptsWithChar_(self, ch)];
          break;
          ...
          if (ignoreWhiteSpace_) {
            ...
            [((OrgScilabForgeJlatexmathTeXFormula *) nil_chk(formula_)) addWithOrgScilabForgeJlatexmathAtom:[new_OrgScilabForgeJlatexmathUnderscoreAtom_init() autorelease]];
            pos_++;
          }
          break;
          case '&':
          if (!arrayMode_) @throw [new_OrgScilabForgeJlatexmathExceptionParseException_initWithNSString_(@"Character '&' is only available in array mode !") autorelease];
          ...
          if (ignoreWhiteSpace_) {
            ...
            [((OrgScilabForgeJlatexmathTeXFormula *) nil_chk(formula_)) addWithOrgScilabForgeJlatexmathAtom:[self convertCharacterWithChar:OrgScilabForgeJlatexmathTeXParser_PRIME withBoolean:YES]];
          }
          pos_++;
          break;
          case OrgScilabForgeJlatexmathTeXParser_BACKPRIME:
          if (ignoreWhiteSpace_) {
            [((OrgScilabForgeJlatexmathTeXFormula *) nil_chk(formula_)) addWithOrgScilabForgeJlatexmathAtom:[new_OrgScilabForgeJlatexmathCumulativeScriptsAtom_initWithOrgScilabForgeJlatexmathAtom_withOrgScilabForgeJlatexmathAtom_withOrgScilabForgeJlatexmathAtom_([self getLastAtom], nil, OrgScilabForgeJlatexmathSymbolAtom_getWithNSString_(@"backprime")) autorelease]];
          }
          else {
            [((OrgScilabForgeJlatexmathTeXFormula *) nil_chk(formula_)) addWithOrgScilabForgeJlatexmathAtom:[self convertCharacterWithChar:OrgScilabForgeJlatexmathTeXParser_BACKPRIME withBoolean:YES]];
          }
          pos_++;
          break;
          ...
          if (ignoreWhiteSpace_) {
            [((OrgScilabForgeJlatexmathTeXFormula *) nil_chk(formula_)) addWithOrgScilabForgeJlatexmathAtom:[new_OrgScilabForgeJlatexmathCumulativeScriptsAtom_initWithOrgScilabForgeJlatexmathAtom_withOrgScilabForgeJlatexmathAtom_withOrgScilabForgeJlatexmathAtom_([self getLastAtom], nil, OrgScilabForgeJlatexmathSymbolAtom_getWithNSString_(@"prime")) autorelease]];
            [formula_ addWithOrgScilabForgeJlatexmathAtom:[new_OrgScilabForgeJlatexmathCumulativeScriptsAtom_initWithOrgScilabForgeJlatexmathAtom_withOrgScilabForgeJlatexmathAtom_withOrgScilabForgeJlatexmathAtom_([self getLastAtom], nil, OrgScilabForgeJlatexmathSymbolAtom_getWithNSString_(@"prime")) autorelease]];
          }
          else {
            [((OrgScilabForgeJlatexmathTeXFormula *) nil_chk(formula_)) addWithOrgScilabForgeJlatexmathAtom:[self convertCharacterWithChar:OrgScilabForgeJlatexmathTeXParser_PRIME withBoolean:YES]];
            [formula_ addWithOrgScilabForgeJlatexmathAtom:[self convertCharacterWithChar:OrgScilabForgeJlatexmathTeXParser_PRIME withBoolean:YES]];
          }
          pos_++;
          break;
          default:
          [((OrgScilabForgeJlatexmathTeXFormula *) nil_chk(formula_)) addWithOrgScilabForgeJlatexmathAtom:[self convertCharacterWithChar:ch withBoolean:NO]];
          pos_++;
        }
      }
    }
  ...
  if (((OrgScilabForgeJlatexmathTeXFormula *) nil_chk(formula_))->root_ == nil && !arrayMode_) {
    [formula_ addWithOrgScilabForgeJlatexmathAtom:[new_OrgScilabForgeJlatexmathEmptyAtom_init() autorelease]];
  }
}
...
- (NSString *)getGroupWithChar:(jchar)open
  ...
  if (pos_ < len_ && ch == open) {
    ...
    @throw [new_OrgScilabForgeJlatexmathExceptionParseException_initWithNSString_(JreStrcat("$C$", @"missing '", open, @"'!")) autorelease];
  }
}
...
- (NSString *)getGroupWithNSString:(NSString *)open
  ...
  if (group != 0) {
    ...
    @throw [new_OrgScilabForgeJlatexmathExceptionParseException_initWithNSString_(JreStrcat("$$$$", @"The token ", open, @" must be closed by ", close)) autorelease];
  }
...
- (OrgScilabForgeJlatexmathAtom *)getArgument {
  ...
  if (ch == OrgScilabForgeJlatexmathTeXParser_L_GROUP) {
    ...
    OrgScilabForgeJlatexmathTeXParser_set_formula_(self, tf);
    pos_++;
    group_++;
    [self parse];
    OrgScilabForgeJlatexmathTeXParser_set_formula_(self, sformula);
    if (((OrgScilabForgeJlatexmathTeXFormula *) nil_chk(self->formula_))->root_ == nil) {
      OrgScilabForgeJlatexmathRowAtom *at = [new_OrgScilabForgeJlatexmathRowAtom_init() autorelease];
...
- (NSString *)getOverArgument {
  ...
  if (ogroup >= 2) @throw [new_OrgScilabForgeJlatexmathExceptionParseException_initWithNSString_(@"Illegal end,  missing '}' !") autorelease];
  NSString *str;
  if (ogroup == 0) {
...
- (OrgScilabForgeJlatexmathAtom *)convertCharacterWithChar:(jchar)c
  ...
  if (ignoreWhiteSpace_) {
    if (c >= 945 && c <= 969) {
      ...
      return ((OrgScilabForgeJlatexmathTeXFormula *) [new_OrgScilabForgeJlatexmathTeXFormula_initWithNSString_(IOSObjectArray_Get(nil_chk(OrgScilabForgeJlatexmathTeXFormula_get_symbolFormulaMappings_()), c)) autorelease])->root_;
    }
  }
  ...
  if (((c < '0' || c > '9') && (c < 'a' || c > 'z') && (c < 'A' || c > 'Z'))) {
    ...
    if (symbolName == nil && (OrgScilabForgeJlatexmathTeXFormula_get_symbolFormulaMappings_() == nil || IOSObjectArray_Get(OrgScilabForgeJlatexmathTeXFormula_get_symbolFormulaMappings_(), c) == nil)) {
      ...
      if (fontInfos != nil) {
        if (oneChar) {
          return [new_OrgScilabForgeJlatexmathJavaFontRenderingAtom_initWithNSString_withOrgScilabForgeJlatexmathTeXFormula_FontInfos_(OrgScilabForgeJlatexmathCharacterCharacter_toStringWithChar_(c), fontInfos) autorelease];
        }
        jint start = pos_++;
        jint end = len_ - 1;
        while (pos_ < len_) {
        ...
        return [new_OrgScilabForgeJlatexmathJavaFontRenderingAtom_initWithNSString_withOrgScilabForgeJlatexmathTeXFormula_FontInfos_([((JavaLangStringBuffer *) nil_chk(parseString_)) substringWithInt:start withInt:end + 1], fontInfos) autorelease];
      }
      if (!isPartial_) {
        @throw [new_OrgScilabForgeJlatexmathExceptionParseException_initWithNSString_(JreStrcat("$$$IC", @"Unknown character : '", OrgScilabForgeJlatexmathCharacterCharacter_toStringWithChar_(c), @"' (or ", ((jint) c), ')')) autorelease];
      }
      else {
        return [new_OrgScilabForgeJlatexmathColorAtom_initWithOrgScilabForgeJlatexmathAtom_withOrgScilabForgeJlatexmathPlatformGraphicsColor_withOrgScilabForgeJlatexmathPlatformGraphicsColor_([new_OrgScilabForgeJlatexmathRomanAtom_initWithOrgScilabForgeJlatexmathAtom_(((OrgScilabForgeJlatexmathTeXFormula *) [new_OrgScilabForgeJlatexmathTeXFormula_initWithNSString_(JreStrcat("$I$", @"\\text{(Unknown char ", ((jint) c), @")}")) autorelease])->root_) autorelease], nil, OrgScilabForgeJlatexmathColorUtil_get_RED_()) autorelease];
      }
    }
    else {
      if (!ignoreWhiteSpace_) {
      ...
      if (OrgScilabForgeJlatexmathTeXFormula_get_symbolFormulaMappings_() != nil && IOSObjectArray_Get(OrgScilabForgeJlatexmathTeXFormula_get_symbolFormulaMappings_(), c) != nil) {
        return ((OrgScilabForgeJlatexmathTeXFormula *) [new_OrgScilabForgeJlatexmathTeXFormula_initWithNSString_(IOSObjectArray_Get(OrgScilabForgeJlatexmathTeXFormula_get_symbolFormulaMappings_(), c)) autorelease])->root_;
      }
      @try {
      ...
      @catch (OrgScilabForgeJlatexmathExceptionSymbolNotFoundException *e) {
        @throw [new_OrgScilabForgeJlatexmathExceptionParseException_initWithNSString_withJavaLangThrowable_(JreStrcat("$$$$$", @"The character '", OrgScilabForgeJlatexmathCharacterCharacter_toStringWithChar_(c), @"' was mapped to an unknown symbol with the name '", symbolName, @"'!"), e) autorelease];
      }
    }
  }
  else {
    ...
    return [new_OrgScilabForgeJlatexmathCharAtom_initWithChar_withNSString_(c, ((OrgScilabForgeJlatexmathTeXFormula *) nil_chk(formula_))->textStyle_) autorelease];
  }
}
...
- (IOSObjectArray *)getOptsArgsWithInt:(jint)nbArgs
                               withInt:(jint)opts {
  IOSObjectArray *args = [IOSObjectArray arrayWithLength:nbArgs + 10 + 1 type:NSString_class_()];
  if (nbArgs != 0) {
    if (opts == 1) {
      jint j = nbArgs + 1;
      @try {
        for (; j < nbArgs + 11; j++) {
          OrgScilabForgeJlatexmathTeXParser_skipWhiteSpace(self);
          IOSObjectArray_Set(args, j, [self getGroupWithChar:OrgScilabForgeJlatexmathTeXParser_L_BRACK withChar:OrgScilabForgeJlatexmathTeXParser_R_BRACK]);
        }
      }
      @catch (OrgScilabForgeJlatexmathExceptionParseException *e) {
        IOSObjectArray_Set(args, j, nil);
      }
    }
    OrgScilabForgeJlatexmathTeXParser_skipWhiteSpace(self);
    @try {
      IOSObjectArray_Set(args, 1, [self getGroupWithChar:OrgScilabForgeJlatexmathTeXParser_L_GROUP withChar:OrgScilabForgeJlatexmathTeXParser_R_GROUP]);
    }
    @catch (OrgScilabForgeJlatexmathExceptionParseException *e) {
      if ([((JavaLangStringBuffer *) nil_chk(parseString_)) charAtWithInt:pos_] != '\\') {
        IOSObjectArray_Set(args, 1, JreStrcat("C", [parseString_ charAtWithInt:pos_]));
        pos_++;
      }
      else IOSObjectArray_Set(args, 1, OrgScilabForgeJlatexmathTeXParser_getCommandWithArgsWithNSString_(self, OrgScilabForgeJlatexmathTeXParser_getCommand(self)));
    }
    if (opts == 2) {
      jint j = nbArgs + 1;
      @try {
    ...
    for (jint i = 2; i <= nbArgs; i++) {
      OrgScilabForgeJlatexmathTeXParser_skipWhiteSpace(self);
      @try {
        IOSObjectArray_Set(args, i, [self getGroupWithChar:OrgScilabForgeJlatexmathTeXParser_L_GROUP withChar:OrgScilabForgeJlatexmathTeXParser_R_GROUP]);
      }
      @catch (OrgScilabForgeJlatexmathExceptionParseException *e) {
        if ([((JavaLangStringBuffer *) nil_chk(parseString_)) charAtWithInt:pos_] != '\\') {
          IOSObjectArray_Set(args, i, JreStrcat("C", [parseString_ charAtWithInt:pos_]));
          pos_++;
        }
        else {
          IOSObjectArray_Set(args, i, OrgScilabForgeJlatexmathTeXParser_getCommandWithArgsWithNSString_(self, OrgScilabForgeJlatexmathTeXParser_getCommand(self)));
        }
      }
    }
    if (ignoreWhiteSpace_) {
...
- (void)dealloc {
  RELEASE_(formula_);
  RELEASE_(parseString_);
  [super dealloc];
}

+ (void)initialize {
  if (self == [OrgScilabForgeJlatexmathTeXParser class]) {
    JreStrongAssignAndConsume(&OrgScilabForgeJlatexmathTeXParser_unparsedContents_, nil, new_JavaUtilHashSet_initWithInt_(6));
    {
...
void OrgScilabForgeJlatexmathTeXParser_initWithNSString_withOrgScilabForgeJlatexmathTeXFormula_(OrgScilabForgeJlatexmathTeXParser *self, NSString *parseString, OrgScilabForgeJlatexmathTeXFormula *formula) {
  OrgScilabForgeJlatexmathTeXParser_initWithNSString_withOrgScilabForgeJlatexmathTeXFormula_withBoolean_(self, parseString, formula, YES);
}
...
void OrgScilabForgeJlatexmathTeXParser_initWithBoolean_withNSString_withOrgScilabForgeJlatexmathTeXFormula_(OrgScilabForgeJlatexmathTeXParser *self, jboolean isPartial, NSString *parseString, OrgScilabForgeJlatexmathTeXFormula *formula) {
  OrgScilabForgeJlatexmathTeXParser_initWithNSString_withOrgScilabForgeJlatexmathTeXFormula_withBoolean_(self, parseString, formula, NO);
...
void OrgScilabForgeJlatexmathTeXParser_initWithBoolean_withNSString_withOrgScilabForgeJlatexmathTeXFormula_withBoolean_(OrgScilabForgeJlatexmathTeXParser *self, jboolean isPartial, NSString *parseString, OrgScilabForgeJlatexmathTeXFormula *formula, jboolean firstpass) {
  ...
  OrgScilabForgeJlatexmathTeXParser_set_formula_(self, formula);
  self->isPartial_ = isPartial;
  if (parseString != nil) {
    OrgScilabForgeJlatexmathTeXParser_setAndConsume_parseString_(self, new_JavaLangStringBuffer_initWithNSString_(parseString));
    ...
    OrgScilabForgeJlatexmathTeXParser_set_parseString_(self, nil);
    self->pos_ = 0;
    self->len_ = 0;
  }
}
...
void OrgScilabForgeJlatexmathTeXParser_initWithNSString_withOrgScilabForgeJlatexmathTeXFormula_withBoolean_(OrgScilabForgeJlatexmathTeXParser *self, NSString *parseString, OrgScilabForgeJlatexmathTeXFormula *formula, jboolean firstpass) {
  OrgScilabForgeJlatexmathTeXParser_initWithBoolean_withNSString_withOrgScilabForgeJlatexmathTeXFormula_withBoolean_(self, NO, parseString, formula, firstpass);
}
...
void OrgScilabForgeJlatexmathTeXParser_initWithBoolean_withNSString_withOrgScilabForgeJlatexmathArrayOfAtoms_withBoolean_(OrgScilabForgeJlatexmathTeXParser *self, jboolean isPartial, NSString *parseString, OrgScilabForgeJlatexmathArrayOfAtoms *aoa, jboolean firstpass) {
  OrgScilabForgeJlatexmathTeXParser_initWithBoolean_withNSString_withOrgScilabForgeJlatexmathTeXFormula_withBoolean_(self, isPartial, parseString, aoa, firstpass);
  self->arrayMode_ = YES;
}
...
void OrgScilabForgeJlatexmathTeXParser_initWithBoolean_withNSString_withOrgScilabForgeJlatexmathArrayOfAtoms_withBoolean_withBoolean_(OrgScilabForgeJlatexmathTeXParser *self, jboolean isPartial, NSString *parseString, OrgScilabForgeJlatexmathArrayOfAtoms *aoa, jboolean firstpass, jboolean space) {
  OrgScilabForgeJlatexmathTeXParser_initWithBoolean_withNSString_withOrgScilabForgeJlatexmathTeXFormula_withBoolean_withBoolean_(self, isPartial, parseString, aoa, firstpass, space);
  self->arrayMode_ = YES;
}
...
void OrgScilabForgeJlatexmathTeXParser_initWithNSString_withOrgScilabForgeJlatexmathArrayOfAtoms_withBoolean_(OrgScilabForgeJlatexmathTeXParser *self, NSString *parseString, OrgScilabForgeJlatexmathArrayOfAtoms *aoa, jboolean firstpass) {
  OrgScilabForgeJlatexmathTeXParser_initWithBoolean_withNSString_withOrgScilabForgeJlatexmathTeXFormula_withBoolean_(self, NO, parseString, aoa, firstpass);
}
      ...
      ch = [((JavaLangStringBuffer *) nil_chk(self->parseString_)) charAtWithInt:self->pos_];
      {
        ...
        switch (ch) {
          ...
          if ([@"newcommand" isEqual:com] || [@"renewcommand" isEqual:com]) {
            ...
            @try {
              [((OrgScilabForgeJlatexmathMacroInfo *) nil_chk(mac)) invokeWithOrgScilabForgeJlatexmathTeXParser:self withNSStringArray:args];
            }
            @catch (OrgScilabForgeJlatexmathExceptionParseException *e) {
              if (!self->isPartial_) {
                @throw e;
            ...
            [self->parseString_ delete__WithInt:spos withInt:self->pos_];
            ...
            IOSObjectArray_Set(nil_chk(args), 0, com);
            @try {
              [self->parseString_ replaceWithInt:spos withInt:self->pos_ withNSString:(NSString *) check_class_cast([mac invokeWithOrgScilabForgeJlatexmathTeXParser:self withNSStringArray:args], [NSString class])];
            }
            @catch (OrgScilabForgeJlatexmathExceptionParseException *e) {
              if (!self->isPartial_) {
                @throw e;
            ...
            if (mac == nil) {
              if (!self->isPartial_) {
                @throw [new_OrgScilabForgeJlatexmathExceptionParseException_initWithNSString_(JreStrcat("$$$ICI", @"Unknown environment: ", IOSObjectArray_Get(args, 1), @" at position ", [self getLine], ':', [self getCol])) autorelease];
              }
            }
            else {
              @try {
                ...
                [self->parseString_ replaceWithInt:spos withInt:self->pos_ withNSString:expr];
                self->len_ = [self->parseString_ length];
                self->pos_ = spos;
              }
              @catch (OrgScilabForgeJlatexmathExceptionParseException *e) {
            ...
            [self getOptsArgsWithInt:1 withInt:0];
          }
          break;
          ...
          [self->parseString_ replaceWithInt:spos withInt:self->pos_ withNSString:@""];
          self->len_ = [self->parseString_ length];
          self->pos_ = spos;
          break;
          case OrgScilabForgeJlatexmathTeXParser_DEGRE:
          [self->parseString_ replaceWithInt:self->pos_ withInt:self->pos_ + 1 withNSString:@"^\\circ"];
          self->len_ = [self->parseString_ length];
          self->pos_++;
          break;
          case OrgScilabForgeJlatexmathTeXParser_SUPTWO:
          [self->parseString_ replaceWithInt:self->pos_ withInt:self->pos_ + 1 withNSString:@"\\jlatexmathcumsup{2}"];
          self->len_ = [self->parseString_ length];
          self->pos_++;
          break;
          case OrgScilabForgeJlatexmathTeXParser_SUPTHREE:
          [self->parseString_ replaceWithInt:self->pos_ withInt:self->pos_ + 1 withNSString:@"\\jlatexmathcumsup{3}"];
          self->len_ = [self->parseString_ length];
          self->pos_++;
          break;
          case OrgScilabForgeJlatexmathTeXParser_SUPONE:
          [self->parseString_ replaceWithInt:self->pos_ withInt:self->pos_ + 1 withNSString:@"\\jlatexmathcumsup{1}"];
          self->len_ = [self->parseString_ length];
          self->pos_++;
          break;
          case OrgScilabForgeJlatexmathTeXParser_SUPZERO:
          [self->parseString_ replaceWithInt:self->pos_ withInt:self->pos_ + 1 withNSString:@"\\jlatexmathcumsup{0}"];
          self->len_ = [self->parseString_ length];
          self->pos_++;
          break;
          case OrgScilabForgeJlatexmathTeXParser_SUPFOUR:
          [self->parseString_ replaceWithInt:self->pos_ withInt:self->pos_ + 1 withNSString:@"\\jlatexmathcumsup{4}"];
          self->len_ = [self->parseString_ length];
          self->pos_++;
          break;
          case OrgScilabForgeJlatexmathTeXParser_SUPFIVE:
          [self->parseString_ replaceWithInt:self->pos_ withInt:self->pos_ + 1 withNSString:@"\\jlatexmathcumsup{5}"];
          self->len_ = [self->parseString_ length];
          self->pos_++;
          break;
          case OrgScilabForgeJlatexmathTeXParser_SUPSIX:
          [self->parseString_ replaceWithInt:self->pos_ withInt:self->pos_ + 1 withNSString:@"\\jlatexmathcumsup{6}"];
          self->len_ = [self->parseString_ length];
          self->pos_++;
          break;
          case OrgScilabForgeJlatexmathTeXParser_SUPSEVEN:
          [self->parseString_ replaceWithInt:self->pos_ withInt:self->pos_ + 1 withNSString:@"\\jlatexmathcumsup{7}"];
          self->len_ = [self->parseString_ length];
          self->pos_++;
          break;
          case OrgScilabForgeJlatexmathTeXParser_SUPEIGHT:
          [self->parseString_ replaceWithInt:self->pos_ withInt:self->pos_ + 1 withNSString:@"\\jlatexmathcumsup{8}"];
          self->len_ = [self->parseString_ length];
          self->pos_++;
          break;
          case OrgScilabForgeJlatexmathTeXParser_SUPNINE:
          [self->parseString_ replaceWithInt:self->pos_ withInt:self->pos_ + 1 withNSString:@"\\jlatexmathcumsup{9}"];
          self->len_ = [self->parseString_ length];
          self->pos_++;
          break;
          case OrgScilabForgeJlatexmathTeXParser_SUPPLUS:
          [self->parseString_ replaceWithInt:self->pos_ withInt:self->pos_ + 1 withNSString:@"\\jlatexmathcumsup{+}"];
          self->len_ = [self->parseString_ length];
          self->pos_++;
          break;
          ...
          [self->parseString_ replaceWithInt:self->pos_ withInt:self->pos_ + 1 withNSString:@"\\jlatexmathcumsup{n}"];
          self->len_ = [self->parseString_ length];
          self->pos_++;
          break;
          case OrgScilabForgeJlatexmathTeXParser_SUBTWO:
          [self->parseString_ replaceWithInt:self->pos_ withInt:self->pos_ + 1 withNSString:@"\\jlatexmathcumsub{2}"];
          self->len_ = [self->parseString_ length];
          self->pos_++;
          break;
          case OrgScilabForgeJlatexmathTeXParser_SUBTHREE:
          [self->parseString_ replaceWithInt:self->pos_ withInt:self->pos_ + 1 withNSString:@"\\jlatexmathcumsub{3}"];
          self->len_ = [self->parseString_ length];
          self->pos_++;
          break;
          case OrgScilabForgeJlatexmathTeXParser_SUBONE:
          [self->parseString_ replaceWithInt:self->pos_ withInt:self->pos_ + 1 withNSString:@"\\jlatexmathcumsub{1}"];
          self->len_ = [self->parseString_ length];
          self->pos_++;
          break;
          case OrgScilabForgeJlatexmathTeXParser_SUBZERO:
          [self->parseString_ replaceWithInt:self->pos_ withInt:self->pos_ + 1 withNSString:@"\\jlatexmathcumsub{0}"];
          self->len_ = [self->parseString_ length];
          self->pos_++;
          break;
          case OrgScilabForgeJlatexmathTeXParser_SUBFOUR:
          [self->parseString_ replaceWithInt:self->pos_ withInt:self->pos_ + 1 withNSString:@"\\jlatexmathcumsub{4}"];
          self->len_ = [self->parseString_ length];
          self->pos_++;
          break;
          case OrgScilabForgeJlatexmathTeXParser_SUBFIVE:
          [self->parseString_ replaceWithInt:self->pos_ withInt:self->pos_ + 1 withNSString:@"\\jlatexmathcumsub{5}"];
          self->len_ = [self->parseString_ length];
          self->pos_++;
          break;
          case OrgScilabForgeJlatexmathTeXParser_SUBSIX:
          [self->parseString_ replaceWithInt:self->pos_ withInt:self->pos_ + 1 withNSString:@"\\jlatexmathcumsub{6}"];
          self->len_ = [self->parseString_ length];
          self->pos_++;
          break;
          case OrgScilabForgeJlatexmathTeXParser_SUBSEVEN:
          [self->parseString_ replaceWithInt:self->pos_ withInt:self->pos_ + 1 withNSString:@"\\jlatexmathcumsub{7}"];
          self->len_ = [self->parseString_ length];
          self->pos_++;
          break;
          case OrgScilabForgeJlatexmathTeXParser_SUBEIGHT:
          [self->parseString_ replaceWithInt:self->pos_ withInt:self->pos_ + 1 withNSString:@"\\jlatexmathcumsub{8}"];
          self->len_ = [self->parseString_ length];
          self->pos_++;
          break;
          case OrgScilabForgeJlatexmathTeXParser_SUBNINE:
          [self->parseString_ replaceWithInt:self->pos_ withInt:self->pos_ + 1 withNSString:@"\\jlatexmathcumsub{9}"];
          self->len_ = [self->parseString_ length];
          self->pos_++;
          break;
          case OrgScilabForgeJlatexmathTeXParser_SUBPLUS:
          [self->parseString_ replaceWithInt:self->pos_ withInt:self->pos_ + 1 withNSString:@"\\jlatexmathcumsub{+}"];
          self->len_ = [self->parseString_ length];
          self->pos_++;
          break;
...
OrgScilabForgeJlatexmathAtom *OrgScilabForgeJlatexmathTeXParser_getScriptsWithChar_(OrgScilabForgeJlatexmathTeXParser *self, jchar f) {
  ...
  if ([((OrgScilabForgeJlatexmathTeXFormula *) nil_chk(self->formula_))->root_ isKindOfClass:[OrgScilabForgeJlatexmathRowAtom class]]) {
    ...
    at = [new_OrgScilabForgeJlatexmathPhantomAtom_initWithOrgScilabForgeJlatexmathAtom_withBoolean_withBoolean_withBoolean_([new_OrgScilabForgeJlatexmathCharAtom_initWithChar_withNSString_('M', @"mathnormal") autorelease], NO, YES, YES) autorelease];
  }
  else {
    at = self->formula_->root_;
    OrgScilabForgeJlatexmathTeXFormula_set_root_(self->formula_, nil);
  }
  if ([((OrgScilabForgeJlatexmathAtom *) nil_chk(at)) getRightType] == OrgScilabForgeJlatexmathTeXConstants_TYPE_BIG_OPERATOR) return [new_OrgScilabForgeJlatexmathBigOperatorAtom_initWithOrgScilabForgeJlatexmathAtom_withOrgScilabForgeJlatexmathAtom_withOrgScilabForgeJlatexmathAtom_(at, first, second) autorelease];
    ...
    if ([((OrgScilabForgeJlatexmathOverUnderDelimiter *) check_class_cast(at, [OrgScilabForgeJlatexmathOverUnderDelimiter class])) isOver]) {
      if (second != nil) {
        ...
        return [new_OrgScilabForgeJlatexmathScriptsAtom_initWithOrgScilabForgeJlatexmathAtom_withOrgScilabForgeJlatexmathAtom_withOrgScilabForgeJlatexmathAtom_(at, first, nil) autorelease];
      }
    }
    else if (first != nil) {
      ...
      return [new_OrgScilabForgeJlatexmathScriptsAtom_initWithOrgScilabForgeJlatexmathAtom_withOrgScilabForgeJlatexmathAtom_withOrgScilabForgeJlatexmathAtom_(at, nil, second) autorelease];
    }
  }
  return [new_OrgScilabForgeJlatexmathScriptsAtom_initWithOrgScilabForgeJlatexmathAtom_withOrgScilabForgeJlatexmathAtom_withOrgScilabForgeJlatexmathAtom_(at, first, second) autorelease];
}
...
OrgScilabForgeJlatexmathAtom *OrgScilabForgeJlatexmathTeXParser_processEscape(OrgScilabForgeJlatexmathTeXParser *self) {
  ...
  if (!self->isPartial_) {
    @throw [new_OrgScilabForgeJlatexmathExceptionParseException_initWithNSString_(JreStrcat("$$C", @"Unknown symbol or command or predefined TeXFormula: '", command, '\'')) autorelease];
  }
  else {
    return [new_OrgScilabForgeJlatexmathColorAtom_initWithOrgScilabForgeJlatexmathAtom_withOrgScilabForgeJlatexmathPlatformGraphicsColor_withOrgScilabForgeJlatexmathPlatformGraphicsColor_([new_OrgScilabForgeJlatexmathRomanAtom_initWithOrgScilabForgeJlatexmathAtom_(((OrgScilabForgeJlatexmathTeXFormula *) [new_OrgScilabForgeJlatexmathTeXFormula_initWithNSString_(JreStrcat("$$", @"\\backslash ", command)) autorelease])->root_) autorelease], nil, OrgScilabForgeJlatexmathColorUtil_get_RED_()) autorelease];
  }
}
...
void OrgScilabForgeJlatexmathTeXParser_insertWithInt_withInt_withNSString_(OrgScilabForgeJlatexmathTeXParser *self, jint beg, jint end, NSString *formula) {
  [((JavaLangStringBuffer *) nil_chk(self->parseString_)) replaceWithInt:beg withInt:end withNSString:formula];
  self->len_ = [self->parseString_ length];
  self->pos_ = beg;
  self->insertion_ = YES;
}
...
NSString *OrgScilabForgeJlatexmathTeXParser_getCommandWithArgsWithNSString_(OrgScilabForgeJlatexmathTeXParser *self, NSString *command) {
  ...
  if (mac != nil) {
    ...
    JavaLangStringBuffer *mac_arg = [new_JavaLangStringBuffer_initWithNSString_(@"\\") autorelease];
    [mac_arg appendWithNSString:command];
    for (jint j = 0; j < mac->posOpts_; j++) {
      NSString *arg_t = IOSObjectArray_Get(nil_chk(mac_args), mac->nbArgs_ + j + 1);
      if (arg_t != nil) {
        [((JavaLangStringBuffer *) nil_chk([((JavaLangStringBuffer *) nil_chk([mac_arg appendWithNSString:@"["])) appendWithNSString:arg_t])) appendWithNSString:@"]"];
      }
    }
...
OrgScilabForgeJlatexmathAtom *OrgScilabForgeJlatexmathTeXParser_processCommandsWithNSString_(OrgScilabForgeJlatexmathTeXParser *self, NSString *command) {
  ...
  IOSObjectArray_Set(nil_chk(args), 0, command);
