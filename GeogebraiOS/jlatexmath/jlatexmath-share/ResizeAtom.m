...
//  source: /Users/jacky/GSoC/JLaTeXMathiOS/JLaTeXMathiOS/javasource/org/scilab/forge/jlatexmath/ResizeAtom.java
//
...
- (OrgScilabForgeJlatexmathBox *)createBoxWithOrgScilabForgeJlatexmathTeXEnvironment:(OrgScilabForgeJlatexmathTeXEnvironment *)env {
  ...
  if (wunit_ == -1 && hunit_ == -1) {
    ...
    return [new_OrgScilabForgeJlatexmathScaleBox_initWithOrgScilabForgeJlatexmathBox_withDouble_withDouble_(bbox, xscl, yscl) autorelease];
  }
}
...
void OrgScilabForgeJlatexmathResizeAtom_initWithOrgScilabForgeJlatexmathAtom_withNSString_withNSString_withBoolean_(OrgScilabForgeJlatexmathResizeAtom *self, OrgScilabForgeJlatexmathAtom *base, NSString *ws, NSString *hs, jboolean keepaspectratio) {
  ...
  OrgScilabForgeJlatexmathResizeAtom_set_base_(self, base);
